...
private static Logger logger = Logger.getLogger(LCContPlanUI.class);
	...
	private boolean prepareOutputData() {
		try {
			...
			mInputData.add(this.mLQBenefitDutyParamSet);
			mInputData.add(this.mLQBenefitSchema);
	...
	public static void main(String[] args) {
		// LQBenefitDutyParamSet tLQBenefitDutyParamSet = new
		// LQBenefitDutyParamSet();
		...
		// tLQBenefitDutyParamSet.add(tLCContPlanDutyParamSchema);
		//
		// tLCContPlanDutyParamSchema = new LCContPlanDutyParamSchema();
		// tLCContPlanDutyParamSchema.setGrpContNo("120110000000236 ");
		// tLCContPlanDutyParamSchema.setRiskCode("221670");
		...
		// tVData.add(tG);
		// tVData.add(tLQBenefitDutyParamSet);
