 ...
 * @version 1.0
 */
public class PDOtherInfoAfterEndService implements AfterEndService
{
private static Logger logger = Logger.getLogger(PDOtherInfoAfterEndService.class);
  ...
  public PDOtherInfoAfterEndService() {}
