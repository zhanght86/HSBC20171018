...
public class BQRePrintUWNoticeAfterInitService implements AfterInitService {
private static Logger logger = Logger.getLogger(BQRePrintUWNoticeAfterInitService.class);
	...
	public BQRePrintUWNoticeAfterInitService() {
	}
	...
	private boolean dealLwmission() {
		...
		String tSQL = "select * from lwmission where missionid='"
				+ "?missionid?" + "' " 
				+ " and activityid='0000000353' and missionprop14='"+"?missionprop14?"+"'";
		logger.debug("需要删除的工作流活动节点："+0000000353);
