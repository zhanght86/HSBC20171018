...
/**
 * <p>
 * Title:工作流服务类:新契约人工核保补打核保通知书
 * </p>
 * <p>
 * Description: 补打核保通知书工作流AfterInit服务类
 * </p>
 * <p>
...
public class UWRePrintAllNoticeAfterInitService implements AfterInitService {
private static Logger logger = Logger.getLogger(UWRePrintAllNoticeAfterInitService.class);
	...
	public UWRePrintAllNoticeAfterInitService() {
	}
	...
	private boolean checkData() {
		...
		if (!tLCContDB.getInfo()) {
			...
			tError.moduleName = "UWRePrintAllNoticeAfterInitServer";
		...
		if (!mLOPRTManagerSchema.getCode().equals(mCode)) {
			CError tError = new CError();
			tError.moduleName = "UWRePrintAllNoticeAfterInitServer";
			tError.functionName = "checkData";
			tError.errorMessage = "核保通知书" + mLOPRTManagerSchema.getPrtSeq()
