...
public class RnewRePrintRReportAfterInitService implements AfterInitService {
private static Logger logger = Logger.getLogger(RnewRePrintRReportAfterInitService.class);
	...
	public RnewRePrintRReportAfterInitService() {
	}
...
//		}
	...
	private boolean prepareTransferData() {
		...
		mTransferData
		.setNameAndValue("ContNo", mLCContSchema.getContNo());
		mTransferData
		...
		mTransferData.setNameAndValue("BranchAttr", tLABranchGroupSet.get(1)
				.getBranchAttr());
		mTransferData
				.setNameAndValue("ManageCom", mLOPRTManagerSchema.getManageCom());
		mTransferData
		.setNameAndValue("Code", mLCContSchema.getContNo());
	...
	private boolean dealLwmission() {
		...
		String tSQL = "select * from lwmission where missionid='"
				+ "?missionid?" + "' " + " and activityid='0000007014' ";
