...
public class PDSugIncomeDataAlgBL    implements BusinessService{
...
*/
 ...
 private boolean getInputData(VData cInputData) {
 	try {
 		...
 		tList.add(mRiskCode);
 		tList.add((String)mTransferData.getValueByName("PROCEEDSCODE"));
 		tList.add((String)mTransferData.getValueByName("CALEXPRESS"));
 		tList.add((String)mTransferData.getValueByName("CALORDERNO"));
 		tList.add((String)mTransferData.getValueByName("EXPRESSPROPERTY"));
		tList.add((String)mTransferData.getValueByName("RECURSIONINITVALUE"));
		tList.add((String)mTransferData.getValueByName("BACK"));
		tList.add((String)mTransferData.getValueByName("RESULTPRECISION"));
		tList.add((String)mTransferData.getValueByName("REMARK"));
		tList.add((String)mTransferData.getValueByName("SHOWFLAG"));
		tList.add((String)mTransferData.getValueByName("TERMS"));
