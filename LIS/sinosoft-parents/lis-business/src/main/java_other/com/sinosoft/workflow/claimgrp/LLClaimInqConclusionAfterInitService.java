...
import com.sinosoft.lis.claimgrp.LLClaimInqConclusionBL;


/**
 * <p>Title: 调查结论《赔案层面》处理信息提交服务类 </p>
 * <p>Description: </p>
...
private static Logger logger = Logger.getLogger(LLClaimInqConclusionAfterInitService.class);
    ...
    private boolean dealData()
    {
        ...
        logger.debug("----------LLClaimInqConclusionAfterInitService transact----------"+transact);
