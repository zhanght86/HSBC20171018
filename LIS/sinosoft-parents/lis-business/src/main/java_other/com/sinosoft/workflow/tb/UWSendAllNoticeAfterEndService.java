 ...
 * </p>
 * <p>
 * Description:工作流发核保通知书AfterEnd服务类
 * </p>
 * <p>
...
public class UWSendAllNoticeAfterEndService implements AfterEndService {
private static Logger logger = Logger.getLogger(UWSendAllNoticeAfterEndService.class);
	...
	public UWSendAllNoticeAfterEndService() {
	}
	...
	private boolean getInputData(VData cInputData, String cOperate) {
		...
		if (mGlobalInput == null) {
			...
			tError.moduleName = "UWSendAllNoticeAfterEndService";
	...
	private boolean prepareMission() {
		...
		String tStr = "Select * from LWMission where MissionID = '"
				+ "?mMissionID?"
				+ "'"
				+ "and (ActivityID = '0000001100' or ActivityID = '0000000005' "
				+ " or ActivityID = '0000005505')";
		sqlbv.sql(tStr);
		...
		if (tLWMissionSet != null && tLWMissionSet.size() == 1) {
			...
			if (tLWMissionSet != null && tLWMissionSet.size() == 1) {
				...
				tError.errorMessage = "查询工作流发核保通知书的起始任务节点失败!";
				this.mErrors.addOneError(tError);
				return false;
			}
		}
