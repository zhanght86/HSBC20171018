...
public class LLRePrintAutoHealthAfterInitService implements AfterInitService {
private static Logger logger = Logger.getLogger(LLRePrintAutoHealthAfterInitService.class);
	...
	public LLRePrintAutoHealthAfterInitService() {
	}
	...
	private boolean checkData() {
		...
		if (!mLOPRTManagerSchema.getCode().equals("LP03")) {
			CError.buildErr(this, "体检通知书" + mLOPRTManagerSchema.getPrtSeq()
					+ "体检标识信息查询失败!") ;
			return false;
		}
