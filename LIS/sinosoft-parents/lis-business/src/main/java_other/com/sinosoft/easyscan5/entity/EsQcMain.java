...
public class EsQcMain implements java.io.Serializable {
	...
	public EsQcMain(EsDocMain esDocMain) {
		this.docId = esDocMain.getDocid() + "";
		...
		this.docVersion = esDocMain.getVersion();
	...
	/** minimal constructor */
	public EsQcMain(String docId, String docCode, String bussType,
			String subType, String qcStatus, Long numPages, String docFlag,
			String scanOperator, Date scanDate, String manageCom,
			String scanNo, String tempFlag, Date createDate, Date updateDate, String systemNo) {
		this.docId = docId;
	...
	public EsQcMain(String docId, String docCode, String bussType,
			String subType, String qcStatus, Long numPages, String docFlag,
			String docRemark, String scanOperator, Date scanDate,
			String manageCom, String scanNo, String docPriority,
			String tempFlag, String docVersion, String qcOperator,
			Date qcStartDate, Date qcUploadDate, Date qcFinishDate,
			String qcLockFlag, String qcErrorinfo, Date createDate,
			...
			String scanCom,String printCode,String channel,String groupNo,String batchNo) {
		this.docId = docId;
		this.docCode = docCode;
		this.bussType = bussType;
		this.subType = subType;
	...
	public void setV(String FCode ,String FValue)
	{
