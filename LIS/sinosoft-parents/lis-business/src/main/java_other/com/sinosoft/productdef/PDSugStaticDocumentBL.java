...
public class PDSugStaticDocumentBL    implements BusinessService{
...
*/
 ...
 private boolean getInputData(VData cInputData) {
 	try {
 		...
 		tList.add("");
 		tList.add("");
 		tList.add((String)mTransferData.getValueByName("FILEPATH"));
 		tList.add((String)mTransferData.getValueByName("LANGUAGE"));
 		tList.add((String)mTransferData.getValueByName("BAK"));
