 ...
 * @version 1.0
 */
public class PDApplyAfterEndService implements AfterEndService
{
private static Logger logger = Logger.getLogger(PDApplyAfterEndService.class);
