...
/**
 * <p>
 * Title: 工作流节点任务:新契约发团单核保要求通知书
 * </p>
 * <p>
 * Description:工作流发团单核保要求通知书AfterEnd服务类
 * </p>
 * <p>
...
public class GrpUWSendRequireNoticeAfterEndService implements AfterEndService {
private static Logger logger = Logger.getLogger(GrpUWSendRequireNoticeAfterEndService.class);
	...
	public GrpUWSendRequireNoticeAfterEndService() {
	}
	...
	private boolean prepareMission() {
		...
		String tStr = "Select * from LWMission where MissionID = '"
				+ mMissionID + "'" + "and ActivityID = '0000002004'";
		...
		if (tLWMissionSet != null && tLWMissionSet.size() == 1) {
			...
			if (tLWMissionSet != null && tLWMissionSet.size() == 1) {
				...
				tError.errorMessage = "查询工作流发团单核保要求通知书的起始任务节点失败!";
				this.mErrors.addOneError(tError);
				return false;
			}
		}
