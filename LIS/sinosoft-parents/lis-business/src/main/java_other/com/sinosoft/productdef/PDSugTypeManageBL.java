...
public class PDSugTypeManageBL    implements BusinessService{
...
*/
 ...
 private boolean getInputData(VData cInputData) {
 	try {
 		...
 		tList.add((String)mTransferData.getValueByName("RELATION"));
 		tList.add((String)mTransferData.getValueByName("FILENAME"));
