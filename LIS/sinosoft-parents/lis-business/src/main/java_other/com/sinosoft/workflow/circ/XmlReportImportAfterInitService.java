...
{
private static Logger logger = Logger.getLogger(XmlReportImportAfterInitService.class);
...
//        mOperate = cOperate;
                                ...
                                TransferData tTransferData)
    {
        ...
        logger.debug("tNeedItemKeyName:" + tNeedItemKeyName);
        if (tNeedItemKeyValue.equals("1")) //1-扩充要素
        {
            ...
            if (!tLFItemRelaDB.getInfo())
            {
                ...
                logger.debug("getinfo fail:itemcode=" +
                                   tLFItemRelaDB.getItemCode());
                return "0";
            }

            logger.debug("UpItemCode:" + tLFItemRelaDB.getUpItemCode());
            logger.debug("Layer:" + tLFItemRelaDB.getLayer());
            logger.debug("Remark:" + tLFItemRelaDB.getRemark());
