...
public class BOMMainPol extends AbstractBOM
{
	...
	{
	  if(!(new BOMPreCheck().CheckSequence(String.valueOf(SpecFlag)))){
	    	return;
  	   }else{
...
SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd hh:mm:ss");
	  ...
	  {
	     strReturn = StrTool.GBKToUnicode(String.valueOf(getSpecFlag()));
	  }
