...
{
private static Logger logger = Logger.getLogger(ReportCWImportAfterInitService.class);
...
//        mOperate = cOperate;
    ...
    private boolean dealData()
    {
        ...
        String tWhereSQLValue = (String) mTransferData.getValueByName((Object) tWhereSQLName)
                                .toString();
