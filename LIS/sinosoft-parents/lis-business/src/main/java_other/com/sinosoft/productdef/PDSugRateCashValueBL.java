...
public class PDSugRateCashValueBL {
	...
	public boolean submitData(VData cInputData, String cOperate) {
		...
		try
		{
	        ...
	        if (!tSubmit.submitData(mResult, "")) {
	            ...
	            tError.moduleName = "PDSugRateCashValueBL";
		...
		{
			this.mErrors.addOneError("PDSugRateCashValueBL处理错误");
			return false;
		}
	...
	private boolean deal(VData cInputData, String cOperate) throws Exception{
		...
		String newTableName = (String) mTransferData
		...
		if (cOperate.equals("createRateTable")) {
			...
			saveSQLForDeploy(tRiskCode, tPayCode, coreCreateSQL, newTableName, "3");
			
		} else if (cOperate.equals("deleteRateTable")) {
			sql = "drop table " + newTableName;
			
			deleteSQL(tRiskCode, tPayCode, "3", newTableName);
