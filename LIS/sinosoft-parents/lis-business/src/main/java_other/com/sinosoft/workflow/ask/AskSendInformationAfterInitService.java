...
import com.sinosoft.lis.cbcheck.UWAskInfoBL;
...
private static Logger logger = Logger.getLogger(AskSendInformationAfterInitService.class);
	...
	private boolean getInputData(VData cInputData, String cOperate) {
		...
		mTransferData = (TransferData) cInputData.getObjectByObjectName(
				"TransferData", 0);
		mLCInformationSet = (LCInformationSet) cInputData
	...
	private boolean dealData() {
		...
		if (tResult) {
			mMap = (MMap) tUWAskInfoBL.getResult().getObjectByObjectName(
					"MMap", 0);
