...
private static Logger logger = Logger.getLogger(UWRReportAfterEndService.class);
	...
	private boolean prepareMission() {
		...
		String tStr = "Select * from LWMission where MissionID = '"
				+ "?mMissionID?" + "'"
				+ "and ActivityID in ('0000001100','0000005505')";
		sqlbv.sql(tStr);
		...
		if (tLWMissionSet != null && tLWMissionSet.size() == 1) {
			...
			mInitLWMissionSchema.setMissionProp18("4");// 核保未回复
