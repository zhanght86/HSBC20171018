...
/**
 * <p>
 * Title: 工作流服务类:新契约人工核保
 * </p>
 * <p>
 * Description: 人工核保工作流AfterEnd服务类
 * </p>
 * <p>
...
private static Logger logger = Logger.getLogger(GrpContSignAfterEndService.class);
	...
	private boolean checkData() {
		...
		tLWMissionDB.setActivityID("0000011006");
	...
	private boolean prepareMission() {
		String tStr = "Select * from LWMission where MissionID = '"
				+ mMissionID + "'" + " and ActivityID = '0000011005'";
		LWMissionDB tLWMissionDB = new LWMissionDB();
