...
{
private static Logger logger = Logger.getLogger(ReportXSImportRedoAfterInitService.class);
...
//                        " and month(reportdate)=" + mStatMon;
        mDeleteXMLSQL = "delete from LFXMLColl where StatYear=" +
        		"?mStatYear?" + " and StatMon=" +
                        "?mStatMon?";
        sqlbv2.sql(mDeleteXMLSQL);
        sqlbv2.put("mStatYear", mStatYear.trim());
        sqlbv2.put("mStatMon", mStatMon.trim());
        return true;
