...
public class LLRePrintSendNoticeAfterInitService implements AfterInitService {
private static Logger logger = Logger.getLogger(LLRePrintSendNoticeAfterInitService.class);
	...
	public LLRePrintSendNoticeAfterInitService() {
	}
	...
	private boolean prepareTransferData() {
		...
		mTransferData.setNameAndValue("PrtSeq_A", mLOPRTManagerSchema
				.getPrtSeq());
		mTransferData.setNameAndValue("PrtSeq_I", mLOPRTManagerSchema
				.getPrtSeq());
		mTransferData.setNameAndValue("SaleChnl", mLCContSchema.getSaleChnl());

		mTransferData.setNameAndValue("OldPrtSeq_A", mLOPRTManagerSchema
				.getOldPrtSeq());
		mTransferData.setNameAndValue("OldPrtSeq_I", mLOPRTManagerSchema
				.getOldPrtSeq());
		mTransferData.setNameAndValue("CustomerNoType_A", mLOPRTManagerSchema
				.getStandbyFlag6());
		mTransferData.setNameAndValue("CustomerNoType_I", mLOPRTManagerSchema.getStandbyFlag6());
		mTransferData.setNameAndValue("CustomerNo_A", mLOPRTManagerSchema.getStandbyFlag7());
		mTransferData.setNameAndValue("CustomerNo_I", mLOPRTManagerSchema.getStandbyFlag7());
		mTransferData
