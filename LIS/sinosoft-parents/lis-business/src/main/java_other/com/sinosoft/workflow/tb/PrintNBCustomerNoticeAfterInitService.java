 ...
 * @version 6.0
 */
public class PrintNBCustomerNoticeAfterInitService implements AfterInitService {
private static Logger logger = Logger.getLogger(PrintNBCustomerNoticeAfterInitService.class);
	...
	public PrintNBCustomerNoticeAfterInitService() {
	}
	...
	private boolean getInputData(VData cInputData, String cOperate) {
		...
		if (mGlobalInput == null) {
			...
			CError tError = new CError();
			tError.moduleName = "PrintNBCustomerNoticeAfterInitService";
	...
	private boolean dealData() {
		// 添加相关业务类
		// 新契约通知书信息
		if (preparePrintNewBusinessCustomer() == false)
			return false;
	 ...
	 * @return boolean
	 */
	private boolean preparePrintNewBusinessCustomer() {
