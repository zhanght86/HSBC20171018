...
public class LLPrintImpartQuestAfterInitService implements AfterInitService {
private static Logger logger = Logger.getLogger(LLPrintImpartQuestAfterInitService.class);
	...
	public LLPrintImpartQuestAfterInitService() {
	}
