...
import com.sinosoft.lis.bq.PEdorAccepManuUWBL;
...
private static Logger logger = Logger.getLogger(PEdorAppUWConfirmAfterInitService.class);
	...
	public boolean submitData(VData cInputData, String cOperate) {
		logger.debug("======PEdorAppUWConfirmAfterInitService======");
