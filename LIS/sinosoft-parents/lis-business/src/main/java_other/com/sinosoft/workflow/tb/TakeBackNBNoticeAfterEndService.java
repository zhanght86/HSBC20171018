 ...
 * 
 * <p>
 * Description: 回收新契约内容变更通知书工作流服务类
 * </p>
 * 
 * <p>
 ...
 * @version 6.0
 */
public class TakeBackNBNoticeAfterEndService implements AfterEndService {
private static Logger logger = Logger.getLogger(TakeBackNBNoticeAfterEndService.class);
	...
	public TakeBackNBNoticeAfterEndService() {
	}
	...
	private boolean checkData() {
		...
		tLWMissionDB.setActivityID("0000001250");
	...
	private boolean prepareMission() {
		...
		String tStr = "Select * from LWMission where MissionID = '"
				+ "?MissionID1?" + "'"
				+ "and ActivityID in ('0000001210','0000001250')";
		...
		tStr = "Select count(*) from LWMission where MissionID = '"
				+ "?MissionID?" + "'" + " and ActivityID in ('0000001002')";
