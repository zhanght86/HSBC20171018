...
public class PDSugIncomeTabHeadBL    implements BusinessService{
...
*/
 public boolean submitData(VData cInputData,String cOperate)
 {
	...
	if(!result){
		this.mErrors.addOneError("PDSugTabHeadCongBL.submitData处理失败，" + commonBase.mErrors.getFirstError());
 ...
 private boolean getInputData(VData cInputData) {
 	try {
 		...
 		tList.add((String)mTransferData.getValueByName("PRIFITCODE"));
 		tList.add((String)mTransferData.getValueByName("NAME"));
 		tList.add((String)mTransferData.getValueByName("SHOWORDER"));
		tList.add((String)mTransferData.getValueByName("PARENTID"));
