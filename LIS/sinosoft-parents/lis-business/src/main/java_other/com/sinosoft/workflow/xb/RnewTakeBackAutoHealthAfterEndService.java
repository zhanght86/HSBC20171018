...
public class RnewTakeBackAutoHealthAfterEndService implements AfterEndService {
private static Logger logger = Logger.getLogger(RnewTakeBackAutoHealthAfterEndService.class);
	...
	public RnewTakeBackAutoHealthAfterEndService() {
	}
	...
	private boolean checkData() {
		...
		tLWMissionDB.setActivityID("0000007009");
...
//		}
	...
	private boolean prepareMission_new() {
		...
		String tStr = "Select * from LWMission where MissionID = '"
				+ "?mMissionID?" + "' and ActivityID = '0000007008'"
				+ " and MissionProp14 = '"
				+ "?MissionProp14?" + "'";
