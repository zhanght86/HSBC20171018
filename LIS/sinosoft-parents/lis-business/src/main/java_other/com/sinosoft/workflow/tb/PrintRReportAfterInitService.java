...
private static Logger logger = Logger.getLogger(PrintRReportAfterInitService.class);
	...
	private boolean prepareTransferData() {
		...
		mTransferData.setNameAndValue("InsuredNo", tLCRReportSchema
				.getCustomerNo());
		mTransferData
				.setNameAndValue("InsuredName", tLCRReportSchema.getName());
		mTransferData.setNameAndValue("RROperator", tLCRReportSchema
				.getOperator());
		...
		mTransferData.setNameAndValue("ExeOperator", mLOPRTManagerSchema
				.getExeOperator());
		mTransferData.setNameAndValue("CustomerNo", tLCRReportSchema
				.getCustomerNo());
