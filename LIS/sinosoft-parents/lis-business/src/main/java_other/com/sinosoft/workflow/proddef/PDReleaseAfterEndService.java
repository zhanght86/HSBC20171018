 ...
 * @version 1.0
 */
public class PDReleaseAfterEndService implements AfterEndService
{
private static Logger logger = Logger.getLogger(PDReleaseAfterEndService.class);
  ...
  public PDReleaseAfterEndService() {}
