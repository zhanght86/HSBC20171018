...
/**
 * <p>
 * Title:工作流服务类:新契约人工核保补打团单核保要求通知书
 * </p>
 * <p>
 * Description: 补打团单核保要求通知书工作流AfterInit服务类
 * </p>
 * <p>
...
public class RePrintGrpUWRequireAfterInitService implements AfterInitService {
private static Logger logger = Logger.getLogger(RePrintGrpUWRequireAfterInitService.class);
	...
	public RePrintGrpUWRequireAfterInitService() {
	}
	...
	private boolean checkData() {
		...
		if (tLOPRTManagerSet == null) {
			...
			tError.functionName = "checkData";
			tError.errorMessage = "团单核保要求通知书" + mLOPRTManagerSchema.getPrtSeq()
					+ "信息查询失败!";
			this.mErrors.addOneError(tError);
			return false;
		}
		...
		if (!mLOPRTManagerSchema.getCode().equals("75")) {
			CError tError = new CError();
			tError.moduleName = "RePrintAutoHealthAfterInitService";
			tError.functionName = "checkData";
			tError.errorMessage = "团单核保要求通知书" + mLOPRTManagerSchema.getPrtSeq()
