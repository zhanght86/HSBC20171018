...
public class GrpUWPrintRequireAfterInitService implements AfterInitService {
private static Logger logger = Logger.getLogger(GrpUWPrintRequireAfterInitService.class);
	...
	public GrpUWPrintRequireAfterInitService() {
	}
	...
	private boolean prepareTransferData() {
		...
		mTransferData
				.setNameAndValue("Code", PrintManagerBL.CODE_GRP_UWREQUIRE);
