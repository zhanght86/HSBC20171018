...
public class RnewWorkFlowBLS {
private static Logger logger = Logger.getLogger(RnewWorkFlowBLS.class);
	// 传输数据类
	...
	public boolean submitData(VData cInputData, String cOperate) {
		...
		logger.debug("End RnewWorkFlowBLS Submit...");
