...
public class BQTakeBackUWNoticeAfterEndService  implements AfterEndService {
private static Logger logger = Logger.getLogger(BQTakeBackUWNoticeAfterEndService.class);
	...
	public BQTakeBackUWNoticeAfterEndService() {
	}
...
//	}
	...
	private boolean prepareMission_new() {			
		...
		// 删除补打节点，包括本次回收节点
		String tStr = "Select * from LWMission where MissionID = '"
				+ "?mMissionID?" + "'" + "and ActivityID = '0000000352' "				
				+ " and MissionProp14 = '"
				+ "?MissionProp14?"
				+ "'"				
				+ " union "
		...
		tStr = "Select count(*)"
				...
				//考虑处于发送核保通知书到回到核保之间的工作流节点
				+ "('0000000302', '0000000304', '0000000303', '0000000305', "
                + " '0000000312', '0000000315', '0000000316', '0000000314',"
                + " '0000000351', '0000000352', '0000000353',"
                + " '0000000332') " ;
		String tReSult = new String(); 
		ExeSQL tExeSQL = new ExeSQL();
		...
		if (tCount == 2) 
		{
			...
			tLWMissionDB1.setSubMissionID(mSubMissionID);
			//tLWMissionDB1.setActivityID("0000000005");
			...
			mLWMissionUpdateSet.add(tLWMissionSchema);
			mLBMissionInsertSet.add(tLBMissionSchema);
		}		
