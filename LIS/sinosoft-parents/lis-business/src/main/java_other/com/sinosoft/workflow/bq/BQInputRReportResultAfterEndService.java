...
public class BQInputRReportResultAfterEndService implements AfterEndService {
private static Logger logger = Logger.getLogger(BQInputRReportResultAfterEndService.class);
	...
	public BQInputRReportResultAfterEndService() {
	}
	...
	private boolean prepareMission_new() {
		...
		String tStr = "Select * from LWMission where MissionID = '"
				+ "?mMissionID?" + "' and ActivityID = '0000000315'"
				+ " and MissionProp14 = '"
				+ "?MissionProp14?" + "'";
		LWMissionDB tLWMissionDB = new LWMissionDB();
