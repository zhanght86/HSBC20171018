...
public class RnewUWConfirmAfterEndService implements AfterEndService {
private static Logger logger = Logger.getLogger(RnewUWConfirmAfterEndService.class);
	...
	public RnewUWConfirmAfterEndService() {
	}
...
//			return false;
	...
	private boolean prepareMission() {
		...
		tStr = "Select * from LWMission where MissionID = '"
				...
				+ "'"
				+ "and ActivityID in "
				+ "(0000007001,0000007002,0000007004, 0000007005, 0000007006, 0000007007, "
