 ...
 * </p>
 * <p>
 * Description: 发核保通知书工作流AfterEnd服务类
 * </p>
 * <p>
...
private static Logger logger = Logger.getLogger(UWSendNoticeAfterEndService.class);
	...
	private boolean prepareMission() {
		...
		// tongmeng 2007-12-04 modify
		// 修改missionprop18为4(核保未回复)
		LWMissionDB tLWMissionDB = new LWMissionDB();
		LWMissionSet tLWMissionSet = new LWMissionSet();
		String tStr = "Select * from LWMission where MissionID = '"
				+ "?MissionID?" + "'" + "and ActivityID = '0000001100'";
		...
		if (tLWMissionSet == null || tLWMissionSet.size() != 1) {
			...
			CError.buildErr(this,"查询工作流保全人工核保的起始任务节点失败!");
			return false;
		}
		// tongmeng 2007-12-07 modify
		// 发送核保通知书后,返回到公共池
		...
		mReflections.transFields(tLBMissionSchema, mInitLWMissionSchema);
		...
		mInitLWMissionSchema.setMissionProp18("4");
		mInitLWMissionSchema.setMissionProp14("0000000000");
		...
		mInitLWMissionSchema.setMissionProp20(mInitLWMissionSchema
				.getDefaultOperator());
	...
	private boolean prepareOutputData() {
		...
		map.put(this.mLWLockSchema, "DELETE");
