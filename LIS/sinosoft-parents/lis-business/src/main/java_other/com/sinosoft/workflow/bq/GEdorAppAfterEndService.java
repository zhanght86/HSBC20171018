...
import com.sinosoft.lis.bq.GEdorAppBL;
 ...
 * @version 1.0
 */
public class GEdorAppAfterEndService implements AfterEndService {
private static Logger logger = Logger.getLogger(GEdorAppAfterEndService.class);
	...
	public GEdorAppAfterEndService() {
	}
