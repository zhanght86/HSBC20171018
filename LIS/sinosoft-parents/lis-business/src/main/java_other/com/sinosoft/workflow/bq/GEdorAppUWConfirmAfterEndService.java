 ...
 * </p>
 */
public class GEdorAppUWConfirmAfterEndService implements AfterEndService {
private static Logger logger = Logger.getLogger(GEdorAppUWConfirmAfterEndService.class);
	...
	public GEdorAppUWConfirmAfterEndService() {
	}
