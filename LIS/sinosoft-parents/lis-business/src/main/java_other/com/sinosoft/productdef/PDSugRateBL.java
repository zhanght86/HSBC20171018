...
public class PDSugRateBL    implements BusinessService{
...
*/
 ...
 private boolean getInputData(VData cInputData) {
 	try {
 		...
 		tList.add(mRiskCode);
 		tList.add((String)mTransferData.getValueByName("CURRENCY"));
 		tList.add((String)mTransferData.getValueByName("TYPE"));
 		tList.add((String)mTransferData.getValueByName("SIGN"));
 		tList.add((String)mTransferData.getValueByName("STARTDATE"));
		tList.add((String)mTransferData.getValueByName("ENDDATE"));
		tList.add((String)mTransferData.getValueByName("RATE"));
