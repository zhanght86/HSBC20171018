...
public class UpIndexIssueReqXmlConstants extends ParentXmlConstants {
	 ...
	 * 请求issue节点issueno属性
	 */
	public static final String XML_ISSUE_ISSUENO = "issueno";
	/**
	 * 请求报文批次号channel子节点
	 */
	...
	/**
	 * 请求报文组节点的子节点：单证节点docid属性
	 */
	public static final String XML_DOC_DOCID = "docid";
	/**
	 * 请求报文组节点的子节点：单证节点doccode属性
	 */
	public static final String XML_DOC_DOCCODE = "doccode";
	/**
	 * 请求报文组节点的子节点：单证节点groupno属性
	 */
	public static final String XML_DOC_GROUPNO = "groupno";
	/**
	...
	public static final String XML_DOC_VERSION = "docversion";
	/**
	 ...
	 * 请求报文page节点的pageid属性
	 */
	public static final String XML_PAGE_PAGEID = "pageid";
	/**
	 * 请求报文page节点的pageflag属性
	 */
	public static final String XML_PAGE_PAGEFLAG = "pageflag";
	/**
	...
	public static final String XML_SCANTYPE = "scanorder";
}