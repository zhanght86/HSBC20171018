...
public class RnewTakeBackRReportAfterEnd1Service implements AfterEndService {
private static Logger logger = Logger.getLogger(RnewTakeBackRReportAfterEnd1Service.class);
	...
	public RnewTakeBackRReportAfterEnd1Service() {
	}
...
//		map.put(this.mLBMissionSet_Insert, "INSERT");
	...
	private boolean checkData() {
		...
		tLWMissionDB.setActivityID("0000007012");
...
//		}
	...
	private boolean prepareMission() {
		...
		// 查询出同一生调通知书(原打印流水号相同者)待回收的任务节点(以及同一通知书相关的补打,打印工作节点),并回收
		boolean flag = false;
		String tStr = "Select * from LWMission where MissionID = '"
