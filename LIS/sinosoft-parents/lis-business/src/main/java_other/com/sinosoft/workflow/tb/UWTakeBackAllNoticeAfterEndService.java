...
/**
 * <p>
 * Title: 工作流节点任务:新契约人工核保回收核保通知书工作流服务类
 * </p>
 * <p>
 * Description:新契约人工核保核保通知书回收工作流AfterEnd服务类 对回收成功后工作流节点的流转进行控制
 * </p>
 * <p>
...
public class UWTakeBackAllNoticeAfterEndService implements AfterEndService {
private static Logger logger = Logger.getLogger(UWTakeBackAllNoticeAfterEndService.class);
	...
	public UWTakeBackAllNoticeAfterEndService() {
	}
	...
	private boolean checkData() {
		...
		tLWMissionDB.setActivityID("0000001300");
		...
		if (tLWMissionSet == null || tLWMissionSet.size() != 1) {
			...
			tError.moduleName = "UWTakeBackAllNoticeAfterEndService";
	...
	private boolean getInputData(VData cInputData, String cOperate) {
		...
		if (mGlobalInput == null) {
			...
			// this.mErrors.copyAllErrors( tLCContDB.mErrors );
			CError tError = new CError();
			tError.moduleName = "PRnewUWTakeBackAllNoticeAfterEndService";
	...
	private boolean prepareMission() {
		...
		tStr = "Select count(*) from LWMission where MissionID = '"
				+ "?mMissionID?"
				+ "'"
				+ "and ActivityID in ('0000001111','0000001112','0000001113','0000001106','0000001107','0000001108','0000001114','0000001115','0000001116','0000001017','0000001018','0000001019','0000001020','0000001021','0000001002','0000001280','0000001290','0000001300')";
		sqlbv.sql(tStr);
		sqlbv.put("mMissionID", mMissionID);
