...
import com.tencent.qcloud.file.FileProcess;
import com.tencent.qcloud.http.HttpSender;
import com.tencent.qcloud.http.RequestBodyKey;
import com.tencent.qcloud.http.RequestBodyValue;
import com.tencent.qcloud.http.RequestHeaderKey;
import com.tencent.qcloud.http.RequestHeaderValue;
import com.tencent.qcloud.http.ResponseBodyKey;
...
public class CosCloud {
	private static Logger logger = Logger.getLogger(CosCloud.class);
    ...
    private com.tencent.qcloud.algr.SignatureComputer signatureComputer;
    // 初始化Cos，使用默认超时时间， 30S
    public CosCloud(int appId, String secretId, String secretKey, String bucketName) {
        this(appId, secretId, secretKey, bucketName,DEFAULT_TIMEOUT_IN_SECONDS);
    }
    ...
    public CosCloud(int appId, String secretId, String secretKey, String bucketName,int timeOut) {
        ...
        this.signatureComputer = new com.tencent.qcloud.algr.SignatureComputer( String.valueOf(appId), this.secretId, this.secretKey);
    }
    ...
    public String updateFile(String bucketName, String remotePath, String bizAttribute)
        ...
        String sign = this.signatureComputer.getSignStrOnce(remotePath, bucketName);
    ...
    public String getFileStat(String bucketName, String remotePath) throws Exception {
        ...
        String sign = this.signatureComputer.getSignStr(DEFAULT_SIGN_EXPIRED_IN_SECONDS, bucketName);
    ...
    public String getFolderList(String bucketName, String remotePath, String prefix, int num,
        ...
        String sign = this.signatureComputer.getSignStr(CosCloud.DEFAULT_SIGN_EXPIRED_IN_SECONDS, bucketName);
    ...
    public String uploadFile(String bucketName, String remotePath, InputStream inputStream)
        ...
        String shaDigest = com.tencent.qcloud.algr.CheckSummer.getChecksum(fileContent);
    ...
    public String sliceUploadFileParallel(String bucketName, String remotePath, String localPath,
        ...
        if (data.has(ResponseBodyKey.Data.ACCESS_URL)) {
            ...
            if (!doneSignal.await(MAX_WAIT_TIME_PARALL_SEND_FILE, TimeUnit.SECONDS)) // 30s
            {
                ...
                logger.debug(CosCloud.class.getName() + "::sliceUploadFileParallel: " + errMsg);
    ...
    private class SliceUploadInner implements java.util.concurrent.Callable<JSONObject> {
        ...
        public JSONObject call() throws Exception {
            try {
                ...
                logger.debug(CosCloud.class.getName() + "::call: " + errMsg);
                throw e;
            } finally {
