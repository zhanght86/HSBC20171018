...
public class LLAddPremCalUI {
private static Logger logger = Logger.getLogger(LLAddPremCalUI.class);
	...
	public boolean submitData(VData cInputData, String cOperate) {
		...
		LLAddPremCalBL tLLAddPremCalBL = new LLAddPremCalBL();
		if (!tLLAddPremCalBL.submitData(mInputData, cOperate)) {
			if (tLLAddPremCalBL.mErrors.needDealError()) {
				mErrors.copyAllErrors(tLLAddPremCalBL.mErrors);
				return false;
			} else {
			...
			mResult = tLLAddPremCalBL.getResult();
			return true;
		}
