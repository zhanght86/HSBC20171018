...
/**
 * <p>Title: Web业务系统</p>
 * <p>Description: 发起呈报逻辑处理类</p>
 * <p>Copyright: Copyright (c) 2002</p>
 * <p>Company: Sinosoft</p>
 * @author: zl
 * @version 1.0
 */
public class LLGrpSubmitApplyBL
{
private static Logger logger = Logger.getLogger(LLGrpSubmitApplyBL.class);
    ...
    */
    ...
    {
        logger.debug("----------LLGrpSubmitApplyBL begin submitData----------");
        //将操作数据拷贝到本类中
        ...
        if (!getInputData())
            return false;
        logger.debug("----------LLGrpSubmitApplyBL after getInputData----------");
        ...
        logger.debug("----------LLGrpSubmitApplyBL after checkInputData----------");
        //进行业务处理
        if (!dealData(cOperate))
        {
            return false;
        }
        logger.debug("----------LLGrpSubmitApplyBL after dealData----------");
        //准备往后台的数据
        if (!prepareOutputData())
        {
            return false;
        }
        logger.debug("----------LLGrpSubmitApplyBL after prepareOutputData----------");
    ...
    private boolean getInputData()
    {
        ...
        mLLSubmitApplySchema = (LLSubmitApplySchema) mInputData.getObjectByObjectName(
            "LLSubmitApplySchema", 0);
        ...
        if (mLLSubmitApplySchema == null)
        {
            ...
            tError.moduleName = "LLGrpSubmitApplyBL";
    ...
    private boolean dealData(String cOperate)
    {
        ...
        if (cOperate.equals("INSERT"))
        {
            ...
            String updatesql="update LLSubReport set SubmitFlag='1' where SubRptNo='" +mLLSubmitApplySchema.getClmNo() +"' and CustomerNo='" +mLLSubmitApplySchema.getCustomerNo() +"'";
