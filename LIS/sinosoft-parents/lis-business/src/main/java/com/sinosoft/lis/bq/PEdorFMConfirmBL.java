...
public class PEdorFMConfirmBL implements EdorConfirm {
private static Logger logger = Logger.getLogger(PEdorFMConfirmBL.class);
	...
	private boolean prepareData() {
		...
		tLPPolSet = tLPPolDB.executeQuery(sbv1);
