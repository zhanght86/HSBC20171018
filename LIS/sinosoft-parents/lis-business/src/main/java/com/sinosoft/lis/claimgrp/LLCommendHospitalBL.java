...
private static Logger logger = Logger.getLogger(LLCommendHospitalBL.class);
    ...
    */
    ...
    private boolean getInputData(VData cInputData,String cOperate)
    {
        ...
        mLLCommendHospitalSchema = (LLCommendHospitalSchema) mInputData.getObjectByObjectName("LLCommendHospitalSchema", 0);
        return true;
    }
	...
	tLLCommendHospitalDB.setHospitalCode(mLLCommendHospitalSchema.getHospitalCode());      //用户编码

        logger.debug("---------Go To HospitalInsert()----------"+tLLCommendHospitalDB.getCount());
        //  如果推荐医院列表无数据，则添加数据
