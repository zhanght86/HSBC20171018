...
public class GEdorAppCancelUI {
private static Logger logger = Logger.getLogger(GEdorAppCancelUI.class);
	...
	public boolean submitData(VData cInputData, String cOperate) {
		...
		logger.debug("--------------------------");
		if (tGEdorAppCancelBL.submitData(cInputData, mOperate) == false) {
			// @@错误处理
	...
	public static void main(String[] args) {
		...
		tLPGrpEdorMainSchema.setEdorNo("86110020040430000258");
		...
		GEdorAppCancelUI tGEdorAppCancelUI = new GEdorAppCancelUI();
		tGEdorAppCancelUI.submitData(tVData, "DELETE||EDOR");
