...
public class InsuAccEndNoticePrintBL implements PrintService {
private static Logger logger = Logger.getLogger(InsuAccEndNoticePrintBL.class);
	...
	public InsuAccEndNoticePrintBL() {
	}
	...
	private boolean getInputData() {
		...
		if (mNoType == null || mNoType.trim().equals("")) {
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "InsuAccEndNoticePrintBL";
		...
		mEndDate = mLOPRTManagerSchema.getStandbyFlag2();
	...
	private boolean dealData() {
    	...
    	String printName = "保险合同终止通知书(万能险)";
	...
	public static void main(String[] args) {
		...
		InsuAccEndNoticePrintBL gt = new InsuAccEndNoticePrintBL();
