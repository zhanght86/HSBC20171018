 ...
 * </p>
 * 
 * @author zhaoy,2005-9-1 18:03
 * @version 1.0
 */

public class LLPRBCaseDealProcessUI {
private static Logger logger = Logger.getLogger(LLPRBCaseDealProcessUI.class);
	...
	public boolean submitData(VData cInputData, String cOperate) {
		...
		if (tLLPRBCaseDealProcessBL.submitData(cInputData, mOperate) == false) {
			// @@错误处理
			this.mErrors.copyAllErrors(tLLPRBCaseDealProcessBL.mErrors);
			...
			mResult = tLLPRBCaseDealProcessBL.getResult();
		}
		return true;
	}
