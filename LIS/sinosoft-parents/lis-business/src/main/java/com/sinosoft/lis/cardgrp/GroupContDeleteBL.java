...
private static Logger logger = Logger.getLogger(GroupContDeleteBL.class);
	...
	private boolean dealData() {
		...
		mMap.put("delete from LJAPayPerson where  GrpContNo = '" + tGrpContNo
				+ "'", "DELETE");
		mMap.put(
		...
		mMap.put("delete from LCGrpAppnt where GrpContNo = '" + tGrpContNo
				+ "'", "DELETE");
		mMap.put(
				"delete from llaccount where GrpContNo = '" + tGrpContNo + "'",
				"DELETE");
		...
		mMap.put("delete from lacommisiondetail where GrpContNo = '"
				+ tGrpContNo + "'", "DELETE");
		mMap.put("delete from lwmission where missionprop1='" + tGrpContNo
				+ "'", "DELETE");
