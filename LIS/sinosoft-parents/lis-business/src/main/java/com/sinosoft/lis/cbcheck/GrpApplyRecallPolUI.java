...
private static Logger logger = Logger.getLogger(GrpApplyRecallPolUI.class);
	...
	public static void main(String[] args) {
		...
		tLCApplyRecallPolSchema.setPrtNo("20111111111111");
		...
		if (!tGrpApplyRecallPolUI.submitData(tVData, "")) {
			logger.debug(tGrpApplyRecallPolUI.mErrors.getError(0).errorMessage);
		}
