...
private static Logger logger = Logger.getLogger(LLMAffixListBL.class);
    ...
    */
    ...
    private boolean getInputData()
    {
        ...
        mLLReportAffixSet = (LLReportAffixSet) mInputData.getObjectByObjectName(
              "LLReportAffixSet", 0);
      ...
      try
      {
        ...
        if (mLLReportAffixSet.size()>0)
        {
             for (int i = 1; i <= mLLReportAffixSet.size(); i++)
             {
                 ...
                 String strSql="delete from LLReportAffix where RptNo='"+tRptNo+"' and CustomerNo='"+tCustomerNo+"'";
        ...
        tLLReportAffixSchema.setCustomerNo(mLLReportAffixSchema.getCustomerNo());
        tLLReportAffixSchema.setAffixCode(mLLReportAffixSchema.getAffixCode());
        tLLReportAffixSchema.setAffixName(mLLReportAffixSchema.getAffixName());
        tLLReportAffixSchema.setReadyCount(mLLReportAffixSchema.getReadyCount());
        tLLReportAffixSchema.setProperty(mLLReportAffixSchema.getProperty());//单证属性标志
        tLLReportAffixSchema.setNeedFlag(mLLReportAffixSchema.getNeedFlag());//是否必需标志
        //生成AffixNo
