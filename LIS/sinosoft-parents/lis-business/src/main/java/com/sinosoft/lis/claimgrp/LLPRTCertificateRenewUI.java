...
public class LLPRTCertificateRenewUI implements BusinessService
{
private static Logger logger = Logger.getLogger(LLPRTCertificateRenewUI.class);
    ...
    public LLPRTCertificateRenewUI(){}
    ...
    public boolean submitData(VData cInputData, String cOperate)
    {
        ...
        if (tLLPRTCertificateRenewBL.submitData(cInputData, cOperate) == false)
        {
            // @@错误处理
            this.mErrors.copyAllErrors(tLLPRTCertificateRenewBL.mErrors);
        ...
        {
            mResult = tLLPRTCertificateRenewBL.getResult();
...
//
//        LLPRTCertificateRenewUI tLLPRTCertificateRenewUI = new
//                LLPRTCertificateRenewUI();
//
//        tLLPRTCertificateRenewUI.submitData(tVData, "");
    }
