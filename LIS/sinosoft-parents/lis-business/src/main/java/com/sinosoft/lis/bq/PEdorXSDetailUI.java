 ...
 * @version 1.0
 */
public class PEdorXSDetailUI implements BusinessService {
private static Logger logger = Logger.getLogger(PEdorXSDetailUI.class);
	...
	public boolean submitData(VData cInputData, String cOperate) {
		...
		PEdorXSDetailBLF tPEdorXSDetailBLF = new PEdorXSDetailBLF();
		logger.debug("---UI BEGIN---" + mOperate+tPEdorXSDetailBLF);
		if (tPEdorXSDetailBLF.submitData(cInputData, mOperate) == false) {
			// @@错误处理
			this.mErrors.copyAllErrors(tPEdorXSDetailBLF.mErrors);
			...
			mResult = tPEdorXSDetailBLF.getResult();
		return true;
	}
