...
private static Logger logger = Logger.getLogger(LCAscriptionRuleFactoryUI.class);
	...
	private LCAscriptionRuleFactorySchema mOldLCAscriptionRuleFactorySchema = new LCAscriptionRuleFactorySchema();
	...
	public static void main(String[] args) {
		...
		tLCAscriptionRuleFactorySchema.setGrpContNo("20060608000002");
		tLCAscriptionRuleFactorySchema.setGrpPolNo("120210000000533");
		tLCAscriptionRuleFactorySchema.setAscriptionRuleCode("F");
		...
		tLCAscriptionRuleFactorySchema.setParams("1,5,0.1");
		tLCAscriptionRuleFactorySet.add(tLCAscriptionRuleFactorySchema);

		tOldLCAscriptionRuleFactorySchema.setGrpContNo("20060608000002");
		tOldLCAscriptionRuleFactorySchema.setAscriptionRuleCode("D");
		tOldLCAscriptionRuleFactorySchema.setAscriptionRuleName("D");
		...
		tVData.add("20060608000002");
		tVData.add(tOldLCAscriptionRuleFactorySchema);
		// tVData.add("86110020040990000041");
		// tVData.add("A");
		// tVData.add("select * from dual");
		// tLCAscriptionRuleFactoryUI.submitData(tVData, "INSERT||MAIN");
		tLCAscriptionRuleFactoryUI.submitData(tVData, "UPDATE||MAIN");
	}
	...
	private boolean prepareOutputData() {
		try {
			...
			mInputData.add(this.mOldLCAscriptionRuleFactorySchema);
		} catch (Exception ex) {
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LCAscriptionRuleFactoryUI";
	...
	private boolean getInputData(VData cInputData) {
		...
		this.mOldLCAscriptionRuleFactorySchema
				.setSchema((LCAscriptionRuleFactorySchema) cInputData
						.getObjectByObjectName("LCAscriptionRuleFactorySchema",
								1));
