...
public class UWManuAddChkUI  implements BusinessService{
private static Logger logger = Logger.getLogger(UWManuAddChkUI.class);
	...
	public UWManuAddChkUI() {
	}

	public boolean submitData(VData cInputData, String cOperate) {
		mOperate = cOperate;
		UWManuAddChkBL tUWManuAddChkBL = new UWManuAddChkBL();

		logger.debug("---UWManuAddChkUI BEGIN---");
		if (tUWManuAddChkBL.submitData(cInputData, cOperate) == false) {
			// @@错误处理
			this.mErrors.copyAllErrors(tUWManuAddChkBL.mErrors);
