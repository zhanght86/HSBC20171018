/*
 * @(#)GrpEdorBLPrintBL.java      Jun 19, 2006
 *
 ...
 * @version：1.0
 */
public class GrpEdorBLPrintBL implements EdorPrint {
private static Logger logger = Logger.getLogger(GrpEdorBLPrintBL.class);
	// 公共数据
