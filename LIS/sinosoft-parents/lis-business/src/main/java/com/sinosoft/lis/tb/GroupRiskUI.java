...
private static Logger logger = Logger.getLogger(GroupRiskUI.class);
	...
	public static void main(String[] args) {
		...
		mLCGrpContSchema.setGrpContNo("20060706000002");
		mLCGrpContSchema.setPrtNo("20060706000002");
		mGlobalInput.ManageCom = "8621";
		mGlobalInput.Operator = "001";
		mLCGrpPolSchema.setGrpContNo("20060706000002");
		mLCGrpPolSchema.setRiskCode("00101000");
		mLCGrpPolSchema.setPayIntv("0");
		mLCGrpPolSchema.setBonusFlag("0");
		mLCGrpPolSchema.setCValiDate("2006-08-30");
		...
		if (tGroupRiskBL.submitData(tVData, "INSERT||GROUPRISK") == false) {
