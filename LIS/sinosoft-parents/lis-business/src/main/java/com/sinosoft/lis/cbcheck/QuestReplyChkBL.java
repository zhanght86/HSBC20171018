...
private static Logger logger = Logger.getLogger(QuestReplyChkBL.class);
	...
	private boolean prepareQuest() {
		...
		tLCIssuePolSchema.setReplyDate(PubFun.getCurrentDate());
		tLCIssuePolSchema.setReplyTime(PubFun.getCurrentTime());
	...
	private boolean checkQuesFlag(LCIssuePolSchema tLCIssuePolSchema) {
		...
		tsql = "select * from lcissuepol where proposalcontno = '"
				...
				+ " and ((operatepos <> '0' and backobjtype in ('2','3')) or (operatepos <> '0' and backobjtype in ('1','4')) or (operatepos = '0' and backobjtype = '3') or (operatepos = '0' and backobjtype = '2' )or (operatepos = '0' and backobjtype = '4' ))";
