...
public class LLUWAddFeeUI implements BusinessService{
private static Logger logger = Logger.getLogger(LLUWAddFeeUI.class);
	...
	public boolean submitData(VData cInputData, String cOperate) {
		...
		if (tLLUWAddFeeBL.submitData(cInputData, cOperate) == false) {
			// @@错误处理
			this.mErrors.copyAllErrors(tLLUWAddFeeBL.mErrors);
	...
	public static void main(String[] a) {
		...
		try {
			if (flag == true) {
				// 准备传输数据 VData
				LLUWAddFeeUI tUWManuAddChkUI = new LLUWAddFeeUI();
