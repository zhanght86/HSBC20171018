 ...
 */
public class RnewUWScoreRReportUI {
private static Logger logger = Logger.getLogger(RnewUWScoreRReportUI.class);
	...
	public boolean submitData(VData cInputData, String cOperate) {
		...
		RnewUWScoreRReportBL tUWScoreRReportBL = new RnewUWScoreRReportBL();
