...
public class OperationDataImport implements RIDataImport {
	...
	public String getAvailableSQL() {
		...
		strBuffer
				.append(" Risk_Amnt(a.payyears,ceil(decode(months_between('"
						+ endDate
						+ "',a.cvalidate),0,1,months_between('"
						+ endDate
						+ "',a.cvalidate))/12),a.amnt,a.InsuredAppAge,a.years,a.InsuredSex,a.prem,a.riskcode,a.payendyear,a.payendyearflag,a.insuyear,a.insuyearflag,a.payintv) as RiskAmnt, ");
		...
		strBuffer
				.append(" and exists(select 'X' from lccontstate where polno=a.polno and StateType = 'Available' and State = '0' and enddate is null) ");
		strBuffer
	...
	public static void main(String[] arg) {
		OperationDataImport tRIDataImportNBGeneral = new OperationDataImport();
