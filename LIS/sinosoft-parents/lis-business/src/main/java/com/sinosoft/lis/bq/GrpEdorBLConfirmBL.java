...
public class GrpEdorBLConfirmBL implements EdorConfirm {
private static Logger logger = Logger.getLogger(GrpEdorBLConfirmBL.class);
	// public GrpEdorBLConfirmBL() {}
	...
	public boolean submitData(VData cInputData, String cOperate) {
		// logger.debug("\t@> GrpEdorBLConfirmBL.submitData() 开始");

		// 接收参数
		if (cInputData == null) {
			CError.buildErr(this, "无法获取提交的数据, 请确认数据不为空！");
			logger.debug("\t@> GrpEdorBLConfirmBL.submitData() : 无法获取 InputData 数据！");
			return false;
		} else {
		...
		// logger.debug("\t@> GrpEdorBLConfirmBL.submitData() 成功");
		return true;
	...
	private boolean getInputData() {
		// logger.debug("\t@> GrpEdorBLConfirmBL.getInputData() 开始");
		...
		if (rGlobalInput == null) {
			...
			logger.debug("\t@> GrpEdorBLConfirmBL.getInputData() : 无法获取 GlobalInput 数据！");
			return false;
		}
		...
		if (rLPGrpEdorItemSchema == null) {
			...
			logger.debug("\t@> GrpEdorBLConfirmBL.getInputData() : 无法获取 LPGrpEdorItemSchema 数据！");
			return false;
		}
		...
		// logger.debug("\t@> GrpEdorBLConfirmBL.getInputData() 成功");
		return true;
	...
	private boolean checkData() {
		// logger.debug("\t@> GrpEdorBLConfirmBL.checkData() 开始");
		...
		// logger.debug("\t@> GrpEdorBLConfirmBL.checkData() 成功");
		return true;
	...
	private boolean dealData() {
		// logger.debug("\t@> GrpEdorBLConfirmBL.dealData() 开始");
		...
		// logger.debug("\t@> GrpEdorBLConfirmBL.dealData() 成功");
		return true;
	...
	private boolean outputData() {
		// logger.debug("\t@> GrpEdorBLConfirmBL.outputData() 开始");

		rResultData = new VData();
		rResultData.add(rMap);

		// logger.debug("\t@> GrpEdorBLConfirmBL.outputData() 成功");
		return true;
	...
	// {
	// GrpEdorBLConfirmBL tGrpEdorBLConfirmBL = new GrpEdorBLConfirmBL();
	// } //function main end
	// ==========================================================================

} // class GrpEdorBLConfirmBL end
