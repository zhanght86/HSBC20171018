...
private static Logger logger = Logger.getLogger(StringManager.class);
   ...
   public static void main (String args[]){
	   StringBuffer mResult = new StringBuffer(2560); //modified by liuqiang
	   StringManager mes = StringManager.getManager("i18n",Locale.CHINESE);
	   String str ="";
	   logger.debug(mes.getString(str));
