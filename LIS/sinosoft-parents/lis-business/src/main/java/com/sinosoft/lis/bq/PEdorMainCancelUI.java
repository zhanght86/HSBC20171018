...
public class PEdorMainCancelUI {
private static Logger logger = Logger.getLogger(PEdorMainCancelUI.class);
	...
	public boolean submitData(VData cInputData, String cOperate) {
		...
		logger.debug("--------------------------");
		if (tPEdorMainCancelBL.submitData(cInputData, mOperate) == false) {
			// @@错误处理
