// 加密算法采用这个版本 2011-06-03
// $Id: IDEA.java,v 1.4 2000/08/17 11:40:51 edwin Exp $
//
// $Log: IDEA.java,v $
...
package com.sinosoft.lis.encrypt.cipher;
...
//............................................................................
    ...
    private static final int
        ...
        BLOCK_SIZE = 8,
        KEY_LENGTH = 16;
    public static final int ENCRYPT = 1,DECRYPT = 2;
    private int state = 0;
...
//        link();
     ...
     * @throws InvalidKeyException 
     */
    public IDEA(Key k) throws InvalidKeyException {
//        super(false, false, "Cryptix");
//        link();
    	makeKey(k);
    }
...
//............................................................................
    ...
    /**
     * <b>SPI</b>: This is the main engine method for encrypt data.
     * @param  in           the input data.
     * @param  out          the output array.
     * @return the number of bytes written.
     */
    public int encrypt(byte[] in, byte[] out) {
    	this.state = ENCRYPT;
    	return engineUpdate(in,0,in.length,out,0);
    }
    /**
     * <b>SPI</b>: This is the main engine method for encrypt data.
     * @param  in           the input data.
     ...
     * @return the number of bytes written.
     */
    public int decrypt(byte[] in, byte[] out) {
    	invertKey();
    	this.state = DECRYPT;
    	return engineUpdate(in,0,in.length,out,0);
    }
    ...
    public int engineUpdate(byte[] in, int inOffset, int inLen, byte[] out, int outOffset) {
        ...
        boolean doEncrypt = (this.state == ENCRYPT);
...
//............................................................................
    ...
    throws InvalidKeyException {
        ...
        if (userkey == null)
            throw new InvalidKeyException("IDEA: Null user key");

        if (userkey.length != KEY_LENGTH)
            throw new InvalidKeyException("IDEA: Invalid user key length");
