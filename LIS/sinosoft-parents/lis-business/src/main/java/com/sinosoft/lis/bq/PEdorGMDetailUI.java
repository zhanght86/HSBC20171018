 ...
 * </p>
 * <p>
 * Description: 领取方式变更（保全项目代码：GM）功能类
 * </p>
 * <p>
 ...
 * @version 1.0
 */
public class PEdorGMDetailUI {
private static Logger logger = Logger.getLogger(PEdorGMDetailUI.class);
	...
	public boolean submitData(VData cInputData, String cOperate) {
		...
		PEdorGMDetailBLF tPEdorGMDetailBLF = new PEdorGMDetailBLF();
		if (tPEdorGMDetailBLF.submitData(cInputData, mOperate) == false) {
			// @@错误处理
			this.mErrors.copyAllErrors(tPEdorGMDetailBLF.mErrors);
			...
			mResult = tPEdorGMDetailBLF.getResult();
		}
		return true;
	}
