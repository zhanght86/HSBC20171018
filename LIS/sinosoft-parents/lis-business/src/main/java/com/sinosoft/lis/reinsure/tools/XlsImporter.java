...
import com.sinosoft.lis.reinsure.tools.importer.input.DOMBuilder;
...
public class XlsImporter {
	 ...
	 *            String[]
	 */
	public XlsImporter(String fileName, String configFileName,
			String[] sheetNames) {
	...
	private List getHeadList(String sheetName) {
		...
		try {
			...
			Document document = builder.build(new FileInputStream(
					configFileName));
