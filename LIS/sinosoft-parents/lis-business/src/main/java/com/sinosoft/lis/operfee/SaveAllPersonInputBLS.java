 ...
 * @version 1.0
 */
public class SaveAllPersonInputBLS
{
private static Logger logger = Logger.getLogger(SaveAllPersonInputBLS.class);
        ...
        throws Exception
    {
        ...
        if (!b.booleanValue())
        {
            conn.rollback();
            conn.close();
            throw new Exception(DBObject.getClass().getName() + " " + action + " Failed");
        }
    }
    ...
    {
        SaveAllPersonInputBLS SaveAllPersonInputBLS1 = new SaveAllPersonInputBLS();
    }
}
