 ...
 * </p>
 * <p>
 * Description:年金，满期金给付ConfirmBL层
 * </p>
 * <p>
...
public class PEdorAGConfirmBL implements EdorConfirm {
private static Logger logger = Logger.getLogger(PEdorAGConfirmBL.class);
	...
	private boolean exchangCPData() {
		...
		String uptPrintSql = "update loprtmanager set StateFlag = '1' where otherno ='"
				+ "?otherno?"
				+ "' and code='BQ17' and StateFlag = '0'";
		SQLwithBindVariables sbv=new SQLwithBindVariables();
		sbv.sql(uptPrintSql);
		sbv.put("otherno", mLPEdorItemSchema.getPolNo());
		map.put(sbv, "UPDATE");
	...
	public static void main(String[] args) {
		...
		boolean tag = tPEdorAGConfirmBL.submitData(tVData, "UPDATE||MAIN");
		if (tag) {
