...
public class CalClaimRetentUI {
	...
	public boolean submitData(VData cInputData, String cOperate) {
		...
		CalClaimRetentBL tCalClaimRetentBL = new CalClaimRetentBL();

		System.out.println("---UI BEGIN---");
		if (tCalClaimRetentBL.submitData(cInputData, mOperate) == false) {
			// @@错误处理
			this.mErrors.copyAllErrors(tCalClaimRetentBL.mErrors);
		...
		mResult=tCalClaimRetentBL.getResult();
		return true;
	}
