...
public class EdorInValiBillPrintBL implements BqBill {
private static Logger logger = Logger.getLogger(EdorInValiBillPrintBL.class);
	...
	public static final String VTS_NAME = "EdorInValiBill.vts";
	...
	public boolean submitData(VData cInputData, String cOperate) {
		...
		if (!mOperate.equals("PRINT")) {
			...
			tError.moduleName = "EdorInValiBillPrintBL";
	...
	private boolean preparePrintData() {
		...
		strsql = " select substr(b.managecom, 1, 6), "
				...
				+ " and d.codetype = 'contavailablereason'),"
				...
				+ " where a.contno=b.contno and b.appflag='1' and a.statetype = 'Available'"
				+ " and a.state = '1'"
				+ " and a.enddate is null" + " and a.startdate >= '"
				+ "?mStartDate?" + "'" + " and a.startdate <= '" + "?mEndDate?" + "'"
				+" and b.ManageCom like concat('"+"?mManageCom?"+"','%') "
				+ " and  exists ( select 'X' from lcpol c where c.contno = b.contno and c.polno=c.mainpolno and c.polno=a.polno)"
