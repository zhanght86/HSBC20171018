...
private static Logger logger = Logger.getLogger(LLBalAliveFeeBL.class);
	...
	private boolean getLLJSGet(LCPolSchema pLCPolSchema, String pDate) {
		...
		/**
		 * －－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－BEG No1.0 查询
		 * 在LJSGet应付总表判断是否有信息 根据保单险种号,意外事故发生日期 < LastGettoDate上次领至日期为条件进行判断
		 * －－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－
		 */
		String tSql = "";
		tSql = " select * from LJSGet where 1=1 "
				...
				+ " and PolNo = '" + "?PolNo?" + "'"
				+ " and LastGettoDate > to_date('" + "?pDate?"
				+ "','yyyy-mm-dd') )";
	...
	private boolean getLJSGetDraw(LCPolSchema pLCPolSchema, String pDate) {
		...
		/**
		 * －－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－ No1.0 查询
		 * 在LJAGetDraw给付表(生存领取_实付)判断是否有信息 根据保单险种号,意外事故发生日期 <
		 * LastGettoDate上次领至日期为条件进行判断 －－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－
		 */
		String tSql = "";
		tSql = "select * from LJSGetDraw where 1=1 " + " and PolNo = '"
				+ "?PolNo?" + "'"
	...
	private boolean getLJAGetDraw(LCPolSchema pLCPolSchema, String pDate) {
		 ...
		 * －－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－
		 */
		String tSql = "select (case when sum(LJAGetDraw.GetMoney) is null then 0 else sum(LJAGetDraw.GetMoney) end) from LJAGetDraw where 1=1 "
				+ " and PolNo = '"
				+ "?PolNo?"
				+ "'"
				+ " and LastGettoDate >= to_date('"
				+ "?pDate?"
				+ "','yyyy-mm-dd') ";
		...
		String tCal = tExeSQL.getOneValue(sqlbv2);
