...
public class NBCF1PUI implements PrintService {
private static Logger logger = Logger.getLogger(NBCF1PUI.class);
	...
	public boolean submitData(VData cInputData, String cOperate) {
		...
		NBCF1PBL tNBCF1PBL = new NBCF1PBL();
	...
	public static void main(String[] args) {
		NBCF1PUI tNBCF1PUI = new NBCF1PUI();
		...
		tNBCF1PUI.submitData(tVData, "CONFIRM");
	}
