...
/**
 * <p>Title: </p>
 * <p>Description: 理赔决定通知书--拒付[保项层面]打印</p>
 * <p>Copyright: Copyright (c) 2002</p>
 * <p>Company: </p>
 * @author zhaoy,2005-08-5
 * @version 1.0
 */

public class LLPRTProtestItemUI
{
private static Logger logger = Logger.getLogger(LLPRTProtestItemUI.class);
    ...
    public boolean submitData(VData cInputData, String cOperate)
    {
        ...
        LLPRTProtestItemBL tLLPRTProtestItemBL = new LLPRTProtestItemBL();

        if (tLLPRTProtestItemBL.submitData(cInputData, mOperate) == false)
        {
            // @@错误处理
            this.mErrors.copyAllErrors(tLLPRTProtestItemBL.mErrors);
            CError tError = new CError();
            tError.moduleName = "LLPRTProtestItemBL";
        ...
        {
            mResult = tLLPRTProtestItemBL.getResult();
        }
        return true;
    }
