...
public class NBCF1PBLS {
private static Logger logger = Logger.getLogger(NBCF1PBLS.class);
	...
	public boolean submitData(VData cInputData, String cOperate) {
		...
		logger.debug("Start NBCF1PBLS Submit...");
		...
		logger.debug("End NBCF1PBLS Submit...");
