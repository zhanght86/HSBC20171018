 ...
 * @CreateDate 2006-3-8
 */
public class GrpEdorWMConfirmBL implements EdorConfirm {
private static Logger logger = Logger.getLogger(GrpEdorWMConfirmBL.class);
	...
	private boolean dealData() {
		...
		mMap.put(tLPGrpContSchema, "UPDATE");
