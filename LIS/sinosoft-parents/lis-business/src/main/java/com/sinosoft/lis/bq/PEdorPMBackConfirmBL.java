 ...
 * @version 1.0
 */
public class PEdorPMBackConfirmBL implements EdorBack {
private static Logger logger = Logger.getLogger(PEdorPMBackConfirmBL.class);
	/** 传入数据的容器 */
	...
	private boolean dealData() {
		...
		//ljspayperson转ljapayperson后还能回退么???
		//实收缴费表隔天的销售系统提数
		//销售这边的处理方案是一正一负还是删除那笔数据
