 ...
 */
public class PEdorTICancelBL implements EdorCancel
{
private static Logger logger = Logger.getLogger(PEdorTICancelBL.class);
    ...
    private boolean dealData(){
        ...
        String[] tableForDel =
        {
        "lpinsuaccout", "lpinsuaccin","LPPerInvestPlan"
         };
