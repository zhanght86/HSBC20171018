...
public class FileImportPreParePayPersonBLS
{
private static Logger logger = Logger.getLogger(FileImportPreParePayPersonBLS.class);
  ...
  public FileImportPreParePayPersonBLS() {
  }
  ...
  public boolean submitData(VData cInputData,String cOperate)
  {
        ...
        logger.debug("Start FileImportPreParePayPersonBLS Submit...");
        if (!this.saveData())
                return false;
        logger.debug("End FileImportPreParePayPersonBLS Submit...");
            ...
            o = map.getOrder().get(String.valueOf(j+1));
                        ...
                        if (action.equals("INSERT")) {
                          ...
                          if (!b.booleanValue()) {
                                ...
                                conn.close();
                                logger.debug(DBObject.getClass().getName() + " " + action + " Failed");
                                return false;
                          }
                        }
