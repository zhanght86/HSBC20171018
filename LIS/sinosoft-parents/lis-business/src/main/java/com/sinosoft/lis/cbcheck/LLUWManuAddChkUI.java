...
public class LLUWManuAddChkUI implements BusinessService {
private static Logger logger = Logger.getLogger(LLUWManuAddChkUI.class);
	...
	public LLUWManuAddChkUI() {
	}

	public boolean submitData(VData cInputData, String cOperate) {
		mOperate = cOperate;
		LLUWManuAddChkBL tLLUWManuAddChkBL = new LLUWManuAddChkBL();

		logger.debug("---UWManuAddChkUI BEGIN---");
		if (tLLUWManuAddChkBL.submitData(cInputData, cOperate) == false) {
			// @@错误处理
			this.mErrors.copyAllErrors(tLLUWManuAddChkBL.mErrors);
