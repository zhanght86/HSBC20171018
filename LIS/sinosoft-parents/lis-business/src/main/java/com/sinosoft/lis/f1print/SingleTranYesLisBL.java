...
public class SingleTranYesLisBL {
private static Logger logger = Logger.getLogger(SingleTranYesLisBL.class);
	...
	private void buildError(String szFunc, String szErrMsg) {
		...
		cError.moduleName = "SingleTranYesLisBL";
	...
	private boolean getPrintData() {
		...
		if (this.mListType == null || this.mListType == "") {
			...
			xmlexport.createDocument("SingleTranYesRLis.vts", "printer"); // appoint
																			// to a
																			// special
																			// output
																			// .vts
			...
			xmlexport.createDocument("SingleTranYesPLis.vts", "printer");
		}
	...
	public static void main(String[] args) {
		...
		SingleTranYesLisUI tSingleTranYesLisUI = new SingleTranYesLisUI();
		tSingleTranYesLisUI.submitData(tVData, "PRINT");
	}
}
