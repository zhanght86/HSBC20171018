...
public class FirstPayF1PBLS_MS {
private static Logger logger = Logger.getLogger(FirstPayF1PBLS_MS.class);
	...
	public boolean submitData(VData cInputData, String cOperate) {
		...
		logger.debug("Start FirstPayF1PBLS Submit...");
		...
		logger.debug("End FirstPayF1PBLS Submit...");
