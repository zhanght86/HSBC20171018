...
public class FacuAudit_Limited_Sucess_IBW30_010070 implements FacuAudit {
	...
	private boolean dealData() {
		...
		String tSql = "select currency,salechnl from lcpol where Contno = '"
		...
		if (!("01".equals(infoSSRS.getAllData()[0][0]) && "03".equals(infoSSRS
				.getAllData()[0][1]))) {
			uwFlag = true;
			return true;
		}
