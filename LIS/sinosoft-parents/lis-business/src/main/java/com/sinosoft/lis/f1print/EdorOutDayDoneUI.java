...
public class EdorOutDayDoneUI {
private static Logger logger = Logger.getLogger(EdorOutDayDoneUI.class);
...
public CErrors getErrors() {
  ...
  public static void main(String[] args) {
	  EdorOutDayDoneUI LAAgentTempfeePolUI1 = new EdorOutDayDoneUI();
  }
}
