 ...
 * @version 1.0
 */
public class LLBnfRepealBL implements BusinessService{
private static Logger logger = Logger.getLogger(LLBnfRepealBL.class);
...
//				" and InsuredNo='"+mCustomerNo+ "' and bnfkind='"+mBnfKind+"'";
//			map.put(deleteSql1, "DELETE");
//				
//			// 删除赔付应付表
//			String deleteSql4 = " delete from LJSGetClaim where "
//								+ "  getnoticeno in(select getnoticeno from ljsget where otherno = '" + mClmNo + "'" + " and othernotype='5' and InsuredNo='"+mCustomerNo+"')";
//			map.put(deleteSql4, "DELETE");		
//						
//			String deleteSql2="delete from Ljsget where otherno='"+mClmNo+"'" +
//				" and InsuredNo='"+mCustomerNo+"' and othernotype='5'";
//			map.put(deleteSql2, "DELETE");

			// 删除受益人分配表
			String deleteSql3 = " delete from LLBnf where " + " ClmNo = '"
						+ "?ClmNo?" + "'" + "  and bnfkind='"+"?bnfkind?"+"'"+ " and InsuredNo = '" + "?InsuredNo?" + "'";
			SQLwithBindVariables sqlbv = new SQLwithBindVariables();
			sqlbv.sql(deleteSql3);
			sqlbv.put("ClmNo", mClmNo);
			sqlbv.put("bnfkind", mBnfKind);
			sqlbv.put("InsuredNo", mCustomerNo);
