...
import com.sinosoft.lis.claimgrp.LLMedicalFeeInp1BL;
 ...
 * @version 1.0
 */
public class LLMedicalFeeInp1UI implements BusinessService
{
private static Logger logger = Logger.getLogger(LLMedicalFeeInp1UI.class);
    ...
    public boolean submitData(VData cInputData, String cOperate)
    {
        ...
        LLMedicalFeeInp1BL tLLMedicalFeeInp1BL = new LLMedicalFeeInp1BL();

        logger.debug("----------LLMedicalFeeInp1UI Begin----------");
        if (tLLMedicalFeeInp1BL.submitData(mInputData, mOperate) == false)
        {
            // @@错误处理
            this.mErrors.copyAllErrors(tLLMedicalFeeInp1BL.mErrors);
            CError tError = new CError();
            tError.moduleName = "LLMedicalFeeInp1BLUI";
        ...
        {
            mResult = tLLMedicalFeeInp1BL.getResult();
        }
        logger.debug("----------LLMedicalFeeInp1UI End----------");
