 ...
 * 
 * @author：lizhuo
 * @CreateDate: Jun 19, 2006
 * @version：1.0
 */
public class GrpEdorBDPrintBL implements EdorPrint {
private static Logger logger = Logger.getLogger(GrpEdorBDPrintBL.class);
	// 公共数据
