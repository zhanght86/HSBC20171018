...
public class BQInsuredUWUI {
private static Logger logger = Logger.getLogger(BQInsuredUWUI.class);
	/** 传入数据的容器 */
	...
	public boolean submitData(VData cInputData, String cOperate) {
		...
		BQInsuredUWBL tLCInsuredUWBL = new BQInsuredUWBL();
	...
	public static void main(String[] args) {
		...
		if (!tBQInsuredUWUI.submitData(tVData, "submit")) {

			int n = tBQInsuredUWUI.mErrors.getErrorCount();
			Content = " 核保特约失败，原因是: "
					+ tBQInsuredUWUI.mErrors.getError(0).errorMessage;
			FlagStr = "Fail";
		}
