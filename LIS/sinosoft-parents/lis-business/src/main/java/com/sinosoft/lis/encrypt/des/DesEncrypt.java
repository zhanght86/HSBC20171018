package com.sinosoft.lis.encrypt.des;
...
//		  tDesEncrypt.makeDesKey();
	        String key1 = "26D5BF5B07FB0E8C";
	        String key2 = "409D3B100EA2F246";
	        String key3 = "FEFBC8073798ECF1";
	        String data = "001";
	        String str = tDesEncrypt.strEnc(data, key1, key2, key3);
	        logger.debug(str+" : "+str.length()+" : "+LisEncrypt.encryptMD5(str)+ " : " + LisEncrypt.encryptMD5(str).length());
//	        
//	        String dec = tDesEncrypt.strDec(str, key1, key2, key3);
	        logger.debug( tDesEncrypt.makeDesKey());
		 // logger.debug(tDesEncrypt.makeDesKey());
	    }
	  
	  private final static String key1 = "26D5BF5B07FB0E8C";
	  private final static String key2 = "409D3B100EA2F246";
	  private final static String key3 = "FEFBC8073798ECF1";
	  
	  public String strEnc(String data)
	  {
		  String firstKey = this.key1;
		  String secondKey = this.key2;
		  String thirdKey = this.key3;
		  return this.strEnc(data, firstKey, secondKey, thirdKey);
	  }
	  ...
	  public String strDec(String data)
	  {
		  ...
		  String secondKey = this.key2;
		  String thirdKey = this.key3;
		  return this.strDec(data, firstKey, secondKey, thirdKey);
	  }
	    ...
	    public static String makeDesKey() {
	    	...
	    	try {
	    		   ...
	    		   tfinalKey = byte2hex(rawKeyData);
	    		 //  logger.debug(byte2hex(rawKeyData));
