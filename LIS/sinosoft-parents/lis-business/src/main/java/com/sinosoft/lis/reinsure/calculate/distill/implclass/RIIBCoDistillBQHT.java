 ...
 * @version 1.0
 */
public class RIIBCoDistillBQHT implements RIDistill {
	String mEventType;
	...
	private String getDistillSQL() {
		...
		strBuffer
				.append(" a.PolNo||','|| d.Dutycode ||','||b.edorno||','||b.edortype||','||'"
						+ mAccumulateDefNo + "'||','||'GBBQHT' as UnionKey, ");// 联合主键
		...
		strBuffer.append(" d.getdate as GetRate, ");
		...
		strBuffer.append("and a.contno = b.contno  and a.polno = c.polno ");
		strBuffer
				.append("and a.polno = d.polno  and c.Dutycode = d.Dutycode ");
		// strBuffer.append("and (c.StandPrem-d.GetMoney)<>0 ");
		strBuffer
		...
		// 增额，减额，部分退保
		// strBuffer.append(" and a.contno = c.Contno and b.edortype  not in('CF','CT','ES','SX')  and b.edorstate='0'");
		strBuffer.append(" and b.edorstate='0' and  b.Edortype = 'BR' ");
		// 不临分
		strBuffer
		...
		strBuffer.append(") ");
		System.out.println("共保回退提数sql: " + strBuffer.toString());
	...
	private String getDistillSQL1() {
		...
		strBuffer.append("where a.ContType='1' ");
		strBuffer.append("and a.contno = b.contno  and a.polno = c.polno ");
		strBuffer.append("and a.polno = d.polno  and c.Dutycode = d.Dutycode ");
		// strBuffer.append("and (c.StandPrem-d.GetMoney)<>0 ");
		strBuffer
				.append(" and exists(select 'X' from RIAccumulateRDCode r where a.riskcode = r.associatedcode  and r.accumulatedefno='"
						+ mAccumulateDefNo + "') ");
		...
		strBuffer.append(" and a.Currency='01'");
		strBuffer.append(") ");
		System.out.println("共保回退临分提数sql: " + strBuffer.toString());
		return strBuffer.toString();
	}
	...
	public static void main(String[] args) {
		...
		RIIBCoDistillBQHT tRIDistillRN = new RIIBCoDistillBQHT();
