 ...
 * @version 1.0
 */
public class LLPerClaimRegisterBLF
{
private static Logger logger = Logger.getLogger(LLPerClaimRegisterBLF.class);
    ...
    public boolean submitData(VData cInputData,String cOperate)
    {
       ...
       logger.debug("----------mOperate======"+mOperate);
        ...
        logger.debug("----------LLPerClaimRegisterBLF after getInputData----------");
        //检查数据合法性
        if (!checkInputData())
        {
            return false;
        }
        logger.debug("----------LLPerClaimRegisterBLF after checkInputData----------");
        //进行业务处理,得到业务处理返回值
        if (!dealData())
        {
            return false;
        }
        logger.debug("----------LLPerClaimRegisterBLF after dealData----------");
        //准备往后台的数据
        if (!prepareOutputData())
        {
            return false;
        }
        logger.debug("----------LLPerClaimRegisterBLF after prepareOutputData----------");
        ...
        if (!tPubSubmit.submitData(mInputData, ""))
        {
            ...
            tError.moduleName = "LLPerClaimRegisterBLF";
    ...
    {
        logger.debug("----------LLPerClaimRegisterBLF dealData BEGIN----------");
        ...
        {
            logger.debug("-----start LLPerClaimRegisterBLF getData from BL");
            VData tempVData = new VData();
            tempVData = tLLPerClaimRegisterBL.getResult();
