...
public class BQOperatorNoticeF1PUI implements BusinessService{
private static Logger logger = Logger.getLogger(BQOperatorNoticeF1PUI.class);
	...
	public boolean submitData(VData cInputData, String cOperate) {
		...
		BQOperatorNoticeF1PBL tBQOperatorNoticeF1PBL = new BQOperatorNoticeF1PBL();
		logger.debug("Start OperatorNoticeF1PUI Submit ...");

		if (!tBQOperatorNoticeF1PBL.submitData(vData, cOperate)) {
			if (tBQOperatorNoticeF1PBL.mErrors.needDealError()) {
				mErrors.copyAllErrors(tBQOperatorNoticeF1PBL.mErrors);
				return false;
			} else {
			...
			mResult = tBQOperatorNoticeF1PBL.getResult();
			return true;
		}
	}
