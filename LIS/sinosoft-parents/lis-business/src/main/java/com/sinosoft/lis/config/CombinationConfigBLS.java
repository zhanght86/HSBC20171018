...
public class CombinationConfigBLS {
private static Logger logger = Logger.getLogger(CombinationConfigBLS.class);
	...
	private boolean saveLDPlan(VData mInputData) {
		...
		try {
			...
			tLDPlanDBSet.set((LDPlanSet) mInputData.getObjectByObjectName(
					"LDPlanSet", 0));

			LDPlanDB tLDPlanDB = new LDPlanDB(conn);
			tLDPlanDB.setContPlanCode(tLDPlanDBSet.get(1).getContPlanCode());
			...
			LDPlanRiskDBSet tLDPlanRiskDBSet = new LDPlanRiskDBSet(conn);
			tLDPlanRiskDBSet.set((LDPlanRiskSet) mInputData
					.getObjectByObjectName("LDPlanRiskSet", 0));
			...
			LDPlanDutyParamDBSet tLDPlanDutyParamDBSet = new LDPlanDutyParamDBSet(
					conn);
