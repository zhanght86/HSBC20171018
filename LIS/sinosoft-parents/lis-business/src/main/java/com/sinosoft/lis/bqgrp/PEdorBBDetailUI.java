 ...
 * @version 1.0
 */
public class PEdorBBDetailUI implements BusinessService
{
private static Logger logger = Logger.getLogger(PEdorBBDetailUI.class);
  ...
  */
  ...
  LPInsuredSchema tLPInsuredSchema=new LPInsuredSchema();
    ...
    logger.debug("---123---transact:"+transact);
    GlobalInput tG = new GlobalInput();
    logger.debug("------------------begin ui");
    tG.ManageCom="0101";
    tG.Operator="001";
    tLPEdorItemDB.setEdorAcceptNo("6120050913000005");
    tLPEdorItemDB.setEdorNo("6020050917000005");
    tLPEdorItemDB.setInsuredNo("0000535290");
    tLPEdorItemDB.setPolNo("000000");
    tLPEdorItemDB.setGrpContNo("240110000000255");

    tLPEdorItemDB.setEdorType("BB");
    tLPEdorItemDB.setContNo("2301190000000481");
    tLPEdorItemDB.getInfo();


            //团体客户信息  LPGrp
            tLPPersonSchema.setEdorNo("6020050917000005");
            tLPPersonSchema.setEdorType("BB");
            tLPPersonSchema.setCustomerNo("0000008850");            //客户号码
            ...
            //客户地址  LCGrpAddress
            tLPAddressSchema.setEdorNo("6020050917000005");
            tLPAddressSchema.setEdorType("BB");
            tLPAddressSchema.setCustomerNo("0000535290");            //客户号码
            tLPAddressSchema.setAddressNo("1");      //地址号码
            ...
            //个单合同
            tLPContSchema.setEdorNo("6020050917000005");
            tLPContSchema.setGrpContNo("240110000000255");
            tLPContSchema.setEdorType("BB");
            tLPContSchema.setInsuredIDType("0");
            tLPContSchema.setInsuredIDNo("4101");

            //被保人
            tLPInsuredSchema.setEdorNo("6020050917000005");
            tLPInsuredSchema.setEdorType("BB");
            tLPInsuredSchema.setGrpContNo("240110000000255");
            tLPInsuredSchema.setContNo("2301190000000481");

            tLPInsuredSchema.setInsuredNo("0000535290");
