...
public class PersonPayPlanCancelBLS
{
private static Logger logger = Logger.getLogger(PersonPayPlanCancelBLS.class);
    ...
    {
        PersonPayPlanCancelBLS AutoConfirmBLS1 = new PersonPayPlanCancelBLS();
    }
}
