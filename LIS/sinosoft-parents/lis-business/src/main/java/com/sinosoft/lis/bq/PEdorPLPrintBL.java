...
public class PEdorPLPrintBL implements EdorPrint {
	private static Logger logger = Logger.getLogger(PEdorPLPrintBL.class);
	...
	private boolean dealData() {
		...
		// add by jiaqiangli 2008-08-14
		// 判断是挂失还是解挂 edortype = 'PL' 挂失与解挂
		// 根据LPEdorItem中EdorReasonCode是否为空来判断挂失还是解挂
		logger.debug("EdorReasonCode" + mLPEdorItemSchema.getEdorReasonCode());
		...
		if (mLPEdorItemSchema.getStandbyFlag1() != null
			...
			// 解挂
			xmlexport.addDisplayControl("displayPF");
		}
	...
	private boolean prepareData() {
		...
		logger.debug("tag.size" + mTextTag.size());
