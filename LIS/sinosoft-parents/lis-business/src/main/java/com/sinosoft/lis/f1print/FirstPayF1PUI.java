...
public class FirstPayF1PUI implements PrintService {
private static Logger logger = Logger.getLogger(FirstPayF1PUI.class);
	...
	public boolean submitData(VData cInputData, String cOperate) {
		...
		FirstPayF1PBL tFirstPayF1PBL = new FirstPayF1PBL();
	...
	public static void main(String[] args) {
		...
		tLOPRTManagerSchema.setPrtSeq("810000000000360");
		tLOPRTManagerSchema.setOtherNo("130110000013377");
