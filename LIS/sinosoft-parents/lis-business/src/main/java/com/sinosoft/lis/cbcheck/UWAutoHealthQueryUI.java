...
private static Logger logger = Logger.getLogger(UWAutoHealthQueryUI.class);
	...
	public static void main(String[] args) {
		...
		p.setContNo("86210000000000");
		p.setPolNo("110110000000178");
		p.setInsuredNo("9000000523");

		LCPolSet tLCPolSet = new LCPolSet();
		tLCPolSet.add(p);
		TransferData mTransferData = new TransferData();
		mTransferData.setNameAndValue("ContNo", "86210000000000");
		mTransferData.setNameAndValue("InsuredNo", "9000000523");
		//
