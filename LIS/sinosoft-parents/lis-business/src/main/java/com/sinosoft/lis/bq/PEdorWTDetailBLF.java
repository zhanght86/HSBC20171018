 ...
 * </p>
 * <p>
 * Description: 保全- 保单犹豫期退保变更明细保存提交类
 * </p>
 * <p>
 ...
 */
public class PEdorWTDetailBLF implements EdorDetail {
private static Logger logger = Logger.getLogger(PEdorWTDetailBLF.class);
	...
	private boolean dealData() {
		...
		if (!tPEdorWTDetailBL.submitData(mInputData, mOperate)) {
			mErrors.copyAllErrors(tPEdorWTDetailBL.mErrors);
			return false;
		}
