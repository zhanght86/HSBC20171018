...
public class BonusRateBL implements BusinessService{
private static Logger logger = Logger.getLogger(BonusRateBL.class);
	...
	public boolean submitData(VData cInputData, String cOperate) {
		...
		if (!dealData()) {
			...
			tError.moduleName = "BonusRateBL";
			tError.functionName = "submitData";
			tError.errorMessage = "数据处理失败BonusRateBL-->dealData!";
	...
	private boolean dealData() {
		...
		if (mLOBonusMainSchema != null) {
			...
			if ("update".equals(mOperate)) {
				tLOBonusMainDB.setFiscalYear(mLOBonusMainSchema.getFiscalYear());
				...
				if (tLOBonusMainSet.size() < 1) {
					...
					tLOBonusMainSchema.setBonusCoefSum(mLOBonusMainSchema.getBonusCoefSum());
					tLOBonusMainSchema.setFiscalYear(mLOBonusMainSchema.getFiscalYear());
					tLOBonusMainSchema.setDistributeRate(mLOBonusMainSchema.getDistributeRate());
					tLOBonusMainSchema.setDistributeValue(mLOBonusMainSchema.getDistributeValue());
