...
public class GrpClaimVTSForThree
{
private static Logger logger = Logger.getLogger(GrpClaimVTSForThree.class);
    ...
    // excel文件的sheet数量
    private static int SHEET_COUNT = 3;
    ...
    private int SHEET_LLCLAIMDETAIL = 2;
    private int STRID_COL_LLCLAIMDETAIL = 1;
    ...
    private void genPart(String strFileName) throws Exception
    {
        ...
        ele = new Element("LLCLAIMDETAILTABLE");
        root.addContent(ele);
        genXMLPart(ele, this.SHEET_LLCLAIMDETAIL);
...
//            }
                            ...
                            String szErrMsg)
    {
        ...
        cError.moduleName = "GrpClaimVTSForThree";
