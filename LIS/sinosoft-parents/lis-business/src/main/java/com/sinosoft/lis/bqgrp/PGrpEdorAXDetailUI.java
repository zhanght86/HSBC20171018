 ...
 * @version 1.0
 */
public class PGrpEdorAXDetailUI implements BusinessService{
private static Logger logger = Logger.getLogger(PGrpEdorAXDetailUI.class);
  ...
  public boolean submitData(VData cInputData, String cOperate)	{
    ...
    PGrpEdorAXDetailBL tPGrpEdorAXDetailBL = new PGrpEdorAXDetailBL();

    if(tPGrpEdorAXDetailBL.submitData(cInputData, cOperate) == false)	{
      // @@错误处理
      this.mErrors.copyAllErrors(tPGrpEdorAXDetailBL.mErrors);
      mResult.clear();
      mResult.add(mErrors.getFirstError());
      return false;
    }	else {
      mResult = tPGrpEdorAXDetailBL.getResult();
    }
  ...
  public static void main(String[] args) {
    ...
    PGrpEdorAXDetailUI tPGrpEdorXTDetailUI = new PGrpEdorAXDetailUI();
