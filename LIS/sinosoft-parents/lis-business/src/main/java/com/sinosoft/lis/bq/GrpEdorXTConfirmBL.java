...
public class GrpEdorXTConfirmBL implements EdorConfirm {
private static Logger logger = Logger.getLogger(GrpEdorXTConfirmBL.class);
	// public GrpEdorXTConfirmBL() {}
	...
	public boolean submitData(VData cInputData, String cOperate) {
		// logger.debug("\t@> GrpEdorXTConfirmBL.submitData() 开始");

		// 接收参数
		if (cInputData == null) {
			CError.buildErr(this, "无法获取提交的数据, 请确认数据不为空！");
			logger.debug("\t@> GrpEdorXTConfirmBL.submitData() : 无法获取 InputData 数据！");
			return false;
		} else {
		...
		// logger.debug("\t@> GrpEdorXTConfirmBL.submitData() 成功");
		return true;
	...
	private boolean dealData() {
		// logger.debug("\t@> GrpEdorXTConfirmBL.dealData() 开始");
		...
		if (!tGrpEdorCTConfirmBL.submitData(rInputData, rOperation)) {
			...
			logger.debug("\t@> GrpEdorXTDetailBL.dealData() : GrpEdorCTConfirmBL.submitData() 失败！");
			return false;
		}
		...
		// logger.debug("\t@> GrpEdorXTConfirmBL.dealData() 成功");
		return true;
	...
	// {
	// GrpEdorXTConfirmBL tGrpEdorXTConfirmBL = new GrpEdorXTConfirmBL();
	// } //function main end
	// ==========================================================================

} // class GrpEdorXTConfirmBL end
