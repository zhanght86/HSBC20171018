 ...
 * @version 1.0
 */
public class RINewDistillFX implements RIDistill {
	String mEventType;
	...
	private String getUnSQL() {
		...
		strBuffer
				.append(" a.PolNo||','|| d.Dutycode ||','||b.edorno||','||b.edortype||','||'"
						+ mAccumulateDefNo + "'||','||'BQ' as UnionKey, ");
		...
		System.out.println("复效提数公共部分sql: " + strBuffer.toString());
	...
	private String getSpecSQL() {
		...
		strBuffer.append(" from lcpol a ,lpedoritem b,Lcduty d,Lpduty e");
		System.out.println("复效临分提数公共部分sql: " + strBuffer.toString());
		return strBuffer.toString();
	}
	...
	private boolean dealData() {
		try {
			...
			buildError("dealData", " 提取复效业务数据失败 " + ex.getMessage());
			return false;
		}
		return true;
	}
...
//		strBuffer.append(" and ((d.Amnt - e.Amnt) <> 0 or (b.Edortype='AB' and a.Mainpolno!=a.Polno))");
		strBuffer
				.append(" and e.Edorno =(select f.edorconfno from lpedorapp f where f.edoracceptno = b.edoracceptno)");
		strBuffer.append(" and b.edortype in('RE') ");
		strBuffer
				.append(" and a.Polno=d.Polno and a.contno = e.Contno  and b.edorstate='0' ");
		strBuffer.append("and a.Polno=e.Polno and d.Dutycode=e.Dutycode");
		strBuffer
		...
		strBuffer.append(") ");
		System.out.println("复效提数sql: " + strBuffer.toString());
		return strBuffer.toString();
	}
...
//		strBuffer.append(" and ((d.Amnt - e.Amnt) <> 0 or (b.Edortype='AB' and a.Mainpolno!=a.Polno))");
		...
		strBuffer
				.append(" and  a.Polno=d.Polno and a.contno = e.Contno and b.edortype in('RE')  and b.edorstate='0'");
		strBuffer.append("and a.Polno=e.Polno and d.Dutycode=e.Dutycode");
		strBuffer
				.append(" and e.Edorno =(select f.edorconfno from lpedorapp f where f.edoracceptno = b.edoracceptno)");
		strBuffer
				.append(" and exists(select 'X' from Lpedorapp x where x.Edoracceptno=b.Edoracceptno and x.Confdate between '"
						...
						+ mRIWFLogSchema.getEndDate() + "')");
		strBuffer.append(") ");
		System.out.println("复效临分提数sql: " + strBuffer.toString());
		return strBuffer.toString();
	}
...
//		strBuffer.append(" and ((d.Amnt - e.Amnt) <> 0 or (b.Edortype='AB' and a.Mainpolno!=a.Polno))");
		...
		// LN:保单贷款
		// MO 变更频次 ES协议退保 AB附加 RE 复效 IS 增额 RS减额
		strBuffer.append(" and  a.Polno=d.Polno  and a.contno = e.Contno and b.edortype in('RE')  and b.edorstate='0'");
		strBuffer.append("and a.Polno=e.Polno and d.Dutycode=e.Dutycode");
		strBuffer
				.append(" and e.Edorno =(select f.edorconfno from lpedorapp f where f.edoracceptno = b.edoracceptno)");
		strBuffer
	...
	public static void main(String[] args) {
		...
		mRIWFLogSchema.setBatchNo("x00001");
		mRIWFLogSchema.setStartDate("2012-1-1");
		mRIWFLogSchema.setEndDate("2013-11-9");
		mRIWFLogSchema.setTaskCode("L01010010010");
		cInputData.add(mRIWFLogSchema);
		RINewDistillFX tRIDistillBQ = new RINewDistillFX();
