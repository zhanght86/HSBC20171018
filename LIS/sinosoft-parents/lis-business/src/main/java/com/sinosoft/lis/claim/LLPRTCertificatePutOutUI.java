...
public class LLPRTCertificatePutOutUI implements BusinessService{
private static Logger logger = Logger.getLogger(LLPRTCertificatePutOutUI.class);
	...
	public LLPRTCertificatePutOutUI() {
	}
	...
	public boolean submitData(VData cInputData, String cOperate) {
		...
		if (tLLPRTCertificatePutOutBL.submitData(cInputData, cOperate) == false) {
			// @@错误处理
			this.mErrors.copyAllErrors(tLLPRTCertificatePutOutBL.mErrors);
			...
			mResult = tLLPRTCertificatePutOutBL.getResult();
		}
		return true;
	}
	...
	public static void main(String[] args) {
		...
		// tTransferData.setNameAndValue("ClmNo","90000001256");
		...
		//
		// LLPRTCertificatePutOutUI tLLPRTCertificatePutOutUI = new
		// LLPRTCertificatePutOutUI();
		//
		// tLLPRTCertificatePutOutUI.submitData(tVData, "");
	}
