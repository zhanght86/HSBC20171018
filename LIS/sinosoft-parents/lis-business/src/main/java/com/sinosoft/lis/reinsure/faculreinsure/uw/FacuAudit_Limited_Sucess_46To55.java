...
public class FacuAudit_Limited_Sucess_46To55 implements FacuAudit {
	...
	private boolean dealData() {
		...
		if (Double.parseDouble(ageSSRS.getAllData()[0][0]) < 46
				|| Double.parseDouble(ageSSRS.getAllData()[0][0]) > 55) {
			uwFlag = true;
			return true;
		}
