 ...
 * @version 1.0
 */
public class GrpEdorICAppConfirmBL implements EdorAppConfirm {
private static Logger logger = Logger.getLogger(GrpEdorICAppConfirmBL.class);
	...
	private boolean dealData() {
		try {
			...
			tError.moduleName = "GrpEdorICAppConfirmBL";
