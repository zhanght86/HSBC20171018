...
public class FIRuleDefBL
{
private static Logger logger = Logger.getLogger(FIRuleDefBL.class);
	...
	public boolean submitData(VData cInputData, String cOperate)
	{
		...
		if (!dealData(cOperate))
		{
			...
			tError.moduleName = "FIRuleDefBL";
			tError.functionName = "submitData";
			tError.errorMessage = "数据处理失败 FIRuleDefBL-->dealData!";
		...
		{
			logger.debug("Start FIRuleDefBL Submit...");
            ...
            mmResult = "Succ";
			logger.debug("End FIRuleDefBL Submit...");
		}
		mInputData = null;
		return true;
	}
	...
	private boolean dealData(String cOperate)
	{
		...
		{
			map.put(mFIRuleDefSchema,"INSERT");
			tReturn = true;
		}
		if(mOperate.equals("UPDATE||MAIN"))
		{
			map.put(mFIRuleDefSchema,"UPDATE");
			tReturn = true;
		}
		if(mOperate.equals("DELETE||MAIN"))
		{
			map.put(mFIRuleDefSchema,"DELETE");
			tReturn = true;
		}
		return tReturn;
	}
