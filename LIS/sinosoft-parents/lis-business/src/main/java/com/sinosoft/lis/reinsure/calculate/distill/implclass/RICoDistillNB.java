 ...
 * @version 1.0
 */
public class RICoDistillNB implements RIDistill {
	String mEventType;
	...
	private String getDistillSQL() {
		...
		strBuffer.append("' ) ");
		System.out.println("共保新契约提数sql: " + strBuffer.toString());
	...
	private String getDistillSQL1() {
		...
		strBuffer.append(mRIWFLogSchema.getEndDate());
		strBuffer.append("' ) ");
		System.out.println("共保新契约临分提数sql: " + strBuffer.toString());
		return strBuffer.toString();
	}
	...
	public static void main(String[] args) {
		...
		RICoDistillNB tRIDistillNB = new RICoDistillNB();
