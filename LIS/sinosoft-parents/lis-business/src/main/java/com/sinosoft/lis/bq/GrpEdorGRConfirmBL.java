 ...
 * @version 1.0
 */
public class GrpEdorGRConfirmBL implements EdorConfirm {
private static Logger logger = Logger.getLogger(GrpEdorGRConfirmBL.class);
	...
	public GrpEdorGRConfirmBL() {
	}

	public boolean submitData(VData cInputData, String cOperate) {
		logger.debug("--==  Grp GR Confirm  ==--");
	...
	private boolean dealData() {
		...
		// String delSql;
		// //清除旧P表
		// delSql = " delete from lpgrpcont where "
		// + " edorno = '" + mLPGrpEdorItemSchema.getEdorNo() +
		// "'"
		// + " and edortype = '" +
		...
		//
		// //清除旧C表
		// delSql = " delete from lcgrpcont where "
		// + " grpcontno = '" +
		// mLPGrpEdorItemSchema.getGrpContNo() + "' ";
		// mMap.put(delSql, "DELETE");
		//
		...
		// mMap.put(newLPGrpContSchema, "INSERT");
		//
		...
		// mMap.put(newLCGrpContSchema, "INSERT");
		...
		newLPGrpContSchema.setModifyDate(CurrDate);
		newLPGrpContSchema.setModifyTime(CurrTime);
		newLPGrpContSchema.setLostTimes(tLCGrpContSchema.getLostTimes());
		newLPGrpContSchema.setPrintCount(tLCGrpContSchema.getPrintCount());
