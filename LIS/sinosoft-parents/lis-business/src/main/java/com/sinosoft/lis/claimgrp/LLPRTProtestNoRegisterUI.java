...
public class LLPRTProtestNoRegisterUI implements BusinessService
{
private static Logger logger = Logger.getLogger(LLPRTProtestNoRegisterUI.class);
    ...
    public LLPRTProtestNoRegisterUI(){}
    ...
    public boolean submitData(VData cInputData, String cOperate)
    {
        ...
        LLPRTProtestNoRegisterBL tLLPRTProtestNoRegisterBL = new LLPRTProtestNoRegisterBL();

        if (tLLPRTProtestNoRegisterBL.submitData(cInputData, cOperate) == false)
        {
            // @@错误处理
            this.mErrors.copyAllErrors(tLLPRTProtestNoRegisterBL.mErrors);
        ...
        {
            mResult = tLLPRTProtestNoRegisterBL.getResult();
        }
        return true;
    }
...
//        tTransferData.setNameAndValue("ClmNo","90000006210");
//        tTransferData.setNameAndValue("CustNo","0000522610");
//        VData tVData = new VData();
//        tVData.add(tTransferData);
//
//        LLPRTProtestNoRegisterUI tLLPRTProtestNoRegisterUI = new
//                LLPRTProtestNoRegisterUI();
//
//        tLLPRTProtestNoRegisterUI.submitData(tVData, "");
    }
