...
private static Logger logger = Logger.getLogger(LLInqApplyUI.class);
	...
	public boolean submitData(VData cInputData, String cOperate) {
		...
		LLInqApplyBLF tLLInqApplyBLF = new LLInqApplyBLF();
		logger.debug("----------UI BEGIN----------");
		if (!tLLInqApplyBLF.submitData(mInputData, mOperate)) {

			// @@错误处理
			this.mErrors.copyAllErrors(tLLInqApplyBLF.mErrors);
			...
			mResult = tLLInqApplyBLF.getmResult();
		}
		mInputData = null;
		return true;
	}
