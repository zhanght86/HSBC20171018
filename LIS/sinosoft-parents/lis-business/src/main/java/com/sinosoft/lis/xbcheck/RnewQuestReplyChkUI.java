 ...
 * @version 1.0
 */
public class RnewQuestReplyChkUI {
private static Logger logger = Logger.getLogger(RnewQuestReplyChkUI.class);
	...
	public boolean submitData(VData cInputData, String cOperate) {
		...
		RnewQuestReplyChkBL tBQQuestReplyChkBL = new RnewQuestReplyChkBL();
