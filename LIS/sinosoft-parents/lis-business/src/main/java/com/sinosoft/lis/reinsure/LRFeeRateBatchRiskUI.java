...
public class LRFeeRateBatchRiskUI
{
    ...
    public boolean submitData(VData cInputData, String cOperate)
    {
        ...
        if (!tLRFeeRateBatchRiskBL.submitData(cInputData, cOperate))
        {
            if (tLRFeeRateBatchRiskBL.mErrors.needDealError())
            {
                this.mErrors.copyAllErrors(tLRFeeRateBatchRiskBL.mErrors);
            }
            else
            {
         ...
         mResult = tLRFeeRateBatchRiskBL.getResult();
        return true;
    }
