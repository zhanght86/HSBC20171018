...
/**
 * <p>Title: </p>
 * <p>Description: 再保续期通用可参考提数类</p>
 * <p>Copyright: Copyright (c) 2008</p>
 * <p>Company: </p>
 * @author LIJIAN
 * @version 1.0
 */
public class RIDistillRN implements RIDistill {
    String mEventType;
    ...
    private String getDistillSQL(){
        ...
        String startDate = mRIWFLogSchema.getStartDate().substring(5);
        String endDate = mRIWFLogSchema.getEndDate().substring(5);
        ...
        //保单年度
        strBuffer.append(" ceil(months_between('"+mRIWFLogSchema.getEndDate()+"',a.cvalidate-1)/12) as InsuredYear, ");
        ...
        //风险保额
        strBuffer.append(" Risk_Amnt(a.payyears,ceil(months_between('"+mRIWFLogSchema.getEndDate()+"',a.cvalidate-1)/12),a.amnt,a.InsuredAppAge,a.years,a.InsuredSex,a.prem,a.riskcode,a.payendyear,a.payendyearflag,a.insuyear,a.insuyearflag,a.payintv) as RiskAmnt, ");
        ...
        ////业务日期按 保单生效周年日 提取
        strBuffer.append(" add_months(a.cvalidate,ceil(months_between('"+mRIWFLogSchema.getEndDate()+"',a.cvalidate-1)/12-1)*12) as GetDate, ");
...
//        String tsql="select distinct trim(c.associatedcode) from riaccumulaterdcode c where trim(c.accumulatedefno)='"+mAccumulateDefNo+"' ";
        ...
        strBuffer.append(" and months_between('"+mRIWFLogSchema.getEndDate()+"', a.cvalidate-1) >12");        
    ...
    private String getDistillSQL1(){
        ...
        strBuffer.append(" '' as RecordType, ");
        strBuffer.append(" '01' as DataFlag, ");//01:个人险种 02：个人险种责任
        strBuffer.append(" a.PolNo||','||"+PubFun.getCurrentDate().substring(0, 4)+" as UnionKey, ");//需要考虑这个联合主键的设置polno+","+保单年度
        strBuffer.append(" a.GrpContNo as GrpContNo, ");
        strBuffer.append(" '00000000000000000000' as ProposalGrpContNo, ");
        strBuffer.append(" a.GrpPolNo as GrpPolNo, ");
        strBuffer.append(" '00000000000000000000' as GrpProposalNo, ");
        ...
        strBuffer.append(" from lcpol a  ");
        strBuffer.append(" where a.conttype='1' and exists(select 'X' from lccontstate where polno=a.polno and enddate is null and State = '0' and StateType = 'Available'  )");
         strBuffer.append(" and not exists (Select 'X' From RIPolRecord m where m.unionkey=(a.PolNo||','||'"+mRIWFLogSchema.getEndDate().substring(0, 4)+"')) ");
        strBuffer.append(" and not exists (Select 'X' From RIPolRecordBake n where n.unionkey=(a.PolNo||','||'"+mRIWFLogSchema.getEndDate().substring(0, 4)+"')) ");
//      临分的保单
        ...
        strBuffer.append(" and to_char(a.cvalidate,'MM-DD') between '"+startDate+"' and '"+endDate+"' ");
        strBuffer.append(" and months_between('"+mRIWFLogSchema.getEndDate()+"', a.cvalidate-1) >12  and appflag ='1' ");
    ...
    public static void main(String[] args){
    	...
    	mRIWFLogSchema.setStartDate("2009-03-01");
    	mRIWFLogSchema.setEndDate("2009-03-31");
    	mRIWFLogSchema.setTaskCode("L000000001");
    	cInputData.add(mRIWFLogSchema);
    	RIDistillRN tRIDistillRN = new RIDistillRN();  	
