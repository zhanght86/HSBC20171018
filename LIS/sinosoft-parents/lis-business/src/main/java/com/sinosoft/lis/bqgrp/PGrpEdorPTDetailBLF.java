 ...
 * @version 1.0
 */
public class PGrpEdorPTDetailBLF implements EdorDetail {
private static Logger logger = Logger.getLogger(PGrpEdorPTDetailBLF.class);
  ...
  private boolean dealData() {
    PGrpEdorPTDetailBL tPGrpEdorPTDetailBL = new PGrpEdorPTDetailBL();
    if (!tPGrpEdorPTDetailBL.submitData(mInputData, mOperate)) {
      this.mErrors.copyAllErrors(tPGrpEdorPTDetailBL.mErrors);
      CError tError = new CError();
    ...
    mResult.clear();
    mResult = tPGrpEdorPTDetailBL.getResult();
    return true;
  }
