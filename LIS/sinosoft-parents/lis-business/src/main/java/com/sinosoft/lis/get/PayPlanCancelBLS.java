...
public class PayPlanCancelBLS
{
private static Logger logger = Logger.getLogger(PayPlanCancelBLS.class);
    ...
    {
        PayPlanCancelBLS AutoConfirmBLS1 = new PayPlanCancelBLS();
    }
}
