...
private static Logger logger = Logger.getLogger(LLInqCourseBL.class);
	...
	private boolean getInputData(VData cInputData, String cOperate) {
		...
		mLLInqCourseSchema = (LLInqCourseSchema) cInputData
				.getObjectByObjectName("LLInqCourseSchema", 0);
		mLLInqCertificateSet = (LLInqCertificateSet) cInputData
				.getObjectByObjectName("LLInqCertificateSet", 0);
