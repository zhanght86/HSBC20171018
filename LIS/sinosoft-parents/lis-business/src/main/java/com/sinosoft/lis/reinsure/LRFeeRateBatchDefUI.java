...
public class LRFeeRateBatchDefUI implements BusinessService {
	...
	public boolean submitData(VData cInputData, String cOperate) {
		...
		if (!tLRFeeRateBatchDefBL.submitData(cInputData, cOperate)) {
			if (tLRFeeRateBatchDefBL.mErrors.needDealError()) {
				this.mErrors.copyAllErrors(tLRFeeRateBatchDefBL.mErrors);
			} else {
				buildError("submitData", "tCardPlanBL发生错误，但是没有提供详细信息！");
			}
			return false;
		}
		mResult = tLRFeeRateBatchDefBL.getResult();
		return true;
	}
