...
/**
 * <p>
 * ClassName: GrpCardImportExcelToXml
 * </p>
 * <p>
 * Description: 用于卡单导入时将excel文件解析为xml文件
 * </p>
 * <p>
 ...
 * @date: 2007-04-01
 */
public class GrpCardImportExcelToXml {
private static Logger logger = Logger.getLogger(GrpCardImportExcelToXml.class);
	...
	public GrpCardImportExcelToXml() {
		this.initInfo();
	}
	 ...
	 */
	public GrpCardImportExcelToXml(String strFileName,
	...
	public boolean transform() {
		try {
			...
			while (hasMoreData(0)) {
				...
				// 取被保人信息
				oneContData = genRelatedInformationInOneCont(1, "INSUREDTABLE");
				oneContRow.addContent(oneContData);
				// //取险种信息
				oneContData = genRelatedInformationInOneCont(2, "LCPOLTABLE");
				oneContRow.addContent(oneContData);
				// 取受益人信息
	...
	private void buildError(String szFunc, String szErrMsg) {
		...
		cError.moduleName = "GrpCardImportExcelToXml";
	...
	public static void main(String[] args) {
		try {
			 ...
			 * 调用excel转换到xml的类
			 */
			GrpCardImportExcelToXml parser = new GrpCardImportExcelToXml(
