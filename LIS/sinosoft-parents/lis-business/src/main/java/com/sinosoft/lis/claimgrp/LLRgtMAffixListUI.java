...
import com.sinosoft.lis.claimgrp.LLRgtMAffixListBL;
 ...
 * @version 1.0
 */
public class LLRgtMAffixListUI implements BusinessService
{
private static Logger logger = Logger.getLogger(LLRgtMAffixListUI.class);
    ...
    public boolean submitData(VData cInputData,String cOperate)
    {
        ...
        LLRgtMAffixListBL tLLRgtMAffixListBL = new LLRgtMAffixListBL();

        logger.debug("----------LLRgtMAffixListUI Begin----------");
        if (tLLRgtMAffixListBL.submitData(mInputData,mOperate) == false)
        {
            // @@错误处理
            this.mErrors.copyAllErrors(tLLRgtMAffixListBL.mErrors);
            CError tError = new CError();
            tError.moduleName = "LLRgtMAffixListUI";
        ...
        {
            mResult = tLLRgtMAffixListBL.getResult();
        }
        logger.debug("----------LLRgtMAffixListUI End----------");
    ...
    public static void main(String[] args)
    {
     ...
     String[][] tAffixGridValues={{"0000000533","CLM003","索赔申请书","1","0"},{"0000000534","CLM008","受益人身份证明原件和户籍证明原件(身故保险金)","1","0"},{"0000000228","CLM005","赔款给付协议书","1","0"}};
