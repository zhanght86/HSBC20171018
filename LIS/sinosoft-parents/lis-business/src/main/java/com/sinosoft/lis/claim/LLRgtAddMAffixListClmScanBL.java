...
public class LLRgtAddMAffixListClmScanBL {
private static Logger logger = Logger.getLogger(LLRgtAddMAffixListClmScanBL.class);
	...
	public LLRgtAddMAffixListClmScanBL() {
	}
			...
			try {
				if (mSetSize > 0) {
					...
					String strSql = "delete from LLAffix where RgtNo='"
							+ "?RgtNo?" + "' and (SubFlag is null or SubFlag='1')";
