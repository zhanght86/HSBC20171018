...
public class CalEndorRetentUI {
	...
	public boolean submitData(VData cInputData, String cOperate) {
		...
		if (tCalEndorRetentBL.submitData(cInputData, mOperate) == false) {
			// @@错误处理
			this.mErrors.copyAllErrors(tCalEndorRetentBL.mErrors);
		...
		mResult=tCalEndorRetentBL.getResult();
		return true;
	}
