...
public class RANF1PUI implements PrintService {
private static Logger logger = Logger.getLogger(RANF1PUI.class);
	...
	public boolean submitData(VData cInputData, String cOperate) {
		...
		RANF1PBL tRANF1PBL = new RANF1PBL();
		logger.debug("Start RANF1P UI Submit ...");

		if (!tRANF1PBL.submitData(vData, cOperate)) {
			if (tRANF1PBL.mErrors.needDealError()) {
				mErrors.copyAllErrors(tRANF1PBL.mErrors);
				return false;
			} else {
	...
	public static void main(String[] args) {
		...
		tLOPRTManagerSchema.setPrtSeq("810000000000070");
