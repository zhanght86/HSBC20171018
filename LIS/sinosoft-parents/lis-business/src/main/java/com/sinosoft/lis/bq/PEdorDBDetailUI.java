...
public class PEdorDBDetailUI {
private static Logger logger = Logger.getLogger(PEdorDBDetailUI.class);
	...
	public boolean submitData(VData cInputData, String cOperate) {
		...
		PEdorDBDetailBLF tPEdorDBDetailBLF = new PEdorDBDetailBLF();
		logger.debug("---UI BEGIN---" + mOperate+tPEdorDBDetailBLF);
		if (tPEdorDBDetailBLF.submitData(cInputData, mOperate) == false) {
			// @@错误处理
			this.mErrors.copyAllErrors(tPEdorDBDetailBLF.mErrors);
			...
			mResult = tPEdorDBDetailBLF.getResult();
		return true;
	}
