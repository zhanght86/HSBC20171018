...
public class DocTBYWYWorkFlowService extends BaseService {
private static Logger logger = Logger.getLogger(DocTBYWYWorkFlowService.class);
	...
	public boolean deal(){
		...
		tTransferData.setNameAndValue("CertifyCode", "9996"); // by niuzj
																// 20050809
