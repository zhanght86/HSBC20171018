 ...
 * @version 6.0
 */
public class RnewUWErrUI implements BusinessService{
private static Logger logger = Logger.getLogger(RnewUWErrUI.class);
	...
	public boolean submitData(VData cInputData, String cOperate) {
		...
		RnewUWErrBL tUWErrBL = new RnewUWErrBL();
