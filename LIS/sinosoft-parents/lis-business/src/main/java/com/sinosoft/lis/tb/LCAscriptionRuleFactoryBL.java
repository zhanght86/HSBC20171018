...
private static Logger logger = Logger.getLogger(LCAscriptionRuleFactoryBL.class);
	...
	private boolean prepareOldData() {
		...
		LCAscriptionRuleFactorySchema tLCAscriptionRuleFactorySchema = new LCAscriptionRuleFactorySchema();
		if (mOldLCAscriptionRuleFactorySchema != null) {
			tLCAscriptionRuleFactorySchema = mOldLCAscriptionRuleFactorySchema;
		}
	...
	private boolean checkData() {
		...
		if (this.mOperate.compareTo("DELETE||MAIN") == 0
			...
			sqlbv.put("riskcode", tLCAscriptionRuleFactorySchema.getRiskCode());
			sqlbv.put("ascriptionrulecode", tLCAscriptionRuleFactorySchema.getAscriptionRuleCode());
		...
		if (this.mOperate.compareTo("INSERT||MAIN") == 0
				|| (this.mOperate.compareTo("UPDATE||MAIN") == 0
						&& mOldLCAscriptionRuleFactorySchema != null && !mOldLCAscriptionRuleFactorySchema
						.getAscriptionRuleCode().equalsIgnoreCase(
