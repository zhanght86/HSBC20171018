...
public class NewIndiDueFeeBLS {
private static Logger logger = Logger.getLogger(NewIndiDueFeeBLS.class);
	// 错误处理类，每个需要错误处理的类中都放置该类
	public CErrors mErrors = new CErrors();
	/** 数据操作字符串 */
	private String mOperate;

	public NewIndiDueFeeBLS() {
	}

	public static void main(String[] args) {
		NewIndiDueFeeBLS mNewIndiDueFeeBLS1 = new NewIndiDueFeeBLS();
	}
	...
	public boolean submitData(VData cInputData, String cOperate) {
		...
		logger.debug("Start NewIndiDueFee BLS Submit...");
		// 信息保存
		...
		logger.debug("End NewIndiDueFee BLS Submit...");
	...
	private boolean save(VData mInputData) {
		...
		if (conn == null) {
			...
			tError.moduleName = "NewIndiDueFeeBLS";
