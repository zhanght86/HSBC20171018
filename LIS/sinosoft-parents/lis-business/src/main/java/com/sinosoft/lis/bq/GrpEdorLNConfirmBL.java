 ...
 * @date     : 2006-05-09, 2006-06-02, 2006-08-21
 * @direction: 团体保全保单质押贷款确认
 ******************************************************************************/
...
public class GrpEdorLNConfirmBL implements EdorConfirm {
private static Logger logger = Logger.getLogger(GrpEdorLNConfirmBL.class);
	// public GrpEdorLNConfirmBL() {}
	...
	public boolean submitData(VData cInputData, String cOperate) {
		// logger.debug("\t@> GrpEdorLNConfirmBL.submitData() 开始");

		// 接收参数
		if (cInputData == null) {
			CError.buildErr(this, "无法获取提交的数据, 请确认数据不为空！");
			logger.debug("\t@> GrpEdorLNConfirmBL.submitData() : 无法获取 InputData 数据！");
			return false;
		} else {
		...
		// logger.debug("\t@> GrpEdorLNConfirmBL.submitData() 结束");
		return true;
	...
	private boolean getInputData() {
		// logger.debug("\t@> GrpEdorLNConfirmBL.getInputData() 开始");
		...
		if (rGlobalInput == null) {
			...
			logger.debug("\t@> GrpEdorLNConfirmBL.getInputData() : 无法获取 GlobalInput 数据！");
			return false;
		}
		...
		if (rLPGrpEdorItemSchema == null) {
			...
			logger.debug("\t@> GrpEdorLNConfirmBL.getInputData() : 无法获取 LPGrpEdorItemSchema 数据！");
			return false;
		}
		...
		// logger.debug("\t@> GrpEdorLNConfirmBL.getInputData() 结束");
		return true;
	...
	private boolean checkData() {
		// logger.debug("\t@> GrpEdorLNConfirmBL.checkData() 开始");
		...
		// logger.debug("\t@> GrpEdorLNConfirmBL.checkData() 结束");
		return true;
	...
	private boolean dealData() {
		// logger.debug("\t@> GrpEdorLNConfirmBL.dealData() 开始");
		...
		// logger.debug("\t@> GrpEdorLNConfirmBL.dealData() 结束");
		return true;
	...
	private boolean outputData() {
		// logger.debug("\t@> GrpEdorLNConfirmBL.outputData() 开始");

		rResultData = new VData();
		rResultData.add(rMap);

		// logger.debug("\t@> GrpEdorLNConfirmBL.outputData() 结束");
		return true;
	...
	// {
	// GrpEdorLNConfirmBL tGrpEdorLNConfirmBL = new GrpEdorLNConfirmBL();
	// } //function main end
	// ==========================================================================

} // class GrpEdorLNConfirmBL end
