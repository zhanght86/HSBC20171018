...
public class OperatorNoticeF1PUI implements PrintService {
private static Logger logger = Logger.getLogger(OperatorNoticeF1PUI.class);
	...
	public boolean submitData(VData cInputData, String cOperate) {
		...
		String mOperate =cOperate;
		//问卷传入两个信息
		String tOperate[]=null;
		if(cOperate.indexOf("-")!=-1){
			tOperate =cOperate.split("-");
			cOperate =tOperate[0];
		}
		if (!cOperate.equals("CONFIRM") && !cOperate.equals("PRINT")
				...
				&& !cOperate.equals("PRINTcsi")&&!cOperate.equals("PRINTd1")
				&& !cOperate.equals("PRINTd2")&&!cOperate.equals("PRINTd3")
				&& !cOperate.equals("PRINTd4")&& !cOperate.equals("PRINTd5")
				&& !cOperate.equals("PRINTd6")&& !cOperate.equals("PRINTd7")
				&& !cOperate.equals("PRINTd8")&& !cOperate.equals("PRINTd9")
				&& !cOperate.equals("PRINTd10")&& !cOperate.equals("PRINTd11")
		...
		OperatorNoticeF1PBL tOperatorNoticeF1PBL = new OperatorNoticeF1PBL();
		logger.debug("Start OperatorNoticeF1PUI Submit ...");

		if (!tOperatorNoticeF1PBL.submitData(vData, mOperate)) {
			if (tOperatorNoticeF1PBL.mErrors.needDealError()) {
				mErrors.copyAllErrors(tOperatorNoticeF1PBL.mErrors);
				return false;
			} else {
			...
			mResult = tOperatorNoticeF1PBL.getResult();
			return true;
		}
	}
