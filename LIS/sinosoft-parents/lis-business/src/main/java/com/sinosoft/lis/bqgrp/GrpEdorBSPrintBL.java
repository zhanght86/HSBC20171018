...
public class GrpEdorBSPrintBL implements EdorPrint {
private static Logger logger = Logger.getLogger(GrpEdorBSPrintBL.class);
	...
	private boolean dealData() {
        ...
        ListTable tBSListTable = new ListTable();
        tBSListTable.setName("BS");

		String tNewEndDate = "";//新的止期
		ExeSQL tExeSQL = new ExeSQL();
		String tSql = "select min(startdate) from lpgrpcontstate where grpcontno = '"+tLCGrpContSchema.getGrpContNo()+"' and edorno = '"+mLPGrpEdorItemSchema.getEdorNo()+"' and edortype = '"+mLPGrpEdorItemSchema.getEdorType()+"' and enddate is null and statetype = 'Available' and state = '1'";
...
//		tOldEndDate = tExeSQL.getOneValue(tSql);
		...
		String[] b_strBS = new String[2];
		xmlexport.addListTable(tBSListTable, b_strBS);
