...
public class PEdorBLPrintBL implements EdorPrint {
	private static Logger logger = Logger.getLogger(PEdorBLPrintBL.class);
	...
	private boolean dealData() {
		xmlexport.addDisplayControl("displayBL");
