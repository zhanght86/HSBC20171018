 ...
 * @version 1.0
 */
public class RINewDistillJYFX implements RIDistill {
	String mEventType;
	...
	private String getUnSQL() {
		...
		System.out.println("简易复效提数公共部分sql: " + strBuffer.toString());
	...
	private String getSpecSQL() {
		...
		strBuffer.append(" '' as StandbyDate5 ");
		strBuffer.append(" from lcpol a,lcduty d,LPRevalidateTrack c ");
		System.out.println("简易复效临分提数公共部分sql: " + strBuffer.toString());
		return strBuffer.toString();
	}
	...
	private String getDistillSQL() {
		...
		strBuffer.append(") ");
		System.out.println("简易复效提数sql: " + strBuffer.toString());
		return strBuffer.toString();
	}
	...
	private String getDistillSQL1() {
		...
		strBuffer
				.append(" and a.riskcode not in('IBC02','IBC01','IRD04','IRA03')");
		strBuffer.append(") ");
		System.out.println("简易复效临分提数sql: " + strBuffer.toString());
		return strBuffer.toString();
	}
	...
	public static void main(String[] args) {
		...
		mRIWFLogSchema.setStartDate("2013-09-01");
		mRIWFLogSchema.setEndDate("2013-09-30");
		mRIWFLogSchema.setTaskCode("L01010010010");
		cInputData.add(mRIWFLogSchema);
		RINewDistillJYFX tRIDistillRN = new RINewDistillJYFX();
