...
public class RIDataImportNBGeneral implements RIDataImport {
    ...
    public boolean getInputData(VData cInputData,String cOperate){
    	...
    	mAccumulateDefNo = (String)mTransferData.getValueByName("AccumulateDefNo");
    	return true;
    }
    private boolean dealData(){
    	try{
            ...
            do{
            	 ...
            	 rsWrapper.getData();
                 if (tRIPolRecordBakeSet != null && tRIPolRecordBakeSet.size() > 0){
            ...
            }while(tRIPolRecordBakeSet != null && tRIPolRecordBakeSet.size() > 0);
    ...
    public String getAvailableSQL(){
    	StringBuffer strBuffer = new StringBuffer();
         ...
         strBuffer.append(" ceil(decode(months_between('"+endDate+"',a.cvalidate),0,1,months_between('"+endDate+"',a.cvalidate))/12) as InsuredYear, ");
         ...
         strBuffer.append(" Risk_Amnt(a.payyears,ceil(decode(months_between('"+endDate+"',a.cvalidate),0,1,months_between('"+endDate+"',a.cvalidate))/12),a.amnt,a.InsuredAppAge,a.years,a.InsuredSex,a.prem,a.riskcode,a.payendyear,a.payendyearflag,a.insuyear,a.insuyearflag,a.payintv) as RiskAmnt, ");
...
//       计划别
         ...
         strBuffer.append(" and exists(select 'X' from lccontstate where polno=a.polno and StateType = 'Available' and State = '0' and enddate is null) ");
         strBuffer.append(" and exists(select 'X' from riaccumulaterdcode c where c.associatedcode = a.riskcode and c.accumulatedefno ='"+mAccumulateDefNo+"') ");
         strBuffer.append(" and appflag ='1' ");
         strBuffer.append(" order by GetDate,polno");
         
         System.out.println("业务数据提取　sql: "+strBuffer.toString());
    ...
    public static void  main(String[]arg){
    	RIDataImportNBGeneral tRIDataImportNBGeneral = new RIDataImportNBGeneral();
    	tRIDataImportNBGeneral.getAvailableSQL();
    }
