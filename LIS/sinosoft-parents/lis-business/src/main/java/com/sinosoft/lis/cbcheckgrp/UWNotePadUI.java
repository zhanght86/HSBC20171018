...
public class UWNotePadUI implements BusinessService{
private static Logger logger = Logger.getLogger(UWNotePadUI.class);
	/** 传入数据的容器 */
	...
	public boolean submitData(VData cInputData, String cOperate) {
		...
		UWNotePadBL tUWNotePadBL = new UWNotePadBL();
