...
import com.sinosoft.lis.claimgrp.LLMedicalFeeInp5BL;
 ...
 * @version 1.0
 */
public class LLMedicalFeeInp5UI implements BusinessService
{
private static Logger logger = Logger.getLogger(LLMedicalFeeInp5UI.class);
    ...
    public boolean submitData(VData cInputData, String cOperate)
    {
        ...
        LLMedicalFeeInp5BL tLLMedicalFeeInp5BL = new LLMedicalFeeInp5BL();

        logger.debug("----------LLMedicalFeeInp5UI Begin----------");
        if (tLLMedicalFeeInp5BL.submitData(mInputData, mOperate) == false)
        {
            // @@错误处理
            this.mErrors.copyAllErrors(tLLMedicalFeeInp5BL.mErrors);
            CError tError = new CError();
            tError.moduleName = "LLMedicalFeeInp5BLUI";
        ...
        {
            mResult = tLLMedicalFeeInp5BL.getResult();
        }
        logger.debug("----------LLMedicalFeeInp5UI End----------");
    ...
    public static void main(String[] args)
    {
        ...
        LLMedicalFeeInp5UI tLLMedicalFeeInp1UI = new LLMedicalFeeInp5UI();
