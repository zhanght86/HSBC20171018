 ...
 * @version 1.0
 */
public class MeetF1PUI implements PrintService, BusinessService{
private static Logger logger = Logger.getLogger(MeetF1PUI.class);
	...
	public boolean submitData(VData cInputData, String cOperate) {
		...
		MeetF1PBL tMeetF1PBL = new MeetF1PBL();
		logger.debug("Start RefuseAppF1P UI Submit ...");

		if (!tMeetF1PBL.submitData(vData, cOperate)) {
			if (tMeetF1PBL.mErrors.needDealError()) {
				mErrors.copyAllErrors(tMeetF1PBL.mErrors);
				return false;
			} else {
