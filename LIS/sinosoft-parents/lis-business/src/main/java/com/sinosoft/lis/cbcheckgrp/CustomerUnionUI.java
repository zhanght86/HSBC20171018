...
private static Logger logger = Logger.getLogger(CustomerUnionUI.class);
	...
	public static void main(String[] args) {
		...
		sbSQL.append(" SELECT  TABLE_NAME, COLUMN_NAME ").append(
				"   FROM  COLS ").append("  WHERE  COLUMN_NAME IN ").append(
				" ('INSUREDNO', 'CUSTOMERNO', 'APPNTNO' ) ").append(
		...
		// tTransferData.setNameAndValue("CustomerNo_NEW","0000523200");
		// tTransferData.setNameAndValue("CustomerNo_OLD","SN99000000086");
		//
