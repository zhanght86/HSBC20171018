 ...
 * @version 1.0
 */
public class RIIBCoDistillBQTB implements RIDistill {
	String mEventType;
	...
	private String getDistillSQL() {
		...
		// 退保，犹退，协退
		strBuffer
				.append(" and a.contno = c.Contno and a.appflag='4' and b.edortype in('CF','CT','ES') and b.edorstate='0'");
		// 不临分
		strBuffer
	...
	private String getDistillSQL1() {
		...
		strBuffer.append(" and a.Currency='01'");
		strBuffer.append(") ");
		System.out.println("共保退保临分提数sql: " + strBuffer.toString());
		return strBuffer.toString();
	}
	...
	public static void main(String[] args) {
		...
		mRIWFLogSchema.setEndDate("2011-11-27");
		mRIWFLogSchema.setTaskCode("L01010070010");
		cInputData.add(mRIWFLogSchema);
		RIIBCoDistillBQTB tRIDistillRN = new RIIBCoDistillBQTB();
