...
public class PEdorFMBackConfirmBL implements EdorBack {
private static Logger logger = Logger.getLogger(PEdorFMBackConfirmBL.class);
	/** 传入数据的容器 */
