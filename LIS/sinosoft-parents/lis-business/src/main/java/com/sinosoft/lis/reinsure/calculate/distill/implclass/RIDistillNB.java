...
/**
 * <p>Title: </p>
 * <p>Description:再保新契约通过可参考提数程序 </p>
 * <p>Copyright: Copyright (c) 2008</p>
 * <p>Company: </p>
 * @author LIJIAN
 * @version 1.0
 */
public class RIDistillNB implements RIDistill {
    String mEventType;
    ...
    private String getDistillSQL(){
        ...
        //保单年度
        strBuffer.append(" ceil(months_between(greatest(a.signdate,a.cvalidate),a.cvalidate-1)/12) as InsuredYear, ");
        ...
        //风险保额
        strBuffer.append(" Risk_Amnt(a.payyears,ceil(months_between(greatest(a.signdate,a.cvalidate),a.cvalidate-1)/12),a.amnt,a.InsuredAppAge,a.years,a.InsuredSex,a.prem,a.riskcode,a.payendyear,a.payendyearflag,a.insuyear,a.insuyearflag,a.payintv) as RiskAmnt, ");
        ...
        strBuffer.append(" and not exists (Select 'X' From RIPolRecord m where m.unionkey=(a.PolNo||',1')) ");
        strBuffer.append(" and not exists (Select 'X' From RIPolRecordBake n where n.unionkey=(a.PolNo||',1')) ");
        //不为临分的保单
        ...
        strBuffer.append(" and exists(select 'X' from riaccumulaterdcode c where a.riskcode=c.associatedcode and c.accumulatedefno='");
        strBuffer.append(mAccumulateDefNo);
        strBuffer.append("')");        
        strBuffer.append(" and greatest(a.signdate,a.cvalidate) between '");//保单生效日与签单日
    ...
    private String getDistillSQL1(){
        ...
        strBuffer.append(" from lcpol a  ");
        strBuffer.append(" where a.conttype='1' and appflag ='1' and exists(select 'X' from lccontstate where  enddate is null and StateType = 'Available' and State = '0' and polno=a.polno ) ");
        strBuffer.append(" and not exists (Select 'X' From RIPolRecord m where m.unionkey=(trim(a.PolNo)||',1')) ");
        strBuffer.append(" and not exists (Select 'X' From RIPolRecordBake n where n.unionkey=(trim(a.PolNo)||',1')) ");       
        strBuffer.append(" and exists(select 'X' from riaccumulaterdcode c where a.riskcode=c.associatedcode and c.accumulatedefno='");
        strBuffer.append(mAccumulateDefNo);
        strBuffer.append("')");
        //临分的保单
        ...
        strBuffer.append(" and greatest(signdate,cvalidate) between '");
        strBuffer.append(mRIWFLogSchema.getStartDate());
        strBuffer.append("' and '");
        strBuffer.append(mRIWFLogSchema.getEndDate());             
        strBuffer.append("' )order by GetDate,polno");
    ...
    public static void main(String[] args){
    	...
    	mRIWFLogSchema.setStartDate("2009-2-1");
    	mRIWFLogSchema.setEndDate("2009-2-31");
    	mRIWFLogSchema.setTaskCode("L000000004");
    	cInputData.add(mRIWFLogSchema);
    	RIDistillNB tRIDistillNB = new RIDistillNB();
