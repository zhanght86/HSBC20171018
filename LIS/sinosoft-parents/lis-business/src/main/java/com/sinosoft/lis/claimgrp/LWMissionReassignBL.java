...
private static Logger logger = Logger.getLogger(LWMissionReassignBL.class);
    ...
    */
    ...
    private boolean getInputData(VData cInputData,String cOperate)
    {
        ...
        mLWMissionSchema = (LWMissionSchema) mInputData.getObjectByObjectName("LWMissionSchema", 0);
        return true;
    }
    ...
    private boolean UserUpdate()
    {
        ...
        tLWMissionSchema.setDefaultOperator(mLWMissionSchema.getDefaultOperator());
