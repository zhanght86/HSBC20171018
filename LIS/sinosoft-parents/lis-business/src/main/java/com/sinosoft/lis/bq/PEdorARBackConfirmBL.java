...
/**
 * <p>Title: Web业务系统</p>
 * <p>Description: 保全- 投连险账户赎回确认生效处理类</p>
 ...
 */
public class PEdorARBackConfirmBL implements EdorBack {
private static Logger logger = Logger.getLogger(PEdorARBackConfirmBL.class);
    /** 传入数据的容器 */
