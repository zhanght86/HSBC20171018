 ...
 */
public class BqApproveNoticePrintBL implements PrintService {
	private static Logger logger = Logger
			.getLogger(BqApproveNoticePrintBL.class);
	...
	private boolean getInputData() {
		...
		if (mNoType == null || mNoType.trim().equals("")) {
			...
			tError.moduleName = "BqApproveNoticePrintBL";
		...
		if (!tEdorItem.trim().equals(PrintManagerBL.CODE_PEdorApproveInfo)) {
			CError tError = new CError();
			tError.moduleName = "BqApproveNoticePrintBL";
			tError.functionName = "getInputData";
	...
	public static void main(String[] args) {
		...
		BqApproveNoticePrintBL tBqApproveNoticePrintBL = new BqApproveNoticePrintBL();
		if (!tBqApproveNoticePrintBL.submitData(tVData, "PRINT")) {
			logger.debug("\t@> BqApproveNoticePrintBL 打印失败");
		}
	} // function main end
}
