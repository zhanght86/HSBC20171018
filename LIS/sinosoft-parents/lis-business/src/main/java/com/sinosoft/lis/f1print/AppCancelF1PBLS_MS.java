...
public class AppCancelF1PBLS_MS {
private static Logger logger = Logger.getLogger(AppCancelF1PBLS_MS.class);
	...
	public boolean submitData(VData cInputData, String cOperate) {
		...
		logger.debug("Start AppCancelF1PBLS Submit...");
		...
		logger.debug("End AppCancelF1PBLS Submit...");
	...
	private boolean save(VData mInputData) {
		...
		if (conn == null) {
			...
			tError.moduleName = "AppCancelF1PBLS";
