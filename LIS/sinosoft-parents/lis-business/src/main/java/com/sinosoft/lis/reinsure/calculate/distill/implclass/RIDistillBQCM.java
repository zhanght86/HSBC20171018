...
/**
 * <p>Title: </p>
 * <p>Description:再保保全CM通用可参考提数程序 </p>
 * <p>Copyright: Copyright (c) 2008</p>
 * <p>Company: </p>
 * @author LIJIAN
 * @version 1.0
 */
public class RIDistillBQCM implements RIDistill {
    String mEventType;
    ...
    private String getDistillSQL(){
        ...
        strBuffer.append(" a.PolNo||','||b.edorno||','||b.edortype as UnionKey, ");//联合主键：polno||","||edorno||","||edortype
        ...
        //保单年度
        strBuffer.append(" ceil(months_between(b.edorvalidate,a.cvalidate-1)/12) as InsuredYear, ");
        ...
        strBuffer.append(" getpreinfo(a.contno,a.polno,b.edorno,b.edorvalidate,'StandPrem') as StandPrem, ");
        strBuffer.append(" getpreinfo(a.contno,a.polno,b.edorno,b.edorvalidate,'Prem') as Prem, ");
        //风险保额
        ...
        strBuffer.append(" getpreinfo(a.contno,a.polno,b.edorno,b.edorvalidate,'Amnt') as Amnt,  ");
        ...
        //preRiskAmnt
        strBuffer.append(" Risk_Amnt(c.payyears,ceil(months_between(b.edorvalidate,c.cvalidate-1)/12),c.amnt,c.InsuredAppAge,c.years,c.InsuredSex,c.prem,c.riskcode,c.payendyear,c.payendyearflag,c.insuyear,c.insuyearflag,c.payintv) as PreRiskAmnt, ");
...
//      不为临分的保单
        ...
        strBuffer.append(" and not exists (Select 'X' From RIPolRecord m where m.unionkey=(a.PolNo||','||b.edorno||','||b.edortype)) ");
        strBuffer.append(" and not exists (Select 'X' From RIPolRecordBake n where n.unionkey=(a.PolNo||','||b.edorno||','||b.edortype)) ");
...
//      被保人重要资料变更
        ...
        strBuffer.append(" and c.polno=a.polno and c.edortype=b.edortype and c.edorno=b.edorno");
//      edortype  CT:退保 EA:解约 RE:复效 AA:加保 PT:减保 CM:客户资料变更(LIDO 是否需要区分投保人与被保险人) IO:被保人职业类别变更
        strBuffer.append(" and b.edorstate='0' and b.edortype='CM' and b.edorvalidate between '"+mRIWFLogSchema.getStartDate()+"' and '"+mRIWFLogSchema.getEndDate()+"' ");
//      strBuffer.append(" and not exists (select * from RITempContLink where proposalno=a.proposalno )");
    ...
    private String getDistillSQL1(){
        ...
        strBuffer.append(" a.OccupationType as OccupationType, ");
        strBuffer.append(" (select b.OccupationCode from LCInsured b where b.insuredno=a.insuredno and b.contno=a.contno) as OccupationCode , ");
        strBuffer.append(" decode( b.edortype,'CT',0 , a.StandPrem ) as StandPrem, ");
        ...
        //strBuffer.append(" AccumulateAmnt(a.InsuredNo,b.DutyCode,a.ContNo) as AccAmnt, ");
        strBuffer.append(" 0 as AccAmnt, ");
        strBuffer.append(" decode( b.edortype,'RE' , 0 ,c.standprem ) as PreStandPrem, ");
        strBuffer.append(" decode( b.edortype,'RE' , 0 ,c.prem ) as PrePrem, ");
        //preRiskAmnt
        strBuffer.append(" decode( b.edortype,'RE' , 0 , Risk_Amnt(c.payyears,ceil(months_between(b.edorvalidate,c.cvalidate-1)/12),c.amnt,c.InsuredAppAge,c.years,c.InsuredSex,c.prem,c.riskcode,c.payendyear,c.payendyearflag,c.insuyear,c.insuyearflag,c.payintv)) as PreRiskAmnt, ");
        strBuffer.append(" decode( b.edortype,'RE' , 0 , c.amnt ) as PreAmnt, ");
        strBuffer.append(" '' as ClmNo, ");
        strBuffer.append(" '' as ClmFeeOperationType, ");
        strBuffer.append(" '' as ClmFeeFinaType, ");
        strBuffer.append(" 0 as StandGetMoney, ");
...
//      edortype  CT:退保 EA:解约 RE:复效 AA:加保 PT:减保 CM:客户资料变更(LIDO 是否需要区分投保人与被保险人) IO:被保人职业类别变更
    ...
    public static void main(String[] args){
    	...
    	RIDistillBQCM tRIDistillBQCM = new RIDistillBQCM();  	
