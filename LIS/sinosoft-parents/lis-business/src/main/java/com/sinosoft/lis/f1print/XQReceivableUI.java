...
public class XQReceivableUI implements PrintService {
private static Logger logger = Logger.getLogger(XQReceivableUI.class);
	...
	public static void main(String[] args) { // String tAppntNo = "0000498010";
		...
		tVData.add(tG);
		XQReceivableUI u = new XQReceivableUI();
	...
	public boolean submitData(VData cInputData, String cOperate) {
		...
		XQReceivableBL tXQReceivableBL = new XQReceivableBL();
		logger.debug("Start ConFeeF1P UI Submit ...");

		if (!tXQReceivableBL.submitData(cInputData, "PRINT")) {

			if (tXQReceivableBL.mErrors.needDealError()) {

				mErrors.copyAllErrors(tXQReceivableBL.mErrors);
				return false;
			} else {
			...
			mResult = tXQReceivableBL.getResult();
			return true;
		}
