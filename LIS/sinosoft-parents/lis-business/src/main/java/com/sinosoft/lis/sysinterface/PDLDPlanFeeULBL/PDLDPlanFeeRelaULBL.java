...
public class PDLDPlanFeeRelaULBL implements BusinessService {
	private static Logger logger = Logger.getLogger(PDLDPlanFeeRelaULBL.class);
    ...
    private boolean dealData() {
        ...
        if (!this.checkData()) {
        	...
        	PDLDPlanFeeRelaULtBL tPDLDPlanFeeRelaULtBL = new PDLDPlanFeeRelaULtBL();
			...
			if (file.renameTo(new File(mImportPath + mNewFileName))) {
				file.delete();
				result = tPDLDPlanFeeRelaULtBL.submitData(mImportPath, mNewFileName,mInputData);
			}else {
				result = tPDLDPlanFeeRelaULtBL.submitData(mImportPath, mFileName,mInputData);
			}
