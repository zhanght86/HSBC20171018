 ...
 * @version 1.0
 */
public class GrpMeetF1PUI implements PrintService {
private static Logger logger = Logger.getLogger(GrpMeetF1PUI.class);
	...
	public boolean submitData(VData cInputData, String cOperate) {
		...
		GrpMeetF1PBL tGrpMeetF1PBL = new GrpMeetF1PBL();
		logger.debug("Start RefuseAppF1P UI Submit ...");

		if (!tGrpMeetF1PBL.submitData(vData, cOperate)) {
			if (tGrpMeetF1PBL.mErrors.needDealError()) {
				mErrors.copyAllErrors(tGrpMeetF1PBL.mErrors);
				return false;
			} else {
				buildError("submitData", "GrpMeetF1PBL发生错误，但是没有提供详细的出错信息");
				return false;
			}
		} else {
			mResult = tGrpMeetF1PBL.getResult();
			return true;
		}
	}
	...
	private void buildError(String szFunc, String szErrMsg) {
		...
		cError.moduleName = "GrpMeetF1PUI";
	...
	public static void main(String[] args) {
		...
		GrpMeetF1PUI UI = new GrpMeetF1PUI();
