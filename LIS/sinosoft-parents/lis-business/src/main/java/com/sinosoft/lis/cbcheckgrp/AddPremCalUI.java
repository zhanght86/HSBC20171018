...
public class AddPremCalUI implements BusinessService{
private static Logger logger = Logger.getLogger(AddPremCalUI.class);
	...
	public boolean submitData(VData cInputData, String cOperate) {
		...
		if (!tAddPremCalBL.submitData(mInputData, cOperate)) {
			if (tAddPremCalBL.mErrors.needDealError()) {
				mErrors.copyAllErrors(tAddPremCalBL.mErrors);
				return false;
			} else {
			...
			mResult = tAddPremCalBL.getResult();
			return true;
		}
