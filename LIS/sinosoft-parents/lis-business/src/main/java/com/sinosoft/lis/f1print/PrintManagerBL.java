...
private static Logger logger = Logger.getLogger(PrintManagerBL.class);
	...
	public static final String ONT_REGTNO = "07"; // 理赔立案号
	...
	// 核保通知书类型定为 89
	public static final String CODE_UW = "TB89"; // 核保通知书
	public static final String CODE_UW_UnPrint = "TB90"; // 核保通知书(非打印类)
	...
	public static final String CODE_BANK_SUCC = "21"; // 转账不成功通知书
	...
	public static final String CODE_LPPE = "LP03"; // 理赔体检通知书
	public static final String CODE_LPPRINTPE = "LP98"; // 理赔体检通知书   新增通知书类型 为生成十位流水号 09-06-08
	public static final String CODE_LPMEET = "LP89"; // 理赔生调通知书
	public static final String CODE_LPSY = "LP81"; // 理赔索要问卷通知书
	public static final String CODE_LPHB = "LP90"; // 理赔核保通知书
	public static final String CODE_LPPRINTHB = "LP97"; // 理赔核保通知书  新增通知书类型 为生成十位流水号 09-06-08
	public static final String CODE_LPHB_UnPrint = "LP91"; // 理赔核保通知书
	public static final String CODE_LPIQ = "LP99"; // 理赔告知问卷
	
	public static final String CODE_EdorINSUACC = "BQ91"; //保全万能险对账单
	public static final String CODE_PEdorLoanPay = "BQ10"; // 保单质押贷款还款通知书
	public static final String CODE_PEdorOverDulLoanPay = "BQ11"; // 保单质押贷款逾期还款通知书
	...
	public static final String CODE_PEdorOrg = "BQ02"; // 保全机构问题件
	public static final String CODE_PEdorUW = "27"; // 保全补资料通知书
	public static final String CODE_PEdorSend = "25"; // 保全核保通知书
	...
	//用作MS的保全失效终止通知书 comment by jiaqiangli 2009-10-19
	...
	public static final String CODE_PEdorInvaliInfo = "BQ33"; // 保全拒绝通知书\
	public static final String CODE_PEdorApproveInfo = "BQ37"; // 保全审批通知书\
	public static final String CODE_PEdorExpireTerminate = "BQ34"; // 保全满期终止通知书
	public static final String CODE_PEdorReceipt = "BQ35"; // 保全补费收据（发票）
	public static final String CODE_GEdorInvoice = "BQ36"; // 保全团体补费收据（发票）
	public static final String CODE_PEdorFina = "BQ40"; // 保全个险日结
	public static final String CODE_GEdorFina = "BQ41"; // 保全团险日结
	
	//bq99 add by jiaqiangli 2009-02-24
	public static final String CODE_BQBankTransferFailure = "BQ99"; // 保全转账失败通知书
	public static final String CODE_LPBankTransferFailure = "LP01"; // 理赔转账失败通知书
	//bq99 add by jiaqiangli 2009-02-24
	...
	public static final String CODE_PEdorBankFine = "BQ49"; // 保全收费银行划款成功通知书

	public static final String CODE_GEdorPayInfo = "BQ51"; // 团体保全收费通知书
	public static final String CODE_GEdorGetInfo = "BQ52"; // 团体保全付费通知书
	public static final String CODE_GEdorInvalid = "BQ53"; // 保全团体失效通知书
	public static final String CODE_GEdorGetNotice = "BQ54"; // 保全团体领取通知书
	public static final String CODE_GEdorLoanPay = "BQ55"; // 保全团体保单质押贷款还款通知书
	...
	public static final String CODE_EdorINSUACCM = "BQ00"; // 保全万能险对账报告（月）
	public static final String CODE_EdorINSUACCY = "BQ01"; // 保全万能险对账报告（年）
	public static final String CODE_EdorINSUACCTEND = "BQ12"; // 保全万能险终止通知书

	public static final String CODE_PEdorGCGetNotice = "BQ92"; // 保全领取形式变更(GC)通知书打印
	public static final String CODE_EdorPayGetForm = "BQ93"; // 保全收付费方式变更通知书打印

	public static final String CODE_EdorUWResultNotice = "BQ94"; // 保全核保结论通知书
	public static final String CODE_EdorUWRequestNotice = "BQ95"; // 保全核保要求通知书
	public static final String CODE_GRP_EDORPE = "BQ96";// 保全团体体检通知书
	...
	public static final String CODE_PEdorAPPRE = "41"; // 保费自垫通知书
	public static final String CODE_PEdorContInvalid = "42"; // 保单失效通知书
	...
	public static final String CODE_PRnewOrg = "48"; // 续保核保机构问题件
	...
	public static final String CODE_PEdorCancel = "BQ42"; // 保全撤销通知书
	
	public static final String CODE_PEdorResult = "BQ71"; // 保全办理结果通知书
	public static final String CODE_PEdorRemind = "BQ72"; // 保全办理进度通知书
	...
	public static final String CODE_GRPBONUSPAYBILL = "35"; // 团体红利派发通知书人名清单
	...
	public static final String CODE_GRP_PE = "G03"; // 团体体检通知书
	public static final String CODE_GRP_MEET = "G04"; // 团体契调通知书
	...
	public static void main(String[] args) {
		...
		tLOPRTManagerSchema.setCode("qd07");

		TransferData tTransferData = new TransferData();
		tTransferData.setNameAndValue("BankCode", "4900010");
		tTransferData.setNameAndValue("Flag", "YS");
		tTransferData.setNameAndValue("ManageCom", "86490000");
		tTransferData.setNameAndValue("TFFlag", "F");
		tTransferData.setNameAndValue("XQFlag", "X");
		tTransferData.setNameAndValue("StartDate", "2006-08-01");
		tTransferData.setNameAndValue("EndDate", "2006-08-02");
		tTransferData.setNameAndValue("SaleChnl", "0");
		...
		tPrintManagerBL.submitData(tVData, "PRINTQD");
	...
	private boolean callPrintService(LOPRTManagerSchema aLOPRTManagerSchema) {
		...
		// 查找打印服务
		String strSQL = "";
		if (aLOPRTManagerSchema.getCode().substring(0, 2).equals("LP")) {// 理赔二核通知书打印
			strSQL = "SELECT * FROM LDCode WHERE CodeType = 'lluwnotice'";
		...
		sqlbv1.sql(strSQL);
		sqlbv1.put("Code", aLOPRTManagerSchema.getCode());
		LDCodeSet tLDCodeSet = new LDCodeDB().executeQuery(sqlbv1);
	...
	private boolean callPrintQDService(LOPRTManagerSchema aLOPRTManagerSchema) {
		...
		sqlbv2.sql(strSQL);
		sqlbv2.put("Code", aLOPRTManagerSchema.getCode());
		LDCodeSet tLDCodeSet = new LDCodeDB().executeQuery(sqlbv2);
		...
		try {
			...
			if (!ps.submitData(vData, "PRINT")) {
				errStr = ps.getErrors().getFirstError();
				if (errStr.indexOf("不支持") >= 0) {
					ps = (PrintService) cls.newInstance();
					if (!ps.submitData(vData, "CONFIRM")) {
						mErrors.copyAllErrors(ps.getErrors());
						return false;
					}
				} else {
