...
public class LLSecondUWApplyBLF {
private static Logger logger = Logger.getLogger(LLSecondUWApplyBLF.class);
	...
	public boolean submitData(VData cInputData, String cOperate) {
		...
		logger.debug("---LLSecondUWApplyBLF dealData Start---");
		...
		logger.debug("---LLSecondUWApplyBLF dealData End---");
	...
	private boolean prepareOutputData() {
		try {
			...
			tError.moduleName = "LLSecondUWApplyBLF";
	...
	private boolean getInputData(VData cInputData, String cOperate) {
		...
		this.mCaseNo = (String) mTransferData.getValueByName("CaseNo");
		if (mCaseNo == null || mCaseNo.trim().equals("")) {
			// @@错误处理
			// this.mErrors.copyAllErrors( tLCContDB.mErrors );
			CError tError = new CError();
			tError.moduleName = "LLSecondUWApplyBLF";
			tError.functionName = "getInputData";
			tError.errorMessage = "前台传输数据CaseNo失败!";
			this.mErrors.addOneError(tError);
			return false;
		}
		...
		if (mBatNo == null || mBatNo.trim().equals("")) {
			...
			tError.moduleName = "LLSecondUWApplyBLF";
			tError.functionName = "getInputData";
			tError.errorMessage = "前台传输数据BatNo失败!";
			this.mErrors.addOneError(tError);
			return false;
		}
		return true;
