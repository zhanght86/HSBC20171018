 ...
 * @version 1.0
 */
public class PEdorRCBackConfirmBL implements EdorBack {
private static Logger logger = Logger.getLogger(PEdorRCBackConfirmBL.class);
	/** 传入数据的容器 */
