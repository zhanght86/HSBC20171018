...
public class SysUWNoticeBLS {
private static Logger logger = Logger.getLogger(SysUWNoticeBLS.class);
...
//传输数据类
  ...
  public SysUWNoticeBLS() {
  }
  public static void main(String[] args) {
    SysUWNoticeBLS sysUWNoticeBLS1 = new SysUWNoticeBLS();
  }
...
*/
  public boolean submitData(VData cInputData,String cOperate)
  {
    ...
    logger.debug("Start SysUWNoticeBLS Submit...");
    if (this.mOperate.equals("TakeBack"))
    {
      if (!saveData())
        logger.debug("update failed") ;
      logger.debug("End SysUWNoticeBLS Submit...");
      return false;
    }
  ...
  private boolean saveData()
  {
    ...
    if (conn==null)
    {
      ...
      tError.moduleName = "SysUWNoticeBLS";
