...
//						+ mLCGrpAppntSchema.getCustomerNo() + "'";
				//modify by ln 修改地址码生成方法
				String sql = "Select Case When AddressNo Is Null Then '0' Else AddressNo End from LCGrpAddress where CustomerNo='"
						+ mLCGrpAppntSchema.getCustomerNo() + "' order by length(AddressNo) desc,AddressNo desc";
