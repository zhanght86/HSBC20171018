...
private static Logger logger = Logger.getLogger(ChangeCvalidateBL.class);
	...
	private boolean dealData() {
		...
		String SpecifyValiDate = (String)(mTransferData.getValueByName("SpecifyValiDate"));
		if(SpecifyValiDate == null || SpecifyValiDate.equals(""))
			SpecifyValiDate = "N";
		// 准备险种信息
		...
		for (int i = 1; i <= mLCPolSet.size(); i++) {
			...
			tLCPolSchema.setSpecifyValiDate(SpecifyValiDate);
