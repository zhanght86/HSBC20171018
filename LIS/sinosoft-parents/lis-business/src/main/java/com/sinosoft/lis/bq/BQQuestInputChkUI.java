 ...
 * @version 1.0
 */
public class BQQuestInputChkUI implements BusinessService{
private static Logger logger = Logger.getLogger(BQQuestInputChkUI.class);
	...
	public boolean submitData(VData cInputData, String cOperate) {
		...
		BQQuestInputChkBL tBQQuestInputChkBL = new BQQuestInputChkBL();

		logger.debug("---QuestInputChkBL UI BEGIN---");

		if (tBQQuestInputChkBL.submitData(cInputData, mOperate) == false) {
			// @@错误处理
			this.mErrors.copyAllErrors(tBQQuestInputChkBL.mErrors);
	...
	public static void main(String[] args) {
		...
		BQQuestInputChkUI ui = new BQQuestInputChkUI();
