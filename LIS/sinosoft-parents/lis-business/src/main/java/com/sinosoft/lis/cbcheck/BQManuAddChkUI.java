...
public class BQManuAddChkUI implements BusinessService{
private static Logger logger = Logger.getLogger(BQManuAddChkUI.class);
	...
	public BQManuAddChkUI() {
	}

	public boolean submitData(VData cInputData, String cOperate) {
		mOperate = cOperate;
		BQManuAddChkBL tBQManuAddChkBL = new BQManuAddChkBL();

		logger.debug("---UWManuAddChkUI BEGIN---");
		if (tBQManuAddChkBL.submitData(cInputData, cOperate) == false) {
			// @@错误处理
			this.mErrors.copyAllErrors(tBQManuAddChkBL.mErrors);
