 ...
 * @version 1.0
 */
public class PGrpEdorPTDetailUI implements BusinessService
{
private static Logger logger = Logger.getLogger(PGrpEdorPTDetailUI.class);
    ...
    public boolean submitData(VData cInputData, String cOperate)
    {
        ...
        PGrpEdorPTDetailBLF tPGrpEdorPTDetailBLF = new PGrpEdorPTDetailBLF();
        logger.debug("---PGrpEdorPTDetailUI BEGIN---" + mOperate);
        if (tPGrpEdorPTDetailBLF.submitData(cInputData, mOperate) == false)
        {
            // @@错误处理
            this.mErrors.copyAllErrors(tPGrpEdorPTDetailBLF.mErrors);
            ...
            mResult = tPGrpEdorPTDetailBLF.getResult();
        mResult.clear();
        return true;
    }
...
//      logger.debug("------transact:"+transact);
        ...
        try
        {
            ...
            tPGrpEdorPTDetailUI.submitData(tVData, transact);
