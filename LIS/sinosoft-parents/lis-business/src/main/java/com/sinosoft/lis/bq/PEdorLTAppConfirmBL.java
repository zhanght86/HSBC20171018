 ...
 * @version 1.0
 */
public class PEdorLTAppConfirmBL implements EdorAppConfirm {
private static Logger logger = Logger.getLogger(PEdorLTAppConfirmBL.class);
	...
	public boolean submitData(VData cInputData, String cOperate) {
		...
		logger.debug("---PEdorZTAppConfirmBL BL BEGIN---");
		// //PEdorZTAppConfirmBL tPEdorZTAppConfirmBL = new
		// PEdorZTAppConfirmBL();
		//
		// if (tPEdorZTAppConfirmBL.submitData(cInputData, cOperate) == false)
		// {
		// // @@错误处理
		// this.mErrors.copyAllErrors(tPEdorZTAppConfirmBL.mErrors);
		// mResult.clear();
		...
		// else
		// {
		// mResult = tPEdorZTAppConfirmBL.getResult();
		// }
	...
	public static void main(String[] args) {
		...
		// tPEdorZTAppConfirmBL.submitData(tVData, "INSERT||GRPEDORTYPEBB");
	}
}
