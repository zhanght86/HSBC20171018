...
public class PayToCatUI implements PrintService {
private static Logger logger = Logger.getLogger(PayToCatUI.class);
	...
	public static void main(String[] args) {
		...
		tTransferData.setNameAndValue("BankCode", "2100020");
	...
	public boolean submitData(VData cInputData, String cOperate) {
		...
		PayToCatBL tPayToCatBL = new PayToCatBL();
		logger.debug("Start ConFeeF1P UI Submit ...");

		if (!tPayToCatBL.submitData(cInputData, "PRINT")) {
			if (tPayToCatBL.mErrors.needDealError()) {
				mErrors.copyAllErrors(tPayToCatBL.mErrors);
				return false;
			} else {
