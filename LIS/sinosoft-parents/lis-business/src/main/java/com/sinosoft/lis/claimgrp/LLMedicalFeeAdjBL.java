...
/**
 * <p>Title: 医疗费用调整显示信息</p>
 * <p>Description: 医疗费用调整显示信息 </p>
...
private static Logger logger = Logger.getLogger(LLMedicalFeeAdjBL.class);
    ...
    private boolean prepareMedicalFeeAdj()
    {
        ...
        String sql = "select * from LLClaimDutyFee where 1=1 "
                     ...
                     + " and DutyFeeCode = '" + dutyFeeCode + "'"
                     + " and DutyFeeStaNo = '" + dutyFeeStaNo + "'";
        mLLClaimDutyFeeSet = mLLClaimDutyFeeDB.executeQuery(sql);

        LLClaimUWDutyFeeSchema tLLClaimUWDutyFeeSchema = new
            LLClaimUWDutyFeeSchema();
            ...
            "B".equalsIgnoreCase(dutyFeeType))
        {
            ...
            tSelectSql = "select * from LLCaseReceipt where 1=1 "
                         + " and ClmNo = '" + clmNo + "'"
                         + " and FeeItemCode = '" + dutyFeeCode + "'"
                         + " and FeeDetailNo = '" + dutyFeeStaNo + "'";
            tLLCaseReceiptSet = tLLCaseReceiptDB.executeQuery(tSelectSql);
        ...
        else if ("C".equalsIgnoreCase(dutyFeeType))
        {
            ...
            tSelectSql = "select * from LLCaseInfo where 1=1 "
                         + " and ClmNo = '" + clmNo + "'"
                         + " and DefoCode = '" + dutyFeeCode + "'"
                         + " and SerialNo = '" + dutyFeeStaNo + "'";
            tLLCaseInfoSet = tLLCaseInfoDB.executeQuery(tSelectSql);
                 ...
                 "E".equalsIgnoreCase(dutyFeeType))
        {
            ...
            tSelectSql = "select * from LLOperation where 1=1 "
                         + " and ClmNo = '" + clmNo + "'"
                         + " and OperationCode = '" + dutyFeeCode + "'"
                         + " and SerialNo = '" + dutyFeeStaNo + "'";
            tLLOperationSet = tLLOperationDB.executeQuery(tSelectSql);
        ...
        else if ("F".equalsIgnoreCase(dutyFeeType))
        {
            ...
            tSelectSql = "select * from LLOtherFactor where 1=1 "
                         ...
                         + " and OperationCode = '" + dutyFeeCode + "'"
                         + " and SerialNo = '" + dutyFeeStaNo + "'";
            tLLOtherFactorSet = tLLOtherFactorDB.executeQuery(tSelectSql);
