...
private static Logger logger = Logger.getLogger(LCDeleteAllInsuredBL.class);
	...
	private boolean dealData() {
		...
		// Update by YaoYi in 2001-9-21 for FK error
//		map.put("delete from lcinsured where grpcontno='" + contno + "'",
//				"DELETE");
		map.put(
				"delete from lcinsured where contno in (select contno from lccont where grpcontno='" + contno + "')", 
				"DELETE"
		);
		...
		map
				.put("delete from lcget where  grpcontno='" + contno + "'",
						"DELETE");
		map.put(
				"delete from lcbnf where contno in (select contno from lccont where grpcontno='" + contno + "')", 
				"DELETE"
		);
		map
