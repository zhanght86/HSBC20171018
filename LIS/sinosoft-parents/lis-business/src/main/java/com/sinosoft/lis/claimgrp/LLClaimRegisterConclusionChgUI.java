 ...
 * @version 1.0
 */
public class LLClaimRegisterConclusionChgUI implements BusinessService
{
private static Logger logger = Logger.getLogger(LLClaimRegisterConclusionChgUI.class);
    ...
    public LLClaimRegisterConclusionChgUI()
    {
    }
    ...
    public boolean submitData(VData cInputData,String cOperate)
    {
        ...
        LLClaimRegisterConclusionChgBL tLLClaimRegisterConclusionChgBL = new LLClaimRegisterConclusionChgBL();

        logger.debug("----------UI BEGIN----------");
        if (tLLClaimRegisterConclusionChgBL.submitData(mInputData,mOperate) == false)
        {
            // @@错误处理
            this.mErrors.copyAllErrors(tLLClaimRegisterConclusionChgBL.mErrors);
            CError tError = new CError();
            tError.moduleName = "LLClaimRegisterConclusionChgUI";
        ...
        {
            mResult = tLLClaimRegisterConclusionChgBL.getResult();
        }
