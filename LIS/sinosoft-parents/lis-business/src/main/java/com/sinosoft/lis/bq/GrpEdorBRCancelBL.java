...
public class GrpEdorBRCancelBL implements EdorCancel
{
private static Logger logger = Logger.getLogger(GrpEdorBRCancelBL.class);
    ...
    private boolean dealData()
    {
        ...
        mMap.put("delete from lpgrpcontstate where grpcontno='" + tGrpContNo + "'"
                 +" and  edorno = '"+tEdorNo+"'",
                         "DELETE");
        mMap.put("delete from lpcontstate where edorno = '"+tEdorNo+"'",
                        "DELETE");
        return true;
    }
    /**
