 ...
 * @date 2002-09-25
 */
public class GrpEdorNPDetailUI implements BusinessService
{
private static Logger logger = Logger.getLogger(GrpEdorNPDetailUI.class);
...
//        }
    ...
    public boolean submitData(VData cInputData, String cOperate)
    {
        ...
        GrpEdorNPDetailBL tGrpEdorNPDetailBL = new GrpEdorNPDetailBL();

//        logger.debug("---UI BEGIN---");
        if (tGrpEdorNPDetailBL.submitData(cInputData, mOperate) == false)
        {
            // @@错误处理
            this.mErrors.copyAllErrors(tGrpEdorNPDetailBL.mErrors);
            return false;
        }
        else
        {
            mResult = tGrpEdorNPDetailBL.getResult();
        }
