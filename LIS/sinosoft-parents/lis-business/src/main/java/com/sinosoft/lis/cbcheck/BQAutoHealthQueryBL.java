...
public class BQAutoHealthQueryBL {
private static Logger logger = Logger.getLogger(BQAutoHealthQueryBL.class);
...
//		mAllLDHealthSet.add( tLDHealthSet );
	...
	*/
	...
	private boolean prepareHealthNew()
	{
		...
		String tSQL_Flag = "";
		tSQL_Flag = "select count(*) from lppol where insuredno='"+"?insuredno?"+"' "
...
//		+ "','13','2') from dual";
		...
		String tempAmnt = riskSql.getOneValue(sqlbv4);			
	...
	*/
	private boolean prepareHealth()
	{
	  ...
	  SQLwithBindVariables sqlbv14 = new SQLwithBindVariables();
		...
		sqlbv14.put("insuredno", this.mInsuredNo);
