 ...
 * @version 1.0
 */
public class RINewDistillBQ implements RIDistill {
	String mEventType;
	...
	private String getUnSQL() {
		...
		strBuffer.append(" decode(b.edortype,'AB',0,e.standprem) as PreStandPrem, ");
		strBuffer.append(" decode(b.edortype,'AB',0,e.prem) as PrePrem, ");
		strBuffer.append(" decode(b.edortype,'AB',0,e.RiskAmnt) as PreRiskAmnt, ");
		strBuffer.append(" decode(b.edortype,'AB',0,e.amnt) as PreAmnt, ");
		...
		System.out.println("保全提数公共部分sql: " + strBuffer.toString());
	...
	private String getSpecSQL() {
		...
		strBuffer.append(" from lcpol a ,lpedoritem b,Lcduty d,Lpduty e");
		System.out.println("保全临分提数公共部分sql: " + strBuffer.toString());
		return strBuffer.toString();
	}
	...
	private String getDistillSQL() {
		...
		strBuffer
				.append(" and ((d.Amnt - e.Amnt) <> 0 or (b.Edortype='AB' and a.Mainpolno!=a.Polno))");
		strBuffer
	...
	private String getDistillSQL1() {
		...
		strBuffer
				.append(" and  a.Polno=d.Polno and a.contno = e.Contno and b.edortype not in('CF','CT','ES')  and b.edorstate='0'");
		strBuffer.append("and a.Polno=e.Polno and d.Dutycode=e.Dutycode");
		strBuffer
				.append(" and e.Edorno =(select f.edorconfno from lpedorapp f where f.edoracceptno = b.edoracceptno)");
		strBuffer
	...
	public static void main(String[] args) {
		...
		RINewDistillBQ tRIDistillBQ = new RINewDistillBQ();
