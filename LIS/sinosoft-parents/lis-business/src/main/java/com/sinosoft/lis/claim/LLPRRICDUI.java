...
public class LLPRRICDUI {
private static Logger logger = Logger.getLogger(LLPRRICDUI.class);
	...
	public boolean submitData(VData cInputData, String cOperate) {
		...
		if (tLLPRRICDBL.submitData(cInputData, cOperate) == false) {
			// @@错误处理
			this.mErrors.copyAllErrors(tLLPRRICDBL.mErrors);
