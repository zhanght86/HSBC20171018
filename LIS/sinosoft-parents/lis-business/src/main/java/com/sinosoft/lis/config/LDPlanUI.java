 ...
 * @version 1.0
 */
public class LDPlanUI
{
private static Logger logger = Logger.getLogger(LDPlanUI.class);
    ...
    private LDPlanDutyParamSet mLDPlanDutyParamSet = new
            LDPlanDutyParamSet();
    ...
    public boolean submitData(VData cInputData, String cOperate)
    {
        ...
        LDPlanBL tLDPlanBL = new LDPlanBL();
        logger.debug("Start LDPlan UI Submit...");
        tLDPlanBL.submitData(mInputData, mOperate);
        logger.debug("End LDPlan UI Submit...");
        //如果有需要处理的错误，则返回
        if (tLDPlanBL.mErrors.needDealError())
        {
            // @@错误处理
            this.mErrors.copyAllErrors(tLDPlanBL.mErrors);
        ...
        {
            this.mResult.clear();
            this.mResult = tLDPlanBL.getResult();
        }
        mInputData = null;
        return true;
    }
