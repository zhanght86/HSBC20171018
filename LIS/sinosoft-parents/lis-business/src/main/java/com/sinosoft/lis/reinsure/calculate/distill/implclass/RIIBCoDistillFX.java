 ...
 * @version 1.0
 */
public class RIIBCoDistillFX implements RIDistill {
	String mEventType;
	...
	private boolean dealData() {
		try {
			...
			buildError("dealData", " 提取共保复效业务数据失败 " + ex.getMessage());
			return false;
		}
		return true;
	}
	...
	private String getDistillSQL() {
		...
		strBuffer.append(") ");
		System.out.println("共保复效提数sql: " + strBuffer.toString());
	...
	private String getDistillSQL1() {
		...
		strBuffer.append(" and a.Currency='01'");
		strBuffer.append(") ");
		System.out.println("共保复效临分提数sql: " + strBuffer.toString());
		return strBuffer.toString();
	}
	...
	public static void main(String[] args) {
		...
		RIIBCoDistillFX tRIDistillRN = new RIIBCoDistillFX();
