 ...
 *
 */
public class LRBsnsBillUI implements BusinessService{
    ...
    public boolean submitData(VData cInputData, String cOperate)
    {
        ...
        LRBsnsBillBL tLRBsnsBillBL = new LRBsnsBillBL();
        if (!tLRBsnsBillBL.submitData(cInputData, cOperate))
        {
            if (tLRBsnsBillBL.mErrors.needDealError())
            {
                this.mErrors.copyAllErrors(tLRBsnsBillBL.mErrors);
            }
            else
            {
        ...
        result = tLRBsnsBillBL.getResult();
        return true;   	    	
    }
