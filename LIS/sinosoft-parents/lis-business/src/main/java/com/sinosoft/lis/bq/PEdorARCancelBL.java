 ...
 */
public class PEdorARCancelBL implements EdorCancel
{
private static Logger logger = Logger.getLogger(PEdorARCancelBL.class);
    ...
    private boolean dealData(){
        ...
        {
        	String delSql = "delete from  " + tableForDel[i] + " where edorno = '" +
        	"?stredorno?" + "'";
