...
public class BQBankFailureNoticeTask extends TaskThread {
private static Logger logger = Logger.getLogger(BQBankFailureNoticeTask.class);
	public CErrors mErrors = new CErrors();

	public BQBankFailureNoticeTask() {
	}
