 ...
 * @version 1.0
 */
public class RIIBCoDistillCL implements RIDistill {
	String mEventType;
	...
	private String getDistillSQL() {
		...
		strBuffer
				.append(" nvl((SELECT x.interestrate FROM riinterest x where  x.enddate is null and x.state='01' and x.riskcode=a.riskcode and x.dutyname=g.Planlevel),0) as StandbyDouble2, ");
		strBuffer
...
/*		strBuffer.append(" (select sum(SuppRiskScore) from LCPrem where polno=a.polno and DutyCode=g.DutyCode and AddFeeDirect='01' and PayEndDate>'"+mRIWFLogSchema.getEndDate()+"') as ExtRate1, ");
	...
	public static void main(String[] args) {
		...
		RIIBCoDistillCL tRIDistillCL = new RIIBCoDistillCL();
