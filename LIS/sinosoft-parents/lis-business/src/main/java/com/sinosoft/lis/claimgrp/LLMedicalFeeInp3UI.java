...
import com.sinosoft.lis.claimgrp.LLMedicalFeeInp3BL;
 ...
 * @version 1.0
 */
public class LLMedicalFeeInp3UI implements BusinessService
{
private static Logger logger = Logger.getLogger(LLMedicalFeeInp3UI.class);
    ...
    public boolean submitData(VData cInputData, String cOperate)
    {
        ...
        LLMedicalFeeInp3BL tLLMedicalFeeInp3BL = new LLMedicalFeeInp3BL();

        logger.debug("----------LLMedicalFeeInp3UI Begin----------");
        if (tLLMedicalFeeInp3BL.submitData(mInputData, mOperate) == false)
        {
            // @@错误处理
            this.mErrors.copyAllErrors(tLLMedicalFeeInp3BL.mErrors);
            CError tError = new CError();
            tError.moduleName = "LLMedicalFeeInp3BLUI";
        ...
        {
            mResult = tLLMedicalFeeInp3BL.getResult();
        }
        logger.debug("----------LLMedicalFeeInp3UI End----------");
    ...
    public static void main(String[] args)
    {
        ...
        LLMedicalFeeInp3UI tLLMedicalFeeInp1UI = new LLMedicalFeeInp3UI();
