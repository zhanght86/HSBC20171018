 ...
 * @version 1.0
 */
public class FinFeeNotSureUI implements BusinessService{
private static Logger logger = Logger.getLogger(FinFeeNotSureUI.class);
	...
	public static void main(String[] args) {
		...
		p.setProposalNo("86120020020220000012");
		p.setPolNo("86120020020220000012");
		...
		tVData.add(tG);
		FinFeeNotSureUI ui = new FinFeeNotSureUI();
	...
	public boolean submitData(VData cInputData, String cOperate) {
		...
		FinFeeNotSureBL tFinFeeSureBL = new FinFeeNotSureBL();
		...
		if (tFinFeeSureBL.submitData(cInputData, mOperate) == false) {
			...
			tError.moduleName = "FinFeeSureUI";
