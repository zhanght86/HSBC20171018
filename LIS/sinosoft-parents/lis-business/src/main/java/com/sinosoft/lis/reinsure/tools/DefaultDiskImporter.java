 ...
 * </p>
 * <p>
 * Description: 只从一个Sheet中导入，而且导入的字段名和数据库绑定
 * </p>
 * <p>
...
public class DefaultDiskImporter extends MultiDiskImporter {
	...
	public static void main(String[] args) {
		...
		DefaultDiskImporter importer = new DefaultDiskImporter(fileName,
				configFileName, sheetName);
		importer.setSchemaClassName("com.sinosoft.lis.schema.LCInsuredListSchema");
		importer.setSchemaSetClassName("com.sinosoft.lis.vschema.LCInsuredListSet");
		importer.doImport();
