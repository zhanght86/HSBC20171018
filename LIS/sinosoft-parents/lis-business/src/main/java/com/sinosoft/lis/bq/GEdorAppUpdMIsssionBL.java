/*
 * @(#)GEdorAppUpdMIsssionBL.java	2005-09-29
 *
 ...
 */
public class GEdorAppUpdMIsssionBL {
private static Logger logger = Logger.getLogger(GEdorAppUpdMIsssionBL.class);
