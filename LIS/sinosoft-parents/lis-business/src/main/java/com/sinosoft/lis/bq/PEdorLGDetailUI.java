...
public class PEdorLGDetailUI {
private static Logger logger = Logger.getLogger(PEdorLGDetailUI.class);
	...
	public boolean submitData(VData cInputData, String cOperate) {
		...
		PEdorLGDetailBLF tPEdorLGDetailBLF = new PEdorLGDetailBLF();
		logger.debug("---UI BEGIN---" + mOperate+tPEdorLGDetailBLF);
		if (tPEdorLGDetailBLF.submitData(cInputData, mOperate) == false) {
			// @@错误处理
			this.mErrors.copyAllErrors(tPEdorLGDetailBLF.mErrors);
			...
			mResult = tPEdorLGDetailBLF.getResult();
		return true;
	}
