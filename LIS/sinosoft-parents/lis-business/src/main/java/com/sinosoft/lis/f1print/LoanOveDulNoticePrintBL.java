...
public class LoanOveDulNoticePrintBL implements PrintService {
	private static Logger logger = Logger
			.getLogger(LoanOveDulNoticePrintBL.class);
	...
	public LoanOveDulNoticePrintBL() {
	}
	...
	public static void main(String[] args) {
		...
		LoanOveDulNoticePrintBL gt = new LoanOveDulNoticePrintBL();
