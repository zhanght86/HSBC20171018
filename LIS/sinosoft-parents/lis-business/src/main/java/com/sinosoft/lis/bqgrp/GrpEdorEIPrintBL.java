...
public class GrpEdorEIPrintBL implements EdorPrint {
private static Logger logger = Logger.getLogger(GrpEdorEIPrintBL.class);
	...
	private boolean dealData() {
		...
		xmlexport.addDisplayControl("displayEI");
        ...
        ListTable tEIListTable = new ListTable();
        tEIListTable.setName("EI");

		String tNewEndDate = "";//新的止期
		ExeSQL tExeSQL = new ExeSQL();
		String tSql = "select max(payenddate) from lpgrppol where grpcontno = '"+tLCGrpContSchema.getGrpContNo()+"' and edorno = '"+mLPGrpEdorItemSchema.getEdorNo()+"' and edortype = '"+mLPGrpEdorItemSchema.getEdorType()+"'";
		...
		tSql = "select max(payenddate+1) from lcgrppol where grpcontno = '"+tLCGrpContSchema.getGrpContNo()+"'";
		...
		String[] b_strEI = new String[2];
		xmlexport.addListTable(tEIListTable, b_strEI);
