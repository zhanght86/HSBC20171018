...
/**
 * <p>Title: </p>
 * <p>Description:再保终止通用可参考提数程序 </p>
 * <p>Copyright: Copyright (c) 2008</p>
 * <p>Company: </p>
 * @author LIJIAN
 * @version 1.0
 */
public class RIDistillTN implements RIDistill {
    String mEventType;
    ...
    private boolean dealData(){
        try{
            ...
            buildError("dealData", " 提取终止业务数据失败 "+ex.getMessage());
            return false;
        }
        return true;
    }
 ...
 */
    private String getDistillSQL(){
        ...
        strBuffer.append(" '05' as EventType, ");//终止保单提数
        strBuffer.append(" '' as RecordType, ");
        strBuffer.append(" '01' as DataFlag, ");//01:个人险种 02：个人险种责任
        strBuffer.append(" a.PolNo || ',' || 'TN'||','||b.startdate as UnionKey, ");//终止主键：polno+'TN'+终止日期
        ...
        strBuffer.append(" b.startdate as GetDate, ");//保单终止日期
...
//      strBuffer.append(" and not exists (select * from RITempContLink where proposalno=a.proposalno )");
        ...
        strBuffer.append(" and not exists (Select 'X' From RIPolRecord m where m.unionkey=(a.PolNo||',' || 'TN'||','||b.startdate)) ");
        strBuffer.append(" and not exists (Select 'X' From RIPolRecordBake n where n.unionkey=(a.PolNo||',' || 'TN'||','||b.startdate)) ");
        ...
        strBuffer.append("')");
//      终止类型包括：01：满期终止 04：理赔终止 05：自垫终止 06：贷款终止 08：其他终止，这里不包括退保解约和失效终止，因为在退保解约和失效的时候程序已经进行了摊回
        strBuffer.append(" and b.statereason in('01','04','05','06','08') and b.enddate is null and b.statetype='Terminate' and b.state='1' and appflag ='4' and a.polno=b.polno ");
//      保单终止日期落在区间内
        strBuffer.append(" and b.startdate between '");
        ...
        System.out.println("终止提数sql: "+strBuffer.toString());
...
//          保单终止日期落在区间内           
            strBuffer.append(" and b.enddate is null and b.statereason in('01','04','05','06','08') and b.statetype='Terminate' and b.state='1' and appflag ='4' and a.polno=b.polno ");
            strBuffer.append(" and b.startdate between '");
            strBuffer.append(mRIWFLogSchema.getStartDate());
            strBuffer.append("' and '");
            strBuffer.append(mRIWFLogSchema.getEndDate());     
            strBuffer.append("')order by GetDate,polno");
            System.out.println("终止临分提数sql: "+strBuffer.toString());
            return strBuffer.toString();
        }
    ...
    public static void main(String[] args){
    	...
    	RIDistillTN tRIDistillTN = new RIDistillTN();  	
    	tRIDistillTN.test(cInputData, "01");
    }
}
