...
private static Logger logger = Logger.getLogger(UWRReportUI.class);
	...
	public static void main(String[] args) {
		...
		p.setProposalContNo("130210000000899");
		p.setContNo("130210000000899");
		...
		tLCRReportSchema.setContNo("130210000000899");
		tLCRReportSchema.setProposalContNo("130210000000899");
		tLCRReportSchema.setCustomerNo("0000000010");
		tLCRReportSchema.setName("naniya");

		LCRReportItemSchema tLCRReportItemSchema = new LCRReportItemSchema();

		tLCRReportItemSchema.setRReportItemCode("1");
