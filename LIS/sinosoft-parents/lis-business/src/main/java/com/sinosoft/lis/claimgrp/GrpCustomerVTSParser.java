...
public class GrpCustomerVTSParser {
private static Logger logger = Logger.getLogger(GrpCustomerVTSParser.class);
  ...
  // excel文件的sheet数量
  private static int SHEET_COUNT = 2;

  // sheet序列号,以及索引所在的列号
  private int SHEET_LLCASE = 0;
  private int STRID_COL_LLCASE = 0;

//  private int SHEET_LLSUBREPORT = 1;
//  private int STRID_COL_LLSUBREPORT = 1;
//
//  private int SHEET_LLAFFIX = 2;
//  private int STRID_COL_LLAFFIX = 1;

  private int SHEET_LLFEEMAIN = 1;
  private int STRID_COL_LLFEEMAIN = 1;

  private int SHEET_LLCASERECEIPT = 2;
  private int STRID_COL_LLCASERECEIPT = 1;
