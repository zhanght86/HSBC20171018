/*
* <p>ClassName: CertPlanUI </p>
* <p>Description: 单证查询统计的核心模块 </p>
* <p>Copyright: Copyright (c) 2002</p>
* <p>Company: sinosoft </p>
* @Database: lis
* @author guoxiang
* @CreateDate：2004-01-06
 */
...
import java.util.*;
public class CertPlanUI {
private static Logger logger = Logger.getLogger(CertPlanUI.class);
  ...
  */
  public boolean submitData(VData cInputData, String cOperate)
  {
    ...
    CertPlanBL tCertPlanBL = new CertPlanBL();

    if( !tCertPlanBL.submitData(mInputData, m_strOperate) ) {
      logger.debug("gxytesf");
      if( tCertPlanBL.mErrors.needDealError() ) {
        this.mErrors.copyAllErrors(tCertPlanBL.mErrors);
        return false;
      } else {
    ...
    this.mResult = tCertPlanBL.getResult();
    return true;
  }
  /**
   * 准备往后层输出所需要的数据
