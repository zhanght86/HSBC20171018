...
public class DANF1PBLS_MS {
private static Logger logger = Logger.getLogger(DANF1PBLS_MS.class);
	...
	public boolean submitData(VData cInputData, String cOperate) {
		...
		logger.debug("Start DANF1PBLS Submit...");
		...
		logger.debug("End DANF1PBLS Submit...");
