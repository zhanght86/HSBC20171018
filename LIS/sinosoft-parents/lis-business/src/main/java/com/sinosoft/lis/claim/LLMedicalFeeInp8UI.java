 ...
 * @version 1.0
 */
public class LLMedicalFeeInp8UI implements BusinessService{
private static Logger logger = Logger.getLogger(LLMedicalFeeInp8UI.class);
	...
	public boolean submitData(VData cInputData, String cOperate) {
		...
		LLMedicalFeeInp8BL tLLMedicalFeeInp8BL = new LLMedicalFeeInp8BL();

		logger.debug("----------LLMedicalFeeInp1UI Begin----------");
		if (tLLMedicalFeeInp8BL.submitData(mInputData, mOperate) == false) {
			// @@错误处理
			this.mErrors.copyAllErrors(tLLMedicalFeeInp8BL.mErrors);
			mResult.clear();
			return false;
		} else {
			mResult = tLLMedicalFeeInp8BL.getResult();
		}
	...
	public static void main(String[] args) {
		...
		LLMedicalFeeInp8UI tLLMedicalFeeInp1UI = new LLMedicalFeeInp8UI();
