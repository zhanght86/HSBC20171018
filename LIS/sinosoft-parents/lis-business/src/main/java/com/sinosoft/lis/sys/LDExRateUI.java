/*
 * <p>ClassName: LDExRateUI </p>
 * <p>Description: LDExRateUI类文件 </p>
...
public class LDExRateUI implements BusinessService
{
private static Logger logger = Logger.getLogger(LDExRateUI.class);
	...
	public boolean submitData(VData cInputData, String cOperate)
	{
		...
		LDExRateBL tLDExRateBL = new LDExRateBL();
		logger.debug("Start LDExRateUI Submit...");
		tLDExRateBL.submitData(mInputData, mOperate);
		logger.debug("End LDExRateUI Submit...");
		// 如果有需要处理的错误，则返回
		if (tLDExRateBL.mErrors.needDealError())
		{
			// @@错误处理
			this.mErrors.copyAllErrors(tLDExRateBL.mErrors);
		...
		{
			this.mResult.clear();
			this.mResult = tLDExRateBL.getResult();
		}
		mInputData = null;
		return true;
	}
