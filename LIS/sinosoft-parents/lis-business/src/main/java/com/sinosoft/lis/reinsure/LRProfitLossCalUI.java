...
public class LRProfitLossCalUI
{
    ...
    public boolean submitData(VData cInputData, String cOperate)
    {
        ...
        if (!tLRProfitLossCalBL.submitData(cInputData, cOperate))
        {
            if (tLRProfitLossCalBL.mErrors.needDealError())
            {
                this.mErrors.copyAllErrors(tLRProfitLossCalBL.mErrors);
            }
            else
            {
         ...
         mResult = tLRProfitLossCalBL.getResult();
        return true;
    }
