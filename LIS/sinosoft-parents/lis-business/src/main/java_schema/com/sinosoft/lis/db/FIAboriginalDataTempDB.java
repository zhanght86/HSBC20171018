...
/**
 * <p>ClassName: FIAboriginalDataTempDB </p>
 ...
 */
public class FIAboriginalDataTempDB extends FIAboriginalDataTempSchema
{
private static Logger logger = Logger.getLogger(FIAboriginalDataTempDB.class);
	...
	**/
	...
	// @Constructor
	public FIAboriginalDataTempDB( Connection tConnection )
	{
		con = tConnection;
		db = new DBOper( con, "FIAboriginalDataTemp" );
		mflag = true;
	}

	public FIAboriginalDataTempDB()
	{
		con = null;
		db = new DBOper( "FIAboriginalDataTemp" );
		mflag = false;
	}
	...
	{
		FIAboriginalDataTempSchema tSchema = this.getSchema();
		...
		else
		{
			...
			tError.moduleName = "FIAboriginalDataTempDB";
	...
	public boolean delete()
	{
		...
		try
		{
			pstmt = con.prepareStatement("DELETE FROM FIAboriginalDataTemp WHERE  ASerialNo = ?");
		...
		SQLString sqlObj = new SQLString("FIAboriginalDataTemp");
		sqlObj.setSQL(4, this);
		sqlObj.getSQL();
//真实的执行语句
logger.debug(String.valueOf("True Error Sql is : DELETE FROM FIAboriginalDataTemp WHERE ASerialNo='"+this.getASerialNo() + "'").replaceAll("'null'", "null"));
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.getReturnFlag() == null || this.getReturnFlag().equals("null")) {
				...
				pstmt.setString(67, this.getReturnFlag().trim());
			}
			if(this.getVoucherno() == null || this.getVoucherno().equals("null")) {
				pstmt.setNull(68, 12);
			} else {
				pstmt.setString(68, this.getVoucherno().trim());
			}
			if(this.getReturndate() == null || this.getReturndate().equals("null")) {
				pstmt.setNull(69, 91);
			} else {
				pstmt.setDate(69, Date.valueOf(this.getReturndate()));
			}
			if(this.getReturntime() == null || this.getReturntime().equals("null")) {
				pstmt.setNull(70, 12);
			} else {
				pstmt.setString(70, this.getReturntime().trim());
			}
			if(this.getDealoperator() == null || this.getDealoperator().equals("null")) {
				pstmt.setNull(71, 12);
			} else {
				pstmt.setString(71, this.getDealoperator().trim());
			}
			// set where condition
			if(this.getASerialNo() == null || this.getASerialNo().equals("null")) {
				pstmt.setNull(72, 12);
			} else {
				pstmt.setString(72, this.getASerialNo().trim());
			}
			pstmt.executeUpdate();
			pstmt.close();
		} catch (Exception ex) {
...
logger.debug(String.valueOf("True Error Sql is : UPDATE FIAboriginalDataTemp SET ASerialNo='"+this.getASerialNo() + "'" + " , AcquisitionID='"+this.getAcquisitionID() + "'" + " , DataBaseID='"+this.getDataBaseID() + "'" + " , BatchNo='"+this.getBatchNo() + "'" + " , CertificateID='"+this.getCertificateID() + "'" + " , CostID='"+this.getCostID() + "'" + " , DataState='"+this.getDataState() + "'" + " , CheckFlag='"+this.getCheckFlag() + "'" + " , BusinessCode='"+this.getBusinessCode() + "'" + " , FeeCode='"+this.getFeeCode() + "'" + " , SumActuMoney="+this.getSumActuMoney() + " , AccountDate='"+this.getAccountDate() + "'" + " , BusinessNo='"+this.getBusinessNo() + "'" + " , StringInfo01='"+this.getStringInfo01() + "'" + " , StringInfo02='"+this.getStringInfo02() + "'" + " , StringInfo03='"+this.getStringInfo03() + "'" + " , StringInfo04='"+this.getStringInfo04() + "'" + " , StringInfo05='"+this.getStringInfo05() + "'" + " , StringInfo06='"+this.getStringInfo06() + "'" + " , StringInfo07='"+this.getStringInfo07() + "'" + " , StringInfo08='"+this.getStringInfo08() + "'" + " , StringInfo09='"+this.getStringInfo09() + "'" + " , StringInfo10='"+this.getStringInfo10() + "'" + " , StringInfo11='"+this.getStringInfo11() + "'" + " , StringInfo12='"+this.getStringInfo12() + "'" + " , StringInfo13='"+this.getStringInfo13() + "'" + " , StringInfo14='"+this.getStringInfo14() + "'" + " , StringInfo15='"+this.getStringInfo15() + "'" + " , DateInfo01='"+this.getDateInfo01() + "'" + " , DateInfo02='"+this.getDateInfo02() + "'" + " , DateInfo03='"+this.getDateInfo03() + "'" + " , DateInfo04='"+this.getDateInfo04() + "'" + " , DateInfo05='"+this.getDateInfo05() + "'" + " , DateInfo06='"+this.getDateInfo06() + "'" + " , DateInfo07='"+this.getDateInfo07() + "'" + " , DateInfo08='"+this.getDateInfo08() + "'" + " , DateInfo09='"+this.getDateInfo09() + "'" + " , DateInfo10='"+this.getDateInfo10() + "'" + " , NumInfo01="+this.getNumInfo01() + " , NumInfo02="+this.getNumInfo02() + " , NumInfo03="+this.getNumInfo03() + " , NumInfo04="+this.getNumInfo04() + " , NumInfo05="+this.getNumInfo05() + " , BusinessNo01='"+this.getBusinessNo01() + "'" + " , BusinessNo02='"+this.getBusinessNo02() + "'" + " , BusinessNo03='"+this.getBusinessNo03() + "'" + " , BusinessNo04='"+this.getBusinessNo04() + "'" + " , BusinessNo05='"+this.getBusinessNo05() + "'" + " , BusinessNo06='"+this.getBusinessNo06() + "'" + " , BusinessNo07='"+this.getBusinessNo07() + "'" + " , BusinessNo08='"+this.getBusinessNo08() + "'" + " , BusinessNo09='"+this.getBusinessNo09() + "'" + " , BusinessNo10='"+this.getBusinessNo10() + "'" + " , TypeFlag01='"+this.getTypeFlag01() + "'" + " , TypeFlag02='"+this.getTypeFlag02() + "'" + " , TypeFlag03='"+this.getTypeFlag03() + "'" + " , TypeFlag04='"+this.getTypeFlag04() + "'" + " , TypeFlag05='"+this.getTypeFlag05() + "'" + " , TypeFlag06='"+this.getTypeFlag06() + "'" + " , TypeFlag07='"+this.getTypeFlag07() + "'" + " , TypeFlag08='"+this.getTypeFlag08() + "'" + " , TypeFlag09='"+this.getTypeFlag09() + "'" + " , TypeFlag10='"+this.getTypeFlag10() + "'" + " , Relationcode='"+this.getRelationcode() + "'" + " , MakeDate='"+this.getMakeDate() + "'" + " , MakeTime='"+this.getMakeTime() + "'" + " , ReturnFlag='"+this.getReturnFlag() + "'" + " , Voucherno='"+this.getVoucherno() + "'" + " , Returndate='"+this.getReturndate() + "'" + " , Returntime='"+this.getReturntime() + "'" + " , Dealoperator='"+this.getDealoperator() + "'"+" WHERE ASerialNo='"+this.getASerialNo() + "'").replaceAll("'null'", "null"));
	...
	public boolean insert()
	{
		...
		try
		{
			pstmt = con.prepareStatement("INSERT INTO FIAboriginalDataTemp VALUES( ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ?)");
			if(this.getASerialNo() == null || this.getASerialNo().equals("null")) {
				pstmt.setNull(1, 12);
			} else {
				pstmt.setString(1, this.getASerialNo().trim());
...
logger.debug(String.valueOf("True Error Sql is : INSERT INTO FIAboriginalDataTemp VALUES('"+this.getASerialNo() + "'"+",'"+this.getAcquisitionID() + "'"+",'"+this.getDataBaseID() + "'"+",'"+this.getBatchNo() + "'"+",'"+this.getCertificateID() + "'"+",'"+this.getCostID() + "'"+",'"+this.getDataState() + "'"+",'"+this.getCheckFlag() + "'"+",'"+this.getBusinessCode() + "'"+",'"+this.getFeeCode() + "'"+","+this.getSumActuMoney()+",'"+this.getAccountDate() + "'"+",'"+this.getBusinessNo() + "'"+",'"+this.getStringInfo01() + "'"+",'"+this.getStringInfo02() + "'"+",'"+this.getStringInfo03() + "'"+",'"+this.getStringInfo04() + "'"+",'"+this.getStringInfo05() + "'"+",'"+this.getStringInfo06() + "'"+",'"+this.getStringInfo07() + "'"+",'"+this.getStringInfo08() + "'"+",'"+this.getStringInfo09() + "'"+",'"+this.getStringInfo10() + "'"+",'"+this.getStringInfo11() + "'"+",'"+this.getStringInfo12() + "'"+",'"+this.getStringInfo13() + "'"+",'"+this.getStringInfo14() + "'"+",'"+this.getStringInfo15() + "'"+",'"+this.getDateInfo01() + "'"+",'"+this.getDateInfo02() + "'"+",'"+this.getDateInfo03() + "'"+",'"+this.getDateInfo04() + "'"+",'"+this.getDateInfo05() + "'"+",'"+this.getDateInfo06() + "'"+",'"+this.getDateInfo07() + "'"+",'"+this.getDateInfo08() + "'"+",'"+this.getDateInfo09() + "'"+",'"+this.getDateInfo10() + "'"+","+this.getNumInfo01()+","+this.getNumInfo02()+","+this.getNumInfo03()+","+this.getNumInfo04()+","+this.getNumInfo05()+",'"+this.getBusinessNo01() + "'"+",'"+this.getBusinessNo02() + "'"+",'"+this.getBusinessNo03() + "'"+",'"+this.getBusinessNo04() + "'"+",'"+this.getBusinessNo05() + "'"+",'"+this.getBusinessNo06() + "'"+",'"+this.getBusinessNo07() + "'"+",'"+this.getBusinessNo08() + "'"+",'"+this.getBusinessNo09() + "'"+",'"+this.getBusinessNo10() + "'"+",'"+this.getTypeFlag01() + "'"+",'"+this.getTypeFlag02() + "'"+",'"+this.getTypeFlag03() + "'"+",'"+this.getTypeFlag04() + "'"+",'"+this.getTypeFlag05() + "'"+",'"+this.getTypeFlag06() + "'"+",'"+this.getTypeFlag07() + "'"+",'"+this.getTypeFlag08() + "'"+",'"+this.getTypeFlag09() + "'"+",'"+this.getTypeFlag10() + "'"+",'"+this.getRelationcode() + "'"+",'"+this.getMakeDate() + "'"+",'"+this.getMakeTime() + "'"+",'"+this.getReturnFlag() + "'"+",'"+this.getVoucherno() + "'"+",'"+this.getReturndate() + "'"+",'"+this.getReturntime() + "'"+",'"+this.getDealoperator() + "'"+")").replaceAll("'null'", "null"));
	...
	public boolean getInfo()
	{
		...
		try
		{
			pstmt = con.prepareStatement("SELECT * FROM FIAboriginalDataTemp WHERE  ASerialNo = ?", 
	...
	public FIAboriginalDataTempSet query()
	{
		PreparedStatement pstmt = null;
 		ResultSet rs = null;
		FIAboriginalDataTempSet aFIAboriginalDataTempSet = new FIAboriginalDataTempSet();
	  ...
	  if( !mflag ) {
		...
		{
			SQLString sqlObj = new SQLString("FIAboriginalDataTemp");
			FIAboriginalDataTempSchema aSchema = this.getSchema();
			...
			{
				i++;
				FIAboriginalDataTempSchema s1 = new FIAboriginalDataTempSchema();
				s1.setSchema(rs,i);
				aFIAboriginalDataTempSet.add(s1);
			}
			try{ rs.close(); } catch( Exception ex ) {}
			try{ pstmt.close(); } catch( Exception ex1 ) {}
		}
		...
		return aFIAboriginalDataTempSet;

	}

	public FIAboriginalDataTempSet executeQuery(String sql)
	{
		Statement stmt = null;
		ResultSet rs = null;
		FIAboriginalDataTempSet aFIAboriginalDataTempSet = new FIAboriginalDataTempSet();
	...
	public FIAboriginalDataTempSet query(int nStart, int nCount)
	{
		PreparedStatement pstmt = null;
 		ResultSet rs = null;
		FIAboriginalDataTempSet aFIAboriginalDataTempSet = new FIAboriginalDataTempSet();
	...
	public FIAboriginalDataTempSet executeQuery(String sql, int nStart, int nCount)
	{
		Statement stmt = null;
		ResultSet rs = null;
		FIAboriginalDataTempSet aFIAboriginalDataTempSet = new FIAboriginalDataTempSet();
	...
	public boolean update(String strWherePart)
	{
	  ...
	  if( !mflag ) {
		...
		try
		{
			...
			String sql = "update FIAboriginalDataTemp " + sqlObj.getUpdPart() + " where " + strWherePart;
...
/**
 * 获取定量数据
 * @return FIAboriginalDataTempSet
 */
public FIAboriginalDataTempSet getData()
{
    int tCount = 0;
    FIAboriginalDataTempSet tFIAboriginalDataTempSet = new FIAboriginalDataTempSet();
    FIAboriginalDataTempSchema tFIAboriginalDataTempSchema = null;
    if (null == mResultSet)
    {
        CError tError = new CError();
        tError.moduleName = "FIAboriginalDataTempDB";
    ...
    {
        tCount = 1;
        tFIAboriginalDataTempSchema = new FIAboriginalDataTempSchema();
        tFIAboriginalDataTempSchema.setSchema(mResultSet, 1);
    ...
    return tFIAboriginalDataTempSet;
}
/**
 * 关闭数据集
 * @return boolean
...
public boolean closeData()
{
	...
	public FIAboriginalDataTempSet executeQuery(SQLwithBindVariables sqlbv) {
	...
	public FIAboriginalDataTempSet executeQuery(SQLwithBindVariables sqlbv, int nStart, int nCount) {
