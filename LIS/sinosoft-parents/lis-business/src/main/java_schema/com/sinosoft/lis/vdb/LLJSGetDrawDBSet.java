...
/*
 * <p>ClassName: LLJSGetDrawDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 多币种改造业务表
 */
public class LLJSGetDrawDBSet extends LLJSGetDrawSet
{
private static Logger logger = Logger.getLogger(LLJSGetDrawDBSet.class);
	...
	**/
	...
	// @Constructor
	public LLJSGetDrawDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LLJSGetDrawDBSet";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getGetDate() == null || this.get(i).getGetDate().equals("null")) {
				...
				pstmt.setDate(12, Date.valueOf(this.get(i).getGetDate()));
			}
			pstmt.setDouble(13, this.get(i).getGetMoney());
			if(this.get(i).getEnterAccDate() == null || this.get(i).getEnterAccDate().equals("null")) {
				pstmt.setDate(14,null);
			} else {
				pstmt.setDate(14, Date.valueOf(this.get(i).getEnterAccDate()));
			}
			...
			if(this.get(i).getKindCode() == null || this.get(i).getKindCode().equals("null")) {
				...
				pstmt.setString(18, this.get(i).getKindCode());
			}
			...
			if(this.get(i).getRiskVersion() == null || this.get(i).getRiskVersion().equals("null")) {
				...
				pstmt.setString(20, this.get(i).getRiskVersion());
			}
			...
			if(this.get(i).getApproveCode() == null || this.get(i).getApproveCode().equals("null")) {
				...
				pstmt.setString(34, this.get(i).getApproveCode());
			}
			if(this.get(i).getApproveDate() == null || this.get(i).getApproveDate().equals("null")) {
				pstmt.setDate(35,null);
			} else {
				pstmt.setDate(35, Date.valueOf(this.get(i).getApproveDate()));
			}
			if(this.get(i).getApproveTime() == null || this.get(i).getApproveTime().equals("null")) {
				pstmt.setString(36,null);
			} else {
				pstmt.setString(36, this.get(i).getApproveTime());
			}
			if(this.get(i).getSerialNo() == null || this.get(i).getSerialNo().equals("null")) {
				pstmt.setString(37,null);
			} else {
				pstmt.setString(37, this.get(i).getSerialNo());
			}
			...
			if(this.get(i).getGetNoticeNo() == null || this.get(i).getGetNoticeNo().equals("null")) {
				...
				pstmt.setString(47, this.get(i).getGetNoticeNo());
			}
			if(this.get(i).getPolNo() == null || this.get(i).getPolNo().equals("null")) {
