...
/*
 * <p>ClassName: LPGrpIssuePolDB </p>
 * <p>Description: DB层数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 保全流程
 */
public class LPGrpIssuePolDB extends LPGrpIssuePolSchema
{
private static Logger logger = Logger.getLogger(LPGrpIssuePolDB.class);
	...
	**/
	...
	// @Constructor
	public LPGrpIssuePolDB( Connection tConnection )
	{
		con = tConnection;
	...
	{
		LPGrpIssuePolSchema tSchema = this.getSchema();
		...
		else
		{
			...
			tError.moduleName = "LPGrpIssuePolDB";
	...
	public boolean getInfo()
	{
		...
		try
		{
			pstmt = con.prepareStatement("SELECT * FROM LPGrpIssuePol WHERE  EdorNo = ? AND EdorType = ? AND ProposalGrpContNo = ? AND SerialNo = ?", 
	...
	public LPGrpIssuePolSet query()
	{
		PreparedStatement pstmt = null;
 		ResultSet rs = null;
		LPGrpIssuePolSet aLPGrpIssuePolSet = new LPGrpIssuePolSet();
	  ...
	  if( !mflag ) {
		...
		{
			SQLString sqlObj = new SQLString("LPGrpIssuePol");
			LPGrpIssuePolSchema aSchema = this.getSchema();
			...
			{
				i++;
				LPGrpIssuePolSchema s1 = new LPGrpIssuePolSchema();
				s1.setSchema(rs,i);
				aLPGrpIssuePolSet.add(s1);
			}
			try{ rs.close(); } catch( Exception ex ) {}
			try{ pstmt.close(); } catch( Exception ex1 ) {}
		}
		...
		return aLPGrpIssuePolSet;

	}

	public LPGrpIssuePolSet executeQuery(String sql)
	{
		Statement stmt = null;
		ResultSet rs = null;
		LPGrpIssuePolSet aLPGrpIssuePolSet = new LPGrpIssuePolSet();
	...
	public LPGrpIssuePolSet query(int nStart, int nCount)
	{
		PreparedStatement pstmt = null;
 		ResultSet rs = null;
		LPGrpIssuePolSet aLPGrpIssuePolSet = new LPGrpIssuePolSet();
	...
	public LPGrpIssuePolSet executeQuery(String sql, int nStart, int nCount)
	{
		Statement stmt = null;
		ResultSet rs = null;
		LPGrpIssuePolSet aLPGrpIssuePolSet = new LPGrpIssuePolSet();
	...
	public boolean update(String strWherePart)
	{
	  ...
	  if( !mflag ) {
		...
		try
		{
			...
			String sql = "update LPGrpIssuePol " + sqlObj.getUpdPart() + " where " + strWherePart;
...
/**
 * 获取定量数据
 * @return LPGrpIssuePolSet
 */
public LPGrpIssuePolSet getData()
{
    int tCount = 0;
    LPGrpIssuePolSet tLPGrpIssuePolSet = new LPGrpIssuePolSet();
    LPGrpIssuePolSchema tLPGrpIssuePolSchema = null;
    if (null == mResultSet)
    {
        CError tError = new CError();
        tError.moduleName = "LPGrpIssuePolDB";
    ...
    {
        tCount = 1;
        tLPGrpIssuePolSchema = new LPGrpIssuePolSchema();
        tLPGrpIssuePolSchema.setSchema(mResultSet, 1);
        tLPGrpIssuePolSet.add(tLPGrpIssuePolSchema);
...
public boolean closeData()
{
	...
	public LPGrpIssuePolSet executeQuery(SQLwithBindVariables sqlbv) {
	...
	public LPGrpIssuePolSet executeQuery(SQLwithBindVariables sqlbv, int nStart, int nCount) {
