...
/*
 * <p>ClassName: PD_LMDiscountDB </p>
 * <p>Description: DB层数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 产品定义平台补充表
 */
public class PD_LMDiscountDB extends PD_LMDiscountSchema
{
private static Logger logger = Logger.getLogger(PD_LMDiscountDB.class);
	...
	**/
	...
	// @Constructor
	public PD_LMDiscountDB( Connection tConnection )
	{
		con = tConnection;
	...
	{
		PD_LMDiscountSchema tSchema = this.getSchema();
		...
		else
		{
			...
			tError.moduleName = "PD_LMDiscountDB";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.getDiscountCode() == null || this.getDiscountCode().equals("null")) {
				...
				pstmt.setString(21, this.getDiscountCode());
			}
			pstmt.executeUpdate();
			pstmt.close();
		} catch (Exception ex) {
	...
	public boolean getInfo()
	{
		...
		try
		{
			pstmt = con.prepareStatement("SELECT * FROM PD_LMDiscount WHERE  DiscountCode = ?", 
	...
	public PD_LMDiscountSet query()
	{
		PreparedStatement pstmt = null;
 		ResultSet rs = null;
		PD_LMDiscountSet aPD_LMDiscountSet = new PD_LMDiscountSet();
	  ...
	  if( !mflag ) {
		...
		{
			SQLString sqlObj = new SQLString("PD_LMDiscount");
			PD_LMDiscountSchema aSchema = this.getSchema();
			...
			{
				i++;
				PD_LMDiscountSchema s1 = new PD_LMDiscountSchema();
				s1.setSchema(rs,i);
				aPD_LMDiscountSet.add(s1);
			}
			try{ rs.close(); } catch( Exception ex ) {}
			try{ pstmt.close(); } catch( Exception ex1 ) {}
		}
		...
		return aPD_LMDiscountSet;

	}

	public PD_LMDiscountSet executeQuery(String sql)
	{
		Statement stmt = null;
		ResultSet rs = null;
		PD_LMDiscountSet aPD_LMDiscountSet = new PD_LMDiscountSet();
	...
	public PD_LMDiscountSet query(int nStart, int nCount)
	{
		PreparedStatement pstmt = null;
 		ResultSet rs = null;
		PD_LMDiscountSet aPD_LMDiscountSet = new PD_LMDiscountSet();
	...
	public PD_LMDiscountSet executeQuery(String sql, int nStart, int nCount)
	{
		Statement stmt = null;
		ResultSet rs = null;
		PD_LMDiscountSet aPD_LMDiscountSet = new PD_LMDiscountSet();
	...
	public boolean update(String strWherePart)
	{
	  ...
	  if( !mflag ) {
		...
		try
		{
			...
			String sql = "update PD_LMDiscount " + sqlObj.getUpdPart() + " where " + strWherePart;
...
/**
 * 获取定量数据
 * @return PD_LMDiscountSet
 */
public PD_LMDiscountSet getData()
{
    int tCount = 0;
    PD_LMDiscountSet tPD_LMDiscountSet = new PD_LMDiscountSet();
    PD_LMDiscountSchema tPD_LMDiscountSchema = null;
    if (null == mResultSet)
    {
        CError tError = new CError();
        tError.moduleName = "PD_LMDiscountDB";
    ...
    {
        tCount = 1;
        tPD_LMDiscountSchema = new PD_LMDiscountSchema();
        tPD_LMDiscountSchema.setSchema(mResultSet, 1);
        tPD_LMDiscountSet.add(tPD_LMDiscountSchema);
...
public boolean closeData()
{
	...
	public PD_LMDiscountSet executeQuery(SQLwithBindVariables sqlbv) {
	...
	public PD_LMDiscountSet executeQuery(SQLwithBindVariables sqlbv, int nStart, int nCount) {
