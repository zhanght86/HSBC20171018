...
/*
 * <p>ClassName: RIUWTaskDB </p>
 * <p>Description: DB层数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 再保系统模型
 */
public class RIUWTaskDB extends RIUWTaskSchema
{
	// @Field
	...
	**/
	...
	// @Constructor
	public RIUWTaskDB( Connection tConnection )
	{
		con = tConnection;
	...
	{
		RIUWTaskSchema tSchema = this.getSchema();
	...
	public boolean getInfo()
	{
		...
		try
		{
			pstmt = con.prepareStatement("SELECT * FROM RIUWTask WHERE  SerialNo = ?", 
	...
	public RIUWTaskSet query()
	{
		Statement stmt = null;
		ResultSet rs = null;
		RIUWTaskSet aRIUWTaskSet = new RIUWTaskSet();
	  ...
	  if( !mflag ) {
		...
		try
		{
			...
			SQLString sqlObj = new SQLString("RIUWTask");
			RIUWTaskSchema aSchema = this.getSchema();
			...
			{
				i++;
				RIUWTaskSchema s1 = new RIUWTaskSchema();
				s1.setSchema(rs,i);
				aRIUWTaskSet.add(s1);
			}
			try{ rs.close(); } catch( Exception ex ) {}
	...
	public RIUWTaskSet executeQuery(String sql)
	{
		Statement stmt = null;
		ResultSet rs = null;
		RIUWTaskSet aRIUWTaskSet = new RIUWTaskSet();
	...
	public RIUWTaskSet query(int nStart, int nCount)
	{
		Statement stmt = null;
		ResultSet rs = null;
		RIUWTaskSet aRIUWTaskSet = new RIUWTaskSet();
	...
	public RIUWTaskSet executeQuery(String sql, int nStart, int nCount)
	{
		Statement stmt = null;
		ResultSet rs = null;
		RIUWTaskSet aRIUWTaskSet = new RIUWTaskSet();
	...
	public boolean update(String strWherePart)
	{
	  ...
	  if( !mflag ) {
		...
		try
		{
			...
			String sql = "update RIUWTask " + sqlObj.getUpdPart() + " where " + strWherePart;
 ...
 * @return RIUWTaskSet
 */
public RIUWTaskSet getData()
{
    int tCount = 0;
    RIUWTaskSet tRIUWTaskSet = new RIUWTaskSet();
    RIUWTaskSchema tRIUWTaskSchema = null;
    if (null == mResultSet)
    {
        CError tError = new CError();
        tError.moduleName = "RIUWTaskDB";
    ...
    try
    {
        ...
        tRIUWTaskSchema.setSchema(mResultSet, 1);
        tRIUWTaskSet.add(tRIUWTaskSchema);
