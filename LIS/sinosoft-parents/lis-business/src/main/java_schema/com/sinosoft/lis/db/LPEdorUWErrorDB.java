...
/*
 * <p>ClassName: LPEdorUWErrorDB </p>
 * <p>Description: DB层数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 保全流程
 */
public class LPEdorUWErrorDB extends LPEdorUWErrorSchema
{
private static Logger logger = Logger.getLogger(LPEdorUWErrorDB.class);
	...
	**/
	...
	// @Constructor
	public LPEdorUWErrorDB( Connection tConnection )
	{
		con = tConnection;
	...
	{
		LPEdorUWErrorSchema tSchema = this.getSchema();
		...
		else
		{
			...
			tError.moduleName = "LPEdorUWErrorDB";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.getAppntName() == null || this.getAppntName().equals("null")) {
				...
				pstmt.setString(14, this.getAppntName());
			}
			...
			if(this.getUWRuleCode() == null || this.getUWRuleCode().equals("null")) {
				...
				pstmt.setString(16, this.getUWRuleCode());
			}
			if(this.getUWError() == null || this.getUWError().equals("null")) {
				pstmt.setNull(17, 12);
			} else {
				pstmt.setString(17, this.getUWError());
			}
			if(this.getCurrValue() == null || this.getCurrValue().equals("null")) {
				pstmt.setNull(18, 12);
			} else {
				pstmt.setString(18, this.getCurrValue());
			}
			...
			if(this.getEdorAcceptNo() == null || this.getEdorAcceptNo().equals("null")) {
				...
				pstmt.setString(24, this.getEdorAcceptNo());
			}
			if(this.getEdorNo() == null || this.getEdorNo().equals("null")) {
				pstmt.setNull(25, 12);
			} else {
	...
	public boolean getInfo()
	{
		...
		try
		{
			pstmt = con.prepareStatement("SELECT * FROM LPEdorUWError WHERE  EdorAcceptNo = ? AND EdorNo = ? AND EdorType = ? AND SerialNo = ?", 
	...
	public LPEdorUWErrorSet query()
	{
		PreparedStatement pstmt = null;
 		ResultSet rs = null;
		LPEdorUWErrorSet aLPEdorUWErrorSet = new LPEdorUWErrorSet();
	  ...
	  if( !mflag ) {
		...
		{
			SQLString sqlObj = new SQLString("LPEdorUWError");
			LPEdorUWErrorSchema aSchema = this.getSchema();
			...
			{
				i++;
				LPEdorUWErrorSchema s1 = new LPEdorUWErrorSchema();
				s1.setSchema(rs,i);
				aLPEdorUWErrorSet.add(s1);
			}
			try{ rs.close(); } catch( Exception ex ) {}
			try{ pstmt.close(); } catch( Exception ex1 ) {}
		}
		...
		return aLPEdorUWErrorSet;

	}

	public LPEdorUWErrorSet executeQuery(String sql)
	{
		Statement stmt = null;
		ResultSet rs = null;
		LPEdorUWErrorSet aLPEdorUWErrorSet = new LPEdorUWErrorSet();
	...
	public LPEdorUWErrorSet query(int nStart, int nCount)
	{
		PreparedStatement pstmt = null;
 		ResultSet rs = null;
		LPEdorUWErrorSet aLPEdorUWErrorSet = new LPEdorUWErrorSet();
	...
	public LPEdorUWErrorSet executeQuery(String sql, int nStart, int nCount)
	{
		Statement stmt = null;
		ResultSet rs = null;
		LPEdorUWErrorSet aLPEdorUWErrorSet = new LPEdorUWErrorSet();
	...
	public boolean update(String strWherePart)
	{
	  ...
	  if( !mflag ) {
		...
		try
		{
			...
			String sql = "update LPEdorUWError " + sqlObj.getUpdPart() + " where " + strWherePart;
...
/**
 * 获取定量数据
 * @return LPEdorUWErrorSet
 */
public LPEdorUWErrorSet getData()
{
    int tCount = 0;
    LPEdorUWErrorSet tLPEdorUWErrorSet = new LPEdorUWErrorSet();
    LPEdorUWErrorSchema tLPEdorUWErrorSchema = null;
    if (null == mResultSet)
    {
        CError tError = new CError();
        tError.moduleName = "LPEdorUWErrorDB";
    ...
    {
        tCount = 1;
        tLPEdorUWErrorSchema = new LPEdorUWErrorSchema();
        tLPEdorUWErrorSchema.setSchema(mResultSet, 1);
        tLPEdorUWErrorSet.add(tLPEdorUWErrorSchema);
...
public boolean closeData()
{
	...
	public LPEdorUWErrorSet executeQuery(SQLwithBindVariables sqlbv) {
	...
	public LPEdorUWErrorSet executeQuery(SQLwithBindVariables sqlbv, int nStart, int nCount) {
