...
/*
 * <p>ClassName: PD_LMEdorZT1DBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 产品定义平台_PDM
 */
public class PD_LMEdorZT1DBSet extends PD_LMEdorZT1Set
{
private static Logger logger = Logger.getLogger(PD_LMEdorZT1DBSet.class);
	...
	**/
	...
	// @Constructor
	public PD_LMEdorZT1DBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "PD_LMEdorZT1DBSet";
...
ex.printStackTrace();
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getOnePayCalCode() == null || this.get(i).getOnePayCalCode().equals("null")) {
				pstmt.setString(11,null);
			} else {
				pstmt.setString(11, this.get(i).getOnePayCalCode());
			}
			if(this.get(i).getOnePayIntvType() == null || this.get(i).getOnePayIntvType().equals("null")) {
				pstmt.setString(12,null);
			} else {
				pstmt.setString(12, this.get(i).getOnePayIntvType());
			}
			if(this.get(i).getOutGetType() == null || this.get(i).getOutGetType().equals("null")) {
				pstmt.setString(13,null);
			} else {
				pstmt.setString(13, this.get(i).getOutGetType());
			}
			if(this.get(i).getCashValueCode() == null || this.get(i).getCashValueCode().equals("null")) {
				pstmt.setString(14,null);
			} else {
				pstmt.setString(14, this.get(i).getCashValueCode());
			}
			...
			if(this.get(i).getDutyCode() == null || this.get(i).getDutyCode().equals("null")) {
				...
				pstmt.setString(27, this.get(i).getDutyCode());
			}
			if(this.get(i).getPayPlanCode() == null || this.get(i).getPayPlanCode().equals("null")) {
				pstmt.setString(28,null);
			} else {
				pstmt.setString(28, this.get(i).getPayPlanCode());
			}
			if(this.get(i).getSurrCalType() == null || this.get(i).getSurrCalType().equals("null")) {
				pstmt.setString(29,null);
			} else {
				pstmt.setString(29, this.get(i).getSurrCalType());
			}
			if(this.get(i).getCycPayIntvType() == null || this.get(i).getCycPayIntvType().equals("null")) {
				pstmt.setString(30,null);
			} else {
				pstmt.setString(30, this.get(i).getCycPayIntvType());
			}
