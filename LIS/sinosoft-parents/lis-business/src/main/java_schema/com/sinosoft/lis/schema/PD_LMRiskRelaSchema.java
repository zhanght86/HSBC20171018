...
import com.sinosoft.lis.db.PD_LMRiskRelaDB;

/**
 * <p>ClassName: PD_LMRiskRelaSchema </p>
 ...
 */
public class PD_LMRiskRelaSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(PD_LMRiskRelaSchema.class);
    ...
    {
        PD_LMRiskRelaSchema cloned = (PD_LMRiskRelaSchema)super.clone();
    ...
    /**
     * 使用另外一个 PD_LMRiskRelaSchema 对象给 Schema 赋值
     * @param: aPD_LMRiskRelaSchema PD_LMRiskRelaSchema
     **/
    public void setSchema(PD_LMRiskRelaSchema aPD_LMRiskRelaSchema)
    {
        this.RiskCode = aPD_LMRiskRelaSchema.getRiskCode();
        this.RelaRiskCode = aPD_LMRiskRelaSchema.getRelaRiskCode();
        this.RelaCode = aPD_LMRiskRelaSchema.getRelaCode();
        this.ManageComGrp = aPD_LMRiskRelaSchema.getManageComGrp();
        this.DKSubPrem = aPD_LMRiskRelaSchema.getDKSubPrem();
        this.Operator = aPD_LMRiskRelaSchema.getOperator();
        this.MakeDate = fDate.getDate(aPD_LMRiskRelaSchema.getMakeDate());
        this.MakeTime = aPD_LMRiskRelaSchema.getMakeTime();
        this.ModifyDate = fDate.getDate(aPD_LMRiskRelaSchema.getModifyDate());
        this.ModifyTime = aPD_LMRiskRelaSchema.getModifyTime();
        this.Standbyflag1 = aPD_LMRiskRelaSchema.getStandbyflag1();
        this.Standbyflag2 = aPD_LMRiskRelaSchema.getStandbyflag2();
        this.Standbyflag3 = aPD_LMRiskRelaSchema.getStandbyflag3();
        this.Standbyflag4 = aPD_LMRiskRelaSchema.getStandbyflag4();
        this.Standbyflag5 = aPD_LMRiskRelaSchema.getStandbyflag5();
        this.Standbyflag6 = aPD_LMRiskRelaSchema.getStandbyflag6();
    }
    ...
    public boolean setSchema(ResultSet rs, int i)
    {
        try
        {
            ...
            if (rs.getString(2) == null)
                ...
                this.RelaRiskCode = rs.getString(2).trim();
            if (rs.getString(3) == null)
                this.RelaCode = null;
            else
                this.RelaCode = rs.getString(3).trim();
            if (rs.getString(4) == null)
                this.ManageComGrp = null;
            else
                this.ManageComGrp = rs.getString(4).trim();
            if (rs.getString(5) == null)
                this.DKSubPrem = null;
            else
                this.DKSubPrem = rs.getString(5).trim();
        ...
        {
            logger.debug("数据库中表PD_LMRiskRela字段个数和Schema中的字段个数不一致，或执行db.executeQuery查询时未使用select * from tables");
            // @@错误处理
            CError tError = new CError();
            tError.moduleName = "PD_LMRiskRelaSchema";
    ...
    public PD_LMRiskRelaSchema getSchema()
    {
        PD_LMRiskRelaSchema aPD_LMRiskRelaSchema = new PD_LMRiskRelaSchema();
        aPD_LMRiskRelaSchema.setSchema(this);
        return aPD_LMRiskRelaSchema;
    }

    public PD_LMRiskRelaDB getDB()
    {
        PD_LMRiskRelaDB aDBOper = new PD_LMRiskRelaDB();
    ...
    /**
     * 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpPD_LMRiskRela>历史记账凭证主表信息</A>表字段
    ...
    public boolean equals(Object otherObject)
    {
        ...
        if (getClass() != otherObject.getClass())
            return false;
        PD_LMRiskRelaSchema other = (PD_LMRiskRelaSchema) otherObject;
        return
                (RiskCode == null ? other.getRiskCode() == null : RiskCode.equals(other.getRiskCode()))
                && (RelaRiskCode == null ? other.getRelaRiskCode() == null : RelaRiskCode.equals(other.getRelaRiskCode()))
                && (RelaCode == null ? other.getRelaCode() == null : RelaCode.equals(other.getRelaCode()))
                && (ManageComGrp == null ? other.getManageComGrp() == null : ManageComGrp.equals(other.getManageComGrp()))
                && (DKSubPrem == null ? other.getDKSubPrem() == null : DKSubPrem.equals(other.getDKSubPrem()))
