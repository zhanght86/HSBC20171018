...
/*
 * <p>ClassName: LOLoanDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 再保
 */
public class LOLoanDBSet extends LOLoanSet
{
private static Logger logger = Logger.getLogger(LOLoanDBSet.class);
	...
	**/
	...
	// @Constructor
	public LOLoanDBSet(Connection tConnection)
	{
		con = tConnection;
...
ex.printStackTrace();
	...
	public boolean update()
	{
		...
		try
		{
			...
			pstmt.setDouble(25, this.get(i).getPreInterest());
			pstmt.setDouble(26, this.get(i).getCurLoanMoney());
			pstmt.setDouble(27, this.get(i).getLastSumLoanMoney());
			if(this.get(i).getLoanToDate() == null || this.get(i).getLoanToDate().equals("null")) {
				pstmt.setDate(28,null);
			} else {
				pstmt.setDate(28, Date.valueOf(this.get(i).getLoanToDate()));
			}
			if(this.get(i).getNewLoanDate() == null || this.get(i).getNewLoanDate().equals("null")) {
				pstmt.setDate(29,null);
			} else {
				pstmt.setDate(29, Date.valueOf(this.get(i).getNewLoanDate()));
			}
			if(this.get(i).getZqFlag() == null || this.get(i).getZqFlag().equals("null")) {
				pstmt.setString(30,null);
			} else {
				pstmt.setString(30, this.get(i).getZqFlag());
			}
