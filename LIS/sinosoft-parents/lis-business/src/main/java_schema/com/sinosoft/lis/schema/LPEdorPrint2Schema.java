...
/*
 * <p>ClassName: LPEdorPrint2Schema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 保全核心
 */
public class LPEdorPrint2Schema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LPEdorPrint2Schema.class);
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LPEdorPrint2Schema cloned = (LPEdorPrint2Schema)super.clone();
	...
	/**
	* 使用另外一个 LPEdorPrint2Schema 对象给 Schema 赋值
	* @param: aLPEdorPrint2Schema LPEdorPrint2Schema
	**/
	public void setSchema(LPEdorPrint2Schema aLPEdorPrint2Schema)
	{
		this.EdorNo = aLPEdorPrint2Schema.getEdorNo();
		this.PrtFlag = aLPEdorPrint2Schema.getPrtFlag();
		this.PrtTimes = aLPEdorPrint2Schema.getPrtTimes();
		this.ManageCom = aLPEdorPrint2Schema.getManageCom();
		this.Operator = aLPEdorPrint2Schema.getOperator();
		this.MakeDate = fDate.getDate( aLPEdorPrint2Schema.getMakeDate());
		this.MakeTime = aLPEdorPrint2Schema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLPEdorPrint2Schema.getModifyDate());
		this.ModifyTime = aLPEdorPrint2Schema.getModifyTime();
		this.EdorInfo = aLPEdorPrint2Schema.getEdorInfo();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LPEdorPrint2表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LPEdorPrint2Schema";
	...
	public LPEdorPrint2Schema getSchema()
	{
		LPEdorPrint2Schema aLPEdorPrint2Schema = new LPEdorPrint2Schema();
		aLPEdorPrint2Schema.setSchema(this);
		return aLPEdorPrint2Schema;
	}

	public LPEdorPrint2DB getDB()
	{
		LPEdorPrint2DB aDBOper = new LPEdorPrint2DB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLPEdorPrint2描述/A>表字段
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLPEdorPrint2>历史记账凭证主表信息</A>表字段
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LPEdorPrint2Schema other = (LPEdorPrint2Schema)otherObject;
		return
