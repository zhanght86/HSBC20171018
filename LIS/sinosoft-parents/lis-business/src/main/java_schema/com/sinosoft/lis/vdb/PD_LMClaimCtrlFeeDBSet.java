...
/*
 * <p>ClassName: PD_LMClaimCtrlFeeDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 产品定义平台_PDM
 */
public class PD_LMClaimCtrlFeeDBSet extends PD_LMClaimCtrlFeeSet
{
private static Logger logger = Logger.getLogger(PD_LMClaimCtrlFeeDBSet.class);
	...
	**/
	...
	// @Constructor
	public PD_LMClaimCtrlFeeDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "PD_LMClaimCtrlFeeDBSet";
