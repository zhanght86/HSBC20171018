...
import com.sinosoft.lis.db.LOBContPlanDetailSubDB;

/*
 * 与数据库结构不一致，暂不处理
 * <p>ClassName: LOBContPlanDetailSubSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: Physical Data Model 1
 */
public class LOBContPlanDetailSubSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LOBContPlanDetailSubSchema.class);
	// @Field
	/** 业务类型 */
	...
	// @Constructor
	public LOBContPlanDetailSubSchema()
	{
		mErrors = new CErrors();
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LOBContPlanDetailSubSchema cloned = (LOBContPlanDetailSubSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LOBContPlanDetailSubSchema 对象给 Schema 赋值
	* @param: aLOBContPlanDetailSubSchema LOBContPlanDetailSubSchema
	**/
	public void setSchema(LOBContPlanDetailSubSchema aLOBContPlanDetailSubSchema)
	{
		this.BussType = aLOBContPlanDetailSubSchema.getBussType();
		this.BussNo = aLOBContPlanDetailSubSchema.getBussNo();
		this.PolicyNo = aLOBContPlanDetailSubSchema.getPolicyNo();
		this.PropNo = aLOBContPlanDetailSubSchema.getPropNo();
		this.SysPlanCode = aLOBContPlanDetailSubSchema.getSysPlanCode();
		this.PlanCode = aLOBContPlanDetailSubSchema.getPlanCode();
		this.RiskCode = aLOBContPlanDetailSubSchema.getRiskCode();
		this.DutyCode = aLOBContPlanDetailSubSchema.getDutyCode();
		this.P1 = aLOBContPlanDetailSubSchema.getP1();
		this.P2 = aLOBContPlanDetailSubSchema.getP2();
		this.P3 = aLOBContPlanDetailSubSchema.getP3();
		this.P4 = aLOBContPlanDetailSubSchema.getP4();
		this.P5 = aLOBContPlanDetailSubSchema.getP5();
		this.P6 = aLOBContPlanDetailSubSchema.getP6();
		this.P7 = aLOBContPlanDetailSubSchema.getP7();
		this.P8 = aLOBContPlanDetailSubSchema.getP8();
		this.P9 = aLOBContPlanDetailSubSchema.getP9();
		this.P10 = aLOBContPlanDetailSubSchema.getP10();
		this.P11 = aLOBContPlanDetailSubSchema.getP11();
		this.P12 = aLOBContPlanDetailSubSchema.getP12();
		this.P13 = aLOBContPlanDetailSubSchema.getP13();
		this.P14 = aLOBContPlanDetailSubSchema.getP14();
		this.P15 = aLOBContPlanDetailSubSchema.getP15();
		this.P16 = aLOBContPlanDetailSubSchema.getP16();
		this.P17 = aLOBContPlanDetailSubSchema.getP17();
		this.P18 = aLOBContPlanDetailSubSchema.getP18();
		this.P19 = aLOBContPlanDetailSubSchema.getP19();
		this.P20 = aLOBContPlanDetailSubSchema.getP20();
		this.P21 = aLOBContPlanDetailSubSchema.getP21();
		this.P22 = aLOBContPlanDetailSubSchema.getP22();
		this.P23 = aLOBContPlanDetailSubSchema.getP23();
		this.P24 = aLOBContPlanDetailSubSchema.getP24();
		this.P25 = aLOBContPlanDetailSubSchema.getP25();
		this.P26 = aLOBContPlanDetailSubSchema.getP26();
		this.P27 = aLOBContPlanDetailSubSchema.getP27();
		this.P28 = aLOBContPlanDetailSubSchema.getP28();
		this.P29 = aLOBContPlanDetailSubSchema.getP29();
		this.P30 = aLOBContPlanDetailSubSchema.getP30();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LOBContPlanDetailSub表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LOBContPlanDetailSubSchema";
	...
	public LOBContPlanDetailSubSchema getSchema()
	{
		LOBContPlanDetailSubSchema aLOBContPlanDetailSubSchema = new LOBContPlanDetailSubSchema();
		aLOBContPlanDetailSubSchema.setSchema(this);
		return aLOBContPlanDetailSubSchema;
	}

	public LOBContPlanDetailSubDB getDB()
	{
		LOBContPlanDetailSubDB aDBOper = new LOBContPlanDetailSubDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLOBContPlanDetailSub描述/A>表字段
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLOBContPlanDetailSub>历史记账凭证主表信息</A>表字段
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LOBContPlanDetailSubSchema other = (LOBContPlanDetailSubSchema)otherObject;
		return
