...
/*
 * <p>ClassName: LCInsuredDrawDetailDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: Physical Data Model 1
 */
public class LCInsuredDrawDetailDBSet extends LCInsuredDrawDetailSet
{
	// @Field
	...
	**/
	...
	// @Constructor
	public LCInsuredDrawDetailDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public LCInsuredDrawDetailDBSet()
	{
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LCInsuredDrawDetailDBSet";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getGetDutyCode() == null || this.get(i).getGetDutyCode().equals("null")) {
				...
				pstmt.setString(32, this.get(i).getGetDutyCode());
			}
