...
/*
 * <p>ClassName: LCGUWSubDB </p>
 * <p>Description: DB层数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 承保流程
 */
public class LCGUWSubDB extends LCGUWSubSchema
{
private static Logger logger = Logger.getLogger(LCGUWSubDB.class);
	...
	**/
	...
	// @Constructor
	public LCGUWSubDB( Connection tConnection )
	{
		con = tConnection;
	...
	{
		LCGUWSubSchema tSchema = this.getSchema();
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.getGrpProposalNo() == null || this.getGrpProposalNo().equals("null")) {
				...
				pstmt.setString(39, this.getGrpProposalNo());
			}
	...
	public boolean getInfo()
	{
		...
		try
		{
			pstmt = con.prepareStatement("SELECT * FROM LCGUWSub WHERE  GrpProposalNo = ? AND UWNo = ?", 
	...
	public LCGUWSubSet query()
	{
		PreparedStatement pstmt = null;
 		ResultSet rs = null;
		LCGUWSubSet aLCGUWSubSet = new LCGUWSubSet();
	  ...
	  if( !mflag ) {
		...
		{
			SQLString sqlObj = new SQLString("LCGUWSub");
			LCGUWSubSchema aSchema = this.getSchema();
			...
			{
				i++;
				LCGUWSubSchema s1 = new LCGUWSubSchema();
				s1.setSchema(rs,i);
				aLCGUWSubSet.add(s1);
			}
			try{ rs.close(); } catch( Exception ex ) {}
	...
	public LCGUWSubSet executeQuery(String sql)
	{
		Statement stmt = null;
		ResultSet rs = null;
		LCGUWSubSet aLCGUWSubSet = new LCGUWSubSet();
	...
	public LCGUWSubSet query(int nStart, int nCount)
	{
		PreparedStatement pstmt = null;
 		ResultSet rs = null;
		LCGUWSubSet aLCGUWSubSet = new LCGUWSubSet();
	...
	public LCGUWSubSet executeQuery(String sql, int nStart, int nCount)
	{
		Statement stmt = null;
		ResultSet rs = null;
		LCGUWSubSet aLCGUWSubSet = new LCGUWSubSet();
	...
	public boolean update(String strWherePart)
	{
	  ...
	  if( !mflag ) {
		...
		try
		{
			...
			String sql = "update LCGUWSub " + sqlObj.getUpdPart() + " where " + strWherePart;
 ...
 * @return LCGUWSubSet
 */
public LCGUWSubSet getData()
{
    int tCount = 0;
    LCGUWSubSet tLCGUWSubSet = new LCGUWSubSet();
    LCGUWSubSchema tLCGUWSubSchema = null;
    if (null == mResultSet)
    {
        CError tError = new CError();
        tError.moduleName = "LCGUWSubDB";
    ...
    try
    {
        ...
        tLCGUWSubSchema.setSchema(mResultSet, 1);
        tLCGUWSubSet.add(tLCGUWSubSchema);
...
public boolean closeData()
{
	...
	public LCGUWSubSet executeQuery(SQLwithBindVariables sqlbv) {
	...
	public LCGUWSubSet executeQuery(SQLwithBindVariables sqlbv, int nStart, int nCount) {
