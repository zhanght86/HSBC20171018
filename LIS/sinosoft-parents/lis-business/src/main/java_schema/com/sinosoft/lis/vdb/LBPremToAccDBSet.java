...
/*
 * <p>ClassName: LBPremToAccDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 寿险业务系统未整理模型
 */
public class LBPremToAccDBSet extends LBPremToAccSet
{
private static Logger logger = Logger.getLogger(LBPremToAccDBSet.class);
	...
	**/
	...
	// @Constructor
	public LBPremToAccDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LBPremToAccDBSet";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getNewFlag() == null || this.get(i).getNewFlag().equals("null")) {
				...
				pstmt.setString(7, this.get(i).getNewFlag());
			}
