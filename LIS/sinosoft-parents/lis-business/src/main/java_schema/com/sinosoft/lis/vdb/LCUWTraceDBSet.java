...
/*
 * <p>ClassName: LCUWTraceDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: Physical Data Model 1
 */
public class LCUWTraceDBSet extends LCUWTraceSet
{
	// @Field
	...
	**/
	...
	// @Constructor
	public LCUWTraceDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LCUWTraceDBSet";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getInsuredNo() == null || this.get(i).getInsuredNo().equals("null")) {
				...
				pstmt.setString(34, this.get(i).getInsuredNo());
			}
			if(this.get(i).getRiskCode() == null || this.get(i).getRiskCode().equals("null")) {
			...
			if(this.get(i).getRuleLevel() == null || this.get(i).getRuleLevel().equals("null")) {
				...
				pstmt.setString(36, this.get(i).getRuleLevel());
			}
			pstmt.setInt(37, this.get(i).getUWNo());
			if(this.get(i).getRuleCode() == null || this.get(i).getRuleCode().equals("null")) {
				pstmt.setString(38,null);
			} else {
				pstmt.setString(38, this.get(i).getRuleCode());
			}
