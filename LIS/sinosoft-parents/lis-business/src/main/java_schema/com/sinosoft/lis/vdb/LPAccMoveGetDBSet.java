...
/*
 * <p>ClassName: LPAccMoveGetDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 保全核心
 */
public class LPAccMoveGetDBSet extends LPAccMoveGetSet
{
private static Logger logger = Logger.getLogger(LPAccMoveGetDBSet.class);
	...
	**/
	...
	// @Constructor
	public LPAccMoveGetDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LPAccMoveGetDBSet";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getAccAscription() == null || this.get(i).getAccAscription().equals("null")) {
				...
				pstmt.setString(28, StrTool.space1(this.get(i).getAccAscription(), 1));
			}
			if(this.get(i).getDutyCode() == null || this.get(i).getDutyCode().equals("null")) {
