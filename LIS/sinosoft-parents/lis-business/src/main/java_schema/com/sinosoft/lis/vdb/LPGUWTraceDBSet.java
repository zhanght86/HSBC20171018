...
/*
 * <p>ClassName: LPGUWTraceDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: Physical Data Model 1
 */
public class LPGUWTraceDBSet extends LPGUWTraceSet
{
	// @Field
	...
	**/
	...
	// @Constructor
	public LPGUWTraceDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LPGUWTraceDBSet";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getAutoUWConclu() == null || this.get(i).getAutoUWConclu().equals("null")) {
				...
				pstmt.setString(10, this.get(i).getAutoUWConclu());
			}
			if(this.get(i).getAutoUWDate() == null || this.get(i).getAutoUWDate().equals("null")) {
				pstmt.setDate(11,null);
			} else {
				pstmt.setDate(11, Date.valueOf(this.get(i).getAutoUWDate()));
			}
			...
			if(this.get(i).getMakeOperator() == null || this.get(i).getMakeOperator().equals("null")) {
				...
				pstmt.setString(27, this.get(i).getMakeOperator());
			}
			...
			if(this.get(i).getGrpContNo() == null || this.get(i).getGrpContNo().equals("null")) {
				...
				pstmt.setString(35, this.get(i).getGrpContNo());
			}
			if(this.get(i).getRiskCode() == null || this.get(i).getRiskCode().equals("null")) {
				pstmt.setString(36,null);
			} else {
				pstmt.setString(36, this.get(i).getRiskCode());
			}
			if(this.get(i).getRuleLevel() == null || this.get(i).getRuleLevel().equals("null")) {
				pstmt.setString(37,null);
			} else {
				pstmt.setString(37, this.get(i).getRuleLevel());
			}
			pstmt.setInt(38, this.get(i).getUWNo());
			if(this.get(i).getRuleCode() == null || this.get(i).getRuleCode().equals("null")) {
				pstmt.setString(39,null);
			} else {
				pstmt.setString(39, this.get(i).getRuleCode());
			}
