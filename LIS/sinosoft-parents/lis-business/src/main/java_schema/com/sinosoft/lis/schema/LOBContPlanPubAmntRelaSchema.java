...
import com.sinosoft.lis.db.LOBContPlanPubAmntRelaDB;

/*
 * 与数据库结构不一致，暂不处理
 * <p>ClassName: LOBContPlanPubAmntRelaSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: Physical Data Model 1
 */
public class LOBContPlanPubAmntRelaSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LOBContPlanPubAmntRelaSchema.class);
	// @Field
	/** 业务类型 */
	...
	// @Constructor
	public LOBContPlanPubAmntRelaSchema()
	{
		mErrors = new CErrors();
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LOBContPlanPubAmntRelaSchema cloned = (LOBContPlanPubAmntRelaSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LOBContPlanPubAmntRelaSchema 对象给 Schema 赋值
	* @param: aLOBContPlanPubAmntRelaSchema LOBContPlanPubAmntRelaSchema
	**/
	public void setSchema(LOBContPlanPubAmntRelaSchema aLOBContPlanPubAmntRelaSchema)
	{
		this.BussType = aLOBContPlanPubAmntRelaSchema.getBussType();
		this.BussNo = aLOBContPlanPubAmntRelaSchema.getBussNo();
		this.PolicyNo = aLOBContPlanPubAmntRelaSchema.getPolicyNo();
		this.SysPlanCode = aLOBContPlanPubAmntRelaSchema.getSysPlanCode();
		this.PlanCode = aLOBContPlanPubAmntRelaSchema.getPlanCode();
		this.LimitAmnt = aLOBContPlanPubAmntRelaSchema.getLimitAmnt();
		this.MakeOperator = aLOBContPlanPubAmntRelaSchema.getMakeOperator();
		this.MakeDate = fDate.getDate( aLOBContPlanPubAmntRelaSchema.getMakeDate());
		this.MakeTime = aLOBContPlanPubAmntRelaSchema.getMakeTime();
		this.ModifyOperator = aLOBContPlanPubAmntRelaSchema.getModifyOperator();
		this.ModifyDate = fDate.getDate( aLOBContPlanPubAmntRelaSchema.getModifyDate());
		this.ModifyTime = aLOBContPlanPubAmntRelaSchema.getModifyTime();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LOBContPlanPubAmntRela表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LOBContPlanPubAmntRelaSchema";
	...
	public LOBContPlanPubAmntRelaSchema getSchema()
	{
		LOBContPlanPubAmntRelaSchema aLOBContPlanPubAmntRelaSchema = new LOBContPlanPubAmntRelaSchema();
		aLOBContPlanPubAmntRelaSchema.setSchema(this);
		return aLOBContPlanPubAmntRelaSchema;
	}

	public LOBContPlanPubAmntRelaDB getDB()
	{
		LOBContPlanPubAmntRelaDB aDBOper = new LOBContPlanPubAmntRelaDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLOBContPlanPubAmntRela描述/A>表字段
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLOBContPlanPubAmntRela>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			LimitAmnt = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 6, SysConst.PACKAGESPILTER );
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LOBContPlanPubAmntRelaSchema other = (LOBContPlanPubAmntRelaSchema)otherObject;
		return
