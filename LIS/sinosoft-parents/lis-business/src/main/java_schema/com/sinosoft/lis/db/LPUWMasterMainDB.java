...
/*
 * <p>ClassName: LPUWMasterMainDB </p>
 * <p>Description: DB层数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 保全流程
 */
public class LPUWMasterMainDB extends LPUWMasterMainSchema
{
private static Logger logger = Logger.getLogger(LPUWMasterMainDB.class);
	...
	**/
	...
	// @Constructor
	public LPUWMasterMainDB( Connection tConnection )
	{
		con = tConnection;
		db = new DBOper( con, "LPUWMasterMain" );
		mflag = true;
	}

	public LPUWMasterMainDB()
	{
		con = null;
		db = new DBOper( "LPUWMasterMain" );
		mflag = false;
	}
	...
	{
		LPUWMasterMainSchema tSchema = this.getSchema();
		...
		else
		{
			...
			tError.moduleName = "LPUWMasterMainDB";
	...
	public boolean delete()
	{
		...
		try
		{
			pstmt = con.prepareStatement("DELETE FROM LPUWMasterMain WHERE  EdorNo = ? AND ContNo = ?");
		...
		SQLString sqlObj = new SQLString("LPUWMasterMain");
	...
	public boolean insert()
	{
		...
		try
		{
			pstmt = con.prepareStatement("INSERT INTO LPUWMasterMain(EdorNo ,GrpContNo ,ContNo ,ProposalContNo ,UWNo ,InsuredNo ,InsuredName ,AppntNo ,AppntName ,AgentCode ,AgentGroup ,PassFlag ,UWGrade ,AppGrade ,PostponeDay ,PostponeDate ,AutoUWFlag ,State ,ManageCom ,UWIdea ,UpReportContent ,Operator ,HealthFlag ,QuesFlag ,SpecFlag ,AddPremFlag ,AddPremReason ,ReportFlag ,PrintFlag ,PrintFlag2 ,ChangePolFlag ,ChangePolReason ,SpecReason ,MakeDate ,MakeTime ,ModifyDate ,ModifyTime) VALUES( ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ?)");
			if(this.getEdorNo() == null || this.getEdorNo().equals("null")) {
				pstmt.setNull(1, 12);
			} else {
				pstmt.setString(1, this.getEdorNo());
	...
	public boolean getInfo()
	{
		...
		try
		{
			pstmt = con.prepareStatement("SELECT * FROM LPUWMasterMain WHERE  EdorNo = ? AND ContNo = ?", 
	...
	public LPUWMasterMainSet query()
	{
		PreparedStatement pstmt = null;
 		ResultSet rs = null;
		LPUWMasterMainSet aLPUWMasterMainSet = new LPUWMasterMainSet();
	  ...
	  if( !mflag ) {
		...
		{
			SQLString sqlObj = new SQLString("LPUWMasterMain");
			LPUWMasterMainSchema aSchema = this.getSchema();
			...
			{
				i++;
				LPUWMasterMainSchema s1 = new LPUWMasterMainSchema();
				s1.setSchema(rs,i);
				aLPUWMasterMainSet.add(s1);
			}
			try{ rs.close(); } catch( Exception ex ) {}
			try{ pstmt.close(); } catch( Exception ex1 ) {}
		}
		...
		return aLPUWMasterMainSet;

	}

	public LPUWMasterMainSet executeQuery(String sql)
	{
		Statement stmt = null;
		ResultSet rs = null;
		LPUWMasterMainSet aLPUWMasterMainSet = new LPUWMasterMainSet();
	...
	public LPUWMasterMainSet query(int nStart, int nCount)
	{
		PreparedStatement pstmt = null;
 		ResultSet rs = null;
		LPUWMasterMainSet aLPUWMasterMainSet = new LPUWMasterMainSet();
	...
	public LPUWMasterMainSet executeQuery(String sql, int nStart, int nCount)
	{
		Statement stmt = null;
		ResultSet rs = null;
		LPUWMasterMainSet aLPUWMasterMainSet = new LPUWMasterMainSet();
	...
	public boolean update(String strWherePart)
	{
	  ...
	  if( !mflag ) {
		...
		try
		{
			...
			String sql = "update LPUWMasterMain " + sqlObj.getUpdPart() + " where " + strWherePart;
...
/**
 * 获取定量数据
 * @return LPUWMasterMainSet
 */
public LPUWMasterMainSet getData()
{
    int tCount = 0;
    LPUWMasterMainSet tLPUWMasterMainSet = new LPUWMasterMainSet();
    LPUWMasterMainSchema tLPUWMasterMainSchema = null;
    if (null == mResultSet)
    {
        CError tError = new CError();
        tError.moduleName = "LPUWMasterMainDB";
    ...
    {
        tCount = 1;
        tLPUWMasterMainSchema = new LPUWMasterMainSchema();
        tLPUWMasterMainSchema.setSchema(mResultSet, 1);
        tLPUWMasterMainSet.add(tLPUWMasterMainSchema);
...
public boolean closeData()
{
	...
	public LPUWMasterMainSet executeQuery(SQLwithBindVariables sqlbv) {
	...
	public LPUWMasterMainSet executeQuery(SQLwithBindVariables sqlbv, int nStart, int nCount) {
