...
/*
 * <p>ClassName: PD_LMEdorCalDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 产品定义平台_PDM
 */
public class PD_LMEdorCalDBSet extends PD_LMEdorCalSet
{
private static Logger logger = Logger.getLogger(PD_LMEdorCalDBSet.class);
	...
	**/
	...
	// @Constructor
	public PD_LMEdorCalDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "PD_LMEdorCalDBSet";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getCalType() == null || this.get(i).getCalType().equals("null")) {
				...
				pstmt.setString(22, this.get(i).getCalType());
			}
