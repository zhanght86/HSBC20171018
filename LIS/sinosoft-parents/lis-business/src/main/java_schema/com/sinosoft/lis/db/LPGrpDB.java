...
/*
 * <p>ClassName: LPGrpDB </p>
 * <p>Description: DB层数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 保全核心
 */
public class LPGrpDB extends LPGrpSchema
{
private static Logger logger = Logger.getLogger(LPGrpDB.class);
	...
	**/
	...
	// @Constructor
	public LPGrpDB( Connection tConnection )
	{
		con = tConnection;
	...
	{
		LPGrpSchema tSchema = this.getSchema();
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.getGrpName() == null || this.getGrpName().equals("null")) {
				...
				pstmt.setString(5, this.getGrpName());
			}
			if(this.getBusinessType() == null || this.getBusinessType().equals("null")) {
				pstmt.setNull(6, 12);
			} else {
				pstmt.setString(6, this.getBusinessType());
			}
			...
			pstmt.setInt(8, this.getPeoples());
			pstmt.setDouble(9, this.getRgtMoney());
			pstmt.setDouble(10, this.getAsset());
			pstmt.setDouble(11, this.getNetProfitRate());
			if(this.getMainBussiness() == null || this.getMainBussiness().equals("null")) {
				pstmt.setNull(12, 12);
			} else {
				pstmt.setString(12, this.getMainBussiness());
			}
			if(this.getCorporation() == null || this.getCorporation().equals("null")) {
				pstmt.setNull(13, 12);
			} else {
				pstmt.setString(13, this.getCorporation());
			}
			if(this.getComAera() == null || this.getComAera().equals("null")) {
				pstmt.setNull(14, 12);
			} else {
				pstmt.setString(14, this.getComAera());
			}
			if(this.getFax() == null || this.getFax().equals("null")) {
				pstmt.setNull(15, 12);
			} else {
				pstmt.setString(15, this.getFax());
			}
			if(this.getPhone() == null || this.getPhone().equals("null")) {
				pstmt.setNull(16, 12);
			} else {
				pstmt.setString(16, this.getPhone());
			}
			if(this.getGetFlag() == null || this.getGetFlag().equals("null")) {
				pstmt.setNull(17, 1);
			} else {
				pstmt.setString(17, this.getGetFlag());
			}
			if(this.getSatrap() == null || this.getSatrap().equals("null")) {
				pstmt.setNull(18, 12);
			} else {
				pstmt.setString(18, this.getSatrap());
			}
			...
			if(this.getFoundDate() == null || this.getFoundDate().equals("null")) {
				...
				pstmt.setDate(20, Date.valueOf(this.getFoundDate()));
			}
			...
			if(this.getGrpGroupNo() == null || this.getGrpGroupNo().equals("null")) {
				...
				pstmt.setString(23, this.getGrpGroupNo());
			}
			...
			if(this.getVIPValue() == null || this.getVIPValue().equals("null")) {
				...
				pstmt.setString(27, this.getVIPValue());
			}
			...
			if(this.getSubCompanyFlag() == null || this.getSubCompanyFlag().equals("null")) {
				...
				pstmt.setString(33, this.getSubCompanyFlag());
			}
			if(this.getSupCustoemrNo() == null || this.getSupCustoemrNo().equals("null")) {
				pstmt.setNull(34, 12);
			} else {
				pstmt.setString(34, this.getSupCustoemrNo());
			}
			...
			pstmt.setInt(36, this.getOnWorkPeoples());
			pstmt.setInt(37, this.getOffWorkPeoples());
			pstmt.setInt(38, this.getOtherPeoples());
			if(this.getBusinessBigType() == null || this.getBusinessBigType().equals("null")) {
				pstmt.setNull(39, 12);
			} else {
				pstmt.setString(39, this.getBusinessBigType());
			}
			if(this.getSocialInsuNo() == null || this.getSocialInsuNo().equals("null")) {
				pstmt.setNull(40, 12);
			} else {
				pstmt.setString(40, this.getSocialInsuNo());
			}
			// set where condition
			if(this.getEdorNo() == null || this.getEdorNo().equals("null")) {
				pstmt.setNull(41, 12);
			...
			if(this.getCustomerNo() == null || this.getCustomerNo().equals("null")) {
				...
				pstmt.setString(43, this.getCustomerNo());
			}
			pstmt.executeUpdate();
			pstmt.close();
		} catch (Exception ex) {
	...
	public boolean getInfo()
	{
		...
		try
		{
			pstmt = con.prepareStatement("SELECT * FROM LPGrp WHERE  EdorNo = ? AND EdorType = ? AND CustomerNo = ?", 
	...
	public LPGrpSet query()
	{
	  ...
	  if( !mflag ) {
		...
		{
			SQLString sqlObj = new SQLString("LPGrp");
			LPGrpSchema aSchema = this.getSchema();
			...
			{
				i++;
				LPGrpSchema s1 = new LPGrpSchema();
				s1.setSchema(rs,i);
				aLPGrpSet.add(s1);
			}
			try{ rs.close(); } catch( Exception ex ) {}
	...
	public LPGrpSet executeQuery(String sql)
	{
		Statement stmt = null;
		ResultSet rs = null;
		LPGrpSet aLPGrpSet = new LPGrpSet();
	...
	public LPGrpSet query(int nStart, int nCount)
	{
		PreparedStatement pstmt = null;
 		ResultSet rs = null;
		LPGrpSet aLPGrpSet = new LPGrpSet();
	...
	public LPGrpSet executeQuery(String sql, int nStart, int nCount)
	{
		Statement stmt = null;
		ResultSet rs = null;
		LPGrpSet aLPGrpSet = new LPGrpSet();
	...
	public boolean update(String strWherePart)
	{
	  ...
	  if( !mflag ) {
		...
		try
		{
			...
			String sql = "update LPGrp " + sqlObj.getUpdPart() + " where " + strWherePart;
 ...
 * @return LPGrpSet
 */
public LPGrpSet getData()
{
    int tCount = 0;
    LPGrpSet tLPGrpSet = new LPGrpSet();
    LPGrpSchema tLPGrpSchema = null;
    if (null == mResultSet)
    {
        CError tError = new CError();
        tError.moduleName = "LPGrpDB";
    ...
    {
        tCount = 1;
        tLPGrpSchema = new LPGrpSchema();
        tLPGrpSchema.setSchema(mResultSet, 1);
        tLPGrpSet.add(tLPGrpSchema);
...
public boolean closeData()
{
	...
	public LPGrpSet executeQuery(SQLwithBindVariables sqlbv) {
	...
	public LPGrpSet executeQuery(SQLwithBindVariables sqlbv, int nStart, int nCount) {
