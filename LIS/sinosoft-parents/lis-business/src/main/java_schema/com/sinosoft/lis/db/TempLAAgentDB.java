...
/*
 * <p>ClassName: TempLAAgentDB </p>
 * <p>Description: DB层数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 代理人管理
 */
public class TempLAAgentDB extends TempLAAgentSchema
{
private static Logger logger = Logger.getLogger(TempLAAgentDB.class);
	...
	**/
	...
	// @Constructor
	public TempLAAgentDB( Connection tConnection )
	{
		con = tConnection;
	...
	{
		TempLAAgentSchema tSchema = this.getSchema();
		...
		else
		{
			...
			tError.moduleName = "TempLAAgentDB";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.getEntryNo() == null || this.getEntryNo().equals("null")) {
				...
				pstmt.setString(6, this.getEntryNo());
			}
			...
			if(this.getAgentState() == null || this.getAgentState().equals("null")) {
				...
				pstmt.setString(63, this.getAgentState());
			}
			if(this.getQualiPassFlag() == null || this.getQualiPassFlag().equals("null")) {
				pstmt.setNull(64, 1);
			} else {
				pstmt.setString(64, this.getQualiPassFlag());
			}
			if(this.getSmokeFlag() == null || this.getSmokeFlag().equals("null")) {
				pstmt.setNull(65, 1);
			} else {
				pstmt.setString(65, this.getSmokeFlag());
			}
			if(this.getRgtAddress() == null || this.getRgtAddress().equals("null")) {
				pstmt.setNull(66, 12);
			} else {
				pstmt.setString(66, this.getRgtAddress());
			}
			if(this.getBankCode() == null || this.getBankCode().equals("null")) {
				pstmt.setNull(67, 12);
			} else {
				pstmt.setString(67, this.getBankCode());
			}
			if(this.getBankAccNo() == null || this.getBankAccNo().equals("null")) {
				pstmt.setNull(68, 12);
			} else {
				pstmt.setString(68, this.getBankAccNo());
			}
			if(this.getOperator() == null || this.getOperator().equals("null")) {
				pstmt.setNull(69, 12);
			} else {
				pstmt.setString(69, this.getOperator());
			}
			if(this.getMakeDate() == null || this.getMakeDate().equals("null")) {
				pstmt.setNull(70, 91);
			} else {
				pstmt.setDate(70, Date.valueOf(this.getMakeDate()));
			}
			if(this.getMakeTime() == null || this.getMakeTime().equals("null")) {
				pstmt.setNull(71, 1);
			} else {
				pstmt.setString(71, this.getMakeTime());
			}
			if(this.getModifyDate() == null || this.getModifyDate().equals("null")) {
				pstmt.setNull(72, 91);
			} else {
				pstmt.setDate(72, Date.valueOf(this.getModifyDate()));
			}
			if(this.getModifyTime() == null || this.getModifyTime().equals("null")) {
				pstmt.setNull(73, 1);
			} else {
				pstmt.setString(73, this.getModifyTime());
			}
			if(this.getBranchType() == null || this.getBranchType().equals("null")) {
				pstmt.setNull(74, 12);
			} else {
				pstmt.setString(74, this.getBranchType());
			}
			if(this.getTrainPeriods() == null || this.getTrainPeriods().equals("null")) {
				pstmt.setNull(75, 12);
			} else {
				pstmt.setString(75, this.getTrainPeriods());
			}
			if(this.getBranchCode() == null || this.getBranchCode().equals("null")) {
				pstmt.setNull(76, 12);
			} else {
				pstmt.setString(76, this.getBranchCode());
			}
			pstmt.setDouble(77, this.getAge());
			if(this.getChannelName() == null || this.getChannelName().equals("null")) {
				pstmt.setNull(78, 12);
			} else {
				pstmt.setString(78, this.getChannelName());
			}
			if(this.getIDType() == null || this.getIDType().equals("null")) {
				pstmt.setNull(79, 1);
			} else {
				pstmt.setString(79, this.getIDType());
			}
			if(this.getConFFlag() == null || this.getConFFlag().equals("null")) {
				pstmt.setNull(80, 1);
			} else {
				pstmt.setString(80, this.getConFFlag());
			}
			if(this.getUpAgent() == null || this.getUpAgent().equals("null")) {
				pstmt.setNull(81, 12);
			} else {
				pstmt.setString(81, this.getUpAgent());
			}
			if(this.getAgentGrade() == null || this.getAgentGrade().equals("null")) {
				pstmt.setNull(82, 12);
			} else {
				pstmt.setString(82, this.getAgentGrade());
			}
			if(this.getTreeBranchCode() == null || this.getTreeBranchCode().equals("null")) {
				pstmt.setNull(83, 12);
			} else {
				pstmt.setString(83, this.getTreeBranchCode());
			}
			// set where condition
			if(this.getEdorNo() == null || this.getEdorNo().equals("null")) {
				pstmt.setNull(84, 12);
	...
	public boolean getInfo()
	{
		...
		try
		{
			pstmt = con.prepareStatement("SELECT * FROM TempLAAgent WHERE  EdorNo = ?", 
	...
	public TempLAAgentSet query()
	{
		PreparedStatement pstmt = null;
 		ResultSet rs = null;
		TempLAAgentSet aTempLAAgentSet = new TempLAAgentSet();
	  ...
	  if( !mflag ) {
		...
		{
			SQLString sqlObj = new SQLString("TempLAAgent");
			TempLAAgentSchema aSchema = this.getSchema();
			...
			{
				i++;
				TempLAAgentSchema s1 = new TempLAAgentSchema();
				s1.setSchema(rs,i);
				aTempLAAgentSet.add(s1);
			}
			try{ rs.close(); } catch( Exception ex ) {}
			try{ pstmt.close(); } catch( Exception ex1 ) {}
		}
		...
		return aTempLAAgentSet;

	}

	public TempLAAgentSet executeQuery(String sql)
	{
		Statement stmt = null;
		ResultSet rs = null;
		TempLAAgentSet aTempLAAgentSet = new TempLAAgentSet();
	...
	public TempLAAgentSet query(int nStart, int nCount)
	{
		PreparedStatement pstmt = null;
 		ResultSet rs = null;
		TempLAAgentSet aTempLAAgentSet = new TempLAAgentSet();
	...
	public TempLAAgentSet executeQuery(String sql, int nStart, int nCount)
	{
		Statement stmt = null;
		ResultSet rs = null;
		TempLAAgentSet aTempLAAgentSet = new TempLAAgentSet();
	...
	public boolean update(String strWherePart)
	{
	  ...
	  if( !mflag ) {
		...
		try
		{
			...
			String sql = "update TempLAAgent " + sqlObj.getUpdPart() + " where " + strWherePart;
...
/**
 * 获取定量数据
 * @return TempLAAgentSet
 */
public TempLAAgentSet getData()
{
    int tCount = 0;
    TempLAAgentSet tTempLAAgentSet = new TempLAAgentSet();
    TempLAAgentSchema tTempLAAgentSchema = null;
    if (null == mResultSet)
    {
        CError tError = new CError();
        tError.moduleName = "TempLAAgentDB";
    ...
    {
        tCount = 1;
        tTempLAAgentSchema = new TempLAAgentSchema();
        tTempLAAgentSchema.setSchema(mResultSet, 1);
        tTempLAAgentSet.add(tTempLAAgentSchema);
...
public boolean closeData()
{
	...
	public TempLAAgentSet executeQuery(SQLwithBindVariables sqlbv) {
	...
	public TempLAAgentSet executeQuery(SQLwithBindVariables sqlbv, int nStart, int nCount) {
