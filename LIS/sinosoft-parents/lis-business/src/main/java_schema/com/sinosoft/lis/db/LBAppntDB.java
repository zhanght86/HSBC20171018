...
{
private static Logger logger = Logger.getLogger(LBAppntDB.class);
	...
	**/
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.getAppntSex() == null || this.getAppntSex().equals("null")) {
				...
				pstmt.setString(8, this.getAppntSex());
			}
			if(this.getAppntBirthday() == null || this.getAppntBirthday().equals("null")) {
				pstmt.setNull(9, 91);
			} else {
				pstmt.setDate(9, Date.valueOf(this.getAppntBirthday()));
			}
			if(this.getAppntType() == null || this.getAppntType().equals("null")) {
				pstmt.setNull(10, 1);
			} else {
				pstmt.setString(10, this.getAppntType());
			}
			...
			if(this.getMarriageDate() == null || this.getMarriageDate().equals("null")) {
				...
				pstmt.setDate(18, Date.valueOf(this.getMarriageDate()));
			}
			...
			if(this.getCreditGrade() == null || this.getCreditGrade().equals("null")) {
				...
				pstmt.setString(23, this.getCreditGrade());
			}
			...
			if(this.getManageCom() == null || this.getManageCom().equals("null")) {
				...
				pstmt.setString(37, this.getManageCom());
			}
			...
			pstmt.setDouble(42, this.getBMI());
	...
	public boolean getInfo()
	{
		...
		try
		{
			pstmt = con.prepareStatement("SELECT * FROM LBAppnt WHERE  ContNo = ?", 
 ...
 * @return LBAppntSet
 */
public LBAppntSet getData()
{
    int tCount = 0;
    LBAppntSet tLBAppntSet = new LBAppntSet();
    LBAppntSchema tLBAppntSchema = null;
    if (null == mResultSet)
    {
        CError tError = new CError();
        tError.moduleName = "LBAppntDB";
    ...
    try
    {
        ...
        tLBAppntSchema.setSchema(mResultSet, 1);
        tLBAppntSet.add(tLBAppntSchema);
...
public boolean closeData()
{
	...
	public LBAppntSet executeQuery(SQLwithBindVariables sqlbv) {
	...
	public LBAppntSet executeQuery(SQLwithBindVariables sqlbv, int nStart, int nCount) {
