...
/**
 * <p>ClassName: FIDetailFinItemCodeDBSet </p>
 ...
 */
public class FIDetailFinItemCodeDBSet extends FIDetailFinItemCodeSet
{
private static Logger logger = Logger.getLogger(FIDetailFinItemCodeDBSet.class);
	...
	**/
	...
	// @Constructor
	public FIDetailFinItemCodeDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public FIDetailFinItemCodeDBSet()
	{
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "FIDetailFinItemCodeDBSet";
	...
	public boolean delete()
	{
		...
		try
		{
			...
			if(this.get(i).getLevelConditionValue() == null || this.get(i).getLevelConditionValue().equals("null")) {
				pstmt.setString(4,null);
			} else {
				pstmt.setString(4, this.get(i).getLevelConditionValue().trim());
			}
                pstmt.addBatch();
            }
            pstmt.executeBatch();
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getLevelCode() == null || this.get(i).getLevelCode().equals("null")) {
				...
				pstmt.setString(5, this.get(i).getLevelCode().trim());
			}
			if(this.get(i).getNextJudgementNo() == null || this.get(i).getNextJudgementNo().equals("null")) {
				pstmt.setString(6,null);
			} else {
				pstmt.setString(6, this.get(i).getNextJudgementNo().trim());
			}
			...
			if(this.get(i).getFinItemID() == null || this.get(i).getFinItemID().equals("null")) {
				...
				pstmt.setString(9, this.get(i).getFinItemID().trim());
			}
			if(this.get(i).getJudgementNo() == null || this.get(i).getJudgementNo().equals("null")) {
				pstmt.setString(10,null);
			} else {
				pstmt.setString(10, this.get(i).getJudgementNo().trim());
			}
			if(this.get(i).getLevelConditionValue() == null || this.get(i).getLevelConditionValue().equals("null")) {
				pstmt.setString(11,null);
			} else {
				pstmt.setString(11, this.get(i).getLevelConditionValue().trim());
			}
                pstmt.addBatch();
            }
            pstmt.executeBatch();
