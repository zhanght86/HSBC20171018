...
/**
 * <p>ClassName: FIAboriginalDataForDealDBSet </p>
 ...
 */
public class FIAboriginalDataForDealDBSet extends FIAboriginalDataForDealSet
{
private static Logger logger = Logger.getLogger(FIAboriginalDataForDealDBSet.class);
	...
	**/
	...
	// @Constructor
	public FIAboriginalDataForDealDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public FIAboriginalDataForDealDBSet()
	{
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "FIAboriginalDataForDealDBSet";
	...
	public boolean delete()
	{
		...
		try
		{
			...
			if(this.get(i).getSerialNo() == null || this.get(i).getSerialNo().equals("null")) {
				...
				pstmt.setString(1, this.get(i).getSerialNo().trim());
			}
                pstmt.addBatch();
            }
            pstmt.executeBatch();
