...
/*
 * <p>ClassName: LPContPlanDetailRelaSubDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: Physical Data Model 1
 */
public class LPContPlanDetailRelaSubDBSet extends LPContPlanDetailRelaSubSet
{
	// @Field
	...
	**/
	...
	// @Constructor
	public LPContPlanDetailRelaSubDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public LPContPlanDetailRelaSubDBSet()
	{
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LPContPlanDetailRelaSubDBSet";
	...
	public boolean delete()
	{
		...
		try
		{
			...
			if(this.get(i).getRelaToMain() == null || this.get(i).getRelaToMain().equals("null")) {
				...
				pstmt.setString(8, this.get(i).getRelaToMain());
			}
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getPolicyNo() == null || this.get(i).getPolicyNo().equals("null")) {
				...
				pstmt.setString(44, this.get(i).getPolicyNo());
			}
			if(this.get(i).getSysPlanCode() == null || this.get(i).getSysPlanCode().equals("null")) {
				pstmt.setString(45,null);
			} else {
				pstmt.setString(45, this.get(i).getSysPlanCode());
			}
			if(this.get(i).getPlanCode() == null || this.get(i).getPlanCode().equals("null")) {
				pstmt.setString(46,null);
			} else {
				pstmt.setString(46, this.get(i).getPlanCode());
			}
			if(this.get(i).getRiskCode() == null || this.get(i).getRiskCode().equals("null")) {
				pstmt.setString(47,null);
			} else {
				pstmt.setString(47, this.get(i).getRiskCode());
			}
			if(this.get(i).getDutyCode() == null || this.get(i).getDutyCode().equals("null")) {
			...
			if(this.get(i).getRelaToMain() == null || this.get(i).getRelaToMain().equals("null")) {
				...
				pstmt.setString(49, this.get(i).getRelaToMain());
			}
