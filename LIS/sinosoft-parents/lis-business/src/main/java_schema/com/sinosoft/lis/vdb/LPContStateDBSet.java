...
/*
 * <p>ClassName: LPContStateDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 保全核心
 */
public class LPContStateDBSet extends LPContStateSet
{
private static Logger logger = Logger.getLogger(LPContStateDBSet.class);
	...
	**/
	...
	// @Constructor
	public LPContStateDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LPContStateDBSet";
