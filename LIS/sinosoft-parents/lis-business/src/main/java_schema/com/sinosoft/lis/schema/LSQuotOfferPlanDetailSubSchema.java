...
import com.sinosoft.lis.db.LSQuotOfferPlanDetailSubDB;

/*
 * <p>ClassName: LSQuotOfferPlanDetailSubSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: Physical Data Model 1
 */
public class LSQuotOfferPlanDetailSubSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LSQuotOfferPlanDetailSubSchema.class);
	// @Field
	/** 报价单号 */
	...
	// @Constructor
	public LSQuotOfferPlanDetailSubSchema()
	{
		mErrors = new CErrors();
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LSQuotOfferPlanDetailSubSchema cloned = (LSQuotOfferPlanDetailSubSchema)super.clone();
	...
	/**
	* 使用另外一个 LSQuotOfferPlanDetailSubSchema 对象给 Schema 赋值
	* @param: aLSQuotOfferPlanDetailSubSchema LSQuotOfferPlanDetailSubSchema
	**/
	public void setSchema(LSQuotOfferPlanDetailSubSchema aLSQuotOfferPlanDetailSubSchema)
	{
		this.OfferListNo = aLSQuotOfferPlanDetailSubSchema.getOfferListNo();
		this.SysPlanCode = aLSQuotOfferPlanDetailSubSchema.getSysPlanCode();
		this.PlanCode = aLSQuotOfferPlanDetailSubSchema.getPlanCode();
		this.RiskCode = aLSQuotOfferPlanDetailSubSchema.getRiskCode();
		this.DutyCode = aLSQuotOfferPlanDetailSubSchema.getDutyCode();
		this.P1 = aLSQuotOfferPlanDetailSubSchema.getP1();
		this.P2 = aLSQuotOfferPlanDetailSubSchema.getP2();
		this.P3 = aLSQuotOfferPlanDetailSubSchema.getP3();
		this.P4 = aLSQuotOfferPlanDetailSubSchema.getP4();
		this.P5 = aLSQuotOfferPlanDetailSubSchema.getP5();
		this.P6 = aLSQuotOfferPlanDetailSubSchema.getP6();
		this.P7 = aLSQuotOfferPlanDetailSubSchema.getP7();
		this.P8 = aLSQuotOfferPlanDetailSubSchema.getP8();
		this.P9 = aLSQuotOfferPlanDetailSubSchema.getP9();
		this.P10 = aLSQuotOfferPlanDetailSubSchema.getP10();
		this.P11 = aLSQuotOfferPlanDetailSubSchema.getP11();
		this.P12 = aLSQuotOfferPlanDetailSubSchema.getP12();
		this.P13 = aLSQuotOfferPlanDetailSubSchema.getP13();
		this.P14 = aLSQuotOfferPlanDetailSubSchema.getP14();
		this.P15 = aLSQuotOfferPlanDetailSubSchema.getP15();
		this.P16 = aLSQuotOfferPlanDetailSubSchema.getP16();
		this.P17 = aLSQuotOfferPlanDetailSubSchema.getP17();
		this.P18 = aLSQuotOfferPlanDetailSubSchema.getP18();
		this.P19 = aLSQuotOfferPlanDetailSubSchema.getP19();
		this.P20 = aLSQuotOfferPlanDetailSubSchema.getP20();
		this.P21 = aLSQuotOfferPlanDetailSubSchema.getP21();
		this.P22 = aLSQuotOfferPlanDetailSubSchema.getP22();
		this.P23 = aLSQuotOfferPlanDetailSubSchema.getP23();
		this.P24 = aLSQuotOfferPlanDetailSubSchema.getP24();
		this.P25 = aLSQuotOfferPlanDetailSubSchema.getP25();
		this.P26 = aLSQuotOfferPlanDetailSubSchema.getP26();
		this.P27 = aLSQuotOfferPlanDetailSubSchema.getP27();
		this.P28 = aLSQuotOfferPlanDetailSubSchema.getP28();
		this.P29 = aLSQuotOfferPlanDetailSubSchema.getP29();
		this.P30 = aLSQuotOfferPlanDetailSubSchema.getP30();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LSQuotOfferPlanDetailSub表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LSQuotOfferPlanDetailSubSchema";
	...
	public LSQuotOfferPlanDetailSubSchema getSchema()
	{
		LSQuotOfferPlanDetailSubSchema aLSQuotOfferPlanDetailSubSchema = new LSQuotOfferPlanDetailSubSchema();
		aLSQuotOfferPlanDetailSubSchema.setSchema(this);
		return aLSQuotOfferPlanDetailSubSchema;
	}

	public LSQuotOfferPlanDetailSubDB getDB()
	{
		LSQuotOfferPlanDetailSubDB aDBOper = new LSQuotOfferPlanDetailSubDB();
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLSQuotOfferPlanDetailSub>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			P21 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 26, SysConst.PACKAGESPILTER );
			P22 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 27, SysConst.PACKAGESPILTER );
			P23 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 28, SysConst.PACKAGESPILTER );
			P24 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 29, SysConst.PACKAGESPILTER );
			P25 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 30, SysConst.PACKAGESPILTER );
			P26 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 31, SysConst.PACKAGESPILTER );
			P27 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 32, SysConst.PACKAGESPILTER );
			P28 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 33, SysConst.PACKAGESPILTER );
			P29 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 34, SysConst.PACKAGESPILTER );
			P30 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 35, SysConst.PACKAGESPILTER );
		}
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LSQuotOfferPlanDetailSubSchema other = (LSQuotOfferPlanDetailSubSchema)otherObject;
		return
