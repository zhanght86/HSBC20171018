...
/*
 * <p>ClassName: LPInsuredDrawDetailDB </p>
 * <p>Description: DB层数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: Physical Data Model 1
 */
public class LPInsuredDrawDetailDB extends LPInsuredDrawDetailSchema
{
	// @Field
	...
	**/
	...
	// @Constructor
	public LPInsuredDrawDetailDB( Connection tConnection )
	{
		con = tConnection;
	...
	{
		LPInsuredDrawDetailSchema tSchema = this.getSchema();
		...
		else
		{
			...
			tError.moduleName = "LPInsuredDrawDetailDB";
	...
	public boolean update()
	{
		...
		try
		{
			...
			pstmt.setDouble(12, this.getSumMoney());
			if(this.getGetMode() == null || this.getGetMode().equals("null")) {
				pstmt.setNull(13, 12);
			} else {
				pstmt.setString(13, this.getGetMode());
			}
			pstmt.setInt(14, this.getGetIntv());
			if(this.getGetStartDate() == null || this.getGetStartDate().equals("null")) {
				pstmt.setNull(15, 91);
			} else {
				pstmt.setDate(15, Date.valueOf(this.getGetStartDate()));
			}
			if(this.getGetToDate() == null || this.getGetToDate().equals("null")) {
				pstmt.setNull(16, 91);
			} else {
				pstmt.setDate(16, Date.valueOf(this.getGetToDate()));
			}
			if(this.getGetEndDate() == null || this.getGetEndDate().equals("null")) {
				pstmt.setNull(17, 91);
			} else {
				pstmt.setDate(17, Date.valueOf(this.getGetEndDate()));
			}
			pstmt.setInt(18, this.getGetTimes());
			pstmt.setDouble(19, this.getGetMoney());
			if(this.getNextLiveDate() == null || this.getNextLiveDate().equals("null")) {
				pstmt.setNull(20, 91);
			} else {
				pstmt.setDate(20, Date.valueOf(this.getNextLiveDate()));
			}
			if(this.getNextGetDate() == null || this.getNextGetDate().equals("null")) {
				pstmt.setNull(21, 91);
			} else {
				pstmt.setDate(21, Date.valueOf(this.getNextGetDate()));
			}
			pstmt.setDouble(22, this.getAlreadyMoney());
			if(this.getGetEndState() == null || this.getGetEndState().equals("null")) {
				pstmt.setNull(23, 12);
			} else {
				pstmt.setString(23, this.getGetEndState());
			}
			...
			if(this.getEdorType() == null || this.getEdorType().equals("null")) {
				...
				pstmt.setString(33, this.getEdorType());
			}
			if(this.getPolNo() == null || this.getPolNo().equals("null")) {
				pstmt.setNull(34, 12);
			} else {
			...
			if(this.getGetDutyCode() == null || this.getGetDutyCode().equals("null")) {
				...
				pstmt.setString(36, this.getGetDutyCode());
			}
			pstmt.executeUpdate();
			pstmt.close();
		} catch (Exception ex) {
	...
	public boolean getInfo()
	{
		...
		try
		{
			pstmt = con.prepareStatement("SELECT * FROM LPInsuredDrawDetail WHERE  EdorNo = ? AND EdorType = ? AND PolNo = ? AND DutyCode = ? AND GetDutyCode = ?", 
	...
	public LPInsuredDrawDetailSet query()
	{
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		LPInsuredDrawDetailSet aLPInsuredDrawDetailSet = new LPInsuredDrawDetailSet();
	  ...
	  if( !mflag ) {
		...
		{
			SQLString sqlObj = new SQLString("LPInsuredDrawDetail");
			LPInsuredDrawDetailSchema aSchema = this.getSchema();
			...
			{
				i++;
				LPInsuredDrawDetailSchema s1 = new LPInsuredDrawDetailSchema();
				s1.setSchema(rs,i);
				aLPInsuredDrawDetailSet.add(s1);
			}
			try{ rs.close(); } catch( Exception ex ) {}
			try{ pstmt.close(); } catch( Exception ex1 ) {}
		}
		...
		return aLPInsuredDrawDetailSet;
	}

	public LPInsuredDrawDetailSet executeQuery(String sql)
	{
		Statement stmt = null;
		ResultSet rs = null;
		LPInsuredDrawDetailSet aLPInsuredDrawDetailSet = new LPInsuredDrawDetailSet();
	...
	public LPInsuredDrawDetailSet query(int nStart, int nCount)
	{
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		LPInsuredDrawDetailSet aLPInsuredDrawDetailSet = new LPInsuredDrawDetailSet();
	...
	public LPInsuredDrawDetailSet executeQuery(String sql, int nStart, int nCount)
	{
		Statement stmt = null;
		ResultSet rs = null;
		LPInsuredDrawDetailSet aLPInsuredDrawDetailSet = new LPInsuredDrawDetailSet();
	...
	public boolean update(String strWherePart)
	{
	  ...
	  if( !mflag ) {
		...
		try
		{
			...
			String sql = "update LPInsuredDrawDetail " + sqlObj.getUpdPart() + " where " + strWherePart;
...
/**
 * 获取定量数据
 * @return LPInsuredDrawDetailSet
 */
public LPInsuredDrawDetailSet getData()
{
    int tCount = 0;
    LPInsuredDrawDetailSet tLPInsuredDrawDetailSet = new LPInsuredDrawDetailSet();
    LPInsuredDrawDetailSchema tLPInsuredDrawDetailSchema = null;
    if (null == mResultSet)
    {
        CError tError = new CError();
        tError.moduleName = "LPInsuredDrawDetailDB";
    ...
    {
        tCount = 1;
        tLPInsuredDrawDetailSchema = new LPInsuredDrawDetailSchema();
        tLPInsuredDrawDetailSchema.setSchema(mResultSet, 1);
        tLPInsuredDrawDetailSet.add(tLPInsuredDrawDetailSchema);
    ...
    return tLPInsuredDrawDetailSet;
}
/**
 * 关闭数据集
 * @return boolean
...
public boolean closeData()
{
	...
	public LPInsuredDrawDetailSet executeQuery(SQLwithBindVariables sqlbv) {
	...
	public LPInsuredDrawDetailSet executeQuery(SQLwithBindVariables sqlbv, int nStart, int nCount) {
