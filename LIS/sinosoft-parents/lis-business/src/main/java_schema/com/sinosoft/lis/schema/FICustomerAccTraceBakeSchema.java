...
import com.sinosoft.lis.db.FICustomerAccTraceBakeDB;
...
/**
 * <p>
 * ClassName: FICustomerAccTraceBakeSchema
 * </p>
 * <p>
 * Description: 客户账户轨迹备份表（FICustomerAccTraceBake）的Schema文件
 * </p>
 * <p>
 * Company: sinosoft
 * </p>
 ...
 */
public class FICustomerAccTraceBakeSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(FICustomerAccTraceBakeSchema.class);
	...
	// @Constructor
	public FICustomerAccTraceBakeSchema()
	{
		mErrors = new CErrors();
	...
	{
		FICustomerAccTraceBakeSchema cloned = (FICustomerAccTraceBakeSchema) super.clone();
	...
	/**
	 * 使用另外一个 FICustomerAccTraceBakeSchema 对象给 Schema 赋值
	 * @param: aFICustomerAccTraceBakeSchema FICustomerAccTraceBakeSchema
	 **/
	public void setSchema(FICustomerAccTraceBakeSchema aFICustomerAccTraceBakeSchema)
	{
		this.Sequence = aFICustomerAccTraceBakeSchema.getSequence();
		this.InsuAccNo = aFICustomerAccTraceBakeSchema.getInsuAccNo();
		this.CustomerNo = aFICustomerAccTraceBakeSchema.getCustomerNo();
		this.CustomerType = aFICustomerAccTraceBakeSchema.getCustomerType();
		this.ContNo = aFICustomerAccTraceBakeSchema.getContNo();
		this.OperationNo = aFICustomerAccTraceBakeSchema.getOperationNo();
		this.OperationType = aFICustomerAccTraceBakeSchema.getOperationType();
		this.PayMode = aFICustomerAccTraceBakeSchema.getPayMode();
		this.OperType = aFICustomerAccTraceBakeSchema.getOperType();
		this.OtherNo = aFICustomerAccTraceBakeSchema.getOtherNo();
		this.DCFlag = aFICustomerAccTraceBakeSchema.getDCFlag();
		this.Currency = aFICustomerAccTraceBakeSchema.getCurrency();
		this.Money = aFICustomerAccTraceBakeSchema.getMoney();
		this.State = aFICustomerAccTraceBakeSchema.getState();
		this.ConfDate = fDate.getDate(aFICustomerAccTraceBakeSchema.getConfDate());
		this.ConfTime = aFICustomerAccTraceBakeSchema.getConfTime();
		this.Operator = aFICustomerAccTraceBakeSchema.getOperator();
		this.MakeDate = fDate.getDate(aFICustomerAccTraceBakeSchema.getMakeDate());
		this.MakeTime = aFICustomerAccTraceBakeSchema.getMakeTime();
		this.ModifyDate = fDate.getDate(aFICustomerAccTraceBakeSchema.getModifyDate());
		this.ModifyTime = aFICustomerAccTraceBakeSchema.getModifyTime();
		this.EnterAccDate = fDate.getDate(aFICustomerAccTraceBakeSchema.getEnterAccDate());
		this.EnterAccTime = aFICustomerAccTraceBakeSchema.getEnterAccTime();
	}
	...
	public boolean setSchema(ResultSet rs, int i)
	{
		...
		{
			logger.debug("数据库中的FICustomerAccTraceBake表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "FICustomerAccTraceBakeSchema";
	...
	public FICustomerAccTraceBakeSchema getSchema()
	{
		FICustomerAccTraceBakeSchema aFICustomerAccTraceBakeSchema = new FICustomerAccTraceBakeSchema();
		aFICustomerAccTraceBakeSchema.setSchema(this);
		return aFICustomerAccTraceBakeSchema;
	}

	public FICustomerAccTraceBakeDB getDB()
	{
		FICustomerAccTraceBakeDB aDBOper = new FICustomerAccTraceBakeDB();
	 ...
	 * /dataStructure/tb.html#PrpFICustomerAccTraceBake>历史记账凭证主表信息</A>表字段
	...
	public boolean equals(Object otherObject)
	{
		...
		if (getClass() != otherObject.getClass())
			return false;
		FICustomerAccTraceBakeSchema other = (FICustomerAccTraceBakeSchema) otherObject;
