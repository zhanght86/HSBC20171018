...
/*
 * <p>ClassName: RnewScoreRReportSubDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 续期续保二核
 */
public class RnewScoreRReportSubDBSet extends RnewScoreRReportSubSet
{
private static Logger logger = Logger.getLogger(RnewScoreRReportSubDBSet.class);
	...
	**/
	...
	// @Constructor
	public RnewScoreRReportSubDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public RnewScoreRReportSubDBSet()
	{
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "RnewScoreRReportSubDBSet";
