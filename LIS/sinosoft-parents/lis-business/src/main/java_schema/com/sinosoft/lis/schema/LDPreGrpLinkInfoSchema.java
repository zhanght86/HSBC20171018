...
import com.sinosoft.lis.db.LDPreGrpLinkInfoDB;

/*
 * <p>ClassName: LDPreGrpLinkInfoSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: Physical Data Model 1
 */
public class LDPreGrpLinkInfoSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LDPreGrpLinkInfoSchema.class);
	// @Field
	/** 准客户号码 */
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LDPreGrpLinkInfoSchema cloned = (LDPreGrpLinkInfoSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LDPreGrpLinkInfoSchema 对象给 Schema 赋值
	* @param: aLDPreGrpLinkInfoSchema LDPreGrpLinkInfoSchema
	**/
	public void setSchema(LDPreGrpLinkInfoSchema aLDPreGrpLinkInfoSchema)
	{
		this.PreCustomerNo = aLDPreGrpLinkInfoSchema.getPreCustomerNo();
		this.LinkOrderNo = aLDPreGrpLinkInfoSchema.getLinkOrderNo();
		this.LinkType = aLDPreGrpLinkInfoSchema.getLinkType();
		this.LinkMan = aLDPreGrpLinkInfoSchema.getLinkMan();
		this.IDType = aLDPreGrpLinkInfoSchema.getIDType();
		this.IDNo = aLDPreGrpLinkInfoSchema.getIDNo();
		this.IDExpiryDate = fDate.getDate( aLDPreGrpLinkInfoSchema.getIDExpiryDate());
		this.Mobile = aLDPreGrpLinkInfoSchema.getMobile();
		this.Phone = aLDPreGrpLinkInfoSchema.getPhone();
		this.Fax = aLDPreGrpLinkInfoSchema.getFax();
		this.Email = aLDPreGrpLinkInfoSchema.getEmail();
		this.Depart = aLDPreGrpLinkInfoSchema.getDepart();
		this.Post = aLDPreGrpLinkInfoSchema.getPost();
		this.MakeOperator = aLDPreGrpLinkInfoSchema.getMakeOperator();
		this.MakeDate = fDate.getDate( aLDPreGrpLinkInfoSchema.getMakeDate());
		this.MakeTime = aLDPreGrpLinkInfoSchema.getMakeTime();
		this.ModifyOperator = aLDPreGrpLinkInfoSchema.getModifyOperator();
		this.ModifyDate = fDate.getDate( aLDPreGrpLinkInfoSchema.getModifyDate());
		this.ModifyTime = aLDPreGrpLinkInfoSchema.getModifyTime();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LDPreGrpLinkInfo表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LDPreGrpLinkInfoSchema";
	...
	public LDPreGrpLinkInfoSchema getSchema()
	{
		LDPreGrpLinkInfoSchema aLDPreGrpLinkInfoSchema = new LDPreGrpLinkInfoSchema();
		aLDPreGrpLinkInfoSchema.setSchema(this);
		return aLDPreGrpLinkInfoSchema;
	}

	public LDPreGrpLinkInfoDB getDB()
	{
		LDPreGrpLinkInfoDB aDBOper = new LDPreGrpLinkInfoDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLDPreGrpLinkInfo描述/A>表字段
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLDPreGrpLinkInfo>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			LinkOrderNo= new Integer(ChgData.chgNumericStr(StrTool.getStr(strMessage,2,SysConst.PACKAGESPILTER))).intValue();
			LinkType = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 3, SysConst.PACKAGESPILTER );
			...
			IDExpiryDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 7,SysConst.PACKAGESPILTER));
			Mobile = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 8, SysConst.PACKAGESPILTER );
			...
			Depart = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 12, SysConst.PACKAGESPILTER );
			Post = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 13, SysConst.PACKAGESPILTER );
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LDPreGrpLinkInfoSchema other = (LDPreGrpLinkInfoSchema)otherObject;
		return
