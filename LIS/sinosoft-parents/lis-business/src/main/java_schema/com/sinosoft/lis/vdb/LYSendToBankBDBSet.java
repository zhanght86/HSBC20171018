...
/*
 * <p>ClassName: LYSendToBankBDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 银行业务
 */
public class LYSendToBankBDBSet extends LYSendToBankBSet
{
private static Logger logger = Logger.getLogger(LYSendToBankBDBSet.class);
	...
	**/
	...
	// @Constructor
	public LYSendToBankBDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LYSendToBankBDBSet";
