...
import com.sinosoft.lis.db.LJTempFeeClassBakDB;

/*
 * <p>ClassName: LJTempFeeClassBakSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: PhysicalDataModel_1
 */
public class LJTempFeeClassBakSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LJTempFeeClassBakSchema.class);
	...
	// @Constructor
	public LJTempFeeClassBakSchema()
	{
		mErrors = new CErrors();
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LJTempFeeClassBakSchema cloned = (LJTempFeeClassBakSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LJTempFeeClassBakSchema 对象给 Schema 赋值
	* @param: aLJTempFeeClassBakSchema LJTempFeeClassBakSchema
	**/
	public void setSchema(LJTempFeeClassBakSchema aLJTempFeeClassBakSchema)
	{
		this.TempFeeNo = aLJTempFeeClassBakSchema.getTempFeeNo();
		this.PayMode = aLJTempFeeClassBakSchema.getPayMode();
		this.ChequeNo = aLJTempFeeClassBakSchema.getChequeNo();
		this.PayMoney = aLJTempFeeClassBakSchema.getPayMoney();
		this.AppntName = aLJTempFeeClassBakSchema.getAppntName();
		this.PayDate = fDate.getDate( aLJTempFeeClassBakSchema.getPayDate());
		this.ConfDate = fDate.getDate( aLJTempFeeClassBakSchema.getConfDate());
		this.ApproveDate = fDate.getDate( aLJTempFeeClassBakSchema.getApproveDate());
		this.EnterAccDate = fDate.getDate( aLJTempFeeClassBakSchema.getEnterAccDate());
		this.ConfFlag = aLJTempFeeClassBakSchema.getConfFlag();
		this.SerialNo = aLJTempFeeClassBakSchema.getSerialNo();
		this.ManageCom = aLJTempFeeClassBakSchema.getManageCom();
		this.PolicyCom = aLJTempFeeClassBakSchema.getPolicyCom();
		this.BankCode = aLJTempFeeClassBakSchema.getBankCode();
		this.BankAccNo = aLJTempFeeClassBakSchema.getBankAccNo();
		this.AccName = aLJTempFeeClassBakSchema.getAccName();
		this.ConfMakeDate = fDate.getDate( aLJTempFeeClassBakSchema.getConfMakeDate());
		this.ConfMakeTime = aLJTempFeeClassBakSchema.getConfMakeTime();
		this.ChequeDate = fDate.getDate( aLJTempFeeClassBakSchema.getChequeDate());
		this.Operator = aLJTempFeeClassBakSchema.getOperator();
		this.MakeDate = fDate.getDate( aLJTempFeeClassBakSchema.getMakeDate());
		this.MakeTime = aLJTempFeeClassBakSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLJTempFeeClassBakSchema.getModifyDate());
		this.ModifyTime = aLJTempFeeClassBakSchema.getModifyTime();
		this.InBankCode = aLJTempFeeClassBakSchema.getInBankCode();
		this.InBankAccNo = aLJTempFeeClassBakSchema.getInBankAccNo();
		this.InAccName = aLJTempFeeClassBakSchema.getInAccName();
		this.ContCom = aLJTempFeeClassBakSchema.getContCom();
		this.OtherNo = aLJTempFeeClassBakSchema.getOtherNo();
		this.OtherNoType = aLJTempFeeClassBakSchema.getOtherNoType();
		this.TempFeeNoType = aLJTempFeeClassBakSchema.getTempFeeNoType();
		this.OperState = aLJTempFeeClassBakSchema.getOperState();
		this.IDType = aLJTempFeeClassBakSchema.getIDType();
		this.IDNo = aLJTempFeeClassBakSchema.getIDNo();
		this.OriBankAccNo = aLJTempFeeClassBakSchema.getOriBankAccNo();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LJTempFeeClassBak表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LJTempFeeClassBakSchema";
	...
	public LJTempFeeClassBakSchema getSchema()
	{
		LJTempFeeClassBakSchema aLJTempFeeClassBakSchema = new LJTempFeeClassBakSchema();
		aLJTempFeeClassBakSchema.setSchema(this);
		return aLJTempFeeClassBakSchema;
	}

	public LJTempFeeClassBakDB getDB()
	{
		LJTempFeeClassBakDB aDBOper = new LJTempFeeClassBakDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLJTempFeeClassBak描述/A>表字段
	...
	**/
	public String encode()
	{
		...
		strReturn.append(StrTool.cTrim(OriBankAccNo));
		return strReturn.toString();
	}

	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLJTempFeeClassBak>历史记账凭证主表信息</A>表字段
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LJTempFeeClassBakSchema other = (LJTempFeeClassBakSchema)otherObject;
		return
