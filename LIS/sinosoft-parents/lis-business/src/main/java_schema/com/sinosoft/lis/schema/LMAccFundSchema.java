...
import com.sinosoft.lis.db.LMAccFundDB;

/*
 * <p>ClassName: LMAccFundSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 投连改造
 */
public class LMAccFundSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LMAccFundSchema.class);
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LMAccFundSchema cloned = (LMAccFundSchema)super.clone();
	...
	*/
	...
	{
		if(aSaleState!=null && aSaleState.length()>1)
			throw new IllegalArgumentException("销售状态SaleState值"+aSaleState+"的长度"+aSaleState.length()+"大于最大值1");
		SaleState = aSaleState;
	}

	/**
	* 使用另外一个 LMAccFundSchema 对象给 Schema 赋值
	* @param: aLMAccFundSchema LMAccFundSchema
	**/
	public void setSchema(LMAccFundSchema aLMAccFundSchema)
	{
		this.InsuAccNo = aLMAccFundSchema.getInsuAccNo();
		this.FundNo = aLMAccFundSchema.getFundNo();
		this.FundName = aLMAccFundSchema.getFundName();
		this.SaleState = aLMAccFundSchema.getSaleState();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LMAccFund表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LMAccFundSchema";
	...
	public LMAccFundSchema getSchema()
	{
		LMAccFundSchema aLMAccFundSchema = new LMAccFundSchema();
		aLMAccFundSchema.setSchema(this);
		return aLMAccFundSchema;
	}

	public LMAccFundDB getDB()
	{
		LMAccFundDB aDBOper = new LMAccFundDB();
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLMAccFund>历史记账凭证主表信息</A>表字段
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LMAccFundSchema other = (LMAccFundSchema)otherObject;
		return
