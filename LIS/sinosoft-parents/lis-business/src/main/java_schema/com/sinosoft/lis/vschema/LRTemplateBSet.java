...
/*
 * <p>ClassName: LRTemplateBSet </p>
 * <p>Description: LRTemplateBSchemaSet类文件 </p>
...
public class LRTemplateBSet extends SchemaSet
{
	...
	{
		LRTemplateBSchema tSchema = (LRTemplateBSchema)super.getObj(index);
		return tSchema;
	}
	...
	**/
	public String encode()
	{
		...
		for (int i = 1; i <= n; i++)
		{
			LRTemplateBSchema aSchema = this.get(i);
	...
	**/
	public boolean decode( String str )
	{
		...
		while( nEndPos != -1 )
		{
			LRTemplateBSchema aSchema = new LRTemplateBSchema();
		...
		LRTemplateBSchema tSchema = new LRTemplateBSchema();
