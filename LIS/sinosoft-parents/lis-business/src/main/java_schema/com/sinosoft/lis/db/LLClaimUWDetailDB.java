...
/*
 * <p>ClassName: LLClaimUWDetailDB </p>
 * <p>Description: DB层数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 理赔管理
 */
public class LLClaimUWDetailDB extends LLClaimUWDetailSchema
{
	// @Field
	...
	**/
	...
	// @Constructor
	public LLClaimUWDetailDB( Connection tConnection )
	{
		con = tConnection;
	...
	{
		LLClaimUWDetailSchema tSchema = this.getSchema();
		...
		else
		{
			...
			tError.moduleName = "LLClaimUWDetailDB";
	...
	public boolean delete()
	{
		...
		try
		{
			...
			if(this.getClmUWNo() == null || this.getClmUWNo().equals("null")) {
				...
				pstmt.setString(3, this.getClmUWNo());
			}
			...
			if(this.getCaseRelaNo() == null || this.getCaseRelaNo().equals("null")) {
				...
				pstmt.setString(8, this.getCaseRelaNo());
			}
			pstmt.executeUpdate();
			pstmt.close();
		} catch (Exception ex) {
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.getDefoType() == null || this.getDefoType().equals("null")) {
				...
				pstmt.setString(9, this.getDefoType());
			}
			...
			if(this.getPolMngCom() == null || this.getPolMngCom().equals("null")) {
				...
				pstmt.setString(16, this.getPolMngCom());
			}
			...
			pstmt.setDouble(20, this.getTabFeeMoney());
			pstmt.setDouble(21, this.getClaimMoney());
			pstmt.setDouble(22, this.getStandPay());
			pstmt.setDouble(23, this.getRealPay());
			if(this.getAdjReason() == null || this.getAdjReason().equals("null")) {
				pstmt.setNull(24, 12);
			} else {
				pstmt.setString(24, this.getAdjReason());
			}
			if(this.getAdjRemark() == null || this.getAdjRemark().equals("null")) {
				pstmt.setNull(25, 12);
			} else {
				pstmt.setString(25, this.getAdjRemark());
			}
			if(this.getGiveType() == null || this.getGiveType().equals("null")) {
				pstmt.setNull(26, 12);
			} else {
				pstmt.setString(26, this.getGiveType());
			}
			if(this.getGiveTypeDesc() == null || this.getGiveTypeDesc().equals("null")) {
				pstmt.setNull(27, 12);
			} else {
				pstmt.setString(27, this.getGiveTypeDesc());
			}
			if(this.getGiveReason() == null || this.getGiveReason().equals("null")) {
				pstmt.setNull(28, 12);
			} else {
				pstmt.setString(28, this.getGiveReason());
			}
			if(this.getGiveReasonDesc() == null || this.getGiveReasonDesc().equals("null")) {
				pstmt.setNull(29, 12);
			} else {
				pstmt.setString(29, this.getGiveReasonDesc());
			}
			...
			if(this.getReceiptNo() == null || this.getReceiptNo().equals("null")) {
				...
				pstmt.setString(32, this.getReceiptNo());
			}
			if(this.getRemark() == null || this.getRemark().equals("null")) {
				pstmt.setNull(33, 12);
			} else {
				pstmt.setString(33, this.getRemark());
			}
			if(this.getAppClmUWer() == null || this.getAppClmUWer().equals("null")) {
				pstmt.setNull(34, 12);
			} else {
				pstmt.setString(34, this.getAppClmUWer());
			}
			if(this.getAppActionType() == null || this.getAppActionType().equals("null")) {
				pstmt.setNull(35, 1);
			} else {
				pstmt.setString(35, this.getAppActionType());
			}
			...
			if(this.getMngCom() == null || this.getMngCom().equals("null")) {
				...
				pstmt.setString(38, this.getMngCom());
			}
			...
			if(this.getPrepayFlag() == null || this.getPrepayFlag().equals("null")) {
				...
				pstmt.setString(44, this.getPrepayFlag());
			}
			pstmt.setDouble(45, this.getPrepaySum());
			pstmt.setDouble(46, this.getAmnt());
			pstmt.setDouble(47, this.getYearBonus());
			pstmt.setDouble(48, this.getEndBonus());
			pstmt.setInt(49, this.getGracePeriod());
			if(this.getCasePolType() == null || this.getCasePolType().equals("null")) {
				pstmt.setNull(50, 12);
			} else {
				pstmt.setString(50, this.getCasePolType());
			}
			if(this.getCustomerNo() == null || this.getCustomerNo().equals("null")) {
				pstmt.setNull(51, 12);
			} else {
				pstmt.setString(51, this.getCustomerNo());
			}
			if(this.getAcctFlag() == null || this.getAcctFlag().equals("null")) {
				pstmt.setNull(52, 12);
			} else {
				pstmt.setString(52, this.getAcctFlag());
			}
			if(this.getPosFlag() == null || this.getPosFlag().equals("null")) {
				pstmt.setNull(53, 12);
			} else {
				pstmt.setString(53, this.getPosFlag());
			}
			if(this.getPosEdorNo() == null || this.getPosEdorNo().equals("null")) {
				pstmt.setNull(54, 12);
			} else {
				pstmt.setString(54, this.getPosEdorNo());
			}
			...
			if(this.getEffectOnMainRisk() == null || this.getEffectOnMainRisk().equals("null")) {
				...
				pstmt.setString(56, this.getEffectOnMainRisk());
			}
			if(this.getRiskCalCode() == null || this.getRiskCalCode().equals("null")) {
				pstmt.setNull(57, 12);
			} else {
				pstmt.setString(57, this.getRiskCalCode());
			}
			pstmt.setDouble(58, this.getAddAmnt());
			if(this.getPosEdorType() == null || this.getPosEdorType().equals("null")) {
				pstmt.setNull(59, 12);
			} else {
				pstmt.setString(59, this.getPosEdorType());
			}
			if(this.getRiskType() == null || this.getRiskType().equals("null")) {
				pstmt.setNull(60, 12);
			} else {
				pstmt.setString(60, this.getRiskType());
			}
			if(this.getBackNo() == null || this.getBackNo().equals("null")) {
				pstmt.setNull(61, 12);
			} else {
				pstmt.setString(61, this.getBackNo());
			}
			pstmt.setDouble(62, this.getPopedomPay());
			pstmt.setDouble(63, this.getInsFeePay());
			// set where condition
			if(this.getClmNo() == null || this.getClmNo().equals("null")) {
				pstmt.setNull(64, 12);
			} else {
				pstmt.setString(64, this.getClmNo());
			}
			if(this.getCaseNo() == null || this.getCaseNo().equals("null")) {
				pstmt.setNull(65, 12);
			} else {
				pstmt.setString(65, this.getCaseNo());
			}
			if(this.getClmUWNo() == null || this.getClmUWNo().equals("null")) {
				pstmt.setNull(66, 12);
			} else {
				pstmt.setString(66, this.getClmUWNo());
			}
			if(this.getPolNo() == null || this.getPolNo().equals("null")) {
				pstmt.setNull(67, 12);
			} else {
				pstmt.setString(67, this.getPolNo());
			}
			if(this.getDutyCode() == null || this.getDutyCode().equals("null")) {
				pstmt.setNull(68, 12);
			} else {
			...
			if(this.getGetDutyCode() == null || this.getGetDutyCode().equals("null")) {
				...
				pstmt.setString(69, this.getGetDutyCode());
			}
			if(this.getGetDutyKind() == null || this.getGetDutyKind().equals("null")) {
				pstmt.setNull(70, 12);
			} else {
				pstmt.setString(70, this.getGetDutyKind());
			}
			if(this.getCaseRelaNo() == null || this.getCaseRelaNo().equals("null")) {
				pstmt.setNull(71, 12);
			} else {
				pstmt.setString(71, this.getCaseRelaNo());
			}
			pstmt.executeUpdate();
			pstmt.close();
		} catch (Exception ex) {
	...
	public boolean getInfo()
	{
		...
		try
		{
			pstmt = con.prepareStatement("SELECT * FROM LLClaimUWDetail WHERE  ClmNo = ? AND CaseNo = ? AND ClmUWNo = ? AND PolNo = ? AND DutyCode = ? AND GetDutyCode = ? AND GetDutyKind = ? AND CaseRelaNo = ?", 
	...
	public LLClaimUWDetailSet query()
	{
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		LLClaimUWDetailSet aLLClaimUWDetailSet = new LLClaimUWDetailSet();
	  ...
	  if( !mflag ) {
		...
		{
			SQLString sqlObj = new SQLString("LLClaimUWDetail");
			LLClaimUWDetailSchema aSchema = this.getSchema();
			...
			{
				i++;
				LLClaimUWDetailSchema s1 = new LLClaimUWDetailSchema();
				s1.setSchema(rs,i);
				aLLClaimUWDetailSet.add(s1);
			}
			try{ rs.close(); } catch( Exception ex ) {}
			try{ pstmt.close(); } catch( Exception ex1 ) {}
		}
		...
		return aLLClaimUWDetailSet;
	}

	public LLClaimUWDetailSet executeQuery(String sql)
	{
		Statement stmt = null;
		ResultSet rs = null;
		LLClaimUWDetailSet aLLClaimUWDetailSet = new LLClaimUWDetailSet();
	...
	public LLClaimUWDetailSet query(int nStart, int nCount)
	{
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		LLClaimUWDetailSet aLLClaimUWDetailSet = new LLClaimUWDetailSet();
	...
	public LLClaimUWDetailSet executeQuery(String sql, int nStart, int nCount)
	{
		Statement stmt = null;
		ResultSet rs = null;
		LLClaimUWDetailSet aLLClaimUWDetailSet = new LLClaimUWDetailSet();
	...
	public boolean update(String strWherePart)
	{
	  ...
	  if( !mflag ) {
		...
		try
		{
			...
			String sql = "update LLClaimUWDetail " + sqlObj.getUpdPart() + " where " + strWherePart;
...
/**
 * 获取定量数据
 * @return LLClaimUWDetailSet
 */
public LLClaimUWDetailSet getData()
{
    int tCount = 0;
    ...
    try
    {
        ...
        tLLClaimUWDetailSchema.setSchema(mResultSet, 1);
...
public boolean closeData()
{
	...
	public LLClaimUWDetailSet executeQuery(SQLwithBindVariables sqlbv) {
	...
	public LLClaimUWDetailSet executeQuery(SQLwithBindVariables sqlbv, int nStart, int nCount) {
