...
/*
 * <p>ClassName: LRBOMItemSet </p>
 * <p>Description: LRBOMItemSchemaSet类文件 </p>
...
{
private static Logger logger = Logger.getLogger(LRBOMItemSet.class);
	...
	{
		LRBOMItemSchema tSchema = (LRBOMItemSchema)super.getObj(index);
		return tSchema;
	}
	...
	**/
	public String encode()
	{
		...
		for (int i = 1; i <= n; i++)
		{
			LRBOMItemSchema aSchema = this.get(i);
	...
	**/
	public boolean decode( String str )
	{
		...
		while( nEndPos != -1 )
		{
			LRBOMItemSchema aSchema = new LRBOMItemSchema();
		...
		LRBOMItemSchema tSchema = new LRBOMItemSchema();
