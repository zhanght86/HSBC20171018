...
/*
 * <p>ClassName: LBPOEdorInvestListDB </p>
 * <p>Description: DB层数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: Physical Data Model 1
 */
public class LBPOEdorInvestListDB extends LBPOEdorInvestListSchema
{
	// @Field
	...
	**/
	...
	// @Constructor
	public LBPOEdorInvestListDB( Connection tConnection )
	{
		con = tConnection;
	...
	{
		LBPOEdorInvestListSchema tSchema = this.getSchema();
		...
		else
		{
			...
			tError.moduleName = "LBPOEdorInvestListDB";
	...
	public boolean getInfo()
	{
		...
		try
		{
			pstmt = con.prepareStatement("SELECT * FROM LBPOEdorInvestList WHERE  SerialNo = ?", 
	...
	public LBPOEdorInvestListSet query()
	{
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		LBPOEdorInvestListSet aLBPOEdorInvestListSet = new LBPOEdorInvestListSet();
	  ...
	  if( !mflag ) {
		...
		{
			SQLString sqlObj = new SQLString("LBPOEdorInvestList");
			LBPOEdorInvestListSchema aSchema = this.getSchema();
			...
			{
				i++;
				LBPOEdorInvestListSchema s1 = new LBPOEdorInvestListSchema();
				s1.setSchema(rs,i);
				aLBPOEdorInvestListSet.add(s1);
			}
			try{ rs.close(); } catch( Exception ex ) {}
			try{ pstmt.close(); } catch( Exception ex1 ) {}
		}
		...
		return aLBPOEdorInvestListSet;
	}

	public LBPOEdorInvestListSet executeQuery(String sql)
	{
		Statement stmt = null;
		ResultSet rs = null;
		LBPOEdorInvestListSet aLBPOEdorInvestListSet = new LBPOEdorInvestListSet();
	...
	public LBPOEdorInvestListSet query(int nStart, int nCount)
	{
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		LBPOEdorInvestListSet aLBPOEdorInvestListSet = new LBPOEdorInvestListSet();
	...
	public LBPOEdorInvestListSet executeQuery(String sql, int nStart, int nCount)
	{
		Statement stmt = null;
		ResultSet rs = null;
		LBPOEdorInvestListSet aLBPOEdorInvestListSet = new LBPOEdorInvestListSet();
	...
	public boolean update(String strWherePart)
	{
	  ...
	  if( !mflag ) {
		...
		try
		{
			...
			String sql = "update LBPOEdorInvestList " + sqlObj.getUpdPart() + " where " + strWherePart;
...
/**
 * 获取定量数据
 * @return LBPOEdorInvestListSet
 */
public LBPOEdorInvestListSet getData()
{
    int tCount = 0;
    LBPOEdorInvestListSet tLBPOEdorInvestListSet = new LBPOEdorInvestListSet();
    LBPOEdorInvestListSchema tLBPOEdorInvestListSchema = null;
    if (null == mResultSet)
    {
        CError tError = new CError();
        tError.moduleName = "LBPOEdorInvestListDB";
    ...
    {
        tCount = 1;
        tLBPOEdorInvestListSchema = new LBPOEdorInvestListSchema();
        tLBPOEdorInvestListSchema.setSchema(mResultSet, 1);
...
public boolean closeData()
{
	...
	public LBPOEdorInvestListSet executeQuery(SQLwithBindVariables sqlbv) {
	...
	public LBPOEdorInvestListSet executeQuery(SQLwithBindVariables sqlbv, int nStart, int nCount) {
