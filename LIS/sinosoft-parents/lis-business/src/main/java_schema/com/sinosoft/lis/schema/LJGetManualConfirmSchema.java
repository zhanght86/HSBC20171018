...
import com.sinosoft.lis.db.LJGetManualConfirmDB;

/*
 * <p>ClassName: LJGetManualConfirmSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: Physical Data Model 1
 */
public class LJGetManualConfirmSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LJGetManualConfirmSchema.class);
	// @Field
	/** 申请批次号 */
	...
	// @Constructor
	public LJGetManualConfirmSchema()
	{
		mErrors = new CErrors();
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LJGetManualConfirmSchema cloned = (LJGetManualConfirmSchema)super.clone();
	...
	/**
	* 使用另外一个 LJGetManualConfirmSchema 对象给 Schema 赋值
	* @param: aLJGetManualConfirmSchema LJGetManualConfirmSchema
	**/
	public void setSchema(LJGetManualConfirmSchema aLJGetManualConfirmSchema)
	{
		this.ApplyBatNo = aLJGetManualConfirmSchema.getApplyBatNo();
		this.AppOperator = aLJGetManualConfirmSchema.getAppOperator();
		this.AppDate = fDate.getDate( aLJGetManualConfirmSchema.getAppDate());
		this.AppTime = aLJGetManualConfirmSchema.getAppTime();
		this.ManageCom = aLJGetManualConfirmSchema.getManageCom();
		this.ComCode = aLJGetManualConfirmSchema.getComCode();
		this.MakeOperator = aLJGetManualConfirmSchema.getMakeOperator();
		this.MakeDate = fDate.getDate( aLJGetManualConfirmSchema.getMakeDate());
		this.MakeTime = aLJGetManualConfirmSchema.getMakeTime();
		this.ModifyOperator = aLJGetManualConfirmSchema.getModifyOperator();
		this.ModifyDate = fDate.getDate( aLJGetManualConfirmSchema.getModifyDate());
		this.ModifyTime = aLJGetManualConfirmSchema.getModifyTime();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LJGetManualConfirm表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LJGetManualConfirmSchema";
	...
	public LJGetManualConfirmSchema getSchema()
	{
		LJGetManualConfirmSchema aLJGetManualConfirmSchema = new LJGetManualConfirmSchema();
		aLJGetManualConfirmSchema.setSchema(this);
		return aLJGetManualConfirmSchema;
	}

	public LJGetManualConfirmDB getDB()
	{
		LJGetManualConfirmDB aDBOper = new LJGetManualConfirmDB();
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLJGetManualConfirm>历史记账凭证主表信息</A>表字段
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LJGetManualConfirmSchema other = (LJGetManualConfirmSchema)otherObject;
		return
