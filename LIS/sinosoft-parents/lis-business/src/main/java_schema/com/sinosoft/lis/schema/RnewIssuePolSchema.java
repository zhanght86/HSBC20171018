...
/*
 * <p>ClassName: RnewIssuePolSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 续期续保二核
 */
public class RnewIssuePolSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(RnewIssuePolSchema.class);
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		RnewIssuePolSchema cloned = (RnewIssuePolSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 RnewIssuePolSchema 对象给 Schema 赋值
	* @param: aRnewIssuePolSchema RnewIssuePolSchema
	**/
	public void setSchema(RnewIssuePolSchema aRnewIssuePolSchema)
	{
		this.GrpContNo = aRnewIssuePolSchema.getGrpContNo();
		this.ContNo = aRnewIssuePolSchema.getContNo();
		this.ProposalContNo = aRnewIssuePolSchema.getProposalContNo();
		this.PrtSeq = aRnewIssuePolSchema.getPrtSeq();
		this.SerialNo = aRnewIssuePolSchema.getSerialNo();
		this.FieldName = aRnewIssuePolSchema.getFieldName();
		this.Location = aRnewIssuePolSchema.getLocation();
		this.IssueType = aRnewIssuePolSchema.getIssueType();
		this.OperatePos = aRnewIssuePolSchema.getOperatePos();
		this.BackObjType = aRnewIssuePolSchema.getBackObjType();
		this.BackObj = aRnewIssuePolSchema.getBackObj();
		this.IsueManageCom = aRnewIssuePolSchema.getIsueManageCom();
		this.IssueCont = aRnewIssuePolSchema.getIssueCont();
		this.PrintCount = aRnewIssuePolSchema.getPrintCount();
		this.NeedPrint = aRnewIssuePolSchema.getNeedPrint();
		this.ReplyMan = aRnewIssuePolSchema.getReplyMan();
		this.ReplyResult = aRnewIssuePolSchema.getReplyResult();
		this.State = aRnewIssuePolSchema.getState();
		this.Operator = aRnewIssuePolSchema.getOperator();
		this.ManageCom = aRnewIssuePolSchema.getManageCom();
		this.MakeDate = fDate.getDate( aRnewIssuePolSchema.getMakeDate());
		this.MakeTime = aRnewIssuePolSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aRnewIssuePolSchema.getModifyDate());
		this.ModifyTime = aRnewIssuePolSchema.getModifyTime();
		this.QuestionObjType = aRnewIssuePolSchema.getQuestionObjType();
		this.QuestionObj = aRnewIssuePolSchema.getQuestionObj();
		this.QuestionObjName = aRnewIssuePolSchema.getQuestionObjName();
		this.ErrField = aRnewIssuePolSchema.getErrField();
		this.ErrFieldName = aRnewIssuePolSchema.getErrFieldName();
		this.ErrContent = aRnewIssuePolSchema.getErrContent();
		this.StandbyFlag1 = aRnewIssuePolSchema.getStandbyFlag1();
		this.StandbyFlag2 = aRnewIssuePolSchema.getStandbyFlag2();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的RnewIssuePol表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "RnewIssuePolSchema";
	...
	public RnewIssuePolSchema getSchema()
	{
		RnewIssuePolSchema aRnewIssuePolSchema = new RnewIssuePolSchema();
		aRnewIssuePolSchema.setSchema(this);
		return aRnewIssuePolSchema;
	}

	public RnewIssuePolDB getDB()
	{
		RnewIssuePolDB aDBOper = new RnewIssuePolDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpRnewIssuePol描述/A>表字段
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpRnewIssuePol>历史记账凭证主表信息</A>表字段
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		RnewIssuePolSchema other = (RnewIssuePolSchema)otherObject;
		return
