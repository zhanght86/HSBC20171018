...
/*
 * <p>ClassName: LCGrpFeeParamSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 承保核心
 */
public class LCGrpFeeParamSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LCGrpFeeParamSchema.class);
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LCGrpFeeParamSchema cloned = (LCGrpFeeParamSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LCGrpFeeParamSchema 对象给 Schema 赋值
	* @param: aLCGrpFeeParamSchema LCGrpFeeParamSchema
	**/
	public void setSchema(LCGrpFeeParamSchema aLCGrpFeeParamSchema)
	{
		this.GrpPolNo = aLCGrpFeeParamSchema.getGrpPolNo();
		this.GrpContNo = aLCGrpFeeParamSchema.getGrpContNo();
		this.RiskCode = aLCGrpFeeParamSchema.getRiskCode();
		this.FeeCode = aLCGrpFeeParamSchema.getFeeCode();
		this.InsuAccNo = aLCGrpFeeParamSchema.getInsuAccNo();
		this.PayPlanCode = aLCGrpFeeParamSchema.getPayPlanCode();
		this.FeeID = aLCGrpFeeParamSchema.getFeeID();
		this.FeeMin = aLCGrpFeeParamSchema.getFeeMin();
		this.FeeMax = aLCGrpFeeParamSchema.getFeeMax();
		this.FeeRate = aLCGrpFeeParamSchema.getFeeRate();
		this.Operator = aLCGrpFeeParamSchema.getOperator();
		this.MakeDate = fDate.getDate( aLCGrpFeeParamSchema.getMakeDate());
		this.MakeTime = aLCGrpFeeParamSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLCGrpFeeParamSchema.getModifyDate());
		this.ModifyTime = aLCGrpFeeParamSchema.getModifyTime();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LCGrpFeeParam表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LCGrpFeeParamSchema";
	...
	public LCGrpFeeParamSchema getSchema()
	{
		LCGrpFeeParamSchema aLCGrpFeeParamSchema = new LCGrpFeeParamSchema();
		aLCGrpFeeParamSchema.setSchema(this);
		return aLCGrpFeeParamSchema;
	}

	public LCGrpFeeParamDB getDB()
	{
		LCGrpFeeParamDB aDBOper = new LCGrpFeeParamDB();
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLCGrpFeeParam>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			FeeID= new Integer(ChgData.chgNumericStr(StrTool.getStr(strMessage,7,SysConst.PACKAGESPILTER))).intValue();
			FeeMin = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,8,SysConst.PACKAGESPILTER))).doubleValue();
			FeeMax = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,9,SysConst.PACKAGESPILTER))).doubleValue();
			FeeRate = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,10,SysConst.PACKAGESPILTER))).doubleValue();
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LCGrpFeeParamSchema other = (LCGrpFeeParamSchema)otherObject;
		return
