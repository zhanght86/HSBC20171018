...
/*
 * <p>ClassName: PD_LMEdorBonusZTDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 产品定义平台_PDM
 */
public class PD_LMEdorBonusZTDBSet extends PD_LMEdorBonusZTSet
{
private static Logger logger = Logger.getLogger(PD_LMEdorBonusZTDBSet.class);
	...
	**/
	...
	// @Constructor
	public PD_LMEdorBonusZTDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "PD_LMEdorBonusZTDBSet";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getCycPayIntvType() == null || this.get(i).getCycPayIntvType().equals("null")) {
				...
				pstmt.setString(21, this.get(i).getCycPayIntvType());
			}
