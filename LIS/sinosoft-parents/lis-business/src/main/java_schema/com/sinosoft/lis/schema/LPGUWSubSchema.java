...
/*
 * <p>ClassName: LPGUWSubSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 保全流程
 */
public class LPGUWSubSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LPGUWSubSchema.class);
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LPGUWSubSchema cloned = (LPGUWSubSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LPGUWSubSchema 对象给 Schema 赋值
	* @param: aLPGUWSubSchema LPGUWSubSchema
	**/
	public void setSchema(LPGUWSubSchema aLPGUWSubSchema)
	{
		this.EdorNo = aLPGUWSubSchema.getEdorNo();
		this.EdorType = aLPGUWSubSchema.getEdorType();
		this.GrpContNo = aLPGUWSubSchema.getGrpContNo();
		this.ProposalGrpContNo = aLPGUWSubSchema.getProposalGrpContNo();
		this.GrpPolNo = aLPGUWSubSchema.getGrpPolNo();
		this.GrpProposalNo = aLPGUWSubSchema.getGrpProposalNo();
		this.UWNo = aLPGUWSubSchema.getUWNo();
		this.InsuredNo = aLPGUWSubSchema.getInsuredNo();
		this.InsuredName = aLPGUWSubSchema.getInsuredName();
		this.AppntNo = aLPGUWSubSchema.getAppntNo();
		this.AppntName = aLPGUWSubSchema.getAppntName();
		this.AgentCode = aLPGUWSubSchema.getAgentCode();
		this.AgentGroup = aLPGUWSubSchema.getAgentGroup();
		this.PassFlag = aLPGUWSubSchema.getPassFlag();
		this.UWGrade = aLPGUWSubSchema.getUWGrade();
		this.AppGrade = aLPGUWSubSchema.getAppGrade();
		this.PostponeDay = aLPGUWSubSchema.getPostponeDay();
		this.PostponeDate = fDate.getDate( aLPGUWSubSchema.getPostponeDate());
		this.AutoUWFlag = aLPGUWSubSchema.getAutoUWFlag();
		this.State = aLPGUWSubSchema.getState();
		this.ManageCom = aLPGUWSubSchema.getManageCom();
		this.UWIdea = aLPGUWSubSchema.getUWIdea();
		this.UpReportContent = aLPGUWSubSchema.getUpReportContent();
		this.Operator = aLPGUWSubSchema.getOperator();
		this.HealthFlag = aLPGUWSubSchema.getHealthFlag();
		this.QuesFlag = aLPGUWSubSchema.getQuesFlag();
		this.SpecFlag = aLPGUWSubSchema.getSpecFlag();
		this.AddPremFlag = aLPGUWSubSchema.getAddPremFlag();
		this.AddPremReason = aLPGUWSubSchema.getAddPremReason();
		this.ReportFlag = aLPGUWSubSchema.getReportFlag();
		this.PrintFlag = aLPGUWSubSchema.getPrintFlag();
		this.PrintFlag2 = aLPGUWSubSchema.getPrintFlag2();
		this.ChangePolFlag = aLPGUWSubSchema.getChangePolFlag();
		this.ChangePolReason = aLPGUWSubSchema.getChangePolReason();
		this.SpecReason = aLPGUWSubSchema.getSpecReason();
		this.MakeDate = fDate.getDate( aLPGUWSubSchema.getMakeDate());
		this.MakeTime = aLPGUWSubSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLPGUWSubSchema.getModifyDate());
		this.ModifyTime = aLPGUWSubSchema.getModifyTime();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LPGUWSub表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LPGUWSubSchema";
	...
	public LPGUWSubSchema getSchema()
	{
		LPGUWSubSchema aLPGUWSubSchema = new LPGUWSubSchema();
		aLPGUWSubSchema.setSchema(this);
		return aLPGUWSubSchema;
	}

	public LPGUWSubDB getDB()
	{
		LPGUWSubDB aDBOper = new LPGUWSubDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLPGUWSub描述/A>表字段
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLPGUWSub>历史记账凭证主表信息</A>表字段
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LPGUWSubSchema other = (LPGUWSubSchema)otherObject;
		return
