...
/*
 * <p>ClassName: LBPODataDetailErrorDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: PhysicalDataModel_1
 */
public class LBPODataDetailErrorDBSet extends LBPODataDetailErrorSet
{
private static Logger logger = Logger.getLogger(LBPODataDetailErrorDBSet.class);
	...
	**/
	...
	// @Constructor
	public LBPODataDetailErrorDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public LBPODataDetailErrorDBSet()
	{
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LBPODataDetailErrorDBSet";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getErrorFlag() == null || this.get(i).getErrorFlag().equals("null")) {
				...
				pstmt.setString(11, this.get(i).getErrorFlag());
			}
			if(this.get(i).getContent() == null || this.get(i).getContent().equals("null")) {
				pstmt.setString(12,null);
			} else {
				pstmt.setString(12, this.get(i).getContent());
			}
			...
			if(this.get(i).getOtherNo() == null || this.get(i).getOtherNo().equals("null")) {
				...
				pstmt.setString(14, this.get(i).getOtherNo());
			}
			// set where condition
			if(this.get(i).getBussNo() == null || this.get(i).getBussNo().equals("null")) {
			...
			pstmt.setInt(17, this.get(i).getErrorCount());
			if(this.get(i).getSerialNo() == null || this.get(i).getSerialNo().equals("null")) {
