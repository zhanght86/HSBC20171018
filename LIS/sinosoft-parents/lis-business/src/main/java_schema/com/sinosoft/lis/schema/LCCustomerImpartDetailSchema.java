 ...
 * @Database: 承保核心
 */
public class LCCustomerImpartDetailSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LCCustomerImpartDetailSchema.class);
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LCCustomerImpartDetailSchema cloned = (LCCustomerImpartDetailSchema)super.clone();
	...
	**/
	public void setSchema(LCCustomerImpartDetailSchema aLCCustomerImpartDetailSchema)
	{
		...
		this.ImpartDetailContent = aLCCustomerImpartDetailSchema.getImpartDetailContent();
		this.DiseaseContent = aLCCustomerImpartDetailSchema.getDiseaseContent();
		this.StartDate = fDate.getDate( aLCCustomerImpartDetailSchema.getStartDate());
		...
		this.ModifyDate = fDate.getDate( aLCCustomerImpartDetailSchema.getModifyDate());
		this.ModifyTime = aLCCustomerImpartDetailSchema.getModifyTime();
		this.PatchNo = aLCCustomerImpartDetailSchema.getPatchNo();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LCCustomerImpartDetail表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
	...
	{
		LCCustomerImpartDetailSchema aLCCustomerImpartDetailSchema = new LCCustomerImpartDetailSchema();
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			SubSerialNo = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 7, SysConst.PACKAGESPILTER );
			ImpartDetailContent = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 8, SysConst.PACKAGESPILTER );
			...
			Prover = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 12, SysConst.PACKAGESPILTER );
			CurrCondition = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 13, SysConst.PACKAGESPILTER );
			IsProved = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 14, SysConst.PACKAGESPILTER );
			CustomerNo = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 15, SysConst.PACKAGESPILTER );
			CustomerNoType = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 16, SysConst.PACKAGESPILTER );
			UWClaimFlg = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 17, SysConst.PACKAGESPILTER );
			PrtFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 18, SysConst.PACKAGESPILTER );
			...
			PatchNo= new Integer(ChgData.chgNumericStr(StrTool.getStr(strMessage,24,SysConst.PACKAGESPILTER))).intValue();
		}
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LCCustomerImpartDetailSchema other = (LCCustomerImpartDetailSchema)otherObject;
		return
