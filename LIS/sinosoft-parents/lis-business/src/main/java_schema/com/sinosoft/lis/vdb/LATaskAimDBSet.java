...
/*
 * <p>ClassName: LATaskAimDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 代理人管理
 */
public class LATaskAimDBSet extends LATaskAimSet
{
private static Logger logger = Logger.getLogger(LATaskAimDBSet.class);
	...
	**/
	...
	// @Constructor
	public LATaskAimDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LATaskAimDBSet";
	...
	public boolean delete()
	{
		...
		try
		{
			...
			if(this.get(i).getAimTable() == null || this.get(i).getAimTable().equals("null")) {
				pstmt.setString(2,null);
			} else {
				pstmt.setString(2, this.get(i).getAimTable());
			}
			if(this.get(i).getAimCol() == null || this.get(i).getAimCol().equals("null")) {
				pstmt.setString(3,null);
			} else {
				pstmt.setString(3, this.get(i).getAimCol());
			}
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getIndexSet() == null || this.get(i).getIndexSet().equals("null")) {
				...
				pstmt.setString(4, this.get(i).getIndexSet());
			}
			...
			pstmt.setInt(8, this.get(i).getCalOrder());
			// set where condition
			if(this.get(i).getTaskID() == null || this.get(i).getTaskID().equals("null")) {
				pstmt.setString(9,null);
			} else {
				pstmt.setString(9, this.get(i).getTaskID());
			}
			if(this.get(i).getAimTable() == null || this.get(i).getAimTable().equals("null")) {
				pstmt.setString(10,null);
			} else {
				pstmt.setString(10, this.get(i).getAimTable());
			}
			if(this.get(i).getAimCol() == null || this.get(i).getAimCol().equals("null")) {
				pstmt.setString(11,null);
			} else {
				pstmt.setString(11, this.get(i).getAimCol());
			}
