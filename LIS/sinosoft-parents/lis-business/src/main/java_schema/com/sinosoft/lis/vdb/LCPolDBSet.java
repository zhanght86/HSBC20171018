	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getAutoPubAccFlag() == null || this.get(i).getAutoPubAccFlag().equals("null")) {
				...
				pstmt.setString(121, this.get(i).getAutoPubAccFlag());
			}
			if(this.get(i).getAscriptionFlag() == null || this.get(i).getAscriptionFlag().equals("null")) {
				pstmt.setString(122,null);
			} else {
				pstmt.setString(122, this.get(i).getAscriptionFlag());
			}
			if(this.get(i).getPCValiDate() == null || this.get(i).getPCValiDate().equals("null")) {
				pstmt.setDate(123,null);
			} else {
				pstmt.setDate(123, Date.valueOf(this.get(i).getPCValiDate()));
			}
			...
			if(this.get(i).getCurrency() == null || this.get(i).getCurrency().equals("null")) {
				...
				pstmt.setString(132, this.get(i).getCurrency());
			}
			if(this.get(i).getInvestRuleCode() == null || this.get(i).getInvestRuleCode().equals("null")) {
				pstmt.setString(133,null);
			} else {
				pstmt.setString(133, this.get(i).getInvestRuleCode());
			}
			if(this.get(i).getUintLinkValiFlag() == null || this.get(i).getUintLinkValiFlag().equals("null")) {
				pstmt.setString(134,null);
			} else {
				pstmt.setString(134, this.get(i).getUintLinkValiFlag());
			}
			if(this.get(i).getRenewContNo() == null || this.get(i).getRenewContNo().equals("null")) {
				pstmt.setString(135,null);
			} else {
				pstmt.setString(135, this.get(i).getRenewContNo());
			}
			pstmt.setInt(136, this.get(i).getInitNumPeople());
			pstmt.setDouble(137, this.get(i).getInitMult());
			pstmt.setDouble(138, this.get(i).getInitAmnt());
			pstmt.setDouble(139, this.get(i).getInitRiskAmnt());
			pstmt.setDouble(140, this.get(i).getInitPrem());
			pstmt.setDouble(141, this.get(i).getInitStandPrem());
			pstmt.setDouble(142, this.get(i).getInitPeriodPrem());
			pstmt.setDouble(143, this.get(i).getPeriodPrem());
			pstmt.setInt(144, this.get(i).getSumNumPeople());
			if(this.get(i).getPremCalMode() == null || this.get(i).getPremCalMode().equals("null")) {
				pstmt.setString(145,null);
			} else {
				pstmt.setString(145, this.get(i).getPremCalMode());
			}
			if(this.get(i).getLang() == null || this.get(i).getLang().equals("null")) {
				pstmt.setString(146,null);
			} else {
				pstmt.setString(146, this.get(i).getLang());
			}
			pstmt.setDouble(147, this.get(i).getChargeFeeRate());
			pstmt.setDouble(148, this.get(i).getCommRate());
			pstmt.setDouble(149, this.get(i).getGradeFeeRate());
			pstmt.setDouble(150, this.get(i).getOtherFeeRate());
			pstmt.setDouble(151, this.get(i).getAddFeeRate());
			pstmt.setDouble(152, this.get(i).getAddFee());
			if(this.get(i).getComCode() == null || this.get(i).getComCode().equals("null")) {
				pstmt.setString(153,null);
			} else {
				pstmt.setString(153, this.get(i).getComCode());
			}
			if(this.get(i).getModifyOperator() == null || this.get(i).getModifyOperator().equals("null")) {
				pstmt.setString(154,null);
			} else {
				pstmt.setString(154, this.get(i).getModifyOperator());
			}
			// set where condition
			if(this.get(i).getPolNo() == null || this.get(i).getPolNo().equals("null")) {
				pstmt.setString(155,null);
			} else {
				pstmt.setString(155, this.get(i).getPolNo());
			}
