...
import com.sinosoft.lis.db.LPGetToAccDB;

/*
 * <p>ClassName: LPGetToAccSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 保全核心
 */
public class LPGetToAccSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LPGetToAccSchema.class);
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LPGetToAccSchema cloned = (LPGetToAccSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LPGetToAccSchema 对象给 Schema 赋值
	* @param: aLPGetToAccSchema LPGetToAccSchema
	**/
	public void setSchema(LPGetToAccSchema aLPGetToAccSchema)
	{
		this.EdorNo = aLPGetToAccSchema.getEdorNo();
		this.EdorType = aLPGetToAccSchema.getEdorType();
		this.PolNo = aLPGetToAccSchema.getPolNo();
		this.DutyCode = aLPGetToAccSchema.getDutyCode();
		this.GetDutyCode = aLPGetToAccSchema.getGetDutyCode();
		this.InsuAccNo = aLPGetToAccSchema.getInsuAccNo();
		this.DefaultRate = aLPGetToAccSchema.getDefaultRate();
		this.NeedInput = aLPGetToAccSchema.getNeedInput();
		this.CalCodeMoney = aLPGetToAccSchema.getCalCodeMoney();
		this.DealDirection = aLPGetToAccSchema.getDealDirection();
		this.CalFlag = aLPGetToAccSchema.getCalFlag();
		this.Operator = aLPGetToAccSchema.getOperator();
		this.MakeDate = fDate.getDate( aLPGetToAccSchema.getMakeDate());
		this.MakeTime = aLPGetToAccSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLPGetToAccSchema.getModifyDate());
		this.ModifyTime = aLPGetToAccSchema.getModifyTime();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LPGetToAcc表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LPGetToAccSchema";
	...
	public LPGetToAccSchema getSchema()
	{
		LPGetToAccSchema aLPGetToAccSchema = new LPGetToAccSchema();
		aLPGetToAccSchema.setSchema(this);
		return aLPGetToAccSchema;
	}

	public LPGetToAccDB getDB()
	{
		LPGetToAccDB aDBOper = new LPGetToAccDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLPGetToAcc描述/A>表字段
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLPGetToAcc>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			DefaultRate = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,7,SysConst.PACKAGESPILTER))).doubleValue();
			NeedInput = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 8, SysConst.PACKAGESPILTER );
			CalCodeMoney = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 9, SysConst.PACKAGESPILTER );
			DealDirection = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 10, SysConst.PACKAGESPILTER );
			CalFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 11, SysConst.PACKAGESPILTER );
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LPGetToAccSchema other = (LPGetToAccSchema)otherObject;
		return
