...
/*
 * <p>ClassName: LZCardDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 单证管理
 */
public class LZCardDBSet extends LZCardSet
{
private static Logger logger = Logger.getLogger(LZCardDBSet.class);
	...
	**/
	...
	// @Constructor
	public LZCardDBSet(Connection tConnection)
	{
		con = tConnection;
