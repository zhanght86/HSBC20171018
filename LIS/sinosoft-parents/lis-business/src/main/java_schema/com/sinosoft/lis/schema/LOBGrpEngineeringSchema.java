...
import com.sinosoft.lis.db.LOBGrpEngineeringDB;

/*
 * 与数据库结构不一致，暂不处理
 * <p>ClassName: LOBGrpEngineeringSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: Physical Data Model 1
 */
public class LOBGrpEngineeringSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LOBGrpEngineeringSchema.class);
	// @Field
	/** 业务类型 */
	...
	// @Constructor
	public LOBGrpEngineeringSchema()
	{
		mErrors = new CErrors();
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LOBGrpEngineeringSchema cloned = (LOBGrpEngineeringSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LOBGrpEngineeringSchema 对象给 Schema 赋值
	* @param: aLOBGrpEngineeringSchema LOBGrpEngineeringSchema
	**/
	public void setSchema(LOBGrpEngineeringSchema aLOBGrpEngineeringSchema)
	{
		this.BussType = aLOBGrpEngineeringSchema.getBussType();
		this.BussNo = aLOBGrpEngineeringSchema.getBussNo();
		this.GrpContNo = aLOBGrpEngineeringSchema.getGrpContNo();
		this.GrpPropNo = aLOBGrpEngineeringSchema.getGrpPropNo();
		this.EnginName = aLOBGrpEngineeringSchema.getEnginName();
		this.EnginType = aLOBGrpEngineeringSchema.getEnginType();
		this.EnginArea = aLOBGrpEngineeringSchema.getEnginArea();
		this.EnginCost = aLOBGrpEngineeringSchema.getEnginCost();
		this.EnginPlace = aLOBGrpEngineeringSchema.getEnginPlace();
		this.EnginStartDate = fDate.getDate( aLOBGrpEngineeringSchema.getEnginStartDate());
		this.EnginEndDate = fDate.getDate( aLOBGrpEngineeringSchema.getEnginEndDate());
		this.InsurerName = aLOBGrpEngineeringSchema.getInsurerName();
		this.InsurerType = aLOBGrpEngineeringSchema.getInsurerType();
		this.ContractorName = aLOBGrpEngineeringSchema.getContractorName();
		this.ContractorType = aLOBGrpEngineeringSchema.getContractorType();
		this.ContractorType2 = aLOBGrpEngineeringSchema.getContractorType2();
		this.DetailDes = aLOBGrpEngineeringSchema.getDetailDes();
		this.EnginDesc = aLOBGrpEngineeringSchema.getEnginDesc();
		this.EnginCondition = aLOBGrpEngineeringSchema.getEnginCondition();
		this.SpecFlag = aLOBGrpEngineeringSchema.getSpecFlag();
		this.PremCalMode = aLOBGrpEngineeringSchema.getPremCalMode();
		this.PremFeeRate = aLOBGrpEngineeringSchema.getPremFeeRate();
		this.FirstPrem = aLOBGrpEngineeringSchema.getFirstPrem();
		this.ContractorPeoples = aLOBGrpEngineeringSchema.getContractorPeoples();
		this.SafeProve = aLOBGrpEngineeringSchema.getSafeProve();
		this.Remark = aLOBGrpEngineeringSchema.getRemark();
		this.ManageCom = aLOBGrpEngineeringSchema.getManageCom();
		this.ComCode = aLOBGrpEngineeringSchema.getComCode();
		this.MakeOperator = aLOBGrpEngineeringSchema.getMakeOperator();
		this.MakeDate = fDate.getDate( aLOBGrpEngineeringSchema.getMakeDate());
		this.MakeTime = aLOBGrpEngineeringSchema.getMakeTime();
		this.ModifyOperator = aLOBGrpEngineeringSchema.getModifyOperator();
		this.ModifyDate = fDate.getDate( aLOBGrpEngineeringSchema.getModifyDate());
		this.ModifyTime = aLOBGrpEngineeringSchema.getModifyTime();
		this.EnginDays = aLOBGrpEngineeringSchema.getEnginDays();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LOBGrpEngineering表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LOBGrpEngineeringSchema";
	...
	public LOBGrpEngineeringSchema getSchema()
	{
		LOBGrpEngineeringSchema aLOBGrpEngineeringSchema = new LOBGrpEngineeringSchema();
		aLOBGrpEngineeringSchema.setSchema(this);
		return aLOBGrpEngineeringSchema;
	}

	public LOBGrpEngineeringDB getDB()
	{
		LOBGrpEngineeringDB aDBOper = new LOBGrpEngineeringDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLOBGrpEngineering描述/A>表字段
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLOBGrpEngineering>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			ContractorType2 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 16, SysConst.PACKAGESPILTER );
			DetailDes = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 17, SysConst.PACKAGESPILTER );
			...
			PremCalMode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 21, SysConst.PACKAGESPILTER );
			PremFeeRate = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,22,SysConst.PACKAGESPILTER))).doubleValue();
			FirstPrem = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,23,SysConst.PACKAGESPILTER))).doubleValue();
			ContractorPeoples= new Integer(ChgData.chgNumericStr(StrTool.getStr(strMessage,24,SysConst.PACKAGESPILTER))).intValue();
			SafeProve = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 25, SysConst.PACKAGESPILTER );
			...
			MakeOperator = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 29, SysConst.PACKAGESPILTER );
			...
			EnginDays = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 35, SysConst.PACKAGESPILTER );
		}
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LOBGrpEngineeringSchema other = (LOBGrpEngineeringSchema)otherObject;
		return
