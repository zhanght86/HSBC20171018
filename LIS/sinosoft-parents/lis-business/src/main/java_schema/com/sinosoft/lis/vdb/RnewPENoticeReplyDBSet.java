...
/*
 * <p>ClassName: RnewPENoticeReplyDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 续期续保二核
 */
public class RnewPENoticeReplyDBSet extends RnewPENoticeReplySet
{
private static Logger logger = Logger.getLogger(RnewPENoticeReplyDBSet.class);
	...
	**/
	...
	// @Constructor
	public RnewPENoticeReplyDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "RnewPENoticeReplyDBSet";
