...
/*
 * <p>ClassName: LPContPlanParamDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 保全核心
 */
public class LPContPlanParamDBSet extends LPContPlanParamSet
{
private static Logger logger = Logger.getLogger(LPContPlanParamDBSet.class);
	...
	**/
	...
	// @Constructor
	public LPContPlanParamDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LPContPlanParamDBSet";
	...
	public boolean delete()
	{
		...
		try
		{
			...
			if(this.get(i).getPlanType() == null || this.get(i).getPlanType().equals("null")) {
				...
				pstmt.setString(13, StrTool.space1(this.get(i).getPlanType(), 1));
			}
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getParamName() == null || this.get(i).getParamName().equals("null")) {
				...
				pstmt.setString(17, this.get(i).getParamName());
			}
			if(this.get(i).getParam() == null || this.get(i).getParam().equals("null")) {
				pstmt.setString(18,null);
			} else {
				pstmt.setString(18, this.get(i).getParam());
			}
			...
			if(this.get(i).getPlanType() == null || this.get(i).getPlanType().equals("null")) {
				...
				pstmt.setString(23, this.get(i).getPlanType());
			}
			// set where condition
			if(this.get(i).getEdorNo() == null || this.get(i).getEdorNo().equals("null")) {
			...
			if(this.get(i).getMainRiskCode() == null || this.get(i).getMainRiskCode().equals("null")) {
				...
				pstmt.setString(27, this.get(i).getMainRiskCode());
			}
			if(this.get(i).getRiskCode() == null || this.get(i).getRiskCode().equals("null")) {
			...
			if(this.get(i).getContPlanCode() == null || this.get(i).getContPlanCode().equals("null")) {
				...
				pstmt.setString(29, this.get(i).getContPlanCode());
			}
			if(this.get(i).getFactoryType() == null || this.get(i).getFactoryType().equals("null")) {
				pstmt.setString(30,null);
			} else {
				pstmt.setString(30, this.get(i).getFactoryType());
			}
			if(this.get(i).getOtherNo() == null || this.get(i).getOtherNo().equals("null")) {
			...
			if(this.get(i).getFactoryCode() == null || this.get(i).getFactoryCode().equals("null")) {
				...
				pstmt.setString(32, this.get(i).getFactoryCode());
			}
			pstmt.setInt(33, this.get(i).getFactorySubCode());
			if(this.get(i).getInerSerialNo() == null || this.get(i).getInerSerialNo().equals("null")) {
				pstmt.setString(34,null);
			} else {
				pstmt.setString(34, this.get(i).getInerSerialNo());
			}
			if(this.get(i).getParamName() == null || this.get(i).getParamName().equals("null")) {
				pstmt.setString(35,null);
			} else {
				pstmt.setString(35, this.get(i).getParamName());
			}
			if(this.get(i).getPlanType() == null || this.get(i).getPlanType().equals("null")) {
