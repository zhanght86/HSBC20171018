...
/*
 * <p>ClassName: LCContStateSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 承保核心
 */
public class LCContStateSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LCContStateSchema.class);
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LCContStateSchema cloned = (LCContStateSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LCContStateSchema 对象给 Schema 赋值
	* @param: aLCContStateSchema LCContStateSchema
	**/
	public void setSchema(LCContStateSchema aLCContStateSchema)
	{
		this.ContNo = aLCContStateSchema.getContNo();
		this.InsuredNo = aLCContStateSchema.getInsuredNo();
		this.PolNo = aLCContStateSchema.getPolNo();
		this.StateType = aLCContStateSchema.getStateType();
		this.State = aLCContStateSchema.getState();
		this.StateReason = aLCContStateSchema.getStateReason();
		this.StartDate = fDate.getDate( aLCContStateSchema.getStartDate());
		this.EndDate = fDate.getDate( aLCContStateSchema.getEndDate());
		this.Remark = aLCContStateSchema.getRemark();
		this.Operator = aLCContStateSchema.getOperator();
		this.MakeDate = fDate.getDate( aLCContStateSchema.getMakeDate());
		this.MakeTime = aLCContStateSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLCContStateSchema.getModifyDate());
		this.ModifyTime = aLCContStateSchema.getModifyTime();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LCContState表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LCContStateSchema";
	...
	public LCContStateSchema getSchema()
	{
		LCContStateSchema aLCContStateSchema = new LCContStateSchema();
		aLCContStateSchema.setSchema(this);
		return aLCContStateSchema;
	}

	public LCContStateDB getDB()
	{
		LCContStateDB aDBOper = new LCContStateDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLCContState描述/A>表字段
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLCContState>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			StateType = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 4, SysConst.PACKAGESPILTER );
			State = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 5, SysConst.PACKAGESPILTER );
			StateReason = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 6, SysConst.PACKAGESPILTER );
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LCContStateSchema other = (LCContStateSchema)otherObject;
		return
