...
import com.sinosoft.lis.db.LLUWGrpRReportDB;

/*
 * <p>ClassName: LLUWGrpRReportSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 泰康未整理PDM
 */
public class LLUWGrpRReportSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LLUWGrpRReportSchema.class);
	// @Field
	/** 赔案号 */
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LLUWGrpRReportSchema cloned = (LLUWGrpRReportSchema)super.clone();
	...
	*/
	...
	{
		if(aRReportReason!=null && aRReportReason.length()>600)
			throw new IllegalArgumentException("生调原因RReportReason值"+aRReportReason+"的长度"+aRReportReason.length()+"大于最大值600");
		RReportReason = aRReportReason;
	}

	/**
	* 使用另外一个 LLUWGrpRReportSchema 对象给 Schema 赋值
	* @param: aLLUWGrpRReportSchema LLUWGrpRReportSchema
	**/
	public void setSchema(LLUWGrpRReportSchema aLLUWGrpRReportSchema)
	{
		this.ClmNo = aLLUWGrpRReportSchema.getClmNo();
		this.GrpContNo = aLLUWGrpRReportSchema.getGrpContNo();
		this.PrtSeq = aLLUWGrpRReportSchema.getPrtSeq();
		this.PrintFlag = aLLUWGrpRReportSchema.getPrintFlag();
		this.ManageCom = aLLUWGrpRReportSchema.getManageCom();
		this.AgentName = aLLUWGrpRReportSchema.getAgentName();
		this.AgentCode = aLLUWGrpRReportSchema.getAgentCode();
		this.Operator = aLLUWGrpRReportSchema.getOperator();
		this.MakeDate = fDate.getDate( aLLUWGrpRReportSchema.getMakeDate());
		this.MakeTime = aLLUWGrpRReportSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLLUWGrpRReportSchema.getModifyDate());
		this.ModifyTime = aLLUWGrpRReportSchema.getModifyTime();
		this.Remark = aLLUWGrpRReportSchema.getRemark();
		this.RReportReason = aLLUWGrpRReportSchema.getRReportReason();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LLUWGrpRReport表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LLUWGrpRReportSchema";
	...
	public LLUWGrpRReportSchema getSchema()
	{
		LLUWGrpRReportSchema aLLUWGrpRReportSchema = new LLUWGrpRReportSchema();
		aLLUWGrpRReportSchema.setSchema(this);
		return aLLUWGrpRReportSchema;
	}

	public LLUWGrpRReportDB getDB()
	{
		LLUWGrpRReportDB aDBOper = new LLUWGrpRReportDB();
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLLUWGrpRReport>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			PrintFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 4, SysConst.PACKAGESPILTER );
			...
			RReportReason = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 14, SysConst.PACKAGESPILTER );
		}
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LLUWGrpRReportSchema other = (LLUWGrpRReportSchema)otherObject;
		return
