...
{
private static Logger logger = Logger.getLogger(LAOrphanPolicyDB.class);
	...
	**/
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.getZipCode() == null || this.getZipCode().equals("null")) {
				...
				pstmt.setString(5, this.getZipCode());
			}
			...
			if(this.getT1() == null || this.getT1().equals("null")) {
				...
				pstmt.setString(7, this.getT1());
			}
			if(this.getT2() == null || this.getT2().equals("null")) {
				pstmt.setNull(8, 12);
			} else {
				pstmt.setString(8, this.getT2());
			}
			...
			if(this.getBranchType() == null || this.getBranchType().equals("null")) {
				...
				pstmt.setString(14, this.getBranchType());
			}
			...
			if(this.getFlag() == null || this.getFlag().equals("null")) {
				...
				pstmt.setString(17, this.getFlag());
			}
			// set where condition
			if(this.getContNo() == null || this.getContNo().equals("null")) {
				pstmt.setNull(18, 12);
	...
	public boolean getInfo()
	{
		...
		try
		{
			pstmt = con.prepareStatement("SELECT * FROM LAOrphanPolicy WHERE  ContNo = ?", 
	...
	public LAOrphanPolicySet executeQuery(String sql)
	{
		Statement stmt = null;
		ResultSet rs = null;
		LAOrphanPolicySet aLAOrphanPolicySet = new LAOrphanPolicySet();
	...
	public LAOrphanPolicySet executeQuery(String sql, int nStart, int nCount)
	{
		Statement stmt = null;
		ResultSet rs = null;
		LAOrphanPolicySet aLAOrphanPolicySet = new LAOrphanPolicySet();
...
public boolean closeData()
{
	...
	public LAOrphanPolicySet executeQuery(SQLwithBindVariables sqlbv) {
	...
	public LAOrphanPolicySet executeQuery(SQLwithBindVariables sqlbv, int nStart, int nCount) {
