...
/*
 * <p>ClassName: RIWFErrLogDB </p>
 * <p>Description: DB层数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 再保系统模型
 */
public class RIWFErrLogDB extends RIWFErrLogSchema
{
	// @Field
	...
	**/
	...
	// @Constructor
	public RIWFErrLogDB( Connection tConnection )
	{
		con = tConnection;
	...
	{
		RIWFErrLogSchema tSchema = this.getSchema();
		...
		else
		{
			...
			tError.moduleName = "RIWFErrLogDB";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.getTaskCode() == null || this.getTaskCode().equals("null")) {
				...
				pstmt.setString(3, this.getTaskCode());
			}
	...
	public boolean getInfo()
	{
		...
		try
		{
			pstmt = con.prepareStatement("SELECT * FROM RIWFErrLog WHERE  SerialNo = ?", 
	...
	public RIWFErrLogSet query()
	{
		Statement stmt = null;
		ResultSet rs = null;
		RIWFErrLogSet aRIWFErrLogSet = new RIWFErrLogSet();
	  ...
	  if( !mflag ) {
		...
		try
		{
			...
			SQLString sqlObj = new SQLString("RIWFErrLog");
			RIWFErrLogSchema aSchema = this.getSchema();
			...
			{
				i++;
				RIWFErrLogSchema s1 = new RIWFErrLogSchema();
				s1.setSchema(rs,i);
				aRIWFErrLogSet.add(s1);
			}
			try{ rs.close(); } catch( Exception ex ) {}
		...
		return aRIWFErrLogSet;
	}

	public RIWFErrLogSet executeQuery(String sql)
	{
		Statement stmt = null;
		ResultSet rs = null;
		RIWFErrLogSet aRIWFErrLogSet = new RIWFErrLogSet();
	...
	public RIWFErrLogSet query(int nStart, int nCount)
	{
		Statement stmt = null;
		ResultSet rs = null;
		RIWFErrLogSet aRIWFErrLogSet = new RIWFErrLogSet();
	...
	public RIWFErrLogSet executeQuery(String sql, int nStart, int nCount)
	{
		Statement stmt = null;
		ResultSet rs = null;
		RIWFErrLogSet aRIWFErrLogSet = new RIWFErrLogSet();
	...
	public boolean update(String strWherePart)
	{
	  ...
	  if( !mflag ) {
		...
		try
		{
			...
			String sql = "update RIWFErrLog " + sqlObj.getUpdPart() + " where " + strWherePart;
...
/**
 * 获取定量数据
 * @return RIWFErrLogSet
 */
public RIWFErrLogSet getData()
{
    int tCount = 0;
    RIWFErrLogSet tRIWFErrLogSet = new RIWFErrLogSet();
    RIWFErrLogSchema tRIWFErrLogSchema = null;
    if (null == mResultSet)
    {
        CError tError = new CError();
        tError.moduleName = "RIWFErrLogDB";
    ...
    {
        tCount = 1;
        tRIWFErrLogSchema = new RIWFErrLogSchema();
        tRIWFErrLogSchema.setSchema(mResultSet, 1);
        tRIWFErrLogSet.add(tRIWFErrLogSchema);
