...
/*
 * <p>ClassName: LBCustomerImpartParamsDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 寿险业务系统未整理模型
 */
public class LBCustomerImpartParamsDBSet extends LBCustomerImpartParamsSet
{
private static Logger logger = Logger.getLogger(LBCustomerImpartParamsDBSet.class);
	...
	**/
	...
	// @Constructor
	public LBCustomerImpartParamsDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public LBCustomerImpartParamsDBSet()
	{
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LBCustomerImpartParamsDBSet";
	...
	public boolean delete()
	{
		...
		try
		{
			...
			if(this.get(i).getImpartVer() == null || this.get(i).getImpartVer().equals("null")) {
				...
				pstmt.setString(3, this.get(i).getImpartVer());
			}
			...
			if(this.get(i).getCustomerNoType() == null || this.get(i).getCustomerNoType().equals("null")) {
				...
				pstmt.setString(5, StrTool.space1(this.get(i).getCustomerNoType(), 1));
			}
			if(this.get(i).getImpartParamNo() == null || this.get(i).getImpartParamNo().equals("null")) {
				pstmt.setString(6,null);
			} else {
				pstmt.setString(6, this.get(i).getImpartParamNo());
			}
			pstmt.setInt(7, this.get(i).getPatchNo());
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getCustomerNoType() == null || this.get(i).getCustomerNoType().equals("null")) {
				...
				pstmt.setString(9, this.get(i).getCustomerNoType());
			}
			if(this.get(i).getImpartParamNo() == null || this.get(i).getImpartParamNo().equals("null")) {
				pstmt.setString(10,null);
			} else {
				pstmt.setString(10, this.get(i).getImpartParamNo());
			}
			if(this.get(i).getImpartParamName() == null || this.get(i).getImpartParamName().equals("null")) {
				pstmt.setString(11,null);
			} else {
				pstmt.setString(11, this.get(i).getImpartParamName());
			}
			if(this.get(i).getImpartParam() == null || this.get(i).getImpartParam().equals("null")) {
				pstmt.setString(12,null);
			} else {
				pstmt.setString(12, this.get(i).getImpartParam());
			}
			...
			if(this.get(i).getImpartCode() == null || this.get(i).getImpartCode().equals("null")) {
				...
				pstmt.setString(20, this.get(i).getImpartCode());
			}
			if(this.get(i).getImpartVer() == null || this.get(i).getImpartVer().equals("null")) {
				pstmt.setString(21,null);
			} else {
				pstmt.setString(21, this.get(i).getImpartVer());
			}
			if(this.get(i).getCustomerNo() == null || this.get(i).getCustomerNo().equals("null")) {
			...
			if(this.get(i).getCustomerNoType() == null || this.get(i).getCustomerNoType().equals("null")) {
				...
				pstmt.setString(23, StrTool.space1(this.get(i).getCustomerNoType(), 1));
			}
			if(this.get(i).getImpartParamNo() == null || this.get(i).getImpartParamNo().equals("null")) {
				pstmt.setString(24,null);
			} else {
				pstmt.setString(24, this.get(i).getImpartParamNo());
			}
