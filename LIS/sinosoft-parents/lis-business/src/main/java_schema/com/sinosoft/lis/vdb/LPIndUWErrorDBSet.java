...
/*
 * <p>ClassName: LPIndUWErrorDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 保全流程
 */
public class LPIndUWErrorDBSet extends LPIndUWErrorSet
{
private static Logger logger = Logger.getLogger(LPIndUWErrorDBSet.class);
	...
	**/
	...
	// @Constructor
	public LPIndUWErrorDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LPIndUWErrorDBSet";
