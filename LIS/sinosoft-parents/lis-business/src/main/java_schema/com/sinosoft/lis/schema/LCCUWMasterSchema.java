...
/*
 * <p>ClassName: LCCUWMasterSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: lccuwmaster
 */
public class LCCUWMasterSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LCCUWMasterSchema.class);
	// @Field
	/** 集体合同号码 */
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LCCUWMasterSchema cloned = (LCCUWMasterSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LCCUWMasterSchema 对象给 Schema 赋值
	* @param: aLCCUWMasterSchema LCCUWMasterSchema
	**/
	public void setSchema(LCCUWMasterSchema aLCCUWMasterSchema)
	{
		this.GrpContNo = aLCCUWMasterSchema.getGrpContNo();
		this.ContNo = aLCCUWMasterSchema.getContNo();
		this.ProposalContNo = aLCCUWMasterSchema.getProposalContNo();
		this.UWNo = aLCCUWMasterSchema.getUWNo();
		this.InsuredNo = aLCCUWMasterSchema.getInsuredNo();
		this.InsuredName = aLCCUWMasterSchema.getInsuredName();
		this.AppntNo = aLCCUWMasterSchema.getAppntNo();
		this.AppntName = aLCCUWMasterSchema.getAppntName();
		this.AgentCode = aLCCUWMasterSchema.getAgentCode();
		this.AgentGroup = aLCCUWMasterSchema.getAgentGroup();
		this.PassFlag = aLCCUWMasterSchema.getPassFlag();
		this.UWGrade = aLCCUWMasterSchema.getUWGrade();
		this.AppGrade = aLCCUWMasterSchema.getAppGrade();
		this.PostponeDay = aLCCUWMasterSchema.getPostponeDay();
		this.PostponeDate = fDate.getDate( aLCCUWMasterSchema.getPostponeDate());
		this.AutoUWFlag = aLCCUWMasterSchema.getAutoUWFlag();
		this.State = aLCCUWMasterSchema.getState();
		this.ManageCom = aLCCUWMasterSchema.getManageCom();
		this.UWIdea = aLCCUWMasterSchema.getUWIdea();
		this.UpReportContent = aLCCUWMasterSchema.getUpReportContent();
		this.Operator = aLCCUWMasterSchema.getOperator();
		this.HealthFlag = aLCCUWMasterSchema.getHealthFlag();
		this.QuesFlag = aLCCUWMasterSchema.getQuesFlag();
		this.SpecFlag = aLCCUWMasterSchema.getSpecFlag();
		this.AddPremFlag = aLCCUWMasterSchema.getAddPremFlag();
		this.AddPremReason = aLCCUWMasterSchema.getAddPremReason();
		this.ReportFlag = aLCCUWMasterSchema.getReportFlag();
		this.PrintFlag = aLCCUWMasterSchema.getPrintFlag();
		this.PrintFlag2 = aLCCUWMasterSchema.getPrintFlag2();
		this.ChangePolFlag = aLCCUWMasterSchema.getChangePolFlag();
		this.ChangePolReason = aLCCUWMasterSchema.getChangePolReason();
		this.SpecReason = aLCCUWMasterSchema.getSpecReason();
		this.MakeDate = fDate.getDate( aLCCUWMasterSchema.getMakeDate());
		this.MakeTime = aLCCUWMasterSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLCCUWMasterSchema.getModifyDate());
		this.ModifyTime = aLCCUWMasterSchema.getModifyTime();
		this.SugPassFlag = aLCCUWMasterSchema.getSugPassFlag();
		this.SugUWIdea = aLCCUWMasterSchema.getSugUWIdea();
		this.UpReport = aLCCUWMasterSchema.getUpReport();
		this.CommonReason = aLCCUWMasterSchema.getCommonReason();
		this.BatchNo = aLCCUWMasterSchema.getBatchNo();
		this.CommonReasonCode = aLCCUWMasterSchema.getCommonReasonCode();
		this.UWState = aLCCUWMasterSchema.getUWState();
		this.UniteNo = aLCCUWMasterSchema.getUniteNo();
		this.WaitReason = aLCCUWMasterSchema.getWaitReason();
		this.WaitContent = aLCCUWMasterSchema.getWaitContent();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LCCUWMaster表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LCCUWMasterSchema";
	...
	public LCCUWMasterSchema getSchema()
	{
		LCCUWMasterSchema aLCCUWMasterSchema = new LCCUWMasterSchema();
		aLCCUWMasterSchema.setSchema(this);
		return aLCCUWMasterSchema;
	}

	public LCCUWMasterDB getDB()
	{
		LCCUWMasterDB aDBOper = new LCCUWMasterDB();
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLCCUWMaster>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			BatchNo= new Integer(ChgData.chgNumericStr(StrTool.getStr(strMessage,41,SysConst.PACKAGESPILTER))).intValue();
			CommonReasonCode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 42, SysConst.PACKAGESPILTER );
			UWState = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 43, SysConst.PACKAGESPILTER );
			UniteNo = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 44, SysConst.PACKAGESPILTER );
			WaitReason = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 45, SysConst.PACKAGESPILTER );
			WaitContent = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 46, SysConst.PACKAGESPILTER );
		}
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LCCUWMasterSchema other = (LCCUWMasterSchema)otherObject;
		return
