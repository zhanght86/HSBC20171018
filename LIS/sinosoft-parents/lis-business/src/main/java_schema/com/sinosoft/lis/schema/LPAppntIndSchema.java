...
/*
 * <p>ClassName: LPAppntIndSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 寿险业务系统lis5模型
 */
public class LPAppntIndSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LPAppntIndSchema.class);
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LPAppntIndSchema cloned = (LPAppntIndSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LPAppntIndSchema 对象给 Schema 赋值
	* @param: aLPAppntIndSchema LPAppntIndSchema
	**/
	public void setSchema(LPAppntIndSchema aLPAppntIndSchema)
	{
		this.EdorNo = aLPAppntIndSchema.getEdorNo();
		this.PolNo = aLPAppntIndSchema.getPolNo();
		this.CustomerNo = aLPAppntIndSchema.getCustomerNo();
		this.EdorType = aLPAppntIndSchema.getEdorType();
		this.SequenceNo = aLPAppntIndSchema.getSequenceNo();
		this.AppntGrade = aLPAppntIndSchema.getAppntGrade();
		this.RelationToInsured = aLPAppntIndSchema.getRelationToInsured();
		this.Password = aLPAppntIndSchema.getPassword();
		this.Name = aLPAppntIndSchema.getName();
		this.Sex = aLPAppntIndSchema.getSex();
		this.Birthday = fDate.getDate( aLPAppntIndSchema.getBirthday());
		this.NativePlace = aLPAppntIndSchema.getNativePlace();
		this.Nationality = aLPAppntIndSchema.getNationality();
		this.Marriage = aLPAppntIndSchema.getMarriage();
		this.MarriageDate = fDate.getDate( aLPAppntIndSchema.getMarriageDate());
		this.OccupationType = aLPAppntIndSchema.getOccupationType();
		this.StartWorkDate = fDate.getDate( aLPAppntIndSchema.getStartWorkDate());
		this.Salary = aLPAppntIndSchema.getSalary();
		this.Health = aLPAppntIndSchema.getHealth();
		this.Stature = aLPAppntIndSchema.getStature();
		this.Avoirdupois = aLPAppntIndSchema.getAvoirdupois();
		this.CreditGrade = aLPAppntIndSchema.getCreditGrade();
		this.IDType = aLPAppntIndSchema.getIDType();
		this.Proterty = aLPAppntIndSchema.getProterty();
		this.IDNo = aLPAppntIndSchema.getIDNo();
		this.OthIDType = aLPAppntIndSchema.getOthIDType();
		this.OthIDNo = aLPAppntIndSchema.getOthIDNo();
		this.ICNo = aLPAppntIndSchema.getICNo();
		this.HomeAddressCode = aLPAppntIndSchema.getHomeAddressCode();
		this.HomeAddress = aLPAppntIndSchema.getHomeAddress();
		this.PostalAddress = aLPAppntIndSchema.getPostalAddress();
		this.ZipCode = aLPAppntIndSchema.getZipCode();
		this.Phone = aLPAppntIndSchema.getPhone();
		this.BP = aLPAppntIndSchema.getBP();
		this.Mobile = aLPAppntIndSchema.getMobile();
		this.EMail = aLPAppntIndSchema.getEMail();
		this.JoinCompanyDate = fDate.getDate( aLPAppntIndSchema.getJoinCompanyDate());
		this.Position = aLPAppntIndSchema.getPosition();
		this.GrpNo = aLPAppntIndSchema.getGrpNo();
		this.GrpName = aLPAppntIndSchema.getGrpName();
		this.GrpPhone = aLPAppntIndSchema.getGrpPhone();
		this.GrpAddressCode = aLPAppntIndSchema.getGrpAddressCode();
		this.GrpAddress = aLPAppntIndSchema.getGrpAddress();
		this.DeathDate = fDate.getDate( aLPAppntIndSchema.getDeathDate());
		this.Remark = aLPAppntIndSchema.getRemark();
		this.State = aLPAppntIndSchema.getState();
		this.ModifyDate = fDate.getDate( aLPAppntIndSchema.getModifyDate());
		this.ModifyTime = aLPAppntIndSchema.getModifyTime();
		this.WorkType = aLPAppntIndSchema.getWorkType();
		this.PluralityType = aLPAppntIndSchema.getPluralityType();
		this.Degree = aLPAppntIndSchema.getDegree();
		this.OccupationCode = aLPAppntIndSchema.getOccupationCode();
		this.GrpZipCode = aLPAppntIndSchema.getGrpZipCode();
		this.SmokeFlag = aLPAppntIndSchema.getSmokeFlag();
		this.RgtAddress = aLPAppntIndSchema.getRgtAddress();
		this.HomeZipCode = aLPAppntIndSchema.getHomeZipCode();
		this.Phone2 = aLPAppntIndSchema.getPhone2();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LPAppntInd表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LPAppntIndSchema";
	...
	public LPAppntIndSchema getSchema()
	{
		LPAppntIndSchema aLPAppntIndSchema = new LPAppntIndSchema();
		aLPAppntIndSchema.setSchema(this);
		return aLPAppntIndSchema;
	}

	public LPAppntIndDB getDB()
	{
		LPAppntIndDB aDBOper = new LPAppntIndDB();
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLPAppntInd>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			NativePlace = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 12, SysConst.PACKAGESPILTER );
			Nationality = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 13, SysConst.PACKAGESPILTER );
			Marriage = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 14, SysConst.PACKAGESPILTER );
			MarriageDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 15,SysConst.PACKAGESPILTER));
			OccupationType = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 16, SysConst.PACKAGESPILTER );
			StartWorkDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 17,SysConst.PACKAGESPILTER));
			Salary = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,18,SysConst.PACKAGESPILTER))).doubleValue();
			...
			IDType = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 23, SysConst.PACKAGESPILTER );
			Proterty = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 24, SysConst.PACKAGESPILTER );
			IDNo = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 25, SysConst.PACKAGESPILTER );
			OthIDType = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 26, SysConst.PACKAGESPILTER );
			OthIDNo = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 27, SysConst.PACKAGESPILTER );
			ICNo = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 28, SysConst.PACKAGESPILTER );
			HomeAddressCode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 29, SysConst.PACKAGESPILTER );
			HomeAddress = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 30, SysConst.PACKAGESPILTER );
			PostalAddress = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 31, SysConst.PACKAGESPILTER );
			ZipCode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 32, SysConst.PACKAGESPILTER );
			Phone = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 33, SysConst.PACKAGESPILTER );
			BP = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 34, SysConst.PACKAGESPILTER );
			Mobile = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 35, SysConst.PACKAGESPILTER );
			EMail = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 36, SysConst.PACKAGESPILTER );
			JoinCompanyDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 37,SysConst.PACKAGESPILTER));
			Position = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 38, SysConst.PACKAGESPILTER );
			...
			GrpPhone = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 41, SysConst.PACKAGESPILTER );
			GrpAddressCode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 42, SysConst.PACKAGESPILTER );
			GrpAddress = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 43, SysConst.PACKAGESPILTER );
			DeathDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 44,SysConst.PACKAGESPILTER));
			Remark = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 45, SysConst.PACKAGESPILTER );
			State = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 46, SysConst.PACKAGESPILTER );
			...
			WorkType = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 49, SysConst.PACKAGESPILTER );
			PluralityType = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 50, SysConst.PACKAGESPILTER );
			Degree = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 51, SysConst.PACKAGESPILTER );
			OccupationCode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 52, SysConst.PACKAGESPILTER );
			GrpZipCode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 53, SysConst.PACKAGESPILTER );
			SmokeFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 54, SysConst.PACKAGESPILTER );
			RgtAddress = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 55, SysConst.PACKAGESPILTER );
			HomeZipCode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 56, SysConst.PACKAGESPILTER );
			Phone2 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 57, SysConst.PACKAGESPILTER );
		}
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LPAppntIndSchema other = (LPAppntIndSchema)otherObject;
		return
