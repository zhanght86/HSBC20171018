...
/*
 * <p>ClassName: LDRiskToRateSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 费率表维护
 */
public class LDRiskToRateSchema implements Schema, Cloneable
{
	// @Field
	/** 险种编码 */
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LDRiskToRateSchema cloned = (LDRiskToRateSchema)super.clone();
	...
	/**
	* 使用另外一个 LDRiskToRateSchema 对象给 Schema 赋值
	* @param: aLDRiskToRateSchema LDRiskToRateSchema
	**/
	public void setSchema(LDRiskToRateSchema aLDRiskToRateSchema)
	{
		this.RiskCode = aLDRiskToRateSchema.getRiskCode();
		this.RiskName = aLDRiskToRateSchema.getRiskName();
		this.RateType = aLDRiskToRateSchema.getRateType();
		this.RateTable = aLDRiskToRateSchema.getRateTable();
		this.Operator = aLDRiskToRateSchema.getOperator();
		this.MakeDate = fDate.getDate( aLDRiskToRateSchema.getMakeDate());
		this.MakeTime = aLDRiskToRateSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLDRiskToRateSchema.getModifyDate());
		this.ModifyTime = aLDRiskToRateSchema.getModifyTime();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			System.out.println("数据库中的LDRiskToRate表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			sqle.printStackTrace();
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LDRiskToRateSchema";
	...
	public LDRiskToRateSchema getSchema()
	{
		LDRiskToRateSchema aLDRiskToRateSchema = new LDRiskToRateSchema();
		aLDRiskToRateSchema.setSchema(this);
		return aLDRiskToRateSchema;
	}

	public LDRiskToRateDB getDB()
	{
		LDRiskToRateDB aDBOper = new LDRiskToRateDB();
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLDRiskToRate>历史记账凭证主表信息</A>表字段
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LDRiskToRateSchema other = (LDRiskToRateSchema)otherObject;
		return
