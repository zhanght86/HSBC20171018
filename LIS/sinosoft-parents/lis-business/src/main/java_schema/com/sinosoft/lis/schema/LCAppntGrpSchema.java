...
/*
 * <p>ClassName: LCAppntGrpSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 寿险业务系统lis5模型
 */
public class LCAppntGrpSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LCAppntGrpSchema.class);
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LCAppntGrpSchema cloned = (LCAppntGrpSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LCAppntGrpSchema 对象给 Schema 赋值
	* @param: aLCAppntGrpSchema LCAppntGrpSchema
	**/
	public void setSchema(LCAppntGrpSchema aLCAppntGrpSchema)
	{
		this.PolNo = aLCAppntGrpSchema.getPolNo();
		this.GrpNo = aLCAppntGrpSchema.getGrpNo();
		this.RelationToInsured = aLCAppntGrpSchema.getRelationToInsured();
		this.AppntGrade = aLCAppntGrpSchema.getAppntGrade();
		this.Password = aLCAppntGrpSchema.getPassword();
		this.GrpName = aLCAppntGrpSchema.getGrpName();
		this.GrpAddressCode = aLCAppntGrpSchema.getGrpAddressCode();
		this.GrpAddress = aLCAppntGrpSchema.getGrpAddress();
		this.GrpZipCode = aLCAppntGrpSchema.getGrpZipCode();
		this.BusinessType = aLCAppntGrpSchema.getBusinessType();
		this.GrpNature = aLCAppntGrpSchema.getGrpNature();
		this.Peoples = aLCAppntGrpSchema.getPeoples();
		this.RgtMoney = aLCAppntGrpSchema.getRgtMoney();
		this.Asset = aLCAppntGrpSchema.getAsset();
		this.NetProfitRate = aLCAppntGrpSchema.getNetProfitRate();
		this.MainBussiness = aLCAppntGrpSchema.getMainBussiness();
		this.Corporation = aLCAppntGrpSchema.getCorporation();
		this.ComAera = aLCAppntGrpSchema.getComAera();
		this.LinkMan1 = aLCAppntGrpSchema.getLinkMan1();
		this.Department1 = aLCAppntGrpSchema.getDepartment1();
		this.HeadShip1 = aLCAppntGrpSchema.getHeadShip1();
		this.Phone1 = aLCAppntGrpSchema.getPhone1();
		this.E_Mail1 = aLCAppntGrpSchema.getE_Mail1();
		this.Fax1 = aLCAppntGrpSchema.getFax1();
		this.LinkMan2 = aLCAppntGrpSchema.getLinkMan2();
		this.Department2 = aLCAppntGrpSchema.getDepartment2();
		this.HeadShip2 = aLCAppntGrpSchema.getHeadShip2();
		this.Phone2 = aLCAppntGrpSchema.getPhone2();
		this.E_Mail2 = aLCAppntGrpSchema.getE_Mail2();
		this.Fax2 = aLCAppntGrpSchema.getFax2();
		this.Fax = aLCAppntGrpSchema.getFax();
		this.Phone = aLCAppntGrpSchema.getPhone();
		this.GetFlag = aLCAppntGrpSchema.getGetFlag();
		this.Satrap = aLCAppntGrpSchema.getSatrap();
		this.EMail = aLCAppntGrpSchema.getEMail();
		this.FoundDate = fDate.getDate( aLCAppntGrpSchema.getFoundDate());
		this.BankAccNo = aLCAppntGrpSchema.getBankAccNo();
		this.BankCode = aLCAppntGrpSchema.getBankCode();
		this.GrpGroupNo = aLCAppntGrpSchema.getGrpGroupNo();
		this.State = aLCAppntGrpSchema.getState();
		this.Remark = aLCAppntGrpSchema.getRemark();
		this.BlacklistFlag = aLCAppntGrpSchema.getBlacklistFlag();
		this.Operator = aLCAppntGrpSchema.getOperator();
		this.MakeDate = fDate.getDate( aLCAppntGrpSchema.getMakeDate());
		this.MakeTime = aLCAppntGrpSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLCAppntGrpSchema.getModifyDate());
		this.ModifyTime = aLCAppntGrpSchema.getModifyTime();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LCAppntGrp表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LCAppntGrpSchema";
	...
	public LCAppntGrpSchema getSchema()
	{
		LCAppntGrpSchema aLCAppntGrpSchema = new LCAppntGrpSchema();
		aLCAppntGrpSchema.setSchema(this);
		return aLCAppntGrpSchema;
	}

	public LCAppntGrpDB getDB()
	{
		LCAppntGrpDB aDBOper = new LCAppntGrpDB();
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLCAppntGrp>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			GrpNo = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 2, SysConst.PACKAGESPILTER );
			RelationToInsured = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 3, SysConst.PACKAGESPILTER );
			...
			GrpAddressCode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 7, SysConst.PACKAGESPILTER );
			GrpAddress = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 8, SysConst.PACKAGESPILTER );
			GrpZipCode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 9, SysConst.PACKAGESPILTER );
			BusinessType = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 10, SysConst.PACKAGESPILTER );
			GrpNature = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 11, SysConst.PACKAGESPILTER );
			Peoples= new Integer(ChgData.chgNumericStr(StrTool.getStr(strMessage,12,SysConst.PACKAGESPILTER))).intValue();
			RgtMoney = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,13,SysConst.PACKAGESPILTER))).doubleValue();
			Asset = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,14,SysConst.PACKAGESPILTER))).doubleValue();
			NetProfitRate = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,15,SysConst.PACKAGESPILTER))).doubleValue();
			MainBussiness = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 16, SysConst.PACKAGESPILTER );
			Corporation = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 17, SysConst.PACKAGESPILTER );
			ComAera = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 18, SysConst.PACKAGESPILTER );
			LinkMan1 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 19, SysConst.PACKAGESPILTER );
			Department1 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 20, SysConst.PACKAGESPILTER );
			HeadShip1 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 21, SysConst.PACKAGESPILTER );
			Phone1 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 22, SysConst.PACKAGESPILTER );
			E_Mail1 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 23, SysConst.PACKAGESPILTER );
			Fax1 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 24, SysConst.PACKAGESPILTER );
			LinkMan2 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 25, SysConst.PACKAGESPILTER );
			Department2 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 26, SysConst.PACKAGESPILTER );
			HeadShip2 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 27, SysConst.PACKAGESPILTER );
			Phone2 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 28, SysConst.PACKAGESPILTER );
			E_Mail2 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 29, SysConst.PACKAGESPILTER );
			Fax2 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 30, SysConst.PACKAGESPILTER );
			Fax = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 31, SysConst.PACKAGESPILTER );
			Phone = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 32, SysConst.PACKAGESPILTER );
			GetFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 33, SysConst.PACKAGESPILTER );
			...
			FoundDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 36,SysConst.PACKAGESPILTER));
			BankAccNo = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 37, SysConst.PACKAGESPILTER );
			BankCode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 38, SysConst.PACKAGESPILTER );
			GrpGroupNo = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 39, SysConst.PACKAGESPILTER );
			State = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 40, SysConst.PACKAGESPILTER );
			Remark = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 41, SysConst.PACKAGESPILTER );
			BlacklistFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 42, SysConst.PACKAGESPILTER );
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LCAppntGrpSchema other = (LCAppntGrpSchema)otherObject;
		return
