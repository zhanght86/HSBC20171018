...
/*
 * <p>ClassName: LPSpecDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 保全流程
 */
public class LPSpecDBSet extends LPSpecSet
{
private static Logger logger = Logger.getLogger(LPSpecDBSet.class);
	...
	**/
	...
	// @Constructor
	public LPSpecDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean delete()
	{
		...
		try
		{
			...
			if(this.get(i).getProposalNo() == null || this.get(i).getProposalNo().equals("null")) {
				...
				pstmt.setString(3, this.get(i).getProposalNo());
			}
