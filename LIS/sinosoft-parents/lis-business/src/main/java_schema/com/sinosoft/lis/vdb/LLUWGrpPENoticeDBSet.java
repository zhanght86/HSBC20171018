...
/*
 * <p>ClassName: LLUWGrpPENoticeDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 泰康未整理PDM
 */
public class LLUWGrpPENoticeDBSet extends LLUWGrpPENoticeSet
{
	// @Field
	...
	**/
	...
	// @Constructor
	public LLUWGrpPENoticeDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LLUWGrpPENoticeDBSet";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getPEResult() == null || this.get(i).getPEResult().equals("null")) {
				...
				pstmt.setString(17, this.get(i).getPEResult());
			}
			// set where condition
			if(this.get(i).getClmNo() == null || this.get(i).getClmNo().equals("null")) {
