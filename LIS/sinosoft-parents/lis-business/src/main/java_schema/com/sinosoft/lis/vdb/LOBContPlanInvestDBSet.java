...
/*
 * <p>ClassName: LOBContPlanInvestDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: Physical Data Model 1
 */
public class LOBContPlanInvestDBSet extends LOBContPlanInvestSet
{
	// @Field
	...
	**/
	...
	// @Constructor
	public LOBContPlanInvestDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LOBContPlanInvestDBSet";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getSegment4() == null || this.get(i).getSegment4().equals("null")) {
				...
				pstmt.setString(13, this.get(i).getSegment4());
			}
			...
			if(this.get(i).getBussType() == null || this.get(i).getBussType().equals("null")) {
				...
				pstmt.setString(20, this.get(i).getBussType());
			}
			if(this.get(i).getBussNo() == null || this.get(i).getBussNo().equals("null")) {
				pstmt.setString(21,null);
			} else {
				pstmt.setString(21, this.get(i).getBussNo());
			}
			if(this.get(i).getPolicyNo() == null || this.get(i).getPolicyNo().equals("null")) {
