...
/*
 * <p>ClassName: LCAscriptionRuleParamsDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 承保核心
 */
public class LCAscriptionRuleParamsDBSet extends LCAscriptionRuleParamsSet
{
private static Logger logger = Logger.getLogger(LCAscriptionRuleParamsDBSet.class);
	...
	**/
	...
	// @Constructor
	public LCAscriptionRuleParamsDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public LCAscriptionRuleParamsDBSet()
	{
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LCAscriptionRuleParamsDBSet";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getAscriptionRuleCode() == null || this.get(i).getAscriptionRuleCode().equals("null")) {
				...
				pstmt.setString(20, this.get(i).getAscriptionRuleCode());
			}
			if(this.get(i).getFactoryType() == null || this.get(i).getFactoryType().equals("null")) {
