...
/*
 * <p>ClassName: LYRenewBankInfoDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 银行业务
 */
public class LYRenewBankInfoDBSet extends LYRenewBankInfoSet
{
private static Logger logger = Logger.getLogger(LYRenewBankInfoDBSet.class);
	...
	**/
	...
	// @Constructor
	public LYRenewBankInfoDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LYRenewBankInfoDBSet";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getPaytoDate() == null || this.get(i).getPaytoDate().equals("null")) {
				...
				pstmt.setDate(7, Date.valueOf(this.get(i).getPaytoDate()));
			}
			...
			if(this.get(i).getBankAccNo() == null || this.get(i).getBankAccNo().equals("null")) {
				...
				pstmt.setString(10, this.get(i).getBankAccNo());
			}
			...
			if(this.get(i).getConfirmOperator() == null || this.get(i).getConfirmOperator().equals("null")) {
				...
				pstmt.setString(12, this.get(i).getConfirmOperator());
			}
			if(this.get(i).getUndoOperator() == null || this.get(i).getUndoOperator().equals("null")) {
				pstmt.setString(13,null);
			} else {
				pstmt.setString(13, this.get(i).getUndoOperator());
			}
