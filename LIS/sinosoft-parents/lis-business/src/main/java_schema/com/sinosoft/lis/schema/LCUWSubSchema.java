...
/*
 * <p>ClassName: LCUWSubSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 承保流程
 */
public class LCUWSubSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LCUWSubSchema.class);
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LCUWSubSchema cloned = (LCUWSubSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LCUWSubSchema 对象给 Schema 赋值
	* @param: aLCUWSubSchema LCUWSubSchema
	**/
	public void setSchema(LCUWSubSchema aLCUWSubSchema)
	{
		this.GrpContNo = aLCUWSubSchema.getGrpContNo();
		this.ContNo = aLCUWSubSchema.getContNo();
		this.ProposalContNo = aLCUWSubSchema.getProposalContNo();
		this.PolNo = aLCUWSubSchema.getPolNo();
		this.ProposalNo = aLCUWSubSchema.getProposalNo();
		this.UWNo = aLCUWSubSchema.getUWNo();
		this.InsuredNo = aLCUWSubSchema.getInsuredNo();
		this.InsuredName = aLCUWSubSchema.getInsuredName();
		this.AppntNo = aLCUWSubSchema.getAppntNo();
		this.AppntName = aLCUWSubSchema.getAppntName();
		this.AgentCode = aLCUWSubSchema.getAgentCode();
		this.AgentGroup = aLCUWSubSchema.getAgentGroup();
		this.PassFlag = aLCUWSubSchema.getPassFlag();
		this.UWGrade = aLCUWSubSchema.getUWGrade();
		this.AppGrade = aLCUWSubSchema.getAppGrade();
		this.PostponeDay = aLCUWSubSchema.getPostponeDay();
		this.PostponeDate = fDate.getDate( aLCUWSubSchema.getPostponeDate());
		this.AutoUWFlag = aLCUWSubSchema.getAutoUWFlag();
		this.State = aLCUWSubSchema.getState();
		this.ManageCom = aLCUWSubSchema.getManageCom();
		this.UWIdea = aLCUWSubSchema.getUWIdea();
		this.UpReportContent = aLCUWSubSchema.getUpReportContent();
		this.Operator = aLCUWSubSchema.getOperator();
		this.HealthFlag = aLCUWSubSchema.getHealthFlag();
		this.QuesFlag = aLCUWSubSchema.getQuesFlag();
		this.SpecFlag = aLCUWSubSchema.getSpecFlag();
		this.AddPremFlag = aLCUWSubSchema.getAddPremFlag();
		this.AddPremReason = aLCUWSubSchema.getAddPremReason();
		this.ReportFlag = aLCUWSubSchema.getReportFlag();
		this.PrintFlag = aLCUWSubSchema.getPrintFlag();
		this.PrintFlag2 = aLCUWSubSchema.getPrintFlag2();
		this.ChangePolFlag = aLCUWSubSchema.getChangePolFlag();
		this.ChangePolReason = aLCUWSubSchema.getChangePolReason();
		this.SpecReason = aLCUWSubSchema.getSpecReason();
		this.MakeDate = fDate.getDate( aLCUWSubSchema.getMakeDate());
		this.MakeTime = aLCUWSubSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLCUWSubSchema.getModifyDate());
		this.ModifyTime = aLCUWSubSchema.getModifyTime();
		this.SugPassFlag = aLCUWSubSchema.getSugPassFlag();
		this.SugUWIdea = aLCUWSubSchema.getSugUWIdea();
		this.UpReport = aLCUWSubSchema.getUpReport();
		this.UWType = aLCUWSubSchema.getUWType();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LCUWSub表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LCUWSubSchema";
	...
	public LCUWSubSchema getSchema()
	{
		LCUWSubSchema aLCUWSubSchema = new LCUWSubSchema();
		aLCUWSubSchema.setSchema(this);
		return aLCUWSubSchema;
	}

	public LCUWSubDB getDB()
	{
		LCUWSubDB aDBOper = new LCUWSubDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLCUWSub描述/A>表字段
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLCUWSub>历史记账凭证主表信息</A>表字段
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LCUWSubSchema other = (LCUWSubSchema)otherObject;
		return
