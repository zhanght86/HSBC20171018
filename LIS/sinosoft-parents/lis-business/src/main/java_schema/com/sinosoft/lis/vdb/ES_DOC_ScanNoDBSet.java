...
/*
 * <p>ClassName: ES_DOC_ScanNoDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: PhysicalDataModel_1
 */
public class ES_DOC_ScanNoDBSet extends ES_DOC_ScanNoSet
{
private static Logger logger = Logger.getLogger(ES_DOC_ScanNoDBSet.class);
	...
	**/
	...
	// @Constructor
	public ES_DOC_ScanNoDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "ES_DOC_ScanNoDBSet";
	...
	public boolean delete()
	{
		...
		try
		{
			...
			if(this.get(i).getScanNo() == null || this.get(i).getScanNo().equals("null")) {
				...
				pstmt.setString(1, this.get(i).getScanNo());
			}
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getScanOperator() == null || this.get(i).getScanOperator().equals("null")) {
				...
				pstmt.setString(2, this.get(i).getScanOperator());
			}
