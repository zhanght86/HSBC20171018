...
/*
 * <p>ClassName: RICalParamSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 再保系统模型
 */
public class RICalParamSchema implements Schema, Cloneable
{
	// @Field
	/** 序列号 */
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		RICalParamSchema cloned = (RICalParamSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 RICalParamSchema 对象给 Schema 赋值
	* @param: aRICalParamSchema RICalParamSchema
	**/
	public void setSchema(RICalParamSchema aRICalParamSchema)
	{
		this.SerialNo = aRICalParamSchema.getSerialNo();
		this.EventNo = aRICalParamSchema.getEventNo();
		this.BatchNo = aRICalParamSchema.getBatchNo();
		this.OtherNo = aRICalParamSchema.getOtherNo();
		this.ContNo = aRICalParamSchema.getContNo();
		this.RiskCode = aRICalParamSchema.getRiskCode();
		this.DutyCode = aRICalParamSchema.getDutyCode();
		this.AreaID = aRICalParamSchema.getAreaID();
		this.AccumulateDefNO = aRICalParamSchema.getAccumulateDefNO();
		this.RIPreceptNo = aRICalParamSchema.getRIPreceptNo();
		this.ParamDouble1 = aRICalParamSchema.getParamDouble1();
		this.ParamDouble2 = aRICalParamSchema.getParamDouble2();
		this.ParamDouble3 = aRICalParamSchema.getParamDouble3();
		this.ParamDouble4 = aRICalParamSchema.getParamDouble4();
		this.ParamDouble5 = aRICalParamSchema.getParamDouble5();
		this.ParamDouble6 = aRICalParamSchema.getParamDouble6();
		this.ParamDouble7 = aRICalParamSchema.getParamDouble7();
		this.ParamDouble8 = aRICalParamSchema.getParamDouble8();
		this.ParamDouble9 = aRICalParamSchema.getParamDouble9();
		this.ParamDouble10 = aRICalParamSchema.getParamDouble10();
		this.ParamString1 = aRICalParamSchema.getParamString1();
		this.ParamString2 = aRICalParamSchema.getParamString2();
		this.ParamString3 = aRICalParamSchema.getParamString3();
		this.ParamString4 = aRICalParamSchema.getParamString4();
		this.ParamString5 = aRICalParamSchema.getParamString5();
		this.ParamString6 = aRICalParamSchema.getParamString6();
		this.ParamDate1 = fDate.getDate( aRICalParamSchema.getParamDate1());
		this.ParamDate2 = fDate.getDate( aRICalParamSchema.getParamDate2());
		this.ParamDate3 = fDate.getDate( aRICalParamSchema.getParamDate3());
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			System.out.println("数据库中的RICalParam表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "RICalParamSchema";
	...
	public RICalParamSchema getSchema()
	{
		RICalParamSchema aRICalParamSchema = new RICalParamSchema();
		aRICalParamSchema.setSchema(this);
		return aRICalParamSchema;
	}

	public RICalParamDB getDB()
	{
		RICalParamDB aDBOper = new RICalParamDB();
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpRICalParam>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			AccumulateDefNO = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 9, SysConst.PACKAGESPILTER );
			RIPreceptNo = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 10, SysConst.PACKAGESPILTER );
			ParamDouble1 = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,11,SysConst.PACKAGESPILTER))).doubleValue();
			ParamDouble2 = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,12,SysConst.PACKAGESPILTER))).doubleValue();
			ParamDouble3 = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,13,SysConst.PACKAGESPILTER))).doubleValue();
			ParamDouble4 = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,14,SysConst.PACKAGESPILTER))).doubleValue();
			ParamDouble5 = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,15,SysConst.PACKAGESPILTER))).doubleValue();
			ParamDouble6 = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,16,SysConst.PACKAGESPILTER))).doubleValue();
			ParamDouble7 = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,17,SysConst.PACKAGESPILTER))).doubleValue();
			ParamDouble8 = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,18,SysConst.PACKAGESPILTER))).doubleValue();
			ParamDouble9 = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,19,SysConst.PACKAGESPILTER))).doubleValue();
			ParamDouble10 = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,20,SysConst.PACKAGESPILTER))).doubleValue();
			ParamString1 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 21, SysConst.PACKAGESPILTER );
			ParamString2 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 22, SysConst.PACKAGESPILTER );
			ParamString3 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 23, SysConst.PACKAGESPILTER );
			ParamString4 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 24, SysConst.PACKAGESPILTER );
			ParamString5 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 25, SysConst.PACKAGESPILTER );
			ParamString6 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 26, SysConst.PACKAGESPILTER );
			ParamDate1 = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 27,SysConst.PACKAGESPILTER));
			ParamDate2 = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 28,SysConst.PACKAGESPILTER));
			ParamDate3 = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 29,SysConst.PACKAGESPILTER));
		}
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		RICalParamSchema other = (RICalParamSchema)otherObject;
		return
