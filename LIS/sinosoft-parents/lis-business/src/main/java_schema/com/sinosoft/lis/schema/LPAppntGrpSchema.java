...
/*
 * <p>ClassName: LPAppntGrpSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 寿险业务系统lis5模型
 */
public class LPAppntGrpSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LPAppntGrpSchema.class);
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LPAppntGrpSchema cloned = (LPAppntGrpSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LPAppntGrpSchema 对象给 Schema 赋值
	* @param: aLPAppntGrpSchema LPAppntGrpSchema
	**/
	public void setSchema(LPAppntGrpSchema aLPAppntGrpSchema)
	{
		this.EdorNo = aLPAppntGrpSchema.getEdorNo();
		this.EdorType = aLPAppntGrpSchema.getEdorType();
		this.PolNo = aLPAppntGrpSchema.getPolNo();
		this.GrpNo = aLPAppntGrpSchema.getGrpNo();
		this.RelationToInsured = aLPAppntGrpSchema.getRelationToInsured();
		this.AppntGrade = aLPAppntGrpSchema.getAppntGrade();
		this.Password = aLPAppntGrpSchema.getPassword();
		this.GrpName = aLPAppntGrpSchema.getGrpName();
		this.GrpAddressCode = aLPAppntGrpSchema.getGrpAddressCode();
		this.GrpAddress = aLPAppntGrpSchema.getGrpAddress();
		this.GrpZipCode = aLPAppntGrpSchema.getGrpZipCode();
		this.BusinessType = aLPAppntGrpSchema.getBusinessType();
		this.GrpNature = aLPAppntGrpSchema.getGrpNature();
		this.Peoples = aLPAppntGrpSchema.getPeoples();
		this.RgtMoney = aLPAppntGrpSchema.getRgtMoney();
		this.Asset = aLPAppntGrpSchema.getAsset();
		this.NetProfitRate = aLPAppntGrpSchema.getNetProfitRate();
		this.MainBussiness = aLPAppntGrpSchema.getMainBussiness();
		this.Corporation = aLPAppntGrpSchema.getCorporation();
		this.ComAera = aLPAppntGrpSchema.getComAera();
		this.LinkMan1 = aLPAppntGrpSchema.getLinkMan1();
		this.Department1 = aLPAppntGrpSchema.getDepartment1();
		this.HeadShip1 = aLPAppntGrpSchema.getHeadShip1();
		this.Phone1 = aLPAppntGrpSchema.getPhone1();
		this.E_Mail1 = aLPAppntGrpSchema.getE_Mail1();
		this.Fax1 = aLPAppntGrpSchema.getFax1();
		this.LinkMan2 = aLPAppntGrpSchema.getLinkMan2();
		this.Department2 = aLPAppntGrpSchema.getDepartment2();
		this.HeadShip2 = aLPAppntGrpSchema.getHeadShip2();
		this.Phone2 = aLPAppntGrpSchema.getPhone2();
		this.E_Mail2 = aLPAppntGrpSchema.getE_Mail2();
		this.Fax2 = aLPAppntGrpSchema.getFax2();
		this.Fax = aLPAppntGrpSchema.getFax();
		this.Phone = aLPAppntGrpSchema.getPhone();
		this.GetFlag = aLPAppntGrpSchema.getGetFlag();
		this.Satrap = aLPAppntGrpSchema.getSatrap();
		this.EMail = aLPAppntGrpSchema.getEMail();
		this.FoundDate = fDate.getDate( aLPAppntGrpSchema.getFoundDate());
		this.BankAccNo = aLPAppntGrpSchema.getBankAccNo();
		this.BankCode = aLPAppntGrpSchema.getBankCode();
		this.GrpGroupNo = aLPAppntGrpSchema.getGrpGroupNo();
		this.State = aLPAppntGrpSchema.getState();
		this.Remark = aLPAppntGrpSchema.getRemark();
		this.BlacklistFlag = aLPAppntGrpSchema.getBlacklistFlag();
		this.Operator = aLPAppntGrpSchema.getOperator();
		this.MakeDate = fDate.getDate( aLPAppntGrpSchema.getMakeDate());
		this.MakeTime = aLPAppntGrpSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLPAppntGrpSchema.getModifyDate());
		this.ModifyTime = aLPAppntGrpSchema.getModifyTime();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LPAppntGrp表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LPAppntGrpSchema";
	...
	public LPAppntGrpSchema getSchema()
	{
		LPAppntGrpSchema aLPAppntGrpSchema = new LPAppntGrpSchema();
		aLPAppntGrpSchema.setSchema(this);
		return aLPAppntGrpSchema;
	}

	public LPAppntGrpDB getDB()
	{
		LPAppntGrpDB aDBOper = new LPAppntGrpDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLPAppntGrp描述/A>表字段
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLPAppntGrp>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			GrpNo = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 4, SysConst.PACKAGESPILTER );
			...
			GrpName = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 8, SysConst.PACKAGESPILTER );
			GrpAddressCode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 9, SysConst.PACKAGESPILTER );
			GrpAddress = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 10, SysConst.PACKAGESPILTER );
			GrpZipCode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 11, SysConst.PACKAGESPILTER );
			BusinessType = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 12, SysConst.PACKAGESPILTER );
			GrpNature = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 13, SysConst.PACKAGESPILTER );
			Peoples= new Integer(ChgData.chgNumericStr(StrTool.getStr(strMessage,14,SysConst.PACKAGESPILTER))).intValue();
			RgtMoney = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,15,SysConst.PACKAGESPILTER))).doubleValue();
			Asset = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,16,SysConst.PACKAGESPILTER))).doubleValue();
			NetProfitRate = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,17,SysConst.PACKAGESPILTER))).doubleValue();
			MainBussiness = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 18, SysConst.PACKAGESPILTER );
			Corporation = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 19, SysConst.PACKAGESPILTER );
			ComAera = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 20, SysConst.PACKAGESPILTER );
			LinkMan1 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 21, SysConst.PACKAGESPILTER );
			Department1 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 22, SysConst.PACKAGESPILTER );
			HeadShip1 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 23, SysConst.PACKAGESPILTER );
			Phone1 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 24, SysConst.PACKAGESPILTER );
			E_Mail1 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 25, SysConst.PACKAGESPILTER );
			Fax1 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 26, SysConst.PACKAGESPILTER );
			LinkMan2 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 27, SysConst.PACKAGESPILTER );
			Department2 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 28, SysConst.PACKAGESPILTER );
			HeadShip2 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 29, SysConst.PACKAGESPILTER );
			Phone2 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 30, SysConst.PACKAGESPILTER );
			E_Mail2 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 31, SysConst.PACKAGESPILTER );
			Fax2 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 32, SysConst.PACKAGESPILTER );
			Fax = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 33, SysConst.PACKAGESPILTER );
			Phone = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 34, SysConst.PACKAGESPILTER );
			GetFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 35, SysConst.PACKAGESPILTER );
			...
			FoundDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 38,SysConst.PACKAGESPILTER));
			BankAccNo = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 39, SysConst.PACKAGESPILTER );
			BankCode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 40, SysConst.PACKAGESPILTER );
			GrpGroupNo = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 41, SysConst.PACKAGESPILTER );
			State = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 42, SysConst.PACKAGESPILTER );
			Remark = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 43, SysConst.PACKAGESPILTER );
			BlacklistFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 44, SysConst.PACKAGESPILTER );
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LPAppntGrpSchema other = (LPAppntGrpSchema)otherObject;
		return
