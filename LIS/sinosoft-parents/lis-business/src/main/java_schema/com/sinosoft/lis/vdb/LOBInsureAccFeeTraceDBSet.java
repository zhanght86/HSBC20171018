...
/*
 * <p>ClassName: LOBInsureAccFeeTraceDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: bug
 */
public class LOBInsureAccFeeTraceDBSet extends LOBInsureAccFeeTraceSet
{
	// @Field
	...
	**/
	...
	// @Constructor
	public LOBInsureAccFeeTraceDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public LOBInsureAccFeeTraceDBSet()
	{
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LOBInsureAccFeeTraceDBSet";
