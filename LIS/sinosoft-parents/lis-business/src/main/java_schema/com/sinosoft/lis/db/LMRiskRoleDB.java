...
{
private static Logger logger = Logger.getLogger(LMRiskRoleDB.class);
	...
	**/
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.getRiskRoleSex() == null || this.getRiskRoleSex().equals("null")) {
				...
				pstmt.setString(16, StrTool.space1(this.getRiskRoleSex(), 1));
			}
			if(this.getRiskRoleNo() == null || this.getRiskRoleNo().equals("null")) {
				pstmt.setNull(17, 12);
			} else {
	...
	public boolean getInfo()
	{
		...
		try
		{
			pstmt = con.prepareStatement("SELECT * FROM LMRiskRole WHERE  RiskCode = ? AND RiskRole = ? AND RiskRoleSex = ? AND RiskRoleNo = ?", 
...
public boolean closeData()
{
	...
	public LMRiskRoleSet executeQuery(SQLwithBindVariables sqlbv) {
	...
	public LMRiskRoleSet executeQuery(SQLwithBindVariables sqlbv, int nStart, int nCount) {
