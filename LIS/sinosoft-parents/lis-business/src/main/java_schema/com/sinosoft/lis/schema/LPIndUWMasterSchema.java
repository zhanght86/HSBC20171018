...
/*
 * <p>ClassName: LPIndUWMasterSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 保全流程
 */
public class LPIndUWMasterSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LPIndUWMasterSchema.class);
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LPIndUWMasterSchema cloned = (LPIndUWMasterSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LPIndUWMasterSchema 对象给 Schema 赋值
	* @param: aLPIndUWMasterSchema LPIndUWMasterSchema
	**/
	public void setSchema(LPIndUWMasterSchema aLPIndUWMasterSchema)
	{
		this.GrpContNo = aLPIndUWMasterSchema.getGrpContNo();
		this.ContNo = aLPIndUWMasterSchema.getContNo();
		this.ProposalContNo = aLPIndUWMasterSchema.getProposalContNo();
		this.UWNo = aLPIndUWMasterSchema.getUWNo();
		this.InsuredNo = aLPIndUWMasterSchema.getInsuredNo();
		this.InsuredName = aLPIndUWMasterSchema.getInsuredName();
		this.AppntNo = aLPIndUWMasterSchema.getAppntNo();
		this.AppntName = aLPIndUWMasterSchema.getAppntName();
		this.AgentCode = aLPIndUWMasterSchema.getAgentCode();
		this.AgentGroup = aLPIndUWMasterSchema.getAgentGroup();
		this.PassFlag = aLPIndUWMasterSchema.getPassFlag();
		this.UWGrade = aLPIndUWMasterSchema.getUWGrade();
		this.AppGrade = aLPIndUWMasterSchema.getAppGrade();
		this.PostponeDay = aLPIndUWMasterSchema.getPostponeDay();
		this.PostponeDate = fDate.getDate( aLPIndUWMasterSchema.getPostponeDate());
		this.AutoUWFlag = aLPIndUWMasterSchema.getAutoUWFlag();
		this.State = aLPIndUWMasterSchema.getState();
		this.ManageCom = aLPIndUWMasterSchema.getManageCom();
		this.UWIdea = aLPIndUWMasterSchema.getUWIdea();
		this.UpReportContent = aLPIndUWMasterSchema.getUpReportContent();
		this.Operator = aLPIndUWMasterSchema.getOperator();
		this.HealthFlag = aLPIndUWMasterSchema.getHealthFlag();
		this.QuesFlag = aLPIndUWMasterSchema.getQuesFlag();
		this.SpecFlag = aLPIndUWMasterSchema.getSpecFlag();
		this.AddPremFlag = aLPIndUWMasterSchema.getAddPremFlag();
		this.AddPremReason = aLPIndUWMasterSchema.getAddPremReason();
		this.ReportFlag = aLPIndUWMasterSchema.getReportFlag();
		this.PrintFlag = aLPIndUWMasterSchema.getPrintFlag();
		this.PrintFlag2 = aLPIndUWMasterSchema.getPrintFlag2();
		this.ChangePolFlag = aLPIndUWMasterSchema.getChangePolFlag();
		this.ChangePolReason = aLPIndUWMasterSchema.getChangePolReason();
		this.SpecReason = aLPIndUWMasterSchema.getSpecReason();
		this.MakeDate = fDate.getDate( aLPIndUWMasterSchema.getMakeDate());
		this.MakeTime = aLPIndUWMasterSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLPIndUWMasterSchema.getModifyDate());
		this.ModifyTime = aLPIndUWMasterSchema.getModifyTime();
		this.SugPassFlag = aLPIndUWMasterSchema.getSugPassFlag();
		this.SugUWIdea = aLPIndUWMasterSchema.getSugUWIdea();
		this.EdorNo = aLPIndUWMasterSchema.getEdorNo();
		this.EdorType = aLPIndUWMasterSchema.getEdorType();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LPIndUWMaster表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LPIndUWMasterSchema";
	...
	public LPIndUWMasterSchema getSchema()
	{
		LPIndUWMasterSchema aLPIndUWMasterSchema = new LPIndUWMasterSchema();
		aLPIndUWMasterSchema.setSchema(this);
		return aLPIndUWMasterSchema;
	}

	public LPIndUWMasterDB getDB()
	{
		LPIndUWMasterDB aDBOper = new LPIndUWMasterDB();
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLPIndUWMaster>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			EdorNo = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 39, SysConst.PACKAGESPILTER );
			EdorType = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 40, SysConst.PACKAGESPILTER );
		}
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LPIndUWMasterSchema other = (LPIndUWMasterSchema)otherObject;
		return
