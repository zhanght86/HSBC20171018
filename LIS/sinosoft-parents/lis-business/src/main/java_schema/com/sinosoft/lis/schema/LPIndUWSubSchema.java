...
/*
 * <p>ClassName: LPIndUWSubSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 保全流程
 */
public class LPIndUWSubSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LPIndUWSubSchema.class);
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LPIndUWSubSchema cloned = (LPIndUWSubSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LPIndUWSubSchema 对象给 Schema 赋值
	* @param: aLPIndUWSubSchema LPIndUWSubSchema
	**/
	public void setSchema(LPIndUWSubSchema aLPIndUWSubSchema)
	{
		this.GrpContNo = aLPIndUWSubSchema.getGrpContNo();
		this.ContNo = aLPIndUWSubSchema.getContNo();
		this.ProposalContNo = aLPIndUWSubSchema.getProposalContNo();
		this.UWNo = aLPIndUWSubSchema.getUWNo();
		this.InsuredNo = aLPIndUWSubSchema.getInsuredNo();
		this.InsuredName = aLPIndUWSubSchema.getInsuredName();
		this.AppntNo = aLPIndUWSubSchema.getAppntNo();
		this.AppntName = aLPIndUWSubSchema.getAppntName();
		this.AgentCode = aLPIndUWSubSchema.getAgentCode();
		this.AgentGroup = aLPIndUWSubSchema.getAgentGroup();
		this.PassFlag = aLPIndUWSubSchema.getPassFlag();
		this.UWGrade = aLPIndUWSubSchema.getUWGrade();
		this.AppGrade = aLPIndUWSubSchema.getAppGrade();
		this.PostponeDay = aLPIndUWSubSchema.getPostponeDay();
		this.PostponeDate = fDate.getDate( aLPIndUWSubSchema.getPostponeDate());
		this.AutoUWFlag = aLPIndUWSubSchema.getAutoUWFlag();
		this.State = aLPIndUWSubSchema.getState();
		this.ManageCom = aLPIndUWSubSchema.getManageCom();
		this.UWIdea = aLPIndUWSubSchema.getUWIdea();
		this.UpReportContent = aLPIndUWSubSchema.getUpReportContent();
		this.Operator = aLPIndUWSubSchema.getOperator();
		this.HealthFlag = aLPIndUWSubSchema.getHealthFlag();
		this.QuesFlag = aLPIndUWSubSchema.getQuesFlag();
		this.SpecFlag = aLPIndUWSubSchema.getSpecFlag();
		this.AddPremFlag = aLPIndUWSubSchema.getAddPremFlag();
		this.AddPremReason = aLPIndUWSubSchema.getAddPremReason();
		this.ReportFlag = aLPIndUWSubSchema.getReportFlag();
		this.PrintFlag = aLPIndUWSubSchema.getPrintFlag();
		this.PrintFlag2 = aLPIndUWSubSchema.getPrintFlag2();
		this.ChangePolFlag = aLPIndUWSubSchema.getChangePolFlag();
		this.ChangePolReason = aLPIndUWSubSchema.getChangePolReason();
		this.SpecReason = aLPIndUWSubSchema.getSpecReason();
		this.MakeDate = fDate.getDate( aLPIndUWSubSchema.getMakeDate());
		this.MakeTime = aLPIndUWSubSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLPIndUWSubSchema.getModifyDate());
		this.ModifyTime = aLPIndUWSubSchema.getModifyTime();
		this.SugPassFlag = aLPIndUWSubSchema.getSugPassFlag();
		this.SugUWIdea = aLPIndUWSubSchema.getSugUWIdea();
		this.EdorNo = aLPIndUWSubSchema.getEdorNo();
		this.EdorType = aLPIndUWSubSchema.getEdorType();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LPIndUWSub表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LPIndUWSubSchema";
	...
	public LPIndUWSubSchema getSchema()
	{
		LPIndUWSubSchema aLPIndUWSubSchema = new LPIndUWSubSchema();
		aLPIndUWSubSchema.setSchema(this);
		return aLPIndUWSubSchema;
	}

	public LPIndUWSubDB getDB()
	{
		LPIndUWSubDB aDBOper = new LPIndUWSubDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLPIndUWSub描述/A>表字段
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLPIndUWSub>历史记账凭证主表信息</A>表字段
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LPIndUWSubSchema other = (LPIndUWSubSchema)otherObject;
		return
