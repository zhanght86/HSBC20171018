...
/*
 * <p>ClassName: LPReturnLoanSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 再保
 */
public class LPReturnLoanSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LPReturnLoanSchema.class);
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LPReturnLoanSchema cloned = (LPReturnLoanSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LPReturnLoanSchema 对象给 Schema 赋值
	* @param: aLPReturnLoanSchema LPReturnLoanSchema
	**/
	public void setSchema(LPReturnLoanSchema aLPReturnLoanSchema)
	{
		this.ContNo = aLPReturnLoanSchema.getContNo();
		this.PolNo = aLPReturnLoanSchema.getPolNo();
		this.EdorType = aLPReturnLoanSchema.getEdorType();
		this.SerialNo = aLPReturnLoanSchema.getSerialNo();
		this.ActuGetNo = aLPReturnLoanSchema.getActuGetNo();
		this.LoanType = aLPReturnLoanSchema.getLoanType();
		this.OrderNo = aLPReturnLoanSchema.getOrderNo();
		this.LoanDate = fDate.getDate( aLPReturnLoanSchema.getLoanDate());
		this.PayOffDate = fDate.getDate( aLPReturnLoanSchema.getPayOffDate());
		this.SumMoney = aLPReturnLoanSchema.getSumMoney();
		this.InputFlag = aLPReturnLoanSchema.getInputFlag();
		this.InterestType = aLPReturnLoanSchema.getInterestType();
		this.InterestRate = aLPReturnLoanSchema.getInterestRate();
		this.InterestMode = aLPReturnLoanSchema.getInterestMode();
		this.RateCalType = aLPReturnLoanSchema.getRateCalType();
		this.RateCalCode = aLPReturnLoanSchema.getRateCalCode();
		this.SpecifyRate = aLPReturnLoanSchema.getSpecifyRate();
		this.LeaveMoney = aLPReturnLoanSchema.getLeaveMoney();
		this.PayOffFlag = aLPReturnLoanSchema.getPayOffFlag();
		this.Operator = aLPReturnLoanSchema.getOperator();
		this.MakeDate = fDate.getDate( aLPReturnLoanSchema.getMakeDate());
		this.MakeTime = aLPReturnLoanSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLPReturnLoanSchema.getModifyDate());
		this.ModifyTime = aLPReturnLoanSchema.getModifyTime();
		this.EdorNo = aLPReturnLoanSchema.getEdorNo();
		this.LoanNo = aLPReturnLoanSchema.getLoanNo();
		this.ReturnMoney = aLPReturnLoanSchema.getReturnMoney();
		this.ReturnInterest = aLPReturnLoanSchema.getReturnInterest();
		this.ClmNo = aLPReturnLoanSchema.getClmNo();
		this.Currency = aLPReturnLoanSchema.getCurrency();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LPReturnLoan表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LPReturnLoanSchema";
	...
	public LPReturnLoanSchema getSchema()
	{
		LPReturnLoanSchema aLPReturnLoanSchema = new LPReturnLoanSchema();
		aLPReturnLoanSchema.setSchema(this);
		return aLPReturnLoanSchema;
	}

	public LPReturnLoanDB getDB()
	{
		LPReturnLoanDB aDBOper = new LPReturnLoanDB();
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLPReturnLoan>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			LoanNo = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 26, SysConst.PACKAGESPILTER );
			ReturnMoney = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,27,SysConst.PACKAGESPILTER))).doubleValue();
			ReturnInterest = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,28,SysConst.PACKAGESPILTER))).doubleValue();
			ClmNo = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 29, SysConst.PACKAGESPILTER );
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LPReturnLoanSchema other = (LPReturnLoanSchema)otherObject;
		return
