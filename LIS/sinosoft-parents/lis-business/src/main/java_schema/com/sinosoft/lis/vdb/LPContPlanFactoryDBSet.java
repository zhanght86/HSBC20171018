...
/*
 * <p>ClassName: LPContPlanFactoryDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 保全核心
 */
public class LPContPlanFactoryDBSet extends LPContPlanFactorySet
{
private static Logger logger = Logger.getLogger(LPContPlanFactoryDBSet.class);
	...
	**/
	...
	// @Constructor
	public LPContPlanFactoryDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LPContPlanFactoryDBSet";
	...
	public boolean delete()
	{
		...
		try
		{
			...
			if(this.get(i).getFactoryType() == null || this.get(i).getFactoryType().equals("null")) {
				...
				pstmt.setString(7, this.get(i).getFactoryType());
			}
			...
			if(this.get(i).getFactoryCode() == null || this.get(i).getFactoryCode().equals("null")) {
				...
				pstmt.setString(9, this.get(i).getFactoryCode());
			}
			pstmt.setInt(10, this.get(i).getFactorySubCode());
			...
			if(this.get(i).getPlanType() == null || this.get(i).getPlanType().equals("null")) {
				...
				pstmt.setString(12, StrTool.space1(this.get(i).getPlanType(), 1));
			}
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getFactoryType() == null || this.get(i).getFactoryType().equals("null")) {
				...
				pstmt.setString(11, this.get(i).getFactoryType());
			}
			if(this.get(i).getOtherNo() == null || this.get(i).getOtherNo().equals("null")) {
				pstmt.setString(12,null);
			} else {
				pstmt.setString(12, this.get(i).getOtherNo());
			}
			if(this.get(i).getFactoryCode() == null || this.get(i).getFactoryCode().equals("null")) {
				pstmt.setString(13,null);
			} else {
				pstmt.setString(13, this.get(i).getFactoryCode());
			}
			pstmt.setInt(14, this.get(i).getFactorySubCode());
			if(this.get(i).getFactoryName() == null || this.get(i).getFactoryName().equals("null")) {
				pstmt.setString(15,null);
			} else {
				pstmt.setString(15, this.get(i).getFactoryName());
			}
			if(this.get(i).getInerSerialNo() == null || this.get(i).getInerSerialNo().equals("null")) {
				pstmt.setString(16,null);
			} else {
				pstmt.setString(16, this.get(i).getInerSerialNo());
			}
			...
			if(this.get(i).getParams() == null || this.get(i).getParams().equals("null")) {
				...
				pstmt.setString(18, this.get(i).getParams());
			}
			if(this.get(i).getCalRemark() == null || this.get(i).getCalRemark().equals("null")) {
				pstmt.setString(19,null);
			} else {
				pstmt.setString(19, this.get(i).getCalRemark());
			}
			...
			if(this.get(i).getPlanType() == null || this.get(i).getPlanType().equals("null")) {
				...
				pstmt.setString(24, this.get(i).getPlanType());
			}
			// set where condition
			if(this.get(i).getEdorNo() == null || this.get(i).getEdorNo().equals("null")) {
			...
			if(this.get(i).getProposalGrpContNo() == null || this.get(i).getProposalGrpContNo().equals("null")) {
				...
				pstmt.setString(27, this.get(i).getProposalGrpContNo());
			}
			if(this.get(i).getMainRiskCode() == null || this.get(i).getMainRiskCode().equals("null")) {
				pstmt.setString(28,null);
			} else {
				pstmt.setString(28, this.get(i).getMainRiskCode());
			}
			if(this.get(i).getRiskCode() == null || this.get(i).getRiskCode().equals("null")) {
			...
			if(this.get(i).getFactoryType() == null || this.get(i).getFactoryType().equals("null")) {
				...
				pstmt.setString(31, this.get(i).getFactoryType());
			}
			if(this.get(i).getOtherNo() == null || this.get(i).getOtherNo().equals("null")) {
				pstmt.setString(32,null);
			} else {
				pstmt.setString(32, this.get(i).getOtherNo());
			}
			if(this.get(i).getFactoryCode() == null || this.get(i).getFactoryCode().equals("null")) {
				pstmt.setString(33,null);
			} else {
				pstmt.setString(33, this.get(i).getFactoryCode());
			}
			pstmt.setInt(34, this.get(i).getFactorySubCode());
			if(this.get(i).getInerSerialNo() == null || this.get(i).getInerSerialNo().equals("null")) {
				pstmt.setString(35,null);
			} else {
				pstmt.setString(35, this.get(i).getInerSerialNo());
			}
			if(this.get(i).getPlanType() == null || this.get(i).getPlanType().equals("null")) {
				pstmt.setString(36,null);
			} else {
				pstmt.setString(36, StrTool.space1(this.get(i).getPlanType(), 1));
			}
