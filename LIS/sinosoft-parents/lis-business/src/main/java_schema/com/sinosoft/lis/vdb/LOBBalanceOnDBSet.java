...
/*
 * <p>ClassName: LOBBalanceOnDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: Physical Data Model 1
 */
public class LOBBalanceOnDBSet extends LOBBalanceOnSet
{
	// @Field
	...
	**/
	...
	// @Constructor
	public LOBBalanceOnDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LOBBalanceOnDBSet";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getGrpPropNo() == null || this.get(i).getGrpPropNo().equals("null")) {
				...
				pstmt.setString(27, this.get(i).getGrpPropNo());
			}
