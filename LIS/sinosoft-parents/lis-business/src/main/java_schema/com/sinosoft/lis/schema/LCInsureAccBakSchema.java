...
import com.sinosoft.lis.db.LCInsureAccBakDB;

/*
 * <p>ClassName: LCInsureAccBakSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: PhysicalDataModel_1
 */
public class LCInsureAccBakSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LCInsureAccBakSchema.class);
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LCInsureAccBakSchema cloned = (LCInsureAccBakSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LCInsureAccBakSchema 对象给 Schema 赋值
	* @param: aLCInsureAccBakSchema LCInsureAccBakSchema
	**/
	public void setSchema(LCInsureAccBakSchema aLCInsureAccBakSchema)
	{
		this.PolNo = aLCInsureAccBakSchema.getPolNo();
		this.InsuAccNo = aLCInsureAccBakSchema.getInsuAccNo();
		this.ContNo = aLCInsureAccBakSchema.getContNo();
		this.GrpContNo = aLCInsureAccBakSchema.getGrpContNo();
		this.GrpPolNo = aLCInsureAccBakSchema.getGrpPolNo();
		this.PrtNo = aLCInsureAccBakSchema.getPrtNo();
		this.RiskCode = aLCInsureAccBakSchema.getRiskCode();
		this.AccType = aLCInsureAccBakSchema.getAccType();
		this.InvestType = aLCInsureAccBakSchema.getInvestType();
		this.FundCompanyCode = aLCInsureAccBakSchema.getFundCompanyCode();
		this.InsuredNo = aLCInsureAccBakSchema.getInsuredNo();
		this.AppntNo = aLCInsureAccBakSchema.getAppntNo();
		this.Owner = aLCInsureAccBakSchema.getOwner();
		this.AccComputeFlag = aLCInsureAccBakSchema.getAccComputeFlag();
		this.AccFoundDate = fDate.getDate( aLCInsureAccBakSchema.getAccFoundDate());
		this.AccFoundTime = aLCInsureAccBakSchema.getAccFoundTime();
		this.BalaDate = fDate.getDate( aLCInsureAccBakSchema.getBalaDate());
		this.BalaTime = aLCInsureAccBakSchema.getBalaTime();
		this.SumPay = aLCInsureAccBakSchema.getSumPay();
		this.SumPaym = aLCInsureAccBakSchema.getSumPaym();
		this.LastAccBala = aLCInsureAccBakSchema.getLastAccBala();
		this.LastUnitCount = aLCInsureAccBakSchema.getLastUnitCount();
		this.LastUnitPrice = aLCInsureAccBakSchema.getLastUnitPrice();
		this.InsuAccBala = aLCInsureAccBakSchema.getInsuAccBala();
		this.UnitCount = aLCInsureAccBakSchema.getUnitCount();
		this.UnitPrice = aLCInsureAccBakSchema.getUnitPrice();
		this.InsuAccGetMoney = aLCInsureAccBakSchema.getInsuAccGetMoney();
		this.FrozenMoney = aLCInsureAccBakSchema.getFrozenMoney();
		this.State = aLCInsureAccBakSchema.getState();
		this.ManageCom = aLCInsureAccBakSchema.getManageCom();
		this.Operator = aLCInsureAccBakSchema.getOperator();
		this.MakeDate = fDate.getDate( aLCInsureAccBakSchema.getMakeDate());
		this.MakeTime = aLCInsureAccBakSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLCInsureAccBakSchema.getModifyDate());
		this.ModifyTime = aLCInsureAccBakSchema.getModifyTime();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LCInsureAccBak表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LCInsureAccBakSchema";
	...
	public LCInsureAccBakSchema getSchema()
	{
		LCInsureAccBakSchema aLCInsureAccBakSchema = new LCInsureAccBakSchema();
		aLCInsureAccBakSchema.setSchema(this);
		return aLCInsureAccBakSchema;
	}

	public LCInsureAccBakDB getDB()
	{
		LCInsureAccBakDB aDBOper = new LCInsureAccBakDB();
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLCInsureAccBak>历史记账凭证主表信息</A>表字段
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LCInsureAccBakSchema other = (LCInsureAccBakSchema)otherObject;
		return
