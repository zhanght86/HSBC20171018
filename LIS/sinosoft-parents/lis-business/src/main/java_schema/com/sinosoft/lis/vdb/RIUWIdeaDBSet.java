...
/*
 * <p>ClassName: RIUWIdeaDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 再保系统模型
 */
public class RIUWIdeaDBSet extends RIUWIdeaSet
{
	// @Field
	...
	**/
	...
	// @Constructor
	public RIUWIdeaDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "RIUWIdeaDBSet";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getUWOperator() == null || this.get(i).getUWOperator().equals("null")) {
				...
				pstmt.setString(9, this.get(i).getUWOperator());
			}
			...
			if(this.get(i).getUWConclusion() == null || this.get(i).getUWConclusion().equals("null")) {
				...
				pstmt.setString(11, this.get(i).getUWConclusion());
			}
