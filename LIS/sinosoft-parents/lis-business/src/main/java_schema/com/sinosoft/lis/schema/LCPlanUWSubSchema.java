...
/*
 * <p>ClassName: LCPlanUWSubSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 寿险业务系统未整理模型
 */
public class LCPlanUWSubSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LCPlanUWSubSchema.class);
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LCPlanUWSubSchema cloned = (LCPlanUWSubSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LCPlanUWSubSchema 对象给 Schema 赋值
	* @param: aLCPlanUWSubSchema LCPlanUWSubSchema
	**/
	public void setSchema(LCPlanUWSubSchema aLCPlanUWSubSchema)
	{
		this.GrpContNo = aLCPlanUWSubSchema.getGrpContNo();
		this.ContNo = aLCPlanUWSubSchema.getContNo();
		this.ProposalContNo = aLCPlanUWSubSchema.getProposalContNo();
		this.ContPlanCode = aLCPlanUWSubSchema.getContPlanCode();
		this.PlanType = aLCPlanUWSubSchema.getPlanType();
		this.UWNo = aLCPlanUWSubSchema.getUWNo();
		this.InsuredNo = aLCPlanUWSubSchema.getInsuredNo();
		this.InsuredName = aLCPlanUWSubSchema.getInsuredName();
		this.AppntNo = aLCPlanUWSubSchema.getAppntNo();
		this.AppntName = aLCPlanUWSubSchema.getAppntName();
		this.AgentCode = aLCPlanUWSubSchema.getAgentCode();
		this.AgentGroup = aLCPlanUWSubSchema.getAgentGroup();
		this.PassFlag = aLCPlanUWSubSchema.getPassFlag();
		this.UWGrade = aLCPlanUWSubSchema.getUWGrade();
		this.AppGrade = aLCPlanUWSubSchema.getAppGrade();
		this.PostponeDay = aLCPlanUWSubSchema.getPostponeDay();
		this.PostponeDate = fDate.getDate( aLCPlanUWSubSchema.getPostponeDate());
		this.AutoUWFlag = aLCPlanUWSubSchema.getAutoUWFlag();
		this.State = aLCPlanUWSubSchema.getState();
		this.ManageCom = aLCPlanUWSubSchema.getManageCom();
		this.UWIdea = aLCPlanUWSubSchema.getUWIdea();
		this.UpReportContent = aLCPlanUWSubSchema.getUpReportContent();
		this.HealthFlag = aLCPlanUWSubSchema.getHealthFlag();
		this.QuesFlag = aLCPlanUWSubSchema.getQuesFlag();
		this.SpecFlag = aLCPlanUWSubSchema.getSpecFlag();
		this.AddPremFlag = aLCPlanUWSubSchema.getAddPremFlag();
		this.AddPremReason = aLCPlanUWSubSchema.getAddPremReason();
		this.ReportFlag = aLCPlanUWSubSchema.getReportFlag();
		this.PrintFlag = aLCPlanUWSubSchema.getPrintFlag();
		this.PrintFlag2 = aLCPlanUWSubSchema.getPrintFlag2();
		this.ChangePolFlag = aLCPlanUWSubSchema.getChangePolFlag();
		this.ChangePolReason = aLCPlanUWSubSchema.getChangePolReason();
		this.SpecReason = aLCPlanUWSubSchema.getSpecReason();
		this.SugPassFlag = aLCPlanUWSubSchema.getSugPassFlag();
		this.SugUWIdea = aLCPlanUWSubSchema.getSugUWIdea();
		this.UpReport = aLCPlanUWSubSchema.getUpReport();
		this.Operator = aLCPlanUWSubSchema.getOperator();
		this.MakeDate = fDate.getDate( aLCPlanUWSubSchema.getMakeDate());
		this.MakeTime = aLCPlanUWSubSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLCPlanUWSubSchema.getModifyDate());
		this.ModifyTime = aLCPlanUWSubSchema.getModifyTime();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LCPlanUWSub表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LCPlanUWSubSchema";
	...
	public LCPlanUWSubSchema getSchema()
	{
		LCPlanUWSubSchema aLCPlanUWSubSchema = new LCPlanUWSubSchema();
		aLCPlanUWSubSchema.setSchema(this);
		return aLCPlanUWSubSchema;
	}

	public LCPlanUWSubDB getDB()
	{
		LCPlanUWSubDB aDBOper = new LCPlanUWSubDB();
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLCPlanUWSub>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			SugPassFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 34, SysConst.PACKAGESPILTER );
			SugUWIdea = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 35, SysConst.PACKAGESPILTER );
			UpReport = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 36, SysConst.PACKAGESPILTER );
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LCPlanUWSubSchema other = (LCPlanUWSubSchema)otherObject;
		return
