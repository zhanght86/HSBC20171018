...
/*
 * <p>ClassName: LPAppntSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 保全核心
 */
public class LPAppntSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LPAppntSchema.class);
	// @Field
	/** 批单号 */
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LPAppntSchema cloned = (LPAppntSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LPAppntSchema 对象给 Schema 赋值
	* @param: aLPAppntSchema LPAppntSchema
	**/
	public void setSchema(LPAppntSchema aLPAppntSchema)
	{
		this.EdorNo = aLPAppntSchema.getEdorNo();
		this.EdorType = aLPAppntSchema.getEdorType();
		this.GrpContNo = aLPAppntSchema.getGrpContNo();
		this.ContNo = aLPAppntSchema.getContNo();
		this.PrtNo = aLPAppntSchema.getPrtNo();
		this.AppntNo = aLPAppntSchema.getAppntNo();
		this.AppntGrade = aLPAppntSchema.getAppntGrade();
		this.AppntName = aLPAppntSchema.getAppntName();
		this.AppntSex = aLPAppntSchema.getAppntSex();
		this.AppntBirthday = fDate.getDate( aLPAppntSchema.getAppntBirthday());
		this.AppntType = aLPAppntSchema.getAppntType();
		this.AddressNo = aLPAppntSchema.getAddressNo();
		this.IDType = aLPAppntSchema.getIDType();
		this.IDNo = aLPAppntSchema.getIDNo();
		this.NativePlace = aLPAppntSchema.getNativePlace();
		this.Nationality = aLPAppntSchema.getNationality();
		this.RgtAddress = aLPAppntSchema.getRgtAddress();
		this.Marriage = aLPAppntSchema.getMarriage();
		this.MarriageDate = fDate.getDate( aLPAppntSchema.getMarriageDate());
		this.Health = aLPAppntSchema.getHealth();
		this.Stature = aLPAppntSchema.getStature();
		this.Avoirdupois = aLPAppntSchema.getAvoirdupois();
		this.Degree = aLPAppntSchema.getDegree();
		this.CreditGrade = aLPAppntSchema.getCreditGrade();
		this.BankCode = aLPAppntSchema.getBankCode();
		this.BankAccNo = aLPAppntSchema.getBankAccNo();
		this.AccName = aLPAppntSchema.getAccName();
		this.JoinCompanyDate = fDate.getDate( aLPAppntSchema.getJoinCompanyDate());
		this.StartWorkDate = fDate.getDate( aLPAppntSchema.getStartWorkDate());
		this.Position = aLPAppntSchema.getPosition();
		this.Salary = aLPAppntSchema.getSalary();
		this.OccupationType = aLPAppntSchema.getOccupationType();
		this.OccupationCode = aLPAppntSchema.getOccupationCode();
		this.WorkType = aLPAppntSchema.getWorkType();
		this.PluralityType = aLPAppntSchema.getPluralityType();
		this.SmokeFlag = aLPAppntSchema.getSmokeFlag();
		this.Operator = aLPAppntSchema.getOperator();
		this.ManageCom = aLPAppntSchema.getManageCom();
		this.MakeDate = fDate.getDate( aLPAppntSchema.getMakeDate());
		this.MakeTime = aLPAppntSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLPAppntSchema.getModifyDate());
		this.ModifyTime = aLPAppntSchema.getModifyTime();
		this.BMI = aLPAppntSchema.getBMI();
		this.License = aLPAppntSchema.getLicense();
		this.LicenseType = aLPAppntSchema.getLicenseType();
		this.RelationToInsured = aLPAppntSchema.getRelationToInsured();
		this.SocialInsuFlag = aLPAppntSchema.getSocialInsuFlag();
		this.IDExpDate = fDate.getDate( aLPAppntSchema.getIDExpDate());
		this.LastName = aLPAppntSchema.getLastName();
		this.FirstName = aLPAppntSchema.getFirstName();
		this.LastNameEn = aLPAppntSchema.getLastNameEn();
		this.FirstNameEn = aLPAppntSchema.getFirstNameEn();
		this.NameEn = aLPAppntSchema.getNameEn();
		this.LastNamePY = aLPAppntSchema.getLastNamePY();
		this.FirstNamePY = aLPAppntSchema.getFirstNamePY();
		this.Language = aLPAppntSchema.getLanguage();
		this.IDStartDate = fDate.getDate( aLPAppntSchema.getIDStartDate());
		this.IDEndDate = fDate.getDate( aLPAppntSchema.getIDEndDate());
		this.WorkCompName = aLPAppntSchema.getWorkCompName();
		this.WorkIDNo = aLPAppntSchema.getWorkIDNo();
		this.State = aLPAppntSchema.getState();
		this.DeathDate = fDate.getDate( aLPAppntSchema.getDeathDate());
		this.BlacklistFlag = aLPAppntSchema.getBlacklistFlag();
		this.VIPValue = aLPAppntSchema.getVIPValue();
		this.SendMsgFlag = aLPAppntSchema.getSendMsgFlag();
		this.SendMailFlag = aLPAppntSchema.getSendMailFlag();
		this.SendQQFlag = aLPAppntSchema.getSendQQFlag();
		this.SendMSNFlag = aLPAppntSchema.getSendMSNFlag();
		this.WechatFlag = aLPAppntSchema.getWechatFlag();
		this.Remark = aLPAppntSchema.getRemark();
		this.ComCode = aLPAppntSchema.getComCode();
		this.ModifyOperator = aLPAppntSchema.getModifyOperator();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LPAppnt表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LPAppntSchema";
	...
	public LPAppntSchema getSchema()
	{
		LPAppntSchema aLPAppntSchema = new LPAppntSchema();
		aLPAppntSchema.setSchema(this);
		return aLPAppntSchema;
	}

	public LPAppntDB getDB()
	{
		LPAppntDB aDBOper = new LPAppntDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLPAppnt描述/A>表字段
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLPAppnt>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			AppntBirthday = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 10,SysConst.PACKAGESPILTER));
			...
			MarriageDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 19,SysConst.PACKAGESPILTER));
			Health = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 20, SysConst.PACKAGESPILTER );
			Stature = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,21,SysConst.PACKAGESPILTER))).doubleValue();
			Avoirdupois = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,22,SysConst.PACKAGESPILTER))).doubleValue();
			...
			JoinCompanyDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 28,SysConst.PACKAGESPILTER));
			StartWorkDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 29,SysConst.PACKAGESPILTER));
			Position = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 30, SysConst.PACKAGESPILTER );
			Salary = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,31,SysConst.PACKAGESPILTER))).doubleValue();
			...
			BMI = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,43,SysConst.PACKAGESPILTER))).doubleValue();
			...
			IDStartDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 57,SysConst.PACKAGESPILTER));
			IDEndDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 58,SysConst.PACKAGESPILTER));
			WorkCompName = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 59, SysConst.PACKAGESPILTER );
			WorkIDNo = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 60, SysConst.PACKAGESPILTER );
			State = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 61, SysConst.PACKAGESPILTER );
			DeathDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 62,SysConst.PACKAGESPILTER));
			BlacklistFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 63, SysConst.PACKAGESPILTER );
			VIPValue = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 64, SysConst.PACKAGESPILTER );
			SendMsgFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 65, SysConst.PACKAGESPILTER );
			SendMailFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 66, SysConst.PACKAGESPILTER );
			SendQQFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 67, SysConst.PACKAGESPILTER );
			SendMSNFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 68, SysConst.PACKAGESPILTER );
			WechatFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 69, SysConst.PACKAGESPILTER );
			Remark = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 70, SysConst.PACKAGESPILTER );
			ComCode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 71, SysConst.PACKAGESPILTER );
			ModifyOperator = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 72, SysConst.PACKAGESPILTER );
		}
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LPAppntSchema other = (LPAppntSchema)otherObject;
		return
