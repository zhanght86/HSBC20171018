...
/*
 * <p>ClassName: LCGPlanUWSubDB </p>
 * <p>Description: DB层数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 寿险业务系统未整理模型
 */
public class LCGPlanUWSubDB extends LCGPlanUWSubSchema
{
private static Logger logger = Logger.getLogger(LCGPlanUWSubDB.class);
	...
	**/
	...
	// @Constructor
	public LCGPlanUWSubDB( Connection tConnection )
	{
		con = tConnection;
		db = new DBOper( con, "LCGPlanUWSub" );
		mflag = true;
	}

	public LCGPlanUWSubDB()
	{
		con = null;
		db = new DBOper( "LCGPlanUWSub" );
		mflag = false;
	}
	...
	{
		LCGPlanUWSubSchema tSchema = this.getSchema();
		...
		else
		{
			...
			tError.moduleName = "LCGPlanUWSubDB";
	...
	public boolean delete()
	{
		...
		try
		{
			pstmt = con.prepareStatement("DELETE FROM LCGPlanUWSub WHERE  ProposalGrpContNo = ? AND ContPlanCode = ? AND PlanType = ? AND UWNo = ?");
		...
		SQLString sqlObj = new SQLString("LCGPlanUWSub");
	...
	public boolean update()
	{
		...
		try
		{
			pstmt = con.prepareStatement("UPDATE LCGPlanUWSub SET  GrpContNo = ? , ProposalGrpContNo = ? , ContPlanCode = ? , PlanType = ? , UWNo = ? , InsuredNo = ? , InsuredName = ? , AppntNo = ? , AppntName = ? , AgentCode = ? , AgentGroup = ? , PassFlag = ? , UWGrade = ? , AppGrade = ? , PostponeDay = ? , PostponeDate = ? , AutoUWFlag = ? , State = ? , ManageCom = ? , UWIdea = ? , UpReportContent = ? , HealthFlag = ? , QuesFlag = ? , SpecFlag = ? , AddPremFlag = ? , AddPremReason = ? , ReportFlag = ? , PrintFlag = ? , PrintFlag2 = ? , ChangePolFlag = ? , ChangePolReason = ? , SpecReason = ? , UpReport = ? , Operator = ? , MakeDate = ? , MakeTime = ? , ModifyDate = ? , ModifyTime = ? WHERE  ProposalGrpContNo = ? AND ContPlanCode = ? AND PlanType = ? AND UWNo = ?");
	...
	public boolean insert()
	{
		...
		try
		{
			pstmt = con.prepareStatement("INSERT INTO LCGPlanUWSub(GrpContNo ,ProposalGrpContNo ,ContPlanCode ,PlanType ,UWNo ,InsuredNo ,InsuredName ,AppntNo ,AppntName ,AgentCode ,AgentGroup ,PassFlag ,UWGrade ,AppGrade ,PostponeDay ,PostponeDate ,AutoUWFlag ,State ,ManageCom ,UWIdea ,UpReportContent ,HealthFlag ,QuesFlag ,SpecFlag ,AddPremFlag ,AddPremReason ,ReportFlag ,PrintFlag ,PrintFlag2 ,ChangePolFlag ,ChangePolReason ,SpecReason ,UpReport ,Operator ,MakeDate ,MakeTime ,ModifyDate ,ModifyTime) VALUES( ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ?)");
			if(this.getGrpContNo() == null || this.getGrpContNo().equals("null")) {
				pstmt.setNull(1, 1);
			} else {
				pstmt.setString(1, this.getGrpContNo());
	...
	public boolean getInfo()
	{
		...
		try
		{
			pstmt = con.prepareStatement("SELECT * FROM LCGPlanUWSub WHERE  ProposalGrpContNo = ? AND ContPlanCode = ? AND PlanType = ? AND UWNo = ?", 
	...
	public LCGPlanUWSubSet query()
	{
		PreparedStatement pstmt = null;
 		ResultSet rs = null;
		LCGPlanUWSubSet aLCGPlanUWSubSet = new LCGPlanUWSubSet();
	  ...
	  if( !mflag ) {
		...
		{
			SQLString sqlObj = new SQLString("LCGPlanUWSub");
			LCGPlanUWSubSchema aSchema = this.getSchema();
			...
			{
				i++;
				LCGPlanUWSubSchema s1 = new LCGPlanUWSubSchema();
				s1.setSchema(rs,i);
				aLCGPlanUWSubSet.add(s1);
			}
			try{ rs.close(); } catch( Exception ex ) {}
			try{ pstmt.close(); } catch( Exception ex1 ) {}
		}
		...
		return aLCGPlanUWSubSet;

	}

	public LCGPlanUWSubSet executeQuery(String sql)
	{
		Statement stmt = null;
		ResultSet rs = null;
		LCGPlanUWSubSet aLCGPlanUWSubSet = new LCGPlanUWSubSet();
	...
	public LCGPlanUWSubSet query(int nStart, int nCount)
	{
		PreparedStatement pstmt = null;
 		ResultSet rs = null;
		LCGPlanUWSubSet aLCGPlanUWSubSet = new LCGPlanUWSubSet();
	...
	public LCGPlanUWSubSet executeQuery(String sql, int nStart, int nCount)
	{
		Statement stmt = null;
		ResultSet rs = null;
		LCGPlanUWSubSet aLCGPlanUWSubSet = new LCGPlanUWSubSet();
	...
	public boolean update(String strWherePart)
	{
	  ...
	  if( !mflag ) {
		...
		try
		{
			...
			String sql = "update LCGPlanUWSub " + sqlObj.getUpdPart() + " where " + strWherePart;
...
/**
 * 获取定量数据
 * @return LCGPlanUWSubSet
 */
public LCGPlanUWSubSet getData()
{
    int tCount = 0;
    LCGPlanUWSubSet tLCGPlanUWSubSet = new LCGPlanUWSubSet();
    LCGPlanUWSubSchema tLCGPlanUWSubSchema = null;
    if (null == mResultSet)
    {
        CError tError = new CError();
        tError.moduleName = "LCGPlanUWSubDB";
    ...
    try
    {
        ...
        tLCGPlanUWSubSchema.setSchema(mResultSet, 1);
        tLCGPlanUWSubSet.add(tLCGPlanUWSubSchema);
...
public boolean closeData()
{
	...
	public LCGPlanUWSubSet executeQuery(SQLwithBindVariables sqlbv) {
	...
	public LCGPlanUWSubSet executeQuery(SQLwithBindVariables sqlbv, int nStart, int nCount) {
