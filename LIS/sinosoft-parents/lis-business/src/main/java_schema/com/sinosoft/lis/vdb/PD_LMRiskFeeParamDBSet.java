...
/**
 * <p>ClassName: PD_LMRiskFeeParamDBSet </p>
 ...
 */
public class PD_LMRiskFeeParamDBSet extends PD_LMRiskFeeParamSet
{
private static Logger logger = Logger.getLogger(PD_LMRiskFeeParamDBSet.class);
    ...
    // @Constructor
    public PD_LMRiskFeeParamDBSet(Connection cConnection)
    {
        con = cConnection;
    ...
    public boolean deleteSQL()
    {
        ...
        else
        {
            ...
            tError.moduleName = "PD_LMRiskFeeParamDBSet";
    ...
    public boolean insert()
    {
        ...
        try
        {
            ...
            for (int i = 1; i <= tCount; i++)
            {
                ...
                pstmt.setDouble(5, this.get(i).getFeeID());
                ...
                pstmt.setDouble(16, this.get(i).getStandbyflag3());
                pstmt.setDouble(17, this.get(i).getStandbyflag4());
    ...
    public boolean update()
    {
        ...
        try
        {
            ...
            for (int i = 1; i <= tCount; i++)
            {
                ...
                {
                    pstmt.setString(23, this.get(i).getFeeCalMode());
                }
                pstmt.setDouble(24, this.get(i).getFeeID());
                pstmt.addBatch();
            }
            pstmt.executeBatch();
            pstmt.close();
