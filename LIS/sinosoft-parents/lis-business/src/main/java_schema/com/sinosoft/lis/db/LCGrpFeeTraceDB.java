...
/*
 * <p>ClassName: LCGrpFeeTraceDB </p>
 * <p>Description: DB层数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 泰康未整理PDM
 */
public class LCGrpFeeTraceDB extends LCGrpFeeTraceSchema
{
	// @Field
	...
	**/
	...
	// @Constructor
	public LCGrpFeeTraceDB( Connection tConnection )
	{
		con = tConnection;
	...
	{
		LCGrpFeeTraceSchema tSchema = this.getSchema();
		...
		else
		{
			...
			tError.moduleName = "LCGrpFeeTraceDB";
	...
	public boolean getInfo()
	{
		...
		try
		{
			pstmt = con.prepareStatement("SELECT * FROM LCGrpFeeTrace WHERE  SerialNo = ?", 
	...
	public LCGrpFeeTraceSet query()
	{
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		LCGrpFeeTraceSet aLCGrpFeeTraceSet = new LCGrpFeeTraceSet();
	  ...
	  if( !mflag ) {
		...
		{
			SQLString sqlObj = new SQLString("LCGrpFeeTrace");
			LCGrpFeeTraceSchema aSchema = this.getSchema();
			...
			{
				i++;
				LCGrpFeeTraceSchema s1 = new LCGrpFeeTraceSchema();
				s1.setSchema(rs,i);
				aLCGrpFeeTraceSet.add(s1);
			}
			try{ rs.close(); } catch( Exception ex ) {}
			try{ pstmt.close(); } catch( Exception ex1 ) {}
		}
		...
		return aLCGrpFeeTraceSet;
	}

	public LCGrpFeeTraceSet executeQuery(String sql)
	{
		Statement stmt = null;
		ResultSet rs = null;
		LCGrpFeeTraceSet aLCGrpFeeTraceSet = new LCGrpFeeTraceSet();
	...
	public LCGrpFeeTraceSet query(int nStart, int nCount)
	{
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		LCGrpFeeTraceSet aLCGrpFeeTraceSet = new LCGrpFeeTraceSet();
	...
	public LCGrpFeeTraceSet executeQuery(String sql, int nStart, int nCount)
	{
		Statement stmt = null;
		ResultSet rs = null;
		LCGrpFeeTraceSet aLCGrpFeeTraceSet = new LCGrpFeeTraceSet();
	...
	public boolean update(String strWherePart)
	{
	  ...
	  if( !mflag ) {
		...
		try
		{
			...
			String sql = "update LCGrpFeeTrace " + sqlObj.getUpdPart() + " where " + strWherePart;
...
/**
 * 获取定量数据
 * @return LCGrpFeeTraceSet
 */
public LCGrpFeeTraceSet getData()
{
    int tCount = 0;
    LCGrpFeeTraceSet tLCGrpFeeTraceSet = new LCGrpFeeTraceSet();
    LCGrpFeeTraceSchema tLCGrpFeeTraceSchema = null;
    if (null == mResultSet)
    {
        CError tError = new CError();
        tError.moduleName = "LCGrpFeeTraceDB";
    ...
    {
        tCount = 1;
        tLCGrpFeeTraceSchema = new LCGrpFeeTraceSchema();
        tLCGrpFeeTraceSchema.setSchema(mResultSet, 1);
        tLCGrpFeeTraceSet.add(tLCGrpFeeTraceSchema);
...
public boolean closeData()
{
	...
	public LCGrpFeeTraceSet executeQuery(SQLwithBindVariables sqlbv) {
	...
	public LCGrpFeeTraceSet executeQuery(SQLwithBindVariables sqlbv, int nStart, int nCount) {
