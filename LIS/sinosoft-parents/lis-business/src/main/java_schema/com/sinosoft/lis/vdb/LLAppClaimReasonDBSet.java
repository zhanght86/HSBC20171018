...
/*
 * <p>ClassName: LLAppClaimReasonDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 理赔管理
 */
public class LLAppClaimReasonDBSet extends LLAppClaimReasonSet
{
	// @Field
	...
	**/
	...
	// @Constructor
	public LLAppClaimReasonDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LLAppClaimReasonDBSet";
	...
	public boolean delete()
	{
		...
		try
		{
			...
			if(this.get(i).getReasonCode() == null || this.get(i).getReasonCode().equals("null")) {
				...
				pstmt.setString(4, this.get(i).getReasonCode());
			}
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getReasonType() == null || this.get(i).getReasonType().equals("null")) {
				...
				pstmt.setString(5, this.get(i).getReasonType());
			}
			...
			if(this.get(i).getAffixGetDate() == null || this.get(i).getAffixGetDate().equals("null")) {
				...
				pstmt.setDate(7, Date.valueOf(this.get(i).getAffixGetDate()));
			}
			if(this.get(i).getMngCom() == null || this.get(i).getMngCom().equals("null")) {
				pstmt.setString(8,null);
			} else {
				pstmt.setString(8, this.get(i).getMngCom());
			}
			...
			if(this.get(i).getRgtNo() == null || this.get(i).getRgtNo().equals("null")) {
				...
				pstmt.setString(17, this.get(i).getRgtNo());
			}
			if(this.get(i).getCustomerNo() == null || this.get(i).getCustomerNo().equals("null")) {
			...
			if(this.get(i).getReasonCode() == null || this.get(i).getReasonCode().equals("null")) {
				...
				pstmt.setString(19, this.get(i).getReasonCode());
			}
