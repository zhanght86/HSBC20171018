...
/*
 * <p>ClassName: LYSendToBankBSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 银行业务
 */
public class LYSendToBankBSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LYSendToBankBSchema.class);
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LYSendToBankBSchema cloned = (LYSendToBankBSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LYSendToBankBSchema 对象给 Schema 赋值
	* @param: aLYSendToBankBSchema LYSendToBankBSchema
	**/
	public void setSchema(LYSendToBankBSchema aLYSendToBankBSchema)
	{
		this.SerialNo = aLYSendToBankBSchema.getSerialNo();
		this.DealType = aLYSendToBankBSchema.getDealType();
		this.DataType = aLYSendToBankBSchema.getDataType();
		this.PayCode = aLYSendToBankBSchema.getPayCode();
		this.PayType = aLYSendToBankBSchema.getPayType();
		this.Name = aLYSendToBankBSchema.getName();
		this.BankCode = aLYSendToBankBSchema.getBankCode();
		this.AccType = aLYSendToBankBSchema.getAccType();
		this.AccName = aLYSendToBankBSchema.getAccName();
		this.AccNo = aLYSendToBankBSchema.getAccNo();
		this.PolNo = aLYSendToBankBSchema.getPolNo();
		this.NoType = aLYSendToBankBSchema.getNoType();
		this.ComCode = aLYSendToBankBSchema.getComCode();
		this.AgentCode = aLYSendToBankBSchema.getAgentCode();
		this.PayMoney = aLYSendToBankBSchema.getPayMoney();
		this.SendDate = fDate.getDate( aLYSendToBankBSchema.getSendDate());
		this.BankDealDate = fDate.getDate( aLYSendToBankBSchema.getBankDealDate());
		this.BankDealTime = fDate.getDate( aLYSendToBankBSchema.getBankDealTime());
		this.BankSuccFlag = aLYSendToBankBSchema.getBankSuccFlag();
		this.VertifyFlag = aLYSendToBankBSchema.getVertifyFlag();
		this.Remark = aLYSendToBankBSchema.getRemark();
		this.ConvertFlag = aLYSendToBankBSchema.getConvertFlag();
		this.DoType = aLYSendToBankBSchema.getDoType();
		this.ModifyDate = fDate.getDate( aLYSendToBankBSchema.getModifyDate());
		this.ModifyTime = aLYSendToBankBSchema.getModifyTime();
		this.RiskCode = aLYSendToBankBSchema.getRiskCode();
		this.SerNo = aLYSendToBankBSchema.getSerNo();
		this.BankName = aLYSendToBankBSchema.getBankName();
		this.InBankCode = aLYSendToBankBSchema.getInBankCode();
		this.InBankName = aLYSendToBankBSchema.getInBankName();
		this.InAccType = aLYSendToBankBSchema.getInAccType();
		this.InAccName = aLYSendToBankBSchema.getInAccName();
		this.InAccNo = aLYSendToBankBSchema.getInAccNo();
		this.IDType = aLYSendToBankBSchema.getIDType();
		this.IDNo = aLYSendToBankBSchema.getIDNo();
		this.StandByFlag1 = aLYSendToBankBSchema.getStandByFlag1();
		this.StandByFlag2 = aLYSendToBankBSchema.getStandByFlag2();
		this.StandByFlag3 = aLYSendToBankBSchema.getStandByFlag3();
		this.StandByFlag4 = aLYSendToBankBSchema.getStandByFlag4();
		this.StandByFlag5 = aLYSendToBankBSchema.getStandByFlag5();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LYSendToBankB表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LYSendToBankBSchema";
	...
	public LYSendToBankBSchema getSchema()
	{
		LYSendToBankBSchema aLYSendToBankBSchema = new LYSendToBankBSchema();
		aLYSendToBankBSchema.setSchema(this);
		return aLYSendToBankBSchema;
	}

	public LYSendToBankBDB getDB()
	{
		LYSendToBankBDB aDBOper = new LYSendToBankBDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLYSendToBankB描述/A>表字段
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLYSendToBankB>历史记账凭证主表信息</A>表字段
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LYSendToBankBSchema other = (LYSendToBankBSchema)otherObject;
		return
