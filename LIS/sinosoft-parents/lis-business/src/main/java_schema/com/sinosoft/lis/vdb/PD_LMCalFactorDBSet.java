...
/*
 * <p>ClassName: PD_LMCalFactorDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 产品定义平台_PDM
 */
public class PD_LMCalFactorDBSet extends PD_LMCalFactorSet
{
private static Logger logger = Logger.getLogger(PD_LMCalFactorDBSet.class);
	...
	**/
	...
	// @Constructor
	public PD_LMCalFactorDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "PD_LMCalFactorDBSet";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getCalCode() == null || this.get(i).getCalCode().equals("null")) {
				...
				pstmt.setString(19, this.get(i).getCalCode());
			}
			if(this.get(i).getFactorCode() == null || this.get(i).getFactorCode().equals("null")) {
				pstmt.setString(20,null);
			} else {
				pstmt.setString(20, this.get(i).getFactorCode());
			}
