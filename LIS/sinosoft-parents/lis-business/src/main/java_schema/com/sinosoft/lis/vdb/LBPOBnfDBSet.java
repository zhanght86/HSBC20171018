...
/*
 * <p>ClassName: LBPOBnfDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 内部外包流程
 */
public class LBPOBnfDBSet extends LBPOBnfSet
{
private static Logger logger = Logger.getLogger(LBPOBnfDBSet.class);
	...
	**/
	...
	// @Constructor
	public LBPOBnfDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LBPOBnfDBSet";
	...
	public boolean delete()
	{
		...
		try
		{
			...
			if(this.get(i).getFillNo() == null || this.get(i).getFillNo().equals("null")) {
				...
				pstmt.setString(2, this.get(i).getFillNo());
			}
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getBnfType() == null || this.get(i).getBnfType().equals("null")) {
				...
				pstmt.setString(6, this.get(i).getBnfType());
			}
			...
			if(this.get(i).getBnfLot() == null || this.get(i).getBnfLot().equals("null")) {
				...
				pstmt.setString(10, this.get(i).getBnfLot());
			}
			...
			if(this.get(i).getBirthday() == null || this.get(i).getBirthday().equals("null")) {
				...
				pstmt.setString(14, this.get(i).getBirthday());
			}
			...
			if(this.get(i).getModifyDate() == null || this.get(i).getModifyDate().equals("null")) {
				...
				pstmt.setString(20, this.get(i).getModifyDate());
			}
			...
			if(this.get(i).getBnfAddress() == null || this.get(i).getBnfAddress().equals("null")) {
				...
				pstmt.setString(22, this.get(i).getBnfAddress());
			}
			// set where condition
			pstmt.setInt(23, this.get(i).getInputNo());
			if(this.get(i).getFillNo() == null || this.get(i).getFillNo().equals("null")) {
				pstmt.setString(24,null);
			} else {
				pstmt.setString(24, this.get(i).getFillNo());
			}
			if(this.get(i).getPolNo() == null || this.get(i).getPolNo().equals("null")) {
