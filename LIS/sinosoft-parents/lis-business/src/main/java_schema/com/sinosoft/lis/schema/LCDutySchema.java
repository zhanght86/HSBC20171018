...
/*
 * <p>ClassName: LCDutySchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 承保核心
 */
public class LCDutySchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LCDutySchema.class);
	// @Field
	/** 保单险种号码 */
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LCDutySchema cloned = (LCDutySchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LCDutySchema 对象给 Schema 赋值
	* @param: aLCDutySchema LCDutySchema
	**/
	public void setSchema(LCDutySchema aLCDutySchema)
	{
		this.PolNo = aLCDutySchema.getPolNo();
		this.DutyCode = aLCDutySchema.getDutyCode();
		this.ContNo = aLCDutySchema.getContNo();
		this.Mult = aLCDutySchema.getMult();
		this.StandPrem = aLCDutySchema.getStandPrem();
		this.Prem = aLCDutySchema.getPrem();
		this.SumPrem = aLCDutySchema.getSumPrem();
		this.Amnt = aLCDutySchema.getAmnt();
		this.RiskAmnt = aLCDutySchema.getRiskAmnt();
		this.PayIntv = aLCDutySchema.getPayIntv();
		this.PayYears = aLCDutySchema.getPayYears();
		this.Years = aLCDutySchema.getYears();
		this.FloatRate = aLCDutySchema.getFloatRate();
		this.FirstPayDate = fDate.getDate( aLCDutySchema.getFirstPayDate());
		this.FirstMonth = aLCDutySchema.getFirstMonth();
		this.PaytoDate = fDate.getDate( aLCDutySchema.getPaytoDate());
		this.PayEndDate = fDate.getDate( aLCDutySchema.getPayEndDate());
		this.PayEndYearFlag = aLCDutySchema.getPayEndYearFlag();
		this.PayEndYear = aLCDutySchema.getPayEndYear();
		this.GetYearFlag = aLCDutySchema.getGetYearFlag();
		this.GetYear = aLCDutySchema.getGetYear();
		this.InsuYearFlag = aLCDutySchema.getInsuYearFlag();
		this.InsuYear = aLCDutySchema.getInsuYear();
		this.AcciYearFlag = aLCDutySchema.getAcciYearFlag();
		this.AcciYear = aLCDutySchema.getAcciYear();
		this.EndDate = fDate.getDate( aLCDutySchema.getEndDate());
		this.AcciEndDate = fDate.getDate( aLCDutySchema.getAcciEndDate());
		this.FreeFlag = aLCDutySchema.getFreeFlag();
		this.FreeRate = aLCDutySchema.getFreeRate();
		this.FreeStartDate = fDate.getDate( aLCDutySchema.getFreeStartDate());
		this.FreeEndDate = fDate.getDate( aLCDutySchema.getFreeEndDate());
		this.GetStartDate = fDate.getDate( aLCDutySchema.getGetStartDate());
		this.GetStartType = aLCDutySchema.getGetStartType();
		this.LiveGetMode = aLCDutySchema.getLiveGetMode();
		this.DeadGetMode = aLCDutySchema.getDeadGetMode();
		this.BonusGetMode = aLCDutySchema.getBonusGetMode();
		this.SSFlag = aLCDutySchema.getSSFlag();
		this.PeakLine = aLCDutySchema.getPeakLine();
		this.GetLimit = aLCDutySchema.getGetLimit();
		this.GetRate = aLCDutySchema.getGetRate();
		this.CalRule = aLCDutySchema.getCalRule();
		this.PremToAmnt = aLCDutySchema.getPremToAmnt();
		this.StandbyFlag1 = aLCDutySchema.getStandbyFlag1();
		this.StandbyFlag2 = aLCDutySchema.getStandbyFlag2();
		this.StandbyFlag3 = aLCDutySchema.getStandbyFlag3();
		this.Operator = aLCDutySchema.getOperator();
		this.MakeDate = fDate.getDate( aLCDutySchema.getMakeDate());
		this.MakeTime = aLCDutySchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLCDutySchema.getModifyDate());
		this.ModifyTime = aLCDutySchema.getModifyTime();
		this.CValiDate = fDate.getDate( aLCDutySchema.getCValiDate());
		this.GetIntv = aLCDutySchema.getGetIntv();
		this.AscriptionRuleCode = aLCDutySchema.getAscriptionRuleCode();
		this.PayRuleCode = aLCDutySchema.getPayRuleCode();
		this.Currency = aLCDutySchema.getCurrency();
		this.ContPlanCode = aLCDutySchema.getContPlanCode();
		this.PlanCode = aLCDutySchema.getPlanCode();
		this.RiskCode = aLCDutySchema.getRiskCode();
		this.PeriodPrem = aLCDutySchema.getPeriodPrem();
		this.ConfDate = fDate.getDate( aLCDutySchema.getConfDate());
		this.State = aLCDutySchema.getState();
		this.ManageCom = aLCDutySchema.getManageCom();
		this.ComCode = aLCDutySchema.getComCode();
		this.ModifyOperator = aLCDutySchema.getModifyOperator();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LCDuty表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LCDutySchema";
	...
	public LCDutySchema getSchema()
	{
		LCDutySchema aLCDutySchema = new LCDutySchema();
		aLCDutySchema.setSchema(this);
		return aLCDutySchema;
	}

	public LCDutyDB getDB()
	{
		LCDutyDB aDBOper = new LCDutyDB();
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLCDuty>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			Mult = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,4,SysConst.PACKAGESPILTER))).doubleValue();
			StandPrem = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,5,SysConst.PACKAGESPILTER))).doubleValue();
			Prem = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,6,SysConst.PACKAGESPILTER))).doubleValue();
			SumPrem = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,7,SysConst.PACKAGESPILTER))).doubleValue();
			Amnt = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,8,SysConst.PACKAGESPILTER))).doubleValue();
			RiskAmnt = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,9,SysConst.PACKAGESPILTER))).doubleValue();
			PayIntv= new Integer(ChgData.chgNumericStr(StrTool.getStr(strMessage,10,SysConst.PACKAGESPILTER))).intValue();
			PayYears= new Integer(ChgData.chgNumericStr(StrTool.getStr(strMessage,11,SysConst.PACKAGESPILTER))).intValue();
			Years= new Integer(ChgData.chgNumericStr(StrTool.getStr(strMessage,12,SysConst.PACKAGESPILTER))).intValue();
			FloatRate = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,13,SysConst.PACKAGESPILTER))).doubleValue();
			FirstPayDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 14,SysConst.PACKAGESPILTER));
			FirstMonth= new Integer(ChgData.chgNumericStr(StrTool.getStr(strMessage,15,SysConst.PACKAGESPILTER))).intValue();
			PaytoDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 16,SysConst.PACKAGESPILTER));
			PayEndDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 17,SysConst.PACKAGESPILTER));
			PayEndYearFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 18, SysConst.PACKAGESPILTER );
			PayEndYear= new Integer(ChgData.chgNumericStr(StrTool.getStr(strMessage,19,SysConst.PACKAGESPILTER))).intValue();
			GetYearFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 20, SysConst.PACKAGESPILTER );
			GetYear= new Integer(ChgData.chgNumericStr(StrTool.getStr(strMessage,21,SysConst.PACKAGESPILTER))).intValue();
			...
			AcciYearFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 24, SysConst.PACKAGESPILTER );
			AcciYear= new Integer(ChgData.chgNumericStr(StrTool.getStr(strMessage,25,SysConst.PACKAGESPILTER))).intValue();
			EndDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 26,SysConst.PACKAGESPILTER));
			AcciEndDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 27,SysConst.PACKAGESPILTER));
			FreeFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 28, SysConst.PACKAGESPILTER );
			FreeRate = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,29,SysConst.PACKAGESPILTER))).doubleValue();
			FreeStartDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 30,SysConst.PACKAGESPILTER));
			FreeEndDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 31,SysConst.PACKAGESPILTER));
			GetStartDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 32,SysConst.PACKAGESPILTER));
			GetStartType = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 33, SysConst.PACKAGESPILTER );
			LiveGetMode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 34, SysConst.PACKAGESPILTER );
			DeadGetMode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 35, SysConst.PACKAGESPILTER );
			BonusGetMode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 36, SysConst.PACKAGESPILTER );
			SSFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 37, SysConst.PACKAGESPILTER );
			PeakLine = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,38,SysConst.PACKAGESPILTER))).doubleValue();
			GetLimit = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,39,SysConst.PACKAGESPILTER))).doubleValue();
			GetRate = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,40,SysConst.PACKAGESPILTER))).doubleValue();
			CalRule = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 41, SysConst.PACKAGESPILTER );
			PremToAmnt = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 42, SysConst.PACKAGESPILTER );
			StandbyFlag1 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 43, SysConst.PACKAGESPILTER );
			StandbyFlag2 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 44, SysConst.PACKAGESPILTER );
			StandbyFlag3 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 45, SysConst.PACKAGESPILTER );
			...
			GetIntv= new Integer(ChgData.chgNumericStr(StrTool.getStr(strMessage,52,SysConst.PACKAGESPILTER))).intValue();
			AscriptionRuleCode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 53, SysConst.PACKAGESPILTER );
			PayRuleCode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 54, SysConst.PACKAGESPILTER );
			Currency = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 55, SysConst.PACKAGESPILTER );
			ContPlanCode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 56, SysConst.PACKAGESPILTER );
			PlanCode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 57, SysConst.PACKAGESPILTER );
			RiskCode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 58, SysConst.PACKAGESPILTER );
			PeriodPrem = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,59,SysConst.PACKAGESPILTER))).doubleValue();
			ConfDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 60,SysConst.PACKAGESPILTER));
			State = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 61, SysConst.PACKAGESPILTER );
			ManageCom = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 62, SysConst.PACKAGESPILTER );
			ComCode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 63, SysConst.PACKAGESPILTER );
			ModifyOperator = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 64, SysConst.PACKAGESPILTER );
		}
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LCDutySchema other = (LCDutySchema)otherObject;
		return
