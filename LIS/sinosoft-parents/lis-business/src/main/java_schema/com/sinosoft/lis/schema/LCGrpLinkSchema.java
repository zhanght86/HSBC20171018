...
import com.sinosoft.lis.db.LCGrpLinkDB;

/*
 * <p>ClassName: LCGrpLinkSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: Physical Data Model 1
 */
public class LCGrpLinkSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LCGrpLinkSchema.class);
	// @Field
	/** 团体保单号 */
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LCGrpLinkSchema cloned = (LCGrpLinkSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LCGrpLinkSchema 对象给 Schema 赋值
	* @param: aLCGrpLinkSchema LCGrpLinkSchema
	**/
	public void setSchema(LCGrpLinkSchema aLCGrpLinkSchema)
	{
		this.GrpContNo = aLCGrpLinkSchema.getGrpContNo();
		this.GrpPropNo = aLCGrpLinkSchema.getGrpPropNo();
		this.ContactNo = aLCGrpLinkSchema.getContactNo();
		this.CustomerNo = aLCGrpLinkSchema.getCustomerNo();
		this.LinkManFlag = aLCGrpLinkSchema.getLinkManFlag();
		this.LinkMan = aLCGrpLinkSchema.getLinkMan();
		this.Department = aLCGrpLinkSchema.getDepartment();
		this.HeadShip = aLCGrpLinkSchema.getHeadShip();
		this.MobilePhone = aLCGrpLinkSchema.getMobilePhone();
		this.Phone = aLCGrpLinkSchema.getPhone();
		this.Fax = aLCGrpLinkSchema.getFax();
		this.EMail = aLCGrpLinkSchema.getEMail();
		this.IDType = aLCGrpLinkSchema.getIDType();
		this.IDNo = aLCGrpLinkSchema.getIDNo();
		this.IDStartDate = fDate.getDate( aLCGrpLinkSchema.getIDStartDate());
		this.IDEndDate = fDate.getDate( aLCGrpLinkSchema.getIDEndDate());
		this.MakeOperator = aLCGrpLinkSchema.getMakeOperator();
		this.MakeDate = fDate.getDate( aLCGrpLinkSchema.getMakeDate());
		this.MakeTime = aLCGrpLinkSchema.getMakeTime();
		this.ModifyOperator = aLCGrpLinkSchema.getModifyOperator();
		this.ModifyDate = fDate.getDate( aLCGrpLinkSchema.getModifyDate());
		this.ModifyTime = aLCGrpLinkSchema.getModifyTime();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LCGrpLink表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LCGrpLinkSchema";
	...
	public LCGrpLinkSchema getSchema()
	{
		LCGrpLinkSchema aLCGrpLinkSchema = new LCGrpLinkSchema();
		aLCGrpLinkSchema.setSchema(this);
		return aLCGrpLinkSchema;
	}

	public LCGrpLinkDB getDB()
	{
		LCGrpLinkDB aDBOper = new LCGrpLinkDB();
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLCGrpLink>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			LinkManFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 5, SysConst.PACKAGESPILTER );
			...
			HeadShip = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 8, SysConst.PACKAGESPILTER );
			MobilePhone = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 9, SysConst.PACKAGESPILTER );
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LCGrpLinkSchema other = (LCGrpLinkSchema)otherObject;
		return
