...
/*
 * <p>ClassName: LPInsuredDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 保全核心
 */
public class LPInsuredDBSet extends LPInsuredSet
{
	// @Field
	...
	**/
	...
	// @Constructor
	public LPInsuredDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LPInsuredDBSet";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getExecuteCom() == null || this.get(i).getExecuteCom().equals("null")) {
				...
				pstmt.setString(9, this.get(i).getExecuteCom());
			}
			...
			if(this.get(i).getRelationToMainInsured() == null || this.get(i).getRelationToMainInsured().equals("null")) {
				...
				pstmt.setString(11, this.get(i).getRelationToMainInsured());
			}
			if(this.get(i).getRelationToAppnt() == null || this.get(i).getRelationToAppnt().equals("null")) {
				pstmt.setString(12,null);
			} else {
				pstmt.setString(12, this.get(i).getRelationToAppnt());
			}
			...
			if(this.get(i).getSequenceNo() == null || this.get(i).getSequenceNo().equals("null")) {
				...
				pstmt.setString(14, this.get(i).getSequenceNo());
			}
			...
			if(this.get(i).getJoinCompanyDate() == null || this.get(i).getJoinCompanyDate().equals("null")) {
				...
				pstmt.setDate(33, Date.valueOf(this.get(i).getJoinCompanyDate()));
			}
			if(this.get(i).getStartWorkDate() == null || this.get(i).getStartWorkDate().equals("null")) {
				pstmt.setDate(34,null);
			} else {
				pstmt.setDate(34, Date.valueOf(this.get(i).getStartWorkDate()));
			}
			...
			pstmt.setDouble(36, this.get(i).getSalary());
			...
			if(this.get(i).getInsuredStat() == null || this.get(i).getInsuredStat().equals("null")) {
				...
				pstmt.setString(44, this.get(i).getInsuredStat());
			}
			...
			if(this.get(i).getUWFlag() == null || this.get(i).getUWFlag().equals("null")) {
				...
				pstmt.setString(49, this.get(i).getUWFlag());
			}
			if(this.get(i).getUWCode() == null || this.get(i).getUWCode().equals("null")) {
				pstmt.setString(50,null);
			} else {
				pstmt.setString(50, this.get(i).getUWCode());
			}
			if(this.get(i).getUWDate() == null || this.get(i).getUWDate().equals("null")) {
				pstmt.setDate(51,null);
			} else {
				pstmt.setDate(51, Date.valueOf(this.get(i).getUWDate()));
			}
			if(this.get(i).getUWTime() == null || this.get(i).getUWTime().equals("null")) {
				pstmt.setString(52,null);
			} else {
				pstmt.setString(52, this.get(i).getUWTime());
			}
			pstmt.setDouble(53, this.get(i).getBMI());
			pstmt.setInt(54, this.get(i).getInsuredPeoples());
			if(this.get(i).getLicense() == null || this.get(i).getLicense().equals("null")) {
				pstmt.setString(55,null);
			} else {
				pstmt.setString(55, this.get(i).getLicense());
			}
			if(this.get(i).getLicenseType() == null || this.get(i).getLicenseType().equals("null")) {
				pstmt.setString(56,null);
			} else {
				pstmt.setString(56, this.get(i).getLicenseType());
			}
			pstmt.setInt(57, this.get(i).getCustomerSeqNo());
