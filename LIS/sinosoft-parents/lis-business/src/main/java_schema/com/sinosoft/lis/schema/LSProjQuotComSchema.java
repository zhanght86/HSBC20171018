...
import com.sinosoft.lis.db.LSProjQuotComDB;

/*
 * <p>ClassName: LSProjQuotComSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: Physical Data Model 1
 */
public class LSProjQuotComSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LSProjQuotComSchema.class);
	// @Field
	/** 询价号 */
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LSProjQuotComSchema cloned = (LSProjQuotComSchema)super.clone();
	...
	public void setManageCom(String aManageCom)
	{
		if(aManageCom!=null && aManageCom.length()>20)
			throw new IllegalArgumentException("适用机构ManageCom值"+aManageCom+"的长度"+aManageCom.length()+"大于最大值20");
		ManageCom = aManageCom;
	}

	/**
	* 使用另外一个 LSProjQuotComSchema 对象给 Schema 赋值
	* @param: aLSProjQuotComSchema LSProjQuotComSchema
	**/
	public void setSchema(LSProjQuotComSchema aLSProjQuotComSchema)
	{
		this.QuotNo = aLSProjQuotComSchema.getQuotNo();
		this.QuotBatNo = aLSProjQuotComSchema.getQuotBatNo();
		this.ManageCom = aLSProjQuotComSchema.getManageCom();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LSProjQuotCom表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LSProjQuotComSchema";
	...
	public LSProjQuotComSchema getSchema()
	{
		LSProjQuotComSchema aLSProjQuotComSchema = new LSProjQuotComSchema();
		aLSProjQuotComSchema.setSchema(this);
		return aLSProjQuotComSchema;
	}

	public LSProjQuotComDB getDB()
	{
		LSProjQuotComDB aDBOper = new LSProjQuotComDB();
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLSProjQuotCom>历史记账凭证主表信息</A>表字段
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LSProjQuotComSchema other = (LSProjQuotComSchema)otherObject;
		return
