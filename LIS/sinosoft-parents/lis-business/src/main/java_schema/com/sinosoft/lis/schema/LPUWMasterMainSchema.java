...
/*
 * <p>ClassName: LPUWMasterMainSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 保全流程
 */
public class LPUWMasterMainSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LPUWMasterMainSchema.class);
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LPUWMasterMainSchema cloned = (LPUWMasterMainSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LPUWMasterMainSchema 对象给 Schema 赋值
	* @param: aLPUWMasterMainSchema LPUWMasterMainSchema
	**/
	public void setSchema(LPUWMasterMainSchema aLPUWMasterMainSchema)
	{
		this.EdorNo = aLPUWMasterMainSchema.getEdorNo();
		this.GrpContNo = aLPUWMasterMainSchema.getGrpContNo();
		this.ContNo = aLPUWMasterMainSchema.getContNo();
		this.ProposalContNo = aLPUWMasterMainSchema.getProposalContNo();
		this.UWNo = aLPUWMasterMainSchema.getUWNo();
		this.InsuredNo = aLPUWMasterMainSchema.getInsuredNo();
		this.InsuredName = aLPUWMasterMainSchema.getInsuredName();
		this.AppntNo = aLPUWMasterMainSchema.getAppntNo();
		this.AppntName = aLPUWMasterMainSchema.getAppntName();
		this.AgentCode = aLPUWMasterMainSchema.getAgentCode();
		this.AgentGroup = aLPUWMasterMainSchema.getAgentGroup();
		this.PassFlag = aLPUWMasterMainSchema.getPassFlag();
		this.UWGrade = aLPUWMasterMainSchema.getUWGrade();
		this.AppGrade = aLPUWMasterMainSchema.getAppGrade();
		this.PostponeDay = aLPUWMasterMainSchema.getPostponeDay();
		this.PostponeDate = fDate.getDate( aLPUWMasterMainSchema.getPostponeDate());
		this.AutoUWFlag = aLPUWMasterMainSchema.getAutoUWFlag();
		this.State = aLPUWMasterMainSchema.getState();
		this.ManageCom = aLPUWMasterMainSchema.getManageCom();
		this.UWIdea = aLPUWMasterMainSchema.getUWIdea();
		this.UpReportContent = aLPUWMasterMainSchema.getUpReportContent();
		this.Operator = aLPUWMasterMainSchema.getOperator();
		this.HealthFlag = aLPUWMasterMainSchema.getHealthFlag();
		this.QuesFlag = aLPUWMasterMainSchema.getQuesFlag();
		this.SpecFlag = aLPUWMasterMainSchema.getSpecFlag();
		this.AddPremFlag = aLPUWMasterMainSchema.getAddPremFlag();
		this.AddPremReason = aLPUWMasterMainSchema.getAddPremReason();
		this.ReportFlag = aLPUWMasterMainSchema.getReportFlag();
		this.PrintFlag = aLPUWMasterMainSchema.getPrintFlag();
		this.PrintFlag2 = aLPUWMasterMainSchema.getPrintFlag2();
		this.ChangePolFlag = aLPUWMasterMainSchema.getChangePolFlag();
		this.ChangePolReason = aLPUWMasterMainSchema.getChangePolReason();
		this.SpecReason = aLPUWMasterMainSchema.getSpecReason();
		this.MakeDate = fDate.getDate( aLPUWMasterMainSchema.getMakeDate());
		this.MakeTime = aLPUWMasterMainSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLPUWMasterMainSchema.getModifyDate());
		this.ModifyTime = aLPUWMasterMainSchema.getModifyTime();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LPUWMasterMain表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LPUWMasterMainSchema";
	...
	public LPUWMasterMainSchema getSchema()
	{
		LPUWMasterMainSchema aLPUWMasterMainSchema = new LPUWMasterMainSchema();
		aLPUWMasterMainSchema.setSchema(this);
		return aLPUWMasterMainSchema;
	}

	public LPUWMasterMainDB getDB()
	{
		LPUWMasterMainDB aDBOper = new LPUWMasterMainDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLPUWMasterMain描述/A>表字段
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLPUWMasterMain>历史记账凭证主表信息</A>表字段
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LPUWMasterMainSchema other = (LPUWMasterMainSchema)otherObject;
		return
