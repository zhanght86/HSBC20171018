...
/*
 * <p>ClassName: LYBankUploadDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 银行业务
 */
public class LYBankUploadDBSet extends LYBankUploadSet
{
private static Logger logger = Logger.getLogger(LYBankUploadDBSet.class);
	...
	**/
	...
	// @Constructor
	public LYBankUploadDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LYBankUploadDBSet";
