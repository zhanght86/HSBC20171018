...
import com.sinosoft.lis.db.LCInsureAccClassBakDB;

/*
 * <p>ClassName: LCInsureAccClassBakSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: PhysicalDataModel_1
 */
public class LCInsureAccClassBakSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LCInsureAccClassBakSchema.class);
	...
	// @Constructor
	public LCInsureAccClassBakSchema()
	{
		mErrors = new CErrors();
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LCInsureAccClassBakSchema cloned = (LCInsureAccClassBakSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LCInsureAccClassBakSchema 对象给 Schema 赋值
	* @param: aLCInsureAccClassBakSchema LCInsureAccClassBakSchema
	**/
	public void setSchema(LCInsureAccClassBakSchema aLCInsureAccClassBakSchema)
	{
		this.GrpContNo = aLCInsureAccClassBakSchema.getGrpContNo();
		this.GrpPolNo = aLCInsureAccClassBakSchema.getGrpPolNo();
		this.ContNo = aLCInsureAccClassBakSchema.getContNo();
		this.ManageCom = aLCInsureAccClassBakSchema.getManageCom();
		this.PolNo = aLCInsureAccClassBakSchema.getPolNo();
		this.InsuAccNo = aLCInsureAccClassBakSchema.getInsuAccNo();
		this.PayPlanCode = aLCInsureAccClassBakSchema.getPayPlanCode();
		this.OtherNo = aLCInsureAccClassBakSchema.getOtherNo();
		this.OtherType = aLCInsureAccClassBakSchema.getOtherType();
		this.AccAscription = aLCInsureAccClassBakSchema.getAccAscription();
		this.RiskCode = aLCInsureAccClassBakSchema.getRiskCode();
		this.InsuredNo = aLCInsureAccClassBakSchema.getInsuredNo();
		this.AppntNo = aLCInsureAccClassBakSchema.getAppntNo();
		this.AccType = aLCInsureAccClassBakSchema.getAccType();
		this.AccComputeFlag = aLCInsureAccClassBakSchema.getAccComputeFlag();
		this.AccFoundDate = fDate.getDate( aLCInsureAccClassBakSchema.getAccFoundDate());
		this.AccFoundTime = aLCInsureAccClassBakSchema.getAccFoundTime();
		this.BalaDate = fDate.getDate( aLCInsureAccClassBakSchema.getBalaDate());
		this.BalaTime = aLCInsureAccClassBakSchema.getBalaTime();
		this.SumPay = aLCInsureAccClassBakSchema.getSumPay();
		this.SumPaym = aLCInsureAccClassBakSchema.getSumPaym();
		this.LastAccBala = aLCInsureAccClassBakSchema.getLastAccBala();
		this.LastUnitCount = aLCInsureAccClassBakSchema.getLastUnitCount();
		this.LastUnitPrice = aLCInsureAccClassBakSchema.getLastUnitPrice();
		this.InsuAccBala = aLCInsureAccClassBakSchema.getInsuAccBala();
		this.UnitCount = aLCInsureAccClassBakSchema.getUnitCount();
		this.InsuAccGetMoney = aLCInsureAccClassBakSchema.getInsuAccGetMoney();
		this.FrozenMoney = aLCInsureAccClassBakSchema.getFrozenMoney();
		this.State = aLCInsureAccClassBakSchema.getState();
		this.Operator = aLCInsureAccClassBakSchema.getOperator();
		this.MakeDate = fDate.getDate( aLCInsureAccClassBakSchema.getMakeDate());
		this.MakeTime = aLCInsureAccClassBakSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLCInsureAccClassBakSchema.getModifyDate());
		this.ModifyTime = aLCInsureAccClassBakSchema.getModifyTime();
		this.AscriptRate = aLCInsureAccClassBakSchema.getAscriptRate();
		this.AscriptType = aLCInsureAccClassBakSchema.getAscriptType();
		this.UnitPrice = aLCInsureAccClassBakSchema.getUnitPrice();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LCInsureAccClassBak表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LCInsureAccClassBakSchema";
	...
	public LCInsureAccClassBakSchema getSchema()
	{
		LCInsureAccClassBakSchema aLCInsureAccClassBakSchema = new LCInsureAccClassBakSchema();
		aLCInsureAccClassBakSchema.setSchema(this);
		return aLCInsureAccClassBakSchema;
	}

	public LCInsureAccClassBakDB getDB()
	{
		LCInsureAccClassBakDB aDBOper = new LCInsureAccClassBakDB();
	...
	**/
	public String encode()
	{
		...
		strReturn.append( ChgData.chgData(UnitPrice));
		return strReturn.toString();
	}

	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLCInsureAccClassBak>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			AscriptRate = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,35,SysConst.PACKAGESPILTER))).doubleValue();
			AscriptType = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 36, SysConst.PACKAGESPILTER );
			UnitPrice = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,37,SysConst.PACKAGESPILTER))).doubleValue();
		}
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LCInsureAccClassBakSchema other = (LCInsureAccClassBakSchema)otherObject;
		return
