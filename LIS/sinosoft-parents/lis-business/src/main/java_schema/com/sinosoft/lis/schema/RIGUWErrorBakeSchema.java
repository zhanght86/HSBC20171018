...
import com.sinosoft.lis.db.RIGUWErrorBakeDB;

/*
 * <p>ClassName: RIGUWErrorBakeSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 再保系统模型
 */
public class RIGUWErrorBakeSchema implements Schema, Cloneable
{
	// @Field
	/** 批次号 */
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		RIGUWErrorBakeSchema cloned = (RIGUWErrorBakeSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 RIGUWErrorBakeSchema 对象给 Schema 赋值
	* @param: aRIGUWErrorBakeSchema RIGUWErrorBakeSchema
	**/
	public void setSchema(RIGUWErrorBakeSchema aRIGUWErrorBakeSchema)
	{
		this.BatchNo = aRIGUWErrorBakeSchema.getBatchNo();
		this.SerialNo = aRIGUWErrorBakeSchema.getSerialNo();
		this.ArithmeticID = aRIGUWErrorBakeSchema.getArithmeticID();
		this.CalItemType = aRIGUWErrorBakeSchema.getCalItemType();
		this.RuleType = aRIGUWErrorBakeSchema.getRuleType();
		this.AuditCode = aRIGUWErrorBakeSchema.getAuditCode();
		this.AuditAffixCode = aRIGUWErrorBakeSchema.getAuditAffixCode();
		this.GrpContNo = aRIGUWErrorBakeSchema.getGrpContNo();
		this.ProposalGrpContNo = aRIGUWErrorBakeSchema.getProposalGrpContNo();
		this.GrpPolNo = aRIGUWErrorBakeSchema.getGrpPolNo();
		this.GrpProposalNo = aRIGUWErrorBakeSchema.getGrpProposalNo();
		this.PolNo = aRIGUWErrorBakeSchema.getPolNo();
		this.ProposalNo = aRIGUWErrorBakeSchema.getProposalNo();
		this.ContPlanCode = aRIGUWErrorBakeSchema.getContPlanCode();
		this.DutyCode = aRIGUWErrorBakeSchema.getDutyCode();
		this.InsuredNo = aRIGUWErrorBakeSchema.getInsuredNo();
		this.InsuredName = aRIGUWErrorBakeSchema.getInsuredName();
		this.AppntNo = aRIGUWErrorBakeSchema.getAppntNo();
		this.AppntName = aRIGUWErrorBakeSchema.getAppntName();
		this.UWError = aRIGUWErrorBakeSchema.getUWError();
		this.Riskcode = aRIGUWErrorBakeSchema.getRiskcode();
		this.CurrValue = aRIGUWErrorBakeSchema.getCurrValue();
		this.UWPassFlag = aRIGUWErrorBakeSchema.getUWPassFlag();
		this.ManageCom = aRIGUWErrorBakeSchema.getManageCom();
		this.MakeDate = fDate.getDate( aRIGUWErrorBakeSchema.getMakeDate());
		this.MakeTime = aRIGUWErrorBakeSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aRIGUWErrorBakeSchema.getModifyDate());
		this.ModifyTime = aRIGUWErrorBakeSchema.getModifyTime();
		this.StandbyString1 = aRIGUWErrorBakeSchema.getStandbyString1();
		this.StandbyString2 = aRIGUWErrorBakeSchema.getStandbyString2();
		this.StandbyString3 = aRIGUWErrorBakeSchema.getStandbyString3();
		this.StandbyDouble1 = aRIGUWErrorBakeSchema.getStandbyDouble1();
		this.StandbyDouble2 = aRIGUWErrorBakeSchema.getStandbyDouble2();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			System.out.println("数据库中的RIGUWErrorBake表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "RIGUWErrorBakeSchema";
	...
	public RIGUWErrorBakeSchema getSchema()
	{
		RIGUWErrorBakeSchema aRIGUWErrorBakeSchema = new RIGUWErrorBakeSchema();
		aRIGUWErrorBakeSchema.setSchema(this);
		return aRIGUWErrorBakeSchema;
	}

	public RIGUWErrorBakeDB getDB()
	{
		RIGUWErrorBakeDB aDBOper = new RIGUWErrorBakeDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpRIGUWErrorBake描述/A>表字段
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpRIGUWErrorBake>历史记账凭证主表信息</A>表字段
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		RIGUWErrorBakeSchema other = (RIGUWErrorBakeSchema)otherObject;
		return
