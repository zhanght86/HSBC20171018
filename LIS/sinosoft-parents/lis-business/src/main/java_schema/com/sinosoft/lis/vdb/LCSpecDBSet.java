...
/*
 * <p>ClassName: LCSpecDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 承保流程
 */
public class LCSpecDBSet extends LCSpecSet
{
private static Logger logger = Logger.getLogger(LCSpecDBSet.class);
	...
	**/
	...
	// @Constructor
	public LCSpecDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getProposalNo() == null || this.get(i).getProposalNo().equals("null")) {
				...
				pstmt.setString(4, this.get(i).getProposalNo());
			}
			...
			if(this.get(i).getProposalNo() == null || this.get(i).getProposalNo().equals("null")) {
				...
				pstmt.setString(19, this.get(i).getProposalNo());
			}
			if(this.get(i).getSerialNo() == null || this.get(i).getSerialNo().equals("null")) {
