...
/*
 * <p>ClassName: LPAppntIndDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 寿险业务系统lis5模型
 */
public class LPAppntIndDBSet extends LPAppntIndSet
{
private static Logger logger = Logger.getLogger(LPAppntIndDBSet.class);
	...
	**/
	...
	// @Constructor
	public LPAppntIndDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LPAppntIndDBSet";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getSequenceNo() == null || this.get(i).getSequenceNo().equals("null")) {
				...
				pstmt.setString(5, this.get(i).getSequenceNo());
			}
			...
			if(this.get(i).getIDType() == null || this.get(i).getIDType().equals("null")) {
				...
				pstmt.setString(23, this.get(i).getIDType());
			}
			if(this.get(i).getProterty() == null || this.get(i).getProterty().equals("null")) {
				pstmt.setString(24,null);
			} else {
				pstmt.setString(24, this.get(i).getProterty());
			}
			...
			if(this.get(i).getBP() == null || this.get(i).getBP().equals("null")) {
				...
				pstmt.setString(34, this.get(i).getBP());
			}
			if(this.get(i).getMobile() == null || this.get(i).getMobile().equals("null")) {
				pstmt.setString(35,null);
			} else {
				pstmt.setString(35, this.get(i).getMobile());
			}
			...
			if(this.get(i).getPhone2() == null || this.get(i).getPhone2().equals("null")) {
				...
				pstmt.setString(57, this.get(i).getPhone2());
			}
			// set where condition
			if(this.get(i).getEdorNo() == null || this.get(i).getEdorNo().equals("null")) {
				pstmt.setString(58,null);
			} else {
				pstmt.setString(58, this.get(i).getEdorNo());
			}
			if(this.get(i).getPolNo() == null || this.get(i).getPolNo().equals("null")) {
				pstmt.setString(59,null);
			} else {
				pstmt.setString(59, this.get(i).getPolNo());
			}
			if(this.get(i).getCustomerNo() == null || this.get(i).getCustomerNo().equals("null")) {
			...
			if(this.get(i).getEdorType() == null || this.get(i).getEdorType().equals("null")) {
				...
				pstmt.setString(61, this.get(i).getEdorType());
			}
