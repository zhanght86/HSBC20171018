...
/*
 * <p>ClassName: LCPlanUWMasterDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 寿险业务系统未整理模型
 */
public class LCPlanUWMasterDBSet extends LCPlanUWMasterSet
{
private static Logger logger = Logger.getLogger(LCPlanUWMasterDBSet.class);
	...
	**/
	...
	// @Constructor
	public LCPlanUWMasterDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LCPlanUWMasterDBSet";
	...
	public boolean delete()
	{
		...
		try
		{
			...
			if(this.get(i).getProposalContNo() == null || this.get(i).getProposalContNo().equals("null")) {
				...
				pstmt.setString(1, StrTool.space1(this.get(i).getProposalContNo(), 20));
			}
			...
			if(this.get(i).getPlanType() == null || this.get(i).getPlanType().equals("null")) {
				...
				pstmt.setString(3, StrTool.space1(this.get(i).getPlanType(), 1));
			}
			if(this.get(i).getInsuredNo() == null || this.get(i).getInsuredNo().equals("null")) {
				pstmt.setString(4,null);
			} else {
				pstmt.setString(4, StrTool.space1(this.get(i).getInsuredNo(), 24));
			}
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getSugPassFlag() == null || this.get(i).getSugPassFlag().equals("null")) {
				...
				pstmt.setString(13, this.get(i).getSugPassFlag());
			}
			...
			if(this.get(i).getProposalContNo() == null || this.get(i).getProposalContNo().equals("null")) {
				...
				pstmt.setString(42, StrTool.space1(this.get(i).getProposalContNo(), 20));
			}
			if(this.get(i).getContPlanCode() == null || this.get(i).getContPlanCode().equals("null")) {
			...
			if(this.get(i).getPlanType() == null || this.get(i).getPlanType().equals("null")) {
				...
				pstmt.setString(44, StrTool.space1(this.get(i).getPlanType(), 1));
			}
			if(this.get(i).getInsuredNo() == null || this.get(i).getInsuredNo().equals("null")) {
				pstmt.setString(45,null);
			} else {
				pstmt.setString(45, StrTool.space1(this.get(i).getInsuredNo(), 24));
			}
