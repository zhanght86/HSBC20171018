...
import com.sinosoft.lis.db.LPContPlanParamDB;

/*
 * <p>ClassName: LPContPlanParamSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 保全核心
 */
public class LPContPlanParamSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LPContPlanParamSchema.class);
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LPContPlanParamSchema cloned = (LPContPlanParamSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LPContPlanParamSchema 对象给 Schema 赋值
	* @param: aLPContPlanParamSchema LPContPlanParamSchema
	**/
	public void setSchema(LPContPlanParamSchema aLPContPlanParamSchema)
	{
		this.EdorNo = aLPContPlanParamSchema.getEdorNo();
		this.EdorType = aLPContPlanParamSchema.getEdorType();
		this.GrpContNo = aLPContPlanParamSchema.getGrpContNo();
		this.ProposalGrpContNo = aLPContPlanParamSchema.getProposalGrpContNo();
		this.MainRiskCode = aLPContPlanParamSchema.getMainRiskCode();
		this.MainRiskVersion = aLPContPlanParamSchema.getMainRiskVersion();
		this.RiskCode = aLPContPlanParamSchema.getRiskCode();
		this.RiskVersion = aLPContPlanParamSchema.getRiskVersion();
		this.ContPlanCode = aLPContPlanParamSchema.getContPlanCode();
		this.ContPlanName = aLPContPlanParamSchema.getContPlanName();
		this.FactoryType = aLPContPlanParamSchema.getFactoryType();
		this.OtherNo = aLPContPlanParamSchema.getOtherNo();
		this.FactoryCode = aLPContPlanParamSchema.getFactoryCode();
		this.FactorySubCode = aLPContPlanParamSchema.getFactorySubCode();
		this.FactoryName = aLPContPlanParamSchema.getFactoryName();
		this.InerSerialNo = aLPContPlanParamSchema.getInerSerialNo();
		this.ParamName = aLPContPlanParamSchema.getParamName();
		this.Param = aLPContPlanParamSchema.getParam();
		this.MakeDate = fDate.getDate( aLPContPlanParamSchema.getMakeDate());
		this.MakeTime = aLPContPlanParamSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLPContPlanParamSchema.getModifyDate());
		this.ModifyTime = aLPContPlanParamSchema.getModifyTime();
		this.PlanType = aLPContPlanParamSchema.getPlanType();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LPContPlanParam表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LPContPlanParamSchema";
	...
	public LPContPlanParamSchema getSchema()
	{
		LPContPlanParamSchema aLPContPlanParamSchema = new LPContPlanParamSchema();
		aLPContPlanParamSchema.setSchema(this);
		return aLPContPlanParamSchema;
	}

	public LPContPlanParamDB getDB()
	{
		LPContPlanParamDB aDBOper = new LPContPlanParamDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLPContPlanParam描述/A>表字段
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLPContPlanParam>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			ParamName = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 17, SysConst.PACKAGESPILTER );
			Param = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 18, SysConst.PACKAGESPILTER );
			...
			PlanType = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 23, SysConst.PACKAGESPILTER );
		}
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LPContPlanParamSchema other = (LPContPlanParamSchema)otherObject;
		return
