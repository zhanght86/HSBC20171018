...
import com.sinosoft.lis.db.LDGrpContactInfoDB;

/*
 * <p>ClassName: LDGrpContactInfoSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 客户管理
 */
public class LDGrpContactInfoSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LDGrpContactInfoSchema.class);
	// @Field
	/** 客户号码 */
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LDGrpContactInfoSchema cloned = (LDGrpContactInfoSchema)super.clone();
	...
	/**
	* 使用另外一个 LDGrpContactInfoSchema 对象给 Schema 赋值
	* @param: aLDGrpContactInfoSchema LDGrpContactInfoSchema
	**/
	public void setSchema(LDGrpContactInfoSchema aLDGrpContactInfoSchema)
	{
		this.CustomerNo = aLDGrpContactInfoSchema.getCustomerNo();
		this.Province = aLDGrpContactInfoSchema.getProvince();
		this.City = aLDGrpContactInfoSchema.getCity();
		this.County = aLDGrpContactInfoSchema.getCounty();
		this.Address = aLDGrpContactInfoSchema.getAddress();
		this.ZipCode = aLDGrpContactInfoSchema.getZipCode();
		this.LinkMan1 = aLDGrpContactInfoSchema.getLinkMan1();
		this.Department1 = aLDGrpContactInfoSchema.getDepartment1();
		this.HeadShip1 = aLDGrpContactInfoSchema.getHeadShip1();
		this.MobilePhone1 = aLDGrpContactInfoSchema.getMobilePhone1();
		this.Phone1 = aLDGrpContactInfoSchema.getPhone1();
		this.Fax1 = aLDGrpContactInfoSchema.getFax1();
		this.EMail1 = aLDGrpContactInfoSchema.getEMail1();
		this.MakeOperator = aLDGrpContactInfoSchema.getMakeOperator();
		this.MakeDate = fDate.getDate( aLDGrpContactInfoSchema.getMakeDate());
		this.MakeTime = aLDGrpContactInfoSchema.getMakeTime();
		this.ModifyOperator = aLDGrpContactInfoSchema.getModifyOperator();
		this.ModifyDate = fDate.getDate( aLDGrpContactInfoSchema.getModifyDate());
		this.ModifyTime = aLDGrpContactInfoSchema.getModifyTime();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LDGrpContactInfo表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LDGrpContactInfoSchema";
	...
	public LDGrpContactInfoSchema getSchema()
	{
		LDGrpContactInfoSchema aLDGrpContactInfoSchema = new LDGrpContactInfoSchema();
		aLDGrpContactInfoSchema.setSchema(this);
		return aLDGrpContactInfoSchema;
	}

	public LDGrpContactInfoDB getDB()
	{
		LDGrpContactInfoDB aDBOper = new LDGrpContactInfoDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLDGrpContactInfo描述/A>表字段
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLDGrpContactInfo>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			MobilePhone1 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 10, SysConst.PACKAGESPILTER );
			Phone1 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 11, SysConst.PACKAGESPILTER );
			Fax1 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 12, SysConst.PACKAGESPILTER );
			EMail1 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 13, SysConst.PACKAGESPILTER );
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LDGrpContactInfoSchema other = (LDGrpContactInfoSchema)otherObject;
		return
