...
/*
 * <p>ClassName: LCAscriptionRuleFactoryDB </p>
 * <p>Description: DB层数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 承保核心
 */
public class LCAscriptionRuleFactoryDB extends LCAscriptionRuleFactorySchema
{
private static Logger logger = Logger.getLogger(LCAscriptionRuleFactoryDB.class);
	...
	**/
	...
	// @Constructor
	public LCAscriptionRuleFactoryDB( Connection tConnection )
	{
		con = tConnection;
	...
	public LCAscriptionRuleFactoryDB()
	{
		con = null;
	...
	{
		LCAscriptionRuleFactorySchema tSchema = this.getSchema();
		...
		else
		{
			...
			tError.moduleName = "LCAscriptionRuleFactoryDB";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.getAscriptType() == null || this.getAscriptType().equals("null")) {
				...
				pstmt.setString(20, this.getAscriptType());
			}
			// set where condition
			if(this.getGrpPolNo() == null || this.getGrpPolNo().equals("null")) {
				pstmt.setNull(21, 12);
			...
			if(this.getAscriptionRuleCode() == null || this.getAscriptionRuleCode().equals("null")) {
				...
				pstmt.setString(22, this.getAscriptionRuleCode());
			}
			if(this.getFactoryType() == null || this.getFactoryType().equals("null")) {
				pstmt.setNull(23, 12);
			} else {
	...
	public boolean getInfo()
	{
		...
		try
		{
			pstmt = con.prepareStatement("SELECT * FROM LCAscriptionRuleFactory WHERE  GrpPolNo = ? AND AscriptionRuleCode = ? AND FactoryType = ? AND OtherNo = ? AND FactoryCode = ? AND FactorySubCode = ? AND InerSerialNo = ?", 
	...
	public LCAscriptionRuleFactorySet query()
	{
		PreparedStatement pstmt = null;
 		ResultSet rs = null;
	  ...
	  if( !mflag ) {
		...
		{
			SQLString sqlObj = new SQLString("LCAscriptionRuleFactory");
			LCAscriptionRuleFactorySchema aSchema = this.getSchema();
			...
			{
				i++;
				LCAscriptionRuleFactorySchema s1 = new LCAscriptionRuleFactorySchema();
				s1.setSchema(rs,i);
				aLCAscriptionRuleFactorySet.add(s1);
			}
			try{ rs.close(); } catch( Exception ex ) {}
			try{ pstmt.close(); } catch( Exception ex1 ) {}
		}
		...
		return aLCAscriptionRuleFactorySet;

	}

	public LCAscriptionRuleFactorySet executeQuery(String sql)
	{
		Statement stmt = null;
		ResultSet rs = null;
		LCAscriptionRuleFactorySet aLCAscriptionRuleFactorySet = new LCAscriptionRuleFactorySet();
	...
	public LCAscriptionRuleFactorySet query(int nStart, int nCount)
	{
		PreparedStatement pstmt = null;
 		ResultSet rs = null;
		LCAscriptionRuleFactorySet aLCAscriptionRuleFactorySet = new LCAscriptionRuleFactorySet();
	...
	public LCAscriptionRuleFactorySet executeQuery(String sql, int nStart, int nCount)
	{
		Statement stmt = null;
		ResultSet rs = null;
		LCAscriptionRuleFactorySet aLCAscriptionRuleFactorySet = new LCAscriptionRuleFactorySet();
	...
	public boolean update(String strWherePart)
	{
	  ...
	  if( !mflag ) {
		...
		try
		{
			...
			String sql = "update LCAscriptionRuleFactory " + sqlObj.getUpdPart() + " where " + strWherePart;
...
/**
 * 获取定量数据
 * @return LCAscriptionRuleFactorySet
 */
public LCAscriptionRuleFactorySet getData()
{
    int tCount = 0;
    LCAscriptionRuleFactorySet tLCAscriptionRuleFactorySet = new LCAscriptionRuleFactorySet();
    LCAscriptionRuleFactorySchema tLCAscriptionRuleFactorySchema = null;
    if (null == mResultSet)
    {
        CError tError = new CError();
        tError.moduleName = "LCAscriptionRuleFactoryDB";
    ...
    try
    {
        ...
        tLCAscriptionRuleFactorySchema.setSchema(mResultSet, 1);
    ...
    return tLCAscriptionRuleFactorySet;
}
/**
 * 关闭数据集
 * @return boolean
...
public boolean closeData()
{
	...
	public LCAscriptionRuleFactorySet executeQuery(SQLwithBindVariables sqlbv) {
	...
	public LCAscriptionRuleFactorySet executeQuery(SQLwithBindVariables sqlbv, int nStart, int nCount) {
