...
import com.sinosoft.lis.db.RIRecordTraceBDB;

/*
 * <p>ClassName: RIRecordTraceBSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 再保系统模型
 */
public class RIRecordTraceBSchema implements Schema, Cloneable
{
	// @Field
	/** 备份序列号 */
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		RIRecordTraceBSchema cloned = (RIRecordTraceBSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 RIRecordTraceBSchema 对象给 Schema 赋值
	* @param: aRIRecordTraceBSchema RIRecordTraceBSchema
	**/
	public void setSchema(RIRecordTraceBSchema aRIRecordTraceBSchema)
	{
		this.BakeSerialNo = aRIRecordTraceBSchema.getBakeSerialNo();
		this.SerialNo = aRIRecordTraceBSchema.getSerialNo();
		this.BatchNo = aRIRecordTraceBSchema.getBatchNo();
		this.AccumulateDefNO = aRIRecordTraceBSchema.getAccumulateDefNO();
		this.RIPreceptNo = aRIRecordTraceBSchema.getRIPreceptNo();
		this.OtherNo = aRIRecordTraceBSchema.getOtherNo();
		this.ContNo = aRIRecordTraceBSchema.getContNo();
		this.AreaID = aRIRecordTraceBSchema.getAreaID();
		this.EventNo = aRIRecordTraceBSchema.getEventNo();
		this.EventType = aRIRecordTraceBSchema.getEventType();
		this.RiskCode = aRIRecordTraceBSchema.getRiskCode();
		this.DutyCode = aRIRecordTraceBSchema.getDutyCode();
		this.IncomeCompanyNo = aRIRecordTraceBSchema.getIncomeCompanyNo();
		this.FeeType = aRIRecordTraceBSchema.getFeeType();
		this.FeeMoney = aRIRecordTraceBSchema.getFeeMoney();
		this.CurentAmnt = aRIRecordTraceBSchema.getCurentAmnt();
		this.CessionAmount = aRIRecordTraceBSchema.getCessionAmount();
		this.CessionRate = aRIRecordTraceBSchema.getCessionRate();
		this.AmountChang = aRIRecordTraceBSchema.getAmountChang();
		this.PremChang = aRIRecordTraceBSchema.getPremChang();
		this.CommChang = aRIRecordTraceBSchema.getCommChang();
		this.ReturnPay = aRIRecordTraceBSchema.getReturnPay();
		this.ReturnFee = aRIRecordTraceBSchema.getReturnFee();
		this.AddSubFlag = aRIRecordTraceBSchema.getAddSubFlag();
		this.StandbyString1 = aRIRecordTraceBSchema.getStandbyString1();
		this.StandbyString2 = aRIRecordTraceBSchema.getStandbyString2();
		this.StandbyString3 = aRIRecordTraceBSchema.getStandbyString3();
		this.StandbyString4 = aRIRecordTraceBSchema.getStandbyString4();
		this.StandbyDouble1 = aRIRecordTraceBSchema.getStandbyDouble1();
		this.StandbyDouble2 = aRIRecordTraceBSchema.getStandbyDouble2();
		this.StandbyDouble3 = aRIRecordTraceBSchema.getStandbyDouble3();
		this.StandbyDouble4 = aRIRecordTraceBSchema.getStandbyDouble4();
		this.StandbyDouble5 = aRIRecordTraceBSchema.getStandbyDouble5();
		this.StandbyDouble6 = aRIRecordTraceBSchema.getStandbyDouble6();
		this.StandbyDouble7 = aRIRecordTraceBSchema.getStandbyDouble7();
		this.StandbyDouble8 = aRIRecordTraceBSchema.getStandbyDouble8();
		this.StandbyDouble9 = aRIRecordTraceBSchema.getStandbyDouble9();
		this.StandbyDate1 = aRIRecordTraceBSchema.getStandbyDate1();
		this.StandbyDate2 = aRIRecordTraceBSchema.getStandbyDate2();
		this.ReinsureType = aRIRecordTraceBSchema.getReinsureType();
		this.RIDate = fDate.getDate( aRIRecordTraceBSchema.getRIDate());
		this.FIDate = fDate.getDate( aRIRecordTraceBSchema.getFIDate());
		this.Currency = aRIRecordTraceBSchema.getCurrency();
		this.BillNo = aRIRecordTraceBSchema.getBillNo();
		this.BillBatchNo = aRIRecordTraceBSchema.getBillBatchNo();
		this.SettleFlag = aRIRecordTraceBSchema.getSettleFlag();
		this.PrePremChang = aRIRecordTraceBSchema.getPrePremChang();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			System.out.println("数据库中的RIRecordTraceB表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "RIRecordTraceBSchema";
	...
	public RIRecordTraceBSchema getSchema()
	{
		RIRecordTraceBSchema aRIRecordTraceBSchema = new RIRecordTraceBSchema();
		aRIRecordTraceBSchema.setSchema(this);
		return aRIRecordTraceBSchema;
	}

	public RIRecordTraceBDB getDB()
	{
		RIRecordTraceBDB aDBOper = new RIRecordTraceBDB();
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpRIRecordTraceB>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			AccumulateDefNO = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 4, SysConst.PACKAGESPILTER );
			...
			EventNo = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 9, SysConst.PACKAGESPILTER );
			EventType = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 10, SysConst.PACKAGESPILTER );
			...
			IncomeCompanyNo = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 13, SysConst.PACKAGESPILTER );
			FeeType = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 14, SysConst.PACKAGESPILTER );
			FeeMoney = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,15,SysConst.PACKAGESPILTER))).doubleValue();
			CurentAmnt = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,16,SysConst.PACKAGESPILTER))).doubleValue();
			CessionAmount = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,17,SysConst.PACKAGESPILTER))).doubleValue();
			CessionRate = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,18,SysConst.PACKAGESPILTER))).doubleValue();
			AmountChang = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,19,SysConst.PACKAGESPILTER))).doubleValue();
			PremChang = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,20,SysConst.PACKAGESPILTER))).doubleValue();
			CommChang = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,21,SysConst.PACKAGESPILTER))).doubleValue();
			ReturnPay = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,22,SysConst.PACKAGESPILTER))).doubleValue();
			ReturnFee = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,23,SysConst.PACKAGESPILTER))).doubleValue();
			AddSubFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 24, SysConst.PACKAGESPILTER );
			...
			StandbyString4 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 28, SysConst.PACKAGESPILTER );
			StandbyDouble1 = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,29,SysConst.PACKAGESPILTER))).doubleValue();
			StandbyDouble2 = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,30,SysConst.PACKAGESPILTER))).doubleValue();
			StandbyDouble3 = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,31,SysConst.PACKAGESPILTER))).doubleValue();
			StandbyDouble4 = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,32,SysConst.PACKAGESPILTER))).doubleValue();
			StandbyDouble5 = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,33,SysConst.PACKAGESPILTER))).doubleValue();
			StandbyDouble6 = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,34,SysConst.PACKAGESPILTER))).doubleValue();
			StandbyDouble7 = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,35,SysConst.PACKAGESPILTER))).doubleValue();
			StandbyDouble8 = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,36,SysConst.PACKAGESPILTER))).doubleValue();
			StandbyDouble9 = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,37,SysConst.PACKAGESPILTER))).doubleValue();
			StandbyDate1 = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,38,SysConst.PACKAGESPILTER))).doubleValue();
			StandbyDate2 = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,39,SysConst.PACKAGESPILTER))).doubleValue();
			ReinsureType = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 40, SysConst.PACKAGESPILTER );
			RIDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 41,SysConst.PACKAGESPILTER));
			FIDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 42,SysConst.PACKAGESPILTER));
			Currency = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 43, SysConst.PACKAGESPILTER );
			BillNo = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 44, SysConst.PACKAGESPILTER );
			BillBatchNo = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 45, SysConst.PACKAGESPILTER );
			SettleFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 46, SysConst.PACKAGESPILTER );
			PrePremChang = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,47,SysConst.PACKAGESPILTER))).doubleValue();
		}
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		RIRecordTraceBSchema other = (RIRecordTraceBSchema)otherObject;
		return
