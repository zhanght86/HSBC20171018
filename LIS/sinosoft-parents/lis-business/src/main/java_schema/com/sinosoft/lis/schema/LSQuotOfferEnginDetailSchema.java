...
import com.sinosoft.lis.db.LSQuotOfferEnginDetailDB;

/*
 * <p>ClassName: LSQuotOfferEnginDetailSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: Physical Data Model 1
 */
public class LSQuotOfferEnginDetailSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LSQuotOfferEnginDetailSchema.class);
	// @Field
	/** 报价单号 */
	...
	// @Constructor
	public LSQuotOfferEnginDetailSchema()
	{
		mErrors = new CErrors();
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LSQuotOfferEnginDetailSchema cloned = (LSQuotOfferEnginDetailSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LSQuotOfferEnginDetailSchema 对象给 Schema 赋值
	* @param: aLSQuotOfferEnginDetailSchema LSQuotOfferEnginDetailSchema
	**/
	public void setSchema(LSQuotOfferEnginDetailSchema aLSQuotOfferEnginDetailSchema)
	{
		this.OfferListNo = aLSQuotOfferEnginDetailSchema.getOfferListNo();
		this.SysPlanCode = aLSQuotOfferEnginDetailSchema.getSysPlanCode();
		this.PlanCode = aLSQuotOfferEnginDetailSchema.getPlanCode();
		this.EnginCode = aLSQuotOfferEnginDetailSchema.getEnginCode();
		this.OtherDesc = aLSQuotOfferEnginDetailSchema.getOtherDesc();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LSQuotOfferEnginDetail表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LSQuotOfferEnginDetailSchema";
	...
	public LSQuotOfferEnginDetailSchema getSchema()
	{
		LSQuotOfferEnginDetailSchema aLSQuotOfferEnginDetailSchema = new LSQuotOfferEnginDetailSchema();
		aLSQuotOfferEnginDetailSchema.setSchema(this);
		return aLSQuotOfferEnginDetailSchema;
	}

	public LSQuotOfferEnginDetailDB getDB()
	{
		LSQuotOfferEnginDetailDB aDBOper = new LSQuotOfferEnginDetailDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLSQuotOfferEnginDetail描述/A>表字段
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLSQuotOfferEnginDetail>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			EnginCode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 4, SysConst.PACKAGESPILTER );
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LSQuotOfferEnginDetailSchema other = (LSQuotOfferEnginDetailSchema)otherObject;
		return
