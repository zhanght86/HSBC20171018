...
import com.sinosoft.lis.db.LCInsureAccClassFeeBakDB;

/*
 * <p>ClassName: LCInsureAccClassFeeBakSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: PhysicalDataModel_1
 */
public class LCInsureAccClassFeeBakSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LCInsureAccClassFeeBakSchema.class);
	...
	// @Constructor
	public LCInsureAccClassFeeBakSchema()
	{
		mErrors = new CErrors();
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LCInsureAccClassFeeBakSchema cloned = (LCInsureAccClassFeeBakSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LCInsureAccClassFeeBakSchema 对象给 Schema 赋值
	* @param: aLCInsureAccClassFeeBakSchema LCInsureAccClassFeeBakSchema
	**/
	public void setSchema(LCInsureAccClassFeeBakSchema aLCInsureAccClassFeeBakSchema)
	{
		this.PolNo = aLCInsureAccClassFeeBakSchema.getPolNo();
		this.InsuAccNo = aLCInsureAccClassFeeBakSchema.getInsuAccNo();
		this.PayPlanCode = aLCInsureAccClassFeeBakSchema.getPayPlanCode();
		this.OtherNo = aLCInsureAccClassFeeBakSchema.getOtherNo();
		this.OtherType = aLCInsureAccClassFeeBakSchema.getOtherType();
		this.AccAscription = aLCInsureAccClassFeeBakSchema.getAccAscription();
		this.RiskCode = aLCInsureAccClassFeeBakSchema.getRiskCode();
		this.ContNo = aLCInsureAccClassFeeBakSchema.getContNo();
		this.GrpPolNo = aLCInsureAccClassFeeBakSchema.getGrpPolNo();
		this.GrpContNo = aLCInsureAccClassFeeBakSchema.getGrpContNo();
		this.ManageCom = aLCInsureAccClassFeeBakSchema.getManageCom();
		this.InsuredNo = aLCInsureAccClassFeeBakSchema.getInsuredNo();
		this.AppntNo = aLCInsureAccClassFeeBakSchema.getAppntNo();
		this.AccType = aLCInsureAccClassFeeBakSchema.getAccType();
		this.AccComputeFlag = aLCInsureAccClassFeeBakSchema.getAccComputeFlag();
		this.AccFoundDate = fDate.getDate( aLCInsureAccClassFeeBakSchema.getAccFoundDate());
		this.AccFoundTime = aLCInsureAccClassFeeBakSchema.getAccFoundTime();
		this.BalaDate = fDate.getDate( aLCInsureAccClassFeeBakSchema.getBalaDate());
		this.BalaTime = aLCInsureAccClassFeeBakSchema.getBalaTime();
		this.FeeRate = aLCInsureAccClassFeeBakSchema.getFeeRate();
		this.Fee = aLCInsureAccClassFeeBakSchema.getFee();
		this.FeeUnit = aLCInsureAccClassFeeBakSchema.getFeeUnit();
		this.Operator = aLCInsureAccClassFeeBakSchema.getOperator();
		this.MakeDate = fDate.getDate( aLCInsureAccClassFeeBakSchema.getMakeDate());
		this.MakeTime = aLCInsureAccClassFeeBakSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLCInsureAccClassFeeBakSchema.getModifyDate());
		this.ModifyTime = aLCInsureAccClassFeeBakSchema.getModifyTime();
		this.FeeCode = aLCInsureAccClassFeeBakSchema.getFeeCode();
		this.IsInitFee = aLCInsureAccClassFeeBakSchema.getIsInitFee();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LCInsureAccClassFeeBak表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LCInsureAccClassFeeBakSchema";
	...
	public LCInsureAccClassFeeBakSchema getSchema()
	{
		LCInsureAccClassFeeBakSchema aLCInsureAccClassFeeBakSchema = new LCInsureAccClassFeeBakSchema();
		aLCInsureAccClassFeeBakSchema.setSchema(this);
		return aLCInsureAccClassFeeBakSchema;
	}

	public LCInsureAccClassFeeBakDB getDB()
	{
		LCInsureAccClassFeeBakDB aDBOper = new LCInsureAccClassFeeBakDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLCInsureAccClassFeeBak描述/A>表字段
	...
	**/
	public String encode()
	{
		...
		strReturn.append(StrTool.cTrim(IsInitFee));
		return strReturn.toString();
	}

	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLCInsureAccClassFeeBak>历史记账凭证主表信息</A>表字段
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LCInsureAccClassFeeBakSchema other = (LCInsureAccClassFeeBakSchema)otherObject;
		return
