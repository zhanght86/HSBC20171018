...
import com.sinosoft.lis.db.RIPolRecordBakeBDB;

/*
 * <p>ClassName: RIPolRecordBakeBSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 再保系统模型
 */
public class RIPolRecordBakeBSchema implements Schema, Cloneable
{
	// @Field
	/** 备份序列号 */
	...
	public static final int FIELDNUM = 149;	// 数据库表的字段个数
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		RIPolRecordBakeBSchema cloned = (RIPolRecordBakeBSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 RIPolRecordBakeBSchema 对象给 Schema 赋值
	* @param: aRIPolRecordBakeBSchema RIPolRecordBakeBSchema
	**/
	public void setSchema(RIPolRecordBakeBSchema aRIPolRecordBakeBSchema)
	{
		this.BakeSerialNo = aRIPolRecordBakeBSchema.getBakeSerialNo();
		this.BatchNo = aRIPolRecordBakeBSchema.getBatchNo();
		this.EventNo = aRIPolRecordBakeBSchema.getEventNo();
		this.EventType = aRIPolRecordBakeBSchema.getEventType();
		this.RecordType = aRIPolRecordBakeBSchema.getRecordType();
		this.NodeState = aRIPolRecordBakeBSchema.getNodeState();
		this.DataFlag = aRIPolRecordBakeBSchema.getDataFlag();
		this.UnionKey = aRIPolRecordBakeBSchema.getUnionKey();
		this.GrpContNo = aRIPolRecordBakeBSchema.getGrpContNo();
		this.ProposalGrpContNo = aRIPolRecordBakeBSchema.getProposalGrpContNo();
		this.GrpPolNo = aRIPolRecordBakeBSchema.getGrpPolNo();
		this.GrpProposalNo = aRIPolRecordBakeBSchema.getGrpProposalNo();
		this.ContNo = aRIPolRecordBakeBSchema.getContNo();
		this.PolNo = aRIPolRecordBakeBSchema.getPolNo();
		this.ProposalNo = aRIPolRecordBakeBSchema.getProposalNo();
		this.ContPlanCode = aRIPolRecordBakeBSchema.getContPlanCode();
		this.PlanType = aRIPolRecordBakeBSchema.getPlanType();
		this.RiskPeriod = aRIPolRecordBakeBSchema.getRiskPeriod();
		this.RiskType = aRIPolRecordBakeBSchema.getRiskType();
		this.RiskCode = aRIPolRecordBakeBSchema.getRiskCode();
		this.DutyCode = aRIPolRecordBakeBSchema.getDutyCode();
		this.Years = aRIPolRecordBakeBSchema.getYears();
		this.InsuredYear = aRIPolRecordBakeBSchema.getInsuredYear();
		this.SaleChnl = aRIPolRecordBakeBSchema.getSaleChnl();
		this.CValiDate = fDate.getDate( aRIPolRecordBakeBSchema.getCValiDate());
		this.EndDate = fDate.getDate( aRIPolRecordBakeBSchema.getEndDate());
		this.InsuredNo = aRIPolRecordBakeBSchema.getInsuredNo();
		this.InsuredName = aRIPolRecordBakeBSchema.getInsuredName();
		this.InsuredSex = aRIPolRecordBakeBSchema.getInsuredSex();
		this.InsuredBirthday = fDate.getDate( aRIPolRecordBakeBSchema.getInsuredBirthday());
		this.InsuredAge = aRIPolRecordBakeBSchema.getInsuredAge();
		this.CurrentAge = aRIPolRecordBakeBSchema.getCurrentAge();
		this.IDType = aRIPolRecordBakeBSchema.getIDType();
		this.IDNo = aRIPolRecordBakeBSchema.getIDNo();
		this.OccupationType = aRIPolRecordBakeBSchema.getOccupationType();
		this.HealthTime1 = aRIPolRecordBakeBSchema.getHealthTime1();
		this.HealthTime2 = aRIPolRecordBakeBSchema.getHealthTime2();
		this.OccupationCode = aRIPolRecordBakeBSchema.getOccupationCode();
		this.SuppRiskScore = aRIPolRecordBakeBSchema.getSuppRiskScore();
		this.SmokeFlag = aRIPolRecordBakeBSchema.getSmokeFlag();
		this.AdditionalRate = aRIPolRecordBakeBSchema.getAdditionalRate();
		this.ExtType = aRIPolRecordBakeBSchema.getExtType();
		this.ExtPrem = aRIPolRecordBakeBSchema.getExtPrem();
		this.BegAccountValue = aRIPolRecordBakeBSchema.getBegAccountValue();
		this.EndUnit = aRIPolRecordBakeBSchema.getEndUnit();
		this.EndPrice = aRIPolRecordBakeBSchema.getEndPrice();
		this.EndAccountValue = aRIPolRecordBakeBSchema.getEndAccountValue();
		this.FeeType = aRIPolRecordBakeBSchema.getFeeType();
		this.FeeMoney = aRIPolRecordBakeBSchema.getFeeMoney();
		this.NonCashFlag = aRIPolRecordBakeBSchema.getNonCashFlag();
		this.StandPrem = aRIPolRecordBakeBSchema.getStandPrem();
		this.Prem = aRIPolRecordBakeBSchema.getPrem();
		this.Amnt = aRIPolRecordBakeBSchema.getAmnt();
		this.Mult = aRIPolRecordBakeBSchema.getMult();
		this.Reserve = aRIPolRecordBakeBSchema.getReserve();
		this.APE = aRIPolRecordBakeBSchema.getAPE();
		this.CSV = aRIPolRecordBakeBSchema.getCSV();
		this.Retention = aRIPolRecordBakeBSchema.getRetention();
		this.Suminsured = aRIPolRecordBakeBSchema.getSuminsured();
		this.Faceamount = aRIPolRecordBakeBSchema.getFaceamount();
		this.Currency = aRIPolRecordBakeBSchema.getCurrency();
		this.RiskAmnt = aRIPolRecordBakeBSchema.getRiskAmnt();
		this.PayIntv = aRIPolRecordBakeBSchema.getPayIntv();
		this.PayYears = aRIPolRecordBakeBSchema.getPayYears();
		this.PayEndYearFlag = aRIPolRecordBakeBSchema.getPayEndYearFlag();
		this.PayEndYear = aRIPolRecordBakeBSchema.getPayEndYear();
		this.GetYearFlag = aRIPolRecordBakeBSchema.getGetYearFlag();
		this.GetYear = aRIPolRecordBakeBSchema.getGetYear();
		this.InsuYearFlag = aRIPolRecordBakeBSchema.getInsuYearFlag();
		this.InsuYear = aRIPolRecordBakeBSchema.getInsuYear();
		this.AcciYearFlag = aRIPolRecordBakeBSchema.getAcciYearFlag();
		this.AcciYear = aRIPolRecordBakeBSchema.getAcciYear();
		this.AcciEndDate = fDate.getDate( aRIPolRecordBakeBSchema.getAcciEndDate());
		this.GetStartDate = fDate.getDate( aRIPolRecordBakeBSchema.getGetStartDate());
		this.GetStartType = aRIPolRecordBakeBSchema.getGetStartType();
		this.PeakLine = aRIPolRecordBakeBSchema.getPeakLine();
		this.GetLimit = aRIPolRecordBakeBSchema.getGetLimit();
		this.GetIntv = aRIPolRecordBakeBSchema.getGetIntv();
		this.PayNo = aRIPolRecordBakeBSchema.getPayNo();
		this.PayCount = aRIPolRecordBakeBSchema.getPayCount();
		this.PayMoney = aRIPolRecordBakeBSchema.getPayMoney();
		this.LastPayToDate = fDate.getDate( aRIPolRecordBakeBSchema.getLastPayToDate());
		this.CurPayToDate = fDate.getDate( aRIPolRecordBakeBSchema.getCurPayToDate());
		this.EdorNo = aRIPolRecordBakeBSchema.getEdorNo();
		this.FeeOperationType = aRIPolRecordBakeBSchema.getFeeOperationType();
		this.FeeFinaType = aRIPolRecordBakeBSchema.getFeeFinaType();
		this.ChangeRate = aRIPolRecordBakeBSchema.getChangeRate();
		this.AccCurrency = aRIPolRecordBakeBSchema.getAccCurrency();
		this.AccAmnt = aRIPolRecordBakeBSchema.getAccAmnt();
		this.PreStandPrem = aRIPolRecordBakeBSchema.getPreStandPrem();
		this.PrePrem = aRIPolRecordBakeBSchema.getPrePrem();
		this.PreRiskAmnt = aRIPolRecordBakeBSchema.getPreRiskAmnt();
		this.PreAmnt = aRIPolRecordBakeBSchema.getPreAmnt();
		this.ClmNo = aRIPolRecordBakeBSchema.getClmNo();
		this.ClmFeeOperationType = aRIPolRecordBakeBSchema.getClmFeeOperationType();
		this.ClmFeeFinaType = aRIPolRecordBakeBSchema.getClmFeeFinaType();
		this.StandGetMoney = aRIPolRecordBakeBSchema.getStandGetMoney();
		this.GetRate = aRIPolRecordBakeBSchema.getGetRate();
		this.ClmGetMoney = aRIPolRecordBakeBSchema.getClmGetMoney();
		this.AccDate = fDate.getDate( aRIPolRecordBakeBSchema.getAccDate());
		this.AccumulateDefNO = aRIPolRecordBakeBSchema.getAccumulateDefNO();
		this.RIContNo = aRIPolRecordBakeBSchema.getRIContNo();
		this.RIPreceptNo = aRIPolRecordBakeBSchema.getRIPreceptNo();
		this.ReinsreFlag = aRIPolRecordBakeBSchema.getReinsreFlag();
		this.GetDate = fDate.getDate( aRIPolRecordBakeBSchema.getGetDate());
		this.StandbyString1 = aRIPolRecordBakeBSchema.getStandbyString1();
		this.StandbyString2 = aRIPolRecordBakeBSchema.getStandbyString2();
		this.StandbyString3 = aRIPolRecordBakeBSchema.getStandbyString3();
		this.StandbyDouble1 = aRIPolRecordBakeBSchema.getStandbyDouble1();
		this.StandbyDouble2 = aRIPolRecordBakeBSchema.getStandbyDouble2();
		this.StandbyDouble3 = aRIPolRecordBakeBSchema.getStandbyDouble3();
		this.StandbyDate1 = fDate.getDate( aRIPolRecordBakeBSchema.getStandbyDate1());
		this.StandbyDate2 = fDate.getDate( aRIPolRecordBakeBSchema.getStandbyDate2());
		this.ManageCom = aRIPolRecordBakeBSchema.getManageCom();
		this.MakeDate = fDate.getDate( aRIPolRecordBakeBSchema.getMakeDate());
		this.MakeTime = aRIPolRecordBakeBSchema.getMakeTime();
		this.PreChRiskAmnt = aRIPolRecordBakeBSchema.getPreChRiskAmnt();
		this.ChRiskAmnt = aRIPolRecordBakeBSchema.getChRiskAmnt();
		this.PreChangeRate = aRIPolRecordBakeBSchema.getPreChangeRate();
		this.MainPolNo = aRIPolRecordBakeBSchema.getMainPolNo();
		this.RIPreceptType = aRIPolRecordBakeBSchema.getRIPreceptType();
		this.BFFlag = aRIPolRecordBakeBSchema.getBFFlag();
		this.EdorPrem = aRIPolRecordBakeBSchema.getEdorPrem();
		this.ChEdorPrem = aRIPolRecordBakeBSchema.getChEdorPrem();
		this.ChPrem = aRIPolRecordBakeBSchema.getChPrem();
		this.Bonus1 = aRIPolRecordBakeBSchema.getBonus1();
		this.Bonus2 = aRIPolRecordBakeBSchema.getBonus2();
		this.Bonus3 = aRIPolRecordBakeBSchema.getBonus3();
		this.ExtRate1 = aRIPolRecordBakeBSchema.getExtRate1();
		this.ExtRate2 = aRIPolRecordBakeBSchema.getExtRate2();
		this.ExtRate3 = aRIPolRecordBakeBSchema.getExtRate3();
		this.ExtPrem1 = aRIPolRecordBakeBSchema.getExtPrem1();
		this.ExtPrem2 = aRIPolRecordBakeBSchema.getExtPrem2();
		this.ExtPrem3 = aRIPolRecordBakeBSchema.getExtPrem3();
		this.StandbyString4 = aRIPolRecordBakeBSchema.getStandbyString4();
		this.StandbyString5 = aRIPolRecordBakeBSchema.getStandbyString5();
		this.StandbyString6 = aRIPolRecordBakeBSchema.getStandbyString6();
		this.StandbyString7 = aRIPolRecordBakeBSchema.getStandbyString7();
		this.StandbyString8 = aRIPolRecordBakeBSchema.getStandbyString8();
		this.StandbyString9 = aRIPolRecordBakeBSchema.getStandbyString9();
		this.StandbyDouble4 = aRIPolRecordBakeBSchema.getStandbyDouble4();
		this.StandbyDouble5 = aRIPolRecordBakeBSchema.getStandbyDouble5();
		this.StandbyDouble6 = aRIPolRecordBakeBSchema.getStandbyDouble6();
		this.StandbyDouble7 = aRIPolRecordBakeBSchema.getStandbyDouble7();
		this.StandbyDouble8 = aRIPolRecordBakeBSchema.getStandbyDouble8();
		this.StandbyDouble9 = aRIPolRecordBakeBSchema.getStandbyDouble9();
		this.StandbyDate3 = fDate.getDate( aRIPolRecordBakeBSchema.getStandbyDate3());
		this.StandbyDate4 = fDate.getDate( aRIPolRecordBakeBSchema.getStandbyDate4());
		this.StandbyDate5 = fDate.getDate( aRIPolRecordBakeBSchema.getStandbyDate5());
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			System.out.println("数据库中的RIPolRecordBakeB表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			sqle.printStackTrace();
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "RIPolRecordBakeBSchema";
	...
	public RIPolRecordBakeBSchema getSchema()
	{
		RIPolRecordBakeBSchema aRIPolRecordBakeBSchema = new RIPolRecordBakeBSchema();
		aRIPolRecordBakeBSchema.setSchema(this);
		return aRIPolRecordBakeBSchema;
	}

	public RIPolRecordBakeBDB getDB()
	{
		RIPolRecordBakeBDB aDBOper = new RIPolRecordBakeBDB();
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpRIPolRecordBakeB>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			EventType = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 4, SysConst.PACKAGESPILTER );
			RecordType = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 5, SysConst.PACKAGESPILTER );
			NodeState = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 6, SysConst.PACKAGESPILTER );
			DataFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 7, SysConst.PACKAGESPILTER );
			UnionKey = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 8, SysConst.PACKAGESPILTER );
			GrpContNo = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 9, SysConst.PACKAGESPILTER );
			ProposalGrpContNo = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 10, SysConst.PACKAGESPILTER );
			GrpPolNo = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 11, SysConst.PACKAGESPILTER );
			GrpProposalNo = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 12, SysConst.PACKAGESPILTER );
			...
			ContPlanCode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 16, SysConst.PACKAGESPILTER );
			PlanType = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 17, SysConst.PACKAGESPILTER );
			RiskPeriod = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 18, SysConst.PACKAGESPILTER );
			RiskType = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 19, SysConst.PACKAGESPILTER );
			...
			Years= new Integer(ChgData.chgNumericStr(StrTool.getStr(strMessage,22,SysConst.PACKAGESPILTER))).intValue();
			InsuredYear= new Integer(ChgData.chgNumericStr(StrTool.getStr(strMessage,23,SysConst.PACKAGESPILTER))).intValue();
			...
			EndDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 26,SysConst.PACKAGESPILTER));
			InsuredNo = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 27, SysConst.PACKAGESPILTER );
			InsuredName = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 28, SysConst.PACKAGESPILTER );
			InsuredSex = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 29, SysConst.PACKAGESPILTER );
			InsuredBirthday = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 30,SysConst.PACKAGESPILTER));
			InsuredAge= new Integer(ChgData.chgNumericStr(StrTool.getStr(strMessage,31,SysConst.PACKAGESPILTER))).intValue();
			CurrentAge= new Integer(ChgData.chgNumericStr(StrTool.getStr(strMessage,32,SysConst.PACKAGESPILTER))).intValue();
			...
			HealthTime1 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 36, SysConst.PACKAGESPILTER );
			HealthTime2 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 37, SysConst.PACKAGESPILTER );
			OccupationCode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 38, SysConst.PACKAGESPILTER );
			SuppRiskScore = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 39, SysConst.PACKAGESPILTER );
			SmokeFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 40, SysConst.PACKAGESPILTER );
			AdditionalRate = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,41,SysConst.PACKAGESPILTER))).doubleValue();
			ExtType = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 42, SysConst.PACKAGESPILTER );
			ExtPrem = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,43,SysConst.PACKAGESPILTER))).doubleValue();
			BegAccountValue = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,44,SysConst.PACKAGESPILTER))).doubleValue();
			EndUnit= new Integer(ChgData.chgNumericStr(StrTool.getStr(strMessage,45,SysConst.PACKAGESPILTER))).intValue();
			EndPrice = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,46,SysConst.PACKAGESPILTER))).doubleValue();
			EndAccountValue = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,47,SysConst.PACKAGESPILTER))).doubleValue();
			FeeType = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 48, SysConst.PACKAGESPILTER );
			FeeMoney = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,49,SysConst.PACKAGESPILTER))).doubleValue();
			NonCashFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 50, SysConst.PACKAGESPILTER );
			StandPrem = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,51,SysConst.PACKAGESPILTER))).doubleValue();
			...
			Mult = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,54,SysConst.PACKAGESPILTER))).doubleValue();
			Reserve = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,55,SysConst.PACKAGESPILTER))).doubleValue();
			APE = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,56,SysConst.PACKAGESPILTER))).doubleValue();
			CSV = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,57,SysConst.PACKAGESPILTER))).doubleValue();
			Retention = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,58,SysConst.PACKAGESPILTER))).doubleValue();
			Suminsured = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,59,SysConst.PACKAGESPILTER))).doubleValue();
			Faceamount = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,60,SysConst.PACKAGESPILTER))).doubleValue();
			Currency = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 61, SysConst.PACKAGESPILTER );
			RiskAmnt = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,62,SysConst.PACKAGESPILTER))).doubleValue();
			PayIntv= new Integer(ChgData.chgNumericStr(StrTool.getStr(strMessage,63,SysConst.PACKAGESPILTER))).intValue();
			PayYears= new Integer(ChgData.chgNumericStr(StrTool.getStr(strMessage,64,SysConst.PACKAGESPILTER))).intValue();
			PayEndYearFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 65, SysConst.PACKAGESPILTER );
			PayEndYear= new Integer(ChgData.chgNumericStr(StrTool.getStr(strMessage,66,SysConst.PACKAGESPILTER))).intValue();
			GetYearFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 67, SysConst.PACKAGESPILTER );
			GetYear= new Integer(ChgData.chgNumericStr(StrTool.getStr(strMessage,68,SysConst.PACKAGESPILTER))).intValue();
			InsuYearFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 69, SysConst.PACKAGESPILTER );
			InsuYear= new Integer(ChgData.chgNumericStr(StrTool.getStr(strMessage,70,SysConst.PACKAGESPILTER))).intValue();
			AcciYearFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 71, SysConst.PACKAGESPILTER );
			AcciYear= new Integer(ChgData.chgNumericStr(StrTool.getStr(strMessage,72,SysConst.PACKAGESPILTER))).intValue();
			AcciEndDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 73,SysConst.PACKAGESPILTER));
			GetStartDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 74,SysConst.PACKAGESPILTER));
			GetStartType = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 75, SysConst.PACKAGESPILTER );
			PeakLine = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,76,SysConst.PACKAGESPILTER))).doubleValue();
			GetLimit = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,77,SysConst.PACKAGESPILTER))).doubleValue();
			GetIntv= new Integer(ChgData.chgNumericStr(StrTool.getStr(strMessage,78,SysConst.PACKAGESPILTER))).intValue();
			PayNo = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 79, SysConst.PACKAGESPILTER );
			PayCount= new Integer(ChgData.chgNumericStr(StrTool.getStr(strMessage,80,SysConst.PACKAGESPILTER))).intValue();
			PayMoney = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,81,SysConst.PACKAGESPILTER))).doubleValue();
			LastPayToDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 82,SysConst.PACKAGESPILTER));
			CurPayToDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 83,SysConst.PACKAGESPILTER));
			EdorNo = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 84, SysConst.PACKAGESPILTER );
			FeeOperationType = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 85, SysConst.PACKAGESPILTER );
			FeeFinaType = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 86, SysConst.PACKAGESPILTER );
			ChangeRate = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,87,SysConst.PACKAGESPILTER))).doubleValue();
			AccCurrency = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 88, SysConst.PACKAGESPILTER );
			AccAmnt = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,89,SysConst.PACKAGESPILTER))).doubleValue();
			PreStandPrem = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,90,SysConst.PACKAGESPILTER))).doubleValue();
			PrePrem = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,91,SysConst.PACKAGESPILTER))).doubleValue();
			PreRiskAmnt = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,92,SysConst.PACKAGESPILTER))).doubleValue();
			PreAmnt = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,93,SysConst.PACKAGESPILTER))).doubleValue();
			ClmNo = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 94, SysConst.PACKAGESPILTER );
			ClmFeeOperationType = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 95, SysConst.PACKAGESPILTER );
			ClmFeeFinaType = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 96, SysConst.PACKAGESPILTER );
			StandGetMoney = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,97,SysConst.PACKAGESPILTER))).doubleValue();
			GetRate = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,98,SysConst.PACKAGESPILTER))).doubleValue();
			ClmGetMoney = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,99,SysConst.PACKAGESPILTER))).doubleValue();
			AccDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 100,SysConst.PACKAGESPILTER));
			AccumulateDefNO = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 101, SysConst.PACKAGESPILTER );
			RIContNo = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 102, SysConst.PACKAGESPILTER );
			RIPreceptNo = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 103, SysConst.PACKAGESPILTER );
			ReinsreFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 104, SysConst.PACKAGESPILTER );
			GetDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 105,SysConst.PACKAGESPILTER));
			StandbyString1 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 106, SysConst.PACKAGESPILTER );
			StandbyString2 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 107, SysConst.PACKAGESPILTER );
			StandbyString3 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 108, SysConst.PACKAGESPILTER );
			StandbyDouble1 = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,109,SysConst.PACKAGESPILTER))).doubleValue();
			StandbyDouble2 = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,110,SysConst.PACKAGESPILTER))).doubleValue();
			StandbyDouble3 = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,111,SysConst.PACKAGESPILTER))).doubleValue();
			StandbyDate1 = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 112,SysConst.PACKAGESPILTER));
			StandbyDate2 = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 113,SysConst.PACKAGESPILTER));
			ManageCom = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 114, SysConst.PACKAGESPILTER );
			MakeDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 115,SysConst.PACKAGESPILTER));
			MakeTime = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 116, SysConst.PACKAGESPILTER );
			PreChRiskAmnt = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,117,SysConst.PACKAGESPILTER))).doubleValue();
			ChRiskAmnt = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,118,SysConst.PACKAGESPILTER))).doubleValue();
			PreChangeRate = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,119,SysConst.PACKAGESPILTER))).doubleValue();
			MainPolNo = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 120, SysConst.PACKAGESPILTER );
			RIPreceptType = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 121, SysConst.PACKAGESPILTER );
			BFFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 122, SysConst.PACKAGESPILTER );
			EdorPrem = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,123,SysConst.PACKAGESPILTER))).doubleValue();
			ChEdorPrem = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,124,SysConst.PACKAGESPILTER))).doubleValue();
			ChPrem = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,125,SysConst.PACKAGESPILTER))).doubleValue();
			Bonus1 = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,126,SysConst.PACKAGESPILTER))).doubleValue();
			Bonus2 = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,127,SysConst.PACKAGESPILTER))).doubleValue();
			Bonus3 = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,128,SysConst.PACKAGESPILTER))).doubleValue();
			ExtRate1 = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,129,SysConst.PACKAGESPILTER))).doubleValue();
			ExtRate2 = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,130,SysConst.PACKAGESPILTER))).doubleValue();
			ExtRate3 = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,131,SysConst.PACKAGESPILTER))).doubleValue();
			ExtPrem1 = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,132,SysConst.PACKAGESPILTER))).doubleValue();
			ExtPrem2 = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,133,SysConst.PACKAGESPILTER))).doubleValue();
			ExtPrem3 = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,134,SysConst.PACKAGESPILTER))).doubleValue();
			StandbyString4 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 135, SysConst.PACKAGESPILTER );
			StandbyString5 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 136, SysConst.PACKAGESPILTER );
			StandbyString6 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 137, SysConst.PACKAGESPILTER );
			StandbyString7 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 138, SysConst.PACKAGESPILTER );
			StandbyString8 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 139, SysConst.PACKAGESPILTER );
			StandbyString9 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 140, SysConst.PACKAGESPILTER );
			StandbyDouble4 = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,141,SysConst.PACKAGESPILTER))).doubleValue();
			StandbyDouble5 = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,142,SysConst.PACKAGESPILTER))).doubleValue();
			StandbyDouble6 = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,143,SysConst.PACKAGESPILTER))).doubleValue();
			StandbyDouble7 = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,144,SysConst.PACKAGESPILTER))).doubleValue();
			StandbyDouble8 = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,145,SysConst.PACKAGESPILTER))).doubleValue();
			StandbyDouble9 = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,146,SysConst.PACKAGESPILTER))).doubleValue();
			StandbyDate3 = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 147,SysConst.PACKAGESPILTER));
			StandbyDate4 = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 148,SysConst.PACKAGESPILTER));
			StandbyDate5 = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 149,SysConst.PACKAGESPILTER));
		}
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		RIPolRecordBakeBSchema other = (RIPolRecordBakeBSchema)otherObject;
		return
