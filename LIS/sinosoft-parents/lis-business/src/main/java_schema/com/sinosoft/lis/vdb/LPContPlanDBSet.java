...
/*
 * <p>ClassName: LPContPlanDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 保全核心
 */
public class LPContPlanDBSet extends LPContPlanSet
{
	// @Field
	...
	**/
	...
	// @Constructor
	public LPContPlanDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LPContPlanDBSet";
	...
	public boolean delete()
	{
		...
		try
		{
			...
			if(this.get(i).getPlanType() == null || this.get(i).getPlanType().equals("null")) {
				...
				pstmt.setString(5, StrTool.space1(this.get(i).getPlanType(), 2));
			}
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getContPlanName() == null || this.get(i).getContPlanName().equals("null")) {
				...
				pstmt.setString(6, this.get(i).getContPlanName());
			}
			if(this.get(i).getPlanType() == null || this.get(i).getPlanType().equals("null")) {
			...
			if(this.get(i).getPlanRule() == null || this.get(i).getPlanRule().equals("null")) {
				...
				pstmt.setString(8, this.get(i).getPlanRule());
			}
			if(this.get(i).getPlanSql() == null || this.get(i).getPlanSql().equals("null")) {
				pstmt.setString(9,null);
			} else {
				pstmt.setString(9, this.get(i).getPlanSql());
			}
			...
			pstmt.setInt(16, this.get(i).getPeoples3());
			if(this.get(i).getRemark2() == null || this.get(i).getRemark2().equals("null")) {
				pstmt.setString(17,null);
			} else {
				pstmt.setString(17, this.get(i).getRemark2());
			}
			pstmt.setInt(18, this.get(i).getPeoples2());
			if(this.get(i).getPlanCode() == null || this.get(i).getPlanCode().equals("null")) {
				pstmt.setString(19,null);
			} else {
				pstmt.setString(19, this.get(i).getPlanCode());
			}
			if(this.get(i).getPlanFlag() == null || this.get(i).getPlanFlag().equals("null")) {
				pstmt.setString(20,null);
			} else {
				pstmt.setString(20, this.get(i).getPlanFlag());
			}
			if(this.get(i).getPremCalType() == null || this.get(i).getPremCalType().equals("null")) {
				pstmt.setString(21,null);
			} else {
				pstmt.setString(21, this.get(i).getPremCalType());
			}
			pstmt.setInt(22, this.get(i).getInsuPeriod());
			if(this.get(i).getInsuPeriodFlag() == null || this.get(i).getInsuPeriodFlag().equals("null")) {
				pstmt.setString(23,null);
			} else {
				pstmt.setString(23, this.get(i).getInsuPeriodFlag());
			}
			if(this.get(i).getOccupTypeFlag() == null || this.get(i).getOccupTypeFlag().equals("null")) {
				pstmt.setString(24,null);
			} else {
				pstmt.setString(24, this.get(i).getOccupTypeFlag());
			}
			if(this.get(i).getMinOccupType() == null || this.get(i).getMinOccupType().equals("null")) {
				pstmt.setString(25,null);
			} else {
				pstmt.setString(25, this.get(i).getMinOccupType());
			}
			if(this.get(i).getMaxOccupType() == null || this.get(i).getMaxOccupType().equals("null")) {
				pstmt.setString(26,null);
			} else {
				pstmt.setString(26, this.get(i).getMaxOccupType());
			}
			if(this.get(i).getOccupType() == null || this.get(i).getOccupType().equals("null")) {
				pstmt.setString(27,null);
			} else {
				pstmt.setString(27, this.get(i).getOccupType());
			}
			if(this.get(i).getOccupMidType() == null || this.get(i).getOccupMidType().equals("null")) {
				pstmt.setString(28,null);
			} else {
				pstmt.setString(28, this.get(i).getOccupMidType());
			}
			if(this.get(i).getOccupCode() == null || this.get(i).getOccupCode().equals("null")) {
				pstmt.setString(29,null);
			} else {
				pstmt.setString(29, this.get(i).getOccupCode());
			}
			pstmt.setInt(30, this.get(i).getMinAge());
			pstmt.setInt(31, this.get(i).getMaxAge());
			pstmt.setInt(32, this.get(i).getAvgAge());
			pstmt.setDouble(33, this.get(i).getSocialInsuRate());
			pstmt.setDouble(34, this.get(i).getMaleRate());
			pstmt.setDouble(35, this.get(i).getFemaleRate());
			pstmt.setDouble(36, this.get(i).getRetireRate());
			if(this.get(i).getPremMode() == null || this.get(i).getPremMode().equals("null")) {
				pstmt.setString(37,null);
			} else {
				pstmt.setString(37, this.get(i).getPremMode());
			}
			pstmt.setDouble(38, this.get(i).getEnterpriseRate());
			pstmt.setDouble(39, this.get(i).getMinSalary());
			pstmt.setDouble(40, this.get(i).getMaxSalary());
			pstmt.setDouble(41, this.get(i).getAvgSalary());
			if(this.get(i).getOtherDesc() == null || this.get(i).getOtherDesc().equals("null")) {
				pstmt.setString(42,null);
			} else {
				pstmt.setString(42, this.get(i).getOtherDesc());
			}
			...
			if(this.get(i).getOccupRate() == null || this.get(i).getOccupRate().equals("null")) {
				...
				pstmt.setString(44, this.get(i).getOccupRate());
			}
			if(this.get(i).getCombiCode() == null || this.get(i).getCombiCode().equals("null")) {
				pstmt.setString(45,null);
			} else {
				pstmt.setString(45, this.get(i).getCombiCode());
			}
			if(this.get(i).getCombiRate() == null || this.get(i).getCombiRate().equals("null")) {
				pstmt.setString(46,null);
			} else {
				pstmt.setString(46, this.get(i).getCombiRate());
			}
			pstmt.setInt(47, this.get(i).getCombiMult());
			// set where condition
			if(this.get(i).getEdorNo() == null || this.get(i).getEdorNo().equals("null")) {
			...
			if(this.get(i).getEdorType() == null || this.get(i).getEdorType().equals("null")) {
				...
				pstmt.setString(49, this.get(i).getEdorType());
			}
			if(this.get(i).getGrpContNo() == null || this.get(i).getGrpContNo().equals("null")) {
				pstmt.setString(50,null);
			} else {
				pstmt.setString(50, this.get(i).getGrpContNo());
			}
			if(this.get(i).getContPlanCode() == null || this.get(i).getContPlanCode().equals("null")) {
				pstmt.setString(51,null);
			} else {
				pstmt.setString(51, this.get(i).getContPlanCode());
			}
			if(this.get(i).getPlanType() == null || this.get(i).getPlanType().equals("null")) {
				pstmt.setString(52,null);
			} else {
				pstmt.setString(52, StrTool.space1(this.get(i).getPlanType(), 2));
			}
