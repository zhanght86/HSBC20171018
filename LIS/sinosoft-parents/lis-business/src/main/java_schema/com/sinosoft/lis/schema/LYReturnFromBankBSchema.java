...
/*
 * <p>ClassName: LYReturnFromBankBSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 银行业务
 */
public class LYReturnFromBankBSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LYReturnFromBankBSchema.class);
	...
	// @Constructor
	public LYReturnFromBankBSchema()
	{
		mErrors = new CErrors();
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LYReturnFromBankBSchema cloned = (LYReturnFromBankBSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LYReturnFromBankBSchema 对象给 Schema 赋值
	* @param: aLYReturnFromBankBSchema LYReturnFromBankBSchema
	**/
	public void setSchema(LYReturnFromBankBSchema aLYReturnFromBankBSchema)
	{
		this.SerialNo = aLYReturnFromBankBSchema.getSerialNo();
		this.DealType = aLYReturnFromBankBSchema.getDealType();
		this.DataType = aLYReturnFromBankBSchema.getDataType();
		this.PayCode = aLYReturnFromBankBSchema.getPayCode();
		this.PayType = aLYReturnFromBankBSchema.getPayType();
		this.Name = aLYReturnFromBankBSchema.getName();
		this.BankCode = aLYReturnFromBankBSchema.getBankCode();
		this.AccType = aLYReturnFromBankBSchema.getAccType();
		this.AccName = aLYReturnFromBankBSchema.getAccName();
		this.AccNo = aLYReturnFromBankBSchema.getAccNo();
		this.PolNo = aLYReturnFromBankBSchema.getPolNo();
		this.NoType = aLYReturnFromBankBSchema.getNoType();
		this.ComCode = aLYReturnFromBankBSchema.getComCode();
		this.AgentCode = aLYReturnFromBankBSchema.getAgentCode();
		this.PayMoney = aLYReturnFromBankBSchema.getPayMoney();
		this.SendDate = fDate.getDate( aLYReturnFromBankBSchema.getSendDate());
		this.BankDealDate = fDate.getDate( aLYReturnFromBankBSchema.getBankDealDate());
		this.BankDealTime = fDate.getDate( aLYReturnFromBankBSchema.getBankDealTime());
		this.BankSuccFlag = aLYReturnFromBankBSchema.getBankSuccFlag();
		this.VertifyFlag = aLYReturnFromBankBSchema.getVertifyFlag();
		this.Remark = aLYReturnFromBankBSchema.getRemark();
		this.ConvertFlag = aLYReturnFromBankBSchema.getConvertFlag();
		this.DoType = aLYReturnFromBankBSchema.getDoType();
		this.ModifyDate = fDate.getDate( aLYReturnFromBankBSchema.getModifyDate());
		this.ModifyTime = aLYReturnFromBankBSchema.getModifyTime();
		this.RiskCode = aLYReturnFromBankBSchema.getRiskCode();
		this.SerNo = aLYReturnFromBankBSchema.getSerNo();
		this.BankName = aLYReturnFromBankBSchema.getBankName();
		this.InBankCode = aLYReturnFromBankBSchema.getInBankCode();
		this.InBankName = aLYReturnFromBankBSchema.getInBankName();
		this.InAccType = aLYReturnFromBankBSchema.getInAccType();
		this.InAccName = aLYReturnFromBankBSchema.getInAccName();
		this.InAccNo = aLYReturnFromBankBSchema.getInAccNo();
		this.IDType = aLYReturnFromBankBSchema.getIDType();
		this.IDNo = aLYReturnFromBankBSchema.getIDNo();
		this.StandByFlag1 = aLYReturnFromBankBSchema.getStandByFlag1();
		this.StandByFlag2 = aLYReturnFromBankBSchema.getStandByFlag2();
		this.StandByFlag3 = aLYReturnFromBankBSchema.getStandByFlag3();
		this.StandByFlag4 = aLYReturnFromBankBSchema.getStandByFlag4();
		this.StandByFlag5 = aLYReturnFromBankBSchema.getStandByFlag5();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LYReturnFromBankB表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LYReturnFromBankBSchema";
	...
	public LYReturnFromBankBSchema getSchema()
	{
		LYReturnFromBankBSchema aLYReturnFromBankBSchema = new LYReturnFromBankBSchema();
		aLYReturnFromBankBSchema.setSchema(this);
		return aLYReturnFromBankBSchema;
	}

	public LYReturnFromBankBDB getDB()
	{
		LYReturnFromBankBDB aDBOper = new LYReturnFromBankBDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLYReturnFromBankB描述/A>表字段
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLYReturnFromBankB>历史记账凭证主表信息</A>表字段
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LYReturnFromBankBSchema other = (LYReturnFromBankBSchema)otherObject;
		return
