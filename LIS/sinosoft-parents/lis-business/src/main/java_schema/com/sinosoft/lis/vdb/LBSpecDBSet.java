...
/*
 * <p>ClassName: LBSpecDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 承保流程
 */
public class LBSpecDBSet extends LBSpecSet
{
private static Logger logger = Logger.getLogger(LBSpecDBSet.class);
	...
	**/
	...
	// @Constructor
	public LBSpecDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getProposalNo() == null || this.get(i).getProposalNo().equals("null")) {
				...
				pstmt.setString(18, this.get(i).getProposalNo());
			}
			if(this.get(i).getSerialNo() == null || this.get(i).getSerialNo().equals("null")) {
