...
/*
 * <p>ClassName: LDAssignPlanDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 自动分配
 */
public class LDAssignPlanDBSet extends LDAssignPlanSet
{
private static Logger logger = Logger.getLogger(LDAssignPlanDBSet.class);
	...
	**/
	...
	// @Constructor
	public LDAssignPlanDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LDAssignPlanDBSet";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getTaskStartTime() == null || this.get(i).getTaskStartTime().equals("null")) {
				...
				pstmt.setString(4, this.get(i).getTaskStartTime());
			}
			if(this.get(i).getTaskEndTime() == null || this.get(i).getTaskEndTime().equals("null")) {
				pstmt.setString(5,null);
			} else {
				pstmt.setString(5, this.get(i).getTaskEndTime());
			}
			if(this.get(i).getAssignNo() == null || this.get(i).getAssignNo().equals("null")) {
				pstmt.setString(6,null);
			} else {
				pstmt.setString(6, this.get(i).getAssignNo());
			}
