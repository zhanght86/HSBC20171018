...
{
private static Logger logger = Logger.getLogger(LCAddressDBSet.class);
	...
	**/
	...
	public boolean delete()
	{
		...
		try
		{
			...
			pstmt.setInt(2, this.get(i).getAddressNo());
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getMobileChs() == null || this.get(i).getMobileChs().equals("null")) {
				...
				pstmt.setString(16, this.get(i).getMobileChs());
			}
			...
			pstmt.setInt(33, this.get(i).getAddressNo());
