...
/*
 * <p>ClassName: PD_LMEdorCalSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 产品定义平台_PDM
 */
public class PD_LMEdorCalSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(PD_LMEdorCalSchema.class);
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		PD_LMEdorCalSchema cloned = (PD_LMEdorCalSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 PD_LMEdorCalSchema 对象给 Schema 赋值
	* @param: aPD_LMEdorCalSchema PD_LMEdorCalSchema
	**/
	public void setSchema(PD_LMEdorCalSchema aPD_LMEdorCalSchema)
	{
		this.RiskCode = aPD_LMEdorCalSchema.getRiskCode();
		this.DutyCode = aPD_LMEdorCalSchema.getDutyCode();
		this.EdorType = aPD_LMEdorCalSchema.getEdorType();
		this.CalType = aPD_LMEdorCalSchema.getCalType();
		this.RiskVer = aPD_LMEdorCalSchema.getRiskVer();
		this.CalCode = aPD_LMEdorCalSchema.getCalCode();
		this.CalDescibe = aPD_LMEdorCalSchema.getCalDescibe();
		this.Operator = aPD_LMEdorCalSchema.getOperator();
		this.MakeDate = fDate.getDate( aPD_LMEdorCalSchema.getMakeDate());
		this.MakeTime = aPD_LMEdorCalSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aPD_LMEdorCalSchema.getModifyDate());
		this.ModifyTime = aPD_LMEdorCalSchema.getModifyTime();
		this.Standbyflag1 = aPD_LMEdorCalSchema.getStandbyflag1();
		this.Standbyflag2 = aPD_LMEdorCalSchema.getStandbyflag2();
		this.Standbyflag3 = aPD_LMEdorCalSchema.getStandbyflag3();
		this.Standbyflag4 = aPD_LMEdorCalSchema.getStandbyflag4();
		this.Standbyflag5 = aPD_LMEdorCalSchema.getStandbyflag5();
		this.Standbyflag6 = aPD_LMEdorCalSchema.getStandbyflag6();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的PD_LMEdorCal表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "PD_LMEdorCalSchema";
	...
	public PD_LMEdorCalSchema getSchema()
	{
		PD_LMEdorCalSchema aPD_LMEdorCalSchema = new PD_LMEdorCalSchema();
		aPD_LMEdorCalSchema.setSchema(this);
		return aPD_LMEdorCalSchema;
	}

	public PD_LMEdorCalDB getDB()
	{
		PD_LMEdorCalDB aDBOper = new PD_LMEdorCalDB();
	...
	**/
	public String encode()
	{
		...
		strReturn.append(StrTool.cTrim(CalDescibe)); strReturn.append(SysConst.PACKAGESPILTER);
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpPD_LMEdorCal>历史记账凭证主表信息</A>表字段
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		PD_LMEdorCalSchema other = (PD_LMEdorCalSchema)otherObject;
		return
