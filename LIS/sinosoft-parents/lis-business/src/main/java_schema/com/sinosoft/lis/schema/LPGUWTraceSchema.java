...
import com.sinosoft.lis.db.LPGUWTraceDB;

/*
 * <p>ClassName: LPGUWTraceSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: Physical Data Model 1
 */
public class LPGUWTraceSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LPGUWTraceSchema.class);
	// @Field
	/** 保全批单号 */
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LPGUWTraceSchema cloned = (LPGUWTraceSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LPGUWTraceSchema 对象给 Schema 赋值
	* @param: aLPGUWTraceSchema LPGUWTraceSchema
	**/
	public void setSchema(LPGUWTraceSchema aLPGUWTraceSchema)
	{
		this.EdorNo = aLPGUWTraceSchema.getEdorNo();
		this.EdorType = aLPGUWTraceSchema.getEdorType();
		this.GrpContNo = aLPGUWTraceSchema.getGrpContNo();
		this.RiskCode = aLPGUWTraceSchema.getRiskCode();
		this.RuleLevel = aLPGUWTraceSchema.getRuleLevel();
		this.UWNo = aLPGUWTraceSchema.getUWNo();
		this.RuleCode = aLPGUWTraceSchema.getRuleCode();
		this.PostponeDay = aLPGUWTraceSchema.getPostponeDay();
		this.PostponeDate = fDate.getDate( aLPGUWTraceSchema.getPostponeDate());
		this.AutoUWConclu = aLPGUWTraceSchema.getAutoUWConclu();
		this.AutoUWDate = fDate.getDate( aLPGUWTraceSchema.getAutoUWDate());
		this.UWError = aLPGUWTraceSchema.getUWError();
		this.UWConclu = aLPGUWTraceSchema.getUWConclu();
		this.UWIdea = aLPGUWTraceSchema.getUWIdea();
		this.UWDate = fDate.getDate( aLPGUWTraceSchema.getUWDate());
		this.UpReport = aLPGUWTraceSchema.getUpReport();
		this.UpReportContent = aLPGUWTraceSchema.getUpReportContent();
		this.HealthFlag = aLPGUWTraceSchema.getHealthFlag();
		this.QuesFlag = aLPGUWTraceSchema.getQuesFlag();
		this.SpecFlag = aLPGUWTraceSchema.getSpecFlag();
		this.AddPremFlag = aLPGUWTraceSchema.getAddPremFlag();
		this.AddPremReason = aLPGUWTraceSchema.getAddPremReason();
		this.ReportFlag = aLPGUWTraceSchema.getReportFlag();
		this.PrintFlag = aLPGUWTraceSchema.getPrintFlag();
		this.ManageCom = aLPGUWTraceSchema.getManageCom();
		this.ComCode = aLPGUWTraceSchema.getComCode();
		this.MakeOperator = aLPGUWTraceSchema.getMakeOperator();
		this.MakeDate = fDate.getDate( aLPGUWTraceSchema.getMakeDate());
		this.MakeTime = aLPGUWTraceSchema.getMakeTime();
		this.ModifyOperator = aLPGUWTraceSchema.getModifyOperator();
		this.ModifyDate = fDate.getDate( aLPGUWTraceSchema.getModifyDate());
		this.ModifyTime = aLPGUWTraceSchema.getModifyTime();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LPGUWTrace表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LPGUWTraceSchema";
	...
	public LPGUWTraceSchema getSchema()
	{
		LPGUWTraceSchema aLPGUWTraceSchema = new LPGUWTraceSchema();
		aLPGUWTraceSchema.setSchema(this);
		return aLPGUWTraceSchema;
	}

	public LPGUWTraceDB getDB()
	{
		LPGUWTraceDB aDBOper = new LPGUWTraceDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLPGUWTrace描述/A>表字段
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLPGUWTrace>历史记账凭证主表信息</A>表字段
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LPGUWTraceSchema other = (LPGUWTraceSchema)otherObject;
		return
