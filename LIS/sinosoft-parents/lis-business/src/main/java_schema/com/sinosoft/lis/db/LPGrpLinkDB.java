...
/*
 * <p>ClassName: LPGrpLinkDB </p>
 * <p>Description: DB层数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: Physical Data Model 1
 */
public class LPGrpLinkDB extends LPGrpLinkSchema
{
	// @Field
	...
	**/
	...
	// @Constructor
	public LPGrpLinkDB( Connection tConnection )
	{
		con = tConnection;
	...
	{
		LPGrpLinkSchema tSchema = this.getSchema();
	...
	public boolean getInfo()
	{
		...
		try
		{
			pstmt = con.prepareStatement("SELECT * FROM LPGrpLink WHERE  EdorNo = ? AND EdorType = ? AND GrpContNo = ? AND ContactNo = ? AND CustomerNo = ?", 
	...
	public LPGrpLinkSet query()
	{
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		LPGrpLinkSet aLPGrpLinkSet = new LPGrpLinkSet();
	  ...
	  if( !mflag ) {
		...
		{
			SQLString sqlObj = new SQLString("LPGrpLink");
			LPGrpLinkSchema aSchema = this.getSchema();
			...
			{
				i++;
				LPGrpLinkSchema s1 = new LPGrpLinkSchema();
				s1.setSchema(rs,i);
				aLPGrpLinkSet.add(s1);
			}
			try{ rs.close(); } catch( Exception ex ) {}
			try{ pstmt.close(); } catch( Exception ex1 ) {}
		}
		...
		return aLPGrpLinkSet;
	}

	public LPGrpLinkSet executeQuery(String sql)
	{
		Statement stmt = null;
		ResultSet rs = null;
		LPGrpLinkSet aLPGrpLinkSet = new LPGrpLinkSet();
	...
	public LPGrpLinkSet query(int nStart, int nCount)
	{
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		LPGrpLinkSet aLPGrpLinkSet = new LPGrpLinkSet();
	...
	public LPGrpLinkSet executeQuery(String sql, int nStart, int nCount)
	{
		Statement stmt = null;
		ResultSet rs = null;
		LPGrpLinkSet aLPGrpLinkSet = new LPGrpLinkSet();
	...
	public boolean update(String strWherePart)
	{
	  ...
	  if( !mflag ) {
		...
		try
		{
			...
			String sql = "update LPGrpLink " + sqlObj.getUpdPart() + " where " + strWherePart;
 ...
 * @return LPGrpLinkSet
 */
public LPGrpLinkSet getData()
{
    int tCount = 0;
    LPGrpLinkSet tLPGrpLinkSet = new LPGrpLinkSet();
    LPGrpLinkSchema tLPGrpLinkSchema = null;
    if (null == mResultSet)
    {
        CError tError = new CError();
        tError.moduleName = "LPGrpLinkDB";
    ...
    {
        tCount = 1;
        tLPGrpLinkSchema = new LPGrpLinkSchema();
        tLPGrpLinkSchema.setSchema(mResultSet, 1);
        tLPGrpLinkSet.add(tLPGrpLinkSchema);
...
public boolean closeData()
{
	...
	public LPGrpLinkSet executeQuery(SQLwithBindVariables sqlbv) {
	...
	public LPGrpLinkSet executeQuery(SQLwithBindVariables sqlbv, int nStart, int nCount) {
