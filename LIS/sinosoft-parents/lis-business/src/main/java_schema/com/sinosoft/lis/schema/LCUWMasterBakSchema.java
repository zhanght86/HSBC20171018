...
import com.sinosoft.lis.db.LCUWMasterBakDB;

/*
 * <p>ClassName: LCUWMasterBakSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: PhysicalDataModel_1
 */
public class LCUWMasterBakSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LCUWMasterBakSchema.class);
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LCUWMasterBakSchema cloned = (LCUWMasterBakSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LCUWMasterBakSchema 对象给 Schema 赋值
	* @param: aLCUWMasterBakSchema LCUWMasterBakSchema
	**/
	public void setSchema(LCUWMasterBakSchema aLCUWMasterBakSchema)
	{
		this.GrpContNo = aLCUWMasterBakSchema.getGrpContNo();
		this.ContNo = aLCUWMasterBakSchema.getContNo();
		this.ProposalContNo = aLCUWMasterBakSchema.getProposalContNo();
		this.PolNo = aLCUWMasterBakSchema.getPolNo();
		this.ProposalNo = aLCUWMasterBakSchema.getProposalNo();
		this.UWNo = aLCUWMasterBakSchema.getUWNo();
		this.InsuredNo = aLCUWMasterBakSchema.getInsuredNo();
		this.InsuredName = aLCUWMasterBakSchema.getInsuredName();
		this.AppntNo = aLCUWMasterBakSchema.getAppntNo();
		this.AppntName = aLCUWMasterBakSchema.getAppntName();
		this.AgentCode = aLCUWMasterBakSchema.getAgentCode();
		this.AgentGroup = aLCUWMasterBakSchema.getAgentGroup();
		this.PassFlag = aLCUWMasterBakSchema.getPassFlag();
		this.UWGrade = aLCUWMasterBakSchema.getUWGrade();
		this.AppGrade = aLCUWMasterBakSchema.getAppGrade();
		this.PostponeDay = aLCUWMasterBakSchema.getPostponeDay();
		this.PostponeDate = fDate.getDate( aLCUWMasterBakSchema.getPostponeDate());
		this.AutoUWFlag = aLCUWMasterBakSchema.getAutoUWFlag();
		this.State = aLCUWMasterBakSchema.getState();
		this.ManageCom = aLCUWMasterBakSchema.getManageCom();
		this.UWIdea = aLCUWMasterBakSchema.getUWIdea();
		this.UpReportContent = aLCUWMasterBakSchema.getUpReportContent();
		this.Operator = aLCUWMasterBakSchema.getOperator();
		this.HealthFlag = aLCUWMasterBakSchema.getHealthFlag();
		this.QuesFlag = aLCUWMasterBakSchema.getQuesFlag();
		this.SpecFlag = aLCUWMasterBakSchema.getSpecFlag();
		this.AddPremFlag = aLCUWMasterBakSchema.getAddPremFlag();
		this.AddPremReason = aLCUWMasterBakSchema.getAddPremReason();
		this.ReportFlag = aLCUWMasterBakSchema.getReportFlag();
		this.PrintFlag = aLCUWMasterBakSchema.getPrintFlag();
		this.PrintFlag2 = aLCUWMasterBakSchema.getPrintFlag2();
		this.ChangePolFlag = aLCUWMasterBakSchema.getChangePolFlag();
		this.ChangePolReason = aLCUWMasterBakSchema.getChangePolReason();
		this.SpecReason = aLCUWMasterBakSchema.getSpecReason();
		this.MakeDate = fDate.getDate( aLCUWMasterBakSchema.getMakeDate());
		this.MakeTime = aLCUWMasterBakSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLCUWMasterBakSchema.getModifyDate());
		this.ModifyTime = aLCUWMasterBakSchema.getModifyTime();
		this.SugPassFlag = aLCUWMasterBakSchema.getSugPassFlag();
		this.SugUWIdea = aLCUWMasterBakSchema.getSugUWIdea();
		this.UpReport = aLCUWMasterBakSchema.getUpReport();
		this.BatchNo = aLCUWMasterBakSchema.getBatchNo();
		this.UWType = aLCUWMasterBakSchema.getUWType();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LCUWMasterBak表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LCUWMasterBakSchema";
	...
	public LCUWMasterBakSchema getSchema()
	{
		LCUWMasterBakSchema aLCUWMasterBakSchema = new LCUWMasterBakSchema();
		aLCUWMasterBakSchema.setSchema(this);
		return aLCUWMasterBakSchema;
	}

	public LCUWMasterBakDB getDB()
	{
		LCUWMasterBakDB aDBOper = new LCUWMasterBakDB();
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLCUWMasterBak>历史记账凭证主表信息</A>表字段
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LCUWMasterBakSchema other = (LCUWMasterBakSchema)otherObject;
		return
