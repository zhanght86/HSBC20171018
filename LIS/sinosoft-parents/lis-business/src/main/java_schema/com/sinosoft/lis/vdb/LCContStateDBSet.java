...
/*
 * <p>ClassName: LCContStateDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 承保核心
 */
public class LCContStateDBSet extends LCContStateSet
{
private static Logger logger = Logger.getLogger(LCContStateDBSet.class);
	...
	**/
	...
	// @Constructor
	public LCContStateDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LCContStateDBSet";
