...
/*
 * <p>ClassName: RnewRReportItemDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 续期续保二核
 */
public class RnewRReportItemDBSet extends RnewRReportItemSet
{
private static Logger logger = Logger.getLogger(RnewRReportItemDBSet.class);
	...
	**/
	...
	// @Constructor
	public RnewRReportItemDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "RnewRReportItemDBSet";
