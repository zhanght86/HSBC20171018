...
import com.sinosoft.lis.db.LCContPlanPerInvestDB;

/*
 * <p>ClassName: LCContPlanPerInvestSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 新单管理
 */
public class LCContPlanPerInvestSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LCContPlanPerInvestSchema.class);
	// @Field
	/** 保单号 */
	...
	// @Constructor
	public LCContPlanPerInvestSchema()
	{
		mErrors = new CErrors();
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LCContPlanPerInvestSchema cloned = (LCContPlanPerInvestSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LCContPlanPerInvestSchema 对象给 Schema 赋值
	* @param: aLCContPlanPerInvestSchema LCContPlanPerInvestSchema
	**/
	public void setSchema(LCContPlanPerInvestSchema aLCContPlanPerInvestSchema)
	{
		this.PolicyNo = aLCContPlanPerInvestSchema.getPolicyNo();
		this.SysPlanCode = aLCContPlanPerInvestSchema.getSysPlanCode();
		this.PlanCode = aLCContPlanPerInvestSchema.getPlanCode();
		this.RiskCode = aLCContPlanPerInvestSchema.getRiskCode();
		this.DutyCode = aLCContPlanPerInvestSchema.getDutyCode();
		this.PayPlanCode = aLCContPlanPerInvestSchema.getPayPlanCode();
		this.InsuAccNo = aLCContPlanPerInvestSchema.getInsuAccNo();
		this.InvestMinRate = aLCContPlanPerInvestSchema.getInvestMinRate();
		this.InvestMaxRate = aLCContPlanPerInvestSchema.getInvestMaxRate();
		this.InvestRate = aLCContPlanPerInvestSchema.getInvestRate();
		this.InvestMoney = aLCContPlanPerInvestSchema.getInvestMoney();
		this.RealInvestMoney = aLCContPlanPerInvestSchema.getRealInvestMoney();
		this.Other1 = aLCContPlanPerInvestSchema.getOther1();
		this.Other2 = aLCContPlanPerInvestSchema.getOther2();
		this.Other3 = aLCContPlanPerInvestSchema.getOther3();
		this.MakeOperator = aLCContPlanPerInvestSchema.getMakeOperator();
		this.MakeDate = fDate.getDate( aLCContPlanPerInvestSchema.getMakeDate());
		this.MakeTime = aLCContPlanPerInvestSchema.getMakeTime();
		this.ModifyOperator = aLCContPlanPerInvestSchema.getModifyOperator();
		this.ModifyDate = fDate.getDate( aLCContPlanPerInvestSchema.getModifyDate());
		this.ModifyTime = aLCContPlanPerInvestSchema.getModifyTime();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LCContPlanPerInvest表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LCContPlanPerInvestSchema";
	...
	public LCContPlanPerInvestSchema getSchema()
	{
		LCContPlanPerInvestSchema aLCContPlanPerInvestSchema = new LCContPlanPerInvestSchema();
		aLCContPlanPerInvestSchema.setSchema(this);
		return aLCContPlanPerInvestSchema;
	}

	public LCContPlanPerInvestDB getDB()
	{
		LCContPlanPerInvestDB aDBOper = new LCContPlanPerInvestDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLCContPlanPerInvest描述/A>表字段
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLCContPlanPerInvest>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			InvestMinRate = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,8,SysConst.PACKAGESPILTER))).doubleValue();
			InvestMaxRate = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,9,SysConst.PACKAGESPILTER))).doubleValue();
			InvestRate = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,10,SysConst.PACKAGESPILTER))).doubleValue();
			InvestMoney = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,11,SysConst.PACKAGESPILTER))).doubleValue();
			RealInvestMoney = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,12,SysConst.PACKAGESPILTER))).doubleValue();
			Other1 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 13, SysConst.PACKAGESPILTER );
			Other2 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 14, SysConst.PACKAGESPILTER );
			Other3 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 15, SysConst.PACKAGESPILTER );
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LCContPlanPerInvestSchema other = (LCContPlanPerInvestSchema)otherObject;
		return
