...
/*
 * <p>ClassName: LJSGetOtherSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: PhysicalDataModel_5
 */
public class LJSGetOtherSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LJSGetOtherSchema.class);
	// @Field
	/** 给付通知书号码 */
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LJSGetOtherSchema cloned = (LJSGetOtherSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LJSGetOtherSchema 对象给 Schema 赋值
	* @param: aLJSGetOtherSchema LJSGetOtherSchema
	**/
	public void setSchema(LJSGetOtherSchema aLJSGetOtherSchema)
	{
		this.GetNoticeNo = aLJSGetOtherSchema.getGetNoticeNo();
		this.OtherNo = aLJSGetOtherSchema.getOtherNo();
		this.OtherNoType = aLJSGetOtherSchema.getOtherNoType();
		this.PayMode = aLJSGetOtherSchema.getPayMode();
		this.GetMoney = aLJSGetOtherSchema.getGetMoney();
		this.GetDate = fDate.getDate( aLJSGetOtherSchema.getGetDate());
		this.ManageCom = aLJSGetOtherSchema.getManageCom();
		this.AgentCom = aLJSGetOtherSchema.getAgentCom();
		this.AgentType = aLJSGetOtherSchema.getAgentType();
		this.APPntName = aLJSGetOtherSchema.getAPPntName();
		this.AgentGroup = aLJSGetOtherSchema.getAgentGroup();
		this.AgentCode = aLJSGetOtherSchema.getAgentCode();
		this.FeeOperationType = aLJSGetOtherSchema.getFeeOperationType();
		this.FeeFinaType = aLJSGetOtherSchema.getFeeFinaType();
		this.SerialNo = aLJSGetOtherSchema.getSerialNo();
		this.Operator = aLJSGetOtherSchema.getOperator();
		this.MakeTime = aLJSGetOtherSchema.getMakeTime();
		this.MakeDate = fDate.getDate( aLJSGetOtherSchema.getMakeDate());
		this.State = aLJSGetOtherSchema.getState();
		this.ModifyDate = fDate.getDate( aLJSGetOtherSchema.getModifyDate());
		this.ModifyTime = aLJSGetOtherSchema.getModifyTime();
		this.Currency = aLJSGetOtherSchema.getCurrency();
		this.NetAmount = aLJSGetOtherSchema.getNetAmount();
		this.TaxAmount = aLJSGetOtherSchema.getTaxAmount();
		this.Tax = aLJSGetOtherSchema.getTax();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LJSGetOther表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LJSGetOtherSchema";
	...
	public LJSGetOtherSchema getSchema()
	{
		LJSGetOtherSchema aLJSGetOtherSchema = new LJSGetOtherSchema();
		aLJSGetOtherSchema.setSchema(this);
		return aLJSGetOtherSchema;
	}

	public LJSGetOtherDB getDB()
	{
		LJSGetOtherDB aDBOper = new LJSGetOtherDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLJSGetOther描述/A>表字段
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLJSGetOther>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			FeeOperationType = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 13, SysConst.PACKAGESPILTER );
			FeeFinaType = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 14, SysConst.PACKAGESPILTER );
			SerialNo = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 15, SysConst.PACKAGESPILTER );
			...
			NetAmount = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,23,SysConst.PACKAGESPILTER))).doubleValue();
			TaxAmount = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,24,SysConst.PACKAGESPILTER))).doubleValue();
			Tax = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,25,SysConst.PACKAGESPILTER))).doubleValue();
		}
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LJSGetOtherSchema other = (LJSGetOtherSchema)otherObject;
		return
