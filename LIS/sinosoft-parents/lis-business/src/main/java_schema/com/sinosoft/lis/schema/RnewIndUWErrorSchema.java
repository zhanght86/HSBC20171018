...
/*
 * <p>ClassName: RnewIndUWErrorSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 续期续保二核
 */
public class RnewIndUWErrorSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(RnewIndUWErrorSchema.class);
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		RnewIndUWErrorSchema cloned = (RnewIndUWErrorSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 RnewIndUWErrorSchema 对象给 Schema 赋值
	* @param: aRnewIndUWErrorSchema RnewIndUWErrorSchema
	**/
	public void setSchema(RnewIndUWErrorSchema aRnewIndUWErrorSchema)
	{
		this.GrpContNo = aRnewIndUWErrorSchema.getGrpContNo();
		this.ContNo = aRnewIndUWErrorSchema.getContNo();
		this.ProposalContNo = aRnewIndUWErrorSchema.getProposalContNo();
		this.UWNo = aRnewIndUWErrorSchema.getUWNo();
		this.SerialNo = aRnewIndUWErrorSchema.getSerialNo();
		this.InsuredNo = aRnewIndUWErrorSchema.getInsuredNo();
		this.InsuredName = aRnewIndUWErrorSchema.getInsuredName();
		this.AppntNo = aRnewIndUWErrorSchema.getAppntNo();
		this.AppntName = aRnewIndUWErrorSchema.getAppntName();
		this.ManageCom = aRnewIndUWErrorSchema.getManageCom();
		this.UWRuleCode = aRnewIndUWErrorSchema.getUWRuleCode();
		this.UWError = aRnewIndUWErrorSchema.getUWError();
		this.CurrValue = aRnewIndUWErrorSchema.getCurrValue();
		this.ModifyDate = fDate.getDate( aRnewIndUWErrorSchema.getModifyDate());
		this.ModifyTime = aRnewIndUWErrorSchema.getModifyTime();
		this.UWPassFlag = aRnewIndUWErrorSchema.getUWPassFlag();
		this.UWGrade = aRnewIndUWErrorSchema.getUWGrade();
		this.SugPassFlag = aRnewIndUWErrorSchema.getSugPassFlag();
		this.UWType = aRnewIndUWErrorSchema.getUWType();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的RnewIndUWError表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "RnewIndUWErrorSchema";
	...
	public RnewIndUWErrorSchema getSchema()
	{
		RnewIndUWErrorSchema aRnewIndUWErrorSchema = new RnewIndUWErrorSchema();
		aRnewIndUWErrorSchema.setSchema(this);
		return aRnewIndUWErrorSchema;
	}

	public RnewIndUWErrorDB getDB()
	{
		RnewIndUWErrorDB aDBOper = new RnewIndUWErrorDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpRnewIndUWError描述/A>表字段
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpRnewIndUWError>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			UWType = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 19, SysConst.PACKAGESPILTER );
		}
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		RnewIndUWErrorSchema other = (RnewIndUWErrorSchema)otherObject;
		return
