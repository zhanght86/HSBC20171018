...
import com.sinosoft.lis.db.LPUWSubMainDB;

/*
 * <p>ClassName: LPUWSubMainSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 保全流程
 */
public class LPUWSubMainSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LPUWSubMainSchema.class);
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LPUWSubMainSchema cloned = (LPUWSubMainSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LPUWSubMainSchema 对象给 Schema 赋值
	* @param: aLPUWSubMainSchema LPUWSubMainSchema
	**/
	public void setSchema(LPUWSubMainSchema aLPUWSubMainSchema)
	{
		this.EdorNo = aLPUWSubMainSchema.getEdorNo();
		this.GrpContNo = aLPUWSubMainSchema.getGrpContNo();
		this.ContNo = aLPUWSubMainSchema.getContNo();
		this.ProposalContNo = aLPUWSubMainSchema.getProposalContNo();
		this.UWNo = aLPUWSubMainSchema.getUWNo();
		this.InsuredNo = aLPUWSubMainSchema.getInsuredNo();
		this.InsuredName = aLPUWSubMainSchema.getInsuredName();
		this.AppntNo = aLPUWSubMainSchema.getAppntNo();
		this.AppntName = aLPUWSubMainSchema.getAppntName();
		this.AgentCode = aLPUWSubMainSchema.getAgentCode();
		this.AgentGroup = aLPUWSubMainSchema.getAgentGroup();
		this.PassFlag = aLPUWSubMainSchema.getPassFlag();
		this.UWGrade = aLPUWSubMainSchema.getUWGrade();
		this.AppGrade = aLPUWSubMainSchema.getAppGrade();
		this.PostponeDay = aLPUWSubMainSchema.getPostponeDay();
		this.PostponeDate = fDate.getDate( aLPUWSubMainSchema.getPostponeDate());
		this.AutoUWFlag = aLPUWSubMainSchema.getAutoUWFlag();
		this.State = aLPUWSubMainSchema.getState();
		this.ManageCom = aLPUWSubMainSchema.getManageCom();
		this.UWIdea = aLPUWSubMainSchema.getUWIdea();
		this.UpReportContent = aLPUWSubMainSchema.getUpReportContent();
		this.Operator = aLPUWSubMainSchema.getOperator();
		this.HealthFlag = aLPUWSubMainSchema.getHealthFlag();
		this.QuesFlag = aLPUWSubMainSchema.getQuesFlag();
		this.SpecFlag = aLPUWSubMainSchema.getSpecFlag();
		this.AddPremFlag = aLPUWSubMainSchema.getAddPremFlag();
		this.AddPremReason = aLPUWSubMainSchema.getAddPremReason();
		this.ReportFlag = aLPUWSubMainSchema.getReportFlag();
		this.PrintFlag = aLPUWSubMainSchema.getPrintFlag();
		this.PrintFlag2 = aLPUWSubMainSchema.getPrintFlag2();
		this.ChangePolFlag = aLPUWSubMainSchema.getChangePolFlag();
		this.ChangePolReason = aLPUWSubMainSchema.getChangePolReason();
		this.SpecReason = aLPUWSubMainSchema.getSpecReason();
		this.MakeDate = fDate.getDate( aLPUWSubMainSchema.getMakeDate());
		this.MakeTime = aLPUWSubMainSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLPUWSubMainSchema.getModifyDate());
		this.ModifyTime = aLPUWSubMainSchema.getModifyTime();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LPUWSubMain表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LPUWSubMainSchema";
	...
	public LPUWSubMainSchema getSchema()
	{
		LPUWSubMainSchema aLPUWSubMainSchema = new LPUWSubMainSchema();
		aLPUWSubMainSchema.setSchema(this);
		return aLPUWSubMainSchema;
	}

	public LPUWSubMainDB getDB()
	{
		LPUWSubMainDB aDBOper = new LPUWSubMainDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLPUWSubMain描述/A>表字段
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLPUWSubMain>历史记账凭证主表信息</A>表字段
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LPUWSubMainSchema other = (LPUWSubMainSchema)otherObject;
		return
