...
{
private static Logger logger = Logger.getLogger(LDTaskParamDB.class);
	...
	**/
	...
	public LDTaskParamSet executeQuery(String sql)
	{
		Statement stmt = null;
		ResultSet rs = null;
		LDTaskParamSet aLDTaskParamSet = new LDTaskParamSet();
	...
	public LDTaskParamSet executeQuery(String sql, int nStart, int nCount)
	{
		Statement stmt = null;
		ResultSet rs = null;
		LDTaskParamSet aLDTaskParamSet = new LDTaskParamSet();
...
public boolean closeData()
{
	...
	public LDTaskParamSet executeQuery(SQLwithBindVariables sqlbv) {
	...
	public LDTaskParamSet executeQuery(SQLwithBindVariables sqlbv, int nStart, int nCount) {
