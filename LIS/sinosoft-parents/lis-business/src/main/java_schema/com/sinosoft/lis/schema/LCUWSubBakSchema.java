...
import com.sinosoft.lis.db.LCUWSubBakDB;

/*
 * <p>ClassName: LCUWSubBakSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: PhysicalDataModel_1
 */
public class LCUWSubBakSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LCUWSubBakSchema.class);
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LCUWSubBakSchema cloned = (LCUWSubBakSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LCUWSubBakSchema 对象给 Schema 赋值
	* @param: aLCUWSubBakSchema LCUWSubBakSchema
	**/
	public void setSchema(LCUWSubBakSchema aLCUWSubBakSchema)
	{
		this.GrpContNo = aLCUWSubBakSchema.getGrpContNo();
		this.ContNo = aLCUWSubBakSchema.getContNo();
		this.ProposalContNo = aLCUWSubBakSchema.getProposalContNo();
		this.PolNo = aLCUWSubBakSchema.getPolNo();
		this.ProposalNo = aLCUWSubBakSchema.getProposalNo();
		this.UWNo = aLCUWSubBakSchema.getUWNo();
		this.InsuredNo = aLCUWSubBakSchema.getInsuredNo();
		this.InsuredName = aLCUWSubBakSchema.getInsuredName();
		this.AppntNo = aLCUWSubBakSchema.getAppntNo();
		this.AppntName = aLCUWSubBakSchema.getAppntName();
		this.AgentCode = aLCUWSubBakSchema.getAgentCode();
		this.AgentGroup = aLCUWSubBakSchema.getAgentGroup();
		this.PassFlag = aLCUWSubBakSchema.getPassFlag();
		this.UWGrade = aLCUWSubBakSchema.getUWGrade();
		this.AppGrade = aLCUWSubBakSchema.getAppGrade();
		this.PostponeDay = aLCUWSubBakSchema.getPostponeDay();
		this.PostponeDate = fDate.getDate( aLCUWSubBakSchema.getPostponeDate());
		this.AutoUWFlag = aLCUWSubBakSchema.getAutoUWFlag();
		this.State = aLCUWSubBakSchema.getState();
		this.ManageCom = aLCUWSubBakSchema.getManageCom();
		this.UWIdea = aLCUWSubBakSchema.getUWIdea();
		this.UpReportContent = aLCUWSubBakSchema.getUpReportContent();
		this.Operator = aLCUWSubBakSchema.getOperator();
		this.HealthFlag = aLCUWSubBakSchema.getHealthFlag();
		this.QuesFlag = aLCUWSubBakSchema.getQuesFlag();
		this.SpecFlag = aLCUWSubBakSchema.getSpecFlag();
		this.AddPremFlag = aLCUWSubBakSchema.getAddPremFlag();
		this.AddPremReason = aLCUWSubBakSchema.getAddPremReason();
		this.ReportFlag = aLCUWSubBakSchema.getReportFlag();
		this.PrintFlag = aLCUWSubBakSchema.getPrintFlag();
		this.PrintFlag2 = aLCUWSubBakSchema.getPrintFlag2();
		this.ChangePolFlag = aLCUWSubBakSchema.getChangePolFlag();
		this.ChangePolReason = aLCUWSubBakSchema.getChangePolReason();
		this.SpecReason = aLCUWSubBakSchema.getSpecReason();
		this.MakeDate = fDate.getDate( aLCUWSubBakSchema.getMakeDate());
		this.MakeTime = aLCUWSubBakSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLCUWSubBakSchema.getModifyDate());
		this.ModifyTime = aLCUWSubBakSchema.getModifyTime();
		this.SugPassFlag = aLCUWSubBakSchema.getSugPassFlag();
		this.SugUWIdea = aLCUWSubBakSchema.getSugUWIdea();
		this.UpReport = aLCUWSubBakSchema.getUpReport();
		this.UWType = aLCUWSubBakSchema.getUWType();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LCUWSubBak表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LCUWSubBakSchema";
	...
	public LCUWSubBakSchema getSchema()
	{
		LCUWSubBakSchema aLCUWSubBakSchema = new LCUWSubBakSchema();
		aLCUWSubBakSchema.setSchema(this);
		return aLCUWSubBakSchema;
	}

	public LCUWSubBakDB getDB()
	{
		LCUWSubBakDB aDBOper = new LCUWSubBakDB();
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLCUWSubBak>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			UWType = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 42, SysConst.PACKAGESPILTER );
		}
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LCUWSubBakSchema other = (LCUWSubBakSchema)otherObject;
		return
