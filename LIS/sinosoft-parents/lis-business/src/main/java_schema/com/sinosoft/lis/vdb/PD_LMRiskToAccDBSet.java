...
/*
 * <p>ClassName: PD_LMRiskToAccDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: PhysicalDataModel_11
 */
public class PD_LMRiskToAccDBSet extends PD_LMRiskToAccSet
{
	// @Field
	...
	**/
	...
	// @Constructor
	public PD_LMRiskToAccDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "PD_LMRiskToAccDBSet";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getInsuAccInpflag() == null || this.get(i).getInsuAccInpflag().equals("null")) {
				...
				pstmt.setString(16, this.get(i).getInsuAccInpflag());
			}
			if(this.get(i).getDefaultOrder() == null || this.get(i).getDefaultOrder().equals("null")) {
				pstmt.setString(17,null);
			} else {
				pstmt.setString(17, this.get(i).getDefaultOrder());
			}
			// set where condition
			if(this.get(i).getInsuAccNo() == null || this.get(i).getInsuAccNo().equals("null")) {
