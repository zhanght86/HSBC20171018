...
/*
 * <p>ClassName: LLPrepayUWDetailDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 理赔管理
 */
public class LLPrepayUWDetailDBSet extends LLPrepayUWDetailSet
{
private static Logger logger = Logger.getLogger(LLPrepayUWDetailDBSet.class);
	...
	**/
	...
	// @Constructor
	public LLPrepayUWDetailDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LLPrepayUWDetailDBSet";
	...
	public boolean delete()
	{
		...
		try
		{
			...
			if(this.get(i).getPrepayNo() == null || this.get(i).getPrepayNo().equals("null")) {
				...
				pstmt.setString(8, this.get(i).getPrepayNo());
			}
			if(this.get(i).getRgtNo() == null || this.get(i).getRgtNo().equals("null")) {
				pstmt.setString(9,null);
			} else {
				pstmt.setString(9, this.get(i).getRgtNo());
			}
			...
			if(this.get(i).getCaseRelaNo() == null || this.get(i).getCaseRelaNo().equals("null")) {
				...
				pstmt.setString(11, this.get(i).getCaseRelaNo());
			}
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getDeclineNo() == null || this.get(i).getDeclineNo().equals("null")) {
				...
				pstmt.setString(10, this.get(i).getDeclineNo());
			}
			...
			pstmt.setDouble(19, this.get(i).getPrepaySum());
			...
			if(this.get(i).getMngCom() == null || this.get(i).getMngCom().equals("null")) {
				...
				pstmt.setString(22, this.get(i).getMngCom());
			}
			...
			if(this.get(i).getBackNo() == null || this.get(i).getBackNo().equals("null")) {
				...
				pstmt.setString(33, this.get(i).getBackNo());
			}
			if(this.get(i).getClmNo() == null || this.get(i).getClmNo().equals("null")) {
				pstmt.setString(34,null);
			} else {
				pstmt.setString(34, this.get(i).getClmNo());
			}
			if(this.get(i).getCaseNo() == null || this.get(i).getCaseNo().equals("null")) {
				pstmt.setString(35,null);
			} else {
				pstmt.setString(35, this.get(i).getCaseNo());
			}
			if(this.get(i).getPolNo() == null || this.get(i).getPolNo().equals("null")) {
			...
			if(this.get(i).getGetDutyKind() == null || this.get(i).getGetDutyKind().equals("null")) {
				...
				pstmt.setString(37, this.get(i).getGetDutyKind());
			}
			if(this.get(i).getGetDutyCode() == null || this.get(i).getGetDutyCode().equals("null")) {
			...
			if(this.get(i).getPrepayNo() == null || this.get(i).getPrepayNo().equals("null")) {
				...
				pstmt.setString(40, this.get(i).getPrepayNo());
			}
			if(this.get(i).getRgtNo() == null || this.get(i).getRgtNo().equals("null")) {
				pstmt.setString(41,null);
			} else {
				pstmt.setString(41, this.get(i).getRgtNo());
			}
			if(this.get(i).getDutyCode() == null || this.get(i).getDutyCode().equals("null")) {
			...
			if(this.get(i).getCaseRelaNo() == null || this.get(i).getCaseRelaNo().equals("null")) {
				...
				pstmt.setString(43, this.get(i).getCaseRelaNo());
			}
