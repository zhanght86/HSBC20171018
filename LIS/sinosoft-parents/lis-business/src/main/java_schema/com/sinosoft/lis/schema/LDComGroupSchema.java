...
/*
 * <p>ClassName: LDComGroupSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 承保流程
 */
public class LDComGroupSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LDComGroupSchema.class);
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LDComGroupSchema cloned = (LDComGroupSchema)super.clone();
	...
	/**
	* 使用另外一个 LDComGroupSchema 对象给 Schema 赋值
	* @param: aLDComGroupSchema LDComGroupSchema
	**/
	public void setSchema(LDComGroupSchema aLDComGroupSchema)
	{
		this.ComGroup = aLDComGroupSchema.getComGroup();
		this.ComGroupName = aLDComGroupSchema.getComGroupName();
		this.CalSQL = aLDComGroupSchema.getCalSQL();
		this.Operator = aLDComGroupSchema.getOperator();
		this.MakeDate = fDate.getDate( aLDComGroupSchema.getMakeDate());
		this.MakeTime = aLDComGroupSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLDComGroupSchema.getModifyDate());
		this.ModifyTime = aLDComGroupSchema.getModifyTime();
		this.Remark = aLDComGroupSchema.getRemark();
		this.BatchNo = aLDComGroupSchema.getBatchNo();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LDComGroup表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LDComGroupSchema";
	...
	public LDComGroupSchema getSchema()
	{
		LDComGroupSchema aLDComGroupSchema = new LDComGroupSchema();
		aLDComGroupSchema.setSchema(this);
		return aLDComGroupSchema;
	}

	public LDComGroupDB getDB()
	{
		LDComGroupDB aDBOper = new LDComGroupDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLDComGroup描述/A>表字段
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLDComGroup>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			ComGroup = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 1, SysConst.PACKAGESPILTER );
			ComGroupName = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 2, SysConst.PACKAGESPILTER );
			CalSQL = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 3, SysConst.PACKAGESPILTER );
			...
			BatchNo = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 10, SysConst.PACKAGESPILTER );
		}
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LDComGroupSchema other = (LDComGroupSchema)otherObject;
		return
