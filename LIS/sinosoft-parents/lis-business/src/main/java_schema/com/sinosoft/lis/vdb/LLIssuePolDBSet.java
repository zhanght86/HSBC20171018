...
/*
 * <p>ClassName: LLIssuePolDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 理赔管理
 */
public class LLIssuePolDBSet extends LLIssuePolSet
{
private static Logger logger = Logger.getLogger(LLIssuePolDBSet.class);
	...
	**/
	...
	// @Constructor
	public LLIssuePolDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LLIssuePolDBSet";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getBatNo() == null || this.get(i).getBatNo().equals("null")) {
				...
				pstmt.setString(36, this.get(i).getBatNo());
			}
			if(this.get(i).getProposalContNo() == null || this.get(i).getProposalContNo().equals("null")) {
				pstmt.setString(37,null);
			} else {
				pstmt.setString(37, this.get(i).getProposalContNo());
			}
			if(this.get(i).getSerialNo() == null || this.get(i).getSerialNo().equals("null")) {
