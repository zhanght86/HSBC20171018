...
/*
 * <p>ClassName: LCCUWMasterDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: lccuwmaster
 */
public class LCCUWMasterDBSet extends LCCUWMasterSet
{
	// @Field
	...
	**/
	...
	// @Constructor
	public LCCUWMasterDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LCCUWMasterDBSet";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getCommonReason() == null || this.get(i).getCommonReason().equals("null")) {
				...
				pstmt.setString(40, this.get(i).getCommonReason());
			}
			pstmt.setInt(41, this.get(i).getBatchNo());
			...
			if(this.get(i).getUWState() == null || this.get(i).getUWState().equals("null")) {
				...
				pstmt.setString(43, this.get(i).getUWState());
			}
			if(this.get(i).getUniteNo() == null || this.get(i).getUniteNo().equals("null")) {
				pstmt.setString(44,null);
			} else {
				pstmt.setString(44, this.get(i).getUniteNo());
			}
			if(this.get(i).getWaitReason() == null || this.get(i).getWaitReason().equals("null")) {
				pstmt.setString(45,null);
			} else {
				pstmt.setString(45, this.get(i).getWaitReason());
			}
			if(this.get(i).getWaitContent() == null || this.get(i).getWaitContent().equals("null")) {
				pstmt.setString(46,null);
			} else {
				pstmt.setString(46, this.get(i).getWaitContent());
			}
			// set where condition
			if(this.get(i).getContNo() == null || this.get(i).getContNo().equals("null")) {
