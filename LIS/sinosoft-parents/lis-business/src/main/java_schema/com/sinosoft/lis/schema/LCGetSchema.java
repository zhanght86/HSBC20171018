...
/*
 * <p>ClassName: LCGetSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 承保核心
 */
public class LCGetSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LCGetSchema.class);
	// @Field
	/** 集体合同号码 */
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LCGetSchema cloned = (LCGetSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LCGetSchema 对象给 Schema 赋值
	* @param: aLCGetSchema LCGetSchema
	**/
	public void setSchema(LCGetSchema aLCGetSchema)
	{
		this.GrpContNo = aLCGetSchema.getGrpContNo();
		this.ContNo = aLCGetSchema.getContNo();
		this.PolNo = aLCGetSchema.getPolNo();
		this.DutyCode = aLCGetSchema.getDutyCode();
		this.GetDutyCode = aLCGetSchema.getGetDutyCode();
		this.GetDutyKind = aLCGetSchema.getGetDutyKind();
		this.InsuredNo = aLCGetSchema.getInsuredNo();
		this.GetMode = aLCGetSchema.getGetMode();
		this.GetLimit = aLCGetSchema.getGetLimit();
		this.GetRate = aLCGetSchema.getGetRate();
		this.UrgeGetFlag = aLCGetSchema.getUrgeGetFlag();
		this.LiveGetType = aLCGetSchema.getLiveGetType();
		this.AddRate = aLCGetSchema.getAddRate();
		this.CanGet = aLCGetSchema.getCanGet();
		this.NeedAcc = aLCGetSchema.getNeedAcc();
		this.NeedCancelAcc = aLCGetSchema.getNeedCancelAcc();
		this.StandMoney = aLCGetSchema.getStandMoney();
		this.ActuGet = aLCGetSchema.getActuGet();
		this.SumMoney = aLCGetSchema.getSumMoney();
		this.GetIntv = aLCGetSchema.getGetIntv();
		this.GettoDate = fDate.getDate( aLCGetSchema.getGettoDate());
		this.GetStartDate = fDate.getDate( aLCGetSchema.getGetStartDate());
		this.GetEndDate = fDate.getDate( aLCGetSchema.getGetEndDate());
		this.BalaDate = fDate.getDate( aLCGetSchema.getBalaDate());
		this.State = aLCGetSchema.getState();
		this.ManageCom = aLCGetSchema.getManageCom();
		this.Operator = aLCGetSchema.getOperator();
		this.MakeDate = fDate.getDate( aLCGetSchema.getMakeDate());
		this.MakeTime = aLCGetSchema.getMakeTime();
		this.ModifyTime = aLCGetSchema.getModifyTime();
		this.ModifyDate = fDate.getDate( aLCGetSchema.getModifyDate());
		this.GetEndState = aLCGetSchema.getGetEndState();
		this.Currency = aLCGetSchema.getCurrency();
		this.ComCode = aLCGetSchema.getComCode();
		this.ModifyOperator = aLCGetSchema.getModifyOperator();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LCGet表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LCGetSchema";
	...
	public LCGetSchema getSchema()
	{
		LCGetSchema aLCGetSchema = new LCGetSchema();
		aLCGetSchema.setSchema(this);
		return aLCGetSchema;
	}

	public LCGetDB getDB()
	{
		LCGetDB aDBOper = new LCGetDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLCGet描述/A>表字段
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLCGet>历史记账凭证主表信息</A>表字段
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LCGetSchema other = (LCGetSchema)otherObject;
		return
