...
/*
 * <p>ClassName: LOBContPlanDetailSubDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: Physical Data Model 1
 */
public class LOBContPlanDetailSubDBSet extends LOBContPlanDetailSubSet
{
	// @Field
	...
	**/
	...
	// @Constructor
	public LOBContPlanDetailSubDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public LOBContPlanDetailSubDBSet()
	{
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LOBContPlanDetailSubDBSet";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getBussType() == null || this.get(i).getBussType().equals("null")) {
				...
				pstmt.setString(39, this.get(i).getBussType());
			}
			if(this.get(i).getBussNo() == null || this.get(i).getBussNo().equals("null")) {
				pstmt.setString(40,null);
			} else {
				pstmt.setString(40, this.get(i).getBussNo());
			}
			if(this.get(i).getPolicyNo() == null || this.get(i).getPolicyNo().equals("null")) {
