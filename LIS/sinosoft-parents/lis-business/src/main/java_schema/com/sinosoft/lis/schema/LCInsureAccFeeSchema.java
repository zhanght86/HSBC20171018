...
/*
 * <p>ClassName: LCInsureAccFeeSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 承保核心
 */
public class LCInsureAccFeeSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LCInsureAccFeeSchema.class);
	// @Field
	/** 集体合同号码 */
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LCInsureAccFeeSchema cloned = (LCInsureAccFeeSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LCInsureAccFeeSchema 对象给 Schema 赋值
	* @param: aLCInsureAccFeeSchema LCInsureAccFeeSchema
	**/
	public void setSchema(LCInsureAccFeeSchema aLCInsureAccFeeSchema)
	{
		this.GrpContNo = aLCInsureAccFeeSchema.getGrpContNo();
		this.GrpPolNo = aLCInsureAccFeeSchema.getGrpPolNo();
		this.PolNo = aLCInsureAccFeeSchema.getPolNo();
		this.InsuAccNo = aLCInsureAccFeeSchema.getInsuAccNo();
		this.ContNo = aLCInsureAccFeeSchema.getContNo();
		this.ManageCom = aLCInsureAccFeeSchema.getManageCom();
		this.PrtNo = aLCInsureAccFeeSchema.getPrtNo();
		this.RiskCode = aLCInsureAccFeeSchema.getRiskCode();
		this.AccType = aLCInsureAccFeeSchema.getAccType();
		this.InvestType = aLCInsureAccFeeSchema.getInvestType();
		this.FundCompanyCode = aLCInsureAccFeeSchema.getFundCompanyCode();
		this.InsuredNo = aLCInsureAccFeeSchema.getInsuredNo();
		this.AppntNo = aLCInsureAccFeeSchema.getAppntNo();
		this.Owner = aLCInsureAccFeeSchema.getOwner();
		this.AccComputeFlag = aLCInsureAccFeeSchema.getAccComputeFlag();
		this.AccFoundDate = fDate.getDate( aLCInsureAccFeeSchema.getAccFoundDate());
		this.AccFoundTime = aLCInsureAccFeeSchema.getAccFoundTime();
		this.FeeRate = aLCInsureAccFeeSchema.getFeeRate();
		this.Fee = aLCInsureAccFeeSchema.getFee();
		this.FeeUnit = aLCInsureAccFeeSchema.getFeeUnit();
		this.BalaDate = fDate.getDate( aLCInsureAccFeeSchema.getBalaDate());
		this.BalaTime = aLCInsureAccFeeSchema.getBalaTime();
		this.Operator = aLCInsureAccFeeSchema.getOperator();
		this.MakeDate = fDate.getDate( aLCInsureAccFeeSchema.getMakeDate());
		this.MakeTime = aLCInsureAccFeeSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLCInsureAccFeeSchema.getModifyDate());
		this.ModifyTime = aLCInsureAccFeeSchema.getModifyTime();
		this.Currency = aLCInsureAccFeeSchema.getCurrency();
		this.ComCode = aLCInsureAccFeeSchema.getComCode();
		this.ModifyOperator = aLCInsureAccFeeSchema.getModifyOperator();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LCInsureAccFee表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LCInsureAccFeeSchema";
	...
	public LCInsureAccFeeSchema getSchema()
	{
		LCInsureAccFeeSchema aLCInsureAccFeeSchema = new LCInsureAccFeeSchema();
		aLCInsureAccFeeSchema.setSchema(this);
		return aLCInsureAccFeeSchema;
	}

	public LCInsureAccFeeDB getDB()
	{
		LCInsureAccFeeDB aDBOper = new LCInsureAccFeeDB();
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLCInsureAccFee>历史记账凭证主表信息</A>表字段
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LCInsureAccFeeSchema other = (LCInsureAccFeeSchema)otherObject;
		return
