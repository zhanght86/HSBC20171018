...
/*
 * <p>ClassName: LBRemarkDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 寿险业务系统缺失模型
 */
public class LBRemarkDBSet extends LBRemarkSet
{
private static Logger logger = Logger.getLogger(LBRemarkDBSet.class);
	...
	**/
	...
	// @Constructor
	public LBRemarkDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LBRemarkDBSet";
