...
/*
 * <p>ClassName: LCAscriptionRuleParamsSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 承保核心
 */
public class LCAscriptionRuleParamsSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LCAscriptionRuleParamsSchema.class);
	...
	// @Constructor
	public LCAscriptionRuleParamsSchema()
	{
		mErrors = new CErrors();
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LCAscriptionRuleParamsSchema cloned = (LCAscriptionRuleParamsSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LCAscriptionRuleParamsSchema 对象给 Schema 赋值
	* @param: aLCAscriptionRuleParamsSchema LCAscriptionRuleParamsSchema
	**/
	public void setSchema(LCAscriptionRuleParamsSchema aLCAscriptionRuleParamsSchema)
	{
		this.GrpPolNo = aLCAscriptionRuleParamsSchema.getGrpPolNo();
		this.GrpContNo = aLCAscriptionRuleParamsSchema.getGrpContNo();
		this.RiskCode = aLCAscriptionRuleParamsSchema.getRiskCode();
		this.AscriptionRuleCode = aLCAscriptionRuleParamsSchema.getAscriptionRuleCode();
		this.AscriptionRuleName = aLCAscriptionRuleParamsSchema.getAscriptionRuleName();
		this.FactoryType = aLCAscriptionRuleParamsSchema.getFactoryType();
		this.OtherNo = aLCAscriptionRuleParamsSchema.getOtherNo();
		this.FactoryCode = aLCAscriptionRuleParamsSchema.getFactoryCode();
		this.FactorySubCode = aLCAscriptionRuleParamsSchema.getFactorySubCode();
		this.FactoryName = aLCAscriptionRuleParamsSchema.getFactoryName();
		this.InerSerialNo = aLCAscriptionRuleParamsSchema.getInerSerialNo();
		this.ParamName = aLCAscriptionRuleParamsSchema.getParamName();
		this.Param = aLCAscriptionRuleParamsSchema.getParam();
		this.Operator = aLCAscriptionRuleParamsSchema.getOperator();
		this.MakeDate = fDate.getDate( aLCAscriptionRuleParamsSchema.getMakeDate());
		this.MakeTime = aLCAscriptionRuleParamsSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLCAscriptionRuleParamsSchema.getModifyDate());
		this.ModifyTime = aLCAscriptionRuleParamsSchema.getModifyTime();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LCAscriptionRuleParams表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LCAscriptionRuleParamsSchema";
	...
	public LCAscriptionRuleParamsSchema getSchema()
	{
		LCAscriptionRuleParamsSchema aLCAscriptionRuleParamsSchema = new LCAscriptionRuleParamsSchema();
		aLCAscriptionRuleParamsSchema.setSchema(this);
		return aLCAscriptionRuleParamsSchema;
	}

	public LCAscriptionRuleParamsDB getDB()
	{
		LCAscriptionRuleParamsDB aDBOper = new LCAscriptionRuleParamsDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLCAscriptionRuleParams描述/A>表字段
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLCAscriptionRuleParams>历史记账凭证主表信息</A>表字段
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LCAscriptionRuleParamsSchema other = (LCAscriptionRuleParamsSchema)otherObject;
		return
