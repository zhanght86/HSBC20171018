...
import com.sinosoft.lis.db.PD_LCSetMealRiskRelaDB;

/**
 * <p>ClassName: PD_LCSetMealRiskRelaSchema </p>
 ...
 */
public class PD_LCSetMealRiskRelaSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(PD_LCSetMealRiskRelaSchema.class);
    ...
    // @Constructor
    public PD_LCSetMealRiskRelaSchema()
    {
        mErrors = new CErrors();
    ...
    {
        PD_LCSetMealRiskRelaSchema cloned = (PD_LCSetMealRiskRelaSchema)super.clone();
    ...
    /**
     * 使用另外一个 PD_LCSetMealRiskRelaSchema 对象给 Schema 赋值
     * @param: aPD_LCSetMealRiskRelaSchema PD_LCSetMealRiskRelaSchema
     **/
    public void setSchema(PD_LCSetMealRiskRelaSchema aPD_LCSetMealRiskRelaSchema)
    {
        this.Code = aPD_LCSetMealRiskRelaSchema.getCode();
        this.RiskCode = aPD_LCSetMealRiskRelaSchema.getRiskCode();
        this.MainRiskCode = aPD_LCSetMealRiskRelaSchema.getMainRiskCode();
        this.MakeDate = fDate.getDate(aPD_LCSetMealRiskRelaSchema.getMakeDate());
        this.MakeTime = aPD_LCSetMealRiskRelaSchema.getMakeTime();
        this.ModifyDate = fDate.getDate(aPD_LCSetMealRiskRelaSchema.getModifyDate());
        this.ModifyTime = aPD_LCSetMealRiskRelaSchema.getModifyTime();
        this.Operator = aPD_LCSetMealRiskRelaSchema.getOperator();
        this.StandbyFlag1 = aPD_LCSetMealRiskRelaSchema.getStandbyFlag1();
        this.StandbyFlag2 = aPD_LCSetMealRiskRelaSchema.getStandbyFlag2();
        this.StandbyFlag3 = aPD_LCSetMealRiskRelaSchema.getStandbyFlag3();
    }
    ...
    public boolean setSchema(ResultSet rs, int i)
    {
        try
        {
            ...
            if (rs.getString(3) == null)
                ...
                this.MainRiskCode = rs.getString(3).trim();
            this.MakeDate = rs.getDate(4);
            if (rs.getString(5) == null)
                this.MakeTime = null;
            else
                this.MakeTime = rs.getString(5).trim();
            this.ModifyDate = rs.getDate(6);
            if (rs.getString(7) == null)
                this.ModifyTime = null;
            else
                this.ModifyTime = rs.getString(7).trim();
        ...
        {
            logger.debug("数据库中表PD_LCSetMealRiskRela字段个数和Schema中的字段个数不一致，或执行db.executeQuery查询时未使用select * from tables");
            // @@错误处理
            CError tError = new CError();
            tError.moduleName = "PD_LCSetMealRiskRelaSchema";
    ...
    public PD_LCSetMealRiskRelaSchema getSchema()
    {
        PD_LCSetMealRiskRelaSchema aPD_LCSetMealRiskRelaSchema = new PD_LCSetMealRiskRelaSchema();
        aPD_LCSetMealRiskRelaSchema.setSchema(this);
        return aPD_LCSetMealRiskRelaSchema;
    }

    public PD_LCSetMealRiskRelaDB getDB()
    {
        PD_LCSetMealRiskRelaDB aDBOper = new PD_LCSetMealRiskRelaDB();
    ...
    /**
     * 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpPD_LCSetMealRiskRela>历史记账凭证主表信息</A>表字段
    ...
    public boolean equals(Object otherObject)
    {
        ...
        if (getClass() != otherObject.getClass())
            return false;
        PD_LCSetMealRiskRelaSchema other = (PD_LCSetMealRiskRelaSchema) otherObject;
        return
