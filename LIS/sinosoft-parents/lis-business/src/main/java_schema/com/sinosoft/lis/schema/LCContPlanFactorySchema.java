...
/*
 * <p>ClassName: LCContPlanFactorySchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 承保核心
 */
public class LCContPlanFactorySchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LCContPlanFactorySchema.class);
	...
	// @Constructor
	public LCContPlanFactorySchema()
	{
		mErrors = new CErrors();
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LCContPlanFactorySchema cloned = (LCContPlanFactorySchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LCContPlanFactorySchema 对象给 Schema 赋值
	* @param: aLCContPlanFactorySchema LCContPlanFactorySchema
	**/
	public void setSchema(LCContPlanFactorySchema aLCContPlanFactorySchema)
	{
		this.GrpContNo = aLCContPlanFactorySchema.getGrpContNo();
		this.ProposalGrpContNo = aLCContPlanFactorySchema.getProposalGrpContNo();
		this.MainRiskCode = aLCContPlanFactorySchema.getMainRiskCode();
		this.MainRiskVersion = aLCContPlanFactorySchema.getMainRiskVersion();
		this.RiskCode = aLCContPlanFactorySchema.getRiskCode();
		this.RiskVersion = aLCContPlanFactorySchema.getRiskVersion();
		this.ContPlanCode = aLCContPlanFactorySchema.getContPlanCode();
		this.ContPlanName = aLCContPlanFactorySchema.getContPlanName();
		this.FactoryType = aLCContPlanFactorySchema.getFactoryType();
		this.OtherNo = aLCContPlanFactorySchema.getOtherNo();
		this.FactoryCode = aLCContPlanFactorySchema.getFactoryCode();
		this.FactorySubCode = aLCContPlanFactorySchema.getFactorySubCode();
		this.FactoryName = aLCContPlanFactorySchema.getFactoryName();
		this.InerSerialNo = aLCContPlanFactorySchema.getInerSerialNo();
		this.CalSql = aLCContPlanFactorySchema.getCalSql();
		this.Params = aLCContPlanFactorySchema.getParams();
		this.CalRemark = aLCContPlanFactorySchema.getCalRemark();
		this.MakeDate = fDate.getDate( aLCContPlanFactorySchema.getMakeDate());
		this.MakeTime = aLCContPlanFactorySchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLCContPlanFactorySchema.getModifyDate());
		this.ModifyTime = aLCContPlanFactorySchema.getModifyTime();
		this.PlanType = aLCContPlanFactorySchema.getPlanType();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LCContPlanFactory表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LCContPlanFactorySchema";
	...
	public LCContPlanFactorySchema getSchema()
	{
		LCContPlanFactorySchema aLCContPlanFactorySchema = new LCContPlanFactorySchema();
		aLCContPlanFactorySchema.setSchema(this);
		return aLCContPlanFactorySchema;
	}

	public LCContPlanFactoryDB getDB()
	{
		LCContPlanFactoryDB aDBOper = new LCContPlanFactoryDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLCContPlanFactory描述/A>表字段
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLCContPlanFactory>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			Params = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 16, SysConst.PACKAGESPILTER );
			CalRemark = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 17, SysConst.PACKAGESPILTER );
			...
			PlanType = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 22, SysConst.PACKAGESPILTER );
		}
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LCContPlanFactorySchema other = (LCContPlanFactorySchema)otherObject;
		return
