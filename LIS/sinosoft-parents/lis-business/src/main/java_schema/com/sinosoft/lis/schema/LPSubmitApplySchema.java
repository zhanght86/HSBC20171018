...
/*
 * <p>ClassName: LPSubmitApplySchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 保全核心
 */
public class LPSubmitApplySchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LPSubmitApplySchema.class);
	...
	*/
	...
	/**
	* 使用另外一个 LPSubmitApplySchema 对象给 Schema 赋值
	* @param: aLPSubmitApplySchema LPSubmitApplySchema
	**/
	public void setSchema(LPSubmitApplySchema aLPSubmitApplySchema)
	{
		this.SubNo = aLPSubmitApplySchema.getSubNo();
		this.GrpContNo = aLPSubmitApplySchema.getGrpContNo();
		this.EdorType = aLPSubmitApplySchema.getEdorType();
		this.SubDesc = aLPSubmitApplySchema.getSubDesc();
		this.SubPer = aLPSubmitApplySchema.getSubPer();
		this.SubDate = fDate.getDate( aLPSubmitApplySchema.getSubDate());
		this.ManageCom = aLPSubmitApplySchema.getManageCom();
		this.SubTimes = aLPSubmitApplySchema.getSubTimes();
		this.SubState = aLPSubmitApplySchema.getSubState();
		this.DispDept = aLPSubmitApplySchema.getDispDept();
		this.DispPer = aLPSubmitApplySchema.getDispPer();
		this.DealDate = fDate.getDate( aLPSubmitApplySchema.getDealDate());
		this.DealType = aLPSubmitApplySchema.getDealType();
		this.DealIdea = aLPSubmitApplySchema.getDealIdea();
		this.Operator = aLPSubmitApplySchema.getOperator();
		this.HasDealed = aLPSubmitApplySchema.getHasDealed();
		this.AppText1 = aLPSubmitApplySchema.getAppText1();
		this.AppText2 = aLPSubmitApplySchema.getAppText2();
		this.AppText3 = aLPSubmitApplySchema.getAppText3();
		this.MakeDate = fDate.getDate( aLPSubmitApplySchema.getMakeDate());
		this.MakeTime = aLPSubmitApplySchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLPSubmitApplySchema.getModifyDate());
		this.ModifyTime = aLPSubmitApplySchema.getModifyTime();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LPSubmitApply表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LPSubmitApplySchema";
	...
	public LPSubmitApplyDB getDB()
	{
		LPSubmitApplyDB aDBOper = new LPSubmitApplyDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLPSubmitApply描述/A>表字段
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLPSubmitApply>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			SubNo = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 1, SysConst.PACKAGESPILTER );
			...
			SubDesc = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 4, SysConst.PACKAGESPILTER );
			SubPer = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 5, SysConst.PACKAGESPILTER );
			SubDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 6,SysConst.PACKAGESPILTER));
			ManageCom = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 7, SysConst.PACKAGESPILTER );
			SubTimes= new Integer(ChgData.chgNumericStr(StrTool.getStr(strMessage,8,SysConst.PACKAGESPILTER))).intValue();
			SubState = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 9, SysConst.PACKAGESPILTER );
			DispDept = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 10, SysConst.PACKAGESPILTER );
			DispPer = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 11, SysConst.PACKAGESPILTER );
			DealDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 12,SysConst.PACKAGESPILTER));
			DealType = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 13, SysConst.PACKAGESPILTER );
			DealIdea = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 14, SysConst.PACKAGESPILTER );
			Operator = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 15, SysConst.PACKAGESPILTER );
			HasDealed = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 16, SysConst.PACKAGESPILTER );
			AppText1 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 17, SysConst.PACKAGESPILTER );
			AppText2 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 18, SysConst.PACKAGESPILTER );
			AppText3 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 19, SysConst.PACKAGESPILTER );
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LPSubmitApplySchema other = (LPSubmitApplySchema)otherObject;
		return
