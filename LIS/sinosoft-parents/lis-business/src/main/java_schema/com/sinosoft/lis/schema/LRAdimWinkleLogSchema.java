...
import com.sinosoft.lis.db.LRAdimWinkleLogDB;

/*
 * <p>ClassName: LRAdimWinkleLogSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 保费续期及中介
 */
public class LRAdimWinkleLogSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LRAdimWinkleLogSchema.class);
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LRAdimWinkleLogSchema cloned = (LRAdimWinkleLogSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LRAdimWinkleLogSchema 对象给 Schema 赋值
	* @param: aLRAdimWinkleLogSchema LRAdimWinkleLogSchema
	**/
	public void setSchema(LRAdimWinkleLogSchema aLRAdimWinkleLogSchema)
	{
		this.ManageCom = aLRAdimWinkleLogSchema.getManageCom();
		this.YearMonth = aLRAdimWinkleLogSchema.getYearMonth();
		this.Type = aLRAdimWinkleLogSchema.getType();
		this.State = aLRAdimWinkleLogSchema.getState();
		this.Operator = aLRAdimWinkleLogSchema.getOperator();
		this.MakeDate = fDate.getDate( aLRAdimWinkleLogSchema.getMakeDate());
		this.MakeTime = aLRAdimWinkleLogSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLRAdimWinkleLogSchema.getModifyDate());
		this.ModifyTime = aLRAdimWinkleLogSchema.getModifyTime();
		this.Flag = aLRAdimWinkleLogSchema.getFlag();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LRAdimWinkleLog表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LRAdimWinkleLogSchema";
	...
	public LRAdimWinkleLogSchema getSchema()
	{
		LRAdimWinkleLogSchema aLRAdimWinkleLogSchema = new LRAdimWinkleLogSchema();
		aLRAdimWinkleLogSchema.setSchema(this);
		return aLRAdimWinkleLogSchema;
	}

	public LRAdimWinkleLogDB getDB()
	{
		LRAdimWinkleLogDB aDBOper = new LRAdimWinkleLogDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLRAdimWinkleLog描述/A>表字段
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLRAdimWinkleLog>历史记账凭证主表信息</A>表字段
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LRAdimWinkleLogSchema other = (LRAdimWinkleLogSchema)otherObject;
		return
