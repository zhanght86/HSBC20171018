...
/*
 * <p>ClassName: LPCustomerImpartSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 保全核心
 */
public class LPCustomerImpartSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LPCustomerImpartSchema.class);
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LPCustomerImpartSchema cloned = (LPCustomerImpartSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LPCustomerImpartSchema 对象给 Schema 赋值
	* @param: aLPCustomerImpartSchema LPCustomerImpartSchema
	**/
	public void setSchema(LPCustomerImpartSchema aLPCustomerImpartSchema)
	{
		this.EdorNo = aLPCustomerImpartSchema.getEdorNo();
		this.EdorType = aLPCustomerImpartSchema.getEdorType();
		this.GrpContNo = aLPCustomerImpartSchema.getGrpContNo();
		this.ContNo = aLPCustomerImpartSchema.getContNo();
		this.ProposalContNo = aLPCustomerImpartSchema.getProposalContNo();
		this.PrtNo = aLPCustomerImpartSchema.getPrtNo();
		this.ImpartCode = aLPCustomerImpartSchema.getImpartCode();
		this.ImpartVer = aLPCustomerImpartSchema.getImpartVer();
		this.ImpartContent = aLPCustomerImpartSchema.getImpartContent();
		this.ImpartParamModle = aLPCustomerImpartSchema.getImpartParamModle();
		this.CustomerNo = aLPCustomerImpartSchema.getCustomerNo();
		this.CustomerNoType = aLPCustomerImpartSchema.getCustomerNoType();
		this.UWClaimFlg = aLPCustomerImpartSchema.getUWClaimFlg();
		this.PrtFlag = aLPCustomerImpartSchema.getPrtFlag();
		this.Operator = aLPCustomerImpartSchema.getOperator();
		this.MakeDate = fDate.getDate( aLPCustomerImpartSchema.getMakeDate());
		this.MakeTime = aLPCustomerImpartSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLPCustomerImpartSchema.getModifyDate());
		this.ModifyTime = aLPCustomerImpartSchema.getModifyTime();
		this.PatchNo = aLPCustomerImpartSchema.getPatchNo();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LPCustomerImpart表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LPCustomerImpartSchema";
	...
	public LPCustomerImpartSchema getSchema()
	{
		LPCustomerImpartSchema aLPCustomerImpartSchema = new LPCustomerImpartSchema();
		aLPCustomerImpartSchema.setSchema(this);
		return aLPCustomerImpartSchema;
	}

	public LPCustomerImpartDB getDB()
	{
		LPCustomerImpartDB aDBOper = new LPCustomerImpartDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLPCustomerImpart描述/A>表字段
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLPCustomerImpart>历史记账凭证主表信息</A>表字段
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LPCustomerImpartSchema other = (LPCustomerImpartSchema)otherObject;
		return
