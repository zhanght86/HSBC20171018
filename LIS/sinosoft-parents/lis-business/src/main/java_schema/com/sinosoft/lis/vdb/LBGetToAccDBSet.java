...
/*
 * <p>ClassName: LBGetToAccDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 寿险业务系统未整理模型
 */
public class LBGetToAccDBSet extends LBGetToAccSet
{
private static Logger logger = Logger.getLogger(LBGetToAccDBSet.class);
	...
	**/
	...
	// @Constructor
	public LBGetToAccDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LBGetToAccDBSet";
...
ex.printStackTrace();
	...
	public boolean update()
	{
		...
		try
		{
			...
			pstmt.setDouble(6, this.get(i).getDefaultRate());
			if(this.get(i).getNeedInput() == null || this.get(i).getNeedInput().equals("null")) {
				pstmt.setString(7,null);
			} else {
				pstmt.setString(7, this.get(i).getNeedInput());
			}
			...
			if(this.get(i).getDealDirection() == null || this.get(i).getDealDirection().equals("null")) {
				...
				pstmt.setString(9, this.get(i).getDealDirection());
			}
			...
			if(this.get(i).getGetDutyCode() == null || this.get(i).getGetDutyCode().equals("null")) {
				...
				pstmt.setString(18, this.get(i).getGetDutyCode());
			}
			if(this.get(i).getInsuAccNo() == null || this.get(i).getInsuAccNo().equals("null")) {
