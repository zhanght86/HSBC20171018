...
import com.sinosoft.lis.db.LSQuotPubAmntRelaDB;

/*
 * <p>ClassName: LSQuotPubAmntRelaSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: Physical Data Model 1
 */
public class LSQuotPubAmntRelaSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LSQuotPubAmntRelaSchema.class);
	// @Field
	/** 询价号 */
	...
	// @Constructor
	public LSQuotPubAmntRelaSchema()
	{
		mErrors = new CErrors();
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LSQuotPubAmntRelaSchema cloned = (LSQuotPubAmntRelaSchema)super.clone();
	...
	/**
	* 使用另外一个 LSQuotPubAmntRelaSchema 对象给 Schema 赋值
	* @param: aLSQuotPubAmntRelaSchema LSQuotPubAmntRelaSchema
	**/
	public void setSchema(LSQuotPubAmntRelaSchema aLSQuotPubAmntRelaSchema)
	{
		this.QuotNo = aLSQuotPubAmntRelaSchema.getQuotNo();
		this.QuotBatNo = aLSQuotPubAmntRelaSchema.getQuotBatNo();
		this.SysPlanCode = aLSQuotPubAmntRelaSchema.getSysPlanCode();
		this.PlanCode = aLSQuotPubAmntRelaSchema.getPlanCode();
		this.LimitAmnt = aLSQuotPubAmntRelaSchema.getLimitAmnt();
		this.MakeOperator = aLSQuotPubAmntRelaSchema.getMakeOperator();
		this.MakeDate = fDate.getDate( aLSQuotPubAmntRelaSchema.getMakeDate());
		this.MakeTime = aLSQuotPubAmntRelaSchema.getMakeTime();
		this.ModifyOperator = aLSQuotPubAmntRelaSchema.getModifyOperator();
		this.ModifyDate = fDate.getDate( aLSQuotPubAmntRelaSchema.getModifyDate());
		this.ModifyTime = aLSQuotPubAmntRelaSchema.getModifyTime();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LSQuotPubAmntRela表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LSQuotPubAmntRelaSchema";
	...
	public LSQuotPubAmntRelaSchema getSchema()
	{
		LSQuotPubAmntRelaSchema aLSQuotPubAmntRelaSchema = new LSQuotPubAmntRelaSchema();
		aLSQuotPubAmntRelaSchema.setSchema(this);
		return aLSQuotPubAmntRelaSchema;
	}

	public LSQuotPubAmntRelaDB getDB()
	{
		LSQuotPubAmntRelaDB aDBOper = new LSQuotPubAmntRelaDB();
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLSQuotPubAmntRela>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			LimitAmnt = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 5, SysConst.PACKAGESPILTER );
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LSQuotPubAmntRelaSchema other = (LSQuotPubAmntRelaSchema)otherObject;
		return
