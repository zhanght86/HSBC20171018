...
/*
 * <p>ClassName: PD_TESTTRACKDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 产品定义平台补充表
 */
public class PD_TestTrackDBSet extends PD_TestTrackSet
{
private static Logger logger = Logger.getLogger(PD_TestTrackDBSet.class);
	...
	**/
	...
	// @Constructor
	public PD_TestTrackDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "PD_TESTTRACKDBSet";
	...
	public boolean delete()
	{
		...
		try
		{
            ...
            {
			if(this.get(i).getBATCHNUM() == null || this.get(i).getBATCHNUM().equals("null")) {
				pstmt.setString(1,null);
			} else {
				pstmt.setString(1, this.get(i).getBATCHNUM());
			}
			if(this.get(i).getTESTPLANKIND() == null || this.get(i).getTESTPLANKIND().equals("null")) {
				pstmt.setString(2,null);
			} else {
				pstmt.setString(2, this.get(i).getTESTPLANKIND());
			}
			if(this.get(i).getCLEWCONTENTCODE() == null || this.get(i).getCLEWCONTENTCODE().equals("null")) {
				pstmt.setString(3,null);
			} else {
				pstmt.setString(3, this.get(i).getCLEWCONTENTCODE());
			}
...
ex.printStackTrace();
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getCLEWCONTENTNAME() == null || this.get(i).getCLEWCONTENTNAME().equals("null")) {
				pstmt.setString(4,null);
			} else {
				pstmt.setString(4, this.get(i).getCLEWCONTENTNAME());
			}
			if(this.get(i).getTESTSTATE() == null || this.get(i).getTESTSTATE().equals("null")) {
				pstmt.setString(5,null);
			} else {
				pstmt.setString(5, this.get(i).getTESTSTATE());
			}
			if(this.get(i).getTESTPERSON() == null || this.get(i).getTESTPERSON().equals("null")) {
				pstmt.setString(6,null);
			} else {
				pstmt.setString(6, this.get(i).getTESTPERSON());
			}
			if(this.get(i).getTESTTIME() == null || this.get(i).getTESTTIME().equals("null")) {
				pstmt.setDate(7,null);
			} else {
				pstmt.setDate(7, Date.valueOf(this.get(i).getTESTTIME()));
			}
			...
			if(this.get(i).getBATCHNUM() == null || this.get(i).getBATCHNUM().equals("null")) {
				...
				pstmt.setString(19, this.get(i).getBATCHNUM());
			}
			if(this.get(i).getTESTPLANKIND() == null || this.get(i).getTESTPLANKIND().equals("null")) {
				pstmt.setString(20,null);
			} else {
				pstmt.setString(20, this.get(i).getTESTPLANKIND());
			}
			if(this.get(i).getCLEWCONTENTCODE() == null || this.get(i).getCLEWCONTENTCODE().equals("null")) {
				pstmt.setString(21,null);
			} else {
				pstmt.setString(21, this.get(i).getCLEWCONTENTCODE());
			}
