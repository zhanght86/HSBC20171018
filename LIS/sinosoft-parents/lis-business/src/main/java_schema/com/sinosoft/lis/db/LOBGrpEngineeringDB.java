...
/*
 * <p>ClassName: LOBGrpEngineeringDB </p>
 * <p>Description: DB层数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: Physical Data Model 1
 */
public class LOBGrpEngineeringDB extends LOBGrpEngineeringSchema
{
	// @Field
	...
	**/
	...
	// @Constructor
	public LOBGrpEngineeringDB( Connection tConnection )
	{
		con = tConnection;
	...
	{
		LOBGrpEngineeringSchema tSchema = this.getSchema();
		...
		else
		{
			...
			tError.moduleName = "LOBGrpEngineeringDB";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.getBussNo() == null || this.getBussNo().equals("null")) {
				...
				pstmt.setString(37, this.getBussNo());
			}
			if(this.getGrpContNo() == null || this.getGrpContNo().equals("null")) {
				pstmt.setNull(38, 12);
			} else {
	...
	public boolean getInfo()
	{
		...
		try
		{
			pstmt = con.prepareStatement("SELECT * FROM LOBGrpEngineering WHERE  BussType = ? AND BussNo = ? AND GrpContNo = ?", 
	...
	public LOBGrpEngineeringSet query()
	{
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		LOBGrpEngineeringSet aLOBGrpEngineeringSet = new LOBGrpEngineeringSet();
	  ...
	  if( !mflag ) {
		...
		{
			SQLString sqlObj = new SQLString("LOBGrpEngineering");
			LOBGrpEngineeringSchema aSchema = this.getSchema();
			...
			{
				i++;
				LOBGrpEngineeringSchema s1 = new LOBGrpEngineeringSchema();
				s1.setSchema(rs,i);
				aLOBGrpEngineeringSet.add(s1);
			}
			try{ rs.close(); } catch( Exception ex ) {}
			try{ pstmt.close(); } catch( Exception ex1 ) {}
		}
		...
		return aLOBGrpEngineeringSet;
	}

	public LOBGrpEngineeringSet executeQuery(String sql)
	{
		Statement stmt = null;
		ResultSet rs = null;
		LOBGrpEngineeringSet aLOBGrpEngineeringSet = new LOBGrpEngineeringSet();
	...
	public LOBGrpEngineeringSet query(int nStart, int nCount)
	{
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		LOBGrpEngineeringSet aLOBGrpEngineeringSet = new LOBGrpEngineeringSet();
	...
	public LOBGrpEngineeringSet executeQuery(String sql, int nStart, int nCount)
	{
		Statement stmt = null;
		ResultSet rs = null;
		LOBGrpEngineeringSet aLOBGrpEngineeringSet = new LOBGrpEngineeringSet();
	...
	public boolean update(String strWherePart)
	{
	  ...
	  if( !mflag ) {
		...
		try
		{
			...
			String sql = "update LOBGrpEngineering " + sqlObj.getUpdPart() + " where " + strWherePart;
...
/**
 * 获取定量数据
 * @return LOBGrpEngineeringSet
 */
public LOBGrpEngineeringSet getData()
{
    int tCount = 0;
    LOBGrpEngineeringSet tLOBGrpEngineeringSet = new LOBGrpEngineeringSet();
    LOBGrpEngineeringSchema tLOBGrpEngineeringSchema = null;
    if (null == mResultSet)
    {
        CError tError = new CError();
        tError.moduleName = "LOBGrpEngineeringDB";
    ...
    {
        tCount = 1;
        tLOBGrpEngineeringSchema = new LOBGrpEngineeringSchema();
        tLOBGrpEngineeringSchema.setSchema(mResultSet, 1);
        tLOBGrpEngineeringSet.add(tLOBGrpEngineeringSchema);
...
public boolean closeData()
{
	...
	public LOBGrpEngineeringSet executeQuery(SQLwithBindVariables sqlbv) {
	...
	public LOBGrpEngineeringSet executeQuery(SQLwithBindVariables sqlbv, int nStart, int nCount) {
