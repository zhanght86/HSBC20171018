...
/*
 * <p>ClassName: LPInsureAccClassDB </p>
 * <p>Description: DB层数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 保全核心
 */
public class LPInsureAccClassDB extends LPInsureAccClassSchema
{
	// @Field
	...
	**/
	...
	// @Constructor
	public LPInsureAccClassDB( Connection tConnection )
	{
		con = tConnection;
	...
	{
		LPInsureAccClassSchema tSchema = this.getSchema();
		...
		else
		{
			...
			tError.moduleName = "LPInsureAccClassDB";
	...
	public boolean delete()
	{
		...
		try
		{
			...
			if(this.getAccAscription() == null || this.getAccAscription().equals("null")) {
				...
				pstmt.setString(8, StrTool.space1(this.getAccAscription(), 1));
			}
			pstmt.executeUpdate();
			pstmt.close();
		} catch (Exception ex) {
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.getOtherType() == null || this.getOtherType().equals("null")) {
				...
				pstmt.setString(11, this.getOtherType());
			}
			if(this.getAccAscription() == null || this.getAccAscription().equals("null")) {
				pstmt.setNull(12, 1);
			} else {
				pstmt.setString(12, this.getAccAscription());
			}
			...
			if(this.getAccType() == null || this.getAccType().equals("null")) {
				...
				pstmt.setString(16, this.getAccType());
			}
			if(this.getAccComputeFlag() == null || this.getAccComputeFlag().equals("null")) {
				pstmt.setNull(17, 12);
			} else {
				pstmt.setString(17, this.getAccComputeFlag());
			}
			if(this.getAccFoundDate() == null || this.getAccFoundDate().equals("null")) {
				pstmt.setNull(18, 91);
			} else {
				pstmt.setDate(18, Date.valueOf(this.getAccFoundDate()));
			}
			if(this.getAccFoundTime() == null || this.getAccFoundTime().equals("null")) {
				pstmt.setNull(19, 12);
			} else {
				pstmt.setString(19, this.getAccFoundTime());
			}
			if(this.getBalaDate() == null || this.getBalaDate().equals("null")) {
				pstmt.setNull(20, 91);
			} else {
				pstmt.setDate(20, Date.valueOf(this.getBalaDate()));
			}
			if(this.getBalaTime() == null || this.getBalaTime().equals("null")) {
				pstmt.setNull(21, 12);
			} else {
				pstmt.setString(21, this.getBalaTime());
			}
			pstmt.setDouble(22, this.getSumPay());
			pstmt.setDouble(23, this.getSumPaym());
			pstmt.setDouble(24, this.getLastAccBala());
			pstmt.setDouble(25, this.getLastUnitCount());
			pstmt.setDouble(26, this.getLastUnitPrice());
			pstmt.setDouble(27, this.getInsuAccBala());
			pstmt.setDouble(28, this.getUnitCount());
			pstmt.setDouble(29, this.getInsuAccGetMoney());
			pstmt.setDouble(30, this.getFrozenMoney());
			if(this.getState() == null || this.getState().equals("null")) {
				pstmt.setNull(31, 12);
			} else {
				pstmt.setString(31, this.getState());
			}
			...
			pstmt.setDouble(38, this.getAscriptRate());
			if(this.getFeeDate() == null || this.getFeeDate().equals("null")) {
				pstmt.setNull(39, 91);
			} else {
				pstmt.setDate(39, Date.valueOf(this.getFeeDate()));
			}
			pstmt.setDouble(40, this.getUnitPrice());
			...
			if(this.getInvestType() == null || this.getInvestType().equals("null")) {
				...
				pstmt.setString(42, this.getInvestType());
			}
			...
			if(this.getEdorNo() == null || this.getEdorNo().equals("null")) {
				...
				pstmt.setString(45, this.getEdorNo());
			}
			if(this.getEdorType() == null || this.getEdorType().equals("null")) {
				pstmt.setNull(46, 12);
			} else {
				pstmt.setString(46, this.getEdorType());
			}
			if(this.getGrpContNo() == null || this.getGrpContNo().equals("null")) {
				pstmt.setNull(47, 12);
			} else {
				pstmt.setString(47, this.getGrpContNo());
			}
			if(this.getPolNo() == null || this.getPolNo().equals("null")) {
				pstmt.setNull(48, 12);
			} else {
			...
			if(this.getInsuAccNo() == null || this.getInsuAccNo().equals("null")) {
				...
				pstmt.setString(49, this.getInsuAccNo());
			}
			if(this.getPayPlanCode() == null || this.getPayPlanCode().equals("null")) {
				pstmt.setNull(50, 12);
			} else {
				pstmt.setString(50, this.getPayPlanCode());
			}
			if(this.getOtherNo() == null || this.getOtherNo().equals("null")) {
				pstmt.setNull(51, 12);
			} else {
			...
			if(this.getAccAscription() == null || this.getAccAscription().equals("null")) {
				...
				pstmt.setString(52, StrTool.space1(this.getAccAscription(), 1));
			}
			pstmt.executeUpdate();
			pstmt.close();
		} catch (Exception ex) {
	...
	public boolean getInfo()
	{
		...
		try
		{
			pstmt = con.prepareStatement("SELECT * FROM LPInsureAccClass WHERE  EdorNo = ? AND EdorType = ? AND GrpContNo = ? AND PolNo = ? AND InsuAccNo = ? AND PayPlanCode = ? AND OtherNo = ? AND AccAscription = ?", 
	...
	public LPInsureAccClassSet query()
	{
		PreparedStatement pstmt = null;
		ResultSet rs = null;
	  ...
	  if( !mflag ) {
		...
		{
			SQLString sqlObj = new SQLString("LPInsureAccClass");
			LPInsureAccClassSchema aSchema = this.getSchema();
			...
			{
				i++;
				LPInsureAccClassSchema s1 = new LPInsureAccClassSchema();
				s1.setSchema(rs,i);
				aLPInsureAccClassSet.add(s1);
			}
			try{ rs.close(); } catch( Exception ex ) {}
			try{ pstmt.close(); } catch( Exception ex1 ) {}
		}
		...
		return aLPInsureAccClassSet;
	}

	public LPInsureAccClassSet executeQuery(String sql)
	{
		Statement stmt = null;
		ResultSet rs = null;
		LPInsureAccClassSet aLPInsureAccClassSet = new LPInsureAccClassSet();
	...
	public LPInsureAccClassSet query(int nStart, int nCount)
	{
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		LPInsureAccClassSet aLPInsureAccClassSet = new LPInsureAccClassSet();
	...
	public LPInsureAccClassSet executeQuery(String sql, int nStart, int nCount)
	{
		Statement stmt = null;
		ResultSet rs = null;
		LPInsureAccClassSet aLPInsureAccClassSet = new LPInsureAccClassSet();
	...
	public boolean update(String strWherePart)
	{
	  ...
	  if( !mflag ) {
		...
		try
		{
			...
			String sql = "update LPInsureAccClass " + sqlObj.getUpdPart() + " where " + strWherePart;
...
/**
 * 获取定量数据
 * @return LPInsureAccClassSet
 */
public LPInsureAccClassSet getData()
{
    int tCount = 0;
    ...
    try
    {
        ...
        tLPInsureAccClassSchema.setSchema(mResultSet, 1);
...
public boolean closeData()
{
	...
	public LPInsureAccClassSet executeQuery(SQLwithBindVariables sqlbv) {
	...
	public LPInsureAccClassSet executeQuery(SQLwithBindVariables sqlbv, int nStart, int nCount) {
