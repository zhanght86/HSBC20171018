...
/*
 * <p>ClassName: LPCustomerContactInfoDB </p>
 * <p>Description: DB层数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: Physical Data Model 1
 */
public class LPCustomerContactInfoDB extends LPCustomerContactInfoSchema
{
	// @Field
	...
	**/
	...
	// @Constructor
	public LPCustomerContactInfoDB( Connection tConnection )
	{
		con = tConnection;
	...
	public LPCustomerContactInfoDB()
	{
		con = null;
	...
	{
		LPCustomerContactInfoSchema tSchema = this.getSchema();
		...
		else
		{
			...
			tError.moduleName = "LPCustomerContactInfoDB";
	...
	public boolean getInfo()
	{
		...
		try
		{
			pstmt = con.prepareStatement("SELECT * FROM LPCustomerContactInfo WHERE  EdorNo = ? AND EdorType = ? AND ContNo = ? AND CustomerNo = ?", 
	...
	public LPCustomerContactInfoSet query()
	{
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		LPCustomerContactInfoSet aLPCustomerContactInfoSet = new LPCustomerContactInfoSet();
	  ...
	  if( !mflag ) {
		...
		{
			SQLString sqlObj = new SQLString("LPCustomerContactInfo");
			LPCustomerContactInfoSchema aSchema = this.getSchema();
			...
			{
				i++;
				LPCustomerContactInfoSchema s1 = new LPCustomerContactInfoSchema();
				s1.setSchema(rs,i);
				aLPCustomerContactInfoSet.add(s1);
			}
			try{ rs.close(); } catch( Exception ex ) {}
			try{ pstmt.close(); } catch( Exception ex1 ) {}
		}
		...
		return aLPCustomerContactInfoSet;
	}

	public LPCustomerContactInfoSet executeQuery(String sql)
	{
		Statement stmt = null;
		ResultSet rs = null;
		LPCustomerContactInfoSet aLPCustomerContactInfoSet = new LPCustomerContactInfoSet();
	...
	public LPCustomerContactInfoSet query(int nStart, int nCount)
	{
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		LPCustomerContactInfoSet aLPCustomerContactInfoSet = new LPCustomerContactInfoSet();
	...
	public LPCustomerContactInfoSet executeQuery(String sql, int nStart, int nCount)
	{
		Statement stmt = null;
		ResultSet rs = null;
		LPCustomerContactInfoSet aLPCustomerContactInfoSet = new LPCustomerContactInfoSet();
	...
	public boolean update(String strWherePart)
	{
	  ...
	  if( !mflag ) {
		...
		try
		{
			...
			String sql = "update LPCustomerContactInfo " + sqlObj.getUpdPart() + " where " + strWherePart;
...
/**
 * 获取定量数据
 * @return LPCustomerContactInfoSet
 */
public LPCustomerContactInfoSet getData()
{
    int tCount = 0;
    LPCustomerContactInfoSet tLPCustomerContactInfoSet = new LPCustomerContactInfoSet();
    LPCustomerContactInfoSchema tLPCustomerContactInfoSchema = null;
    if (null == mResultSet)
    {
        CError tError = new CError();
        tError.moduleName = "LPCustomerContactInfoDB";
    ...
    {
        tCount = 1;
        tLPCustomerContactInfoSchema = new LPCustomerContactInfoSchema();
        tLPCustomerContactInfoSchema.setSchema(mResultSet, 1);
        tLPCustomerContactInfoSet.add(tLPCustomerContactInfoSchema);
    ...
    return tLPCustomerContactInfoSet;
}
/**
 * 关闭数据集
 * @return boolean
...
public boolean closeData()
{
	...
	public LPCustomerContactInfoSet executeQuery(SQLwithBindVariables sqlbv) {
	...
	public LPCustomerContactInfoSet executeQuery(SQLwithBindVariables sqlbv, int nStart, int nCount) {
