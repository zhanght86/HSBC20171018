...
/*
 * <p>ClassName: LCGUWErrorSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 承保流程
 */
public class LCGUWErrorSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LCGUWErrorSchema.class);
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LCGUWErrorSchema cloned = (LCGUWErrorSchema)super.clone();
	...
	/**
	* 使用另外一个 LCGUWErrorSchema 对象给 Schema 赋值
	* @param: aLCGUWErrorSchema LCGUWErrorSchema
	**/
	public void setSchema(LCGUWErrorSchema aLCGUWErrorSchema)
	{
		this.GrpContNo = aLCGUWErrorSchema.getGrpContNo();
		this.ProposalGrpContNo = aLCGUWErrorSchema.getProposalGrpContNo();
		this.GrpPolNo = aLCGUWErrorSchema.getGrpPolNo();
		this.GrpProposalNo = aLCGUWErrorSchema.getGrpProposalNo();
		this.SerialNo = aLCGUWErrorSchema.getSerialNo();
		this.UWNo = aLCGUWErrorSchema.getUWNo();
		this.GrpNo = aLCGUWErrorSchema.getGrpNo();
		this.Name = aLCGUWErrorSchema.getName();
		this.ManageCom = aLCGUWErrorSchema.getManageCom();
		this.UWRuleCode = aLCGUWErrorSchema.getUWRuleCode();
		this.UWError = aLCGUWErrorSchema.getUWError();
		this.CurrValue = aLCGUWErrorSchema.getCurrValue();
		this.UWPassFlag = aLCGUWErrorSchema.getUWPassFlag();
		this.ModifyDate = fDate.getDate( aLCGUWErrorSchema.getModifyDate());
		this.ModifyTime = aLCGUWErrorSchema.getModifyTime();
		this.UWGrade = aLCGUWErrorSchema.getUWGrade();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LCGUWError表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LCGUWErrorSchema";
	...
	public LCGUWErrorSchema getSchema()
	{
		LCGUWErrorSchema aLCGUWErrorSchema = new LCGUWErrorSchema();
		aLCGUWErrorSchema.setSchema(this);
		return aLCGUWErrorSchema;
	}

	public LCGUWErrorDB getDB()
	{
		LCGUWErrorDB aDBOper = new LCGUWErrorDB();
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLCGUWError>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			GrpNo = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 7, SysConst.PACKAGESPILTER );
			...
			UWRuleCode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 10, SysConst.PACKAGESPILTER );
			UWError = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 11, SysConst.PACKAGESPILTER );
			CurrValue = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 12, SysConst.PACKAGESPILTER );
			UWPassFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 13, SysConst.PACKAGESPILTER );
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LCGUWErrorSchema other = (LCGUWErrorSchema)otherObject;
		return
