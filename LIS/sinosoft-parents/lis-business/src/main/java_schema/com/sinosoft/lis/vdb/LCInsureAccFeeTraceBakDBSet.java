...
/*
 * <p>ClassName: LCInsureAccFeeTraceBakDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: PhysicalDataModel_1
 */
public class LCInsureAccFeeTraceBakDBSet extends LCInsureAccFeeTraceBakSet
{
private static Logger logger = Logger.getLogger(LCInsureAccFeeTraceBakDBSet.class);
	...
	**/
	...
	// @Constructor
	public LCInsureAccFeeTraceBakDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public LCInsureAccFeeTraceBakDBSet()
	{
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LCInsureAccFeeTraceBakDBSet";
