...
import com.sinosoft.lis.db.LCGrpChangeFeeDB;

/*
 * <p>ClassName: LCGrpChangeFeeSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: Physical Data Model 1
 */
public class LCGrpChangeFeeSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LCGrpChangeFeeSchema.class);
	// @Field
	/** 保单号码 */
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LCGrpChangeFeeSchema cloned = (LCGrpChangeFeeSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LCGrpChangeFeeSchema 对象给 Schema 赋值
	* @param: aLCGrpChangeFeeSchema LCGrpChangeFeeSchema
	**/
	public void setSchema(LCGrpChangeFeeSchema aLCGrpChangeFeeSchema)
	{
		this.PolicyNo = aLCGrpChangeFeeSchema.getPolicyNo();
		this.AgentCom = aLCGrpChangeFeeSchema.getAgentCom();
		this.AgentComName = aLCGrpChangeFeeSchema.getAgentComName();
		this.RiskCode = aLCGrpChangeFeeSchema.getRiskCode();
		this.ChangeFee = aLCGrpChangeFeeSchema.getChangeFee();
		this.ManageCom = aLCGrpChangeFeeSchema.getManageCom();
		this.ComCode = aLCGrpChangeFeeSchema.getComCode();
		this.MakeOperator = aLCGrpChangeFeeSchema.getMakeOperator();
		this.MakeDate = fDate.getDate( aLCGrpChangeFeeSchema.getMakeDate());
		this.MakeTime = aLCGrpChangeFeeSchema.getMakeTime();
		this.ModifyOperator = aLCGrpChangeFeeSchema.getModifyOperator();
		this.ModifyDate = fDate.getDate( aLCGrpChangeFeeSchema.getModifyDate());
		this.ModifyTime = aLCGrpChangeFeeSchema.getModifyTime();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LCGrpChangeFee表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LCGrpChangeFeeSchema";
	...
	public LCGrpChangeFeeSchema getSchema()
	{
		LCGrpChangeFeeSchema aLCGrpChangeFeeSchema = new LCGrpChangeFeeSchema();
		aLCGrpChangeFeeSchema.setSchema(this);
		return aLCGrpChangeFeeSchema;
	}

	public LCGrpChangeFeeDB getDB()
	{
		LCGrpChangeFeeDB aDBOper = new LCGrpChangeFeeDB();
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLCGrpChangeFee>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			ChangeFee = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,5,SysConst.PACKAGESPILTER))).doubleValue();
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LCGrpChangeFeeSchema other = (LCGrpChangeFeeSchema)otherObject;
		return
