...
/*
 * <p>ClassName: PD_LMDutyCtrlDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 产品定义平台_PDM
 */
public class PD_LMDutyCtrlDBSet extends PD_LMDutyCtrlSet
{
private static Logger logger = Logger.getLogger(PD_LMDutyCtrlDBSet.class);
	...
	**/
	...
	// @Constructor
	public PD_LMDutyCtrlDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "PD_LMDutyCtrlDBSet";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getOtherCode() == null || this.get(i).getOtherCode().equals("null")) {
				...
				pstmt.setString(18, this.get(i).getOtherCode());
			}
			if(this.get(i).getFieldName() == null || this.get(i).getFieldName().equals("null")) {
				pstmt.setString(19,null);
			} else {
				pstmt.setString(19, this.get(i).getFieldName());
			}
