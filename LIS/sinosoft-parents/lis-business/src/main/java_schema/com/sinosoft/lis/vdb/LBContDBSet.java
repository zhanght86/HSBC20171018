	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getContType() == null || this.get(i).getContType().equals("null")) {
				...
				pstmt.setString(6, this.get(i).getContType());
			}
			if(this.get(i).getFamilyType() == null || this.get(i).getFamilyType().equals("null")) {
				pstmt.setString(7,null);
			} else {
				pstmt.setString(7, this.get(i).getFamilyType());
			}
			...
			if(this.get(i).getPolType() == null || this.get(i).getPolType().equals("null")) {
				...
				pstmt.setString(9, this.get(i).getPolType());
			}
			...
			if(this.get(i).getExecuteCom() == null || this.get(i).getExecuteCom().equals("null")) {
				...
				pstmt.setString(12, this.get(i).getExecuteCom());
			}
			if(this.get(i).getAgentCom() == null || this.get(i).getAgentCom().equals("null")) {
				pstmt.setString(13,null);
			} else {
				pstmt.setString(13, this.get(i).getAgentCom());
			}
			...
			if(this.get(i).getSignCom() == null || this.get(i).getSignCom().equals("null")) {
				...
				pstmt.setString(39, this.get(i).getSignCom());
			}
			if(this.get(i).getSignDate() == null || this.get(i).getSignDate().equals("null")) {
				pstmt.setDate(40,null);
			} else {
				pstmt.setDate(40, Date.valueOf(this.get(i).getSignDate()));
			}
			if(this.get(i).getSignTime() == null || this.get(i).getSignTime().equals("null")) {
				pstmt.setString(41,null);
			} else {
				pstmt.setString(41, this.get(i).getSignTime());
			}
			if(this.get(i).getConsignNo() == null || this.get(i).getConsignNo().equals("null")) {
				pstmt.setString(42,null);
			} else {
				pstmt.setString(42, this.get(i).getConsignNo());
			}
			if(this.get(i).getBankCode() == null || this.get(i).getBankCode().equals("null")) {
				pstmt.setString(43,null);
			} else {
				pstmt.setString(43, this.get(i).getBankCode());
			}
			if(this.get(i).getBankAccNo() == null || this.get(i).getBankAccNo().equals("null")) {
				pstmt.setString(44,null);
			} else {
				pstmt.setString(44, this.get(i).getBankAccNo());
			}
			if(this.get(i).getAccName() == null || this.get(i).getAccName().equals("null")) {
				pstmt.setString(45,null);
			} else {
				pstmt.setString(45, this.get(i).getAccName());
			}
			pstmt.setInt(46, this.get(i).getPrintCount());
			pstmt.setInt(47, this.get(i).getLostTimes());
			if(this.get(i).getLang() == null || this.get(i).getLang().equals("null")) {
				pstmt.setString(48,null);
			} else {
				pstmt.setString(48, this.get(i).getLang());
			}
			...
			if(this.get(i).getRemark() == null || this.get(i).getRemark().equals("null")) {
				...
				pstmt.setString(50, this.get(i).getRemark());
			}
			pstmt.setInt(51, this.get(i).getPeoples());
			pstmt.setDouble(52, this.get(i).getMult());
			pstmt.setDouble(53, this.get(i).getPrem());
			pstmt.setDouble(54, this.get(i).getAmnt());
			pstmt.setDouble(55, this.get(i).getSumPrem());
			pstmt.setDouble(56, this.get(i).getDif());
