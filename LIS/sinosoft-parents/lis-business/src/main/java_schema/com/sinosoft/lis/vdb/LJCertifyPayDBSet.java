...
/*
 * <p>ClassName: LJCertifyPayDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 寿险业务系统未整理模型
 */
public class LJCertifyPayDBSet extends LJCertifyPaySet
{
private static Logger logger = Logger.getLogger(LJCertifyPayDBSet.class);
	...
	**/
	...
	// @Constructor
	public LJCertifyPayDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LJCertifyPayDBSet";
...
ex.printStackTrace();
	...
	public boolean update()
	{
		...
		try
		{
			...
			pstmt.setDouble(3, this.get(i).getActuPayMoney());
			if(this.get(i).getCertifyNo() == null || this.get(i).getCertifyNo().equals("null")) {
				pstmt.setString(4,null);
			} else {
				pstmt.setString(4, this.get(i).getCertifyNo());
			}
			...
			if(this.get(i).getBranchType() == null || this.get(i).getBranchType().equals("null")) {
				...
				pstmt.setString(10, this.get(i).getBranchType());
			}
			if(this.get(i).getPayDate() == null || this.get(i).getPayDate().equals("null")) {
				pstmt.setDate(11,null);
			} else {
				pstmt.setDate(11, Date.valueOf(this.get(i).getPayDate()));
			}
