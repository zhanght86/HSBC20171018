...
/*
 * <p>ClassName: LCIndUWSubSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 承保流程
 */
public class LCIndUWSubSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LCIndUWSubSchema.class);
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LCIndUWSubSchema cloned = (LCIndUWSubSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LCIndUWSubSchema 对象给 Schema 赋值
	* @param: aLCIndUWSubSchema LCIndUWSubSchema
	**/
	public void setSchema(LCIndUWSubSchema aLCIndUWSubSchema)
	{
		this.GrpContNo = aLCIndUWSubSchema.getGrpContNo();
		this.ContNo = aLCIndUWSubSchema.getContNo();
		this.ProposalContNo = aLCIndUWSubSchema.getProposalContNo();
		this.UWNo = aLCIndUWSubSchema.getUWNo();
		this.InsuredNo = aLCIndUWSubSchema.getInsuredNo();
		this.InsuredName = aLCIndUWSubSchema.getInsuredName();
		this.AppntNo = aLCIndUWSubSchema.getAppntNo();
		this.AppntName = aLCIndUWSubSchema.getAppntName();
		this.AgentCode = aLCIndUWSubSchema.getAgentCode();
		this.AgentGroup = aLCIndUWSubSchema.getAgentGroup();
		this.PassFlag = aLCIndUWSubSchema.getPassFlag();
		this.UWGrade = aLCIndUWSubSchema.getUWGrade();
		this.AppGrade = aLCIndUWSubSchema.getAppGrade();
		this.PostponeDay = aLCIndUWSubSchema.getPostponeDay();
		this.PostponeDate = fDate.getDate( aLCIndUWSubSchema.getPostponeDate());
		this.AutoUWFlag = aLCIndUWSubSchema.getAutoUWFlag();
		this.State = aLCIndUWSubSchema.getState();
		this.ManageCom = aLCIndUWSubSchema.getManageCom();
		this.UWIdea = aLCIndUWSubSchema.getUWIdea();
		this.UpReportContent = aLCIndUWSubSchema.getUpReportContent();
		this.Operator = aLCIndUWSubSchema.getOperator();
		this.HealthFlag = aLCIndUWSubSchema.getHealthFlag();
		this.QuesFlag = aLCIndUWSubSchema.getQuesFlag();
		this.SpecFlag = aLCIndUWSubSchema.getSpecFlag();
		this.AddPremFlag = aLCIndUWSubSchema.getAddPremFlag();
		this.AddPremReason = aLCIndUWSubSchema.getAddPremReason();
		this.ReportFlag = aLCIndUWSubSchema.getReportFlag();
		this.PrintFlag = aLCIndUWSubSchema.getPrintFlag();
		this.PrintFlag2 = aLCIndUWSubSchema.getPrintFlag2();
		this.ChangePolFlag = aLCIndUWSubSchema.getChangePolFlag();
		this.ChangePolReason = aLCIndUWSubSchema.getChangePolReason();
		this.SpecReason = aLCIndUWSubSchema.getSpecReason();
		this.MakeDate = fDate.getDate( aLCIndUWSubSchema.getMakeDate());
		this.MakeTime = aLCIndUWSubSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLCIndUWSubSchema.getModifyDate());
		this.ModifyTime = aLCIndUWSubSchema.getModifyTime();
		this.SugPassFlag = aLCIndUWSubSchema.getSugPassFlag();
		this.SugUWIdea = aLCIndUWSubSchema.getSugUWIdea();
		this.UpReport = aLCIndUWSubSchema.getUpReport();
		this.UWType = aLCIndUWSubSchema.getUWType();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LCIndUWSub表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LCIndUWSubSchema";
	...
	public LCIndUWSubSchema getSchema()
	{
		LCIndUWSubSchema aLCIndUWSubSchema = new LCIndUWSubSchema();
		aLCIndUWSubSchema.setSchema(this);
		return aLCIndUWSubSchema;
	}

	public LCIndUWSubDB getDB()
	{
		LCIndUWSubDB aDBOper = new LCIndUWSubDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLCIndUWSub描述/A>表字段
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLCIndUWSub>历史记账凭证主表信息</A>表字段
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LCIndUWSubSchema other = (LCIndUWSubSchema)otherObject;
		return
