...
/*
 * <p>ClassName: PD_LMRiskEdorItemDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 产品定义平台_PDM
 */
public class PD_LMRiskEdorItemDBSet extends PD_LMRiskEdorItemSet
{
	// @Field
	...
	**/
	...
	// @Constructor
	public PD_LMRiskEdorItemDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "PD_LMRiskEdorItemDBSet";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getEdorName() == null || this.get(i).getEdorName().equals("null")) {
				...
				pstmt.setString(6, this.get(i).getEdorName());
			}
			...
			if(this.get(i).getFinType() == null || this.get(i).getFinType().equals("null")) {
				pstmt.setString(15,null);
			} else {
				pstmt.setString(15, this.get(i).getFinType());
			}
			if(this.get(i).getEdorProperty() == null || this.get(i).getEdorProperty().equals("null")) {
				pstmt.setString(16,null);
			} else {
				pstmt.setString(16, this.get(i).getEdorProperty());
			}
			...
			if(this.get(i).getStandbyflag1() == null || this.get(i).getStandbyflag1().equals("null")) {
				...
				pstmt.setString(22, this.get(i).getStandbyflag1());
			}
			if(this.get(i).getStandbyflag2() == null || this.get(i).getStandbyflag2().equals("null")) {
				pstmt.setString(23,null);
			} else {
				pstmt.setString(23, this.get(i).getStandbyflag2());
			}
			pstmt.setInt(24, this.get(i).getStandbyflag3());
			pstmt.setInt(25, this.get(i).getStandbyflag4());
			pstmt.setDouble(26, this.get(i).getStandbyflag5());
			pstmt.setDouble(27, this.get(i).getStandbyflag6());
			// set where condition
			if(this.get(i).getRiskCode() == null || this.get(i).getRiskCode().equals("null")) {
			...
			if(this.get(i).getEdorCode() == null || this.get(i).getEdorCode().equals("null")) {
				...
				pstmt.setString(29, this.get(i).getEdorCode());
			}
