...
import com.sinosoft.lis.db.LPGrpIssuePolDB;

/*
 * <p>ClassName: LPGrpIssuePolSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 保全流程
 */
public class LPGrpIssuePolSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LPGrpIssuePolSchema.class);
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LPGrpIssuePolSchema cloned = (LPGrpIssuePolSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LPGrpIssuePolSchema 对象给 Schema 赋值
	* @param: aLPGrpIssuePolSchema LPGrpIssuePolSchema
	**/
	public void setSchema(LPGrpIssuePolSchema aLPGrpIssuePolSchema)
	{
		this.EdorNo = aLPGrpIssuePolSchema.getEdorNo();
		this.EdorType = aLPGrpIssuePolSchema.getEdorType();
		this.GrpContNo = aLPGrpIssuePolSchema.getGrpContNo();
		this.ProposalGrpContNo = aLPGrpIssuePolSchema.getProposalGrpContNo();
		this.PrtSeq = aLPGrpIssuePolSchema.getPrtSeq();
		this.SerialNo = aLPGrpIssuePolSchema.getSerialNo();
		this.IssueType = aLPGrpIssuePolSchema.getIssueType();
		this.OperatePos = aLPGrpIssuePolSchema.getOperatePos();
		this.BackObjType = aLPGrpIssuePolSchema.getBackObjType();
		this.BackObj = aLPGrpIssuePolSchema.getBackObj();
		this.IsueManageCom = aLPGrpIssuePolSchema.getIsueManageCom();
		this.IssueCont = aLPGrpIssuePolSchema.getIssueCont();
		this.PrintCount = aLPGrpIssuePolSchema.getPrintCount();
		this.NeedPrint = aLPGrpIssuePolSchema.getNeedPrint();
		this.ReplyMan = aLPGrpIssuePolSchema.getReplyMan();
		this.ReplyResult = aLPGrpIssuePolSchema.getReplyResult();
		this.State = aLPGrpIssuePolSchema.getState();
		this.Operator = aLPGrpIssuePolSchema.getOperator();
		this.ManageCom = aLPGrpIssuePolSchema.getManageCom();
		this.MakeDate = fDate.getDate( aLPGrpIssuePolSchema.getMakeDate());
		this.MakeTime = aLPGrpIssuePolSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLPGrpIssuePolSchema.getModifyDate());
		this.ModifyTime = aLPGrpIssuePolSchema.getModifyTime();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LPGrpIssuePol表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LPGrpIssuePolSchema";
	...
	public LPGrpIssuePolSchema getSchema()
	{
		LPGrpIssuePolSchema aLPGrpIssuePolSchema = new LPGrpIssuePolSchema();
		aLPGrpIssuePolSchema.setSchema(this);
		return aLPGrpIssuePolSchema;
	}

	public LPGrpIssuePolDB getDB()
	{
		LPGrpIssuePolDB aDBOper = new LPGrpIssuePolDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLPGrpIssuePol描述/A>表字段
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLPGrpIssuePol>历史记账凭证主表信息</A>表字段
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LPGrpIssuePolSchema other = (LPGrpIssuePolSchema)otherObject;
		return
