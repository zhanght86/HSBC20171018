...
/*
 * <p>ClassName: LCCustomerImpartParamsSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 承保核心
 */
public class LCCustomerImpartParamsSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LCCustomerImpartParamsSchema.class);
	...
	// @Constructor
	public LCCustomerImpartParamsSchema()
	{
		mErrors = new CErrors();
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LCCustomerImpartParamsSchema cloned = (LCCustomerImpartParamsSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LCCustomerImpartParamsSchema 对象给 Schema 赋值
	* @param: aLCCustomerImpartParamsSchema LCCustomerImpartParamsSchema
	**/
	public void setSchema(LCCustomerImpartParamsSchema aLCCustomerImpartParamsSchema)
	{
		this.GrpContNo = aLCCustomerImpartParamsSchema.getGrpContNo();
		this.ContNo = aLCCustomerImpartParamsSchema.getContNo();
		this.ProposalContNo = aLCCustomerImpartParamsSchema.getProposalContNo();
		this.PrtNo = aLCCustomerImpartParamsSchema.getPrtNo();
		this.ImpartCode = aLCCustomerImpartParamsSchema.getImpartCode();
		this.ImpartVer = aLCCustomerImpartParamsSchema.getImpartVer();
		this.CustomerNo = aLCCustomerImpartParamsSchema.getCustomerNo();
		this.CustomerNoType = aLCCustomerImpartParamsSchema.getCustomerNoType();
		this.ImpartParamNo = aLCCustomerImpartParamsSchema.getImpartParamNo();
		this.ImpartParamName = aLCCustomerImpartParamsSchema.getImpartParamName();
		this.ImpartParam = aLCCustomerImpartParamsSchema.getImpartParam();
		this.Operator = aLCCustomerImpartParamsSchema.getOperator();
		this.MakeDate = fDate.getDate( aLCCustomerImpartParamsSchema.getMakeDate());
		this.MakeTime = aLCCustomerImpartParamsSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLCCustomerImpartParamsSchema.getModifyDate());
		this.ModifyTime = aLCCustomerImpartParamsSchema.getModifyTime();
		this.PatchNo = aLCCustomerImpartParamsSchema.getPatchNo();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LCCustomerImpartParams表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LCCustomerImpartParamsSchema";
	...
	public LCCustomerImpartParamsSchema getSchema()
	{
		LCCustomerImpartParamsSchema aLCCustomerImpartParamsSchema = new LCCustomerImpartParamsSchema();
		aLCCustomerImpartParamsSchema.setSchema(this);
		return aLCCustomerImpartParamsSchema;
	}

	public LCCustomerImpartParamsDB getDB()
	{
		LCCustomerImpartParamsDB aDBOper = new LCCustomerImpartParamsDB();
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLCCustomerImpartParams>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			ImpartCode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 5, SysConst.PACKAGESPILTER );
			...
			CustomerNoType = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 8, SysConst.PACKAGESPILTER );
			ImpartParamNo = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 9, SysConst.PACKAGESPILTER );
			ImpartParamName = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 10, SysConst.PACKAGESPILTER );
			ImpartParam = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 11, SysConst.PACKAGESPILTER );
			...
			PatchNo= new Integer(ChgData.chgNumericStr(StrTool.getStr(strMessage,17,SysConst.PACKAGESPILTER))).intValue();
		}
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LCCustomerImpartParamsSchema other = (LCCustomerImpartParamsSchema)otherObject;
		return
