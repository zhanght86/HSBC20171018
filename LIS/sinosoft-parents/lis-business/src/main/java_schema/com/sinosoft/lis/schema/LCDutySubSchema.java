...
import com.sinosoft.lis.db.LCDutySubDB;

/*
 * <p>ClassName: LCDutySubSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 新单管理
 */
public class LCDutySubSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LCDutySubSchema.class);
	// @Field
	/** 业务类型 */
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LCDutySubSchema cloned = (LCDutySubSchema)super.clone();
	...
	/**
	* 使用另外一个 LCDutySubSchema 对象给 Schema 赋值
	* @param: aLCDutySubSchema LCDutySubSchema
	**/
	public void setSchema(LCDutySubSchema aLCDutySubSchema)
	{
		this.BussType = aLCDutySubSchema.getBussType();
		this.BussNo = aLCDutySubSchema.getBussNo();
		this.ContNo = aLCDutySubSchema.getContNo();
		this.PolNo = aLCDutySubSchema.getPolNo();
		this.OtherNo = aLCDutySubSchema.getOtherNo();
		this.SysPlanCode = aLCDutySubSchema.getSysPlanCode();
		this.PlanCode = aLCDutySubSchema.getPlanCode();
		this.RiskCode = aLCDutySubSchema.getRiskCode();
		this.DutyCode = aLCDutySubSchema.getDutyCode();
		this.P1 = aLCDutySubSchema.getP1();
		this.P2 = aLCDutySubSchema.getP2();
		this.P3 = aLCDutySubSchema.getP3();
		this.P4 = aLCDutySubSchema.getP4();
		this.P5 = aLCDutySubSchema.getP5();
		this.P6 = aLCDutySubSchema.getP6();
		this.P7 = aLCDutySubSchema.getP7();
		this.P8 = aLCDutySubSchema.getP8();
		this.P9 = aLCDutySubSchema.getP9();
		this.P10 = aLCDutySubSchema.getP10();
		this.P11 = aLCDutySubSchema.getP11();
		this.P12 = aLCDutySubSchema.getP12();
		this.P13 = aLCDutySubSchema.getP13();
		this.P14 = aLCDutySubSchema.getP14();
		this.P15 = aLCDutySubSchema.getP15();
		this.P16 = aLCDutySubSchema.getP16();
		this.P17 = aLCDutySubSchema.getP17();
		this.P18 = aLCDutySubSchema.getP18();
		this.P19 = aLCDutySubSchema.getP19();
		this.P20 = aLCDutySubSchema.getP20();
		this.P21 = aLCDutySubSchema.getP21();
		this.P22 = aLCDutySubSchema.getP22();
		this.P23 = aLCDutySubSchema.getP23();
		this.P24 = aLCDutySubSchema.getP24();
		this.P25 = aLCDutySubSchema.getP25();
		this.P26 = aLCDutySubSchema.getP26();
		this.P27 = aLCDutySubSchema.getP27();
		this.P28 = aLCDutySubSchema.getP28();
		this.P29 = aLCDutySubSchema.getP29();
		this.P30 = aLCDutySubSchema.getP30();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LCDutySub表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LCDutySubSchema";
	...
	public LCDutySubSchema getSchema()
	{
		LCDutySubSchema aLCDutySubSchema = new LCDutySubSchema();
		aLCDutySubSchema.setSchema(this);
		return aLCDutySubSchema;
	}

	public LCDutySubDB getDB()
	{
		LCDutySubDB aDBOper = new LCDutySubDB();
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLCDutySub>历史记账凭证主表信息</A>表字段
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LCDutySubSchema other = (LCDutySubSchema)otherObject;
		return
