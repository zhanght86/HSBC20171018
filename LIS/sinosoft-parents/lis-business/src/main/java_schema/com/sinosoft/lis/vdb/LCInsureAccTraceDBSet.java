...
/*
 * <p>ClassName: LCInsureAccTraceDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 承保核心
 */
public class LCInsureAccTraceDBSet extends LCInsureAccTraceSet
{
	// @Field
	...
	**/
	...
	// @Constructor
	public LCInsureAccTraceDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LCInsureAccTraceDBSet";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getInvestType() == null || this.get(i).getInvestType().equals("null")) {
				...
				pstmt.setString(33, this.get(i).getInvestType());
			}
			pstmt.setDouble(34, this.get(i).getUnitCountPrice());
			pstmt.setDouble(35, this.get(i).getPreMoney());
			if(this.get(i).getConfDate() == null || this.get(i).getConfDate().equals("null")) {
				pstmt.setDate(36,null);
			} else {
				pstmt.setDate(36, Date.valueOf(this.get(i).getConfDate()));
			}
			if(this.get(i).getAllocationDate() == null || this.get(i).getAllocationDate().equals("null")) {
				pstmt.setDate(37,null);
			} else {
				pstmt.setDate(37, Date.valueOf(this.get(i).getAllocationDate()));
			}
			if(this.get(i).getPricingDate() == null || this.get(i).getPricingDate().equals("null")) {
				pstmt.setDate(38,null);
			} else {
				pstmt.setDate(38, Date.valueOf(this.get(i).getPricingDate()));
			}
