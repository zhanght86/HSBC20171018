...
import com.sinosoft.lis.db.LOReportParamDB;

/*
 * <p>ClassName: LOReportParamSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 后台任务服务
 */
public class LOReportParamSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LOReportParamSchema.class);
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LOReportParamSchema cloned = (LOReportParamSchema)super.clone();
	...
	/**
	* 使用另外一个 LOReportParamSchema 对象给 Schema 赋值
	* @param: aLOReportParamSchema LOReportParamSchema
	**/
	public void setSchema(LOReportParamSchema aLOReportParamSchema)
	{
		this.PrtSeq = aLOReportParamSchema.getPrtSeq();
		this.ParamName = aLOReportParamSchema.getParamName();
		this.ParamValue = aLOReportParamSchema.getParamValue();
		this.Operator = aLOReportParamSchema.getOperator();
		this.MakeDate = fDate.getDate( aLOReportParamSchema.getMakeDate());
		this.MakeTime = aLOReportParamSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLOReportParamSchema.getModifyDate());
		this.ModifyTime = aLOReportParamSchema.getModifyTime();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LOReportParam表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LOReportParamSchema";
	...
	public LOReportParamSchema getSchema()
	{
		LOReportParamSchema aLOReportParamSchema = new LOReportParamSchema();
		aLOReportParamSchema.setSchema(this);
		return aLOReportParamSchema;
	}

	public LOReportParamDB getDB()
	{
		LOReportParamDB aDBOper = new LOReportParamDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLOReportParam描述/A>表字段
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLOReportParam>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			ParamName = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 2, SysConst.PACKAGESPILTER );
			ParamValue = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 3, SysConst.PACKAGESPILTER );
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LOReportParamSchema other = (LOReportParamSchema)otherObject;
		return
