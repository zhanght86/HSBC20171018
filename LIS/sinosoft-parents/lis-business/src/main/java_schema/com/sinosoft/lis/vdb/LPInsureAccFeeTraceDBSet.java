...
/*
 * <p>ClassName: LPInsureAccFeeTraceDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: bug2
 */
public class LPInsureAccFeeTraceDBSet extends LPInsureAccFeeTraceSet
{
	// @Field
	...
	**/
	...
	// @Constructor
	public LPInsureAccFeeTraceDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public LPInsureAccFeeTraceDBSet()
	{
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LPInsureAccFeeTraceDBSet";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getPayNo() == null || this.get(i).getPayNo().equals("null")) {
				...
				pstmt.setString(28, this.get(i).getPayNo());
			}
			...
			pstmt.setDouble(38, this.get(i).getNetAmount());
			pstmt.setDouble(39, this.get(i).getTaxAmount());
			pstmt.setDouble(40, this.get(i).getTax());
			// set where condition
			if(this.get(i).getSerialNo() == null || this.get(i).getSerialNo().equals("null")) {
