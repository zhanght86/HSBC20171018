...
/*
 * <p>ClassName: LLPrepayUWClaimDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 理赔管理
 */
public class LLPrepayUWClaimDBSet extends LLPrepayUWClaimSet
{
private static Logger logger = Logger.getLogger(LLPrepayUWClaimDBSet.class);
	...
	**/
	...
	// @Constructor
	public LLPrepayUWClaimDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LLPrepayUWClaimDBSet";
...
ex.printStackTrace();
	...
	public boolean update()
	{
		...
		try
		{
			...
			pstmt.setDouble(5, this.get(i).getPrepaySum());
