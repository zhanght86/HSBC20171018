...
/*
 * <p>ClassName: PD_LACommissionRateDB </p>
 * <p>Description: DB层数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: PD_LACommissionRate
 */
public class PD_LACommissionRateDB extends PD_LACommissionRateSchema
{
	// @Field
	...
	**/
	...
	// @Constructor
	public PD_LACommissionRateDB( Connection tConnection )
	{
		con = tConnection;
	...
	{
		PD_LACommissionRateSchema tSchema = this.getSchema();
		...
		else
		{
			...
			tError.moduleName = "PD_LACommissionRateDB";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.getIDNo() == null || this.getIDNo().equals("null")) {
				...
				pstmt.setString(36, this.getIDNo());
			}
			pstmt.executeUpdate();
			pstmt.close();
		} catch (Exception ex) {
	...
	public boolean getInfo()
	{
		...
		try
		{
			pstmt = con.prepareStatement("SELECT * FROM PD_LACommissionRate WHERE  IDNo = ?", 
	...
	public PD_LACommissionRateSet query()
	{
		Statement stmt = null;
		ResultSet rs = null;
		PD_LACommissionRateSet aPD_LACommissionRateSet = new PD_LACommissionRateSet();
	  ...
	  if( !mflag ) {
		...
		try
		{
			...
			SQLString sqlObj = new SQLString("PD_LACommissionRate");
			PD_LACommissionRateSchema aSchema = this.getSchema();
			...
			{
				i++;
				PD_LACommissionRateSchema s1 = new PD_LACommissionRateSchema();
				s1.setSchema(rs,i);
				aPD_LACommissionRateSet.add(s1);
			}
			try{ rs.close(); } catch( Exception ex ) {}
		...
		return aPD_LACommissionRateSet;
	}

	public PD_LACommissionRateSet executeQuery(SQLwithBindVariables sqlbv) {
	...
	public PD_LACommissionRateSet executeQuery(String sql)
	{
		Statement stmt = null;
		ResultSet rs = null;
		PD_LACommissionRateSet aPD_LACommissionRateSet = new PD_LACommissionRateSet();
	...
	public PD_LACommissionRateSet query(int nStart, int nCount)
	{
		Statement stmt = null;
		ResultSet rs = null;
		PD_LACommissionRateSet aPD_LACommissionRateSet = new PD_LACommissionRateSet();
	...
	public PD_LACommissionRateSet executeQuery(String sql, int nStart, int nCount)
	{
		Statement stmt = null;
		ResultSet rs = null;
		PD_LACommissionRateSet aPD_LACommissionRateSet = new PD_LACommissionRateSet();
	...
	public boolean update(String strWherePart)
	{
	  ...
	  if( !mflag ) {
		...
		try
		{
			...
			String sql = "update PD_LACommissionRate " + sqlObj.getUpdPart() + " where " + strWherePart;
...
/**
 * 获取定量数据
 * @return PD_LACommissionRateSet
 */
public PD_LACommissionRateSet getData()
{
    int tCount = 0;
    PD_LACommissionRateSet tPD_LACommissionRateSet = new PD_LACommissionRateSet();
    PD_LACommissionRateSchema tPD_LACommissionRateSchema = null;
    if (null == mResultSet)
    {
        CError tError = new CError();
        tError.moduleName = "PD_LACommissionRateDB";
    ...
    {
        tCount = 1;
        tPD_LACommissionRateSchema = new PD_LACommissionRateSchema();
        tPD_LACommissionRateSchema.setSchema(mResultSet, 1);
        tPD_LACommissionRateSet.add(tPD_LACommissionRateSchema);
    ...
    return tPD_LACommissionRateSet;
}
/**
 * 关闭数据集
 * @return boolean
