...
import com.sinosoft.lis.db.PD_LMEdorNetDB;

/**
 * <p>ClassName: PD_LMEdorNetSchema </p>
 ...
 */
public class PD_LMEdorNetSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(PD_LMEdorNetSchema.class);
    ...
    /** 缴费最小期间 */
    private int PayShortYear;
    /** 缴费最大期间 */
    private int PayLongYear;
    /** 操作员 */
    ...
    {
        PD_LMEdorNetSchema cloned = (PD_LMEdorNetSchema)super.clone();
    ...
    public void setNetRate(String aNetRate)
    {
        if (aNetRate != null && !aNetRate.equals(""))
        {
            ...
            NetRate = tDouble.doubleValue();
        }
    }

    public int getPayShortYear()
    {
        return PayShortYear;
    }

    public void setPayShortYear(int aPayShortYear)
    {
        PayShortYear = aPayShortYear;
    }

    public void setPayShortYear(String aPayShortYear)
    {
        if (aPayShortYear != null && !aPayShortYear.equals(""))
        {
            Integer tInteger = new Integer(aPayShortYear);
            int i = tInteger.intValue();
            PayShortYear = i;
        }
    }

    public int getPayLongYear()
    {
        return PayLongYear;
    }

    public void setPayLongYear(int aPayLongYear)
    {
        PayLongYear = aPayLongYear;
    }

    public void setPayLongYear(String aPayLongYear)
    {
        if (aPayLongYear != null && !aPayLongYear.equals(""))
        {
            Integer tInteger = new Integer(aPayLongYear);
            int i = tInteger.intValue();
            PayLongYear = i;
        }
    }
    ...
    /**
     * 使用另外一个 PD_LMEdorNetSchema 对象给 Schema 赋值
     * @param: aPD_LMEdorNetSchema PD_LMEdorNetSchema
     **/
    public void setSchema(PD_LMEdorNetSchema aPD_LMEdorNetSchema)
    {
        this.RiskCode = aPD_LMEdorNetSchema.getRiskCode();
        this.StartYear = aPD_LMEdorNetSchema.getStartYear();
        this.EndYear = aPD_LMEdorNetSchema.getEndYear();
        this.NetRate = aPD_LMEdorNetSchema.getNetRate();
        this.PayShortYear = aPD_LMEdorNetSchema.getPayShortYear();
        this.PayLongYear = aPD_LMEdorNetSchema.getPayLongYear();
        this.Operator = aPD_LMEdorNetSchema.getOperator();
        this.MakeDate = fDate.getDate(aPD_LMEdorNetSchema.getMakeDate());
        this.MakeTime = aPD_LMEdorNetSchema.getMakeTime();
        this.ModifyDate = fDate.getDate(aPD_LMEdorNetSchema.getModifyDate());
        this.ModifyTime = aPD_LMEdorNetSchema.getModifyTime();
        this.Standbyflag1 = aPD_LMEdorNetSchema.getStandbyflag1();
        this.Standbyflag2 = aPD_LMEdorNetSchema.getStandbyflag2();
        this.Standbyflag3 = aPD_LMEdorNetSchema.getStandbyflag3();
        this.Standbyflag4 = aPD_LMEdorNetSchema.getStandbyflag4();
        this.Standbyflag5 = aPD_LMEdorNetSchema.getStandbyflag5();
        this.Standbyflag6 = aPD_LMEdorNetSchema.getStandbyflag6();
    }
    ...
    public boolean setSchema(ResultSet rs, int i)
    {
        try
        {
            ...
            this.StartYear = rs.getDouble(2);
            this.EndYear = rs.getDouble(3);
            this.NetRate = rs.getDouble(4);
            this.PayShortYear = rs.getInt(5);
            this.PayLongYear = rs.getInt(6);
        ...
        {
            logger.debug("数据库中表PD_LMEdorNet字段个数和Schema中的字段个数不一致，或执行db.executeQuery查询时未使用select * from tables");
            // @@错误处理
            CError tError = new CError();
            tError.moduleName = "PD_LMEdorNetSchema";
    ...
    public PD_LMEdorNetSchema getSchema()
    {
        PD_LMEdorNetSchema aPD_LMEdorNetSchema = new PD_LMEdorNetSchema();
        aPD_LMEdorNetSchema.setSchema(this);
        return aPD_LMEdorNetSchema;
    }

    public PD_LMEdorNetDB getDB()
    {
        PD_LMEdorNetDB aDBOper = new PD_LMEdorNetDB();
    ...
    public String encode()
    {
        ...
        strReturn.append(ChgData.chgData(StartYear));
        strReturn.append(SysConst.PACKAGESPILTER);
        strReturn.append(ChgData.chgData(EndYear));
        strReturn.append(SysConst.PACKAGESPILTER);
        strReturn.append(ChgData.chgData(NetRate));
        strReturn.append(SysConst.PACKAGESPILTER);
        strReturn.append(ChgData.chgData(PayShortYear));
        strReturn.append(SysConst.PACKAGESPILTER);
        strReturn.append(ChgData.chgData(PayLongYear));
        strReturn.append(SysConst.PACKAGESPILTER);
    ...
    /**
     * 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpPD_LMEdorNet>历史记账凭证主表信息</A>表字段
    ...
    public boolean decode(String strMessage)
    {
        try
        {
            ...
            StartYear = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage, 2, SysConst.PACKAGESPILTER))).doubleValue();
            EndYear = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage, 3, SysConst.PACKAGESPILTER))).doubleValue();
            NetRate = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage, 4, SysConst.PACKAGESPILTER))).doubleValue();
            PayShortYear = new Integer(ChgData.chgNumericStr(StrTool.getStr(strMessage, 5, SysConst.PACKAGESPILTER))).intValue();
            PayLongYear = new Integer(ChgData.chgNumericStr(StrTool.getStr(strMessage, 6, SysConst.PACKAGESPILTER))).intValue();
    ...
    public String getV(String FCode)
    {
        ...
        if (FCode.equalsIgnoreCase("PayShortYear"))
        {
            strReturn = StrTool.GBKToUnicode(String.valueOf(PayShortYear));
        }
        if (FCode.equalsIgnoreCase("PayLongYear"))
        {
            strReturn = StrTool.GBKToUnicode(String.valueOf(PayLongYear));
        }
    ...
    public String getV(int nFieldIndex)
    {
        ...
        switch (nFieldIndex)
        {
            ...
            case 3:
                ...
                break;
            case 4:
                strFieldValue = String.valueOf(PayShortYear);
                break;
            case 5:
                strFieldValue = String.valueOf(PayLongYear);
                break;
            case 6:
    ...
    public boolean equals(Object otherObject)
    {
        ...
        if (getClass() != otherObject.getClass())
            return false;
        PD_LMEdorNetSchema other = (PD_LMEdorNetSchema) otherObject;
        return
                ...
                && PayShortYear == other.getPayShortYear()
                && PayLongYear == other.getPayLongYear()
    ...
    public int getFieldIndex(String strFieldName)
    {
        ...
        if (strFieldName.equals("PayShortYear"))
        {
            return 4;
        }
        if (strFieldName.equals("PayLongYear"))
        {
            return 5;
        }
    ...
    public String getFieldName(int nFieldIndex)
    {
        ...
        switch (nFieldIndex)
        {
            ...
            case 3:
                ...
                break;
            case 4:
                strFieldName = "PayShortYear";
                break;
            case 5:
                strFieldName = "PayLongYear";
                break;
            case 6:
