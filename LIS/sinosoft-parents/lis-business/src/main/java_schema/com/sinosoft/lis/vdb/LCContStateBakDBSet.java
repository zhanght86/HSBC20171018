...
/*
 * <p>ClassName: LCContStateBakDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: PhysicalDataModel_1
 */
public class LCContStateBakDBSet extends LCContStateBakSet
{
private static Logger logger = Logger.getLogger(LCContStateBakDBSet.class);
	...
	**/
	...
	// @Constructor
	public LCContStateBakDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LCContStateBakDBSet";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getStateReason() == null || this.get(i).getStateReason().equals("null")) {
				...
				pstmt.setString(6, this.get(i).getStateReason());
			}
			if(this.get(i).getStartDate() == null || this.get(i).getStartDate().equals("null")) {
			...
			if(this.get(i).getStateType() == null || this.get(i).getStateType().equals("null")) {
				...
				pstmt.setString(18, this.get(i).getStateType());
			}
			if(this.get(i).getStartDate() == null || this.get(i).getStartDate().equals("null")) {
