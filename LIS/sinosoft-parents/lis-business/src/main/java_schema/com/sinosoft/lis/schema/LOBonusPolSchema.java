 ...
 * @Database: 分红管理
 */
public class LOBonusPolSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LOBonusPolSchema.class);
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LOBonusPolSchema cloned = (LOBonusPolSchema)super.clone();
	...
	* @param: aLOBonusPolSchema LOBonusPolSchema
	**/
	public void setSchema(LOBonusPolSchema aLOBonusPolSchema)
	{
		...
		this.BonusGetMode = aLOBonusPolSchema.getBonusGetMode();
		this.ValiFlag = aLOBonusPolSchema.getValiFlag();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LOBonusPol表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
