...
/*
 * <p>ClassName: LPCustomerImpartDetailDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 保全核心
 */
public class LPCustomerImpartDetailDBSet extends LPCustomerImpartDetailSet
{
private static Logger logger = Logger.getLogger(LPCustomerImpartDetailDBSet.class);
	...
	**/
	...
	// @Constructor
	public LPCustomerImpartDetailDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public LPCustomerImpartDetailDBSet()
	{
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LPCustomerImpartDetailDBSet";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getSubSerialNo() == null || this.get(i).getSubSerialNo().equals("null")) {
				...
				pstmt.setString(9, this.get(i).getSubSerialNo());
			}
			if(this.get(i).getImpartDetailContent() == null || this.get(i).getImpartDetailContent().equals("null")) {
				pstmt.setString(10,null);
			} else {
				pstmt.setString(10, this.get(i).getImpartDetailContent());
			}
			...
			if(this.get(i).getProposalContNo() == null || this.get(i).getProposalContNo().equals("null")) {
				...
				pstmt.setString(29, this.get(i).getProposalContNo());
			}
			if(this.get(i).getImpartCode() == null || this.get(i).getImpartCode().equals("null")) {
				pstmt.setString(30,null);
			} else {
				pstmt.setString(30, this.get(i).getImpartCode());
			}
			if(this.get(i).getImpartVer() == null || this.get(i).getImpartVer().equals("null")) {
				pstmt.setString(31,null);
			} else {
				pstmt.setString(31, this.get(i).getImpartVer());
			}
			if(this.get(i).getSubSerialNo() == null || this.get(i).getSubSerialNo().equals("null")) {
				pstmt.setString(32,null);
			} else {
				pstmt.setString(32, this.get(i).getSubSerialNo());
			}
