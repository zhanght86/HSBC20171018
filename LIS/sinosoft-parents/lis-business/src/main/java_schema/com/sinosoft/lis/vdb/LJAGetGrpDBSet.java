...
/*
 * <p>ClassName: LJAGetGrpDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: Physical Data Model 1
 */
public class LJAGetGrpDBSet extends LJAGetGrpSet
{
	// @Field
	...
	**/
	...
	// @Constructor
	public LJAGetGrpDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LJAGetGrpDBSet";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getGetNoticeNo() == null || this.get(i).getGetNoticeNo().equals("null")) {
				...
				pstmt.setString(13, this.get(i).getGetNoticeNo());
			}
			...
			if(this.get(i).getActuGetNo() == null || this.get(i).getActuGetNo().equals("null")) {
				...
				pstmt.setString(22, this.get(i).getActuGetNo());
			}
			if(this.get(i).getGrpPolNo() == null || this.get(i).getGrpPolNo().equals("null")) {
