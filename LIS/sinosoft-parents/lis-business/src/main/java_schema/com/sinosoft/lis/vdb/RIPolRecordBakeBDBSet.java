...
/*
 * <p>ClassName: RIPolRecordBakeBDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 再保系统模型
 */
public class RIPolRecordBakeBDBSet extends RIPolRecordBakeBSet
{
	// @Field
	...
	**/
	...
	// @Constructor
	public RIPolRecordBakeBDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "RIPolRecordBakeBDBSet";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getGrpProposalNo() == null || this.get(i).getGrpProposalNo().equals("null")) {
				...
				pstmt.setString(12, this.get(i).getGrpProposalNo());
			}
			...
			if(this.get(i).getProposalNo() == null || this.get(i).getProposalNo().equals("null")) {
				...
				pstmt.setString(15, this.get(i).getProposalNo());
			}
			if(this.get(i).getContPlanCode() == null || this.get(i).getContPlanCode().equals("null")) {
				pstmt.setString(16,null);
			} else {
				pstmt.setString(16, this.get(i).getContPlanCode());
			}
			...
			if(this.get(i).getRiskPeriod() == null || this.get(i).getRiskPeriod().equals("null")) {
				...
				pstmt.setString(18, this.get(i).getRiskPeriod());
			}
			if(this.get(i).getRiskType() == null || this.get(i).getRiskType().equals("null")) {
				pstmt.setString(19,null);
			} else {
				pstmt.setString(19, this.get(i).getRiskType());
			}
			...
			pstmt.setInt(22, this.get(i).getYears());
			pstmt.setInt(23, this.get(i).getInsuredYear());
			...
			if(this.get(i).getInsuredNo() == null || this.get(i).getInsuredNo().equals("null")) {
				...
				pstmt.setString(27, this.get(i).getInsuredNo());
			}
			if(this.get(i).getInsuredName() == null || this.get(i).getInsuredName().equals("null")) {
				pstmt.setString(28,null);
			} else {
				pstmt.setString(28, this.get(i).getInsuredName());
			}
			if(this.get(i).getInsuredSex() == null || this.get(i).getInsuredSex().equals("null")) {
				pstmt.setString(29,null);
			} else {
				pstmt.setString(29, this.get(i).getInsuredSex());
			}
			if(this.get(i).getInsuredBirthday() == null || this.get(i).getInsuredBirthday().equals("null")) {
				pstmt.setDate(30,null);
			} else {
				pstmt.setDate(30, Date.valueOf(this.get(i).getInsuredBirthday()));
			}
			pstmt.setInt(31, this.get(i).getInsuredAge());
			pstmt.setInt(32, this.get(i).getCurrentAge());
			...
			if(this.get(i).getHealthTime1() == null || this.get(i).getHealthTime1().equals("null")) {
				...
				pstmt.setString(36, this.get(i).getHealthTime1());
			}
			if(this.get(i).getHealthTime2() == null || this.get(i).getHealthTime2().equals("null")) {
				pstmt.setString(37,null);
			} else {
				pstmt.setString(37, this.get(i).getHealthTime2());
			}
			if(this.get(i).getOccupationCode() == null || this.get(i).getOccupationCode().equals("null")) {
				pstmt.setString(38,null);
			} else {
				pstmt.setString(38, this.get(i).getOccupationCode());
			}
			if(this.get(i).getSuppRiskScore() == null || this.get(i).getSuppRiskScore().equals("null")) {
				pstmt.setString(39,null);
			} else {
				pstmt.setString(39, this.get(i).getSuppRiskScore());
			}
			if(this.get(i).getSmokeFlag() == null || this.get(i).getSmokeFlag().equals("null")) {
				pstmt.setString(40,null);
			} else {
				pstmt.setString(40, this.get(i).getSmokeFlag());
			}
			pstmt.setDouble(41, this.get(i).getAdditionalRate());
			if(this.get(i).getExtType() == null || this.get(i).getExtType().equals("null")) {
				pstmt.setString(42,null);
			} else {
				pstmt.setString(42, this.get(i).getExtType());
			}
			pstmt.setDouble(43, this.get(i).getExtPrem());
			pstmt.setDouble(44, this.get(i).getBegAccountValue());
			pstmt.setInt(45, this.get(i).getEndUnit());
			pstmt.setDouble(46, this.get(i).getEndPrice());
			pstmt.setDouble(47, this.get(i).getEndAccountValue());
			if(this.get(i).getFeeType() == null || this.get(i).getFeeType().equals("null")) {
				pstmt.setString(48,null);
			} else {
				pstmt.setString(48, this.get(i).getFeeType());
			}
			pstmt.setDouble(49, this.get(i).getFeeMoney());
			if(this.get(i).getNonCashFlag() == null || this.get(i).getNonCashFlag().equals("null")) {
				pstmt.setString(50,null);
			} else {
				pstmt.setString(50, this.get(i).getNonCashFlag());
			}
			pstmt.setDouble(51, this.get(i).getStandPrem());
			pstmt.setDouble(52, this.get(i).getPrem());
			pstmt.setDouble(53, this.get(i).getAmnt());
			pstmt.setDouble(54, this.get(i).getMult());
			pstmt.setDouble(55, this.get(i).getReserve());
			pstmt.setDouble(56, this.get(i).getAPE());
			pstmt.setDouble(57, this.get(i).getCSV());
			pstmt.setDouble(58, this.get(i).getRetention());
			pstmt.setDouble(59, this.get(i).getSuminsured());
			pstmt.setDouble(60, this.get(i).getFaceamount());
			if(this.get(i).getCurrency() == null || this.get(i).getCurrency().equals("null")) {
				pstmt.setString(61,null);
			} else {
				pstmt.setString(61, this.get(i).getCurrency());
			}
			pstmt.setDouble(62, this.get(i).getRiskAmnt());
			pstmt.setInt(63, this.get(i).getPayIntv());
			pstmt.setInt(64, this.get(i).getPayYears());
			if(this.get(i).getPayEndYearFlag() == null || this.get(i).getPayEndYearFlag().equals("null")) {
				pstmt.setString(65,null);
			} else {
				pstmt.setString(65, this.get(i).getPayEndYearFlag());
			}
			pstmt.setInt(66, this.get(i).getPayEndYear());
			if(this.get(i).getGetYearFlag() == null || this.get(i).getGetYearFlag().equals("null")) {
				pstmt.setString(67,null);
			} else {
				pstmt.setString(67, this.get(i).getGetYearFlag());
			}
			pstmt.setInt(68, this.get(i).getGetYear());
			if(this.get(i).getInsuYearFlag() == null || this.get(i).getInsuYearFlag().equals("null")) {
				pstmt.setString(69,null);
			} else {
				pstmt.setString(69, this.get(i).getInsuYearFlag());
			}
			pstmt.setInt(70, this.get(i).getInsuYear());
			if(this.get(i).getAcciYearFlag() == null || this.get(i).getAcciYearFlag().equals("null")) {
				pstmt.setString(71,null);
			} else {
				pstmt.setString(71, this.get(i).getAcciYearFlag());
			}
			pstmt.setInt(72, this.get(i).getAcciYear());
			if(this.get(i).getAcciEndDate() == null || this.get(i).getAcciEndDate().equals("null")) {
				pstmt.setDate(73,null);
			} else {
				pstmt.setDate(73, Date.valueOf(this.get(i).getAcciEndDate()));
			}
			...
			if(this.get(i).getGetStartType() == null || this.get(i).getGetStartType().equals("null")) {
				...
				pstmt.setString(75, this.get(i).getGetStartType());
			}
			pstmt.setDouble(76, this.get(i).getPeakLine());
			pstmt.setDouble(77, this.get(i).getGetLimit());
			pstmt.setInt(78, this.get(i).getGetIntv());
			if(this.get(i).getPayNo() == null || this.get(i).getPayNo().equals("null")) {
				pstmt.setString(79,null);
			} else {
				pstmt.setString(79, this.get(i).getPayNo());
			}
			pstmt.setInt(80, this.get(i).getPayCount());
			pstmt.setDouble(81, this.get(i).getPayMoney());
			if(this.get(i).getLastPayToDate() == null || this.get(i).getLastPayToDate().equals("null")) {
				pstmt.setDate(82,null);
			} else {
				pstmt.setDate(82, Date.valueOf(this.get(i).getLastPayToDate()));
			}
			if(this.get(i).getCurPayToDate() == null || this.get(i).getCurPayToDate().equals("null")) {
				pstmt.setDate(83,null);
			} else {
				pstmt.setDate(83, Date.valueOf(this.get(i).getCurPayToDate()));
			}
			...
			if(this.get(i).getFeeOperationType() == null || this.get(i).getFeeOperationType().equals("null")) {
				...
				pstmt.setString(85, this.get(i).getFeeOperationType());
			}
			if(this.get(i).getFeeFinaType() == null || this.get(i).getFeeFinaType().equals("null")) {
				pstmt.setString(86,null);
			} else {
				pstmt.setString(86, this.get(i).getFeeFinaType());
			}
			pstmt.setDouble(87, this.get(i).getChangeRate());
			if(this.get(i).getAccCurrency() == null || this.get(i).getAccCurrency().equals("null")) {
				pstmt.setString(88,null);
			} else {
				pstmt.setString(88, this.get(i).getAccCurrency());
			}
			pstmt.setDouble(89, this.get(i).getAccAmnt());
			pstmt.setDouble(90, this.get(i).getPreStandPrem());
			pstmt.setDouble(91, this.get(i).getPrePrem());
			pstmt.setDouble(92, this.get(i).getPreRiskAmnt());
			pstmt.setDouble(93, this.get(i).getPreAmnt());
			if(this.get(i).getClmNo() == null || this.get(i).getClmNo().equals("null")) {
				pstmt.setString(94,null);
			} else {
				pstmt.setString(94, this.get(i).getClmNo());
			}
			if(this.get(i).getClmFeeOperationType() == null || this.get(i).getClmFeeOperationType().equals("null")) {
				pstmt.setString(95,null);
			} else {
				pstmt.setString(95, this.get(i).getClmFeeOperationType());
			}
			if(this.get(i).getClmFeeFinaType() == null || this.get(i).getClmFeeFinaType().equals("null")) {
				pstmt.setString(96,null);
			} else {
				pstmt.setString(96, this.get(i).getClmFeeFinaType());
			}
			pstmt.setDouble(97, this.get(i).getStandGetMoney());
			pstmt.setDouble(98, this.get(i).getGetRate());
			pstmt.setDouble(99, this.get(i).getClmGetMoney());
			if(this.get(i).getAccDate() == null || this.get(i).getAccDate().equals("null")) {
				pstmt.setDate(100,null);
			} else {
				pstmt.setDate(100, Date.valueOf(this.get(i).getAccDate()));
			}
			if(this.get(i).getAccumulateDefNO() == null || this.get(i).getAccumulateDefNO().equals("null")) {
				pstmt.setString(101,null);
			} else {
				pstmt.setString(101, this.get(i).getAccumulateDefNO());
			}
			if(this.get(i).getRIContNo() == null || this.get(i).getRIContNo().equals("null")) {
				pstmt.setString(102,null);
			} else {
				pstmt.setString(102, this.get(i).getRIContNo());
			}
			if(this.get(i).getRIPreceptNo() == null || this.get(i).getRIPreceptNo().equals("null")) {
				pstmt.setString(103,null);
			} else {
				pstmt.setString(103, this.get(i).getRIPreceptNo());
			}
			if(this.get(i).getReinsreFlag() == null || this.get(i).getReinsreFlag().equals("null")) {
				pstmt.setString(104,null);
			} else {
				pstmt.setString(104, this.get(i).getReinsreFlag());
			}
			if(this.get(i).getGetDate() == null || this.get(i).getGetDate().equals("null")) {
				pstmt.setDate(105,null);
			} else {
				pstmt.setDate(105, Date.valueOf(this.get(i).getGetDate()));
			}
			if(this.get(i).getStandbyString1() == null || this.get(i).getStandbyString1().equals("null")) {
				pstmt.setString(106,null);
			} else {
				pstmt.setString(106, this.get(i).getStandbyString1());
			}
			if(this.get(i).getStandbyString2() == null || this.get(i).getStandbyString2().equals("null")) {
				pstmt.setString(107,null);
			} else {
				pstmt.setString(107, this.get(i).getStandbyString2());
			}
			if(this.get(i).getStandbyString3() == null || this.get(i).getStandbyString3().equals("null")) {
				pstmt.setString(108,null);
			} else {
				pstmt.setString(108, this.get(i).getStandbyString3());
			}
			pstmt.setDouble(109, this.get(i).getStandbyDouble1());
			pstmt.setDouble(110, this.get(i).getStandbyDouble2());
			pstmt.setDouble(111, this.get(i).getStandbyDouble3());
			if(this.get(i).getStandbyDate1() == null || this.get(i).getStandbyDate1().equals("null")) {
				pstmt.setDate(112,null);
			} else {
				pstmt.setDate(112, Date.valueOf(this.get(i).getStandbyDate1()));
			}
			if(this.get(i).getStandbyDate2() == null || this.get(i).getStandbyDate2().equals("null")) {
				pstmt.setDate(113,null);
			} else {
				pstmt.setDate(113, Date.valueOf(this.get(i).getStandbyDate2()));
			}
			if(this.get(i).getManageCom() == null || this.get(i).getManageCom().equals("null")) {
				pstmt.setString(114,null);
			} else {
				pstmt.setString(114, this.get(i).getManageCom());
			}
			if(this.get(i).getMakeDate() == null || this.get(i).getMakeDate().equals("null")) {
				pstmt.setDate(115,null);
			} else {
				pstmt.setDate(115, Date.valueOf(this.get(i).getMakeDate()));
			}
			if(this.get(i).getMakeTime() == null || this.get(i).getMakeTime().equals("null")) {
				pstmt.setString(116,null);
			} else {
				pstmt.setString(116, this.get(i).getMakeTime());
			}
			pstmt.setDouble(117, this.get(i).getPreChRiskAmnt());
			pstmt.setDouble(118, this.get(i).getChRiskAmnt());
			pstmt.setDouble(119, this.get(i).getPreChangeRate());
			if(this.get(i).getMainPolNo() == null || this.get(i).getMainPolNo().equals("null")) {
				pstmt.setString(120,null);
			} else {
				pstmt.setString(120, this.get(i).getMainPolNo());
			}
			if(this.get(i).getRIPreceptType() == null || this.get(i).getRIPreceptType().equals("null")) {
				pstmt.setString(121,null);
			} else {
				pstmt.setString(121, this.get(i).getRIPreceptType());
			}
			if(this.get(i).getBFFlag() == null || this.get(i).getBFFlag().equals("null")) {
				pstmt.setString(122,null);
			} else {
				pstmt.setString(122, this.get(i).getBFFlag());
			}
			pstmt.setDouble(123, this.get(i).getEdorPrem());
			pstmt.setDouble(124, this.get(i).getChEdorPrem());
			pstmt.setDouble(125, this.get(i).getChPrem());
			pstmt.setDouble(126, this.get(i).getBonus1());
			pstmt.setDouble(127, this.get(i).getBonus2());
			pstmt.setDouble(128, this.get(i).getBonus3());
			pstmt.setDouble(129, this.get(i).getExtRate1());
			pstmt.setDouble(130, this.get(i).getExtRate2());
			pstmt.setDouble(131, this.get(i).getExtRate3());
			pstmt.setDouble(132, this.get(i).getExtPrem1());
			pstmt.setDouble(133, this.get(i).getExtPrem2());
			pstmt.setDouble(134, this.get(i).getExtPrem3());
			if(this.get(i).getStandbyString4() == null || this.get(i).getStandbyString4().equals("null")) {
				pstmt.setString(135,null);
			} else {
				pstmt.setString(135, this.get(i).getStandbyString4());
			}
			if(this.get(i).getStandbyString5() == null || this.get(i).getStandbyString5().equals("null")) {
				pstmt.setString(136,null);
			} else {
				pstmt.setString(136, this.get(i).getStandbyString5());
			}
			if(this.get(i).getStandbyString6() == null || this.get(i).getStandbyString6().equals("null")) {
				pstmt.setString(137,null);
			} else {
				pstmt.setString(137, this.get(i).getStandbyString6());
			}
			if(this.get(i).getStandbyString7() == null || this.get(i).getStandbyString7().equals("null")) {
				pstmt.setString(138,null);
			} else {
				pstmt.setString(138, this.get(i).getStandbyString7());
			}
			if(this.get(i).getStandbyString8() == null || this.get(i).getStandbyString8().equals("null")) {
				pstmt.setString(139,null);
			} else {
				pstmt.setString(139, this.get(i).getStandbyString8());
			}
			if(this.get(i).getStandbyString9() == null || this.get(i).getStandbyString9().equals("null")) {
				pstmt.setString(140,null);
			} else {
				pstmt.setString(140, this.get(i).getStandbyString9());
			}
			pstmt.setDouble(141, this.get(i).getStandbyDouble4());
			pstmt.setDouble(142, this.get(i).getStandbyDouble5());
			pstmt.setDouble(143, this.get(i).getStandbyDouble6());
			pstmt.setDouble(144, this.get(i).getStandbyDouble7());
			pstmt.setDouble(145, this.get(i).getStandbyDouble8());
			pstmt.setDouble(146, this.get(i).getStandbyDouble9());
			if(this.get(i).getStandbyDate3() == null || this.get(i).getStandbyDate3().equals("null")) {
				pstmt.setDate(147,null);
			} else {
				pstmt.setDate(147, Date.valueOf(this.get(i).getStandbyDate3()));
			}
			if(this.get(i).getStandbyDate4() == null || this.get(i).getStandbyDate4().equals("null")) {
				pstmt.setDate(148,null);
			} else {
				pstmt.setDate(148, Date.valueOf(this.get(i).getStandbyDate4()));
			}
			if(this.get(i).getStandbyDate5() == null || this.get(i).getStandbyDate5().equals("null")) {
				pstmt.setDate(149,null);
			} else {
				pstmt.setDate(149, Date.valueOf(this.get(i).getStandbyDate5()));
			}
			// set where condition
			if(this.get(i).getBakeSerialNo() == null || this.get(i).getBakeSerialNo().equals("null")) {
				pstmt.setString(150,null);
			} else {
				pstmt.setString(150, this.get(i).getBakeSerialNo());
			}
			if(this.get(i).getEventNo() == null || this.get(i).getEventNo().equals("null")) {
				pstmt.setString(151,null);
			} else {
				pstmt.setString(151, this.get(i).getEventNo());
			}
