...
public class LCInsureAccDB extends LCInsureAccSchema
{
	...
	**/
	...
	public boolean getInfo()
	{
		...
		try
		{
			pstmt = con.prepareStatement("SELECT * FROM LCInsureAcc WHERE  PolNo = ? AND InsuAccNo = ?", 
...
public LCInsureAccSet getData()
{
    ...
    try
    {
        ...
        tLCInsureAccSchema.setSchema(mResultSet, 1);
...
public boolean closeData()
{
	...
	public LCInsureAccSet executeQuery(SQLwithBindVariables sqlbv) {
	...
	public LCInsureAccSet executeQuery(SQLwithBindVariables sqlbv, int nStart, int nCount) {
