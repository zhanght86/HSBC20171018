...
/*
 * <p>ClassName: LQBenefitToRiskSchema </p>
 ...
 */
public class LQBenefitToRiskSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LQBenefitToRiskSchema.class);
	...
	public LQBenefitToRiskSchema()
	{
		...
		PK = pk;
            ...
            public Object clone()
                    throws CloneNotSupportedException
            {
                LQBenefitToRiskSchema cloned = (LQBenefitToRiskSchema)super.clone();
	...
	/**
	* 使用另外一个 LQBenefitToRiskSchema 对象给 Schema 赋值
	* @param: aLQBenefitToRiskSchema LQBenefitToRiskSchema
	**/
	public void setSchema(LQBenefitToRiskSchema aLQBenefitToRiskSchema)
	{
		this.AskPriceNo = aLQBenefitToRiskSchema.getAskPriceNo();
		this.AskNo = aLQBenefitToRiskSchema.getAskNo();
		this.MainRiskCode = aLQBenefitToRiskSchema.getMainRiskCode();
		this.MainRiskVersion = aLQBenefitToRiskSchema.getMainRiskVersion();
		this.RiskCode = aLQBenefitToRiskSchema.getRiskCode();
		this.RiskVersion = aLQBenefitToRiskSchema.getRiskVersion();
		this.ContPlanCode = aLQBenefitToRiskSchema.getContPlanCode();
		this.ContPlanName = aLQBenefitToRiskSchema.getContPlanName();
		this.Remark = aLQBenefitToRiskSchema.getRemark();
		this.Operator = aLQBenefitToRiskSchema.getOperator();
		this.MakeDate = fDate.getDate( aLQBenefitToRiskSchema.getMakeDate());
		this.MakeTime = aLQBenefitToRiskSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLQBenefitToRiskSchema.getModifyDate());
		this.ModifyTime = aLQBenefitToRiskSchema.getModifyTime();
		this.PlanType = aLQBenefitToRiskSchema.getPlanType();
		this.RiskPrem = aLQBenefitToRiskSchema.getRiskPrem();
		this.SysContPlanCode = aLQBenefitToRiskSchema.getSysContPlanCode();
		this.SysContPlanMult = aLQBenefitToRiskSchema.getSysContPlanMult();
		this.SysContPlanRate = aLQBenefitToRiskSchema.getSysContPlanRate();
		this.Currency = aLQBenefitToRiskSchema.getCurrency();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LQBenefitToRisk表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LQBenefitToRiskSchema";
	...
	public LQBenefitToRiskSchema getSchema()
	{
		LQBenefitToRiskSchema aLQBenefitToRiskSchema = new LQBenefitToRiskSchema();
		aLQBenefitToRiskSchema.setSchema(this);
		return aLQBenefitToRiskSchema;
	}

	public LQBenefitToRiskDB getDB()
	{
		LQBenefitToRiskDB aDBOper = new LQBenefitToRiskDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLQBenefitToRisk描述/A>表字段
...
strReturn.append(StrTool.cTrim(Currency));
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLQBenefitToRisk>历史记账凭证主表信息</A>表字段
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LQBenefitToRiskSchema other = (LQBenefitToRiskSchema)otherObject;
		return
