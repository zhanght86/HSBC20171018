...
/*
 * <p>ClassName: LCGeneralSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 承保核心
 */
public class LCGeneralSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LCGeneralSchema.class);
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LCGeneralSchema cloned = (LCGeneralSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LCGeneralSchema 对象给 Schema 赋值
	* @param: aLCGeneralSchema LCGeneralSchema
	**/
	public void setSchema(LCGeneralSchema aLCGeneralSchema)
	{
		this.GrpContNo = aLCGeneralSchema.getGrpContNo();
		this.PrtNo = aLCGeneralSchema.getPrtNo();
		this.ExecuteCom = aLCGeneralSchema.getExecuteCom();
		this.ManageCom = aLCGeneralSchema.getManageCom();
		this.CustomerNo = aLCGeneralSchema.getCustomerNo();
		this.AddressNo = aLCGeneralSchema.getAddressNo();
		this.EmployeePeoples = aLCGeneralSchema.getEmployeePeoples();
		this.RelationPepoles = aLCGeneralSchema.getRelationPepoles();
		this.IsPayManageCom = aLCGeneralSchema.getIsPayManageCom();
		this.Operator = aLCGeneralSchema.getOperator();
		this.MakeDate = fDate.getDate( aLCGeneralSchema.getMakeDate());
		this.MakeTime = aLCGeneralSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLCGeneralSchema.getModifyDate());
		this.ModifyTime = aLCGeneralSchema.getModifyTime();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LCGeneral表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LCGeneralSchema";
	...
	public LCGeneralSchema getSchema()
	{
		LCGeneralSchema aLCGeneralSchema = new LCGeneralSchema();
		aLCGeneralSchema.setSchema(this);
		return aLCGeneralSchema;
	}

	public LCGeneralDB getDB()
	{
		LCGeneralDB aDBOper = new LCGeneralDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLCGeneral描述/A>表字段
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLCGeneral>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			EmployeePeoples= new Integer(ChgData.chgNumericStr(StrTool.getStr(strMessage,7,SysConst.PACKAGESPILTER))).intValue();
			RelationPepoles= new Integer(ChgData.chgNumericStr(StrTool.getStr(strMessage,8,SysConst.PACKAGESPILTER))).intValue();
			IsPayManageCom = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 9, SysConst.PACKAGESPILTER );
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LCGeneralSchema other = (LCGeneralSchema)otherObject;
		return
