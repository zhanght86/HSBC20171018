...
import com.sinosoft.lis.db.LPContPlanInvestDB;

/*
 * <p>ClassName: LPContPlanInvestSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: Physical Data Model 1
 */
public class LPContPlanInvestSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LPContPlanInvestSchema.class);
	// @Field
	/** 保全批单号 */
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LPContPlanInvestSchema cloned = (LPContPlanInvestSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LPContPlanInvestSchema 对象给 Schema 赋值
	* @param: aLPContPlanInvestSchema LPContPlanInvestSchema
	**/
	public void setSchema(LPContPlanInvestSchema aLPContPlanInvestSchema)
	{
		this.EdorNo = aLPContPlanInvestSchema.getEdorNo();
		this.EdorType = aLPContPlanInvestSchema.getEdorType();
		this.PolicyNo = aLPContPlanInvestSchema.getPolicyNo();
		this.SysPlanCode = aLPContPlanInvestSchema.getSysPlanCode();
		this.PlanCode = aLPContPlanInvestSchema.getPlanCode();
		this.RiskCode = aLPContPlanInvestSchema.getRiskCode();
		this.DutyCode = aLPContPlanInvestSchema.getDutyCode();
		this.PayPlanCode = aLPContPlanInvestSchema.getPayPlanCode();
		this.PayMoney = aLPContPlanInvestSchema.getPayMoney();
		this.Segment1 = aLPContPlanInvestSchema.getSegment1();
		this.Segment2 = aLPContPlanInvestSchema.getSegment2();
		this.Segment3 = aLPContPlanInvestSchema.getSegment3();
		this.Segment4 = aLPContPlanInvestSchema.getSegment4();
		this.MakeOperator = aLPContPlanInvestSchema.getMakeOperator();
		this.MakeDate = fDate.getDate( aLPContPlanInvestSchema.getMakeDate());
		this.MakeTime = aLPContPlanInvestSchema.getMakeTime();
		this.ModifyOperator = aLPContPlanInvestSchema.getModifyOperator();
		this.ModifyDate = fDate.getDate( aLPContPlanInvestSchema.getModifyDate());
		this.ModifyTime = aLPContPlanInvestSchema.getModifyTime();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LPContPlanInvest表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LPContPlanInvestSchema";
	...
	public LPContPlanInvestSchema getSchema()
	{
		LPContPlanInvestSchema aLPContPlanInvestSchema = new LPContPlanInvestSchema();
		aLPContPlanInvestSchema.setSchema(this);
		return aLPContPlanInvestSchema;
	}

	public LPContPlanInvestDB getDB()
	{
		LPContPlanInvestDB aDBOper = new LPContPlanInvestDB();
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLPContPlanInvest>历史记账凭证主表信息</A>表字段
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LPContPlanInvestSchema other = (LPContPlanInvestSchema)otherObject;
		return
