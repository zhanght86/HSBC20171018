...
/*
 * <p>ClassName: LJSGetGrpDB </p>
 * <p>Description: DB层数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: Physical Data Model 1
 */
public class LJSGetGrpDB extends LJSGetGrpSchema
{
	// @Field
	...
	**/
	...
	// @Constructor
	public LJSGetGrpDB( Connection tConnection )
	{
		con = tConnection;
	...
	{
		LJSGetGrpSchema tSchema = this.getSchema();
	...
	public boolean getInfo()
	{
		...
		try
		{
			pstmt = con.prepareStatement("SELECT * FROM LJSGetGrp WHERE  GetNoticeNo = ? AND GrpPolNo = ?", 
	...
	public LJSGetGrpSet query()
	{
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		LJSGetGrpSet aLJSGetGrpSet = new LJSGetGrpSet();
	  ...
	  if( !mflag ) {
		...
		{
			SQLString sqlObj = new SQLString("LJSGetGrp");
			LJSGetGrpSchema aSchema = this.getSchema();
			...
			{
				i++;
				LJSGetGrpSchema s1 = new LJSGetGrpSchema();
				s1.setSchema(rs,i);
				aLJSGetGrpSet.add(s1);
			}
			try{ rs.close(); } catch( Exception ex ) {}
			try{ pstmt.close(); } catch( Exception ex1 ) {}
		}
		...
		return aLJSGetGrpSet;
	}

	public LJSGetGrpSet executeQuery(String sql)
	{
		Statement stmt = null;
		ResultSet rs = null;
		LJSGetGrpSet aLJSGetGrpSet = new LJSGetGrpSet();
	...
	public LJSGetGrpSet query(int nStart, int nCount)
	{
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		LJSGetGrpSet aLJSGetGrpSet = new LJSGetGrpSet();
	...
	public LJSGetGrpSet executeQuery(String sql, int nStart, int nCount)
	{
		Statement stmt = null;
		ResultSet rs = null;
		LJSGetGrpSet aLJSGetGrpSet = new LJSGetGrpSet();
	...
	public boolean update(String strWherePart)
	{
	  ...
	  if( !mflag ) {
		...
		try
		{
			...
			String sql = "update LJSGetGrp " + sqlObj.getUpdPart() + " where " + strWherePart;
 ...
 * @return LJSGetGrpSet
 */
public LJSGetGrpSet getData()
{
    int tCount = 0;
    LJSGetGrpSet tLJSGetGrpSet = new LJSGetGrpSet();
    LJSGetGrpSchema tLJSGetGrpSchema = null;
    if (null == mResultSet)
    {
        CError tError = new CError();
        tError.moduleName = "LJSGetGrpDB";
    ...
    {
        tCount = 1;
        tLJSGetGrpSchema = new LJSGetGrpSchema();
        tLJSGetGrpSchema.setSchema(mResultSet, 1);
        tLJSGetGrpSet.add(tLJSGetGrpSchema);
...
public boolean closeData()
{
	...
	public LJSGetGrpSet executeQuery(SQLwithBindVariables sqlbv) {
	...
	public LJSGetGrpSet executeQuery(SQLwithBindVariables sqlbv, int nStart, int nCount) {
