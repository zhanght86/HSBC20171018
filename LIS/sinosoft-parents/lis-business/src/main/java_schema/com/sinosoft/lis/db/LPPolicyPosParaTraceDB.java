...
/*
 * <p>ClassName: LPPolicyPosParaTraceDB </p>
 * <p>Description: DB层数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: Physical Data Model 1
 */
public class LPPolicyPosParaTraceDB extends LPPolicyPosParaTraceSchema
{
	// @Field
	...
	**/
	...
	// @Constructor
	public LPPolicyPosParaTraceDB( Connection tConnection )
	{
		con = tConnection;
	...
	{
		LPPolicyPosParaTraceSchema tSchema = this.getSchema();
		...
		else
		{
			...
			tError.moduleName = "LPPolicyPosParaTraceDB";
	...
	public boolean update()
	{
		...
		try
		{
			...
			pstmt.setInt(6, this.getPumpDays());
			if(this.getGracePeriod() == null || this.getGracePeriod().equals("null")) {
				pstmt.setNull(7, 12);
			} else {
				pstmt.setString(7, this.getGracePeriod());
			}
			...
			if(this.getTraceNo() == null || this.getTraceNo().equals("null")) {
				...
				pstmt.setString(17, this.getTraceNo());
			}
			pstmt.executeUpdate();
			pstmt.close();
		} catch (Exception ex) {
	...
	public boolean getInfo()
	{
		...
		try
		{
			pstmt = con.prepareStatement("SELECT * FROM LPPolicyPosParaTrace WHERE  TraceNo = ?", 
	...
	public LPPolicyPosParaTraceSet query()
	{
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		LPPolicyPosParaTraceSet aLPPolicyPosParaTraceSet = new LPPolicyPosParaTraceSet();
	  ...
	  if( !mflag ) {
		...
		{
			SQLString sqlObj = new SQLString("LPPolicyPosParaTrace");
			LPPolicyPosParaTraceSchema aSchema = this.getSchema();
			...
			{
				i++;
				LPPolicyPosParaTraceSchema s1 = new LPPolicyPosParaTraceSchema();
				s1.setSchema(rs,i);
				aLPPolicyPosParaTraceSet.add(s1);
			}
			try{ rs.close(); } catch( Exception ex ) {}
			try{ pstmt.close(); } catch( Exception ex1 ) {}
		}
		...
		return aLPPolicyPosParaTraceSet;
	}

	public LPPolicyPosParaTraceSet executeQuery(String sql)
	{
		Statement stmt = null;
		ResultSet rs = null;
		LPPolicyPosParaTraceSet aLPPolicyPosParaTraceSet = new LPPolicyPosParaTraceSet();
	...
	public LPPolicyPosParaTraceSet query(int nStart, int nCount)
	{
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		LPPolicyPosParaTraceSet aLPPolicyPosParaTraceSet = new LPPolicyPosParaTraceSet();
	...
	public LPPolicyPosParaTraceSet executeQuery(String sql, int nStart, int nCount)
	{
		Statement stmt = null;
		ResultSet rs = null;
		LPPolicyPosParaTraceSet aLPPolicyPosParaTraceSet = new LPPolicyPosParaTraceSet();
	...
	public boolean update(String strWherePart)
	{
	  ...
	  if( !mflag ) {
		...
		try
		{
			...
			String sql = "update LPPolicyPosParaTrace " + sqlObj.getUpdPart() + " where " + strWherePart;
...
/**
 * 获取定量数据
 * @return LPPolicyPosParaTraceSet
 */
public LPPolicyPosParaTraceSet getData()
{
    int tCount = 0;
    LPPolicyPosParaTraceSet tLPPolicyPosParaTraceSet = new LPPolicyPosParaTraceSet();
    LPPolicyPosParaTraceSchema tLPPolicyPosParaTraceSchema = null;
    if (null == mResultSet)
    {
        CError tError = new CError();
        tError.moduleName = "LPPolicyPosParaTraceDB";
    ...
    {
        tCount = 1;
        tLPPolicyPosParaTraceSchema = new LPPolicyPosParaTraceSchema();
        tLPPolicyPosParaTraceSchema.setSchema(mResultSet, 1);
        tLPPolicyPosParaTraceSet.add(tLPPolicyPosParaTraceSchema);
    ...
    return tLPPolicyPosParaTraceSet;
}
/**
 * 关闭数据集
 * @return boolean
...
public boolean closeData()
{
	...
	public LPPolicyPosParaTraceSet executeQuery(SQLwithBindVariables sqlbv) {
	...
	public LPPolicyPosParaTraceSet executeQuery(SQLwithBindVariables sqlbv, int nStart, int nCount) {
