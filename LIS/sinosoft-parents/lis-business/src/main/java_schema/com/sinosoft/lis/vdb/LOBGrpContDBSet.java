...
/*
 * <p>ClassName: LOBGrpContDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: PhysicalDataModel_12
 */
public class LOBGrpContDBSet extends LOBGrpContSet
{
	// @Field
	...
	**/
	...
	// @Constructor
	public LOBGrpContDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LOBGrpContDBSet";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getAgentCode1() == null || this.get(i).getAgentCode1().equals("null")) {
				...
				pstmt.setString(10, this.get(i).getAgentCode1());
			}
			...
			if(this.get(i).getPassword2() == null || this.get(i).getPassword2().equals("null")) {
				...
				pstmt.setString(12, this.get(i).getPassword2());
			}
			...
			if(this.get(i).getBusinessType() == null || this.get(i).getBusinessType().equals("null")) {
				...
				pstmt.setString(17, this.get(i).getBusinessType());
			}
			...
			pstmt.setDouble(19, this.get(i).getRgtMoney());
			pstmt.setDouble(20, this.get(i).getAsset());
			...
			if(this.get(i).getMainBussiness() == null || this.get(i).getMainBussiness().equals("null")) {
				...
				pstmt.setString(22, this.get(i).getMainBussiness());
			}
			...
			if(this.get(i).getAccName() == null || this.get(i).getAccName().equals("null")) {
				...
				pstmt.setString(34, this.get(i).getAccName());
			}
			...
			if(this.get(i).getConTFlag() == null || this.get(i).getConTFlag().equals("null")) {
				...
				pstmt.setString(135, this.get(i).getConTFlag());
			}
			if(this.get(i).getSaleDepart() == null || this.get(i).getSaleDepart().equals("null")) {
				pstmt.setString(136,null);
			} else {
				pstmt.setString(136, this.get(i).getSaleDepart());
			}
			if(this.get(i).getChnlType() == null || this.get(i).getChnlType().equals("null")) {
				pstmt.setString(137,null);
			} else {
				pstmt.setString(137, this.get(i).getChnlType());
			}
			if(this.get(i).getAgentBranchesCode() == null || this.get(i).getAgentBranchesCode().equals("null")) {
				pstmt.setString(138,null);
			} else {
				pstmt.setString(138, this.get(i).getAgentBranchesCode());
			}
			if(this.get(i).getProjectType() == null || this.get(i).getProjectType().equals("null")) {
				pstmt.setString(139,null);
			} else {
				pstmt.setString(139, this.get(i).getProjectType());
			}
			if(this.get(i).getRenewFlag() == null || this.get(i).getRenewFlag().equals("null")) {
				pstmt.setString(140,null);
			} else {
				pstmt.setString(140, this.get(i).getRenewFlag());
			}
			pstmt.setInt(141, this.get(i).getRenewCount());
			if(this.get(i).getRenewContNo() == null || this.get(i).getRenewContNo().equals("null")) {
				pstmt.setString(142,null);
			} else {
				pstmt.setString(142, this.get(i).getRenewContNo());
			}
			pstmt.setInt(143, this.get(i).getInitNumPeople());
			pstmt.setInt(144, this.get(i).getInitMult());
			pstmt.setDouble(145, this.get(i).getInitAmnt());
			pstmt.setDouble(146, this.get(i).getInitRiskAmnt());
			pstmt.setDouble(147, this.get(i).getInitPrem());
			pstmt.setDouble(148, this.get(i).getInitStandPrem());
			pstmt.setDouble(149, this.get(i).getRiskAmnt());
			pstmt.setDouble(150, this.get(i).getStandPrem());
			pstmt.setInt(151, this.get(i).getSumNumPeople());
			pstmt.setInt(152, this.get(i).getInsuYear());
			if(this.get(i).getInsuYearFlag() == null || this.get(i).getInsuYearFlag().equals("null")) {
				pstmt.setString(153,null);
			} else {
				pstmt.setString(153, this.get(i).getInsuYearFlag());
			}
			pstmt.setInt(154, this.get(i).getYears());
			pstmt.setInt(155, this.get(i).getPayEndYear());
			if(this.get(i).getPayEndYearFlag() == null || this.get(i).getPayEndYearFlag().equals("null")) {
				pstmt.setString(156,null);
			} else {
				pstmt.setString(156, this.get(i).getPayEndYearFlag());
			}
			pstmt.setInt(157, this.get(i).getPayYears());
			if(this.get(i).getValDateType() == null || this.get(i).getValDateType().equals("null")) {
				pstmt.setString(158,null);
			} else {
				pstmt.setString(158, this.get(i).getValDateType());
			}
			if(this.get(i).getEndDate() == null || this.get(i).getEndDate().equals("null")) {
				pstmt.setDate(159,null);
			} else {
				pstmt.setDate(159, Date.valueOf(this.get(i).getEndDate()));
			}
			if(this.get(i).getFirstPayDate() == null || this.get(i).getFirstPayDate().equals("null")) {
				pstmt.setDate(160,null);
			} else {
				pstmt.setDate(160, Date.valueOf(this.get(i).getFirstPayDate()));
			}
			if(this.get(i).getPayEndDate() == null || this.get(i).getPayEndDate().equals("null")) {
				pstmt.setDate(161,null);
			} else {
				pstmt.setDate(161, Date.valueOf(this.get(i).getPayEndDate()));
			}
			if(this.get(i).getPayToDate() == null || this.get(i).getPayToDate().equals("null")) {
				pstmt.setDate(162,null);
			} else {
				pstmt.setDate(162, Date.valueOf(this.get(i).getPayToDate()));
			}
			if(this.get(i).getAutoPayFlag() == null || this.get(i).getAutoPayFlag().equals("null")) {
				pstmt.setString(163,null);
			} else {
				pstmt.setString(163, this.get(i).getAutoPayFlag());
			}
			if(this.get(i).getSignOperator() == null || this.get(i).getSignOperator().equals("null")) {
				pstmt.setString(164,null);
			} else {
				pstmt.setString(164, this.get(i).getSignOperator());
			}
			if(this.get(i).getCoInsurance() == null || this.get(i).getCoInsurance().equals("null")) {
				pstmt.setString(165,null);
			} else {
				pstmt.setString(165, this.get(i).getCoInsurance());
			}
			pstmt.setDouble(166, this.get(i).getAmntShareRate());
			pstmt.setDouble(167, this.get(i).getPremShareRate());
			if(this.get(i).getScanCom() == null || this.get(i).getScanCom().equals("null")) {
				pstmt.setString(168,null);
			} else {
				pstmt.setString(168, this.get(i).getScanCom());
			}
			if(this.get(i).getComCode() == null || this.get(i).getComCode().equals("null")) {
				pstmt.setString(169,null);
			} else {
				pstmt.setString(169, this.get(i).getComCode());
			}
			if(this.get(i).getModifyOperator() == null || this.get(i).getModifyOperator().equals("null")) {
				pstmt.setString(170,null);
			} else {
				pstmt.setString(170, this.get(i).getModifyOperator());
			}
			// set where condition
			if(this.get(i).getGrpContNo() == null || this.get(i).getGrpContNo().equals("null")) {
				pstmt.setString(171,null);
			} else {
				pstmt.setString(171, this.get(i).getGrpContNo());
			}
