...
/*
 * <p>ClassName: LCGrpIssuePolDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 承保流程
 */
public class LCGrpIssuePolDBSet extends LCGrpIssuePolSet
{
	// @Field
	...
	**/
	...
	// @Constructor
	public LCGrpIssuePolDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LCGrpIssuePolDBSet";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getLocation() == null || this.get(i).getLocation().equals("null")) {
				...
				pstmt.setString(6, this.get(i).getLocation());
			}
			...
			if(this.get(i).getProposalGrpContNo() == null || this.get(i).getProposalGrpContNo().equals("null")) {
				...
				pstmt.setString(32, this.get(i).getProposalGrpContNo());
			}
			if(this.get(i).getSerialNo() == null || this.get(i).getSerialNo().equals("null")) {
