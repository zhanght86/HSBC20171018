 ...
 * @Database: 单证管理
 */
public class LZCardBugetSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LZCardBugetSchema.class);
	...
	* @param: aLZCardBugetSchema LZCardBugetSchema
	**/
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LZCardBuget表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
	...
	**/
	public String encode()
	{
		...
		strReturn.append(StrTool.cTrim(fDate.getString( SDate ))); strReturn.append(SysConst.PACKAGESPILTER);
		strReturn.append(StrTool.cTrim(fDate.getString( EDate ))); strReturn.append(SysConst.PACKAGESPILTER);
		strReturn.append( ChgData.chgData(Buget));strReturn.append(SysConst.PACKAGESPILTER);
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			SDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 2,SysConst.PACKAGESPILTER));
			EDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 3,SysConst.PACKAGESPILTER));
			Buget = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,4,SysConst.PACKAGESPILTER))).doubleValue();
	...
	**/
	public String getV(String FCode)
	{
		...
		if (FCode.equalsIgnoreCase("SDate"))
		{
			strReturn = StrTool.GBKToUnicode(String.valueOf( this.getSDate()));
		}
		if (FCode.equalsIgnoreCase("EDate"))
		{
			strReturn = StrTool.GBKToUnicode(String.valueOf( this.getEDate()));
		}
		if (FCode.equalsIgnoreCase("Buget"))
		{
			strReturn = StrTool.GBKToUnicode(String.valueOf(Buget));
		}
	...
	public String getV(int nFieldIndex)
	{
		...
		switch(nFieldIndex) {
			case 0:
				...
				break;
			case 1:
				strFieldValue = StrTool.GBKToUnicode(String.valueOf( this.getSDate()));
				break;
			case 2:
				strFieldValue = StrTool.GBKToUnicode(String.valueOf( this.getEDate()));
				break;
			case 3:
