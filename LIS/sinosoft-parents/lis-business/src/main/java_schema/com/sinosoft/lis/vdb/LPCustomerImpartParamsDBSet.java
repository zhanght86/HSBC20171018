...
/*
 * <p>ClassName: LPCustomerImpartParamsDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 保全核心
 */
public class LPCustomerImpartParamsDBSet extends LPCustomerImpartParamsSet
{
private static Logger logger = Logger.getLogger(LPCustomerImpartParamsDBSet.class);
	...
	**/
	...
	// @Constructor
	public LPCustomerImpartParamsDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public LPCustomerImpartParamsDBSet()
	{
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LPCustomerImpartParamsDBSet";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getCustomerNoType() == null || this.get(i).getCustomerNoType().equals("null")) {
				...
				pstmt.setString(10, this.get(i).getCustomerNoType());
			}
			if(this.get(i).getImpartParamNo() == null || this.get(i).getImpartParamNo().equals("null")) {
				pstmt.setString(11,null);
			} else {
				pstmt.setString(11, this.get(i).getImpartParamNo());
			}
			if(this.get(i).getImpartParamName() == null || this.get(i).getImpartParamName().equals("null")) {
				pstmt.setString(12,null);
			} else {
				pstmt.setString(12, this.get(i).getImpartParamName());
			}
			if(this.get(i).getImpartParam() == null || this.get(i).getImpartParam().equals("null")) {
				pstmt.setString(13,null);
			} else {
				pstmt.setString(13, this.get(i).getImpartParam());
			}
			...
			pstmt.setInt(19, this.get(i).getPatchNo());
			// set where condition
			if(this.get(i).getEdorNo() == null || this.get(i).getEdorNo().equals("null")) {
			...
			if(this.get(i).getContNo() == null || this.get(i).getContNo().equals("null")) {
				...
				pstmt.setString(22, this.get(i).getContNo());
			}
			if(this.get(i).getProposalContNo() == null || this.get(i).getProposalContNo().equals("null")) {
				pstmt.setString(23,null);
			} else {
				pstmt.setString(23, this.get(i).getProposalContNo());
			}
			if(this.get(i).getImpartCode() == null || this.get(i).getImpartCode().equals("null")) {
				pstmt.setString(24,null);
			} else {
				pstmt.setString(24, this.get(i).getImpartCode());
			}
			if(this.get(i).getImpartVer() == null || this.get(i).getImpartVer().equals("null")) {
				pstmt.setString(25,null);
			} else {
				pstmt.setString(25, this.get(i).getImpartVer());
			}
			if(this.get(i).getCustomerNo() == null || this.get(i).getCustomerNo().equals("null")) {
			...
			if(this.get(i).getCustomerNoType() == null || this.get(i).getCustomerNoType().equals("null")) {
				...
				pstmt.setString(27, StrTool.space1(this.get(i).getCustomerNoType(), 1));
			}
			if(this.get(i).getImpartParamNo() == null || this.get(i).getImpartParamNo().equals("null")) {
				pstmt.setString(28,null);
			} else {
				pstmt.setString(28, this.get(i).getImpartParamNo());
			}
