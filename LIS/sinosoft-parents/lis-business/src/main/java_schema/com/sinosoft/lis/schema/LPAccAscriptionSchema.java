...
import com.sinosoft.lis.db.LPAccAscriptionDB;

/*
 * <p>ClassName: LPAccAscriptionSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: Physical Data Model 1
 */
public class LPAccAscriptionSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LPAccAscriptionSchema.class);
	// @Field
	/** 保全批单号 */
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LPAccAscriptionSchema cloned = (LPAccAscriptionSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LPAccAscriptionSchema 对象给 Schema 赋值
	* @param: aLPAccAscriptionSchema LPAccAscriptionSchema
	**/
	public void setSchema(LPAccAscriptionSchema aLPAccAscriptionSchema)
	{
		this.EdorNo = aLPAccAscriptionSchema.getEdorNo();
		this.EdorType = aLPAccAscriptionSchema.getEdorType();
		this.SerialNo = aLPAccAscriptionSchema.getSerialNo();
		this.GrpContNo = aLPAccAscriptionSchema.getGrpContNo();
		this.RiskCode = aLPAccAscriptionSchema.getRiskCode();
		this.GrpPolNo = aLPAccAscriptionSchema.getGrpPolNo();
		this.RuleType = aLPAccAscriptionSchema.getRuleType();
		this.PositionCode = aLPAccAscriptionSchema.getPositionCode();
		this.StartYears = aLPAccAscriptionSchema.getStartYears();
		this.EndYears = aLPAccAscriptionSchema.getEndYears();
		this.Rate = aLPAccAscriptionSchema.getRate();
		this.Segment1 = aLPAccAscriptionSchema.getSegment1();
		this.Segment2 = aLPAccAscriptionSchema.getSegment2();
		this.Segment3 = aLPAccAscriptionSchema.getSegment3();
		this.MakeOperator = aLPAccAscriptionSchema.getMakeOperator();
		this.MakeDate = fDate.getDate( aLPAccAscriptionSchema.getMakeDate());
		this.MakeTime = aLPAccAscriptionSchema.getMakeTime();
		this.ModifyOperator = aLPAccAscriptionSchema.getModifyOperator();
		this.ModifyDate = fDate.getDate( aLPAccAscriptionSchema.getModifyDate());
		this.ModifyTime = aLPAccAscriptionSchema.getModifyTime();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LPAccAscription表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LPAccAscriptionSchema";
	...
	public LPAccAscriptionSchema getSchema()
	{
		LPAccAscriptionSchema aLPAccAscriptionSchema = new LPAccAscriptionSchema();
		aLPAccAscriptionSchema.setSchema(this);
		return aLPAccAscriptionSchema;
	}

	public LPAccAscriptionDB getDB()
	{
		LPAccAscriptionDB aDBOper = new LPAccAscriptionDB();
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLPAccAscription>历史记账凭证主表信息</A>表字段
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LPAccAscriptionSchema other = (LPAccAscriptionSchema)otherObject;
		return
