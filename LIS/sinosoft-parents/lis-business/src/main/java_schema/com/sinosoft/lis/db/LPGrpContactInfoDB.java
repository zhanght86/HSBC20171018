...
/*
 * <p>ClassName: LPGrpContactInfoDB </p>
 * <p>Description: DB层数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: Physical Data Model 1
 */
public class LPGrpContactInfoDB extends LPGrpContactInfoSchema
{
	// @Field
	...
	**/
	...
	// @Constructor
	public LPGrpContactInfoDB( Connection tConnection )
	{
		con = tConnection;
	...
	{
		LPGrpContactInfoSchema tSchema = this.getSchema();
		...
		else
		{
			...
			tError.moduleName = "LPGrpContactInfoDB";
	...
	public boolean getInfo()
	{
		...
		try
		{
			pstmt = con.prepareStatement("SELECT * FROM LPGrpContactInfo WHERE  EdorNo = ? AND EdorType = ? AND GrpContNo = ? AND CustomerNo = ?", 
	...
	public LPGrpContactInfoSet query()
	{
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		LPGrpContactInfoSet aLPGrpContactInfoSet = new LPGrpContactInfoSet();
	  ...
	  if( !mflag ) {
		...
		{
			SQLString sqlObj = new SQLString("LPGrpContactInfo");
			LPGrpContactInfoSchema aSchema = this.getSchema();
			...
			{
				i++;
				LPGrpContactInfoSchema s1 = new LPGrpContactInfoSchema();
				s1.setSchema(rs,i);
				aLPGrpContactInfoSet.add(s1);
			}
			try{ rs.close(); } catch( Exception ex ) {}
			try{ pstmt.close(); } catch( Exception ex1 ) {}
		}
		...
		return aLPGrpContactInfoSet;
	}

	public LPGrpContactInfoSet executeQuery(String sql)
	{
		Statement stmt = null;
		ResultSet rs = null;
		LPGrpContactInfoSet aLPGrpContactInfoSet = new LPGrpContactInfoSet();
	...
	public LPGrpContactInfoSet query(int nStart, int nCount)
	{
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		LPGrpContactInfoSet aLPGrpContactInfoSet = new LPGrpContactInfoSet();
	...
	public LPGrpContactInfoSet executeQuery(String sql, int nStart, int nCount)
	{
		Statement stmt = null;
		ResultSet rs = null;
		LPGrpContactInfoSet aLPGrpContactInfoSet = new LPGrpContactInfoSet();
	...
	public boolean update(String strWherePart)
	{
	  ...
	  if( !mflag ) {
		...
		try
		{
			...
			String sql = "update LPGrpContactInfo " + sqlObj.getUpdPart() + " where " + strWherePart;
...
/**
 * 获取定量数据
 * @return LPGrpContactInfoSet
 */
public LPGrpContactInfoSet getData()
{
    int tCount = 0;
    LPGrpContactInfoSet tLPGrpContactInfoSet = new LPGrpContactInfoSet();
    LPGrpContactInfoSchema tLPGrpContactInfoSchema = null;
    if (null == mResultSet)
    {
        CError tError = new CError();
        tError.moduleName = "LPGrpContactInfoDB";
    ...
    {
        tCount = 1;
        tLPGrpContactInfoSchema = new LPGrpContactInfoSchema();
        tLPGrpContactInfoSchema.setSchema(mResultSet, 1);
        tLPGrpContactInfoSet.add(tLPGrpContactInfoSchema);
...
public boolean closeData()
{
	...
	public LPGrpContactInfoSet executeQuery(SQLwithBindVariables sqlbv) {
	...
	public LPGrpContactInfoSet executeQuery(SQLwithBindVariables sqlbv, int nStart, int nCount) {
