...
/*
 * <p>ClassName: PD_LMRiskDutySchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 产品定义平台_PDM
 */
public class PD_LMRiskDutySchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(PD_LMRiskDutySchema.class);
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		PD_LMRiskDutySchema cloned = (PD_LMRiskDutySchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 PD_LMRiskDutySchema 对象给 Schema 赋值
	* @param: aPD_LMRiskDutySchema PD_LMRiskDutySchema
	**/
	public void setSchema(PD_LMRiskDutySchema aPD_LMRiskDutySchema)
	{
		this.RiskCode = aPD_LMRiskDutySchema.getRiskCode();
		this.DutyCode = aPD_LMRiskDutySchema.getDutyCode();
		this.RiskVer = aPD_LMRiskDutySchema.getRiskVer();
		this.ChoFlag = aPD_LMRiskDutySchema.getChoFlag();
		this.SpecFlag = aPD_LMRiskDutySchema.getSpecFlag();
		this.Operator = aPD_LMRiskDutySchema.getOperator();
		this.MakeDate = fDate.getDate( aPD_LMRiskDutySchema.getMakeDate());
		this.MakeTime = aPD_LMRiskDutySchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aPD_LMRiskDutySchema.getModifyDate());
		this.ModifyTime = aPD_LMRiskDutySchema.getModifyTime();
		this.Standbyflag1 = aPD_LMRiskDutySchema.getStandbyflag1();
		this.Standbyflag2 = aPD_LMRiskDutySchema.getStandbyflag2();
		this.Standbyflag3 = aPD_LMRiskDutySchema.getStandbyflag3();
		this.Standbyflag4 = aPD_LMRiskDutySchema.getStandbyflag4();
		this.Standbyflag5 = aPD_LMRiskDutySchema.getStandbyflag5();
		this.Standbyflag6 = aPD_LMRiskDutySchema.getStandbyflag6();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的PD_LMRiskDuty表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "PD_LMRiskDutySchema";
	...
	public PD_LMRiskDutySchema getSchema()
	{
		PD_LMRiskDutySchema aPD_LMRiskDutySchema = new PD_LMRiskDutySchema();
		aPD_LMRiskDutySchema.setSchema(this);
		return aPD_LMRiskDutySchema;
	}

	public PD_LMRiskDutyDB getDB()
	{
		PD_LMRiskDutyDB aDBOper = new PD_LMRiskDutyDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpPD_LMRiskDuty描述/A>表字段
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpPD_LMRiskDuty>历史记账凭证主表信息</A>表字段
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		PD_LMRiskDutySchema other = (PD_LMRiskDutySchema)otherObject;
		return
