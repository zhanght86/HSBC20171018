...
import com.sinosoft.lis.db.LCCUWSubBakDB;

/*
 * <p>ClassName: LCCUWSubBakSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: PhysicalDataModel_1
 */
public class LCCUWSubBakSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LCCUWSubBakSchema.class);
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LCCUWSubBakSchema cloned = (LCCUWSubBakSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LCCUWSubBakSchema 对象给 Schema 赋值
	* @param: aLCCUWSubBakSchema LCCUWSubBakSchema
	**/
	public void setSchema(LCCUWSubBakSchema aLCCUWSubBakSchema)
	{
		this.GrpContNo = aLCCUWSubBakSchema.getGrpContNo();
		this.ContNo = aLCCUWSubBakSchema.getContNo();
		this.ProposalContNo = aLCCUWSubBakSchema.getProposalContNo();
		this.UWNo = aLCCUWSubBakSchema.getUWNo();
		this.InsuredNo = aLCCUWSubBakSchema.getInsuredNo();
		this.InsuredName = aLCCUWSubBakSchema.getInsuredName();
		this.AppntNo = aLCCUWSubBakSchema.getAppntNo();
		this.AppntName = aLCCUWSubBakSchema.getAppntName();
		this.AgentCode = aLCCUWSubBakSchema.getAgentCode();
		this.AgentGroup = aLCCUWSubBakSchema.getAgentGroup();
		this.PassFlag = aLCCUWSubBakSchema.getPassFlag();
		this.UWGrade = aLCCUWSubBakSchema.getUWGrade();
		this.AppGrade = aLCCUWSubBakSchema.getAppGrade();
		this.PostponeDay = aLCCUWSubBakSchema.getPostponeDay();
		this.PostponeDate = fDate.getDate( aLCCUWSubBakSchema.getPostponeDate());
		this.AutoUWFlag = aLCCUWSubBakSchema.getAutoUWFlag();
		this.State = aLCCUWSubBakSchema.getState();
		this.ManageCom = aLCCUWSubBakSchema.getManageCom();
		this.UWIdea = aLCCUWSubBakSchema.getUWIdea();
		this.UpReportContent = aLCCUWSubBakSchema.getUpReportContent();
		this.Operator = aLCCUWSubBakSchema.getOperator();
		this.HealthFlag = aLCCUWSubBakSchema.getHealthFlag();
		this.QuesFlag = aLCCUWSubBakSchema.getQuesFlag();
		this.SpecFlag = aLCCUWSubBakSchema.getSpecFlag();
		this.AddPremFlag = aLCCUWSubBakSchema.getAddPremFlag();
		this.AddPremReason = aLCCUWSubBakSchema.getAddPremReason();
		this.ReportFlag = aLCCUWSubBakSchema.getReportFlag();
		this.PrintFlag = aLCCUWSubBakSchema.getPrintFlag();
		this.PrintFlag2 = aLCCUWSubBakSchema.getPrintFlag2();
		this.ChangePolFlag = aLCCUWSubBakSchema.getChangePolFlag();
		this.ChangePolReason = aLCCUWSubBakSchema.getChangePolReason();
		this.SpecReason = aLCCUWSubBakSchema.getSpecReason();
		this.MakeDate = fDate.getDate( aLCCUWSubBakSchema.getMakeDate());
		this.MakeTime = aLCCUWSubBakSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLCCUWSubBakSchema.getModifyDate());
		this.ModifyTime = aLCCUWSubBakSchema.getModifyTime();
		this.SugPassFlag = aLCCUWSubBakSchema.getSugPassFlag();
		this.SugUWIdea = aLCCUWSubBakSchema.getSugUWIdea();
		this.UpReport = aLCCUWSubBakSchema.getUpReport();
		this.CommonReason = aLCCUWSubBakSchema.getCommonReason();
		this.CommonReasonCode = aLCCUWSubBakSchema.getCommonReasonCode();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LCCUWSubBak表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LCCUWSubBakSchema";
	...
	public LCCUWSubBakSchema getSchema()
	{
		LCCUWSubBakSchema aLCCUWSubBakSchema = new LCCUWSubBakSchema();
		aLCCUWSubBakSchema.setSchema(this);
		return aLCCUWSubBakSchema;
	}

	public LCCUWSubBakDB getDB()
	{
		LCCUWSubBakDB aDBOper = new LCCUWSubBakDB();
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLCCUWSubBak>历史记账凭证主表信息</A>表字段
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LCCUWSubBakSchema other = (LCCUWSubBakSchema)otherObject;
		return
