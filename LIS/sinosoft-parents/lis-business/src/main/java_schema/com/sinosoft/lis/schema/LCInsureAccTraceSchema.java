...
/*
 * <p>ClassName: LCInsureAccTraceSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 承保核心
 */
public class LCInsureAccTraceSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LCInsureAccTraceSchema.class);
	// @Field
	/** 集体合同号码 */
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LCInsureAccTraceSchema cloned = (LCInsureAccTraceSchema)super.clone();
	...
	*/
	...
	public void setEdorType(String aEdorType)
	{
		if(aEdorType!=null && aEdorType.length()>10)
			throw new IllegalArgumentException("批改类型EdorType值"+aEdorType+"的长度"+aEdorType.length()+"大于最大值10");
		EdorType = aEdorType;
	}
	...
	/**
	* 使用另外一个 LCInsureAccTraceSchema 对象给 Schema 赋值
	* @param: aLCInsureAccTraceSchema LCInsureAccTraceSchema
	**/
	public void setSchema(LCInsureAccTraceSchema aLCInsureAccTraceSchema)
	{
		this.GrpContNo = aLCInsureAccTraceSchema.getGrpContNo();
		this.GrpPolNo = aLCInsureAccTraceSchema.getGrpPolNo();
		this.ContNo = aLCInsureAccTraceSchema.getContNo();
		this.PolNo = aLCInsureAccTraceSchema.getPolNo();
		this.SerialNo = aLCInsureAccTraceSchema.getSerialNo();
		this.InsuAccNo = aLCInsureAccTraceSchema.getInsuAccNo();
		this.RiskCode = aLCInsureAccTraceSchema.getRiskCode();
		this.PayPlanCode = aLCInsureAccTraceSchema.getPayPlanCode();
		this.OtherNo = aLCInsureAccTraceSchema.getOtherNo();
		this.OtherType = aLCInsureAccTraceSchema.getOtherType();
		this.AccAscription = aLCInsureAccTraceSchema.getAccAscription();
		this.MoneyType = aLCInsureAccTraceSchema.getMoneyType();
		this.Money = aLCInsureAccTraceSchema.getMoney();
		this.UnitCount = aLCInsureAccTraceSchema.getUnitCount();
		this.PayDate = fDate.getDate( aLCInsureAccTraceSchema.getPayDate());
		this.State = aLCInsureAccTraceSchema.getState();
		this.ManageCom = aLCInsureAccTraceSchema.getManageCom();
		this.Operator = aLCInsureAccTraceSchema.getOperator();
		this.MakeDate = fDate.getDate( aLCInsureAccTraceSchema.getMakeDate());
		this.MakeTime = aLCInsureAccTraceSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLCInsureAccTraceSchema.getModifyDate());
		this.ModifyTime = aLCInsureAccTraceSchema.getModifyTime();
		this.FeeCode = aLCInsureAccTraceSchema.getFeeCode();
		this.AccAlterNo = aLCInsureAccTraceSchema.getAccAlterNo();
		this.AccAlterType = aLCInsureAccTraceSchema.getAccAlterType();
		this.BusyType = aLCInsureAccTraceSchema.getBusyType();
		this.ShouldValueDate = fDate.getDate( aLCInsureAccTraceSchema.getShouldValueDate());
		this.ValueDate = fDate.getDate( aLCInsureAccTraceSchema.getValueDate());
		this.PayNo = aLCInsureAccTraceSchema.getPayNo();
		this.EdorType = aLCInsureAccTraceSchema.getEdorType();
		this.DutyCode = aLCInsureAccTraceSchema.getDutyCode();
		this.Currency = aLCInsureAccTraceSchema.getCurrency();
		this.InvestType = aLCInsureAccTraceSchema.getInvestType();
		this.UnitCountPrice = aLCInsureAccTraceSchema.getUnitCountPrice();
		this.PreMoney = aLCInsureAccTraceSchema.getPreMoney();
		this.ConfDate = fDate.getDate( aLCInsureAccTraceSchema.getConfDate());
		this.AllocationDate = fDate.getDate( aLCInsureAccTraceSchema.getAllocationDate());
		this.PricingDate = fDate.getDate( aLCInsureAccTraceSchema.getPricingDate());
		this.ComCode = aLCInsureAccTraceSchema.getComCode();
		this.ModifyOperator = aLCInsureAccTraceSchema.getModifyOperator();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LCInsureAccTrace表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LCInsureAccTraceSchema";
	...
	public LCInsureAccTraceSchema getSchema()
	{
		LCInsureAccTraceSchema aLCInsureAccTraceSchema = new LCInsureAccTraceSchema();
		aLCInsureAccTraceSchema.setSchema(this);
		return aLCInsureAccTraceSchema;
	}

	public LCInsureAccTraceDB getDB()
	{
		LCInsureAccTraceDB aDBOper = new LCInsureAccTraceDB();
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLCInsureAccTrace>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			BusyType = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 26, SysConst.PACKAGESPILTER );
			ShouldValueDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 27,SysConst.PACKAGESPILTER));
			ValueDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 28,SysConst.PACKAGESPILTER));
			PayNo = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 29, SysConst.PACKAGESPILTER );
			EdorType = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 30, SysConst.PACKAGESPILTER );
			...
			InvestType = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 33, SysConst.PACKAGESPILTER );
			UnitCountPrice = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,34,SysConst.PACKAGESPILTER))).doubleValue();
			PreMoney = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,35,SysConst.PACKAGESPILTER))).doubleValue();
			ConfDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 36,SysConst.PACKAGESPILTER));
			AllocationDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 37,SysConst.PACKAGESPILTER));
			PricingDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 38,SysConst.PACKAGESPILTER));
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LCInsureAccTraceSchema other = (LCInsureAccTraceSchema)otherObject;
		return
