...
/**
 * <p>ClassName: FIInfoFinItemAssociatedDBSet </p>
 ...
 */
public class FIInfoFinItemAssociatedDBSet extends FIInfoFinItemAssociatedSet
{
private static Logger logger = Logger.getLogger(FIInfoFinItemAssociatedDBSet.class);
	...
	**/
	...
	// @Constructor
	public FIInfoFinItemAssociatedDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public FIInfoFinItemAssociatedDBSet()
	{
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "FIInfoFinItemAssociatedDBSet";
	...
	public boolean delete()
	{
		...
		try
		{
			...
			if(this.get(i).getAssociatedID() == null || this.get(i).getAssociatedID().equals("null")) {
				...
				pstmt.setString(3, this.get(i).getAssociatedID().trim());
			}
                pstmt.addBatch();
            }
            pstmt.executeBatch();
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getAssociatedName() == null || this.get(i).getAssociatedName().equals("null")) {
				...
				pstmt.setString(4, this.get(i).getAssociatedName().trim());
			}
			...
			if(this.get(i).getFinItemID() == null || this.get(i).getFinItemID().equals("null")) {
				...
				pstmt.setString(7, this.get(i).getFinItemID().trim());
			}
			if(this.get(i).getAssociatedID() == null || this.get(i).getAssociatedID().equals("null")) {
				pstmt.setString(8,null);
			} else {
				pstmt.setString(8, this.get(i).getAssociatedID().trim());
			}
                pstmt.addBatch();
            }
            pstmt.executeBatch();
