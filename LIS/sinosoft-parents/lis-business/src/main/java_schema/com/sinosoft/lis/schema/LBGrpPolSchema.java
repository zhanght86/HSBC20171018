...
/*
 * <p>ClassName: LBGrpPolSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: PhysicalDataModel_14
 */
public class LBGrpPolSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LBGrpPolSchema.class);
	// @Field
	/** 批单号 */
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LBGrpPolSchema cloned = (LBGrpPolSchema)super.clone();
	...
	*/
	...
	{
		if(aBonusFlag!=null && aBonusFlag.length()>10)
			throw new IllegalArgumentException("分红标记BonusFlag值"+aBonusFlag+"的长度"+aBonusFlag.length()+"大于最大值10");
	...
	*/
	...
	/**
	* 使用另外一个 LBGrpPolSchema 对象给 Schema 赋值
	* @param: aLBGrpPolSchema LBGrpPolSchema
	**/
	public void setSchema(LBGrpPolSchema aLBGrpPolSchema)
	{
		this.EdorNo = aLBGrpPolSchema.getEdorNo();
		this.GrpPolNo = aLBGrpPolSchema.getGrpPolNo();
		this.GrpContNo = aLBGrpPolSchema.getGrpContNo();
		this.GrpProposalNo = aLBGrpPolSchema.getGrpProposalNo();
		this.PrtNo = aLBGrpPolSchema.getPrtNo();
		this.KindCode = aLBGrpPolSchema.getKindCode();
		this.RiskCode = aLBGrpPolSchema.getRiskCode();
		this.RiskVersion = aLBGrpPolSchema.getRiskVersion();
		this.SaleChnl = aLBGrpPolSchema.getSaleChnl();
		this.ManageCom = aLBGrpPolSchema.getManageCom();
		this.AgentCom = aLBGrpPolSchema.getAgentCom();
		this.AgentType = aLBGrpPolSchema.getAgentType();
		this.AgentCode = aLBGrpPolSchema.getAgentCode();
		this.AgentGroup = aLBGrpPolSchema.getAgentGroup();
		this.AgentCode1 = aLBGrpPolSchema.getAgentCode1();
		this.CustomerNo = aLBGrpPolSchema.getCustomerNo();
		this.AddressNo = aLBGrpPolSchema.getAddressNo();
		this.GrpName = aLBGrpPolSchema.getGrpName();
		this.FirstPayDate = fDate.getDate( aLBGrpPolSchema.getFirstPayDate());
		this.PayEndDate = fDate.getDate( aLBGrpPolSchema.getPayEndDate());
		this.PaytoDate = fDate.getDate( aLBGrpPolSchema.getPaytoDate());
		this.RegetDate = fDate.getDate( aLBGrpPolSchema.getRegetDate());
		this.LastEdorDate = fDate.getDate( aLBGrpPolSchema.getLastEdorDate());
		this.SSFlag = aLBGrpPolSchema.getSSFlag();
		this.PeakLine = aLBGrpPolSchema.getPeakLine();
		this.GetLimit = aLBGrpPolSchema.getGetLimit();
		this.GetRate = aLBGrpPolSchema.getGetRate();
		this.BonusRate = aLBGrpPolSchema.getBonusRate();
		this.MaxMedFee = aLBGrpPolSchema.getMaxMedFee();
		this.OutPayFlag = aLBGrpPolSchema.getOutPayFlag();
		this.EmployeeRate = aLBGrpPolSchema.getEmployeeRate();
		this.FamilyRate = aLBGrpPolSchema.getFamilyRate();
		this.SpecFlag = aLBGrpPolSchema.getSpecFlag();
		this.ExpPeoples = aLBGrpPolSchema.getExpPeoples();
		this.ExpPremium = aLBGrpPolSchema.getExpPremium();
		this.ExpAmnt = aLBGrpPolSchema.getExpAmnt();
		this.PayMode = aLBGrpPolSchema.getPayMode();
		this.ManageFeeRate = aLBGrpPolSchema.getManageFeeRate();
		this.PayIntv = aLBGrpPolSchema.getPayIntv();
		this.CValiDate = fDate.getDate( aLBGrpPolSchema.getCValiDate());
		this.Peoples2 = aLBGrpPolSchema.getPeoples2();
		this.Mult = aLBGrpPolSchema.getMult();
		this.Prem = aLBGrpPolSchema.getPrem();
		this.Amnt = aLBGrpPolSchema.getAmnt();
		this.SumPrem = aLBGrpPolSchema.getSumPrem();
		this.SumPay = aLBGrpPolSchema.getSumPay();
		this.Dif = aLBGrpPolSchema.getDif();
		this.State = aLBGrpPolSchema.getState();
		this.ApproveFlag = aLBGrpPolSchema.getApproveFlag();
		this.ApproveCode = aLBGrpPolSchema.getApproveCode();
		this.ApproveDate = fDate.getDate( aLBGrpPolSchema.getApproveDate());
		this.ApproveTime = aLBGrpPolSchema.getApproveTime();
		this.UWFlag = aLBGrpPolSchema.getUWFlag();
		this.UWOperator = aLBGrpPolSchema.getUWOperator();
		this.UWDate = fDate.getDate( aLBGrpPolSchema.getUWDate());
		this.UWTime = aLBGrpPolSchema.getUWTime();
		this.AppFlag = aLBGrpPolSchema.getAppFlag();
		this.Remark = aLBGrpPolSchema.getRemark();
		this.StandbyFlag1 = aLBGrpPolSchema.getStandbyFlag1();
		this.StandbyFlag2 = aLBGrpPolSchema.getStandbyFlag2();
		this.StandbyFlag3 = aLBGrpPolSchema.getStandbyFlag3();
		this.Operator = aLBGrpPolSchema.getOperator();
		this.MakeDate = fDate.getDate( aLBGrpPolSchema.getMakeDate());
		this.MakeTime = aLBGrpPolSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLBGrpPolSchema.getModifyDate());
		this.ModifyTime = aLBGrpPolSchema.getModifyTime();
		this.OnWorkPeoples = aLBGrpPolSchema.getOnWorkPeoples();
		this.OffWorkPeoples = aLBGrpPolSchema.getOffWorkPeoples();
		this.OtherPeoples = aLBGrpPolSchema.getOtherPeoples();
		this.RelaPeoples = aLBGrpPolSchema.getRelaPeoples();
		this.RelaMatePeoples = aLBGrpPolSchema.getRelaMatePeoples();
		this.RelaYoungPeoples = aLBGrpPolSchema.getRelaYoungPeoples();
		this.RelaOtherPeoples = aLBGrpPolSchema.getRelaOtherPeoples();
		this.WaitPeriod = aLBGrpPolSchema.getWaitPeriod();
		this.HealthInsurType = aLBGrpPolSchema.getHealthInsurType();
		this.AscriptionFlag = aLBGrpPolSchema.getAscriptionFlag();
		this.InitRate = aLBGrpPolSchema.getInitRate();
		this.HealthProType = aLBGrpPolSchema.getHealthProType();
		this.BonusFlag = aLBGrpPolSchema.getBonusFlag();
		this.DistriFlag = aLBGrpPolSchema.getDistriFlag();
		this.Peoples3 = aLBGrpPolSchema.getPeoples3();
		this.FeeRate = aLBGrpPolSchema.getFeeRate();
		this.RenewFlag = aLBGrpPolSchema.getRenewFlag();
		this.DistriRate = aLBGrpPolSchema.getDistriRate();
		this.Currency = aLBGrpPolSchema.getCurrency();
		this.UintLinkValiFlag = aLBGrpPolSchema.getUintLinkValiFlag();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LBGrpPol表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LBGrpPolSchema";
	...
	public LBGrpPolSchema getSchema()
	{
		LBGrpPolSchema aLBGrpPolSchema = new LBGrpPolSchema();
		aLBGrpPolSchema.setSchema(this);
		return aLBGrpPolSchema;
	}

	public LBGrpPolDB getDB()
	{
		LBGrpPolDB aDBOper = new LBGrpPolDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLBGrpPol描述/A>表字段
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLBGrpPol>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			AddressNo = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 17, SysConst.PACKAGESPILTER );
			GrpName = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 18, SysConst.PACKAGESPILTER );
			FirstPayDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 19,SysConst.PACKAGESPILTER));
			PayEndDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 20,SysConst.PACKAGESPILTER));
			PaytoDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 21,SysConst.PACKAGESPILTER));
			RegetDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 22,SysConst.PACKAGESPILTER));
			LastEdorDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 23,SysConst.PACKAGESPILTER));
			SSFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 24, SysConst.PACKAGESPILTER );
			PeakLine = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,25,SysConst.PACKAGESPILTER))).doubleValue();
			GetLimit = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,26,SysConst.PACKAGESPILTER))).doubleValue();
			GetRate = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,27,SysConst.PACKAGESPILTER))).doubleValue();
			BonusRate = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,28,SysConst.PACKAGESPILTER))).doubleValue();
			MaxMedFee = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,29,SysConst.PACKAGESPILTER))).doubleValue();
			OutPayFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 30, SysConst.PACKAGESPILTER );
			EmployeeRate = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,31,SysConst.PACKAGESPILTER))).doubleValue();
			FamilyRate = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,32,SysConst.PACKAGESPILTER))).doubleValue();
			SpecFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 33, SysConst.PACKAGESPILTER );
			ExpPeoples= new Integer(ChgData.chgNumericStr(StrTool.getStr(strMessage,34,SysConst.PACKAGESPILTER))).intValue();
			ExpPremium = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,35,SysConst.PACKAGESPILTER))).doubleValue();
			ExpAmnt = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,36,SysConst.PACKAGESPILTER))).doubleValue();
			PayMode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 37, SysConst.PACKAGESPILTER );
			ManageFeeRate = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,38,SysConst.PACKAGESPILTER))).doubleValue();
			PayIntv= new Integer(ChgData.chgNumericStr(StrTool.getStr(strMessage,39,SysConst.PACKAGESPILTER))).intValue();
			CValiDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 40,SysConst.PACKAGESPILTER));
			Peoples2= new Integer(ChgData.chgNumericStr(StrTool.getStr(strMessage,41,SysConst.PACKAGESPILTER))).intValue();
			Mult = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,42,SysConst.PACKAGESPILTER))).doubleValue();
			Prem = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,43,SysConst.PACKAGESPILTER))).doubleValue();
			Amnt = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,44,SysConst.PACKAGESPILTER))).doubleValue();
			SumPrem = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,45,SysConst.PACKAGESPILTER))).doubleValue();
			SumPay = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,46,SysConst.PACKAGESPILTER))).doubleValue();
			Dif = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,47,SysConst.PACKAGESPILTER))).doubleValue();
			State = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 48, SysConst.PACKAGESPILTER );
			ApproveFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 49, SysConst.PACKAGESPILTER );
			ApproveCode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 50, SysConst.PACKAGESPILTER );
			ApproveDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 51,SysConst.PACKAGESPILTER));
			ApproveTime = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 52, SysConst.PACKAGESPILTER );
			UWFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 53, SysConst.PACKAGESPILTER );
			UWOperator = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 54, SysConst.PACKAGESPILTER );
			UWDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 55,SysConst.PACKAGESPILTER));
			UWTime = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 56, SysConst.PACKAGESPILTER );
			AppFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 57, SysConst.PACKAGESPILTER );
			Remark = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 58, SysConst.PACKAGESPILTER );
			StandbyFlag1 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 59, SysConst.PACKAGESPILTER );
			StandbyFlag2 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 60, SysConst.PACKAGESPILTER );
			StandbyFlag3 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 61, SysConst.PACKAGESPILTER );
			...
			ModifyDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 65,SysConst.PACKAGESPILTER));
			ModifyTime = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 66, SysConst.PACKAGESPILTER );
			OnWorkPeoples= new Integer(ChgData.chgNumericStr(StrTool.getStr(strMessage,67,SysConst.PACKAGESPILTER))).intValue();
			OffWorkPeoples= new Integer(ChgData.chgNumericStr(StrTool.getStr(strMessage,68,SysConst.PACKAGESPILTER))).intValue();
			OtherPeoples= new Integer(ChgData.chgNumericStr(StrTool.getStr(strMessage,69,SysConst.PACKAGESPILTER))).intValue();
			RelaPeoples= new Integer(ChgData.chgNumericStr(StrTool.getStr(strMessage,70,SysConst.PACKAGESPILTER))).intValue();
			RelaMatePeoples= new Integer(ChgData.chgNumericStr(StrTool.getStr(strMessage,71,SysConst.PACKAGESPILTER))).intValue();
			RelaYoungPeoples= new Integer(ChgData.chgNumericStr(StrTool.getStr(strMessage,72,SysConst.PACKAGESPILTER))).intValue();
			RelaOtherPeoples= new Integer(ChgData.chgNumericStr(StrTool.getStr(strMessage,73,SysConst.PACKAGESPILTER))).intValue();
			WaitPeriod= new Integer(ChgData.chgNumericStr(StrTool.getStr(strMessage,74,SysConst.PACKAGESPILTER))).intValue();
			...
			BonusFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 79, SysConst.PACKAGESPILTER );
			DistriFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 80, SysConst.PACKAGESPILTER );
			Peoples3= new Integer(ChgData.chgNumericStr(StrTool.getStr(strMessage,81,SysConst.PACKAGESPILTER))).intValue();
			FeeRate = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,82,SysConst.PACKAGESPILTER))).doubleValue();
			RenewFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 83, SysConst.PACKAGESPILTER );
			DistriRate = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,84,SysConst.PACKAGESPILTER))).doubleValue();
			Currency = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 85, SysConst.PACKAGESPILTER );
			UintLinkValiFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 86, SysConst.PACKAGESPILTER );
		}
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LBGrpPolSchema other = (LBGrpPolSchema)otherObject;
		return
