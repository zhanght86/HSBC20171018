...
/**
 * <p>ClassName: FIAboriginalDataBDB </p>
 ...
 */
public class FIAboriginalDataBDB extends FIAboriginalDataBSchema
{
private static Logger logger = Logger.getLogger(FIAboriginalDataBDB.class);
	...
	**/
	...
	// @Constructor
	public FIAboriginalDataBDB( Connection tConnection )
	{
		con = tConnection;
	...
	{
		FIAboriginalDataBSchema tSchema = this.getSchema();
		...
		else
		{
			...
			tError.moduleName = "FIAboriginalDataBDB";
	...
	public boolean delete()
	{
		...
		try
		{
			...
			if(this.getDelSerialNo() == null || this.getDelSerialNo().equals("null")) {
				pstmt.setNull(1, 12);
			} else {
				pstmt.setString(1, this.getDelSerialNo().trim());
			}
			pstmt.executeUpdate();
			pstmt.close();
		} catch (Exception ex) {
		...
		sqlObj.getSQL();
//真实的执行语句
logger.debug(String.valueOf("True Error Sql is : DELETE FROM FIAboriginalDataB WHERE DelSerialNo='"+this.getDelSerialNo() + "'").replaceAll("'null'", "null"));
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.getMakeTime() == null || this.getMakeTime().equals("null")) {
				...
				pstmt.setString(69, this.getMakeTime().trim());
			}
			// set where condition
			if(this.getDelSerialNo() == null || this.getDelSerialNo().equals("null")) {
				pstmt.setNull(70, 12);
			} else {
				pstmt.setString(70, this.getDelSerialNo().trim());
			}
			pstmt.executeUpdate();
			pstmt.close();
		} catch (Exception ex) {
...
logger.debug(String.valueOf("True Error Sql is : INSERT INTO FIAboriginalDataB VALUES('"+this.getDelSerialNo() + "'"+",'"+this.getDelOperator() + "'"+",'"+this.getDelReason() + "'"+",'"+this.getASerialNo() + "'"+",'"+this.getAcquisitionID() + "'"+",'"+this.getDataBaseID() + "'"+",'"+this.getBatchNo() + "'"+",'"+this.getCertificateID() + "'"+",'"+this.getCostID() + "'"+",'"+this.getDataState() + "'"+",'"+this.getCheckFlag() + "'"+",'"+this.getBusinessCode() + "'"+",'"+this.getFeeCode() + "'"+","+this.getSumActuMoney()+",'"+this.getAccountDate() + "'"+",'"+this.getBusinessNo() + "'"+",'"+this.getStringInfo01() + "'"+",'"+this.getStringInfo02() + "'"+",'"+this.getStringInfo03() + "'"+",'"+this.getStringInfo04() + "'"+",'"+this.getStringInfo05() + "'"+",'"+this.getStringInfo06() + "'"+",'"+this.getStringInfo07() + "'"+",'"+this.getStringInfo08() + "'"+",'"+this.getStringInfo09() + "'"+",'"+this.getStringInfo10() + "'"+",'"+this.getStringInfo11() + "'"+",'"+this.getStringInfo12() + "'"+",'"+this.getStringInfo13() + "'"+",'"+this.getStringInfo14() + "'"+",'"+this.getStringInfo15() + "'"+",'"+this.getDateInfo01() + "'"+",'"+this.getDateInfo02() + "'"+",'"+this.getDateInfo03() + "'"+",'"+this.getDateInfo04() + "'"+",'"+this.getDateInfo05() + "'"+",'"+this.getDateInfo06() + "'"+",'"+this.getDateInfo07() + "'"+",'"+this.getDateInfo08() + "'"+",'"+this.getDateInfo09() + "'"+",'"+this.getDateInfo10() + "'"+","+this.getNumInfo01()+","+this.getNumInfo02()+","+this.getNumInfo03()+","+this.getNumInfo04()+","+this.getNumInfo05()+",'"+this.getBusinessNo01() + "'"+",'"+this.getBusinessNo02() + "'"+",'"+this.getBusinessNo03() + "'"+",'"+this.getBusinessNo04() + "'"+",'"+this.getBusinessNo05() + "'"+",'"+this.getBusinessNo06() + "'"+",'"+this.getBusinessNo07() + "'"+",'"+this.getBusinessNo08() + "'"+",'"+this.getBusinessNo09() + "'"+",'"+this.getBusinessNo10() + "'"+",'"+this.getTypeFlag01() + "'"+",'"+this.getTypeFlag02() + "'"+",'"+this.getTypeFlag03() + "'"+",'"+this.getTypeFlag04() + "'"+",'"+this.getTypeFlag05() + "'"+",'"+this.getTypeFlag06() + "'"+",'"+this.getTypeFlag07() + "'"+",'"+this.getTypeFlag08() + "'"+",'"+this.getTypeFlag09() + "'"+",'"+this.getTypeFlag10() + "'"+",'"+this.getRelationcode() + "'"+",'"+this.getMakeDate() + "'"+",'"+this.getMakeTime() + "'"+")").replaceAll("'null'", "null"));
	...
	public boolean getInfo()
	{
		...
		try
		{
			pstmt = con.prepareStatement("SELECT * FROM FIAboriginalDataB WHERE  DelSerialNo = ?", 
	...
	public FIAboriginalDataBSet query()
	{
		PreparedStatement pstmt = null;
 		ResultSet rs = null;
		FIAboriginalDataBSet aFIAboriginalDataBSet = new FIAboriginalDataBSet();
	  ...
	  if( !mflag ) {
		...
		{
			SQLString sqlObj = new SQLString("FIAboriginalDataB");
			FIAboriginalDataBSchema aSchema = this.getSchema();
			...
			{
				i++;
				FIAboriginalDataBSchema s1 = new FIAboriginalDataBSchema();
				s1.setSchema(rs,i);
				aFIAboriginalDataBSet.add(s1);
			}
			try{ rs.close(); } catch( Exception ex ) {}
			try{ pstmt.close(); } catch( Exception ex1 ) {}
		}
		...
		return aFIAboriginalDataBSet;

	}

	public FIAboriginalDataBSet executeQuery(String sql)
	{
		Statement stmt = null;
		ResultSet rs = null;
		FIAboriginalDataBSet aFIAboriginalDataBSet = new FIAboriginalDataBSet();
	...
	public FIAboriginalDataBSet query(int nStart, int nCount)
	{
		PreparedStatement pstmt = null;
 		ResultSet rs = null;
		FIAboriginalDataBSet aFIAboriginalDataBSet = new FIAboriginalDataBSet();
	...
	public FIAboriginalDataBSet executeQuery(String sql, int nStart, int nCount)
	{
		Statement stmt = null;
		ResultSet rs = null;
		FIAboriginalDataBSet aFIAboriginalDataBSet = new FIAboriginalDataBSet();
	...
	public boolean update(String strWherePart)
	{
	  ...
	  if( !mflag ) {
		...
		try
		{
			...
			String sql = "update FIAboriginalDataB " + sqlObj.getUpdPart() + " where " + strWherePart;
...
/**
 * 获取定量数据
 * @return FIAboriginalDataBSet
 */
public FIAboriginalDataBSet getData()
{
    int tCount = 0;
    FIAboriginalDataBSet tFIAboriginalDataBSet = new FIAboriginalDataBSet();
    FIAboriginalDataBSchema tFIAboriginalDataBSchema = null;
    if (null == mResultSet)
    {
        CError tError = new CError();
        tError.moduleName = "FIAboriginalDataBDB";
    ...
    {
        tCount = 1;
        tFIAboriginalDataBSchema = new FIAboriginalDataBSchema();
        tFIAboriginalDataBSchema.setSchema(mResultSet, 1);
        tFIAboriginalDataBSet.add(tFIAboriginalDataBSchema);
...
public boolean closeData()
{
	...
	public FIAboriginalDataBSet executeQuery(SQLwithBindVariables sqlbv) {
	...
	public FIAboriginalDataBSet executeQuery(SQLwithBindVariables sqlbv, int nStart, int nCount) {
