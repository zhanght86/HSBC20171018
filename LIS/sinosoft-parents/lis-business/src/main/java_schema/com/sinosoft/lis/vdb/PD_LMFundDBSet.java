...
/*
 * <p>ClassName: PD_LMFundDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: PhysicalDataModel_6
 */
public class PD_LMFundDBSet extends PD_LMFundSet
{
private static Logger logger = Logger.getLogger(PD_LMFundDBSet.class);
	...
	**/
	...
	// @Constructor
	public PD_LMFundDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "PD_LMFundDBSet";
