...
/*
 * <p>ClassName: LCContPlanRiskDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 多币种改造业务表
 */
public class LCContPlanRiskDBSet extends LCContPlanRiskSet
{
private static Logger logger = Logger.getLogger(LCContPlanRiskDBSet.class);
	...
	**/
	...
	// @Constructor
	public LCContPlanRiskDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LCContPlanRiskDBSet";
	...
	public boolean delete()
	{
		...
		try
		{
			...
			if(this.get(i).getPlanType() == null || this.get(i).getPlanType().equals("null")) {
				...
				pstmt.setString(5, StrTool.space1(this.get(i).getPlanType(), 1));
			}
...
ex.printStackTrace();
	...
	public boolean update()
	{
		...
		try
		{
			...
			pstmt.setDouble(16, this.get(i).getRiskPrem());
			if(this.get(i).getSysContPlanCode() == null || this.get(i).getSysContPlanCode().equals("null")) {
				pstmt.setString(17,null);
			} else {
				pstmt.setString(17, this.get(i).getSysContPlanCode());
			}
			pstmt.setDouble(18, this.get(i).getSysContPlanMult());
			pstmt.setDouble(19, this.get(i).getSysContPlanRate());
