...
/*
 * <p>ClassName: RICalParamDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 再保系统模型
 */
public class RICalParamDBSet extends RICalParamSet
{
	// @Field
	...
	**/
	...
	// @Constructor
	public RICalParamDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "RICalParamDBSet";
...
ex.printStackTrace();
	...
	public boolean update()
	{
		...
		try
		{
			...
			pstmt.setDouble(11, this.get(i).getParamDouble1());
			pstmt.setDouble(12, this.get(i).getParamDouble2());
			pstmt.setDouble(13, this.get(i).getParamDouble3());
			pstmt.setDouble(14, this.get(i).getParamDouble4());
			pstmt.setDouble(15, this.get(i).getParamDouble5());
			pstmt.setDouble(16, this.get(i).getParamDouble6());
			pstmt.setDouble(17, this.get(i).getParamDouble7());
			pstmt.setDouble(18, this.get(i).getParamDouble8());
			pstmt.setDouble(19, this.get(i).getParamDouble9());
			pstmt.setDouble(20, this.get(i).getParamDouble10());
			if(this.get(i).getParamString1() == null || this.get(i).getParamString1().equals("null")) {
				pstmt.setString(21,null);
			} else {
				pstmt.setString(21, this.get(i).getParamString1());
			}
			if(this.get(i).getParamString2() == null || this.get(i).getParamString2().equals("null")) {
				pstmt.setString(22,null);
			} else {
				pstmt.setString(22, this.get(i).getParamString2());
			}
			if(this.get(i).getParamString3() == null || this.get(i).getParamString3().equals("null")) {
				pstmt.setString(23,null);
			} else {
				pstmt.setString(23, this.get(i).getParamString3());
			}
			if(this.get(i).getParamString4() == null || this.get(i).getParamString4().equals("null")) {
				pstmt.setString(24,null);
			} else {
				pstmt.setString(24, this.get(i).getParamString4());
			}
			if(this.get(i).getParamString5() == null || this.get(i).getParamString5().equals("null")) {
				pstmt.setString(25,null);
			} else {
				pstmt.setString(25, this.get(i).getParamString5());
			}
			if(this.get(i).getParamString6() == null || this.get(i).getParamString6().equals("null")) {
				pstmt.setString(26,null);
			} else {
				pstmt.setString(26, this.get(i).getParamString6());
			}
			if(this.get(i).getParamDate1() == null || this.get(i).getParamDate1().equals("null")) {
				pstmt.setDate(27,null);
			} else {
				pstmt.setDate(27, Date.valueOf(this.get(i).getParamDate1()));
			}
			if(this.get(i).getParamDate2() == null || this.get(i).getParamDate2().equals("null")) {
				pstmt.setDate(28,null);
			} else {
				pstmt.setDate(28, Date.valueOf(this.get(i).getParamDate2()));
			}
			if(this.get(i).getParamDate3() == null || this.get(i).getParamDate3().equals("null")) {
				pstmt.setDate(29,null);
			} else {
				pstmt.setDate(29, Date.valueOf(this.get(i).getParamDate3()));
			}
			// set where condition
			if(this.get(i).getSerialNo() == null || this.get(i).getSerialNo().equals("null")) {
