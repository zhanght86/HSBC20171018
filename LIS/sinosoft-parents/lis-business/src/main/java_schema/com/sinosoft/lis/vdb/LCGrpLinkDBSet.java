...
/*
 * <p>ClassName: LCGrpLinkDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: Physical Data Model 1
 */
public class LCGrpLinkDBSet extends LCGrpLinkSet
{
	// @Field
	...
	**/
	...
	// @Constructor
	public LCGrpLinkDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LCGrpLinkDBSet";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getLinkManFlag() == null || this.get(i).getLinkManFlag().equals("null")) {
				...
				pstmt.setString(5, this.get(i).getLinkManFlag());
			}
			if(this.get(i).getLinkMan() == null || this.get(i).getLinkMan().equals("null")) {
				pstmt.setString(6,null);
			} else {
				pstmt.setString(6, this.get(i).getLinkMan());
			}
			...
			if(this.get(i).getHeadShip() == null || this.get(i).getHeadShip().equals("null")) {
				...
				pstmt.setString(8, this.get(i).getHeadShip());
			}
			if(this.get(i).getMobilePhone() == null || this.get(i).getMobilePhone().equals("null")) {
				pstmt.setString(9,null);
			} else {
				pstmt.setString(9, this.get(i).getMobilePhone());
			}
			...
			if(this.get(i).getIDStartDate() == null || this.get(i).getIDStartDate().equals("null")) {
				...
				pstmt.setDate(15, Date.valueOf(this.get(i).getIDStartDate()));
			}
			if(this.get(i).getIDEndDate() == null || this.get(i).getIDEndDate().equals("null")) {
				pstmt.setDate(16,null);
			} else {
				pstmt.setDate(16, Date.valueOf(this.get(i).getIDEndDate()));
			}
