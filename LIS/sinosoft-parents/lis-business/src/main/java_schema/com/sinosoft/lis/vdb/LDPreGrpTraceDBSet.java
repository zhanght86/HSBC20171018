...
/*
 * <p>ClassName: LDPreGrpTraceDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: Physical Data Model 1
 */
public class LDPreGrpTraceDBSet extends LDPreGrpTraceSet
{
	// @Field
	...
	**/
	...
	// @Constructor
	public LDPreGrpTraceDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LDPreGrpTraceDBSet";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getPreCustomerName() == null || this.get(i).getPreCustomerName().equals("null")) {
				...
				pstmt.setString(3, this.get(i).getPreCustomerName());
			}
			...
			if(this.get(i).getBusiCategory() == null || this.get(i).getBusiCategory().equals("null")) {
				...
				pstmt.setString(7, this.get(i).getBusiCategory());
			}
			pstmt.setInt(8, this.get(i).getSumNumPeople());
			pstmt.setInt(9, this.get(i).getPreSumPeople());
			pstmt.setDouble(10, this.get(i).getPreSumPrem());
			if(this.get(i).getUpCustomerNo() == null || this.get(i).getUpCustomerNo().equals("null")) {
				pstmt.setString(11,null);
			} else {
				pstmt.setString(11, this.get(i).getUpCustomerNo());
			}
			...
			if(this.get(i).getTraceID() == null || this.get(i).getTraceID().equals("null")) {
				...
				pstmt.setString(28, this.get(i).getTraceID());
			}
			if(this.get(i).getPreCustomerNo() == null || this.get(i).getPreCustomerNo().equals("null")) {
				pstmt.setString(29,null);
			} else {
				pstmt.setString(29, this.get(i).getPreCustomerNo());
			}
