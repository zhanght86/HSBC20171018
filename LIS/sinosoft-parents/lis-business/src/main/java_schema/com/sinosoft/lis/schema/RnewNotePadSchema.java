...
import com.sinosoft.lis.db.RnewNotePadDB;

/*
 * <p>ClassName: RnewNotePadSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 续期续保二核
 */
public class RnewNotePadSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(RnewNotePadSchema.class);
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		RnewNotePadSchema cloned = (RnewNotePadSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 RnewNotePadSchema 对象给 Schema 赋值
	* @param: aRnewNotePadSchema RnewNotePadSchema
	**/
	public void setSchema(RnewNotePadSchema aRnewNotePadSchema)
	{
		this.GrpContNo = aRnewNotePadSchema.getGrpContNo();
		this.ContNo = aRnewNotePadSchema.getContNo();
		this.ProposalContNo = aRnewNotePadSchema.getProposalContNo();
		this.SerialNo = aRnewNotePadSchema.getSerialNo();
		this.OperatePos = aRnewNotePadSchema.getOperatePos();
		this.PrtNo = aRnewNotePadSchema.getPrtNo();
		this.NotePadCont = aRnewNotePadSchema.getNotePadCont();
		this.Operator = aRnewNotePadSchema.getOperator();
		this.ManageCom = aRnewNotePadSchema.getManageCom();
		this.MakeDate = fDate.getDate( aRnewNotePadSchema.getMakeDate());
		this.MakeTime = aRnewNotePadSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aRnewNotePadSchema.getModifyDate());
		this.ModifyTime = aRnewNotePadSchema.getModifyTime();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的RnewNotePad表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "RnewNotePadSchema";
	...
	public RnewNotePadSchema getSchema()
	{
		RnewNotePadSchema aRnewNotePadSchema = new RnewNotePadSchema();
		aRnewNotePadSchema.setSchema(this);
		return aRnewNotePadSchema;
	}

	public RnewNotePadDB getDB()
	{
		RnewNotePadDB aDBOper = new RnewNotePadDB();
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpRnewNotePad>历史记账凭证主表信息</A>表字段
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		RnewNotePadSchema other = (RnewNotePadSchema)otherObject;
		return
