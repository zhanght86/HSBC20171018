...
/*
 * <p>ClassName: LPGrpPolSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 保全核心
 */
public class LPGrpPolSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LPGrpPolSchema.class);
	// @Field
	/** 批单号 */
	...
	public static final int FIELDNUM = 114;	// 数据库表的字段个数
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LPGrpPolSchema cloned = (LPGrpPolSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LPGrpPolSchema 对象给 Schema 赋值
	* @param: aLPGrpPolSchema LPGrpPolSchema
	**/
	public void setSchema(LPGrpPolSchema aLPGrpPolSchema)
	{
		this.EdorNo = aLPGrpPolSchema.getEdorNo();
		this.EdorType = aLPGrpPolSchema.getEdorType();
		this.GrpPolNo = aLPGrpPolSchema.getGrpPolNo();
		this.GrpContNo = aLPGrpPolSchema.getGrpContNo();
		this.GrpProposalNo = aLPGrpPolSchema.getGrpProposalNo();
		this.PrtNo = aLPGrpPolSchema.getPrtNo();
		this.KindCode = aLPGrpPolSchema.getKindCode();
		this.RiskCode = aLPGrpPolSchema.getRiskCode();
		this.RiskVersion = aLPGrpPolSchema.getRiskVersion();
		this.SaleChnl = aLPGrpPolSchema.getSaleChnl();
		this.ManageCom = aLPGrpPolSchema.getManageCom();
		this.AgentCom = aLPGrpPolSchema.getAgentCom();
		this.AgentType = aLPGrpPolSchema.getAgentType();
		this.AgentCode = aLPGrpPolSchema.getAgentCode();
		this.AgentGroup = aLPGrpPolSchema.getAgentGroup();
		this.AgentCode1 = aLPGrpPolSchema.getAgentCode1();
		this.CustomerNo = aLPGrpPolSchema.getCustomerNo();
		this.AddressNo = aLPGrpPolSchema.getAddressNo();
		this.GrpName = aLPGrpPolSchema.getGrpName();
		this.FirstPayDate = fDate.getDate( aLPGrpPolSchema.getFirstPayDate());
		this.PayEndDate = fDate.getDate( aLPGrpPolSchema.getPayEndDate());
		this.PaytoDate = fDate.getDate( aLPGrpPolSchema.getPaytoDate());
		this.RegetDate = fDate.getDate( aLPGrpPolSchema.getRegetDate());
		this.LastEdorDate = fDate.getDate( aLPGrpPolSchema.getLastEdorDate());
		this.SSFlag = aLPGrpPolSchema.getSSFlag();
		this.PeakLine = aLPGrpPolSchema.getPeakLine();
		this.GetLimit = aLPGrpPolSchema.getGetLimit();
		this.GetRate = aLPGrpPolSchema.getGetRate();
		this.BonusRate = aLPGrpPolSchema.getBonusRate();
		this.MaxMedFee = aLPGrpPolSchema.getMaxMedFee();
		this.OutPayFlag = aLPGrpPolSchema.getOutPayFlag();
		this.EmployeeRate = aLPGrpPolSchema.getEmployeeRate();
		this.FamilyRate = aLPGrpPolSchema.getFamilyRate();
		this.SpecFlag = aLPGrpPolSchema.getSpecFlag();
		this.ExpPeoples = aLPGrpPolSchema.getExpPeoples();
		this.ExpPremium = aLPGrpPolSchema.getExpPremium();
		this.ExpAmnt = aLPGrpPolSchema.getExpAmnt();
		this.PayMode = aLPGrpPolSchema.getPayMode();
		this.ManageFeeRate = aLPGrpPolSchema.getManageFeeRate();
		this.PayIntv = aLPGrpPolSchema.getPayIntv();
		this.CValiDate = fDate.getDate( aLPGrpPolSchema.getCValiDate());
		this.Peoples2 = aLPGrpPolSchema.getPeoples2();
		this.Mult = aLPGrpPolSchema.getMult();
		this.Prem = aLPGrpPolSchema.getPrem();
		this.Amnt = aLPGrpPolSchema.getAmnt();
		this.SumPrem = aLPGrpPolSchema.getSumPrem();
		this.SumPay = aLPGrpPolSchema.getSumPay();
		this.Dif = aLPGrpPolSchema.getDif();
		this.State = aLPGrpPolSchema.getState();
		this.ApproveFlag = aLPGrpPolSchema.getApproveFlag();
		this.ApproveCode = aLPGrpPolSchema.getApproveCode();
		this.ApproveDate = fDate.getDate( aLPGrpPolSchema.getApproveDate());
		this.ApproveTime = aLPGrpPolSchema.getApproveTime();
		this.UWFlag = aLPGrpPolSchema.getUWFlag();
		this.UWOperator = aLPGrpPolSchema.getUWOperator();
		this.UWDate = fDate.getDate( aLPGrpPolSchema.getUWDate());
		this.UWTime = aLPGrpPolSchema.getUWTime();
		this.AppFlag = aLPGrpPolSchema.getAppFlag();
		this.Remark = aLPGrpPolSchema.getRemark();
		this.StandbyFlag1 = aLPGrpPolSchema.getStandbyFlag1();
		this.StandbyFlag2 = aLPGrpPolSchema.getStandbyFlag2();
		this.StandbyFlag3 = aLPGrpPolSchema.getStandbyFlag3();
		this.Operator = aLPGrpPolSchema.getOperator();
		this.MakeDate = fDate.getDate( aLPGrpPolSchema.getMakeDate());
		this.MakeTime = aLPGrpPolSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLPGrpPolSchema.getModifyDate());
		this.ModifyTime = aLPGrpPolSchema.getModifyTime();
		this.OnWorkPeoples = aLPGrpPolSchema.getOnWorkPeoples();
		this.OffWorkPeoples = aLPGrpPolSchema.getOffWorkPeoples();
		this.OtherPeoples = aLPGrpPolSchema.getOtherPeoples();
		this.RelaPeoples = aLPGrpPolSchema.getRelaPeoples();
		this.RelaMatePeoples = aLPGrpPolSchema.getRelaMatePeoples();
		this.RelaYoungPeoples = aLPGrpPolSchema.getRelaYoungPeoples();
		this.RelaOtherPeoples = aLPGrpPolSchema.getRelaOtherPeoples();
		this.WaitPeriod = aLPGrpPolSchema.getWaitPeriod();
		this.BONUSFLAG = aLPGrpPolSchema.getBONUSFLAG();
		this.HealthInsurType = aLPGrpPolSchema.getHealthInsurType();
		this.AscriptionFlag = aLPGrpPolSchema.getAscriptionFlag();
		this.InitRate = aLPGrpPolSchema.getInitRate();
		this.HealthProType = aLPGrpPolSchema.getHealthProType();
		this.DistriFlag = aLPGrpPolSchema.getDistriFlag();
		this.Peoples3 = aLPGrpPolSchema.getPeoples3();
		this.FeeRate = aLPGrpPolSchema.getFeeRate();
		this.RenewFlag = aLPGrpPolSchema.getRenewFlag();
		this.DistriRate = aLPGrpPolSchema.getDistriRate();
		this.FixprofitRate = aLPGrpPolSchema.getFixprofitRate();
		this.ChargeFeeRate = aLPGrpPolSchema.getChargeFeeRate();
		this.CommRate = aLPGrpPolSchema.getCommRate();
		this.StandbyFlag4 = aLPGrpPolSchema.getStandbyFlag4();
		this.Currency = aLPGrpPolSchema.getCurrency();
		this.UintLinkValiFlag = aLPGrpPolSchema.getUintLinkValiFlag();
		this.RenewCount = aLPGrpPolSchema.getRenewCount();
		this.RenewContNo = aLPGrpPolSchema.getRenewContNo();
		this.InitNumPeople = aLPGrpPolSchema.getInitNumPeople();
		this.InitMult = aLPGrpPolSchema.getInitMult();
		this.InitAmnt = aLPGrpPolSchema.getInitAmnt();
		this.InitRiskAmnt = aLPGrpPolSchema.getInitRiskAmnt();
		this.InitPrem = aLPGrpPolSchema.getInitPrem();
		this.InitStandPrem = aLPGrpPolSchema.getInitStandPrem();
		this.RiskAmnt = aLPGrpPolSchema.getRiskAmnt();
		this.StandPrem = aLPGrpPolSchema.getStandPrem();
		this.SumNumPeople = aLPGrpPolSchema.getSumNumPeople();
		this.ValDateType = aLPGrpPolSchema.getValDateType();
		this.EndDate = fDate.getDate( aLPGrpPolSchema.getEndDate());
		this.AutoPayFlag = aLPGrpPolSchema.getAutoPayFlag();
		this.SubFlag = aLPGrpPolSchema.getSubFlag();
		this.StopFlag = aLPGrpPolSchema.getStopFlag();
		this.KeepValueOpt = aLPGrpPolSchema.getKeepValueOpt();
		this.Lang = aLPGrpPolSchema.getLang();
		this.GradeFeeRate = aLPGrpPolSchema.getGradeFeeRate();
		this.OtherFeeRate = aLPGrpPolSchema.getOtherFeeRate();
		this.PricingMode = aLPGrpPolSchema.getPricingMode();
		this.ComCode = aLPGrpPolSchema.getComCode();
		this.ModifyOperator = aLPGrpPolSchema.getModifyOperator();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LPGrpPol表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LPGrpPolSchema";
	...
	public LPGrpPolSchema getSchema()
	{
		LPGrpPolSchema aLPGrpPolSchema = new LPGrpPolSchema();
		aLPGrpPolSchema.setSchema(this);
		return aLPGrpPolSchema;
	}

	public LPGrpPolDB getDB()
	{
		LPGrpPolDB aDBOper = new LPGrpPolDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLPGrpPol描述/A>表字段
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLPGrpPol>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			FirstPayDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 20,SysConst.PACKAGESPILTER));
			PayEndDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 21,SysConst.PACKAGESPILTER));
			PaytoDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 22,SysConst.PACKAGESPILTER));
			RegetDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 23,SysConst.PACKAGESPILTER));
			LastEdorDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 24,SysConst.PACKAGESPILTER));
			SSFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 25, SysConst.PACKAGESPILTER );
			PeakLine = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,26,SysConst.PACKAGESPILTER))).doubleValue();
			GetLimit = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,27,SysConst.PACKAGESPILTER))).doubleValue();
			GetRate = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,28,SysConst.PACKAGESPILTER))).doubleValue();
			BonusRate = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,29,SysConst.PACKAGESPILTER))).doubleValue();
			MaxMedFee = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,30,SysConst.PACKAGESPILTER))).doubleValue();
			OutPayFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 31, SysConst.PACKAGESPILTER );
			EmployeeRate = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,32,SysConst.PACKAGESPILTER))).doubleValue();
			FamilyRate = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,33,SysConst.PACKAGESPILTER))).doubleValue();
			SpecFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 34, SysConst.PACKAGESPILTER );
			ExpPeoples= new Integer(ChgData.chgNumericStr(StrTool.getStr(strMessage,35,SysConst.PACKAGESPILTER))).intValue();
			ExpPremium = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,36,SysConst.PACKAGESPILTER))).doubleValue();
			ExpAmnt = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,37,SysConst.PACKAGESPILTER))).doubleValue();
			PayMode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 38, SysConst.PACKAGESPILTER );
			ManageFeeRate = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,39,SysConst.PACKAGESPILTER))).doubleValue();
			PayIntv= new Integer(ChgData.chgNumericStr(StrTool.getStr(strMessage,40,SysConst.PACKAGESPILTER))).intValue();
			CValiDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 41,SysConst.PACKAGESPILTER));
			Peoples2= new Integer(ChgData.chgNumericStr(StrTool.getStr(strMessage,42,SysConst.PACKAGESPILTER))).intValue();
			...
			SumPrem = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,46,SysConst.PACKAGESPILTER))).doubleValue();
			SumPay = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,47,SysConst.PACKAGESPILTER))).doubleValue();
			Dif = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,48,SysConst.PACKAGESPILTER))).doubleValue();
			State = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 49, SysConst.PACKAGESPILTER );
			ApproveFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 50, SysConst.PACKAGESPILTER );
			ApproveCode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 51, SysConst.PACKAGESPILTER );
			ApproveDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 52,SysConst.PACKAGESPILTER));
			ApproveTime = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 53, SysConst.PACKAGESPILTER );
			UWFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 54, SysConst.PACKAGESPILTER );
			UWOperator = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 55, SysConst.PACKAGESPILTER );
			UWDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 56,SysConst.PACKAGESPILTER));
			UWTime = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 57, SysConst.PACKAGESPILTER );
			AppFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 58, SysConst.PACKAGESPILTER );
			Remark = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 59, SysConst.PACKAGESPILTER );
			StandbyFlag1 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 60, SysConst.PACKAGESPILTER );
			StandbyFlag2 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 61, SysConst.PACKAGESPILTER );
			StandbyFlag3 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 62, SysConst.PACKAGESPILTER );
			Operator = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 63, SysConst.PACKAGESPILTER );
			...
			OnWorkPeoples= new Integer(ChgData.chgNumericStr(StrTool.getStr(strMessage,68,SysConst.PACKAGESPILTER))).intValue();
			OffWorkPeoples= new Integer(ChgData.chgNumericStr(StrTool.getStr(strMessage,69,SysConst.PACKAGESPILTER))).intValue();
			OtherPeoples= new Integer(ChgData.chgNumericStr(StrTool.getStr(strMessage,70,SysConst.PACKAGESPILTER))).intValue();
			RelaPeoples= new Integer(ChgData.chgNumericStr(StrTool.getStr(strMessage,71,SysConst.PACKAGESPILTER))).intValue();
			RelaMatePeoples= new Integer(ChgData.chgNumericStr(StrTool.getStr(strMessage,72,SysConst.PACKAGESPILTER))).intValue();
			RelaYoungPeoples= new Integer(ChgData.chgNumericStr(StrTool.getStr(strMessage,73,SysConst.PACKAGESPILTER))).intValue();
			RelaOtherPeoples= new Integer(ChgData.chgNumericStr(StrTool.getStr(strMessage,74,SysConst.PACKAGESPILTER))).intValue();
			WaitPeriod= new Integer(ChgData.chgNumericStr(StrTool.getStr(strMessage,75,SysConst.PACKAGESPILTER))).intValue();
			BONUSFLAG = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 76, SysConst.PACKAGESPILTER );
			HealthInsurType = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 77, SysConst.PACKAGESPILTER );
			AscriptionFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 78, SysConst.PACKAGESPILTER );
			InitRate = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,79,SysConst.PACKAGESPILTER))).doubleValue();
			HealthProType = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 80, SysConst.PACKAGESPILTER );
			DistriFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 81, SysConst.PACKAGESPILTER );
			Peoples3= new Integer(ChgData.chgNumericStr(StrTool.getStr(strMessage,82,SysConst.PACKAGESPILTER))).intValue();
			FeeRate = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,83,SysConst.PACKAGESPILTER))).doubleValue();
			RenewFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 84, SysConst.PACKAGESPILTER );
			DistriRate = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,85,SysConst.PACKAGESPILTER))).doubleValue();
			FixprofitRate = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,86,SysConst.PACKAGESPILTER))).doubleValue();
			ChargeFeeRate = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,87,SysConst.PACKAGESPILTER))).doubleValue();
			CommRate = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,88,SysConst.PACKAGESPILTER))).doubleValue();
			StandbyFlag4 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 89, SysConst.PACKAGESPILTER );
			Currency = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 90, SysConst.PACKAGESPILTER );
			UintLinkValiFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 91, SysConst.PACKAGESPILTER );
			RenewCount= new Integer(ChgData.chgNumericStr(StrTool.getStr(strMessage,92,SysConst.PACKAGESPILTER))).intValue();
			RenewContNo = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 93, SysConst.PACKAGESPILTER );
			InitNumPeople= new Integer(ChgData.chgNumericStr(StrTool.getStr(strMessage,94,SysConst.PACKAGESPILTER))).intValue();
			InitMult = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,95,SysConst.PACKAGESPILTER))).doubleValue();
			InitAmnt = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,96,SysConst.PACKAGESPILTER))).doubleValue();
			InitRiskAmnt = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,97,SysConst.PACKAGESPILTER))).doubleValue();
			InitPrem = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,98,SysConst.PACKAGESPILTER))).doubleValue();
			InitStandPrem = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,99,SysConst.PACKAGESPILTER))).doubleValue();
			RiskAmnt = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,100,SysConst.PACKAGESPILTER))).doubleValue();
			StandPrem = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,101,SysConst.PACKAGESPILTER))).doubleValue();
			SumNumPeople= new Integer(ChgData.chgNumericStr(StrTool.getStr(strMessage,102,SysConst.PACKAGESPILTER))).intValue();
			ValDateType = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 103, SysConst.PACKAGESPILTER );
			EndDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 104,SysConst.PACKAGESPILTER));
			AutoPayFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 105, SysConst.PACKAGESPILTER );
			SubFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 106, SysConst.PACKAGESPILTER );
			StopFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 107, SysConst.PACKAGESPILTER );
			KeepValueOpt = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 108, SysConst.PACKAGESPILTER );
			Lang = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 109, SysConst.PACKAGESPILTER );
			GradeFeeRate = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,110,SysConst.PACKAGESPILTER))).doubleValue();
			OtherFeeRate = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,111,SysConst.PACKAGESPILTER))).doubleValue();
			PricingMode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 112, SysConst.PACKAGESPILTER );
			ComCode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 113, SysConst.PACKAGESPILTER );
			ModifyOperator = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 114, SysConst.PACKAGESPILTER );
		}
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LPGrpPolSchema other = (LPGrpPolSchema)otherObject;
		return
