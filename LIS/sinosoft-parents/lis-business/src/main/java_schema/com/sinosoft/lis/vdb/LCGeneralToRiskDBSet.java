...
/*
 * <p>ClassName: LCGeneralToRiskDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 承保核心
 */
public class LCGeneralToRiskDBSet extends LCGeneralToRiskSet
{
	// @Field
	...
	**/
	...
	// @Constructor
	public LCGeneralToRiskDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LCGeneralToRiskDBSet";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getAccName() == null || this.get(i).getAccName().equals("null")) {
				...
				pstmt.setString(22, this.get(i).getAccName());
			}
			if(this.get(i).getFirstPayDate() == null || this.get(i).getFirstPayDate().equals("null")) {
				pstmt.setDate(23,null);
			} else {
				pstmt.setDate(23, Date.valueOf(this.get(i).getFirstPayDate()));
			}
			if(this.get(i).getPayEndDate() == null || this.get(i).getPayEndDate().equals("null")) {
				pstmt.setDate(24,null);
			} else {
				pstmt.setDate(24, Date.valueOf(this.get(i).getPayEndDate()));
			}
			if(this.get(i).getPaytoDate() == null || this.get(i).getPaytoDate().equals("null")) {
				pstmt.setDate(25,null);
			} else {
				pstmt.setDate(25, Date.valueOf(this.get(i).getPaytoDate()));
			}
			if(this.get(i).getRegetDate() == null || this.get(i).getRegetDate().equals("null")) {
				pstmt.setDate(26,null);
			} else {
				pstmt.setDate(26, Date.valueOf(this.get(i).getRegetDate()));
			}
			if(this.get(i).getLastEdorDate() == null || this.get(i).getLastEdorDate().equals("null")) {
				pstmt.setDate(27,null);
			} else {
				pstmt.setDate(27, Date.valueOf(this.get(i).getLastEdorDate()));
			}
			if(this.get(i).getSSFlag() == null || this.get(i).getSSFlag().equals("null")) {
				pstmt.setString(28,null);
			} else {
				pstmt.setString(28, this.get(i).getSSFlag());
			}
			pstmt.setDouble(29, this.get(i).getPeakLine());
			pstmt.setDouble(30, this.get(i).getGetLimit());
			pstmt.setDouble(31, this.get(i).getGetRate());
			pstmt.setDouble(32, this.get(i).getBonusRate());
			pstmt.setDouble(33, this.get(i).getMaxMedFee());
			if(this.get(i).getOutPayFlag() == null || this.get(i).getOutPayFlag().equals("null")) {
				pstmt.setString(34,null);
			} else {
				pstmt.setString(34, this.get(i).getOutPayFlag());
			}
			pstmt.setDouble(35, this.get(i).getEmployeeRate());
			pstmt.setDouble(36, this.get(i).getFamilyRate());
			if(this.get(i).getSpecFlag() == null || this.get(i).getSpecFlag().equals("null")) {
				pstmt.setString(37,null);
			} else {
				pstmt.setString(37, this.get(i).getSpecFlag());
			}
			pstmt.setInt(38, this.get(i).getExpPeoples());
			pstmt.setDouble(39, this.get(i).getExpPremium());
			pstmt.setDouble(40, this.get(i).getExpAmnt());
			if(this.get(i).getPayMode() == null || this.get(i).getPayMode().equals("null")) {
				pstmt.setString(41,null);
			} else {
				pstmt.setString(41, this.get(i).getPayMode());
			}
			pstmt.setDouble(42, this.get(i).getManageFeeRate());
			pstmt.setInt(43, this.get(i).getPayIntv());
			if(this.get(i).getCValiDate() == null || this.get(i).getCValiDate().equals("null")) {
				pstmt.setDate(44,null);
			} else {
				pstmt.setDate(44, Date.valueOf(this.get(i).getCValiDate()));
			}
			pstmt.setInt(45, this.get(i).getPeoples2());
			pstmt.setDouble(46, this.get(i).getMult());
			pstmt.setDouble(47, this.get(i).getPrem());
			pstmt.setDouble(48, this.get(i).getAmnt());
			pstmt.setDouble(49, this.get(i).getSumPrem());
			pstmt.setDouble(50, this.get(i).getSumPay());
			pstmt.setDouble(51, this.get(i).getDif());
			if(this.get(i).getState() == null || this.get(i).getState().equals("null")) {
				pstmt.setString(52,null);
			} else {
				pstmt.setString(52, this.get(i).getState());
			}
			...
			if(this.get(i).getApproveDate() == null || this.get(i).getApproveDate().equals("null")) {
				...
				pstmt.setDate(55, Date.valueOf(this.get(i).getApproveDate()));
			}
			...
			if(this.get(i).getUWDate() == null || this.get(i).getUWDate().equals("null")) {
				...
				pstmt.setDate(59, Date.valueOf(this.get(i).getUWDate()));
			}
			...
			if(this.get(i).getStandbyFlag1() == null || this.get(i).getStandbyFlag1().equals("null")) {
				...
				pstmt.setString(63, this.get(i).getStandbyFlag1());
			}
			if(this.get(i).getStandbyFlag2() == null || this.get(i).getStandbyFlag2().equals("null")) {
				pstmt.setString(64,null);
			} else {
				pstmt.setString(64, this.get(i).getStandbyFlag2());
			}
			if(this.get(i).getStandbyFlag3() == null || this.get(i).getStandbyFlag3().equals("null")) {
				pstmt.setString(65,null);
			} else {
				pstmt.setString(65, this.get(i).getStandbyFlag3());
			}
			...
			if(this.get(i).getMakeDate() == null || this.get(i).getMakeDate().equals("null")) {
				...
				pstmt.setDate(67, Date.valueOf(this.get(i).getMakeDate()));
			}
			...
			if(this.get(i).getModifyDate() == null || this.get(i).getModifyDate().equals("null")) {
				...
				pstmt.setDate(69, Date.valueOf(this.get(i).getModifyDate()));
			}
			...
			if(this.get(i).getGrpPolNo() == null || this.get(i).getGrpPolNo().equals("null")) {
				...
				pstmt.setString(71, this.get(i).getGrpPolNo());
			}
			if(this.get(i).getGrpContNo() == null || this.get(i).getGrpContNo().equals("null")) {
			...
			if(this.get(i).getExecuteCom() == null || this.get(i).getExecuteCom().equals("null")) {
				...
				pstmt.setString(73, this.get(i).getExecuteCom());
			}
