...
/*
 * <p>ClassName: PD_LMRiskDutyFactorDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 产品定义平台_PDM
 */
public class PD_LMRiskDutyFactorDBSet extends PD_LMRiskDutyFactorSet
{
private static Logger logger = Logger.getLogger(PD_LMRiskDutyFactorDBSet.class);
	...
	**/
	...
	// @Constructor
	public PD_LMRiskDutyFactorDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public PD_LMRiskDutyFactorDBSet()
	{
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "PD_LMRiskDutyFactorDBSet";
	...
	public boolean delete()
	{
		...
		try
		{
			...
			if(this.get(i).getCalFactor() == null || this.get(i).getCalFactor().equals("null")) {
				...
				pstmt.setString(3, this.get(i).getCalFactor());
			}
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getCalFactorType() == null || this.get(i).getCalFactorType().equals("null")) {
				...
				pstmt.setString(5, this.get(i).getCalFactorType());
			}
			...
			if(this.get(i).getChooseFlag() == null || this.get(i).getChooseFlag().equals("null")) {
				...
				pstmt.setString(7, this.get(i).getChooseFlag());
			}
			if(this.get(i).getFactorNoti() == null || this.get(i).getFactorNoti().equals("null")) {
				pstmt.setString(8,null);
			} else {
				pstmt.setString(8, this.get(i).getFactorNoti());
			}
			pstmt.setInt(9, this.get(i).getFactorOrder());
			...
			if(this.get(i).getInsuAccNo() == null || this.get(i).getInsuAccNo().equals("null")) {
				...
				pstmt.setString(12, this.get(i).getInsuAccNo());
			}
