...
/*
 * <p>ClassName: LBInsureAccTraceDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 投连改造
 */
public class LBInsureAccTraceDBSet extends LBInsureAccTraceSet
{
	// @Field
	...
	**/
	...
	// @Constructor
	public LBInsureAccTraceDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LBInsureAccTraceDBSet";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getMoneyType() == null || this.get(i).getMoneyType().equals("null")) {
				...
				pstmt.setString(13, this.get(i).getMoneyType());
			}
			pstmt.setDouble(14, this.get(i).getMoney());
			pstmt.setDouble(15, this.get(i).getUnitCount());
