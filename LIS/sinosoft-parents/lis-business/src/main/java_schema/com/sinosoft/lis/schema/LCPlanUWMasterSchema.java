...
/*
 * <p>ClassName: LCPlanUWMasterSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 寿险业务系统未整理模型
 */
public class LCPlanUWMasterSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LCPlanUWMasterSchema.class);
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LCPlanUWMasterSchema cloned = (LCPlanUWMasterSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LCPlanUWMasterSchema 对象给 Schema 赋值
	* @param: aLCPlanUWMasterSchema LCPlanUWMasterSchema
	**/
	public void setSchema(LCPlanUWMasterSchema aLCPlanUWMasterSchema)
	{
		this.GrpContNo = aLCPlanUWMasterSchema.getGrpContNo();
		this.ContNo = aLCPlanUWMasterSchema.getContNo();
		this.ProposalContNo = aLCPlanUWMasterSchema.getProposalContNo();
		this.ContPlanCode = aLCPlanUWMasterSchema.getContPlanCode();
		this.PlanType = aLCPlanUWMasterSchema.getPlanType();
		this.UWNo = aLCPlanUWMasterSchema.getUWNo();
		this.InsuredNo = aLCPlanUWMasterSchema.getInsuredNo();
		this.InsuredName = aLCPlanUWMasterSchema.getInsuredName();
		this.AppntNo = aLCPlanUWMasterSchema.getAppntNo();
		this.AppntName = aLCPlanUWMasterSchema.getAppntName();
		this.AgentCode = aLCPlanUWMasterSchema.getAgentCode();
		this.AgentGroup = aLCPlanUWMasterSchema.getAgentGroup();
		this.SugPassFlag = aLCPlanUWMasterSchema.getSugPassFlag();
		this.PassFlag = aLCPlanUWMasterSchema.getPassFlag();
		this.UWGrade = aLCPlanUWMasterSchema.getUWGrade();
		this.AppGrade = aLCPlanUWMasterSchema.getAppGrade();
		this.PostponeDay = aLCPlanUWMasterSchema.getPostponeDay();
		this.PostponeDate = fDate.getDate( aLCPlanUWMasterSchema.getPostponeDate());
		this.AutoUWFlag = aLCPlanUWMasterSchema.getAutoUWFlag();
		this.State = aLCPlanUWMasterSchema.getState();
		this.ManageCom = aLCPlanUWMasterSchema.getManageCom();
		this.UWIdea = aLCPlanUWMasterSchema.getUWIdea();
		this.UpReportContent = aLCPlanUWMasterSchema.getUpReportContent();
		this.HealthFlag = aLCPlanUWMasterSchema.getHealthFlag();
		this.QuesFlag = aLCPlanUWMasterSchema.getQuesFlag();
		this.SpecFlag = aLCPlanUWMasterSchema.getSpecFlag();
		this.AddPremFlag = aLCPlanUWMasterSchema.getAddPremFlag();
		this.AddPremReason = aLCPlanUWMasterSchema.getAddPremReason();
		this.ReportFlag = aLCPlanUWMasterSchema.getReportFlag();
		this.PrintFlag = aLCPlanUWMasterSchema.getPrintFlag();
		this.PrintFlag2 = aLCPlanUWMasterSchema.getPrintFlag2();
		this.ChangePolFlag = aLCPlanUWMasterSchema.getChangePolFlag();
		this.ChangePolReason = aLCPlanUWMasterSchema.getChangePolReason();
		this.SpecReason = aLCPlanUWMasterSchema.getSpecReason();
		this.SugUWIdea = aLCPlanUWMasterSchema.getSugUWIdea();
		this.UpReport = aLCPlanUWMasterSchema.getUpReport();
		this.Operator = aLCPlanUWMasterSchema.getOperator();
		this.MakeDate = fDate.getDate( aLCPlanUWMasterSchema.getMakeDate());
		this.MakeTime = aLCPlanUWMasterSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLCPlanUWMasterSchema.getModifyDate());
		this.ModifyTime = aLCPlanUWMasterSchema.getModifyTime();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LCPlanUWMaster表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LCPlanUWMasterSchema";
	...
	public LCPlanUWMasterSchema getSchema()
	{
		LCPlanUWMasterSchema aLCPlanUWMasterSchema = new LCPlanUWMasterSchema();
		aLCPlanUWMasterSchema.setSchema(this);
		return aLCPlanUWMasterSchema;
	}

	public LCPlanUWMasterDB getDB()
	{
		LCPlanUWMasterDB aDBOper = new LCPlanUWMasterDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLCPlanUWMaster描述/A>表字段
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLCPlanUWMaster>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			SugPassFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 13, SysConst.PACKAGESPILTER );
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LCPlanUWMasterSchema other = (LCPlanUWMasterSchema)otherObject;
		return
