...
/*
 * <p>ClassName: LCCustomerAccountDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 新单管理
 */
public class LCCustomerAccountDBSet extends LCCustomerAccountSet
{
	// @Field
	...
	**/
	...
	// @Constructor
	public LCCustomerAccountDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LCCustomerAccountDBSet";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getAccKind() == null || this.get(i).getAccKind().equals("null")) {
				...
				pstmt.setString(4, this.get(i).getAccKind());
			}
			...
			if(this.get(i).getBankAccNo() == null || this.get(i).getBankAccNo().equals("null")) {
				...
				pstmt.setString(6, this.get(i).getBankAccNo());
			}
			...
			if(this.get(i).getFirstPayFlag() == null || this.get(i).getFirstPayFlag().equals("null")) {
				...
				pstmt.setString(8, this.get(i).getFirstPayFlag());
			}
			...
			if(this.get(i).getPayType() == null || this.get(i).getPayType().equals("null")) {
				...
				pstmt.setString(10, this.get(i).getPayType());
			}
			...
			if(this.get(i).getCustomerType() == null || this.get(i).getCustomerType().equals("null")) {
				...
				pstmt.setString(22, this.get(i).getCustomerType());
			}
			if(this.get(i).getCustomerNo() == null || this.get(i).getCustomerNo().equals("null")) {
