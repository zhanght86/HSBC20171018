...
/*
 * <p>ClassName: LCInsureAccClassFeeDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 承保核心
 */
public class LCInsureAccClassFeeDBSet extends LCInsureAccClassFeeSet
{
	// @Field
	...
	**/
	...
	// @Constructor
	public LCInsureAccClassFeeDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public LCInsureAccClassFeeDBSet()
	{
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LCInsureAccClassFeeDBSet";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getInvestType() == null || this.get(i).getInvestType().equals("null")) {
				...
				pstmt.setString(31, this.get(i).getInvestType());
			}
			...
			if(this.get(i).getInsuAccNo() == null || this.get(i).getInsuAccNo().equals("null")) {
				...
				pstmt.setString(35, this.get(i).getInsuAccNo());
			}
			if(this.get(i).getPayPlanCode() == null || this.get(i).getPayPlanCode().equals("null")) {
			...
			if(this.get(i).getOtherNo() == null || this.get(i).getOtherNo().equals("null")) {
				...
				pstmt.setString(37, this.get(i).getOtherNo());
			}
			if(this.get(i).getAccAscription() == null || this.get(i).getAccAscription().equals("null")) {
				pstmt.setString(38,null);
			} else {
				pstmt.setString(38, StrTool.space1(this.get(i).getAccAscription(), 1));
			}
			if(this.get(i).getFeeCode() == null || this.get(i).getFeeCode().equals("null")) {
