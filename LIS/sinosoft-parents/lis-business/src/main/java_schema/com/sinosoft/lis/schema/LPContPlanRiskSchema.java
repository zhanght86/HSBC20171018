...
import com.sinosoft.lis.db.LPContPlanRiskDB;

/*
 * <p>ClassName: LPContPlanRiskSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 多币种改造业务表
 */
public class LPContPlanRiskSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LPContPlanRiskSchema.class);
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LPContPlanRiskSchema cloned = (LPContPlanRiskSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LPContPlanRiskSchema 对象给 Schema 赋值
	* @param: aLPContPlanRiskSchema LPContPlanRiskSchema
	**/
	public void setSchema(LPContPlanRiskSchema aLPContPlanRiskSchema)
	{
		this.EdorNo = aLPContPlanRiskSchema.getEdorNo();
		this.EdorType = aLPContPlanRiskSchema.getEdorType();
		this.GrpContNo = aLPContPlanRiskSchema.getGrpContNo();
		this.ProposalGrpContNo = aLPContPlanRiskSchema.getProposalGrpContNo();
		this.MainRiskCode = aLPContPlanRiskSchema.getMainRiskCode();
		this.MainRiskVersion = aLPContPlanRiskSchema.getMainRiskVersion();
		this.RiskCode = aLPContPlanRiskSchema.getRiskCode();
		this.RiskVersion = aLPContPlanRiskSchema.getRiskVersion();
		this.ContPlanCode = aLPContPlanRiskSchema.getContPlanCode();
		this.ContPlanName = aLPContPlanRiskSchema.getContPlanName();
		this.Remark = aLPContPlanRiskSchema.getRemark();
		this.Operator = aLPContPlanRiskSchema.getOperator();
		this.MakeDate = fDate.getDate( aLPContPlanRiskSchema.getMakeDate());
		this.MakeTime = aLPContPlanRiskSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLPContPlanRiskSchema.getModifyDate());
		this.ModifyTime = aLPContPlanRiskSchema.getModifyTime();
		this.PlanType = aLPContPlanRiskSchema.getPlanType();
		this.Currency = aLPContPlanRiskSchema.getCurrency();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LPContPlanRisk表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LPContPlanRiskSchema";
	...
	public LPContPlanRiskSchema getSchema()
	{
		LPContPlanRiskSchema aLPContPlanRiskSchema = new LPContPlanRiskSchema();
		aLPContPlanRiskSchema.setSchema(this);
		return aLPContPlanRiskSchema;
	}

	public LPContPlanRiskDB getDB()
	{
		LPContPlanRiskDB aDBOper = new LPContPlanRiskDB();
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLPContPlanRisk>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			Currency = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 18, SysConst.PACKAGESPILTER );
		}
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LPContPlanRiskSchema other = (LPContPlanRiskSchema)otherObject;
		return
