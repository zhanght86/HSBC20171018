...
/*
 * <p>ClassName: LPGUWSubMainDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 保全流程
 */
public class LPGUWSubMainDBSet extends LPGUWSubMainSet
{
private static Logger logger = Logger.getLogger(LPGUWSubMainDBSet.class);
	...
	**/
	...
	// @Constructor
	public LPGUWSubMainDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LPGUWSubMainDBSet";
...
ex.printStackTrace();
	...
	public boolean update()
	{
		...
		try
		{
			...
			pstmt.setInt(39, this.get(i).getUWNo());
