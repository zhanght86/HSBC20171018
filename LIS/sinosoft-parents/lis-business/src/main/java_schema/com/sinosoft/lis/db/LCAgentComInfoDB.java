...
public class LCAgentComInfoDB extends LCAgentComInfoSchema
{
	...
	**/
	...
	public boolean getInfo()
	{
		...
		try
		{
			pstmt = con.prepareStatement("SELECT * FROM LCAgentComInfo WHERE  SerialNo = ? AND PolicyNo = ?", 
...
public boolean closeData()
{
	...
	public LCAgentComInfoSet executeQuery(SQLwithBindVariables sqlbv) {
	...
	public LCAgentComInfoSet executeQuery(SQLwithBindVariables sqlbv, int nStart, int nCount) {
