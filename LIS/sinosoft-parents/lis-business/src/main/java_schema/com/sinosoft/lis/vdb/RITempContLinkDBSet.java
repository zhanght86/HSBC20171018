...
/*
 * <p>ClassName: RITempContLinkDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 再保系统模型
 */
public class RITempContLinkDBSet extends RITempContLinkSet
{
	// @Field
	...
	**/
	...
	// @Constructor
	public RITempContLinkDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "RITempContLinkDBSet";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getCalFeeTerm() == null || this.get(i).getCalFeeTerm().equals("null")) {
				...
				pstmt.setString(12, this.get(i).getCalFeeTerm());
			}
			if(this.get(i).getCalFeeType() == null || this.get(i).getCalFeeType().equals("null")) {
				pstmt.setString(13,null);
			} else {
				pstmt.setString(13, this.get(i).getCalFeeType());
			}
			if(this.get(i).getStandbyString1() == null || this.get(i).getStandbyString1().equals("null")) {
				pstmt.setString(14,null);
			} else {
				pstmt.setString(14, this.get(i).getStandbyString1());
			}
			if(this.get(i).getStandbyString2() == null || this.get(i).getStandbyString2().equals("null")) {
				pstmt.setString(15,null);
			} else {
				pstmt.setString(15, this.get(i).getStandbyString2());
			}
			if(this.get(i).getStandbyString3() == null || this.get(i).getStandbyString3().equals("null")) {
				pstmt.setString(16,null);
			} else {
				pstmt.setString(16, this.get(i).getStandbyString3());
			}
			pstmt.setDouble(17, this.get(i).getStandbyDouble1());
			pstmt.setDouble(18, this.get(i).getStandbyDouble2());
			pstmt.setDouble(19, this.get(i).getStandbyDouble3());
			if(this.get(i).getStandbyDate1() == null || this.get(i).getStandbyDate1().equals("null")) {
				pstmt.setDate(20,null);
			} else {
				pstmt.setDate(20, Date.valueOf(this.get(i).getStandbyDate1()));
			}
			if(this.get(i).getStandbyDate2() == null || this.get(i).getStandbyDate2().equals("null")) {
				pstmt.setDate(21,null);
			} else {
				pstmt.setDate(21, Date.valueOf(this.get(i).getStandbyDate2()));
			}
			...
			if(this.get(i).getRIContNo() == null || this.get(i).getRIContNo().equals("null")) {
				...
				pstmt.setString(25, this.get(i).getRIContNo());
			}
			if(this.get(i).getRIPreceptNo() == null || this.get(i).getRIPreceptNo().equals("null")) {
				pstmt.setString(26,null);
			} else {
				pstmt.setString(26, this.get(i).getRIPreceptNo());
			}
			if(this.get(i).getRelaType() == null || this.get(i).getRelaType().equals("null")) {
				pstmt.setString(27,null);
			} else {
				pstmt.setString(27, this.get(i).getRelaType());
			}
			if(this.get(i).getProposalGrpContNo() == null || this.get(i).getProposalGrpContNo().equals("null")) {
				pstmt.setString(28,null);
			} else {
				pstmt.setString(28, this.get(i).getProposalGrpContNo());
			}
			if(this.get(i).getProposalNo() == null || this.get(i).getProposalNo().equals("null")) {
				pstmt.setString(29,null);
			} else {
				pstmt.setString(29, this.get(i).getProposalNo());
			}
			if(this.get(i).getContPlanCode() == null || this.get(i).getContPlanCode().equals("null")) {
