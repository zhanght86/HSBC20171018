...
{
private static Logger logger = Logger.getLogger(LABranchGroupBDB.class);
	...
	**/
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.getUpBranch() == null || this.getUpBranch().equals("null")) {
				pstmt.setNull(4, 12);
			} else {
				pstmt.setString(4, this.getUpBranch());
			}
			if(this.getBranchAttr() == null || this.getBranchAttr().equals("null")) {
				pstmt.setNull(5, 12);
			} else {
				pstmt.setString(5, this.getBranchAttr());
			}
			...
			if(this.getBranchLevel() == null || this.getBranchLevel().equals("null")) {
				...
				pstmt.setString(7, this.getBranchLevel());
			}
			if(this.getBranchManager() == null || this.getBranchManager().equals("null")) {
				pstmt.setNull(8, 12);
			} else {
				pstmt.setString(8, this.getBranchManager());
			}
			if(this.getBranchAddressCode() == null || this.getBranchAddressCode().equals("null")) {
				pstmt.setNull(9, 12);
			} else {
				pstmt.setString(9, this.getBranchAddressCode());
			}
			...
			if(this.getBranchPhone() == null || this.getBranchPhone().equals("null")) {
				pstmt.setNull(11, 12);
			} else {
				pstmt.setString(11, this.getBranchPhone());
			}
			if(this.getBranchFax() == null || this.getBranchFax().equals("null")) {
				pstmt.setNull(12, 12);
			} else {
				pstmt.setString(12, this.getBranchFax());
			}
			if(this.getBranchZipcode() == null || this.getBranchZipcode().equals("null")) {
				pstmt.setNull(13, 12);
			} else {
				pstmt.setString(13, this.getBranchZipcode());
			}
			if(this.getFoundDate() == null || this.getFoundDate().equals("null")) {
				pstmt.setNull(14, 91);
			} else {
				pstmt.setDate(14, Date.valueOf(this.getFoundDate()));
			}
			...
			if(this.getEndFlag() == null || this.getEndFlag().equals("null")) {
				...
				pstmt.setString(16, this.getEndFlag());
			}
			...
			if(this.getFieldFlag() == null || this.getFieldFlag().equals("null")) {
				pstmt.setNull(18, 1);
			} else {
				pstmt.setString(18, this.getFieldFlag());
			}
			...
			if(this.getModifyTime2() == null || this.getModifyTime2().equals("null")) {
				...
				pstmt.setString(24, this.getModifyTime2());
			}
			if(this.getEdorNo() == null || this.getEdorNo().equals("null")) {
				pstmt.setNull(25, 12);
			} else {
			...
			if(this.getBranchManagerName() == null || this.getBranchManagerName().equals("null")) {
				pstmt.setNull(31, 12);
			} else {
				pstmt.setString(31, this.getBranchManagerName());
			}
			if(this.getUpBranchAttr() == null || this.getUpBranchAttr().equals("null")) {
				pstmt.setNull(32, 1);
			} else {
				pstmt.setString(32, this.getUpBranchAttr());
			}
			if(this.getBranchJobType() == null || this.getBranchJobType().equals("null")) {
				pstmt.setNull(33, 1);
			} else {
				pstmt.setString(33, this.getBranchJobType());
			}
			...
			if(this.getBranchKind() == null || this.getBranchKind().equals("null")) {
				pstmt.setNull(35, 12);
			} else {
				pstmt.setString(35, this.getBranchKind());
			}
			if(this.getIndexCalNo() == null || this.getIndexCalNo().equals("null")) {
				pstmt.setNull(36, 12);
			} else {
				pstmt.setString(36, this.getIndexCalNo());
			}
			// set where condition
			if(this.getAgentGroup() == null || this.getAgentGroup().equals("null")) {
				pstmt.setNull(37, 12);
			} else {
				pstmt.setString(37, this.getAgentGroup());
			}
			if(this.getEdorNo() == null || this.getEdorNo().equals("null")) {
				pstmt.setNull(38, 12);
			} else {
	...
	public boolean getInfo()
	{
		...
		try
		{
			pstmt = con.prepareStatement("SELECT * FROM LABranchGroupB WHERE  AgentGroup = ? AND EdorNo = ?", 
	...
	public LABranchGroupBSet executeQuery(String sql)
	{
		Statement stmt = null;
		ResultSet rs = null;
		LABranchGroupBSet aLABranchGroupBSet = new LABranchGroupBSet();
	...
	public LABranchGroupBSet executeQuery(String sql, int nStart, int nCount)
	{
		Statement stmt = null;
		ResultSet rs = null;
		LABranchGroupBSet aLABranchGroupBSet = new LABranchGroupBSet();
...
public boolean closeData()
{
	...
	public LABranchGroupBSet executeQuery(SQLwithBindVariables sqlbv) {
	...
	public LABranchGroupBSet executeQuery(SQLwithBindVariables sqlbv, int nStart, int nCount) {
