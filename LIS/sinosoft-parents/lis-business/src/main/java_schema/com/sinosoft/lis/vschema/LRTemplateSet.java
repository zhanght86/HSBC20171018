...
/*
 * <p>ClassName: LRTemplateSet </p>
 * <p>Description: LRTemplateSchemaSet类文件 </p>
...
public class LRTemplateSet extends SchemaSet
{
	...
	{
		LRTemplateSchema tSchema = (LRTemplateSchema)super.getObj(index);
		return tSchema;
	}
	...
	**/
	public String encode()
	{
		...
		for (int i = 1; i <= n; i++)
		{
			LRTemplateSchema aSchema = this.get(i);
	...
	**/
	public boolean decode( String str )
	{
		...
		while( nEndPos != -1 )
		{
			LRTemplateSchema aSchema = new LRTemplateSchema();
		...
		LRTemplateSchema tSchema = new LRTemplateSchema();
