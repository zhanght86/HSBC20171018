...
/*
 * <p>ClassName: LPBnfDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 保全核心
 */
public class LPBnfDBSet extends LPBnfSet
{
	// @Field
	...
	**/
	...
	// @Constructor
	public LPBnfDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean delete()
	{
		...
		try
		{
			...
			if(this.get(i).getBnfType() == null || this.get(i).getBnfType().equals("null")) {
				...
				pstmt.setString(5, StrTool.space1(this.get(i).getBnfType(), 1));
			}
			pstmt.setInt(6, this.get(i).getBnfNo());
			if(this.get(i).getBnfGrade() == null || this.get(i).getBnfGrade().equals("null")) {
				pstmt.setString(7,null);
			} else {
				pstmt.setString(7, StrTool.space1(this.get(i).getBnfGrade(), 1));
			}
...
ex.printStackTrace();
	...
	public boolean update()
	{
		...
		try
		{
			...
			pstmt.setInt(7, this.get(i).getBnfNo());
			if(this.get(i).getBnfGrade() == null || this.get(i).getBnfGrade().equals("null")) {
			...
			pstmt.setDouble(10, this.get(i).getBnfLot());
			...
			if(this.get(i).getPostalAddress() == null || this.get(i).getPostalAddress().equals("null")) {
				...
				pstmt.setString(22, this.get(i).getPostalAddress());
			}
			if(this.get(i).getZipCode() == null || this.get(i).getZipCode().equals("null")) {
				pstmt.setString(23,null);
			} else {
				pstmt.setString(23, this.get(i).getZipCode());
			}
			...
			if(this.get(i).getIDExpDate() == null || this.get(i).getIDExpDate().equals("null")) {
				...
				pstmt.setDate(28, Date.valueOf(this.get(i).getIDExpDate()));
			}
			if(this.get(i).getMobile() == null || this.get(i).getMobile().equals("null")) {
				pstmt.setString(29,null);
			} else {
				pstmt.setString(29, this.get(i).getMobile());
			}
			...
			if(this.get(i).getInsuredNo() == null || this.get(i).getInsuredNo().equals("null")) {
				...
				pstmt.setString(36, this.get(i).getInsuredNo());
			}
			if(this.get(i).getBnfType() == null || this.get(i).getBnfType().equals("null")) {
				pstmt.setString(37,null);
			} else {
				pstmt.setString(37, StrTool.space1(this.get(i).getBnfType(), 1));
			}
			pstmt.setInt(38, this.get(i).getBnfNo());
			if(this.get(i).getBnfGrade() == null || this.get(i).getBnfGrade().equals("null")) {
				pstmt.setString(39,null);
			} else {
				pstmt.setString(39, StrTool.space1(this.get(i).getBnfGrade(), 1));
			}
