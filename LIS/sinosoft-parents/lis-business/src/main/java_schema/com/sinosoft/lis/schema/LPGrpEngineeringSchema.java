...
import com.sinosoft.lis.db.LPGrpEngineeringDB;

/*
 * <p>ClassName: LPGrpEngineeringSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: Physical Data Model 1
 */
public class LPGrpEngineeringSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LPGrpEngineeringSchema.class);
	// @Field
	/** 保全批单号 */
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LPGrpEngineeringSchema cloned = (LPGrpEngineeringSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LPGrpEngineeringSchema 对象给 Schema 赋值
	* @param: aLPGrpEngineeringSchema LPGrpEngineeringSchema
	**/
	public void setSchema(LPGrpEngineeringSchema aLPGrpEngineeringSchema)
	{
		this.EdorNo = aLPGrpEngineeringSchema.getEdorNo();
		this.EdorType = aLPGrpEngineeringSchema.getEdorType();
		this.GrpContNo = aLPGrpEngineeringSchema.getGrpContNo();
		this.GrpPropNo = aLPGrpEngineeringSchema.getGrpPropNo();
		this.EnginName = aLPGrpEngineeringSchema.getEnginName();
		this.EnginType = aLPGrpEngineeringSchema.getEnginType();
		this.EnginArea = aLPGrpEngineeringSchema.getEnginArea();
		this.EnginCost = aLPGrpEngineeringSchema.getEnginCost();
		this.EnginPlace = aLPGrpEngineeringSchema.getEnginPlace();
		this.EnginStartDate = fDate.getDate( aLPGrpEngineeringSchema.getEnginStartDate());
		this.EnginEndDate = fDate.getDate( aLPGrpEngineeringSchema.getEnginEndDate());
		this.InsurerName = aLPGrpEngineeringSchema.getInsurerName();
		this.InsurerType = aLPGrpEngineeringSchema.getInsurerType();
		this.ContractorName = aLPGrpEngineeringSchema.getContractorName();
		this.ContractorType = aLPGrpEngineeringSchema.getContractorType();
		this.ContractorType2 = aLPGrpEngineeringSchema.getContractorType2();
		this.DetailDes = aLPGrpEngineeringSchema.getDetailDes();
		this.EnginDesc = aLPGrpEngineeringSchema.getEnginDesc();
		this.EnginCondition = aLPGrpEngineeringSchema.getEnginCondition();
		this.SpecFlag = aLPGrpEngineeringSchema.getSpecFlag();
		this.PremCalMode = aLPGrpEngineeringSchema.getPremCalMode();
		this.PremFeeRate = aLPGrpEngineeringSchema.getPremFeeRate();
		this.FirstPrem = aLPGrpEngineeringSchema.getFirstPrem();
		this.ContractorPeoples = aLPGrpEngineeringSchema.getContractorPeoples();
		this.SafeProve = aLPGrpEngineeringSchema.getSafeProve();
		this.Remark = aLPGrpEngineeringSchema.getRemark();
		this.ManageCom = aLPGrpEngineeringSchema.getManageCom();
		this.ComCode = aLPGrpEngineeringSchema.getComCode();
		this.MakeOperator = aLPGrpEngineeringSchema.getMakeOperator();
		this.MakeDate = fDate.getDate( aLPGrpEngineeringSchema.getMakeDate());
		this.MakeTime = aLPGrpEngineeringSchema.getMakeTime();
		this.ModifyOperator = aLPGrpEngineeringSchema.getModifyOperator();
		this.ModifyDate = fDate.getDate( aLPGrpEngineeringSchema.getModifyDate());
		this.ModifyTime = aLPGrpEngineeringSchema.getModifyTime();
		this.EnginDays = aLPGrpEngineeringSchema.getEnginDays();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LPGrpEngineering表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LPGrpEngineeringSchema";
	...
	public LPGrpEngineeringSchema getSchema()
	{
		LPGrpEngineeringSchema aLPGrpEngineeringSchema = new LPGrpEngineeringSchema();
		aLPGrpEngineeringSchema.setSchema(this);
		return aLPGrpEngineeringSchema;
	}

	public LPGrpEngineeringDB getDB()
	{
		LPGrpEngineeringDB aDBOper = new LPGrpEngineeringDB();
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLPGrpEngineering>历史记账凭证主表信息</A>表字段
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LPGrpEngineeringSchema other = (LPGrpEngineeringSchema)otherObject;
		return
