...
/*
 * <p>ClassName: LPCGrpSpecSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 保全流程
 */
public class LPCGrpSpecSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LPCGrpSpecSchema.class);
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LPCGrpSpecSchema cloned = (LPCGrpSpecSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LPCGrpSpecSchema 对象给 Schema 赋值
	* @param: aLPCGrpSpecSchema LPCGrpSpecSchema
	**/
	public void setSchema(LPCGrpSpecSchema aLPCGrpSpecSchema)
	{
		this.EdorNo = aLPCGrpSpecSchema.getEdorNo();
		this.EdorType = aLPCGrpSpecSchema.getEdorType();
		this.GrpContNo = aLPCGrpSpecSchema.getGrpContNo();
		this.ProposalGrpContNo = aLPCGrpSpecSchema.getProposalGrpContNo();
		this.PrtSeq = aLPCGrpSpecSchema.getPrtSeq();
		this.SerialNo = aLPCGrpSpecSchema.getSerialNo();
		this.EndorsementNo = aLPCGrpSpecSchema.getEndorsementNo();
		this.SpecType = aLPCGrpSpecSchema.getSpecType();
		this.SpecCode = aLPCGrpSpecSchema.getSpecCode();
		this.SpecContent = aLPCGrpSpecSchema.getSpecContent();
		this.PrtFlag = aLPCGrpSpecSchema.getPrtFlag();
		this.BackupType = aLPCGrpSpecSchema.getBackupType();
		this.Operator = aLPCGrpSpecSchema.getOperator();
		this.MakeDate = fDate.getDate( aLPCGrpSpecSchema.getMakeDate());
		this.MakeTime = aLPCGrpSpecSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLPCGrpSpecSchema.getModifyDate());
		this.ModifyTime = aLPCGrpSpecSchema.getModifyTime();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LPCGrpSpec表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LPCGrpSpecSchema";
	...
	public LPCGrpSpecSchema getSchema()
	{
		LPCGrpSpecSchema aLPCGrpSpecSchema = new LPCGrpSpecSchema();
		aLPCGrpSpecSchema.setSchema(this);
		return aLPCGrpSpecSchema;
	}

	public LPCGrpSpecDB getDB()
	{
		LPCGrpSpecDB aDBOper = new LPCGrpSpecDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLPCGrpSpec描述/A>表字段
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLPCGrpSpec>历史记账凭证主表信息</A>表字段
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LPCGrpSpecSchema other = (LPCGrpSpecSchema)otherObject;
		return
