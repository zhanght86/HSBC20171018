...
/*
 * <p>ClassName: LCGCUWErrorSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 承保流程
 */
public class LCGCUWErrorSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LCGCUWErrorSchema.class);
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LCGCUWErrorSchema cloned = (LCGCUWErrorSchema)super.clone();
	...
	/**
	* 使用另外一个 LCGCUWErrorSchema 对象给 Schema 赋值
	* @param: aLCGCUWErrorSchema LCGCUWErrorSchema
	**/
	public void setSchema(LCGCUWErrorSchema aLCGCUWErrorSchema)
	{
		this.GrpContNo = aLCGCUWErrorSchema.getGrpContNo();
		this.ProposalGrpContNo = aLCGCUWErrorSchema.getProposalGrpContNo();
		this.SerialNo = aLCGCUWErrorSchema.getSerialNo();
		this.UWNo = aLCGCUWErrorSchema.getUWNo();
		this.GrpNo = aLCGCUWErrorSchema.getGrpNo();
		this.Name = aLCGCUWErrorSchema.getName();
		this.InsuredNo = aLCGCUWErrorSchema.getInsuredNo();
		this.InsuredName = aLCGCUWErrorSchema.getInsuredName();
		this.AppntNo = aLCGCUWErrorSchema.getAppntNo();
		this.AppntName = aLCGCUWErrorSchema.getAppntName();
		this.ManageCom = aLCGCUWErrorSchema.getManageCom();
		this.UWRuleCode = aLCGCUWErrorSchema.getUWRuleCode();
		this.UWError = aLCGCUWErrorSchema.getUWError();
		this.CurrValue = aLCGCUWErrorSchema.getCurrValue();
		this.ModifyDate = fDate.getDate( aLCGCUWErrorSchema.getModifyDate());
		this.ModifyTime = aLCGCUWErrorSchema.getModifyTime();
		this.UWPassFlag = aLCGCUWErrorSchema.getUWPassFlag();
		this.UWGrade = aLCGCUWErrorSchema.getUWGrade();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LCGCUWError表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LCGCUWErrorSchema";
	...
	public LCGCUWErrorSchema getSchema()
	{
		LCGCUWErrorSchema aLCGCUWErrorSchema = new LCGCUWErrorSchema();
		aLCGCUWErrorSchema.setSchema(this);
		return aLCGCUWErrorSchema;
	}

	public LCGCUWErrorDB getDB()
	{
		LCGCUWErrorDB aDBOper = new LCGCUWErrorDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLCGCUWError描述/A>表字段
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLCGCUWError>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			GrpNo = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 5, SysConst.PACKAGESPILTER );
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LCGCUWErrorSchema other = (LCGCUWErrorSchema)otherObject;
		return
