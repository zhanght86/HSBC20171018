...
import com.sinosoft.lis.db.LCCustomerAccountDB;

/*
 * <p>ClassName: LCCustomerAccountSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 新单管理
 */
public class LCCustomerAccountSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LCCustomerAccountSchema.class);
	// @Field
	/** 保单号 */
	...
	// @Constructor
	public LCCustomerAccountSchema()
	{
		mErrors = new CErrors();
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LCCustomerAccountSchema cloned = (LCCustomerAccountSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LCCustomerAccountSchema 对象给 Schema 赋值
	* @param: aLCCustomerAccountSchema LCCustomerAccountSchema
	**/
	public void setSchema(LCCustomerAccountSchema aLCCustomerAccountSchema)
	{
		this.PolicyNo = aLCCustomerAccountSchema.getPolicyNo();
		this.CustomerType = aLCCustomerAccountSchema.getCustomerType();
		this.CustomerNo = aLCCustomerAccountSchema.getCustomerNo();
		this.AccKind = aLCCustomerAccountSchema.getAccKind();
		this.BankCode = aLCCustomerAccountSchema.getBankCode();
		this.BankAccNo = aLCCustomerAccountSchema.getBankAccNo();
		this.AccName = aLCCustomerAccountSchema.getAccName();
		this.FirstPayFlag = aLCCustomerAccountSchema.getFirstPayFlag();
		this.GetFlag = aLCCustomerAccountSchema.getGetFlag();
		this.PayType = aLCCustomerAccountSchema.getPayType();
		this.State = aLCCustomerAccountSchema.getState();
		this.Segment1 = aLCCustomerAccountSchema.getSegment1();
		this.Segment2 = aLCCustomerAccountSchema.getSegment2();
		this.Segment3 = aLCCustomerAccountSchema.getSegment3();
		this.MakeOperator = aLCCustomerAccountSchema.getMakeOperator();
		this.MakeDate = fDate.getDate( aLCCustomerAccountSchema.getMakeDate());
		this.MakeTime = aLCCustomerAccountSchema.getMakeTime();
		this.ModifyOperator = aLCCustomerAccountSchema.getModifyOperator();
		this.ModifyDate = fDate.getDate( aLCCustomerAccountSchema.getModifyDate());
		this.ModifyTime = aLCCustomerAccountSchema.getModifyTime();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LCCustomerAccount表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LCCustomerAccountSchema";
	...
	public LCCustomerAccountSchema getSchema()
	{
		LCCustomerAccountSchema aLCCustomerAccountSchema = new LCCustomerAccountSchema();
		aLCCustomerAccountSchema.setSchema(this);
		return aLCCustomerAccountSchema;
	}

	public LCCustomerAccountDB getDB()
	{
		LCCustomerAccountDB aDBOper = new LCCustomerAccountDB();
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLCCustomerAccount>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			AccKind = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 4, SysConst.PACKAGESPILTER );
			BankCode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 5, SysConst.PACKAGESPILTER );
			BankAccNo = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 6, SysConst.PACKAGESPILTER );
			AccName = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 7, SysConst.PACKAGESPILTER );
			FirstPayFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 8, SysConst.PACKAGESPILTER );
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LCCustomerAccountSchema other = (LCCustomerAccountSchema)otherObject;
		return
