...
import com.sinosoft.lis.db.LPGCUWSubDB;

/*
 * <p>ClassName: LPGCUWSubSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 保全流程
 */
public class LPGCUWSubSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LPGCUWSubSchema.class);
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LPGCUWSubSchema cloned = (LPGCUWSubSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LPGCUWSubSchema 对象给 Schema 赋值
	* @param: aLPGCUWSubSchema LPGCUWSubSchema
	**/
	public void setSchema(LPGCUWSubSchema aLPGCUWSubSchema)
	{
		this.EdorNo = aLPGCUWSubSchema.getEdorNo();
		this.EdorType = aLPGCUWSubSchema.getEdorType();
		this.GrpContNo = aLPGCUWSubSchema.getGrpContNo();
		this.ProposalGrpContNo = aLPGCUWSubSchema.getProposalGrpContNo();
		this.UWNo = aLPGCUWSubSchema.getUWNo();
		this.InsuredNo = aLPGCUWSubSchema.getInsuredNo();
		this.InsuredName = aLPGCUWSubSchema.getInsuredName();
		this.AppntNo = aLPGCUWSubSchema.getAppntNo();
		this.AppntName = aLPGCUWSubSchema.getAppntName();
		this.AgentCode = aLPGCUWSubSchema.getAgentCode();
		this.AgentGroup = aLPGCUWSubSchema.getAgentGroup();
		this.PassFlag = aLPGCUWSubSchema.getPassFlag();
		this.UWGrade = aLPGCUWSubSchema.getUWGrade();
		this.AppGrade = aLPGCUWSubSchema.getAppGrade();
		this.PostponeDay = aLPGCUWSubSchema.getPostponeDay();
		this.PostponeDate = fDate.getDate( aLPGCUWSubSchema.getPostponeDate());
		this.AutoUWFlag = aLPGCUWSubSchema.getAutoUWFlag();
		this.State = aLPGCUWSubSchema.getState();
		this.ManageCom = aLPGCUWSubSchema.getManageCom();
		this.UWIdea = aLPGCUWSubSchema.getUWIdea();
		this.UpReportContent = aLPGCUWSubSchema.getUpReportContent();
		this.Operator = aLPGCUWSubSchema.getOperator();
		this.HealthFlag = aLPGCUWSubSchema.getHealthFlag();
		this.QuesFlag = aLPGCUWSubSchema.getQuesFlag();
		this.SpecFlag = aLPGCUWSubSchema.getSpecFlag();
		this.AddPremFlag = aLPGCUWSubSchema.getAddPremFlag();
		this.AddPremReason = aLPGCUWSubSchema.getAddPremReason();
		this.ReportFlag = aLPGCUWSubSchema.getReportFlag();
		this.PrintFlag = aLPGCUWSubSchema.getPrintFlag();
		this.PrintFlag2 = aLPGCUWSubSchema.getPrintFlag2();
		this.ChangePolFlag = aLPGCUWSubSchema.getChangePolFlag();
		this.ChangePolReason = aLPGCUWSubSchema.getChangePolReason();
		this.SpecReason = aLPGCUWSubSchema.getSpecReason();
		this.MakeDate = fDate.getDate( aLPGCUWSubSchema.getMakeDate());
		this.MakeTime = aLPGCUWSubSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLPGCUWSubSchema.getModifyDate());
		this.ModifyTime = aLPGCUWSubSchema.getModifyTime();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LPGCUWSub表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LPGCUWSubSchema";
	...
	public LPGCUWSubSchema getSchema()
	{
		LPGCUWSubSchema aLPGCUWSubSchema = new LPGCUWSubSchema();
		aLPGCUWSubSchema.setSchema(this);
		return aLPGCUWSubSchema;
	}

	public LPGCUWSubDB getDB()
	{
		LPGCUWSubDB aDBOper = new LPGCUWSubDB();
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLPGCUWSub>历史记账凭证主表信息</A>表字段
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LPGCUWSubSchema other = (LPGCUWSubSchema)otherObject;
		return
