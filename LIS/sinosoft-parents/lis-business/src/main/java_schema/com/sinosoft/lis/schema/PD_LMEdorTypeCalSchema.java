...
import com.sinosoft.lis.db.PD_LMEdorTypeCalDB;

/*
 * <p>ClassName: PD_LMEdorTypeCalSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: PhysicalDataModel_12
 */
public class PD_LMEdorTypeCalSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(PD_LMEdorTypeCalSchema.class);
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		PD_LMEdorTypeCalSchema cloned = (PD_LMEdorTypeCalSchema)super.clone();
	...
	/**
	* 使用另外一个 PD_LMEdorTypeCalSchema 对象给 Schema 赋值
	* @param: aPD_LMEdorTypeCalSchema PD_LMEdorTypeCalSchema
	**/
	public void setSchema(PD_LMEdorTypeCalSchema aPD_LMEdorTypeCalSchema)
	{
		this.RiskCode = aPD_LMEdorTypeCalSchema.getRiskCode();
		this.EdorType = aPD_LMEdorTypeCalSchema.getEdorType();
		this.EdorTypeCal = aPD_LMEdorTypeCalSchema.getEdorTypeCal();
		this.DutyCode = aPD_LMEdorTypeCalSchema.getDutyCode();
		this.CalCode = aPD_LMEdorTypeCalSchema.getCalCode();
		this.InnerCalCode = aPD_LMEdorTypeCalSchema.getInnerCalCode();
		this.ManageCom = aPD_LMEdorTypeCalSchema.getManageCom();
		this.Flag = aPD_LMEdorTypeCalSchema.getFlag();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的PD_LMEdorTypeCal表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "PD_LMEdorTypeCalSchema";
	...
	public PD_LMEdorTypeCalSchema getSchema()
	{
		PD_LMEdorTypeCalSchema aPD_LMEdorTypeCalSchema = new PD_LMEdorTypeCalSchema();
		aPD_LMEdorTypeCalSchema.setSchema(this);
		return aPD_LMEdorTypeCalSchema;
	}

	public PD_LMEdorTypeCalDB getDB()
	{
		PD_LMEdorTypeCalDB aDBOper = new PD_LMEdorTypeCalDB();
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpPD_LMEdorTypeCal>历史记账凭证主表信息</A>表字段
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		PD_LMEdorTypeCalSchema other = (PD_LMEdorTypeCalSchema)otherObject;
		return
