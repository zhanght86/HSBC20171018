...
import com.sinosoft.lis.db.RnewQuestionnaireDB;

/*
 * <p>ClassName: RnewQuestionnaireSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 续期续保二核
 */
public class RnewQuestionnaireSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(RnewQuestionnaireSchema.class);
	...
	// @Constructor
	public RnewQuestionnaireSchema()
	{
		mErrors = new CErrors();
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		RnewQuestionnaireSchema cloned = (RnewQuestionnaireSchema)super.clone();
	...
	/**
	* 使用另外一个 RnewQuestionnaireSchema 对象给 Schema 赋值
	* @param: aRnewQuestionnaireSchema RnewQuestionnaireSchema
	**/
	public void setSchema(RnewQuestionnaireSchema aRnewQuestionnaireSchema)
	{
		this.ProposalContNo = aRnewQuestionnaireSchema.getProposalContNo();
		this.SerialNo = aRnewQuestionnaireSchema.getSerialNo();
		this.AskType = aRnewQuestionnaireSchema.getAskType();
		this.AskTypeName = aRnewQuestionnaireSchema.getAskTypeName();
		this.AskContentNo = aRnewQuestionnaireSchema.getAskContentNo();
		this.AskContentName = aRnewQuestionnaireSchema.getAskContentName();
		this.Operator = aRnewQuestionnaireSchema.getOperator();
		this.MakeDate = fDate.getDate( aRnewQuestionnaireSchema.getMakeDate());
		this.MakeTime = aRnewQuestionnaireSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aRnewQuestionnaireSchema.getModifyDate());
		this.ModifyTime = aRnewQuestionnaireSchema.getModifyTime();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的RnewQuestionnaire表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "RnewQuestionnaireSchema";
	...
	public RnewQuestionnaireSchema getSchema()
	{
		RnewQuestionnaireSchema aRnewQuestionnaireSchema = new RnewQuestionnaireSchema();
		aRnewQuestionnaireSchema.setSchema(this);
		return aRnewQuestionnaireSchema;
	}

	public RnewQuestionnaireDB getDB()
	{
		RnewQuestionnaireDB aDBOper = new RnewQuestionnaireDB();
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpRnewQuestionnaire>历史记账凭证主表信息</A>表字段
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		RnewQuestionnaireSchema other = (RnewQuestionnaireSchema)otherObject;
		return
