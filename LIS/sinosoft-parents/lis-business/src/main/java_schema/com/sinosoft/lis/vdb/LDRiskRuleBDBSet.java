...
/*
 * <p>ClassName: LDRiskRuleBDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 承保流程
 */
public class LDRiskRuleBDBSet extends LDRiskRuleBSet
{
private static Logger logger = Logger.getLogger(LDRiskRuleBDBSet.class);
	...
	**/
	...
	// @Constructor
	public LDRiskRuleBDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LDRiskRuleBDBSet";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getBakDate() == null || this.get(i).getBakDate().equals("null")) {
				...
				pstmt.setDate(16, Date.valueOf(this.get(i).getBakDate()));
			}
			if(this.get(i).getBakTime() == null || this.get(i).getBakTime().equals("null")) {
				pstmt.setString(17,null);
			} else {
				pstmt.setString(17, this.get(i).getBakTime());
			}
			// set where condition
			if(this.get(i).getSerialNo() == null || this.get(i).getSerialNo().equals("null")) {
