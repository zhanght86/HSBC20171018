...
/*
 * <p>ClassName: RnewIndUWMasterDB </p>
 * <p>Description: DB层数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 续期续保二核
 */
public class RnewIndUWMasterDB extends RnewIndUWMasterSchema
{
private static Logger logger = Logger.getLogger(RnewIndUWMasterDB.class);
	...
	**/
	...
	// @Constructor
	public RnewIndUWMasterDB( Connection tConnection )
	{
		con = tConnection;
		db = new DBOper( con, "RnewIndUWMaster" );
		mflag = true;
	}

	public RnewIndUWMasterDB()
	{
		con = null;
		db = new DBOper( "RnewIndUWMaster" );
		mflag = false;
	}
	...
	{
		RnewIndUWMasterSchema tSchema = this.getSchema();
		...
		else
		{
			...
			tError.moduleName = "RnewIndUWMasterDB";
	...
	public boolean delete()
	{
		...
		try
		{
			pstmt = con.prepareStatement("DELETE FROM RnewIndUWMaster WHERE  ContNo = ? AND InsuredNo = ?");
		...
		SQLString sqlObj = new SQLString("RnewIndUWMaster");
	...
	public boolean getInfo()
	{
		...
		try
		{
			pstmt = con.prepareStatement("SELECT * FROM RnewIndUWMaster WHERE  ContNo = ? AND InsuredNo = ?", 
	...
	public RnewIndUWMasterSet query()
	{
		PreparedStatement pstmt = null;
 		ResultSet rs = null;
		RnewIndUWMasterSet aRnewIndUWMasterSet = new RnewIndUWMasterSet();
	  ...
	  if( !mflag ) {
		...
		{
			SQLString sqlObj = new SQLString("RnewIndUWMaster");
			RnewIndUWMasterSchema aSchema = this.getSchema();
			...
			{
				i++;
				RnewIndUWMasterSchema s1 = new RnewIndUWMasterSchema();
				s1.setSchema(rs,i);
				aRnewIndUWMasterSet.add(s1);
			}
			try{ rs.close(); } catch( Exception ex ) {}
			try{ pstmt.close(); } catch( Exception ex1 ) {}
		}
		...
		return aRnewIndUWMasterSet;

	}

	public RnewIndUWMasterSet executeQuery(String sql)
	{
		Statement stmt = null;
		ResultSet rs = null;
		RnewIndUWMasterSet aRnewIndUWMasterSet = new RnewIndUWMasterSet();
	...
	public RnewIndUWMasterSet query(int nStart, int nCount)
	{
		PreparedStatement pstmt = null;
 		ResultSet rs = null;
		RnewIndUWMasterSet aRnewIndUWMasterSet = new RnewIndUWMasterSet();
	...
	public RnewIndUWMasterSet executeQuery(String sql, int nStart, int nCount)
	{
		Statement stmt = null;
		ResultSet rs = null;
		RnewIndUWMasterSet aRnewIndUWMasterSet = new RnewIndUWMasterSet();
	...
	public boolean update(String strWherePart)
	{
	  ...
	  if( !mflag ) {
		...
		try
		{
			...
			String sql = "update RnewIndUWMaster " + sqlObj.getUpdPart() + " where " + strWherePart;
...
/**
 * 获取定量数据
 * @return RnewIndUWMasterSet
 */
public RnewIndUWMasterSet getData()
{
    int tCount = 0;
    RnewIndUWMasterSet tRnewIndUWMasterSet = new RnewIndUWMasterSet();
    RnewIndUWMasterSchema tRnewIndUWMasterSchema = null;
    if (null == mResultSet)
    {
        CError tError = new CError();
        tError.moduleName = "RnewIndUWMasterDB";
    ...
    {
        tCount = 1;
        tRnewIndUWMasterSchema = new RnewIndUWMasterSchema();
        tRnewIndUWMasterSchema.setSchema(mResultSet, 1);
        tRnewIndUWMasterSet.add(tRnewIndUWMasterSchema);
...
public boolean closeData()
{
	...
	public RnewIndUWMasterSet executeQuery(SQLwithBindVariables sqlbv) {
	...
	public RnewIndUWMasterSet executeQuery(SQLwithBindVariables sqlbv, int nStart, int nCount) {
