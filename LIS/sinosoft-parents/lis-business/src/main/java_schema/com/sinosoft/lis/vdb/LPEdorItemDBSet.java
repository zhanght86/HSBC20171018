...
/*
 * <p>ClassName: LPEdorItemDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 保全核心
 */
public class LPEdorItemDBSet extends LPEdorItemSet
{
	// @Field
	...
	**/
	...
	// @Constructor
	public LPEdorItemDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LPEdorItemDBSet";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getApproveGrade() == null || this.get(i).getApproveGrade().equals("null")) {
				...
				pstmt.setString(37, this.get(i).getApproveGrade());
			}
			if(this.get(i).getEdorTypeCal() == null || this.get(i).getEdorTypeCal().equals("null")) {
				pstmt.setString(38,null);
			} else {
				pstmt.setString(38, this.get(i).getEdorTypeCal());
			}
			...
			if(this.get(i).getInsuredNo() == null || this.get(i).getInsuredNo().equals("null")) {
				...
				pstmt.setString(46, this.get(i).getInsuredNo());
			}
			if(this.get(i).getPolNo() == null || this.get(i).getPolNo().equals("null")) {
