...
/*
 * <p>ClassName: LCInsureAccClassBakDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: PhysicalDataModel_1
 */
public class LCInsureAccClassBakDBSet extends LCInsureAccClassBakSet
{
private static Logger logger = Logger.getLogger(LCInsureAccClassBakDBSet.class);
	...
	**/
	...
	// @Constructor
	public LCInsureAccClassBakDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public LCInsureAccClassBakDBSet()
	{
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LCInsureAccClassBakDBSet";
...
ex.printStackTrace();
	...
	public boolean update()
	{
		...
		try
		{
			...
			pstmt.setDouble(35, this.get(i).getAscriptRate());
			if(this.get(i).getAscriptType() == null || this.get(i).getAscriptType().equals("null")) {
				pstmt.setString(36,null);
			} else {
				pstmt.setString(36, this.get(i).getAscriptType());
			}
			pstmt.setDouble(37, this.get(i).getUnitPrice());
			// set where condition
			if(this.get(i).getPolNo() == null || this.get(i).getPolNo().equals("null")) {
