...
/*
 * <p>ClassName: LBPOAppntDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 内部外包流程
 */
public class LBPOAppntDBSet extends LBPOAppntSet
{
private static Logger logger = Logger.getLogger(LBPOAppntDBSet.class);
	...
	**/
	...
	// @Constructor
	public LBPOAppntDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LBPOAppntDBSet";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getAppntBirthday() == null || this.get(i).getAppntBirthday().equals("null")) {
				...
				pstmt.setString(10, this.get(i).getAppntBirthday());
			}
			...
			if(this.get(i).getMarriageDate() == null || this.get(i).getMarriageDate().equals("null")) {
				...
				pstmt.setString(19, this.get(i).getMarriageDate());
			}
			...
			if(this.get(i).getStature() == null || this.get(i).getStature().equals("null")) {
				...
				pstmt.setString(21, this.get(i).getStature());
			}
			if(this.get(i).getAvoirdupois() == null || this.get(i).getAvoirdupois().equals("null")) {
				pstmt.setString(22,null);
			} else {
				pstmt.setString(22, this.get(i).getAvoirdupois());
			}
			...
			if(this.get(i).getJoinCompanyDate() == null || this.get(i).getJoinCompanyDate().equals("null")) {
				...
				pstmt.setString(28, this.get(i).getJoinCompanyDate());
			}
			if(this.get(i).getStartWorkDate() == null || this.get(i).getStartWorkDate().equals("null")) {
				pstmt.setString(29,null);
			} else {
				pstmt.setString(29, this.get(i).getStartWorkDate());
			}
			...
			if(this.get(i).getSalary() == null || this.get(i).getSalary().equals("null")) {
				...
				pstmt.setString(31, this.get(i).getSalary());
			}
			...
			if(this.get(i).getMakeDate() == null || this.get(i).getMakeDate().equals("null")) {
				...
				pstmt.setString(39, this.get(i).getMakeDate());
			}
			...
			if(this.get(i).getModifyDate() == null || this.get(i).getModifyDate().equals("null")) {
				...
				pstmt.setString(41, this.get(i).getModifyDate());
			}
			...
			if(this.get(i).getBMI() == null || this.get(i).getBMI().equals("null")) {
				...
				pstmt.setString(43, this.get(i).getBMI());
			}
			...
			if(this.get(i).getContNo() == null || this.get(i).getContNo().equals("null")) {
				...
				pstmt.setString(63, this.get(i).getContNo());
			}
			pstmt.setInt(64, this.get(i).getInputNo());
			if(this.get(i).getFillNo() == null || this.get(i).getFillNo().equals("null")) {
				pstmt.setString(65,null);
			} else {
				pstmt.setString(65, this.get(i).getFillNo());
			}
