...
/*
 * <p>ClassName: LCCSpecSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 承保流程
 */
public class LCCSpecSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LCCSpecSchema.class);
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LCCSpecSchema cloned = (LCCSpecSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LCCSpecSchema 对象给 Schema 赋值
	* @param: aLCCSpecSchema LCCSpecSchema
	**/
	public void setSchema(LCCSpecSchema aLCCSpecSchema)
	{
		this.GrpContNo = aLCCSpecSchema.getGrpContNo();
		this.ContNo = aLCCSpecSchema.getContNo();
		this.ProposalContNo = aLCCSpecSchema.getProposalContNo();
		this.PrtSeq = aLCCSpecSchema.getPrtSeq();
		this.SerialNo = aLCCSpecSchema.getSerialNo();
		this.EndorsementNo = aLCCSpecSchema.getEndorsementNo();
		this.SpecType = aLCCSpecSchema.getSpecType();
		this.SpecCode = aLCCSpecSchema.getSpecCode();
		this.SpecContent = aLCCSpecSchema.getSpecContent();
		this.PrtFlag = aLCCSpecSchema.getPrtFlag();
		this.BackupType = aLCCSpecSchema.getBackupType();
		this.Operator = aLCCSpecSchema.getOperator();
		this.MakeDate = fDate.getDate( aLCCSpecSchema.getMakeDate());
		this.MakeTime = aLCCSpecSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLCCSpecSchema.getModifyDate());
		this.ModifyTime = aLCCSpecSchema.getModifyTime();
		this.CustomerNo = aLCCSpecSchema.getCustomerNo();
		this.SpecReason = aLCCSpecSchema.getSpecReason();
		this.NeedPrint = aLCCSpecSchema.getNeedPrint();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LCCSpec表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LCCSpecSchema";
	...
	public LCCSpecSchema getSchema()
	{
		LCCSpecSchema aLCCSpecSchema = new LCCSpecSchema();
		aLCCSpecSchema.setSchema(this);
		return aLCCSpecSchema;
	}

	public LCCSpecDB getDB()
	{
		LCCSpecDB aDBOper = new LCCSpecDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLCCSpec描述/A>表字段
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLCCSpec>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			SpecType = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 7, SysConst.PACKAGESPILTER );
			SpecCode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 8, SysConst.PACKAGESPILTER );
			SpecContent = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 9, SysConst.PACKAGESPILTER );
			PrtFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 10, SysConst.PACKAGESPILTER );
			BackupType = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 11, SysConst.PACKAGESPILTER );
			...
			SpecReason = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 18, SysConst.PACKAGESPILTER );
			NeedPrint = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 19, SysConst.PACKAGESPILTER );
		}
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LCCSpecSchema other = (LCCSpecSchema)otherObject;
		return
