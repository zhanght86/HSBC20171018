...
/*
 * <p>ClassName: LLUWPENoticeResultDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 泰康未整理PDM
 */
public class LLUWPENoticeResultDBSet extends LLUWPENoticeResultSet
{
	// @Field
	...
	**/
	...
	// @Constructor
	public LLUWPENoticeResultDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public LLUWPENoticeResultDBSet()
	{
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LLUWPENoticeResultDBSet";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getDisDesb() == null || this.get(i).getDisDesb().equals("null")) {
				...
				pstmt.setString(9, this.get(i).getDisDesb());
			}
			if(this.get(i).getDisResult() == null || this.get(i).getDisResult().equals("null")) {
				pstmt.setString(10,null);
			} else {
				pstmt.setString(10, this.get(i).getDisResult());
			}
