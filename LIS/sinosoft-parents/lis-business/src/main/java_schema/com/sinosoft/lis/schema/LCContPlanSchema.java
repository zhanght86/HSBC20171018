...
/*
 * <p>ClassName: LCContPlanSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 承保核心
 */
public class LCContPlanSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LCContPlanSchema.class);
	// @Field
	/** 集体合同号码 */
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LCContPlanSchema cloned = (LCContPlanSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LCContPlanSchema 对象给 Schema 赋值
	* @param: aLCContPlanSchema LCContPlanSchema
	**/
	public void setSchema(LCContPlanSchema aLCContPlanSchema)
	{
		this.GrpContNo = aLCContPlanSchema.getGrpContNo();
		this.ProposalGrpContNo = aLCContPlanSchema.getProposalGrpContNo();
		this.ContPlanCode = aLCContPlanSchema.getContPlanCode();
		this.ContPlanName = aLCContPlanSchema.getContPlanName();
		this.PlanType = aLCContPlanSchema.getPlanType();
		this.PlanRule = aLCContPlanSchema.getPlanRule();
		this.PlanSql = aLCContPlanSchema.getPlanSql();
		this.Remark = aLCContPlanSchema.getRemark();
		this.Operator = aLCContPlanSchema.getOperator();
		this.MakeDate = fDate.getDate( aLCContPlanSchema.getMakeDate());
		this.MakeTime = aLCContPlanSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLCContPlanSchema.getModifyDate());
		this.ModifyTime = aLCContPlanSchema.getModifyTime();
		this.Peoples3 = aLCContPlanSchema.getPeoples3();
		this.Remark2 = aLCContPlanSchema.getRemark2();
		this.Peoples2 = aLCContPlanSchema.getPeoples2();
		this.PlanCode = aLCContPlanSchema.getPlanCode();
		this.PlanFlag = aLCContPlanSchema.getPlanFlag();
		this.PremCalType = aLCContPlanSchema.getPremCalType();
		this.InsuPeriod = aLCContPlanSchema.getInsuPeriod();
		this.InsuPeriodFlag = aLCContPlanSchema.getInsuPeriodFlag();
		this.OccupTypeFlag = aLCContPlanSchema.getOccupTypeFlag();
		this.MinOccupType = aLCContPlanSchema.getMinOccupType();
		this.MaxOccupType = aLCContPlanSchema.getMaxOccupType();
		this.OccupType = aLCContPlanSchema.getOccupType();
		this.OccupMidType = aLCContPlanSchema.getOccupMidType();
		this.OccupCode = aLCContPlanSchema.getOccupCode();
		this.MinAge = aLCContPlanSchema.getMinAge();
		this.MaxAge = aLCContPlanSchema.getMaxAge();
		this.AvgAge = aLCContPlanSchema.getAvgAge();
		this.SocialInsuRate = aLCContPlanSchema.getSocialInsuRate();
		this.MaleRate = aLCContPlanSchema.getMaleRate();
		this.FemaleRate = aLCContPlanSchema.getFemaleRate();
		this.RetireRate = aLCContPlanSchema.getRetireRate();
		this.PremMode = aLCContPlanSchema.getPremMode();
		this.EnterpriseRate = aLCContPlanSchema.getEnterpriseRate();
		this.MinSalary = aLCContPlanSchema.getMinSalary();
		this.MaxSalary = aLCContPlanSchema.getMaxSalary();
		this.AvgSalary = aLCContPlanSchema.getAvgSalary();
		this.OtherDesc = aLCContPlanSchema.getOtherDesc();
		this.ModifyOperator = aLCContPlanSchema.getModifyOperator();
		this.OccupRate = aLCContPlanSchema.getOccupRate();
		this.CombiCode = aLCContPlanSchema.getCombiCode();
		this.CombiRate = aLCContPlanSchema.getCombiRate();
		this.CombiMult = aLCContPlanSchema.getCombiMult();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LCContPlan表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LCContPlanSchema";
	...
	public LCContPlanSchema getSchema()
	{
		LCContPlanSchema aLCContPlanSchema = new LCContPlanSchema();
		aLCContPlanSchema.setSchema(this);
		return aLCContPlanSchema;
	}

	public LCContPlanDB getDB()
	{
		LCContPlanDB aDBOper = new LCContPlanDB();
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLCContPlan>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			PlanCode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 17, SysConst.PACKAGESPILTER );
			PlanFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 18, SysConst.PACKAGESPILTER );
			PremCalType = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 19, SysConst.PACKAGESPILTER );
			InsuPeriod= new Integer(ChgData.chgNumericStr(StrTool.getStr(strMessage,20,SysConst.PACKAGESPILTER))).intValue();
			InsuPeriodFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 21, SysConst.PACKAGESPILTER );
			OccupTypeFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 22, SysConst.PACKAGESPILTER );
			MinOccupType = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 23, SysConst.PACKAGESPILTER );
			MaxOccupType = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 24, SysConst.PACKAGESPILTER );
			OccupType = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 25, SysConst.PACKAGESPILTER );
			OccupMidType = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 26, SysConst.PACKAGESPILTER );
			OccupCode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 27, SysConst.PACKAGESPILTER );
			MinAge= new Integer(ChgData.chgNumericStr(StrTool.getStr(strMessage,28,SysConst.PACKAGESPILTER))).intValue();
			MaxAge= new Integer(ChgData.chgNumericStr(StrTool.getStr(strMessage,29,SysConst.PACKAGESPILTER))).intValue();
			AvgAge= new Integer(ChgData.chgNumericStr(StrTool.getStr(strMessage,30,SysConst.PACKAGESPILTER))).intValue();
			SocialInsuRate = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,31,SysConst.PACKAGESPILTER))).doubleValue();
			MaleRate = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,32,SysConst.PACKAGESPILTER))).doubleValue();
			FemaleRate = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,33,SysConst.PACKAGESPILTER))).doubleValue();
			RetireRate = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,34,SysConst.PACKAGESPILTER))).doubleValue();
			PremMode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 35, SysConst.PACKAGESPILTER );
			EnterpriseRate = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,36,SysConst.PACKAGESPILTER))).doubleValue();
			MinSalary = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,37,SysConst.PACKAGESPILTER))).doubleValue();
			MaxSalary = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,38,SysConst.PACKAGESPILTER))).doubleValue();
			AvgSalary = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,39,SysConst.PACKAGESPILTER))).doubleValue();
			OtherDesc = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 40, SysConst.PACKAGESPILTER );
			ModifyOperator = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 41, SysConst.PACKAGESPILTER );
			OccupRate = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 42, SysConst.PACKAGESPILTER );
			CombiCode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 43, SysConst.PACKAGESPILTER );
			CombiRate = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 44, SysConst.PACKAGESPILTER );
			CombiMult= new Integer(ChgData.chgNumericStr(StrTool.getStr(strMessage,45,SysConst.PACKAGESPILTER))).intValue();
		}
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LCContPlanSchema other = (LCContPlanSchema)otherObject;
		return
