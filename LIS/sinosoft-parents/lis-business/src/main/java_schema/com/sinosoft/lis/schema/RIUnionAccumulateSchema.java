...
/*
 * <p>ClassName: RIUnionAccumulateSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 再保系统模型
 */
public class RIUnionAccumulateSchema implements Schema, Cloneable
{
	// @Field
	/** 累计方案编码 */
	private String AccumulateDefNO;
	/** 联合累计编号 */
	private String UnionAccNo;
	/** 险种/责任编码 */
	...
	// @Constructor
	public RIUnionAccumulateSchema()
	{
		mErrors = new CErrors();
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		RIUnionAccumulateSchema cloned = (RIUnionAccumulateSchema)super.clone();
	...
	public String getUnionAccNo()
	{
		return UnionAccNo;
	}
	public void setUnionAccNo(String aUnionAccNo)
	{
		UnionAccNo = aUnionAccNo;
	}
	...
	*/
	...
	/**
	* 使用另外一个 RIUnionAccumulateSchema 对象给 Schema 赋值
	* @param: aRIUnionAccumulateSchema RIUnionAccumulateSchema
	**/
	public void setSchema(RIUnionAccumulateSchema aRIUnionAccumulateSchema)
	{
		this.AccumulateDefNO = aRIUnionAccumulateSchema.getAccumulateDefNO();
		this.UnionAccNo = aRIUnionAccumulateSchema.getUnionAccNo();
		this.AssociatedCode = aRIUnionAccumulateSchema.getAssociatedCode();
		this.StandbyFlag = aRIUnionAccumulateSchema.getStandbyFlag();
		this.State = aRIUnionAccumulateSchema.getState();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		try
		{
			...
			if( rs.getString("UnionAccNo") == null )
				this.UnionAccNo = null;
			else
				this.UnionAccNo = rs.getString("UnionAccNo").trim();
		...
		{
			System.out.println("数据库中的RIUnionAccumulate表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "RIUnionAccumulateSchema";
	...
	public RIUnionAccumulateSchema getSchema()
	{
		RIUnionAccumulateSchema aRIUnionAccumulateSchema = new RIUnionAccumulateSchema();
		aRIUnionAccumulateSchema.setSchema(this);
		return aRIUnionAccumulateSchema;
	}

	public RIUnionAccumulateDB getDB()
	{
		RIUnionAccumulateDB aDBOper = new RIUnionAccumulateDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpRIUnionAccumulate描述/A>表字段
	...
	**/
	public String encode()
	{
		...
		strReturn.append(StrTool.cTrim(UnionAccNo)); strReturn.append(SysConst.PACKAGESPILTER);
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpRIUnionAccumulate>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			UnionAccNo = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 2, SysConst.PACKAGESPILTER );
			AssociatedCode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 3, SysConst.PACKAGESPILTER );
	...
	**/
	public String getV(String FCode)
	{
		...
		if (FCode.equalsIgnoreCase("UnionAccNo"))
		{
			strReturn = StrTool.GBKToUnicode(String.valueOf(UnionAccNo));
		}
	...
	public String getV(int nFieldIndex)
	{
		...
		switch(nFieldIndex) {
			case 0:
				...
				break;
			case 1:
				strFieldValue = StrTool.GBKToUnicode(UnionAccNo);
				break;
			case 2:
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		RIUnionAccumulateSchema other = (RIUnionAccumulateSchema)otherObject;
		return
			AccumulateDefNO.equals(other.getAccumulateDefNO())
			&& UnionAccNo.equals(other.getUnionAccNo())
	...
	**/
	public int getFieldIndex(String strFieldName)
	{
		...
		if( strFieldName.equals("UnionAccNo") ) {
			return 1;
		}
