...
/*
 * <p>ClassName: LACustomerQualityRecordDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 承保流程
 */
public class LACustomerQualityRecordDBSet extends LACustomerQualityRecordSet
{
private static Logger logger = Logger.getLogger(LACustomerQualityRecordDBSet.class);
	...
	**/
	...
	// @Constructor
	public LACustomerQualityRecordDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public LACustomerQualityRecordDBSet()
	{
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LACustomerQualityRecordDBSet";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getQualityFlag() == null || this.get(i).getQualityFlag().equals("null")) {
				...
				pstmt.setString(9, this.get(i).getQualityFlag());
			}
