...
{
private static Logger logger = Logger.getLogger(LGWorkTraceSchema.class);
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LGWorkTrace表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
	...
	**/
	public String encode()
	{
		...
		strReturn.append(StrTool.cTrim(InMethodNo)); strReturn.append(SysConst.PACKAGESPILTER);
		...
		strReturn.append(StrTool.cTrim(SendComNo)); strReturn.append(SysConst.PACKAGESPILTER);
		strReturn.append(StrTool.cTrim(SendPersonNo)); strReturn.append(SysConst.PACKAGESPILTER);
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			WorkBoxNo = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 3, SysConst.PACKAGESPILTER );
			InMethodNo = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 4, SysConst.PACKAGESPILTER );
			...
			SendComNo = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 7, SysConst.PACKAGESPILTER );
			SendPersonNo = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 8, SysConst.PACKAGESPILTER );
	...
	**/
	public String getV(String FCode)
	{
		...
		if (FCode.equalsIgnoreCase("InMethodNo"))
		{
		...
		if (FCode.equalsIgnoreCase("SendComNo"))
		{
			strReturn = StrTool.GBKToUnicode(String.valueOf(SendComNo));
		}
		if (FCode.equalsIgnoreCase("SendPersonNo"))
		{
