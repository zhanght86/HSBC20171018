...
{
private static Logger logger = Logger.getLogger(LAAgentBDBSet.class);
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getPassword() == null || this.get(i).getPassword().equals("null")) {
				...
				pstmt.setString(8, this.get(i).getPassword());
			}
			if(this.get(i).getEntryNo() == null || this.get(i).getEntryNo().equals("null")) {
				pstmt.setString(9,null);
			} else {
				pstmt.setString(9, this.get(i).getEntryNo());
			}
