...
/*
 * <p>ClassName: LLCUWBatchSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 理赔管理
 */
public class LLCUWBatchSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LLCUWBatchSchema.class);
	...
	/** 赔案相关标志 */
	private String ClaimRelFlag;
	/** 投保书健康告知栏询问号 */
	private String HealthImpartNo1;
	/** 体检健康告知栏询问号 */
	private String HealthImpartNo2;
	/** 对应未告知情况 */
	private String NoImpartDesc;
	/** 备注1 */
	private String Remark1;
	/** 备注2 */
	private String Remark2;
	/** 有效标志 */
	private String InEffectFlag;
	/** 二核发起人 */
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LLCUWBatchSchema cloned = (LLCUWBatchSchema)super.clone();
	...
	* 1无关
	*/
	public String getClaimRelFlag()
	{
		return ClaimRelFlag;
	}
	public void setClaimRelFlag(String aClaimRelFlag)
	{
		ClaimRelFlag = aClaimRelFlag;
	}
	public String getHealthImpartNo1()
	{
		return HealthImpartNo1;
	}
	public void setHealthImpartNo1(String aHealthImpartNo1)
	{
		HealthImpartNo1 = aHealthImpartNo1;
	}
	public String getHealthImpartNo2()
	{
		return HealthImpartNo2;
	}
	public void setHealthImpartNo2(String aHealthImpartNo2)
	{
		HealthImpartNo2 = aHealthImpartNo2;
	}
	public String getNoImpartDesc()
	{
		return NoImpartDesc;
	}
	public void setNoImpartDesc(String aNoImpartDesc)
	{
		NoImpartDesc = aNoImpartDesc;
	}
	...
	* 2--不生效
	*/
	public String getInEffectFlag()
	{
		return InEffectFlag;
	}
	public void setInEffectFlag(String aInEffectFlag)
	{
		InEffectFlag = aInEffectFlag;
	}
	...
	/**
	* 使用另外一个 LLCUWBatchSchema 对象给 Schema 赋值
	* @param: aLLCUWBatchSchema LLCUWBatchSchema
	**/
	public void setSchema(LLCUWBatchSchema aLLCUWBatchSchema)
	{
		this.CaseNo = aLLCUWBatchSchema.getCaseNo();
		this.BatNo = aLLCUWBatchSchema.getBatNo();
		this.GrpContNo = aLLCUWBatchSchema.getGrpContNo();
		this.ContNo = aLLCUWBatchSchema.getContNo();
		this.ProposalContNo = aLLCUWBatchSchema.getProposalContNo();
		this.UWNo = aLLCUWBatchSchema.getUWNo();
		this.InsuredNo = aLLCUWBatchSchema.getInsuredNo();
		this.InsuredName = aLLCUWBatchSchema.getInsuredName();
		this.AppntNo = aLLCUWBatchSchema.getAppntNo();
		this.AppntName = aLLCUWBatchSchema.getAppntName();
		this.PassFlag = aLLCUWBatchSchema.getPassFlag();
		this.UWGrade = aLLCUWBatchSchema.getUWGrade();
		this.AppGrade = aLLCUWBatchSchema.getAppGrade();
		this.PostponeDay = aLLCUWBatchSchema.getPostponeDay();
		this.PostponeDate = fDate.getDate( aLLCUWBatchSchema.getPostponeDate());
		this.AutoUWFlag = aLLCUWBatchSchema.getAutoUWFlag();
		this.State = aLLCUWBatchSchema.getState();
		this.ManageCom = aLLCUWBatchSchema.getManageCom();
		this.UWIdea = aLLCUWBatchSchema.getUWIdea();
		this.UpReportContent = aLLCUWBatchSchema.getUpReportContent();
		this.Operator = aLLCUWBatchSchema.getOperator();
		this.HealthFlag = aLLCUWBatchSchema.getHealthFlag();
		this.QuesFlag = aLLCUWBatchSchema.getQuesFlag();
		this.SpecFlag = aLLCUWBatchSchema.getSpecFlag();
		this.AddPremFlag = aLLCUWBatchSchema.getAddPremFlag();
		this.AddPremReason = aLLCUWBatchSchema.getAddPremReason();
		this.ReportFlag = aLLCUWBatchSchema.getReportFlag();
		this.PrintFlag = aLLCUWBatchSchema.getPrintFlag();
		this.PrintFlag2 = aLLCUWBatchSchema.getPrintFlag2();
		this.ChangePolFlag = aLLCUWBatchSchema.getChangePolFlag();
		this.ChangePolReason = aLLCUWBatchSchema.getChangePolReason();
		this.SpecReason = aLLCUWBatchSchema.getSpecReason();
		this.MakeDate = fDate.getDate( aLLCUWBatchSchema.getMakeDate());
		this.MakeTime = aLLCUWBatchSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLLCUWBatchSchema.getModifyDate());
		this.ModifyTime = aLLCUWBatchSchema.getModifyTime();
		this.SugPassFlag = aLLCUWBatchSchema.getSugPassFlag();
		this.SugUWIdea = aLLCUWBatchSchema.getSugUWIdea();
		this.ClaimRelFlag = aLLCUWBatchSchema.getClaimRelFlag();
		this.HealthImpartNo1 = aLLCUWBatchSchema.getHealthImpartNo1();
		this.HealthImpartNo2 = aLLCUWBatchSchema.getHealthImpartNo2();
		this.NoImpartDesc = aLLCUWBatchSchema.getNoImpartDesc();
		this.Remark1 = aLLCUWBatchSchema.getRemark1();
		this.Remark2 = aLLCUWBatchSchema.getRemark2();
		this.InEffectFlag = aLLCUWBatchSchema.getInEffectFlag();
		this.UWOperator = aLLCUWBatchSchema.getUWOperator();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		try
		{
			...
			if( rs.getString("ClaimRelFlag") == null )
				this.ClaimRelFlag = null;
			else
				this.ClaimRelFlag = rs.getString("ClaimRelFlag").trim();

			if( rs.getString("HealthImpartNo1") == null )
				this.HealthImpartNo1 = null;
			else
				this.HealthImpartNo1 = rs.getString("HealthImpartNo1").trim();

			if( rs.getString("HealthImpartNo2") == null )
				this.HealthImpartNo2 = null;
			else
				this.HealthImpartNo2 = rs.getString("HealthImpartNo2").trim();

			if( rs.getString("NoImpartDesc") == null )
				this.NoImpartDesc = null;
			else
				this.NoImpartDesc = rs.getString("NoImpartDesc").trim();
			...
			if( rs.getString("InEffectFlag") == null )
				this.InEffectFlag = null;
			else
				this.InEffectFlag = rs.getString("InEffectFlag").trim();
		...
		{
			logger.debug("数据库中的LLCUWBatch表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LLCUWBatchSchema";
	...
	public LLCUWBatchSchema getSchema()
	{
		LLCUWBatchSchema aLLCUWBatchSchema = new LLCUWBatchSchema();
		aLLCUWBatchSchema.setSchema(this);
		return aLLCUWBatchSchema;
	}

	public LLCUWBatchDB getDB()
	{
		LLCUWBatchDB aDBOper = new LLCUWBatchDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLLCUWBatch描述/A>表字段
	...
	**/
	public String encode()
	{
		...
		strReturn.append(StrTool.cTrim(ClaimRelFlag)); strReturn.append(SysConst.PACKAGESPILTER);
		strReturn.append(StrTool.cTrim(HealthImpartNo1)); strReturn.append(SysConst.PACKAGESPILTER);
		strReturn.append(StrTool.cTrim(HealthImpartNo2)); strReturn.append(SysConst.PACKAGESPILTER);
		strReturn.append(StrTool.cTrim(NoImpartDesc)); strReturn.append(SysConst.PACKAGESPILTER);
		...
		strReturn.append(StrTool.cTrim(InEffectFlag)); strReturn.append(SysConst.PACKAGESPILTER);
		strReturn.append(StrTool.cTrim(UWOperator));
		return strReturn.toString();
	}

	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLLCUWBatch>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			InsuredName = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 8, SysConst.PACKAGESPILTER );
			...
			ClaimRelFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 39, SysConst.PACKAGESPILTER );
			HealthImpartNo1 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 40, SysConst.PACKAGESPILTER );
			HealthImpartNo2 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 41, SysConst.PACKAGESPILTER );
			NoImpartDesc = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 42, SysConst.PACKAGESPILTER );
			Remark1 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 43, SysConst.PACKAGESPILTER );
			Remark2 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 44, SysConst.PACKAGESPILTER );
			InEffectFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 45, SysConst.PACKAGESPILTER );
			UWOperator = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 46, SysConst.PACKAGESPILTER );
		}
	...
	**/
	public String getV(String FCode)
	{
		...
		if (FCode.equalsIgnoreCase("ClaimRelFlag"))
		{
			strReturn = StrTool.GBKToUnicode(String.valueOf(ClaimRelFlag));
		}
		if (FCode.equalsIgnoreCase("HealthImpartNo1"))
		{
			strReturn = StrTool.GBKToUnicode(String.valueOf(HealthImpartNo1));
		}
		if (FCode.equalsIgnoreCase("HealthImpartNo2"))
		{
			strReturn = StrTool.GBKToUnicode(String.valueOf(HealthImpartNo2));
		}
		if (FCode.equalsIgnoreCase("NoImpartDesc"))
		{
			strReturn = StrTool.GBKToUnicode(String.valueOf(NoImpartDesc));
		}
		...
		if (FCode.equalsIgnoreCase("InEffectFlag"))
		{
			strReturn = StrTool.GBKToUnicode(String.valueOf(InEffectFlag));
		}
	...
	public String getV(int nFieldIndex)
	{
		...
		switch(nFieldIndex) {
			...
			case 37:
				...
				break;
			case 38:
				strFieldValue = StrTool.GBKToUnicode(ClaimRelFlag);
				break;
			case 39:
				strFieldValue = StrTool.GBKToUnicode(HealthImpartNo1);
				break;
			case 40:
				strFieldValue = StrTool.GBKToUnicode(HealthImpartNo2);
				break;
			case 41:
				strFieldValue = StrTool.GBKToUnicode(NoImpartDesc);
				break;
			case 42:
			...
			case 43:
				...
				break;
			case 44:
				strFieldValue = StrTool.GBKToUnicode(InEffectFlag);
				break;
			case 45:
	...
	**/
	public boolean setV(String FCode ,String FValue)
	{
		...
		if (FCode.equalsIgnoreCase("HealthImpartNo1"))
		{
			if( FValue != null && !FValue.equals(""))
			{
				HealthImpartNo1 = FValue.trim();
			}
			else
				HealthImpartNo1 = null;
		}
		if (FCode.equalsIgnoreCase("HealthImpartNo2"))
		{
			if( FValue != null && !FValue.equals(""))
			{
				HealthImpartNo2 = FValue.trim();
			}
			else
				HealthImpartNo2 = null;
		}
		if (FCode.equalsIgnoreCase("NoImpartDesc"))
		{
			if( FValue != null && !FValue.equals(""))
			{
				NoImpartDesc = FValue.trim();
			}
			else
				NoImpartDesc = null;
		}
	...
	public boolean equals(Object otherObject)
	{
		...
		LLCUWBatchSchema other = (LLCUWBatchSchema)otherObject;
		return
			...
			&& ClaimRelFlag.equals(other.getClaimRelFlag())
			&& HealthImpartNo1.equals(other.getHealthImpartNo1())
			&& HealthImpartNo2.equals(other.getHealthImpartNo2())
			&& NoImpartDesc.equals(other.getNoImpartDesc())
			&& Remark1.equals(other.getRemark1())
			&& Remark2.equals(other.getRemark2())
			&& InEffectFlag.equals(other.getInEffectFlag())
	...
	**/
	public int getFieldIndex(String strFieldName)
	{
		...
		if( strFieldName.equals("ClaimRelFlag") ) {
			return 38;
		}
		if( strFieldName.equals("HealthImpartNo1") ) {
			return 39;
		}
		if( strFieldName.equals("HealthImpartNo2") ) {
			return 40;
		}
		if( strFieldName.equals("NoImpartDesc") ) {
			return 41;
		}
		...
		if( strFieldName.equals("InEffectFlag") ) {
			return 44;
		}
	...
	public String getFieldName(int nFieldIndex)
	{
		...
		switch(nFieldIndex) {
			...
			case 37:
				...
				break;
			case 38:
				strFieldName = "ClaimRelFlag";
				break;
			case 39:
				strFieldName = "HealthImpartNo1";
				break;
			case 40:
				strFieldName = "HealthImpartNo2";
				break;
			case 41:
				strFieldName = "NoImpartDesc";
				break;
			case 42:
