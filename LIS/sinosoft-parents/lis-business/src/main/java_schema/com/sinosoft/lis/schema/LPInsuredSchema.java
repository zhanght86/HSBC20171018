...
/*
 * <p>ClassName: LPInsuredSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 保全核心
 */
public class LPInsuredSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LPInsuredSchema.class);
	// @Field
	/** 批单号 */
	...
	public static final int FIELDNUM = 111;	// 数据库表的字段个数
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LPInsuredSchema cloned = (LPInsuredSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LPInsuredSchema 对象给 Schema 赋值
	* @param: aLPInsuredSchema LPInsuredSchema
	**/
	public void setSchema(LPInsuredSchema aLPInsuredSchema)
	{
		this.EdorNo = aLPInsuredSchema.getEdorNo();
		this.EdorType = aLPInsuredSchema.getEdorType();
		this.GrpContNo = aLPInsuredSchema.getGrpContNo();
		this.ContNo = aLPInsuredSchema.getContNo();
		this.InsuredNo = aLPInsuredSchema.getInsuredNo();
		this.PrtNo = aLPInsuredSchema.getPrtNo();
		this.AppntNo = aLPInsuredSchema.getAppntNo();
		this.ManageCom = aLPInsuredSchema.getManageCom();
		this.ExecuteCom = aLPInsuredSchema.getExecuteCom();
		this.FamilyID = aLPInsuredSchema.getFamilyID();
		this.RelationToMainInsured = aLPInsuredSchema.getRelationToMainInsured();
		this.RelationToAppnt = aLPInsuredSchema.getRelationToAppnt();
		this.AddressNo = aLPInsuredSchema.getAddressNo();
		this.SequenceNo = aLPInsuredSchema.getSequenceNo();
		this.Name = aLPInsuredSchema.getName();
		this.Sex = aLPInsuredSchema.getSex();
		this.Birthday = fDate.getDate( aLPInsuredSchema.getBirthday());
		this.IDType = aLPInsuredSchema.getIDType();
		this.IDNo = aLPInsuredSchema.getIDNo();
		this.NativePlace = aLPInsuredSchema.getNativePlace();
		this.Nationality = aLPInsuredSchema.getNationality();
		this.RgtAddress = aLPInsuredSchema.getRgtAddress();
		this.Marriage = aLPInsuredSchema.getMarriage();
		this.MarriageDate = fDate.getDate( aLPInsuredSchema.getMarriageDate());
		this.Health = aLPInsuredSchema.getHealth();
		this.Stature = aLPInsuredSchema.getStature();
		this.Avoirdupois = aLPInsuredSchema.getAvoirdupois();
		this.Degree = aLPInsuredSchema.getDegree();
		this.CreditGrade = aLPInsuredSchema.getCreditGrade();
		this.BankCode = aLPInsuredSchema.getBankCode();
		this.BankAccNo = aLPInsuredSchema.getBankAccNo();
		this.AccName = aLPInsuredSchema.getAccName();
		this.JoinCompanyDate = fDate.getDate( aLPInsuredSchema.getJoinCompanyDate());
		this.StartWorkDate = fDate.getDate( aLPInsuredSchema.getStartWorkDate());
		this.Position = aLPInsuredSchema.getPosition();
		this.Salary = aLPInsuredSchema.getSalary();
		this.OccupationType = aLPInsuredSchema.getOccupationType();
		this.OccupationCode = aLPInsuredSchema.getOccupationCode();
		this.WorkType = aLPInsuredSchema.getWorkType();
		this.PluralityType = aLPInsuredSchema.getPluralityType();
		this.SmokeFlag = aLPInsuredSchema.getSmokeFlag();
		this.ContPlanCode = aLPInsuredSchema.getContPlanCode();
		this.Operator = aLPInsuredSchema.getOperator();
		this.InsuredStat = aLPInsuredSchema.getInsuredStat();
		this.MakeDate = fDate.getDate( aLPInsuredSchema.getMakeDate());
		this.MakeTime = aLPInsuredSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLPInsuredSchema.getModifyDate());
		this.ModifyTime = aLPInsuredSchema.getModifyTime();
		this.UWFlag = aLPInsuredSchema.getUWFlag();
		this.UWCode = aLPInsuredSchema.getUWCode();
		this.UWDate = fDate.getDate( aLPInsuredSchema.getUWDate());
		this.UWTime = aLPInsuredSchema.getUWTime();
		this.BMI = aLPInsuredSchema.getBMI();
		this.InsuredPeoples = aLPInsuredSchema.getInsuredPeoples();
		this.License = aLPInsuredSchema.getLicense();
		this.LicenseType = aLPInsuredSchema.getLicenseType();
		this.CustomerSeqNo = aLPInsuredSchema.getCustomerSeqNo();
		this.SocialInsuNo = aLPInsuredSchema.getSocialInsuNo();
		this.SendMsgFlag = aLPInsuredSchema.getSendMsgFlag();
		this.SendMailFlag = aLPInsuredSchema.getSendMailFlag();
		this.JoinContDate = fDate.getDate( aLPInsuredSchema.getJoinContDate());
		this.WorkNo = aLPInsuredSchema.getWorkNo();
		this.CertifyCode = aLPInsuredSchema.getCertifyCode();
		this.StartCode = aLPInsuredSchema.getStartCode();
		this.EndCode = aLPInsuredSchema.getEndCode();
		this.SocialInsuFlag = aLPInsuredSchema.getSocialInsuFlag();
		this.IDExpDate = fDate.getDate( aLPInsuredSchema.getIDExpDate());
		this.GrpNo = aLPInsuredSchema.getGrpNo();
		this.OrganComCode = aLPInsuredSchema.getOrganComCode();
		this.LastName = aLPInsuredSchema.getLastName();
		this.FirstName = aLPInsuredSchema.getFirstName();
		this.LastNameEn = aLPInsuredSchema.getLastNameEn();
		this.FirstNameEn = aLPInsuredSchema.getFirstNameEn();
		this.NameEn = aLPInsuredSchema.getNameEn();
		this.LastNamePY = aLPInsuredSchema.getLastNamePY();
		this.FirstNamePY = aLPInsuredSchema.getFirstNamePY();
		this.Language = aLPInsuredSchema.getLanguage();
		this.MainCustomerNo = aLPInsuredSchema.getMainCustomerNo();
		this.InsuredType = aLPInsuredSchema.getInsuredType();
		this.IsLongValid = aLPInsuredSchema.getIsLongValid();
		this.IDStartDate = fDate.getDate( aLPInsuredSchema.getIDStartDate());
		this.InsuredAppAge = aLPInsuredSchema.getInsuredAppAge();
		this.Seniority = aLPInsuredSchema.getSeniority();
		this.WorkCompName = aLPInsuredSchema.getWorkCompName();
		this.PlanCode = aLPInsuredSchema.getPlanCode();
		this.DeathDate = fDate.getDate( aLPInsuredSchema.getDeathDate());
		this.BlacklistFlag = aLPInsuredSchema.getBlacklistFlag();
		this.VIPValue = aLPInsuredSchema.getVIPValue();
		this.SendQQFlag = aLPInsuredSchema.getSendQQFlag();
		this.SendMSNFlag = aLPInsuredSchema.getSendMSNFlag();
		this.ServerArea = aLPInsuredSchema.getServerArea();
		this.SubCustomerNo = aLPInsuredSchema.getSubCustomerNo();
		this.Substandard = aLPInsuredSchema.getSubstandard();
		this.Remark = aLPInsuredSchema.getRemark();
		this.PakageCode = aLPInsuredSchema.getPakageCode();
		this.Destination = aLPInsuredSchema.getDestination();
		this.Purpose = aLPInsuredSchema.getPurpose();
		this.EmergencyContact = aLPInsuredSchema.getEmergencyContact();
		this.EmerContPhone = aLPInsuredSchema.getEmerContPhone();
		this.ApplytoDay = aLPInsuredSchema.getApplytoDay();
		this.MaternityFlag = aLPInsuredSchema.getMaternityFlag();
		this.RescueType = aLPInsuredSchema.getRescueType();
		this.DeptCode = aLPInsuredSchema.getDeptCode();
		this.SubCompanyCode = aLPInsuredSchema.getSubCompanyCode();
		this.InsureCode = aLPInsuredSchema.getInsureCode();
		this.WorkAddress = aLPInsuredSchema.getWorkAddress();
		this.SocialInsuAddress = aLPInsuredSchema.getSocialInsuAddress();
		this.OriginContNo = aLPInsuredSchema.getOriginContNo();
		this.OriginInsuredNo = aLPInsuredSchema.getOriginInsuredNo();
		this.ComCode = aLPInsuredSchema.getComCode();
		this.ModifyOperator = aLPInsuredSchema.getModifyOperator();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LPInsured表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LPInsuredSchema";
	...
	public LPInsuredSchema getSchema()
	{
		LPInsuredSchema aLPInsuredSchema = new LPInsuredSchema();
		aLPInsuredSchema.setSchema(this);
		return aLPInsuredSchema;
	}

	public LPInsuredDB getDB()
	{
		LPInsuredDB aDBOper = new LPInsuredDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLPInsured描述/A>表字段
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLPInsured>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			ExecuteCom = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 9, SysConst.PACKAGESPILTER );
			FamilyID = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 10, SysConst.PACKAGESPILTER );
			RelationToMainInsured = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 11, SysConst.PACKAGESPILTER );
			RelationToAppnt = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 12, SysConst.PACKAGESPILTER );
			AddressNo = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 13, SysConst.PACKAGESPILTER );
			SequenceNo = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 14, SysConst.PACKAGESPILTER );
			...
			NativePlace = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 20, SysConst.PACKAGESPILTER );
			Nationality = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 21, SysConst.PACKAGESPILTER );
			RgtAddress = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 22, SysConst.PACKAGESPILTER );
			Marriage = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 23, SysConst.PACKAGESPILTER );
			MarriageDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 24,SysConst.PACKAGESPILTER));
			Health = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 25, SysConst.PACKAGESPILTER );
			Stature = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,26,SysConst.PACKAGESPILTER))).doubleValue();
			Avoirdupois = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,27,SysConst.PACKAGESPILTER))).doubleValue();
			Degree = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 28, SysConst.PACKAGESPILTER );
			CreditGrade = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 29, SysConst.PACKAGESPILTER );
			...
			JoinCompanyDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 33,SysConst.PACKAGESPILTER));
			StartWorkDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 34,SysConst.PACKAGESPILTER));
			Position = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 35, SysConst.PACKAGESPILTER );
			Salary = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,36,SysConst.PACKAGESPILTER))).doubleValue();
			...
			WorkType = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 39, SysConst.PACKAGESPILTER );
			PluralityType = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 40, SysConst.PACKAGESPILTER );
			SmokeFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 41, SysConst.PACKAGESPILTER );
			ContPlanCode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 42, SysConst.PACKAGESPILTER );
			Operator = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 43, SysConst.PACKAGESPILTER );
			InsuredStat = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 44, SysConst.PACKAGESPILTER );
			...
			UWFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 49, SysConst.PACKAGESPILTER );
			UWCode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 50, SysConst.PACKAGESPILTER );
			UWDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 51,SysConst.PACKAGESPILTER));
			UWTime = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 52, SysConst.PACKAGESPILTER );
			BMI = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,53,SysConst.PACKAGESPILTER))).doubleValue();
			InsuredPeoples= new Integer(ChgData.chgNumericStr(StrTool.getStr(strMessage,54,SysConst.PACKAGESPILTER))).intValue();
			License = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 55, SysConst.PACKAGESPILTER );
			LicenseType = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 56, SysConst.PACKAGESPILTER );
			CustomerSeqNo= new Integer(ChgData.chgNumericStr(StrTool.getStr(strMessage,57,SysConst.PACKAGESPILTER))).intValue();
			SocialInsuNo = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 58, SysConst.PACKAGESPILTER );
			SendMsgFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 59, SysConst.PACKAGESPILTER );
			SendMailFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 60, SysConst.PACKAGESPILTER );
			JoinContDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 61,SysConst.PACKAGESPILTER));
			WorkNo = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 62, SysConst.PACKAGESPILTER );
			CertifyCode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 63, SysConst.PACKAGESPILTER );
			StartCode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 64, SysConst.PACKAGESPILTER );
			EndCode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 65, SysConst.PACKAGESPILTER );
			SocialInsuFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 66, SysConst.PACKAGESPILTER );
			IDExpDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 67,SysConst.PACKAGESPILTER));
			GrpNo = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 68, SysConst.PACKAGESPILTER );
			OrganComCode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 69, SysConst.PACKAGESPILTER );
			LastName = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 70, SysConst.PACKAGESPILTER );
			FirstName = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 71, SysConst.PACKAGESPILTER );
			LastNameEn = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 72, SysConst.PACKAGESPILTER );
			FirstNameEn = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 73, SysConst.PACKAGESPILTER );
			NameEn = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 74, SysConst.PACKAGESPILTER );
			LastNamePY = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 75, SysConst.PACKAGESPILTER );
			FirstNamePY = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 76, SysConst.PACKAGESPILTER );
			Language = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 77, SysConst.PACKAGESPILTER );
			MainCustomerNo = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 78, SysConst.PACKAGESPILTER );
			InsuredType = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 79, SysConst.PACKAGESPILTER );
			IsLongValid = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 80, SysConst.PACKAGESPILTER );
			IDStartDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 81,SysConst.PACKAGESPILTER));
			InsuredAppAge= new Integer(ChgData.chgNumericStr(StrTool.getStr(strMessage,82,SysConst.PACKAGESPILTER))).intValue();
			Seniority = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,83,SysConst.PACKAGESPILTER))).doubleValue();
			WorkCompName = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 84, SysConst.PACKAGESPILTER );
			PlanCode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 85, SysConst.PACKAGESPILTER );
			DeathDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 86,SysConst.PACKAGESPILTER));
			BlacklistFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 87, SysConst.PACKAGESPILTER );
			VIPValue = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 88, SysConst.PACKAGESPILTER );
			SendQQFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 89, SysConst.PACKAGESPILTER );
			SendMSNFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 90, SysConst.PACKAGESPILTER );
			ServerArea = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 91, SysConst.PACKAGESPILTER );
			SubCustomerNo = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 92, SysConst.PACKAGESPILTER );
			Substandard = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 93, SysConst.PACKAGESPILTER );
			Remark = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 94, SysConst.PACKAGESPILTER );
			PakageCode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 95, SysConst.PACKAGESPILTER );
			Destination = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 96, SysConst.PACKAGESPILTER );
			Purpose = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 97, SysConst.PACKAGESPILTER );
			EmergencyContact = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 98, SysConst.PACKAGESPILTER );
			EmerContPhone = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 99, SysConst.PACKAGESPILTER );
			ApplytoDay = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 100, SysConst.PACKAGESPILTER );
			MaternityFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 101, SysConst.PACKAGESPILTER );
			RescueType = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 102, SysConst.PACKAGESPILTER );
			DeptCode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 103, SysConst.PACKAGESPILTER );
			SubCompanyCode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 104, SysConst.PACKAGESPILTER );
			InsureCode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 105, SysConst.PACKAGESPILTER );
			WorkAddress = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 106, SysConst.PACKAGESPILTER );
			SocialInsuAddress = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 107, SysConst.PACKAGESPILTER );
			OriginContNo = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 108, SysConst.PACKAGESPILTER );
			OriginInsuredNo = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 109, SysConst.PACKAGESPILTER );
			ComCode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 110, SysConst.PACKAGESPILTER );
			ModifyOperator = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 111, SysConst.PACKAGESPILTER );
		}
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LPInsuredSchema other = (LPInsuredSchema)otherObject;
		return
