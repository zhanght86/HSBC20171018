...
/*
 * <p>ClassName: LCUWMasterSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 承保流程
 */
public class LCUWMasterSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LCUWMasterSchema.class);
	// @Field
	/** 集体合同号码 */
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LCUWMasterSchema cloned = (LCUWMasterSchema)super.clone();
	...
	*/
	...
	{
		if(aUWType!=null && aUWType.length()>2)
			throw new IllegalArgumentException("核保类型UWType值"+aUWType+"的长度"+aUWType.length()+"大于最大值2");
		UWType = aUWType;
	}
	...
	*/
	...
	/**
	* 使用另外一个 LCUWMasterSchema 对象给 Schema 赋值
	* @param: aLCUWMasterSchema LCUWMasterSchema
	**/
	public void setSchema(LCUWMasterSchema aLCUWMasterSchema)
	{
		this.GrpContNo = aLCUWMasterSchema.getGrpContNo();
		this.ContNo = aLCUWMasterSchema.getContNo();
		this.ProposalContNo = aLCUWMasterSchema.getProposalContNo();
		this.PolNo = aLCUWMasterSchema.getPolNo();
		this.ProposalNo = aLCUWMasterSchema.getProposalNo();
		this.UWNo = aLCUWMasterSchema.getUWNo();
		this.InsuredNo = aLCUWMasterSchema.getInsuredNo();
		this.InsuredName = aLCUWMasterSchema.getInsuredName();
		this.AppntNo = aLCUWMasterSchema.getAppntNo();
		this.AppntName = aLCUWMasterSchema.getAppntName();
		this.AgentCode = aLCUWMasterSchema.getAgentCode();
		this.AgentGroup = aLCUWMasterSchema.getAgentGroup();
		this.PassFlag = aLCUWMasterSchema.getPassFlag();
		this.UWGrade = aLCUWMasterSchema.getUWGrade();
		this.AppGrade = aLCUWMasterSchema.getAppGrade();
		this.PostponeDay = aLCUWMasterSchema.getPostponeDay();
		this.PostponeDate = fDate.getDate( aLCUWMasterSchema.getPostponeDate());
		this.AutoUWFlag = aLCUWMasterSchema.getAutoUWFlag();
		this.State = aLCUWMasterSchema.getState();
		this.ManageCom = aLCUWMasterSchema.getManageCom();
		this.UWIdea = aLCUWMasterSchema.getUWIdea();
		this.UpReportContent = aLCUWMasterSchema.getUpReportContent();
		this.Operator = aLCUWMasterSchema.getOperator();
		this.HealthFlag = aLCUWMasterSchema.getHealthFlag();
		this.QuesFlag = aLCUWMasterSchema.getQuesFlag();
		this.SpecFlag = aLCUWMasterSchema.getSpecFlag();
		this.AddPremFlag = aLCUWMasterSchema.getAddPremFlag();
		this.AddPremReason = aLCUWMasterSchema.getAddPremReason();
		this.ReportFlag = aLCUWMasterSchema.getReportFlag();
		this.PrintFlag = aLCUWMasterSchema.getPrintFlag();
		this.PrintFlag2 = aLCUWMasterSchema.getPrintFlag2();
		this.ChangePolFlag = aLCUWMasterSchema.getChangePolFlag();
		this.ChangePolReason = aLCUWMasterSchema.getChangePolReason();
		this.SpecReason = aLCUWMasterSchema.getSpecReason();
		this.MakeDate = fDate.getDate( aLCUWMasterSchema.getMakeDate());
		this.MakeTime = aLCUWMasterSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLCUWMasterSchema.getModifyDate());
		this.ModifyTime = aLCUWMasterSchema.getModifyTime();
		this.SugPassFlag = aLCUWMasterSchema.getSugPassFlag();
		this.SugUWIdea = aLCUWMasterSchema.getSugUWIdea();
		this.UpReport = aLCUWMasterSchema.getUpReport();
		this.BatchNo = aLCUWMasterSchema.getBatchNo();
		this.UWType = aLCUWMasterSchema.getUWType();
		this.AutoUWDate = fDate.getDate( aLCUWMasterSchema.getAutoUWDate());
		this.UWConclu = aLCUWMasterSchema.getUWConclu();
		this.UWDate = fDate.getDate( aLCUWMasterSchema.getUWDate());
		this.ComCode = aLCUWMasterSchema.getComCode();
		this.ModifyOperator = aLCUWMasterSchema.getModifyOperator();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LCUWMaster表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LCUWMasterSchema";
	...
	public LCUWMasterSchema getSchema()
	{
		LCUWMasterSchema aLCUWMasterSchema = new LCUWMasterSchema();
		aLCUWMasterSchema.setSchema(this);
		return aLCUWMasterSchema;
	}

	public LCUWMasterDB getDB()
	{
		LCUWMasterDB aDBOper = new LCUWMasterDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLCUWMaster描述/A>表字段
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLCUWMaster>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			UpReport = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 41, SysConst.PACKAGESPILTER );
			BatchNo= new Integer(ChgData.chgNumericStr(StrTool.getStr(strMessage,42,SysConst.PACKAGESPILTER))).intValue();
			UWType = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 43, SysConst.PACKAGESPILTER );
			AutoUWDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 44,SysConst.PACKAGESPILTER));
			UWConclu = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 45, SysConst.PACKAGESPILTER );
			UWDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 46,SysConst.PACKAGESPILTER));
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LCUWMasterSchema other = (LCUWMasterSchema)otherObject;
		return
