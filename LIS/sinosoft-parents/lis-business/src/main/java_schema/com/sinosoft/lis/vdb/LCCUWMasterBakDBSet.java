...
/*
 * <p>ClassName: LCCUWMasterBakDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: PhysicalDataModel_1
 */
public class LCCUWMasterBakDBSet extends LCCUWMasterBakSet
{
private static Logger logger = Logger.getLogger(LCCUWMasterBakDBSet.class);
	...
	**/
	...
	// @Constructor
	public LCCUWMasterBakDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LCCUWMasterBakDBSet";
