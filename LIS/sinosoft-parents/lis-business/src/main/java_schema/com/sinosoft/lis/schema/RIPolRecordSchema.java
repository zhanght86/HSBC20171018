...
/*
 * <p>ClassName: RIPolRecordSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 再保系统模型
 */
public class RIPolRecordSchema implements Schema, Cloneable
{
	// @Field
	/** 批次号 */
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		RIPolRecordSchema cloned = (RIPolRecordSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 RIPolRecordSchema 对象给 Schema 赋值
	* @param: aRIPolRecordSchema RIPolRecordSchema
	**/
	public void setSchema(RIPolRecordSchema aRIPolRecordSchema)
	{
		this.BatchNo = aRIPolRecordSchema.getBatchNo();
		this.EventNo = aRIPolRecordSchema.getEventNo();
		this.EventType = aRIPolRecordSchema.getEventType();
		this.RecordType = aRIPolRecordSchema.getRecordType();
		this.NodeState = aRIPolRecordSchema.getNodeState();
		this.DataFlag = aRIPolRecordSchema.getDataFlag();
		this.UnionKey = aRIPolRecordSchema.getUnionKey();
		this.GrpContNo = aRIPolRecordSchema.getGrpContNo();
		this.ProposalGrpContNo = aRIPolRecordSchema.getProposalGrpContNo();
		this.GrpPolNo = aRIPolRecordSchema.getGrpPolNo();
		this.GrpProposalNo = aRIPolRecordSchema.getGrpProposalNo();
		this.ContNo = aRIPolRecordSchema.getContNo();
		this.PolNo = aRIPolRecordSchema.getPolNo();
		this.ProposalNo = aRIPolRecordSchema.getProposalNo();
		this.ContPlanCode = aRIPolRecordSchema.getContPlanCode();
		this.PlanType = aRIPolRecordSchema.getPlanType();
		this.RiskPeriod = aRIPolRecordSchema.getRiskPeriod();
		this.RiskType = aRIPolRecordSchema.getRiskType();
		this.RiskCode = aRIPolRecordSchema.getRiskCode();
		this.DutyCode = aRIPolRecordSchema.getDutyCode();
		this.Years = aRIPolRecordSchema.getYears();
		this.InsuredYear = aRIPolRecordSchema.getInsuredYear();
		this.SaleChnl = aRIPolRecordSchema.getSaleChnl();
		this.CValiDate = fDate.getDate( aRIPolRecordSchema.getCValiDate());
		this.EndDate = fDate.getDate( aRIPolRecordSchema.getEndDate());
		this.InsuredNo = aRIPolRecordSchema.getInsuredNo();
		this.InsuredName = aRIPolRecordSchema.getInsuredName();
		this.InsuredSex = aRIPolRecordSchema.getInsuredSex();
		this.InsuredBirthday = fDate.getDate( aRIPolRecordSchema.getInsuredBirthday());
		this.InsuredAge = aRIPolRecordSchema.getInsuredAge();
		this.CurrentAge = aRIPolRecordSchema.getCurrentAge();
		this.IDType = aRIPolRecordSchema.getIDType();
		this.IDNo = aRIPolRecordSchema.getIDNo();
		this.OccupationType = aRIPolRecordSchema.getOccupationType();
		this.HealthTime1 = aRIPolRecordSchema.getHealthTime1();
		this.HealthTime2 = aRIPolRecordSchema.getHealthTime2();
		this.OccupationCode = aRIPolRecordSchema.getOccupationCode();
		this.SuppRiskScore = aRIPolRecordSchema.getSuppRiskScore();
		this.SmokeFlag = aRIPolRecordSchema.getSmokeFlag();
		this.AdditionalRate = aRIPolRecordSchema.getAdditionalRate();
		this.ExtType = aRIPolRecordSchema.getExtType();
		this.ExtPrem = aRIPolRecordSchema.getExtPrem();
		this.BegAccountValue = aRIPolRecordSchema.getBegAccountValue();
		this.EndUnit = aRIPolRecordSchema.getEndUnit();
		this.EndPrice = aRIPolRecordSchema.getEndPrice();
		this.EndAccountValue = aRIPolRecordSchema.getEndAccountValue();
		this.FeeType = aRIPolRecordSchema.getFeeType();
		this.FeeMoney = aRIPolRecordSchema.getFeeMoney();
		this.NonCashFlag = aRIPolRecordSchema.getNonCashFlag();
		this.StandPrem = aRIPolRecordSchema.getStandPrem();
		this.Prem = aRIPolRecordSchema.getPrem();
		this.Amnt = aRIPolRecordSchema.getAmnt();
		this.Mult = aRIPolRecordSchema.getMult();
		this.Reserve = aRIPolRecordSchema.getReserve();
		this.APE = aRIPolRecordSchema.getAPE();
		this.CSV = aRIPolRecordSchema.getCSV();
		this.Retention = aRIPolRecordSchema.getRetention();
		this.Suminsured = aRIPolRecordSchema.getSuminsured();
		this.Faceamount = aRIPolRecordSchema.getFaceamount();
		this.Currency = aRIPolRecordSchema.getCurrency();
		this.RiskAmnt = aRIPolRecordSchema.getRiskAmnt();
		this.PayIntv = aRIPolRecordSchema.getPayIntv();
		this.PayYears = aRIPolRecordSchema.getPayYears();
		this.PayEndYearFlag = aRIPolRecordSchema.getPayEndYearFlag();
		this.PayEndYear = aRIPolRecordSchema.getPayEndYear();
		this.GetYearFlag = aRIPolRecordSchema.getGetYearFlag();
		this.GetYear = aRIPolRecordSchema.getGetYear();
		this.InsuYearFlag = aRIPolRecordSchema.getInsuYearFlag();
		this.InsuYear = aRIPolRecordSchema.getInsuYear();
		this.AcciYearFlag = aRIPolRecordSchema.getAcciYearFlag();
		this.AcciYear = aRIPolRecordSchema.getAcciYear();
		this.AcciEndDate = fDate.getDate( aRIPolRecordSchema.getAcciEndDate());
		this.GetStartDate = fDate.getDate( aRIPolRecordSchema.getGetStartDate());
		this.GetStartType = aRIPolRecordSchema.getGetStartType();
		this.PeakLine = aRIPolRecordSchema.getPeakLine();
		this.GetLimit = aRIPolRecordSchema.getGetLimit();
		this.GetIntv = aRIPolRecordSchema.getGetIntv();
		this.PayNo = aRIPolRecordSchema.getPayNo();
		this.PayCount = aRIPolRecordSchema.getPayCount();
		this.PayMoney = aRIPolRecordSchema.getPayMoney();
		this.LastPayToDate = fDate.getDate( aRIPolRecordSchema.getLastPayToDate());
		this.CurPayToDate = fDate.getDate( aRIPolRecordSchema.getCurPayToDate());
		this.EdorNo = aRIPolRecordSchema.getEdorNo();
		this.FeeOperationType = aRIPolRecordSchema.getFeeOperationType();
		this.FeeFinaType = aRIPolRecordSchema.getFeeFinaType();
		this.ChangeRate = aRIPolRecordSchema.getChangeRate();
		this.AccCurrency = aRIPolRecordSchema.getAccCurrency();
		this.AccAmnt = aRIPolRecordSchema.getAccAmnt();
		this.PreStandPrem = aRIPolRecordSchema.getPreStandPrem();
		this.PrePrem = aRIPolRecordSchema.getPrePrem();
		this.PreRiskAmnt = aRIPolRecordSchema.getPreRiskAmnt();
		this.PreAmnt = aRIPolRecordSchema.getPreAmnt();
		this.ClmNo = aRIPolRecordSchema.getClmNo();
		this.ClmFeeOperationType = aRIPolRecordSchema.getClmFeeOperationType();
		this.ClmFeeFinaType = aRIPolRecordSchema.getClmFeeFinaType();
		this.StandGetMoney = aRIPolRecordSchema.getStandGetMoney();
		this.GetRate = aRIPolRecordSchema.getGetRate();
		this.ClmGetMoney = aRIPolRecordSchema.getClmGetMoney();
		this.AccDate = fDate.getDate( aRIPolRecordSchema.getAccDate());
		this.AccumulateDefNO = aRIPolRecordSchema.getAccumulateDefNO();
		this.RIContNo = aRIPolRecordSchema.getRIContNo();
		this.RIPreceptNo = aRIPolRecordSchema.getRIPreceptNo();
		this.ReinsreFlag = aRIPolRecordSchema.getReinsreFlag();
		this.GetDate = fDate.getDate( aRIPolRecordSchema.getGetDate());
		this.StandbyString1 = aRIPolRecordSchema.getStandbyString1();
		this.StandbyString2 = aRIPolRecordSchema.getStandbyString2();
		this.StandbyString3 = aRIPolRecordSchema.getStandbyString3();
		this.StandbyDouble1 = aRIPolRecordSchema.getStandbyDouble1();
		this.StandbyDouble2 = aRIPolRecordSchema.getStandbyDouble2();
		this.StandbyDouble3 = aRIPolRecordSchema.getStandbyDouble3();
		this.StandbyDate1 = fDate.getDate( aRIPolRecordSchema.getStandbyDate1());
		this.StandbyDate2 = fDate.getDate( aRIPolRecordSchema.getStandbyDate2());
		this.ManageCom = aRIPolRecordSchema.getManageCom();
		this.MakeDate = fDate.getDate( aRIPolRecordSchema.getMakeDate());
		this.MakeTime = aRIPolRecordSchema.getMakeTime();
		this.PreChRiskAmnt = aRIPolRecordSchema.getPreChRiskAmnt();
		this.ChRiskAmnt = aRIPolRecordSchema.getChRiskAmnt();
		this.PreChangeRate = aRIPolRecordSchema.getPreChangeRate();
		this.MainPolNo = aRIPolRecordSchema.getMainPolNo();
		this.RIPreceptType = aRIPolRecordSchema.getRIPreceptType();
		this.BFFlag = aRIPolRecordSchema.getBFFlag();
		this.EdorPrem = aRIPolRecordSchema.getEdorPrem();
		this.ChEdorPrem = aRIPolRecordSchema.getChEdorPrem();
		this.ChPrem = aRIPolRecordSchema.getChPrem();
		this.Bonus1 = aRIPolRecordSchema.getBonus1();
		this.Bonus2 = aRIPolRecordSchema.getBonus2();
		this.Bonus3 = aRIPolRecordSchema.getBonus3();
		this.ExtRate1 = aRIPolRecordSchema.getExtRate1();
		this.ExtRate2 = aRIPolRecordSchema.getExtRate2();
		this.ExtRate3 = aRIPolRecordSchema.getExtRate3();
		this.ExtPrem1 = aRIPolRecordSchema.getExtPrem1();
		this.ExtPrem2 = aRIPolRecordSchema.getExtPrem2();
		this.ExtPrem3 = aRIPolRecordSchema.getExtPrem3();
		this.StandbyString4 = aRIPolRecordSchema.getStandbyString4();
		this.StandbyString5 = aRIPolRecordSchema.getStandbyString5();
		this.StandbyString6 = aRIPolRecordSchema.getStandbyString6();
		this.StandbyString7 = aRIPolRecordSchema.getStandbyString7();
		this.StandbyString8 = aRIPolRecordSchema.getStandbyString8();
		this.StandbyString9 = aRIPolRecordSchema.getStandbyString9();
		this.StandbyDouble4 = aRIPolRecordSchema.getStandbyDouble4();
		this.StandbyDouble5 = aRIPolRecordSchema.getStandbyDouble5();
		this.StandbyDouble6 = aRIPolRecordSchema.getStandbyDouble6();
		this.StandbyDouble7 = aRIPolRecordSchema.getStandbyDouble7();
		this.StandbyDouble8 = aRIPolRecordSchema.getStandbyDouble8();
		this.StandbyDouble9 = aRIPolRecordSchema.getStandbyDouble9();
		this.StandbyDate3 = fDate.getDate( aRIPolRecordSchema.getStandbyDate3());
		this.StandbyDate4 = fDate.getDate( aRIPolRecordSchema.getStandbyDate4());
		this.StandbyDate5 = fDate.getDate( aRIPolRecordSchema.getStandbyDate5());
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			System.out.println("数据库中的RIPolRecord表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			sqle.printStackTrace();
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "RIPolRecordSchema";
	...
	public RIPolRecordSchema getSchema()
	{
		RIPolRecordSchema aRIPolRecordSchema = new RIPolRecordSchema();
		aRIPolRecordSchema.setSchema(this);
		return aRIPolRecordSchema;
	}

	public RIPolRecordDB getDB()
	{
		RIPolRecordDB aDBOper = new RIPolRecordDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpRIPolRecord描述/A>表字段
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpRIPolRecord>历史记账凭证主表信息</A>表字段
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		RIPolRecordSchema other = (RIPolRecordSchema)otherObject;
		return
