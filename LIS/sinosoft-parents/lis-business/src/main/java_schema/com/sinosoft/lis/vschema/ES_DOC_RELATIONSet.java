...
{
private static Logger logger = Logger.getLogger(ES_DOC_RELATIONSet.class);
	...
	{
		ES_DOC_RELATIONSchema tSchema = (ES_DOC_RELATIONSchema)super.getObj(index);
		return tSchema;
	}
	...
	**/
	public String encode()
	{
		...
		for (int i = 1; i <= n; i++)
		{
			ES_DOC_RELATIONSchema aSchema = this.get(i);
