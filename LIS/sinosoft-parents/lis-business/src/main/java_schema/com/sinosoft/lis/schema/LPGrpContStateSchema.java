...
/*
 * <p>ClassName: LPGrpContStateSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 保全核心
 */
public class LPGrpContStateSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LPGrpContStateSchema.class);
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LPGrpContStateSchema cloned = (LPGrpContStateSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LPGrpContStateSchema 对象给 Schema 赋值
	* @param: aLPGrpContStateSchema LPGrpContStateSchema
	**/
	public void setSchema(LPGrpContStateSchema aLPGrpContStateSchema)
	{
		this.EdorNo = aLPGrpContStateSchema.getEdorNo();
		this.EdorType = aLPGrpContStateSchema.getEdorType();
		this.GrpContNo = aLPGrpContStateSchema.getGrpContNo();
		this.GrpPolNo = aLPGrpContStateSchema.getGrpPolNo();
		this.StateType = aLPGrpContStateSchema.getStateType();
		this.State = aLPGrpContStateSchema.getState();
		this.StateReason = aLPGrpContStateSchema.getStateReason();
		this.StartDate = fDate.getDate( aLPGrpContStateSchema.getStartDate());
		this.EndDate = fDate.getDate( aLPGrpContStateSchema.getEndDate());
		this.Remark = aLPGrpContStateSchema.getRemark();
		this.Operator = aLPGrpContStateSchema.getOperator();
		this.MakeDate = fDate.getDate( aLPGrpContStateSchema.getMakeDate());
		this.MakeTime = aLPGrpContStateSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLPGrpContStateSchema.getModifyDate());
		this.ModifyTime = aLPGrpContStateSchema.getModifyTime();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LPGrpContState表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LPGrpContStateSchema";
	...
	public LPGrpContStateSchema getSchema()
	{
		LPGrpContStateSchema aLPGrpContStateSchema = new LPGrpContStateSchema();
		aLPGrpContStateSchema.setSchema(this);
		return aLPGrpContStateSchema;
	}

	public LPGrpContStateDB getDB()
	{
		LPGrpContStateDB aDBOper = new LPGrpContStateDB();
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLPGrpContState>历史记账凭证主表信息</A>表字段
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LPGrpContStateSchema other = (LPGrpContStateSchema)otherObject;
		return
