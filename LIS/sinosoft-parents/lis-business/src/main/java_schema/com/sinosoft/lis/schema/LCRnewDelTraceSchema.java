...
import com.sinosoft.lis.db.LCRnewDelTraceDB;

/*
 * <p>ClassName: LCRnewDelTraceSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 保费续期及中介
 */
public class LCRnewDelTraceSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LCRnewDelTraceSchema.class);
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LCRnewDelTraceSchema cloned = (LCRnewDelTraceSchema)super.clone();
	...
	*/
	...
	public void setDelType(String aDelType)
	{
		DelType = aDelType;
	}
	...
	/**
	* 使用另外一个 LCRnewDelTraceSchema 对象给 Schema 赋值
	* @param: aLCRnewDelTraceSchema LCRnewDelTraceSchema
	**/
	public void setSchema(LCRnewDelTraceSchema aLCRnewDelTraceSchema)
	{
		this.SerialNo = aLCRnewDelTraceSchema.getSerialNo();
		this.DelType = aLCRnewDelTraceSchema.getDelType();
		this.PrtNo = aLCRnewDelTraceSchema.getPrtNo();
		this.ContNo = aLCRnewDelTraceSchema.getContNo();
		this.ManageCom = aLCRnewDelTraceSchema.getManageCom();
		this.OldOperator = aLCRnewDelTraceSchema.getOldOperator();
		this.OldMakeDate = fDate.getDate( aLCRnewDelTraceSchema.getOldMakeDate());
		this.OldMakeTime = aLCRnewDelTraceSchema.getOldMakeTime();
		this.MakeDate = fDate.getDate( aLCRnewDelTraceSchema.getMakeDate());
		this.MakeTime = aLCRnewDelTraceSchema.getMakeTime();
		this.Remark = aLCRnewDelTraceSchema.getRemark();
		this.Operator = aLCRnewDelTraceSchema.getOperator();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		try
		{
			...
			if( rs.getString("DelType") == null )
				this.DelType = null;
			else
				this.DelType = rs.getString("DelType").trim();
		...
		{
			logger.debug("数据库中的LCRnewDelTrace表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LCRnewDelTraceSchema";
	...
	public LCRnewDelTraceSchema getSchema()
	{
		LCRnewDelTraceSchema aLCRnewDelTraceSchema = new LCRnewDelTraceSchema();
		aLCRnewDelTraceSchema.setSchema(this);
		return aLCRnewDelTraceSchema;
	}

	public LCRnewDelTraceDB getDB()
	{
		LCRnewDelTraceDB aDBOper = new LCRnewDelTraceDB();
	...
	**/
	public String encode()
	{
		...
		strReturn.append(StrTool.cTrim(DelType)); strReturn.append(SysConst.PACKAGESPILTER);
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLCRnewDelTrace>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			DelType = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 2, SysConst.PACKAGESPILTER );
	...
	**/
	public String getV(String FCode)
	{
		...
		if (FCode.equalsIgnoreCase("DelType"))
		{
			strReturn = StrTool.GBKToUnicode(String.valueOf(DelType));
		}
	...
	public String getV(int nFieldIndex)
	{
		...
		switch(nFieldIndex) {
			case 0:
				...
				break;
			case 1:
				strFieldValue = StrTool.GBKToUnicode(DelType);
				break;
			case 2:
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LCRnewDelTraceSchema other = (LCRnewDelTraceSchema)otherObject;
		return
			SerialNo.equals(other.getSerialNo())
			&& DelType.equals(other.getDelType())
	...
	**/
	public int getFieldIndex(String strFieldName)
	{
		...
		if( strFieldName.equals("DelType") ) {
			return 1;
		}
