...
/*
 * <p>ClassName: LBTempFeeDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 寿险业务收费
 */
public class LBTempFeeDBSet extends LBTempFeeSet
{
	// @Field
	...
	**/
	...
	// @Constructor
	public LBTempFeeDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LBTempFeeDBSet";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getBackUpSerialNo() == null || this.get(i).getBackUpSerialNo().equals("null")) {
				...
				pstmt.setString(40, this.get(i).getBackUpSerialNo());
			}
			if(this.get(i).getBackUpReason() == null || this.get(i).getBackUpReason().equals("null")) {
				pstmt.setString(41,null);
			} else {
				pstmt.setString(41, this.get(i).getBackUpReason());
			}
			// set where condition
			if(this.get(i).getTempFeeNo() == null || this.get(i).getTempFeeNo().equals("null")) {
				pstmt.setString(42,null);
			} else {
				pstmt.setString(42, this.get(i).getTempFeeNo());
			}
			if(this.get(i).getTempFeeType() == null || this.get(i).getTempFeeType().equals("null")) {
				pstmt.setString(43,null);
			} else {
				pstmt.setString(43, StrTool.space1(this.get(i).getTempFeeType(), 2));
			}
			if(this.get(i).getRiskCode() == null || this.get(i).getRiskCode().equals("null")) {
			...
			if(this.get(i).getBackUpSerialNo() == null || this.get(i).getBackUpSerialNo().equals("null")) {
				...
				pstmt.setString(45, this.get(i).getBackUpSerialNo());
			}
