...
/*
 * <p>ClassName: LCGrpAddressDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 承保核心
 */
public class LCGrpAddressDBSet extends LCGrpAddressSet
{
private static Logger logger = Logger.getLogger(LCGrpAddressDBSet.class);
	...
	**/
	...
	// @Constructor
	public LCGrpAddressDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LCGrpAddressDBSet";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getAddressNo() == null || this.get(i).getAddressNo().equals("null")) {
				...
				pstmt.setString(25, this.get(i).getAddressNo());
			}
