...
import com.sinosoft.lis.db.PD_TestPointClew_LibDB;

/**
 * <p>ClassName: PD_TestPointClew_LibSchema </p>
 ...
 */
public class PD_TestPointClew_LibSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(PD_TestPointClew_LibSchema.class);
    ...
    // @Constructor
    public PD_TestPointClew_LibSchema()
    {
        mErrors = new CErrors();
    ...
    {
        PD_TestPointClew_LibSchema cloned = (PD_TestPointClew_LibSchema)super.clone();
    ...
    /**
     * 使用另外一个 PD_TestPointClew_LibSchema 对象给 Schema 赋值
     * @param: aPD_TestPointClew_LibSchema PD_TestPointClew_LibSchema
     **/
    public void setSchema(PD_TestPointClew_LibSchema aPD_TestPointClew_LibSchema)
    {
        this.TableCode = aPD_TestPointClew_LibSchema.getTableCode();
        this.FieldCode = aPD_TestPointClew_LibSchema.getFieldCode();
        this.Id = aPD_TestPointClew_LibSchema.getId();
        this.ClewContent = aPD_TestPointClew_LibSchema.getClewContent();
        this.Operator = aPD_TestPointClew_LibSchema.getOperator();
        this.MakeDate = fDate.getDate(aPD_TestPointClew_LibSchema.getMakeDate());
        this.MakeTime = aPD_TestPointClew_LibSchema.getMakeTime();
        this.ModifyDate = fDate.getDate(aPD_TestPointClew_LibSchema.getModifyDate());
        this.ModifyTime = aPD_TestPointClew_LibSchema.getModifyTime();
        this.Standbyflag1 = aPD_TestPointClew_LibSchema.getStandbyflag1();
        this.Standbyflag2 = aPD_TestPointClew_LibSchema.getStandbyflag2();
        this.Standbyflag3 = aPD_TestPointClew_LibSchema.getStandbyflag3();
        this.Standbyflag4 = aPD_TestPointClew_LibSchema.getStandbyflag4();
        this.Standbyflag5 = aPD_TestPointClew_LibSchema.getStandbyflag5();
        this.Standbyflag6 = aPD_TestPointClew_LibSchema.getStandbyflag6();
    }
    ...
    public boolean setSchema(ResultSet rs, int i)
    {
        try
        {
            ...
            if (rs.getString(3) == null)
                ...
                this.Id = rs.getString(3).trim();
            if (rs.getString(4) == null)
                this.ClewContent = null;
            else
                this.ClewContent = rs.getString(4).trim();
        ...
        {
            logger.debug("数据库中表PD_TestPointClew_Lib字段个数和Schema中的字段个数不一致，或执行db.executeQuery查询时未使用select * from tables");
            // @@错误处理
            CError tError = new CError();
            tError.moduleName = "PD_TestPointClew_LibSchema";
    ...
    public PD_TestPointClew_LibSchema getSchema()
    {
        PD_TestPointClew_LibSchema aPD_TestPointClew_LibSchema = new PD_TestPointClew_LibSchema();
        aPD_TestPointClew_LibSchema.setSchema(this);
        return aPD_TestPointClew_LibSchema;
    }

    public PD_TestPointClew_LibDB getDB()
    {
        PD_TestPointClew_LibDB aDBOper = new PD_TestPointClew_LibDB();
    ...
    public String encode()
    {
        ...
        strReturn.append(SysConst.PACKAGESPILTER);
        strReturn.append(StrTool.cTrim(ClewContent));
        strReturn.append(SysConst.PACKAGESPILTER);
    ...
    /**
     * 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpPD_TestPointClew_Lib>历史记账凭证主表信息</A>表字段
    ...
    public boolean equals(Object otherObject)
    {
        ...
        if (getClass() != otherObject.getClass())
            return false;
        PD_TestPointClew_LibSchema other = (PD_TestPointClew_LibSchema) otherObject;
        return
                ...
                && (ClewContent == null ? other.getClewContent() == null : ClewContent.equals(other.getClewContent()))
