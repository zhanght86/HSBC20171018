...
/*
 * <p>ClassName: LLUWMasterDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 理赔管理
 */
public class LLUWMasterDBSet extends LLUWMasterSet
{
private static Logger logger = Logger.getLogger(LLUWMasterDBSet.class);
	...
	**/
	...
	// @Constructor
	public LLUWMasterDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LLUWMasterDBSet";
