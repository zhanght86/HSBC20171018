...
/*
 * <p>ClassName: LDTaskMsgItemDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 任务提醒内容映射表
 */
public class LDTaskMsgItemDBSet extends LDTaskMsgItemSet
{
private static Logger logger = Logger.getLogger(LDTaskMsgItemDBSet.class);
	...
	**/
	...
	// @Constructor
	public LDTaskMsgItemDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LDTaskMsgItemDBSet";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getTaskCode() == null || this.get(i).getTaskCode().equals("null")) {
				...
				pstmt.setString(6, this.get(i).getTaskCode());
			}
			if(this.get(i).getTaskPlanCode() == null || this.get(i).getTaskPlanCode().equals("null")) {
				pstmt.setString(7,null);
			} else {
				pstmt.setString(7, this.get(i).getTaskPlanCode());
			}
			if(this.get(i).getSubjectID() == null || this.get(i).getSubjectID().equals("null")) {
				pstmt.setString(8,null);
			} else {
				pstmt.setString(8, this.get(i).getSubjectID());
			}
			if(this.get(i).getItemID() == null || this.get(i).getItemID().equals("null")) {
				pstmt.setString(9,null);
			} else {
				pstmt.setString(9, this.get(i).getItemID());
			}
			if(this.get(i).getMsgType() == null || this.get(i).getMsgType().equals("null")) {
				pstmt.setString(10,null);
			} else {
				pstmt.setString(10, this.get(i).getMsgType());
			}
