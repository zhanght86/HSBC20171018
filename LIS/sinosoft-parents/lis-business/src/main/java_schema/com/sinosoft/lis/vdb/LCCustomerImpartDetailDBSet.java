...
/*
 * <p>ClassName: LCCustomerImpartDetailDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 承保核心
 */
public class LCCustomerImpartDetailDBSet extends LCCustomerImpartDetailSet
{
private static Logger logger = Logger.getLogger(LCCustomerImpartDetailDBSet.class);
	...
	**/
	...
	// @Constructor
	public LCCustomerImpartDetailDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public LCCustomerImpartDetailDBSet()
	{
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LCCustomerImpartDetailDBSet";
...
ex.printStackTrace();
	...
	public boolean update()
	{
		...
		try
		{
			...
			pstmt.setInt(24, this.get(i).getPatchNo());
			// set where condition
			if(this.get(i).getGrpContNo() == null || this.get(i).getGrpContNo().equals("null")) {
			...
			if(this.get(i).getProposalContNo() == null || this.get(i).getProposalContNo().equals("null")) {
				...
				pstmt.setString(26, this.get(i).getProposalContNo());
			}
			if(this.get(i).getImpartCode() == null || this.get(i).getImpartCode().equals("null")) {
				pstmt.setString(27,null);
			} else {
				pstmt.setString(27, this.get(i).getImpartCode());
			}
			if(this.get(i).getImpartVer() == null || this.get(i).getImpartVer().equals("null")) {
				pstmt.setString(28,null);
			} else {
				pstmt.setString(28, this.get(i).getImpartVer());
			}
			if(this.get(i).getSubSerialNo() == null || this.get(i).getSubSerialNo().equals("null")) {
				pstmt.setString(29,null);
			} else {
				pstmt.setString(29, this.get(i).getSubSerialNo());
			}
			if(this.get(i).getCustomerNo() == null || this.get(i).getCustomerNo().equals("null")) {
			...
			if(this.get(i).getCustomerNoType() == null || this.get(i).getCustomerNoType().equals("null")) {
				...
				pstmt.setString(31, StrTool.space1(this.get(i).getCustomerNoType(), 1));
			}
