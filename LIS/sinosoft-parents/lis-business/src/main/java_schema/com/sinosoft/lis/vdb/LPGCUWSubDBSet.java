...
/*
 * <p>ClassName: LPGCUWSubDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 保全流程
 */
public class LPGCUWSubDBSet extends LPGCUWSubSet
{
private static Logger logger = Logger.getLogger(LPGCUWSubDBSet.class);
	...
	**/
	...
	// @Constructor
	public LPGCUWSubDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LPGCUWSubDBSet";
...
ex.printStackTrace();
	...
	public boolean update()
	{
		...
		try
		{
			...
			pstmt.setInt(41, this.get(i).getUWNo());
