...
/*
 * <p>ClassName: LLGrpClaimUserDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 理赔管理
 */
public class LLGrpClaimUserDBSet extends LLGrpClaimUserSet
{
private static Logger logger = Logger.getLogger(LLGrpClaimUserDBSet.class);
	...
	**/
	...
	// @Constructor
	public LLGrpClaimUserDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LLGrpClaimUserDBSet";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getUserCode() == null || this.get(i).getUserCode().equals("null")) {
				...
				pstmt.setString(37, this.get(i).getUserCode());
			}
