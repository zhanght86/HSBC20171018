...
/*
 * <p>ClassName: LCAppntGrpDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 寿险业务系统lis5模型
 */
public class LCAppntGrpDBSet extends LCAppntGrpSet
{
private static Logger logger = Logger.getLogger(LCAppntGrpDBSet.class);
	...
	**/
	...
	// @Constructor
	public LCAppntGrpDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LCAppntGrpDBSet";
	...
	public boolean delete()
	{
		...
		try
		{
			...
			if(this.get(i).getGrpNo() == null || this.get(i).getGrpNo().equals("null")) {
				...
				pstmt.setString(2, this.get(i).getGrpNo());
			}
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getRelationToInsured() == null || this.get(i).getRelationToInsured().equals("null")) {
				...
				pstmt.setString(3, this.get(i).getRelationToInsured());
			}
			...
			if(this.get(i).getGrpAddressCode() == null || this.get(i).getGrpAddressCode().equals("null")) {
				...
				pstmt.setString(7, this.get(i).getGrpAddressCode());
			}
			...
			if(this.get(i).getGetFlag() == null || this.get(i).getGetFlag().equals("null")) {
				...
				pstmt.setString(33, this.get(i).getGetFlag());
			}
			...
			if(this.get(i).getFoundDate() == null || this.get(i).getFoundDate().equals("null")) {
				...
				pstmt.setDate(36, Date.valueOf(this.get(i).getFoundDate()));
			}
			if(this.get(i).getBankAccNo() == null || this.get(i).getBankAccNo().equals("null")) {
				pstmt.setString(37,null);
			} else {
				pstmt.setString(37, this.get(i).getBankAccNo());
			}
			if(this.get(i).getBankCode() == null || this.get(i).getBankCode().equals("null")) {
				pstmt.setString(38,null);
			} else {
				pstmt.setString(38, this.get(i).getBankCode());
			}
			if(this.get(i).getGrpGroupNo() == null || this.get(i).getGrpGroupNo().equals("null")) {
				pstmt.setString(39,null);
			} else {
				pstmt.setString(39, this.get(i).getGrpGroupNo());
			}
			...
			if(this.get(i).getRemark() == null || this.get(i).getRemark().equals("null")) {
				...
				pstmt.setString(41, this.get(i).getRemark());
			}
			if(this.get(i).getBlacklistFlag() == null || this.get(i).getBlacklistFlag().equals("null")) {
				pstmt.setString(42,null);
			} else {
				pstmt.setString(42, this.get(i).getBlacklistFlag());
			}
			...
			if(this.get(i).getGrpNo() == null || this.get(i).getGrpNo().equals("null")) {
				...
				pstmt.setString(49, this.get(i).getGrpNo());
			}
