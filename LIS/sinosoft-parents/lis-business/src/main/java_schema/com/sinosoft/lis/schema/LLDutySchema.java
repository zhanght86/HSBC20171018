...
/*
 * <p>ClassName: LLDutySchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 理赔管理
 */
public class LLDutySchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LLDutySchema.class);
	// @Field
	/** 赔案号 */
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LLDutySchema cloned = (LLDutySchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LLDutySchema 对象给 Schema 赋值
	* @param: aLLDutySchema LLDutySchema
	**/
	public void setSchema(LLDutySchema aLLDutySchema)
	{
		this.ClmNo = aLLDutySchema.getClmNo();
		this.OperationType = aLLDutySchema.getOperationType();
		this.PolNo = aLLDutySchema.getPolNo();
		this.DutyCode = aLLDutySchema.getDutyCode();
		this.ContNo = aLLDutySchema.getContNo();
		this.Mult = aLLDutySchema.getMult();
		this.StandPrem = aLLDutySchema.getStandPrem();
		this.Prem = aLLDutySchema.getPrem();
		this.SumPrem = aLLDutySchema.getSumPrem();
		this.Amnt = aLLDutySchema.getAmnt();
		this.RiskAmnt = aLLDutySchema.getRiskAmnt();
		this.PayIntv = aLLDutySchema.getPayIntv();
		this.PayYears = aLLDutySchema.getPayYears();
		this.Years = aLLDutySchema.getYears();
		this.FloatRate = aLLDutySchema.getFloatRate();
		this.FirstPayDate = fDate.getDate( aLLDutySchema.getFirstPayDate());
		this.FirstMonth = aLLDutySchema.getFirstMonth();
		this.PaytoDate = fDate.getDate( aLLDutySchema.getPaytoDate());
		this.PayEndDate = fDate.getDate( aLLDutySchema.getPayEndDate());
		this.PayEndYearFlag = aLLDutySchema.getPayEndYearFlag();
		this.PayEndYear = aLLDutySchema.getPayEndYear();
		this.GetYearFlag = aLLDutySchema.getGetYearFlag();
		this.GetYear = aLLDutySchema.getGetYear();
		this.InsuYearFlag = aLLDutySchema.getInsuYearFlag();
		this.InsuYear = aLLDutySchema.getInsuYear();
		this.AcciYearFlag = aLLDutySchema.getAcciYearFlag();
		this.AcciYear = aLLDutySchema.getAcciYear();
		this.EndDate = fDate.getDate( aLLDutySchema.getEndDate());
		this.AcciEndDate = fDate.getDate( aLLDutySchema.getAcciEndDate());
		this.FreeFlag = aLLDutySchema.getFreeFlag();
		this.FreeRate = aLLDutySchema.getFreeRate();
		this.FreeStartDate = fDate.getDate( aLLDutySchema.getFreeStartDate());
		this.FreeEndDate = fDate.getDate( aLLDutySchema.getFreeEndDate());
		this.GetStartDate = fDate.getDate( aLLDutySchema.getGetStartDate());
		this.GetStartType = aLLDutySchema.getGetStartType();
		this.LiveGetMode = aLLDutySchema.getLiveGetMode();
		this.DeadGetMode = aLLDutySchema.getDeadGetMode();
		this.BonusGetMode = aLLDutySchema.getBonusGetMode();
		this.SSFlag = aLLDutySchema.getSSFlag();
		this.PeakLine = aLLDutySchema.getPeakLine();
		this.GetLimit = aLLDutySchema.getGetLimit();
		this.GetRate = aLLDutySchema.getGetRate();
		this.CalRule = aLLDutySchema.getCalRule();
		this.PremToAmnt = aLLDutySchema.getPremToAmnt();
		this.StandbyFlag1 = aLLDutySchema.getStandbyFlag1();
		this.StandbyFlag2 = aLLDutySchema.getStandbyFlag2();
		this.StandbyFlag3 = aLLDutySchema.getStandbyFlag3();
		this.Operator = aLLDutySchema.getOperator();
		this.MakeDate = fDate.getDate( aLLDutySchema.getMakeDate());
		this.MakeTime = aLLDutySchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLLDutySchema.getModifyDate());
		this.ModifyTime = aLLDutySchema.getModifyTime();
		this.CValiDate = fDate.getDate( aLLDutySchema.getCValiDate());
		this.GetIntv = aLLDutySchema.getGetIntv();
		this.Currency = aLLDutySchema.getCurrency();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LLDuty表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LLDutySchema";
	...
	public LLDutySchema getSchema()
	{
		LLDutySchema aLLDutySchema = new LLDutySchema();
		aLLDutySchema.setSchema(this);
		return aLLDutySchema;
	}

	public LLDutyDB getDB()
	{
		LLDutyDB aDBOper = new LLDutyDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLLDuty描述/A>表字段
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLLDuty>历史记账凭证主表信息</A>表字段
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LLDutySchema other = (LLDutySchema)otherObject;
		return
