...
/*
 * <p>ClassName: LCGrpRReportSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 承保流程
 */
public class LCGrpRReportSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LCGrpRReportSchema.class);
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LCGrpRReportSchema cloned = (LCGrpRReportSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LCGrpRReportSchema 对象给 Schema 赋值
	* @param: aLCGrpRReportSchema LCGrpRReportSchema
	**/
	public void setSchema(LCGrpRReportSchema aLCGrpRReportSchema)
	{
		this.GrpContNo = aLCGrpRReportSchema.getGrpContNo();
		this.PrtSeq = aLCGrpRReportSchema.getPrtSeq();
		this.PrintFlag = aLCGrpRReportSchema.getPrintFlag();
		this.ManageCom = aLCGrpRReportSchema.getManageCom();
		this.AgentName = aLCGrpRReportSchema.getAgentName();
		this.AgentCode = aLCGrpRReportSchema.getAgentCode();
		this.Operator = aLCGrpRReportSchema.getOperator();
		this.MakeDate = fDate.getDate( aLCGrpRReportSchema.getMakeDate());
		this.MakeTime = aLCGrpRReportSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLCGrpRReportSchema.getModifyDate());
		this.ModifyTime = aLCGrpRReportSchema.getModifyTime();
		this.Remark = aLCGrpRReportSchema.getRemark();
		this.RReportReason = aLCGrpRReportSchema.getRReportReason();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LCGrpRReport表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LCGrpRReportSchema";
	...
	public LCGrpRReportSchema getSchema()
	{
		LCGrpRReportSchema aLCGrpRReportSchema = new LCGrpRReportSchema();
		aLCGrpRReportSchema.setSchema(this);
		return aLCGrpRReportSchema;
	}

	public LCGrpRReportDB getDB()
	{
		LCGrpRReportDB aDBOper = new LCGrpRReportDB();
	...
	**/
	public String encode()
	{
		...
		strReturn.append(StrTool.cTrim(RReportReason));
		return strReturn.toString();
	}

	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLCGrpRReport>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			PrintFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 3, SysConst.PACKAGESPILTER );
			...
			RReportReason = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 13, SysConst.PACKAGESPILTER );
		}
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LCGrpRReportSchema other = (LCGrpRReportSchema)otherObject;
		return
