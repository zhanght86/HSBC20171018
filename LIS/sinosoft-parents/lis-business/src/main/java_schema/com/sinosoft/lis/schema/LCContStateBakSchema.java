...
import com.sinosoft.lis.db.LCContStateBakDB;

/*
 * <p>ClassName: LCContStateBakSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: PhysicalDataModel_1
 */
public class LCContStateBakSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LCContStateBakSchema.class);
	...
	*/
	...
	/**
	* 使用另外一个 LCContStateBakSchema 对象给 Schema 赋值
	* @param: aLCContStateBakSchema LCContStateBakSchema
	**/
	public void setSchema(LCContStateBakSchema aLCContStateBakSchema)
	{
		this.ContNo = aLCContStateBakSchema.getContNo();
		this.InsuredNo = aLCContStateBakSchema.getInsuredNo();
		this.PolNo = aLCContStateBakSchema.getPolNo();
		this.StateType = aLCContStateBakSchema.getStateType();
		this.State = aLCContStateBakSchema.getState();
		this.StateReason = aLCContStateBakSchema.getStateReason();
		this.StartDate = fDate.getDate( aLCContStateBakSchema.getStartDate());
		this.EndDate = fDate.getDate( aLCContStateBakSchema.getEndDate());
		this.Remark = aLCContStateBakSchema.getRemark();
		this.Operator = aLCContStateBakSchema.getOperator();
		this.MakeDate = fDate.getDate( aLCContStateBakSchema.getMakeDate());
		this.MakeTime = aLCContStateBakSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLCContStateBakSchema.getModifyDate());
		this.ModifyTime = aLCContStateBakSchema.getModifyTime();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LCContStateBak表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LCContStateBakSchema";
	...
	public LCContStateBakDB getDB()
	{
		LCContStateBakDB aDBOper = new LCContStateBakDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLCContStateBak描述/A>表字段
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLCContStateBak>历史记账凭证主表信息</A>表字段
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LCContStateBakSchema other = (LCContStateBakSchema)otherObject;
		return
