...
/*
 * <p>ClassName: LCUWReportSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: PhysicalDataModel_2
 */
public class LCUWReportSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LCUWReportSchema.class);
	// @Field
	/** 其他号码 */
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LCUWReportSchema cloned = (LCUWReportSchema)super.clone();
	...
	public void setOtherNoType(String aOtherNoType)
	{
		if(aOtherNoType!=null && aOtherNoType.length()>1)
			throw new IllegalArgumentException("其他号码类型OtherNoType值"+aOtherNoType+"的长度"+aOtherNoType.length()+"大于最大值1");
	...
	public void setReportCont(String aReportCont)
	{
		ReportCont = aReportCont;
	}
	...
	public void setUWOperator(String aUWOperator)
	{
		if(aUWOperator!=null && aUWOperator.length()>10)
			throw new IllegalArgumentException("核保员UWOperator值"+aUWOperator+"的长度"+aUWOperator.length()+"大于最大值10");
	...
	*/
	...
	{
		if(aOperatePos!=null && aOperatePos.length()>1)
			throw new IllegalArgumentException("操作位置OperatePos值"+aOperatePos+"的长度"+aOperatePos.length()+"大于最大值1");
		OperatePos = aOperatePos;
	}

	/**
	* 使用另外一个 LCUWReportSchema 对象给 Schema 赋值
	* @param: aLCUWReportSchema LCUWReportSchema
	**/
	public void setSchema(LCUWReportSchema aLCUWReportSchema)
	{
		this.OtherNo = aLCUWReportSchema.getOtherNo();
		this.OtherNoType = aLCUWReportSchema.getOtherNoType();
		this.ReportCont = aLCUWReportSchema.getReportCont();
		this.UWOperator = aLCUWReportSchema.getUWOperator();
		this.ManageCom = aLCUWReportSchema.getManageCom();
		this.MakeDate = fDate.getDate( aLCUWReportSchema.getMakeDate());
		this.MakeTime = aLCUWReportSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLCUWReportSchema.getModifyDate());
		this.ModifyTime = aLCUWReportSchema.getModifyTime();
		this.SerialNo = aLCUWReportSchema.getSerialNo();
		this.OperatePos = aLCUWReportSchema.getOperatePos();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		try
		{
			...
			if( rs.getString("ReportCont") == null )
				this.ReportCont = null;
			else
				this.ReportCont = rs.getString("ReportCont").trim();
		...
		{
			logger.debug("数据库中的LCUWReport表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LCUWReportSchema";
	...
	public LCUWReportSchema getSchema()
	{
		LCUWReportSchema aLCUWReportSchema = new LCUWReportSchema();
		aLCUWReportSchema.setSchema(this);
		return aLCUWReportSchema;
	}

	public LCUWReportDB getDB()
	{
		LCUWReportDB aDBOper = new LCUWReportDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLCUWReport描述/A>表字段
	...
	**/
	public String encode()
	{
		...
		strReturn.append(StrTool.cTrim(ReportCont)); strReturn.append(SysConst.PACKAGESPILTER);
		...
		strReturn.append(StrTool.cTrim(OperatePos));
		return strReturn.toString();
	}

	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLCUWReport>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			ReportCont = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 3, SysConst.PACKAGESPILTER );
			UWOperator = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 4, SysConst.PACKAGESPILTER );
	...
	**/
	public String getV(String FCode)
	{
		...
		if (FCode.equalsIgnoreCase("ReportCont"))
		{
			strReturn = StrTool.GBKToUnicode(String.valueOf(ReportCont));
		}
	...
	public String getV(int nFieldIndex)
	{
		...
		switch(nFieldIndex) {
			...
			case 1:
				...
				break;
			case 2:
				strFieldValue = StrTool.GBKToUnicode(ReportCont);
				break;
			case 3:
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LCUWReportSchema other = (LCUWReportSchema)otherObject;
		return
			OtherNo.equals(other.getOtherNo())
			&& OtherNoType.equals(other.getOtherNoType())
			&& ReportCont.equals(other.getReportCont())
	...
	**/
	public int getFieldIndex(String strFieldName)
	{
		...
		if( strFieldName.equals("ReportCont") ) {
			return 2;
		}
