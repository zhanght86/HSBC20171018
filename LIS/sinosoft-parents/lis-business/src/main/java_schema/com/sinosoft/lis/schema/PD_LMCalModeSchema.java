...
/*
 * <p>ClassName: PD_LMCalModeSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 产品定义平台_PDM
 */
public class PD_LMCalModeSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(PD_LMCalModeSchema.class);
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		PD_LMCalModeSchema cloned = (PD_LMCalModeSchema)super.clone();
	...
	*/
	...
	/**
	* A--计算责任给付(Amount)、 P--计算缴费(Premium)、 C--计算赔付(Claim)、 G--计算领取(Get) X--描述现金价值。 Z--单证描述 H 为计算体检额度算法类型 M 为查询投保单交费状态算法类型 S--查询保单状态算法 T--代理人佣金计算算法 U--个险核保规则 V--承保时CheckField中的描述 W--佣金计算的编码
	*/
	...
	/**
	* 使用另外一个 PD_LMCalModeSchema 对象给 Schema 赋值
	* @param: aPD_LMCalModeSchema PD_LMCalModeSchema
	**/
	public void setSchema(PD_LMCalModeSchema aPD_LMCalModeSchema)
	{
		this.CalCode = aPD_LMCalModeSchema.getCalCode();
		this.RiskCode = aPD_LMCalModeSchema.getRiskCode();
		this.Type = aPD_LMCalModeSchema.getType();
		this.CalSQL = aPD_LMCalModeSchema.getCalSQL();
		this.Remark = aPD_LMCalModeSchema.getRemark();
		this.Operator = aPD_LMCalModeSchema.getOperator();
		this.MakeDate = fDate.getDate( aPD_LMCalModeSchema.getMakeDate());
		this.MakeTime = aPD_LMCalModeSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aPD_LMCalModeSchema.getModifyDate());
		this.ModifyTime = aPD_LMCalModeSchema.getModifyTime();
		this.Standbyflag1 = aPD_LMCalModeSchema.getStandbyflag1();
		this.Standbyflag2 = aPD_LMCalModeSchema.getStandbyflag2();
		this.Standbyflag3 = aPD_LMCalModeSchema.getStandbyflag3();
		this.Standbyflag4 = aPD_LMCalModeSchema.getStandbyflag4();
		this.Standbyflag5 = aPD_LMCalModeSchema.getStandbyflag5();
		this.Standbyflag6 = aPD_LMCalModeSchema.getStandbyflag6();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的PD_LMCalMode表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "PD_LMCalModeSchema";
	...
	public PD_LMCalModeSchema getSchema()
	{
		PD_LMCalModeSchema aPD_LMCalModeSchema = new PD_LMCalModeSchema();
		aPD_LMCalModeSchema.setSchema(this);
		return aPD_LMCalModeSchema;
	}

	public PD_LMCalModeDB getDB()
	{
		PD_LMCalModeDB aDBOper = new PD_LMCalModeDB();
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpPD_LMCalMode>历史记账凭证主表信息</A>表字段
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		PD_LMCalModeSchema other = (PD_LMCalModeSchema)otherObject;
		return
