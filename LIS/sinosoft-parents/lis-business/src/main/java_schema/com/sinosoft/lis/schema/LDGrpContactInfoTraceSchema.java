...
import com.sinosoft.lis.db.LDGrpContactInfoTraceDB;

/*
 * <p>ClassName: LDGrpContactInfoTraceSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 客户管理
 */
public class LDGrpContactInfoTraceSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LDGrpContactInfoTraceSchema.class);
	// @Field
	/** 轨迹号 */
	...
	// @Constructor
	public LDGrpContactInfoTraceSchema()
	{
		mErrors = new CErrors();
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LDGrpContactInfoTraceSchema cloned = (LDGrpContactInfoTraceSchema)super.clone();
	...
	/**
	* 使用另外一个 LDGrpContactInfoTraceSchema 对象给 Schema 赋值
	* @param: aLDGrpContactInfoTraceSchema LDGrpContactInfoTraceSchema
	**/
	public void setSchema(LDGrpContactInfoTraceSchema aLDGrpContactInfoTraceSchema)
	{
		this.TraceID = aLDGrpContactInfoTraceSchema.getTraceID();
		this.CustomerNo = aLDGrpContactInfoTraceSchema.getCustomerNo();
		this.Province = aLDGrpContactInfoTraceSchema.getProvince();
		this.City = aLDGrpContactInfoTraceSchema.getCity();
		this.County = aLDGrpContactInfoTraceSchema.getCounty();
		this.Address = aLDGrpContactInfoTraceSchema.getAddress();
		this.ZipCode = aLDGrpContactInfoTraceSchema.getZipCode();
		this.LinkMan1 = aLDGrpContactInfoTraceSchema.getLinkMan1();
		this.Department1 = aLDGrpContactInfoTraceSchema.getDepartment1();
		this.HeadShip1 = aLDGrpContactInfoTraceSchema.getHeadShip1();
		this.MobilePhone1 = aLDGrpContactInfoTraceSchema.getMobilePhone1();
		this.Phone1 = aLDGrpContactInfoTraceSchema.getPhone1();
		this.Fax1 = aLDGrpContactInfoTraceSchema.getFax1();
		this.EMail1 = aLDGrpContactInfoTraceSchema.getEMail1();
		this.MakeOperator = aLDGrpContactInfoTraceSchema.getMakeOperator();
		this.MakeDate = fDate.getDate( aLDGrpContactInfoTraceSchema.getMakeDate());
		this.MakeTime = aLDGrpContactInfoTraceSchema.getMakeTime();
		this.ModifyOperator = aLDGrpContactInfoTraceSchema.getModifyOperator();
		this.ModifyDate = fDate.getDate( aLDGrpContactInfoTraceSchema.getModifyDate());
		this.ModifyTime = aLDGrpContactInfoTraceSchema.getModifyTime();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LDGrpContactInfoTrace表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LDGrpContactInfoTraceSchema";
	...
	public LDGrpContactInfoTraceSchema getSchema()
	{
		LDGrpContactInfoTraceSchema aLDGrpContactInfoTraceSchema = new LDGrpContactInfoTraceSchema();
		aLDGrpContactInfoTraceSchema.setSchema(this);
		return aLDGrpContactInfoTraceSchema;
	}

	public LDGrpContactInfoTraceDB getDB()
	{
		LDGrpContactInfoTraceDB aDBOper = new LDGrpContactInfoTraceDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLDGrpContactInfoTrace描述/A>表字段
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLDGrpContactInfoTrace>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			Province = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 3, SysConst.PACKAGESPILTER );
			City = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 4, SysConst.PACKAGESPILTER );
			County = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 5, SysConst.PACKAGESPILTER );
			...
			LinkMan1 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 8, SysConst.PACKAGESPILTER );
			Department1 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 9, SysConst.PACKAGESPILTER );
			HeadShip1 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 10, SysConst.PACKAGESPILTER );
			MobilePhone1 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 11, SysConst.PACKAGESPILTER );
			Phone1 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 12, SysConst.PACKAGESPILTER );
			Fax1 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 13, SysConst.PACKAGESPILTER );
			EMail1 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 14, SysConst.PACKAGESPILTER );
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LDGrpContactInfoTraceSchema other = (LDGrpContactInfoTraceSchema)otherObject;
		return
