...
import com.sinosoft.lis.db.LPRReportItemDB;

/*
 * <p>ClassName: LPRReportItemSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 保全流程
 */
public class LPRReportItemSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LPRReportItemSchema.class);
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LPRReportItemSchema cloned = (LPRReportItemSchema)super.clone();
	...
	/**
	* 使用另外一个 LPRReportItemSchema 对象给 Schema 赋值
	* @param: aLPRReportItemSchema LPRReportItemSchema
	**/
	public void setSchema(LPRReportItemSchema aLPRReportItemSchema)
	{
		this.EdorNo = aLPRReportItemSchema.getEdorNo();
		this.GrpContNo = aLPRReportItemSchema.getGrpContNo();
		this.ContNo = aLPRReportItemSchema.getContNo();
		this.ProposalContNo = aLPRReportItemSchema.getProposalContNo();
		this.PrtSeq = aLPRReportItemSchema.getPrtSeq();
		this.RReportItemCode = aLPRReportItemSchema.getRReportItemCode();
		this.RReportItemName = aLPRReportItemSchema.getRReportItemName();
		this.ModifyDate = fDate.getDate( aLPRReportItemSchema.getModifyDate());
		this.ModifyTime = aLPRReportItemSchema.getModifyTime();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LPRReportItem表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LPRReportItemSchema";
	...
	public LPRReportItemSchema getSchema()
	{
		LPRReportItemSchema aLPRReportItemSchema = new LPRReportItemSchema();
		aLPRReportItemSchema.setSchema(this);
		return aLPRReportItemSchema;
	}

	public LPRReportItemDB getDB()
	{
		LPRReportItemDB aDBOper = new LPRReportItemDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLPRReportItem描述/A>表字段
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLPRReportItem>历史记账凭证主表信息</A>表字段
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LPRReportItemSchema other = (LPRReportItemSchema)otherObject;
		return
