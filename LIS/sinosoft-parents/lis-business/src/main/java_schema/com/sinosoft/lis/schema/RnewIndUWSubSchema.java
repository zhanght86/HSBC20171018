...
/*
 * <p>ClassName: RnewIndUWSubSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 续期续保二核
 */
public class RnewIndUWSubSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(RnewIndUWSubSchema.class);
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		RnewIndUWSubSchema cloned = (RnewIndUWSubSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 RnewIndUWSubSchema 对象给 Schema 赋值
	* @param: aRnewIndUWSubSchema RnewIndUWSubSchema
	**/
	public void setSchema(RnewIndUWSubSchema aRnewIndUWSubSchema)
	{
		this.GrpContNo = aRnewIndUWSubSchema.getGrpContNo();
		this.ContNo = aRnewIndUWSubSchema.getContNo();
		this.ProposalContNo = aRnewIndUWSubSchema.getProposalContNo();
		this.UWNo = aRnewIndUWSubSchema.getUWNo();
		this.InsuredNo = aRnewIndUWSubSchema.getInsuredNo();
		this.InsuredName = aRnewIndUWSubSchema.getInsuredName();
		this.AppntNo = aRnewIndUWSubSchema.getAppntNo();
		this.AppntName = aRnewIndUWSubSchema.getAppntName();
		this.AgentCode = aRnewIndUWSubSchema.getAgentCode();
		this.AgentGroup = aRnewIndUWSubSchema.getAgentGroup();
		this.PassFlag = aRnewIndUWSubSchema.getPassFlag();
		this.UWGrade = aRnewIndUWSubSchema.getUWGrade();
		this.AppGrade = aRnewIndUWSubSchema.getAppGrade();
		this.PostponeDay = aRnewIndUWSubSchema.getPostponeDay();
		this.PostponeDate = fDate.getDate( aRnewIndUWSubSchema.getPostponeDate());
		this.AutoUWFlag = aRnewIndUWSubSchema.getAutoUWFlag();
		this.State = aRnewIndUWSubSchema.getState();
		this.ManageCom = aRnewIndUWSubSchema.getManageCom();
		this.UWIdea = aRnewIndUWSubSchema.getUWIdea();
		this.UpReportContent = aRnewIndUWSubSchema.getUpReportContent();
		this.Operator = aRnewIndUWSubSchema.getOperator();
		this.HealthFlag = aRnewIndUWSubSchema.getHealthFlag();
		this.QuesFlag = aRnewIndUWSubSchema.getQuesFlag();
		this.SpecFlag = aRnewIndUWSubSchema.getSpecFlag();
		this.AddPremFlag = aRnewIndUWSubSchema.getAddPremFlag();
		this.AddPremReason = aRnewIndUWSubSchema.getAddPremReason();
		this.ReportFlag = aRnewIndUWSubSchema.getReportFlag();
		this.PrintFlag = aRnewIndUWSubSchema.getPrintFlag();
		this.PrintFlag2 = aRnewIndUWSubSchema.getPrintFlag2();
		this.ChangePolFlag = aRnewIndUWSubSchema.getChangePolFlag();
		this.ChangePolReason = aRnewIndUWSubSchema.getChangePolReason();
		this.SpecReason = aRnewIndUWSubSchema.getSpecReason();
		this.MakeDate = fDate.getDate( aRnewIndUWSubSchema.getMakeDate());
		this.MakeTime = aRnewIndUWSubSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aRnewIndUWSubSchema.getModifyDate());
		this.ModifyTime = aRnewIndUWSubSchema.getModifyTime();
		this.SugPassFlag = aRnewIndUWSubSchema.getSugPassFlag();
		this.SugUWIdea = aRnewIndUWSubSchema.getSugUWIdea();
		this.UpReport = aRnewIndUWSubSchema.getUpReport();
		this.UWType = aRnewIndUWSubSchema.getUWType();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的RnewIndUWSub表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "RnewIndUWSubSchema";
	...
	public RnewIndUWSubSchema getSchema()
	{
		RnewIndUWSubSchema aRnewIndUWSubSchema = new RnewIndUWSubSchema();
		aRnewIndUWSubSchema.setSchema(this);
		return aRnewIndUWSubSchema;
	}

	public RnewIndUWSubDB getDB()
	{
		RnewIndUWSubDB aDBOper = new RnewIndUWSubDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpRnewIndUWSub描述/A>表字段
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpRnewIndUWSub>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			UWType = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 40, SysConst.PACKAGESPILTER );
		}
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		RnewIndUWSubSchema other = (RnewIndUWSubSchema)otherObject;
		return
