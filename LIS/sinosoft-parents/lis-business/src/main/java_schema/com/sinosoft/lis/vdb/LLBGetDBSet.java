...
/*
 * <p>ClassName: LLBGetDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 多币种改造业务表
 */
public class LLBGetDBSet extends LLBGetSet
{
private static Logger logger = Logger.getLogger(LLBGetDBSet.class);
	...
	**/
	...
	// @Constructor
	public LLBGetDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getBnfNo() == null || this.get(i).getBnfNo().equals("null")) {
				...
				pstmt.setString(4, this.get(i).getBnfNo());
			}
			...
			if(this.get(i).getGetDutyCode() == null || this.get(i).getGetDutyCode().equals("null")) {
				...
				pstmt.setString(15, this.get(i).getGetDutyCode());
			}
			...
			if(this.get(i).getGetMode() == null || this.get(i).getGetMode().equals("null")) {
				...
				pstmt.setString(18, this.get(i).getGetMode());
			}
			pstmt.setDouble(19, this.get(i).getGetLimit());
			pstmt.setDouble(20, this.get(i).getGetRate());
			if(this.get(i).getUrgeGetFlag() == null || this.get(i).getUrgeGetFlag().equals("null")) {
				pstmt.setString(21,null);
			} else {
				pstmt.setString(21, this.get(i).getUrgeGetFlag());
			}
			if(this.get(i).getLiveGetType() == null || this.get(i).getLiveGetType().equals("null")) {
				pstmt.setString(22,null);
			} else {
				pstmt.setString(22, this.get(i).getLiveGetType());
			}
			pstmt.setDouble(23, this.get(i).getAddRate());
			if(this.get(i).getCanGet() == null || this.get(i).getCanGet().equals("null")) {
				pstmt.setString(24,null);
			} else {
				pstmt.setString(24, this.get(i).getCanGet());
			}
			if(this.get(i).getNeedAcc() == null || this.get(i).getNeedAcc().equals("null")) {
				pstmt.setString(25,null);
			} else {
				pstmt.setString(25, this.get(i).getNeedAcc());
			}
			if(this.get(i).getNeedCancelAcc() == null || this.get(i).getNeedCancelAcc().equals("null")) {
				pstmt.setString(26,null);
			} else {
				pstmt.setString(26, this.get(i).getNeedCancelAcc());
			}
			pstmt.setDouble(27, this.get(i).getStandMoney());
			pstmt.setDouble(28, this.get(i).getActuGet());
			pstmt.setDouble(29, this.get(i).getSumMoney());
			pstmt.setInt(30, this.get(i).getGetIntv());
			if(this.get(i).getGettoDate() == null || this.get(i).getGettoDate().equals("null")) {
				pstmt.setDate(31,null);
			} else {
				pstmt.setDate(31, Date.valueOf(this.get(i).getGettoDate()));
			}
			...
			if(this.get(i).getGetEndDate() == null || this.get(i).getGetEndDate().equals("null")) {
				...
				pstmt.setDate(33, Date.valueOf(this.get(i).getGetEndDate()));
			}
			if(this.get(i).getBalaDate() == null || this.get(i).getBalaDate().equals("null")) {
				pstmt.setDate(34,null);
			} else {
				pstmt.setDate(34, Date.valueOf(this.get(i).getBalaDate()));
			}
			...
			if(this.get(i).getGetEndState() == null || this.get(i).getGetEndState().equals("null")) {
				...
				pstmt.setString(42, this.get(i).getGetEndState());
			}
			...
			if(this.get(i).getBackNo() == null || this.get(i).getBackNo().equals("null")) {
				...
				pstmt.setString(44, this.get(i).getBackNo());
			}
			if(this.get(i).getClmNo() == null || this.get(i).getClmNo().equals("null")) {
			...
			if(this.get(i).getOperationType() == null || this.get(i).getOperationType().equals("null")) {
				...
				pstmt.setString(46, this.get(i).getOperationType());
			}
			if(this.get(i).getPolNo() == null || this.get(i).getPolNo().equals("null")) {
			...
			if(this.get(i).getGetDutyCode() == null || this.get(i).getGetDutyCode().equals("null")) {
				...
				pstmt.setString(49, this.get(i).getGetDutyCode());
			}
