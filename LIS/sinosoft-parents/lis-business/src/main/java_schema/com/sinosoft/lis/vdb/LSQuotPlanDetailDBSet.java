...
/*
 * <p>ClassName: LSQuotPlanDetailDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: Physical Data Model 1
 */
public class LSQuotPlanDetailDBSet extends LSQuotPlanDetailSet
{
	// @Field
	...
	**/
	...
	// @Constructor
	public LSQuotPlanDetailDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LSQuotPlanDetailDBSet";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getQuotNo() == null || this.get(i).getQuotNo().equals("null")) {
				...
				pstmt.setString(31, this.get(i).getQuotNo());
			}
			pstmt.setInt(32, this.get(i).getQuotBatNo());
			if(this.get(i).getSysPlanCode() == null || this.get(i).getSysPlanCode().equals("null")) {
				pstmt.setString(33,null);
			} else {
				pstmt.setString(33, this.get(i).getSysPlanCode());
			}
			if(this.get(i).getPlanCode() == null || this.get(i).getPlanCode().equals("null")) {
				pstmt.setString(34,null);
			} else {
				pstmt.setString(34, this.get(i).getPlanCode());
			}
			if(this.get(i).getRiskCode() == null || this.get(i).getRiskCode().equals("null")) {
