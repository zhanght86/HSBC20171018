...
/*
 * <p>ClassName: LCGetToAccDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 承保核心
 */
public class LCGetToAccDBSet extends LCGetToAccSet
{
private static Logger logger = Logger.getLogger(LCGetToAccDBSet.class);
	...
	**/
	...
	// @Constructor
	public LCGetToAccDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LCGetToAccDBSet";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getGetDutyCode() == null || this.get(i).getGetDutyCode().equals("null")) {
				...
				pstmt.setString(17, this.get(i).getGetDutyCode());
			}
			if(this.get(i).getInsuAccNo() == null || this.get(i).getInsuAccNo().equals("null")) {
