 ...
 * @Database: 承保流程
 */
public class LCIndUWErrorSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LCIndUWErrorSchema.class);
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LCIndUWErrorSchema cloned = (LCIndUWErrorSchema)super.clone();
	...
	* @param: aLCIndUWErrorSchema LCIndUWErrorSchema
	**/
	public void setSchema(LCIndUWErrorSchema aLCIndUWErrorSchema)
	{
		...
		this.UWType = aLCIndUWErrorSchema.getUWType();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LCIndUWError表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
