 ...
 * @Database: 寿险业务付费
 */
public class LJAGetDrawSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LJAGetDrawSchema.class);
	// @Field
	/** 实付号码 */
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LJAGetDrawSchema cloned = (LJAGetDrawSchema)super.clone();
	...
	* @param: aLJAGetDrawSchema LJAGetDrawSchema
	**/
	public void setSchema(LJAGetDrawSchema aLJAGetDrawSchema)
	{
		...
		this.RReportFlag = aLJAGetDrawSchema.getRReportFlag();
		this.ComeFlag = aLJAGetDrawSchema.getComeFlag();
		this.Currency = aLJAGetDrawSchema.getCurrency();
		this.NetAmount = aLJAGetDrawSchema.getNetAmount();
		this.TaxAmount = aLJAGetDrawSchema.getTaxAmount();
		this.Tax = aLJAGetDrawSchema.getTax();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LJAGetDraw表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			GetmFirstFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 29, SysConst.PACKAGESPILTER );
			...
			GetNoticeNo = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 40, SysConst.PACKAGESPILTER );
			...
			NetAmount = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,46,SysConst.PACKAGESPILTER))).doubleValue();
			TaxAmount = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,47,SysConst.PACKAGESPILTER))).doubleValue();
			Tax = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,48,SysConst.PACKAGESPILTER))).doubleValue();
		}
