...
/*
 * <p>ClassName: RnewIndUWMasterSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 续期续保二核
 */
public class RnewIndUWMasterSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(RnewIndUWMasterSchema.class);
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		RnewIndUWMasterSchema cloned = (RnewIndUWMasterSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 RnewIndUWMasterSchema 对象给 Schema 赋值
	* @param: aRnewIndUWMasterSchema RnewIndUWMasterSchema
	**/
	public void setSchema(RnewIndUWMasterSchema aRnewIndUWMasterSchema)
	{
		this.GrpContNo = aRnewIndUWMasterSchema.getGrpContNo();
		this.ContNo = aRnewIndUWMasterSchema.getContNo();
		this.ProposalContNo = aRnewIndUWMasterSchema.getProposalContNo();
		this.UWNo = aRnewIndUWMasterSchema.getUWNo();
		this.InsuredNo = aRnewIndUWMasterSchema.getInsuredNo();
		this.InsuredName = aRnewIndUWMasterSchema.getInsuredName();
		this.AppntNo = aRnewIndUWMasterSchema.getAppntNo();
		this.AppntName = aRnewIndUWMasterSchema.getAppntName();
		this.AgentCode = aRnewIndUWMasterSchema.getAgentCode();
		this.AgentGroup = aRnewIndUWMasterSchema.getAgentGroup();
		this.PassFlag = aRnewIndUWMasterSchema.getPassFlag();
		this.UWGrade = aRnewIndUWMasterSchema.getUWGrade();
		this.AppGrade = aRnewIndUWMasterSchema.getAppGrade();
		this.PostponeDay = aRnewIndUWMasterSchema.getPostponeDay();
		this.PostponeDate = fDate.getDate( aRnewIndUWMasterSchema.getPostponeDate());
		this.AutoUWFlag = aRnewIndUWMasterSchema.getAutoUWFlag();
		this.State = aRnewIndUWMasterSchema.getState();
		this.ManageCom = aRnewIndUWMasterSchema.getManageCom();
		this.UWIdea = aRnewIndUWMasterSchema.getUWIdea();
		this.UpReportContent = aRnewIndUWMasterSchema.getUpReportContent();
		this.Operator = aRnewIndUWMasterSchema.getOperator();
		this.HealthFlag = aRnewIndUWMasterSchema.getHealthFlag();
		this.QuesFlag = aRnewIndUWMasterSchema.getQuesFlag();
		this.SpecFlag = aRnewIndUWMasterSchema.getSpecFlag();
		this.AddPremFlag = aRnewIndUWMasterSchema.getAddPremFlag();
		this.AddPremReason = aRnewIndUWMasterSchema.getAddPremReason();
		this.ReportFlag = aRnewIndUWMasterSchema.getReportFlag();
		this.PrintFlag = aRnewIndUWMasterSchema.getPrintFlag();
		this.PrintFlag2 = aRnewIndUWMasterSchema.getPrintFlag2();
		this.ChangePolFlag = aRnewIndUWMasterSchema.getChangePolFlag();
		this.ChangePolReason = aRnewIndUWMasterSchema.getChangePolReason();
		this.SpecReason = aRnewIndUWMasterSchema.getSpecReason();
		this.MakeDate = fDate.getDate( aRnewIndUWMasterSchema.getMakeDate());
		this.MakeTime = aRnewIndUWMasterSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aRnewIndUWMasterSchema.getModifyDate());
		this.ModifyTime = aRnewIndUWMasterSchema.getModifyTime();
		this.SugPassFlag = aRnewIndUWMasterSchema.getSugPassFlag();
		this.SugUWIdea = aRnewIndUWMasterSchema.getSugUWIdea();
		this.UpReport = aRnewIndUWMasterSchema.getUpReport();
		this.BatchNo = aRnewIndUWMasterSchema.getBatchNo();
		this.UWType = aRnewIndUWMasterSchema.getUWType();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的RnewIndUWMaster表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "RnewIndUWMasterSchema";
	...
	public RnewIndUWMasterSchema getSchema()
	{
		RnewIndUWMasterSchema aRnewIndUWMasterSchema = new RnewIndUWMasterSchema();
		aRnewIndUWMasterSchema.setSchema(this);
		return aRnewIndUWMasterSchema;
	}

	public RnewIndUWMasterDB getDB()
	{
		RnewIndUWMasterDB aDBOper = new RnewIndUWMasterDB();
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpRnewIndUWMaster>历史记账凭证主表信息</A>表字段
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		RnewIndUWMasterSchema other = (RnewIndUWMasterSchema)otherObject;
		return
