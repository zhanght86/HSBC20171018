...
import com.sinosoft.lis.db.LSQuotEngineeringTraceDB;

/*
 * <p>ClassName: LSQuotEngineeringTraceSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: Physical Data Model 1
 */
public class LSQuotEngineeringTraceSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LSQuotEngineeringTraceSchema.class);
	// @Field
	/** 流水号 */
	...
	/** 最低工程面积 */
	private double MinEnginArea;
	/** 最低工程造价 */
	private double MinEnginCost;
	...
	// @Constructor
	public LSQuotEngineeringTraceSchema()
	{
		mErrors = new CErrors();
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LSQuotEngineeringTraceSchema cloned = (LSQuotEngineeringTraceSchema)super.clone();
	...
	*/
	...
	public double getMinEnginArea()
	{
		return MinEnginArea;
	}
	public void setMinEnginArea(double aMinEnginArea)
	{
		MinEnginArea = aMinEnginArea;
	}
	public void setMinEnginArea(String aMinEnginArea)
	{
		if (aMinEnginArea != null && !aMinEnginArea.equals(""))
		{
			Double tDouble = new Double(aMinEnginArea);
			double d = tDouble.doubleValue();
			MinEnginArea = d;
		}
	}

	public double getMinEnginCost()
	{
		return MinEnginCost;
	}
	public void setMinEnginCost(double aMinEnginCost)
	{
		MinEnginCost = aMinEnginCost;
	}
	public void setMinEnginCost(String aMinEnginCost)
	{
		if (aMinEnginCost != null && !aMinEnginCost.equals(""))
		{
			Double tDouble = new Double(aMinEnginCost);
			double d = tDouble.doubleValue();
			MinEnginCost = d;
		}
	}
	...
	/**
	* 使用另外一个 LSQuotEngineeringTraceSchema 对象给 Schema 赋值
	* @param: aLSQuotEngineeringTraceSchema LSQuotEngineeringTraceSchema
	**/
	public void setSchema(LSQuotEngineeringTraceSchema aLSQuotEngineeringTraceSchema)
	{
		this.SerialNo = aLSQuotEngineeringTraceSchema.getSerialNo();
		this.QuotNo = aLSQuotEngineeringTraceSchema.getQuotNo();
		this.QuotBatNo = aLSQuotEngineeringTraceSchema.getQuotBatNo();
		this.SysPlanCode = aLSQuotEngineeringTraceSchema.getSysPlanCode();
		this.PlanCode = aLSQuotEngineeringTraceSchema.getPlanCode();
		this.EnginName = aLSQuotEngineeringTraceSchema.getEnginName();
		this.EnginType = aLSQuotEngineeringTraceSchema.getEnginType();
		this.EnginArea = aLSQuotEngineeringTraceSchema.getEnginArea();
		this.EnginCost = aLSQuotEngineeringTraceSchema.getEnginCost();
		this.EnginPlace = aLSQuotEngineeringTraceSchema.getEnginPlace();
		this.EnginStartDate = fDate.getDate( aLSQuotEngineeringTraceSchema.getEnginStartDate());
		this.EnginEndDate = fDate.getDate( aLSQuotEngineeringTraceSchema.getEnginEndDate());
		this.InsurerName = aLSQuotEngineeringTraceSchema.getInsurerName();
		this.InsurerType = aLSQuotEngineeringTraceSchema.getInsurerType();
		this.ContractorName = aLSQuotEngineeringTraceSchema.getContractorName();
		this.ContractorType = aLSQuotEngineeringTraceSchema.getContractorType();
		this.EnginDesc = aLSQuotEngineeringTraceSchema.getEnginDesc();
		this.EnginCondition = aLSQuotEngineeringTraceSchema.getEnginCondition();
		this.Remark = aLSQuotEngineeringTraceSchema.getRemark();
		this.MakeOperator = aLSQuotEngineeringTraceSchema.getMakeOperator();
		this.MakeDate = fDate.getDate( aLSQuotEngineeringTraceSchema.getMakeDate());
		this.MakeTime = aLSQuotEngineeringTraceSchema.getMakeTime();
		this.ModifyOperator = aLSQuotEngineeringTraceSchema.getModifyOperator();
		this.ModifyDate = fDate.getDate( aLSQuotEngineeringTraceSchema.getModifyDate());
		this.ModifyTime = aLSQuotEngineeringTraceSchema.getModifyTime();
		this.EnginDays = aLSQuotEngineeringTraceSchema.getEnginDays();
		this.MinEnginArea = aLSQuotEngineeringTraceSchema.getMinEnginArea();
		this.MinEnginCost = aLSQuotEngineeringTraceSchema.getMinEnginCost();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		try
		{
			...
			this.MinEnginArea = rs.getDouble("MinEnginArea");
			this.MinEnginCost = rs.getDouble("MinEnginCost");
		}
		catch(SQLException sqle)
		{
			logger.debug("数据库中的LSQuotEngineeringTrace表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LSQuotEngineeringTraceSchema";
	...
	public LSQuotEngineeringTraceSchema getSchema()
	{
		LSQuotEngineeringTraceSchema aLSQuotEngineeringTraceSchema = new LSQuotEngineeringTraceSchema();
		aLSQuotEngineeringTraceSchema.setSchema(this);
		return aLSQuotEngineeringTraceSchema;
	}

	public LSQuotEngineeringTraceDB getDB()
	{
		LSQuotEngineeringTraceDB aDBOper = new LSQuotEngineeringTraceDB();
	...
	**/
	public String encode()
	{
		...
		strReturn.append(StrTool.cTrim(EnginDays)); strReturn.append(SysConst.PACKAGESPILTER);
		strReturn.append( ChgData.chgData(MinEnginArea));strReturn.append(SysConst.PACKAGESPILTER);
		strReturn.append( ChgData.chgData(MinEnginCost));
		return strReturn.toString();
	}

	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLSQuotEngineeringTrace>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			EnginName = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 6, SysConst.PACKAGESPILTER );
			EnginType = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 7, SysConst.PACKAGESPILTER );
			EnginArea = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,8,SysConst.PACKAGESPILTER))).doubleValue();
			EnginCost = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,9,SysConst.PACKAGESPILTER))).doubleValue();
			EnginPlace = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 10, SysConst.PACKAGESPILTER );
			EnginStartDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 11,SysConst.PACKAGESPILTER));
			EnginEndDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 12,SysConst.PACKAGESPILTER));
			InsurerName = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 13, SysConst.PACKAGESPILTER );
			InsurerType = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 14, SysConst.PACKAGESPILTER );
			ContractorName = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 15, SysConst.PACKAGESPILTER );
			ContractorType = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 16, SysConst.PACKAGESPILTER );
			EnginDesc = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 17, SysConst.PACKAGESPILTER );
			EnginCondition = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 18, SysConst.PACKAGESPILTER );
			...
			EnginDays = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 26, SysConst.PACKAGESPILTER );
			MinEnginArea = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,27,SysConst.PACKAGESPILTER))).doubleValue();
			MinEnginCost = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,28,SysConst.PACKAGESPILTER))).doubleValue();
		}
	...
	**/
	public String getV(String FCode)
	{
		...
		if (FCode.equalsIgnoreCase("MinEnginArea"))
		{
			strReturn = StrTool.GBKToUnicode(String.valueOf(MinEnginArea));
		}
		if (FCode.equalsIgnoreCase("MinEnginCost"))
		{
			strReturn = StrTool.GBKToUnicode(String.valueOf(MinEnginCost));
		}
		if (strReturn.equals(""))
		{
			strReturn = "null";
	...
	public String getV(int nFieldIndex)
	{
		...
		switch(nFieldIndex) {
			...
			case 25:
				...
				break;
			case 26:
				strFieldValue = String.valueOf(MinEnginArea);
				break;
			case 27:
				strFieldValue = String.valueOf(MinEnginCost);
				break;
			default:
				strFieldValue = "";
		};
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LSQuotEngineeringTraceSchema other = (LSQuotEngineeringTraceSchema)otherObject;
		return
			...
			&& MinEnginArea == other.getMinEnginArea()
			&& MinEnginCost == other.getMinEnginCost();
	}
	...
	**/
	public int getFieldIndex(String strFieldName)
	{
		...
		if( strFieldName.equals("MinEnginArea") ) {
			return 26;
		}
		if( strFieldName.equals("MinEnginCost") ) {
			return 27;
		}
		return -1;
	}
	...
	public String getFieldName(int nFieldIndex)
	{
		...
		switch(nFieldIndex) {
			...
			case 25:
				...
				break;
			case 26:
				strFieldName = "MinEnginArea";
				break;
			case 27:
				strFieldName = "MinEnginCost";
				break;
			default:
				strFieldName = "";
		};
