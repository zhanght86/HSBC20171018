...
import com.sinosoft.lis.db.LBGetToAccDB;

/*
 * <p>ClassName: LBGetToAccSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 寿险业务系统未整理模型
 */
public class LBGetToAccSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LBGetToAccSchema.class);
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LBGetToAccSchema cloned = (LBGetToAccSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LBGetToAccSchema 对象给 Schema 赋值
	* @param: aLBGetToAccSchema LBGetToAccSchema
	**/
	public void setSchema(LBGetToAccSchema aLBGetToAccSchema)
	{
		this.EdorNo = aLBGetToAccSchema.getEdorNo();
		this.PolNo = aLBGetToAccSchema.getPolNo();
		this.DutyCode = aLBGetToAccSchema.getDutyCode();
		this.GetDutyCode = aLBGetToAccSchema.getGetDutyCode();
		this.InsuAccNo = aLBGetToAccSchema.getInsuAccNo();
		this.DefaultRate = aLBGetToAccSchema.getDefaultRate();
		this.NeedInput = aLBGetToAccSchema.getNeedInput();
		this.CalCodeMoney = aLBGetToAccSchema.getCalCodeMoney();
		this.DealDirection = aLBGetToAccSchema.getDealDirection();
		this.CalFlag = aLBGetToAccSchema.getCalFlag();
		this.Operator = aLBGetToAccSchema.getOperator();
		this.MakeDate = fDate.getDate( aLBGetToAccSchema.getMakeDate());
		this.MakeTime = aLBGetToAccSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLBGetToAccSchema.getModifyDate());
		this.ModifyTime = aLBGetToAccSchema.getModifyTime();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LBGetToAcc表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LBGetToAccSchema";
	...
	public LBGetToAccSchema getSchema()
	{
		LBGetToAccSchema aLBGetToAccSchema = new LBGetToAccSchema();
		aLBGetToAccSchema.setSchema(this);
		return aLBGetToAccSchema;
	}

	public LBGetToAccDB getDB()
	{
		LBGetToAccDB aDBOper = new LBGetToAccDB();
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLBGetToAcc>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			DefaultRate = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,6,SysConst.PACKAGESPILTER))).doubleValue();
			NeedInput = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 7, SysConst.PACKAGESPILTER );
			CalCodeMoney = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 8, SysConst.PACKAGESPILTER );
			DealDirection = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 9, SysConst.PACKAGESPILTER );
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LBGetToAccSchema other = (LBGetToAccSchema)otherObject;
		return
