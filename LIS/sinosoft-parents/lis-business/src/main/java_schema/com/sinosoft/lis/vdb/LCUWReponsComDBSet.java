...
/*
 * <p>ClassName: LCUWReponsComDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 权限管理
 */
public class LCUWReponsComDBSet extends LCUWReponsComSet
{
private static Logger logger = Logger.getLogger(LCUWReponsComDBSet.class);
	...
	**/
	...
	// @Constructor
	public LCUWReponsComDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LCUWReponsComDBSet";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getValidStartDate() == null || this.get(i).getValidStartDate().equals("null")) {
				...
				pstmt.setDate(3, Date.valueOf(this.get(i).getValidStartDate()));
			}
			if(this.get(i).getValidEndDate() == null || this.get(i).getValidEndDate().equals("null")) {
				pstmt.setDate(4,null);
			} else {
				pstmt.setDate(4, Date.valueOf(this.get(i).getValidEndDate()));
			}
			...
			if(this.get(i).getUserCode() == null || this.get(i).getUserCode().equals("null")) {
				...
				pstmt.setString(9, this.get(i).getUserCode());
			}
			if(this.get(i).getManageCom() == null || this.get(i).getManageCom().equals("null")) {
