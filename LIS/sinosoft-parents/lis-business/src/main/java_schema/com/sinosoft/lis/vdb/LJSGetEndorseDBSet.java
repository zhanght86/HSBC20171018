...
/*
 * <p>ClassName: LJSGetEndorseDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 寿险业务收费
 */
public class LJSGetEndorseDBSet extends LJSGetEndorseSet
{
	// @Field
	...
	**/
	...
	// @Constructor
	public LJSGetEndorseDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LJSGetEndorseDBSet";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getPolType() == null || this.get(i).getPolType().equals("null")) {
				...
				pstmt.setString(27, this.get(i).getPolType());
			}
			...
			if(this.get(i).getGetFlag() == null || this.get(i).getGetFlag().equals("null")) {
				...
				pstmt.setString(31, this.get(i).getGetFlag());
			}
			...
			if(this.get(i).getSubFeeOperationType() == null || this.get(i).getSubFeeOperationType().equals("null")) {
				...
				pstmt.setString(38, this.get(i).getSubFeeOperationType());
			}
			...
			pstmt.setDouble(40, this.get(i).getPeriodPrem());
			...
			pstmt.setDouble(43, this.get(i).getNetAmount());
			pstmt.setDouble(44, this.get(i).getTaxAmount());
			pstmt.setDouble(45, this.get(i).getTax());
			// set where condition
			if(this.get(i).getGetNoticeNo() == null || this.get(i).getGetNoticeNo().equals("null")) {
				pstmt.setString(46,null);
			} else {
				pstmt.setString(46, this.get(i).getGetNoticeNo());
			}
			if(this.get(i).getEndorsementNo() == null || this.get(i).getEndorsementNo().equals("null")) {
				pstmt.setString(47,null);
			} else {
				pstmt.setString(47, this.get(i).getEndorsementNo());
			}
			if(this.get(i).getFeeOperationType() == null || this.get(i).getFeeOperationType().equals("null")) {
			...
			if(this.get(i).getFeeFinaType() == null || this.get(i).getFeeFinaType().equals("null")) {
				...
				pstmt.setString(49, this.get(i).getFeeFinaType());
			}
			if(this.get(i).getPolNo() == null || this.get(i).getPolNo().equals("null")) {
			...
			if(this.get(i).getPayPlanCode() == null || this.get(i).getPayPlanCode().equals("null")) {
				...
				pstmt.setString(53, this.get(i).getPayPlanCode());
			}
			if(this.get(i).getSubFeeOperationType() == null || this.get(i).getSubFeeOperationType().equals("null")) {
				pstmt.setString(54,null);
			} else {
				pstmt.setString(54, this.get(i).getSubFeeOperationType());
			}
