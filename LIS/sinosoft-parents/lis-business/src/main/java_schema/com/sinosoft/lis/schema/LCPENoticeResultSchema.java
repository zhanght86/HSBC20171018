...
/*
 * <p>ClassName: LCPENoticeResultSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 承保流程
 */
public class LCPENoticeResultSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LCPENoticeResultSchema.class);
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LCPENoticeResultSchema cloned = (LCPENoticeResultSchema)super.clone();
	...
	/**
	* 使用另外一个 LCPENoticeResultSchema 对象给 Schema 赋值
	* @param: aLCPENoticeResultSchema LCPENoticeResultSchema
	**/
	public void setSchema(LCPENoticeResultSchema aLCPENoticeResultSchema)
	{
		this.GrpContNo = aLCPENoticeResultSchema.getGrpContNo();
		this.ContNo = aLCPENoticeResultSchema.getContNo();
		this.ProposalContNo = aLCPENoticeResultSchema.getProposalContNo();
		this.PrtSeq = aLCPENoticeResultSchema.getPrtSeq();
		this.CustomerNo = aLCPENoticeResultSchema.getCustomerNo();
		this.Name = aLCPENoticeResultSchema.getName();
		this.SerialNo = aLCPENoticeResultSchema.getSerialNo();
		this.DisDesb = aLCPENoticeResultSchema.getDisDesb();
		this.DisResult = aLCPENoticeResultSchema.getDisResult();
		this.ICDCode = aLCPENoticeResultSchema.getICDCode();
		this.Remark = aLCPENoticeResultSchema.getRemark();
		this.Operator = aLCPENoticeResultSchema.getOperator();
		this.MakeDate = fDate.getDate( aLCPENoticeResultSchema.getMakeDate());
		this.MakeTime = aLCPENoticeResultSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLCPENoticeResultSchema.getModifyDate());
		this.ModifyTime = aLCPENoticeResultSchema.getModifyTime();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LCPENoticeResult表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LCPENoticeResultSchema";
	...
	public LCPENoticeResultSchema getSchema()
	{
		LCPENoticeResultSchema aLCPENoticeResultSchema = new LCPENoticeResultSchema();
		aLCPENoticeResultSchema.setSchema(this);
		return aLCPENoticeResultSchema;
	}

	public LCPENoticeResultDB getDB()
	{
		LCPENoticeResultDB aDBOper = new LCPENoticeResultDB();
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLCPENoticeResult>历史记账凭证主表信息</A>表字段
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LCPENoticeResultSchema other = (LCPENoticeResultSchema)otherObject;
		return
