...
/*
 * <p>ClassName: LCCustomerContactInfoDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 新单管理
 */
public class LCCustomerContactInfoDBSet extends LCCustomerContactInfoSet
{
	// @Field
	...
	**/
	...
	// @Constructor
	public LCCustomerContactInfoDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public LCCustomerContactInfoDBSet()
	{
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LCCustomerContactInfoDBSet";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getContNo() == null || this.get(i).getContNo().equals("null")) {
				...
				pstmt.setString(37, this.get(i).getContNo());
			}
			if(this.get(i).getCustomerNo() == null || this.get(i).getCustomerNo().equals("null")) {
				pstmt.setString(38,null);
			} else {
				pstmt.setString(38, this.get(i).getCustomerNo());
			}
