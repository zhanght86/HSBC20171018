...
/*
 * <p>ClassName: LCParamDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 承保核心
 */
public class LCParamDBSet extends LCParamSet
{
private static Logger logger = Logger.getLogger(LCParamDBSet.class);
	...
	**/
	...
	// @Constructor
	public LCParamDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LCParamDBSet";
	...
	public boolean delete()
	{
		...
		try
		{
			...
			if(this.get(i).getParamName() == null || this.get(i).getParamName().equals("null")) {
				...
				pstmt.setString(9, this.get(i).getParamName());
			}
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getParam() == null || this.get(i).getParam().equals("null")) {
				...
				pstmt.setString(11, this.get(i).getParam());
			}
			...
			if(this.get(i).getGrpPolNo() == null || this.get(i).getGrpPolNo().equals("null")) {
				...
				pstmt.setString(17, this.get(i).getGrpPolNo());
			}
			if(this.get(i).getPolNo() == null || this.get(i).getPolNo().equals("null")) {
			...
			if(this.get(i).getFactoryType() == null || this.get(i).getFactoryType().equals("null")) {
				...
				pstmt.setString(19, this.get(i).getFactoryType());
			}
			if(this.get(i).getOtherNo() == null || this.get(i).getOtherNo().equals("null")) {
				pstmt.setString(20,null);
			} else {
				pstmt.setString(20, this.get(i).getOtherNo());
			}
			if(this.get(i).getFactoryCode() == null || this.get(i).getFactoryCode().equals("null")) {
				pstmt.setString(21,null);
			} else {
				pstmt.setString(21, this.get(i).getFactoryCode());
			}
			pstmt.setInt(22, this.get(i).getFactorySubCode());
			if(this.get(i).getInerSerialNo() == null || this.get(i).getInerSerialNo().equals("null")) {
				pstmt.setString(23,null);
			} else {
				pstmt.setString(23, this.get(i).getInerSerialNo());
			}
			if(this.get(i).getParamName() == null || this.get(i).getParamName().equals("null")) {
				pstmt.setString(24,null);
			} else {
				pstmt.setString(24, this.get(i).getParamName());
			}
