...
import com.sinosoft.lis.db.RnewPENoticeResultDB;

/*
 * <p>ClassName: RnewPENoticeResultSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 续期续保二核
 */
public class RnewPENoticeResultSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(RnewPENoticeResultSchema.class);
	...
	// @Constructor
	public RnewPENoticeResultSchema()
	{
		mErrors = new CErrors();
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		RnewPENoticeResultSchema cloned = (RnewPENoticeResultSchema)super.clone();
	...
	/**
	* 使用另外一个 RnewPENoticeResultSchema 对象给 Schema 赋值
	* @param: aRnewPENoticeResultSchema RnewPENoticeResultSchema
	**/
	public void setSchema(RnewPENoticeResultSchema aRnewPENoticeResultSchema)
	{
		this.GrpContNo = aRnewPENoticeResultSchema.getGrpContNo();
		this.ContNo = aRnewPENoticeResultSchema.getContNo();
		this.ProposalContNo = aRnewPENoticeResultSchema.getProposalContNo();
		this.PrtSeq = aRnewPENoticeResultSchema.getPrtSeq();
		this.CustomerNo = aRnewPENoticeResultSchema.getCustomerNo();
		this.Name = aRnewPENoticeResultSchema.getName();
		this.SerialNo = aRnewPENoticeResultSchema.getSerialNo();
		this.DisDesb = aRnewPENoticeResultSchema.getDisDesb();
		this.DisResult = aRnewPENoticeResultSchema.getDisResult();
		this.ICDCode = aRnewPENoticeResultSchema.getICDCode();
		this.Remark = aRnewPENoticeResultSchema.getRemark();
		this.Operator = aRnewPENoticeResultSchema.getOperator();
		this.MakeDate = fDate.getDate( aRnewPENoticeResultSchema.getMakeDate());
		this.MakeTime = aRnewPENoticeResultSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aRnewPENoticeResultSchema.getModifyDate());
		this.ModifyTime = aRnewPENoticeResultSchema.getModifyTime();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的RnewPENoticeResult表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "RnewPENoticeResultSchema";
	...
	public RnewPENoticeResultSchema getSchema()
	{
		RnewPENoticeResultSchema aRnewPENoticeResultSchema = new RnewPENoticeResultSchema();
		aRnewPENoticeResultSchema.setSchema(this);
		return aRnewPENoticeResultSchema;
	}

	public RnewPENoticeResultDB getDB()
	{
		RnewPENoticeResultDB aDBOper = new RnewPENoticeResultDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpRnewPENoticeResult描述/A>表字段
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpRnewPENoticeResult>历史记账凭证主表信息</A>表字段
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		RnewPENoticeResultSchema other = (RnewPENoticeResultSchema)otherObject;
		return
