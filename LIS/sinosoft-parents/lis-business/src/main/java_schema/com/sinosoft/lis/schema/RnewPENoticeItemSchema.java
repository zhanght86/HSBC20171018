...
import com.sinosoft.lis.db.RnewPENoticeItemDB;

/*
 * <p>ClassName: RnewPENoticeItemSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 续期续保二核
 */
public class RnewPENoticeItemSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(RnewPENoticeItemSchema.class);
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		RnewPENoticeItemSchema cloned = (RnewPENoticeItemSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 RnewPENoticeItemSchema 对象给 Schema 赋值
	* @param: aRnewPENoticeItemSchema RnewPENoticeItemSchema
	**/
	public void setSchema(RnewPENoticeItemSchema aRnewPENoticeItemSchema)
	{
		this.GrpContNo = aRnewPENoticeItemSchema.getGrpContNo();
		this.ContNo = aRnewPENoticeItemSchema.getContNo();
		this.ProposalContNo = aRnewPENoticeItemSchema.getProposalContNo();
		this.PrtSeq = aRnewPENoticeItemSchema.getPrtSeq();
		this.PEItemCode = aRnewPENoticeItemSchema.getPEItemCode();
		this.PEItemName = aRnewPENoticeItemSchema.getPEItemName();
		this.ModifyDate = fDate.getDate( aRnewPENoticeItemSchema.getModifyDate());
		this.ModifyTime = aRnewPENoticeItemSchema.getModifyTime();
		this.FreePE = aRnewPENoticeItemSchema.getFreePE();
		this.PEItemResult = aRnewPENoticeItemSchema.getPEItemResult();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的RnewPENoticeItem表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "RnewPENoticeItemSchema";
	...
	public RnewPENoticeItemSchema getSchema()
	{
		RnewPENoticeItemSchema aRnewPENoticeItemSchema = new RnewPENoticeItemSchema();
		aRnewPENoticeItemSchema.setSchema(this);
		return aRnewPENoticeItemSchema;
	}

	public RnewPENoticeItemDB getDB()
	{
		RnewPENoticeItemDB aDBOper = new RnewPENoticeItemDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpRnewPENoticeItem描述/A>表字段
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpRnewPENoticeItem>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			PEItemCode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 5, SysConst.PACKAGESPILTER );
			PEItemName = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 6, SysConst.PACKAGESPILTER );
			...
			FreePE = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 9, SysConst.PACKAGESPILTER );
			PEItemResult = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 10, SysConst.PACKAGESPILTER );
		}
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		RnewPENoticeItemSchema other = (RnewPENoticeItemSchema)otherObject;
		return
