...
import com.sinosoft.lis.db.LCContPlanDetailDB;

/*
 * <p>ClassName: LCContPlanDetailSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 新单管理
 */
public class LCContPlanDetailSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LCContPlanDetailSchema.class);
	// @Field
	/** 保单号码 */
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LCContPlanDetailSchema cloned = (LCContPlanDetailSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LCContPlanDetailSchema 对象给 Schema 赋值
	* @param: aLCContPlanDetailSchema LCContPlanDetailSchema
	**/
	public void setSchema(LCContPlanDetailSchema aLCContPlanDetailSchema)
	{
		this.PolicyNo = aLCContPlanDetailSchema.getPolicyNo();
		this.PropNo = aLCContPlanDetailSchema.getPropNo();
		this.SysPlanCode = aLCContPlanDetailSchema.getSysPlanCode();
		this.PlanCode = aLCContPlanDetailSchema.getPlanCode();
		this.RiskCode = aLCContPlanDetailSchema.getRiskCode();
		this.DutyCode = aLCContPlanDetailSchema.getDutyCode();
		this.AmntType = aLCContPlanDetailSchema.getAmntType();
		this.FixedAmnt = aLCContPlanDetailSchema.getFixedAmnt();
		this.SalaryMult = aLCContPlanDetailSchema.getSalaryMult();
		this.MaxAmnt = aLCContPlanDetailSchema.getMaxAmnt();
		this.MinAmnt = aLCContPlanDetailSchema.getMinAmnt();
		this.ExceptPremType = aLCContPlanDetailSchema.getExceptPremType();
		this.ExceptPrem = aLCContPlanDetailSchema.getExceptPrem();
		this.StandValue = aLCContPlanDetailSchema.getStandValue();
		this.InitPrem = aLCContPlanDetailSchema.getInitPrem();
		this.ExceptYield = aLCContPlanDetailSchema.getExceptYield();
		this.FinalValue = aLCContPlanDetailSchema.getFinalValue();
		this.ChangeType = aLCContPlanDetailSchema.getChangeType();
		this.RelaShareFlag = aLCContPlanDetailSchema.getRelaShareFlag();
		this.Remark = aLCContPlanDetailSchema.getRemark();
		this.MakeOperator = aLCContPlanDetailSchema.getMakeOperator();
		this.MakeDate = fDate.getDate( aLCContPlanDetailSchema.getMakeDate());
		this.MakeTime = aLCContPlanDetailSchema.getMakeTime();
		this.ModifyOperator = aLCContPlanDetailSchema.getModifyOperator();
		this.ModifyDate = fDate.getDate( aLCContPlanDetailSchema.getModifyDate());
		this.ModifyTime = aLCContPlanDetailSchema.getModifyTime();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LCContPlanDetail表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LCContPlanDetailSchema";
	...
	public LCContPlanDetailSchema getSchema()
	{
		LCContPlanDetailSchema aLCContPlanDetailSchema = new LCContPlanDetailSchema();
		aLCContPlanDetailSchema.setSchema(this);
		return aLCContPlanDetailSchema;
	}

	public LCContPlanDetailDB getDB()
	{
		LCContPlanDetailDB aDBOper = new LCContPlanDetailDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLCContPlanDetail描述/A>表字段
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLCContPlanDetail>历史记账凭证主表信息</A>表字段
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LCContPlanDetailSchema other = (LCContPlanDetailSchema)otherObject;
		return
