...
/*
 * <p>ClassName: RIRecordTraceTempSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 再保系统模型
 */
public class RIRecordTraceTempSchema implements Schema, Cloneable
{
	// @Field
	/** 序列号 */
	...
	// @Constructor
	public RIRecordTraceTempSchema()
	{
		mErrors = new CErrors();
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		RIRecordTraceTempSchema cloned = (RIRecordTraceTempSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 RIRecordTraceTempSchema 对象给 Schema 赋值
	* @param: aRIRecordTraceTempSchema RIRecordTraceTempSchema
	**/
	public void setSchema(RIRecordTraceTempSchema aRIRecordTraceTempSchema)
	{
		this.SerialNo = aRIRecordTraceTempSchema.getSerialNo();
		this.BatchNo = aRIRecordTraceTempSchema.getBatchNo();
		this.AccumulateDefNO = aRIRecordTraceTempSchema.getAccumulateDefNO();
		this.RIPreceptNo = aRIRecordTraceTempSchema.getRIPreceptNo();
		this.OtherNo = aRIRecordTraceTempSchema.getOtherNo();
		this.ContNo = aRIRecordTraceTempSchema.getContNo();
		this.AreaID = aRIRecordTraceTempSchema.getAreaID();
		this.EventNo = aRIRecordTraceTempSchema.getEventNo();
		this.EventType = aRIRecordTraceTempSchema.getEventType();
		this.RiskCode = aRIRecordTraceTempSchema.getRiskCode();
		this.DutyCode = aRIRecordTraceTempSchema.getDutyCode();
		this.IncomeCompanyNo = aRIRecordTraceTempSchema.getIncomeCompanyNo();
		this.FeeType = aRIRecordTraceTempSchema.getFeeType();
		this.FeeMoney = aRIRecordTraceTempSchema.getFeeMoney();
		this.CurentAmnt = aRIRecordTraceTempSchema.getCurentAmnt();
		this.CessionAmount = aRIRecordTraceTempSchema.getCessionAmount();
		this.CessionRate = aRIRecordTraceTempSchema.getCessionRate();
		this.AmountChang = aRIRecordTraceTempSchema.getAmountChang();
		this.PremChang = aRIRecordTraceTempSchema.getPremChang();
		this.CommChang = aRIRecordTraceTempSchema.getCommChang();
		this.ReturnPay = aRIRecordTraceTempSchema.getReturnPay();
		this.ReturnFee = aRIRecordTraceTempSchema.getReturnFee();
		this.AddSubFlag = aRIRecordTraceTempSchema.getAddSubFlag();
		this.StandbyString1 = aRIRecordTraceTempSchema.getStandbyString1();
		this.StandbyString2 = aRIRecordTraceTempSchema.getStandbyString2();
		this.StandbyString3 = aRIRecordTraceTempSchema.getStandbyString3();
		this.StandbyString4 = aRIRecordTraceTempSchema.getStandbyString4();
		this.StandbyDouble1 = aRIRecordTraceTempSchema.getStandbyDouble1();
		this.StandbyDouble2 = aRIRecordTraceTempSchema.getStandbyDouble2();
		this.StandbyDouble3 = aRIRecordTraceTempSchema.getStandbyDouble3();
		this.StandbyDouble4 = aRIRecordTraceTempSchema.getStandbyDouble4();
		this.StandbyDouble5 = aRIRecordTraceTempSchema.getStandbyDouble5();
		this.StandbyDouble6 = aRIRecordTraceTempSchema.getStandbyDouble6();
		this.StandbyDouble7 = aRIRecordTraceTempSchema.getStandbyDouble7();
		this.StandbyDouble8 = aRIRecordTraceTempSchema.getStandbyDouble8();
		this.StandbyDouble9 = aRIRecordTraceTempSchema.getStandbyDouble9();
		this.StandbyDate1 = aRIRecordTraceTempSchema.getStandbyDate1();
		this.StandbyDate2 = aRIRecordTraceTempSchema.getStandbyDate2();
		this.ReinsureType = aRIRecordTraceTempSchema.getReinsureType();
		this.RIDate = fDate.getDate( aRIRecordTraceTempSchema.getRIDate());
		this.FIDate = fDate.getDate( aRIRecordTraceTempSchema.getFIDate());
		this.Currency = aRIRecordTraceTempSchema.getCurrency();
		this.BillNo = aRIRecordTraceTempSchema.getBillNo();
		this.BillBatchNo = aRIRecordTraceTempSchema.getBillBatchNo();
		this.SettleFlag = aRIRecordTraceTempSchema.getSettleFlag();
		this.PrePremChang = aRIRecordTraceTempSchema.getPrePremChang();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			System.out.println("数据库中的RIRecordTraceTemp表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			sqle.printStackTrace();
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "RIRecordTraceTempSchema";
	...
	public RIRecordTraceTempSchema getSchema()
	{
		RIRecordTraceTempSchema aRIRecordTraceTempSchema = new RIRecordTraceTempSchema();
		aRIRecordTraceTempSchema.setSchema(this);
		return aRIRecordTraceTempSchema;
	}

	public RIRecordTraceTempDB getDB()
	{
		RIRecordTraceTempDB aDBOper = new RIRecordTraceTempDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpRIRecordTraceTemp描述/A>表字段
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpRIRecordTraceTemp>历史记账凭证主表信息</A>表字段
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		RIRecordTraceTempSchema other = (RIRecordTraceTempSchema)otherObject;
		return
