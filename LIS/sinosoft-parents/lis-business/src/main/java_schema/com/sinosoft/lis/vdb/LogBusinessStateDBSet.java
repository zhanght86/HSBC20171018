...
/*
 * <p>ClassName: LogBusinessStateDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: PhysicalDataModel_1
 */
public class LogBusinessStateDBSet extends LogBusinessStateSet
{
	// @Field
	...
	**/
	...
	// @Constructor
	public LogBusinessStateDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LogBusinessStateDBSet";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getItemDes() == null || this.get(i).getItemDes().equals("null")) {
				...
				pstmt.setString(7, this.get(i).getItemDes());
			}
			...
			if(this.get(i).getLogNo() == null || this.get(i).getLogNo().equals("null")) {
				...
				pstmt.setString(13, this.get(i).getLogNo());
			}
