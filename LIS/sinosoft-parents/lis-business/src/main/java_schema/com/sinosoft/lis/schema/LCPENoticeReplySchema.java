...
import com.sinosoft.lis.db.LCPENoticeReplyDB;

/*
 * <p>ClassName: LCPENoticeReplySchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 承保流程
 */
public class LCPENoticeReplySchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LCPENoticeReplySchema.class);
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LCPENoticeReplySchema cloned = (LCPENoticeReplySchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LCPENoticeReplySchema 对象给 Schema 赋值
	* @param: aLCPENoticeReplySchema LCPENoticeReplySchema
	**/
	public void setSchema(LCPENoticeReplySchema aLCPENoticeReplySchema)
	{
		this.ContNo = aLCPENoticeReplySchema.getContNo();
		this.ProposalContNo = aLCPENoticeReplySchema.getProposalContNo();
		this.PrtSeq = aLCPENoticeReplySchema.getPrtSeq();
		this.PEItemCode = aLCPENoticeReplySchema.getPEItemCode();
		this.PEItemName = aLCPENoticeReplySchema.getPEItemName();
		this.PEItemDivCode = aLCPENoticeReplySchema.getPEItemDivCode();
		this.PEItemDivName = aLCPENoticeReplySchema.getPEItemDivName();
		this.PEItemDivDes = aLCPENoticeReplySchema.getPEItemDivDes();
		this.PEItemDivRes = aLCPENoticeReplySchema.getPEItemDivRes();
		this.PEItemDivNor = aLCPENoticeReplySchema.getPEItemDivNor();
		this.FreePE = aLCPENoticeReplySchema.getFreePE();
		this.ModifyDate = fDate.getDate( aLCPENoticeReplySchema.getModifyDate());
		this.ModifyTime = aLCPENoticeReplySchema.getModifyTime();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LCPENoticeReply表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LCPENoticeReplySchema";
	...
	public LCPENoticeReplySchema getSchema()
	{
		LCPENoticeReplySchema aLCPENoticeReplySchema = new LCPENoticeReplySchema();
		aLCPENoticeReplySchema.setSchema(this);
		return aLCPENoticeReplySchema;
	}

	public LCPENoticeReplyDB getDB()
	{
		LCPENoticeReplyDB aDBOper = new LCPENoticeReplyDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLCPENoticeReply描述/A>表字段
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLCPENoticeReply>历史记账凭证主表信息</A>表字段
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LCPENoticeReplySchema other = (LCPENoticeReplySchema)otherObject;
		return
