...
{
private static Logger logger = Logger.getLogger(LMAccGuratRateDBSet.class);
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getRateState() == null || this.get(i).getRateState().equals("null")) {
				...
				pstmt.setString(10, this.get(i).getRateState());
			}
			// set where condition
			if(this.get(i).getRiskCode() == null || this.get(i).getRiskCode().equals("null")) {
			...
			if(this.get(i).getRateStartDate() == null || this.get(i).getRateStartDate().equals("null")) {
				...
				pstmt.setDate(13, Date.valueOf(this.get(i).getRateStartDate()));
			}
			if(this.get(i).getRateIntv() == null || this.get(i).getRateIntv().equals("null")) {
				pstmt.setString(14,null);
			} else {
				pstmt.setString(14, StrTool.space1(this.get(i).getRateIntv(), 1));
			}
