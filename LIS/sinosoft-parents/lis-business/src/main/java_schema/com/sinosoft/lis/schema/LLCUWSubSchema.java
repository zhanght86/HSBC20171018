...
/*
 * <p>ClassName: LLCUWSubSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 理赔管理
 */
public class LLCUWSubSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LLCUWSubSchema.class);
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LLCUWSubSchema cloned = (LLCUWSubSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LLCUWSubSchema 对象给 Schema 赋值
	* @param: aLLCUWSubSchema LLCUWSubSchema
	**/
	public void setSchema(LLCUWSubSchema aLLCUWSubSchema)
	{
		this.CaseNo = aLLCUWSubSchema.getCaseNo();
		this.GrpContNo = aLLCUWSubSchema.getGrpContNo();
		this.BatNo = aLLCUWSubSchema.getBatNo();
		this.ContNo = aLLCUWSubSchema.getContNo();
		this.ProposalContNo = aLLCUWSubSchema.getProposalContNo();
		this.UWNo = aLLCUWSubSchema.getUWNo();
		this.InsuredNo = aLLCUWSubSchema.getInsuredNo();
		this.InsuredName = aLLCUWSubSchema.getInsuredName();
		this.AppntNo = aLLCUWSubSchema.getAppntNo();
		this.AppntName = aLLCUWSubSchema.getAppntName();
		this.AgentCode = aLLCUWSubSchema.getAgentCode();
		this.AgentGroup = aLLCUWSubSchema.getAgentGroup();
		this.PassFlag = aLLCUWSubSchema.getPassFlag();
		this.UWGrade = aLLCUWSubSchema.getUWGrade();
		this.AppGrade = aLLCUWSubSchema.getAppGrade();
		this.PostponeDay = aLLCUWSubSchema.getPostponeDay();
		this.PostponeDate = fDate.getDate( aLLCUWSubSchema.getPostponeDate());
		this.AutoUWFlag = aLLCUWSubSchema.getAutoUWFlag();
		this.State = aLLCUWSubSchema.getState();
		this.ManageCom = aLLCUWSubSchema.getManageCom();
		this.UWIdea = aLLCUWSubSchema.getUWIdea();
		this.UpReportContent = aLLCUWSubSchema.getUpReportContent();
		this.Operator = aLLCUWSubSchema.getOperator();
		this.HealthFlag = aLLCUWSubSchema.getHealthFlag();
		this.QuesFlag = aLLCUWSubSchema.getQuesFlag();
		this.SpecFlag = aLLCUWSubSchema.getSpecFlag();
		this.AddPremFlag = aLLCUWSubSchema.getAddPremFlag();
		this.AddPremReason = aLLCUWSubSchema.getAddPremReason();
		this.ReportFlag = aLLCUWSubSchema.getReportFlag();
		this.PrintFlag = aLLCUWSubSchema.getPrintFlag();
		this.PrintFlag2 = aLLCUWSubSchema.getPrintFlag2();
		this.ChangePolFlag = aLLCUWSubSchema.getChangePolFlag();
		this.ChangePolReason = aLLCUWSubSchema.getChangePolReason();
		this.SpecReason = aLLCUWSubSchema.getSpecReason();
		this.MakeDate = fDate.getDate( aLLCUWSubSchema.getMakeDate());
		this.MakeTime = aLLCUWSubSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLLCUWSubSchema.getModifyDate());
		this.ModifyTime = aLLCUWSubSchema.getModifyTime();
		this.SugPassFlag = aLLCUWSubSchema.getSugPassFlag();
		this.SugUWIdea = aLLCUWSubSchema.getSugUWIdea();
		this.ClaimRelFlag = aLLCUWSubSchema.getClaimRelFlag();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LLCUWSub表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LLCUWSubSchema";
	...
	public LLCUWSubSchema getSchema()
	{
		LLCUWSubSchema aLLCUWSubSchema = new LLCUWSubSchema();
		aLLCUWSubSchema.setSchema(this);
		return aLLCUWSubSchema;
	}

	public LLCUWSubDB getDB()
	{
		LLCUWSubDB aDBOper = new LLCUWSubDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLLCUWSub描述/A>表字段
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLLCUWSub>历史记账凭证主表信息</A>表字段
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LLCUWSubSchema other = (LLCUWSubSchema)otherObject;
		return
