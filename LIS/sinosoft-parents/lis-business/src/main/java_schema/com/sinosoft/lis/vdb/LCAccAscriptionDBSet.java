...
/*
 * <p>ClassName: LCAccAscriptionDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: Physical Data Model 1
 */
public class LCAccAscriptionDBSet extends LCAccAscriptionSet
{
	// @Field
	...
	**/
	...
	// @Constructor
	public LCAccAscriptionDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LCAccAscriptionDBSet";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getPositionCode() == null || this.get(i).getPositionCode().equals("null")) {
				...
				pstmt.setString(6, this.get(i).getPositionCode());
			}
			pstmt.setInt(7, this.get(i).getStartYears());
			pstmt.setInt(8, this.get(i).getEndYears());
