...
import com.sinosoft.lis.db.LCFactoryDB;

/*
 * <p>ClassName: LCFactorySchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 承保核心
 */
public class LCFactorySchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LCFactorySchema.class);
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LCFactorySchema cloned = (LCFactorySchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LCFactorySchema 对象给 Schema 赋值
	* @param: aLCFactorySchema LCFactorySchema
	**/
	public void setSchema(LCFactorySchema aLCFactorySchema)
	{
		this.ContNo = aLCFactorySchema.getContNo();
		this.GrpPolNo = aLCFactorySchema.getGrpPolNo();
		this.PolNo = aLCFactorySchema.getPolNo();
		this.FactoryType = aLCFactorySchema.getFactoryType();
		this.OtherNo = aLCFactorySchema.getOtherNo();
		this.FactoryCode = aLCFactorySchema.getFactoryCode();
		this.FactorySubCode = aLCFactorySchema.getFactorySubCode();
		this.FactoryName = aLCFactorySchema.getFactoryName();
		this.InerSerialNo = aLCFactorySchema.getInerSerialNo();
		this.CalSql = aLCFactorySchema.getCalSql();
		this.Params = aLCFactorySchema.getParams();
		this.CalRemark = aLCFactorySchema.getCalRemark();
		this.MakeDate = fDate.getDate( aLCFactorySchema.getMakeDate());
		this.MakeTime = aLCFactorySchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLCFactorySchema.getModifyDate());
		this.ModifyTime = aLCFactorySchema.getModifyTime();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LCFactory表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LCFactorySchema";
	...
	public LCFactorySchema getSchema()
	{
		LCFactorySchema aLCFactorySchema = new LCFactorySchema();
		aLCFactorySchema.setSchema(this);
		return aLCFactorySchema;
	}

	public LCFactoryDB getDB()
	{
		LCFactoryDB aDBOper = new LCFactoryDB();
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLCFactory>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			CalRemark = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 12, SysConst.PACKAGESPILTER );
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LCFactorySchema other = (LCFactorySchema)otherObject;
		return
