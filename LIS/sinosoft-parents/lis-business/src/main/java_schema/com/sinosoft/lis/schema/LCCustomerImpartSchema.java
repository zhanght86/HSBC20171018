...
/*
 * <p>ClassName: LCCustomerImpartSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 承保核心
 */
public class LCCustomerImpartSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LCCustomerImpartSchema.class);
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LCCustomerImpartSchema cloned = (LCCustomerImpartSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LCCustomerImpartSchema 对象给 Schema 赋值
	* @param: aLCCustomerImpartSchema LCCustomerImpartSchema
	**/
	public void setSchema(LCCustomerImpartSchema aLCCustomerImpartSchema)
	{
		this.GrpContNo = aLCCustomerImpartSchema.getGrpContNo();
		this.ContNo = aLCCustomerImpartSchema.getContNo();
		this.ProposalContNo = aLCCustomerImpartSchema.getProposalContNo();
		this.PrtNo = aLCCustomerImpartSchema.getPrtNo();
		this.ImpartCode = aLCCustomerImpartSchema.getImpartCode();
		this.ImpartVer = aLCCustomerImpartSchema.getImpartVer();
		this.ImpartContent = aLCCustomerImpartSchema.getImpartContent();
		this.ImpartParamModle = aLCCustomerImpartSchema.getImpartParamModle();
		this.CustomerNo = aLCCustomerImpartSchema.getCustomerNo();
		this.CustomerNoType = aLCCustomerImpartSchema.getCustomerNoType();
		this.UWClaimFlg = aLCCustomerImpartSchema.getUWClaimFlg();
		this.PrtFlag = aLCCustomerImpartSchema.getPrtFlag();
		this.Operator = aLCCustomerImpartSchema.getOperator();
		this.MakeDate = fDate.getDate( aLCCustomerImpartSchema.getMakeDate());
		this.MakeTime = aLCCustomerImpartSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLCCustomerImpartSchema.getModifyDate());
		this.ModifyTime = aLCCustomerImpartSchema.getModifyTime();
		this.PatchNo = aLCCustomerImpartSchema.getPatchNo();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LCCustomerImpart表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LCCustomerImpartSchema";
	...
	public LCCustomerImpartSchema getSchema()
	{
		LCCustomerImpartSchema aLCCustomerImpartSchema = new LCCustomerImpartSchema();
		aLCCustomerImpartSchema.setSchema(this);
		return aLCCustomerImpartSchema;
	}

	public LCCustomerImpartDB getDB()
	{
		LCCustomerImpartDB aDBOper = new LCCustomerImpartDB();
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLCCustomerImpart>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			ImpartContent = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 7, SysConst.PACKAGESPILTER );
			...
			UWClaimFlg = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 11, SysConst.PACKAGESPILTER );
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LCCustomerImpartSchema other = (LCCustomerImpartSchema)otherObject;
		return
