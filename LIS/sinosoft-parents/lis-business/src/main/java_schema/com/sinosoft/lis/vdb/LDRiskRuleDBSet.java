...
/*
 * <p>ClassName: LDRiskRuleDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 承保流程
 */
public class LDRiskRuleDBSet extends LDRiskRuleSet
{
private static Logger logger = Logger.getLogger(LDRiskRuleDBSet.class);
	...
	**/
	...
	// @Constructor
	public LDRiskRuleDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LDRiskRuleDBSet";
