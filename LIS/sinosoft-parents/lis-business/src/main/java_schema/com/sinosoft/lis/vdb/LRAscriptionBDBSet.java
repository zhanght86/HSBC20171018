...
/*
 * <p>ClassName: LRAscriptionBDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 保费续期及中介
 */
public class LRAscriptionBDBSet extends LRAscriptionBSet
{
private static Logger logger = Logger.getLogger(LRAscriptionBDBSet.class);
	...
	**/
	...
	// @Constructor
	public LRAscriptionBDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LRAscriptionBDBSet";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getAscriptionDate() == null || this.get(i).getAscriptionDate().equals("null")) {
				...
				pstmt.setDate(9, Date.valueOf(this.get(i).getAscriptionDate()));
			}
			...
			if(this.get(i).getMainPolNo() == null || this.get(i).getMainPolNo().equals("null")) {
				...
				pstmt.setString(15, this.get(i).getMainPolNo());
			}
			if(this.get(i).getNoti() == null || this.get(i).getNoti().equals("null")) {
				pstmt.setString(16,null);
			} else {
				pstmt.setString(16, this.get(i).getNoti());
			}
			...
			if(this.get(i).getAscriptType() == null || this.get(i).getAscriptType().equals("null")) {
				...
				pstmt.setString(23, this.get(i).getAscriptType());
			}
			if(this.get(i).getPrtNo() == null || this.get(i).getPrtNo().equals("null")) {
				pstmt.setString(24,null);
			} else {
				pstmt.setString(24, this.get(i).getPrtNo());
			}
			...
			pstmt.setInt(26, this.get(i).getPayCount());
			if(this.get(i).getOldPolno() == null || this.get(i).getOldPolno().equals("null")) {
				pstmt.setString(27,null);
			} else {
				pstmt.setString(27, this.get(i).getOldPolno());
			}
			...
			if(this.get(i).getCValiDate() == null || this.get(i).getCValiDate().equals("null")) {
				...
				pstmt.setDate(29, Date.valueOf(this.get(i).getCValiDate()));
			}
			pstmt.setInt(30, this.get(i).getPayYear());
			...
			if(this.get(i).getAddCode() == null || this.get(i).getAddCode().equals("null")) {
				...
				pstmt.setString(32, this.get(i).getAddCode());
			}
