...
/**
 * <p>ClassName: FIAboriginalDataTempSchema </p>
 ...
 */
public class FIAboriginalDataTempSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(FIAboriginalDataTempSchema.class);
	...
	// @Constructor
	public FIAboriginalDataTempSchema()
	{
		mErrors = new CErrors();
		...
		PK = pk;
            ...
            public Object clone()
                    throws CloneNotSupportedException
            {
                FIAboriginalDataTempSchema cloned = (FIAboriginalDataTempSchema)super.clone();
	...
	/**
	* 使用另外一个 FIAboriginalDataTempSchema 对象给 Schema 赋值
	* @param: aFIAboriginalDataTempSchema FIAboriginalDataTempSchema
	**/
	public void setSchema(FIAboriginalDataTempSchema aFIAboriginalDataTempSchema)
	{
		this.ASerialNo = aFIAboriginalDataTempSchema.getASerialNo();
		this.AcquisitionID = aFIAboriginalDataTempSchema.getAcquisitionID();
		this.DataBaseID = aFIAboriginalDataTempSchema.getDataBaseID();
		this.BatchNo = aFIAboriginalDataTempSchema.getBatchNo();
		this.CertificateID = aFIAboriginalDataTempSchema.getCertificateID();
		this.CostID = aFIAboriginalDataTempSchema.getCostID();
		this.DataState = aFIAboriginalDataTempSchema.getDataState();
		this.CheckFlag = aFIAboriginalDataTempSchema.getCheckFlag();
		this.BusinessCode = aFIAboriginalDataTempSchema.getBusinessCode();
		this.FeeCode = aFIAboriginalDataTempSchema.getFeeCode();
		this.SumActuMoney = aFIAboriginalDataTempSchema.getSumActuMoney();
		this.AccountDate = fDate.getDate( aFIAboriginalDataTempSchema.getAccountDate());
		this.BusinessNo = aFIAboriginalDataTempSchema.getBusinessNo();
		this.StringInfo01 = aFIAboriginalDataTempSchema.getStringInfo01();
		this.StringInfo02 = aFIAboriginalDataTempSchema.getStringInfo02();
		this.StringInfo03 = aFIAboriginalDataTempSchema.getStringInfo03();
		this.StringInfo04 = aFIAboriginalDataTempSchema.getStringInfo04();
		this.StringInfo05 = aFIAboriginalDataTempSchema.getStringInfo05();
		this.StringInfo06 = aFIAboriginalDataTempSchema.getStringInfo06();
		this.StringInfo07 = aFIAboriginalDataTempSchema.getStringInfo07();
		this.StringInfo08 = aFIAboriginalDataTempSchema.getStringInfo08();
		this.StringInfo09 = aFIAboriginalDataTempSchema.getStringInfo09();
		this.StringInfo10 = aFIAboriginalDataTempSchema.getStringInfo10();
		this.StringInfo11 = aFIAboriginalDataTempSchema.getStringInfo11();
		this.StringInfo12 = aFIAboriginalDataTempSchema.getStringInfo12();
		this.StringInfo13 = aFIAboriginalDataTempSchema.getStringInfo13();
		this.StringInfo14 = aFIAboriginalDataTempSchema.getStringInfo14();
		this.StringInfo15 = aFIAboriginalDataTempSchema.getStringInfo15();
		this.DateInfo01 = fDate.getDate( aFIAboriginalDataTempSchema.getDateInfo01());
		this.DateInfo02 = fDate.getDate( aFIAboriginalDataTempSchema.getDateInfo02());
		this.DateInfo03 = fDate.getDate( aFIAboriginalDataTempSchema.getDateInfo03());
		this.DateInfo04 = fDate.getDate( aFIAboriginalDataTempSchema.getDateInfo04());
		this.DateInfo05 = fDate.getDate( aFIAboriginalDataTempSchema.getDateInfo05());
		this.DateInfo06 = fDate.getDate( aFIAboriginalDataTempSchema.getDateInfo06());
		this.DateInfo07 = fDate.getDate( aFIAboriginalDataTempSchema.getDateInfo07());
		this.DateInfo08 = fDate.getDate( aFIAboriginalDataTempSchema.getDateInfo08());
		this.DateInfo09 = fDate.getDate( aFIAboriginalDataTempSchema.getDateInfo09());
		this.DateInfo10 = fDate.getDate( aFIAboriginalDataTempSchema.getDateInfo10());
		this.NumInfo01 = aFIAboriginalDataTempSchema.getNumInfo01();
		this.NumInfo02 = aFIAboriginalDataTempSchema.getNumInfo02();
		this.NumInfo03 = aFIAboriginalDataTempSchema.getNumInfo03();
		this.NumInfo04 = aFIAboriginalDataTempSchema.getNumInfo04();
		this.NumInfo05 = aFIAboriginalDataTempSchema.getNumInfo05();
		this.BusinessNo01 = aFIAboriginalDataTempSchema.getBusinessNo01();
		this.BusinessNo02 = aFIAboriginalDataTempSchema.getBusinessNo02();
		this.BusinessNo03 = aFIAboriginalDataTempSchema.getBusinessNo03();
		this.BusinessNo04 = aFIAboriginalDataTempSchema.getBusinessNo04();
		this.BusinessNo05 = aFIAboriginalDataTempSchema.getBusinessNo05();
		this.BusinessNo06 = aFIAboriginalDataTempSchema.getBusinessNo06();
		this.BusinessNo07 = aFIAboriginalDataTempSchema.getBusinessNo07();
		this.BusinessNo08 = aFIAboriginalDataTempSchema.getBusinessNo08();
		this.BusinessNo09 = aFIAboriginalDataTempSchema.getBusinessNo09();
		this.BusinessNo10 = aFIAboriginalDataTempSchema.getBusinessNo10();
		this.TypeFlag01 = aFIAboriginalDataTempSchema.getTypeFlag01();
		this.TypeFlag02 = aFIAboriginalDataTempSchema.getTypeFlag02();
		this.TypeFlag03 = aFIAboriginalDataTempSchema.getTypeFlag03();
		this.TypeFlag04 = aFIAboriginalDataTempSchema.getTypeFlag04();
		this.TypeFlag05 = aFIAboriginalDataTempSchema.getTypeFlag05();
		this.TypeFlag06 = aFIAboriginalDataTempSchema.getTypeFlag06();
		this.TypeFlag07 = aFIAboriginalDataTempSchema.getTypeFlag07();
		this.TypeFlag08 = aFIAboriginalDataTempSchema.getTypeFlag08();
		this.TypeFlag09 = aFIAboriginalDataTempSchema.getTypeFlag09();
		this.TypeFlag10 = aFIAboriginalDataTempSchema.getTypeFlag10();
		this.Relationcode = aFIAboriginalDataTempSchema.getRelationcode();
		this.MakeDate = fDate.getDate( aFIAboriginalDataTempSchema.getMakeDate());
		this.MakeTime = aFIAboriginalDataTempSchema.getMakeTime();
		this.ReturnFlag = aFIAboriginalDataTempSchema.getReturnFlag();
		this.Voucherno = aFIAboriginalDataTempSchema.getVoucherno();
		this.Returndate = fDate.getDate( aFIAboriginalDataTempSchema.getReturndate());
		this.Returntime = aFIAboriginalDataTempSchema.getReturntime();
		this.Dealoperator = aFIAboriginalDataTempSchema.getDealoperator();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的FIAboriginalDataTemp表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "FIAboriginalDataTempSchema";
	...
	public FIAboriginalDataTempSchema getSchema()
	{
		FIAboriginalDataTempSchema aFIAboriginalDataTempSchema = new FIAboriginalDataTempSchema();
		aFIAboriginalDataTempSchema.setSchema(this);
		return aFIAboriginalDataTempSchema;
	}

	public FIAboriginalDataTempDB getDB()
	{
		FIAboriginalDataTempDB aDBOper = new FIAboriginalDataTempDB();
...
strReturn.append(StrTool.cTrim(Dealoperator));
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpFIAboriginalDataTemp>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			CostID = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 6, SysConst.PACKAGESPILTER );
			DataState = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 7, SysConst.PACKAGESPILTER );
			CheckFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 8, SysConst.PACKAGESPILTER );
			BusinessCode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 9, SysConst.PACKAGESPILTER );
			FeeCode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 10, SysConst.PACKAGESPILTER );
			SumActuMoney = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,11,SysConst.PACKAGESPILTER))).doubleValue();
			AccountDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 12,SysConst.PACKAGESPILTER));
			BusinessNo = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 13, SysConst.PACKAGESPILTER );
			StringInfo01 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 14, SysConst.PACKAGESPILTER );
			StringInfo02 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 15, SysConst.PACKAGESPILTER );
			StringInfo03 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 16, SysConst.PACKAGESPILTER );
			StringInfo04 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 17, SysConst.PACKAGESPILTER );
			StringInfo05 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 18, SysConst.PACKAGESPILTER );
			StringInfo06 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 19, SysConst.PACKAGESPILTER );
			StringInfo07 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 20, SysConst.PACKAGESPILTER );
			StringInfo08 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 21, SysConst.PACKAGESPILTER );
			StringInfo09 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 22, SysConst.PACKAGESPILTER );
			StringInfo10 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 23, SysConst.PACKAGESPILTER );
			StringInfo11 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 24, SysConst.PACKAGESPILTER );
			StringInfo12 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 25, SysConst.PACKAGESPILTER );
			StringInfo13 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 26, SysConst.PACKAGESPILTER );
			StringInfo14 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 27, SysConst.PACKAGESPILTER );
			StringInfo15 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 28, SysConst.PACKAGESPILTER );
			DateInfo01 = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 29,SysConst.PACKAGESPILTER));
			DateInfo02 = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 30,SysConst.PACKAGESPILTER));
			DateInfo03 = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 31,SysConst.PACKAGESPILTER));
			DateInfo04 = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 32,SysConst.PACKAGESPILTER));
			DateInfo05 = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 33,SysConst.PACKAGESPILTER));
			DateInfo06 = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 34,SysConst.PACKAGESPILTER));
			DateInfo07 = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 35,SysConst.PACKAGESPILTER));
			DateInfo08 = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 36,SysConst.PACKAGESPILTER));
			DateInfo09 = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 37,SysConst.PACKAGESPILTER));
			DateInfo10 = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 38,SysConst.PACKAGESPILTER));
			NumInfo01 = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,39,SysConst.PACKAGESPILTER))).doubleValue();
			NumInfo02 = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,40,SysConst.PACKAGESPILTER))).doubleValue();
			NumInfo03= new Integer(ChgData.chgNumericStr(StrTool.getStr(strMessage,41,SysConst.PACKAGESPILTER))).intValue();
			NumInfo04= new Integer(ChgData.chgNumericStr(StrTool.getStr(strMessage,42,SysConst.PACKAGESPILTER))).intValue();
			NumInfo05= new Integer(ChgData.chgNumericStr(StrTool.getStr(strMessage,43,SysConst.PACKAGESPILTER))).intValue();
			BusinessNo01 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 44, SysConst.PACKAGESPILTER );
			BusinessNo02 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 45, SysConst.PACKAGESPILTER );
			BusinessNo03 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 46, SysConst.PACKAGESPILTER );
			BusinessNo04 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 47, SysConst.PACKAGESPILTER );
			BusinessNo05 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 48, SysConst.PACKAGESPILTER );
			BusinessNo06 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 49, SysConst.PACKAGESPILTER );
			BusinessNo07 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 50, SysConst.PACKAGESPILTER );
			BusinessNo08 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 51, SysConst.PACKAGESPILTER );
			BusinessNo09 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 52, SysConst.PACKAGESPILTER );
			BusinessNo10 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 53, SysConst.PACKAGESPILTER );
			TypeFlag01 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 54, SysConst.PACKAGESPILTER );
			TypeFlag02 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 55, SysConst.PACKAGESPILTER );
			TypeFlag03 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 56, SysConst.PACKAGESPILTER );
			TypeFlag04 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 57, SysConst.PACKAGESPILTER );
			TypeFlag05 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 58, SysConst.PACKAGESPILTER );
			TypeFlag06 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 59, SysConst.PACKAGESPILTER );
			TypeFlag07 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 60, SysConst.PACKAGESPILTER );
			TypeFlag08 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 61, SysConst.PACKAGESPILTER );
			TypeFlag09 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 62, SysConst.PACKAGESPILTER );
			TypeFlag10 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 63, SysConst.PACKAGESPILTER );
			Relationcode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 64, SysConst.PACKAGESPILTER );
			...
			ReturnFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 67, SysConst.PACKAGESPILTER );
			Voucherno = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 68, SysConst.PACKAGESPILTER );
			Returndate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 69,SysConst.PACKAGESPILTER));
			Returntime = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 70, SysConst.PACKAGESPILTER );
			Dealoperator = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 71, SysConst.PACKAGESPILTER );
		}
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		FIAboriginalDataTempSchema other = (FIAboriginalDataTempSchema)otherObject;
		return
