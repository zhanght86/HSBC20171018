...
import com.sinosoft.lis.db.LCContPlanDetailRelaSubDB;

/*
 * <p>ClassName: LCContPlanDetailRelaSubSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 新单管理
 */
public class LCContPlanDetailRelaSubSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LCContPlanDetailRelaSubSchema.class);
	// @Field
	/** 保单号码 */
	...
	// @Constructor
	public LCContPlanDetailRelaSubSchema()
	{
		mErrors = new CErrors();
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LCContPlanDetailRelaSubSchema cloned = (LCContPlanDetailRelaSubSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LCContPlanDetailRelaSubSchema 对象给 Schema 赋值
	* @param: aLCContPlanDetailRelaSubSchema LCContPlanDetailRelaSubSchema
	**/
	public void setSchema(LCContPlanDetailRelaSubSchema aLCContPlanDetailRelaSubSchema)
	{
		this.PolicyNo = aLCContPlanDetailRelaSubSchema.getPolicyNo();
		this.PropNo = aLCContPlanDetailRelaSubSchema.getPropNo();
		this.SysPlanCode = aLCContPlanDetailRelaSubSchema.getSysPlanCode();
		this.PlanCode = aLCContPlanDetailRelaSubSchema.getPlanCode();
		this.RiskCode = aLCContPlanDetailRelaSubSchema.getRiskCode();
		this.DutyCode = aLCContPlanDetailRelaSubSchema.getDutyCode();
		this.RelaToMain = aLCContPlanDetailRelaSubSchema.getRelaToMain();
		this.MainAmntRate = aLCContPlanDetailRelaSubSchema.getMainAmntRate();
		this.RelaAmntRate = aLCContPlanDetailRelaSubSchema.getRelaAmntRate();
		this.P1 = aLCContPlanDetailRelaSubSchema.getP1();
		this.P2 = aLCContPlanDetailRelaSubSchema.getP2();
		this.P3 = aLCContPlanDetailRelaSubSchema.getP3();
		this.P4 = aLCContPlanDetailRelaSubSchema.getP4();
		this.P5 = aLCContPlanDetailRelaSubSchema.getP5();
		this.P6 = aLCContPlanDetailRelaSubSchema.getP6();
		this.P7 = aLCContPlanDetailRelaSubSchema.getP7();
		this.P8 = aLCContPlanDetailRelaSubSchema.getP8();
		this.P9 = aLCContPlanDetailRelaSubSchema.getP9();
		this.P10 = aLCContPlanDetailRelaSubSchema.getP10();
		this.P11 = aLCContPlanDetailRelaSubSchema.getP11();
		this.P12 = aLCContPlanDetailRelaSubSchema.getP12();
		this.P13 = aLCContPlanDetailRelaSubSchema.getP13();
		this.P14 = aLCContPlanDetailRelaSubSchema.getP14();
		this.P15 = aLCContPlanDetailRelaSubSchema.getP15();
		this.P16 = aLCContPlanDetailRelaSubSchema.getP16();
		this.P17 = aLCContPlanDetailRelaSubSchema.getP17();
		this.P18 = aLCContPlanDetailRelaSubSchema.getP18();
		this.P19 = aLCContPlanDetailRelaSubSchema.getP19();
		this.P20 = aLCContPlanDetailRelaSubSchema.getP20();
		this.P21 = aLCContPlanDetailRelaSubSchema.getP21();
		this.P22 = aLCContPlanDetailRelaSubSchema.getP22();
		this.P23 = aLCContPlanDetailRelaSubSchema.getP23();
		this.P24 = aLCContPlanDetailRelaSubSchema.getP24();
		this.P25 = aLCContPlanDetailRelaSubSchema.getP25();
		this.P26 = aLCContPlanDetailRelaSubSchema.getP26();
		this.P27 = aLCContPlanDetailRelaSubSchema.getP27();
		this.P28 = aLCContPlanDetailRelaSubSchema.getP28();
		this.P29 = aLCContPlanDetailRelaSubSchema.getP29();
		this.P30 = aLCContPlanDetailRelaSubSchema.getP30();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LCContPlanDetailRelaSub表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LCContPlanDetailRelaSubSchema";
	...
	public LCContPlanDetailRelaSubSchema getSchema()
	{
		LCContPlanDetailRelaSubSchema aLCContPlanDetailRelaSubSchema = new LCContPlanDetailRelaSubSchema();
		aLCContPlanDetailRelaSubSchema.setSchema(this);
		return aLCContPlanDetailRelaSubSchema;
	}

	public LCContPlanDetailRelaSubDB getDB()
	{
		LCContPlanDetailRelaSubDB aDBOper = new LCContPlanDetailRelaSubDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLCContPlanDetailRelaSub描述/A>表字段
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLCContPlanDetailRelaSub>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			RelaToMain = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 7, SysConst.PACKAGESPILTER );
			MainAmntRate = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 8, SysConst.PACKAGESPILTER );
			RelaAmntRate = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 9, SysConst.PACKAGESPILTER );
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LCContPlanDetailRelaSubSchema other = (LCContPlanDetailRelaSubSchema)otherObject;
		return
