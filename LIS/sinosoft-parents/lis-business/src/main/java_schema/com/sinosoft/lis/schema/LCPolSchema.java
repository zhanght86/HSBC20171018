...
{
private static Logger logger = Logger.getLogger(LCPolSchema.class);
	// @Field
	/** 集体合同号码 */
	...
	public static final int FIELDNUM = 154;	// 数据库表的字段个数
	...
	**/
	public void setSchema(LCPolSchema aLCPolSchema)
	{
		...
		this.PCValiDate = fDate.getDate( aLCPolSchema.getPCValiDate());
		this.RiskSequence = aLCPolSchema.getRiskSequence();
		this.CancleForegetSpecFlag = aLCPolSchema.getCancleForegetSpecFlag();
		this.TakeDate = fDate.getDate( aLCPolSchema.getTakeDate());
		this.TakeTime = aLCPolSchema.getTakeTime();
		this.AirNo = aLCPolSchema.getAirNo();
		this.TicketNo = aLCPolSchema.getTicketNo();
		this.SeatNo = aLCPolSchema.getSeatNo();
		this.InputPrem = aLCPolSchema.getInputPrem();
		this.Currency = aLCPolSchema.getCurrency();
		this.InvestRuleCode = aLCPolSchema.getInvestRuleCode();
		this.UintLinkValiFlag = aLCPolSchema.getUintLinkValiFlag();
		this.RenewContNo = aLCPolSchema.getRenewContNo();
		this.InitNumPeople = aLCPolSchema.getInitNumPeople();
		this.InitMult = aLCPolSchema.getInitMult();
		this.InitAmnt = aLCPolSchema.getInitAmnt();
		this.InitRiskAmnt = aLCPolSchema.getInitRiskAmnt();
		this.InitPrem = aLCPolSchema.getInitPrem();
		this.InitStandPrem = aLCPolSchema.getInitStandPrem();
		this.InitPeriodPrem = aLCPolSchema.getInitPeriodPrem();
		this.PeriodPrem = aLCPolSchema.getPeriodPrem();
		this.SumNumPeople = aLCPolSchema.getSumNumPeople();
		this.PremCalMode = aLCPolSchema.getPremCalMode();
		this.Lang = aLCPolSchema.getLang();
		this.ChargeFeeRate = aLCPolSchema.getChargeFeeRate();
		this.CommRate = aLCPolSchema.getCommRate();
		this.GradeFeeRate = aLCPolSchema.getGradeFeeRate();
		this.OtherFeeRate = aLCPolSchema.getOtherFeeRate();
		this.AddFeeRate = aLCPolSchema.getAddFeeRate();
		this.AddFee = aLCPolSchema.getAddFee();
		this.ComCode = aLCPolSchema.getComCode();
		this.ModifyOperator = aLCPolSchema.getModifyOperator();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LCPol表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			AutoPubAccFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 121, SysConst.PACKAGESPILTER );
			AscriptionFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 122, SysConst.PACKAGESPILTER );
			PCValiDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 123,SysConst.PACKAGESPILTER));
			...
			Currency = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 132, SysConst.PACKAGESPILTER );
			InvestRuleCode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 133, SysConst.PACKAGESPILTER );
			UintLinkValiFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 134, SysConst.PACKAGESPILTER );
			RenewContNo = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 135, SysConst.PACKAGESPILTER );
			InitNumPeople= new Integer(ChgData.chgNumericStr(StrTool.getStr(strMessage,136,SysConst.PACKAGESPILTER))).intValue();
			InitMult = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,137,SysConst.PACKAGESPILTER))).doubleValue();
			InitAmnt = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,138,SysConst.PACKAGESPILTER))).doubleValue();
			InitRiskAmnt = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,139,SysConst.PACKAGESPILTER))).doubleValue();
			InitPrem = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,140,SysConst.PACKAGESPILTER))).doubleValue();
			InitStandPrem = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,141,SysConst.PACKAGESPILTER))).doubleValue();
			InitPeriodPrem = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,142,SysConst.PACKAGESPILTER))).doubleValue();
			PeriodPrem = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,143,SysConst.PACKAGESPILTER))).doubleValue();
			SumNumPeople= new Integer(ChgData.chgNumericStr(StrTool.getStr(strMessage,144,SysConst.PACKAGESPILTER))).intValue();
			PremCalMode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 145, SysConst.PACKAGESPILTER );
			Lang = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 146, SysConst.PACKAGESPILTER );
			ChargeFeeRate = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,147,SysConst.PACKAGESPILTER))).doubleValue();
			CommRate = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,148,SysConst.PACKAGESPILTER))).doubleValue();
			GradeFeeRate = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,149,SysConst.PACKAGESPILTER))).doubleValue();
			OtherFeeRate = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,150,SysConst.PACKAGESPILTER))).doubleValue();
			AddFeeRate = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,151,SysConst.PACKAGESPILTER))).doubleValue();
			AddFee = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,152,SysConst.PACKAGESPILTER))).doubleValue();
			ComCode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 153, SysConst.PACKAGESPILTER );
			ModifyOperator = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 154, SysConst.PACKAGESPILTER );
		}
