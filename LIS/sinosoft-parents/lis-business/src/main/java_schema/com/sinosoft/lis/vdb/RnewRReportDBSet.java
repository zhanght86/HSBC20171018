...
/*
 * <p>ClassName: RnewRReportDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 续期续保二核
 */
public class RnewRReportDBSet extends RnewRReportSet
{
private static Logger logger = Logger.getLogger(RnewRReportDBSet.class);
	...
	**/
	...
	// @Constructor
	public RnewRReportDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "RnewRReportDBSet";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getProposalContNo() == null || this.get(i).getProposalContNo().equals("null")) {
				...
				pstmt.setString(25, this.get(i).getProposalContNo());
			}
			if(this.get(i).getPrtSeq() == null || this.get(i).getPrtSeq().equals("null")) {
				pstmt.setString(26,null);
			} else {
				pstmt.setString(26, this.get(i).getPrtSeq());
			}
