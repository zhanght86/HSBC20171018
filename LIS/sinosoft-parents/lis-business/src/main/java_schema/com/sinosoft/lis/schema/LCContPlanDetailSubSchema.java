...
import com.sinosoft.lis.db.LCContPlanDetailSubDB;

/*
 * <p>ClassName: LCContPlanDetailSubSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 新单管理
 */
public class LCContPlanDetailSubSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LCContPlanDetailSubSchema.class);
	// @Field
	/** 保单号码 */
	...
	// @Constructor
	public LCContPlanDetailSubSchema()
	{
		mErrors = new CErrors();
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LCContPlanDetailSubSchema cloned = (LCContPlanDetailSubSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LCContPlanDetailSubSchema 对象给 Schema 赋值
	* @param: aLCContPlanDetailSubSchema LCContPlanDetailSubSchema
	**/
	public void setSchema(LCContPlanDetailSubSchema aLCContPlanDetailSubSchema)
	{
		this.PolicyNo = aLCContPlanDetailSubSchema.getPolicyNo();
		this.PropNo = aLCContPlanDetailSubSchema.getPropNo();
		this.SysPlanCode = aLCContPlanDetailSubSchema.getSysPlanCode();
		this.PlanCode = aLCContPlanDetailSubSchema.getPlanCode();
		this.RiskCode = aLCContPlanDetailSubSchema.getRiskCode();
		this.DutyCode = aLCContPlanDetailSubSchema.getDutyCode();
		this.P1 = aLCContPlanDetailSubSchema.getP1();
		this.P2 = aLCContPlanDetailSubSchema.getP2();
		this.P3 = aLCContPlanDetailSubSchema.getP3();
		this.P4 = aLCContPlanDetailSubSchema.getP4();
		this.P5 = aLCContPlanDetailSubSchema.getP5();
		this.P6 = aLCContPlanDetailSubSchema.getP6();
		this.P7 = aLCContPlanDetailSubSchema.getP7();
		this.P8 = aLCContPlanDetailSubSchema.getP8();
		this.P9 = aLCContPlanDetailSubSchema.getP9();
		this.P10 = aLCContPlanDetailSubSchema.getP10();
		this.P11 = aLCContPlanDetailSubSchema.getP11();
		this.P12 = aLCContPlanDetailSubSchema.getP12();
		this.P13 = aLCContPlanDetailSubSchema.getP13();
		this.P14 = aLCContPlanDetailSubSchema.getP14();
		this.P15 = aLCContPlanDetailSubSchema.getP15();
		this.P16 = aLCContPlanDetailSubSchema.getP16();
		this.P17 = aLCContPlanDetailSubSchema.getP17();
		this.P18 = aLCContPlanDetailSubSchema.getP18();
		this.P19 = aLCContPlanDetailSubSchema.getP19();
		this.P20 = aLCContPlanDetailSubSchema.getP20();
		this.P21 = aLCContPlanDetailSubSchema.getP21();
		this.P22 = aLCContPlanDetailSubSchema.getP22();
		this.P23 = aLCContPlanDetailSubSchema.getP23();
		this.P24 = aLCContPlanDetailSubSchema.getP24();
		this.P25 = aLCContPlanDetailSubSchema.getP25();
		this.P26 = aLCContPlanDetailSubSchema.getP26();
		this.P27 = aLCContPlanDetailSubSchema.getP27();
		this.P28 = aLCContPlanDetailSubSchema.getP28();
		this.P29 = aLCContPlanDetailSubSchema.getP29();
		this.P30 = aLCContPlanDetailSubSchema.getP30();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LCContPlanDetailSub表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LCContPlanDetailSubSchema";
	...
	public LCContPlanDetailSubSchema getSchema()
	{
		LCContPlanDetailSubSchema aLCContPlanDetailSubSchema = new LCContPlanDetailSubSchema();
		aLCContPlanDetailSubSchema.setSchema(this);
		return aLCContPlanDetailSubSchema;
	}

	public LCContPlanDetailSubDB getDB()
	{
		LCContPlanDetailSubDB aDBOper = new LCContPlanDetailSubDB();
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLCContPlanDetailSub>历史记账凭证主表信息</A>表字段
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LCContPlanDetailSubSchema other = (LCContPlanDetailSubSchema)otherObject;
		return
