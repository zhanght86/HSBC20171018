...
/*
 * <p>ClassName: PD_LDStaffRateSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: PD_LDStaffRate
 */
public class PD_LDStaffRateSchema implements Schema, Cloneable
{
	// @Field
	/** 流水號 */
	private String IDNo;
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		PD_LDStaffRateSchema cloned = (PD_LDStaffRateSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 PD_LDStaffRateSchema 对象给 Schema 赋值
	* @param: aPD_LDStaffRateSchema PD_LDStaffRateSchema
	**/
	public void setSchema(PD_LDStaffRateSchema aPD_LDStaffRateSchema)
	{
		this.IDNo = aPD_LDStaffRateSchema.getIDNo();
		this.AgentCom = aPD_LDStaffRateSchema.getAgentCom();
		this.ManageCom = aPD_LDStaffRateSchema.getManageCom();
		this.RiskCode = aPD_LDStaffRateSchema.getRiskCode();
		this.PayYear = aPD_LDStaffRateSchema.getPayYear();
		this.Currency = aPD_LDStaffRateSchema.getCurrency();
		this.InvestType = aPD_LDStaffRateSchema.getInvestType();
		this.PayType = aPD_LDStaffRateSchema.getPayType();
		this.ProtectionPlan = aPD_LDStaffRateSchema.getProtectionPlan();
		this.PayYears = aPD_LDStaffRateSchema.getPayYears();
		this.CommRate = aPD_LDStaffRateSchema.getCommRate();
		this.StartDate = fDate.getDate( aPD_LDStaffRateSchema.getStartDate());
		this.EndDate = fDate.getDate( aPD_LDStaffRateSchema.getEndDate());
		this.ValidFlag = aPD_LDStaffRateSchema.getValidFlag();
		this.AppState = aPD_LDStaffRateSchema.getAppState();
		this.AppDate = fDate.getDate( aPD_LDStaffRateSchema.getAppDate());
		this.AppTime = aPD_LDStaffRateSchema.getAppTime();
		this.Branchtype = aPD_LDStaffRateSchema.getBranchtype();
		this.ActionType = aPD_LDStaffRateSchema.getActionType();
		this.OrigIDNo = aPD_LDStaffRateSchema.getOrigIDNo();
		this.Operator = aPD_LDStaffRateSchema.getOperator();
		this.MakeDate = fDate.getDate( aPD_LDStaffRateSchema.getMakeDate());
		this.MakeTime = aPD_LDStaffRateSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aPD_LDStaffRateSchema.getModifyDate());
		this.ModifyTime = aPD_LDStaffRateSchema.getModifyTime();
		this.StaffRate = aPD_LDStaffRateSchema.getStaffRate();
		this.InsureAgeStart = aPD_LDStaffRateSchema.getInsureAgeStart();
		this.InsureAgeEnd = aPD_LDStaffRateSchema.getInsureAgeEnd();
		this.PayToAge = aPD_LDStaffRateSchema.getPayToAge();
		this.DefaultFlag = aPD_LDStaffRateSchema.getDefaultFlag();
		this.SRFlag = aPD_LDStaffRateSchema.getSRFlag();
		this.PlanCode = aPD_LDStaffRateSchema.getPlanCode();
		this.Insuyear = aPD_LDStaffRateSchema.getInsuyear();
		this.InsuyearFlag = aPD_LDStaffRateSchema.getInsuyearFlag();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			System.out.println("数据库中的PD_LDStaffRate表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			sqle.printStackTrace();
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "PD_LDStaffRateSchema";
	...
	public PD_LDStaffRateSchema getSchema()
	{
		PD_LDStaffRateSchema aPD_LDStaffRateSchema = new PD_LDStaffRateSchema();
		aPD_LDStaffRateSchema.setSchema(this);
		return aPD_LDStaffRateSchema;
	}

	public PD_LDStaffRateDB getDB()
	{
		PD_LDStaffRateDB aDBOper = new PD_LDStaffRateDB();
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpPD_LDStaffRate>历史记账凭证主表信息</A>表字段
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		PD_LDStaffRateSchema other = (PD_LDStaffRateSchema)otherObject;
		return
