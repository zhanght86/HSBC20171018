...
/*
 * <p>ClassName: LCInsuredRelatedSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 承保核心
 */
public class LCInsuredRelatedSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LCInsuredRelatedSchema.class);
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LCInsuredRelatedSchema cloned = (LCInsuredRelatedSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LCInsuredRelatedSchema 对象给 Schema 赋值
	* @param: aLCInsuredRelatedSchema LCInsuredRelatedSchema
	**/
	public void setSchema(LCInsuredRelatedSchema aLCInsuredRelatedSchema)
	{
		this.PolNo = aLCInsuredRelatedSchema.getPolNo();
		this.CustomerNo = aLCInsuredRelatedSchema.getCustomerNo();
		this.MainCustomerNo = aLCInsuredRelatedSchema.getMainCustomerNo();
		this.RelationToInsured = aLCInsuredRelatedSchema.getRelationToInsured();
		this.AddressNo = aLCInsuredRelatedSchema.getAddressNo();
		this.Name = aLCInsuredRelatedSchema.getName();
		this.Sex = aLCInsuredRelatedSchema.getSex();
		this.Birthday = fDate.getDate( aLCInsuredRelatedSchema.getBirthday());
		this.IDType = aLCInsuredRelatedSchema.getIDType();
		this.IDNo = aLCInsuredRelatedSchema.getIDNo();
		this.Operator = aLCInsuredRelatedSchema.getOperator();
		this.MakeDate = fDate.getDate( aLCInsuredRelatedSchema.getMakeDate());
		this.MakeTime = aLCInsuredRelatedSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLCInsuredRelatedSchema.getModifyDate());
		this.ModifyTime = aLCInsuredRelatedSchema.getModifyTime();
		this.SequenceNo = aLCInsuredRelatedSchema.getSequenceNo();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LCInsuredRelated表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LCInsuredRelatedSchema";
	...
	public LCInsuredRelatedSchema getSchema()
	{
		LCInsuredRelatedSchema aLCInsuredRelatedSchema = new LCInsuredRelatedSchema();
		aLCInsuredRelatedSchema.setSchema(this);
		return aLCInsuredRelatedSchema;
	}

	public LCInsuredRelatedDB getDB()
	{
		LCInsuredRelatedDB aDBOper = new LCInsuredRelatedDB();
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLCInsuredRelated>历史记账凭证主表信息</A>表字段
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LCInsuredRelatedSchema other = (LCInsuredRelatedSchema)otherObject;
		return
