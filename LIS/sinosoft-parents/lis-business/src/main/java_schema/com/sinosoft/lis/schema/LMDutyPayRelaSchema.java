...
/*
 * <p>ClassName: LMDutyPayRelaSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 新险种定义
 */
public class LMDutyPayRelaSchema implements Schema, Cloneable
{
	// @Field
	/** 责任代码 */
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LMDutyPayRelaSchema cloned = (LMDutyPayRelaSchema)super.clone();
	...
	/**
	* 使用另外一个 LMDutyPayRelaSchema 对象给 Schema 赋值
	* @param: aLMDutyPayRelaSchema LMDutyPayRelaSchema
	**/
	public void setSchema(LMDutyPayRelaSchema aLMDutyPayRelaSchema)
	{
		this.DutyCode = aLMDutyPayRelaSchema.getDutyCode();
		this.PayPlanCode = aLMDutyPayRelaSchema.getPayPlanCode();
		this.PayPlanName = aLMDutyPayRelaSchema.getPayPlanName();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			System.out.println("数据库中的LMDutyPayRela表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LMDutyPayRelaSchema";
	...
	public LMDutyPayRelaSchema getSchema()
	{
		LMDutyPayRelaSchema aLMDutyPayRelaSchema = new LMDutyPayRelaSchema();
		aLMDutyPayRelaSchema.setSchema(this);
		return aLMDutyPayRelaSchema;
	}

	public LMDutyPayRelaDB getDB()
	{
		LMDutyPayRelaDB aDBOper = new LMDutyPayRelaDB();
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLMDutyPayRela>历史记账凭证主表信息</A>表字段
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LMDutyPayRelaSchema other = (LMDutyPayRelaSchema)otherObject;
		return
