...
/*
 * <p>ClassName: LCPENoticeDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 承保流程
 */
public class LCPENoticeDBSet extends LCPENoticeSet
{
private static Logger logger = Logger.getLogger(LCPENoticeDBSet.class);
	...
	**/
	...
	// @Constructor
	public LCPENoticeDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LCPENoticeDBSet";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getSendDate() == null || this.get(i).getSendDate().equals("null")) {
				...
				pstmt.setDate(31, Date.valueOf(this.get(i).getSendDate()));
			}
			if(this.get(i).getSendTime() == null || this.get(i).getSendTime().equals("null")) {
				pstmt.setString(32,null);
			} else {
				pstmt.setString(32, this.get(i).getSendTime());
			}
			// set where condition
			if(this.get(i).getProposalContNo() == null || this.get(i).getProposalContNo().equals("null")) {
			...
			if(this.get(i).getPrtSeq() == null || this.get(i).getPrtSeq().equals("null")) {
				...
				pstmt.setString(34, this.get(i).getPrtSeq());
			}
			if(this.get(i).getCustomerNo() == null || this.get(i).getCustomerNo().equals("null")) {
				pstmt.setString(35,null);
			} else {
				pstmt.setString(35, this.get(i).getCustomerNo());
			}
