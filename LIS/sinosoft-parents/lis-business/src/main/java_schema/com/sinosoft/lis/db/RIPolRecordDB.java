...
/*
 * <p>ClassName: RIPolRecordDB </p>
 * <p>Description: DB层数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 再保系统模型
 */
public class RIPolRecordDB extends RIPolRecordSchema
{
	// @Field
	...
	**/
	...
	// @Constructor
	public RIPolRecordDB( Connection tConnection )
	{
		con = tConnection;
	...
	{
		RIPolRecordSchema tSchema = this.getSchema();
		...
		else
		{
			...
			tError.moduleName = "RIPolRecordDB";
	...
	public boolean getInfo()
	{
		...
		try
		{
			pstmt = con.prepareStatement("SELECT * FROM RIPolRecord WHERE  EventNo = ?", 
	...
	public RIPolRecordSet query()
	{
		Statement stmt = null;
		ResultSet rs = null;
		RIPolRecordSet aRIPolRecordSet = new RIPolRecordSet();
	  ...
	  if( !mflag ) {
		...
		try
		{
			...
			SQLString sqlObj = new SQLString("RIPolRecord");
			RIPolRecordSchema aSchema = this.getSchema();
			...
			{
				i++;
				RIPolRecordSchema s1 = new RIPolRecordSchema();
				s1.setSchema(rs,i);
				aRIPolRecordSet.add(s1);
			}
			try{ rs.close(); } catch( Exception ex ) {}
		...
		return aRIPolRecordSet;
	}

	public RIPolRecordSet executeQuery(String sql)
	{
		Statement stmt = null;
		ResultSet rs = null;
		RIPolRecordSet aRIPolRecordSet = new RIPolRecordSet();
	...
	public RIPolRecordSet query(int nStart, int nCount)
	{
		Statement stmt = null;
		ResultSet rs = null;
		RIPolRecordSet aRIPolRecordSet = new RIPolRecordSet();
	...
	public RIPolRecordSet executeQuery(String sql, int nStart, int nCount)
	{
		Statement stmt = null;
		ResultSet rs = null;
		RIPolRecordSet aRIPolRecordSet = new RIPolRecordSet();
	...
	public boolean update(String strWherePart)
	{
	  ...
	  if( !mflag ) {
		...
		try
		{
			...
			String sql = "update RIPolRecord " + sqlObj.getUpdPart() + " where " + strWherePart;
...
/**
 * 获取定量数据
 * @return RIPolRecordSet
 */
public RIPolRecordSet getData()
{
    int tCount = 0;
    RIPolRecordSet tRIPolRecordSet = new RIPolRecordSet();
    RIPolRecordSchema tRIPolRecordSchema = null;
    if (null == mResultSet)
    {
        CError tError = new CError();
        tError.moduleName = "RIPolRecordDB";
    ...
    {
        tCount = 1;
        tRIPolRecordSchema = new RIPolRecordSchema();
        tRIPolRecordSchema.setSchema(mResultSet, 1);
        tRIPolRecordSet.add(tRIPolRecordSchema);
