...
/*
 * <p>ClassName: LCGetBakDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: PhysicalDataModel_1
 */
public class LCGetBakDBSet extends LCGetBakSet
{
private static Logger logger = Logger.getLogger(LCGetBakDBSet.class);
	...
	**/
	...
	// @Constructor
	public LCGetBakDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LCGetBakDBSet";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getDutyCode() == null || this.get(i).getDutyCode().equals("null")) {
				...
				pstmt.setString(34, this.get(i).getDutyCode());
			}
			if(this.get(i).getGetDutyCode() == null || this.get(i).getGetDutyCode().equals("null")) {
