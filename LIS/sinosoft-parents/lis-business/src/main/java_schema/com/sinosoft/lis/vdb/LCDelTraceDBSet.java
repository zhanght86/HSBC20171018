...
/*
 * <p>ClassName: LCDelTraceDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 承保流程
 */
public class LCDelTraceDBSet extends LCDelTraceSet
{
private static Logger logger = Logger.getLogger(LCDelTraceDBSet.class);
	...
	**/
	...
	// @Constructor
	public LCDelTraceDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LCDelTraceDBSet";
