...
/*
 * <p>ClassName: LCPremBakDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: PhysicalDataModel_1
 */
public class LCPremBakDBSet extends LCPremBakSet
{
private static Logger logger = Logger.getLogger(LCPremBakDBSet.class);
	...
	**/
	...
	// @Constructor
	public LCPremBakDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LCPremBakDBSet";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getPayPlanCode() == null || this.get(i).getPayPlanCode().equals("null")) {
				...
				pstmt.setString(36, this.get(i).getPayPlanCode());
			}
