...
import com.sinosoft.lis.db.LPPolicyPosParaTraceDB;

/*
 * <p>ClassName: LPPolicyPosParaTraceSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: Physical Data Model 1
 */
public class LPPolicyPosParaTraceSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LPPolicyPosParaTraceSchema.class);
	// @Field
	/** 轨迹号 */
	...
	// @Constructor
	public LPPolicyPosParaTraceSchema()
	{
		mErrors = new CErrors();
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LPPolicyPosParaTraceSchema cloned = (LPPolicyPosParaTraceSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LPPolicyPosParaTraceSchema 对象给 Schema 赋值
	* @param: aLPPolicyPosParaTraceSchema LPPolicyPosParaTraceSchema
	**/
	public void setSchema(LPPolicyPosParaTraceSchema aLPPolicyPosParaTraceSchema)
	{
		this.TraceNo = aLPPolicyPosParaTraceSchema.getTraceNo();
		this.TraceType = aLPPolicyPosParaTraceSchema.getTraceType();
		this.SerialNo = aLPPolicyPosParaTraceSchema.getSerialNo();
		this.PolicyNo = aLPPolicyPosParaTraceSchema.getPolicyNo();
		this.BussType = aLPPolicyPosParaTraceSchema.getBussType();
		this.PumpDays = aLPPolicyPosParaTraceSchema.getPumpDays();
		this.GracePeriod = aLPPolicyPosParaTraceSchema.getGracePeriod();
		this.Segment1 = aLPPolicyPosParaTraceSchema.getSegment1();
		this.Segment2 = aLPPolicyPosParaTraceSchema.getSegment2();
		this.Segment3 = aLPPolicyPosParaTraceSchema.getSegment3();
		this.MakeOperator = aLPPolicyPosParaTraceSchema.getMakeOperator();
		this.MakeDate = fDate.getDate( aLPPolicyPosParaTraceSchema.getMakeDate());
		this.MakeTime = aLPPolicyPosParaTraceSchema.getMakeTime();
		this.ModifyOperator = aLPPolicyPosParaTraceSchema.getModifyOperator();
		this.ModifyDate = fDate.getDate( aLPPolicyPosParaTraceSchema.getModifyDate());
		this.ModifyTime = aLPPolicyPosParaTraceSchema.getModifyTime();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LPPolicyPosParaTrace表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LPPolicyPosParaTraceSchema";
	...
	public LPPolicyPosParaTraceSchema getSchema()
	{
		LPPolicyPosParaTraceSchema aLPPolicyPosParaTraceSchema = new LPPolicyPosParaTraceSchema();
		aLPPolicyPosParaTraceSchema.setSchema(this);
		return aLPPolicyPosParaTraceSchema;
	}

	public LPPolicyPosParaTraceDB getDB()
	{
		LPPolicyPosParaTraceDB aDBOper = new LPPolicyPosParaTraceDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLPPolicyPosParaTrace描述/A>表字段
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLPPolicyPosParaTrace>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			PumpDays= new Integer(ChgData.chgNumericStr(StrTool.getStr(strMessage,6,SysConst.PACKAGESPILTER))).intValue();
			GracePeriod = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 7, SysConst.PACKAGESPILTER );
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LPPolicyPosParaTraceSchema other = (LPPolicyPosParaTraceSchema)otherObject;
		return
