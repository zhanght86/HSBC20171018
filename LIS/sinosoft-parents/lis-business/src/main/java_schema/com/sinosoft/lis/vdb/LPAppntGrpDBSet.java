...
/*
 * <p>ClassName: LPAppntGrpDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 寿险业务系统lis5模型
 */
public class LPAppntGrpDBSet extends LPAppntGrpSet
{
private static Logger logger = Logger.getLogger(LPAppntGrpDBSet.class);
	...
	**/
	...
	// @Constructor
	public LPAppntGrpDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LPAppntGrpDBSet";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getGrpNo() == null || this.get(i).getGrpNo().equals("null")) {
				...
				pstmt.setString(4, this.get(i).getGrpNo());
			}
			...
			if(this.get(i).getFoundDate() == null || this.get(i).getFoundDate().equals("null")) {
				...
				pstmt.setDate(38, Date.valueOf(this.get(i).getFoundDate()));
			}
			...
			if(this.get(i).getBankCode() == null || this.get(i).getBankCode().equals("null")) {
				...
				pstmt.setString(40, this.get(i).getBankCode());
			}
			if(this.get(i).getGrpGroupNo() == null || this.get(i).getGrpGroupNo().equals("null")) {
				pstmt.setString(41,null);
			} else {
				pstmt.setString(41, this.get(i).getGrpGroupNo());
			}
			if(this.get(i).getState() == null || this.get(i).getState().equals("null")) {
				pstmt.setString(42,null);
			} else {
				pstmt.setString(42, this.get(i).getState());
			}
			...
			if(this.get(i).getEdorNo() == null || this.get(i).getEdorNo().equals("null")) {
				...
				pstmt.setString(50, this.get(i).getEdorNo());
			}
			if(this.get(i).getEdorType() == null || this.get(i).getEdorType().equals("null")) {
				pstmt.setString(51,null);
			} else {
				pstmt.setString(51, this.get(i).getEdorType());
			}
