...
import com.sinosoft.lis.db.LDPreGrpSalerDB;

/*
 * <p>ClassName: LDPreGrpSalerSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: Physical Data Model 1
 */
public class LDPreGrpSalerSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LDPreGrpSalerSchema.class);
	// @Field
	/** 准客户号码 */
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LDPreGrpSalerSchema cloned = (LDPreGrpSalerSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LDPreGrpSalerSchema 对象给 Schema 赋值
	* @param: aLDPreGrpSalerSchema LDPreGrpSalerSchema
	**/
	public void setSchema(LDPreGrpSalerSchema aLDPreGrpSalerSchema)
	{
		this.PreCustomerNo = aLDPreGrpSalerSchema.getPreCustomerNo();
		this.SalerType = aLDPreGrpSalerSchema.getSalerType();
		this.SalerCode = aLDPreGrpSalerSchema.getSalerCode();
		this.MakeOperator = aLDPreGrpSalerSchema.getMakeOperator();
		this.MakeDate = fDate.getDate( aLDPreGrpSalerSchema.getMakeDate());
		this.MakeTime = aLDPreGrpSalerSchema.getMakeTime();
		this.ModifyOperator = aLDPreGrpSalerSchema.getModifyOperator();
		this.ModifyDate = fDate.getDate( aLDPreGrpSalerSchema.getModifyDate());
		this.ModifyTime = aLDPreGrpSalerSchema.getModifyTime();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LDPreGrpSaler表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LDPreGrpSalerSchema";
	...
	public LDPreGrpSalerSchema getSchema()
	{
		LDPreGrpSalerSchema aLDPreGrpSalerSchema = new LDPreGrpSalerSchema();
		aLDPreGrpSalerSchema.setSchema(this);
		return aLDPreGrpSalerSchema;
	}

	public LDPreGrpSalerDB getDB()
	{
		LDPreGrpSalerDB aDBOper = new LDPreGrpSalerDB();
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLDPreGrpSaler>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			SalerType = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 2, SysConst.PACKAGESPILTER );
			SalerCode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 3, SysConst.PACKAGESPILTER );
			MakeOperator = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 4, SysConst.PACKAGESPILTER );
			...
			ModifyOperator = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 7, SysConst.PACKAGESPILTER );
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LDPreGrpSalerSchema other = (LDPreGrpSalerSchema)otherObject;
		return
