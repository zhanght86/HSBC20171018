...
/*
 * <p>ClassName: ES_DOC_PAGESSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: bug4
 */
public class ES_DOC_PAGESSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(ES_DOC_PAGESSchema.class);
	// @Field
	/** 页编号 */
	private int PageID;
	/** 单证编号 */
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		ES_DOC_PAGESSchema cloned = (ES_DOC_PAGESSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 ES_DOC_PAGESSchema 对象给 Schema 赋值
	* @param: aES_DOC_PAGESSchema ES_DOC_PAGESSchema
	**/
	public void setSchema(ES_DOC_PAGESSchema aES_DOC_PAGESSchema)
	{
		this.PageID = aES_DOC_PAGESSchema.getPageID();
		this.DocID = aES_DOC_PAGESSchema.getDocID();
		this.PageCode = aES_DOC_PAGESSchema.getPageCode();
		this.HostName = aES_DOC_PAGESSchema.getHostName();
		this.PageName = aES_DOC_PAGESSchema.getPageName();
		this.PageSuffix = aES_DOC_PAGESSchema.getPageSuffix();
		this.PicPathFTP = aES_DOC_PAGESSchema.getPicPathFTP();
		this.PageFlag = aES_DOC_PAGESSchema.getPageFlag();
		this.PicPath = aES_DOC_PAGESSchema.getPicPath();
		this.PageType = aES_DOC_PAGESSchema.getPageType();
		this.ManageCom = aES_DOC_PAGESSchema.getManageCom();
		this.Operator = aES_DOC_PAGESSchema.getOperator();
		this.MakeDate = fDate.getDate( aES_DOC_PAGESSchema.getMakeDate());
		this.MakeTime = aES_DOC_PAGESSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aES_DOC_PAGESSchema.getModifyDate());
		this.ModifyTime = aES_DOC_PAGESSchema.getModifyTime();
		this.ScanNo = aES_DOC_PAGESSchema.getScanNo();
		this.FNDocKey = aES_DOC_PAGESSchema.getFNDocKey();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的ES_DOC_PAGES表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "ES_DOC_PAGESSchema";
	...
	public ES_DOC_PAGESSchema getSchema()
	{
		ES_DOC_PAGESSchema aES_DOC_PAGESSchema = new ES_DOC_PAGESSchema();
		aES_DOC_PAGESSchema.setSchema(this);
		return aES_DOC_PAGESSchema;
	}

	public ES_DOC_PAGESDB getDB()
	{
		ES_DOC_PAGESDB aDBOper = new ES_DOC_PAGESDB();
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpES_DOC_PAGES>历史记账凭证主表信息</A>表字段
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		ES_DOC_PAGESSchema other = (ES_DOC_PAGESSchema)otherObject;
		return
