...
/*
 * <p>ClassName: LBPOPolSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 内部外包流程
 */
public class LBPOPolSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LBPOPolSchema.class);
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LBPOPolSchema cloned = (LBPOPolSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LBPOPolSchema 对象给 Schema 赋值
	* @param: aLBPOPolSchema LBPOPolSchema
	**/
	public void setSchema(LBPOPolSchema aLBPOPolSchema)
	{
		this.GrpContNo = aLBPOPolSchema.getGrpContNo();
		this.GrpPolNo = aLBPOPolSchema.getGrpPolNo();
		this.ContNo = aLBPOPolSchema.getContNo();
		this.InputNo = aLBPOPolSchema.getInputNo();
		this.PolNo = aLBPOPolSchema.getPolNo();
		this.FillNo = aLBPOPolSchema.getFillNo();
		this.ProposalNo = aLBPOPolSchema.getProposalNo();
		this.PrtNo = aLBPOPolSchema.getPrtNo();
		this.ContType = aLBPOPolSchema.getContType();
		this.PolTypeFlag = aLBPOPolSchema.getPolTypeFlag();
		this.MainPolNo = aLBPOPolSchema.getMainPolNo();
		this.MasterPolNo = aLBPOPolSchema.getMasterPolNo();
		this.KindCode = aLBPOPolSchema.getKindCode();
		this.RiskCode = aLBPOPolSchema.getRiskCode();
		this.RiskVersion = aLBPOPolSchema.getRiskVersion();
		this.ManageCom = aLBPOPolSchema.getManageCom();
		this.AgentCom = aLBPOPolSchema.getAgentCom();
		this.AgentType = aLBPOPolSchema.getAgentType();
		this.AgentCode = aLBPOPolSchema.getAgentCode();
		this.AgentGroup = aLBPOPolSchema.getAgentGroup();
		this.AgentCode1 = aLBPOPolSchema.getAgentCode1();
		this.SaleChnl = aLBPOPolSchema.getSaleChnl();
		this.Handler = aLBPOPolSchema.getHandler();
		this.InsuredNo = aLBPOPolSchema.getInsuredNo();
		this.InsuredPeoples = aLBPOPolSchema.getInsuredPeoples();
		this.AppntNo = aLBPOPolSchema.getAppntNo();
		this.CValiDate = aLBPOPolSchema.getCValiDate();
		this.SignCom = aLBPOPolSchema.getSignCom();
		this.SignDate = aLBPOPolSchema.getSignDate();
		this.SignTime = aLBPOPolSchema.getSignTime();
		this.FirstPayDate = aLBPOPolSchema.getFirstPayDate();
		this.PayEndDate = aLBPOPolSchema.getPayEndDate();
		this.PaytoDate = aLBPOPolSchema.getPaytoDate();
		this.GetStartDate = aLBPOPolSchema.getGetStartDate();
		this.EndDate = aLBPOPolSchema.getEndDate();
		this.AcciEndDate = aLBPOPolSchema.getAcciEndDate();
		this.GetYearFlag = aLBPOPolSchema.getGetYearFlag();
		this.GetYear = aLBPOPolSchema.getGetYear();
		this.PayEndYearFlag = aLBPOPolSchema.getPayEndYearFlag();
		this.PayEndYear = aLBPOPolSchema.getPayEndYear();
		this.InsuYearFlag = aLBPOPolSchema.getInsuYearFlag();
		this.InsuYear = aLBPOPolSchema.getInsuYear();
		this.AcciYearFlag = aLBPOPolSchema.getAcciYearFlag();
		this.AcciYear = aLBPOPolSchema.getAcciYear();
		this.GetStartType = aLBPOPolSchema.getGetStartType();
		this.SpecifyValiDate = aLBPOPolSchema.getSpecifyValiDate();
		this.PayMode = aLBPOPolSchema.getPayMode();
		this.PayLocation = aLBPOPolSchema.getPayLocation();
		this.PayIntv = aLBPOPolSchema.getPayIntv();
		this.PayYears = aLBPOPolSchema.getPayYears();
		this.Years = aLBPOPolSchema.getYears();
		this.ManageFeeRate = aLBPOPolSchema.getManageFeeRate();
		this.FloatRate = aLBPOPolSchema.getFloatRate();
		this.PremToAmnt = aLBPOPolSchema.getPremToAmnt();
		this.Mult = aLBPOPolSchema.getMult();
		this.StandPrem = aLBPOPolSchema.getStandPrem();
		this.Prem = aLBPOPolSchema.getPrem();
		this.SumPrem = aLBPOPolSchema.getSumPrem();
		this.Amnt = aLBPOPolSchema.getAmnt();
		this.RiskAmnt = aLBPOPolSchema.getRiskAmnt();
		this.LeavingMoney = aLBPOPolSchema.getLeavingMoney();
		this.EndorseTimes = aLBPOPolSchema.getEndorseTimes();
		this.ClaimTimes = aLBPOPolSchema.getClaimTimes();
		this.LiveTimes = aLBPOPolSchema.getLiveTimes();
		this.RenewCount = aLBPOPolSchema.getRenewCount();
		this.LastGetDate = aLBPOPolSchema.getLastGetDate();
		this.LastLoanDate = aLBPOPolSchema.getLastLoanDate();
		this.LastRegetDate = aLBPOPolSchema.getLastRegetDate();
		this.LastEdorDate = aLBPOPolSchema.getLastEdorDate();
		this.LastRevDate = aLBPOPolSchema.getLastRevDate();
		this.RnewFlag = aLBPOPolSchema.getRnewFlag();
		this.StopFlag = aLBPOPolSchema.getStopFlag();
		this.ExpiryFlag = aLBPOPolSchema.getExpiryFlag();
		this.AutoPayFlag = aLBPOPolSchema.getAutoPayFlag();
		this.InterestDifFlag = aLBPOPolSchema.getInterestDifFlag();
		this.SubFlag = aLBPOPolSchema.getSubFlag();
		this.BnfFlag = aLBPOPolSchema.getBnfFlag();
		this.HealthCheckFlag = aLBPOPolSchema.getHealthCheckFlag();
		this.ImpartFlag = aLBPOPolSchema.getImpartFlag();
		this.ReinsureFlag = aLBPOPolSchema.getReinsureFlag();
		this.AgentPayFlag = aLBPOPolSchema.getAgentPayFlag();
		this.AgentGetFlag = aLBPOPolSchema.getAgentGetFlag();
		this.LiveGetMode = aLBPOPolSchema.getLiveGetMode();
		this.DeadGetMode = aLBPOPolSchema.getDeadGetMode();
		this.BonusGetMode = aLBPOPolSchema.getBonusGetMode();
		this.BonusMan = aLBPOPolSchema.getBonusMan();
		this.DeadFlag = aLBPOPolSchema.getDeadFlag();
		this.SmokeFlag = aLBPOPolSchema.getSmokeFlag();
		this.Remark = aLBPOPolSchema.getRemark();
		this.ApproveFlag = aLBPOPolSchema.getApproveFlag();
		this.ApproveCode = aLBPOPolSchema.getApproveCode();
		this.ApproveDate = aLBPOPolSchema.getApproveDate();
		this.ApproveTime = aLBPOPolSchema.getApproveTime();
		this.UWFlag = aLBPOPolSchema.getUWFlag();
		this.UWCode = aLBPOPolSchema.getUWCode();
		this.UWDate = aLBPOPolSchema.getUWDate();
		this.UWTime = aLBPOPolSchema.getUWTime();
		this.PolApplyDate = aLBPOPolSchema.getPolApplyDate();
		this.AppFlag = aLBPOPolSchema.getAppFlag();
		this.PolState = aLBPOPolSchema.getPolState();
		this.StandbyFlag1 = aLBPOPolSchema.getStandbyFlag1();
		this.StandbyFlag2 = aLBPOPolSchema.getStandbyFlag2();
		this.StandbyFlag3 = aLBPOPolSchema.getStandbyFlag3();
		this.Operator = aLBPOPolSchema.getOperator();
		this.MakeDate = aLBPOPolSchema.getMakeDate();
		this.MakeTime = aLBPOPolSchema.getMakeTime();
		this.ModifyDate = aLBPOPolSchema.getModifyDate();
		this.ModifyTime = aLBPOPolSchema.getModifyTime();
		this.WaitPeriod = aLBPOPolSchema.getWaitPeriod();
		this.GetForm = aLBPOPolSchema.getGetForm();
		this.GetBankCode = aLBPOPolSchema.getGetBankCode();
		this.GetBankAccNo = aLBPOPolSchema.getGetBankAccNo();
		this.GetAccName = aLBPOPolSchema.getGetAccName();
		this.KeepValueOpt = aLBPOPolSchema.getKeepValueOpt();
		this.PayRuleCode = aLBPOPolSchema.getPayRuleCode();
		this.AscriptionRuleCode = aLBPOPolSchema.getAscriptionRuleCode();
		this.AutoPubAccFlag = aLBPOPolSchema.getAutoPubAccFlag();
		this.RiskSequence = aLBPOPolSchema.getRiskSequence();
		this.GetLimit = aLBPOPolSchema.getGetLimit();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LBPOPol表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LBPOPolSchema";
	...
	public LBPOPolSchema getSchema()
	{
		LBPOPolSchema aLBPOPolSchema = new LBPOPolSchema();
		aLBPOPolSchema.setSchema(this);
		return aLBPOPolSchema;
	}

	public LBPOPolDB getDB()
	{
		LBPOPolDB aDBOper = new LBPOPolDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLBPOPol描述/A>表字段
	...
	**/
	public String encode()
	{
		...
		strReturn.append(StrTool.cTrim(GetLimit));
		return strReturn.toString();
	}

	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLBPOPol>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			FillNo = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 6, SysConst.PACKAGESPILTER );
			...
			InsuredPeoples = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 25, SysConst.PACKAGESPILTER );
			AppntNo = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 26, SysConst.PACKAGESPILTER );
			CValiDate = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 27, SysConst.PACKAGESPILTER );
			...
			FirstPayDate = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 31, SysConst.PACKAGESPILTER );
			PayEndDate = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 32, SysConst.PACKAGESPILTER );
			PaytoDate = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 33, SysConst.PACKAGESPILTER );
			GetStartDate = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 34, SysConst.PACKAGESPILTER );
			EndDate = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 35, SysConst.PACKAGESPILTER );
			AcciEndDate = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 36, SysConst.PACKAGESPILTER );
			GetYearFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 37, SysConst.PACKAGESPILTER );
			GetYear = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 38, SysConst.PACKAGESPILTER );
			PayEndYearFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 39, SysConst.PACKAGESPILTER );
			PayEndYear = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 40, SysConst.PACKAGESPILTER );
			InsuYearFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 41, SysConst.PACKAGESPILTER );
			InsuYear = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 42, SysConst.PACKAGESPILTER );
			AcciYearFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 43, SysConst.PACKAGESPILTER );
			AcciYear = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 44, SysConst.PACKAGESPILTER );
			GetStartType = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 45, SysConst.PACKAGESPILTER );
			SpecifyValiDate = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 46, SysConst.PACKAGESPILTER );
			PayMode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 47, SysConst.PACKAGESPILTER );
			PayLocation = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 48, SysConst.PACKAGESPILTER );
			PayIntv = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 49, SysConst.PACKAGESPILTER );
			PayYears = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 50, SysConst.PACKAGESPILTER );
			Years = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 51, SysConst.PACKAGESPILTER );
			ManageFeeRate = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 52, SysConst.PACKAGESPILTER );
			FloatRate = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 53, SysConst.PACKAGESPILTER );
			PremToAmnt = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 54, SysConst.PACKAGESPILTER );
			Mult = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 55, SysConst.PACKAGESPILTER );
			StandPrem = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 56, SysConst.PACKAGESPILTER );
			Prem = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 57, SysConst.PACKAGESPILTER );
			SumPrem = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 58, SysConst.PACKAGESPILTER );
			Amnt = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 59, SysConst.PACKAGESPILTER );
			RiskAmnt = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 60, SysConst.PACKAGESPILTER );
			LeavingMoney = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 61, SysConst.PACKAGESPILTER );
			EndorseTimes = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 62, SysConst.PACKAGESPILTER );
			ClaimTimes = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 63, SysConst.PACKAGESPILTER );
			LiveTimes = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 64, SysConst.PACKAGESPILTER );
			RenewCount = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 65, SysConst.PACKAGESPILTER );
			LastGetDate = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 66, SysConst.PACKAGESPILTER );
			LastLoanDate = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 67, SysConst.PACKAGESPILTER );
			LastRegetDate = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 68, SysConst.PACKAGESPILTER );
			LastEdorDate = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 69, SysConst.PACKAGESPILTER );
			LastRevDate = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 70, SysConst.PACKAGESPILTER );
			RnewFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 71, SysConst.PACKAGESPILTER );
			StopFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 72, SysConst.PACKAGESPILTER );
			ExpiryFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 73, SysConst.PACKAGESPILTER );
			AutoPayFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 74, SysConst.PACKAGESPILTER );
			InterestDifFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 75, SysConst.PACKAGESPILTER );
			SubFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 76, SysConst.PACKAGESPILTER );
			BnfFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 77, SysConst.PACKAGESPILTER );
			HealthCheckFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 78, SysConst.PACKAGESPILTER );
			ImpartFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 79, SysConst.PACKAGESPILTER );
			ReinsureFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 80, SysConst.PACKAGESPILTER );
			AgentPayFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 81, SysConst.PACKAGESPILTER );
			AgentGetFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 82, SysConst.PACKAGESPILTER );
			LiveGetMode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 83, SysConst.PACKAGESPILTER );
			DeadGetMode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 84, SysConst.PACKAGESPILTER );
			BonusGetMode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 85, SysConst.PACKAGESPILTER );
			BonusMan = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 86, SysConst.PACKAGESPILTER );
			DeadFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 87, SysConst.PACKAGESPILTER );
			SmokeFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 88, SysConst.PACKAGESPILTER );
			Remark = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 89, SysConst.PACKAGESPILTER );
			ApproveFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 90, SysConst.PACKAGESPILTER );
			ApproveCode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 91, SysConst.PACKAGESPILTER );
			ApproveDate = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 92, SysConst.PACKAGESPILTER );
			ApproveTime = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 93, SysConst.PACKAGESPILTER );
			UWFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 94, SysConst.PACKAGESPILTER );
			UWCode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 95, SysConst.PACKAGESPILTER );
			UWDate = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 96, SysConst.PACKAGESPILTER );
			UWTime = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 97, SysConst.PACKAGESPILTER );
			PolApplyDate = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 98, SysConst.PACKAGESPILTER );
			AppFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 99, SysConst.PACKAGESPILTER );
			PolState = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 100, SysConst.PACKAGESPILTER );
			StandbyFlag1 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 101, SysConst.PACKAGESPILTER );
			StandbyFlag2 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 102, SysConst.PACKAGESPILTER );
			StandbyFlag3 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 103, SysConst.PACKAGESPILTER );
			Operator = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 104, SysConst.PACKAGESPILTER );
			MakeDate = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 105, SysConst.PACKAGESPILTER );
			MakeTime = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 106, SysConst.PACKAGESPILTER );
			ModifyDate = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 107, SysConst.PACKAGESPILTER );
			ModifyTime = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 108, SysConst.PACKAGESPILTER );
			WaitPeriod = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 109, SysConst.PACKAGESPILTER );
			GetForm = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 110, SysConst.PACKAGESPILTER );
			GetBankCode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 111, SysConst.PACKAGESPILTER );
			GetBankAccNo = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 112, SysConst.PACKAGESPILTER );
			GetAccName = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 113, SysConst.PACKAGESPILTER );
			KeepValueOpt = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 114, SysConst.PACKAGESPILTER );
			PayRuleCode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 115, SysConst.PACKAGESPILTER );
			AscriptionRuleCode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 116, SysConst.PACKAGESPILTER );
			AutoPubAccFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 117, SysConst.PACKAGESPILTER );
			RiskSequence = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 118, SysConst.PACKAGESPILTER );
			GetLimit = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 119, SysConst.PACKAGESPILTER );
		}
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LBPOPolSchema other = (LBPOPolSchema)otherObject;
		return
			...
			&& FloatRate.equals(other.getFloatRate())
