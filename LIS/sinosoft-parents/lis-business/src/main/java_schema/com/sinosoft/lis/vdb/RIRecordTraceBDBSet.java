...
/*
 * <p>ClassName: RIRecordTraceBDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 再保系统模型
 */
public class RIRecordTraceBDBSet extends RIRecordTraceBSet
{
	// @Field
	...
	**/
	...
	// @Constructor
	public RIRecordTraceBDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "RIRecordTraceBDBSet";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getAccumulateDefNO() == null || this.get(i).getAccumulateDefNO().equals("null")) {
				...
				pstmt.setString(4, this.get(i).getAccumulateDefNO());
			}
			...
			if(this.get(i).getEventNo() == null || this.get(i).getEventNo().equals("null")) {
				...
				pstmt.setString(9, this.get(i).getEventNo());
			}
			if(this.get(i).getEventType() == null || this.get(i).getEventType().equals("null")) {
				pstmt.setString(10,null);
			} else {
				pstmt.setString(10, this.get(i).getEventType());
			}
			...
			if(this.get(i).getIncomeCompanyNo() == null || this.get(i).getIncomeCompanyNo().equals("null")) {
				...
				pstmt.setString(13, this.get(i).getIncomeCompanyNo());
			}
			...
			pstmt.setDouble(15, this.get(i).getFeeMoney());
			pstmt.setDouble(16, this.get(i).getCurentAmnt());
			pstmt.setDouble(17, this.get(i).getCessionAmount());
			pstmt.setDouble(18, this.get(i).getCessionRate());
			pstmt.setDouble(19, this.get(i).getAmountChang());
			pstmt.setDouble(20, this.get(i).getPremChang());
			pstmt.setDouble(21, this.get(i).getCommChang());
			pstmt.setDouble(22, this.get(i).getReturnPay());
			pstmt.setDouble(23, this.get(i).getReturnFee());
			if(this.get(i).getAddSubFlag() == null || this.get(i).getAddSubFlag().equals("null")) {
				pstmt.setString(24,null);
			} else {
				pstmt.setString(24, this.get(i).getAddSubFlag());
			}
			if(this.get(i).getStandbyString1() == null || this.get(i).getStandbyString1().equals("null")) {
				pstmt.setString(25,null);
			} else {
				pstmt.setString(25, this.get(i).getStandbyString1());
			}
			if(this.get(i).getStandbyString2() == null || this.get(i).getStandbyString2().equals("null")) {
				pstmt.setString(26,null);
			} else {
				pstmt.setString(26, this.get(i).getStandbyString2());
			}
			if(this.get(i).getStandbyString3() == null || this.get(i).getStandbyString3().equals("null")) {
				pstmt.setString(27,null);
			} else {
				pstmt.setString(27, this.get(i).getStandbyString3());
			}
			if(this.get(i).getStandbyString4() == null || this.get(i).getStandbyString4().equals("null")) {
				pstmt.setString(28,null);
			} else {
				pstmt.setString(28, this.get(i).getStandbyString4());
			}
			pstmt.setDouble(29, this.get(i).getStandbyDouble1());
			pstmt.setDouble(30, this.get(i).getStandbyDouble2());
			pstmt.setDouble(31, this.get(i).getStandbyDouble3());
			pstmt.setDouble(32, this.get(i).getStandbyDouble4());
			pstmt.setDouble(33, this.get(i).getStandbyDouble5());
			pstmt.setDouble(34, this.get(i).getStandbyDouble6());
			pstmt.setDouble(35, this.get(i).getStandbyDouble7());
			pstmt.setDouble(36, this.get(i).getStandbyDouble8());
			pstmt.setDouble(37, this.get(i).getStandbyDouble9());
			pstmt.setDouble(38, this.get(i).getStandbyDate1());
			pstmt.setDouble(39, this.get(i).getStandbyDate2());
			if(this.get(i).getReinsureType() == null || this.get(i).getReinsureType().equals("null")) {
				pstmt.setString(40,null);
			} else {
				pstmt.setString(40, this.get(i).getReinsureType());
			}
			if(this.get(i).getRIDate() == null || this.get(i).getRIDate().equals("null")) {
				pstmt.setDate(41,null);
			} else {
				pstmt.setDate(41, Date.valueOf(this.get(i).getRIDate()));
			}
			if(this.get(i).getFIDate() == null || this.get(i).getFIDate().equals("null")) {
				pstmt.setDate(42,null);
			} else {
				pstmt.setDate(42, Date.valueOf(this.get(i).getFIDate()));
			}
			...
			if(this.get(i).getBillNo() == null || this.get(i).getBillNo().equals("null")) {
				...
				pstmt.setString(44, this.get(i).getBillNo());
			}
			if(this.get(i).getBillBatchNo() == null || this.get(i).getBillBatchNo().equals("null")) {
				pstmt.setString(45,null);
			} else {
				pstmt.setString(45, this.get(i).getBillBatchNo());
			}
			if(this.get(i).getSettleFlag() == null || this.get(i).getSettleFlag().equals("null")) {
				pstmt.setString(46,null);
			} else {
				pstmt.setString(46, this.get(i).getSettleFlag());
			}
			pstmt.setDouble(47, this.get(i).getPrePremChang());
			// set where condition
			if(this.get(i).getBakeSerialNo() == null || this.get(i).getBakeSerialNo().equals("null")) {
				pstmt.setString(48,null);
			} else {
				pstmt.setString(48, this.get(i).getBakeSerialNo());
			}
			if(this.get(i).getSerialNo() == null || this.get(i).getSerialNo().equals("null")) {
				pstmt.setString(49,null);
			} else {
				pstmt.setString(49, this.get(i).getSerialNo());
			}
