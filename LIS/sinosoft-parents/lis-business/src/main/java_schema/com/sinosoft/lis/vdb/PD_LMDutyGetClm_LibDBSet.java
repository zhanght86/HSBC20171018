...
/*
 * <p>ClassName: PD_LMDutyGetClm_LibDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 产品定义平台_PDM
 */
public class PD_LMDutyGetClm_LibDBSet extends PD_LMDutyGetClm_LibSet
{
private static Logger logger = Logger.getLogger(PD_LMDutyGetClm_LibDBSet.class);
	...
	**/
	...
	// @Constructor
	public PD_LMDutyGetClm_LibDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public PD_LMDutyGetClm_LibDBSet()
	{
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "PD_LMDutyGetClm_LibDBSet";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getGetDutyCode2() == null || this.get(i).getGetDutyCode2().equals("null")) {
				...
				pstmt.setString(39, this.get(i).getGetDutyCode2());
			}
