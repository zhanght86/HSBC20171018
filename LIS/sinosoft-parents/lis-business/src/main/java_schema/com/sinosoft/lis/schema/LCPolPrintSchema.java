...
/*
 * <p>ClassName: LCPolPrintSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 寿险业务系统未整理模型
 */
public class LCPolPrintSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LCPolPrintSchema.class);
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LCPolPrintSchema cloned = (LCPolPrintSchema)super.clone();
	...
	public InputStream getPolInfo()
	{
		return PolInfo;
	}
	public void setPolInfo(InputStream aPolInfo)
	{
		PolInfo = aPolInfo;
	}
	public void setPolInfo(String aPolInfo)
	{
	}
	...
	*/
	...
	/**
	* 使用另外一个 LCPolPrintSchema 对象给 Schema 赋值
	* @param: aLCPolPrintSchema LCPolPrintSchema
	**/
	public void setSchema(LCPolPrintSchema aLCPolPrintSchema)
	{
		this.MainPolNo = aLCPolPrintSchema.getMainPolNo();
		this.PrtFlag = aLCPolPrintSchema.getPrtFlag();
		this.PrtTimes = aLCPolPrintSchema.getPrtTimes();
		this.ManageCom = aLCPolPrintSchema.getManageCom();
		this.Operator = aLCPolPrintSchema.getOperator();
		this.MakeDate = fDate.getDate( aLCPolPrintSchema.getMakeDate());
		this.MakeTime = aLCPolPrintSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLCPolPrintSchema.getModifyDate());
		this.ModifyTime = aLCPolPrintSchema.getModifyTime();
		this.PolInfo = aLCPolPrintSchema.getPolInfo();
		this.PolType = aLCPolPrintSchema.getPolType();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		try
		{
			...
			this.PolInfo = rs.getBinaryStream("PolInfo");
		...
		{
			logger.debug("数据库中的LCPolPrint表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LCPolPrintSchema";
	...
	public LCPolPrintSchema getSchema()
	{
		LCPolPrintSchema aLCPolPrintSchema = new LCPolPrintSchema();
		aLCPolPrintSchema.setSchema(this);
		return aLCPolPrintSchema;
	}

	public LCPolPrintDB getDB()
	{
		LCPolPrintDB aDBOper = new LCPolPrintDB();
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLCPolPrint>历史记账凭证主表信息</A>表字段
	...
	**/
	public String getV(String FCode)
	{
		...
		if (FCode.equalsIgnoreCase("PolInfo"))
		{
			strReturn = StrTool.GBKToUnicode(String.valueOf(PolInfo));
		}
	...
	public String getV(int nFieldIndex)
	{
		...
		switch(nFieldIndex) {
			...
			case 8:
				...
				break;
			case 9:
				strFieldValue = String.valueOf(PolInfo);
				break;
			case 10:
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LCPolPrintSchema other = (LCPolPrintSchema)otherObject;
		return
	...
	**/
	public int getFieldIndex(String strFieldName)
	{
		...
		if( strFieldName.equals("PolInfo") ) {
			return 9;
		}
