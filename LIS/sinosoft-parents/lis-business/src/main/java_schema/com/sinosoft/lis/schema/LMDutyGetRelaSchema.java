 ...
 * @Database: 新险种定义
 */
public class LMDutyGetRelaSchema implements Schema, Cloneable
{
	// @Field
	/** 责任代码 */
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LMDutyGetRelaSchema cloned = (LMDutyGetRelaSchema)super.clone();
	...
	* @param: aLMDutyGetRelaSchema LMDutyGetRelaSchema
	**/
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			System.out.println("数据库中的LMDutyGetRela表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
