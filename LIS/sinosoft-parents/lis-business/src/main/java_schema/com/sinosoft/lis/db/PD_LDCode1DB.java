 ...
 */
public class PD_LDCode1DB extends PD_LDCode1Schema
{
private static Logger logger = Logger.getLogger(PD_LDCode1DB.class);
    ...
    // @Constructor
    public PD_LDCode1DB(Connection cConnection)
    {
        con = cConnection;
    ...
    {
        PD_LDCode1Schema tSchema = this.getSchema();
        ...
        else
        {
            ...
            tError.moduleName = "PD_LDCode1DB";
    ...
    public boolean insert()
    {
        ...
        try
        {
            ...
            pstmt.setDouble(15, this.getStandbyflag3());
            pstmt.setDouble(16, this.getStandbyflag4());
    ...
    public boolean delete()
    {
        ...
        try
        {
            ...
            {
                pstmt.setString(1, StrTool.space1(this.getCodeType(), 20));
            }
            if (this.getCode() == null || this.getCode().equals("null"))
            {
                pstmt.setNull(2, 1);
            ...
            {
                pstmt.setString(2, StrTool.space1(this.getCode(), 20));
            }
            pstmt.executeUpdate();
            pstmt.close();
            if (!mflag)
    ...
    public boolean update()
    {
        ...
        try
        {
            ...
            {
                pstmt.setString(19, StrTool.space1(this.getCodeType(), 20));
            }
            if (this.getCode() == null || this.getCode().equals("null"))
            {
                pstmt.setNull(20, 1);
            ...
            {
                pstmt.setString(20, StrTool.space1(this.getCode(), 20));
            }
            pstmt.executeUpdate();
            pstmt.close();
            if (!mflag)
    ...
    public boolean getInfo()
    {
        ...
        try
        {
            pstmt = con.prepareStatement("SELECT * FROM PD_LDCode1 WHERE  CodeType = ? AND Code = ?", ResultSet.TYPE_FORWARD_ONLY, ResultSet.CONCUR_READ_ONLY);
            if (this.getCodeType() == null || this.getCodeType().equals("null"))
            {
                pstmt.setNull(1, 1);
            }
     ...
     * @return boolean
     */
    public PD_LDCode1Set query()
    {
		PreparedStatement pstmt = null;
 		ResultSet rs = null;
		PD_LDCode1Set aPD_LDCode1Set = new PD_LDCode1Set();
	  ...
	  if( !mflag ) {
		...
		{
			SQLString sqlObj = new SQLString("PD_LDCode1");
			PD_LDCode1Schema aSchema = this.getSchema();
			...
			{
				i++;
				PD_LDCode1Schema s1 = new PD_LDCode1Schema();
				s1.setSchema(rs,i);
				aPD_LDCode1Set.add(s1);
			}
		...
		return aPD_LDCode1Set;

    }

    public PD_LDCode1Set executeQuery(String sql)
    {
        Statement stmt = null;
        ResultSet rs = null;
        PD_LDCode1Set aPD_LDCode1Set = new PD_LDCode1Set();
        ...
        {
            logger.debug("##### Error Sql in PD_LDCode1DB at query(): " + sql);
            // @@错误处理
            CError tError = new CError();
            tError.moduleName = "PD_LDCode1DB";
            tError.functionName = "query";
    ...
    public PD_LDCode1Set query(int nStart, int nCount)
    {
		PreparedStatement pstmt = null;
 		ResultSet rs = null;
		PD_LDCode1Set aPD_LDCode1Set = new PD_LDCode1Set();
    ...
    public PD_LDCode1Set executeQuery(String sql, int nStart, int nCount)
    {
        Statement stmt = null;
        ResultSet rs = null;
        PD_LDCode1Set aPD_LDCode1Set = new PD_LDCode1Set();
    ...
    public boolean update(String strWherePart)
    {
        ...
        SQLString sqlObj = new SQLString("PD_LDCode1");
        sqlObj.setSQL(2, this.getSchema());
        String sql = "update PD_LDCode1 " + sqlObj.getUpdPart() + " where " + strWherePart;
        try
        {
            stmt = con.createStatement(ResultSet.TYPE_FORWARD_ONLY, ResultSet.CONCUR_READ_ONLY);
        ...
        {
            logger.debug("##### Error Sql in PD_LDCode1DB at update(String strWherePart): " + sql);
            // @@错误处理
            CError tError = new CError();
            tError.moduleName = "PD_LDCode1DB";
            tError.functionName = "update";
    ...
    /**
     * 获取定量数据
     * @return PD_LDCode1Set
     */
    public PD_LDCode1Set getData()
    {
        int tCount = 0;
        PD_LDCode1Set tPD_LDCode1Set = new PD_LDCode1Set();
        PD_LDCode1Schema tPD_LDCode1Schema = null;
        if (null == mResultSet)
        {
            CError tError = new CError();
            tError.moduleName = "PD_LDCode1DB";
        ...
        {
            tCount = 1;
            tPD_LDCode1Schema = new PD_LDCode1Schema();
            tPD_LDCode1Schema.setSchema(mResultSet, 1);
            tPD_LDCode1Set.add(tPD_LDCode1Schema);
	...
	public PD_LDCode1Set executeQuery(SQLwithBindVariables sqlbv) {
	...
	public PD_LDCode1Set executeQuery(SQLwithBindVariables sqlbv, int nStart, int nCount) {
