...
import com.sinosoft.lis.db.RIBsnsBillBatchBakeDB;

/*
 * <p>ClassName: RIBsnsBillBatchBakeSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 再保系统模型
 */
public class RIBsnsBillBatchBakeSchema implements Schema, Cloneable
{
	// @Field
	/** 备份序号 */
	...
	// @Constructor
	public RIBsnsBillBatchBakeSchema()
	{
		mErrors = new CErrors();
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		RIBsnsBillBatchBakeSchema cloned = (RIBsnsBillBatchBakeSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 RIBsnsBillBatchBakeSchema 对象给 Schema 赋值
	* @param: aRIBsnsBillBatchBakeSchema RIBsnsBillBatchBakeSchema
	**/
	public void setSchema(RIBsnsBillBatchBakeSchema aRIBsnsBillBatchBakeSchema)
	{
		this.BackupNo = aRIBsnsBillBatchBakeSchema.getBackupNo();
		this.BatchNo = aRIBsnsBillBatchBakeSchema.getBatchNo();
		this.BillNo = aRIBsnsBillBatchBakeSchema.getBillNo();
		this.Currency = aRIBsnsBillBatchBakeSchema.getCurrency();
		this.IncomeCompanyNo = aRIBsnsBillBatchBakeSchema.getIncomeCompanyNo();
		this.State = aRIBsnsBillBatchBakeSchema.getState();
		this.RIContNo = aRIBsnsBillBatchBakeSchema.getRIContNo();
		this.BillTimes = aRIBsnsBillBatchBakeSchema.getBillTimes();
		this.StartDate = fDate.getDate( aRIBsnsBillBatchBakeSchema.getStartDate());
		this.EndDate = fDate.getDate( aRIBsnsBillBatchBakeSchema.getEndDate());
		this.UWOperator = aRIBsnsBillBatchBakeSchema.getUWOperator();
		this.Idea = aRIBsnsBillBatchBakeSchema.getIdea();
		this.Operator = aRIBsnsBillBatchBakeSchema.getOperator();
		this.ManageCom = aRIBsnsBillBatchBakeSchema.getManageCom();
		this.MakeDate = fDate.getDate( aRIBsnsBillBatchBakeSchema.getMakeDate());
		this.MakeTime = aRIBsnsBillBatchBakeSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aRIBsnsBillBatchBakeSchema.getModifyDate());
		this.ModifyTime = aRIBsnsBillBatchBakeSchema.getModifyTime();
		this.StandbyString1 = aRIBsnsBillBatchBakeSchema.getStandbyString1();
		this.StandbyString2 = aRIBsnsBillBatchBakeSchema.getStandbyString2();
		this.StandbyString3 = aRIBsnsBillBatchBakeSchema.getStandbyString3();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			System.out.println("数据库中的RIBsnsBillBatchBake表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			sqle.printStackTrace();
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "RIBsnsBillBatchBakeSchema";
	...
	public RIBsnsBillBatchBakeSchema getSchema()
	{
		RIBsnsBillBatchBakeSchema aRIBsnsBillBatchBakeSchema = new RIBsnsBillBatchBakeSchema();
		aRIBsnsBillBatchBakeSchema.setSchema(this);
		return aRIBsnsBillBatchBakeSchema;
	}

	public RIBsnsBillBatchBakeDB getDB()
	{
		RIBsnsBillBatchBakeDB aDBOper = new RIBsnsBillBatchBakeDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpRIBsnsBillBatchBake描述/A>表字段
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpRIBsnsBillBatchBake>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			RIContNo = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 7, SysConst.PACKAGESPILTER );
			BillTimes = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 8, SysConst.PACKAGESPILTER );
			...
			UWOperator = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 11, SysConst.PACKAGESPILTER );
			Idea = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 12, SysConst.PACKAGESPILTER );
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		RIBsnsBillBatchBakeSchema other = (RIBsnsBillBatchBakeSchema)otherObject;
		return
