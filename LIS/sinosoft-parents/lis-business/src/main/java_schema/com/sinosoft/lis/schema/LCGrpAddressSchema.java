...
/*
 * <p>ClassName: LCGrpAddressSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 承保核心
 */
public class LCGrpAddressSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LCGrpAddressSchema.class);
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LCGrpAddressSchema cloned = (LCGrpAddressSchema)super.clone();
	...
	/**
	* 使用另外一个 LCGrpAddressSchema 对象给 Schema 赋值
	* @param: aLCGrpAddressSchema LCGrpAddressSchema
	**/
	public void setSchema(LCGrpAddressSchema aLCGrpAddressSchema)
	{
		this.CustomerNo = aLCGrpAddressSchema.getCustomerNo();
		this.AddressNo = aLCGrpAddressSchema.getAddressNo();
		this.GrpAddress = aLCGrpAddressSchema.getGrpAddress();
		this.GrpZipCode = aLCGrpAddressSchema.getGrpZipCode();
		this.LinkMan1 = aLCGrpAddressSchema.getLinkMan1();
		this.Department1 = aLCGrpAddressSchema.getDepartment1();
		this.HeadShip1 = aLCGrpAddressSchema.getHeadShip1();
		this.Phone1 = aLCGrpAddressSchema.getPhone1();
		this.E_Mail1 = aLCGrpAddressSchema.getE_Mail1();
		this.Fax1 = aLCGrpAddressSchema.getFax1();
		this.LinkMan2 = aLCGrpAddressSchema.getLinkMan2();
		this.Department2 = aLCGrpAddressSchema.getDepartment2();
		this.HeadShip2 = aLCGrpAddressSchema.getHeadShip2();
		this.Phone2 = aLCGrpAddressSchema.getPhone2();
		this.E_Mail2 = aLCGrpAddressSchema.getE_Mail2();
		this.Fax2 = aLCGrpAddressSchema.getFax2();
		this.Operator = aLCGrpAddressSchema.getOperator();
		this.MakeDate = fDate.getDate( aLCGrpAddressSchema.getMakeDate());
		this.MakeTime = aLCGrpAddressSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLCGrpAddressSchema.getModifyDate());
		this.ModifyTime = aLCGrpAddressSchema.getModifyTime();
		this.MobilePhone1 = aLCGrpAddressSchema.getMobilePhone1();
		this.MobilePhone2 = aLCGrpAddressSchema.getMobilePhone2();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LCGrpAddress表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LCGrpAddressSchema";
	...
	public LCGrpAddressSchema getSchema()
	{
		LCGrpAddressSchema aLCGrpAddressSchema = new LCGrpAddressSchema();
		aLCGrpAddressSchema.setSchema(this);
		return aLCGrpAddressSchema;
	}

	public LCGrpAddressDB getDB()
	{
		LCGrpAddressDB aDBOper = new LCGrpAddressDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLCGrpAddress描述/A>表字段
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLCGrpAddress>历史记账凭证主表信息</A>表字段
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LCGrpAddressSchema other = (LCGrpAddressSchema)otherObject;
		return
