...
/*
 * <p>ClassName: LCGUWMasterSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 承保流程
 */
public class LCGUWMasterSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LCGUWMasterSchema.class);
	// @Field
	/** 集体合同号码 */
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LCGUWMasterSchema cloned = (LCGUWMasterSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LCGUWMasterSchema 对象给 Schema 赋值
	* @param: aLCGUWMasterSchema LCGUWMasterSchema
	**/
	public void setSchema(LCGUWMasterSchema aLCGUWMasterSchema)
	{
		this.GrpContNo = aLCGUWMasterSchema.getGrpContNo();
		this.ProposalGrpContNo = aLCGUWMasterSchema.getProposalGrpContNo();
		this.GrpPolNo = aLCGUWMasterSchema.getGrpPolNo();
		this.GrpProposalNo = aLCGUWMasterSchema.getGrpProposalNo();
		this.UWNo = aLCGUWMasterSchema.getUWNo();
		this.InsuredNo = aLCGUWMasterSchema.getInsuredNo();
		this.InsuredName = aLCGUWMasterSchema.getInsuredName();
		this.AppntNo = aLCGUWMasterSchema.getAppntNo();
		this.AppntName = aLCGUWMasterSchema.getAppntName();
		this.AgentCode = aLCGUWMasterSchema.getAgentCode();
		this.AgentGroup = aLCGUWMasterSchema.getAgentGroup();
		this.PassFlag = aLCGUWMasterSchema.getPassFlag();
		this.UWGrade = aLCGUWMasterSchema.getUWGrade();
		this.AppGrade = aLCGUWMasterSchema.getAppGrade();
		this.PostponeDay = aLCGUWMasterSchema.getPostponeDay();
		this.PostponeDate = fDate.getDate( aLCGUWMasterSchema.getPostponeDate());
		this.AutoUWFlag = aLCGUWMasterSchema.getAutoUWFlag();
		this.State = aLCGUWMasterSchema.getState();
		this.ManageCom = aLCGUWMasterSchema.getManageCom();
		this.UWIdea = aLCGUWMasterSchema.getUWIdea();
		this.UpReportContent = aLCGUWMasterSchema.getUpReportContent();
		this.Operator = aLCGUWMasterSchema.getOperator();
		this.HealthFlag = aLCGUWMasterSchema.getHealthFlag();
		this.QuesFlag = aLCGUWMasterSchema.getQuesFlag();
		this.SpecFlag = aLCGUWMasterSchema.getSpecFlag();
		this.AddPremFlag = aLCGUWMasterSchema.getAddPremFlag();
		this.AddPremReason = aLCGUWMasterSchema.getAddPremReason();
		this.ReportFlag = aLCGUWMasterSchema.getReportFlag();
		this.PrintFlag = aLCGUWMasterSchema.getPrintFlag();
		this.PrintFlag2 = aLCGUWMasterSchema.getPrintFlag2();
		this.ChangePolFlag = aLCGUWMasterSchema.getChangePolFlag();
		this.ChangePolReason = aLCGUWMasterSchema.getChangePolReason();
		this.SpecReason = aLCGUWMasterSchema.getSpecReason();
		this.MakeDate = fDate.getDate( aLCGUWMasterSchema.getMakeDate());
		this.MakeTime = aLCGUWMasterSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLCGUWMasterSchema.getModifyDate());
		this.ModifyTime = aLCGUWMasterSchema.getModifyTime();
		this.UpReport = aLCGUWMasterSchema.getUpReport();
		this.AutoUWDate = fDate.getDate( aLCGUWMasterSchema.getAutoUWDate());
		this.UWConclu = aLCGUWMasterSchema.getUWConclu();
		this.UWDate = fDate.getDate( aLCGUWMasterSchema.getUWDate());
		this.ComCode = aLCGUWMasterSchema.getComCode();
		this.ModifyOperator = aLCGUWMasterSchema.getModifyOperator();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LCGUWMaster表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LCGUWMasterSchema";
	...
	public LCGUWMasterSchema getSchema()
	{
		LCGUWMasterSchema aLCGUWMasterSchema = new LCGUWMasterSchema();
		aLCGUWMasterSchema.setSchema(this);
		return aLCGUWMasterSchema;
	}

	public LCGUWMasterDB getDB()
	{
		LCGUWMasterDB aDBOper = new LCGUWMasterDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLCGUWMaster描述/A>表字段
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLCGUWMaster>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			UWNo= new Integer(ChgData.chgNumericStr(StrTool.getStr(strMessage,5,SysConst.PACKAGESPILTER))).intValue();
			...
			PassFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 12, SysConst.PACKAGESPILTER );
			UWGrade = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 13, SysConst.PACKAGESPILTER );
			AppGrade = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 14, SysConst.PACKAGESPILTER );
			PostponeDay = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 15, SysConst.PACKAGESPILTER );
			PostponeDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 16,SysConst.PACKAGESPILTER));
			AutoUWFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 17, SysConst.PACKAGESPILTER );
			...
			UWIdea = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 20, SysConst.PACKAGESPILTER );
			UpReportContent = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 21, SysConst.PACKAGESPILTER );
			Operator = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 22, SysConst.PACKAGESPILTER );
			HealthFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 23, SysConst.PACKAGESPILTER );
			QuesFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 24, SysConst.PACKAGESPILTER );
			SpecFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 25, SysConst.PACKAGESPILTER );
			AddPremFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 26, SysConst.PACKAGESPILTER );
			AddPremReason = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 27, SysConst.PACKAGESPILTER );
			ReportFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 28, SysConst.PACKAGESPILTER );
			PrintFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 29, SysConst.PACKAGESPILTER );
			PrintFlag2 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 30, SysConst.PACKAGESPILTER );
			ChangePolFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 31, SysConst.PACKAGESPILTER );
			ChangePolReason = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 32, SysConst.PACKAGESPILTER );
			SpecReason = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 33, SysConst.PACKAGESPILTER );
			...
			UpReport = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 38, SysConst.PACKAGESPILTER );
			AutoUWDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 39,SysConst.PACKAGESPILTER));
			UWConclu = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 40, SysConst.PACKAGESPILTER );
			UWDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 41,SysConst.PACKAGESPILTER));
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LCGUWMasterSchema other = (LCGUWMasterSchema)otherObject;
		return
