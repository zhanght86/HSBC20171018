...
/*
 * <p>ClassName: LBInsureAccClassSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 投连改造
 */
public class LBInsureAccClassSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LBInsureAccClassSchema.class);
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LBInsureAccClassSchema cloned = (LBInsureAccClassSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LBInsureAccClassSchema 对象给 Schema 赋值
	* @param: aLBInsureAccClassSchema LBInsureAccClassSchema
	**/
	public void setSchema(LBInsureAccClassSchema aLBInsureAccClassSchema)
	{
		this.EdorNo = aLBInsureAccClassSchema.getEdorNo();
		this.GrpContNo = aLBInsureAccClassSchema.getGrpContNo();
		this.GrpPolNo = aLBInsureAccClassSchema.getGrpPolNo();
		this.ContNo = aLBInsureAccClassSchema.getContNo();
		this.ManageCom = aLBInsureAccClassSchema.getManageCom();
		this.PolNo = aLBInsureAccClassSchema.getPolNo();
		this.InsuAccNo = aLBInsureAccClassSchema.getInsuAccNo();
		this.PayPlanCode = aLBInsureAccClassSchema.getPayPlanCode();
		this.OtherNo = aLBInsureAccClassSchema.getOtherNo();
		this.OtherType = aLBInsureAccClassSchema.getOtherType();
		this.AccAscription = aLBInsureAccClassSchema.getAccAscription();
		this.RiskCode = aLBInsureAccClassSchema.getRiskCode();
		this.InsuredNo = aLBInsureAccClassSchema.getInsuredNo();
		this.AppntNo = aLBInsureAccClassSchema.getAppntNo();
		this.AccType = aLBInsureAccClassSchema.getAccType();
		this.AccComputeFlag = aLBInsureAccClassSchema.getAccComputeFlag();
		this.AccFoundDate = fDate.getDate( aLBInsureAccClassSchema.getAccFoundDate());
		this.AccFoundTime = aLBInsureAccClassSchema.getAccFoundTime();
		this.BalaDate = fDate.getDate( aLBInsureAccClassSchema.getBalaDate());
		this.BalaTime = aLBInsureAccClassSchema.getBalaTime();
		this.SumPay = aLBInsureAccClassSchema.getSumPay();
		this.SumPaym = aLBInsureAccClassSchema.getSumPaym();
		this.LastAccBala = aLBInsureAccClassSchema.getLastAccBala();
		this.LastUnitCount = aLBInsureAccClassSchema.getLastUnitCount();
		this.LastUnitPrice = aLBInsureAccClassSchema.getLastUnitPrice();
		this.InsuAccBala = aLBInsureAccClassSchema.getInsuAccBala();
		this.UnitCount = aLBInsureAccClassSchema.getUnitCount();
		this.InsuAccGetMoney = aLBInsureAccClassSchema.getInsuAccGetMoney();
		this.FrozenMoney = aLBInsureAccClassSchema.getFrozenMoney();
		this.State = aLBInsureAccClassSchema.getState();
		this.Operator = aLBInsureAccClassSchema.getOperator();
		this.MakeDate = fDate.getDate( aLBInsureAccClassSchema.getMakeDate());
		this.MakeTime = aLBInsureAccClassSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLBInsureAccClassSchema.getModifyDate());
		this.ModifyTime = aLBInsureAccClassSchema.getModifyTime();
		this.AscriptRate = aLBInsureAccClassSchema.getAscriptRate();
		this.AscriptType = aLBInsureAccClassSchema.getAscriptType();
		this.Currency = aLBInsureAccClassSchema.getCurrency();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LBInsureAccClass表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LBInsureAccClassSchema";
	...
	public LBInsureAccClassSchema getSchema()
	{
		LBInsureAccClassSchema aLBInsureAccClassSchema = new LBInsureAccClassSchema();
		aLBInsureAccClassSchema.setSchema(this);
		return aLBInsureAccClassSchema;
	}

	public LBInsureAccClassDB getDB()
	{
		LBInsureAccClassDB aDBOper = new LBInsureAccClassDB();
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLBInsureAccClass>历史记账凭证主表信息</A>表字段
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LBInsureAccClassSchema other = (LBInsureAccClassSchema)otherObject;
		return
