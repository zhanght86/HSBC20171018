...
import com.sinosoft.lis.db.PD_ScheRateCalFactor_LibDB;

/**
 * <p>ClassName: PD_ScheRateCalFactor_LibSchema </p>
 ...
 */
public class PD_ScheRateCalFactor_LibSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(PD_ScheRateCalFactor_LibSchema.class);
    ...
    // @Constructor
    public PD_ScheRateCalFactor_LibSchema()
    {
        mErrors = new CErrors();
    ...
    {
        PD_ScheRateCalFactor_LibSchema cloned = (PD_ScheRateCalFactor_LibSchema)super.clone();
    ...
    /**
     * 使用另外一个 PD_ScheRateCalFactor_LibSchema 对象给 Schema 赋值
     * @param: aPD_ScheRateCalFactor_LibSchema PD_ScheRateCalFactor_LibSchema
     **/
    public void setSchema(PD_ScheRateCalFactor_LibSchema aPD_ScheRateCalFactor_LibSchema)
    {
        this.FactorCode = aPD_ScheRateCalFactor_LibSchema.getFactorCode();
        this.FactorName = aPD_ScheRateCalFactor_LibSchema.getFactorName();
        this.FactorType = aPD_ScheRateCalFactor_LibSchema.getFactorType();
        this.FactorDataType = aPD_ScheRateCalFactor_LibSchema.getFactorDataType();
        this.Operator = aPD_ScheRateCalFactor_LibSchema.getOperator();
        this.MakeDate = fDate.getDate(aPD_ScheRateCalFactor_LibSchema.getMakeDate());
        this.MakeTime = aPD_ScheRateCalFactor_LibSchema.getMakeTime();
        this.ModifyDate = fDate.getDate(aPD_ScheRateCalFactor_LibSchema.getModifyDate());
        this.ModifyTime = aPD_ScheRateCalFactor_LibSchema.getModifyTime();
        this.Standbyflag1 = aPD_ScheRateCalFactor_LibSchema.getStandbyflag1();
        this.Standbyflag2 = aPD_ScheRateCalFactor_LibSchema.getStandbyflag2();
        this.Standbyflag3 = aPD_ScheRateCalFactor_LibSchema.getStandbyflag3();
        this.Standbyflag4 = aPD_ScheRateCalFactor_LibSchema.getStandbyflag4();
        this.Standbyflag5 = aPD_ScheRateCalFactor_LibSchema.getStandbyflag5();
        this.Standbyflag6 = aPD_ScheRateCalFactor_LibSchema.getStandbyflag6();
    }
    ...
    public boolean setSchema(ResultSet rs, int i)
    {
        try
        {
            ...
            if (rs.getString(1) == null)
                ...
                this.FactorCode = rs.getString(1).trim();
            if (rs.getString(2) == null)
                this.FactorName = null;
            else
                this.FactorName = rs.getString(2).trim();
            if (rs.getString(3) == null)
                this.FactorType = null;
            else
                this.FactorType = rs.getString(3).trim();
            if (rs.getString(4) == null)
                this.FactorDataType = null;
            else
                this.FactorDataType = rs.getString(4).trim();
        ...
        {
            logger.debug("数据库中表PD_ScheRateCalFactor_Lib字段个数和Schema中的字段个数不一致，或执行db.executeQuery查询时未使用select * from tables");
            // @@错误处理
            CError tError = new CError();
            tError.moduleName = "PD_ScheRateCalFactor_LibSchema";
    ...
    public PD_ScheRateCalFactor_LibSchema getSchema()
    {
        PD_ScheRateCalFactor_LibSchema aPD_ScheRateCalFactor_LibSchema = new PD_ScheRateCalFactor_LibSchema();
        aPD_ScheRateCalFactor_LibSchema.setSchema(this);
        return aPD_ScheRateCalFactor_LibSchema;
    }

    public PD_ScheRateCalFactor_LibDB getDB()
    {
        PD_ScheRateCalFactor_LibDB aDBOper = new PD_ScheRateCalFactor_LibDB();
        aDBOper.setSchema(this);
        return aDBOper;
    }

    /**
     * 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpPD_ScheRateCalFactor_Lib描述/A>表字段
    ...
    public String encode()
    {
        ...
        strReturn.append(SysConst.PACKAGESPILTER);
        strReturn.append(StrTool.cTrim(FactorDataType));
        strReturn.append(SysConst.PACKAGESPILTER);
    ...
    /**
     * 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpPD_ScheRateCalFactor_Lib>历史记账凭证主表信息</A>表字段
    ...
    public boolean decode(String strMessage)
    {
        try
        {
            ...
            FactorDataType = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 4, SysConst.PACKAGESPILTER);
    ...
    public String getV(String FCode)
    {
        ...
        if (FCode.equals("FactorDataType"))
        {
    ...
    public boolean equals(Object otherObject)
    {
        ...
        if (getClass() != otherObject.getClass())
            return false;
        PD_ScheRateCalFactor_LibSchema other = (PD_ScheRateCalFactor_LibSchema) otherObject;
        return
                (FactorCode == null ? other.getFactorCode() == null : FactorCode.equals(other.getFactorCode()))
                ...
                && (FactorDataType == null ? other.getFactorDataType() == null : FactorDataType.equals(other.getFactorDataType()))
