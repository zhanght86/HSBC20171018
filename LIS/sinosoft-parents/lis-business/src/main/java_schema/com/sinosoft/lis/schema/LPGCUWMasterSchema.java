...
/*
 * <p>ClassName: LPGCUWMasterSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 保全流程
 */
public class LPGCUWMasterSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LPGCUWMasterSchema.class);
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LPGCUWMasterSchema cloned = (LPGCUWMasterSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LPGCUWMasterSchema 对象给 Schema 赋值
	* @param: aLPGCUWMasterSchema LPGCUWMasterSchema
	**/
	public void setSchema(LPGCUWMasterSchema aLPGCUWMasterSchema)
	{
		this.EdorNo = aLPGCUWMasterSchema.getEdorNo();
		this.EdorType = aLPGCUWMasterSchema.getEdorType();
		this.GrpContNo = aLPGCUWMasterSchema.getGrpContNo();
		this.ProposalGrpContNo = aLPGCUWMasterSchema.getProposalGrpContNo();
		this.UWNo = aLPGCUWMasterSchema.getUWNo();
		this.InsuredNo = aLPGCUWMasterSchema.getInsuredNo();
		this.InsuredName = aLPGCUWMasterSchema.getInsuredName();
		this.AppntNo = aLPGCUWMasterSchema.getAppntNo();
		this.AppntName = aLPGCUWMasterSchema.getAppntName();
		this.AgentCode = aLPGCUWMasterSchema.getAgentCode();
		this.AgentGroup = aLPGCUWMasterSchema.getAgentGroup();
		this.PassFlag = aLPGCUWMasterSchema.getPassFlag();
		this.UWGrade = aLPGCUWMasterSchema.getUWGrade();
		this.AppGrade = aLPGCUWMasterSchema.getAppGrade();
		this.PostponeDay = aLPGCUWMasterSchema.getPostponeDay();
		this.PostponeDate = fDate.getDate( aLPGCUWMasterSchema.getPostponeDate());
		this.AutoUWFlag = aLPGCUWMasterSchema.getAutoUWFlag();
		this.State = aLPGCUWMasterSchema.getState();
		this.ManageCom = aLPGCUWMasterSchema.getManageCom();
		this.UWIdea = aLPGCUWMasterSchema.getUWIdea();
		this.UpReportContent = aLPGCUWMasterSchema.getUpReportContent();
		this.Operator = aLPGCUWMasterSchema.getOperator();
		this.HealthFlag = aLPGCUWMasterSchema.getHealthFlag();
		this.QuesFlag = aLPGCUWMasterSchema.getQuesFlag();
		this.SpecFlag = aLPGCUWMasterSchema.getSpecFlag();
		this.AddPremFlag = aLPGCUWMasterSchema.getAddPremFlag();
		this.AddPremReason = aLPGCUWMasterSchema.getAddPremReason();
		this.ReportFlag = aLPGCUWMasterSchema.getReportFlag();
		this.PrintFlag = aLPGCUWMasterSchema.getPrintFlag();
		this.PrintFlag2 = aLPGCUWMasterSchema.getPrintFlag2();
		this.ChangePolFlag = aLPGCUWMasterSchema.getChangePolFlag();
		this.ChangePolReason = aLPGCUWMasterSchema.getChangePolReason();
		this.SpecReason = aLPGCUWMasterSchema.getSpecReason();
		this.MakeDate = fDate.getDate( aLPGCUWMasterSchema.getMakeDate());
		this.MakeTime = aLPGCUWMasterSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLPGCUWMasterSchema.getModifyDate());
		this.ModifyTime = aLPGCUWMasterSchema.getModifyTime();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LPGCUWMaster表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LPGCUWMasterSchema";
	...
	public LPGCUWMasterSchema getSchema()
	{
		LPGCUWMasterSchema aLPGCUWMasterSchema = new LPGCUWMasterSchema();
		aLPGCUWMasterSchema.setSchema(this);
		return aLPGCUWMasterSchema;
	}

	public LPGCUWMasterDB getDB()
	{
		LPGCUWMasterDB aDBOper = new LPGCUWMasterDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLPGCUWMaster描述/A>表字段
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLPGCUWMaster>历史记账凭证主表信息</A>表字段
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LPGCUWMasterSchema other = (LPGCUWMasterSchema)otherObject;
		return
