...
/*
 * <p>ClassName: LCProposalToContDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 新单管理
 */
public class LCProposalToContDBSet extends LCProposalToContSet
{
	// @Field
	...
	**/
	...
	// @Constructor
	public LCProposalToContDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LCProposalToContDBSet";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getContPlanType() == null || this.get(i).getContPlanType().equals("null")) {
				...
				pstmt.setString(5, this.get(i).getContPlanType());
			}
			if(this.get(i).getPolicyFlag() == null || this.get(i).getPolicyFlag().equals("null")) {
				pstmt.setString(6,null);
			} else {
				pstmt.setString(6, this.get(i).getPolicyFlag());
			}
			if(this.get(i).getSubPropNo() == null || this.get(i).getSubPropNo().equals("null")) {
				pstmt.setString(7,null);
			} else {
				pstmt.setString(7, this.get(i).getSubPropNo());
			}
