...
import com.sinosoft.lis.db.LCAppntBakDB;

/*
 * <p>ClassName: LCAppntBakSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: PhysicalDataModel_1
 */
public class LCAppntBakSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LCAppntBakSchema.class);
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LCAppntBakSchema cloned = (LCAppntBakSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LCAppntBakSchema 对象给 Schema 赋值
	* @param: aLCAppntBakSchema LCAppntBakSchema
	**/
	public void setSchema(LCAppntBakSchema aLCAppntBakSchema)
	{
		this.GrpContNo = aLCAppntBakSchema.getGrpContNo();
		this.ContNo = aLCAppntBakSchema.getContNo();
		this.PrtNo = aLCAppntBakSchema.getPrtNo();
		this.AppntNo = aLCAppntBakSchema.getAppntNo();
		this.AppntGrade = aLCAppntBakSchema.getAppntGrade();
		this.AppntName = aLCAppntBakSchema.getAppntName();
		this.AppntSex = aLCAppntBakSchema.getAppntSex();
		this.AppntBirthday = fDate.getDate( aLCAppntBakSchema.getAppntBirthday());
		this.AppntType = aLCAppntBakSchema.getAppntType();
		this.AddressNo = aLCAppntBakSchema.getAddressNo();
		this.IDType = aLCAppntBakSchema.getIDType();
		this.IDNo = aLCAppntBakSchema.getIDNo();
		this.NativePlace = aLCAppntBakSchema.getNativePlace();
		this.Nationality = aLCAppntBakSchema.getNationality();
		this.RgtAddress = aLCAppntBakSchema.getRgtAddress();
		this.Marriage = aLCAppntBakSchema.getMarriage();
		this.MarriageDate = fDate.getDate( aLCAppntBakSchema.getMarriageDate());
		this.Health = aLCAppntBakSchema.getHealth();
		this.Stature = aLCAppntBakSchema.getStature();
		this.Avoirdupois = aLCAppntBakSchema.getAvoirdupois();
		this.Degree = aLCAppntBakSchema.getDegree();
		this.CreditGrade = aLCAppntBakSchema.getCreditGrade();
		this.BankCode = aLCAppntBakSchema.getBankCode();
		this.BankAccNo = aLCAppntBakSchema.getBankAccNo();
		this.AccName = aLCAppntBakSchema.getAccName();
		this.JoinCompanyDate = fDate.getDate( aLCAppntBakSchema.getJoinCompanyDate());
		this.StartWorkDate = fDate.getDate( aLCAppntBakSchema.getStartWorkDate());
		this.Position = aLCAppntBakSchema.getPosition();
		this.Salary = aLCAppntBakSchema.getSalary();
		this.OccupationType = aLCAppntBakSchema.getOccupationType();
		this.OccupationCode = aLCAppntBakSchema.getOccupationCode();
		this.WorkType = aLCAppntBakSchema.getWorkType();
		this.PluralityType = aLCAppntBakSchema.getPluralityType();
		this.SmokeFlag = aLCAppntBakSchema.getSmokeFlag();
		this.Operator = aLCAppntBakSchema.getOperator();
		this.ManageCom = aLCAppntBakSchema.getManageCom();
		this.MakeDate = fDate.getDate( aLCAppntBakSchema.getMakeDate());
		this.MakeTime = aLCAppntBakSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLCAppntBakSchema.getModifyDate());
		this.ModifyTime = aLCAppntBakSchema.getModifyTime();
		this.BMI = aLCAppntBakSchema.getBMI();
		this.License = aLCAppntBakSchema.getLicense();
		this.LicenseType = aLCAppntBakSchema.getLicenseType();
		this.RelationToInsured = aLCAppntBakSchema.getRelationToInsured();
		this.SocialInsuFlag = aLCAppntBakSchema.getSocialInsuFlag();
		this.IDExpDate = fDate.getDate( aLCAppntBakSchema.getIDExpDate());
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LCAppntBak表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LCAppntBakSchema";
	...
	public LCAppntBakSchema getSchema()
	{
		LCAppntBakSchema aLCAppntBakSchema = new LCAppntBakSchema();
		aLCAppntBakSchema.setSchema(this);
		return aLCAppntBakSchema;
	}

	public LCAppntBakDB getDB()
	{
		LCAppntBakDB aDBOper = new LCAppntBakDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLCAppntBak描述/A>表字段
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLCAppntBak>历史记账凭证主表信息</A>表字段
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LCAppntBakSchema other = (LCAppntBakSchema)otherObject;
		return
