...
/*
 * <p>ClassName: LLUWSubSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 理赔管理
 */
public class LLUWSubSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LLUWSubSchema.class);
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LLUWSubSchema cloned = (LLUWSubSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LLUWSubSchema 对象给 Schema 赋值
	* @param: aLLUWSubSchema LLUWSubSchema
	**/
	public void setSchema(LLUWSubSchema aLLUWSubSchema)
	{
		this.CaseNo = aLLUWSubSchema.getCaseNo();
		this.GrpContNo = aLLUWSubSchema.getGrpContNo();
		this.BatNo = aLLUWSubSchema.getBatNo();
		this.ContNo = aLLUWSubSchema.getContNo();
		this.ProposalContNo = aLLUWSubSchema.getProposalContNo();
		this.PolNo = aLLUWSubSchema.getPolNo();
		this.ProposalNo = aLLUWSubSchema.getProposalNo();
		this.UWNo = aLLUWSubSchema.getUWNo();
		this.InsuredNo = aLLUWSubSchema.getInsuredNo();
		this.InsuredName = aLLUWSubSchema.getInsuredName();
		this.AppntNo = aLLUWSubSchema.getAppntNo();
		this.AppntName = aLLUWSubSchema.getAppntName();
		this.AgentCode = aLLUWSubSchema.getAgentCode();
		this.AgentGroup = aLLUWSubSchema.getAgentGroup();
		this.PassFlag = aLLUWSubSchema.getPassFlag();
		this.UWGrade = aLLUWSubSchema.getUWGrade();
		this.AppGrade = aLLUWSubSchema.getAppGrade();
		this.PostponeDay = aLLUWSubSchema.getPostponeDay();
		this.PostponeDate = fDate.getDate( aLLUWSubSchema.getPostponeDate());
		this.AutoUWFlag = aLLUWSubSchema.getAutoUWFlag();
		this.State = aLLUWSubSchema.getState();
		this.ManageCom = aLLUWSubSchema.getManageCom();
		this.UWIdea = aLLUWSubSchema.getUWIdea();
		this.UpReportContent = aLLUWSubSchema.getUpReportContent();
		this.Operator = aLLUWSubSchema.getOperator();
		this.HealthFlag = aLLUWSubSchema.getHealthFlag();
		this.QuesFlag = aLLUWSubSchema.getQuesFlag();
		this.SpecFlag = aLLUWSubSchema.getSpecFlag();
		this.AddPremFlag = aLLUWSubSchema.getAddPremFlag();
		this.AddPremReason = aLLUWSubSchema.getAddPremReason();
		this.ReportFlag = aLLUWSubSchema.getReportFlag();
		this.PrintFlag = aLLUWSubSchema.getPrintFlag();
		this.PrintFlag2 = aLLUWSubSchema.getPrintFlag2();
		this.ChangePolFlag = aLLUWSubSchema.getChangePolFlag();
		this.ChangePolReason = aLLUWSubSchema.getChangePolReason();
		this.SpecReason = aLLUWSubSchema.getSpecReason();
		this.MakeDate = fDate.getDate( aLLUWSubSchema.getMakeDate());
		this.MakeTime = aLLUWSubSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLLUWSubSchema.getModifyDate());
		this.ModifyTime = aLLUWSubSchema.getModifyTime();
		this.SugPassFlag = aLLUWSubSchema.getSugPassFlag();
		this.SugUWIdea = aLLUWSubSchema.getSugUWIdea();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LLUWSub表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LLUWSubSchema";
	...
	public LLUWSubSchema getSchema()
	{
		LLUWSubSchema aLLUWSubSchema = new LLUWSubSchema();
		aLLUWSubSchema.setSchema(this);
		return aLLUWSubSchema;
	}

	public LLUWSubDB getDB()
	{
		LLUWSubDB aDBOper = new LLUWSubDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLLUWSub描述/A>表字段
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLLUWSub>历史记账凭证主表信息</A>表字段
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LLUWSubSchema other = (LLUWSubSchema)otherObject;
		return
