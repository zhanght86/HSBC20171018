...
/*
 * <p>ClassName: LCUWSubDB </p>
 * <p>Description: DB层数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 承保流程
 */
public class LCUWSubDB extends LCUWSubSchema
{
private static Logger logger = Logger.getLogger(LCUWSubDB.class);
	...
	**/
	...
	// @Constructor
	public LCUWSubDB( Connection tConnection )
	{
		con = tConnection;
	...
	{
		LCUWSubSchema tSchema = this.getSchema();
	...
	public boolean getInfo()
	{
		...
		try
		{
			pstmt = con.prepareStatement("SELECT * FROM LCUWSub WHERE  ProposalNo = ? AND UWNo = ?", 
	...
	public LCUWSubSet query()
	{
		PreparedStatement pstmt = null;
 		ResultSet rs = null;
		LCUWSubSet aLCUWSubSet = new LCUWSubSet();
	  ...
	  if( !mflag ) {
		...
		{
			SQLString sqlObj = new SQLString("LCUWSub");
			LCUWSubSchema aSchema = this.getSchema();
			...
			{
				i++;
				LCUWSubSchema s1 = new LCUWSubSchema();
				s1.setSchema(rs,i);
				aLCUWSubSet.add(s1);
			}
			try{ rs.close(); } catch( Exception ex ) {}
	...
	public LCUWSubSet executeQuery(String sql)
	{
		Statement stmt = null;
		ResultSet rs = null;
		LCUWSubSet aLCUWSubSet = new LCUWSubSet();
	...
	public LCUWSubSet query(int nStart, int nCount)
	{
		PreparedStatement pstmt = null;
 		ResultSet rs = null;
		LCUWSubSet aLCUWSubSet = new LCUWSubSet();
	...
	public LCUWSubSet executeQuery(String sql, int nStart, int nCount)
	{
		Statement stmt = null;
		ResultSet rs = null;
		LCUWSubSet aLCUWSubSet = new LCUWSubSet();
	...
	public boolean update(String strWherePart)
	{
	  ...
	  if( !mflag ) {
		...
		try
		{
			...
			String sql = "update LCUWSub " + sqlObj.getUpdPart() + " where " + strWherePart;
 ...
 * @return LCUWSubSet
 */
public LCUWSubSet getData()
{
    int tCount = 0;
    LCUWSubSet tLCUWSubSet = new LCUWSubSet();
    LCUWSubSchema tLCUWSubSchema = null;
    if (null == mResultSet)
    {
        CError tError = new CError();
        tError.moduleName = "LCUWSubDB";
    ...
    try
    {
        ...
        tLCUWSubSchema.setSchema(mResultSet, 1);
...
public boolean closeData()
{
	...
	public LCUWSubSet executeQuery(SQLwithBindVariables sqlbv) {
	...
	public LCUWSubSet executeQuery(SQLwithBindVariables sqlbv, int nStart, int nCount) {
