...
/*
 * <p>ClassName: ES_DOC_PAGES_OLDDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: EasyScanV4
 */
public class ES_DOC_PAGES_OLDDBSet extends ES_DOC_PAGES_OLDSet
{
private static Logger logger = Logger.getLogger(ES_DOC_PAGES_OLDDBSet.class);
	...
	**/
	...
	// @Constructor
	public ES_DOC_PAGES_OLDDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "ES_DOC_PAGES_OLDDBSet";
