...
/*
 * <p>ClassName: PD_LMDiscountSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 产品定义平台补充表
 */
public class PD_LMDiscountSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(PD_LMDiscountSchema.class);
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		PD_LMDiscountSchema cloned = (PD_LMDiscountSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 PD_LMDiscountSchema 对象给 Schema 赋值
	* @param: aPD_LMDiscountSchema PD_LMDiscountSchema
	**/
	public void setSchema(PD_LMDiscountSchema aPD_LMDiscountSchema)
	{
		this.DiscountCode = aPD_LMDiscountSchema.getDiscountCode();
		this.DiscountType = aPD_LMDiscountSchema.getDiscountType();
		this.RiskCode = aPD_LMDiscountSchema.getRiskCode();
		this.DutyCode = aPD_LMDiscountSchema.getDutyCode();
		this.CampaignCode = aPD_LMDiscountSchema.getCampaignCode();
		this.AddFeeDiscFlag = aPD_LMDiscountSchema.getAddFeeDiscFlag();
		this.StartDate = fDate.getDate( aPD_LMDiscountSchema.getStartDate());
		this.EndDate = fDate.getDate( aPD_LMDiscountSchema.getEndDate());
		this.CalCode = aPD_LMDiscountSchema.getCalCode();
		this.Operator = aPD_LMDiscountSchema.getOperator();
		this.MakeDate = fDate.getDate( aPD_LMDiscountSchema.getMakeDate());
		this.MakeTime = aPD_LMDiscountSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aPD_LMDiscountSchema.getModifyDate());
		this.ModifyTime = aPD_LMDiscountSchema.getModifyTime();
		this.Standbyflag1 = aPD_LMDiscountSchema.getStandbyflag1();
		this.Standbyflag2 = aPD_LMDiscountSchema.getStandbyflag2();
		this.Standbyflag3 = aPD_LMDiscountSchema.getStandbyflag3();
		this.Standbyflag4 = aPD_LMDiscountSchema.getStandbyflag4();
		this.Standbyflag5 = aPD_LMDiscountSchema.getStandbyflag5();
		this.Standbyflag6 = aPD_LMDiscountSchema.getStandbyflag6();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的PD_LMDiscount表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "PD_LMDiscountSchema";
	...
	public PD_LMDiscountSchema getSchema()
	{
		PD_LMDiscountSchema aPD_LMDiscountSchema = new PD_LMDiscountSchema();
		aPD_LMDiscountSchema.setSchema(this);
		return aPD_LMDiscountSchema;
	}

	public PD_LMDiscountDB getDB()
	{
		PD_LMDiscountDB aDBOper = new PD_LMDiscountDB();
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpPD_LMDiscount>历史记账凭证主表信息</A>表字段
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		PD_LMDiscountSchema other = (PD_LMDiscountSchema)otherObject;
		return
