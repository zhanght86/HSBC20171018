...
import com.sinosoft.lis.db.LCTranPolErrLogDB;

/*
 * <p>ClassName: LCTranPolErrLogSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 寿险业务系统未整理模型
 */
public class LCTranPolErrLogSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LCTranPolErrLogSchema.class);
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LCTranPolErrLogSchema cloned = (LCTranPolErrLogSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LCTranPolErrLogSchema 对象给 Schema 赋值
	* @param: aLCTranPolErrLogSchema LCTranPolErrLogSchema
	**/
	public void setSchema(LCTranPolErrLogSchema aLCTranPolErrLogSchema)
	{
		this.SeriNo = aLCTranPolErrLogSchema.getSeriNo();
		this.PolNo = aLCTranPolErrLogSchema.getPolNo();
		this.Type = aLCTranPolErrLogSchema.getType();
		this.ErrInfo = aLCTranPolErrLogSchema.getErrInfo();
		this.MakeDate = fDate.getDate( aLCTranPolErrLogSchema.getMakeDate());
		this.MakeTime = aLCTranPolErrLogSchema.getMakeTime();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LCTranPolErrLog表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LCTranPolErrLogSchema";
	...
	public LCTranPolErrLogSchema getSchema()
	{
		LCTranPolErrLogSchema aLCTranPolErrLogSchema = new LCTranPolErrLogSchema();
		aLCTranPolErrLogSchema.setSchema(this);
		return aLCTranPolErrLogSchema;
	}

	public LCTranPolErrLogDB getDB()
	{
		LCTranPolErrLogDB aDBOper = new LCTranPolErrLogDB();
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLCTranPolErrLog>历史记账凭证主表信息</A>表字段
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LCTranPolErrLogSchema other = (LCTranPolErrLogSchema)otherObject;
		return
