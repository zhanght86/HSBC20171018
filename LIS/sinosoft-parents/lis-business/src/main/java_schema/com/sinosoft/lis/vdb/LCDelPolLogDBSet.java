...
/*
 * <p>ClassName: LCDelPolLogDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 寿险业务系统未整理模型
 */
public class LCDelPolLogDBSet extends LCDelPolLogSet
{
private static Logger logger = Logger.getLogger(LCDelPolLogDBSet.class);
	...
	**/
	...
	// @Constructor
	public LCDelPolLogDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LCDelPolLogDBSet";
...
ex.printStackTrace();
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getIsPolFlag() == null || this.get(i).getIsPolFlag().equals("null")) {
				pstmt.setString(3,null);
			} else {
				pstmt.setString(3, this.get(i).getIsPolFlag());
			}
			...
			if(this.get(i).getDelReason() == null || this.get(i).getDelReason().equals("null")) {
				...
				pstmt.setString(11, this.get(i).getDelReason());
			}
			...
			if(this.get(i).getOtherNoType() == null || this.get(i).getOtherNoType().equals("null")) {
				...
				pstmt.setString(14, this.get(i).getOtherNoType());
			}
			if(this.get(i).getMakeDate() == null || this.get(i).getMakeDate().equals("null")) {
			...
			if(this.get(i).getMakeTime() == null || this.get(i).getMakeTime().equals("null")) {
				...
				pstmt.setString(16, StrTool.space1(this.get(i).getMakeTime(), 8));
			}
