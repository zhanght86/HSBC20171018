...
/*
 * <p>ClassName: LMCertifyDesTraceSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 单证管理
 */
public class LMCertifyDesTraceSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LMCertifyDesTraceSchema.class);
	...
	// @Constructor
	public LMCertifyDesTraceSchema()
	{
		mErrors = new CErrors();
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LMCertifyDesTraceSchema cloned = (LMCertifyDesTraceSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LMCertifyDesTraceSchema 对象给 Schema 赋值
	* @param: aLMCertifyDesTraceSchema LMCertifyDesTraceSchema
	**/
	public void setSchema(LMCertifyDesTraceSchema aLMCertifyDesTraceSchema)
	{
		this.CertifyCode = aLMCertifyDesTraceSchema.getCertifyCode();
		this.CertifyName = aLMCertifyDesTraceSchema.getCertifyName();
		this.SubCode = aLMCertifyDesTraceSchema.getSubCode();
		this.RiskCode = aLMCertifyDesTraceSchema.getRiskCode();
		this.RiskVersion = aLMCertifyDesTraceSchema.getRiskVersion();
		this.CertifyClass = aLMCertifyDesTraceSchema.getCertifyClass();
		this.HavePrice = aLMCertifyDesTraceSchema.getHavePrice();
		this.CertifyClass2 = aLMCertifyDesTraceSchema.getCertifyClass2();
		this.ImportantLevel = aLMCertifyDesTraceSchema.getImportantLevel();
		this.HaveNumber = aLMCertifyDesTraceSchema.getHaveNumber();
		this.CertifyLength = aLMCertifyDesTraceSchema.getCertifyLength();
		this.TackBackFlag = aLMCertifyDesTraceSchema.getTackBackFlag();
		this.CertifyPrice = aLMCertifyDesTraceSchema.getCertifyPrice();
		this.Unit = aLMCertifyDesTraceSchema.getUnit();
		this.MaxPrintNo = aLMCertifyDesTraceSchema.getMaxPrintNo();
		this.SplitOnSend = aLMCertifyDesTraceSchema.getSplitOnSend();
		this.HaveLimit = aLMCertifyDesTraceSchema.getHaveLimit();
		this.MaxUnit1 = aLMCertifyDesTraceSchema.getMaxUnit1();
		this.MaxUnit2 = aLMCertifyDesTraceSchema.getMaxUnit2();
		this.HaveValidate = aLMCertifyDesTraceSchema.getHaveValidate();
		this.Validate1 = aLMCertifyDesTraceSchema.getValidate1();
		this.Validate2 = aLMCertifyDesTraceSchema.getValidate2();
		this.State = aLMCertifyDesTraceSchema.getState();
		this.Note = aLMCertifyDesTraceSchema.getNote();
		this.ManageCom = aLMCertifyDesTraceSchema.getManageCom();
		this.Operator = aLMCertifyDesTraceSchema.getOperator();
		this.MakeDate = fDate.getDate( aLMCertifyDesTraceSchema.getMakeDate());
		this.MakeTime = aLMCertifyDesTraceSchema.getMakeTime();
		this.JugAgtFlag = aLMCertifyDesTraceSchema.getJugAgtFlag();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LMCertifyDesTrace表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LMCertifyDesTraceSchema";
	...
	public LMCertifyDesTraceSchema getSchema()
	{
		LMCertifyDesTraceSchema aLMCertifyDesTraceSchema = new LMCertifyDesTraceSchema();
		aLMCertifyDesTraceSchema.setSchema(this);
		return aLMCertifyDesTraceSchema;
	}

	public LMCertifyDesTraceDB getDB()
	{
		LMCertifyDesTraceDB aDBOper = new LMCertifyDesTraceDB();
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLMCertifyDesTrace>历史记账凭证主表信息</A>表字段
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LMCertifyDesTraceSchema other = (LMCertifyDesTraceSchema)otherObject;
		return
