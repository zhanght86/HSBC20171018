...
import com.sinosoft.lis.db.LCCUWMasterBakDB;

/*
 * <p>ClassName: LCCUWMasterBakSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: PhysicalDataModel_1
 */
public class LCCUWMasterBakSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LCCUWMasterBakSchema.class);
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LCCUWMasterBakSchema cloned = (LCCUWMasterBakSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LCCUWMasterBakSchema 对象给 Schema 赋值
	* @param: aLCCUWMasterBakSchema LCCUWMasterBakSchema
	**/
	public void setSchema(LCCUWMasterBakSchema aLCCUWMasterBakSchema)
	{
		this.GrpContNo = aLCCUWMasterBakSchema.getGrpContNo();
		this.ContNo = aLCCUWMasterBakSchema.getContNo();
		this.ProposalContNo = aLCCUWMasterBakSchema.getProposalContNo();
		this.UWNo = aLCCUWMasterBakSchema.getUWNo();
		this.InsuredNo = aLCCUWMasterBakSchema.getInsuredNo();
		this.InsuredName = aLCCUWMasterBakSchema.getInsuredName();
		this.AppntNo = aLCCUWMasterBakSchema.getAppntNo();
		this.AppntName = aLCCUWMasterBakSchema.getAppntName();
		this.AgentCode = aLCCUWMasterBakSchema.getAgentCode();
		this.AgentGroup = aLCCUWMasterBakSchema.getAgentGroup();
		this.PassFlag = aLCCUWMasterBakSchema.getPassFlag();
		this.UWGrade = aLCCUWMasterBakSchema.getUWGrade();
		this.AppGrade = aLCCUWMasterBakSchema.getAppGrade();
		this.PostponeDay = aLCCUWMasterBakSchema.getPostponeDay();
		this.PostponeDate = fDate.getDate( aLCCUWMasterBakSchema.getPostponeDate());
		this.AutoUWFlag = aLCCUWMasterBakSchema.getAutoUWFlag();
		this.State = aLCCUWMasterBakSchema.getState();
		this.ManageCom = aLCCUWMasterBakSchema.getManageCom();
		this.UWIdea = aLCCUWMasterBakSchema.getUWIdea();
		this.UpReportContent = aLCCUWMasterBakSchema.getUpReportContent();
		this.Operator = aLCCUWMasterBakSchema.getOperator();
		this.HealthFlag = aLCCUWMasterBakSchema.getHealthFlag();
		this.QuesFlag = aLCCUWMasterBakSchema.getQuesFlag();
		this.SpecFlag = aLCCUWMasterBakSchema.getSpecFlag();
		this.AddPremFlag = aLCCUWMasterBakSchema.getAddPremFlag();
		this.AddPremReason = aLCCUWMasterBakSchema.getAddPremReason();
		this.ReportFlag = aLCCUWMasterBakSchema.getReportFlag();
		this.PrintFlag = aLCCUWMasterBakSchema.getPrintFlag();
		this.PrintFlag2 = aLCCUWMasterBakSchema.getPrintFlag2();
		this.ChangePolFlag = aLCCUWMasterBakSchema.getChangePolFlag();
		this.ChangePolReason = aLCCUWMasterBakSchema.getChangePolReason();
		this.SpecReason = aLCCUWMasterBakSchema.getSpecReason();
		this.MakeDate = fDate.getDate( aLCCUWMasterBakSchema.getMakeDate());
		this.MakeTime = aLCCUWMasterBakSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLCCUWMasterBakSchema.getModifyDate());
		this.ModifyTime = aLCCUWMasterBakSchema.getModifyTime();
		this.SugPassFlag = aLCCUWMasterBakSchema.getSugPassFlag();
		this.SugUWIdea = aLCCUWMasterBakSchema.getSugUWIdea();
		this.UpReport = aLCCUWMasterBakSchema.getUpReport();
		this.CommonReason = aLCCUWMasterBakSchema.getCommonReason();
		this.BatchNo = aLCCUWMasterBakSchema.getBatchNo();
		this.CommonReasonCode = aLCCUWMasterBakSchema.getCommonReasonCode();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LCCUWMasterBak表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LCCUWMasterBakSchema";
	...
	public LCCUWMasterBakSchema getSchema()
	{
		LCCUWMasterBakSchema aLCCUWMasterBakSchema = new LCCUWMasterBakSchema();
		aLCCUWMasterBakSchema.setSchema(this);
		return aLCCUWMasterBakSchema;
	}

	public LCCUWMasterBakDB getDB()
	{
		LCCUWMasterBakDB aDBOper = new LCCUWMasterBakDB();
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLCCUWMasterBak>历史记账凭证主表信息</A>表字段
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LCCUWMasterBakSchema other = (LCCUWMasterBakSchema)otherObject;
		return
