...
/*
 * <p>ClassName: LJAPayDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 寿险业务收费
 */
public class LJAPayDBSet extends LJAPaySet
{
	// @Field
	...
	**/
	...
	// @Constructor
	public LJAPayDBSet(Connection tConnection)
	{
		con = tConnection;
...
ex.printStackTrace();
	...
	public boolean update()
	{
		...
		try
		{
			...
			pstmt.setInt(35, this.get(i).getPayCount());
			pstmt.setDouble(36, this.get(i).getSumDuePayMoney());
			...
			pstmt.setDouble(53, this.get(i).getNetAmount());
			pstmt.setDouble(54, this.get(i).getTaxAmount());
			pstmt.setDouble(55, this.get(i).getTax());
			// set where condition
			if(this.get(i).getPayNo() == null || this.get(i).getPayNo().equals("null")) {
				pstmt.setString(56,null);
			} else {
				pstmt.setString(56, this.get(i).getPayNo());
			}
			if(this.get(i).getCurrency() == null || this.get(i).getCurrency().equals("null")) {
