...
{
private static Logger logger = Logger.getLogger(LBInsuredDB.class);
	...
	**/
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.getExecuteCom() == null || this.getExecuteCom().equals("null")) {
				...
				pstmt.setString(8, this.getExecuteCom());
			}
			...
			if(this.getRelationToMainInsured() == null || this.getRelationToMainInsured().equals("null")) {
				...
				pstmt.setString(10, this.getRelationToMainInsured());
			}
			if(this.getRelationToAppnt() == null || this.getRelationToAppnt().equals("null")) {
				pstmt.setNull(11, 12);
			} else {
				pstmt.setString(11, this.getRelationToAppnt());
			}
			...
			if(this.getNativePlace() == null || this.getNativePlace().equals("null")) {
				...
				pstmt.setString(19, this.getNativePlace());
			}
			if(this.getNationality() == null || this.getNationality().equals("null")) {
				pstmt.setNull(20, 12);
			} else {
				pstmt.setString(20, this.getNationality());
			}
			if(this.getRgtAddress() == null || this.getRgtAddress().equals("null")) {
				pstmt.setNull(21, 12);
			} else {
				pstmt.setString(21, this.getRgtAddress());
			}
			if(this.getMarriage() == null || this.getMarriage().equals("null")) {
				pstmt.setNull(22, 1);
			} else {
				pstmt.setString(22, this.getMarriage());
			}
			if(this.getMarriageDate() == null || this.getMarriageDate().equals("null")) {
				pstmt.setNull(23, 91);
			} else {
				pstmt.setDate(23, Date.valueOf(this.getMarriageDate()));
			}
			if(this.getHealth() == null || this.getHealth().equals("null")) {
				pstmt.setNull(24, 12);
			} else {
				pstmt.setString(24, this.getHealth());
			}
			pstmt.setDouble(25, this.getStature());
			pstmt.setDouble(26, this.getAvoirdupois());
			...
			if(this.getCreditGrade() == null || this.getCreditGrade().equals("null")) {
				...
				pstmt.setString(28, this.getCreditGrade());
			}
			...
			if(this.getJoinCompanyDate() == null || this.getJoinCompanyDate().equals("null")) {
				...
				pstmt.setDate(32, Date.valueOf(this.getJoinCompanyDate()));
			}
			if(this.getStartWorkDate() == null || this.getStartWorkDate().equals("null")) {
				pstmt.setNull(33, 91);
			} else {
				pstmt.setDate(33, Date.valueOf(this.getStartWorkDate()));
			}
			...
			pstmt.setDouble(35, this.getSalary());
			...
			if(this.getWorkType() == null || this.getWorkType().equals("null")) {
				...
				pstmt.setString(38, this.getWorkType());
			}
			if(this.getPluralityType() == null || this.getPluralityType().equals("null")) {
				pstmt.setNull(39, 12);
			} else {
				pstmt.setString(39, this.getPluralityType());
			}
			...
			if(this.getContPlanCode() == null || this.getContPlanCode().equals("null")) {
				...
				pstmt.setString(41, this.getContPlanCode());
			}
			...
			if(this.getInsuredStat() == null || this.getInsuredStat().equals("null")) {
				...
				pstmt.setString(43, this.getInsuredStat());
			}
			...
			if(this.getOrganComCode() == null || this.getOrganComCode().equals("null")) {
				...
				pstmt.setString(66, this.getOrganComCode());
			}
			// set where condition
			if(this.getContNo() == null || this.getContNo().equals("null")) {
				pstmt.setNull(67, 12);
			} else {
				pstmt.setString(67, this.getContNo());
			}
			if(this.getInsuredNo() == null || this.getInsuredNo().equals("null")) {
				pstmt.setNull(68, 12);
			} else {
				pstmt.setString(68, this.getInsuredNo());
			}
			pstmt.executeUpdate();
			pstmt.close();
		} catch (Exception ex) {
	...
	public boolean getInfo()
	{
		...
		try
		{
			pstmt = con.prepareStatement("SELECT * FROM LBInsured WHERE  ContNo = ? AND InsuredNo = ?", 
...
public boolean closeData()
{
	...
	public LBInsuredSet executeQuery(SQLwithBindVariables sqlbv) {
	...
	public LBInsuredSet executeQuery(SQLwithBindVariables sqlbv, int nStart, int nCount) {
