...
import com.sinosoft.lis.db.LOBCustomerContactInfoDB;

/*
 * 与数据库结构不一致，暂不处理
 * <p>ClassName: LOBCustomerContactInfoSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: Physical Data Model 1
 */
public class LOBCustomerContactInfoSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LOBCustomerContactInfoSchema.class);
	// @Field
	/** 业务类型 */
	...
	// @Constructor
	public LOBCustomerContactInfoSchema()
	{
		mErrors = new CErrors();
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LOBCustomerContactInfoSchema cloned = (LOBCustomerContactInfoSchema)super.clone();
	...
	public void setPolicyNo(String aPolicyNo)
	{
		if(aPolicyNo!=null && aPolicyNo.length()>20)
			throw new IllegalArgumentException("团体保单号PolicyNo值"+aPolicyNo+"的长度"+aPolicyNo.length()+"大于最大值20");
		PolicyNo = aPolicyNo;
	}
	...
	public void setPropNo(String aPropNo)
	{
		if(aPropNo!=null && aPropNo.length()>20)
			throw new IllegalArgumentException("个人投保单号PropNo值"+aPropNo+"的长度"+aPropNo.length()+"大于最大值20");
		PropNo = aPropNo;
	}
	...
	public void setWechat1(String aWechat1)
	{
		if(aWechat1!=null && aWechat1.length()>60)
			throw new IllegalArgumentException("微信号Wechat1值"+aWechat1+"的长度"+aWechat1.length()+"大于最大值60");
		Wechat1 = aWechat1;
	}
	...
	/**
	* 使用另外一个 LOBCustomerContactInfoSchema 对象给 Schema 赋值
	* @param: aLOBCustomerContactInfoSchema LOBCustomerContactInfoSchema
	**/
	public void setSchema(LOBCustomerContactInfoSchema aLOBCustomerContactInfoSchema)
	{
		this.BussType = aLOBCustomerContactInfoSchema.getBussType();
		this.BussNo = aLOBCustomerContactInfoSchema.getBussNo();
		this.PolicyNo = aLOBCustomerContactInfoSchema.getPolicyNo();
		this.PropNo = aLOBCustomerContactInfoSchema.getPropNo();
		this.ContNo = aLOBCustomerContactInfoSchema.getContNo();
		this.CustomerNo = aLOBCustomerContactInfoSchema.getCustomerNo();
		this.Province = aLOBCustomerContactInfoSchema.getProvince();
		this.City = aLOBCustomerContactInfoSchema.getCity();
		this.County = aLOBCustomerContactInfoSchema.getCounty();
		this.PostalAddress = aLOBCustomerContactInfoSchema.getPostalAddress();
		this.ZipCode = aLOBCustomerContactInfoSchema.getZipCode();
		this.Phone = aLOBCustomerContactInfoSchema.getPhone();
		this.Fax = aLOBCustomerContactInfoSchema.getFax();
		this.HomeAddress = aLOBCustomerContactInfoSchema.getHomeAddress();
		this.HomeZipCode = aLOBCustomerContactInfoSchema.getHomeZipCode();
		this.HomePhone = aLOBCustomerContactInfoSchema.getHomePhone();
		this.HomeFax = aLOBCustomerContactInfoSchema.getHomeFax();
		this.CompanyName = aLOBCustomerContactInfoSchema.getCompanyName();
		this.CompanyAddress = aLOBCustomerContactInfoSchema.getCompanyAddress();
		this.CompanyZipCode = aLOBCustomerContactInfoSchema.getCompanyZipCode();
		this.CompanyPhone = aLOBCustomerContactInfoSchema.getCompanyPhone();
		this.CompanyFax = aLOBCustomerContactInfoSchema.getCompanyFax();
		this.Mobile1 = aLOBCustomerContactInfoSchema.getMobile1();
		this.EMail1 = aLOBCustomerContactInfoSchema.getEMail1();
		this.QQ1 = aLOBCustomerContactInfoSchema.getQQ1();
		this.MSN1 = aLOBCustomerContactInfoSchema.getMSN1();
		this.Wechat1 = aLOBCustomerContactInfoSchema.getWechat1();
		this.Mobile2 = aLOBCustomerContactInfoSchema.getMobile2();
		this.EMail2 = aLOBCustomerContactInfoSchema.getEMail2();
		this.QQ2 = aLOBCustomerContactInfoSchema.getQQ2();
		this.MSN2 = aLOBCustomerContactInfoSchema.getMSN2();
		this.Wechat2 = aLOBCustomerContactInfoSchema.getWechat2();
		this.MakeOperator = aLOBCustomerContactInfoSchema.getMakeOperator();
		this.MakeDate = fDate.getDate( aLOBCustomerContactInfoSchema.getMakeDate());
		this.MakeTime = aLOBCustomerContactInfoSchema.getMakeTime();
		this.ModifyOperator = aLOBCustomerContactInfoSchema.getModifyOperator();
		this.ModifyDate = fDate.getDate( aLOBCustomerContactInfoSchema.getModifyDate());
		this.ModifyTime = aLOBCustomerContactInfoSchema.getModifyTime();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LOBCustomerContactInfo表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LOBCustomerContactInfoSchema";
	...
	public LOBCustomerContactInfoSchema getSchema()
	{
		LOBCustomerContactInfoSchema aLOBCustomerContactInfoSchema = new LOBCustomerContactInfoSchema();
		aLOBCustomerContactInfoSchema.setSchema(this);
		return aLOBCustomerContactInfoSchema;
	}

	public LOBCustomerContactInfoDB getDB()
	{
		LOBCustomerContactInfoDB aDBOper = new LOBCustomerContactInfoDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLOBCustomerContactInfo描述/A>表字段
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLOBCustomerContactInfo>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			County = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 9, SysConst.PACKAGESPILTER );
			PostalAddress = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 10, SysConst.PACKAGESPILTER );
			...
			HomeZipCode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 15, SysConst.PACKAGESPILTER );
			HomePhone = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 16, SysConst.PACKAGESPILTER );
			HomeFax = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 17, SysConst.PACKAGESPILTER );
			CompanyName = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 18, SysConst.PACKAGESPILTER );
			CompanyAddress = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 19, SysConst.PACKAGESPILTER );
			CompanyZipCode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 20, SysConst.PACKAGESPILTER );
			CompanyPhone = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 21, SysConst.PACKAGESPILTER );
			CompanyFax = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 22, SysConst.PACKAGESPILTER );
			Mobile1 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 23, SysConst.PACKAGESPILTER );
			EMail1 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 24, SysConst.PACKAGESPILTER );
			QQ1 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 25, SysConst.PACKAGESPILTER );
			MSN1 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 26, SysConst.PACKAGESPILTER );
			Wechat1 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 27, SysConst.PACKAGESPILTER );
			Mobile2 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 28, SysConst.PACKAGESPILTER );
			EMail2 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 29, SysConst.PACKAGESPILTER );
			QQ2 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 30, SysConst.PACKAGESPILTER );
			MSN2 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 31, SysConst.PACKAGESPILTER );
			Wechat2 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 32, SysConst.PACKAGESPILTER );
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LOBCustomerContactInfoSchema other = (LOBCustomerContactInfoSchema)otherObject;
		return
