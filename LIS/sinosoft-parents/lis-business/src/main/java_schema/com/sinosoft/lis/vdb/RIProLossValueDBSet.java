...
/*
 * <p>ClassName: RIProLossValueDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 再保系统模型
 */
public class RIProLossValueDBSet extends RIProLossValueSet
{
	// @Field
	...
	**/
	...
	// @Constructor
	public RIProLossValueDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "RIProLossValueDBSet";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getCalYear() == null || this.get(i).getCalYear().equals("null")) {
				...
				pstmt.setString(4, this.get(i).getCalYear());
			}
			if(this.get(i).getFactorCode() == null || this.get(i).getFactorCode().equals("null")) {
			...
			if(this.get(i).getBatchNo() == null || this.get(i).getBatchNo().equals("null")) {
				...
				pstmt.setString(16, this.get(i).getBatchNo());
			}
			if(this.get(i).getRIProfitNo() == null || this.get(i).getRIProfitNo().equals("null")) {
				pstmt.setString(17,null);
			} else {
				pstmt.setString(17, this.get(i).getRIProfitNo());
			}
			if(this.get(i).getCurrency() == null || this.get(i).getCurrency().equals("null")) {
			...
			if(this.get(i).getFactorCode() == null || this.get(i).getFactorCode().equals("null")) {
				...
				pstmt.setString(19, this.get(i).getFactorCode());
			}
