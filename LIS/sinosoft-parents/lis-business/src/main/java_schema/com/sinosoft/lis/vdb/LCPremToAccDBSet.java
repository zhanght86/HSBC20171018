...
/*
 * <p>ClassName: LCPremToAccDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 承保核心
 */
public class LCPremToAccDBSet extends LCPremToAccSet
{
private static Logger logger = Logger.getLogger(LCPremToAccDBSet.class);
	...
	**/
	...
	// @Constructor
	public LCPremToAccDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LCPremToAccDBSet";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getNewFlag() == null || this.get(i).getNewFlag().equals("null")) {
				...
				pstmt.setString(6, this.get(i).getNewFlag());
			}
