...
import com.sinosoft.lis.db.LDGrpBlackListTraceDB;

/*
 * <p>ClassName: LDGrpBlackListTraceSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 承保核心
 */
public class LDGrpBlackListTraceSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LDGrpBlackListTraceSchema.class);
	// @Field
	/** 流水号 */
	...
	// @Constructor
	public LDGrpBlackListTraceSchema()
	{
		mErrors = new CErrors();
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LDGrpBlackListTraceSchema cloned = (LDGrpBlackListTraceSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LDGrpBlackListTraceSchema 对象给 Schema 赋值
	* @param: aLDGrpBlackListTraceSchema LDGrpBlackListTraceSchema
	**/
	public void setSchema(LDGrpBlackListTraceSchema aLDGrpBlackListTraceSchema)
	{
		this.SerialNo = aLDGrpBlackListTraceSchema.getSerialNo();
		this.CustomerNo = aLDGrpBlackListTraceSchema.getCustomerNo();
		this.Password = aLDGrpBlackListTraceSchema.getPassword();
		this.GrpName = aLDGrpBlackListTraceSchema.getGrpName();
		this.BusinessType = aLDGrpBlackListTraceSchema.getBusinessType();
		this.GrpNature = aLDGrpBlackListTraceSchema.getGrpNature();
		this.Peoples = aLDGrpBlackListTraceSchema.getPeoples();
		this.RgtMoney = aLDGrpBlackListTraceSchema.getRgtMoney();
		this.Asset = aLDGrpBlackListTraceSchema.getAsset();
		this.NetProfitRate = aLDGrpBlackListTraceSchema.getNetProfitRate();
		this.MainBussiness = aLDGrpBlackListTraceSchema.getMainBussiness();
		this.Corporation = aLDGrpBlackListTraceSchema.getCorporation();
		this.ComAera = aLDGrpBlackListTraceSchema.getComAera();
		this.Fax = aLDGrpBlackListTraceSchema.getFax();
		this.Phone = aLDGrpBlackListTraceSchema.getPhone();
		this.GetFlag = aLDGrpBlackListTraceSchema.getGetFlag();
		this.Satrap = aLDGrpBlackListTraceSchema.getSatrap();
		this.EMail = aLDGrpBlackListTraceSchema.getEMail();
		this.FoundDate = fDate.getDate( aLDGrpBlackListTraceSchema.getFoundDate());
		this.BankCode = aLDGrpBlackListTraceSchema.getBankCode();
		this.BankAccNo = aLDGrpBlackListTraceSchema.getBankAccNo();
		this.GrpGroupNo = aLDGrpBlackListTraceSchema.getGrpGroupNo();
		this.BlacklistFlag = aLDGrpBlackListTraceSchema.getBlacklistFlag();
		this.State = aLDGrpBlackListTraceSchema.getState();
		this.Remark = aLDGrpBlackListTraceSchema.getRemark();
		this.VIPValue = aLDGrpBlackListTraceSchema.getVIPValue();
		this.Operator = aLDGrpBlackListTraceSchema.getOperator();
		this.MakeDate = fDate.getDate( aLDGrpBlackListTraceSchema.getMakeDate());
		this.MakeTime = aLDGrpBlackListTraceSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLDGrpBlackListTraceSchema.getModifyDate());
		this.ModifyTime = aLDGrpBlackListTraceSchema.getModifyTime();
		this.SubCompanyFlag = aLDGrpBlackListTraceSchema.getSubCompanyFlag();
		this.SupCustoemrNo = aLDGrpBlackListTraceSchema.getSupCustoemrNo();
		this.LevelCode = aLDGrpBlackListTraceSchema.getLevelCode();
		this.OnWorkPeoples = aLDGrpBlackListTraceSchema.getOnWorkPeoples();
		this.OffWorkPeoples = aLDGrpBlackListTraceSchema.getOffWorkPeoples();
		this.OtherPeoples = aLDGrpBlackListTraceSchema.getOtherPeoples();
		this.BusinessBigType = aLDGrpBlackListTraceSchema.getBusinessBigType();
		this.SocialInsuNo = aLDGrpBlackListTraceSchema.getSocialInsuNo();
		this.BlackListReason = aLDGrpBlackListTraceSchema.getBlackListReason();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LDGrpBlackListTrace表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LDGrpBlackListTraceSchema";
	...
	public LDGrpBlackListTraceSchema getSchema()
	{
		LDGrpBlackListTraceSchema aLDGrpBlackListTraceSchema = new LDGrpBlackListTraceSchema();
		aLDGrpBlackListTraceSchema.setSchema(this);
		return aLDGrpBlackListTraceSchema;
	}

	public LDGrpBlackListTraceDB getDB()
	{
		LDGrpBlackListTraceDB aDBOper = new LDGrpBlackListTraceDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLDGrpBlackListTrace描述/A>表字段
	...
	**/
	public String encode()
	{
		...
		strReturn.append(StrTool.cTrim(BlackListReason));
		return strReturn.toString();
	}

	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLDGrpBlackListTrace>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			BusinessType = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 5, SysConst.PACKAGESPILTER );
			GrpNature = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 6, SysConst.PACKAGESPILTER );
			Peoples= new Integer(ChgData.chgNumericStr(StrTool.getStr(strMessage,7,SysConst.PACKAGESPILTER))).intValue();
			RgtMoney = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,8,SysConst.PACKAGESPILTER))).doubleValue();
			Asset = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,9,SysConst.PACKAGESPILTER))).doubleValue();
			NetProfitRate = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,10,SysConst.PACKAGESPILTER))).doubleValue();
			MainBussiness = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 11, SysConst.PACKAGESPILTER );
			Corporation = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 12, SysConst.PACKAGESPILTER );
			ComAera = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 13, SysConst.PACKAGESPILTER );
			Fax = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 14, SysConst.PACKAGESPILTER );
			Phone = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 15, SysConst.PACKAGESPILTER );
			GetFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 16, SysConst.PACKAGESPILTER );
			Satrap = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 17, SysConst.PACKAGESPILTER );
			EMail = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 18, SysConst.PACKAGESPILTER );
			FoundDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 19,SysConst.PACKAGESPILTER));
			...
			GrpGroupNo = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 22, SysConst.PACKAGESPILTER );
			BlacklistFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 23, SysConst.PACKAGESPILTER );
			...
			VIPValue = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 26, SysConst.PACKAGESPILTER );
			...
			SubCompanyFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 32, SysConst.PACKAGESPILTER );
			SupCustoemrNo = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 33, SysConst.PACKAGESPILTER );
			LevelCode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 34, SysConst.PACKAGESPILTER );
			OnWorkPeoples= new Integer(ChgData.chgNumericStr(StrTool.getStr(strMessage,35,SysConst.PACKAGESPILTER))).intValue();
			OffWorkPeoples= new Integer(ChgData.chgNumericStr(StrTool.getStr(strMessage,36,SysConst.PACKAGESPILTER))).intValue();
			OtherPeoples= new Integer(ChgData.chgNumericStr(StrTool.getStr(strMessage,37,SysConst.PACKAGESPILTER))).intValue();
			BusinessBigType = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 38, SysConst.PACKAGESPILTER );
			SocialInsuNo = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 39, SysConst.PACKAGESPILTER );
			BlackListReason = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 40, SysConst.PACKAGESPILTER );
		}
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LDGrpBlackListTraceSchema other = (LDGrpBlackListTraceSchema)otherObject;
		return
