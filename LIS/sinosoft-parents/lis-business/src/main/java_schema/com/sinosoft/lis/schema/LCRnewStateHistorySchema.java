...
/*
 * <p>ClassName: LCRnewStateHistorySchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 保费续期及中介
 */
public class LCRnewStateHistorySchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LCRnewStateHistorySchema.class);
	...
	// @Constructor
	public LCRnewStateHistorySchema()
	{
		mErrors = new CErrors();
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LCRnewStateHistorySchema cloned = (LCRnewStateHistorySchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LCRnewStateHistorySchema 对象给 Schema 赋值
	* @param: aLCRnewStateHistorySchema LCRnewStateHistorySchema
	**/
	public void setSchema(LCRnewStateHistorySchema aLCRnewStateHistorySchema)
	{
		this.ContNo = aLCRnewStateHistorySchema.getContNo();
		this.RiskCode = aLCRnewStateHistorySchema.getRiskCode();
		this.State = aLCRnewStateHistorySchema.getState();
		this.ManageCom = aLCRnewStateHistorySchema.getManageCom();
		this.AgentCode = aLCRnewStateHistorySchema.getAgentCode();
		this.AgentGroup = aLCRnewStateHistorySchema.getAgentGroup();
		this.MakeDate = fDate.getDate( aLCRnewStateHistorySchema.getMakeDate());
		this.ModifyDate = fDate.getDate( aLCRnewStateHistorySchema.getModifyDate());
		this.Remark = aLCRnewStateHistorySchema.getRemark();
		this.PaytoDate = fDate.getDate( aLCRnewStateHistorySchema.getPaytoDate());
		this.ProposalNo = aLCRnewStateHistorySchema.getProposalNo();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LCRnewStateHistory表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LCRnewStateHistorySchema";
	...
	public LCRnewStateHistorySchema getSchema()
	{
		LCRnewStateHistorySchema aLCRnewStateHistorySchema = new LCRnewStateHistorySchema();
		aLCRnewStateHistorySchema.setSchema(this);
		return aLCRnewStateHistorySchema;
	}

	public LCRnewStateHistoryDB getDB()
	{
		LCRnewStateHistoryDB aDBOper = new LCRnewStateHistoryDB();
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLCRnewStateHistory>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			PaytoDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 10,SysConst.PACKAGESPILTER));
			ProposalNo = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 11, SysConst.PACKAGESPILTER );
		}
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LCRnewStateHistorySchema other = (LCRnewStateHistorySchema)otherObject;
		return
