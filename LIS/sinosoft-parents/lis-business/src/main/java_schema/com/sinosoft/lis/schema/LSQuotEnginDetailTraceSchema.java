...
import com.sinosoft.lis.db.LSQuotEnginDetailTraceDB;

/*
 * <p>ClassName: LSQuotEnginDetailTraceSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: Physical Data Model 1
 */
public class LSQuotEnginDetailTraceSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LSQuotEnginDetailTraceSchema.class);
	// @Field
	/** 流水号 */
	...
	// @Constructor
	public LSQuotEnginDetailTraceSchema()
	{
		mErrors = new CErrors();
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LSQuotEnginDetailTraceSchema cloned = (LSQuotEnginDetailTraceSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LSQuotEnginDetailTraceSchema 对象给 Schema 赋值
	* @param: aLSQuotEnginDetailTraceSchema LSQuotEnginDetailTraceSchema
	**/
	public void setSchema(LSQuotEnginDetailTraceSchema aLSQuotEnginDetailTraceSchema)
	{
		this.SerialNo = aLSQuotEnginDetailTraceSchema.getSerialNo();
		this.QuotNo = aLSQuotEnginDetailTraceSchema.getQuotNo();
		this.QuotBatNo = aLSQuotEnginDetailTraceSchema.getQuotBatNo();
		this.SysPlanCode = aLSQuotEnginDetailTraceSchema.getSysPlanCode();
		this.PlanCode = aLSQuotEnginDetailTraceSchema.getPlanCode();
		this.EnginCode = aLSQuotEnginDetailTraceSchema.getEnginCode();
		this.OtherDesc = aLSQuotEnginDetailTraceSchema.getOtherDesc();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LSQuotEnginDetailTrace表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LSQuotEnginDetailTraceSchema";
	...
	public LSQuotEnginDetailTraceSchema getSchema()
	{
		LSQuotEnginDetailTraceSchema aLSQuotEnginDetailTraceSchema = new LSQuotEnginDetailTraceSchema();
		aLSQuotEnginDetailTraceSchema.setSchema(this);
		return aLSQuotEnginDetailTraceSchema;
	}

	public LSQuotEnginDetailTraceDB getDB()
	{
		LSQuotEnginDetailTraceDB aDBOper = new LSQuotEnginDetailTraceDB();
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLSQuotEnginDetailTrace>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			EnginCode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 6, SysConst.PACKAGESPILTER );
			OtherDesc = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 7, SysConst.PACKAGESPILTER );
		}
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LSQuotEnginDetailTraceSchema other = (LSQuotEnginDetailTraceSchema)otherObject;
		return
