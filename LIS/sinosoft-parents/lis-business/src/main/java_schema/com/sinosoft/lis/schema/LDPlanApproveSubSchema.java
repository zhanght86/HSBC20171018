...
import com.sinosoft.lis.db.LDPlanApproveSubDB;

/*
 * <p>ClassName: LDPlanApproveSubSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 基础信息
 */
public class LDPlanApproveSubSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LDPlanApproveSubSchema.class);
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LDPlanApproveSubSchema cloned = (LDPlanApproveSubSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LDPlanApproveSubSchema 对象给 Schema 赋值
	* @param: aLDPlanApproveSubSchema LDPlanApproveSubSchema
	**/
	public void setSchema(LDPlanApproveSubSchema aLDPlanApproveSubSchema)
	{
		this.ContPlanCode = aLDPlanApproveSubSchema.getContPlanCode();
		this.ContPlanName = aLDPlanApproveSubSchema.getContPlanName();
		this.PlanType = aLDPlanApproveSubSchema.getPlanType();
		this.OperateNo = aLDPlanApproveSubSchema.getOperateNo();
		this.ManageCom = aLDPlanApproveSubSchema.getManageCom();
		this.OperateType = aLDPlanApproveSubSchema.getOperateType();
		this.OperateResult = aLDPlanApproveSubSchema.getOperateResult();
		this.Remark = aLDPlanApproveSubSchema.getRemark();
		this.Operator = aLDPlanApproveSubSchema.getOperator();
		this.MakeDate = fDate.getDate( aLDPlanApproveSubSchema.getMakeDate());
		this.MakeTime = aLDPlanApproveSubSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLDPlanApproveSubSchema.getModifyDate());
		this.ModifyTime = aLDPlanApproveSubSchema.getModifyTime();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LDPlanApproveSub表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LDPlanApproveSubSchema";
	...
	public LDPlanApproveSubSchema getSchema()
	{
		LDPlanApproveSubSchema aLDPlanApproveSubSchema = new LDPlanApproveSubSchema();
		aLDPlanApproveSubSchema.setSchema(this);
		return aLDPlanApproveSubSchema;
	}

	public LDPlanApproveSubDB getDB()
	{
		LDPlanApproveSubDB aDBOper = new LDPlanApproveSubDB();
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLDPlanApproveSub>历史记账凭证主表信息</A>表字段
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LDPlanApproveSubSchema other = (LDPlanApproveSubSchema)otherObject;
		return
