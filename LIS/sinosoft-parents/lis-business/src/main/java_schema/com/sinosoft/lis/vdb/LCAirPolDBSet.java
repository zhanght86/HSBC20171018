...
/*
 * <p>ClassName: LCAirPolDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 短期险平台接口表
 */
public class LCAirPolDBSet extends LCAirPolSet
{
private static Logger logger = Logger.getLogger(LCAirPolDBSet.class);
	...
	**/
	...
	// @Constructor
	public LCAirPolDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LCAirPolDBSet";
