...
/*
 * <p>ClassName: LDPreGrpLinkInfoDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: Physical Data Model 1
 */
public class LDPreGrpLinkInfoDBSet extends LDPreGrpLinkInfoSet
{
	// @Field
	...
	**/
	...
	// @Constructor
	public LDPreGrpLinkInfoDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LDPreGrpLinkInfoDBSet";
	...
	public boolean delete()
	{
		...
		try
		{
			...
			pstmt.setInt(2, this.get(i).getLinkOrderNo());
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getLinkType() == null || this.get(i).getLinkType().equals("null")) {
				...
				pstmt.setString(3, this.get(i).getLinkType());
			}
			...
			if(this.get(i).getIDExpiryDate() == null || this.get(i).getIDExpiryDate().equals("null")) {
				...
				pstmt.setDate(7, Date.valueOf(this.get(i).getIDExpiryDate()));
			}
			if(this.get(i).getMobile() == null || this.get(i).getMobile().equals("null")) {
				pstmt.setString(8,null);
			} else {
				pstmt.setString(8, this.get(i).getMobile());
			}
			...
			if(this.get(i).getDepart() == null || this.get(i).getDepart().equals("null")) {
				...
				pstmt.setString(12, this.get(i).getDepart());
			}
			if(this.get(i).getPost() == null || this.get(i).getPost().equals("null")) {
				pstmt.setString(13,null);
			} else {
				pstmt.setString(13, this.get(i).getPost());
			}
			...
			if(this.get(i).getPreCustomerNo() == null || this.get(i).getPreCustomerNo().equals("null")) {
				...
				pstmt.setString(20, this.get(i).getPreCustomerNo());
			}
			pstmt.setInt(21, this.get(i).getLinkOrderNo());
