...
import com.sinosoft.lis.db.LQDutyDB;

/*
 * <p>ClassName: LQDutySchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: PhysicalDataModel_1
 */
public class LQDutySchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LQDutySchema.class);
	// @Field
	/** 报价单号 */
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LQDutySchema cloned = (LQDutySchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LQDutySchema 对象给 Schema 赋值
	* @param: aLQDutySchema LQDutySchema
	**/
	public void setSchema(LQDutySchema aLQDutySchema)
	{
		this.AskPriceNo = aLQDutySchema.getAskPriceNo();
		this.AskNo = aLQDutySchema.getAskNo();
		this.ClassNo = aLQDutySchema.getClassNo();
		this.DutyCode = aLQDutySchema.getDutyCode();
		this.Mult = aLQDutySchema.getMult();
		this.StandPrem = aLQDutySchema.getStandPrem();
		this.Prem = aLQDutySchema.getPrem();
		this.SumPrem = aLQDutySchema.getSumPrem();
		this.Amnt = aLQDutySchema.getAmnt();
		this.RiskAmnt = aLQDutySchema.getRiskAmnt();
		this.PayIntv = aLQDutySchema.getPayIntv();
		this.PayYears = aLQDutySchema.getPayYears();
		this.Years = aLQDutySchema.getYears();
		this.FloatRate = aLQDutySchema.getFloatRate();
		this.FirstPayDate = fDate.getDate( aLQDutySchema.getFirstPayDate());
		this.FirstMonth = aLQDutySchema.getFirstMonth();
		this.PaytoDate = fDate.getDate( aLQDutySchema.getPaytoDate());
		this.PayEndDate = fDate.getDate( aLQDutySchema.getPayEndDate());
		this.PayEndYearFlag = aLQDutySchema.getPayEndYearFlag();
		this.PayEndYear = aLQDutySchema.getPayEndYear();
		this.GetYearFlag = aLQDutySchema.getGetYearFlag();
		this.GetYear = aLQDutySchema.getGetYear();
		this.InsuYearFlag = aLQDutySchema.getInsuYearFlag();
		this.InsuYear = aLQDutySchema.getInsuYear();
		this.AcciYearFlag = aLQDutySchema.getAcciYearFlag();
		this.AcciYear = aLQDutySchema.getAcciYear();
		this.EndDate = fDate.getDate( aLQDutySchema.getEndDate());
		this.AcciEndDate = fDate.getDate( aLQDutySchema.getAcciEndDate());
		this.FreeFlag = aLQDutySchema.getFreeFlag();
		this.FreeRate = aLQDutySchema.getFreeRate();
		this.FreeStartDate = fDate.getDate( aLQDutySchema.getFreeStartDate());
		this.FreeEndDate = fDate.getDate( aLQDutySchema.getFreeEndDate());
		this.GetStartDate = fDate.getDate( aLQDutySchema.getGetStartDate());
		this.GetStartType = aLQDutySchema.getGetStartType();
		this.LiveGetMode = aLQDutySchema.getLiveGetMode();
		this.DeadGetMode = aLQDutySchema.getDeadGetMode();
		this.BonusGetMode = aLQDutySchema.getBonusGetMode();
		this.SSFlag = aLQDutySchema.getSSFlag();
		this.PeakLine = aLQDutySchema.getPeakLine();
		this.GetLimit = aLQDutySchema.getGetLimit();
		this.GetRate = aLQDutySchema.getGetRate();
		this.CalRule = aLQDutySchema.getCalRule();
		this.PremToAmnt = aLQDutySchema.getPremToAmnt();
		this.StandbyFlag1 = aLQDutySchema.getStandbyFlag1();
		this.StandbyFlag2 = aLQDutySchema.getStandbyFlag2();
		this.StandbyFlag3 = aLQDutySchema.getStandbyFlag3();
		this.Operator = aLQDutySchema.getOperator();
		this.MakeDate = fDate.getDate( aLQDutySchema.getMakeDate());
		this.MakeTime = aLQDutySchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLQDutySchema.getModifyDate());
		this.ModifyTime = aLQDutySchema.getModifyTime();
		this.CValiDate = fDate.getDate( aLQDutySchema.getCValiDate());
		this.GetIntv = aLQDutySchema.getGetIntv();
		this.AscriptionRuleCode = aLQDutySchema.getAscriptionRuleCode();
		this.PayRuleCode = aLQDutySchema.getPayRuleCode();
		this.Currency = aLQDutySchema.getCurrency();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LQDuty表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LQDutySchema";
	...
	public LQDutySchema getSchema()
	{
		LQDutySchema aLQDutySchema = new LQDutySchema();
		aLQDutySchema.setSchema(this);
		return aLQDutySchema;
	}

	public LQDutyDB getDB()
	{
		LQDutyDB aDBOper = new LQDutyDB();
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLQDuty>历史记账凭证主表信息</A>表字段
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LQDutySchema other = (LQDutySchema)otherObject;
		return
