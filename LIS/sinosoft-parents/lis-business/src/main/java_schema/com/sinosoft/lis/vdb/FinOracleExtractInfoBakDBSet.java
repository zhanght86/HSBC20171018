...
/*
 * <p>ClassName: FinOracleExtractInfoBakDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: Physical Data Model 1
 */
public class FinOracleExtractInfoBakDBSet extends FinOracleExtractInfoBakSet
{
	// @Field
	...
	**/
	...
	// @Constructor
	public FinOracleExtractInfoBakDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public FinOracleExtractInfoBakDBSet()
	{
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "FinOracleExtractInfoBakDBSet";
...
ex.printStackTrace();
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getDeleteManageCom() == null || this.get(i).getDeleteManageCom().equals("null")) {
				pstmt.setString(45,null);
			} else {
				pstmt.setString(45, this.get(i).getDeleteManageCom());
			}
			if(this.get(i).getDeleteComCode() == null || this.get(i).getDeleteComCode().equals("null")) {
				pstmt.setString(46,null);
			} else {
				pstmt.setString(46, this.get(i).getDeleteComCode());
			}
			if(this.get(i).getDeleteOperator() == null || this.get(i).getDeleteOperator().equals("null")) {
				pstmt.setString(47,null);
			} else {
				pstmt.setString(47, this.get(i).getDeleteOperator());
			}
			if(this.get(i).getDeleteDate() == null || this.get(i).getDeleteDate().equals("null")) {
				pstmt.setDate(48,null);
			} else {
				pstmt.setDate(48, Date.valueOf(this.get(i).getDeleteDate()));
			}
			if(this.get(i).getDeleteTime() == null || this.get(i).getDeleteTime().equals("null")) {
				pstmt.setString(49,null);
			} else {
				pstmt.setString(49, this.get(i).getDeleteTime());
			}
			// set where condition
			if(this.get(i).getSerialNo() == null || this.get(i).getSerialNo().equals("null")) {
				pstmt.setString(50,null);
			} else {
				pstmt.setString(50, this.get(i).getSerialNo());
			}
