...
/*
 * <p>ClassName: LPGrpFeeParamDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 保全核心
 */
public class LPGrpFeeParamDBSet extends LPGrpFeeParamSet
{
private static Logger logger = Logger.getLogger(LPGrpFeeParamDBSet.class);
	...
	**/
	...
	// @Constructor
	public LPGrpFeeParamDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LPGrpFeeParamDBSet";
...
ex.printStackTrace();
	...
	public boolean update()
	{
		...
		try
		{
			...
			pstmt.setInt(9, this.get(i).getFeeID());
			pstmt.setDouble(10, this.get(i).getFeeMin());
			pstmt.setDouble(11, this.get(i).getFeeMax());
			pstmt.setDouble(12, this.get(i).getFeeRate());
			...
			if(this.get(i).getFeeCode() == null || this.get(i).getFeeCode().equals("null")) {
				...
				pstmt.setString(21, this.get(i).getFeeCode());
			}
			if(this.get(i).getInsuAccNo() == null || this.get(i).getInsuAccNo().equals("null")) {
			...
			pstmt.setInt(24, this.get(i).getFeeID());
