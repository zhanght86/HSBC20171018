...
{
private static Logger logger = Logger.getLogger(LMCalFactorDB.class);
	...
	**/
	...
	public boolean getInfo()
	{
		...
		try
		{
			pstmt = con.prepareStatement("SELECT * FROM LMCalFactor WHERE  CalCode = ? AND FactorCode = ?", 
 ...
 */
public LMCalFactorSet getData()
{
    int tCount = 0;
    LMCalFactorSet tLMCalFactorSet = new LMCalFactorSet();
    LMCalFactorSchema tLMCalFactorSchema = null;
    if (null == mResultSet)
    {
        CError tError = new CError();
        tError.moduleName = "LMCalFactorDB";
    ...
    try
    {
        ...
        tLMCalFactorSchema.setSchema(mResultSet, 1);
...
public boolean closeData()
{
	...
	public LMCalFactorSet executeQuery(SQLwithBindVariables sqlbv) {
	...
	public LMCalFactorSet executeQuery(SQLwithBindVariables sqlbv, int nStart, int nCount) {
