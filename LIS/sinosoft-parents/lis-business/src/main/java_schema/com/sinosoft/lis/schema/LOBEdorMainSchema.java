...
import com.sinosoft.lis.db.LOBEdorMainDB;

/*
 * <p>ClassName: LOBEdorMainSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 保全核心
 */
public class LOBEdorMainSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LOBEdorMainSchema.class);
	// @Field
	/** 保全受理号 */
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LOBEdorMainSchema cloned = (LOBEdorMainSchema)super.clone();
	...
	/**
	* 个人保单时一个批单号对应一个个人合同，团体保单时一个批单号可能对应多个个人保单
	*/
	...
	*/
	...
	/**
	* 使用另外一个 LOBEdorMainSchema 对象给 Schema 赋值
	* @param: aLOBEdorMainSchema LOBEdorMainSchema
	**/
	public void setSchema(LOBEdorMainSchema aLOBEdorMainSchema)
	{
		this.EdorAcceptNo = aLOBEdorMainSchema.getEdorAcceptNo();
		this.EdorNo = aLOBEdorMainSchema.getEdorNo();
		this.ContNo = aLOBEdorMainSchema.getContNo();
		this.EdorAppNo = aLOBEdorMainSchema.getEdorAppNo();
		this.EdorAppName = aLOBEdorMainSchema.getEdorAppName();
		this.ManageCom = aLOBEdorMainSchema.getManageCom();
		this.ChgPrem = aLOBEdorMainSchema.getChgPrem();
		this.ChgAmnt = aLOBEdorMainSchema.getChgAmnt();
		this.GetMoney = aLOBEdorMainSchema.getGetMoney();
		this.GetInterest = aLOBEdorMainSchema.getGetInterest();
		this.EdorAppDate = fDate.getDate( aLOBEdorMainSchema.getEdorAppDate());
		this.EdorValiDate = fDate.getDate( aLOBEdorMainSchema.getEdorValiDate());
		this.EdorState = aLOBEdorMainSchema.getEdorState();
		this.BankCode = aLOBEdorMainSchema.getBankCode();
		this.BankAccNo = aLOBEdorMainSchema.getBankAccNo();
		this.AccName = aLOBEdorMainSchema.getAccName();
		this.PostalAddress = aLOBEdorMainSchema.getPostalAddress();
		this.ZipCode = aLOBEdorMainSchema.getZipCode();
		this.Phone = aLOBEdorMainSchema.getPhone();
		this.PrintFlag = aLOBEdorMainSchema.getPrintFlag();
		this.UWGrade = aLOBEdorMainSchema.getUWGrade();
		this.AppGrade = aLOBEdorMainSchema.getAppGrade();
		this.UWState = aLOBEdorMainSchema.getUWState();
		this.UWOperator = aLOBEdorMainSchema.getUWOperator();
		this.UWDate = fDate.getDate( aLOBEdorMainSchema.getUWDate());
		this.UWTime = aLOBEdorMainSchema.getUWTime();
		this.ConfOperator = aLOBEdorMainSchema.getConfOperator();
		this.ConfDate = fDate.getDate( aLOBEdorMainSchema.getConfDate());
		this.ConfTime = aLOBEdorMainSchema.getConfTime();
		this.Operator = aLOBEdorMainSchema.getOperator();
		this.MakeDate = fDate.getDate( aLOBEdorMainSchema.getMakeDate());
		this.MakeTime = aLOBEdorMainSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLOBEdorMainSchema.getModifyDate());
		this.ModifyTime = aLOBEdorMainSchema.getModifyTime();
		this.Reason = aLOBEdorMainSchema.getReason();
		this.ReasonCode = aLOBEdorMainSchema.getReasonCode();
		this.ApproveFlag = aLOBEdorMainSchema.getApproveFlag();
		this.ApproveOperator = aLOBEdorMainSchema.getApproveOperator();
		this.ApproveDate = fDate.getDate( aLOBEdorMainSchema.getApproveDate());
		this.ApproveTime = aLOBEdorMainSchema.getApproveTime();
		this.Currency = aLOBEdorMainSchema.getCurrency();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LOBEdorMain表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LOBEdorMainSchema";
	...
	public LOBEdorMainSchema getSchema()
	{
		LOBEdorMainSchema aLOBEdorMainSchema = new LOBEdorMainSchema();
		aLOBEdorMainSchema.setSchema(this);
		return aLOBEdorMainSchema;
	}

	public LOBEdorMainDB getDB()
	{
		LOBEdorMainDB aDBOper = new LOBEdorMainDB();
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLOBEdorMain>历史记账凭证主表信息</A>表字段
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LOBEdorMainSchema other = (LOBEdorMainSchema)otherObject;
		return
