...
/*
 * <p>ClassName: LCCSpecDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 承保流程
 */
public class LCCSpecDBSet extends LCCSpecSet
{
private static Logger logger = Logger.getLogger(LCCSpecDBSet.class);
	...
	**/
	...
	// @Constructor
	public LCCSpecDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LCCSpecDBSet";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getSpecReason() == null || this.get(i).getSpecReason().equals("null")) {
				...
				pstmt.setString(18, this.get(i).getSpecReason());
			}
			if(this.get(i).getNeedPrint() == null || this.get(i).getNeedPrint().equals("null")) {
				pstmt.setString(19,null);
			} else {
				pstmt.setString(19, this.get(i).getNeedPrint());
			}
			// set where condition
			if(this.get(i).getProposalContNo() == null || this.get(i).getProposalContNo().equals("null")) {
