...
/*
 * <p>ClassName: LCGPlanUWSubSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 寿险业务系统未整理模型
 */
public class LCGPlanUWSubSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LCGPlanUWSubSchema.class);
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LCGPlanUWSubSchema cloned = (LCGPlanUWSubSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LCGPlanUWSubSchema 对象给 Schema 赋值
	* @param: aLCGPlanUWSubSchema LCGPlanUWSubSchema
	**/
	public void setSchema(LCGPlanUWSubSchema aLCGPlanUWSubSchema)
	{
		this.GrpContNo = aLCGPlanUWSubSchema.getGrpContNo();
		this.ProposalGrpContNo = aLCGPlanUWSubSchema.getProposalGrpContNo();
		this.ContPlanCode = aLCGPlanUWSubSchema.getContPlanCode();
		this.PlanType = aLCGPlanUWSubSchema.getPlanType();
		this.UWNo = aLCGPlanUWSubSchema.getUWNo();
		this.InsuredNo = aLCGPlanUWSubSchema.getInsuredNo();
		this.InsuredName = aLCGPlanUWSubSchema.getInsuredName();
		this.AppntNo = aLCGPlanUWSubSchema.getAppntNo();
		this.AppntName = aLCGPlanUWSubSchema.getAppntName();
		this.AgentCode = aLCGPlanUWSubSchema.getAgentCode();
		this.AgentGroup = aLCGPlanUWSubSchema.getAgentGroup();
		this.PassFlag = aLCGPlanUWSubSchema.getPassFlag();
		this.UWGrade = aLCGPlanUWSubSchema.getUWGrade();
		this.AppGrade = aLCGPlanUWSubSchema.getAppGrade();
		this.PostponeDay = aLCGPlanUWSubSchema.getPostponeDay();
		this.PostponeDate = fDate.getDate( aLCGPlanUWSubSchema.getPostponeDate());
		this.AutoUWFlag = aLCGPlanUWSubSchema.getAutoUWFlag();
		this.State = aLCGPlanUWSubSchema.getState();
		this.ManageCom = aLCGPlanUWSubSchema.getManageCom();
		this.UWIdea = aLCGPlanUWSubSchema.getUWIdea();
		this.UpReportContent = aLCGPlanUWSubSchema.getUpReportContent();
		this.HealthFlag = aLCGPlanUWSubSchema.getHealthFlag();
		this.QuesFlag = aLCGPlanUWSubSchema.getQuesFlag();
		this.SpecFlag = aLCGPlanUWSubSchema.getSpecFlag();
		this.AddPremFlag = aLCGPlanUWSubSchema.getAddPremFlag();
		this.AddPremReason = aLCGPlanUWSubSchema.getAddPremReason();
		this.ReportFlag = aLCGPlanUWSubSchema.getReportFlag();
		this.PrintFlag = aLCGPlanUWSubSchema.getPrintFlag();
		this.PrintFlag2 = aLCGPlanUWSubSchema.getPrintFlag2();
		this.ChangePolFlag = aLCGPlanUWSubSchema.getChangePolFlag();
		this.ChangePolReason = aLCGPlanUWSubSchema.getChangePolReason();
		this.SpecReason = aLCGPlanUWSubSchema.getSpecReason();
		this.UpReport = aLCGPlanUWSubSchema.getUpReport();
		this.Operator = aLCGPlanUWSubSchema.getOperator();
		this.MakeDate = fDate.getDate( aLCGPlanUWSubSchema.getMakeDate());
		this.MakeTime = aLCGPlanUWSubSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLCGPlanUWSubSchema.getModifyDate());
		this.ModifyTime = aLCGPlanUWSubSchema.getModifyTime();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LCGPlanUWSub表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LCGPlanUWSubSchema";
	...
	public LCGPlanUWSubSchema getSchema()
	{
		LCGPlanUWSubSchema aLCGPlanUWSubSchema = new LCGPlanUWSubSchema();
		aLCGPlanUWSubSchema.setSchema(this);
		return aLCGPlanUWSubSchema;
	}

	public LCGPlanUWSubDB getDB()
	{
		LCGPlanUWSubDB aDBOper = new LCGPlanUWSubDB();
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLCGPlanUWSub>历史记账凭证主表信息</A>表字段
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LCGPlanUWSubSchema other = (LCGPlanUWSubSchema)otherObject;
		return
