...
/*
 * <p>ClassName: LCIndUWErrorDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 承保流程
 */
public class LCIndUWErrorDBSet extends LCIndUWErrorSet
{
private static Logger logger = Logger.getLogger(LCIndUWErrorDBSet.class);
	...
	**/
	...
	// @Constructor
	public LCIndUWErrorDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LCIndUWErrorDBSet";
