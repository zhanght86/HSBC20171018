...
/*
 * <p>ClassName: LPCUWMasterSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 保全流程
 */
public class LPCUWMasterSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LPCUWMasterSchema.class);
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LPCUWMasterSchema cloned = (LPCUWMasterSchema)super.clone();
	...
	* 9 标准体<p>
	* <p>
	* 对应LDCode.CodeType = 'edorcontuwstate'
	*/
	...
	*/
	...
	public void setCustomerIdea(String aCustomerIdea)
	{
		CustomerIdea = aCustomerIdea;
	}
	...
	/**
	* 使用另外一个 LPCUWMasterSchema 对象给 Schema 赋值
	* @param: aLPCUWMasterSchema LPCUWMasterSchema
	**/
	public void setSchema(LPCUWMasterSchema aLPCUWMasterSchema)
	{
		this.EdorNo = aLPCUWMasterSchema.getEdorNo();
		this.EdorType = aLPCUWMasterSchema.getEdorType();
		this.GrpContNo = aLPCUWMasterSchema.getGrpContNo();
		this.ContNo = aLPCUWMasterSchema.getContNo();
		this.ProposalContNo = aLPCUWMasterSchema.getProposalContNo();
		this.UWNo = aLPCUWMasterSchema.getUWNo();
		this.InsuredNo = aLPCUWMasterSchema.getInsuredNo();
		this.InsuredName = aLPCUWMasterSchema.getInsuredName();
		this.AppntNo = aLPCUWMasterSchema.getAppntNo();
		this.AppntName = aLPCUWMasterSchema.getAppntName();
		this.AgentCode = aLPCUWMasterSchema.getAgentCode();
		this.AgentGroup = aLPCUWMasterSchema.getAgentGroup();
		this.PassFlag = aLPCUWMasterSchema.getPassFlag();
		this.UWGrade = aLPCUWMasterSchema.getUWGrade();
		this.AppGrade = aLPCUWMasterSchema.getAppGrade();
		this.PostponeDay = aLPCUWMasterSchema.getPostponeDay();
		this.PostponeDate = fDate.getDate( aLPCUWMasterSchema.getPostponeDate());
		this.AutoUWFlag = aLPCUWMasterSchema.getAutoUWFlag();
		this.State = aLPCUWMasterSchema.getState();
		this.ManageCom = aLPCUWMasterSchema.getManageCom();
		this.UWIdea = aLPCUWMasterSchema.getUWIdea();
		this.UpReportContent = aLPCUWMasterSchema.getUpReportContent();
		this.Operator = aLPCUWMasterSchema.getOperator();
		this.HealthFlag = aLPCUWMasterSchema.getHealthFlag();
		this.QuesFlag = aLPCUWMasterSchema.getQuesFlag();
		this.SpecFlag = aLPCUWMasterSchema.getSpecFlag();
		this.AddPremFlag = aLPCUWMasterSchema.getAddPremFlag();
		this.AddPremReason = aLPCUWMasterSchema.getAddPremReason();
		this.ReportFlag = aLPCUWMasterSchema.getReportFlag();
		this.PrintFlag = aLPCUWMasterSchema.getPrintFlag();
		this.PrintFlag2 = aLPCUWMasterSchema.getPrintFlag2();
		this.ChangePolFlag = aLPCUWMasterSchema.getChangePolFlag();
		this.ChangePolReason = aLPCUWMasterSchema.getChangePolReason();
		this.SpecReason = aLPCUWMasterSchema.getSpecReason();
		this.MakeDate = fDate.getDate( aLPCUWMasterSchema.getMakeDate());
		this.MakeTime = aLPCUWMasterSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLPCUWMasterSchema.getModifyDate());
		this.ModifyTime = aLPCUWMasterSchema.getModifyTime();
		this.SugPassFlag = aLPCUWMasterSchema.getSugPassFlag();
		this.SugUWIdea = aLPCUWMasterSchema.getSugUWIdea();
		this.CustomerIdea = aLPCUWMasterSchema.getCustomerIdea();
		this.EdorAcceptNo = aLPCUWMasterSchema.getEdorAcceptNo();
		this.CommonReason = aLPCUWMasterSchema.getCommonReason();
		this.CommonReasonCode = aLPCUWMasterSchema.getCommonReasonCode();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		try
		{
			...
			if( rs.getString("CustomerIdea") == null )
				this.CustomerIdea = null;
			else
				this.CustomerIdea = rs.getString("CustomerIdea").trim();
		...
		{
			logger.debug("数据库中的LPCUWMaster表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LPCUWMasterSchema";
	...
	public LPCUWMasterSchema getSchema()
	{
		LPCUWMasterSchema aLPCUWMasterSchema = new LPCUWMasterSchema();
		aLPCUWMasterSchema.setSchema(this);
		return aLPCUWMasterSchema;
	}

	public LPCUWMasterDB getDB()
	{
		LPCUWMasterDB aDBOper = new LPCUWMasterDB();
	...
	**/
	public String encode()
	{
		...
		strReturn.append(StrTool.cTrim(CustomerIdea)); strReturn.append(SysConst.PACKAGESPILTER);
		...
		strReturn.append(StrTool.cTrim(CommonReasonCode));
		return strReturn.toString();
	}

	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLPCUWMaster>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			UWGrade = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 14, SysConst.PACKAGESPILTER );
			AppGrade = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 15, SysConst.PACKAGESPILTER );
			PostponeDay = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 16, SysConst.PACKAGESPILTER );
			PostponeDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 17,SysConst.PACKAGESPILTER));
			AutoUWFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 18, SysConst.PACKAGESPILTER );
			...
			UWIdea = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 21, SysConst.PACKAGESPILTER );
			UpReportContent = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 22, SysConst.PACKAGESPILTER );
			Operator = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 23, SysConst.PACKAGESPILTER );
			HealthFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 24, SysConst.PACKAGESPILTER );
			QuesFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 25, SysConst.PACKAGESPILTER );
			SpecFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 26, SysConst.PACKAGESPILTER );
			AddPremFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 27, SysConst.PACKAGESPILTER );
			AddPremReason = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 28, SysConst.PACKAGESPILTER );
			ReportFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 29, SysConst.PACKAGESPILTER );
			PrintFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 30, SysConst.PACKAGESPILTER );
			PrintFlag2 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 31, SysConst.PACKAGESPILTER );
			ChangePolFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 32, SysConst.PACKAGESPILTER );
			ChangePolReason = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 33, SysConst.PACKAGESPILTER );
			SpecReason = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 34, SysConst.PACKAGESPILTER );
			...
			SugPassFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 39, SysConst.PACKAGESPILTER );
			SugUWIdea = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 40, SysConst.PACKAGESPILTER );
			CustomerIdea = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 41, SysConst.PACKAGESPILTER );
			EdorAcceptNo = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 42, SysConst.PACKAGESPILTER );
			CommonReason = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 43, SysConst.PACKAGESPILTER );
			CommonReasonCode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 44, SysConst.PACKAGESPILTER );
		}
	...
	**/
	public String getV(String FCode)
	{
		...
		{
			strReturn = StrTool.GBKToUnicode(String.valueOf(CustomerIdea));
		}
	...
	public String getV(int nFieldIndex)
	{
		...
		switch(nFieldIndex) {
			...
			case 39:
				...
				break;
			case 40:
				strFieldValue = StrTool.GBKToUnicode(CustomerIdea);
				break;
			case 41:
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LPCUWMasterSchema other = (LPCUWMasterSchema)otherObject;
		return
			...
			&& CustomerIdea.equals(other.getCustomerIdea())
	...
	**/
	public int getFieldIndex(String strFieldName)
	{
		...
		if( strFieldName.equals("CustomerIdea") ) {
			return 40;
		}
