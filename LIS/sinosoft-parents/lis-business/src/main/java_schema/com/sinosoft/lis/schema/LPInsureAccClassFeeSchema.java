...
/*
 * <p>ClassName: LPInsureAccClassFeeSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 保全核心
 */
public class LPInsureAccClassFeeSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LPInsureAccClassFeeSchema.class);
	// @Field
	/** 批单号 */
	...
	// @Constructor
	public LPInsureAccClassFeeSchema()
	{
		mErrors = new CErrors();
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LPInsureAccClassFeeSchema cloned = (LPInsureAccClassFeeSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LPInsureAccClassFeeSchema 对象给 Schema 赋值
	* @param: aLPInsureAccClassFeeSchema LPInsureAccClassFeeSchema
	**/
	public void setSchema(LPInsureAccClassFeeSchema aLPInsureAccClassFeeSchema)
	{
		this.EdorNo = aLPInsureAccClassFeeSchema.getEdorNo();
		this.EdorType = aLPInsureAccClassFeeSchema.getEdorType();
		this.PolNo = aLPInsureAccClassFeeSchema.getPolNo();
		this.InsuAccNo = aLPInsureAccClassFeeSchema.getInsuAccNo();
		this.PayPlanCode = aLPInsureAccClassFeeSchema.getPayPlanCode();
		this.OtherNo = aLPInsureAccClassFeeSchema.getOtherNo();
		this.OtherType = aLPInsureAccClassFeeSchema.getOtherType();
		this.AccAscription = aLPInsureAccClassFeeSchema.getAccAscription();
		this.RiskCode = aLPInsureAccClassFeeSchema.getRiskCode();
		this.ContNo = aLPInsureAccClassFeeSchema.getContNo();
		this.GrpPolNo = aLPInsureAccClassFeeSchema.getGrpPolNo();
		this.GrpContNo = aLPInsureAccClassFeeSchema.getGrpContNo();
		this.ManageCom = aLPInsureAccClassFeeSchema.getManageCom();
		this.InsuredNo = aLPInsureAccClassFeeSchema.getInsuredNo();
		this.AppntNo = aLPInsureAccClassFeeSchema.getAppntNo();
		this.AccType = aLPInsureAccClassFeeSchema.getAccType();
		this.AccComputeFlag = aLPInsureAccClassFeeSchema.getAccComputeFlag();
		this.AccFoundDate = fDate.getDate( aLPInsureAccClassFeeSchema.getAccFoundDate());
		this.AccFoundTime = aLPInsureAccClassFeeSchema.getAccFoundTime();
		this.BalaDate = fDate.getDate( aLPInsureAccClassFeeSchema.getBalaDate());
		this.BalaTime = aLPInsureAccClassFeeSchema.getBalaTime();
		this.FeeRate = aLPInsureAccClassFeeSchema.getFeeRate();
		this.Fee = aLPInsureAccClassFeeSchema.getFee();
		this.FeeUnit = aLPInsureAccClassFeeSchema.getFeeUnit();
		this.Operator = aLPInsureAccClassFeeSchema.getOperator();
		this.MakeDate = fDate.getDate( aLPInsureAccClassFeeSchema.getMakeDate());
		this.MakeTime = aLPInsureAccClassFeeSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLPInsureAccClassFeeSchema.getModifyDate());
		this.ModifyTime = aLPInsureAccClassFeeSchema.getModifyTime();
		this.FeeCode = aLPInsureAccClassFeeSchema.getFeeCode();
		this.Currency = aLPInsureAccClassFeeSchema.getCurrency();
		this.InvestType = aLPInsureAccClassFeeSchema.getInvestType();
		this.IsInitFee = aLPInsureAccClassFeeSchema.getIsInitFee();
		this.ComCode = aLPInsureAccClassFeeSchema.getComCode();
		this.ModifyOperator = aLPInsureAccClassFeeSchema.getModifyOperator();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LPInsureAccClassFee表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LPInsureAccClassFeeSchema";
	...
	public LPInsureAccClassFeeSchema getSchema()
	{
		LPInsureAccClassFeeSchema aLPInsureAccClassFeeSchema = new LPInsureAccClassFeeSchema();
		aLPInsureAccClassFeeSchema.setSchema(this);
		return aLPInsureAccClassFeeSchema;
	}

	public LPInsureAccClassFeeDB getDB()
	{
		LPInsureAccClassFeeDB aDBOper = new LPInsureAccClassFeeDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLPInsureAccClassFee描述/A>表字段
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLPInsureAccClassFee>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			OtherType = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 7, SysConst.PACKAGESPILTER );
			...
			GrpContNo = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 12, SysConst.PACKAGESPILTER );
			...
			BalaDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 20,SysConst.PACKAGESPILTER));
			BalaTime = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 21, SysConst.PACKAGESPILTER );
			FeeRate = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,22,SysConst.PACKAGESPILTER))).doubleValue();
			Fee = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,23,SysConst.PACKAGESPILTER))).doubleValue();
			FeeUnit = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,24,SysConst.PACKAGESPILTER))).doubleValue();
			...
			FeeCode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 30, SysConst.PACKAGESPILTER );
			Currency = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 31, SysConst.PACKAGESPILTER );
			InvestType = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 32, SysConst.PACKAGESPILTER );
			IsInitFee = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 33, SysConst.PACKAGESPILTER );
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LPInsureAccClassFeeSchema other = (LPInsureAccClassFeeSchema)otherObject;
		return
