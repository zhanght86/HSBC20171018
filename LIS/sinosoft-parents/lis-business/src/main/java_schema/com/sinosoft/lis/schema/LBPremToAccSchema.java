...
import com.sinosoft.lis.db.LBPremToAccDB;

/*
 * <p>ClassName: LBPremToAccSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 寿险业务系统未整理模型
 */
public class LBPremToAccSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LBPremToAccSchema.class);
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LBPremToAccSchema cloned = (LBPremToAccSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LBPremToAccSchema 对象给 Schema 赋值
	* @param: aLBPremToAccSchema LBPremToAccSchema
	**/
	public void setSchema(LBPremToAccSchema aLBPremToAccSchema)
	{
		this.EdorNo = aLBPremToAccSchema.getEdorNo();
		this.PolNo = aLBPremToAccSchema.getPolNo();
		this.DutyCode = aLBPremToAccSchema.getDutyCode();
		this.PayPlanCode = aLBPremToAccSchema.getPayPlanCode();
		this.InsuAccNo = aLBPremToAccSchema.getInsuAccNo();
		this.Rate = aLBPremToAccSchema.getRate();
		this.NewFlag = aLBPremToAccSchema.getNewFlag();
		this.CalCodeMoney = aLBPremToAccSchema.getCalCodeMoney();
		this.CalCodeUnit = aLBPremToAccSchema.getCalCodeUnit();
		this.CalFlag = aLBPremToAccSchema.getCalFlag();
		this.Operator = aLBPremToAccSchema.getOperator();
		this.MakeDate = fDate.getDate( aLBPremToAccSchema.getMakeDate());
		this.MakeTime = aLBPremToAccSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLBPremToAccSchema.getModifyDate());
		this.ModifyTime = aLBPremToAccSchema.getModifyTime();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LBPremToAcc表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LBPremToAccSchema";
	...
	public LBPremToAccSchema getSchema()
	{
		LBPremToAccSchema aLBPremToAccSchema = new LBPremToAccSchema();
		aLBPremToAccSchema.setSchema(this);
		return aLBPremToAccSchema;
	}

	public LBPremToAccDB getDB()
	{
		LBPremToAccDB aDBOper = new LBPremToAccDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLBPremToAcc描述/A>表字段
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLBPremToAcc>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			NewFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 7, SysConst.PACKAGESPILTER );
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LBPremToAccSchema other = (LBPremToAccSchema)otherObject;
		return
