...
/*
 * <p>ClassName: RIBonusAccBakeDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 再保系统模型
 */
public class RIBonusAccBakeDBSet extends RIBonusAccBakeSet
{
	// @Field
	...
	**/
	...
	// @Constructor
	public RIBonusAccBakeDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "RIBonusAccBakeDBSet";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getBonusType() == null || this.get(i).getBonusType().equals("null")) {
				...
				pstmt.setString(10, this.get(i).getBonusType());
			}
			...
			if(this.get(i).getAccComputeFlag() == null || this.get(i).getAccComputeFlag().equals("null")) {
				...
				pstmt.setString(13, this.get(i).getAccComputeFlag());
			}
			pstmt.setDouble(14, this.get(i).getSumBonus());
			...
			if(this.get(i).getLastPayDate() == null || this.get(i).getLastPayDate().equals("null")) {
				...
				pstmt.setDate(25, Date.valueOf(this.get(i).getLastPayDate()));
			}
			// set where condition
			if(this.get(i).getSerialNo() == null || this.get(i).getSerialNo().equals("null")) {
