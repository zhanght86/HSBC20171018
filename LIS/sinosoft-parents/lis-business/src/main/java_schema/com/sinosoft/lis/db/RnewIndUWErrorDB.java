...
/*
 * <p>ClassName: RnewIndUWErrorDB </p>
 * <p>Description: DB层数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 续期续保二核
 */
public class RnewIndUWErrorDB extends RnewIndUWErrorSchema
{
private static Logger logger = Logger.getLogger(RnewIndUWErrorDB.class);
	...
	**/
	...
	// @Constructor
	public RnewIndUWErrorDB( Connection tConnection )
	{
		con = tConnection;
	...
	{
		RnewIndUWErrorSchema tSchema = this.getSchema();
		...
		else
		{
			...
			tError.moduleName = "RnewIndUWErrorDB";
	...
	public boolean getInfo()
	{
		...
		try
		{
			pstmt = con.prepareStatement("SELECT * FROM RnewIndUWError WHERE  UWNo = ? AND SerialNo = ?", 
	...
	public RnewIndUWErrorSet query()
	{
		PreparedStatement pstmt = null;
 		ResultSet rs = null;
		RnewIndUWErrorSet aRnewIndUWErrorSet = new RnewIndUWErrorSet();
	  ...
	  if( !mflag ) {
		...
		{
			SQLString sqlObj = new SQLString("RnewIndUWError");
			RnewIndUWErrorSchema aSchema = this.getSchema();
			...
			{
				i++;
				RnewIndUWErrorSchema s1 = new RnewIndUWErrorSchema();
				s1.setSchema(rs,i);
				aRnewIndUWErrorSet.add(s1);
			}
			try{ rs.close(); } catch( Exception ex ) {}
			try{ pstmt.close(); } catch( Exception ex1 ) {}
		}
		...
		return aRnewIndUWErrorSet;

	}

	public RnewIndUWErrorSet executeQuery(String sql)
	{
		Statement stmt = null;
		ResultSet rs = null;
		RnewIndUWErrorSet aRnewIndUWErrorSet = new RnewIndUWErrorSet();
	...
	public RnewIndUWErrorSet query(int nStart, int nCount)
	{
		PreparedStatement pstmt = null;
 		ResultSet rs = null;
		RnewIndUWErrorSet aRnewIndUWErrorSet = new RnewIndUWErrorSet();
	...
	public RnewIndUWErrorSet executeQuery(String sql, int nStart, int nCount)
	{
		Statement stmt = null;
		ResultSet rs = null;
		RnewIndUWErrorSet aRnewIndUWErrorSet = new RnewIndUWErrorSet();
	...
	public boolean update(String strWherePart)
	{
	  ...
	  if( !mflag ) {
		...
		try
		{
			...
			String sql = "update RnewIndUWError " + sqlObj.getUpdPart() + " where " + strWherePart;
...
/**
 * 获取定量数据
 * @return RnewIndUWErrorSet
 */
public RnewIndUWErrorSet getData()
{
    int tCount = 0;
    RnewIndUWErrorSet tRnewIndUWErrorSet = new RnewIndUWErrorSet();
    RnewIndUWErrorSchema tRnewIndUWErrorSchema = null;
    if (null == mResultSet)
    {
        CError tError = new CError();
        tError.moduleName = "RnewIndUWErrorDB";
    ...
    {
        tCount = 1;
        tRnewIndUWErrorSchema = new RnewIndUWErrorSchema();
        tRnewIndUWErrorSchema.setSchema(mResultSet, 1);
        tRnewIndUWErrorSet.add(tRnewIndUWErrorSchema);
...
public boolean closeData()
{
	...
	public RnewIndUWErrorSet executeQuery(SQLwithBindVariables sqlbv) {
	...
	public RnewIndUWErrorSet executeQuery(SQLwithBindVariables sqlbv, int nStart, int nCount) {
