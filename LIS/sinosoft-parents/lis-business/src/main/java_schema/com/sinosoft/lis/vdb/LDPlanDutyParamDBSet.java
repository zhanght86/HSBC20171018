...
/*
 * <p>ClassName: LDPlanDutyParamDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 基础信息
 */
public class LDPlanDutyParamDBSet extends LDPlanDutyParamSet
{
private static Logger logger = Logger.getLogger(LDPlanDutyParamDBSet.class);
	...
	**/
	...
	// @Constructor
	public LDPlanDutyParamDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LDPlanDutyParamDBSet";
	...
	public boolean delete()
	{
		...
		try
		{
			...
			if(this.get(i).getMainRiskCode() == null || this.get(i).getMainRiskCode().equals("null")) {
				...
				pstmt.setString(1, this.get(i).getMainRiskCode());
			}
			...
			if(this.get(i).getPlanType() == null || this.get(i).getPlanType().equals("null")) {
				...
				pstmt.setString(6, StrTool.space1(this.get(i).getPlanType(), 1));
			}
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getMainRiskVersion() == null || this.get(i).getMainRiskVersion().equals("null")) {
				...
				pstmt.setString(2, this.get(i).getMainRiskVersion());
			}
			if(this.get(i).getRiskCode() == null || this.get(i).getRiskCode().equals("null")) {
				pstmt.setString(3,null);
			} else {
			...
			if(this.get(i).getCalFactorType() == null || this.get(i).getCalFactorType().equals("null")) {
				...
				pstmt.setString(9, this.get(i).getCalFactorType());
			}
			if(this.get(i).getCalFactorValue() == null || this.get(i).getCalFactorValue().equals("null")) {
				pstmt.setString(10,null);
			} else {
				pstmt.setString(10, this.get(i).getCalFactorValue());
			}
			...
			if(this.get(i).getPlanType() == null || this.get(i).getPlanType().equals("null")) {
				...
				pstmt.setString(12, this.get(i).getPlanType());
			}
			if(this.get(i).getPortfolioFlag() == null || this.get(i).getPortfolioFlag().equals("null")) {
				pstmt.setString(13,null);
			} else {
				pstmt.setString(13, this.get(i).getPortfolioFlag());
			}
			// set where condition
			if(this.get(i).getMainRiskCode() == null || this.get(i).getMainRiskCode().equals("null")) {
				pstmt.setString(14,null);
			} else {
				pstmt.setString(14, this.get(i).getMainRiskCode());
			}
			if(this.get(i).getRiskCode() == null || this.get(i).getRiskCode().equals("null")) {
			...
			if(this.get(i).getCalFactor() == null || this.get(i).getCalFactor().equals("null")) {
				...
				pstmt.setString(18, this.get(i).getCalFactor());
			}
			if(this.get(i).getPlanType() == null || this.get(i).getPlanType().equals("null")) {
				pstmt.setString(19,null);
			} else {
				pstmt.setString(19, StrTool.space1(this.get(i).getPlanType(), 1));
			}
