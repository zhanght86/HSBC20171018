...
/*
 * <p>ClassName: LCContPlanDetailSubDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 新单管理
 */
public class LCContPlanDetailSubDBSet extends LCContPlanDetailSubSet
{
	// @Field
	...
	**/
	...
	// @Constructor
	public LCContPlanDetailSubDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public LCContPlanDetailSubDBSet()
	{
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LCContPlanDetailSubDBSet";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getPolicyNo() == null || this.get(i).getPolicyNo().equals("null")) {
				...
				pstmt.setString(37, this.get(i).getPolicyNo());
			}
			if(this.get(i).getSysPlanCode() == null || this.get(i).getSysPlanCode().equals("null")) {
				pstmt.setString(38,null);
			} else {
				pstmt.setString(38, this.get(i).getSysPlanCode());
			}
			if(this.get(i).getPlanCode() == null || this.get(i).getPlanCode().equals("null")) {
				pstmt.setString(39,null);
			} else {
				pstmt.setString(39, this.get(i).getPlanCode());
			}
			if(this.get(i).getRiskCode() == null || this.get(i).getRiskCode().equals("null")) {
				pstmt.setString(40,null);
			} else {
				pstmt.setString(40, this.get(i).getRiskCode());
			}
			if(this.get(i).getDutyCode() == null || this.get(i).getDutyCode().equals("null")) {
