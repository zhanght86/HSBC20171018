...
import com.sinosoft.lis.db.ModifyBankInfoLogDB;

/*
 * <p>ClassName: ModifyBankInfoLogSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 寿险业务收费
 */
public class ModifyBankInfoLogSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(ModifyBankInfoLogSchema.class);
	// @Field
	/** 通知书号码 */
	...
	// @Constructor
	public ModifyBankInfoLogSchema()
	{
		mErrors = new CErrors();
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		ModifyBankInfoLogSchema cloned = (ModifyBankInfoLogSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 ModifyBankInfoLogSchema 对象给 Schema 赋值
	* @param: aModifyBankInfoLogSchema ModifyBankInfoLogSchema
	**/
	public void setSchema(ModifyBankInfoLogSchema aModifyBankInfoLogSchema)
	{
		this.GetNoticeNo = aModifyBankInfoLogSchema.getGetNoticeNo();
		this.ChangeSerialNo = aModifyBankInfoLogSchema.getChangeSerialNo();
		this.ChangeType = aModifyBankInfoLogSchema.getChangeType();
		this.PayMode = aModifyBankInfoLogSchema.getPayMode();
		this.BankCode = aModifyBankInfoLogSchema.getBankCode();
		this.BankAccNo = aModifyBankInfoLogSchema.getBankAccNo();
		this.AccName = aModifyBankInfoLogSchema.getAccName();
		this.OtherNo = aModifyBankInfoLogSchema.getOtherNo();
		this.EdorAcceptNo = aModifyBankInfoLogSchema.getEdorAcceptNo();
		this.Operator = aModifyBankInfoLogSchema.getOperator();
		this.MakeDate = fDate.getDate( aModifyBankInfoLogSchema.getMakeDate());
		this.MakeTime = aModifyBankInfoLogSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aModifyBankInfoLogSchema.getModifyDate());
		this.ModifyTime = aModifyBankInfoLogSchema.getModifyTime();
		this.ManageCom = aModifyBankInfoLogSchema.getManageCom();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的ModifyBankInfoLog表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "ModifyBankInfoLogSchema";
	...
	public ModifyBankInfoLogSchema getSchema()
	{
		ModifyBankInfoLogSchema aModifyBankInfoLogSchema = new ModifyBankInfoLogSchema();
		aModifyBankInfoLogSchema.setSchema(this);
		return aModifyBankInfoLogSchema;
	}

	public ModifyBankInfoLogDB getDB()
	{
		ModifyBankInfoLogDB aDBOper = new ModifyBankInfoLogDB();
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpModifyBankInfoLog>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			ChangeType = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 3, SysConst.PACKAGESPILTER );
			...
			EdorAcceptNo = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 9, SysConst.PACKAGESPILTER );
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		ModifyBankInfoLogSchema other = (ModifyBankInfoLogSchema)otherObject;
		return
