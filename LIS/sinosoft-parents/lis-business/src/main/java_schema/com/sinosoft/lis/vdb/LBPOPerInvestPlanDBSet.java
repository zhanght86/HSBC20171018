...
/*
 * <p>ClassName: LBPOPerInvestPlanDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 内部外包流程
 */
public class LBPOPerInvestPlanDBSet extends LBPOPerInvestPlanSet
{
private static Logger logger = Logger.getLogger(LBPOPerInvestPlanDBSet.class);
	...
	**/
	...
	// @Constructor
	public LBPOPerInvestPlanDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LBPOPerInvestPlanDBSet";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getInvestMinRate() == null || this.get(i).getInvestMinRate().equals("null")) {
				...
				pstmt.setString(11, this.get(i).getInvestMinRate());
			}
			if(this.get(i).getInvestMaxRate() == null || this.get(i).getInvestMaxRate().equals("null")) {
				pstmt.setString(12,null);
			} else {
				pstmt.setString(12, this.get(i).getInvestMaxRate());
			}
			...
			if(this.get(i).getInvestRate() == null || this.get(i).getInvestRate().equals("null")) {
				...
				pstmt.setString(14, this.get(i).getInvestRate());
			}
			if(this.get(i).getInvestMoney() == null || this.get(i).getInvestMoney().equals("null")) {
				pstmt.setString(15,null);
			} else {
				pstmt.setString(15, this.get(i).getInvestMoney());
			}
