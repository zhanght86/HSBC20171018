...
/*
 * <p>ClassName: LSQuotPlanDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: Physical Data Model 1
 */
public class LSQuotPlanDBSet extends LSQuotPlanSet
{
	// @Field
	...
	**/
	...
	// @Constructor
	public LSQuotPlanDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LSQuotPlanDBSet";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getPlanDesc() == null || this.get(i).getPlanDesc().equals("null")) {
				...
				pstmt.setString(5, this.get(i).getPlanDesc());
			}
			...
			if(this.get(i).getPlanFlag() == null || this.get(i).getPlanFlag().equals("null")) {
				...
				pstmt.setString(7, this.get(i).getPlanFlag());
			}
			if(this.get(i).getPremCalType() == null || this.get(i).getPremCalType().equals("null")) {
				pstmt.setString(8,null);
			} else {
				pstmt.setString(8, this.get(i).getPremCalType());
			}
			pstmt.setInt(9, this.get(i).getInsuPeriod());
			if(this.get(i).getInsuPeriodFlag() == null || this.get(i).getInsuPeriodFlag().equals("null")) {
				pstmt.setString(10,null);
			} else {
				pstmt.setString(10, this.get(i).getInsuPeriodFlag());
			}
			if(this.get(i).getOccupTypeFlag() == null || this.get(i).getOccupTypeFlag().equals("null")) {
				pstmt.setString(11,null);
			} else {
				pstmt.setString(11, this.get(i).getOccupTypeFlag());
			}
			if(this.get(i).getMinOccupType() == null || this.get(i).getMinOccupType().equals("null")) {
				pstmt.setString(12,null);
			} else {
				pstmt.setString(12, this.get(i).getMinOccupType());
			}
			if(this.get(i).getMaxOccupType() == null || this.get(i).getMaxOccupType().equals("null")) {
				pstmt.setString(13,null);
			} else {
				pstmt.setString(13, this.get(i).getMaxOccupType());
			}
			if(this.get(i).getOccupType() == null || this.get(i).getOccupType().equals("null")) {
				pstmt.setString(14,null);
			} else {
				pstmt.setString(14, this.get(i).getOccupType());
			}
			if(this.get(i).getOccupMidType() == null || this.get(i).getOccupMidType().equals("null")) {
				pstmt.setString(15,null);
			} else {
				pstmt.setString(15, this.get(i).getOccupMidType());
			}
			if(this.get(i).getOccupCode() == null || this.get(i).getOccupCode().equals("null")) {
				pstmt.setString(16,null);
			} else {
				pstmt.setString(16, this.get(i).getOccupCode());
			}
			pstmt.setInt(17, this.get(i).getMinAge());
			pstmt.setInt(18, this.get(i).getMaxAge());
			pstmt.setInt(19, this.get(i).getAvgAge());
			pstmt.setInt(20, this.get(i).getNumPeople());
			pstmt.setDouble(21, this.get(i).getSocialInsuRate());
			pstmt.setDouble(22, this.get(i).getMaleRate());
			pstmt.setDouble(23, this.get(i).getFemaleRate());
			pstmt.setDouble(24, this.get(i).getRetireRate());
			if(this.get(i).getPremMode() == null || this.get(i).getPremMode().equals("null")) {
				pstmt.setString(25,null);
			} else {
				pstmt.setString(25, this.get(i).getPremMode());
			}
			pstmt.setDouble(26, this.get(i).getEnterpriseRate());
			pstmt.setDouble(27, this.get(i).getMinSalary());
			pstmt.setDouble(28, this.get(i).getMaxSalary());
			pstmt.setDouble(29, this.get(i).getAvgSalary());
			if(this.get(i).getOtherDesc() == null || this.get(i).getOtherDesc().equals("null")) {
				pstmt.setString(30,null);
			} else {
				pstmt.setString(30, this.get(i).getOtherDesc());
			}
			if(this.get(i).getMakeOperator() == null || this.get(i).getMakeOperator().equals("null")) {
				pstmt.setString(31,null);
			} else {
				pstmt.setString(31, this.get(i).getMakeOperator());
			}
			...
			if(this.get(i).getOccupRate() == null || this.get(i).getOccupRate().equals("null")) {
				...
				pstmt.setString(37, this.get(i).getOccupRate());
			}
			// set where condition
			if(this.get(i).getQuotNo() == null || this.get(i).getQuotNo().equals("null")) {
			...
			if(this.get(i).getSysPlanCode() == null || this.get(i).getSysPlanCode().equals("null")) {
				...
				pstmt.setString(40, this.get(i).getSysPlanCode());
			}
			if(this.get(i).getPlanCode() == null || this.get(i).getPlanCode().equals("null")) {
				pstmt.setString(41,null);
			} else {
				pstmt.setString(41, this.get(i).getPlanCode());
			}
