...
/*
 * <p>ClassName: LBAirPolDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 短期险平台接口表
 */
public class LBAirPolDBSet extends LBAirPolSet
{
private static Logger logger = Logger.getLogger(LBAirPolDBSet.class);
	...
	**/
	...
	// @Constructor
	public LBAirPolDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LBAirPolDBSet";
