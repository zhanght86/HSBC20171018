...
public class LMUWDB extends LMUWSchema
{
	...
	**/
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.getRelaPolType() == null || this.getRelaPolType().equals("null")) {
				...
				pstmt.setString(5, this.getRelaPolType());
			}
			if(this.getUWType() == null || this.getUWType().equals("null")) {
				pstmt.setNull(6, 12);
			} else {
				pstmt.setString(6, this.getUWType());
			}
			pstmt.setInt(7, this.getUWOrder());
			...
			if(this.getUWCode() == null || this.getUWCode().equals("null")) {
				...
				pstmt.setString(14, this.getUWCode());
			}
			pstmt.executeUpdate();
			pstmt.close();
		} catch (Exception ex) {
	...
	public boolean getInfo()
	{
		...
		try
		{
			pstmt = con.prepareStatement("SELECT * FROM LMUW WHERE  UWCode = ?", 
	...
	public LMUWSet executeQuery(SQLwithBindVariables sqlbv) {
...
public LMUWSet getData()
{
    ...
    try
    {
        ...
        tLMUWSchema.setSchema(mResultSet, 1);
