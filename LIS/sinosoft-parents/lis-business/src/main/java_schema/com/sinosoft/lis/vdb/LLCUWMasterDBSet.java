...
/*
 * <p>ClassName: LLCUWMasterDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 理赔管理
 */
public class LLCUWMasterDBSet extends LLCUWMasterSet
{
private static Logger logger = Logger.getLogger(LLCUWMasterDBSet.class);
	...
	**/
	...
	// @Constructor
	public LLCUWMasterDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LLCUWMasterDBSet";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getContNo() == null || this.get(i).getContNo().equals("null")) {
				...
				pstmt.setString(43, this.get(i).getContNo());
			}
