...
/*
 * <p>ClassName: LPUWMasterSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 保全流程
 */
public class LPUWMasterSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LPUWMasterSchema.class);
	// @Field
	/** 批单号 */
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LPUWMasterSchema cloned = (LPUWMasterSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LPUWMasterSchema 对象给 Schema 赋值
	* @param: aLPUWMasterSchema LPUWMasterSchema
	**/
	public void setSchema(LPUWMasterSchema aLPUWMasterSchema)
	{
		this.EdorNo = aLPUWMasterSchema.getEdorNo();
		this.EdorType = aLPUWMasterSchema.getEdorType();
		this.GrpContNo = aLPUWMasterSchema.getGrpContNo();
		this.ContNo = aLPUWMasterSchema.getContNo();
		this.ProposalContNo = aLPUWMasterSchema.getProposalContNo();
		this.PolNo = aLPUWMasterSchema.getPolNo();
		this.ProposalNo = aLPUWMasterSchema.getProposalNo();
		this.UWNo = aLPUWMasterSchema.getUWNo();
		this.InsuredNo = aLPUWMasterSchema.getInsuredNo();
		this.InsuredName = aLPUWMasterSchema.getInsuredName();
		this.AppntNo = aLPUWMasterSchema.getAppntNo();
		this.AppntName = aLPUWMasterSchema.getAppntName();
		this.AgentCode = aLPUWMasterSchema.getAgentCode();
		this.AgentGroup = aLPUWMasterSchema.getAgentGroup();
		this.PassFlag = aLPUWMasterSchema.getPassFlag();
		this.UWGrade = aLPUWMasterSchema.getUWGrade();
		this.AppGrade = aLPUWMasterSchema.getAppGrade();
		this.PostponeDay = aLPUWMasterSchema.getPostponeDay();
		this.PostponeDate = fDate.getDate( aLPUWMasterSchema.getPostponeDate());
		this.AutoUWFlag = aLPUWMasterSchema.getAutoUWFlag();
		this.State = aLPUWMasterSchema.getState();
		this.ManageCom = aLPUWMasterSchema.getManageCom();
		this.UWIdea = aLPUWMasterSchema.getUWIdea();
		this.UpReportContent = aLPUWMasterSchema.getUpReportContent();
		this.Operator = aLPUWMasterSchema.getOperator();
		this.HealthFlag = aLPUWMasterSchema.getHealthFlag();
		this.QuesFlag = aLPUWMasterSchema.getQuesFlag();
		this.SpecFlag = aLPUWMasterSchema.getSpecFlag();
		this.AddPremFlag = aLPUWMasterSchema.getAddPremFlag();
		this.AddPremReason = aLPUWMasterSchema.getAddPremReason();
		this.ReportFlag = aLPUWMasterSchema.getReportFlag();
		this.PrintFlag = aLPUWMasterSchema.getPrintFlag();
		this.PrintFlag2 = aLPUWMasterSchema.getPrintFlag2();
		this.ChangePolFlag = aLPUWMasterSchema.getChangePolFlag();
		this.ChangePolReason = aLPUWMasterSchema.getChangePolReason();
		this.SpecReason = aLPUWMasterSchema.getSpecReason();
		this.MakeDate = fDate.getDate( aLPUWMasterSchema.getMakeDate());
		this.MakeTime = aLPUWMasterSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLPUWMasterSchema.getModifyDate());
		this.ModifyTime = aLPUWMasterSchema.getModifyTime();
		this.SugPassFlag = aLPUWMasterSchema.getSugPassFlag();
		this.SugUWIdea = aLPUWMasterSchema.getSugUWIdea();
		this.AutoUWDate = fDate.getDate( aLPUWMasterSchema.getAutoUWDate());
		this.UWConclu = aLPUWMasterSchema.getUWConclu();
		this.UWDate = fDate.getDate( aLPUWMasterSchema.getUWDate());
		this.UpReport = aLPUWMasterSchema.getUpReport();
		this.ComCode = aLPUWMasterSchema.getComCode();
		this.ModifyOperator = aLPUWMasterSchema.getModifyOperator();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LPUWMaster表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LPUWMasterSchema";
	...
	public LPUWMasterSchema getSchema()
	{
		LPUWMasterSchema aLPUWMasterSchema = new LPUWMasterSchema();
		aLPUWMasterSchema.setSchema(this);
		return aLPUWMasterSchema;
	}

	public LPUWMasterDB getDB()
	{
		LPUWMasterDB aDBOper = new LPUWMasterDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLPUWMaster描述/A>表字段
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLPUWMaster>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			AutoUWDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 43,SysConst.PACKAGESPILTER));
			UWConclu = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 44, SysConst.PACKAGESPILTER );
			UWDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 45,SysConst.PACKAGESPILTER));
			UpReport = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 46, SysConst.PACKAGESPILTER );
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LPUWMasterSchema other = (LPUWMasterSchema)otherObject;
		return
