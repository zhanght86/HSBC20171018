...
/*
 * <p>ClassName: LCGCUWSubSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 承保流程
 */
public class LCGCUWSubSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LCGCUWSubSchema.class);
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LCGCUWSubSchema cloned = (LCGCUWSubSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LCGCUWSubSchema 对象给 Schema 赋值
	* @param: aLCGCUWSubSchema LCGCUWSubSchema
	**/
	public void setSchema(LCGCUWSubSchema aLCGCUWSubSchema)
	{
		this.GrpContNo = aLCGCUWSubSchema.getGrpContNo();
		this.ProposalGrpContNo = aLCGCUWSubSchema.getProposalGrpContNo();
		this.UWNo = aLCGCUWSubSchema.getUWNo();
		this.InsuredNo = aLCGCUWSubSchema.getInsuredNo();
		this.InsuredName = aLCGCUWSubSchema.getInsuredName();
		this.AppntNo = aLCGCUWSubSchema.getAppntNo();
		this.AppntName = aLCGCUWSubSchema.getAppntName();
		this.AgentCode = aLCGCUWSubSchema.getAgentCode();
		this.AgentGroup = aLCGCUWSubSchema.getAgentGroup();
		this.PassFlag = aLCGCUWSubSchema.getPassFlag();
		this.UWGrade = aLCGCUWSubSchema.getUWGrade();
		this.AppGrade = aLCGCUWSubSchema.getAppGrade();
		this.PostponeDay = aLCGCUWSubSchema.getPostponeDay();
		this.PostponeDate = fDate.getDate( aLCGCUWSubSchema.getPostponeDate());
		this.AutoUWFlag = aLCGCUWSubSchema.getAutoUWFlag();
		this.State = aLCGCUWSubSchema.getState();
		this.ManageCom = aLCGCUWSubSchema.getManageCom();
		this.UWIdea = aLCGCUWSubSchema.getUWIdea();
		this.UpReportContent = aLCGCUWSubSchema.getUpReportContent();
		this.Operator = aLCGCUWSubSchema.getOperator();
		this.HealthFlag = aLCGCUWSubSchema.getHealthFlag();
		this.QuesFlag = aLCGCUWSubSchema.getQuesFlag();
		this.SpecFlag = aLCGCUWSubSchema.getSpecFlag();
		this.AddPremFlag = aLCGCUWSubSchema.getAddPremFlag();
		this.AddPremReason = aLCGCUWSubSchema.getAddPremReason();
		this.ReportFlag = aLCGCUWSubSchema.getReportFlag();
		this.PrintFlag = aLCGCUWSubSchema.getPrintFlag();
		this.PrintFlag2 = aLCGCUWSubSchema.getPrintFlag2();
		this.ChangePolFlag = aLCGCUWSubSchema.getChangePolFlag();
		this.ChangePolReason = aLCGCUWSubSchema.getChangePolReason();
		this.SpecReason = aLCGCUWSubSchema.getSpecReason();
		this.MakeDate = fDate.getDate( aLCGCUWSubSchema.getMakeDate());
		this.MakeTime = aLCGCUWSubSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLCGCUWSubSchema.getModifyDate());
		this.ModifyTime = aLCGCUWSubSchema.getModifyTime();
		this.UpReport = aLCGCUWSubSchema.getUpReport();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LCGCUWSub表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LCGCUWSubSchema";
	...
	public LCGCUWSubSchema getSchema()
	{
		LCGCUWSubSchema aLCGCUWSubSchema = new LCGCUWSubSchema();
		aLCGCUWSubSchema.setSchema(this);
		return aLCGCUWSubSchema;
	}

	public LCGCUWSubDB getDB()
	{
		LCGCUWSubDB aDBOper = new LCGCUWSubDB();
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLCGCUWSub>历史记账凭证主表信息</A>表字段
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LCGCUWSubSchema other = (LCGCUWSubSchema)otherObject;
		return
