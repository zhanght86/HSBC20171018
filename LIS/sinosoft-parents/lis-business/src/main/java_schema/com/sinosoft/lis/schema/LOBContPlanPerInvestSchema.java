...
import com.sinosoft.lis.db.LOBContPlanPerInvestDB;

/*
 * 与数据库结构不一致，暂不处理
 * <p>ClassName: LOBContPlanPerInvestSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: Physical Data Model 1
 */
public class LOBContPlanPerInvestSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LOBContPlanPerInvestSchema.class);
	// @Field
	/** 业务类型 */
	...
	// @Constructor
	public LOBContPlanPerInvestSchema()
	{
		mErrors = new CErrors();
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LOBContPlanPerInvestSchema cloned = (LOBContPlanPerInvestSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LOBContPlanPerInvestSchema 对象给 Schema 赋值
	* @param: aLOBContPlanPerInvestSchema LOBContPlanPerInvestSchema
	**/
	public void setSchema(LOBContPlanPerInvestSchema aLOBContPlanPerInvestSchema)
	{
		this.BussType = aLOBContPlanPerInvestSchema.getBussType();
		this.BussNo = aLOBContPlanPerInvestSchema.getBussNo();
		this.PolicyNo = aLOBContPlanPerInvestSchema.getPolicyNo();
		this.SysPlanCode = aLOBContPlanPerInvestSchema.getSysPlanCode();
		this.PlanCode = aLOBContPlanPerInvestSchema.getPlanCode();
		this.RiskCode = aLOBContPlanPerInvestSchema.getRiskCode();
		this.DutyCode = aLOBContPlanPerInvestSchema.getDutyCode();
		this.PayPlanCode = aLOBContPlanPerInvestSchema.getPayPlanCode();
		this.InsuAccNo = aLOBContPlanPerInvestSchema.getInsuAccNo();
		this.InvestMinRate = aLOBContPlanPerInvestSchema.getInvestMinRate();
		this.InvestMaxRate = aLOBContPlanPerInvestSchema.getInvestMaxRate();
		this.InvestRate = aLOBContPlanPerInvestSchema.getInvestRate();
		this.InvestMoney = aLOBContPlanPerInvestSchema.getInvestMoney();
		this.RealInvestMoney = aLOBContPlanPerInvestSchema.getRealInvestMoney();
		this.Other1 = aLOBContPlanPerInvestSchema.getOther1();
		this.Other2 = aLOBContPlanPerInvestSchema.getOther2();
		this.Other3 = aLOBContPlanPerInvestSchema.getOther3();
		this.MakeOperator = aLOBContPlanPerInvestSchema.getMakeOperator();
		this.MakeDate = fDate.getDate( aLOBContPlanPerInvestSchema.getMakeDate());
		this.MakeTime = aLOBContPlanPerInvestSchema.getMakeTime();
		this.ModifyOperator = aLOBContPlanPerInvestSchema.getModifyOperator();
		this.ModifyDate = fDate.getDate( aLOBContPlanPerInvestSchema.getModifyDate());
		this.ModifyTime = aLOBContPlanPerInvestSchema.getModifyTime();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LOBContPlanPerInvest表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LOBContPlanPerInvestSchema";
	...
	public LOBContPlanPerInvestSchema getSchema()
	{
		LOBContPlanPerInvestSchema aLOBContPlanPerInvestSchema = new LOBContPlanPerInvestSchema();
		aLOBContPlanPerInvestSchema.setSchema(this);
		return aLOBContPlanPerInvestSchema;
	}

	public LOBContPlanPerInvestDB getDB()
	{
		LOBContPlanPerInvestDB aDBOper = new LOBContPlanPerInvestDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLOBContPlanPerInvest描述/A>表字段
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLOBContPlanPerInvest>历史记账凭证主表信息</A>表字段
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LOBContPlanPerInvestSchema other = (LOBContPlanPerInvestSchema)otherObject;
		return
