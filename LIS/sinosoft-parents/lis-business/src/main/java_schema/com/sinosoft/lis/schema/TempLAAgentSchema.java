...
import com.sinosoft.lis.db.TempLAAgentDB;

/*
 * <p>ClassName: TempLAAgentSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 代理人管理
 */
public class TempLAAgentSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(TempLAAgentSchema.class);
	...
	/** 行政代理人组别 */
	private String TreeBranchCode;

	public static final int FIELDNUM = 83;	// 数据库表的字段个数
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		TempLAAgentSchema cloned = (TempLAAgentSchema)super.clone();
	...
	*/
	...
	public String getTreeBranchCode()
	{
		return TreeBranchCode;
	}
	public void setTreeBranchCode(String aTreeBranchCode)
	{
		TreeBranchCode = aTreeBranchCode;
	}

	/**
	* 使用另外一个 TempLAAgentSchema 对象给 Schema 赋值
	* @param: aTempLAAgentSchema TempLAAgentSchema
	**/
	public void setSchema(TempLAAgentSchema aTempLAAgentSchema)
	{
		this.EdorNo = aTempLAAgentSchema.getEdorNo();
		this.AgentCode = aTempLAAgentSchema.getAgentCode();
		this.AgentGroup = aTempLAAgentSchema.getAgentGroup();
		this.ManageCom = aTempLAAgentSchema.getManageCom();
		this.Password = aTempLAAgentSchema.getPassword();
		this.EntryNo = aTempLAAgentSchema.getEntryNo();
		this.Name = aTempLAAgentSchema.getName();
		this.Sex = aTempLAAgentSchema.getSex();
		this.Birthday = fDate.getDate( aTempLAAgentSchema.getBirthday());
		this.NativePlace = aTempLAAgentSchema.getNativePlace();
		this.Nationality = aTempLAAgentSchema.getNationality();
		this.Marriage = aTempLAAgentSchema.getMarriage();
		this.CreditGrade = aTempLAAgentSchema.getCreditGrade();
		this.HomeAddressCode = aTempLAAgentSchema.getHomeAddressCode();
		this.HomeAddress = aTempLAAgentSchema.getHomeAddress();
		this.PostalAddress = aTempLAAgentSchema.getPostalAddress();
		this.ZipCode = aTempLAAgentSchema.getZipCode();
		this.Phone = aTempLAAgentSchema.getPhone();
		this.BP = aTempLAAgentSchema.getBP();
		this.Mobile = aTempLAAgentSchema.getMobile();
		this.EMail = aTempLAAgentSchema.getEMail();
		this.MarriageDate = fDate.getDate( aTempLAAgentSchema.getMarriageDate());
		this.IDNo = aTempLAAgentSchema.getIDNo();
		this.Source = aTempLAAgentSchema.getSource();
		this.BloodType = aTempLAAgentSchema.getBloodType();
		this.PolityVisage = aTempLAAgentSchema.getPolityVisage();
		this.Degree = aTempLAAgentSchema.getDegree();
		this.GraduateSchool = aTempLAAgentSchema.getGraduateSchool();
		this.Speciality = aTempLAAgentSchema.getSpeciality();
		this.PostTitle = aTempLAAgentSchema.getPostTitle();
		this.ForeignLevel = aTempLAAgentSchema.getForeignLevel();
		this.WorkAge = aTempLAAgentSchema.getWorkAge();
		this.OldCom = aTempLAAgentSchema.getOldCom();
		this.OldOccupation = aTempLAAgentSchema.getOldOccupation();
		this.HeadShip = aTempLAAgentSchema.getHeadShip();
		this.RecommendAgent = aTempLAAgentSchema.getRecommendAgent();
		this.Business = aTempLAAgentSchema.getBusiness();
		this.SaleQuaf = aTempLAAgentSchema.getSaleQuaf();
		this.QuafNo = aTempLAAgentSchema.getQuafNo();
		this.QuafStartDate = fDate.getDate( aTempLAAgentSchema.getQuafStartDate());
		this.QuafEndDate = fDate.getDate( aTempLAAgentSchema.getQuafEndDate());
		this.DevNo1 = aTempLAAgentSchema.getDevNo1();
		this.DevNo2 = aTempLAAgentSchema.getDevNo2();
		this.RetainContNo = aTempLAAgentSchema.getRetainContNo();
		this.AgentKind = aTempLAAgentSchema.getAgentKind();
		this.DevGrade = aTempLAAgentSchema.getDevGrade();
		this.InsideFlag = aTempLAAgentSchema.getInsideFlag();
		this.FullTimeFlag = aTempLAAgentSchema.getFullTimeFlag();
		this.NoWorkFlag = aTempLAAgentSchema.getNoWorkFlag();
		this.TrainDate = fDate.getDate( aTempLAAgentSchema.getTrainDate());
		this.EmployDate = fDate.getDate( aTempLAAgentSchema.getEmployDate());
		this.InDueFormDate = fDate.getDate( aTempLAAgentSchema.getInDueFormDate());
		this.OutWorkDate = fDate.getDate( aTempLAAgentSchema.getOutWorkDate());
		this.RecommendNo = aTempLAAgentSchema.getRecommendNo();
		this.CautionerName = aTempLAAgentSchema.getCautionerName();
		this.CautionerSex = aTempLAAgentSchema.getCautionerSex();
		this.CautionerID = aTempLAAgentSchema.getCautionerID();
		this.CautionerBirthday = fDate.getDate( aTempLAAgentSchema.getCautionerBirthday());
		this.Approver = aTempLAAgentSchema.getApprover();
		this.ApproveDate = fDate.getDate( aTempLAAgentSchema.getApproveDate());
		this.AssuMoney = aTempLAAgentSchema.getAssuMoney();
		this.Remark = aTempLAAgentSchema.getRemark();
		this.AgentState = aTempLAAgentSchema.getAgentState();
		this.QualiPassFlag = aTempLAAgentSchema.getQualiPassFlag();
		this.SmokeFlag = aTempLAAgentSchema.getSmokeFlag();
		this.RgtAddress = aTempLAAgentSchema.getRgtAddress();
		this.BankCode = aTempLAAgentSchema.getBankCode();
		this.BankAccNo = aTempLAAgentSchema.getBankAccNo();
		this.Operator = aTempLAAgentSchema.getOperator();
		this.MakeDate = fDate.getDate( aTempLAAgentSchema.getMakeDate());
		this.MakeTime = aTempLAAgentSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aTempLAAgentSchema.getModifyDate());
		this.ModifyTime = aTempLAAgentSchema.getModifyTime();
		this.BranchType = aTempLAAgentSchema.getBranchType();
		this.TrainPeriods = aTempLAAgentSchema.getTrainPeriods();
		this.BranchCode = aTempLAAgentSchema.getBranchCode();
		this.Age = aTempLAAgentSchema.getAge();
		this.ChannelName = aTempLAAgentSchema.getChannelName();
		this.IDType = aTempLAAgentSchema.getIDType();
		this.ConFFlag = aTempLAAgentSchema.getConFFlag();
		this.UpAgent = aTempLAAgentSchema.getUpAgent();
		this.AgentGrade = aTempLAAgentSchema.getAgentGrade();
		this.TreeBranchCode = aTempLAAgentSchema.getTreeBranchCode();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		try
		{
			...
			if( rs.getString("TreeBranchCode") == null )
				this.TreeBranchCode = null;
			else
				this.TreeBranchCode = rs.getString("TreeBranchCode").trim();

		}
		catch(SQLException sqle)
		{
			logger.debug("数据库中的TempLAAgent表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "TempLAAgentSchema";
	...
	public TempLAAgentSchema getSchema()
	{
		TempLAAgentSchema aTempLAAgentSchema = new TempLAAgentSchema();
		aTempLAAgentSchema.setSchema(this);
		return aTempLAAgentSchema;
	}

	public TempLAAgentDB getDB()
	{
		TempLAAgentDB aDBOper = new TempLAAgentDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpTempLAAgent描述/A>表字段
	...
	**/
	public String encode()
	{
		...
		strReturn.append(StrTool.cTrim(TreeBranchCode));
		return strReturn.toString();
	}

	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpTempLAAgent>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			EntryNo = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 6, SysConst.PACKAGESPILTER );
			...
			CreditGrade = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 13, SysConst.PACKAGESPILTER );
			HomeAddressCode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 14, SysConst.PACKAGESPILTER );
			HomeAddress = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 15, SysConst.PACKAGESPILTER );
			PostalAddress = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 16, SysConst.PACKAGESPILTER );
			ZipCode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 17, SysConst.PACKAGESPILTER );
			Phone = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 18, SysConst.PACKAGESPILTER );
			BP = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 19, SysConst.PACKAGESPILTER );
			Mobile = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 20, SysConst.PACKAGESPILTER );
			EMail = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 21, SysConst.PACKAGESPILTER );
			...
			Source = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 24, SysConst.PACKAGESPILTER );
			BloodType = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 25, SysConst.PACKAGESPILTER );
			PolityVisage = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 26, SysConst.PACKAGESPILTER );
			Degree = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 27, SysConst.PACKAGESPILTER );
			GraduateSchool = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 28, SysConst.PACKAGESPILTER );
			Speciality = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 29, SysConst.PACKAGESPILTER );
			PostTitle = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 30, SysConst.PACKAGESPILTER );
			ForeignLevel = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 31, SysConst.PACKAGESPILTER );
			WorkAge= new Integer(ChgData.chgNumericStr(StrTool.getStr(strMessage,32,SysConst.PACKAGESPILTER))).intValue();
			OldCom = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 33, SysConst.PACKAGESPILTER );
			OldOccupation = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 34, SysConst.PACKAGESPILTER );
			HeadShip = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 35, SysConst.PACKAGESPILTER );
			RecommendAgent = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 36, SysConst.PACKAGESPILTER );
			Business = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 37, SysConst.PACKAGESPILTER );
			SaleQuaf = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 38, SysConst.PACKAGESPILTER );
			QuafNo = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 39, SysConst.PACKAGESPILTER );
			QuafStartDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 40,SysConst.PACKAGESPILTER));
			QuafEndDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 41,SysConst.PACKAGESPILTER));
			DevNo1 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 42, SysConst.PACKAGESPILTER );
			DevNo2 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 43, SysConst.PACKAGESPILTER );
			RetainContNo = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 44, SysConst.PACKAGESPILTER );
			AgentKind = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 45, SysConst.PACKAGESPILTER );
			DevGrade = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 46, SysConst.PACKAGESPILTER );
			InsideFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 47, SysConst.PACKAGESPILTER );
			FullTimeFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 48, SysConst.PACKAGESPILTER );
			NoWorkFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 49, SysConst.PACKAGESPILTER );
			TrainDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 50,SysConst.PACKAGESPILTER));
			EmployDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 51,SysConst.PACKAGESPILTER));
			InDueFormDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 52,SysConst.PACKAGESPILTER));
			OutWorkDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 53,SysConst.PACKAGESPILTER));
			RecommendNo = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 54, SysConst.PACKAGESPILTER );
			CautionerName = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 55, SysConst.PACKAGESPILTER );
			CautionerSex = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 56, SysConst.PACKAGESPILTER );
			CautionerID = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 57, SysConst.PACKAGESPILTER );
			CautionerBirthday = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 58,SysConst.PACKAGESPILTER));
			Approver = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 59, SysConst.PACKAGESPILTER );
			ApproveDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 60,SysConst.PACKAGESPILTER));
			AssuMoney = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,61,SysConst.PACKAGESPILTER))).doubleValue();
			Remark = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 62, SysConst.PACKAGESPILTER );
			AgentState = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 63, SysConst.PACKAGESPILTER );
			QualiPassFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 64, SysConst.PACKAGESPILTER );
			SmokeFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 65, SysConst.PACKAGESPILTER );
			RgtAddress = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 66, SysConst.PACKAGESPILTER );
			BankCode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 67, SysConst.PACKAGESPILTER );
			BankAccNo = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 68, SysConst.PACKAGESPILTER );
			Operator = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 69, SysConst.PACKAGESPILTER );
			MakeDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 70,SysConst.PACKAGESPILTER));
			MakeTime = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 71, SysConst.PACKAGESPILTER );
			ModifyDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 72,SysConst.PACKAGESPILTER));
			ModifyTime = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 73, SysConst.PACKAGESPILTER );
			BranchType = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 74, SysConst.PACKAGESPILTER );
			TrainPeriods = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 75, SysConst.PACKAGESPILTER );
			BranchCode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 76, SysConst.PACKAGESPILTER );
			Age = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,77,SysConst.PACKAGESPILTER))).doubleValue();
			ChannelName = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 78, SysConst.PACKAGESPILTER );
			IDType = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 79, SysConst.PACKAGESPILTER );
			ConFFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 80, SysConst.PACKAGESPILTER );
			UpAgent = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 81, SysConst.PACKAGESPILTER );
			AgentGrade = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 82, SysConst.PACKAGESPILTER );
			TreeBranchCode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 83, SysConst.PACKAGESPILTER );
		}
	...
	**/
	public String getV(String FCode)
	{
		...
		if (FCode.equalsIgnoreCase("TreeBranchCode"))
		{
			strReturn = StrTool.GBKToUnicode(String.valueOf(TreeBranchCode));
		}
		if (strReturn.equals(""))
		{
			strReturn = "null";
	...
	public String getV(int nFieldIndex)
	{
		...
		switch(nFieldIndex) {
			...
			case 81:
				...
				break;
			case 82:
				strFieldValue = StrTool.GBKToUnicode(TreeBranchCode);
				break;
			default:
				strFieldValue = "";
		};
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		TempLAAgentSchema other = (TempLAAgentSchema)otherObject;
		return
			...
			&& TreeBranchCode.equals(other.getTreeBranchCode());
	}
	...
	**/
	public int getFieldIndex(String strFieldName)
	{
		...
		if( strFieldName.equals("TreeBranchCode") ) {
			return 82;
		}
		return -1;
	}
