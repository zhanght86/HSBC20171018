...
{
private static Logger logger = Logger.getLogger(LCGrpContSchema.class);
	// @Field
	/** 集体合同号码 */
	...
	*/
	...
	/**
	* 如客户购买的保单与其需求明显不符,是否已向客户解释清楚,用该字段记录是否已向客户解释，是－Y，不是－N
	*/
	...
	**/
	public void setSchema(LCGrpContSchema aLCGrpContSchema)
	{
		...
		this.ConferNo = aLCGrpContSchema.getConferNo();
		this.SignReportNo = aLCGrpContSchema.getSignReportNo();
		this.AgentConferNo = aLCGrpContSchema.getAgentConferNo();
		this.ContType = aLCGrpContSchema.getContType();
		this.EdorCalType = aLCGrpContSchema.getEdorCalType();
		this.ClientCare = aLCGrpContSchema.getClientCare();
		this.FundReason = aLCGrpContSchema.getFundReason();
		this.BackDateRemark = aLCGrpContSchema.getBackDateRemark();
		this.ClientNeedJudge = aLCGrpContSchema.getClientNeedJudge();
		this.DonateContflag = aLCGrpContSchema.getDonateContflag();
		this.FundJudge = aLCGrpContSchema.getFundJudge();
		this.ExamAndAppNo = aLCGrpContSchema.getExamAndAppNo();
		this.EdorTransPercent = aLCGrpContSchema.getEdorTransPercent();
		this.CardFlag = aLCGrpContSchema.getCardFlag();
		this.AgentCodeOper = aLCGrpContSchema.getAgentCodeOper();
		this.AgentCodeAssi = aLCGrpContSchema.getAgentCodeAssi();
		this.ContPlanFlag = aLCGrpContSchema.getContPlanFlag();
		this.FYCRATE = aLCGrpContSchema.getFYCRATE();
		this.DelayReasonCode = aLCGrpContSchema.getDelayReasonCode();
		this.DelayReasonDesc = aLCGrpContSchema.getDelayReasonDesc();
		this.ContFlag = aLCGrpContSchema.getContFlag();
		this.SaleDepart = aLCGrpContSchema.getSaleDepart();
		this.ChnlType = aLCGrpContSchema.getChnlType();
		this.AgentBranchesCode = aLCGrpContSchema.getAgentBranchesCode();
		this.ProjectType = aLCGrpContSchema.getProjectType();
		this.RenewFlag = aLCGrpContSchema.getRenewFlag();
		this.RenewCount = aLCGrpContSchema.getRenewCount();
		this.RenewContNo = aLCGrpContSchema.getRenewContNo();
		this.InitNumPeople = aLCGrpContSchema.getInitNumPeople();
		this.InitMult = aLCGrpContSchema.getInitMult();
		this.InitAmnt = aLCGrpContSchema.getInitAmnt();
		this.InitRiskAmnt = aLCGrpContSchema.getInitRiskAmnt();
		this.InitPrem = aLCGrpContSchema.getInitPrem();
		this.InitStandPrem = aLCGrpContSchema.getInitStandPrem();
		this.RiskAmnt = aLCGrpContSchema.getRiskAmnt();
		this.StandPrem = aLCGrpContSchema.getStandPrem();
		this.SumNumPeople = aLCGrpContSchema.getSumNumPeople();
		this.InsuYear = aLCGrpContSchema.getInsuYear();
		this.InsuYearFlag = aLCGrpContSchema.getInsuYearFlag();
		this.Years = aLCGrpContSchema.getYears();
		this.PayEndYear = aLCGrpContSchema.getPayEndYear();
		this.PayEndYearFlag = aLCGrpContSchema.getPayEndYearFlag();
		this.PayYears = aLCGrpContSchema.getPayYears();
		this.ValDateType = aLCGrpContSchema.getValDateType();
		this.EndDate = fDate.getDate( aLCGrpContSchema.getEndDate());
		this.FirstPayDate = fDate.getDate( aLCGrpContSchema.getFirstPayDate());
		this.PayEndDate = fDate.getDate( aLCGrpContSchema.getPayEndDate());
		this.PayToDate = fDate.getDate( aLCGrpContSchema.getPayToDate());
		this.AutoPayFlag = aLCGrpContSchema.getAutoPayFlag();
		this.SignOperator = aLCGrpContSchema.getSignOperator();
		this.Coinsurance = aLCGrpContSchema.getCoinsurance();
		this.AmntShareRate = aLCGrpContSchema.getAmntShareRate();
		this.PremShareRate = aLCGrpContSchema.getPremShareRate();
		this.ScanCom = aLCGrpContSchema.getScanCom();
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LCGrpCont表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
