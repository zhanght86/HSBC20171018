...
/*
 * <p>ClassName: LCPENoticeItemSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 承保流程
 */
public class LCPENoticeItemSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LCPENoticeItemSchema.class);
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LCPENoticeItemSchema cloned = (LCPENoticeItemSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LCPENoticeItemSchema 对象给 Schema 赋值
	* @param: aLCPENoticeItemSchema LCPENoticeItemSchema
	**/
	public void setSchema(LCPENoticeItemSchema aLCPENoticeItemSchema)
	{
		this.GrpContNo = aLCPENoticeItemSchema.getGrpContNo();
		this.ContNo = aLCPENoticeItemSchema.getContNo();
		this.ProposalContNo = aLCPENoticeItemSchema.getProposalContNo();
		this.PrtSeq = aLCPENoticeItemSchema.getPrtSeq();
		this.PEItemCode = aLCPENoticeItemSchema.getPEItemCode();
		this.PEItemName = aLCPENoticeItemSchema.getPEItemName();
		this.ModifyDate = fDate.getDate( aLCPENoticeItemSchema.getModifyDate());
		this.ModifyTime = aLCPENoticeItemSchema.getModifyTime();
		this.FreePE = aLCPENoticeItemSchema.getFreePE();
		this.PEItemResult = aLCPENoticeItemSchema.getPEItemResult();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LCPENoticeItem表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LCPENoticeItemSchema";
	...
	public LCPENoticeItemSchema getSchema()
	{
		LCPENoticeItemSchema aLCPENoticeItemSchema = new LCPENoticeItemSchema();
		aLCPENoticeItemSchema.setSchema(this);
		return aLCPENoticeItemSchema;
	}

	public LCPENoticeItemDB getDB()
	{
		LCPENoticeItemDB aDBOper = new LCPENoticeItemDB();
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLCPENoticeItem>历史记账凭证主表信息</A>表字段
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LCPENoticeItemSchema other = (LCPENoticeItemSchema)otherObject;
		return
