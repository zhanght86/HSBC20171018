...
import com.sinosoft.lis.db.LCDutyBakDB;

/*
 * <p>ClassName: LCDutyBakSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: PhysicalDataModel_1
 */
public class LCDutyBakSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LCDutyBakSchema.class);
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LCDutyBakSchema cloned = (LCDutyBakSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LCDutyBakSchema 对象给 Schema 赋值
	* @param: aLCDutyBakSchema LCDutyBakSchema
	**/
	public void setSchema(LCDutyBakSchema aLCDutyBakSchema)
	{
		this.PolNo = aLCDutyBakSchema.getPolNo();
		this.DutyCode = aLCDutyBakSchema.getDutyCode();
		this.ContNo = aLCDutyBakSchema.getContNo();
		this.Mult = aLCDutyBakSchema.getMult();
		this.StandPrem = aLCDutyBakSchema.getStandPrem();
		this.Prem = aLCDutyBakSchema.getPrem();
		this.SumPrem = aLCDutyBakSchema.getSumPrem();
		this.Amnt = aLCDutyBakSchema.getAmnt();
		this.RiskAmnt = aLCDutyBakSchema.getRiskAmnt();
		this.PayIntv = aLCDutyBakSchema.getPayIntv();
		this.PayYears = aLCDutyBakSchema.getPayYears();
		this.Years = aLCDutyBakSchema.getYears();
		this.FloatRate = aLCDutyBakSchema.getFloatRate();
		this.FirstPayDate = fDate.getDate( aLCDutyBakSchema.getFirstPayDate());
		this.FirstMonth = aLCDutyBakSchema.getFirstMonth();
		this.PaytoDate = fDate.getDate( aLCDutyBakSchema.getPaytoDate());
		this.PayEndDate = fDate.getDate( aLCDutyBakSchema.getPayEndDate());
		this.PayEndYearFlag = aLCDutyBakSchema.getPayEndYearFlag();
		this.PayEndYear = aLCDutyBakSchema.getPayEndYear();
		this.GetYearFlag = aLCDutyBakSchema.getGetYearFlag();
		this.GetYear = aLCDutyBakSchema.getGetYear();
		this.InsuYearFlag = aLCDutyBakSchema.getInsuYearFlag();
		this.InsuYear = aLCDutyBakSchema.getInsuYear();
		this.AcciYearFlag = aLCDutyBakSchema.getAcciYearFlag();
		this.AcciYear = aLCDutyBakSchema.getAcciYear();
		this.EndDate = fDate.getDate( aLCDutyBakSchema.getEndDate());
		this.AcciEndDate = fDate.getDate( aLCDutyBakSchema.getAcciEndDate());
		this.FreeFlag = aLCDutyBakSchema.getFreeFlag();
		this.FreeRate = aLCDutyBakSchema.getFreeRate();
		this.FreeStartDate = fDate.getDate( aLCDutyBakSchema.getFreeStartDate());
		this.FreeEndDate = fDate.getDate( aLCDutyBakSchema.getFreeEndDate());
		this.GetStartDate = fDate.getDate( aLCDutyBakSchema.getGetStartDate());
		this.GetStartType = aLCDutyBakSchema.getGetStartType();
		this.LiveGetMode = aLCDutyBakSchema.getLiveGetMode();
		this.DeadGetMode = aLCDutyBakSchema.getDeadGetMode();
		this.BonusGetMode = aLCDutyBakSchema.getBonusGetMode();
		this.SSFlag = aLCDutyBakSchema.getSSFlag();
		this.PeakLine = aLCDutyBakSchema.getPeakLine();
		this.GetLimit = aLCDutyBakSchema.getGetLimit();
		this.GetRate = aLCDutyBakSchema.getGetRate();
		this.CalRule = aLCDutyBakSchema.getCalRule();
		this.PremToAmnt = aLCDutyBakSchema.getPremToAmnt();
		this.StandbyFlag1 = aLCDutyBakSchema.getStandbyFlag1();
		this.StandbyFlag2 = aLCDutyBakSchema.getStandbyFlag2();
		this.StandbyFlag3 = aLCDutyBakSchema.getStandbyFlag3();
		this.Operator = aLCDutyBakSchema.getOperator();
		this.MakeDate = fDate.getDate( aLCDutyBakSchema.getMakeDate());
		this.MakeTime = aLCDutyBakSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLCDutyBakSchema.getModifyDate());
		this.ModifyTime = aLCDutyBakSchema.getModifyTime();
		this.CValiDate = fDate.getDate( aLCDutyBakSchema.getCValiDate());
		this.GetIntv = aLCDutyBakSchema.getGetIntv();
		this.AscriptionRuleCode = aLCDutyBakSchema.getAscriptionRuleCode();
		this.PayRuleCode = aLCDutyBakSchema.getPayRuleCode();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LCDutyBak表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LCDutyBakSchema";
	...
	public LCDutyBakSchema getSchema()
	{
		LCDutyBakSchema aLCDutyBakSchema = new LCDutyBakSchema();
		aLCDutyBakSchema.setSchema(this);
		return aLCDutyBakSchema;
	}

	public LCDutyBakDB getDB()
	{
		LCDutyBakDB aDBOper = new LCDutyBakDB();
	...
	**/
	public String encode()
	{
		...
		strReturn.append(StrTool.cTrim(PayRuleCode));
		return strReturn.toString();
	}

	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLCDutyBak>历史记账凭证主表信息</A>表字段
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LCDutyBakSchema other = (LCDutyBakSchema)otherObject;
		return
