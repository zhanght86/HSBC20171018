...
/*
 * <p>ClassName: RIBsnsBillDetailsSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 再保系统模型
 */
public class RIBsnsBillDetailsSchema implements Schema, Cloneable
{
	// @Field
	/** 批次号 */
	...
	// @Constructor
	public RIBsnsBillDetailsSchema()
	{
		mErrors = new CErrors();
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		RIBsnsBillDetailsSchema cloned = (RIBsnsBillDetailsSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 RIBsnsBillDetailsSchema 对象给 Schema 赋值
	* @param: aRIBsnsBillDetailsSchema RIBsnsBillDetailsSchema
	**/
	public void setSchema(RIBsnsBillDetailsSchema aRIBsnsBillDetailsSchema)
	{
		this.BatchNo = aRIBsnsBillDetailsSchema.getBatchNo();
		this.BillNo = aRIBsnsBillDetailsSchema.getBillNo();
		this.Currency = aRIBsnsBillDetailsSchema.getCurrency();
		this.FeeCode = aRIBsnsBillDetailsSchema.getFeeCode();
		this.FeeName = aRIBsnsBillDetailsSchema.getFeeName();
		this.Summoney = aRIBsnsBillDetailsSchema.getSummoney();
		this.MakeDate = fDate.getDate( aRIBsnsBillDetailsSchema.getMakeDate());
		this.MakeTime = aRIBsnsBillDetailsSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aRIBsnsBillDetailsSchema.getModifyDate());
		this.ModifyTime = aRIBsnsBillDetailsSchema.getModifyTime();
		this.Operator = aRIBsnsBillDetailsSchema.getOperator();
		this.ManageCom = aRIBsnsBillDetailsSchema.getManageCom();
		this.StandbyString1 = aRIBsnsBillDetailsSchema.getStandbyString1();
		this.StandbyString2 = aRIBsnsBillDetailsSchema.getStandbyString2();
		this.StandbyString3 = aRIBsnsBillDetailsSchema.getStandbyString3();
		this.BillItem = aRIBsnsBillDetailsSchema.getBillItem();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			System.out.println("数据库中的RIBsnsBillDetails表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "RIBsnsBillDetailsSchema";
	...
	public RIBsnsBillDetailsSchema getSchema()
	{
		RIBsnsBillDetailsSchema aRIBsnsBillDetailsSchema = new RIBsnsBillDetailsSchema();
		aRIBsnsBillDetailsSchema.setSchema(this);
		return aRIBsnsBillDetailsSchema;
	}

	public RIBsnsBillDetailsDB getDB()
	{
		RIBsnsBillDetailsDB aDBOper = new RIBsnsBillDetailsDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpRIBsnsBillDetails描述/A>表字段
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpRIBsnsBillDetails>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			FeeName = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 5, SysConst.PACKAGESPILTER );
			...
			StandbyString1 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 13, SysConst.PACKAGESPILTER );
			StandbyString2 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 14, SysConst.PACKAGESPILTER );
			StandbyString3 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 15, SysConst.PACKAGESPILTER );
			BillItem = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 16, SysConst.PACKAGESPILTER );
		}
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		RIBsnsBillDetailsSchema other = (RIBsnsBillDetailsSchema)otherObject;
		return
