...
/*
 * <p>ClassName: LPRReportDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 保全流程
 */
public class LPRReportDBSet extends LPRReportSet
{
private static Logger logger = Logger.getLogger(LPRReportDBSet.class);
	...
	**/
	...
	// @Constructor
	public LPRReportDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LPRReportDBSet";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getPrtSeq() == null || this.get(i).getPrtSeq().equals("null")) {
				...
				pstmt.setString(27, this.get(i).getPrtSeq());
			}
