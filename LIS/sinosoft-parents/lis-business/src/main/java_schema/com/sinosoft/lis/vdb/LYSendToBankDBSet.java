...
/*
 * <p>ClassName: LYSendToBankDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 银行业务
 */
public class LYSendToBankDBSet extends LYSendToBankSet
{
private static Logger logger = Logger.getLogger(LYSendToBankDBSet.class);
	...
	**/
	...
	// @Constructor
	public LYSendToBankDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LYSendToBankDBSet";
