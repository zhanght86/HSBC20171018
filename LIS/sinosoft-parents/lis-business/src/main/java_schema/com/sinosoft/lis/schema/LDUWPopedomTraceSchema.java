...
import com.sinosoft.lis.db.LDUWPopedomTraceDB;

/*
 * <p>ClassName: LDUWPopedomTraceSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: Physical Data Model 1
 */
public class LDUWPopedomTraceSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LDUWPopedomTraceSchema.class);
	// @Field
	/** 轨迹号 */
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LDUWPopedomTraceSchema cloned = (LDUWPopedomTraceSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LDUWPopedomTraceSchema 对象给 Schema 赋值
	* @param: aLDUWPopedomTraceSchema LDUWPopedomTraceSchema
	**/
	public void setSchema(LDUWPopedomTraceSchema aLDUWPopedomTraceSchema)
	{
		this.TraceID = aLDUWPopedomTraceSchema.getTraceID();
		this.PopedomLevel = aLDUWPopedomTraceSchema.getPopedomLevel();
		this.PopedomName = aLDUWPopedomTraceSchema.getPopedomName();
		this.PerLifeAmnt = aLDUWPopedomTraceSchema.getPerLifeAmnt();
		this.PerAcciAmnt = aLDUWPopedomTraceSchema.getPerAcciAmnt();
		this.PerIllAmnt = aLDUWPopedomTraceSchema.getPerIllAmnt();
		this.PerMedAmnt = aLDUWPopedomTraceSchema.getPerMedAmnt();
		this.PremScale = aLDUWPopedomTraceSchema.getPremScale();
		this.MainPremRateFloat = aLDUWPopedomTraceSchema.getMainPremRateFloat();
		this.MedPremRateFloat = aLDUWPopedomTraceSchema.getMedPremRateFloat();
		this.ValDate = fDate.getDate( aLDUWPopedomTraceSchema.getValDate());
		this.EndDate = fDate.getDate( aLDUWPopedomTraceSchema.getEndDate());
		this.State = aLDUWPopedomTraceSchema.getState();
		this.MakeOperator = aLDUWPopedomTraceSchema.getMakeOperator();
		this.MakeDate = fDate.getDate( aLDUWPopedomTraceSchema.getMakeDate());
		this.MakeTime = aLDUWPopedomTraceSchema.getMakeTime();
		this.ModifyOperator = aLDUWPopedomTraceSchema.getModifyOperator();
		this.ModifyDate = fDate.getDate( aLDUWPopedomTraceSchema.getModifyDate());
		this.ModifyTime = aLDUWPopedomTraceSchema.getModifyTime();
		this.LifePremRateFloat = aLDUWPopedomTraceSchema.getLifePremRateFloat();
		this.IllnessPremRateFloat = aLDUWPopedomTraceSchema.getIllnessPremRateFloat();
		this.MedicalPremRateFloat = aLDUWPopedomTraceSchema.getMedicalPremRateFloat();
		this.EnginPremRateFloat = aLDUWPopedomTraceSchema.getEnginPremRateFloat();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LDUWPopedomTrace表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LDUWPopedomTraceSchema";
	...
	public LDUWPopedomTraceSchema getSchema()
	{
		LDUWPopedomTraceSchema aLDUWPopedomTraceSchema = new LDUWPopedomTraceSchema();
		aLDUWPopedomTraceSchema.setSchema(this);
		return aLDUWPopedomTraceSchema;
	}

	public LDUWPopedomTraceDB getDB()
	{
		LDUWPopedomTraceDB aDBOper = new LDUWPopedomTraceDB();
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLDUWPopedomTrace>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			PopedomLevel = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 2, SysConst.PACKAGESPILTER );
			PopedomName = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 3, SysConst.PACKAGESPILTER );
			PerLifeAmnt = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,4,SysConst.PACKAGESPILTER))).doubleValue();
			PerAcciAmnt = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,5,SysConst.PACKAGESPILTER))).doubleValue();
			PerIllAmnt = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,6,SysConst.PACKAGESPILTER))).doubleValue();
			PerMedAmnt = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,7,SysConst.PACKAGESPILTER))).doubleValue();
			PremScale = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,8,SysConst.PACKAGESPILTER))).doubleValue();
			MainPremRateFloat = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,9,SysConst.PACKAGESPILTER))).doubleValue();
			MedPremRateFloat = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,10,SysConst.PACKAGESPILTER))).doubleValue();
			ValDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 11,SysConst.PACKAGESPILTER));
			...
			LifePremRateFloat = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,20,SysConst.PACKAGESPILTER))).doubleValue();
			IllnessPremRateFloat = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,21,SysConst.PACKAGESPILTER))).doubleValue();
			MedicalPremRateFloat = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,22,SysConst.PACKAGESPILTER))).doubleValue();
			EnginPremRateFloat = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,23,SysConst.PACKAGESPILTER))).doubleValue();
		}
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LDUWPopedomTraceSchema other = (LDUWPopedomTraceSchema)otherObject;
		return
