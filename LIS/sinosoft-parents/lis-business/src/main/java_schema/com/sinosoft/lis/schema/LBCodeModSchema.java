...
import com.sinosoft.lis.db.LBCodeModDB;

/*
 * <p>ClassName: LBCodeModSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 基础信息
 */
public class LBCodeModSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LBCodeModSchema.class);
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LBCodeModSchema cloned = (LBCodeModSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LBCodeModSchema 对象给 Schema 赋值
	* @param: aLBCodeModSchema LBCodeModSchema
	**/
	public void setSchema(LBCodeModSchema aLBCodeModSchema)
	{
		this.SerialNo = aLBCodeModSchema.getSerialNo();
		this.CodeType = aLBCodeModSchema.getCodeType();
		this.Code = aLBCodeModSchema.getCode();
		this.CodeName = aLBCodeModSchema.getCodeName();
		this.Cont = aLBCodeModSchema.getCont();
		this.Operator = aLBCodeModSchema.getOperator();
		this.ModifyDate = fDate.getDate( aLBCodeModSchema.getModifyDate());
		this.RecordQuest = aLBCodeModSchema.getRecordQuest();
		this.SendObj = aLBCodeModSchema.getSendObj();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LBCodeMod表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LBCodeModSchema";
	...
	public LBCodeModSchema getSchema()
	{
		LBCodeModSchema aLBCodeModSchema = new LBCodeModSchema();
		aLBCodeModSchema.setSchema(this);
		return aLBCodeModSchema;
	}

	public LBCodeModDB getDB()
	{
		LBCodeModDB aDBOper = new LBCodeModDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLBCodeMod描述/A>表字段
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLBCodeMod>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			Cont = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 5, SysConst.PACKAGESPILTER );
			...
			RecordQuest = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 8, SysConst.PACKAGESPILTER );
			SendObj = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 9, SysConst.PACKAGESPILTER );
		}
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LBCodeModSchema other = (LBCodeModSchema)otherObject;
		return
