...
import com.sinosoft.lis.db.LSQuotPlanDetailSubDB;

/*
 * <p>ClassName: LSQuotPlanDetailSubSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: Physical Data Model 1
 */
public class LSQuotPlanDetailSubSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LSQuotPlanDetailSubSchema.class);
	// @Field
	/** 询价号 */
	...
	// @Constructor
	public LSQuotPlanDetailSubSchema()
	{
		mErrors = new CErrors();
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LSQuotPlanDetailSubSchema cloned = (LSQuotPlanDetailSubSchema)super.clone();
	...
	/**
	* 使用另外一个 LSQuotPlanDetailSubSchema 对象给 Schema 赋值
	* @param: aLSQuotPlanDetailSubSchema LSQuotPlanDetailSubSchema
	**/
	public void setSchema(LSQuotPlanDetailSubSchema aLSQuotPlanDetailSubSchema)
	{
		this.QuotNo = aLSQuotPlanDetailSubSchema.getQuotNo();
		this.QuotBatNo = aLSQuotPlanDetailSubSchema.getQuotBatNo();
		this.SysPlanCode = aLSQuotPlanDetailSubSchema.getSysPlanCode();
		this.PlanCode = aLSQuotPlanDetailSubSchema.getPlanCode();
		this.RiskCode = aLSQuotPlanDetailSubSchema.getRiskCode();
		this.DutyCode = aLSQuotPlanDetailSubSchema.getDutyCode();
		this.P1 = aLSQuotPlanDetailSubSchema.getP1();
		this.P2 = aLSQuotPlanDetailSubSchema.getP2();
		this.P3 = aLSQuotPlanDetailSubSchema.getP3();
		this.P4 = aLSQuotPlanDetailSubSchema.getP4();
		this.P5 = aLSQuotPlanDetailSubSchema.getP5();
		this.P6 = aLSQuotPlanDetailSubSchema.getP6();
		this.P7 = aLSQuotPlanDetailSubSchema.getP7();
		this.P8 = aLSQuotPlanDetailSubSchema.getP8();
		this.P9 = aLSQuotPlanDetailSubSchema.getP9();
		this.P10 = aLSQuotPlanDetailSubSchema.getP10();
		this.P11 = aLSQuotPlanDetailSubSchema.getP11();
		this.P12 = aLSQuotPlanDetailSubSchema.getP12();
		this.P13 = aLSQuotPlanDetailSubSchema.getP13();
		this.P14 = aLSQuotPlanDetailSubSchema.getP14();
		this.P15 = aLSQuotPlanDetailSubSchema.getP15();
		this.P16 = aLSQuotPlanDetailSubSchema.getP16();
		this.P17 = aLSQuotPlanDetailSubSchema.getP17();
		this.P18 = aLSQuotPlanDetailSubSchema.getP18();
		this.P19 = aLSQuotPlanDetailSubSchema.getP19();
		this.P20 = aLSQuotPlanDetailSubSchema.getP20();
		this.P21 = aLSQuotPlanDetailSubSchema.getP21();
		this.P22 = aLSQuotPlanDetailSubSchema.getP22();
		this.P23 = aLSQuotPlanDetailSubSchema.getP23();
		this.P24 = aLSQuotPlanDetailSubSchema.getP24();
		this.P25 = aLSQuotPlanDetailSubSchema.getP25();
		this.P26 = aLSQuotPlanDetailSubSchema.getP26();
		this.P27 = aLSQuotPlanDetailSubSchema.getP27();
		this.P28 = aLSQuotPlanDetailSubSchema.getP28();
		this.P29 = aLSQuotPlanDetailSubSchema.getP29();
		this.P30 = aLSQuotPlanDetailSubSchema.getP30();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LSQuotPlanDetailSub表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LSQuotPlanDetailSubSchema";
	...
	public LSQuotPlanDetailSubSchema getSchema()
	{
		LSQuotPlanDetailSubSchema aLSQuotPlanDetailSubSchema = new LSQuotPlanDetailSubSchema();
		aLSQuotPlanDetailSubSchema.setSchema(this);
		return aLSQuotPlanDetailSubSchema;
	}

	public LSQuotPlanDetailSubDB getDB()
	{
		LSQuotPlanDetailSubDB aDBOper = new LSQuotPlanDetailSubDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLSQuotPlanDetailSub描述/A>表字段
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLSQuotPlanDetailSub>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			P1 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 7, SysConst.PACKAGESPILTER );
			P2 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 8, SysConst.PACKAGESPILTER );
			P3 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 9, SysConst.PACKAGESPILTER );
			P4 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 10, SysConst.PACKAGESPILTER );
			P5 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 11, SysConst.PACKAGESPILTER );
			P6 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 12, SysConst.PACKAGESPILTER );
			P7 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 13, SysConst.PACKAGESPILTER );
			P8 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 14, SysConst.PACKAGESPILTER );
			P9 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 15, SysConst.PACKAGESPILTER );
			P10 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 16, SysConst.PACKAGESPILTER );
			P11 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 17, SysConst.PACKAGESPILTER );
			P12 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 18, SysConst.PACKAGESPILTER );
			P13 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 19, SysConst.PACKAGESPILTER );
			P14 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 20, SysConst.PACKAGESPILTER );
			P15 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 21, SysConst.PACKAGESPILTER );
			P16 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 22, SysConst.PACKAGESPILTER );
			P17 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 23, SysConst.PACKAGESPILTER );
			P18 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 24, SysConst.PACKAGESPILTER );
			P19 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 25, SysConst.PACKAGESPILTER );
			P20 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 26, SysConst.PACKAGESPILTER );
			P21 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 27, SysConst.PACKAGESPILTER );
			P22 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 28, SysConst.PACKAGESPILTER );
			P23 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 29, SysConst.PACKAGESPILTER );
			P24 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 30, SysConst.PACKAGESPILTER );
			P25 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 31, SysConst.PACKAGESPILTER );
			P26 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 32, SysConst.PACKAGESPILTER );
			P27 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 33, SysConst.PACKAGESPILTER );
			P28 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 34, SysConst.PACKAGESPILTER );
			P29 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 35, SysConst.PACKAGESPILTER );
			P30 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 36, SysConst.PACKAGESPILTER );
		}
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LSQuotPlanDetailSubSchema other = (LSQuotPlanDetailSubSchema)otherObject;
		return
