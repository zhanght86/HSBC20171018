...
import com.sinosoft.lis.db.BPOPolDataDB;

/*
 * <p>ClassName: BPOPolDataSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: PhysicalDataModel_1
 */
public class BPOPolDataSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(BPOPolDataSchema.class);
	// @Field
	/** 业务号码 */
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		BPOPolDataSchema cloned = (BPOPolDataSchema)super.clone();
	...
	*/
	public InputStream getPolData()
	{
		return PolData;
	}
	public void setPolData(InputStream aPolData)
	{
		PolData = aPolData;
	}
	public void setPolData(String aPolData)
	{
	}
	...
	public void setSerialNo(String aSerialNo)
	{
		if(aSerialNo!=null && aSerialNo.length()>20)
			throw new IllegalArgumentException("处理流水号SerialNo值"+aSerialNo+"的长度"+aSerialNo.length()+"大于最大值20");
		SerialNo = aSerialNo;
	}
	...
	/**
	* 使用另外一个 BPOPolDataSchema 对象给 Schema 赋值
	* @param: aBPOPolDataSchema BPOPolDataSchema
	**/
	public void setSchema(BPOPolDataSchema aBPOPolDataSchema)
	{
		this.BussNo = aBPOPolDataSchema.getBussNo();
		this.BussNoType = aBPOPolDataSchema.getBussNoType();
		this.PolData = aBPOPolDataSchema.getPolData();
		this.SerialNo = aBPOPolDataSchema.getSerialNo();
		this.Operator = aBPOPolDataSchema.getOperator();
		this.MakeDate = fDate.getDate( aBPOPolDataSchema.getMakeDate());
		this.MakeTime = aBPOPolDataSchema.getMakeTime();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		try
		{
			...
			this.PolData = rs.getBinaryStream("PolData");
		...
		{
			logger.debug("数据库中的BPOPolData表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "BPOPolDataSchema";
	...
	public BPOPolDataSchema getSchema()
	{
		BPOPolDataSchema aBPOPolDataSchema = new BPOPolDataSchema();
		aBPOPolDataSchema.setSchema(this);
		return aBPOPolDataSchema;
	}

	public BPOPolDataDB getDB()
	{
		BPOPolDataDB aDBOper = new BPOPolDataDB();
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpBPOPolData>历史记账凭证主表信息</A>表字段
	...
	**/
	public String getV(String FCode)
	{
		...
		if (FCode.equalsIgnoreCase("PolData"))
		{
			strReturn = StrTool.GBKToUnicode(String.valueOf(PolData));
		}
	...
	public String getV(int nFieldIndex)
	{
		...
		switch(nFieldIndex) {
			...
			case 1:
				...
				break;
			case 2:
				strFieldValue = String.valueOf(PolData);
				break;
			case 3:
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		BPOPolDataSchema other = (BPOPolDataSchema)otherObject;
		return
	...
	**/
	public int getFieldIndex(String strFieldName)
	{
		...
		if( strFieldName.equals("PolData") ) {
			return 2;
		}
