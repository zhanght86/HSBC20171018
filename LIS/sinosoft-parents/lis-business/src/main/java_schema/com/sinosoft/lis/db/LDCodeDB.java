	...
	**/
	...
	public boolean update()
	{
		...
		try
		{
			...
			pstmt.setInt(8, this.getOrderNo());
			// set where condition
			if(this.getCodeType() == null || this.getCodeType().equals("null")) {
				pstmt.setNull(9, 12);
			} else {
...
public boolean closeData()
{
	...
	public LDCodeSet executeQuery(SQLwithBindVariables sqlbv) {
	...
	public LDCodeSet executeQuery(SQLwithBindVariables sqlbv, int nStart, int nCount) {
