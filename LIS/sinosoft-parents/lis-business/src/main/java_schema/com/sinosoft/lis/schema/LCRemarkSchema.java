...
import com.sinosoft.lis.db.LCRemarkDB;

/*
 * <p>ClassName: LCRemarkSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 承保流程
 */
public class LCRemarkSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LCRemarkSchema.class);
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LCRemarkSchema cloned = (LCRemarkSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LCRemarkSchema 对象给 Schema 赋值
	* @param: aLCRemarkSchema LCRemarkSchema
	**/
	public void setSchema(LCRemarkSchema aLCRemarkSchema)
	{
		this.PolNo = aLCRemarkSchema.getPolNo();
		this.OperatePos = aLCRemarkSchema.getOperatePos();
		this.PrtNo = aLCRemarkSchema.getPrtNo();
		this.SerialNo = aLCRemarkSchema.getSerialNo();
		this.RemarkCont = aLCRemarkSchema.getRemarkCont();
		this.Operator = aLCRemarkSchema.getOperator();
		this.ManageCom = aLCRemarkSchema.getManageCom();
		this.MakeDate = fDate.getDate( aLCRemarkSchema.getMakeDate());
		this.MakeTime = aLCRemarkSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLCRemarkSchema.getModifyDate());
		this.ModifyTime = aLCRemarkSchema.getModifyTime();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LCRemark表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LCRemarkSchema";
	...
	public LCRemarkSchema getSchema()
	{
		LCRemarkSchema aLCRemarkSchema = new LCRemarkSchema();
		aLCRemarkSchema.setSchema(this);
		return aLCRemarkSchema;
	}

	public LCRemarkDB getDB()
	{
		LCRemarkDB aDBOper = new LCRemarkDB();
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLCRemark>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			OperatePos = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 2, SysConst.PACKAGESPILTER );
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LCRemarkSchema other = (LCRemarkSchema)otherObject;
		return
