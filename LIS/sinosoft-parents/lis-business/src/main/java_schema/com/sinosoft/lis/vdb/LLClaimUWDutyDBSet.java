...
/*
 * <p>ClassName: LLClaimUWDutyDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 泰康未整理PDM
 */
public class LLClaimUWDutyDBSet extends LLClaimUWDutySet
{
	// @Field
	...
	**/
	...
	// @Constructor
	public LLClaimUWDutyDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LLClaimUWDutyDBSet";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getClmNo() == null || this.get(i).getClmNo().equals("null")) {
				...
				pstmt.setString(11, this.get(i).getClmNo());
			}
			...
			if(this.get(i).getClmCheckOperator() == null || this.get(i).getClmCheckOperator().equals("null")) {
				pstmt.setString(21,null);
			} else {
				pstmt.setString(21, this.get(i).getClmCheckOperator());
			}
			if(this.get(i).getClmCheckGrade() == null || this.get(i).getClmCheckGrade().equals("null")) {
				pstmt.setString(22,null);
			} else {
				pstmt.setString(22, this.get(i).getClmCheckGrade());
			}
			if(this.get(i).getCheckType() == null || this.get(i).getCheckType().equals("null")) {
				pstmt.setString(23,null);
			} else {
				pstmt.setString(23, this.get(i).getCheckType());
			}
			if(this.get(i).getClmCheckDecision() == null || this.get(i).getClmCheckDecision().equals("null")) {
				pstmt.setString(24,null);
			} else {
				pstmt.setString(24, this.get(i).getClmCheckDecision());
			}
			...
			if(this.get(i).getGetDutyKind() == null || this.get(i).getGetDutyKind().equals("null")) {
				...
				pstmt.setString(34, this.get(i).getGetDutyKind());
			}
