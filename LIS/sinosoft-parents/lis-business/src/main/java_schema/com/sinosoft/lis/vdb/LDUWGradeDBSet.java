...
/*
 * <p>ClassName: LDUWGradeDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 权限管理
 */
public class LDUWGradeDBSet extends LDUWGradeSet
{
private static Logger logger = Logger.getLogger(LDUWGradeDBSet.class);
	...
	**/
	...
	// @Constructor
	public LDUWGradeDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LDUWGradeDBSet";
	...
	public boolean delete()
	{
		...
		try
		{
			...
			if(this.get(i).getUWState() == null || this.get(i).getUWState().equals("null")) {
				...
				pstmt.setString(4, this.get(i).getUWState());
			}
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getUWState() == null || this.get(i).getUWState().equals("null")) {
				...
				pstmt.setString(5, this.get(i).getUWState());
			}
			if(this.get(i).getUWStateName() == null || this.get(i).getUWStateName().equals("null")) {
				pstmt.setString(6,null);
			} else {
				pstmt.setString(6, this.get(i).getUWStateName());
			}
			pstmt.setDouble(7, this.get(i).getAmnt());
			pstmt.setDouble(8, this.get(i).getAddPrem());
			pstmt.setDouble(9, this.get(i).getRefuse());
			...
			if(this.get(i).getUserCode() == null || this.get(i).getUserCode().equals("null")) {
				...
				pstmt.setString(17, this.get(i).getUserCode());
			}
			if(this.get(i).getUWPopedom() == null || this.get(i).getUWPopedom().equals("null")) {
				pstmt.setString(18,null);
			} else {
				pstmt.setString(18, this.get(i).getUWPopedom());
			}
			if(this.get(i).getUWType() == null || this.get(i).getUWType().equals("null")) {
				pstmt.setString(19,null);
			} else {
				pstmt.setString(19, StrTool.space1(this.get(i).getUWType(), 1));
			}
			if(this.get(i).getUWState() == null || this.get(i).getUWState().equals("null")) {
				pstmt.setString(20,null);
			} else {
				pstmt.setString(20, this.get(i).getUWState());
			}
