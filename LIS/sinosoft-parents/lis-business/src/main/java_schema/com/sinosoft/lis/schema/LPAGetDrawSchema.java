...
/*
 * <p>ClassName: LPAGetDrawSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 多币种改造业务表
 */
public class LPAGetDrawSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LPAGetDrawSchema.class);
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LPAGetDrawSchema cloned = (LPAGetDrawSchema)super.clone();
	...
	*/
	...
	/**
	* 做给付确认时设置的日期：<p>
	* 1.如果是从银行返回，则是核销的日期。<p>
	* 2.如果从柜面领取，则指财务给付确认的日期。
	*/
	...
	*/
	...
	/**
	* 使用另外一个 LPAGetDrawSchema 对象给 Schema 赋值
	* @param: aLPAGetDrawSchema LPAGetDrawSchema
	**/
	public void setSchema(LPAGetDrawSchema aLPAGetDrawSchema)
	{
		this.EdorNo = aLPAGetDrawSchema.getEdorNo();
		this.EdorType = aLPAGetDrawSchema.getEdorType();
		this.ActuGetNo = aLPAGetDrawSchema.getActuGetNo();
		this.PolNo = aLPAGetDrawSchema.getPolNo();
		this.DutyCode = aLPAGetDrawSchema.getDutyCode();
		this.GetDutyKind = aLPAGetDrawSchema.getGetDutyKind();
		this.GetDutyCode = aLPAGetDrawSchema.getGetDutyCode();
		this.GrpContNo = aLPAGetDrawSchema.getGrpContNo();
		this.GrpPolNo = aLPAGetDrawSchema.getGrpPolNo();
		this.ContNo = aLPAGetDrawSchema.getContNo();
		this.AppntNo = aLPAGetDrawSchema.getAppntNo();
		this.InsuredNo = aLPAGetDrawSchema.getInsuredNo();
		this.GetDate = fDate.getDate( aLPAGetDrawSchema.getGetDate());
		this.GetMoney = aLPAGetDrawSchema.getGetMoney();
		this.EnterAccDate = fDate.getDate( aLPAGetDrawSchema.getEnterAccDate());
		this.ConfDate = fDate.getDate( aLPAGetDrawSchema.getConfDate());
		this.FeeOperationType = aLPAGetDrawSchema.getFeeOperationType();
		this.FeeFinaType = aLPAGetDrawSchema.getFeeFinaType();
		this.KindCode = aLPAGetDrawSchema.getKindCode();
		this.RiskCode = aLPAGetDrawSchema.getRiskCode();
		this.RiskVersion = aLPAGetDrawSchema.getRiskVersion();
		this.ManageCom = aLPAGetDrawSchema.getManageCom();
		this.AgentCom = aLPAGetDrawSchema.getAgentCom();
		this.AgentType = aLPAGetDrawSchema.getAgentType();
		this.AgentCode = aLPAGetDrawSchema.getAgentCode();
		this.AgentGroup = aLPAGetDrawSchema.getAgentGroup();
		this.GrpName = aLPAGetDrawSchema.getGrpName();
		this.Handler = aLPAGetDrawSchema.getHandler();
		this.LastGettoDate = fDate.getDate( aLPAGetDrawSchema.getLastGettoDate());
		this.CurGetToDate = fDate.getDate( aLPAGetDrawSchema.getCurGetToDate());
		this.GetmFirstFlag = aLPAGetDrawSchema.getGetmFirstFlag();
		this.GetChannelFlag = aLPAGetDrawSchema.getGetChannelFlag();
		this.DestrayFlag = aLPAGetDrawSchema.getDestrayFlag();
		this.PolType = aLPAGetDrawSchema.getPolType();
		this.ApproveCode = aLPAGetDrawSchema.getApproveCode();
		this.ApproveDate = fDate.getDate( aLPAGetDrawSchema.getApproveDate());
		this.ApproveTime = aLPAGetDrawSchema.getApproveTime();
		this.SerialNo = aLPAGetDrawSchema.getSerialNo();
		this.Operator = aLPAGetDrawSchema.getOperator();
		this.MakeDate = fDate.getDate( aLPAGetDrawSchema.getMakeDate());
		this.MakeTime = aLPAGetDrawSchema.getMakeTime();
		this.GetNoticeNo = aLPAGetDrawSchema.getGetNoticeNo();
		this.ModifyDate = fDate.getDate( aLPAGetDrawSchema.getModifyDate());
		this.ModifyTime = aLPAGetDrawSchema.getModifyTime();
		this.RReportFlag = aLPAGetDrawSchema.getRReportFlag();
		this.ComeFlag = aLPAGetDrawSchema.getComeFlag();
		this.Currency = aLPAGetDrawSchema.getCurrency();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LPAGetDraw表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LPAGetDrawSchema";
	...
	public LPAGetDrawSchema getSchema()
	{
		LPAGetDrawSchema aLPAGetDrawSchema = new LPAGetDrawSchema();
		aLPAGetDrawSchema.setSchema(this);
		return aLPAGetDrawSchema;
	}

	public LPAGetDrawDB getDB()
	{
		LPAGetDrawDB aDBOper = new LPAGetDrawDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLPAGetDraw描述/A>表字段
	...
	**/
	public String encode()
	{
		...
		strReturn.append(StrTool.cTrim(GetmFirstFlag)); strReturn.append(SysConst.PACKAGESPILTER);
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLPAGetDraw>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			ActuGetNo = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 3, SysConst.PACKAGESPILTER );
			...
			GetMoney = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,14,SysConst.PACKAGESPILTER))).doubleValue();
			EnterAccDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 15,SysConst.PACKAGESPILTER));
			ConfDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 16,SysConst.PACKAGESPILTER));
			FeeOperationType = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 17, SysConst.PACKAGESPILTER );
			FeeFinaType = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 18, SysConst.PACKAGESPILTER );
			...
			GrpName = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 27, SysConst.PACKAGESPILTER );
			Handler = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 28, SysConst.PACKAGESPILTER );
			LastGettoDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 29,SysConst.PACKAGESPILTER));
			CurGetToDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 30,SysConst.PACKAGESPILTER));
			GetmFirstFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 31, SysConst.PACKAGESPILTER );
			GetChannelFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 32, SysConst.PACKAGESPILTER );
			DestrayFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 33, SysConst.PACKAGESPILTER );
			PolType = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 34, SysConst.PACKAGESPILTER );
			ApproveCode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 35, SysConst.PACKAGESPILTER );
			ApproveDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 36,SysConst.PACKAGESPILTER));
			ApproveTime = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 37, SysConst.PACKAGESPILTER );
			SerialNo = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 38, SysConst.PACKAGESPILTER );
			...
			GetNoticeNo = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 42, SysConst.PACKAGESPILTER );
			...
			RReportFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 45, SysConst.PACKAGESPILTER );
			ComeFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 46, SysConst.PACKAGESPILTER );
	...
	**/
	public String getV(String FCode)
	{
		...
		if (FCode.equalsIgnoreCase("GetmFirstFlag"))
		{
			strReturn = StrTool.GBKToUnicode(String.valueOf(GetmFirstFlag));
		}
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LPAGetDrawSchema other = (LPAGetDrawSchema)otherObject;
		return
