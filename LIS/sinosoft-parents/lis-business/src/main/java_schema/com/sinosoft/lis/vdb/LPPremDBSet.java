...
/*
 * <p>ClassName: LPPremDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 保全核心
 */
public class LPPremDBSet extends LPPremSet
{
	// @Field
	...
	**/
	...
	// @Constructor
	public LPPremDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getAddForm() == null || this.get(i).getAddForm().equals("null")) {
				...
				pstmt.setString(36, this.get(i).getAddForm());
			}
			...
			pstmt.setDouble(38, this.get(i).getPeriodPrem());
			...
			if(this.get(i).getPayPlanCode() == null || this.get(i).getPayPlanCode().equals("null")) {
				...
				pstmt.setString(45, this.get(i).getPayPlanCode());
			}
