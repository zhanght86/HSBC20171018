...
/*
 * <p>ClassName: LYReturnFromBankSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 银行业务
 */
public class LYReturnFromBankSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LYReturnFromBankSchema.class);
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LYReturnFromBankSchema cloned = (LYReturnFromBankSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LYReturnFromBankSchema 对象给 Schema 赋值
	* @param: aLYReturnFromBankSchema LYReturnFromBankSchema
	**/
	public void setSchema(LYReturnFromBankSchema aLYReturnFromBankSchema)
	{
		this.SerialNo = aLYReturnFromBankSchema.getSerialNo();
		this.DealType = aLYReturnFromBankSchema.getDealType();
		this.DataType = aLYReturnFromBankSchema.getDataType();
		this.PayCode = aLYReturnFromBankSchema.getPayCode();
		this.PayType = aLYReturnFromBankSchema.getPayType();
		this.Name = aLYReturnFromBankSchema.getName();
		this.BankCode = aLYReturnFromBankSchema.getBankCode();
		this.AccType = aLYReturnFromBankSchema.getAccType();
		this.AccName = aLYReturnFromBankSchema.getAccName();
		this.AccNo = aLYReturnFromBankSchema.getAccNo();
		this.PolNo = aLYReturnFromBankSchema.getPolNo();
		this.NoType = aLYReturnFromBankSchema.getNoType();
		this.ComCode = aLYReturnFromBankSchema.getComCode();
		this.AgentCode = aLYReturnFromBankSchema.getAgentCode();
		this.PayMoney = aLYReturnFromBankSchema.getPayMoney();
		this.SendDate = fDate.getDate( aLYReturnFromBankSchema.getSendDate());
		this.BankDealDate = fDate.getDate( aLYReturnFromBankSchema.getBankDealDate());
		this.BankDealTime = fDate.getDate( aLYReturnFromBankSchema.getBankDealTime());
		this.BankSuccFlag = aLYReturnFromBankSchema.getBankSuccFlag();
		this.VertifyFlag = aLYReturnFromBankSchema.getVertifyFlag();
		this.Remark = aLYReturnFromBankSchema.getRemark();
		this.ConvertFlag = aLYReturnFromBankSchema.getConvertFlag();
		this.DoType = aLYReturnFromBankSchema.getDoType();
		this.ModifyDate = fDate.getDate( aLYReturnFromBankSchema.getModifyDate());
		this.ModifyTime = aLYReturnFromBankSchema.getModifyTime();
		this.RiskCode = aLYReturnFromBankSchema.getRiskCode();
		this.SerNo = aLYReturnFromBankSchema.getSerNo();
		this.BankName = aLYReturnFromBankSchema.getBankName();
		this.InBankCode = aLYReturnFromBankSchema.getInBankCode();
		this.InBankName = aLYReturnFromBankSchema.getInBankName();
		this.InAccType = aLYReturnFromBankSchema.getInAccType();
		this.InAccName = aLYReturnFromBankSchema.getInAccName();
		this.InAccNo = aLYReturnFromBankSchema.getInAccNo();
		this.IDType = aLYReturnFromBankSchema.getIDType();
		this.IDNo = aLYReturnFromBankSchema.getIDNo();
		this.StandByFlag1 = aLYReturnFromBankSchema.getStandByFlag1();
		this.StandByFlag2 = aLYReturnFromBankSchema.getStandByFlag2();
		this.StandByFlag3 = aLYReturnFromBankSchema.getStandByFlag3();
		this.StandByFlag4 = aLYReturnFromBankSchema.getStandByFlag4();
		this.StandByFlag5 = aLYReturnFromBankSchema.getStandByFlag5();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LYReturnFromBank表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LYReturnFromBankSchema";
	...
	public LYReturnFromBankSchema getSchema()
	{
		LYReturnFromBankSchema aLYReturnFromBankSchema = new LYReturnFromBankSchema();
		aLYReturnFromBankSchema.setSchema(this);
		return aLYReturnFromBankSchema;
	}

	public LYReturnFromBankDB getDB()
	{
		LYReturnFromBankDB aDBOper = new LYReturnFromBankDB();
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLYReturnFromBank>历史记账凭证主表信息</A>表字段
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LYReturnFromBankSchema other = (LYReturnFromBankSchema)otherObject;
		return
