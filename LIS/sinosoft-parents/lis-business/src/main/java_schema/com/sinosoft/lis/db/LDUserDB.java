	...
	**/
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.getEdorValiFlag() == null || this.getEdorValiFlag().equals("null")) {
				pstmt.setNull(21, 12);
			} else {
				pstmt.setString(21, this.getEdorValiFlag());
			}
			...
			if(this.getUserCode() == null || this.getUserCode().equals("null")) {
				...
				pstmt.setString(24, this.getUserCode());
			}
			pstmt.executeUpdate();
			pstmt.close();
		} catch (Exception ex) {
...
public boolean closeData()
{
	...
	public LDUserSet executeQuery(SQLwithBindVariables sqlbv) {
	...
	public LDUserSet executeQuery(SQLwithBindVariables sqlbv, int nStart, int nCount) {
