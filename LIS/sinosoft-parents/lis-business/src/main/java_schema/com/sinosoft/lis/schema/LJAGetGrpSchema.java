...
import com.sinosoft.lis.db.LJAGetGrpDB;

/*
 * <p>ClassName: LJAGetGrpSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: Physical Data Model 1
 */
public class LJAGetGrpSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LJAGetGrpSchema.class);
	// @Field
	/** 实付号码 */
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LJAGetGrpSchema cloned = (LJAGetGrpSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LJAGetGrpSchema 对象给 Schema 赋值
	* @param: aLJAGetGrpSchema LJAGetGrpSchema
	**/
	public void setSchema(LJAGetGrpSchema aLJAGetGrpSchema)
	{
		this.ActuGetNo = aLJAGetGrpSchema.getActuGetNo();
		this.GrpContNo = aLJAGetGrpSchema.getGrpContNo();
		this.GrpPolNo = aLJAGetGrpSchema.getGrpPolNo();
		this.BussType = aLJAGetGrpSchema.getBussType();
		this.RiskCode = aLJAGetGrpSchema.getRiskCode();
		this.AppntNo = aLJAGetGrpSchema.getAppntNo();
		this.EndorsementNo = aLJAGetGrpSchema.getEndorsementNo();
		this.SumGetMoney = aLJAGetGrpSchema.getSumGetMoney();
		this.PayMode = aLJAGetGrpSchema.getPayMode();
		this.ShouldDate = fDate.getDate( aLJAGetGrpSchema.getShouldDate());
		this.EnterAccDate = fDate.getDate( aLJAGetGrpSchema.getEnterAccDate());
		this.ConfDate = fDate.getDate( aLJAGetGrpSchema.getConfDate());
		this.GetNoticeNo = aLJAGetGrpSchema.getGetNoticeNo();
		this.ManageCom = aLJAGetGrpSchema.getManageCom();
		this.ComCode = aLJAGetGrpSchema.getComCode();
		this.MakeOperator = aLJAGetGrpSchema.getMakeOperator();
		this.MakeDate = fDate.getDate( aLJAGetGrpSchema.getMakeDate());
		this.MakeTime = aLJAGetGrpSchema.getMakeTime();
		this.ModifyOperator = aLJAGetGrpSchema.getModifyOperator();
		this.ModifyDate = fDate.getDate( aLJAGetGrpSchema.getModifyDate());
		this.ModifyTime = aLJAGetGrpSchema.getModifyTime();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LJAGetGrp表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LJAGetGrpSchema";
	...
	public LJAGetGrpSchema getSchema()
	{
		LJAGetGrpSchema aLJAGetGrpSchema = new LJAGetGrpSchema();
		aLJAGetGrpSchema.setSchema(this);
		return aLJAGetGrpSchema;
	}

	public LJAGetGrpDB getDB()
	{
		LJAGetGrpDB aDBOper = new LJAGetGrpDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLJAGetGrp描述/A>表字段
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLJAGetGrp>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			ConfDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 12,SysConst.PACKAGESPILTER));
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LJAGetGrpSchema other = (LJAGetGrpSchema)otherObject;
		return
