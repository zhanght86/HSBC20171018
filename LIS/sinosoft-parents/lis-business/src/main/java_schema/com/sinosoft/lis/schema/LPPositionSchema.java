...
import com.sinosoft.lis.db.LPPositionDB;

/*
 * <p>ClassName: LPPositionSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: Physical Data Model 1
 */
public class LPPositionSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LPPositionSchema.class);
	// @Field
	/** 保全批单号 */
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LPPositionSchema cloned = (LPPositionSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LPPositionSchema 对象给 Schema 赋值
	* @param: aLPPositionSchema LPPositionSchema
	**/
	public void setSchema(LPPositionSchema aLPPositionSchema)
	{
		this.EdorNo = aLPPositionSchema.getEdorNo();
		this.EdorType = aLPPositionSchema.getEdorType();
		this.SerialNo = aLPPositionSchema.getSerialNo();
		this.GrpContNo = aLPPositionSchema.getGrpContNo();
		this.RiskCode = aLPPositionSchema.getRiskCode();
		this.GrpPolNo = aLPPositionSchema.getGrpPolNo();
		this.PositionCode = aLPPositionSchema.getPositionCode();
		this.PositionCodeName = aLPPositionSchema.getPositionCodeName();
		this.CountType = aLPPositionSchema.getCountType();
		this.Segment1 = aLPPositionSchema.getSegment1();
		this.Segment2 = aLPPositionSchema.getSegment2();
		this.Segment3 = aLPPositionSchema.getSegment3();
		this.ManageCom = aLPPositionSchema.getManageCom();
		this.ComCode = aLPPositionSchema.getComCode();
		this.MakeOperator = aLPPositionSchema.getMakeOperator();
		this.MakeDate = fDate.getDate( aLPPositionSchema.getMakeDate());
		this.MakeTime = aLPPositionSchema.getMakeTime();
		this.ModifyOperator = aLPPositionSchema.getModifyOperator();
		this.ModifyDate = fDate.getDate( aLPPositionSchema.getModifyDate());
		this.ModifyTime = aLPPositionSchema.getModifyTime();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LPPosition表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LPPositionSchema";
	...
	public LPPositionSchema getSchema()
	{
		LPPositionSchema aLPPositionSchema = new LPPositionSchema();
		aLPPositionSchema.setSchema(this);
		return aLPPositionSchema;
	}

	public LPPositionDB getDB()
	{
		LPPositionDB aDBOper = new LPPositionDB();
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLPPosition>历史记账凭证主表信息</A>表字段
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LPPositionSchema other = (LPPositionSchema)otherObject;
		return
