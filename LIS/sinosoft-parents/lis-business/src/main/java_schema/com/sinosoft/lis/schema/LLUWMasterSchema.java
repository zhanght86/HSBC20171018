...
/*
 * <p>ClassName: LLUWMasterSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 理赔管理
 */
public class LLUWMasterSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LLUWMasterSchema.class);
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LLUWMasterSchema cloned = (LLUWMasterSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LLUWMasterSchema 对象给 Schema 赋值
	* @param: aLLUWMasterSchema LLUWMasterSchema
	**/
	public void setSchema(LLUWMasterSchema aLLUWMasterSchema)
	{
		this.CaseNo = aLLUWMasterSchema.getCaseNo();
		this.GrpContNo = aLLUWMasterSchema.getGrpContNo();
		this.BatNo = aLLUWMasterSchema.getBatNo();
		this.ContNo = aLLUWMasterSchema.getContNo();
		this.ProposalContNo = aLLUWMasterSchema.getProposalContNo();
		this.PolNo = aLLUWMasterSchema.getPolNo();
		this.ProposalNo = aLLUWMasterSchema.getProposalNo();
		this.UWNo = aLLUWMasterSchema.getUWNo();
		this.InsuredNo = aLLUWMasterSchema.getInsuredNo();
		this.InsuredName = aLLUWMasterSchema.getInsuredName();
		this.AppntNo = aLLUWMasterSchema.getAppntNo();
		this.AppntName = aLLUWMasterSchema.getAppntName();
		this.AgentCode = aLLUWMasterSchema.getAgentCode();
		this.AgentGroup = aLLUWMasterSchema.getAgentGroup();
		this.PassFlag = aLLUWMasterSchema.getPassFlag();
		this.UWGrade = aLLUWMasterSchema.getUWGrade();
		this.AppGrade = aLLUWMasterSchema.getAppGrade();
		this.PostponeDay = aLLUWMasterSchema.getPostponeDay();
		this.PostponeDate = fDate.getDate( aLLUWMasterSchema.getPostponeDate());
		this.AutoUWFlag = aLLUWMasterSchema.getAutoUWFlag();
		this.State = aLLUWMasterSchema.getState();
		this.ManageCom = aLLUWMasterSchema.getManageCom();
		this.UWIdea = aLLUWMasterSchema.getUWIdea();
		this.UpReportContent = aLLUWMasterSchema.getUpReportContent();
		this.Operator = aLLUWMasterSchema.getOperator();
		this.HealthFlag = aLLUWMasterSchema.getHealthFlag();
		this.QuesFlag = aLLUWMasterSchema.getQuesFlag();
		this.SpecFlag = aLLUWMasterSchema.getSpecFlag();
		this.AddPremFlag = aLLUWMasterSchema.getAddPremFlag();
		this.AddPremReason = aLLUWMasterSchema.getAddPremReason();
		this.ReportFlag = aLLUWMasterSchema.getReportFlag();
		this.PrintFlag = aLLUWMasterSchema.getPrintFlag();
		this.PrintFlag2 = aLLUWMasterSchema.getPrintFlag2();
		this.ChangePolFlag = aLLUWMasterSchema.getChangePolFlag();
		this.ChangePolReason = aLLUWMasterSchema.getChangePolReason();
		this.SpecReason = aLLUWMasterSchema.getSpecReason();
		this.MakeDate = fDate.getDate( aLLUWMasterSchema.getMakeDate());
		this.MakeTime = aLLUWMasterSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLLUWMasterSchema.getModifyDate());
		this.ModifyTime = aLLUWMasterSchema.getModifyTime();
		this.SugPassFlag = aLLUWMasterSchema.getSugPassFlag();
		this.SugUWIdea = aLLUWMasterSchema.getSugUWIdea();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LLUWMaster表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LLUWMasterSchema";
	...
	public LLUWMasterSchema getSchema()
	{
		LLUWMasterSchema aLLUWMasterSchema = new LLUWMasterSchema();
		aLLUWMasterSchema.setSchema(this);
		return aLLUWMasterSchema;
	}

	public LLUWMasterDB getDB()
	{
		LLUWMasterDB aDBOper = new LLUWMasterDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLLUWMaster描述/A>表字段
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLLUWMaster>历史记账凭证主表信息</A>表字段
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LLUWMasterSchema other = (LLUWMasterSchema)otherObject;
		return
