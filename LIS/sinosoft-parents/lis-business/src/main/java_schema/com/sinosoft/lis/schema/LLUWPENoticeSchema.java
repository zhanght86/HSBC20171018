...
/*
 * <p>ClassName: LLUWPENoticeSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 理赔管理
 */
public class LLUWPENoticeSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LLUWPENoticeSchema.class);
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LLUWPENoticeSchema cloned = (LLUWPENoticeSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LLUWPENoticeSchema 对象给 Schema 赋值
	* @param: aLLUWPENoticeSchema LLUWPENoticeSchema
	**/
	public void setSchema(LLUWPENoticeSchema aLLUWPENoticeSchema)
	{
		this.ClmNo = aLLUWPENoticeSchema.getClmNo();
		this.BatNo = aLLUWPENoticeSchema.getBatNo();
		this.GrpContNo = aLLUWPENoticeSchema.getGrpContNo();
		this.ContNo = aLLUWPENoticeSchema.getContNo();
		this.ProposalContNo = aLLUWPENoticeSchema.getProposalContNo();
		this.PrtSeq = aLLUWPENoticeSchema.getPrtSeq();
		this.AppName = aLLUWPENoticeSchema.getAppName();
		this.RiskName = aLLUWPENoticeSchema.getRiskName();
		this.PEDate = fDate.getDate( aLLUWPENoticeSchema.getPEDate());
		this.CustomerNo = aLLUWPENoticeSchema.getCustomerNo();
		this.Name = aLLUWPENoticeSchema.getName();
		this.PEAddress = aLLUWPENoticeSchema.getPEAddress();
		this.PEBeforeCond = aLLUWPENoticeSchema.getPEBeforeCond();
		this.PrintFlag = aLLUWPENoticeSchema.getPrintFlag();
		this.ManageCom = aLLUWPENoticeSchema.getManageCom();
		this.AgentName = aLLUWPENoticeSchema.getAgentName();
		this.AgentCode = aLLUWPENoticeSchema.getAgentCode();
		this.Operator = aLLUWPENoticeSchema.getOperator();
		this.MakeDate = fDate.getDate( aLLUWPENoticeSchema.getMakeDate());
		this.MakeTime = aLLUWPENoticeSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLLUWPENoticeSchema.getModifyDate());
		this.ModifyTime = aLLUWPENoticeSchema.getModifyTime();
		this.Remark = aLLUWPENoticeSchema.getRemark();
		this.PEResult = aLLUWPENoticeSchema.getPEResult();
		this.GrpPrtSeq = aLLUWPENoticeSchema.getGrpPrtSeq();
		this.PEDoctor = aLLUWPENoticeSchema.getPEDoctor();
		this.REPEDate = fDate.getDate( aLLUWPENoticeSchema.getREPEDate());
		this.PEReason = aLLUWPENoticeSchema.getPEReason();
		this.MasculineFlag = aLLUWPENoticeSchema.getMasculineFlag();
		this.CustomerType = aLLUWPENoticeSchema.getCustomerType();
		this.HospitCode = aLLUWPENoticeSchema.getHospitCode();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LLUWPENotice表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LLUWPENoticeSchema";
	...
	public LLUWPENoticeSchema getSchema()
	{
		LLUWPENoticeSchema aLLUWPENoticeSchema = new LLUWPENoticeSchema();
		aLLUWPENoticeSchema.setSchema(this);
		return aLLUWPENoticeSchema;
	}

	public LLUWPENoticeDB getDB()
	{
		LLUWPENoticeDB aDBOper = new LLUWPENoticeDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLLUWPENotice描述/A>表字段
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLLUWPENotice>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			PEDoctor = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 26, SysConst.PACKAGESPILTER );
			REPEDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 27,SysConst.PACKAGESPILTER));
			PEReason = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 28, SysConst.PACKAGESPILTER );
			MasculineFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 29, SysConst.PACKAGESPILTER );
			CustomerType = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 30, SysConst.PACKAGESPILTER );
			HospitCode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 31, SysConst.PACKAGESPILTER );
		}
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LLUWPENoticeSchema other = (LLUWPENoticeSchema)otherObject;
		return
