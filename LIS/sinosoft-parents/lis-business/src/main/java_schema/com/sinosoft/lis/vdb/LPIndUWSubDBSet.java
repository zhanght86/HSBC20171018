...
/*
 * <p>ClassName: LPIndUWSubDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 保全流程
 */
public class LPIndUWSubDBSet extends LPIndUWSubSet
{
private static Logger logger = Logger.getLogger(LPIndUWSubDBSet.class);
	...
	**/
	...
	// @Constructor
	public LPIndUWSubDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LPIndUWSubDBSet";
	...
	public boolean delete()
	{
		...
		try
		{
			...
			if(this.get(i).getEdorType() == null || this.get(i).getEdorType().equals("null")) {
				...
				pstmt.setString(5, this.get(i).getEdorType());
			}
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getEdorNo() == null || this.get(i).getEdorNo().equals("null")) {
				...
				pstmt.setString(44, this.get(i).getEdorNo());
			}
			if(this.get(i).getEdorType() == null || this.get(i).getEdorType().equals("null")) {
				pstmt.setString(45,null);
			} else {
				pstmt.setString(45, this.get(i).getEdorType());
			}
