...
/*
 * <p>ClassName: LOBGrpEnginDetailDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: Physical Data Model 1
 */
public class LOBGrpEnginDetailDBSet extends LOBGrpEnginDetailSet
{
	// @Field
	...
	**/
	...
	// @Constructor
	public LOBGrpEnginDetailDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LOBGrpEnginDetailDBSet";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getBussType() == null || this.get(i).getBussType().equals("null")) {
				...
				pstmt.setString(15, this.get(i).getBussType());
			}
			if(this.get(i).getBussNo() == null || this.get(i).getBussNo().equals("null")) {
				pstmt.setString(16,null);
			} else {
				pstmt.setString(16, this.get(i).getBussNo());
			}
			if(this.get(i).getGrpContNo() == null || this.get(i).getGrpContNo().equals("null")) {
			...
			if(this.get(i).getEnginCode() == null || this.get(i).getEnginCode().equals("null")) {
				...
				pstmt.setString(18, this.get(i).getEnginCode());
			}
