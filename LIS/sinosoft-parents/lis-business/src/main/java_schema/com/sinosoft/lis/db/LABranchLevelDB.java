...
{
private static Logger logger = Logger.getLogger(LABranchLevelDB.class);
	...
	**/
	...
	public boolean delete()
	{
		...
		try
		{
			...
			if(this.getBranchLevelCode() == null || this.getBranchLevelCode().equals("null")) {
				pstmt.setNull(1, 12);
			} else {
				pstmt.setString(1, this.getBranchLevelCode());
			}
			pstmt.executeUpdate();
			pstmt.close();
		} catch (Exception ex) {
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.getBranchLevelName() == null || this.getBranchLevelName().equals("null")) {
				pstmt.setNull(2, 12);
			} else {
				pstmt.setString(2, this.getBranchLevelName());
			}
			if(this.getBranchLevelType() == null || this.getBranchLevelType().equals("null")) {
				pstmt.setNull(3, 1);
			} else {
				pstmt.setString(3, this.getBranchLevelType());
			}
			pstmt.setInt(4, this.getBranchLevelID());
			if(this.getBranchType() == null || this.getBranchType().equals("null")) {
				pstmt.setNull(5, 12);
			} else {
				pstmt.setString(5, this.getBranchType());
			}
			if(this.getBranchProperty() == null || this.getBranchProperty().equals("null")) {
				pstmt.setNull(6, 1);
			} else {
				pstmt.setString(6, this.getBranchProperty());
			}
			if(this.getAgentKind() == null || this.getAgentKind().equals("null")) {
				pstmt.setNull(7, 12);
			} else {
				pstmt.setString(7, this.getAgentKind());
			}
			if(this.getSubjectProperty() == null || this.getSubjectProperty().equals("null")) {
				pstmt.setNull(8, 1);
			} else {
				pstmt.setString(8, this.getSubjectProperty());
			}
			if(this.getBranchLevelProperty1() == null || this.getBranchLevelProperty1().equals("null")) {
				pstmt.setNull(9, 12);
			} else {
				pstmt.setString(9, this.getBranchLevelProperty1());
			}
			if(this.getBranchLevelProperty2() == null || this.getBranchLevelProperty2().equals("null")) {
				pstmt.setNull(10, 12);
			} else {
				pstmt.setString(10, this.getBranchLevelProperty2());
			}
			if(this.getBranchLevelProperty3() == null || this.getBranchLevelProperty3().equals("null")) {
				pstmt.setNull(11, 12);
			} else {
				pstmt.setString(11, this.getBranchLevelProperty3());
			}
			if(this.getBranchLevelProperty4() == null || this.getBranchLevelProperty4().equals("null")) {
				pstmt.setNull(12, 12);
			} else {
				pstmt.setString(12, this.getBranchLevelProperty4());
			}
			if(this.getBranchLevelProperty5() == null || this.getBranchLevelProperty5().equals("null")) {
				pstmt.setNull(13, 12);
			} else {
				pstmt.setString(13, this.getBranchLevelProperty5());
			}
			...
			if(this.getBranchLevelCode() == null || this.getBranchLevelCode().equals("null")) {
				...
				pstmt.setString(15, this.getBranchLevelCode());
			}
			pstmt.executeUpdate();
			pstmt.close();
		} catch (Exception ex) {
	...
	public boolean getInfo()
	{
		...
		try
		{
			pstmt = con.prepareStatement("SELECT * FROM LABranchLevel WHERE  BranchLevelCode = ?", 
...
public boolean closeData()
{
	...
	public LABranchLevelSet executeQuery(SQLwithBindVariables sqlbv) {
	...
	public LABranchLevelSet executeQuery(SQLwithBindVariables sqlbv, int nStart, int nCount) {
