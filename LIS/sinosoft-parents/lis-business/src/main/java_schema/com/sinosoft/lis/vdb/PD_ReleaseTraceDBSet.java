...
/**
 * <p>ClassName: PD_ReleaseTraceDBSet </p>
 ...
 */
public class PD_ReleaseTraceDBSet extends PD_ReleaseTraceSet
{
private static Logger logger = Logger.getLogger(PD_ReleaseTraceDBSet.class);
    ...
    // @Constructor
    public PD_ReleaseTraceDBSet(Connection cConnection)
    {
        con = cConnection;
    ...
    public boolean deleteSQL()
    {
        ...
        else
        {
            ...
            tError.moduleName = "PD_ReleaseTraceDBSet";
    ...
    public boolean insert()
    {
        ...
        try
        {
            ...
            {
                if (this.get(i).getReleaseId() == null || this.get(i).getReleaseId().equals("null"))
                {
                    pstmt.setString(1, null);
                }
                else
                {
                    pstmt.setString(1, this.get(i).getReleaseId());
                }
                if (this.get(i).getReleasePlatform() == null || this.get(i).getReleasePlatform().equals("null"))
                {
                    pstmt.setString(2, null);
                }
                else
                {
                    pstmt.setString(2, this.get(i).getReleasePlatform());
                }
    ...
    public boolean update()
    {
        ...
        try
        {
            ...
            for (int i = 1; i <= tCount; i++)
            {
                ...
                {
                    pstmt.setString(18, this.get(i).getReleaseId());
                }
                pstmt.addBatch();
            }
            pstmt.executeBatch();
