...
/*
 * <p>ClassName: RIPolRecordBakeDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 再保系统模型
 */
public class RIPolRecordBakeDBSet extends RIPolRecordBakeSet
{
	// @Field
	...
	**/
	...
	// @Constructor
	public RIPolRecordBakeDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "RIPolRecordBakeDBSet";
