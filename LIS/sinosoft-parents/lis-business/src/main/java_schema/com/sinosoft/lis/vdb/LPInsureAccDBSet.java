...
/*
 * <p>ClassName: LPInsureAccDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 保全核心
 */
public class LPInsureAccDBSet extends LPInsureAccSet
{
	// @Field
	...
	**/
	...
	// @Constructor
	public LPInsureAccDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LPInsureAccDBSet";
...
ex.printStackTrace();
	...
	public boolean update()
	{
		...
		try
		{
			...
			pstmt.setDouble(28, this.get(i).getUnitPrice());
			...
			if(this.get(i).getManageCom() == null || this.get(i).getManageCom().equals("null")) {
				...
				pstmt.setString(32, this.get(i).getManageCom());
			}
			...
			if(this.get(i).getInsuAccNo() == null || this.get(i).getInsuAccNo().equals("null")) {
				...
				pstmt.setString(44, this.get(i).getInsuAccNo());
			}
