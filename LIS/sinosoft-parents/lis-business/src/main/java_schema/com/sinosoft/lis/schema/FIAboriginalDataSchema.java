...
/**
 * <p>ClassName: FIAboriginalDataSchema </p>
 ...
 */
public class FIAboriginalDataSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(FIAboriginalDataSchema.class);
	...
	public FIAboriginalDataSchema()
	{
		...
		PK = pk;
            ...
            public Object clone()
                    throws CloneNotSupportedException
            {
                FIAboriginalDataSchema cloned = (FIAboriginalDataSchema)super.clone();
	...
	/**
	* 使用另外一个 FIAboriginalDataSchema 对象给 Schema 赋值
	* @param: aFIAboriginalDataSchema FIAboriginalDataSchema
	**/
	public void setSchema(FIAboriginalDataSchema aFIAboriginalDataSchema)
	{
		this.ASerialNo = aFIAboriginalDataSchema.getASerialNo();
		this.AcquisitionID = aFIAboriginalDataSchema.getAcquisitionID();
		this.DataBaseID = aFIAboriginalDataSchema.getDataBaseID();
		this.BatchNo = aFIAboriginalDataSchema.getBatchNo();
		this.CertificateID = aFIAboriginalDataSchema.getCertificateID();
		this.CostID = aFIAboriginalDataSchema.getCostID();
		this.DataState = aFIAboriginalDataSchema.getDataState();
		this.CheckFlag = aFIAboriginalDataSchema.getCheckFlag();
		this.BusinessCode = aFIAboriginalDataSchema.getBusinessCode();
		this.FeeCode = aFIAboriginalDataSchema.getFeeCode();
		this.SumActuMoney = aFIAboriginalDataSchema.getSumActuMoney();
		this.AccountDate = fDate.getDate( aFIAboriginalDataSchema.getAccountDate());
		this.BusinessNo = aFIAboriginalDataSchema.getBusinessNo();
		this.StringInfo01 = aFIAboriginalDataSchema.getStringInfo01();
		this.StringInfo02 = aFIAboriginalDataSchema.getStringInfo02();
		this.StringInfo03 = aFIAboriginalDataSchema.getStringInfo03();
		this.StringInfo04 = aFIAboriginalDataSchema.getStringInfo04();
		this.StringInfo05 = aFIAboriginalDataSchema.getStringInfo05();
		this.StringInfo06 = aFIAboriginalDataSchema.getStringInfo06();
		this.StringInfo07 = aFIAboriginalDataSchema.getStringInfo07();
		this.StringInfo08 = aFIAboriginalDataSchema.getStringInfo08();
		this.StringInfo09 = aFIAboriginalDataSchema.getStringInfo09();
		this.StringInfo10 = aFIAboriginalDataSchema.getStringInfo10();
		this.StringInfo11 = aFIAboriginalDataSchema.getStringInfo11();
		this.StringInfo12 = aFIAboriginalDataSchema.getStringInfo12();
		this.StringInfo13 = aFIAboriginalDataSchema.getStringInfo13();
		this.StringInfo14 = aFIAboriginalDataSchema.getStringInfo14();
		this.StringInfo15 = aFIAboriginalDataSchema.getStringInfo15();
		this.DateInfo01 = fDate.getDate( aFIAboriginalDataSchema.getDateInfo01());
		this.DateInfo02 = fDate.getDate( aFIAboriginalDataSchema.getDateInfo02());
		this.DateInfo03 = fDate.getDate( aFIAboriginalDataSchema.getDateInfo03());
		this.DateInfo04 = fDate.getDate( aFIAboriginalDataSchema.getDateInfo04());
		this.DateInfo05 = fDate.getDate( aFIAboriginalDataSchema.getDateInfo05());
		this.DateInfo06 = fDate.getDate( aFIAboriginalDataSchema.getDateInfo06());
		this.DateInfo07 = fDate.getDate( aFIAboriginalDataSchema.getDateInfo07());
		this.DateInfo08 = fDate.getDate( aFIAboriginalDataSchema.getDateInfo08());
		this.DateInfo09 = fDate.getDate( aFIAboriginalDataSchema.getDateInfo09());
		this.DateInfo10 = fDate.getDate( aFIAboriginalDataSchema.getDateInfo10());
		this.NumInfo01 = aFIAboriginalDataSchema.getNumInfo01();
		this.NumInfo02 = aFIAboriginalDataSchema.getNumInfo02();
		this.NumInfo03 = aFIAboriginalDataSchema.getNumInfo03();
		this.NumInfo04 = aFIAboriginalDataSchema.getNumInfo04();
		this.NumInfo05 = aFIAboriginalDataSchema.getNumInfo05();
		this.BusinessNo01 = aFIAboriginalDataSchema.getBusinessNo01();
		this.BusinessNo02 = aFIAboriginalDataSchema.getBusinessNo02();
		this.BusinessNo03 = aFIAboriginalDataSchema.getBusinessNo03();
		this.BusinessNo04 = aFIAboriginalDataSchema.getBusinessNo04();
		this.BusinessNo05 = aFIAboriginalDataSchema.getBusinessNo05();
		this.BusinessNo06 = aFIAboriginalDataSchema.getBusinessNo06();
		this.BusinessNo07 = aFIAboriginalDataSchema.getBusinessNo07();
		this.BusinessNo08 = aFIAboriginalDataSchema.getBusinessNo08();
		this.BusinessNo09 = aFIAboriginalDataSchema.getBusinessNo09();
		this.BusinessNo10 = aFIAboriginalDataSchema.getBusinessNo10();
		this.TypeFlag01 = aFIAboriginalDataSchema.getTypeFlag01();
		this.TypeFlag02 = aFIAboriginalDataSchema.getTypeFlag02();
		this.TypeFlag03 = aFIAboriginalDataSchema.getTypeFlag03();
		this.TypeFlag04 = aFIAboriginalDataSchema.getTypeFlag04();
		this.TypeFlag05 = aFIAboriginalDataSchema.getTypeFlag05();
		this.TypeFlag06 = aFIAboriginalDataSchema.getTypeFlag06();
		this.TypeFlag07 = aFIAboriginalDataSchema.getTypeFlag07();
		this.TypeFlag08 = aFIAboriginalDataSchema.getTypeFlag08();
		this.TypeFlag09 = aFIAboriginalDataSchema.getTypeFlag09();
		this.TypeFlag10 = aFIAboriginalDataSchema.getTypeFlag10();
		this.Relationcode = aFIAboriginalDataSchema.getRelationcode();
		this.MakeDate = fDate.getDate( aFIAboriginalDataSchema.getMakeDate());
		this.MakeTime = aFIAboriginalDataSchema.getMakeTime();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的FIAboriginalData表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "FIAboriginalDataSchema";
	...
	public FIAboriginalDataSchema getSchema()
	{
		FIAboriginalDataSchema aFIAboriginalDataSchema = new FIAboriginalDataSchema();
		aFIAboriginalDataSchema.setSchema(this);
		return aFIAboriginalDataSchema;
	}

	public FIAboriginalDataDB getDB()
	{
		FIAboriginalDataDB aDBOper = new FIAboriginalDataDB();
...
strReturn.append(StrTool.cTrim(MakeTime));
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpFIAboriginalData>历史记账凭证主表信息</A>表字段
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		FIAboriginalDataSchema other = (FIAboriginalDataSchema)otherObject;
		return
