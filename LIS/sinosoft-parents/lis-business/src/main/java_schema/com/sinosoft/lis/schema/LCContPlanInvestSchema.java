...
import com.sinosoft.lis.db.LCContPlanInvestDB;

/*
 * <p>ClassName: LCContPlanInvestSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 新单管理
 */
public class LCContPlanInvestSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LCContPlanInvestSchema.class);
	// @Field
	/** 保单号 */
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LCContPlanInvestSchema cloned = (LCContPlanInvestSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LCContPlanInvestSchema 对象给 Schema 赋值
	* @param: aLCContPlanInvestSchema LCContPlanInvestSchema
	**/
	public void setSchema(LCContPlanInvestSchema aLCContPlanInvestSchema)
	{
		this.PolicyNo = aLCContPlanInvestSchema.getPolicyNo();
		this.SysPlanCode = aLCContPlanInvestSchema.getSysPlanCode();
		this.PlanCode = aLCContPlanInvestSchema.getPlanCode();
		this.RiskCode = aLCContPlanInvestSchema.getRiskCode();
		this.DutyCode = aLCContPlanInvestSchema.getDutyCode();
		this.PayPlanCode = aLCContPlanInvestSchema.getPayPlanCode();
		this.PayMoney = aLCContPlanInvestSchema.getPayMoney();
		this.Segment1 = aLCContPlanInvestSchema.getSegment1();
		this.Segment2 = aLCContPlanInvestSchema.getSegment2();
		this.Segment3 = aLCContPlanInvestSchema.getSegment3();
		this.Segment4 = aLCContPlanInvestSchema.getSegment4();
		this.MakeOperator = aLCContPlanInvestSchema.getMakeOperator();
		this.MakeDate = fDate.getDate( aLCContPlanInvestSchema.getMakeDate());
		this.MakeTime = aLCContPlanInvestSchema.getMakeTime();
		this.ModifyOperator = aLCContPlanInvestSchema.getModifyOperator();
		this.ModifyDate = fDate.getDate( aLCContPlanInvestSchema.getModifyDate());
		this.ModifyTime = aLCContPlanInvestSchema.getModifyTime();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LCContPlanInvest表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LCContPlanInvestSchema";
	...
	public LCContPlanInvestSchema getSchema()
	{
		LCContPlanInvestSchema aLCContPlanInvestSchema = new LCContPlanInvestSchema();
		aLCContPlanInvestSchema.setSchema(this);
		return aLCContPlanInvestSchema;
	}

	public LCContPlanInvestDB getDB()
	{
		LCContPlanInvestDB aDBOper = new LCContPlanInvestDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLCContPlanInvest描述/A>表字段
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLCContPlanInvest>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			Segment4 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 11, SysConst.PACKAGESPILTER );
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LCContPlanInvestSchema other = (LCContPlanInvestSchema)otherObject;
		return
