...
import com.sinosoft.lis.db.LCInsuredDrawDetailDB;

/*
 * <p>ClassName: LCInsuredDrawDetailSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: Physical Data Model 1
 */
public class LCInsuredDrawDetailSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LCInsuredDrawDetailSchema.class);
	// @Field
	/** 团体保单号 */
	...
	// @Constructor
	public LCInsuredDrawDetailSchema()
	{
		mErrors = new CErrors();
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LCInsuredDrawDetailSchema cloned = (LCInsuredDrawDetailSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LCInsuredDrawDetailSchema 对象给 Schema 赋值
	* @param: aLCInsuredDrawDetailSchema LCInsuredDrawDetailSchema
	**/
	public void setSchema(LCInsuredDrawDetailSchema aLCInsuredDrawDetailSchema)
	{
		this.GrpContNo = aLCInsuredDrawDetailSchema.getGrpContNo();
		this.GrpPolNo = aLCInsuredDrawDetailSchema.getGrpPolNo();
		this.ContNo = aLCInsuredDrawDetailSchema.getContNo();
		this.AppntNo = aLCInsuredDrawDetailSchema.getAppntNo();
		this.InsuredNo = aLCInsuredDrawDetailSchema.getInsuredNo();
		this.PolNo = aLCInsuredDrawDetailSchema.getPolNo();
		this.RiskCode = aLCInsuredDrawDetailSchema.getRiskCode();
		this.DutyCode = aLCInsuredDrawDetailSchema.getDutyCode();
		this.GetDutyCode = aLCInsuredDrawDetailSchema.getGetDutyCode();
		this.SumMoney = aLCInsuredDrawDetailSchema.getSumMoney();
		this.GetMode = aLCInsuredDrawDetailSchema.getGetMode();
		this.GetIntv = aLCInsuredDrawDetailSchema.getGetIntv();
		this.GetStartDate = fDate.getDate( aLCInsuredDrawDetailSchema.getGetStartDate());
		this.GetToDate = fDate.getDate( aLCInsuredDrawDetailSchema.getGetToDate());
		this.GetEndDate = fDate.getDate( aLCInsuredDrawDetailSchema.getGetEndDate());
		this.GetTimes = aLCInsuredDrawDetailSchema.getGetTimes();
		this.GetMoney = aLCInsuredDrawDetailSchema.getGetMoney();
		this.NextLiveDate = fDate.getDate( aLCInsuredDrawDetailSchema.getNextLiveDate());
		this.NextGetDate = fDate.getDate( aLCInsuredDrawDetailSchema.getNextGetDate());
		this.AlreadyMoney = aLCInsuredDrawDetailSchema.getAlreadyMoney();
		this.GetEndState = aLCInsuredDrawDetailSchema.getGetEndState();
		this.ManageCom = aLCInsuredDrawDetailSchema.getManageCom();
		this.ComCode = aLCInsuredDrawDetailSchema.getComCode();
		this.MakeOperator = aLCInsuredDrawDetailSchema.getMakeOperator();
		this.MakeDate = fDate.getDate( aLCInsuredDrawDetailSchema.getMakeDate());
		this.MakeTime = aLCInsuredDrawDetailSchema.getMakeTime();
		this.ModifyOperator = aLCInsuredDrawDetailSchema.getModifyOperator();
		this.ModifyDate = fDate.getDate( aLCInsuredDrawDetailSchema.getModifyDate());
		this.ModifyTime = aLCInsuredDrawDetailSchema.getModifyTime();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LCInsuredDrawDetail表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LCInsuredDrawDetailSchema";
	...
	public LCInsuredDrawDetailSchema getSchema()
	{
		LCInsuredDrawDetailSchema aLCInsuredDrawDetailSchema = new LCInsuredDrawDetailSchema();
		aLCInsuredDrawDetailSchema.setSchema(this);
		return aLCInsuredDrawDetailSchema;
	}

	public LCInsuredDrawDetailDB getDB()
	{
		LCInsuredDrawDetailDB aDBOper = new LCInsuredDrawDetailDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLCInsuredDrawDetail描述/A>表字段
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLCInsuredDrawDetail>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			GetMode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 11, SysConst.PACKAGESPILTER );
			GetIntv= new Integer(ChgData.chgNumericStr(StrTool.getStr(strMessage,12,SysConst.PACKAGESPILTER))).intValue();
			GetStartDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 13,SysConst.PACKAGESPILTER));
			GetToDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 14,SysConst.PACKAGESPILTER));
			GetEndDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 15,SysConst.PACKAGESPILTER));
			GetTimes= new Integer(ChgData.chgNumericStr(StrTool.getStr(strMessage,16,SysConst.PACKAGESPILTER))).intValue();
			GetMoney = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,17,SysConst.PACKAGESPILTER))).doubleValue();
			NextLiveDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 18,SysConst.PACKAGESPILTER));
			NextGetDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 19,SysConst.PACKAGESPILTER));
			AlreadyMoney = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,20,SysConst.PACKAGESPILTER))).doubleValue();
			GetEndState = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 21, SysConst.PACKAGESPILTER );
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LCInsuredDrawDetailSchema other = (LCInsuredDrawDetailSchema)otherObject;
		return
