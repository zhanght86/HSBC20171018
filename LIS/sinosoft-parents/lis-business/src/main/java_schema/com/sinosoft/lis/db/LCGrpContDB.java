...
public class LCGrpContDB extends LCGrpContSchema
{
	...
	**/
	...
	public boolean getInfo()
	{
		...
		try
		{
			pstmt = con.prepareStatement("SELECT * FROM LCGrpCont WHERE  GrpContNo = ?", 
...
public boolean closeData()
{
	...
	public LCGrpContSet executeQuery(SQLwithBindVariables sqlbv) {
	...
	public LCGrpContSet executeQuery(SQLwithBindVariables sqlbv, int nStart, int nCount) {
