...
/*
 * <p>ClassName: LJSGetDrawDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 寿险业务付费
 */
public class LJSGetDrawDBSet extends LJSGetDrawSet
{
	// @Field
	...
	**/
	...
	// @Constructor
	public LJSGetDrawDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LJSGetDrawDBSet";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getGetFirstFlag() == null || this.get(i).getGetFirstFlag().equals("null")) {
				...
				pstmt.setString(29, this.get(i).getGetFirstFlag());
			}
			...
			if(this.get(i).getRReportFlag() == null || this.get(i).getRReportFlag().equals("null")) {
				...
				pstmt.setString(42, this.get(i).getRReportFlag());
			}
			if(this.get(i).getComeFlag() == null || this.get(i).getComeFlag().equals("null")) {
				pstmt.setString(43,null);
			} else {
				pstmt.setString(43, this.get(i).getComeFlag());
			}
			...
			pstmt.setDouble(45, this.get(i).getNetAmount());
			pstmt.setDouble(46, this.get(i).getTaxAmount());
			pstmt.setDouble(47, this.get(i).getTax());
			// set where condition
			if(this.get(i).getGetNoticeNo() == null || this.get(i).getGetNoticeNo().equals("null")) {
			...
			if(this.get(i).getGetDutyKind() == null || this.get(i).getGetDutyKind().equals("null")) {
				...
				pstmt.setString(51, this.get(i).getGetDutyKind());
			}
			if(this.get(i).getGetDutyCode() == null || this.get(i).getGetDutyCode().equals("null")) {
