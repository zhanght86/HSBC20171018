...
/*
 * <p>ClassName: LBInsureAccClassDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 投连改造
 */
public class LBInsureAccClassDBSet extends LBInsureAccClassSet
{
private static Logger logger = Logger.getLogger(LBInsureAccClassDBSet.class);
	...
	**/
	...
	// @Constructor
	public LBInsureAccClassDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LBInsureAccClassDBSet";
...
ex.printStackTrace();
	...
	public boolean update()
	{
		...
		try
		{
			...
			pstmt.setDouble(21, this.get(i).getSumPay());
			pstmt.setDouble(22, this.get(i).getSumPaym());
			pstmt.setDouble(23, this.get(i).getLastAccBala());
			pstmt.setDouble(24, this.get(i).getLastUnitCount());
			pstmt.setDouble(25, this.get(i).getLastUnitPrice());
			pstmt.setDouble(26, this.get(i).getInsuAccBala());
			pstmt.setDouble(27, this.get(i).getUnitCount());
			pstmt.setDouble(28, this.get(i).getInsuAccGetMoney());
			pstmt.setDouble(29, this.get(i).getFrozenMoney());
			if(this.get(i).getState() == null || this.get(i).getState().equals("null")) {
				pstmt.setString(30,null);
			} else {
				pstmt.setString(30, this.get(i).getState());
			}
			...
			if(this.get(i).getInsuAccNo() == null || this.get(i).getInsuAccNo().equals("null")) {
				...
				pstmt.setString(41, this.get(i).getInsuAccNo());
			}
			if(this.get(i).getPayPlanCode() == null || this.get(i).getPayPlanCode().equals("null")) {
				pstmt.setString(42,null);
			} else {
				pstmt.setString(42, this.get(i).getPayPlanCode());
			}
			if(this.get(i).getOtherNo() == null || this.get(i).getOtherNo().equals("null")) {
			...
			if(this.get(i).getAccAscription() == null || this.get(i).getAccAscription().equals("null")) {
				...
				pstmt.setString(44, StrTool.space1(this.get(i).getAccAscription(), 1));
			}
