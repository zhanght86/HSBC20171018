...
import com.sinosoft.lis.db.LDCustomerLinkmanDB;

/*
 * <p>ClassName: LDCustomerLinkmanSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 客户管理
 */
public class LDCustomerLinkmanSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LDCustomerLinkmanSchema.class);
	// @Field
	/** 联系号 */
	...
	// @Constructor
	public LDCustomerLinkmanSchema()
	{
		mErrors = new CErrors();
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LDCustomerLinkmanSchema cloned = (LDCustomerLinkmanSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LDCustomerLinkmanSchema 对象给 Schema 赋值
	* @param: aLDCustomerLinkmanSchema LDCustomerLinkmanSchema
	**/
	public void setSchema(LDCustomerLinkmanSchema aLDCustomerLinkmanSchema)
	{
		this.ContactNo = aLDCustomerLinkmanSchema.getContactNo();
		this.CustomerNo = aLDCustomerLinkmanSchema.getCustomerNo();
		this.LinkManFlag = aLDCustomerLinkmanSchema.getLinkManFlag();
		this.LinkMan = aLDCustomerLinkmanSchema.getLinkMan();
		this.Department = aLDCustomerLinkmanSchema.getDepartment();
		this.HeadShip = aLDCustomerLinkmanSchema.getHeadShip();
		this.MobilePhone = aLDCustomerLinkmanSchema.getMobilePhone();
		this.Phone = aLDCustomerLinkmanSchema.getPhone();
		this.Fax = aLDCustomerLinkmanSchema.getFax();
		this.EMail = aLDCustomerLinkmanSchema.getEMail();
		this.IDType = aLDCustomerLinkmanSchema.getIDType();
		this.IDNo = aLDCustomerLinkmanSchema.getIDNo();
		this.ISValFlag = aLDCustomerLinkmanSchema.getISValFlag();
		this.IDStartDate = fDate.getDate( aLDCustomerLinkmanSchema.getIDStartDate());
		this.IDEndDate = fDate.getDate( aLDCustomerLinkmanSchema.getIDEndDate());
		this.State = aLDCustomerLinkmanSchema.getState();
		this.MakeOperator = aLDCustomerLinkmanSchema.getMakeOperator();
		this.MakeDate = fDate.getDate( aLDCustomerLinkmanSchema.getMakeDate());
		this.MakeTime = aLDCustomerLinkmanSchema.getMakeTime();
		this.ModifyOperator = aLDCustomerLinkmanSchema.getModifyOperator();
		this.ModifyDate = fDate.getDate( aLDCustomerLinkmanSchema.getModifyDate());
		this.ModifyTime = aLDCustomerLinkmanSchema.getModifyTime();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LDCustomerLinkman表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LDCustomerLinkmanSchema";
	...
	public LDCustomerLinkmanSchema getSchema()
	{
		LDCustomerLinkmanSchema aLDCustomerLinkmanSchema = new LDCustomerLinkmanSchema();
		aLDCustomerLinkmanSchema.setSchema(this);
		return aLDCustomerLinkmanSchema;
	}

	public LDCustomerLinkmanDB getDB()
	{
		LDCustomerLinkmanDB aDBOper = new LDCustomerLinkmanDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLDCustomerLinkman描述/A>表字段
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLDCustomerLinkman>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			ContactNo= new Integer(ChgData.chgNumericStr(StrTool.getStr(strMessage,1,SysConst.PACKAGESPILTER))).intValue();
			CustomerNo = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 2, SysConst.PACKAGESPILTER );
			LinkManFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 3, SysConst.PACKAGESPILTER );
			LinkMan = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 4, SysConst.PACKAGESPILTER );
			Department = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 5, SysConst.PACKAGESPILTER );
			HeadShip = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 6, SysConst.PACKAGESPILTER );
			MobilePhone = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 7, SysConst.PACKAGESPILTER );
			...
			ISValFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 13, SysConst.PACKAGESPILTER );
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LDCustomerLinkmanSchema other = (LDCustomerLinkmanSchema)otherObject;
		return
