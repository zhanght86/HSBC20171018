...
/*
 * <p>ClassName: RIGrpStateDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 再保系统模型
 */
public class RIGrpStateDBSet extends RIGrpStateSet
{
	// @Field
	...
	**/
	...
	// @Constructor
	public RIGrpStateDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "RIGrpStateDBSet";
...
ex.printStackTrace();
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getExetype() == null || this.get(i).getExetype().equals("null")) {
				pstmt.setString(6,null);
			} else {
				pstmt.setString(6, this.get(i).getExetype());
			}
