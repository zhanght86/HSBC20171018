...
/*
 * <p>ClassName: LSQuotPlanDetailSubTraceDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: Physical Data Model 1
 */
public class LSQuotPlanDetailSubTraceDBSet extends LSQuotPlanDetailSubTraceSet
{
	// @Field
	...
	**/
	...
	// @Constructor
	public LSQuotPlanDetailSubTraceDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public LSQuotPlanDetailSubTraceDBSet()
	{
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LSQuotPlanDetailSubTraceDBSet";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getQuotNo() == null || this.get(i).getQuotNo().equals("null")) {
				...
				pstmt.setString(39, this.get(i).getQuotNo());
			}
			pstmt.setInt(40, this.get(i).getQuotBatNo());
			if(this.get(i).getSysPlanCode() == null || this.get(i).getSysPlanCode().equals("null")) {
