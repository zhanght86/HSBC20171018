...
import com.sinosoft.lis.db.LLDutyCtrllevelDB;

/*
 * <p>ClassName: LLDutyCtrllevelSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 理赔管理
 */
public class LLDutyCtrllevelSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LLDutyCtrllevelSchema.class);
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LLDutyCtrllevelSchema cloned = (LLDutyCtrllevelSchema)super.clone();
	...
	*/
	...
	public void setLevelType(String aLevelType)
	{
	...
	/**
	* 使用另外一个 LLDutyCtrllevelSchema 对象给 Schema 赋值
	* @param: aLLDutyCtrllevelSchema LLDutyCtrllevelSchema
	**/
	public void setSchema(LLDutyCtrllevelSchema aLLDutyCtrllevelSchema)
	{
		this.GrpContNo = aLLDutyCtrllevelSchema.getGrpContNo();
		this.ContType = aLLDutyCtrllevelSchema.getContType();
		this.ContNo = aLLDutyCtrllevelSchema.getContNo();
		this.PolNo = aLLDutyCtrllevelSchema.getPolNo();
		this.RiskCode = aLLDutyCtrllevelSchema.getRiskCode();
		this.DutyCode = aLLDutyCtrllevelSchema.getDutyCode();
		this.ContPlanCode = aLLDutyCtrllevelSchema.getContPlanCode();
		this.LevelType = aLLDutyCtrllevelSchema.getLevelType();
		this.UpLimit = aLLDutyCtrllevelSchema.getUpLimit();
		this.DownLimit = aLLDutyCtrllevelSchema.getDownLimit();
		this.Rate = aLLDutyCtrllevelSchema.getRate();
		this.Flag = aLLDutyCtrllevelSchema.getFlag();
		this.Operator = aLLDutyCtrllevelSchema.getOperator();
		this.MakeDate = fDate.getDate( aLLDutyCtrllevelSchema.getMakeDate());
		this.MakeTime = aLLDutyCtrllevelSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLLDutyCtrllevelSchema.getModifyDate());
		this.ModifyTime = aLLDutyCtrllevelSchema.getModifyTime();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		try
		{
			...
			if( rs.getString("LevelType") == null )
				this.LevelType = null;
			else
				this.LevelType = rs.getString("LevelType").trim();
		...
		{
			logger.debug("数据库中的LLDutyCtrllevel表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LLDutyCtrllevelSchema";
	...
	public LLDutyCtrllevelSchema getSchema()
	{
		LLDutyCtrllevelSchema aLLDutyCtrllevelSchema = new LLDutyCtrllevelSchema();
		aLLDutyCtrllevelSchema.setSchema(this);
		return aLLDutyCtrllevelSchema;
	}

	public LLDutyCtrllevelDB getDB()
	{
		LLDutyCtrllevelDB aDBOper = new LLDutyCtrllevelDB();
	...
	**/
	public String encode()
	{
		...
		strReturn.append(StrTool.cTrim(LevelType)); strReturn.append(SysConst.PACKAGESPILTER);
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLLDutyCtrllevel>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			LevelType = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 8, SysConst.PACKAGESPILTER );
			UpLimit = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,9,SysConst.PACKAGESPILTER))).doubleValue();
			DownLimit = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,10,SysConst.PACKAGESPILTER))).doubleValue();
	...
	**/
	public String getV(String FCode)
	{
		...
		if (FCode.equalsIgnoreCase("LevelType"))
		{
			strReturn = StrTool.GBKToUnicode(String.valueOf(LevelType));
		}
	...
	public String getV(int nFieldIndex)
	{
		...
		switch(nFieldIndex) {
			...
			case 6:
				...
				break;
			case 7:
				strFieldValue = StrTool.GBKToUnicode(LevelType);
				break;
			case 8:
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LLDutyCtrllevelSchema other = (LLDutyCtrllevelSchema)otherObject;
		return
			...
			&& LevelType.equals(other.getLevelType())
	...
	**/
	public int getFieldIndex(String strFieldName)
	{
		...
		if( strFieldName.equals("LevelType") ) {
			return 7;
		}
