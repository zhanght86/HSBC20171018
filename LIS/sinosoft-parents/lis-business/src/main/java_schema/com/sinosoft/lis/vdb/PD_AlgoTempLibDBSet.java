...
/**
 * <p>ClassName: PD_AlgoTempLibDBSet </p>
 ...
 */
public class PD_AlgoTempLibDBSet extends PD_AlgoTempLibSet
{
private static Logger logger = Logger.getLogger(PD_AlgoTempLibDBSet.class);
    ...
    // @Constructor
    public PD_AlgoTempLibDBSet(Connection cConnection)
    {
        con = cConnection;
    ...
    public boolean deleteSQL()
    {
        ...
        else
        {
            ...
            tError.moduleName = "PD_AlgoTempLibDBSet";
    ...
    public boolean insert()
    {
        ...
        try
        {
            ...
            for (int i = 1; i <= tCount; i++)
            {
                ...
                {
                    pstmt.setString(3, this.get(i).getContent());
                }
