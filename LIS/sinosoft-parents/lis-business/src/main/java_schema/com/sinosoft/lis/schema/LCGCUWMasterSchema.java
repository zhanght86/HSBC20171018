...
/*
 * <p>ClassName: LCGCUWMasterSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 承保流程
 */
public class LCGCUWMasterSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LCGCUWMasterSchema.class);
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LCGCUWMasterSchema cloned = (LCGCUWMasterSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LCGCUWMasterSchema 对象给 Schema 赋值
	* @param: aLCGCUWMasterSchema LCGCUWMasterSchema
	**/
	public void setSchema(LCGCUWMasterSchema aLCGCUWMasterSchema)
	{
		this.GrpContNo = aLCGCUWMasterSchema.getGrpContNo();
		this.ProposalGrpContNo = aLCGCUWMasterSchema.getProposalGrpContNo();
		this.UWNo = aLCGCUWMasterSchema.getUWNo();
		this.InsuredNo = aLCGCUWMasterSchema.getInsuredNo();
		this.InsuredName = aLCGCUWMasterSchema.getInsuredName();
		this.AppntNo = aLCGCUWMasterSchema.getAppntNo();
		this.AppntName = aLCGCUWMasterSchema.getAppntName();
		this.AgentCode = aLCGCUWMasterSchema.getAgentCode();
		this.AgentGroup = aLCGCUWMasterSchema.getAgentGroup();
		this.PassFlag = aLCGCUWMasterSchema.getPassFlag();
		this.UWGrade = aLCGCUWMasterSchema.getUWGrade();
		this.AppGrade = aLCGCUWMasterSchema.getAppGrade();
		this.PostponeDay = aLCGCUWMasterSchema.getPostponeDay();
		this.PostponeDate = fDate.getDate( aLCGCUWMasterSchema.getPostponeDate());
		this.AutoUWFlag = aLCGCUWMasterSchema.getAutoUWFlag();
		this.State = aLCGCUWMasterSchema.getState();
		this.ManageCom = aLCGCUWMasterSchema.getManageCom();
		this.UWIdea = aLCGCUWMasterSchema.getUWIdea();
		this.UpReportContent = aLCGCUWMasterSchema.getUpReportContent();
		this.Operator = aLCGCUWMasterSchema.getOperator();
		this.HealthFlag = aLCGCUWMasterSchema.getHealthFlag();
		this.QuesFlag = aLCGCUWMasterSchema.getQuesFlag();
		this.SpecFlag = aLCGCUWMasterSchema.getSpecFlag();
		this.AddPremFlag = aLCGCUWMasterSchema.getAddPremFlag();
		this.AddPremReason = aLCGCUWMasterSchema.getAddPremReason();
		this.ReportFlag = aLCGCUWMasterSchema.getReportFlag();
		this.PrintFlag = aLCGCUWMasterSchema.getPrintFlag();
		this.PrintFlag2 = aLCGCUWMasterSchema.getPrintFlag2();
		this.ChangePolFlag = aLCGCUWMasterSchema.getChangePolFlag();
		this.ChangePolReason = aLCGCUWMasterSchema.getChangePolReason();
		this.SpecReason = aLCGCUWMasterSchema.getSpecReason();
		this.MakeDate = fDate.getDate( aLCGCUWMasterSchema.getMakeDate());
		this.MakeTime = aLCGCUWMasterSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLCGCUWMasterSchema.getModifyDate());
		this.ModifyTime = aLCGCUWMasterSchema.getModifyTime();
		this.UpReport = aLCGCUWMasterSchema.getUpReport();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LCGCUWMaster表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LCGCUWMasterSchema";
	...
	public LCGCUWMasterSchema getSchema()
	{
		LCGCUWMasterSchema aLCGCUWMasterSchema = new LCGCUWMasterSchema();
		aLCGCUWMasterSchema.setSchema(this);
		return aLCGCUWMasterSchema;
	}

	public LCGCUWMasterDB getDB()
	{
		LCGCUWMasterDB aDBOper = new LCGCUWMasterDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLCGCUWMaster描述/A>表字段
	...
	**/
	public String encode()
	{
		...
		strReturn.append(StrTool.cTrim(UpReport));
		return strReturn.toString();
	}

	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLCGCUWMaster>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			InsuredName = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 5, SysConst.PACKAGESPILTER );
			...
			PassFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 10, SysConst.PACKAGESPILTER );
			UWGrade = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 11, SysConst.PACKAGESPILTER );
			AppGrade = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 12, SysConst.PACKAGESPILTER );
			PostponeDay = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 13, SysConst.PACKAGESPILTER );
			PostponeDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 14,SysConst.PACKAGESPILTER));
			AutoUWFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 15, SysConst.PACKAGESPILTER );
			...
			UWIdea = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 18, SysConst.PACKAGESPILTER );
			UpReportContent = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 19, SysConst.PACKAGESPILTER );
			Operator = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 20, SysConst.PACKAGESPILTER );
			HealthFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 21, SysConst.PACKAGESPILTER );
			QuesFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 22, SysConst.PACKAGESPILTER );
			SpecFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 23, SysConst.PACKAGESPILTER );
			AddPremFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 24, SysConst.PACKAGESPILTER );
			AddPremReason = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 25, SysConst.PACKAGESPILTER );
			ReportFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 26, SysConst.PACKAGESPILTER );
			PrintFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 27, SysConst.PACKAGESPILTER );
			PrintFlag2 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 28, SysConst.PACKAGESPILTER );
			ChangePolFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 29, SysConst.PACKAGESPILTER );
			ChangePolReason = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 30, SysConst.PACKAGESPILTER );
			SpecReason = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 31, SysConst.PACKAGESPILTER );
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LCGCUWMasterSchema other = (LCGCUWMasterSchema)otherObject;
		return
