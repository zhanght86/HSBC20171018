...
/*
 * <p>ClassName: LCGUWSubSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 承保流程
 */
public class LCGUWSubSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LCGUWSubSchema.class);
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LCGUWSubSchema cloned = (LCGUWSubSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LCGUWSubSchema 对象给 Schema 赋值
	* @param: aLCGUWSubSchema LCGUWSubSchema
	**/
	public void setSchema(LCGUWSubSchema aLCGUWSubSchema)
	{
		this.GrpContNo = aLCGUWSubSchema.getGrpContNo();
		this.ProposalGrpContNo = aLCGUWSubSchema.getProposalGrpContNo();
		this.GrpPolNo = aLCGUWSubSchema.getGrpPolNo();
		this.GrpProposalNo = aLCGUWSubSchema.getGrpProposalNo();
		this.UWNo = aLCGUWSubSchema.getUWNo();
		this.InsuredNo = aLCGUWSubSchema.getInsuredNo();
		this.InsuredName = aLCGUWSubSchema.getInsuredName();
		this.AppntNo = aLCGUWSubSchema.getAppntNo();
		this.AppntName = aLCGUWSubSchema.getAppntName();
		this.AgentCode = aLCGUWSubSchema.getAgentCode();
		this.AgentGroup = aLCGUWSubSchema.getAgentGroup();
		this.PassFlag = aLCGUWSubSchema.getPassFlag();
		this.UWGrade = aLCGUWSubSchema.getUWGrade();
		this.AppGrade = aLCGUWSubSchema.getAppGrade();
		this.PostponeDay = aLCGUWSubSchema.getPostponeDay();
		this.PostponeDate = fDate.getDate( aLCGUWSubSchema.getPostponeDate());
		this.AutoUWFlag = aLCGUWSubSchema.getAutoUWFlag();
		this.State = aLCGUWSubSchema.getState();
		this.ManageCom = aLCGUWSubSchema.getManageCom();
		this.UWIdea = aLCGUWSubSchema.getUWIdea();
		this.UpReportContent = aLCGUWSubSchema.getUpReportContent();
		this.Operator = aLCGUWSubSchema.getOperator();
		this.HealthFlag = aLCGUWSubSchema.getHealthFlag();
		this.QuesFlag = aLCGUWSubSchema.getQuesFlag();
		this.SpecFlag = aLCGUWSubSchema.getSpecFlag();
		this.AddPremFlag = aLCGUWSubSchema.getAddPremFlag();
		this.AddPremReason = aLCGUWSubSchema.getAddPremReason();
		this.ReportFlag = aLCGUWSubSchema.getReportFlag();
		this.PrintFlag = aLCGUWSubSchema.getPrintFlag();
		this.PrintFlag2 = aLCGUWSubSchema.getPrintFlag2();
		this.ChangePolFlag = aLCGUWSubSchema.getChangePolFlag();
		this.ChangePolReason = aLCGUWSubSchema.getChangePolReason();
		this.SpecReason = aLCGUWSubSchema.getSpecReason();
		this.MakeDate = fDate.getDate( aLCGUWSubSchema.getMakeDate());
		this.MakeTime = aLCGUWSubSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLCGUWSubSchema.getModifyDate());
		this.ModifyTime = aLCGUWSubSchema.getModifyTime();
		this.UpReport = aLCGUWSubSchema.getUpReport();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LCGUWSub表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LCGUWSubSchema";
	...
	public LCGUWSubSchema getSchema()
	{
		LCGUWSubSchema aLCGUWSubSchema = new LCGUWSubSchema();
		aLCGUWSubSchema.setSchema(this);
		return aLCGUWSubSchema;
	}

	public LCGUWSubDB getDB()
	{
		LCGUWSubDB aDBOper = new LCGUWSubDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLCGUWSub描述/A>表字段
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLCGUWSub>历史记账凭证主表信息</A>表字段
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LCGUWSubSchema other = (LCGUWSubSchema)otherObject;
		return
