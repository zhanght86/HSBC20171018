...
/*
 * <p>ClassName: LOBGrpEdorItemDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 多币种改造业务表
 */
public class LOBGrpEdorItemDBSet extends LOBGrpEdorItemSet
{
private static Logger logger = Logger.getLogger(LOBGrpEdorItemDBSet.class);
	...
	**/
	...
	// @Constructor
	public LOBGrpEdorItemDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LOBGrpEdorItemDBSet";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getEdorTypeCal() == null || this.get(i).getEdorTypeCal().equals("null")) {
				...
				pstmt.setString(33, this.get(i).getEdorTypeCal());
			}
			...
			if(this.get(i).getEdorAcceptNo() == null || this.get(i).getEdorAcceptNo().equals("null")) {
				...
				pstmt.setString(35, this.get(i).getEdorAcceptNo());
			}
			if(this.get(i).getEdorNo() == null || this.get(i).getEdorNo().equals("null")) {
