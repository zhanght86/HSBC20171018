...
import com.sinosoft.lis.db.LOBAccAscriptionDB;

/*
 * 与数据库结构不一致，暂不处理
 * <p>ClassName: LOBAccAscriptionSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: Physical Data Model 1
 */
public class LOBAccAscriptionSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LOBAccAscriptionSchema.class);
	// @Field
	/** 业务类型 */
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LOBAccAscriptionSchema cloned = (LOBAccAscriptionSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LOBAccAscriptionSchema 对象给 Schema 赋值
	* @param: aLOBAccAscriptionSchema LOBAccAscriptionSchema
	**/
	public void setSchema(LOBAccAscriptionSchema aLOBAccAscriptionSchema)
	{
		this.BussType = aLOBAccAscriptionSchema.getBussType();
		this.BussNo = aLOBAccAscriptionSchema.getBussNo();
		this.SerialNo = aLOBAccAscriptionSchema.getSerialNo();
		this.GrpContNo = aLOBAccAscriptionSchema.getGrpContNo();
		this.RiskCode = aLOBAccAscriptionSchema.getRiskCode();
		this.GrpPolNo = aLOBAccAscriptionSchema.getGrpPolNo();
		this.RuleType = aLOBAccAscriptionSchema.getRuleType();
		this.PositionCode = aLOBAccAscriptionSchema.getPositionCode();
		this.StartYears = aLOBAccAscriptionSchema.getStartYears();
		this.EndYears = aLOBAccAscriptionSchema.getEndYears();
		this.Rate = aLOBAccAscriptionSchema.getRate();
		this.Segment1 = aLOBAccAscriptionSchema.getSegment1();
		this.Segment2 = aLOBAccAscriptionSchema.getSegment2();
		this.Segment3 = aLOBAccAscriptionSchema.getSegment3();
		this.MakeOperator = aLOBAccAscriptionSchema.getMakeOperator();
		this.MakeDate = fDate.getDate( aLOBAccAscriptionSchema.getMakeDate());
		this.MakeTime = aLOBAccAscriptionSchema.getMakeTime();
		this.ModifyOperator = aLOBAccAscriptionSchema.getModifyOperator();
		this.ModifyDate = fDate.getDate( aLOBAccAscriptionSchema.getModifyDate());
		this.ModifyTime = aLOBAccAscriptionSchema.getModifyTime();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LOBAccAscription表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LOBAccAscriptionSchema";
	...
	public LOBAccAscriptionSchema getSchema()
	{
		LOBAccAscriptionSchema aLOBAccAscriptionSchema = new LOBAccAscriptionSchema();
		aLOBAccAscriptionSchema.setSchema(this);
		return aLOBAccAscriptionSchema;
	}

	public LOBAccAscriptionDB getDB()
	{
		LOBAccAscriptionDB aDBOper = new LOBAccAscriptionDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLOBAccAscription描述/A>表字段
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLOBAccAscription>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			RuleType = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 7, SysConst.PACKAGESPILTER );
			PositionCode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 8, SysConst.PACKAGESPILTER );
			StartYears= new Integer(ChgData.chgNumericStr(StrTool.getStr(strMessage,9,SysConst.PACKAGESPILTER))).intValue();
			EndYears= new Integer(ChgData.chgNumericStr(StrTool.getStr(strMessage,10,SysConst.PACKAGESPILTER))).intValue();
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LOBAccAscriptionSchema other = (LOBAccAscriptionSchema)otherObject;
		return
