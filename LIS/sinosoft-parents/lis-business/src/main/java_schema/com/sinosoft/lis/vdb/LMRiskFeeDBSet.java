...
/*
 * <p>ClassName: LMRiskFeeDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 管理费描述
 */
public class LMRiskFeeDBSet extends LMRiskFeeSet
{
	// @Field
	...
	**/
	...
	// @Constructor
	public LMRiskFeeDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LMRiskFeeDBSet";
...
ex.printStackTrace();
	...
	public boolean update()
	{
		...
		try
		{
			...
			pstmt.setInt(24, this.get(i).getFeeNum());
			...
			if(this.get(i).getFeeType() == null || this.get(i).getFeeType().equals("null")) {
				...
				pstmt.setString(27, this.get(i).getFeeType());
			}
			if(this.get(i).getPeriodType() == null || this.get(i).getPeriodType().equals("null")) {
				pstmt.setString(28,null);
			} else {
				pstmt.setString(28, this.get(i).getPeriodType());
			}
			...
			if(this.get(i).getFeeCalMode() == null || this.get(i).getFeeCalMode().equals("null")) {
				...
				pstmt.setString(33, this.get(i).getFeeCalMode());
			}
