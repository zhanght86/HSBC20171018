...
/*
 * <p>ClassName: LSQuotPubAmntRelaDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: Physical Data Model 1
 */
public class LSQuotPubAmntRelaDBSet extends LSQuotPubAmntRelaSet
{
	// @Field
	...
	**/
	...
	// @Constructor
	public LSQuotPubAmntRelaDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LSQuotPubAmntRelaDBSet";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getLimitAmnt() == null || this.get(i).getLimitAmnt().equals("null")) {
				...
				pstmt.setString(5, this.get(i).getLimitAmnt());
			}
			...
			pstmt.setInt(13, this.get(i).getQuotBatNo());
			if(this.get(i).getSysPlanCode() == null || this.get(i).getSysPlanCode().equals("null")) {
				pstmt.setString(14,null);
			} else {
				pstmt.setString(14, this.get(i).getSysPlanCode());
			}
			if(this.get(i).getPlanCode() == null || this.get(i).getPlanCode().equals("null")) {
				pstmt.setString(15,null);
			} else {
				pstmt.setString(15, this.get(i).getPlanCode());
			}
