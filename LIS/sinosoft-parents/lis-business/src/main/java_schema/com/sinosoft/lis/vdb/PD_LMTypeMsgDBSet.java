...
/*
 * <p>ClassName: PD_LMTypeMsgDBSet </p>
 ...
 */
public class PD_LMTypeMsgDBSet extends PD_LMTypeMsgSet
{
private static Logger logger = Logger.getLogger(PD_LMTypeMsgDBSet.class);
	...
	**/
	...
	// @Constructor
	public PD_LMTypeMsgDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "PD_LMTypeMsgDBSet";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getfileName() == null || this.get(i).getfileName().equals("null")) {
				...
				pstmt.setString(6, this.get(i).getfileName());
			}
