...
import com.sinosoft.lis.db.LPCustomerImpartDetailDB;

/*
 * <p>ClassName: LPCustomerImpartDetailSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 保全核心
 */
public class LPCustomerImpartDetailSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LPCustomerImpartDetailSchema.class);
	...
	// @Constructor
	public LPCustomerImpartDetailSchema()
	{
		mErrors = new CErrors();
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LPCustomerImpartDetailSchema cloned = (LPCustomerImpartDetailSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LPCustomerImpartDetailSchema 对象给 Schema 赋值
	* @param: aLPCustomerImpartDetailSchema LPCustomerImpartDetailSchema
	**/
	public void setSchema(LPCustomerImpartDetailSchema aLPCustomerImpartDetailSchema)
	{
		this.EdorNo = aLPCustomerImpartDetailSchema.getEdorNo();
		this.EdorType = aLPCustomerImpartDetailSchema.getEdorType();
		this.GrpContNo = aLPCustomerImpartDetailSchema.getGrpContNo();
		this.ContNo = aLPCustomerImpartDetailSchema.getContNo();
		this.ProposalContNo = aLPCustomerImpartDetailSchema.getProposalContNo();
		this.PrtNo = aLPCustomerImpartDetailSchema.getPrtNo();
		this.ImpartCode = aLPCustomerImpartDetailSchema.getImpartCode();
		this.ImpartVer = aLPCustomerImpartDetailSchema.getImpartVer();
		this.SubSerialNo = aLPCustomerImpartDetailSchema.getSubSerialNo();
		this.ImpartDetailContent = aLPCustomerImpartDetailSchema.getImpartDetailContent();
		this.StartDate = fDate.getDate( aLPCustomerImpartDetailSchema.getStartDate());
		this.EndDate = fDate.getDate( aLPCustomerImpartDetailSchema.getEndDate());
		this.Prover = aLPCustomerImpartDetailSchema.getProver();
		this.CurrCondition = aLPCustomerImpartDetailSchema.getCurrCondition();
		this.IsProved = aLPCustomerImpartDetailSchema.getIsProved();
		this.CustomerNo = aLPCustomerImpartDetailSchema.getCustomerNo();
		this.CustomerNoType = aLPCustomerImpartDetailSchema.getCustomerNoType();
		this.UWClaimFlg = aLPCustomerImpartDetailSchema.getUWClaimFlg();
		this.PrtFlag = aLPCustomerImpartDetailSchema.getPrtFlag();
		this.Operator = aLPCustomerImpartDetailSchema.getOperator();
		this.MakeDate = fDate.getDate( aLPCustomerImpartDetailSchema.getMakeDate());
		this.MakeTime = aLPCustomerImpartDetailSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLPCustomerImpartDetailSchema.getModifyDate());
		this.ModifyTime = aLPCustomerImpartDetailSchema.getModifyTime();
		this.PatchNo = aLPCustomerImpartDetailSchema.getPatchNo();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LPCustomerImpartDetail表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LPCustomerImpartDetailSchema";
	...
	public LPCustomerImpartDetailSchema getSchema()
	{
		LPCustomerImpartDetailSchema aLPCustomerImpartDetailSchema = new LPCustomerImpartDetailSchema();
		aLPCustomerImpartDetailSchema.setSchema(this);
		return aLPCustomerImpartDetailSchema;
	}

	public LPCustomerImpartDetailDB getDB()
	{
		LPCustomerImpartDetailDB aDBOper = new LPCustomerImpartDetailDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLPCustomerImpartDetail描述/A>表字段
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLPCustomerImpartDetail>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			SubSerialNo = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 9, SysConst.PACKAGESPILTER );
			ImpartDetailContent = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 10, SysConst.PACKAGESPILTER );
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LPCustomerImpartDetailSchema other = (LPCustomerImpartDetailSchema)otherObject;
		return
