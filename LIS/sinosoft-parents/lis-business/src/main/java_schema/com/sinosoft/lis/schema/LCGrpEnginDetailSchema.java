...
import com.sinosoft.lis.db.LCGrpEnginDetailDB;

/*
 * <p>ClassName: LCGrpEnginDetailSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: Physical Data Model 1
 */
public class LCGrpEnginDetailSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LCGrpEnginDetailSchema.class);
	// @Field
	/** 团体保单号 */
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LCGrpEnginDetailSchema cloned = (LCGrpEnginDetailSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LCGrpEnginDetailSchema 对象给 Schema 赋值
	* @param: aLCGrpEnginDetailSchema LCGrpEnginDetailSchema
	**/
	public void setSchema(LCGrpEnginDetailSchema aLCGrpEnginDetailSchema)
	{
		this.GrpContNo = aLCGrpEnginDetailSchema.getGrpContNo();
		this.GrpPropNo = aLCGrpEnginDetailSchema.getGrpPropNo();
		this.EnginCode = aLCGrpEnginDetailSchema.getEnginCode();
		this.OtherDesc = aLCGrpEnginDetailSchema.getOtherDesc();
		this.ManageCom = aLCGrpEnginDetailSchema.getManageCom();
		this.ComCode = aLCGrpEnginDetailSchema.getComCode();
		this.MakeOperator = aLCGrpEnginDetailSchema.getMakeOperator();
		this.MakeDate = fDate.getDate( aLCGrpEnginDetailSchema.getMakeDate());
		this.MakeTime = aLCGrpEnginDetailSchema.getMakeTime();
		this.ModifyOperator = aLCGrpEnginDetailSchema.getModifyOperator();
		this.ModifyDate = fDate.getDate( aLCGrpEnginDetailSchema.getModifyDate());
		this.ModifyTime = aLCGrpEnginDetailSchema.getModifyTime();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LCGrpEnginDetail表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LCGrpEnginDetailSchema";
	...
	public LCGrpEnginDetailSchema getSchema()
	{
		LCGrpEnginDetailSchema aLCGrpEnginDetailSchema = new LCGrpEnginDetailSchema();
		aLCGrpEnginDetailSchema.setSchema(this);
		return aLCGrpEnginDetailSchema;
	}

	public LCGrpEnginDetailDB getDB()
	{
		LCGrpEnginDetailDB aDBOper = new LCGrpEnginDetailDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLCGrpEnginDetail描述/A>表字段
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLCGrpEnginDetail>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			EnginCode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 3, SysConst.PACKAGESPILTER );
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LCGrpEnginDetailSchema other = (LCGrpEnginDetailSchema)otherObject;
		return
