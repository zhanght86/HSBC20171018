...
import com.sinosoft.lis.db.LPEdorPrint3DB;

/*
 * <p>ClassName: LPEdorPrint3Schema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 保全核心
 */
public class LPEdorPrint3Schema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LPEdorPrint3Schema.class);
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LPEdorPrint3Schema cloned = (LPEdorPrint3Schema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LPEdorPrint3Schema 对象给 Schema 赋值
	* @param: aLPEdorPrint3Schema LPEdorPrint3Schema
	**/
	public void setSchema(LPEdorPrint3Schema aLPEdorPrint3Schema)
	{
		this.EdorNo = aLPEdorPrint3Schema.getEdorNo();
		this.EdorType = aLPEdorPrint3Schema.getEdorType();
		this.PrtFlag = aLPEdorPrint3Schema.getPrtFlag();
		this.PrtTimes = aLPEdorPrint3Schema.getPrtTimes();
		this.ManageCom = aLPEdorPrint3Schema.getManageCom();
		this.Operator = aLPEdorPrint3Schema.getOperator();
		this.MakeDate = fDate.getDate( aLPEdorPrint3Schema.getMakeDate());
		this.MakeTime = aLPEdorPrint3Schema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLPEdorPrint3Schema.getModifyDate());
		this.ModifyTime = aLPEdorPrint3Schema.getModifyTime();
		this.EdorInfo = aLPEdorPrint3Schema.getEdorInfo();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LPEdorPrint3表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LPEdorPrint3Schema";
	...
	public LPEdorPrint3Schema getSchema()
	{
		LPEdorPrint3Schema aLPEdorPrint3Schema = new LPEdorPrint3Schema();
		aLPEdorPrint3Schema.setSchema(this);
		return aLPEdorPrint3Schema;
	}

	public LPEdorPrint3DB getDB()
	{
		LPEdorPrint3DB aDBOper = new LPEdorPrint3DB();
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLPEdorPrint3>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			PrtFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 3, SysConst.PACKAGESPILTER );
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LPEdorPrint3Schema other = (LPEdorPrint3Schema)otherObject;
		return
