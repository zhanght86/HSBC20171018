...
/*
 * <p>ClassName: LCAddPolSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 寿险业务系统lis5模型
 */
public class LCAddPolSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LCAddPolSchema.class);
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LCAddPolSchema cloned = (LCAddPolSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LCAddPolSchema 对象给 Schema 赋值
	* @param: aLCAddPolSchema LCAddPolSchema
	**/
	public void setSchema(LCAddPolSchema aLCAddPolSchema)
	{
		this.MainPolNo = aLCAddPolSchema.getMainPolNo();
		this.SerialNo = aLCAddPolSchema.getSerialNo();
		this.PrtNo = aLCAddPolSchema.getPrtNo();
		this.ManageCom = aLCAddPolSchema.getManageCom();
		this.Remark = aLCAddPolSchema.getRemark();
		this.InputState = aLCAddPolSchema.getInputState();
		this.InputOperator = aLCAddPolSchema.getInputOperator();
		this.InputDate = fDate.getDate( aLCAddPolSchema.getInputDate());
		this.InputTime = aLCAddPolSchema.getInputTime();
		this.Operator = aLCAddPolSchema.getOperator();
		this.MakeDate = fDate.getDate( aLCAddPolSchema.getMakeDate());
		this.MakeTime = aLCAddPolSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLCAddPolSchema.getModifyDate());
		this.ModifyTime = aLCAddPolSchema.getModifyTime();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LCAddPol表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LCAddPolSchema";
	...
	public LCAddPolSchema getSchema()
	{
		LCAddPolSchema aLCAddPolSchema = new LCAddPolSchema();
		aLCAddPolSchema.setSchema(this);
		return aLCAddPolSchema;
	}

	public LCAddPolDB getDB()
	{
		LCAddPolDB aDBOper = new LCAddPolDB();
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLCAddPol>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			InputState = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 6, SysConst.PACKAGESPILTER );
			InputOperator = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 7, SysConst.PACKAGESPILTER );
			InputDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 8,SysConst.PACKAGESPILTER));
			InputTime = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 9, SysConst.PACKAGESPILTER );
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LCAddPolSchema other = (LCAddPolSchema)otherObject;
		return
