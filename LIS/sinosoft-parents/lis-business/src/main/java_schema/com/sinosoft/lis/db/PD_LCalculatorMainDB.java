...
/*
 * <p>ClassName: PD_LCalculatorMainDB </p>
 * <p>Description: DB层数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 累加器
 */
public class PD_LCalculatorMainDB extends PD_LCalculatorMainSchema
{
	private static Logger logger = Logger.getLogger(PD_LCalculatorMainDB.class);
	// @Field
	...
	**/
	...
	// @Constructor
	public PD_LCalculatorMainDB( Connection tConnection )
	{
		con = tConnection;
	...
	{
		PD_LCalculatorMainSchema tSchema = this.getSchema();
		...
		else
		{
			...
			tError.moduleName = "PD_LCalculatorMainDB";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.getCalculatorCode() == null || this.getCalculatorCode().equals("null")) {
				...
				pstmt.setString(18, this.getCalculatorCode());
			}
			pstmt.executeUpdate();
			pstmt.close();
		} catch (Exception ex) {
	...
	public boolean getInfo()
	{
		...
		try
		{
			pstmt = con.prepareStatement("SELECT * FROM PD_LCalculatorMain WHERE  CalculatorCode = ?", 
	...
	public PD_LCalculatorMainSet query()
	{
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		PD_LCalculatorMainSet aPD_LCalculatorMainSet = new PD_LCalculatorMainSet();
	  ...
	  if( !mflag ) {
		...
		{
			SQLString sqlObj = new SQLString("PD_LCalculatorMain");
			PD_LCalculatorMainSchema aSchema = this.getSchema();
			...
			{
				i++;
				PD_LCalculatorMainSchema s1 = new PD_LCalculatorMainSchema();
				s1.setSchema(rs,i);
				aPD_LCalculatorMainSet.add(s1);
			}
			try{ rs.close(); } catch( Exception ex ) {}
			try{ pstmt.close(); } catch( Exception ex1 ) {}
		}
		...
		return aPD_LCalculatorMainSet;
	}

	public PD_LCalculatorMainSet executeQuery(String sql)
	{
		Statement stmt = null;
		ResultSet rs = null;
		PD_LCalculatorMainSet aPD_LCalculatorMainSet = new PD_LCalculatorMainSet();
	...
	public PD_LCalculatorMainSet query(int nStart, int nCount)
	{
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		PD_LCalculatorMainSet aPD_LCalculatorMainSet = new PD_LCalculatorMainSet();
	...
	public PD_LCalculatorMainSet executeQuery(String sql, int nStart, int nCount)
	{
		Statement stmt = null;
		ResultSet rs = null;
		PD_LCalculatorMainSet aPD_LCalculatorMainSet = new PD_LCalculatorMainSet();
	...
	public boolean update(String strWherePart)
	{
	  ...
	  if( !mflag ) {
		...
		try
		{
			...
			String sql = "update PD_LCalculatorMain " + sqlObj.getUpdPart() + " where " + strWherePart;
...
/**
 * 获取定量数据
 * @return PD_LCalculatorMainSet
 */
public PD_LCalculatorMainSet getData()
{
    int tCount = 0;
    PD_LCalculatorMainSet tPD_LCalculatorMainSet = new PD_LCalculatorMainSet();
    PD_LCalculatorMainSchema tPD_LCalculatorMainSchema = null;
    if (null == mResultSet)
    {
        CError tError = new CError();
        tError.moduleName = "PD_LCalculatorMainDB";
    ...
    try
    {
        ...
        tPD_LCalculatorMainSchema.setSchema(mResultSet, 1);
...
public boolean closeData()
{
	...
	public PD_LCalculatorMainSet executeQuery(SQLwithBindVariables sqlbv) {
		PreparedStatement pstmt = null;
		ResultSet rs = null;
	...
	public PD_LCalculatorMainSet executeQuery(SQLwithBindVariables sqlbv, int nStart, int nCount) {
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		logger.debug("ExecSQLwithBV SQL: " + sqlbv.originalSql());
		for(String key : sqlbv.variableKey())
