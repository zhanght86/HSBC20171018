...
/*
 * <p>ClassName: LPUWSubMainDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 保全流程
 */
public class LPUWSubMainDBSet extends LPUWSubMainSet
{
private static Logger logger = Logger.getLogger(LPUWSubMainDBSet.class);
	...
	**/
	...
	// @Constructor
	public LPUWSubMainDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LPUWSubMainDBSet";
