...
/*
 * <p>ClassName: LLBalanceDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 理赔管理
 */
public class LLBalanceDBSet extends LLBalanceSet
{
	// @Field
	...
	**/
	...
	// @Constructor
	public LLBalanceDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LLBalanceDBSet";
	...
	public boolean delete()
	{
		...
		try
		{
			...
			if(this.get(i).getBatNo() == null || this.get(i).getBatNo().equals("null")) {
				...
				pstmt.setString(5, this.get(i).getBatNo());
			}
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getKindCode() == null || this.get(i).getKindCode().equals("null")) {
				...
				pstmt.setString(16, this.get(i).getKindCode());
			}
			...
			if(this.get(i).getRiskVersion() == null || this.get(i).getRiskVersion().equals("null")) {
				...
				pstmt.setString(18, this.get(i).getRiskVersion());
			}
			...
			if(this.get(i).getGetDate() == null || this.get(i).getGetDate().equals("null")) {
				...
				pstmt.setDate(21, Date.valueOf(this.get(i).getGetDate()));
			}
			pstmt.setDouble(22, this.get(i).getPay());
			if(this.get(i).getPayFlag() == null || this.get(i).getPayFlag().equals("null")) {
				pstmt.setString(23,null);
			} else {
				pstmt.setString(23, this.get(i).getPayFlag());
			}
			...
			if(this.get(i).getDealFlag() == null || this.get(i).getDealFlag().equals("null")) {
				...
				pstmt.setString(25, this.get(i).getDealFlag());
			}
			...
			if(this.get(i).getAgentCom() == null || this.get(i).getAgentCom().equals("null")) {
				...
				pstmt.setString(27, this.get(i).getAgentCom());
			}
			if(this.get(i).getAgentType() == null || this.get(i).getAgentType().equals("null")) {
				pstmt.setString(28,null);
			} else {
				pstmt.setString(28, this.get(i).getAgentType());
			}
			...
			if(this.get(i).getModifyOperator() == null || this.get(i).getModifyOperator().equals("null")) {
				...
				pstmt.setString(42, this.get(i).getModifyOperator());
			}
			// set where condition
			if(this.get(i).getClmNo() == null || this.get(i).getClmNo().equals("null")) {
			...
			if(this.get(i).getFeeOperationType() == null || this.get(i).getFeeOperationType().equals("null")) {
				...
				pstmt.setString(44, this.get(i).getFeeOperationType());
			}
			if(this.get(i).getSubFeeOperationType() == null || this.get(i).getSubFeeOperationType().equals("null")) {
				pstmt.setString(45,null);
			} else {
				pstmt.setString(45, this.get(i).getSubFeeOperationType());
			}
			if(this.get(i).getFeeFinaType() == null || this.get(i).getFeeFinaType().equals("null")) {
				pstmt.setString(46,null);
			} else {
				pstmt.setString(46, this.get(i).getFeeFinaType());
			}
			if(this.get(i).getBatNo() == null || this.get(i).getBatNo().equals("null")) {
