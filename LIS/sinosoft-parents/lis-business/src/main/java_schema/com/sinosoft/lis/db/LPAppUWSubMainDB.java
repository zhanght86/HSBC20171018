...
/*
 * <p>ClassName: LPAppUWSubMainDB </p>
 * <p>Description: DB层数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 保全流程
 */
public class LPAppUWSubMainDB extends LPAppUWSubMainSchema
{
private static Logger logger = Logger.getLogger(LPAppUWSubMainDB.class);
	...
	**/
	...
	// @Constructor
	public LPAppUWSubMainDB( Connection tConnection )
	{
		con = tConnection;
	...
	{
		LPAppUWSubMainSchema tSchema = this.getSchema();
		...
		else
		{
			...
			tError.moduleName = "LPAppUWSubMainDB";
	...
	public boolean getInfo()
	{
		...
		try
		{
			pstmt = con.prepareStatement("SELECT * FROM LPAppUWSubMain WHERE  EdorAcceptNo = ? AND UWNo = ?", 
	...
	public LPAppUWSubMainSet query()
	{
		PreparedStatement pstmt = null;
 		ResultSet rs = null;
		LPAppUWSubMainSet aLPAppUWSubMainSet = new LPAppUWSubMainSet();
	  ...
	  if( !mflag ) {
		...
		{
			SQLString sqlObj = new SQLString("LPAppUWSubMain");
			LPAppUWSubMainSchema aSchema = this.getSchema();
			...
			{
				i++;
				LPAppUWSubMainSchema s1 = new LPAppUWSubMainSchema();
				s1.setSchema(rs,i);
				aLPAppUWSubMainSet.add(s1);
			}
			try{ rs.close(); } catch( Exception ex ) {}
			try{ pstmt.close(); } catch( Exception ex1 ) {}
		}
		...
		return aLPAppUWSubMainSet;

	}

	public LPAppUWSubMainSet executeQuery(String sql)
	{
		Statement stmt = null;
		ResultSet rs = null;
		LPAppUWSubMainSet aLPAppUWSubMainSet = new LPAppUWSubMainSet();
	...
	public LPAppUWSubMainSet query(int nStart, int nCount)
	{
		PreparedStatement pstmt = null;
 		ResultSet rs = null;
		LPAppUWSubMainSet aLPAppUWSubMainSet = new LPAppUWSubMainSet();
	...
	public LPAppUWSubMainSet executeQuery(String sql, int nStart, int nCount)
	{
		Statement stmt = null;
		ResultSet rs = null;
		LPAppUWSubMainSet aLPAppUWSubMainSet = new LPAppUWSubMainSet();
	...
	public boolean update(String strWherePart)
	{
	  ...
	  if( !mflag ) {
		...
		try
		{
			...
			String sql = "update LPAppUWSubMain " + sqlObj.getUpdPart() + " where " + strWherePart;
...
/**
 * 获取定量数据
 * @return LPAppUWSubMainSet
 */
public LPAppUWSubMainSet getData()
{
    int tCount = 0;
    LPAppUWSubMainSet tLPAppUWSubMainSet = new LPAppUWSubMainSet();
    LPAppUWSubMainSchema tLPAppUWSubMainSchema = null;
    if (null == mResultSet)
    {
        CError tError = new CError();
        tError.moduleName = "LPAppUWSubMainDB";
    ...
    {
        tCount = 1;
        tLPAppUWSubMainSchema = new LPAppUWSubMainSchema();
        tLPAppUWSubMainSchema.setSchema(mResultSet, 1);
        tLPAppUWSubMainSet.add(tLPAppUWSubMainSchema);
...
public boolean closeData()
{
	...
	public LPAppUWSubMainSet executeQuery(SQLwithBindVariables sqlbv) {
	...
	public LPAppUWSubMainSet executeQuery(SQLwithBindVariables sqlbv, int nStart, int nCount) {
