...
/*
 * <p>ClassName: RIGrpStateSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 再保系统模型
 */
public class RIGrpStateSchema implements Schema, Cloneable
{
	// @Field
	/** 序列号 */
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		RIGrpStateSchema cloned = (RIGrpStateSchema)super.clone();
	...
	*/
	...
	public void setExetype(String aExetype)
	{
		Exetype = aExetype;
	}
	...
	/**
	* 使用另外一个 RIGrpStateSchema 对象给 Schema 赋值
	* @param: aRIGrpStateSchema RIGrpStateSchema
	**/
	public void setSchema(RIGrpStateSchema aRIGrpStateSchema)
	{
		this.SerialNo = aRIGrpStateSchema.getSerialNo();
		this.ProposalGrpContNo = aRIGrpStateSchema.getProposalGrpContNo();
		this.ProposalContNo = aRIGrpStateSchema.getProposalContNo();
		this.CaseNo = aRIGrpStateSchema.getCaseNo();
		this.State = aRIGrpStateSchema.getState();
		this.Exetype = aRIGrpStateSchema.getExetype();
		this.StandbyString1 = aRIGrpStateSchema.getStandbyString1();
		this.StandbyString2 = aRIGrpStateSchema.getStandbyString2();
		this.Operator = aRIGrpStateSchema.getOperator();
		this.MakeDate = fDate.getDate( aRIGrpStateSchema.getMakeDate());
		this.MakeTime = aRIGrpStateSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aRIGrpStateSchema.getModifyDate());
		this.ModifyTime = aRIGrpStateSchema.getModifyTime();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		try
		{
			...
			if( rs.getString("Exetype") == null )
				this.Exetype = null;
			else
				this.Exetype = rs.getString("Exetype").trim();
		...
		{
			System.out.println("数据库中的RIGrpState表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "RIGrpStateSchema";
	...
	public RIGrpStateSchema getSchema()
	{
		RIGrpStateSchema aRIGrpStateSchema = new RIGrpStateSchema();
		aRIGrpStateSchema.setSchema(this);
		return aRIGrpStateSchema;
	}

	public RIGrpStateDB getDB()
	{
		RIGrpStateDB aDBOper = new RIGrpStateDB();
	...
	**/
	public String encode()
	{
		...
		strReturn.append(StrTool.cTrim(Exetype)); strReturn.append(SysConst.PACKAGESPILTER);
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpRIGrpState>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			Exetype = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 6, SysConst.PACKAGESPILTER );
	...
	**/
	public String getV(String FCode)
	{
		...
		if (FCode.equalsIgnoreCase("Exetype"))
		{
			strReturn = StrTool.GBKToUnicode(String.valueOf(Exetype));
		}
	...
	public String getV(int nFieldIndex)
	{
		...
		switch(nFieldIndex) {
			...
			case 4:
				...
				break;
			case 5:
				strFieldValue = StrTool.GBKToUnicode(Exetype);
				break;
			case 6:
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		RIGrpStateSchema other = (RIGrpStateSchema)otherObject;
		return
			...
			&& Exetype.equals(other.getExetype())
	...
	**/
	public int getFieldIndex(String strFieldName)
	{
		...
		if( strFieldName.equals("Exetype") ) {
			return 5;
		}
