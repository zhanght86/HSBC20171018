...
import com.sinosoft.lis.db.LCPositionDB;

/*
 * <p>ClassName: LCPositionSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: Physical Data Model 1
 */
public class LCPositionSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LCPositionSchema.class);
	// @Field
	/** 序号 */
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LCPositionSchema cloned = (LCPositionSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LCPositionSchema 对象给 Schema 赋值
	* @param: aLCPositionSchema LCPositionSchema
	**/
	public void setSchema(LCPositionSchema aLCPositionSchema)
	{
		this.SerialNo = aLCPositionSchema.getSerialNo();
		this.GrpContNo = aLCPositionSchema.getGrpContNo();
		this.RiskCode = aLCPositionSchema.getRiskCode();
		this.GrpPolNo = aLCPositionSchema.getGrpPolNo();
		this.PositionCode = aLCPositionSchema.getPositionCode();
		this.PositionCodeName = aLCPositionSchema.getPositionCodeName();
		this.CountType = aLCPositionSchema.getCountType();
		this.Segment1 = aLCPositionSchema.getSegment1();
		this.Segment2 = aLCPositionSchema.getSegment2();
		this.Segment3 = aLCPositionSchema.getSegment3();
		this.ManageCom = aLCPositionSchema.getManageCom();
		this.ComCode = aLCPositionSchema.getComCode();
		this.MakeOperator = aLCPositionSchema.getMakeOperator();
		this.MakeDate = fDate.getDate( aLCPositionSchema.getMakeDate());
		this.MakeTime = aLCPositionSchema.getMakeTime();
		this.ModifyOperator = aLCPositionSchema.getModifyOperator();
		this.ModifyDate = fDate.getDate( aLCPositionSchema.getModifyDate());
		this.ModifyTime = aLCPositionSchema.getModifyTime();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LCPosition表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LCPositionSchema";
	...
	public LCPositionSchema getSchema()
	{
		LCPositionSchema aLCPositionSchema = new LCPositionSchema();
		aLCPositionSchema.setSchema(this);
		return aLCPositionSchema;
	}

	public LCPositionDB getDB()
	{
		LCPositionDB aDBOper = new LCPositionDB();
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLCPosition>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			PositionCode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 5, SysConst.PACKAGESPILTER );
			PositionCodeName = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 6, SysConst.PACKAGESPILTER );
			CountType = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 7, SysConst.PACKAGESPILTER );
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LCPositionSchema other = (LCPositionSchema)otherObject;
		return
