...
/*
 * <p>ClassName: LLUWPENoticeDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 理赔管理
 */
public class LLUWPENoticeDBSet extends LLUWPENoticeSet
{
private static Logger logger = Logger.getLogger(LLUWPENoticeDBSet.class);
	...
	**/
	...
	// @Constructor
	public LLUWPENoticeDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LLUWPENoticeDBSet";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getBatNo() == null || this.get(i).getBatNo().equals("null")) {
				...
				pstmt.setString(33, this.get(i).getBatNo());
			}
			if(this.get(i).getContNo() == null || this.get(i).getContNo().equals("null")) {
			...
			if(this.get(i).getPrtSeq() == null || this.get(i).getPrtSeq().equals("null")) {
				...
				pstmt.setString(35, this.get(i).getPrtSeq());
			}
			if(this.get(i).getCustomerNo() == null || this.get(i).getCustomerNo().equals("null")) {
