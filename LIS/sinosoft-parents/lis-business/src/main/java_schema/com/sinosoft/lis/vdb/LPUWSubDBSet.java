...
/*
 * <p>ClassName: LPUWSubDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 保全流程
 */
public class LPUWSubDBSet extends LPUWSubSet
{
private static Logger logger = Logger.getLogger(LPUWSubDBSet.class);
	...
	**/
	...
	// @Constructor
	public LPUWSubDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LPUWSubDBSet";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getUWIdea() == null || this.get(i).getUWIdea().equals("null")) {
				...
				pstmt.setString(23, this.get(i).getUWIdea());
			}
			if(this.get(i).getUpReportContent() == null || this.get(i).getUpReportContent().equals("null")) {
				pstmt.setString(24,null);
			} else {
				pstmt.setString(24, this.get(i).getUpReportContent());
			}
			...
			if(this.get(i).getSugPassFlag() == null || this.get(i).getSugPassFlag().equals("null")) {
				...
				pstmt.setString(41, this.get(i).getSugPassFlag());
			}
			if(this.get(i).getSugUWIdea() == null || this.get(i).getSugUWIdea().equals("null")) {
				pstmt.setString(42,null);
			} else {
				pstmt.setString(42, this.get(i).getSugUWIdea());
			}
			// set where condition
			if(this.get(i).getEdorNo() == null || this.get(i).getEdorNo().equals("null")) {
