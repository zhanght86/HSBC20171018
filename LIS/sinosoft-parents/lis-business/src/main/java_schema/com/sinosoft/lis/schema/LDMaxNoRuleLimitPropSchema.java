...
/*
 * <p>ClassName: LDMaxNoRuleLimitPropSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 号段管理
 */
public class LDMaxNoRuleLimitPropSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LDMaxNoRuleLimitPropSchema.class);
	// @Field
	/** 号段编码 */
	...
	// @Constructor
	public LDMaxNoRuleLimitPropSchema()
	{
		mErrors = new CErrors();
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LDMaxNoRuleLimitPropSchema cloned = (LDMaxNoRuleLimitPropSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LDMaxNoRuleLimitPropSchema 对象给 Schema 赋值
	* @param: aLDMaxNoRuleLimitPropSchema LDMaxNoRuleLimitPropSchema
	**/
	public void setSchema(LDMaxNoRuleLimitPropSchema aLDMaxNoRuleLimitPropSchema)
	{
		this.NoCode = aLDMaxNoRuleLimitPropSchema.getNoCode();
		this.RuleCode = aLDMaxNoRuleLimitPropSchema.getRuleCode();
		this.PropCode = aLDMaxNoRuleLimitPropSchema.getPropCode();
		this.PropName = aLDMaxNoRuleLimitPropSchema.getPropName();
		this.PropValue = aLDMaxNoRuleLimitPropSchema.getPropValue();
		this.ModifyFlag = aLDMaxNoRuleLimitPropSchema.getModifyFlag();
		this.ShowFlag = aLDMaxNoRuleLimitPropSchema.getShowFlag();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LDMaxNoRuleLimitProp表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LDMaxNoRuleLimitPropSchema";
	...
	public LDMaxNoRuleLimitPropSchema getSchema()
	{
		LDMaxNoRuleLimitPropSchema aLDMaxNoRuleLimitPropSchema = new LDMaxNoRuleLimitPropSchema();
		aLDMaxNoRuleLimitPropSchema.setSchema(this);
		return aLDMaxNoRuleLimitPropSchema;
	}

	public LDMaxNoRuleLimitPropDB getDB()
	{
		LDMaxNoRuleLimitPropDB aDBOper = new LDMaxNoRuleLimitPropDB();
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLDMaxNoRuleLimitProp>历史记账凭证主表信息</A>表字段
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LDMaxNoRuleLimitPropSchema other = (LDMaxNoRuleLimitPropSchema)otherObject;
		return
