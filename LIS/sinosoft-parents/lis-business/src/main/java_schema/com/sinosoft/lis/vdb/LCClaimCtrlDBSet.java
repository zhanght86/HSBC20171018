...
/*
 * <p>ClassName: LCClaimCtrlDBSet </p>
 ...
 */
public class LCClaimCtrlDBSet extends LCClaimCtrlSet
{
private static Logger logger = Logger.getLogger(LCClaimCtrlDBSet.class);
	...
	**/
	...
	// @Constructor
	public LCClaimCtrlDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LCClaimCtrlDBSet";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getClaimCtrlCode() == null || this.get(i).getClaimCtrlCode().equals("null")) {
				...
				pstmt.setString(28, this.get(i).getClaimCtrlCode());
			}
