...
import com.sinosoft.lis.db.LOBCustomerAccountDB;

/*
 * 与数据库结构不一致，暂不处理
 * <p>ClassName: LOBCustomerAccountSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: Physical Data Model 1
 */
public class LOBCustomerAccountSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LOBCustomerAccountSchema.class);
	// @Field
	/** 业务类型 */
	...
	// @Constructor
	public LOBCustomerAccountSchema()
	{
		mErrors = new CErrors();
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LOBCustomerAccountSchema cloned = (LOBCustomerAccountSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LOBCustomerAccountSchema 对象给 Schema 赋值
	* @param: aLOBCustomerAccountSchema LOBCustomerAccountSchema
	**/
	public void setSchema(LOBCustomerAccountSchema aLOBCustomerAccountSchema)
	{
		this.BussType = aLOBCustomerAccountSchema.getBussType();
		this.BussNo = aLOBCustomerAccountSchema.getBussNo();
		this.PolicyNo = aLOBCustomerAccountSchema.getPolicyNo();
		this.CustomerType = aLOBCustomerAccountSchema.getCustomerType();
		this.CustomerNo = aLOBCustomerAccountSchema.getCustomerNo();
		this.AccKind = aLOBCustomerAccountSchema.getAccKind();
		this.BankCode = aLOBCustomerAccountSchema.getBankCode();
		this.BankAccNo = aLOBCustomerAccountSchema.getBankAccNo();
		this.AccName = aLOBCustomerAccountSchema.getAccName();
		this.FirstPayFlag = aLOBCustomerAccountSchema.getFirstPayFlag();
		this.GetFlag = aLOBCustomerAccountSchema.getGetFlag();
		this.PayType = aLOBCustomerAccountSchema.getPayType();
		this.State = aLOBCustomerAccountSchema.getState();
		this.Segment1 = aLOBCustomerAccountSchema.getSegment1();
		this.Segment2 = aLOBCustomerAccountSchema.getSegment2();
		this.Segment3 = aLOBCustomerAccountSchema.getSegment3();
		this.MakeOperator = aLOBCustomerAccountSchema.getMakeOperator();
		this.MakeDate = fDate.getDate( aLOBCustomerAccountSchema.getMakeDate());
		this.MakeTime = aLOBCustomerAccountSchema.getMakeTime();
		this.ModifyOperator = aLOBCustomerAccountSchema.getModifyOperator();
		this.ModifyDate = fDate.getDate( aLOBCustomerAccountSchema.getModifyDate());
		this.ModifyTime = aLOBCustomerAccountSchema.getModifyTime();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LOBCustomerAccount表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LOBCustomerAccountSchema";
	...
	public LOBCustomerAccountSchema getSchema()
	{
		LOBCustomerAccountSchema aLOBCustomerAccountSchema = new LOBCustomerAccountSchema();
		aLOBCustomerAccountSchema.setSchema(this);
		return aLOBCustomerAccountSchema;
	}

	public LOBCustomerAccountDB getDB()
	{
		LOBCustomerAccountDB aDBOper = new LOBCustomerAccountDB();
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLOBCustomerAccount>历史记账凭证主表信息</A>表字段
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LOBCustomerAccountSchema other = (LOBCustomerAccountSchema)otherObject;
		return
