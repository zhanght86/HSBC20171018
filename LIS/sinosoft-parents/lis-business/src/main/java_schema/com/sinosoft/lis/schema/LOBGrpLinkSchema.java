...
import com.sinosoft.lis.db.LOBGrpLinkDB;

/*
 *  与数据库结构不一致，暂不处理
 * <p>ClassName: LOBGrpLinkSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: Physical Data Model 1
 */
public class LOBGrpLinkSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LOBGrpLinkSchema.class);
	// @Field
	/** 业务类型 */
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LOBGrpLinkSchema cloned = (LOBGrpLinkSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LOBGrpLinkSchema 对象给 Schema 赋值
	* @param: aLOBGrpLinkSchema LOBGrpLinkSchema
	**/
	public void setSchema(LOBGrpLinkSchema aLOBGrpLinkSchema)
	{
		this.BussType = aLOBGrpLinkSchema.getBussType();
		this.BussNo = aLOBGrpLinkSchema.getBussNo();
		this.GrpContNo = aLOBGrpLinkSchema.getGrpContNo();
		this.GrpPropNo = aLOBGrpLinkSchema.getGrpPropNo();
		this.ContactNo = aLOBGrpLinkSchema.getContactNo();
		this.CustomerNo = aLOBGrpLinkSchema.getCustomerNo();
		this.LinkManFlag = aLOBGrpLinkSchema.getLinkManFlag();
		this.LinkMan = aLOBGrpLinkSchema.getLinkMan();
		this.Department = aLOBGrpLinkSchema.getDepartment();
		this.HeadShip = aLOBGrpLinkSchema.getHeadShip();
		this.MobilePhone = aLOBGrpLinkSchema.getMobilePhone();
		this.Phone = aLOBGrpLinkSchema.getPhone();
		this.Fax = aLOBGrpLinkSchema.getFax();
		this.EMail = aLOBGrpLinkSchema.getEMail();
		this.IDType = aLOBGrpLinkSchema.getIDType();
		this.IDNo = aLOBGrpLinkSchema.getIDNo();
		this.IDStartDate = fDate.getDate( aLOBGrpLinkSchema.getIDStartDate());
		this.IDEndDate = fDate.getDate( aLOBGrpLinkSchema.getIDEndDate());
		this.MakeOperator = aLOBGrpLinkSchema.getMakeOperator();
		this.MakeDate = fDate.getDate( aLOBGrpLinkSchema.getMakeDate());
		this.MakeTime = aLOBGrpLinkSchema.getMakeTime();
		this.ModifyOperator = aLOBGrpLinkSchema.getModifyOperator();
		this.ModifyDate = fDate.getDate( aLOBGrpLinkSchema.getModifyDate());
		this.ModifyTime = aLOBGrpLinkSchema.getModifyTime();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LOBGrpLink表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LOBGrpLinkSchema";
	...
	public LOBGrpLinkSchema getSchema()
	{
		LOBGrpLinkSchema aLOBGrpLinkSchema = new LOBGrpLinkSchema();
		aLOBGrpLinkSchema.setSchema(this);
		return aLOBGrpLinkSchema;
	}

	public LOBGrpLinkDB getDB()
	{
		LOBGrpLinkDB aDBOper = new LOBGrpLinkDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLOBGrpLink描述/A>表字段
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLOBGrpLink>历史记账凭证主表信息</A>表字段
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LOBGrpLinkSchema other = (LOBGrpLinkSchema)otherObject;
		return
