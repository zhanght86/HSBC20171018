...
/*
 * <p>ClassName: LLBExemptDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 理赔管理
 */
public class LLBExemptDBSet extends LLBExemptSet
{
private static Logger logger = Logger.getLogger(LLBExemptDBSet.class);
	...
	**/
	...
	// @Constructor
	public LLBExemptDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LLBExemptDBSet";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getExemptPeriod() == null || this.get(i).getExemptPeriod().equals("null")) {
				...
				pstmt.setString(35, this.get(i).getExemptPeriod());
			}
			...
			if(this.get(i).getExemptReason() == null || this.get(i).getExemptReason().equals("null")) {
				...
				pstmt.setString(37, this.get(i).getExemptReason());
			}
			if(this.get(i).getExemptDesc() == null || this.get(i).getExemptDesc().equals("null")) {
				pstmt.setString(38,null);
			} else {
				pstmt.setString(38, this.get(i).getExemptDesc());
			}
			// set where condition
			if(this.get(i).getBackNo() == null || this.get(i).getBackNo().equals("null")) {
				pstmt.setString(39,null);
			} else {
				pstmt.setString(39, this.get(i).getBackNo());
			}
			if(this.get(i).getClmNo() == null || this.get(i).getClmNo().equals("null")) {
