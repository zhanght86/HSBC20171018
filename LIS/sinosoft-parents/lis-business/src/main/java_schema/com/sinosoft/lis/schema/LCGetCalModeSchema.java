...
import com.sinosoft.lis.db.LCGetCalModeDB;

/*
 * <p>ClassName: LCGetCalModeSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: Physical Data Model 1
 */
public class LCGetCalModeSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LCGetCalModeSchema.class);
	// @Field
	/** 序号 */
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LCGetCalModeSchema cloned = (LCGetCalModeSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LCGetCalModeSchema 对象给 Schema 赋值
	* @param: aLCGetCalModeSchema LCGetCalModeSchema
	**/
	public void setSchema(LCGetCalModeSchema aLCGetCalModeSchema)
	{
		this.SerialNo = aLCGetCalModeSchema.getSerialNo();
		this.GrpContNo = aLCGetCalModeSchema.getGrpContNo();
		this.GrpPolNo = aLCGetCalModeSchema.getGrpPolNo();
		this.AppntNo = aLCGetCalModeSchema.getAppntNo();
		this.RiskCode = aLCGetCalModeSchema.getRiskCode();
		this.AccType = aLCGetCalModeSchema.getAccType();
		this.GetType = aLCGetCalModeSchema.getGetType();
		this.FeeValue = aLCGetCalModeSchema.getFeeValue();
		this.FeeCalCode = aLCGetCalModeSchema.getFeeCalCode();
		this.CalCode = aLCGetCalModeSchema.getCalCode();
		this.CalCode2 = aLCGetCalModeSchema.getCalCode2();
		this.ValPeriod = aLCGetCalModeSchema.getValPeriod();
		this.ValStartDate = aLCGetCalModeSchema.getValStartDate();
		this.ValEndDate = aLCGetCalModeSchema.getValEndDate();
		this.Segment1 = aLCGetCalModeSchema.getSegment1();
		this.Segment2 = aLCGetCalModeSchema.getSegment2();
		this.Segment3 = aLCGetCalModeSchema.getSegment3();
		this.ManageCom = aLCGetCalModeSchema.getManageCom();
		this.ComCode = aLCGetCalModeSchema.getComCode();
		this.MakeOperator = aLCGetCalModeSchema.getMakeOperator();
		this.MakeDate = fDate.getDate( aLCGetCalModeSchema.getMakeDate());
		this.MakeTime = aLCGetCalModeSchema.getMakeTime();
		this.ModifyOperator = aLCGetCalModeSchema.getModifyOperator();
		this.ModifyDate = fDate.getDate( aLCGetCalModeSchema.getModifyDate());
		this.ModifyTime = aLCGetCalModeSchema.getModifyTime();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LCGetCalMode表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LCGetCalModeSchema";
	...
	public LCGetCalModeSchema getSchema()
	{
		LCGetCalModeSchema aLCGetCalModeSchema = new LCGetCalModeSchema();
		aLCGetCalModeSchema.setSchema(this);
		return aLCGetCalModeSchema;
	}

	public LCGetCalModeDB getDB()
	{
		LCGetCalModeDB aDBOper = new LCGetCalModeDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLCGetCalMode描述/A>表字段
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLCGetCalMode>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			AccType = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 6, SysConst.PACKAGESPILTER );
			GetType = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 7, SysConst.PACKAGESPILTER );
			FeeValue = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 8, SysConst.PACKAGESPILTER );
			FeeCalCode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 9, SysConst.PACKAGESPILTER );
			CalCode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 10, SysConst.PACKAGESPILTER );
			CalCode2 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 11, SysConst.PACKAGESPILTER );
			ValPeriod = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 12, SysConst.PACKAGESPILTER );
			ValStartDate = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 13, SysConst.PACKAGESPILTER );
			ValEndDate = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 14, SysConst.PACKAGESPILTER );
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LCGetCalModeSchema other = (LCGetCalModeSchema)otherObject;
		return
