...
/*
 * <p>ClassName: LPEdorMainDB </p>
 * <p>Description: DB层数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 保全核心
 */
public class LPEdorMainDB extends LPEdorMainSchema
{
	// @Field
	...
	**/
	...
	// @Constructor
	public LPEdorMainDB( Connection tConnection )
	{
		con = tConnection;
	...
	{
		LPEdorMainSchema tSchema = this.getSchema();
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.getEdorAcceptNo() == null || this.getEdorAcceptNo().equals("null")) {
				...
				pstmt.setString(44, this.getEdorAcceptNo());
			}
			if(this.getEdorNo() == null || this.getEdorNo().equals("null")) {
				pstmt.setNull(45, 12);
			} else {
	...
	public boolean getInfo()
	{
		...
		try
		{
			pstmt = con.prepareStatement("SELECT * FROM LPEdorMain WHERE  EdorAcceptNo = ? AND EdorNo = ? AND ContNo = ?", 
	...
	public LPEdorMainSet query()
	{
	  ...
	  if( !mflag ) {
		...
		{
			SQLString sqlObj = new SQLString("LPEdorMain");
			LPEdorMainSchema aSchema = this.getSchema();
			...
			{
				i++;
				LPEdorMainSchema s1 = new LPEdorMainSchema();
				s1.setSchema(rs,i);
				aLPEdorMainSet.add(s1);
			}
			try{ rs.close(); } catch( Exception ex ) {}
			try{ pstmt.close(); } catch( Exception ex1 ) {}
		}
		...
		return aLPEdorMainSet;
	}

	public LPEdorMainSet executeQuery(String sql)
	{
		Statement stmt = null;
		ResultSet rs = null;
		LPEdorMainSet aLPEdorMainSet = new LPEdorMainSet();
	...
	public LPEdorMainSet query(int nStart, int nCount)
	{
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		LPEdorMainSet aLPEdorMainSet = new LPEdorMainSet();
	...
	public LPEdorMainSet executeQuery(String sql, int nStart, int nCount)
	{
		Statement stmt = null;
		ResultSet rs = null;
		LPEdorMainSet aLPEdorMainSet = new LPEdorMainSet();
	...
	public boolean update(String strWherePart)
	{
	  ...
	  if( !mflag ) {
		...
		try
		{
			...
			String sql = "update LPEdorMain " + sqlObj.getUpdPart() + " where " + strWherePart;
...
public LPEdorMainSet getData()
{
    ...
    try
    {
        ...
        tLPEdorMainSchema.setSchema(mResultSet, 1);
...
public boolean closeData()
{
	...
	public LPEdorMainSet executeQuery(SQLwithBindVariables sqlbv) {
	...
	public LPEdorMainSet executeQuery(SQLwithBindVariables sqlbv, int nStart, int nCount) {
