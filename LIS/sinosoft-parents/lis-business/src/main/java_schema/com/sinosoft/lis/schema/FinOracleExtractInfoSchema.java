...
import com.sinosoft.lis.db.FinOracleExtractInfoDB;

/*
 * <p>ClassName: FinOracleExtractInfoSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: Physical Data Model 1
 */
public class FinOracleExtractInfoSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(FinOracleExtractInfoSchema.class);
	// @Field
	/** 流水号 */
	...
	// @Constructor
	public FinOracleExtractInfoSchema()
	{
		mErrors = new CErrors();
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		FinOracleExtractInfoSchema cloned = (FinOracleExtractInfoSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 FinOracleExtractInfoSchema 对象给 Schema 赋值
	* @param: aFinOracleExtractInfoSchema FinOracleExtractInfoSchema
	**/
	public void setSchema(FinOracleExtractInfoSchema aFinOracleExtractInfoSchema)
	{
		this.SerialNo = aFinOracleExtractInfoSchema.getSerialNo();
		this.SourceBatchID = aFinOracleExtractInfoSchema.getSourceBatchID();
		this.AccountingDate = fDate.getDate( aFinOracleExtractInfoSchema.getAccountingDate());
		this.CurrencyCode = aFinOracleExtractInfoSchema.getCurrencyCode();
		this.CurrencyConversionDate = fDate.getDate( aFinOracleExtractInfoSchema.getCurrencyConversionDate());
		this.CurrencyConversionRate = aFinOracleExtractInfoSchema.getCurrencyConversionRate();
		this.CurrencyConversionType = aFinOracleExtractInfoSchema.getCurrencyConversionType();
		this.EnteredDr = aFinOracleExtractInfoSchema.getEnteredDr();
		this.EnteredCr = aFinOracleExtractInfoSchema.getEnteredCr();
		this.AccountedDr = aFinOracleExtractInfoSchema.getAccountedDr();
		this.AccountedCr = aFinOracleExtractInfoSchema.getAccountedCr();
		this.ActualFlag = aFinOracleExtractInfoSchema.getActualFlag();
		this.Segment1 = aFinOracleExtractInfoSchema.getSegment1();
		this.Segment2 = aFinOracleExtractInfoSchema.getSegment2();
		this.Segment3 = aFinOracleExtractInfoSchema.getSegment3();
		this.Segment4 = aFinOracleExtractInfoSchema.getSegment4();
		this.Segment5 = aFinOracleExtractInfoSchema.getSegment5();
		this.Segment6 = aFinOracleExtractInfoSchema.getSegment6();
		this.Segment7 = aFinOracleExtractInfoSchema.getSegment7();
		this.Segment8 = aFinOracleExtractInfoSchema.getSegment8();
		this.Segment9 = aFinOracleExtractInfoSchema.getSegment9();
		this.LineDescription = aFinOracleExtractInfoSchema.getLineDescription();
		this.Attribute1 = aFinOracleExtractInfoSchema.getAttribute1();
		this.Attribute2 = aFinOracleExtractInfoSchema.getAttribute2();
		this.Attribute3 = aFinOracleExtractInfoSchema.getAttribute3();
		this.Attribute4 = aFinOracleExtractInfoSchema.getAttribute4();
		this.Attribute5 = aFinOracleExtractInfoSchema.getAttribute5();
		this.Attribute6 = aFinOracleExtractInfoSchema.getAttribute6();
		this.Attribute7 = aFinOracleExtractInfoSchema.getAttribute7();
		this.Attribute8 = aFinOracleExtractInfoSchema.getAttribute8();
		this.Attribute9 = aFinOracleExtractInfoSchema.getAttribute9();
		this.Attribute10 = aFinOracleExtractInfoSchema.getAttribute10();
		this.Attribute11 = aFinOracleExtractInfoSchema.getAttribute11();
		this.Attribute12 = aFinOracleExtractInfoSchema.getAttribute12();
		this.Attribute13 = aFinOracleExtractInfoSchema.getAttribute13();
		this.Attribute14 = aFinOracleExtractInfoSchema.getAttribute14();
		this.Attribute15 = aFinOracleExtractInfoSchema.getAttribute15();
		this.DataSource = aFinOracleExtractInfoSchema.getDataSource();
		this.State = aFinOracleExtractInfoSchema.getState();
		this.ManageCom = aFinOracleExtractInfoSchema.getManageCom();
		this.ComCode = aFinOracleExtractInfoSchema.getComCode();
		this.MakeOperator = aFinOracleExtractInfoSchema.getMakeOperator();
		this.MakeDate = fDate.getDate( aFinOracleExtractInfoSchema.getMakeDate());
		this.MakeTime = aFinOracleExtractInfoSchema.getMakeTime();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的FinOracleExtractInfo表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "FinOracleExtractInfoSchema";
	...
	public FinOracleExtractInfoSchema getSchema()
	{
		FinOracleExtractInfoSchema aFinOracleExtractInfoSchema = new FinOracleExtractInfoSchema();
		aFinOracleExtractInfoSchema.setSchema(this);
		return aFinOracleExtractInfoSchema;
	}

	public FinOracleExtractInfoDB getDB()
	{
		FinOracleExtractInfoDB aDBOper = new FinOracleExtractInfoDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpFinOracleExtractInfo描述/A>表字段
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpFinOracleExtractInfo>历史记账凭证主表信息</A>表字段
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		FinOracleExtractInfoSchema other = (FinOracleExtractInfoSchema)otherObject;
		return
