...
/*
 * <p>ClassName: LCGPlanUWMasterDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 寿险业务系统未整理模型
 */
public class LCGPlanUWMasterDBSet extends LCGPlanUWMasterSet
{
private static Logger logger = Logger.getLogger(LCGPlanUWMasterDBSet.class);
	...
	**/
	...
	// @Constructor
	public LCGPlanUWMasterDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LCGPlanUWMasterDBSet";
