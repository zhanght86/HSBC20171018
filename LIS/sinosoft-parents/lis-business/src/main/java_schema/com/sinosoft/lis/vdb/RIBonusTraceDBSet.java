...
/*
 * <p>ClassName: RIBonusTraceDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 再保系统模型
 */
public class RIBonusTraceDBSet extends RIBonusTraceSet
{
	// @Field
	...
	**/
	...
	// @Constructor
	public RIBonusTraceDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "RIBonusTraceDBSet";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getBalaDate() == null || this.get(i).getBalaDate().equals("null")) {
				...
				pstmt.setDate(13, Date.valueOf(this.get(i).getBalaDate()));
			}
