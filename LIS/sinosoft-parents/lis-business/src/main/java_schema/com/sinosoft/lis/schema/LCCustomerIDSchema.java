...
import com.sinosoft.lis.db.LCCustomerIDDB;

/*
 * <p>ClassName: LCCustomerIDSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: Physical Data Model 1
 */
public class LCCustomerIDSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LCCustomerIDSchema.class);
	// @Field
	/** 保单号 */
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LCCustomerIDSchema cloned = (LCCustomerIDSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LCCustomerIDSchema 对象给 Schema 赋值
	* @param: aLCCustomerIDSchema LCCustomerIDSchema
	**/
	public void setSchema(LCCustomerIDSchema aLCCustomerIDSchema)
	{
		this.PolicyNo = aLCCustomerIDSchema.getPolicyNo();
		this.CustomerNo = aLCCustomerIDSchema.getCustomerNo();
		this.IDFlag = aLCCustomerIDSchema.getIDFlag();
		this.IDType = aLCCustomerIDSchema.getIDType();
		this.IDNo = aLCCustomerIDSchema.getIDNo();
		this.StartDate = fDate.getDate( aLCCustomerIDSchema.getStartDate());
		this.EndDate = fDate.getDate( aLCCustomerIDSchema.getEndDate());
		this.State = aLCCustomerIDSchema.getState();
		this.Remark = aLCCustomerIDSchema.getRemark();
		this.Segment1 = aLCCustomerIDSchema.getSegment1();
		this.Segment2 = aLCCustomerIDSchema.getSegment2();
		this.Segment3 = aLCCustomerIDSchema.getSegment3();
		this.ManageCom = aLCCustomerIDSchema.getManageCom();
		this.ComCode = aLCCustomerIDSchema.getComCode();
		this.MakeOperator = aLCCustomerIDSchema.getMakeOperator();
		this.MakeDate = fDate.getDate( aLCCustomerIDSchema.getMakeDate());
		this.MakeTime = aLCCustomerIDSchema.getMakeTime();
		this.ModifyOperator = aLCCustomerIDSchema.getModifyOperator();
		this.ModifyDate = fDate.getDate( aLCCustomerIDSchema.getModifyDate());
		this.ModifyTime = aLCCustomerIDSchema.getModifyTime();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LCCustomerID表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LCCustomerIDSchema";
	...
	public LCCustomerIDSchema getSchema()
	{
		LCCustomerIDSchema aLCCustomerIDSchema = new LCCustomerIDSchema();
		aLCCustomerIDSchema.setSchema(this);
		return aLCCustomerIDSchema;
	}

	public LCCustomerIDDB getDB()
	{
		LCCustomerIDDB aDBOper = new LCCustomerIDDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLCCustomerID描述/A>表字段
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLCCustomerID>历史记账凭证主表信息</A>表字段
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LCCustomerIDSchema other = (LCCustomerIDSchema)otherObject;
		return
