...
import com.sinosoft.lis.db.LCNotePadDB;

/*
 * <p>ClassName: LCNotePadSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 承保流程
 */
public class LCNotePadSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LCNotePadSchema.class);
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LCNotePadSchema cloned = (LCNotePadSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LCNotePadSchema 对象给 Schema 赋值
	* @param: aLCNotePadSchema LCNotePadSchema
	**/
	public void setSchema(LCNotePadSchema aLCNotePadSchema)
	{
		this.GrpContNo = aLCNotePadSchema.getGrpContNo();
		this.ContNo = aLCNotePadSchema.getContNo();
		this.ProposalContNo = aLCNotePadSchema.getProposalContNo();
		this.SerialNo = aLCNotePadSchema.getSerialNo();
		this.OperatePos = aLCNotePadSchema.getOperatePos();
		this.PrtNo = aLCNotePadSchema.getPrtNo();
		this.NotePadCont = aLCNotePadSchema.getNotePadCont();
		this.Operator = aLCNotePadSchema.getOperator();
		this.ManageCom = aLCNotePadSchema.getManageCom();
		this.MakeDate = fDate.getDate( aLCNotePadSchema.getMakeDate());
		this.MakeTime = aLCNotePadSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLCNotePadSchema.getModifyDate());
		this.ModifyTime = aLCNotePadSchema.getModifyTime();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LCNotePad表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LCNotePadSchema";
	...
	public LCNotePadSchema getSchema()
	{
		LCNotePadSchema aLCNotePadSchema = new LCNotePadSchema();
		aLCNotePadSchema.setSchema(this);
		return aLCNotePadSchema;
	}

	public LCNotePadDB getDB()
	{
		LCNotePadDB aDBOper = new LCNotePadDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLCNotePad描述/A>表字段
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLCNotePad>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			OperatePos = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 5, SysConst.PACKAGESPILTER );
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LCNotePadSchema other = (LCNotePadSchema)otherObject;
		return
