...
/*
 * <p>ClassName: LDMaxNoRuleLimitSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 号段管理
 */
public class LDMaxNoRuleLimitSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LDMaxNoRuleLimitSchema.class);
	// @Field
	/** 号段编码 */
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LDMaxNoRuleLimitSchema cloned = (LDMaxNoRuleLimitSchema)super.clone();
	...
	/**
	* 使用另外一个 LDMaxNoRuleLimitSchema 对象给 Schema 赋值
	* @param: aLDMaxNoRuleLimitSchema LDMaxNoRuleLimitSchema
	**/
	public void setSchema(LDMaxNoRuleLimitSchema aLDMaxNoRuleLimitSchema)
	{
		this.NoCode = aLDMaxNoRuleLimitSchema.getNoCode();
		this.IDX = aLDMaxNoRuleLimitSchema.getIDX();
		this.Code = aLDMaxNoRuleLimitSchema.getCode();
		this.RuleCode = aLDMaxNoRuleLimitSchema.getRuleCode();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LDMaxNoRuleLimit表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LDMaxNoRuleLimitSchema";
	...
	public LDMaxNoRuleLimitSchema getSchema()
	{
		LDMaxNoRuleLimitSchema aLDMaxNoRuleLimitSchema = new LDMaxNoRuleLimitSchema();
		aLDMaxNoRuleLimitSchema.setSchema(this);
		return aLDMaxNoRuleLimitSchema;
	}

	public LDMaxNoRuleLimitDB getDB()
	{
		LDMaxNoRuleLimitDB aDBOper = new LDMaxNoRuleLimitDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLDMaxNoRuleLimit描述/A>表字段
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLDMaxNoRuleLimit>历史记账凭证主表信息</A>表字段
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LDMaxNoRuleLimitSchema other = (LDMaxNoRuleLimitSchema)otherObject;
		return
