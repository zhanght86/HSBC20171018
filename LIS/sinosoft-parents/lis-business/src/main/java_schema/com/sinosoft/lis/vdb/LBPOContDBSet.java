...
/*
 * <p>ClassName: LBPOContDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 内部外包流程
 */
public class LBPOContDBSet extends LBPOContSet
{
private static Logger logger = Logger.getLogger(LBPOContDBSet.class);
	...
	**/
	...
	// @Constructor
	public LBPOContDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LBPOContDBSet";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getConsignNo() == null || this.get(i).getConsignNo().equals("null")) {
				...
				pstmt.setString(31, this.get(i).getConsignNo());
			}
