...
/*
 * <p>ClassName: LCInsureAccTraceBakDB </p>
 * <p>Description: DB层数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: PhysicalDataModel_1
 */
public class LCInsureAccTraceBakDB extends LCInsureAccTraceBakSchema
{
private static Logger logger = Logger.getLogger(LCInsureAccTraceBakDB.class);
	...
	**/
	...
	// @Constructor
	public LCInsureAccTraceBakDB( Connection tConnection )
	{
		con = tConnection;
	...
	{
		LCInsureAccTraceBakSchema tSchema = this.getSchema();
		...
		else
		{
			...
			tError.moduleName = "LCInsureAccTraceBakDB";
	...
	public boolean getInfo()
	{
		...
		try
		{
			pstmt = con.prepareStatement("SELECT * FROM LCInsureAccTraceBak WHERE  SerialNo = ?", 
	...
	public LCInsureAccTraceBakSet query()
	{
		PreparedStatement pstmt = null;
 		ResultSet rs = null;
		LCInsureAccTraceBakSet aLCInsureAccTraceBakSet = new LCInsureAccTraceBakSet();
	  ...
	  if( !mflag ) {
		...
		{
			SQLString sqlObj = new SQLString("LCInsureAccTraceBak");
			LCInsureAccTraceBakSchema aSchema = this.getSchema();
			...
			{
				i++;
				LCInsureAccTraceBakSchema s1 = new LCInsureAccTraceBakSchema();
				s1.setSchema(rs,i);
				aLCInsureAccTraceBakSet.add(s1);
			}
			try{ rs.close(); } catch( Exception ex ) {}
			try{ pstmt.close(); } catch( Exception ex1 ) {}
		}
		...
		return aLCInsureAccTraceBakSet;

	}

	public LCInsureAccTraceBakSet executeQuery(String sql)
	{
		Statement stmt = null;
		ResultSet rs = null;
		LCInsureAccTraceBakSet aLCInsureAccTraceBakSet = new LCInsureAccTraceBakSet();
	...
	public LCInsureAccTraceBakSet query(int nStart, int nCount)
	{
		PreparedStatement pstmt = null;
 		ResultSet rs = null;
		LCInsureAccTraceBakSet aLCInsureAccTraceBakSet = new LCInsureAccTraceBakSet();
	...
	public LCInsureAccTraceBakSet executeQuery(String sql, int nStart, int nCount)
	{
		Statement stmt = null;
		ResultSet rs = null;
		LCInsureAccTraceBakSet aLCInsureAccTraceBakSet = new LCInsureAccTraceBakSet();
	...
	public boolean update(String strWherePart)
	{
	  ...
	  if( !mflag ) {
		...
		try
		{
			...
			String sql = "update LCInsureAccTraceBak " + sqlObj.getUpdPart() + " where " + strWherePart;
...
/**
 * 获取定量数据
 * @return LCInsureAccTraceBakSet
 */
public LCInsureAccTraceBakSet getData()
{
    int tCount = 0;
    LCInsureAccTraceBakSet tLCInsureAccTraceBakSet = new LCInsureAccTraceBakSet();
    LCInsureAccTraceBakSchema tLCInsureAccTraceBakSchema = null;
    if (null == mResultSet)
    {
        CError tError = new CError();
        tError.moduleName = "LCInsureAccTraceBakDB";
    ...
    {
        tCount = 1;
        tLCInsureAccTraceBakSchema = new LCInsureAccTraceBakSchema();
        tLCInsureAccTraceBakSchema.setSchema(mResultSet, 1);
    ...
    return tLCInsureAccTraceBakSet;
}
/**
 * 关闭数据集
 * @return boolean
...
public boolean closeData()
{
	...
	public LCInsureAccTraceBakSet executeQuery(SQLwithBindVariables sqlbv) {
	...
	public LCInsureAccTraceBakSet executeQuery(SQLwithBindVariables sqlbv, int nStart, int nCount) {
