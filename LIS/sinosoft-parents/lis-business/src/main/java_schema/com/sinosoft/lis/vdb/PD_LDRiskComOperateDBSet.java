...
/**
 * <p>ClassName: PD_LDRiskComOperateDBSet </p>
 ...
 */
public class PD_LDRiskComOperateDBSet extends PD_LDRiskComOperateSet
{
private static Logger logger = Logger.getLogger(PD_LDRiskComOperateDBSet.class);
    ...
    // @Constructor
    public PD_LDRiskComOperateDBSet(Connection cConnection)
    {
        con = cConnection;
    ...
    public PD_LDRiskComOperateDBSet()
    {
    ...
    public boolean deleteSQL()
    {
        ...
        else
        {
            ...
            tError.moduleName = "PD_LDRiskComOperateDBSet";
    ...
    public boolean delete()
    {
        ...
        try
        {
            ...
            for (int i = 1; i <= tCount; i++)
            {
                ...
                {
                    pstmt.setString(3, StrTool.space1(this.get(i).getComCode(), 10));
                }
                if (this.get(i).getOperateType() == null || this.get(i).getOperateType().equals("null"))
                {
                    pstmt.setString(4, null);
                ...
                {
                    pstmt.setString(4, StrTool.space1(this.get(i).getOperateType(), 2));
                }
                pstmt.addBatch();
            }
            pstmt.executeBatch();
    ...
    public boolean update()
    {
        ...
        try
        {
            ...
            for (int i = 1; i <= tCount; i++)
            {
                ...
                {
                    pstmt.setString(18, StrTool.space1(this.get(i).getManageCom(), 10));
                }
                if (this.get(i).getComCode() == null || this.get(i).getComCode().equals("null"))
                {
                ...
                {
                    pstmt.setString(19, StrTool.space1(this.get(i).getComCode(), 10));
                }
                if (this.get(i).getOperateType() == null || this.get(i).getOperateType().equals("null"))
                {
                ...
                {
                    pstmt.setString(20, StrTool.space1(this.get(i).getOperateType(), 2));
                }
                pstmt.addBatch();
            }
            pstmt.executeBatch();
