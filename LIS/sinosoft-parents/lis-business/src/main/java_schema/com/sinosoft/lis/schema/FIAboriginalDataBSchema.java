...
import com.sinosoft.lis.db.FIAboriginalDataBDB;

/**
 * <p>ClassName: FIAboriginalDataBSchema </p>
 ...
 */
public class FIAboriginalDataBSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(FIAboriginalDataBSchema.class);
	...
	// @Constructor
	public FIAboriginalDataBSchema()
	{
		mErrors = new CErrors();
		...
		PK = pk;
            ...
            public Object clone()
                    throws CloneNotSupportedException
            {
                FIAboriginalDataBSchema cloned = (FIAboriginalDataBSchema)super.clone();
	...
	public void setDelReason(String aDelReason)
	{
		DelReason = aDelReason;
	}
	...
	/**
	* 使用另外一个 FIAboriginalDataBSchema 对象给 Schema 赋值
	* @param: aFIAboriginalDataBSchema FIAboriginalDataBSchema
	**/
	public void setSchema(FIAboriginalDataBSchema aFIAboriginalDataBSchema)
	{
		this.DelSerialNo = aFIAboriginalDataBSchema.getDelSerialNo();
		this.DelOperator = aFIAboriginalDataBSchema.getDelOperator();
		this.DelReason = aFIAboriginalDataBSchema.getDelReason();
		this.ASerialNo = aFIAboriginalDataBSchema.getASerialNo();
		this.AcquisitionID = aFIAboriginalDataBSchema.getAcquisitionID();
		this.DataBaseID = aFIAboriginalDataBSchema.getDataBaseID();
		this.BatchNo = aFIAboriginalDataBSchema.getBatchNo();
		this.CertificateID = aFIAboriginalDataBSchema.getCertificateID();
		this.CostID = aFIAboriginalDataBSchema.getCostID();
		this.DataState = aFIAboriginalDataBSchema.getDataState();
		this.CheckFlag = aFIAboriginalDataBSchema.getCheckFlag();
		this.BusinessCode = aFIAboriginalDataBSchema.getBusinessCode();
		this.FeeCode = aFIAboriginalDataBSchema.getFeeCode();
		this.SumActuMoney = aFIAboriginalDataBSchema.getSumActuMoney();
		this.AccountDate = fDate.getDate( aFIAboriginalDataBSchema.getAccountDate());
		this.BusinessNo = aFIAboriginalDataBSchema.getBusinessNo();
		this.StringInfo01 = aFIAboriginalDataBSchema.getStringInfo01();
		this.StringInfo02 = aFIAboriginalDataBSchema.getStringInfo02();
		this.StringInfo03 = aFIAboriginalDataBSchema.getStringInfo03();
		this.StringInfo04 = aFIAboriginalDataBSchema.getStringInfo04();
		this.StringInfo05 = aFIAboriginalDataBSchema.getStringInfo05();
		this.StringInfo06 = aFIAboriginalDataBSchema.getStringInfo06();
		this.StringInfo07 = aFIAboriginalDataBSchema.getStringInfo07();
		this.StringInfo08 = aFIAboriginalDataBSchema.getStringInfo08();
		this.StringInfo09 = aFIAboriginalDataBSchema.getStringInfo09();
		this.StringInfo10 = aFIAboriginalDataBSchema.getStringInfo10();
		this.StringInfo11 = aFIAboriginalDataBSchema.getStringInfo11();
		this.StringInfo12 = aFIAboriginalDataBSchema.getStringInfo12();
		this.StringInfo13 = aFIAboriginalDataBSchema.getStringInfo13();
		this.StringInfo14 = aFIAboriginalDataBSchema.getStringInfo14();
		this.StringInfo15 = aFIAboriginalDataBSchema.getStringInfo15();
		this.DateInfo01 = fDate.getDate( aFIAboriginalDataBSchema.getDateInfo01());
		this.DateInfo02 = fDate.getDate( aFIAboriginalDataBSchema.getDateInfo02());
		this.DateInfo03 = fDate.getDate( aFIAboriginalDataBSchema.getDateInfo03());
		this.DateInfo04 = fDate.getDate( aFIAboriginalDataBSchema.getDateInfo04());
		this.DateInfo05 = fDate.getDate( aFIAboriginalDataBSchema.getDateInfo05());
		this.DateInfo06 = fDate.getDate( aFIAboriginalDataBSchema.getDateInfo06());
		this.DateInfo07 = fDate.getDate( aFIAboriginalDataBSchema.getDateInfo07());
		this.DateInfo08 = fDate.getDate( aFIAboriginalDataBSchema.getDateInfo08());
		this.DateInfo09 = fDate.getDate( aFIAboriginalDataBSchema.getDateInfo09());
		this.DateInfo10 = fDate.getDate( aFIAboriginalDataBSchema.getDateInfo10());
		this.NumInfo01 = aFIAboriginalDataBSchema.getNumInfo01();
		this.NumInfo02 = aFIAboriginalDataBSchema.getNumInfo02();
		this.NumInfo03 = aFIAboriginalDataBSchema.getNumInfo03();
		this.NumInfo04 = aFIAboriginalDataBSchema.getNumInfo04();
		this.NumInfo05 = aFIAboriginalDataBSchema.getNumInfo05();
		this.BusinessNo01 = aFIAboriginalDataBSchema.getBusinessNo01();
		this.BusinessNo02 = aFIAboriginalDataBSchema.getBusinessNo02();
		this.BusinessNo03 = aFIAboriginalDataBSchema.getBusinessNo03();
		this.BusinessNo04 = aFIAboriginalDataBSchema.getBusinessNo04();
		this.BusinessNo05 = aFIAboriginalDataBSchema.getBusinessNo05();
		this.BusinessNo06 = aFIAboriginalDataBSchema.getBusinessNo06();
		this.BusinessNo07 = aFIAboriginalDataBSchema.getBusinessNo07();
		this.BusinessNo08 = aFIAboriginalDataBSchema.getBusinessNo08();
		this.BusinessNo09 = aFIAboriginalDataBSchema.getBusinessNo09();
		this.BusinessNo10 = aFIAboriginalDataBSchema.getBusinessNo10();
		this.TypeFlag01 = aFIAboriginalDataBSchema.getTypeFlag01();
		this.TypeFlag02 = aFIAboriginalDataBSchema.getTypeFlag02();
		this.TypeFlag03 = aFIAboriginalDataBSchema.getTypeFlag03();
		this.TypeFlag04 = aFIAboriginalDataBSchema.getTypeFlag04();
		this.TypeFlag05 = aFIAboriginalDataBSchema.getTypeFlag05();
		this.TypeFlag06 = aFIAboriginalDataBSchema.getTypeFlag06();
		this.TypeFlag07 = aFIAboriginalDataBSchema.getTypeFlag07();
		this.TypeFlag08 = aFIAboriginalDataBSchema.getTypeFlag08();
		this.TypeFlag09 = aFIAboriginalDataBSchema.getTypeFlag09();
		this.TypeFlag10 = aFIAboriginalDataBSchema.getTypeFlag10();
		this.Relationcode = aFIAboriginalDataBSchema.getRelationcode();
		this.MakeDate = fDate.getDate( aFIAboriginalDataBSchema.getMakeDate());
		this.MakeTime = aFIAboriginalDataBSchema.getMakeTime();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		try
		{
			...
			if( rs.getString("DelReason") == null )
				this.DelReason = null;
			else
				this.DelReason = rs.getString("DelReason").trim();
		...
		{
			logger.debug("数据库中的FIAboriginalDataB表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "FIAboriginalDataBSchema";
	...
	public FIAboriginalDataBSchema getSchema()
	{
		FIAboriginalDataBSchema aFIAboriginalDataBSchema = new FIAboriginalDataBSchema();
		aFIAboriginalDataBSchema.setSchema(this);
		return aFIAboriginalDataBSchema;
	}

	public FIAboriginalDataBDB getDB()
	{
		FIAboriginalDataBDB aDBOper = new FIAboriginalDataBDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpFIAboriginalDataB描述/A>表字段
...
strReturn.append(StrTool.cTrim(DelReason)); strReturn.append(SysConst.PACKAGESPILTER);
...
strReturn.append(StrTool.cTrim(MakeTime));
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpFIAboriginalDataB>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			DelOperator = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 2, SysConst.PACKAGESPILTER );
			DelReason = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 3, SysConst.PACKAGESPILTER );
			ASerialNo = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 4, SysConst.PACKAGESPILTER );
			AcquisitionID = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 5, SysConst.PACKAGESPILTER );
			DataBaseID = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 6, SysConst.PACKAGESPILTER );
			BatchNo = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 7, SysConst.PACKAGESPILTER );
			CertificateID = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 8, SysConst.PACKAGESPILTER );
			CostID = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 9, SysConst.PACKAGESPILTER );
			DataState = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 10, SysConst.PACKAGESPILTER );
			CheckFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 11, SysConst.PACKAGESPILTER );
			BusinessCode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 12, SysConst.PACKAGESPILTER );
			FeeCode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 13, SysConst.PACKAGESPILTER );
			SumActuMoney = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,14,SysConst.PACKAGESPILTER))).doubleValue();
			AccountDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 15,SysConst.PACKAGESPILTER));
			BusinessNo = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 16, SysConst.PACKAGESPILTER );
			StringInfo01 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 17, SysConst.PACKAGESPILTER );
			StringInfo02 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 18, SysConst.PACKAGESPILTER );
			StringInfo03 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 19, SysConst.PACKAGESPILTER );
			StringInfo04 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 20, SysConst.PACKAGESPILTER );
			StringInfo05 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 21, SysConst.PACKAGESPILTER );
			StringInfo06 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 22, SysConst.PACKAGESPILTER );
			StringInfo07 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 23, SysConst.PACKAGESPILTER );
			StringInfo08 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 24, SysConst.PACKAGESPILTER );
			StringInfo09 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 25, SysConst.PACKAGESPILTER );
			StringInfo10 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 26, SysConst.PACKAGESPILTER );
			StringInfo11 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 27, SysConst.PACKAGESPILTER );
			StringInfo12 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 28, SysConst.PACKAGESPILTER );
			StringInfo13 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 29, SysConst.PACKAGESPILTER );
			StringInfo14 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 30, SysConst.PACKAGESPILTER );
			StringInfo15 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 31, SysConst.PACKAGESPILTER );
			DateInfo01 = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 32,SysConst.PACKAGESPILTER));
			DateInfo02 = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 33,SysConst.PACKAGESPILTER));
			DateInfo03 = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 34,SysConst.PACKAGESPILTER));
			DateInfo04 = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 35,SysConst.PACKAGESPILTER));
			DateInfo05 = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 36,SysConst.PACKAGESPILTER));
			DateInfo06 = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 37,SysConst.PACKAGESPILTER));
			DateInfo07 = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 38,SysConst.PACKAGESPILTER));
			DateInfo08 = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 39,SysConst.PACKAGESPILTER));
			DateInfo09 = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 40,SysConst.PACKAGESPILTER));
			DateInfo10 = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 41,SysConst.PACKAGESPILTER));
			NumInfo01 = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,42,SysConst.PACKAGESPILTER))).doubleValue();
			NumInfo02 = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,43,SysConst.PACKAGESPILTER))).doubleValue();
			NumInfo03= new Integer(ChgData.chgNumericStr(StrTool.getStr(strMessage,44,SysConst.PACKAGESPILTER))).intValue();
			NumInfo04= new Integer(ChgData.chgNumericStr(StrTool.getStr(strMessage,45,SysConst.PACKAGESPILTER))).intValue();
			NumInfo05= new Integer(ChgData.chgNumericStr(StrTool.getStr(strMessage,46,SysConst.PACKAGESPILTER))).intValue();
			BusinessNo01 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 47, SysConst.PACKAGESPILTER );
			BusinessNo02 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 48, SysConst.PACKAGESPILTER );
			BusinessNo03 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 49, SysConst.PACKAGESPILTER );
			BusinessNo04 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 50, SysConst.PACKAGESPILTER );
			BusinessNo05 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 51, SysConst.PACKAGESPILTER );
			BusinessNo06 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 52, SysConst.PACKAGESPILTER );
			BusinessNo07 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 53, SysConst.PACKAGESPILTER );
			BusinessNo08 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 54, SysConst.PACKAGESPILTER );
			BusinessNo09 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 55, SysConst.PACKAGESPILTER );
			BusinessNo10 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 56, SysConst.PACKAGESPILTER );
			TypeFlag01 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 57, SysConst.PACKAGESPILTER );
			TypeFlag02 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 58, SysConst.PACKAGESPILTER );
			TypeFlag03 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 59, SysConst.PACKAGESPILTER );
			TypeFlag04 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 60, SysConst.PACKAGESPILTER );
			TypeFlag05 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 61, SysConst.PACKAGESPILTER );
			TypeFlag06 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 62, SysConst.PACKAGESPILTER );
			TypeFlag07 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 63, SysConst.PACKAGESPILTER );
			TypeFlag08 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 64, SysConst.PACKAGESPILTER );
			TypeFlag09 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 65, SysConst.PACKAGESPILTER );
			TypeFlag10 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 66, SysConst.PACKAGESPILTER );
			Relationcode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 67, SysConst.PACKAGESPILTER );
	...
	**/
	public String getV(String FCode)
	{
		...
		if (FCode.equalsIgnoreCase("DelReason"))
		{
			strReturn = StrTool.GBKToUnicode(String.valueOf(DelReason));
		}
	...
	public String getV(int nFieldIndex)
	{
		...
		switch(nFieldIndex) {
			...
			case 1:
				...
				break;
			case 2:
				strFieldValue = StrTool.GBKToUnicode(DelReason);
				break;
			case 3:
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		FIAboriginalDataBSchema other = (FIAboriginalDataBSchema)otherObject;
		return
			DelSerialNo.equals(other.getDelSerialNo())
			&& DelOperator.equals(other.getDelOperator())
			&& DelReason.equals(other.getDelReason())
	...
	**/
	public int getFieldIndex(String strFieldName)
	{
		...
		if( strFieldName.equals("DelReason") ) {
			return 2;
		}
