...
/*
 * <p>ClassName: LCGrpContactInfoDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: Physical Data Model 1
 */
public class LCGrpContactInfoDBSet extends LCGrpContactInfoSet
{
	// @Field
	...
	**/
	...
	// @Constructor
	public LCGrpContactInfoDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LCGrpContactInfoDBSet";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getGrpContNo() == null || this.get(i).getGrpContNo().equals("null")) {
				...
				pstmt.setString(22, this.get(i).getGrpContNo());
			}
			if(this.get(i).getCustomerNo() == null || this.get(i).getCustomerNo().equals("null")) {
