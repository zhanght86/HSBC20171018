...
import com.sinosoft.lis.db.PD_LMDutyGetClmDB;

/*
 * <p>ClassName: PD_LMDutyGetClmSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: Physical Data Model 1
 */
public class PD_LMDutyGetClmSchema implements Schema, Cloneable
{
	// @Field
	/** 给付代码 */
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		PD_LMDutyGetClmSchema cloned = (PD_LMDutyGetClmSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 PD_LMDutyGetClmSchema 对象给 Schema 赋值
	* @param: aPD_LMDutyGetClmSchema PD_LMDutyGetClmSchema
	**/
	public void setSchema(PD_LMDutyGetClmSchema aPD_LMDutyGetClmSchema)
	{
		this.GetDutyCode = aPD_LMDutyGetClmSchema.getGetDutyCode();
		this.GetDutyKind = aPD_LMDutyGetClmSchema.getGetDutyKind();
		this.GetDutyName = aPD_LMDutyGetClmSchema.getGetDutyName();
		this.CalCode = aPD_LMDutyGetClmSchema.getCalCode();
		this.Defaultval = aPD_LMDutyGetClmSchema.getDefaultval();
		this.CnterCalCode = aPD_LMDutyGetClmSchema.getCnterCalCode();
		this.OthCalCode = aPD_LMDutyGetClmSchema.getOthCalCode();
		this.InpFlag = aPD_LMDutyGetClmSchema.getInpFlag();
		this.StatType = aPD_LMDutyGetClmSchema.getStatType();
		this.MinGet = aPD_LMDutyGetClmSchema.getMinGet();
		this.AfterGet = aPD_LMDutyGetClmSchema.getAfterGet();
		this.MaxGet = aPD_LMDutyGetClmSchema.getMaxGet();
		this.ClaimRate = aPD_LMDutyGetClmSchema.getClaimRate();
		this.ClmDayLmt = aPD_LMDutyGetClmSchema.getClmDayLmt();
		this.SumClmDayLmt = aPD_LMDutyGetClmSchema.getSumClmDayLmt();
		this.Deductible = aPD_LMDutyGetClmSchema.getDeductible();
		this.DeDuctDay = aPD_LMDutyGetClmSchema.getDeDuctDay();
		this.ObsPeriod = aPD_LMDutyGetClmSchema.getObsPeriod();
		this.DeadValiFlag = aPD_LMDutyGetClmSchema.getDeadValiFlag();
		this.DeadToPValueFlag = aPD_LMDutyGetClmSchema.getDeadToPValueFlag();
		this.NeedReCompute = aPD_LMDutyGetClmSchema.getNeedReCompute();
		this.CasePolType = aPD_LMDutyGetClmSchema.getCasePolType();
		this.DeformityGrade = aPD_LMDutyGetClmSchema.getDeformityGrade();
		this.FilterCalCode = aPD_LMDutyGetClmSchema.getFilterCalCode();
		this.EffectOnMainRisk = aPD_LMDutyGetClmSchema.getEffectOnMainRisk();
		this.ExtraAmntFlag = aPD_LMDutyGetClmSchema.getExtraAmntFlag();
		this.YearGetLimitFlag = aPD_LMDutyGetClmSchema.getYearGetLimitFlag();
		this.Operator = aPD_LMDutyGetClmSchema.getOperator();
		this.MakeDate = fDate.getDate( aPD_LMDutyGetClmSchema.getMakeDate());
		this.MakeTime = aPD_LMDutyGetClmSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aPD_LMDutyGetClmSchema.getModifyDate());
		this.ModifyTime = aPD_LMDutyGetClmSchema.getModifyTime();
		this.Standbyflag1 = aPD_LMDutyGetClmSchema.getStandbyflag1();
		this.Standbyflag2 = aPD_LMDutyGetClmSchema.getStandbyflag2();
		this.Standbyflag3 = aPD_LMDutyGetClmSchema.getStandbyflag3();
		this.Standbyflag4 = aPD_LMDutyGetClmSchema.getStandbyflag4();
		this.Standbyflag5 = aPD_LMDutyGetClmSchema.getStandbyflag5();
		this.Standbyflag6 = aPD_LMDutyGetClmSchema.getStandbyflag6();
		this.GetByHosday = aPD_LMDutyGetClmSchema.getGetByHosday();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			System.out.println("数据库中的PD_LMDutyGetClm表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			sqle.printStackTrace();
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "PD_LMDutyGetClmSchema";
	...
	public PD_LMDutyGetClmSchema getSchema()
	{
		PD_LMDutyGetClmSchema aPD_LMDutyGetClmSchema = new PD_LMDutyGetClmSchema();
		aPD_LMDutyGetClmSchema.setSchema(this);
		return aPD_LMDutyGetClmSchema;
	}

	public PD_LMDutyGetClmDB getDB()
	{
		PD_LMDutyGetClmDB aDBOper = new PD_LMDutyGetClmDB();
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpPD_LMDutyGetClm>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			GetByHosday = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 39, SysConst.PACKAGESPILTER );
		}
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		PD_LMDutyGetClmSchema other = (PD_LMDutyGetClmSchema)otherObject;
		return
