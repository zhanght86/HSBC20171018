...
/*
 * <p>ClassName: LMCertifyDesDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 单证管理
 */
public class LMCertifyDesDBSet extends LMCertifyDesSet
{
private static Logger logger = Logger.getLogger(LMCertifyDesDBSet.class);
	...
	**/
	...
	// @Constructor
	public LMCertifyDesDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LMCertifyDesDBSet";
