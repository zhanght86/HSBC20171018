...
/*
 * <p>ClassName: LCGPlanUWSubDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 寿险业务系统未整理模型
 */
public class LCGPlanUWSubDBSet extends LCGPlanUWSubSet
{
private static Logger logger = Logger.getLogger(LCGPlanUWSubDBSet.class);
	...
	**/
	...
	// @Constructor
	public LCGPlanUWSubDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LCGPlanUWSubDBSet";
	...
	public boolean delete()
	{
		...
		try
		{
			...
			if(this.get(i).getProposalGrpContNo() == null || this.get(i).getProposalGrpContNo().equals("null")) {
				...
				pstmt.setString(1, StrTool.space1(this.get(i).getProposalGrpContNo(), 20));
			}
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getPlanType() == null || this.get(i).getPlanType().equals("null")) {
				...
				pstmt.setString(4, this.get(i).getPlanType());
			}
			...
			if(this.get(i).getUpReport() == null || this.get(i).getUpReport().equals("null")) {
				...
				pstmt.setString(33, this.get(i).getUpReport());
			}
			...
			if(this.get(i).getProposalGrpContNo() == null || this.get(i).getProposalGrpContNo().equals("null")) {
				...
				pstmt.setString(39, StrTool.space1(this.get(i).getProposalGrpContNo(), 20));
			}
			if(this.get(i).getContPlanCode() == null || this.get(i).getContPlanCode().equals("null")) {
			...
			if(this.get(i).getPlanType() == null || this.get(i).getPlanType().equals("null")) {
				...
				pstmt.setString(41, StrTool.space1(this.get(i).getPlanType(), 1));
			}
