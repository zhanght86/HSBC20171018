...
/*
 * <p>ClassName: LKTransStatusDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 银保通
 */
public class LKTransStatusDBSet extends LKTransStatusSet
{
private static Logger logger = Logger.getLogger(LKTransStatusDBSet.class);
	...
	**/
	...
	// @Constructor
	public LKTransStatusDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LKTransStatusDBSet";
	...
	public boolean delete()
	{
		...
		try
		{
			...
			if(this.get(i).getBankBranch() == null || this.get(i).getBankBranch().equals("null")) {
				...
				pstmt.setString(2, this.get(i).getBankBranch());
			}
			...
			if(this.get(i).getTransNo() == null || this.get(i).getTransNo().equals("null")) {
				...
				pstmt.setString(4, this.get(i).getTransNo());
			}
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getOutServiceCode() == null || this.get(i).getOutServiceCode().equals("null")) {
				...
				pstmt.setString(29, this.get(i).getOutServiceCode());
			}
			if(this.get(i).getIssueWay() == null || this.get(i).getIssueWay().equals("null")) {
				pstmt.setString(30,null);
			} else {
				pstmt.setString(30, this.get(i).getIssueWay());
			}
			// set where condition
			if(this.get(i).getBankCode() == null || this.get(i).getBankCode().equals("null")) {
			...
			if(this.get(i).getBankBranch() == null || this.get(i).getBankBranch().equals("null")) {
				...
				pstmt.setString(32, this.get(i).getBankBranch());
			}
			if(this.get(i).getBankNode() == null || this.get(i).getBankNode().equals("null")) {
				pstmt.setString(33,null);
			} else {
				pstmt.setString(33, this.get(i).getBankNode());
			}
			if(this.get(i).getTransNo() == null || this.get(i).getTransNo().equals("null")) {
				pstmt.setString(34,null);
			} else {
				pstmt.setString(34, this.get(i).getTransNo());
			}
