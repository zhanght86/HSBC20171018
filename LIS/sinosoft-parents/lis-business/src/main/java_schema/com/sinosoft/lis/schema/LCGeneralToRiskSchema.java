...
/*
 * <p>ClassName: LCGeneralToRiskSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 承保核心
 */
public class LCGeneralToRiskSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LCGeneralToRiskSchema.class);
	// @Field
	/** 集体保单险种号码 */
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LCGeneralToRiskSchema cloned = (LCGeneralToRiskSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LCGeneralToRiskSchema 对象给 Schema 赋值
	* @param: aLCGeneralToRiskSchema LCGeneralToRiskSchema
	**/
	public void setSchema(LCGeneralToRiskSchema aLCGeneralToRiskSchema)
	{
		this.GrpPolNo = aLCGeneralToRiskSchema.getGrpPolNo();
		this.GrpContNo = aLCGeneralToRiskSchema.getGrpContNo();
		this.ExecuteCom = aLCGeneralToRiskSchema.getExecuteCom();
		this.AgentCom = aLCGeneralToRiskSchema.getAgentCom();
		this.PrtNo = aLCGeneralToRiskSchema.getPrtNo();
		this.GrpProposalNo = aLCGeneralToRiskSchema.getGrpProposalNo();
		this.KindCode = aLCGeneralToRiskSchema.getKindCode();
		this.RiskCode = aLCGeneralToRiskSchema.getRiskCode();
		this.RiskVersion = aLCGeneralToRiskSchema.getRiskVersion();
		this.SaleChnl = aLCGeneralToRiskSchema.getSaleChnl();
		this.ManageCom = aLCGeneralToRiskSchema.getManageCom();
		this.AgentType = aLCGeneralToRiskSchema.getAgentType();
		this.AgentCode = aLCGeneralToRiskSchema.getAgentCode();
		this.AgentGroup = aLCGeneralToRiskSchema.getAgentGroup();
		this.AgentCode1 = aLCGeneralToRiskSchema.getAgentCode1();
		this.CustomerNo = aLCGeneralToRiskSchema.getCustomerNo();
		this.AddressNo = aLCGeneralToRiskSchema.getAddressNo();
		this.GrpName = aLCGeneralToRiskSchema.getGrpName();
		this.GetFlag = aLCGeneralToRiskSchema.getGetFlag();
		this.BankCode = aLCGeneralToRiskSchema.getBankCode();
		this.BankAccNo = aLCGeneralToRiskSchema.getBankAccNo();
		this.AccName = aLCGeneralToRiskSchema.getAccName();
		this.FirstPayDate = fDate.getDate( aLCGeneralToRiskSchema.getFirstPayDate());
		this.PayEndDate = fDate.getDate( aLCGeneralToRiskSchema.getPayEndDate());
		this.PaytoDate = fDate.getDate( aLCGeneralToRiskSchema.getPaytoDate());
		this.RegetDate = fDate.getDate( aLCGeneralToRiskSchema.getRegetDate());
		this.LastEdorDate = fDate.getDate( aLCGeneralToRiskSchema.getLastEdorDate());
		this.SSFlag = aLCGeneralToRiskSchema.getSSFlag();
		this.PeakLine = aLCGeneralToRiskSchema.getPeakLine();
		this.GetLimit = aLCGeneralToRiskSchema.getGetLimit();
		this.GetRate = aLCGeneralToRiskSchema.getGetRate();
		this.BonusRate = aLCGeneralToRiskSchema.getBonusRate();
		this.MaxMedFee = aLCGeneralToRiskSchema.getMaxMedFee();
		this.OutPayFlag = aLCGeneralToRiskSchema.getOutPayFlag();
		this.EmployeeRate = aLCGeneralToRiskSchema.getEmployeeRate();
		this.FamilyRate = aLCGeneralToRiskSchema.getFamilyRate();
		this.SpecFlag = aLCGeneralToRiskSchema.getSpecFlag();
		this.ExpPeoples = aLCGeneralToRiskSchema.getExpPeoples();
		this.ExpPremium = aLCGeneralToRiskSchema.getExpPremium();
		this.ExpAmnt = aLCGeneralToRiskSchema.getExpAmnt();
		this.PayMode = aLCGeneralToRiskSchema.getPayMode();
		this.ManageFeeRate = aLCGeneralToRiskSchema.getManageFeeRate();
		this.PayIntv = aLCGeneralToRiskSchema.getPayIntv();
		this.CValiDate = fDate.getDate( aLCGeneralToRiskSchema.getCValiDate());
		this.Peoples2 = aLCGeneralToRiskSchema.getPeoples2();
		this.Mult = aLCGeneralToRiskSchema.getMult();
		this.Prem = aLCGeneralToRiskSchema.getPrem();
		this.Amnt = aLCGeneralToRiskSchema.getAmnt();
		this.SumPrem = aLCGeneralToRiskSchema.getSumPrem();
		this.SumPay = aLCGeneralToRiskSchema.getSumPay();
		this.Dif = aLCGeneralToRiskSchema.getDif();
		this.State = aLCGeneralToRiskSchema.getState();
		this.ApproveFlag = aLCGeneralToRiskSchema.getApproveFlag();
		this.ApproveCode = aLCGeneralToRiskSchema.getApproveCode();
		this.ApproveDate = fDate.getDate( aLCGeneralToRiskSchema.getApproveDate());
		this.ApproveTime = aLCGeneralToRiskSchema.getApproveTime();
		this.UWFlag = aLCGeneralToRiskSchema.getUWFlag();
		this.UWOperator = aLCGeneralToRiskSchema.getUWOperator();
		this.UWDate = fDate.getDate( aLCGeneralToRiskSchema.getUWDate());
		this.UWTime = aLCGeneralToRiskSchema.getUWTime();
		this.AppFlag = aLCGeneralToRiskSchema.getAppFlag();
		this.Remark = aLCGeneralToRiskSchema.getRemark();
		this.StandbyFlag1 = aLCGeneralToRiskSchema.getStandbyFlag1();
		this.StandbyFlag2 = aLCGeneralToRiskSchema.getStandbyFlag2();
		this.StandbyFlag3 = aLCGeneralToRiskSchema.getStandbyFlag3();
		this.Operator = aLCGeneralToRiskSchema.getOperator();
		this.MakeDate = fDate.getDate( aLCGeneralToRiskSchema.getMakeDate());
		this.MakeTime = aLCGeneralToRiskSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLCGeneralToRiskSchema.getModifyDate());
		this.ModifyTime = aLCGeneralToRiskSchema.getModifyTime();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LCGeneralToRisk表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LCGeneralToRiskSchema";
	...
	public LCGeneralToRiskSchema getSchema()
	{
		LCGeneralToRiskSchema aLCGeneralToRiskSchema = new LCGeneralToRiskSchema();
		aLCGeneralToRiskSchema.setSchema(this);
		return aLCGeneralToRiskSchema;
	}

	public LCGeneralToRiskDB getDB()
	{
		LCGeneralToRiskDB aDBOper = new LCGeneralToRiskDB();
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLCGeneralToRisk>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			ExecuteCom = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 3, SysConst.PACKAGESPILTER );
			...
			BankCode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 20, SysConst.PACKAGESPILTER );
			BankAccNo = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 21, SysConst.PACKAGESPILTER );
			AccName = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 22, SysConst.PACKAGESPILTER );
			FirstPayDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 23,SysConst.PACKAGESPILTER));
			PayEndDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 24,SysConst.PACKAGESPILTER));
			PaytoDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 25,SysConst.PACKAGESPILTER));
			RegetDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 26,SysConst.PACKAGESPILTER));
			LastEdorDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 27,SysConst.PACKAGESPILTER));
			SSFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 28, SysConst.PACKAGESPILTER );
			PeakLine = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,29,SysConst.PACKAGESPILTER))).doubleValue();
			GetLimit = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,30,SysConst.PACKAGESPILTER))).doubleValue();
			GetRate = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,31,SysConst.PACKAGESPILTER))).doubleValue();
			BonusRate = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,32,SysConst.PACKAGESPILTER))).doubleValue();
			MaxMedFee = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,33,SysConst.PACKAGESPILTER))).doubleValue();
			OutPayFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 34, SysConst.PACKAGESPILTER );
			EmployeeRate = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,35,SysConst.PACKAGESPILTER))).doubleValue();
			FamilyRate = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,36,SysConst.PACKAGESPILTER))).doubleValue();
			SpecFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 37, SysConst.PACKAGESPILTER );
			ExpPeoples= new Integer(ChgData.chgNumericStr(StrTool.getStr(strMessage,38,SysConst.PACKAGESPILTER))).intValue();
			ExpPremium = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,39,SysConst.PACKAGESPILTER))).doubleValue();
			ExpAmnt = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,40,SysConst.PACKAGESPILTER))).doubleValue();
			PayMode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 41, SysConst.PACKAGESPILTER );
			ManageFeeRate = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,42,SysConst.PACKAGESPILTER))).doubleValue();
			PayIntv= new Integer(ChgData.chgNumericStr(StrTool.getStr(strMessage,43,SysConst.PACKAGESPILTER))).intValue();
			CValiDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 44,SysConst.PACKAGESPILTER));
			Peoples2= new Integer(ChgData.chgNumericStr(StrTool.getStr(strMessage,45,SysConst.PACKAGESPILTER))).intValue();
			Mult = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,46,SysConst.PACKAGESPILTER))).doubleValue();
			Prem = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,47,SysConst.PACKAGESPILTER))).doubleValue();
			Amnt = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,48,SysConst.PACKAGESPILTER))).doubleValue();
			SumPrem = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,49,SysConst.PACKAGESPILTER))).doubleValue();
			SumPay = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,50,SysConst.PACKAGESPILTER))).doubleValue();
			Dif = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,51,SysConst.PACKAGESPILTER))).doubleValue();
			State = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 52, SysConst.PACKAGESPILTER );
			...
			ApproveDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 55,SysConst.PACKAGESPILTER));
			...
			UWDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 59,SysConst.PACKAGESPILTER));
			...
			StandbyFlag1 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 63, SysConst.PACKAGESPILTER );
			StandbyFlag2 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 64, SysConst.PACKAGESPILTER );
			StandbyFlag3 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 65, SysConst.PACKAGESPILTER );
			Operator = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 66, SysConst.PACKAGESPILTER );
			MakeDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 67,SysConst.PACKAGESPILTER));
			MakeTime = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 68, SysConst.PACKAGESPILTER );
			ModifyDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 69,SysConst.PACKAGESPILTER));
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LCGeneralToRiskSchema other = (LCGeneralToRiskSchema)otherObject;
		return
