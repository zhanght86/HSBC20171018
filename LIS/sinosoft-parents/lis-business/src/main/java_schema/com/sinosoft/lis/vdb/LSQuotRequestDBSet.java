...
/*
 * <p>ClassName: LSQuotRequestDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: Physical Data Model 1
 */
public class LSQuotRequestDBSet extends LSQuotRequestSet
{
	// @Field
	...
	**/
	...
	// @Constructor
	public LSQuotRequestDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LSQuotRequestDBSet";
...
ex.printStackTrace();
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getRequestType() == null || this.get(i).getRequestType().equals("null")) {
				pstmt.setString(4,null);
			} else {
				pstmt.setString(4, this.get(i).getRequestType());
			}
			if(this.get(i).getOtherTypeDesc() == null || this.get(i).getOtherTypeDesc().equals("null")) {
				pstmt.setString(5,null);
			} else {
				pstmt.setString(5, this.get(i).getOtherTypeDesc());
			}
			...
			if(this.get(i).getRequestDesc() == null || this.get(i).getRequestDesc().equals("null")) {
				pstmt.setString(10,null);
			} else {
				pstmt.setString(10, this.get(i).getRequestDesc());
			}
			if(this.get(i).getSubUWOpinion() == null || this.get(i).getSubUWOpinion().equals("null")) {
				pstmt.setString(11,null);
			} else {
				pstmt.setString(11, this.get(i).getSubUWOpinion());
			}
			if(this.get(i).getBranchUWOpinion() == null || this.get(i).getBranchUWOpinion().equals("null")) {
				pstmt.setString(12,null);
			} else {
				pstmt.setString(12, this.get(i).getBranchUWOpinion());
			}
