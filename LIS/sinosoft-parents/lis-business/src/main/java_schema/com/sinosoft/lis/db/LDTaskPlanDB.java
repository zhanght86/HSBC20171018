...
{
private static Logger logger = Logger.getLogger(LDTaskPlanDB.class);
	...
	**/
	...
	public boolean update()
	{
		...
		try
		{
			...
			pstmt.setInt(6, this.getInterval());
			pstmt.setInt(7, this.getTimes());
			...
			if(this.getContabConfig() == null || this.getContabConfig().equals("null")) {
				pstmt.setNull(15, 12);
			} else {
				pstmt.setString(15, this.getContabConfig());
			}
			if(this.getPlanModeFlag() == null || this.getPlanModeFlag().equals("null")) {
				pstmt.setNull(16, 1);
			} else {
				pstmt.setString(16, this.getPlanModeFlag());
			}
			if(this.getActionAfterFail() == null || this.getActionAfterFail().equals("null")) {
				pstmt.setNull(17, 12);
			} else {
				pstmt.setString(17, this.getActionAfterFail());
			}
			// set where condition
			if(this.getTaskPlanCode() == null || this.getTaskPlanCode().equals("null")) {
				pstmt.setNull(18, 12);
			} else {
				pstmt.setString(18, this.getTaskPlanCode());
			}
			pstmt.executeUpdate();
			pstmt.close();
		} catch (Exception ex) {
	...
	public LDTaskPlanSet executeQuery(String sql)
	{
		Statement stmt = null;
		ResultSet rs = null;
		LDTaskPlanSet aLDTaskPlanSet = new LDTaskPlanSet();
	...
	public LDTaskPlanSet executeQuery(String sql, int nStart, int nCount)
	{
		Statement stmt = null;
		ResultSet rs = null;
		LDTaskPlanSet aLDTaskPlanSet = new LDTaskPlanSet();
...
public boolean closeData()
{
	...
	public LDTaskPlanSet executeQuery(SQLwithBindVariables sqlbv) {
	...
	public LDTaskPlanSet executeQuery(SQLwithBindVariables sqlbv, int nStart, int nCount) {
