...
/*
 * <p>ClassName: LOBGrpLinkDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: Physical Data Model 1
 */
public class LOBGrpLinkDBSet extends LOBGrpLinkSet
{
	// @Field
	...
	**/
	...
	// @Constructor
	public LOBGrpLinkDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LOBGrpLinkDBSet";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getBussType() == null || this.get(i).getBussType().equals("null")) {
				...
				pstmt.setString(25, this.get(i).getBussType());
			}
			if(this.get(i).getBussNo() == null || this.get(i).getBussNo().equals("null")) {
				pstmt.setString(26,null);
			} else {
				pstmt.setString(26, this.get(i).getBussNo());
			}
			if(this.get(i).getGrpContNo() == null || this.get(i).getGrpContNo().equals("null")) {
