...
/*
 * <p>ClassName: LPReturnLoanDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 再保
 */
public class LPReturnLoanDBSet extends LPReturnLoanSet
{
private static Logger logger = Logger.getLogger(LPReturnLoanDBSet.class);
	...
	**/
	...
	// @Constructor
	public LPReturnLoanDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LPReturnLoanDBSet";
	...
	public boolean delete()
	{
		...
		try
		{
			...
			if(this.get(i).getLoanNo() == null || this.get(i).getLoanNo().equals("null")) {
				...
				pstmt.setString(5, this.get(i).getLoanNo());
			}
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getLoanNo() == null || this.get(i).getLoanNo().equals("null")) {
				...
				pstmt.setString(26, this.get(i).getLoanNo());
			}
			pstmt.setDouble(27, this.get(i).getReturnMoney());
			pstmt.setDouble(28, this.get(i).getReturnInterest());
			if(this.get(i).getClmNo() == null || this.get(i).getClmNo().equals("null")) {
				pstmt.setString(29,null);
			} else {
				pstmt.setString(29, this.get(i).getClmNo());
			}
			if(this.get(i).getCurrency() == null || this.get(i).getCurrency().equals("null")) {
			...
			if(this.get(i).getContNo() == null || this.get(i).getContNo().equals("null")) {
				...
				pstmt.setString(31, this.get(i).getContNo());
			}
			if(this.get(i).getPolNo() == null || this.get(i).getPolNo().equals("null")) {
			...
			if(this.get(i).getLoanNo() == null || this.get(i).getLoanNo().equals("null")) {
				...
				pstmt.setString(35, this.get(i).getLoanNo());
			}
			if(this.get(i).getCurrency() == null || this.get(i).getCurrency().equals("null")) {
