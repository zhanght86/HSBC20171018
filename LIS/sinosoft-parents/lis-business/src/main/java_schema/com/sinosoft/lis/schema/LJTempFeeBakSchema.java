...
import com.sinosoft.lis.db.LJTempFeeBakDB;

/*
 * <p>ClassName: LJTempFeeBakSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: PhysicalDataModel_1
 */
public class LJTempFeeBakSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LJTempFeeBakSchema.class);
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LJTempFeeBakSchema cloned = (LJTempFeeBakSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LJTempFeeBakSchema 对象给 Schema 赋值
	* @param: aLJTempFeeBakSchema LJTempFeeBakSchema
	**/
	public void setSchema(LJTempFeeBakSchema aLJTempFeeBakSchema)
	{
		this.TempFeeNo = aLJTempFeeBakSchema.getTempFeeNo();
		this.TempFeeType = aLJTempFeeBakSchema.getTempFeeType();
		this.RiskCode = aLJTempFeeBakSchema.getRiskCode();
		this.PayIntv = aLJTempFeeBakSchema.getPayIntv();
		this.OtherNo = aLJTempFeeBakSchema.getOtherNo();
		this.OtherNoType = aLJTempFeeBakSchema.getOtherNoType();
		this.PayMoney = aLJTempFeeBakSchema.getPayMoney();
		this.PayDate = fDate.getDate( aLJTempFeeBakSchema.getPayDate());
		this.EnterAccDate = fDate.getDate( aLJTempFeeBakSchema.getEnterAccDate());
		this.ConfDate = fDate.getDate( aLJTempFeeBakSchema.getConfDate());
		this.ConfMakeDate = fDate.getDate( aLJTempFeeBakSchema.getConfMakeDate());
		this.ConfMakeTime = aLJTempFeeBakSchema.getConfMakeTime();
		this.SaleChnl = aLJTempFeeBakSchema.getSaleChnl();
		this.ManageCom = aLJTempFeeBakSchema.getManageCom();
		this.PolicyCom = aLJTempFeeBakSchema.getPolicyCom();
		this.AgentCom = aLJTempFeeBakSchema.getAgentCom();
		this.AgentType = aLJTempFeeBakSchema.getAgentType();
		this.APPntName = aLJTempFeeBakSchema.getAPPntName();
		this.AgentGroup = aLJTempFeeBakSchema.getAgentGroup();
		this.AgentCode = aLJTempFeeBakSchema.getAgentCode();
		this.ConfFlag = aLJTempFeeBakSchema.getConfFlag();
		this.SerialNo = aLJTempFeeBakSchema.getSerialNo();
		this.Operator = aLJTempFeeBakSchema.getOperator();
		this.State = aLJTempFeeBakSchema.getState();
		this.MakeTime = aLJTempFeeBakSchema.getMakeTime();
		this.MakeDate = fDate.getDate( aLJTempFeeBakSchema.getMakeDate());
		this.ModifyDate = fDate.getDate( aLJTempFeeBakSchema.getModifyDate());
		this.ModifyTime = aLJTempFeeBakSchema.getModifyTime();
		this.ContCom = aLJTempFeeBakSchema.getContCom();
		this.PayEndYear = aLJTempFeeBakSchema.getPayEndYear();
		this.OperState = aLJTempFeeBakSchema.getOperState();
		this.TempFeeNoType = aLJTempFeeBakSchema.getTempFeeNoType();
		this.StandPrem = aLJTempFeeBakSchema.getStandPrem();
		this.Remark = aLJTempFeeBakSchema.getRemark();
		this.Distict = aLJTempFeeBakSchema.getDistict();
		this.Department = aLJTempFeeBakSchema.getDepartment();
		this.BranchCode = aLJTempFeeBakSchema.getBranchCode();
		this.RiskType = aLJTempFeeBakSchema.getRiskType();
		this.PayYears = aLJTempFeeBakSchema.getPayYears();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LJTempFeeBak表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LJTempFeeBakSchema";
	...
	public LJTempFeeBakSchema getSchema()
	{
		LJTempFeeBakSchema aLJTempFeeBakSchema = new LJTempFeeBakSchema();
		aLJTempFeeBakSchema.setSchema(this);
		return aLJTempFeeBakSchema;
	}

	public LJTempFeeBakDB getDB()
	{
		LJTempFeeBakDB aDBOper = new LJTempFeeBakDB();
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLJTempFeeBak>历史记账凭证主表信息</A>表字段
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LJTempFeeBakSchema other = (LJTempFeeBakSchema)otherObject;
		return
