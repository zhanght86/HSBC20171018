...
import com.sinosoft.lis.db.LBPOInsuredListDB;

/*
 * <p>ClassName: LBPOInsuredListSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: Physical Data Model 1
 */
public class LBPOInsuredListSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LBPOInsuredListSchema.class);
	// @Field
	/** 流水号 */
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LBPOInsuredListSchema cloned = (LBPOInsuredListSchema)super.clone();
	...
	/**
	* 使用另外一个 LBPOInsuredListSchema 对象给 Schema 赋值
	* @param: aLBPOInsuredListSchema LBPOInsuredListSchema
	**/
	public void setSchema(LBPOInsuredListSchema aLBPOInsuredListSchema)
	{
		this.SerialNo = aLBPOInsuredListSchema.getSerialNo();
		this.GrpPropNo = aLBPOInsuredListSchema.getGrpPropNo();
		this.ActivityID = aLBPOInsuredListSchema.getActivityID();
		this.BatchNo = aLBPOInsuredListSchema.getBatchNo();
		this.OrderNo = aLBPOInsuredListSchema.getOrderNo();
		this.ContNo = aLBPOInsuredListSchema.getContNo();
		this.InsuredNo = aLBPOInsuredListSchema.getInsuredNo();
		this.InsuredID = aLBPOInsuredListSchema.getInsuredID();
		this.InsuredType = aLBPOInsuredListSchema.getInsuredType();
		this.InsuredTypeName = aLBPOInsuredListSchema.getInsuredTypeName();
		this.NumPeople = aLBPOInsuredListSchema.getNumPeople();
		this.RelationToMain = aLBPOInsuredListSchema.getRelationToMain();
		this.RelationToMainName = aLBPOInsuredListSchema.getRelationToMainName();
		this.MainInsuredID = aLBPOInsuredListSchema.getMainInsuredID();
		this.InsuredName = aLBPOInsuredListSchema.getInsuredName();
		this.IDType = aLBPOInsuredListSchema.getIDType();
		this.IDTypeName = aLBPOInsuredListSchema.getIDTypeName();
		this.IDNo = aLBPOInsuredListSchema.getIDNo();
		this.Gender = aLBPOInsuredListSchema.getGender();
		this.GenderName = aLBPOInsuredListSchema.getGenderName();
		this.Birthday = aLBPOInsuredListSchema.getBirthday();
		this.PlanCode = aLBPOInsuredListSchema.getPlanCode();
		this.PlanDesc = aLBPOInsuredListSchema.getPlanDesc();
		this.OccupCode = aLBPOInsuredListSchema.getOccupCode();
		this.OccupName = aLBPOInsuredListSchema.getOccupName();
		this.HeadBankCode = aLBPOInsuredListSchema.getHeadBankCode();
		this.HeadBankName = aLBPOInsuredListSchema.getHeadBankName();
		this.AccName = aLBPOInsuredListSchema.getAccName();
		this.BankAccNo = aLBPOInsuredListSchema.getBankAccNo();
		this.BankProvince = aLBPOInsuredListSchema.getBankProvince();
		this.BankProvinceName = aLBPOInsuredListSchema.getBankProvinceName();
		this.BankCity = aLBPOInsuredListSchema.getBankCity();
		this.BankCityName = aLBPOInsuredListSchema.getBankCityName();
		this.ServerArea = aLBPOInsuredListSchema.getServerArea();
		this.ServerAreaName = aLBPOInsuredListSchema.getServerAreaName();
		this.Substandard = aLBPOInsuredListSchema.getSubstandard();
		this.SubstandardName = aLBPOInsuredListSchema.getSubstandardName();
		this.SocialInsuFlag = aLBPOInsuredListSchema.getSocialInsuFlag();
		this.SocialInsuFlagName = aLBPOInsuredListSchema.getSocialInsuFlagName();
		this.Position = aLBPOInsuredListSchema.getPosition();
		this.PositionName = aLBPOInsuredListSchema.getPositionName();
		this.JoinCompDate = aLBPOInsuredListSchema.getJoinCompDate();
		this.Seniority = aLBPOInsuredListSchema.getSeniority();
		this.Salary = aLBPOInsuredListSchema.getSalary();
		this.GetYear = aLBPOInsuredListSchema.getGetYear();
		this.GetStartType = aLBPOInsuredListSchema.getGetStartType();
		this.GetStartTypeName = aLBPOInsuredListSchema.getGetStartTypeName();
		this.WorkIDNo = aLBPOInsuredListSchema.getWorkIDNo();
		this.IsLongValid = aLBPOInsuredListSchema.getIsLongValid();
		this.IsLongValidName = aLBPOInsuredListSchema.getIsLongValidName();
		this.IDEndDate = aLBPOInsuredListSchema.getIDEndDate();
		this.SubCompanyCode = aLBPOInsuredListSchema.getSubCompanyCode();
		this.DeptCode = aLBPOInsuredListSchema.getDeptCode();
		this.InsureCode = aLBPOInsuredListSchema.getInsureCode();
		this.SubCustomerNo = aLBPOInsuredListSchema.getSubCustomerNo();
		this.SubCustomerName = aLBPOInsuredListSchema.getSubCustomerName();
		this.WorkAddress = aLBPOInsuredListSchema.getWorkAddress();
		this.SocialInsuAddress = aLBPOInsuredListSchema.getSocialInsuAddress();
		this.ZipCode = aLBPOInsuredListSchema.getZipCode();
		this.EMail = aLBPOInsuredListSchema.getEMail();
		this.Wechat = aLBPOInsuredListSchema.getWechat();
		this.Phone = aLBPOInsuredListSchema.getPhone();
		this.Mobile = aLBPOInsuredListSchema.getMobile();
		this.Province = aLBPOInsuredListSchema.getProvince();
		this.ProvinceName = aLBPOInsuredListSchema.getProvinceName();
		this.City = aLBPOInsuredListSchema.getCity();
		this.CityName = aLBPOInsuredListSchema.getCityName();
		this.County = aLBPOInsuredListSchema.getCounty();
		this.CountyName = aLBPOInsuredListSchema.getCountyName();
		this.Address = aLBPOInsuredListSchema.getAddress();
		this.State = aLBPOInsuredListSchema.getState();
		this.Reason = aLBPOInsuredListSchema.getReason();
		this.ManageCom = aLBPOInsuredListSchema.getManageCom();
		this.ComCode = aLBPOInsuredListSchema.getComCode();
		this.MakeOperator = aLBPOInsuredListSchema.getMakeOperator();
		this.MakeDate = fDate.getDate( aLBPOInsuredListSchema.getMakeDate());
		this.MakeTime = aLBPOInsuredListSchema.getMakeTime();
		this.ModifyOperator = aLBPOInsuredListSchema.getModifyOperator();
		this.ModifyDate = fDate.getDate( aLBPOInsuredListSchema.getModifyDate());
		this.ModifyTime = aLBPOInsuredListSchema.getModifyTime();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LBPOInsuredList表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LBPOInsuredListSchema";
	...
	public LBPOInsuredListSchema getSchema()
	{
		LBPOInsuredListSchema aLBPOInsuredListSchema = new LBPOInsuredListSchema();
		aLBPOInsuredListSchema.setSchema(this);
		return aLBPOInsuredListSchema;
	}

	public LBPOInsuredListDB getDB()
	{
		LBPOInsuredListDB aDBOper = new LBPOInsuredListDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLBPOInsuredList描述/A>表字段
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLBPOInsuredList>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			InsuredType = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 9, SysConst.PACKAGESPILTER );
			InsuredTypeName = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 10, SysConst.PACKAGESPILTER );
			NumPeople = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 11, SysConst.PACKAGESPILTER );
			RelationToMain = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 12, SysConst.PACKAGESPILTER );
			RelationToMainName = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 13, SysConst.PACKAGESPILTER );
			MainInsuredID = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 14, SysConst.PACKAGESPILTER );
			...
			IDTypeName = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 17, SysConst.PACKAGESPILTER );
			IDNo = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 18, SysConst.PACKAGESPILTER );
			Gender = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 19, SysConst.PACKAGESPILTER );
			GenderName = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 20, SysConst.PACKAGESPILTER );
			Birthday = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 21, SysConst.PACKAGESPILTER );
			PlanCode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 22, SysConst.PACKAGESPILTER );
			PlanDesc = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 23, SysConst.PACKAGESPILTER );
			OccupCode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 24, SysConst.PACKAGESPILTER );
			OccupName = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 25, SysConst.PACKAGESPILTER );
			HeadBankCode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 26, SysConst.PACKAGESPILTER );
			HeadBankName = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 27, SysConst.PACKAGESPILTER );
			...
			BankProvince = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 30, SysConst.PACKAGESPILTER );
			BankProvinceName = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 31, SysConst.PACKAGESPILTER );
			BankCity = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 32, SysConst.PACKAGESPILTER );
			BankCityName = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 33, SysConst.PACKAGESPILTER );
			ServerArea = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 34, SysConst.PACKAGESPILTER );
			ServerAreaName = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 35, SysConst.PACKAGESPILTER );
			Substandard = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 36, SysConst.PACKAGESPILTER );
			SubstandardName = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 37, SysConst.PACKAGESPILTER );
			SocialInsuFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 38, SysConst.PACKAGESPILTER );
			SocialInsuFlagName = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 39, SysConst.PACKAGESPILTER );
			Position = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 40, SysConst.PACKAGESPILTER );
			PositionName = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 41, SysConst.PACKAGESPILTER );
			JoinCompDate = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 42, SysConst.PACKAGESPILTER );
			Seniority = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 43, SysConst.PACKAGESPILTER );
			Salary = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 44, SysConst.PACKAGESPILTER );
			GetYear = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 45, SysConst.PACKAGESPILTER );
			GetStartType = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 46, SysConst.PACKAGESPILTER );
			GetStartTypeName = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 47, SysConst.PACKAGESPILTER );
			WorkIDNo = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 48, SysConst.PACKAGESPILTER );
			IsLongValid = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 49, SysConst.PACKAGESPILTER );
			IsLongValidName = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 50, SysConst.PACKAGESPILTER );
			IDEndDate = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 51, SysConst.PACKAGESPILTER );
			SubCompanyCode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 52, SysConst.PACKAGESPILTER );
			DeptCode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 53, SysConst.PACKAGESPILTER );
			InsureCode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 54, SysConst.PACKAGESPILTER );
			SubCustomerNo = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 55, SysConst.PACKAGESPILTER );
			SubCustomerName = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 56, SysConst.PACKAGESPILTER );
			WorkAddress = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 57, SysConst.PACKAGESPILTER );
			SocialInsuAddress = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 58, SysConst.PACKAGESPILTER );
			ZipCode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 59, SysConst.PACKAGESPILTER );
			EMail = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 60, SysConst.PACKAGESPILTER );
			Wechat = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 61, SysConst.PACKAGESPILTER );
			Phone = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 62, SysConst.PACKAGESPILTER );
			Mobile = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 63, SysConst.PACKAGESPILTER );
			Province = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 64, SysConst.PACKAGESPILTER );
			ProvinceName = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 65, SysConst.PACKAGESPILTER );
			City = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 66, SysConst.PACKAGESPILTER );
			CityName = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 67, SysConst.PACKAGESPILTER );
			County = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 68, SysConst.PACKAGESPILTER );
			CountyName = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 69, SysConst.PACKAGESPILTER );
			Address = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 70, SysConst.PACKAGESPILTER );
			State = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 71, SysConst.PACKAGESPILTER );
			Reason = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 72, SysConst.PACKAGESPILTER );
			ManageCom = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 73, SysConst.PACKAGESPILTER );
			ComCode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 74, SysConst.PACKAGESPILTER );
			MakeOperator = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 75, SysConst.PACKAGESPILTER );
			MakeDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 76,SysConst.PACKAGESPILTER));
			MakeTime = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 77, SysConst.PACKAGESPILTER );
			ModifyOperator = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 78, SysConst.PACKAGESPILTER );
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LBPOInsuredListSchema other = (LBPOInsuredListSchema)otherObject;
		return
