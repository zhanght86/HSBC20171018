...
import com.sinosoft.lis.db.LMRiskDiscountDB;

/*
 * <p>ClassName: LMRiskDiscountSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 新险种定义
 */
public class LMRiskDiscountSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LMRiskDiscountSchema.class);
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LMRiskDiscountSchema cloned = (LMRiskDiscountSchema)super.clone();
	...
	/**
	* 使用另外一个 LMRiskDiscountSchema 对象给 Schema 赋值
	* @param: aLMRiskDiscountSchema LMRiskDiscountSchema
	**/
	public void setSchema(LMRiskDiscountSchema aLMRiskDiscountSchema)
	{
		this.RiskCode = aLMRiskDiscountSchema.getRiskCode();
		this.RiskPeriod = aLMRiskDiscountSchema.getRiskPeriod();
		this.PayIntv = aLMRiskDiscountSchema.getPayIntv();
		this.FloatRate = aLMRiskDiscountSchema.getFloatRate();
		this.SpecFlag = aLMRiskDiscountSchema.getSpecFlag();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LMRiskDiscount表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LMRiskDiscountSchema";
	...
	public LMRiskDiscountSchema getSchema()
	{
		LMRiskDiscountSchema aLMRiskDiscountSchema = new LMRiskDiscountSchema();
		aLMRiskDiscountSchema.setSchema(this);
		return aLMRiskDiscountSchema;
	}

	public LMRiskDiscountDB getDB()
	{
		LMRiskDiscountDB aDBOper = new LMRiskDiscountDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLMRiskDiscount描述/A>表字段
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLMRiskDiscount>历史记账凭证主表信息</A>表字段
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LMRiskDiscountSchema other = (LMRiskDiscountSchema)otherObject;
		return
