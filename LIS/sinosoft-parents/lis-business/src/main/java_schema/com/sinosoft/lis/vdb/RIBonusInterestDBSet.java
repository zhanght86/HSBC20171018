...
/*
 * <p>ClassName: RIBonusInterestDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 再保系统模型
 */
public class RIBonusInterestDBSet extends RIBonusInterestSet
{
	// @Field
	...
	**/
	...
	// @Constructor
	public RIBonusInterestDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "RIBonusInterestDBSet";
...
ex.printStackTrace();
	...
	public boolean update()
	{
		...
		try
		{
			...
			pstmt.setDouble(13, this.get(i).getSIMoney());
