...
/*
 * <p>ClassName: LCContBakDB </p>
 * <p>Description: DB层数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: PhysicalDataModel_1
 */
public class LCContBakDB extends LCContBakSchema
{
private static Logger logger = Logger.getLogger(LCContBakDB.class);
	...
	**/
	...
	// @Constructor
	public LCContBakDB( Connection tConnection )
	{
		con = tConnection;
	...
	{
		LCContBakSchema tSchema = this.getSchema();
	...
	public boolean getInfo()
	{
		...
		try
		{
			pstmt = con.prepareStatement("SELECT * FROM LCContBak WHERE  ContNo = ?", 
	...
	public LCContBakSet query()
	{
		PreparedStatement pstmt = null;
 		ResultSet rs = null;
		LCContBakSet aLCContBakSet = new LCContBakSet();
	  ...
	  if( !mflag ) {
		...
		{
			SQLString sqlObj = new SQLString("LCContBak");
			LCContBakSchema aSchema = this.getSchema();
			...
			{
				i++;
				LCContBakSchema s1 = new LCContBakSchema();
				s1.setSchema(rs,i);
				aLCContBakSet.add(s1);
			}
			try{ rs.close(); } catch( Exception ex ) {}
			try{ pstmt.close(); } catch( Exception ex1 ) {}
		}
		...
		return aLCContBakSet;

	}

	public LCContBakSet executeQuery(String sql)
	{
		Statement stmt = null;
		ResultSet rs = null;
		LCContBakSet aLCContBakSet = new LCContBakSet();
	...
	public LCContBakSet query(int nStart, int nCount)
	{
		PreparedStatement pstmt = null;
 		ResultSet rs = null;
		LCContBakSet aLCContBakSet = new LCContBakSet();
	...
	public LCContBakSet executeQuery(String sql, int nStart, int nCount)
	{
		Statement stmt = null;
		ResultSet rs = null;
		LCContBakSet aLCContBakSet = new LCContBakSet();
	...
	public boolean update(String strWherePart)
	{
	  ...
	  if( !mflag ) {
		...
		try
		{
			...
			String sql = "update LCContBak " + sqlObj.getUpdPart() + " where " + strWherePart;
 ...
 * @return LCContBakSet
 */
public LCContBakSet getData()
{
    int tCount = 0;
    LCContBakSet tLCContBakSet = new LCContBakSet();
    LCContBakSchema tLCContBakSchema = null;
    if (null == mResultSet)
    {
        CError tError = new CError();
        tError.moduleName = "LCContBakDB";
    ...
    {
        tCount = 1;
        tLCContBakSchema = new LCContBakSchema();
        tLCContBakSchema.setSchema(mResultSet, 1);
...
public boolean closeData()
{
	...
	public LCContBakSet executeQuery(SQLwithBindVariables sqlbv) {
	...
	public LCContBakSet executeQuery(SQLwithBindVariables sqlbv, int nStart, int nCount) {
