...
import com.sinosoft.lis.db.LOBPerInvestPlanDB;

/*
 * <p>ClassName: LOBPerInvestPlanSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: bug2
 */
public class LOBPerInvestPlanSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LOBPerInvestPlanSchema.class);
	// @Field
	/** 个人保单号 */
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LOBPerInvestPlanSchema cloned = (LOBPerInvestPlanSchema)super.clone();
	...
	/**
	* 使用另外一个 LOBPerInvestPlanSchema 对象给 Schema 赋值
	* @param: aLOBPerInvestPlanSchema LOBPerInvestPlanSchema
	**/
	public void setSchema(LOBPerInvestPlanSchema aLOBPerInvestPlanSchema)
	{
		this.ContNo = aLOBPerInvestPlanSchema.getContNo();
		this.PolNo = aLOBPerInvestPlanSchema.getPolNo();
		this.GrpPolNo = aLOBPerInvestPlanSchema.getGrpPolNo();
		this.GrpContNo = aLOBPerInvestPlanSchema.getGrpContNo();
		this.InsuredNo = aLOBPerInvestPlanSchema.getInsuredNo();
		this.RiskCode = aLOBPerInvestPlanSchema.getRiskCode();
		this.PayPlanCode = aLOBPerInvestPlanSchema.getPayPlanCode();
		this.InsuAccNo = aLOBPerInvestPlanSchema.getInsuAccNo();
		this.InvestMinRate = aLOBPerInvestPlanSchema.getInvestMinRate();
		this.InvestMaxRate = aLOBPerInvestPlanSchema.getInvestMaxRate();
		this.InputMode = aLOBPerInvestPlanSchema.getInputMode();
		this.InvestRate = aLOBPerInvestPlanSchema.getInvestRate();
		this.InvestMoney = aLOBPerInvestPlanSchema.getInvestMoney();
		this.Operator = aLOBPerInvestPlanSchema.getOperator();
		this.MakeDate = fDate.getDate( aLOBPerInvestPlanSchema.getMakeDate());
		this.MakeTime = aLOBPerInvestPlanSchema.getMakeTime();
		this.ModifyOperator = aLOBPerInvestPlanSchema.getModifyOperator();
		this.ModifyDate = fDate.getDate( aLOBPerInvestPlanSchema.getModifyDate());
		this.ModifyTime = aLOBPerInvestPlanSchema.getModifyTime();
		this.Currency = aLOBPerInvestPlanSchema.getCurrency();
		this.DutyCode = aLOBPerInvestPlanSchema.getDutyCode();
		this.RealInvestMoney = aLOBPerInvestPlanSchema.getRealInvestMoney();
		this.ManageCom = aLOBPerInvestPlanSchema.getManageCom();
		this.ComCode = aLOBPerInvestPlanSchema.getComCode();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LOBPerInvestPlan表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LOBPerInvestPlanSchema";
	...
	public LOBPerInvestPlanSchema getSchema()
	{
		LOBPerInvestPlanSchema aLOBPerInvestPlanSchema = new LOBPerInvestPlanSchema();
		aLOBPerInvestPlanSchema.setSchema(this);
		return aLOBPerInvestPlanSchema;
	}

	public LOBPerInvestPlanDB getDB()
	{
		LOBPerInvestPlanDB aDBOper = new LOBPerInvestPlanDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLOBPerInvestPlan描述/A>表字段
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLOBPerInvestPlan>历史记账凭证主表信息</A>表字段
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LOBPerInvestPlanSchema other = (LOBPerInvestPlanSchema)otherObject;
		return
