...
/*
 * <p>ClassName: LCUWMasterBakDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: PhysicalDataModel_1
 */
public class LCUWMasterBakDBSet extends LCUWMasterBakSet
{
private static Logger logger = Logger.getLogger(LCUWMasterBakDBSet.class);
	...
	**/
	...
	// @Constructor
	public LCUWMasterBakDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LCUWMasterBakDBSet";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getUpReport() == null || this.get(i).getUpReport().equals("null")) {
				...
				pstmt.setString(41, this.get(i).getUpReport());
			}
			pstmt.setInt(42, this.get(i).getBatchNo());
			if(this.get(i).getUWType() == null || this.get(i).getUWType().equals("null")) {
				pstmt.setString(43,null);
			} else {
				pstmt.setString(43, this.get(i).getUWType());
			}
			// set where condition
			if(this.get(i).getProposalNo() == null || this.get(i).getProposalNo().equals("null")) {
				pstmt.setString(44,null);
			} else {
				pstmt.setString(44, this.get(i).getProposalNo());
			}
