...
/*
 * <p>ClassName: RIBsnsBillBatchBakeDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 再保系统模型
 */
public class RIBsnsBillBatchBakeDBSet extends RIBsnsBillBatchBakeSet
{
	// @Field
	...
	**/
	...
	// @Constructor
	public RIBsnsBillBatchBakeDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public RIBsnsBillBatchBakeDBSet()
	{
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "RIBsnsBillBatchBakeDBSet";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getRIContNo() == null || this.get(i).getRIContNo().equals("null")) {
				...
				pstmt.setString(7, this.get(i).getRIContNo());
			}
			if(this.get(i).getBillTimes() == null || this.get(i).getBillTimes().equals("null")) {
				pstmt.setString(8,null);
			} else {
				pstmt.setString(8, this.get(i).getBillTimes());
			}
			...
			if(this.get(i).getUWOperator() == null || this.get(i).getUWOperator().equals("null")) {
				...
				pstmt.setString(11, this.get(i).getUWOperator());
			}
			if(this.get(i).getIdea() == null || this.get(i).getIdea().equals("null")) {
				pstmt.setString(12,null);
			} else {
				pstmt.setString(12, this.get(i).getIdea());
			}
			...
			if(this.get(i).getStandbyString1() == null || this.get(i).getStandbyString1().equals("null")) {
				...
				pstmt.setString(19, this.get(i).getStandbyString1());
			}
			if(this.get(i).getStandbyString2() == null || this.get(i).getStandbyString2().equals("null")) {
				pstmt.setString(20,null);
			} else {
				pstmt.setString(20, this.get(i).getStandbyString2());
			}
			if(this.get(i).getStandbyString3() == null || this.get(i).getStandbyString3().equals("null")) {
				pstmt.setString(21,null);
			} else {
				pstmt.setString(21, this.get(i).getStandbyString3());
			}
			// set where condition
			if(this.get(i).getBackupNo() == null || this.get(i).getBackupNo().equals("null")) {
				pstmt.setString(22,null);
			} else {
				pstmt.setString(22, this.get(i).getBackupNo());
			}
			if(this.get(i).getBatchNo() == null || this.get(i).getBatchNo().equals("null")) {
				pstmt.setString(23,null);
			} else {
				pstmt.setString(23, this.get(i).getBatchNo());
			}
			if(this.get(i).getBillNo() == null || this.get(i).getBillNo().equals("null")) {
				pstmt.setString(24,null);
			} else {
				pstmt.setString(24, this.get(i).getBillNo());
			}
			if(this.get(i).getCurrency() == null || this.get(i).getCurrency().equals("null")) {
