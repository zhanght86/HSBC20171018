...
/*
 * <p>ClassName: LDPlanRuleDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 基础信息
 */
public class LDPlanRuleDBSet extends LDPlanRuleSet
{
private static Logger logger = Logger.getLogger(LDPlanRuleDBSet.class);
	...
	**/
	...
	// @Constructor
	public LDPlanRuleDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LDPlanRuleDBSet";
	...
	public boolean delete()
	{
		...
		try
		{
			...
			if(this.get(i).getFactorySubCode() == null || this.get(i).getFactorySubCode().equals("null")) {
				pstmt.setString(4,null);
			} else {
				pstmt.setString(4, this.get(i).getFactorySubCode());
			}
			...
			if(this.get(i).getParamName() == null || this.get(i).getParamName().equals("null")) {
				...
				pstmt.setString(6, this.get(i).getParamName());
			}
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getFactorySubCode() == null || this.get(i).getFactorySubCode().equals("null")) {
				...
				pstmt.setString(5, this.get(i).getFactorySubCode());
			}
			if(this.get(i).getRuleCode() == null || this.get(i).getRuleCode().equals("null")) {
				pstmt.setString(6,null);
			} else {
			...
			if(this.get(i).getParam() == null || this.get(i).getParam().equals("null")) {
				...
				pstmt.setString(8, this.get(i).getParam());
			}
			...
			if(this.get(i).getFactoryType() == null || this.get(i).getFactoryType().equals("null")) {
				...
				pstmt.setString(15, this.get(i).getFactoryType());
			}
			if(this.get(i).getFactoryCode() == null || this.get(i).getFactoryCode().equals("null")) {
				pstmt.setString(16,null);
			} else {
				pstmt.setString(16, this.get(i).getFactoryCode());
			}
			if(this.get(i).getFactorySubCode() == null || this.get(i).getFactorySubCode().equals("null")) {
				pstmt.setString(17,null);
			} else {
				pstmt.setString(17, this.get(i).getFactorySubCode());
			}
			if(this.get(i).getRuleCode() == null || this.get(i).getRuleCode().equals("null")) {
				pstmt.setString(18,null);
			} else {
				pstmt.setString(18, this.get(i).getRuleCode());
			}
			if(this.get(i).getParamName() == null || this.get(i).getParamName().equals("null")) {
				pstmt.setString(19,null);
			} else {
				pstmt.setString(19, this.get(i).getParamName());
			}
