...
import com.sinosoft.lis.db.LCCustomerContactInfoDB;

/*
 * <p>ClassName: LCCustomerContactInfoSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 新单管理
 */
public class LCCustomerContactInfoSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LCCustomerContactInfoSchema.class);
	// @Field
	/** 团体保单号 */
	...
	// @Constructor
	public LCCustomerContactInfoSchema()
	{
		mErrors = new CErrors();
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LCCustomerContactInfoSchema cloned = (LCCustomerContactInfoSchema)super.clone();
	...
	/**
	* 使用另外一个 LCCustomerContactInfoSchema 对象给 Schema 赋值
	* @param: aLCCustomerContactInfoSchema LCCustomerContactInfoSchema
	**/
	public void setSchema(LCCustomerContactInfoSchema aLCCustomerContactInfoSchema)
	{
		this.PolicyNo = aLCCustomerContactInfoSchema.getPolicyNo();
		this.PropNo = aLCCustomerContactInfoSchema.getPropNo();
		this.ContNo = aLCCustomerContactInfoSchema.getContNo();
		this.CustomerNo = aLCCustomerContactInfoSchema.getCustomerNo();
		this.Province = aLCCustomerContactInfoSchema.getProvince();
		this.City = aLCCustomerContactInfoSchema.getCity();
		this.County = aLCCustomerContactInfoSchema.getCounty();
		this.PostalAddress = aLCCustomerContactInfoSchema.getPostalAddress();
		this.ZipCode = aLCCustomerContactInfoSchema.getZipCode();
		this.Phone = aLCCustomerContactInfoSchema.getPhone();
		this.Fax = aLCCustomerContactInfoSchema.getFax();
		this.HomeAddress = aLCCustomerContactInfoSchema.getHomeAddress();
		this.HomeZipCode = aLCCustomerContactInfoSchema.getHomeZipCode();
		this.HomePhone = aLCCustomerContactInfoSchema.getHomePhone();
		this.HomeFax = aLCCustomerContactInfoSchema.getHomeFax();
		this.CompanyName = aLCCustomerContactInfoSchema.getCompanyName();
		this.CompanyAddress = aLCCustomerContactInfoSchema.getCompanyAddress();
		this.CompanyZipCode = aLCCustomerContactInfoSchema.getCompanyZipCode();
		this.CompanyPhone = aLCCustomerContactInfoSchema.getCompanyPhone();
		this.CompanyFax = aLCCustomerContactInfoSchema.getCompanyFax();
		this.Mobile1 = aLCCustomerContactInfoSchema.getMobile1();
		this.EMail1 = aLCCustomerContactInfoSchema.getEMail1();
		this.QQ1 = aLCCustomerContactInfoSchema.getQQ1();
		this.MSN1 = aLCCustomerContactInfoSchema.getMSN1();
		this.Wechat1 = aLCCustomerContactInfoSchema.getWechat1();
		this.Mobile2 = aLCCustomerContactInfoSchema.getMobile2();
		this.EMail2 = aLCCustomerContactInfoSchema.getEMail2();
		this.QQ2 = aLCCustomerContactInfoSchema.getQQ2();
		this.MSN2 = aLCCustomerContactInfoSchema.getMSN2();
		this.Wechat2 = aLCCustomerContactInfoSchema.getWechat2();
		this.MakeOperator = aLCCustomerContactInfoSchema.getMakeOperator();
		this.MakeDate = fDate.getDate( aLCCustomerContactInfoSchema.getMakeDate());
		this.MakeTime = aLCCustomerContactInfoSchema.getMakeTime();
		this.ModifyOperator = aLCCustomerContactInfoSchema.getModifyOperator();
		this.ModifyDate = fDate.getDate( aLCCustomerContactInfoSchema.getModifyDate());
		this.ModifyTime = aLCCustomerContactInfoSchema.getModifyTime();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LCCustomerContactInfo表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LCCustomerContactInfoSchema";
	...
	public LCCustomerContactInfoSchema getSchema()
	{
		LCCustomerContactInfoSchema aLCCustomerContactInfoSchema = new LCCustomerContactInfoSchema();
		aLCCustomerContactInfoSchema.setSchema(this);
		return aLCCustomerContactInfoSchema;
	}

	public LCCustomerContactInfoDB getDB()
	{
		LCCustomerContactInfoDB aDBOper = new LCCustomerContactInfoDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLCCustomerContactInfo描述/A>表字段
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLCCustomerContactInfo>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			Province = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 5, SysConst.PACKAGESPILTER );
			City = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 6, SysConst.PACKAGESPILTER );
			County = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 7, SysConst.PACKAGESPILTER );
			...
			HomeAddress = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 12, SysConst.PACKAGESPILTER );
			HomeZipCode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 13, SysConst.PACKAGESPILTER );
			HomePhone = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 14, SysConst.PACKAGESPILTER );
			HomeFax = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 15, SysConst.PACKAGESPILTER );
			CompanyName = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 16, SysConst.PACKAGESPILTER );
			CompanyAddress = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 17, SysConst.PACKAGESPILTER );
			CompanyZipCode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 18, SysConst.PACKAGESPILTER );
			CompanyPhone = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 19, SysConst.PACKAGESPILTER );
			CompanyFax = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 20, SysConst.PACKAGESPILTER );
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LCCustomerContactInfoSchema other = (LCCustomerContactInfoSchema)otherObject;
		return
