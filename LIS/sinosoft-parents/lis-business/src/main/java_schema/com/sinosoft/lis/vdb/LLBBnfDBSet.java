...
/*
 * <p>ClassName: LLBBnfDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 多币种改造业务表
 */
public class LLBBnfDBSet extends LLBBnfSet
{
private static Logger logger = Logger.getLogger(LLBBnfDBSet.class);
	...
	**/
	...
	// @Constructor
	public LLBBnfDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean delete()
	{
		...
		try
		{
			...
			if(this.get(i).getFeeOperationType() == null || this.get(i).getFeeOperationType().equals("null")) {
				...
				pstmt.setString(9, this.get(i).getFeeOperationType());
			}
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getGrpPolNo() == null || this.get(i).getGrpPolNo().equals("null")) {
				...
				pstmt.setString(8, this.get(i).getGrpPolNo());
			}
			...
			if(this.get(i).getBnfKind() == null || this.get(i).getBnfKind().equals("null")) {
				...
				pstmt.setString(10, this.get(i).getBnfKind());
			}
			if(this.get(i).getPolNo() == null || this.get(i).getPolNo().equals("null")) {
			...
			if(this.get(i).getSex() == null || this.get(i).getSex().equals("null")) {
				...
				pstmt.setString(19, this.get(i).getSex());
			}
			if(this.get(i).getBirthday() == null || this.get(i).getBirthday().equals("null")) {
				pstmt.setDate(20,null);
			} else {
				pstmt.setDate(20, Date.valueOf(this.get(i).getBirthday()));
			}
			...
			if(this.get(i).getNBPolNo() == null || this.get(i).getNBPolNo().equals("null")) {
				...
				pstmt.setString(48, this.get(i).getNBPolNo());
			}
			if(this.get(i).getFeeOperationType() == null || this.get(i).getFeeOperationType().equals("null")) {
				pstmt.setString(49,null);
			} else {
				pstmt.setString(49, this.get(i).getFeeOperationType());
			}
			if(this.get(i).getCurrency() == null || this.get(i).getCurrency().equals("null")) {
			...
			if(this.get(i).getBackNo() == null || this.get(i).getBackNo().equals("null")) {
				...
				pstmt.setString(51, this.get(i).getBackNo());
			}
			if(this.get(i).getClmNo() == null || this.get(i).getClmNo().equals("null")) {
				pstmt.setString(52,null);
			} else {
				pstmt.setString(52, this.get(i).getClmNo());
			}
			if(this.get(i).getCaseNo() == null || this.get(i).getCaseNo().equals("null")) {
				pstmt.setString(53,null);
			} else {
				pstmt.setString(53, this.get(i).getCaseNo());
			}
			if(this.get(i).getBatNo() == null || this.get(i).getBatNo().equals("null")) {
				pstmt.setString(54,null);
			} else {
				pstmt.setString(54, this.get(i).getBatNo());
			}
			if(this.get(i).getBnfKind() == null || this.get(i).getBnfKind().equals("null")) {
				pstmt.setString(55,null);
			} else {
				pstmt.setString(55, this.get(i).getBnfKind());
			}
			if(this.get(i).getPolNo() == null || this.get(i).getPolNo().equals("null")) {
			...
			if(this.get(i).getInsuredNo() == null || this.get(i).getInsuredNo().equals("null")) {
				...
				pstmt.setString(57, this.get(i).getInsuredNo());
			}
			if(this.get(i).getBnfNo() == null || this.get(i).getBnfNo().equals("null")) {
				pstmt.setString(58,null);
			} else {
				pstmt.setString(58, this.get(i).getBnfNo());
			}
			if(this.get(i).getFeeOperationType() == null || this.get(i).getFeeOperationType().equals("null")) {
				pstmt.setString(59,null);
			} else {
				pstmt.setString(59, this.get(i).getFeeOperationType());
			}
			if(this.get(i).getCurrency() == null || this.get(i).getCurrency().equals("null")) {
