...
import com.sinosoft.lis.db.LCClaimFactorControlDB;

/*
 * <p>ClassName: LCClaimFactorControlSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: Physical Data Model 1
 */
public class LCClaimFactorControlSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LCClaimFactorControlSchema.class);
	// @Field
	/** 保单号 */
	...
	// @Constructor
	public LCClaimFactorControlSchema()
	{
		mErrors = new CErrors();
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LCClaimFactorControlSchema cloned = (LCClaimFactorControlSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LCClaimFactorControlSchema 对象给 Schema 赋值
	* @param: aLCClaimFactorControlSchema LCClaimFactorControlSchema
	**/
	public void setSchema(LCClaimFactorControlSchema aLCClaimFactorControlSchema)
	{
		this.PolicyNo = aLCClaimFactorControlSchema.getPolicyNo();
		this.SysPlanCode = aLCClaimFactorControlSchema.getSysPlanCode();
		this.PlanCode = aLCClaimFactorControlSchema.getPlanCode();
		this.RiskCode = aLCClaimFactorControlSchema.getRiskCode();
		this.DutyCode = aLCClaimFactorControlSchema.getDutyCode();
		this.FactorAttribute = aLCClaimFactorControlSchema.getFactorAttribute();
		this.FactorType = aLCClaimFactorControlSchema.getFactorType();
		this.FactorCode = aLCClaimFactorControlSchema.getFactorCode();
		this.InerSerialNo = aLCClaimFactorControlSchema.getInerSerialNo();
		this.CalSQL = aLCClaimFactorControlSchema.getCalSQL();
		this.Params = aLCClaimFactorControlSchema.getParams();
		this.MakeOperator = aLCClaimFactorControlSchema.getMakeOperator();
		this.MakeDate = fDate.getDate( aLCClaimFactorControlSchema.getMakeDate());
		this.MakeTime = aLCClaimFactorControlSchema.getMakeTime();
		this.ModifyOperator = aLCClaimFactorControlSchema.getModifyOperator();
		this.ModifyDate = fDate.getDate( aLCClaimFactorControlSchema.getModifyDate());
		this.ModifyTime = aLCClaimFactorControlSchema.getModifyTime();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LCClaimFactorControl表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LCClaimFactorControlSchema";
	...
	public LCClaimFactorControlSchema getSchema()
	{
		LCClaimFactorControlSchema aLCClaimFactorControlSchema = new LCClaimFactorControlSchema();
		aLCClaimFactorControlSchema.setSchema(this);
		return aLCClaimFactorControlSchema;
	}

	public LCClaimFactorControlDB getDB()
	{
		LCClaimFactorControlDB aDBOper = new LCClaimFactorControlDB();
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLCClaimFactorControl>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			FactorAttribute = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 6, SysConst.PACKAGESPILTER );
			...
			InerSerialNo= new Integer(ChgData.chgNumericStr(StrTool.getStr(strMessage,9,SysConst.PACKAGESPILTER))).intValue();
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LCClaimFactorControlSchema other = (LCClaimFactorControlSchema)otherObject;
		return
