...
import com.sinosoft.lis.db.LPAppUWSubMainDB;

/*
 * <p>ClassName: LPAppUWSubMainSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 保全流程
 */
public class LPAppUWSubMainSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LPAppUWSubMainSchema.class);
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LPAppUWSubMainSchema cloned = (LPAppUWSubMainSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LPAppUWSubMainSchema 对象给 Schema 赋值
	* @param: aLPAppUWSubMainSchema LPAppUWSubMainSchema
	**/
	public void setSchema(LPAppUWSubMainSchema aLPAppUWSubMainSchema)
	{
		this.EdorAcceptNo = aLPAppUWSubMainSchema.getEdorAcceptNo();
		this.OtherNo = aLPAppUWSubMainSchema.getOtherNo();
		this.OtherNoType = aLPAppUWSubMainSchema.getOtherNoType();
		this.UWNo = aLPAppUWSubMainSchema.getUWNo();
		this.PassFlag = aLPAppUWSubMainSchema.getPassFlag();
		this.UWGrade = aLPAppUWSubMainSchema.getUWGrade();
		this.AppGrade = aLPAppUWSubMainSchema.getAppGrade();
		this.PostponeDay = aLPAppUWSubMainSchema.getPostponeDay();
		this.PostponeDate = fDate.getDate( aLPAppUWSubMainSchema.getPostponeDate());
		this.AutoUWFlag = aLPAppUWSubMainSchema.getAutoUWFlag();
		this.State = aLPAppUWSubMainSchema.getState();
		this.ManageCom = aLPAppUWSubMainSchema.getManageCom();
		this.UWIdea = aLPAppUWSubMainSchema.getUWIdea();
		this.UpReportContent = aLPAppUWSubMainSchema.getUpReportContent();
		this.Operator = aLPAppUWSubMainSchema.getOperator();
		this.HealthFlag = aLPAppUWSubMainSchema.getHealthFlag();
		this.QuesFlag = aLPAppUWSubMainSchema.getQuesFlag();
		this.SpecFlag = aLPAppUWSubMainSchema.getSpecFlag();
		this.AddPremFlag = aLPAppUWSubMainSchema.getAddPremFlag();
		this.AddPremReason = aLPAppUWSubMainSchema.getAddPremReason();
		this.ReportFlag = aLPAppUWSubMainSchema.getReportFlag();
		this.PrintFlag = aLPAppUWSubMainSchema.getPrintFlag();
		this.PrintFlag2 = aLPAppUWSubMainSchema.getPrintFlag2();
		this.SpecReason = aLPAppUWSubMainSchema.getSpecReason();
		this.MakeDate = fDate.getDate( aLPAppUWSubMainSchema.getMakeDate());
		this.MakeTime = aLPAppUWSubMainSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLPAppUWSubMainSchema.getModifyDate());
		this.ModifyTime = aLPAppUWSubMainSchema.getModifyTime();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LPAppUWSubMain表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LPAppUWSubMainSchema";
	...
	public LPAppUWSubMainSchema getSchema()
	{
		LPAppUWSubMainSchema aLPAppUWSubMainSchema = new LPAppUWSubMainSchema();
		aLPAppUWSubMainSchema.setSchema(this);
		return aLPAppUWSubMainSchema;
	}

	public LPAppUWSubMainDB getDB()
	{
		LPAppUWSubMainDB aDBOper = new LPAppUWSubMainDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLPAppUWSubMain描述/A>表字段
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLPAppUWSubMain>历史记账凭证主表信息</A>表字段
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LPAppUWSubMainSchema other = (LPAppUWSubMainSchema)otherObject;
		return
