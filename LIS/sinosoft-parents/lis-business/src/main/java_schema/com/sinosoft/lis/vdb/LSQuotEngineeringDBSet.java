...
/*
 * <p>ClassName: LSQuotEngineeringDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: Physical Data Model 1
 */
public class LSQuotEngineeringDBSet extends LSQuotEngineeringSet
{
	// @Field
	...
	**/
	...
	// @Constructor
	public LSQuotEngineeringDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LSQuotEngineeringDBSet";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getEnginDays() == null || this.get(i).getEnginDays().equals("null")) {
				...
				pstmt.setString(25, this.get(i).getEnginDays());
			}
			pstmt.setDouble(26, this.get(i).getMinEnginArea());
			pstmt.setDouble(27, this.get(i).getMinEnginCost());
			// set where condition
			if(this.get(i).getQuotNo() == null || this.get(i).getQuotNo().equals("null")) {
			...
			if(this.get(i).getSysPlanCode() == null || this.get(i).getSysPlanCode().equals("null")) {
				...
				pstmt.setString(30, this.get(i).getSysPlanCode());
			}
			if(this.get(i).getPlanCode() == null || this.get(i).getPlanCode().equals("null")) {
				pstmt.setString(31,null);
			} else {
				pstmt.setString(31, this.get(i).getPlanCode());
			}
