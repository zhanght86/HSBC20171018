...
/*
 * <p>ClassName: LLReportReasonSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 理赔管理
 */
public class LLReportReasonSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LLReportReasonSchema.class);
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LLReportReasonSchema cloned = (LLReportReasonSchema)super.clone();
	...
	*/
	...
	public void setRpNo(String aRpNo)
	{
		RpNo = aRpNo;
	}
	...
	*/
	...
	/**
	* 使用另外一个 LLReportReasonSchema 对象给 Schema 赋值
	* @param: aLLReportReasonSchema LLReportReasonSchema
	**/
	public void setSchema(LLReportReasonSchema aLLReportReasonSchema)
	{
		this.RpNo = aLLReportReasonSchema.getRpNo();
		this.CustomerNo = aLLReportReasonSchema.getCustomerNo();
		this.ReasonCode = aLLReportReasonSchema.getReasonCode();
		this.ReasonType = aLLReportReasonSchema.getReasonType();
		this.Reason = aLLReportReasonSchema.getReason();
		this.AffixGetDate = fDate.getDate( aLLReportReasonSchema.getAffixGetDate());
		this.MngCom = aLLReportReasonSchema.getMngCom();
		this.Operator = aLLReportReasonSchema.getOperator();
		this.MakeDate = fDate.getDate( aLLReportReasonSchema.getMakeDate());
		this.MakeTime = aLLReportReasonSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLLReportReasonSchema.getModifyDate());
		this.ModifyTime = aLLReportReasonSchema.getModifyTime();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			//rs.absolute(i);		// 非滚动游标
			if( rs.getString("RpNo") == null )
				this.RpNo = null;
			else
				this.RpNo = rs.getString("RpNo").trim();
		...
		{
			logger.debug("数据库中的LLReportReason表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LLReportReasonSchema";
	...
	public LLReportReasonSchema getSchema()
	{
		LLReportReasonSchema aLLReportReasonSchema = new LLReportReasonSchema();
		aLLReportReasonSchema.setSchema(this);
		return aLLReportReasonSchema;
	}

	public LLReportReasonDB getDB()
	{
		LLReportReasonDB aDBOper = new LLReportReasonDB();
	...
	**/
	public String encode()
	{
		...
		strReturn.append(StrTool.cTrim(RpNo)); strReturn.append(SysConst.PACKAGESPILTER);
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLLReportReason>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			RpNo = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 1, SysConst.PACKAGESPILTER );
			CustomerNo = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 2, SysConst.PACKAGESPILTER );
			ReasonCode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 3, SysConst.PACKAGESPILTER );
			ReasonType = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 4, SysConst.PACKAGESPILTER );
			Reason = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 5, SysConst.PACKAGESPILTER );
			AffixGetDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 6,SysConst.PACKAGESPILTER));
			MngCom = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 7, SysConst.PACKAGESPILTER );
	...
	**/
	...
	{
		String strReturn = "";
		if (FCode.equalsIgnoreCase("RpNo"))
		{
			strReturn = StrTool.GBKToUnicode(String.valueOf(RpNo));
		}
	...
	**/
	public String getV(int nFieldIndex)
	{
		...
		switch(nFieldIndex) {
			case 0:
				strFieldValue = StrTool.GBKToUnicode(RpNo);
				break;
			case 1:
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LLReportReasonSchema other = (LLReportReasonSchema)otherObject;
		return
			RpNo.equals(other.getRpNo())
