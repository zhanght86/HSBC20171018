...
/*
 * <p>ClassName: LLUWPremSubDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 理赔管理
 */
public class LLUWPremSubDBSet extends LLUWPremSubSet
{
private static Logger logger = Logger.getLogger(LLUWPremSubDBSet.class);
	...
	**/
	...
	// @Constructor
	public LLUWPremSubDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LLUWPremSubDBSet";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getBatNo() == null || this.get(i).getBatNo().equals("null")) {
				...
				pstmt.setString(41, this.get(i).getBatNo());
			}
			if(this.get(i).getPolNo() == null || this.get(i).getPolNo().equals("null")) {
