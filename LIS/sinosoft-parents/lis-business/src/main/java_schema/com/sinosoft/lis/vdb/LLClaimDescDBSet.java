...
/*
 * <p>ClassName: LLClaimDescDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 理赔管理
 */
public class LLClaimDescDBSet extends LLClaimDescSet
{
private static Logger logger = Logger.getLogger(LLClaimDescDBSet.class);
	...
	**/
	...
	// @Constructor
	public LLClaimDescDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LLClaimDescDBSet";
	...
	public boolean delete()
	{
		...
		try
		{
			...
			if(this.get(i).getDescNo() == null || this.get(i).getDescNo().equals("null")) {
				pstmt.setString(2,null);
			} else {
				pstmt.setString(2, this.get(i).getDescNo());
			}
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getStartPhase() == null || this.get(i).getStartPhase().equals("null")) {
				...
				pstmt.setString(4, this.get(i).getStartPhase());
			}
			if(this.get(i).getDescType() == null || this.get(i).getDescType().equals("null")) {
				pstmt.setString(5,null);
			} else {
				pstmt.setString(5, this.get(i).getDescType());
			}
			if(this.get(i).getDescribe() == null || this.get(i).getDescribe().equals("null")) {
				pstmt.setString(6,null);
			} else {
				pstmt.setString(6, this.get(i).getDescribe());
			}
			...
			if(this.get(i).getDescNo() == null || this.get(i).getDescNo().equals("null")) {
				...
				pstmt.setString(11, this.get(i).getDescNo());
			}
