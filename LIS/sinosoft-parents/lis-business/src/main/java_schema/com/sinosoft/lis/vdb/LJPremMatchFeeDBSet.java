...
/*
 * <p>ClassName: LJPremMatchFeeDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: Physical Data Model 1
 */
public class LJPremMatchFeeDBSet extends LJPremMatchFeeSet
{
	// @Field
	...
	**/
	...
	// @Constructor
	public LJPremMatchFeeDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LJPremMatchFeeDBSet";
	...
	public boolean delete()
	{
		...
		try
		{
			...
			if(this.get(i).getDataSource() == null || this.get(i).getDataSource().equals("null")) {
				...
				pstmt.setString(2, this.get(i).getDataSource());
			}
			if(this.get(i).getSourceNo() == null || this.get(i).getSourceNo().equals("null")) {
				pstmt.setString(3,null);
			} else {
				pstmt.setString(3, this.get(i).getSourceNo());
			}
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getBussNo() == null || this.get(i).getBussNo().equals("null")) {
				...
				pstmt.setString(6, this.get(i).getBussNo());
			}
			if(this.get(i).getCustBankCode() == null || this.get(i).getCustBankCode().equals("null")) {
				pstmt.setString(7,null);
			} else {
				pstmt.setString(7, this.get(i).getCustBankCode());
			}
			...
			pstmt.setDouble(16, this.get(i).getCurOutPayMoney());
			...
			if(this.get(i).getMatchSerialNo() == null || this.get(i).getMatchSerialNo().equals("null")) {
				...
				pstmt.setString(25, this.get(i).getMatchSerialNo());
			}
			if(this.get(i).getDataSource() == null || this.get(i).getDataSource().equals("null")) {
				pstmt.setString(26,null);
			} else {
				pstmt.setString(26, this.get(i).getDataSource());
			}
			if(this.get(i).getSourceNo() == null || this.get(i).getSourceNo().equals("null")) {
				pstmt.setString(27,null);
			} else {
				pstmt.setString(27, this.get(i).getSourceNo());
			}
