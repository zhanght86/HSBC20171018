...
/*
 * <p>ClassName: PD_LMCalModeDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 产品定义平台_PDM
 */
public class PD_LMCalModeDBSet extends PD_LMCalModeSet
{
private static Logger logger = Logger.getLogger(PD_LMCalModeDBSet.class);
	...
	**/
	...
	// @Constructor
	public PD_LMCalModeDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "PD_LMCalModeDBSet";
