...
/*
 * <p>ClassName: LBPayRuleFactoryDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 寿险业务系统未整理模型
 */
public class LBPayRuleFactoryDBSet extends LBPayRuleFactorySet
{
private static Logger logger = Logger.getLogger(LBPayRuleFactoryDBSet.class);
	...
	**/
	...
	// @Constructor
	public LBPayRuleFactoryDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LBPayRuleFactoryDBSet";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getPayRuleCode() == null || this.get(i).getPayRuleCode().equals("null")) {
				...
				pstmt.setString(5, this.get(i).getPayRuleCode());
			}
			if(this.get(i).getPayRuleName() == null || this.get(i).getPayRuleName().equals("null")) {
				pstmt.setString(6,null);
			} else {
				pstmt.setString(6, this.get(i).getPayRuleName());
			}
			if(this.get(i).getFactoryType() == null || this.get(i).getFactoryType().equals("null")) {
				pstmt.setString(7,null);
			} else {
			...
			if(this.get(i).getFactoryName() == null || this.get(i).getFactoryName().equals("null")) {
				...
				pstmt.setString(11, this.get(i).getFactoryName());
			}
			if(this.get(i).getInerSerialNo() == null || this.get(i).getInerSerialNo().equals("null")) {
				pstmt.setString(12,null);
			} else {
				pstmt.setString(12, this.get(i).getInerSerialNo());
			}
			if(this.get(i).getCalSql() == null || this.get(i).getCalSql().equals("null")) {
				pstmt.setString(13,null);
			} else {
				pstmt.setString(13, this.get(i).getCalSql());
			}
			if(this.get(i).getParams() == null || this.get(i).getParams().equals("null")) {
				pstmt.setString(14,null);
			} else {
				pstmt.setString(14, this.get(i).getParams());
			}
			if(this.get(i).getCalRemark() == null || this.get(i).getCalRemark().equals("null")) {
				pstmt.setString(15,null);
			} else {
				pstmt.setString(15, this.get(i).getCalRemark());
			}
			...
			if(this.get(i).getPayRuleCode() == null || this.get(i).getPayRuleCode().equals("null")) {
				...
				pstmt.setString(22, this.get(i).getPayRuleCode());
			}
			if(this.get(i).getFactoryType() == null || this.get(i).getFactoryType().equals("null")) {
