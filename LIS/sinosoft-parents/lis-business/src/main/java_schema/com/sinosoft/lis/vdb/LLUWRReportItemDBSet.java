...
/*
 * <p>ClassName: LLUWRReportItemDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 泰康未整理PDM
 */
public class LLUWRReportItemDBSet extends LLUWRReportItemSet
{
	// @Field
	...
	**/
	...
	// @Constructor
	public LLUWRReportItemDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LLUWRReportItemDBSet";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getClmNo() == null || this.get(i).getClmNo().equals("null")) {
				...
				pstmt.setString(10, this.get(i).getClmNo());
			}
			if(this.get(i).getProposalContNo() == null || this.get(i).getProposalContNo().equals("null")) {
