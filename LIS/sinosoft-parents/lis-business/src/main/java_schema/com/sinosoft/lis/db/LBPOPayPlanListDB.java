...
/*
 * <p>ClassName: LBPOPayPlanListDB </p>
 * <p>Description: DB层数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: Physical Data Model 1
 */
public class LBPOPayPlanListDB extends LBPOPayPlanListSchema
{
	// @Field
	...
	**/
	...
	// @Constructor
	public LBPOPayPlanListDB( Connection tConnection )
	{
		con = tConnection;
	...
	{
		LBPOPayPlanListSchema tSchema = this.getSchema();
		...
		else
		{
			...
			tError.moduleName = "LBPOPayPlanListDB";
	...
	public boolean getInfo()
	{
		...
		try
		{
			pstmt = con.prepareStatement("SELECT * FROM LBPOPayPlanList WHERE  SerialNo = ?", 
	...
	public LBPOPayPlanListSet query()
	{
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		LBPOPayPlanListSet aLBPOPayPlanListSet = new LBPOPayPlanListSet();
	  ...
	  if( !mflag ) {
		...
		{
			SQLString sqlObj = new SQLString("LBPOPayPlanList");
			LBPOPayPlanListSchema aSchema = this.getSchema();
			...
			{
				i++;
				LBPOPayPlanListSchema s1 = new LBPOPayPlanListSchema();
				s1.setSchema(rs,i);
				aLBPOPayPlanListSet.add(s1);
			}
			try{ rs.close(); } catch( Exception ex ) {}
			try{ pstmt.close(); } catch( Exception ex1 ) {}
		}
		...
		return aLBPOPayPlanListSet;
	}

	public LBPOPayPlanListSet executeQuery(String sql)
	{
		Statement stmt = null;
		ResultSet rs = null;
		LBPOPayPlanListSet aLBPOPayPlanListSet = new LBPOPayPlanListSet();
	...
	public LBPOPayPlanListSet query(int nStart, int nCount)
	{
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		LBPOPayPlanListSet aLBPOPayPlanListSet = new LBPOPayPlanListSet();
	...
	public LBPOPayPlanListSet executeQuery(String sql, int nStart, int nCount)
	{
		Statement stmt = null;
		ResultSet rs = null;
		LBPOPayPlanListSet aLBPOPayPlanListSet = new LBPOPayPlanListSet();
	...
	public boolean update(String strWherePart)
	{
	  ...
	  if( !mflag ) {
		...
		try
		{
			...
			String sql = "update LBPOPayPlanList " + sqlObj.getUpdPart() + " where " + strWherePart;
...
/**
 * 获取定量数据
 * @return LBPOPayPlanListSet
 */
public LBPOPayPlanListSet getData()
{
    int tCount = 0;
    LBPOPayPlanListSet tLBPOPayPlanListSet = new LBPOPayPlanListSet();
    LBPOPayPlanListSchema tLBPOPayPlanListSchema = null;
    if (null == mResultSet)
    {
        CError tError = new CError();
        tError.moduleName = "LBPOPayPlanListDB";
    ...
    {
        tCount = 1;
        tLBPOPayPlanListSchema = new LBPOPayPlanListSchema();
        tLBPOPayPlanListSchema.setSchema(mResultSet, 1);
        tLBPOPayPlanListSet.add(tLBPOPayPlanListSchema);
...
public boolean closeData()
{
	...
	public LBPOPayPlanListSet executeQuery(SQLwithBindVariables sqlbv) {
	...
	public LBPOPayPlanListSet executeQuery(SQLwithBindVariables sqlbv, int nStart, int nCount) {
