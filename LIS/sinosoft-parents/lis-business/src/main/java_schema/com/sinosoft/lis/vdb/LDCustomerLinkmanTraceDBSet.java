...
/*
 * <p>ClassName: LDCustomerLinkmanTraceDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 客户管理
 */
public class LDCustomerLinkmanTraceDBSet extends LDCustomerLinkmanTraceSet
{
	// @Field
	...
	**/
	...
	// @Constructor
	public LDCustomerLinkmanTraceDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public LDCustomerLinkmanTraceDBSet()
	{
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LDCustomerLinkmanTraceDBSet";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getLinkManFlag() == null || this.get(i).getLinkManFlag().equals("null")) {
				...
				pstmt.setString(4, this.get(i).getLinkManFlag());
			}
			...
			if(this.get(i).getISValFlag() == null || this.get(i).getISValFlag().equals("null")) {
				...
				pstmt.setString(14, this.get(i).getISValFlag());
			}
			...
			pstmt.setInt(25, this.get(i).getContactNo());
