...
/*
 * <p>ClassName: LLCUWErrorDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 泰康未整理PDM
 */
public class LLCUWErrorDBSet extends LLCUWErrorSet
{
	// @Field
	...
	**/
	...
	// @Constructor
	public LLCUWErrorDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LLCUWErrorDBSet";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getSugPassFlag() == null || this.get(i).getSugPassFlag().equals("null")) {
				...
				pstmt.setString(19, this.get(i).getSugPassFlag());
			}
			// set where condition
			if(this.get(i).getCaseNo() == null || this.get(i).getCaseNo().equals("null")) {
