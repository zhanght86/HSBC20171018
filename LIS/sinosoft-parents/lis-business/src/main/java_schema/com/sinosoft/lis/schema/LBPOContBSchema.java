...
import com.sinosoft.lis.db.LBPOContBDB;

/*
 * <p>ClassName: LBPOContBSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: PhysicalDataModel_1
 */
public class LBPOContBSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LBPOContBSchema.class);
	...
	public static final int FIELDNUM = 100;	// 数据库表的字段个数
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LBPOContBSchema cloned = (LBPOContBSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LBPOContBSchema 对象给 Schema 赋值
	* @param: aLBPOContBSchema LBPOContBSchema
	**/
	public void setSchema(LBPOContBSchema aLBPOContBSchema)
	{
		this.IDX = aLBPOContBSchema.getIDX();
		this.GrpContNo = aLBPOContBSchema.getGrpContNo();
		this.ContNo = aLBPOContBSchema.getContNo();
		this.InputNo = aLBPOContBSchema.getInputNo();
		this.FillNo = aLBPOContBSchema.getFillNo();
		this.ProposalContNo = aLBPOContBSchema.getProposalContNo();
		this.PrtNo = aLBPOContBSchema.getPrtNo();
		this.ContType = aLBPOContBSchema.getContType();
		this.FamilyType = aLBPOContBSchema.getFamilyType();
		this.FamilyID = aLBPOContBSchema.getFamilyID();
		this.PolType = aLBPOContBSchema.getPolType();
		this.CardFlag = aLBPOContBSchema.getCardFlag();
		this.ManageCom = aLBPOContBSchema.getManageCom();
		this.ExecuteCom = aLBPOContBSchema.getExecuteCom();
		this.AgentCom = aLBPOContBSchema.getAgentCom();
		this.AgentCode = aLBPOContBSchema.getAgentCode();
		this.AgentGroup = aLBPOContBSchema.getAgentGroup();
		this.AgentCode1 = aLBPOContBSchema.getAgentCode1();
		this.AgentType = aLBPOContBSchema.getAgentType();
		this.SaleChnl = aLBPOContBSchema.getSaleChnl();
		this.Handler = aLBPOContBSchema.getHandler();
		this.Password = aLBPOContBSchema.getPassword();
		this.PayIntv = aLBPOContBSchema.getPayIntv();
		this.PayMode = aLBPOContBSchema.getPayMode();
		this.PayLocation = aLBPOContBSchema.getPayLocation();
		this.DisputedFlag = aLBPOContBSchema.getDisputedFlag();
		this.OutPayFlag = aLBPOContBSchema.getOutPayFlag();
		this.GetPolMode = aLBPOContBSchema.getGetPolMode();
		this.SignCom = aLBPOContBSchema.getSignCom();
		this.SignDate = aLBPOContBSchema.getSignDate();
		this.SignTime = aLBPOContBSchema.getSignTime();
		this.ConsignNo = aLBPOContBSchema.getConsignNo();
		this.BankCode = aLBPOContBSchema.getBankCode();
		this.BankAccNo = aLBPOContBSchema.getBankAccNo();
		this.AccName = aLBPOContBSchema.getAccName();
		this.PrintCount = aLBPOContBSchema.getPrintCount();
		this.LostTimes = aLBPOContBSchema.getLostTimes();
		this.Lang = aLBPOContBSchema.getLang();
		this.Currency = aLBPOContBSchema.getCurrency();
		this.Remark = aLBPOContBSchema.getRemark();
		this.Peoples = aLBPOContBSchema.getPeoples();
		this.Mult = aLBPOContBSchema.getMult();
		this.Prem = aLBPOContBSchema.getPrem();
		this.Amnt = aLBPOContBSchema.getAmnt();
		this.SumPrem = aLBPOContBSchema.getSumPrem();
		this.Dif = aLBPOContBSchema.getDif();
		this.PaytoDate = aLBPOContBSchema.getPaytoDate();
		this.FirstPayDate = aLBPOContBSchema.getFirstPayDate();
		this.CValiDate = aLBPOContBSchema.getCValiDate();
		this.InputOperator = aLBPOContBSchema.getInputOperator();
		this.InputDate = aLBPOContBSchema.getInputDate();
		this.InputTime = aLBPOContBSchema.getInputTime();
		this.ApproveFlag = aLBPOContBSchema.getApproveFlag();
		this.ApproveCode = aLBPOContBSchema.getApproveCode();
		this.ApproveDate = aLBPOContBSchema.getApproveDate();
		this.ApproveTime = aLBPOContBSchema.getApproveTime();
		this.UWFlag = aLBPOContBSchema.getUWFlag();
		this.UWOperator = aLBPOContBSchema.getUWOperator();
		this.UWDate = aLBPOContBSchema.getUWDate();
		this.UWTime = aLBPOContBSchema.getUWTime();
		this.AppFlag = aLBPOContBSchema.getAppFlag();
		this.PolApplyDate = aLBPOContBSchema.getPolApplyDate();
		this.GetPolDate = aLBPOContBSchema.getGetPolDate();
		this.GetPolTime = aLBPOContBSchema.getGetPolTime();
		this.CustomGetPolDate = aLBPOContBSchema.getCustomGetPolDate();
		this.State = aLBPOContBSchema.getState();
		this.Operator = aLBPOContBSchema.getOperator();
		this.MakeDate = aLBPOContBSchema.getMakeDate();
		this.MakeTime = aLBPOContBSchema.getMakeTime();
		this.ModifyDate = aLBPOContBSchema.getModifyDate();
		this.ModifyTime = aLBPOContBSchema.getModifyTime();
		this.FirstTrialOperator = aLBPOContBSchema.getFirstTrialOperator();
		this.FirstTrialDate = aLBPOContBSchema.getFirstTrialDate();
		this.FirstTrialTime = aLBPOContBSchema.getFirstTrialTime();
		this.ReceiveOperator = aLBPOContBSchema.getReceiveOperator();
		this.ReceiveDate = aLBPOContBSchema.getReceiveDate();
		this.ReceiveTime = aLBPOContBSchema.getReceiveTime();
		this.TempFeeNo = aLBPOContBSchema.getTempFeeNo();
		this.SellType = aLBPOContBSchema.getSellType();
		this.ForceUWFlag = aLBPOContBSchema.getForceUWFlag();
		this.ForceUWReason = aLBPOContBSchema.getForceUWReason();
		this.NewBankCode = aLBPOContBSchema.getNewBankCode();
		this.NewBankAccNo = aLBPOContBSchema.getNewBankAccNo();
		this.NewAccName = aLBPOContBSchema.getNewAccName();
		this.NewPayMode = aLBPOContBSchema.getNewPayMode();
		this.AgentBankCode = aLBPOContBSchema.getAgentBankCode();
		this.BankAgent = aLBPOContBSchema.getBankAgent();
		this.AutoPayFlag = aLBPOContBSchema.getAutoPayFlag();
		this.RnewFlag = aLBPOContBSchema.getRnewFlag();
		this.AgentName = aLBPOContBSchema.getAgentName();
		this.AgentComName = aLBPOContBSchema.getAgentComName();
		this.SignAgentName = aLBPOContBSchema.getSignAgentName();
		this.AgentSignDate = aLBPOContBSchema.getAgentSignDate();
		this.ReleaseFlag = aLBPOContBSchema.getReleaseFlag();
		this.AppSignName = aLBPOContBSchema.getAppSignName();
		this.InsSignName2 = aLBPOContBSchema.getInsSignName2();
		this.ImpartRemark = aLBPOContBSchema.getImpartRemark();
		this.TransDate = fDate.getDate( aLBPOContBSchema.getTransDate());
		this.TransTime = aLBPOContBSchema.getTransTime();
		this.TransOperator = aLBPOContBSchema.getTransOperator();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LBPOContB表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LBPOContBSchema";
	...
	public LBPOContBSchema getSchema()
	{
		LBPOContBSchema aLBPOContBSchema = new LBPOContBSchema();
		aLBPOContBSchema.setSchema(this);
		return aLBPOContBSchema;
	}

	public LBPOContBDB getDB()
	{
		LBPOContBDB aDBOper = new LBPOContBDB();
	...
	**/
	public String encode()
	{
		...
		strReturn.append(StrTool.cTrim(ImpartRemark)); strReturn.append(SysConst.PACKAGESPILTER);
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLBPOContB>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			FamilyType = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 9, SysConst.PACKAGESPILTER );
			FamilyID = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 10, SysConst.PACKAGESPILTER );
			PolType = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 11, SysConst.PACKAGESPILTER );
			CardFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 12, SysConst.PACKAGESPILTER );
			ManageCom = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 13, SysConst.PACKAGESPILTER );
			ExecuteCom = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 14, SysConst.PACKAGESPILTER );
			...
			AgentCode1 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 18, SysConst.PACKAGESPILTER );
			...
			Password = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 22, SysConst.PACKAGESPILTER );
			PayIntv = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 23, SysConst.PACKAGESPILTER );
			PayMode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 24, SysConst.PACKAGESPILTER );
			PayLocation = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 25, SysConst.PACKAGESPILTER );
			DisputedFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 26, SysConst.PACKAGESPILTER );
			OutPayFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 27, SysConst.PACKAGESPILTER );
			GetPolMode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 28, SysConst.PACKAGESPILTER );
			...
			ConsignNo = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 32, SysConst.PACKAGESPILTER );
			...
			PrintCount = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 36, SysConst.PACKAGESPILTER );
			LostTimes = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 37, SysConst.PACKAGESPILTER );
			...
			Remark = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 40, SysConst.PACKAGESPILTER );
			Peoples = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 41, SysConst.PACKAGESPILTER );
			Mult = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 42, SysConst.PACKAGESPILTER );
			Prem = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 43, SysConst.PACKAGESPILTER );
			Amnt = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 44, SysConst.PACKAGESPILTER );
			SumPrem = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 45, SysConst.PACKAGESPILTER );
			Dif = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 46, SysConst.PACKAGESPILTER );
			PaytoDate = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 47, SysConst.PACKAGESPILTER );
			FirstPayDate = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 48, SysConst.PACKAGESPILTER );
			CValiDate = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 49, SysConst.PACKAGESPILTER );
			InputOperator = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 50, SysConst.PACKAGESPILTER );
			InputDate = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 51, SysConst.PACKAGESPILTER );
			InputTime = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 52, SysConst.PACKAGESPILTER );
			ApproveFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 53, SysConst.PACKAGESPILTER );
			ApproveCode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 54, SysConst.PACKAGESPILTER );
			ApproveDate = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 55, SysConst.PACKAGESPILTER );
			ApproveTime = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 56, SysConst.PACKAGESPILTER );
			UWFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 57, SysConst.PACKAGESPILTER );
			UWOperator = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 58, SysConst.PACKAGESPILTER );
			UWDate = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 59, SysConst.PACKAGESPILTER );
			UWTime = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 60, SysConst.PACKAGESPILTER );
			AppFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 61, SysConst.PACKAGESPILTER );
			PolApplyDate = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 62, SysConst.PACKAGESPILTER );
			GetPolDate = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 63, SysConst.PACKAGESPILTER );
			GetPolTime = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 64, SysConst.PACKAGESPILTER );
			CustomGetPolDate = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 65, SysConst.PACKAGESPILTER );
			State = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 66, SysConst.PACKAGESPILTER );
			Operator = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 67, SysConst.PACKAGESPILTER );
			MakeDate = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 68, SysConst.PACKAGESPILTER );
			MakeTime = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 69, SysConst.PACKAGESPILTER );
			ModifyDate = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 70, SysConst.PACKAGESPILTER );
			ModifyTime = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 71, SysConst.PACKAGESPILTER );
			FirstTrialOperator = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 72, SysConst.PACKAGESPILTER );
			FirstTrialDate = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 73, SysConst.PACKAGESPILTER );
			FirstTrialTime = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 74, SysConst.PACKAGESPILTER );
			ReceiveOperator = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 75, SysConst.PACKAGESPILTER );
			ReceiveDate = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 76, SysConst.PACKAGESPILTER );
			ReceiveTime = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 77, SysConst.PACKAGESPILTER );
			TempFeeNo = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 78, SysConst.PACKAGESPILTER );
			SellType = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 79, SysConst.PACKAGESPILTER );
			ForceUWFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 80, SysConst.PACKAGESPILTER );
			ForceUWReason = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 81, SysConst.PACKAGESPILTER );
			NewBankCode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 82, SysConst.PACKAGESPILTER );
			NewBankAccNo = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 83, SysConst.PACKAGESPILTER );
			NewAccName = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 84, SysConst.PACKAGESPILTER );
			NewPayMode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 85, SysConst.PACKAGESPILTER );
			AgentBankCode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 86, SysConst.PACKAGESPILTER );
			BankAgent = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 87, SysConst.PACKAGESPILTER );
			AutoPayFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 88, SysConst.PACKAGESPILTER );
			RnewFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 89, SysConst.PACKAGESPILTER );
			AgentName = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 90, SysConst.PACKAGESPILTER );
			AgentComName = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 91, SysConst.PACKAGESPILTER );
			SignAgentName = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 92, SysConst.PACKAGESPILTER );
			AgentSignDate = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 93, SysConst.PACKAGESPILTER );
			ReleaseFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 94, SysConst.PACKAGESPILTER );
			AppSignName = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 95, SysConst.PACKAGESPILTER );
			InsSignName2 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 96, SysConst.PACKAGESPILTER );
			ImpartRemark = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 97, SysConst.PACKAGESPILTER );
			TransDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 98,SysConst.PACKAGESPILTER));
			TransTime = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 99, SysConst.PACKAGESPILTER );
			TransOperator = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 100, SysConst.PACKAGESPILTER );
		}
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LBPOContBSchema other = (LBPOContBSchema)otherObject;
		return
