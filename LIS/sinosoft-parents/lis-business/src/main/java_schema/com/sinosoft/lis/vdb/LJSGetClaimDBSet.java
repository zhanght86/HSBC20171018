...
/*
 * <p>ClassName: LJSGetClaimDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 寿险业务付费
 */
public class LJSGetClaimDBSet extends LJSGetClaimSet
{
	// @Field
	...
	**/
	...
	// @Constructor
	public LJSGetClaimDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LJSGetClaimDBSet";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getKindCode() == null || this.get(i).getKindCode().equals("null")) {
				...
				pstmt.setString(15, this.get(i).getKindCode());
			}
			...
			if(this.get(i).getRiskVersion() == null || this.get(i).getRiskVersion().equals("null")) {
				...
				pstmt.setString(17, this.get(i).getRiskVersion());
			}
			...
			pstmt.setDouble(34, this.get(i).getNetAmount());
			pstmt.setDouble(35, this.get(i).getTaxAmount());
			pstmt.setDouble(36, this.get(i).getTax());
			// set where condition
			if(this.get(i).getGetNoticeNo() == null || this.get(i).getGetNoticeNo().equals("null")) {
				pstmt.setString(37,null);
			} else {
				pstmt.setString(37, this.get(i).getGetNoticeNo());
			}
			if(this.get(i).getFeeOperationType() == null || this.get(i).getFeeOperationType().equals("null")) {
				pstmt.setString(38,null);
			} else {
				pstmt.setString(38, this.get(i).getFeeOperationType());
			}
			if(this.get(i).getSubFeeOperationType() == null || this.get(i).getSubFeeOperationType().equals("null")) {
				pstmt.setString(39,null);
			} else {
				pstmt.setString(39, this.get(i).getSubFeeOperationType());
			}
			if(this.get(i).getFeeFinaType() == null || this.get(i).getFeeFinaType().equals("null")) {
			...
			if(this.get(i).getGetDutyKind() == null || this.get(i).getGetDutyKind().equals("null")) {
				...
				pstmt.setString(43, this.get(i).getGetDutyKind());
			}
			if(this.get(i).getGetDutyCode() == null || this.get(i).getGetDutyCode().equals("null")) {
