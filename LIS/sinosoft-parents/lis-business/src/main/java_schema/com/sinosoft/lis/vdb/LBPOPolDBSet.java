...
/*
 * <p>ClassName: LBPOPolDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 内部外包流程
 */
public class LBPOPolDBSet extends LBPOPolSet
{
private static Logger logger = Logger.getLogger(LBPOPolDBSet.class);
	...
	**/
	...
	// @Constructor
	public LBPOPolDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LBPOPolDBSet";
	...
	public boolean delete()
	{
		...
		try
		{
            ...
            {
			pstmt.setInt(1, this.get(i).getInputNo());
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getInsuredPeoples() == null || this.get(i).getInsuredPeoples().equals("null")) {
				...
				pstmt.setString(25, this.get(i).getInsuredPeoples());
			}
			...
			if(this.get(i).getPayEndYear() == null || this.get(i).getPayEndYear().equals("null")) {
				...
				pstmt.setString(40, this.get(i).getPayEndYear());
			}
