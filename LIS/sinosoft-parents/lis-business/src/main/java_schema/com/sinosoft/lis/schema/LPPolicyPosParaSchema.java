...
import com.sinosoft.lis.db.LPPolicyPosParaDB;

/*
 * <p>ClassName: LPPolicyPosParaSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: Physical Data Model 1
 */
public class LPPolicyPosParaSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LPPolicyPosParaSchema.class);
	// @Field
	/** 序号 */
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LPPolicyPosParaSchema cloned = (LPPolicyPosParaSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LPPolicyPosParaSchema 对象给 Schema 赋值
	* @param: aLPPolicyPosParaSchema LPPolicyPosParaSchema
	**/
	public void setSchema(LPPolicyPosParaSchema aLPPolicyPosParaSchema)
	{
		this.SerialNo = aLPPolicyPosParaSchema.getSerialNo();
		this.PolicyNo = aLPPolicyPosParaSchema.getPolicyNo();
		this.BussType = aLPPolicyPosParaSchema.getBussType();
		this.PumpDays = aLPPolicyPosParaSchema.getPumpDays();
		this.GracePeriod = aLPPolicyPosParaSchema.getGracePeriod();
		this.Segment1 = aLPPolicyPosParaSchema.getSegment1();
		this.Segment2 = aLPPolicyPosParaSchema.getSegment2();
		this.Segment3 = aLPPolicyPosParaSchema.getSegment3();
		this.MakeOperator = aLPPolicyPosParaSchema.getMakeOperator();
		this.MakeDate = fDate.getDate( aLPPolicyPosParaSchema.getMakeDate());
		this.MakeTime = aLPPolicyPosParaSchema.getMakeTime();
		this.ModifyOperator = aLPPolicyPosParaSchema.getModifyOperator();
		this.ModifyDate = fDate.getDate( aLPPolicyPosParaSchema.getModifyDate());
		this.ModifyTime = aLPPolicyPosParaSchema.getModifyTime();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LPPolicyPosPara表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LPPolicyPosParaSchema";
	...
	public LPPolicyPosParaSchema getSchema()
	{
		LPPolicyPosParaSchema aLPPolicyPosParaSchema = new LPPolicyPosParaSchema();
		aLPPolicyPosParaSchema.setSchema(this);
		return aLPPolicyPosParaSchema;
	}

	public LPPolicyPosParaDB getDB()
	{
		LPPolicyPosParaDB aDBOper = new LPPolicyPosParaDB();
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLPPolicyPosPara>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			PumpDays= new Integer(ChgData.chgNumericStr(StrTool.getStr(strMessage,4,SysConst.PACKAGESPILTER))).intValue();
			GracePeriod = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 5, SysConst.PACKAGESPILTER );
			Segment1 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 6, SysConst.PACKAGESPILTER );
			Segment2 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 7, SysConst.PACKAGESPILTER );
			Segment3 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 8, SysConst.PACKAGESPILTER );
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LPPolicyPosParaSchema other = (LPPolicyPosParaSchema)otherObject;
		return
