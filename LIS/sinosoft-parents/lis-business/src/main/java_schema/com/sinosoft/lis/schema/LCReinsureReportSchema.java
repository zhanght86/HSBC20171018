...
/*
 * <p>ClassName: LCReinsureReportSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 承保流程
 */
public class LCReinsureReportSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LCReinsureReportSchema.class);
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LCReinsureReportSchema cloned = (LCReinsureReportSchema)super.clone();
	...
	*/
	...
	public int getReinsuReportNum()
	{
		return ReinsuReportNum;
	}
	public void setReinsuReportNum(int aReinsuReportNum)
	{
		ReinsuReportNum = aReinsuReportNum;
	}
	public void setReinsuReportNum(String aReinsuReportNum)
	{
		if (aReinsuReportNum != null && !aReinsuReportNum.equals(""))
		{
			Integer tInteger = new Integer(aReinsuReportNum);
	...
	/**
	* 使用另外一个 LCReinsureReportSchema 对象给 Schema 赋值
	* @param: aLCReinsureReportSchema LCReinsureReportSchema
	**/
	public void setSchema(LCReinsureReportSchema aLCReinsureReportSchema)
	{
		this.GrpContNo = aLCReinsureReportSchema.getGrpContNo();
		this.ContNo = aLCReinsureReportSchema.getContNo();
		this.ProposalContNo = aLCReinsureReportSchema.getProposalContNo();
		this.ReinsuredResult = aLCReinsureReportSchema.getReinsuredResult();
		this.MakeDate = fDate.getDate( aLCReinsureReportSchema.getMakeDate());
		this.MakeTime = aLCReinsureReportSchema.getMakeTime();
		this.UserCode = aLCReinsureReportSchema.getUserCode();
		this.DealUserCode = aLCReinsureReportSchema.getDealUserCode();
		this.ModifyDate = fDate.getDate( aLCReinsureReportSchema.getModifyDate());
		this.ModifyTime = aLCReinsureReportSchema.getModifyTime();
		this.ReinsuDesc = aLCReinsureReportSchema.getReinsuDesc();
		this.ReinsuRemark = aLCReinsureReportSchema.getReinsuRemark();
		this.ReinsuReportNum = aLCReinsureReportSchema.getReinsuReportNum();
		this.ReportRemark = aLCReinsureReportSchema.getReportRemark();
		this.ReportReason = aLCReinsureReportSchema.getReportReason();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		try
		{
			...
			this.ReinsuReportNum = rs.getInt("ReinsuReportNum");
		...
		{
			logger.debug("数据库中的LCReinsureReport表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LCReinsureReportSchema";
	...
	public LCReinsureReportSchema getSchema()
	{
		LCReinsureReportSchema aLCReinsureReportSchema = new LCReinsureReportSchema();
		aLCReinsureReportSchema.setSchema(this);
		return aLCReinsureReportSchema;
	}

	public LCReinsureReportDB getDB()
	{
		LCReinsureReportDB aDBOper = new LCReinsureReportDB();
	...
	**/
	public String encode()
	{
		...
		strReturn.append( ChgData.chgData(ReinsuReportNum));strReturn.append(SysConst.PACKAGESPILTER);
		strReturn.append(StrTool.cTrim(ReportRemark)); strReturn.append(SysConst.PACKAGESPILTER);
		strReturn.append(StrTool.cTrim(ReportReason));
		return strReturn.toString();
	}

	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLCReinsureReport>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			ReinsuredResult = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 4, SysConst.PACKAGESPILTER );
			...
			UserCode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 7, SysConst.PACKAGESPILTER );
			DealUserCode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 8, SysConst.PACKAGESPILTER );
			...
			ReinsuDesc = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 11, SysConst.PACKAGESPILTER );
			ReinsuRemark = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 12, SysConst.PACKAGESPILTER );
			ReinsuReportNum= new Integer(ChgData.chgNumericStr(StrTool.getStr(strMessage,13,SysConst.PACKAGESPILTER))).intValue();
			ReportRemark = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 14, SysConst.PACKAGESPILTER );
			ReportReason = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 15, SysConst.PACKAGESPILTER );
		}
	...
	**/
	public String getV(String FCode)
	{
		...
		if (FCode.equalsIgnoreCase("ReinsuReportNum"))
		{
			strReturn = StrTool.GBKToUnicode(String.valueOf(ReinsuReportNum));
		}
	...
	public String getV(int nFieldIndex)
	{
		...
		switch(nFieldIndex) {
			...
			case 11:
				...
				break;
			case 12:
				strFieldValue = String.valueOf(ReinsuReportNum);
				break;
			case 13:
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LCReinsureReportSchema other = (LCReinsureReportSchema)otherObject;
		return
			...
			&& ReinsuReportNum == other.getReinsuReportNum()
	...
	**/
	public int getFieldIndex(String strFieldName)
	{
		...
		if( strFieldName.equals("ReinsuReportNum") ) {
			return 12;
		}
