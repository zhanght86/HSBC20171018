...
/*
 * <p>ClassName: LPGUWSubDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 保全流程
 */
public class LPGUWSubDBSet extends LPGUWSubSet
{
private static Logger logger = Logger.getLogger(LPGUWSubDBSet.class);
	...
	**/
	...
	// @Constructor
	public LPGUWSubDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LPGUWSubDBSet";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getEdorNo() == null || this.get(i).getEdorNo().equals("null")) {
				...
				pstmt.setString(40, this.get(i).getEdorNo());
			}
			if(this.get(i).getEdorType() == null || this.get(i).getEdorType().equals("null")) {
				pstmt.setString(41,null);
			} else {
				pstmt.setString(41, this.get(i).getEdorType());
			}
			if(this.get(i).getGrpPolNo() == null || this.get(i).getGrpPolNo().equals("null")) {
