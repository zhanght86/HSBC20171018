...
/*
 * <p>ClassName: LLDutyDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 理赔管理
 */
public class LLDutyDBSet extends LLDutySet
{
	// @Field
	...
	**/
	...
	// @Constructor
	public LLDutyDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getOperationType() == null || this.get(i).getOperationType().equals("null")) {
				...
				pstmt.setString(57, this.get(i).getOperationType());
			}
			if(this.get(i).getPolNo() == null || this.get(i).getPolNo().equals("null")) {
