...
import com.sinosoft.lis.db.LPDutySubDB;

/*
 * <p>ClassName: LPDutySubSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: Physical Data Model 1
 */
public class LPDutySubSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LPDutySubSchema.class);
	// @Field
	/** 保全批单号 */
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LPDutySubSchema cloned = (LPDutySubSchema)super.clone();
	...
	/**
	* 使用另外一个 LPDutySubSchema 对象给 Schema 赋值
	* @param: aLPDutySubSchema LPDutySubSchema
	**/
	public void setSchema(LPDutySubSchema aLPDutySubSchema)
	{
		this.EdorNo = aLPDutySubSchema.getEdorNo();
		this.EdorType = aLPDutySubSchema.getEdorType();
		this.BussType = aLPDutySubSchema.getBussType();
		this.BussNo = aLPDutySubSchema.getBussNo();
		this.ContNo = aLPDutySubSchema.getContNo();
		this.PolNo = aLPDutySubSchema.getPolNo();
		this.OtherNo = aLPDutySubSchema.getOtherNo();
		this.SysPlanCode = aLPDutySubSchema.getSysPlanCode();
		this.PlanCode = aLPDutySubSchema.getPlanCode();
		this.RiskCode = aLPDutySubSchema.getRiskCode();
		this.DutyCode = aLPDutySubSchema.getDutyCode();
		this.P1 = aLPDutySubSchema.getP1();
		this.P2 = aLPDutySubSchema.getP2();
		this.P3 = aLPDutySubSchema.getP3();
		this.P4 = aLPDutySubSchema.getP4();
		this.P5 = aLPDutySubSchema.getP5();
		this.P6 = aLPDutySubSchema.getP6();
		this.P7 = aLPDutySubSchema.getP7();
		this.P8 = aLPDutySubSchema.getP8();
		this.P9 = aLPDutySubSchema.getP9();
		this.P10 = aLPDutySubSchema.getP10();
		this.P11 = aLPDutySubSchema.getP11();
		this.P12 = aLPDutySubSchema.getP12();
		this.P13 = aLPDutySubSchema.getP13();
		this.P14 = aLPDutySubSchema.getP14();
		this.P15 = aLPDutySubSchema.getP15();
		this.P16 = aLPDutySubSchema.getP16();
		this.P17 = aLPDutySubSchema.getP17();
		this.P18 = aLPDutySubSchema.getP18();
		this.P19 = aLPDutySubSchema.getP19();
		this.P20 = aLPDutySubSchema.getP20();
		this.P21 = aLPDutySubSchema.getP21();
		this.P22 = aLPDutySubSchema.getP22();
		this.P23 = aLPDutySubSchema.getP23();
		this.P24 = aLPDutySubSchema.getP24();
		this.P25 = aLPDutySubSchema.getP25();
		this.P26 = aLPDutySubSchema.getP26();
		this.P27 = aLPDutySubSchema.getP27();
		this.P28 = aLPDutySubSchema.getP28();
		this.P29 = aLPDutySubSchema.getP29();
		this.P30 = aLPDutySubSchema.getP30();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LPDutySub表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LPDutySubSchema";
	...
	public LPDutySubSchema getSchema()
	{
		LPDutySubSchema aLPDutySubSchema = new LPDutySubSchema();
		aLPDutySubSchema.setSchema(this);
		return aLPDutySubSchema;
	}

	public LPDutySubDB getDB()
	{
		LPDutySubDB aDBOper = new LPDutySubDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLPDutySub描述/A>表字段
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLPDutySub>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			SysPlanCode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 8, SysConst.PACKAGESPILTER );
			PlanCode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 9, SysConst.PACKAGESPILTER );
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LPDutySubSchema other = (LPDutySubSchema)otherObject;
		return
