...
/*
 * <p>ClassName: LBPOEdorInsuredBnfListDB </p>
 * <p>Description: DB层数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: Physical Data Model 1
 */
public class LBPOEdorInsuredBnfListDB extends LBPOEdorInsuredBnfListSchema
{
	// @Field
	...
	**/
	...
	// @Constructor
	public LBPOEdorInsuredBnfListDB( Connection tConnection )
	{
		con = tConnection;
	...
	public LBPOEdorInsuredBnfListDB()
	{
		con = null;
	...
	{
		LBPOEdorInsuredBnfListSchema tSchema = this.getSchema();
		...
		else
		{
			...
			tError.moduleName = "LBPOEdorInsuredBnfListDB";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.getHeadBankCode() == null || this.getHeadBankCode().equals("null")) {
				...
				pstmt.setString(22, this.getHeadBankCode());
			}
			if(this.getHeadBankName() == null || this.getHeadBankName().equals("null")) {
				pstmt.setNull(23, 12);
			} else {
				pstmt.setString(23, this.getHeadBankName());
			}
			...
			if(this.getReason() == null || this.getReason().equals("null")) {
				...
				pstmt.setString(32, this.getReason());
			}
			...
			// set where condition
			pstmt.setInt(39, this.getSerialNo());
			pstmt.executeUpdate();
			pstmt.close();
		} catch (Exception ex) {
			// @@错误处理
	...
	public boolean getInfo()
	{
		...
		try
		{
			pstmt = con.prepareStatement("SELECT * FROM LBPOEdorInsuredBnfList WHERE  SerialNo = ?", 
	...
	public LBPOEdorInsuredBnfListSet query()
	{
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		LBPOEdorInsuredBnfListSet aLBPOEdorInsuredBnfListSet = new LBPOEdorInsuredBnfListSet();
	  ...
	  if( !mflag ) {
		...
		{
			SQLString sqlObj = new SQLString("LBPOEdorInsuredBnfList");
			LBPOEdorInsuredBnfListSchema aSchema = this.getSchema();
			...
			{
				i++;
				LBPOEdorInsuredBnfListSchema s1 = new LBPOEdorInsuredBnfListSchema();
				s1.setSchema(rs,i);
				aLBPOEdorInsuredBnfListSet.add(s1);
			}
			try{ rs.close(); } catch( Exception ex ) {}
			try{ pstmt.close(); } catch( Exception ex1 ) {}
		}
		...
		return aLBPOEdorInsuredBnfListSet;
	}

	public LBPOEdorInsuredBnfListSet executeQuery(String sql)
	{
		Statement stmt = null;
		ResultSet rs = null;
		LBPOEdorInsuredBnfListSet aLBPOEdorInsuredBnfListSet = new LBPOEdorInsuredBnfListSet();
	...
	public LBPOEdorInsuredBnfListSet query(int nStart, int nCount)
	{
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		LBPOEdorInsuredBnfListSet aLBPOEdorInsuredBnfListSet = new LBPOEdorInsuredBnfListSet();
	...
	public LBPOEdorInsuredBnfListSet executeQuery(String sql, int nStart, int nCount)
	{
		Statement stmt = null;
		ResultSet rs = null;
		LBPOEdorInsuredBnfListSet aLBPOEdorInsuredBnfListSet = new LBPOEdorInsuredBnfListSet();
	...
	public boolean update(String strWherePart)
	{
	  ...
	  if( !mflag ) {
		...
		try
		{
			...
			String sql = "update LBPOEdorInsuredBnfList " + sqlObj.getUpdPart() + " where " + strWherePart;
...
/**
 * 获取定量数据
 * @return LBPOEdorInsuredBnfListSet
 */
public LBPOEdorInsuredBnfListSet getData()
{
    int tCount = 0;
    LBPOEdorInsuredBnfListSet tLBPOEdorInsuredBnfListSet = new LBPOEdorInsuredBnfListSet();
    LBPOEdorInsuredBnfListSchema tLBPOEdorInsuredBnfListSchema = null;
    if (null == mResultSet)
    {
        CError tError = new CError();
        tError.moduleName = "LBPOEdorInsuredBnfListDB";
    ...
    try
    {
        ...
        tLBPOEdorInsuredBnfListSchema.setSchema(mResultSet, 1);
    ...
    return tLBPOEdorInsuredBnfListSet;
}
/**
 * 关闭数据集
 * @return boolean
...
public boolean closeData()
{
	...
	public LBPOEdorInsuredBnfListSet executeQuery(SQLwithBindVariables sqlbv) {
	...
	public LBPOEdorInsuredBnfListSet executeQuery(SQLwithBindVariables sqlbv, int nStart, int nCount) {
