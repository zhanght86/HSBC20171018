...
/*
 * <p>ClassName: LBPOInsuredListDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: Physical Data Model 1
 */
public class LBPOInsuredListDBSet extends LBPOInsuredListSet
{
	// @Field
	...
	**/
	...
	// @Constructor
	public LBPOInsuredListDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LBPOInsuredListDBSet";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getIDTypeName() == null || this.get(i).getIDTypeName().equals("null")) {
				...
				pstmt.setString(17, this.get(i).getIDTypeName());
			}
			...
			// set where condition
			pstmt.setInt(81, this.get(i).getSerialNo());
