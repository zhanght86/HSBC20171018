...
import com.sinosoft.lis.db.LBAppntIndDB;

/*
 * <p>ClassName: LBAppntIndSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 寿险业务系统lis5模型
 */
public class LBAppntIndSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LBAppntIndSchema.class);
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LBAppntIndSchema cloned = (LBAppntIndSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LBAppntIndSchema 对象给 Schema 赋值
	* @param: aLBAppntIndSchema LBAppntIndSchema
	**/
	public void setSchema(LBAppntIndSchema aLBAppntIndSchema)
	{
		this.EdorNo = aLBAppntIndSchema.getEdorNo();
		this.PolNo = aLBAppntIndSchema.getPolNo();
		this.CustomerNo = aLBAppntIndSchema.getCustomerNo();
		this.SequenceNo = aLBAppntIndSchema.getSequenceNo();
		this.AppntGrade = aLBAppntIndSchema.getAppntGrade();
		this.RelationToInsured = aLBAppntIndSchema.getRelationToInsured();
		this.Password = aLBAppntIndSchema.getPassword();
		this.Name = aLBAppntIndSchema.getName();
		this.Sex = aLBAppntIndSchema.getSex();
		this.Birthday = fDate.getDate( aLBAppntIndSchema.getBirthday());
		this.NativePlace = aLBAppntIndSchema.getNativePlace();
		this.Nationality = aLBAppntIndSchema.getNationality();
		this.Marriage = aLBAppntIndSchema.getMarriage();
		this.MarriageDate = fDate.getDate( aLBAppntIndSchema.getMarriageDate());
		this.OccupationType = aLBAppntIndSchema.getOccupationType();
		this.StartWorkDate = fDate.getDate( aLBAppntIndSchema.getStartWorkDate());
		this.Salary = aLBAppntIndSchema.getSalary();
		this.Health = aLBAppntIndSchema.getHealth();
		this.Stature = aLBAppntIndSchema.getStature();
		this.Avoirdupois = aLBAppntIndSchema.getAvoirdupois();
		this.CreditGrade = aLBAppntIndSchema.getCreditGrade();
		this.IDType = aLBAppntIndSchema.getIDType();
		this.Proterty = aLBAppntIndSchema.getProterty();
		this.IDNo = aLBAppntIndSchema.getIDNo();
		this.OthIDType = aLBAppntIndSchema.getOthIDType();
		this.OthIDNo = aLBAppntIndSchema.getOthIDNo();
		this.ICNo = aLBAppntIndSchema.getICNo();
		this.HomeAddressCode = aLBAppntIndSchema.getHomeAddressCode();
		this.HomeAddress = aLBAppntIndSchema.getHomeAddress();
		this.PostalAddress = aLBAppntIndSchema.getPostalAddress();
		this.ZipCode = aLBAppntIndSchema.getZipCode();
		this.Phone = aLBAppntIndSchema.getPhone();
		this.BP = aLBAppntIndSchema.getBP();
		this.Mobile = aLBAppntIndSchema.getMobile();
		this.EMail = aLBAppntIndSchema.getEMail();
		this.JoinCompanyDate = fDate.getDate( aLBAppntIndSchema.getJoinCompanyDate());
		this.Position = aLBAppntIndSchema.getPosition();
		this.GrpNo = aLBAppntIndSchema.getGrpNo();
		this.GrpName = aLBAppntIndSchema.getGrpName();
		this.GrpPhone = aLBAppntIndSchema.getGrpPhone();
		this.GrpAddressCode = aLBAppntIndSchema.getGrpAddressCode();
		this.GrpAddress = aLBAppntIndSchema.getGrpAddress();
		this.DeathDate = fDate.getDate( aLBAppntIndSchema.getDeathDate());
		this.Remark = aLBAppntIndSchema.getRemark();
		this.State = aLBAppntIndSchema.getState();
		this.ModifyDate = fDate.getDate( aLBAppntIndSchema.getModifyDate());
		this.ModifyTime = aLBAppntIndSchema.getModifyTime();
		this.WorkType = aLBAppntIndSchema.getWorkType();
		this.PluralityType = aLBAppntIndSchema.getPluralityType();
		this.Degree = aLBAppntIndSchema.getDegree();
		this.OccupationCode = aLBAppntIndSchema.getOccupationCode();
		this.GrpZipCode = aLBAppntIndSchema.getGrpZipCode();
		this.SmokeFlag = aLBAppntIndSchema.getSmokeFlag();
		this.RgtAddress = aLBAppntIndSchema.getRgtAddress();
		this.HomeZipCode = aLBAppntIndSchema.getHomeZipCode();
		this.Phone2 = aLBAppntIndSchema.getPhone2();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LBAppntInd表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LBAppntIndSchema";
	...
	public LBAppntIndSchema getSchema()
	{
		LBAppntIndSchema aLBAppntIndSchema = new LBAppntIndSchema();
		aLBAppntIndSchema.setSchema(this);
		return aLBAppntIndSchema;
	}

	public LBAppntIndDB getDB()
	{
		LBAppntIndDB aDBOper = new LBAppntIndDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLBAppntInd描述/A>表字段
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLBAppntInd>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			Nationality = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 12, SysConst.PACKAGESPILTER );
			...
			StartWorkDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 16,SysConst.PACKAGESPILTER));
			Salary = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,17,SysConst.PACKAGESPILTER))).doubleValue();
			...
			CreditGrade = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 21, SysConst.PACKAGESPILTER );
			IDType = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 22, SysConst.PACKAGESPILTER );
			Proterty = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 23, SysConst.PACKAGESPILTER );
			IDNo = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 24, SysConst.PACKAGESPILTER );
			OthIDType = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 25, SysConst.PACKAGESPILTER );
			OthIDNo = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 26, SysConst.PACKAGESPILTER );
			ICNo = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 27, SysConst.PACKAGESPILTER );
			HomeAddressCode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 28, SysConst.PACKAGESPILTER );
			HomeAddress = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 29, SysConst.PACKAGESPILTER );
			PostalAddress = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 30, SysConst.PACKAGESPILTER );
			ZipCode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 31, SysConst.PACKAGESPILTER );
			Phone = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 32, SysConst.PACKAGESPILTER );
			BP = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 33, SysConst.PACKAGESPILTER );
			Mobile = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 34, SysConst.PACKAGESPILTER );
			EMail = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 35, SysConst.PACKAGESPILTER );
			JoinCompanyDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 36,SysConst.PACKAGESPILTER));
			Position = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 37, SysConst.PACKAGESPILTER );
			GrpNo = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 38, SysConst.PACKAGESPILTER );
			GrpName = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 39, SysConst.PACKAGESPILTER );
			GrpPhone = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 40, SysConst.PACKAGESPILTER );
			GrpAddressCode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 41, SysConst.PACKAGESPILTER );
			GrpAddress = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 42, SysConst.PACKAGESPILTER );
			DeathDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 43,SysConst.PACKAGESPILTER));
			Remark = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 44, SysConst.PACKAGESPILTER );
			State = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 45, SysConst.PACKAGESPILTER );
			...
			WorkType = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 48, SysConst.PACKAGESPILTER );
			PluralityType = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 49, SysConst.PACKAGESPILTER );
			Degree = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 50, SysConst.PACKAGESPILTER );
			OccupationCode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 51, SysConst.PACKAGESPILTER );
			GrpZipCode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 52, SysConst.PACKAGESPILTER );
			SmokeFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 53, SysConst.PACKAGESPILTER );
			RgtAddress = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 54, SysConst.PACKAGESPILTER );
			HomeZipCode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 55, SysConst.PACKAGESPILTER );
			Phone2 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 56, SysConst.PACKAGESPILTER );
		}
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LBAppntIndSchema other = (LBAppntIndSchema)otherObject;
		return
