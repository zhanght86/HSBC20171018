...
/*
 * <p>ClassName: LLExemptSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 理赔管理
 */
public class LLExemptSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LLExemptSchema.class);
	...
	/** 豁免期数 */
	private String ExemptPeriod;
	/** 承保时保单号 */
	private String NBPolNo;
	/** 豁免原因 */
	private String ExemptReason;
	/** 豁免描述 */
	private String ExemptDesc;
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LLExemptSchema cloned = (LLExemptSchema)super.clone();
	...
	*/
	...
	public String getExemptPeriod()
	{
		return ExemptPeriod;
	}
	public void setExemptPeriod(String aExemptPeriod)
	{
		ExemptPeriod = aExemptPeriod;
	}
	...
	*/
	...
	public void setExemptReason(String aExemptReason)
	{
		ExemptReason = aExemptReason;
	}
	public String getExemptDesc()
	{
		return ExemptDesc;
	}
	public void setExemptDesc(String aExemptDesc)
	{
		ExemptDesc = aExemptDesc;
	}

	/**
	* 使用另外一个 LLExemptSchema 对象给 Schema 赋值
	* @param: aLLExemptSchema LLExemptSchema
	**/
	public void setSchema(LLExemptSchema aLLExemptSchema)
	{
		this.ClmNo = aLLExemptSchema.getClmNo();
		this.GrpContNo = aLLExemptSchema.getGrpContNo();
		this.ContNo = aLLExemptSchema.getContNo();
		this.PolNo = aLLExemptSchema.getPolNo();
		this.DutyCode = aLLExemptSchema.getDutyCode();
		this.PayPlanCode = aLLExemptSchema.getPayPlanCode();
		this.PayPlanType = aLLExemptSchema.getPayPlanType();
		this.AppntType = aLLExemptSchema.getAppntType();
		this.AppntNo = aLLExemptSchema.getAppntNo();
		this.UrgePayFlag = aLLExemptSchema.getUrgePayFlag();
		this.NeedAcc = aLLExemptSchema.getNeedAcc();
		this.PayTimes = aLLExemptSchema.getPayTimes();
		this.Rate = aLLExemptSchema.getRate();
		this.PayStartDate = fDate.getDate( aLLExemptSchema.getPayStartDate());
		this.PayEndDate = fDate.getDate( aLLExemptSchema.getPayEndDate());
		this.PaytoDate = fDate.getDate( aLLExemptSchema.getPaytoDate());
		this.PayIntv = aLLExemptSchema.getPayIntv();
		this.StandPrem = aLLExemptSchema.getStandPrem();
		this.Prem = aLLExemptSchema.getPrem();
		this.SumPrem = aLLExemptSchema.getSumPrem();
		this.SuppRiskScore = aLLExemptSchema.getSuppRiskScore();
		this.FreeFlag = aLLExemptSchema.getFreeFlag();
		this.FreeRate = aLLExemptSchema.getFreeRate();
		this.FreeStartDate = fDate.getDate( aLLExemptSchema.getFreeStartDate());
		this.FreeEndDate = fDate.getDate( aLLExemptSchema.getFreeEndDate());
		this.State = aLLExemptSchema.getState();
		this.ManageCom = aLLExemptSchema.getManageCom();
		this.Operator = aLLExemptSchema.getOperator();
		this.MakeDate = fDate.getDate( aLLExemptSchema.getMakeDate());
		this.MakeTime = aLLExemptSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLLExemptSchema.getModifyDate());
		this.ModifyTime = aLLExemptSchema.getModifyTime();
		this.AddFeeDirect = aLLExemptSchema.getAddFeeDirect();
		this.ExemptPeriod = aLLExemptSchema.getExemptPeriod();
		this.NBPolNo = aLLExemptSchema.getNBPolNo();
		this.ExemptReason = aLLExemptSchema.getExemptReason();
		this.ExemptDesc = aLLExemptSchema.getExemptDesc();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		try
		{
			...
			if( rs.getString("ExemptPeriod") == null )
				this.ExemptPeriod = null;
			else
				this.ExemptPeriod = rs.getString("ExemptPeriod").trim();
			...
			if( rs.getString("ExemptReason") == null )
				this.ExemptReason = null;
			else
				this.ExemptReason = rs.getString("ExemptReason").trim();

			if( rs.getString("ExemptDesc") == null )
				this.ExemptDesc = null;
			else
				this.ExemptDesc = rs.getString("ExemptDesc").trim();

		}
		catch(SQLException sqle)
		{
			logger.debug("数据库中的LLExempt表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LLExemptSchema";
	...
	public LLExemptSchema getSchema()
	{
		LLExemptSchema aLLExemptSchema = new LLExemptSchema();
		aLLExemptSchema.setSchema(this);
		return aLLExemptSchema;
	}

	public LLExemptDB getDB()
	{
		LLExemptDB aDBOper = new LLExemptDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLLExempt描述/A>表字段
	...
	**/
	public String encode()
	{
		...
		strReturn.append(StrTool.cTrim(ExemptPeriod)); strReturn.append(SysConst.PACKAGESPILTER);
		strReturn.append(StrTool.cTrim(NBPolNo)); strReturn.append(SysConst.PACKAGESPILTER);
		strReturn.append(StrTool.cTrim(ExemptReason)); strReturn.append(SysConst.PACKAGESPILTER);
		strReturn.append(StrTool.cTrim(ExemptDesc));
		return strReturn.toString();
	}

	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLLExempt>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			PayPlanType = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 7, SysConst.PACKAGESPILTER );
			AppntType = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 8, SysConst.PACKAGESPILTER );
			AppntNo = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 9, SysConst.PACKAGESPILTER );
			UrgePayFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 10, SysConst.PACKAGESPILTER );
			NeedAcc = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 11, SysConst.PACKAGESPILTER );
			PayTimes= new Integer(ChgData.chgNumericStr(StrTool.getStr(strMessage,12,SysConst.PACKAGESPILTER))).intValue();
			Rate = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,13,SysConst.PACKAGESPILTER))).doubleValue();
			PayStartDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 14,SysConst.PACKAGESPILTER));
			PayEndDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 15,SysConst.PACKAGESPILTER));
			...
			StandPrem = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,18,SysConst.PACKAGESPILTER))).doubleValue();
			Prem = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,19,SysConst.PACKAGESPILTER))).doubleValue();
			SumPrem = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,20,SysConst.PACKAGESPILTER))).doubleValue();
			SuppRiskScore = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,21,SysConst.PACKAGESPILTER))).doubleValue();
			FreeFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 22, SysConst.PACKAGESPILTER );
			FreeRate = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,23,SysConst.PACKAGESPILTER))).doubleValue();
			FreeStartDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 24,SysConst.PACKAGESPILTER));
			FreeEndDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 25,SysConst.PACKAGESPILTER));
			...
			AddFeeDirect = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 33, SysConst.PACKAGESPILTER );
			ExemptPeriod = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 34, SysConst.PACKAGESPILTER );
			NBPolNo = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 35, SysConst.PACKAGESPILTER );
			ExemptReason = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 36, SysConst.PACKAGESPILTER );
			ExemptDesc = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 37, SysConst.PACKAGESPILTER );
		}
	...
	**/
	public String getV(String FCode)
	{
		...
		{
			strReturn = StrTool.GBKToUnicode(String.valueOf(ExemptPeriod));
		}
		if (FCode.equalsIgnoreCase("NBPolNo"))
		{
			strReturn = StrTool.GBKToUnicode(String.valueOf(NBPolNo));
		}
		if (FCode.equalsIgnoreCase("ExemptReason"))
		{
			strReturn = StrTool.GBKToUnicode(String.valueOf(ExemptReason));
		}
		if (FCode.equalsIgnoreCase("ExemptDesc"))
		{
			strReturn = StrTool.GBKToUnicode(String.valueOf(ExemptDesc));
		}
		if (strReturn.equals(""))
		{
			strReturn = "null";
	...
	public String getV(int nFieldIndex)
	{
		...
		switch(nFieldIndex) {
			...
			case 32:
				...
				break;
			case 33:
				strFieldValue = StrTool.GBKToUnicode(ExemptPeriod);
				break;
			case 34:
				strFieldValue = StrTool.GBKToUnicode(NBPolNo);
				break;
			case 35:
				strFieldValue = StrTool.GBKToUnicode(ExemptReason);
				break;
			case 36:
				strFieldValue = StrTool.GBKToUnicode(ExemptDesc);
				break;
			default:
				strFieldValue = "";
		};
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LLExemptSchema other = (LLExemptSchema)otherObject;
		return
			...
			&& ExemptPeriod.equals(other.getExemptPeriod())
			&& NBPolNo.equals(other.getNBPolNo())
			&& ExemptReason.equals(other.getExemptReason())
			&& ExemptDesc.equals(other.getExemptDesc());
	}
	...
	**/
	public int getFieldIndex(String strFieldName)
	{
		...
		if( strFieldName.equals("ExemptPeriod") ) {
			return 33;
		}
		if( strFieldName.equals("NBPolNo") ) {
			return 34;
		}
		if( strFieldName.equals("ExemptReason") ) {
			return 35;
		}
		if( strFieldName.equals("ExemptDesc") ) {
			return 36;
		}
		return -1;
	}
	...
	public String getFieldName(int nFieldIndex)
	{
		...
		switch(nFieldIndex) {
			...
			case 32:
				...
				break;
			case 33:
				strFieldName = "ExemptPeriod";
				break;
			case 34:
				strFieldName = "NBPolNo";
				break;
			case 35:
				strFieldName = "ExemptReason";
				break;
			case 36:
				strFieldName = "ExemptDesc";
				break;
			default:
				strFieldName = "";
		};
