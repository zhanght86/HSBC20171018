...
/*
 * <p>ClassName: LSQuotEdorRuleDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: Physical Data Model 1
 */
public class LSQuotEdorRuleDBSet extends LSQuotEdorRuleSet
{
	// @Field
	...
	**/
	...
	// @Constructor
	public LSQuotEdorRuleDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LSQuotEdorRuleDBSet";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getEdorCode() == null || this.get(i).getEdorCode().equals("null")) {
				...
				pstmt.setString(5, this.get(i).getEdorCode());
			}
