...
{
private static Logger logger = Logger.getLogger(LCInsuredRelatedDBSet.class);
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getSequenceNo() == null || this.get(i).getSequenceNo().equals("null")) {
				...
				pstmt.setString(16, this.get(i).getSequenceNo());
			}
			// set where condition
			if(this.get(i).getPolNo() == null || this.get(i).getPolNo().equals("null")) {
			...
			if(this.get(i).getMainCustomerNo() == null || this.get(i).getMainCustomerNo().equals("null")) {
				...
				pstmt.setString(19, this.get(i).getMainCustomerNo());
			}
