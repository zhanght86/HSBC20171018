...
/*
 * <p>ClassName: PD_LMDutyGetRelaSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: PhysicalDataModel_4
 */
public class PD_LMDutyGetRelaSchema implements Schema, Cloneable
{
	// @Field
	/** 责任代码 */
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		PD_LMDutyGetRelaSchema cloned = (PD_LMDutyGetRelaSchema)super.clone();
	...
	/**
	* 使用另外一个 PD_LMDutyGetRelaSchema 对象给 Schema 赋值
	* @param: aPD_LMDutyGetRelaSchema PD_LMDutyGetRelaSchema
	**/
	public void setSchema(PD_LMDutyGetRelaSchema aPD_LMDutyGetRelaSchema)
	{
		this.DutyCode = aPD_LMDutyGetRelaSchema.getDutyCode();
		this.GetDutyCode = aPD_LMDutyGetRelaSchema.getGetDutyCode();
		this.GetDutyName = aPD_LMDutyGetRelaSchema.getGetDutyName();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			System.out.println("数据库中的PD_LMDutyGetRela表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "PD_LMDutyGetRelaSchema";
	...
	public PD_LMDutyGetRelaSchema getSchema()
	{
		PD_LMDutyGetRelaSchema aPD_LMDutyGetRelaSchema = new PD_LMDutyGetRelaSchema();
		aPD_LMDutyGetRelaSchema.setSchema(this);
		return aPD_LMDutyGetRelaSchema;
	}

	public PD_LMDutyGetRelaDB getDB()
	{
		PD_LMDutyGetRelaDB aDBOper = new PD_LMDutyGetRelaDB();
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpPD_LMDutyGetRela>历史记账凭证主表信息</A>表字段
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		PD_LMDutyGetRelaSchema other = (PD_LMDutyGetRelaSchema)otherObject;
		return
