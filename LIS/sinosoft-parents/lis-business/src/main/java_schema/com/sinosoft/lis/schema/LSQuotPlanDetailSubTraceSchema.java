...
import com.sinosoft.lis.db.LSQuotPlanDetailSubTraceDB;

/*
 * <p>ClassName: LSQuotPlanDetailSubTraceSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: Physical Data Model 1
 */
public class LSQuotPlanDetailSubTraceSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LSQuotPlanDetailSubTraceSchema.class);
	// @Field
	/** 流水号 */
	...
	// @Constructor
	public LSQuotPlanDetailSubTraceSchema()
	{
		mErrors = new CErrors();
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LSQuotPlanDetailSubTraceSchema cloned = (LSQuotPlanDetailSubTraceSchema)super.clone();
	...
	/**
	* 使用另外一个 LSQuotPlanDetailSubTraceSchema 对象给 Schema 赋值
	* @param: aLSQuotPlanDetailSubTraceSchema LSQuotPlanDetailSubTraceSchema
	**/
	public void setSchema(LSQuotPlanDetailSubTraceSchema aLSQuotPlanDetailSubTraceSchema)
	{
		this.SerialNo = aLSQuotPlanDetailSubTraceSchema.getSerialNo();
		this.QuotNo = aLSQuotPlanDetailSubTraceSchema.getQuotNo();
		this.QuotBatNo = aLSQuotPlanDetailSubTraceSchema.getQuotBatNo();
		this.SysPlanCode = aLSQuotPlanDetailSubTraceSchema.getSysPlanCode();
		this.PlanCode = aLSQuotPlanDetailSubTraceSchema.getPlanCode();
		this.RiskCode = aLSQuotPlanDetailSubTraceSchema.getRiskCode();
		this.DutyCode = aLSQuotPlanDetailSubTraceSchema.getDutyCode();
		this.P1 = aLSQuotPlanDetailSubTraceSchema.getP1();
		this.P2 = aLSQuotPlanDetailSubTraceSchema.getP2();
		this.P3 = aLSQuotPlanDetailSubTraceSchema.getP3();
		this.P4 = aLSQuotPlanDetailSubTraceSchema.getP4();
		this.P5 = aLSQuotPlanDetailSubTraceSchema.getP5();
		this.P6 = aLSQuotPlanDetailSubTraceSchema.getP6();
		this.P7 = aLSQuotPlanDetailSubTraceSchema.getP7();
		this.P8 = aLSQuotPlanDetailSubTraceSchema.getP8();
		this.P9 = aLSQuotPlanDetailSubTraceSchema.getP9();
		this.P10 = aLSQuotPlanDetailSubTraceSchema.getP10();
		this.P11 = aLSQuotPlanDetailSubTraceSchema.getP11();
		this.P12 = aLSQuotPlanDetailSubTraceSchema.getP12();
		this.P13 = aLSQuotPlanDetailSubTraceSchema.getP13();
		this.P14 = aLSQuotPlanDetailSubTraceSchema.getP14();
		this.P15 = aLSQuotPlanDetailSubTraceSchema.getP15();
		this.P16 = aLSQuotPlanDetailSubTraceSchema.getP16();
		this.P17 = aLSQuotPlanDetailSubTraceSchema.getP17();
		this.P18 = aLSQuotPlanDetailSubTraceSchema.getP18();
		this.P19 = aLSQuotPlanDetailSubTraceSchema.getP19();
		this.P20 = aLSQuotPlanDetailSubTraceSchema.getP20();
		this.P21 = aLSQuotPlanDetailSubTraceSchema.getP21();
		this.P22 = aLSQuotPlanDetailSubTraceSchema.getP22();
		this.P23 = aLSQuotPlanDetailSubTraceSchema.getP23();
		this.P24 = aLSQuotPlanDetailSubTraceSchema.getP24();
		this.P25 = aLSQuotPlanDetailSubTraceSchema.getP25();
		this.P26 = aLSQuotPlanDetailSubTraceSchema.getP26();
		this.P27 = aLSQuotPlanDetailSubTraceSchema.getP27();
		this.P28 = aLSQuotPlanDetailSubTraceSchema.getP28();
		this.P29 = aLSQuotPlanDetailSubTraceSchema.getP29();
		this.P30 = aLSQuotPlanDetailSubTraceSchema.getP30();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LSQuotPlanDetailSubTrace表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LSQuotPlanDetailSubTraceSchema";
	...
	public LSQuotPlanDetailSubTraceSchema getSchema()
	{
		LSQuotPlanDetailSubTraceSchema aLSQuotPlanDetailSubTraceSchema = new LSQuotPlanDetailSubTraceSchema();
		aLSQuotPlanDetailSubTraceSchema.setSchema(this);
		return aLSQuotPlanDetailSubTraceSchema;
	}

	public LSQuotPlanDetailSubTraceDB getDB()
	{
		LSQuotPlanDetailSubTraceDB aDBOper = new LSQuotPlanDetailSubTraceDB();
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLSQuotPlanDetailSubTrace>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			P21 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 28, SysConst.PACKAGESPILTER );
			P22 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 29, SysConst.PACKAGESPILTER );
			P23 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 30, SysConst.PACKAGESPILTER );
			P24 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 31, SysConst.PACKAGESPILTER );
			P25 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 32, SysConst.PACKAGESPILTER );
			P26 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 33, SysConst.PACKAGESPILTER );
			P27 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 34, SysConst.PACKAGESPILTER );
			P28 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 35, SysConst.PACKAGESPILTER );
			P29 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 36, SysConst.PACKAGESPILTER );
			P30 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 37, SysConst.PACKAGESPILTER );
		}
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LSQuotPlanDetailSubTraceSchema other = (LSQuotPlanDetailSubTraceSchema)otherObject;
		return
