...
/*
 * <p>ClassName: LLGrpClaimPopedomDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 理赔管理
 */
public class LLGrpClaimPopedomDBSet extends LLGrpClaimPopedomSet
{
private static Logger logger = Logger.getLogger(LLGrpClaimPopedomDBSet.class);
	...
	**/
	...
	// @Constructor
	public LLGrpClaimPopedomDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LLGrpClaimPopedomDBSet";
...
ex.printStackTrace();
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getDSFlag() == null || this.get(i).getDSFlag().equals("null")) {
				pstmt.setString(18,null);
			} else {
				pstmt.setString(18, this.get(i).getDSFlag());
			}
			// set where condition
			if(this.get(i).getJobCategory() == null || this.get(i).getJobCategory().equals("null")) {
				pstmt.setString(19,null);
			} else {
				pstmt.setString(19, this.get(i).getJobCategory());
			}
			if(this.get(i).getCaseCategory() == null || this.get(i).getCaseCategory().equals("null")) {
				pstmt.setString(20,null);
			} else {
				pstmt.setString(20, this.get(i).getCaseCategory());
			}
