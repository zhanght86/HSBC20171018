...
/*
 * <p>ClassName: LCInsureAccClassFeeBakDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: PhysicalDataModel_1
 */
public class LCInsureAccClassFeeBakDBSet extends LCInsureAccClassFeeBakSet
{
private static Logger logger = Logger.getLogger(LCInsureAccClassFeeBakDBSet.class);
	...
	**/
	...
	// @Constructor
	public LCInsureAccClassFeeBakDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public LCInsureAccClassFeeBakDBSet()
	{
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LCInsureAccClassFeeBakDBSet";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getOtherType() == null || this.get(i).getOtherType().equals("null")) {
				...
				pstmt.setString(5, this.get(i).getOtherType());
			}
			if(this.get(i).getAccAscription() == null || this.get(i).getAccAscription().equals("null")) {
				pstmt.setString(6,null);
			} else {
				pstmt.setString(6, this.get(i).getAccAscription());
			}
			...
			if(this.get(i).getFeeCode() == null || this.get(i).getFeeCode().equals("null")) {
				...
				pstmt.setString(28, this.get(i).getFeeCode());
			}
			if(this.get(i).getIsInitFee() == null || this.get(i).getIsInitFee().equals("null")) {
				pstmt.setString(29,null);
			} else {
				pstmt.setString(29, this.get(i).getIsInitFee());
			}
			// set where condition
			if(this.get(i).getPolNo() == null || this.get(i).getPolNo().equals("null")) {
			...
			if(this.get(i).getOtherNo() == null || this.get(i).getOtherNo().equals("null")) {
				...
				pstmt.setString(33, this.get(i).getOtherNo());
			}
			if(this.get(i).getAccAscription() == null || this.get(i).getAccAscription().equals("null")) {
				pstmt.setString(34,null);
			} else {
				pstmt.setString(34, StrTool.space1(this.get(i).getAccAscription(), 1));
			}
			if(this.get(i).getFeeCode() == null || this.get(i).getFeeCode().equals("null")) {
