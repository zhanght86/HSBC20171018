...
/*
 * <p>ClassName: PD_LACommissionRateSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: PD_LACommissionRate
 */
public class PD_LACommissionRateSchema implements Schema, Cloneable
{
	// @Field
	/** 流水號 */
	private String IDNo;
	...
	// @Constructor
	public PD_LACommissionRateSchema()
	{
		mErrors = new CErrors();
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		PD_LACommissionRateSchema cloned = (PD_LACommissionRateSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 PD_LACommissionRateSchema 对象给 Schema 赋值
	* @param: aPD_LACommissionRateSchema PD_LACommissionRateSchema
	**/
	public void setSchema(PD_LACommissionRateSchema aPD_LACommissionRateSchema)
	{
		this.IDNo = aPD_LACommissionRateSchema.getIDNo();
		this.AgentCom = aPD_LACommissionRateSchema.getAgentCom();
		this.ManageCom = aPD_LACommissionRateSchema.getManageCom();
		this.RiskCode = aPD_LACommissionRateSchema.getRiskCode();
		this.PayYear = aPD_LACommissionRateSchema.getPayYear();
		this.Currency = aPD_LACommissionRateSchema.getCurrency();
		this.InvestType = aPD_LACommissionRateSchema.getInvestType();
		this.PayType = aPD_LACommissionRateSchema.getPayType();
		this.ProtectionPlan = aPD_LACommissionRateSchema.getProtectionPlan();
		this.PayYears = aPD_LACommissionRateSchema.getPayYears();
		this.CommRate = aPD_LACommissionRateSchema.getCommRate();
		this.StartDate = fDate.getDate( aPD_LACommissionRateSchema.getStartDate());
		this.EndDate = fDate.getDate( aPD_LACommissionRateSchema.getEndDate());
		this.ValidFlag = aPD_LACommissionRateSchema.getValidFlag();
		this.AppState = aPD_LACommissionRateSchema.getAppState();
		this.AppDate = fDate.getDate( aPD_LACommissionRateSchema.getAppDate());
		this.AppTime = aPD_LACommissionRateSchema.getAppTime();
		this.Branchtype = aPD_LACommissionRateSchema.getBranchtype();
		this.ActionType = aPD_LACommissionRateSchema.getActionType();
		this.OrigIDNo = aPD_LACommissionRateSchema.getOrigIDNo();
		this.Operator = aPD_LACommissionRateSchema.getOperator();
		this.MakeDate = fDate.getDate( aPD_LACommissionRateSchema.getMakeDate());
		this.MakeTime = aPD_LACommissionRateSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aPD_LACommissionRateSchema.getModifyDate());
		this.ModifyTime = aPD_LACommissionRateSchema.getModifyTime();
		this.StaffRate = aPD_LACommissionRateSchema.getStaffRate();
		this.InsureAgeStart = aPD_LACommissionRateSchema.getInsureAgeStart();
		this.InsureAgeEnd = aPD_LACommissionRateSchema.getInsureAgeEnd();
		this.PayToAge = aPD_LACommissionRateSchema.getPayToAge();
		this.DefaultFlag = aPD_LACommissionRateSchema.getDefaultFlag();
		this.SRFlag = aPD_LACommissionRateSchema.getSRFlag();
		this.PlanCode = aPD_LACommissionRateSchema.getPlanCode();
		this.Insuyear = aPD_LACommissionRateSchema.getInsuyear();
		this.InsuyearFlag = aPD_LACommissionRateSchema.getInsuyearFlag();
		this.SectionFlag = aPD_LACommissionRateSchema.getSectionFlag();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			System.out.println("数据库中的PD_LACommissionRate表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			sqle.printStackTrace();
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "PD_LACommissionRateSchema";
	...
	public PD_LACommissionRateSchema getSchema()
	{
		PD_LACommissionRateSchema aPD_LACommissionRateSchema = new PD_LACommissionRateSchema();
		aPD_LACommissionRateSchema.setSchema(this);
		return aPD_LACommissionRateSchema;
	}

	public PD_LACommissionRateDB getDB()
	{
		PD_LACommissionRateDB aDBOper = new PD_LACommissionRateDB();
	...
	**/
	public String encode()
	{
		...
		strReturn.append(StrTool.cTrim(SectionFlag));
		return strReturn.toString();
	}

	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpPD_LACommissionRate>历史记账凭证主表信息</A>表字段
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		PD_LACommissionRateSchema other = (PD_LACommissionRateSchema)otherObject;
		return
