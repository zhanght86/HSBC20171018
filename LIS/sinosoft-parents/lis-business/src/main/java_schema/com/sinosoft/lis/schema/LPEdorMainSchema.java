...
{
private static Logger logger = Logger.getLogger(LPEdorMainSchema.class);
	// @Field
	/** 保全受理号 */
	...
	**/
	public void setSchema(LPEdorMainSchema aLPEdorMainSchema)
	{
		...
		this.ApproveGrade = aLPEdorMainSchema.getApproveGrade();
		this.Currency = aLPEdorMainSchema.getCurrency();
		this.GrpContNo = aLPEdorMainSchema.getGrpContNo();
		this.ComCode = aLPEdorMainSchema.getComCode();
		this.ModifyOperator = aLPEdorMainSchema.getModifyOperator();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LPEdorMain表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
