...
/*
 * <p>ClassName: LPCUWErrorDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 保全流程
 */
public class LPCUWErrorDBSet extends LPCUWErrorSet
{
private static Logger logger = Logger.getLogger(LPCUWErrorDBSet.class);
	...
	**/
	...
	// @Constructor
	public LPCUWErrorDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LPCUWErrorDBSet";
