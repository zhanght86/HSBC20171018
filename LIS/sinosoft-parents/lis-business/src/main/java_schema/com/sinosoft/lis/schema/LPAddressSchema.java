...
/*
 * <p>ClassName: LPAddressSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 保全核心
 */
public class LPAddressSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LPAddressSchema.class);
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LPAddressSchema cloned = (LPAddressSchema)super.clone();
	...
	/**
	* 使用另外一个 LPAddressSchema 对象给 Schema 赋值
	* @param: aLPAddressSchema LPAddressSchema
	**/
	public void setSchema(LPAddressSchema aLPAddressSchema)
	{
		this.EdorNo = aLPAddressSchema.getEdorNo();
		this.EdorType = aLPAddressSchema.getEdorType();
		this.CustomerNo = aLPAddressSchema.getCustomerNo();
		this.AddressNo = aLPAddressSchema.getAddressNo();
		this.PostalAddress = aLPAddressSchema.getPostalAddress();
		this.ZipCode = aLPAddressSchema.getZipCode();
		this.Phone = aLPAddressSchema.getPhone();
		this.Fax = aLPAddressSchema.getFax();
		this.HomeAddress = aLPAddressSchema.getHomeAddress();
		this.HomeZipCode = aLPAddressSchema.getHomeZipCode();
		this.HomePhone = aLPAddressSchema.getHomePhone();
		this.HomeFax = aLPAddressSchema.getHomeFax();
		this.CompanyAddress = aLPAddressSchema.getCompanyAddress();
		this.CompanyZipCode = aLPAddressSchema.getCompanyZipCode();
		this.CompanyPhone = aLPAddressSchema.getCompanyPhone();
		this.CompanyFax = aLPAddressSchema.getCompanyFax();
		this.Mobile = aLPAddressSchema.getMobile();
		this.MobileChs = aLPAddressSchema.getMobileChs();
		this.EMail = aLPAddressSchema.getEMail();
		this.BP = aLPAddressSchema.getBP();
		this.Mobile2 = aLPAddressSchema.getMobile2();
		this.MobileChs2 = aLPAddressSchema.getMobileChs2();
		this.EMail2 = aLPAddressSchema.getEMail2();
		this.BP2 = aLPAddressSchema.getBP2();
		this.Operator = aLPAddressSchema.getOperator();
		this.MakeDate = fDate.getDate( aLPAddressSchema.getMakeDate());
		this.MakeTime = aLPAddressSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLPAddressSchema.getModifyDate());
		this.ModifyTime = aLPAddressSchema.getModifyTime();
		this.GrpName = aLPAddressSchema.getGrpName();
		this.Province = aLPAddressSchema.getProvince();
		this.City = aLPAddressSchema.getCity();
		this.County = aLPAddressSchema.getCounty();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LPAddress表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LPAddressSchema";
	...
	public LPAddressSchema getSchema()
	{
		LPAddressSchema aLPAddressSchema = new LPAddressSchema();
		aLPAddressSchema.setSchema(this);
		return aLPAddressSchema;
	}

	public LPAddressDB getDB()
	{
		LPAddressDB aDBOper = new LPAddressDB();
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLPAddress>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			AddressNo= new Integer(ChgData.chgNumericStr(StrTool.getStr(strMessage,4,SysConst.PACKAGESPILTER))).intValue();
			...
			CompanyAddress = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 13, SysConst.PACKAGESPILTER );
			CompanyZipCode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 14, SysConst.PACKAGESPILTER );
			CompanyPhone = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 15, SysConst.PACKAGESPILTER );
			CompanyFax = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 16, SysConst.PACKAGESPILTER );
			Mobile = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 17, SysConst.PACKAGESPILTER );
			MobileChs = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 18, SysConst.PACKAGESPILTER );
			EMail = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 19, SysConst.PACKAGESPILTER );
			BP = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 20, SysConst.PACKAGESPILTER );
			Mobile2 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 21, SysConst.PACKAGESPILTER );
			MobileChs2 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 22, SysConst.PACKAGESPILTER );
			EMail2 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 23, SysConst.PACKAGESPILTER );
			BP2 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 24, SysConst.PACKAGESPILTER );
			...
			GrpName = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 30, SysConst.PACKAGESPILTER );
			Province = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 31, SysConst.PACKAGESPILTER );
			City = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 32, SysConst.PACKAGESPILTER );
			County = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 33, SysConst.PACKAGESPILTER );
		}
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LPAddressSchema other = (LPAddressSchema)otherObject;
		return
