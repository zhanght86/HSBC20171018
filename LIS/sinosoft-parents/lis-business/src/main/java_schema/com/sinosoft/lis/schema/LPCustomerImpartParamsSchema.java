...
/*
 * <p>ClassName: LPCustomerImpartParamsSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 保全核心
 */
public class LPCustomerImpartParamsSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LPCustomerImpartParamsSchema.class);
	...
	// @Constructor
	public LPCustomerImpartParamsSchema()
	{
		mErrors = new CErrors();
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LPCustomerImpartParamsSchema cloned = (LPCustomerImpartParamsSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LPCustomerImpartParamsSchema 对象给 Schema 赋值
	* @param: aLPCustomerImpartParamsSchema LPCustomerImpartParamsSchema
	**/
	public void setSchema(LPCustomerImpartParamsSchema aLPCustomerImpartParamsSchema)
	{
		this.EdorNo = aLPCustomerImpartParamsSchema.getEdorNo();
		this.EdorType = aLPCustomerImpartParamsSchema.getEdorType();
		this.GrpContNo = aLPCustomerImpartParamsSchema.getGrpContNo();
		this.ContNo = aLPCustomerImpartParamsSchema.getContNo();
		this.ProposalContNo = aLPCustomerImpartParamsSchema.getProposalContNo();
		this.PrtNo = aLPCustomerImpartParamsSchema.getPrtNo();
		this.ImpartCode = aLPCustomerImpartParamsSchema.getImpartCode();
		this.ImpartVer = aLPCustomerImpartParamsSchema.getImpartVer();
		this.CustomerNo = aLPCustomerImpartParamsSchema.getCustomerNo();
		this.CustomerNoType = aLPCustomerImpartParamsSchema.getCustomerNoType();
		this.ImpartParamNo = aLPCustomerImpartParamsSchema.getImpartParamNo();
		this.ImpartParamName = aLPCustomerImpartParamsSchema.getImpartParamName();
		this.ImpartParam = aLPCustomerImpartParamsSchema.getImpartParam();
		this.Operator = aLPCustomerImpartParamsSchema.getOperator();
		this.MakeDate = fDate.getDate( aLPCustomerImpartParamsSchema.getMakeDate());
		this.MakeTime = aLPCustomerImpartParamsSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLPCustomerImpartParamsSchema.getModifyDate());
		this.ModifyTime = aLPCustomerImpartParamsSchema.getModifyTime();
		this.PatchNo = aLPCustomerImpartParamsSchema.getPatchNo();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LPCustomerImpartParams表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LPCustomerImpartParamsSchema";
	...
	public LPCustomerImpartParamsSchema getSchema()
	{
		LPCustomerImpartParamsSchema aLPCustomerImpartParamsSchema = new LPCustomerImpartParamsSchema();
		aLPCustomerImpartParamsSchema.setSchema(this);
		return aLPCustomerImpartParamsSchema;
	}

	public LPCustomerImpartParamsDB getDB()
	{
		LPCustomerImpartParamsDB aDBOper = new LPCustomerImpartParamsDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLPCustomerImpartParams描述/A>表字段
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLPCustomerImpartParams>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			CustomerNoType = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 10, SysConst.PACKAGESPILTER );
			ImpartParamNo = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 11, SysConst.PACKAGESPILTER );
			ImpartParamName = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 12, SysConst.PACKAGESPILTER );
			ImpartParam = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 13, SysConst.PACKAGESPILTER );
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LPCustomerImpartParamsSchema other = (LPCustomerImpartParamsSchema)otherObject;
		return
