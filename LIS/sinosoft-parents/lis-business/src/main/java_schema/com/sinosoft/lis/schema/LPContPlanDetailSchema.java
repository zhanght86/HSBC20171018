...
import com.sinosoft.lis.db.LPContPlanDetailDB;

/*
 * <p>ClassName: LPContPlanDetailSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: Physical Data Model 1
 */
public class LPContPlanDetailSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LPContPlanDetailSchema.class);
	// @Field
	/** 保全批单号 */
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LPContPlanDetailSchema cloned = (LPContPlanDetailSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LPContPlanDetailSchema 对象给 Schema 赋值
	* @param: aLPContPlanDetailSchema LPContPlanDetailSchema
	**/
	public void setSchema(LPContPlanDetailSchema aLPContPlanDetailSchema)
	{
		this.EdorNo = aLPContPlanDetailSchema.getEdorNo();
		this.EdorType = aLPContPlanDetailSchema.getEdorType();
		this.PolicyNo = aLPContPlanDetailSchema.getPolicyNo();
		this.PropNo = aLPContPlanDetailSchema.getPropNo();
		this.SysPlanCode = aLPContPlanDetailSchema.getSysPlanCode();
		this.PlanCode = aLPContPlanDetailSchema.getPlanCode();
		this.RiskCode = aLPContPlanDetailSchema.getRiskCode();
		this.DutyCode = aLPContPlanDetailSchema.getDutyCode();
		this.AmntType = aLPContPlanDetailSchema.getAmntType();
		this.FixedAmnt = aLPContPlanDetailSchema.getFixedAmnt();
		this.SalaryMult = aLPContPlanDetailSchema.getSalaryMult();
		this.MaxAmnt = aLPContPlanDetailSchema.getMaxAmnt();
		this.MinAmnt = aLPContPlanDetailSchema.getMinAmnt();
		this.ExceptPremType = aLPContPlanDetailSchema.getExceptPremType();
		this.ExceptPrem = aLPContPlanDetailSchema.getExceptPrem();
		this.StandValue = aLPContPlanDetailSchema.getStandValue();
		this.InitPrem = aLPContPlanDetailSchema.getInitPrem();
		this.ExceptYield = aLPContPlanDetailSchema.getExceptYield();
		this.FinalValue = aLPContPlanDetailSchema.getFinalValue();
		this.ChangeType = aLPContPlanDetailSchema.getChangeType();
		this.RelaShareFlag = aLPContPlanDetailSchema.getRelaShareFlag();
		this.Remark = aLPContPlanDetailSchema.getRemark();
		this.MakeOperator = aLPContPlanDetailSchema.getMakeOperator();
		this.MakeDate = fDate.getDate( aLPContPlanDetailSchema.getMakeDate());
		this.MakeTime = aLPContPlanDetailSchema.getMakeTime();
		this.ModifyOperator = aLPContPlanDetailSchema.getModifyOperator();
		this.ModifyDate = fDate.getDate( aLPContPlanDetailSchema.getModifyDate());
		this.ModifyTime = aLPContPlanDetailSchema.getModifyTime();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LPContPlanDetail表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LPContPlanDetailSchema";
	...
	public LPContPlanDetailSchema getSchema()
	{
		LPContPlanDetailSchema aLPContPlanDetailSchema = new LPContPlanDetailSchema();
		aLPContPlanDetailSchema.setSchema(this);
		return aLPContPlanDetailSchema;
	}

	public LPContPlanDetailDB getDB()
	{
		LPContPlanDetailDB aDBOper = new LPContPlanDetailDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLPContPlanDetail描述/A>表字段
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLPContPlanDetail>历史记账凭证主表信息</A>表字段
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LPContPlanDetailSchema other = (LPContPlanDetailSchema)otherObject;
		return
