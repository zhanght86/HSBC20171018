...
/*
 * <p>ClassName: LPGrpEdorItemSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 保全核心
 */
public class LPGrpEdorItemSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LPGrpEdorItemSchema.class);
	// @Field
	/** 保全受理号 */
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LPGrpEdorItemSchema cloned = (LPGrpEdorItemSchema)super.clone();
	...
	*/
	...
	public void setEdorTypeCal(String aEdorTypeCal)
	{
		if(aEdorTypeCal!=null && aEdorTypeCal.length()>10)
			throw new IllegalArgumentException("批改算法EdorTypeCal值"+aEdorTypeCal+"的长度"+aEdorTypeCal.length()+"大于最大值10");
	...
	*/
	...
	/**
	* 使用另外一个 LPGrpEdorItemSchema 对象给 Schema 赋值
	* @param: aLPGrpEdorItemSchema LPGrpEdorItemSchema
	**/
	public void setSchema(LPGrpEdorItemSchema aLPGrpEdorItemSchema)
	{
		this.EdorAcceptNo = aLPGrpEdorItemSchema.getEdorAcceptNo();
		this.EdorNo = aLPGrpEdorItemSchema.getEdorNo();
		this.EdorAppNo = aLPGrpEdorItemSchema.getEdorAppNo();
		this.EdorType = aLPGrpEdorItemSchema.getEdorType();
		this.DisplayType = aLPGrpEdorItemSchema.getDisplayType();
		this.GrpContNo = aLPGrpEdorItemSchema.getGrpContNo();
		this.ManageCom = aLPGrpEdorItemSchema.getManageCom();
		this.EdorValiDate = fDate.getDate( aLPGrpEdorItemSchema.getEdorValiDate());
		this.EdorAppDate = fDate.getDate( aLPGrpEdorItemSchema.getEdorAppDate());
		this.EdorState = aLPGrpEdorItemSchema.getEdorState();
		this.UWFlag = aLPGrpEdorItemSchema.getUWFlag();
		this.UWOperator = aLPGrpEdorItemSchema.getUWOperator();
		this.UWDate = fDate.getDate( aLPGrpEdorItemSchema.getUWDate());
		this.UWTime = aLPGrpEdorItemSchema.getUWTime();
		this.ChgPrem = aLPGrpEdorItemSchema.getChgPrem();
		this.ChgAmnt = aLPGrpEdorItemSchema.getChgAmnt();
		this.GetMoney = aLPGrpEdorItemSchema.getGetMoney();
		this.GetInterest = aLPGrpEdorItemSchema.getGetInterest();
		this.Operator = aLPGrpEdorItemSchema.getOperator();
		this.MakeDate = fDate.getDate( aLPGrpEdorItemSchema.getMakeDate());
		this.MakeTime = aLPGrpEdorItemSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLPGrpEdorItemSchema.getModifyDate());
		this.ModifyTime = aLPGrpEdorItemSchema.getModifyTime();
		this.AppReason = aLPGrpEdorItemSchema.getAppReason();
		this.EdorReasonCode = aLPGrpEdorItemSchema.getEdorReasonCode();
		this.EdorReason = aLPGrpEdorItemSchema.getEdorReason();
		this.ApproveFlag = aLPGrpEdorItemSchema.getApproveFlag();
		this.ApproveOperator = aLPGrpEdorItemSchema.getApproveOperator();
		this.ApproveDate = fDate.getDate( aLPGrpEdorItemSchema.getApproveDate());
		this.ApproveTime = aLPGrpEdorItemSchema.getApproveTime();
		this.ApproveGrade = aLPGrpEdorItemSchema.getApproveGrade();
		this.EdorTypeCal = aLPGrpEdorItemSchema.getEdorTypeCal();
		this.Currency = aLPGrpEdorItemSchema.getCurrency();
		this.FeeRate = aLPGrpEdorItemSchema.getFeeRate();
		this.ComCode = aLPGrpEdorItemSchema.getComCode();
		this.ModifyOperator = aLPGrpEdorItemSchema.getModifyOperator();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LPGrpEdorItem表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LPGrpEdorItemSchema";
	...
	public LPGrpEdorItemSchema getSchema()
	{
		LPGrpEdorItemSchema aLPGrpEdorItemSchema = new LPGrpEdorItemSchema();
		aLPGrpEdorItemSchema.setSchema(this);
		return aLPGrpEdorItemSchema;
	}

	public LPGrpEdorItemDB getDB()
	{
		LPGrpEdorItemDB aDBOper = new LPGrpEdorItemDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLPGrpEdorItem描述/A>表字段
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLPGrpEdorItem>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			AppReason = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 24, SysConst.PACKAGESPILTER );
			EdorReasonCode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 25, SysConst.PACKAGESPILTER );
			EdorReason = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 26, SysConst.PACKAGESPILTER );
			ApproveFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 27, SysConst.PACKAGESPILTER );
			ApproveOperator = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 28, SysConst.PACKAGESPILTER );
			...
			ApproveGrade = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 31, SysConst.PACKAGESPILTER );
			EdorTypeCal = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 32, SysConst.PACKAGESPILTER );
			Currency = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 33, SysConst.PACKAGESPILTER );
			FeeRate = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,34,SysConst.PACKAGESPILTER))).doubleValue();
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LPGrpEdorItemSchema other = (LPGrpEdorItemSchema)otherObject;
		return
