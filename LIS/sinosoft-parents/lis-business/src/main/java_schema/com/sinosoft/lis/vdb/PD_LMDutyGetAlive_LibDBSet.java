...
/*
 * <p>ClassName: PD_LMDutyGetAlive_LibDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 产品定义平台_PDM
 */
public class PD_LMDutyGetAlive_LibDBSet extends PD_LMDutyGetAlive_LibSet
{
private static Logger logger = Logger.getLogger(PD_LMDutyGetAlive_LibDBSet.class);
	...
	**/
	...
	// @Constructor
	public PD_LMDutyGetAlive_LibDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public PD_LMDutyGetAlive_LibDBSet()
	{
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "PD_LMDutyGetAlive_LibDBSet";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getGetDutyCode2() == null || this.get(i).getGetDutyCode2().equals("null")) {
				...
				pstmt.setString(46, this.get(i).getGetDutyCode2());
			}
