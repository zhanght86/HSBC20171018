...
/*
 * <p>ClassName: LOBContPlanDetailDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: Physical Data Model 1
 */
public class LOBContPlanDetailDBSet extends LOBContPlanDetailSet
{
	// @Field
	...
	**/
	...
	// @Constructor
	public LOBContPlanDetailDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LOBContPlanDetailDBSet";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getBussType() == null || this.get(i).getBussType().equals("null")) {
				...
				pstmt.setString(29, this.get(i).getBussType());
			}
			if(this.get(i).getBussNo() == null || this.get(i).getBussNo().equals("null")) {
				pstmt.setString(30,null);
			} else {
				pstmt.setString(30, this.get(i).getBussNo());
			}
			if(this.get(i).getPolicyNo() == null || this.get(i).getPolicyNo().equals("null")) {
