...
/*
 * <p>ClassName: LJAPayPersonDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 寿险业务收费
 */
public class LJAPayPersonDBSet extends LJAPayPersonSet
{
	// @Field
	...
	**/
	...
	// @Constructor
	public LJAPayPersonDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LJAPayPersonDBSet";
...
ex.printStackTrace();
	...
	public boolean update()
	{
		...
		try
		{
			...
			pstmt.setInt(38, this.get(i).getMainPolYear());
			...
			if(this.get(i).getEndorsementNo() == null || this.get(i).getEndorsementNo().equals("null")) {
				...
				pstmt.setString(41, this.get(i).getEndorsementNo());
			}
			if(this.get(i).getGetFlag() == null || this.get(i).getGetFlag().equals("null")) {
				pstmt.setString(42,null);
			} else {
				pstmt.setString(42, this.get(i).getGetFlag());
			}
			...
			pstmt.setInt(49, this.get(i).getPayCount());
			if(this.get(i).getPayNo() == null || this.get(i).getPayNo().equals("null")) {
				pstmt.setString(50,null);
			} else {
				pstmt.setString(50, this.get(i).getPayNo());
			}
			if(this.get(i).getDutyCode() == null || this.get(i).getDutyCode().equals("null")) {
			...
			if(this.get(i).getPayPlanCode() == null || this.get(i).getPayPlanCode().equals("null")) {
				...
				pstmt.setString(52, this.get(i).getPayPlanCode());
			}
			if(this.get(i).getPayType() == null || this.get(i).getPayType().equals("null")) {
				pstmt.setString(53,null);
			} else {
				pstmt.setString(53, this.get(i).getPayType());
			}
