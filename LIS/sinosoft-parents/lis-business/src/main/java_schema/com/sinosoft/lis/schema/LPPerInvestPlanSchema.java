...
import com.sinosoft.lis.db.LPPerInvestPlanDB;

/*
 * <p>ClassName: LPPerInvestPlanSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 泰康未整理PDM
 */
public class LPPerInvestPlanSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LPPerInvestPlanSchema.class);
	// @Field
	/** 批单号 */
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LPPerInvestPlanSchema cloned = (LPPerInvestPlanSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LPPerInvestPlanSchema 对象给 Schema 赋值
	* @param: aLPPerInvestPlanSchema LPPerInvestPlanSchema
	**/
	public void setSchema(LPPerInvestPlanSchema aLPPerInvestPlanSchema)
	{
		this.EdorNo = aLPPerInvestPlanSchema.getEdorNo();
		this.EdorType = aLPPerInvestPlanSchema.getEdorType();
		this.ContNo = aLPPerInvestPlanSchema.getContNo();
		this.PolNo = aLPPerInvestPlanSchema.getPolNo();
		this.GrpPolNo = aLPPerInvestPlanSchema.getGrpPolNo();
		this.GrpContNo = aLPPerInvestPlanSchema.getGrpContNo();
		this.InsuredNo = aLPPerInvestPlanSchema.getInsuredNo();
		this.RiskCode = aLPPerInvestPlanSchema.getRiskCode();
		this.PayPlanCode = aLPPerInvestPlanSchema.getPayPlanCode();
		this.InsuAccNo = aLPPerInvestPlanSchema.getInsuAccNo();
		this.InvestMinRate = aLPPerInvestPlanSchema.getInvestMinRate();
		this.InvestMaxRate = aLPPerInvestPlanSchema.getInvestMaxRate();
		this.InputMode = aLPPerInvestPlanSchema.getInputMode();
		this.InvestRate = aLPPerInvestPlanSchema.getInvestRate();
		this.InvestMoney = aLPPerInvestPlanSchema.getInvestMoney();
		this.Operator = aLPPerInvestPlanSchema.getOperator();
		this.MakeDate = fDate.getDate( aLPPerInvestPlanSchema.getMakeDate());
		this.MakeTime = aLPPerInvestPlanSchema.getMakeTime();
		this.ModifyOperator = aLPPerInvestPlanSchema.getModifyOperator();
		this.ModifyDate = fDate.getDate( aLPPerInvestPlanSchema.getModifyDate());
		this.ModifyTime = aLPPerInvestPlanSchema.getModifyTime();
		this.Currency = aLPPerInvestPlanSchema.getCurrency();
		this.DutyCode = aLPPerInvestPlanSchema.getDutyCode();
		this.RealInvestMoney = aLPPerInvestPlanSchema.getRealInvestMoney();
		this.ManageCom = aLPPerInvestPlanSchema.getManageCom();
		this.ComCode = aLPPerInvestPlanSchema.getComCode();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LPPerInvestPlan表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LPPerInvestPlanSchema";
	...
	public LPPerInvestPlanSchema getSchema()
	{
		LPPerInvestPlanSchema aLPPerInvestPlanSchema = new LPPerInvestPlanSchema();
		aLPPerInvestPlanSchema.setSchema(this);
		return aLPPerInvestPlanSchema;
	}

	public LPPerInvestPlanDB getDB()
	{
		LPPerInvestPlanDB aDBOper = new LPPerInvestPlanDB();
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLPPerInvestPlan>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			InvestMinRate = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,11,SysConst.PACKAGESPILTER))).doubleValue();
			InvestMaxRate = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,12,SysConst.PACKAGESPILTER))).doubleValue();
			InputMode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 13, SysConst.PACKAGESPILTER );
			InvestRate = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,14,SysConst.PACKAGESPILTER))).doubleValue();
			InvestMoney = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,15,SysConst.PACKAGESPILTER))).doubleValue();
			...
			RealInvestMoney = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,24,SysConst.PACKAGESPILTER))).doubleValue();
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LPPerInvestPlanSchema other = (LPPerInvestPlanSchema)otherObject;
		return
