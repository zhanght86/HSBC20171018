...
/*
 * <p>ClassName: LBGeneralToRiskDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 泰康未整理PDM
 */
public class LBGeneralToRiskDBSet extends LBGeneralToRiskSet
{
	// @Field
	...
	**/
	...
	// @Constructor
	public LBGeneralToRiskDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LBGeneralToRiskDBSet";
	...
	public boolean delete()
	{
		...
		try
		{
			...
			if(this.get(i).getExecuteCom() == null || this.get(i).getExecuteCom().equals("null")) {
				...
				pstmt.setString(3, this.get(i).getExecuteCom());
			}
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getExecuteCom() == null || this.get(i).getExecuteCom().equals("null")) {
				...
				pstmt.setString(6, this.get(i).getExecuteCom());
			}
			...
			if(this.get(i).getGetFlag() == null || this.get(i).getGetFlag().equals("null")) {
				...
				pstmt.setString(20, this.get(i).getGetFlag());
			}
			...
			if(this.get(i).getAccName() == null || this.get(i).getAccName().equals("null")) {
				...
				pstmt.setString(23, this.get(i).getAccName());
			}
			if(this.get(i).getFirstPayDate() == null || this.get(i).getFirstPayDate().equals("null")) {
				pstmt.setDate(24,null);
			} else {
				pstmt.setDate(24, Date.valueOf(this.get(i).getFirstPayDate()));
			}
			if(this.get(i).getPayEndDate() == null || this.get(i).getPayEndDate().equals("null")) {
				pstmt.setDate(25,null);
			} else {
				pstmt.setDate(25, Date.valueOf(this.get(i).getPayEndDate()));
			}
			if(this.get(i).getPaytoDate() == null || this.get(i).getPaytoDate().equals("null")) {
				pstmt.setDate(26,null);
			} else {
				pstmt.setDate(26, Date.valueOf(this.get(i).getPaytoDate()));
			}
			if(this.get(i).getRegetDate() == null || this.get(i).getRegetDate().equals("null")) {
				pstmt.setDate(27,null);
			} else {
				pstmt.setDate(27, Date.valueOf(this.get(i).getRegetDate()));
			}
			if(this.get(i).getLastEdorDate() == null || this.get(i).getLastEdorDate().equals("null")) {
				pstmt.setDate(28,null);
			} else {
				pstmt.setDate(28, Date.valueOf(this.get(i).getLastEdorDate()));
			}
			if(this.get(i).getSSFlag() == null || this.get(i).getSSFlag().equals("null")) {
				pstmt.setString(29,null);
			} else {
				pstmt.setString(29, this.get(i).getSSFlag());
			}
			pstmt.setDouble(30, this.get(i).getPeakLine());
			pstmt.setDouble(31, this.get(i).getGetLimit());
			pstmt.setDouble(32, this.get(i).getGetRate());
			pstmt.setDouble(33, this.get(i).getBonusRate());
			pstmt.setDouble(34, this.get(i).getMaxMedFee());
			if(this.get(i).getOutPayFlag() == null || this.get(i).getOutPayFlag().equals("null")) {
				pstmt.setString(35,null);
			} else {
				pstmt.setString(35, this.get(i).getOutPayFlag());
			}
			pstmt.setDouble(36, this.get(i).getEmployeeRate());
			pstmt.setDouble(37, this.get(i).getFamilyRate());
			if(this.get(i).getSpecFlag() == null || this.get(i).getSpecFlag().equals("null")) {
				pstmt.setString(38,null);
			} else {
				pstmt.setString(38, this.get(i).getSpecFlag());
			}
			pstmt.setInt(39, this.get(i).getExpPeoples());
			pstmt.setDouble(40, this.get(i).getExpPremium());
			pstmt.setDouble(41, this.get(i).getExpAmnt());
			if(this.get(i).getPayMode() == null || this.get(i).getPayMode().equals("null")) {
				pstmt.setString(42,null);
			} else {
				pstmt.setString(42, this.get(i).getPayMode());
			}
			pstmt.setDouble(43, this.get(i).getManageFeeRate());
			pstmt.setInt(44, this.get(i).getPayIntv());
			if(this.get(i).getCValiDate() == null || this.get(i).getCValiDate().equals("null")) {
				pstmt.setDate(45,null);
			} else {
				pstmt.setDate(45, Date.valueOf(this.get(i).getCValiDate()));
			}
			pstmt.setInt(46, this.get(i).getPeoples2());
			pstmt.setDouble(47, this.get(i).getMult());
			pstmt.setDouble(48, this.get(i).getPrem());
			pstmt.setDouble(49, this.get(i).getAmnt());
			pstmt.setDouble(50, this.get(i).getSumPrem());
			pstmt.setDouble(51, this.get(i).getSumPay());
			pstmt.setDouble(52, this.get(i).getDif());
			if(this.get(i).getState() == null || this.get(i).getState().equals("null")) {
				pstmt.setString(53,null);
			} else {
				pstmt.setString(53, this.get(i).getState());
			}
			if(this.get(i).getApproveFlag() == null || this.get(i).getApproveFlag().equals("null")) {
				pstmt.setString(54,null);
			} else {
				pstmt.setString(54, this.get(i).getApproveFlag());
			}
			if(this.get(i).getApproveCode() == null || this.get(i).getApproveCode().equals("null")) {
				pstmt.setString(55,null);
			} else {
				pstmt.setString(55, this.get(i).getApproveCode());
			}
			if(this.get(i).getApproveDate() == null || this.get(i).getApproveDate().equals("null")) {
				pstmt.setDate(56,null);
			} else {
				pstmt.setDate(56, Date.valueOf(this.get(i).getApproveDate()));
			}
			if(this.get(i).getApproveTime() == null || this.get(i).getApproveTime().equals("null")) {
				pstmt.setString(57,null);
			} else {
				pstmt.setString(57, this.get(i).getApproveTime());
			}
			if(this.get(i).getUWFlag() == null || this.get(i).getUWFlag().equals("null")) {
				pstmt.setString(58,null);
			} else {
				pstmt.setString(58, this.get(i).getUWFlag());
			}
			if(this.get(i).getUWOperator() == null || this.get(i).getUWOperator().equals("null")) {
				pstmt.setString(59,null);
			} else {
				pstmt.setString(59, this.get(i).getUWOperator());
			}
			if(this.get(i).getUWDate() == null || this.get(i).getUWDate().equals("null")) {
				pstmt.setDate(60,null);
			} else {
				pstmt.setDate(60, Date.valueOf(this.get(i).getUWDate()));
			}
			if(this.get(i).getUWTime() == null || this.get(i).getUWTime().equals("null")) {
				pstmt.setString(61,null);
			} else {
				pstmt.setString(61, this.get(i).getUWTime());
			}
			if(this.get(i).getAppFlag() == null || this.get(i).getAppFlag().equals("null")) {
				pstmt.setString(62,null);
			} else {
				pstmt.setString(62, this.get(i).getAppFlag());
			}
			if(this.get(i).getRemark() == null || this.get(i).getRemark().equals("null")) {
				pstmt.setString(63,null);
			} else {
				pstmt.setString(63, this.get(i).getRemark());
			}
			if(this.get(i).getStandbyFlag1() == null || this.get(i).getStandbyFlag1().equals("null")) {
				pstmt.setString(64,null);
			} else {
				pstmt.setString(64, this.get(i).getStandbyFlag1());
			}
			if(this.get(i).getStandbyFlag2() == null || this.get(i).getStandbyFlag2().equals("null")) {
				pstmt.setString(65,null);
			} else {
				pstmt.setString(65, this.get(i).getStandbyFlag2());
			}
			if(this.get(i).getStandbyFlag3() == null || this.get(i).getStandbyFlag3().equals("null")) {
				pstmt.setString(66,null);
			} else {
				pstmt.setString(66, this.get(i).getStandbyFlag3());
			}
			...
			if(this.get(i).getModifyDate() == null || this.get(i).getModifyDate().equals("null")) {
				...
				pstmt.setDate(70, Date.valueOf(this.get(i).getModifyDate()));
			}
			...
			if(this.get(i).getGrpContNo() == null || this.get(i).getGrpContNo().equals("null")) {
				...
				pstmt.setString(72, this.get(i).getGrpContNo());
			}
			if(this.get(i).getGrpPolNo() == null || this.get(i).getGrpPolNo().equals("null")) {
				pstmt.setString(73,null);
			} else {
				pstmt.setString(73, this.get(i).getGrpPolNo());
			}
			if(this.get(i).getExecuteCom() == null || this.get(i).getExecuteCom().equals("null")) {
				pstmt.setString(74,null);
			} else {
				pstmt.setString(74, this.get(i).getExecuteCom());
			}
