...
/*
 * <p>ClassName: LJSPayPersonDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 寿险业务收费
 */
public class LJSPayPersonDBSet extends LJSPayPersonSet
{
	// @Field
	...
	**/
	...
	// @Constructor
	public LJSPayPersonDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LJSPayPersonDBSet";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getLastPayToDate() == null || this.get(i).getLastPayToDate().equals("null")) {
				...
				pstmt.setDate(23, Date.valueOf(this.get(i).getLastPayToDate()));
			}
			if(this.get(i).getCurPayToDate() == null || this.get(i).getCurPayToDate().equals("null")) {
				pstmt.setDate(24,null);
			} else {
				pstmt.setDate(24, Date.valueOf(this.get(i).getCurPayToDate()));
			}
			if(this.get(i).getInInsuAccState() == null || this.get(i).getInInsuAccState().equals("null")) {
				pstmt.setString(25,null);
			} else {
				pstmt.setString(25, this.get(i).getInInsuAccState());
			}
			...
			if(this.get(i).getInputFlag() == null || this.get(i).getInputFlag().equals("null")) {
				...
				pstmt.setString(34, this.get(i).getInputFlag());
			}
			...
			pstmt.setInt(40, this.get(i).getMainPolYear());
			...
			if(this.get(i).getEndorsementNo() == null || this.get(i).getEndorsementNo().equals("null")) {
				...
				pstmt.setString(43, this.get(i).getEndorsementNo());
			}
			if(this.get(i).getGetFlag() == null || this.get(i).getGetFlag().equals("null")) {
				pstmt.setString(44,null);
			} else {
				pstmt.setString(44, this.get(i).getGetFlag());
			}
			...
			pstmt.setInt(51, this.get(i).getPayCount());
			if(this.get(i).getGetNoticeNo() == null || this.get(i).getGetNoticeNo().equals("null")) {
				pstmt.setString(52,null);
			} else {
				pstmt.setString(52, this.get(i).getGetNoticeNo());
			}
			if(this.get(i).getPayAimClass() == null || this.get(i).getPayAimClass().equals("null")) {
				pstmt.setString(53,null);
			} else {
				pstmt.setString(53, StrTool.space1(this.get(i).getPayAimClass(), 1));
			}
			if(this.get(i).getDutyCode() == null || this.get(i).getDutyCode().equals("null")) {
				pstmt.setString(54,null);
			} else {
				pstmt.setString(54, this.get(i).getDutyCode());
			}
			if(this.get(i).getPayPlanCode() == null || this.get(i).getPayPlanCode().equals("null")) {
				pstmt.setString(55,null);
			} else {
				pstmt.setString(55, this.get(i).getPayPlanCode());
			}
			if(this.get(i).getPayType() == null || this.get(i).getPayType().equals("null")) {
				pstmt.setString(56,null);
			} else {
				pstmt.setString(56, this.get(i).getPayType());
			}
