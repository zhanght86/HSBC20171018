...
/*
 * <p>ClassName: LCPlanUWSubDB </p>
 * <p>Description: DB层数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 寿险业务系统未整理模型
 */
public class LCPlanUWSubDB extends LCPlanUWSubSchema
{
private static Logger logger = Logger.getLogger(LCPlanUWSubDB.class);
	...
	**/
	...
	// @Constructor
	public LCPlanUWSubDB( Connection tConnection )
	{
		con = tConnection;
	...
	{
		LCPlanUWSubSchema tSchema = this.getSchema();
		...
		else
		{
			...
			tError.moduleName = "LCPlanUWSubDB";
	...
	public boolean delete()
	{
		...
		try
		{
			...
			if(this.getInsuredNo() == null || this.getInsuredNo().equals("null")) {
				...
				pstmt.setString(5, StrTool.space1(this.getInsuredNo(), 24));
			}
			pstmt.executeUpdate();
			pstmt.close();
		} catch (Exception ex) {
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.getSugPassFlag() == null || this.getSugPassFlag().equals("null")) {
				...
				pstmt.setString(34, this.getSugPassFlag());
			}
			...
			pstmt.setInt(45, this.getUWNo());
			if(this.getInsuredNo() == null || this.getInsuredNo().equals("null")) {
				pstmt.setNull(46, 1);
			} else {
				pstmt.setString(46, StrTool.space1(this.getInsuredNo(), 24));
			}
			pstmt.executeUpdate();
			pstmt.close();
		} catch (Exception ex) {
	...
	public boolean getInfo()
	{
		...
		try
		{
			pstmt = con.prepareStatement("SELECT * FROM LCPlanUWSub WHERE  ProposalContNo = ? AND ContPlanCode = ? AND PlanType = ? AND UWNo = ? AND InsuredNo = ?", 
	...
	public LCPlanUWSubSet query()
	{
		PreparedStatement pstmt = null;
 		ResultSet rs = null;
		LCPlanUWSubSet aLCPlanUWSubSet = new LCPlanUWSubSet();
	  ...
	  if( !mflag ) {
		...
		{
			SQLString sqlObj = new SQLString("LCPlanUWSub");
			LCPlanUWSubSchema aSchema = this.getSchema();
			...
			{
				i++;
				LCPlanUWSubSchema s1 = new LCPlanUWSubSchema();
				s1.setSchema(rs,i);
				aLCPlanUWSubSet.add(s1);
			}
			try{ rs.close(); } catch( Exception ex ) {}
			try{ pstmt.close(); } catch( Exception ex1 ) {}
		}
		...
		return aLCPlanUWSubSet;

	}

	public LCPlanUWSubSet executeQuery(String sql)
	{
		Statement stmt = null;
		ResultSet rs = null;
		LCPlanUWSubSet aLCPlanUWSubSet = new LCPlanUWSubSet();
	...
	public LCPlanUWSubSet query(int nStart, int nCount)
	{
		PreparedStatement pstmt = null;
 		ResultSet rs = null;
		LCPlanUWSubSet aLCPlanUWSubSet = new LCPlanUWSubSet();
	...
	public LCPlanUWSubSet executeQuery(String sql, int nStart, int nCount)
	{
		Statement stmt = null;
		ResultSet rs = null;
		LCPlanUWSubSet aLCPlanUWSubSet = new LCPlanUWSubSet();
	...
	public boolean update(String strWherePart)
	{
	  ...
	  if( !mflag ) {
		...
		try
		{
			...
			String sql = "update LCPlanUWSub " + sqlObj.getUpdPart() + " where " + strWherePart;
...
/**
 * 获取定量数据
 * @return LCPlanUWSubSet
 */
public LCPlanUWSubSet getData()
{
    int tCount = 0;
    LCPlanUWSubSet tLCPlanUWSubSet = new LCPlanUWSubSet();
    LCPlanUWSubSchema tLCPlanUWSubSchema = null;
    if (null == mResultSet)
    {
        CError tError = new CError();
        tError.moduleName = "LCPlanUWSubDB";
    ...
    try
    {
        ...
        tLCPlanUWSubSchema.setSchema(mResultSet, 1);
        tLCPlanUWSubSet.add(tLCPlanUWSubSchema);
...
public boolean closeData()
{
	...
	public LCPlanUWSubSet executeQuery(SQLwithBindVariables sqlbv) {
	...
	public LCPlanUWSubSet executeQuery(SQLwithBindVariables sqlbv, int nStart, int nCount) {
