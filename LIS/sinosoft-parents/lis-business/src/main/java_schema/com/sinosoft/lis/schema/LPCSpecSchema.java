...
/*
 * <p>ClassName: LPCSpecSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 保全流程
 */
public class LPCSpecSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LPCSpecSchema.class);
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LPCSpecSchema cloned = (LPCSpecSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LPCSpecSchema 对象给 Schema 赋值
	* @param: aLPCSpecSchema LPCSpecSchema
	**/
	public void setSchema(LPCSpecSchema aLPCSpecSchema)
	{
		this.EdorNo = aLPCSpecSchema.getEdorNo();
		this.EdorType = aLPCSpecSchema.getEdorType();
		this.GrpContNo = aLPCSpecSchema.getGrpContNo();
		this.ContNo = aLPCSpecSchema.getContNo();
		this.ProposalContNo = aLPCSpecSchema.getProposalContNo();
		this.PrtSeq = aLPCSpecSchema.getPrtSeq();
		this.SerialNo = aLPCSpecSchema.getSerialNo();
		this.EndorsementNo = aLPCSpecSchema.getEndorsementNo();
		this.SpecType = aLPCSpecSchema.getSpecType();
		this.SpecCode = aLPCSpecSchema.getSpecCode();
		this.SpecContent = aLPCSpecSchema.getSpecContent();
		this.PrtFlag = aLPCSpecSchema.getPrtFlag();
		this.BackupType = aLPCSpecSchema.getBackupType();
		this.Operator = aLPCSpecSchema.getOperator();
		this.MakeDate = fDate.getDate( aLPCSpecSchema.getMakeDate());
		this.MakeTime = aLPCSpecSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLPCSpecSchema.getModifyDate());
		this.ModifyTime = aLPCSpecSchema.getModifyTime();
		this.CustomerNo = aLPCSpecSchema.getCustomerNo();
		this.SpecReason = aLPCSpecSchema.getSpecReason();
		this.NeedPrint = aLPCSpecSchema.getNeedPrint();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LPCSpec表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LPCSpecSchema";
	...
	public LPCSpecSchema getSchema()
	{
		LPCSpecSchema aLPCSpecSchema = new LPCSpecSchema();
		aLPCSpecSchema.setSchema(this);
		return aLPCSpecSchema;
	}

	public LPCSpecDB getDB()
	{
		LPCSpecDB aDBOper = new LPCSpecDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLPCSpec描述/A>表字段
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLPCSpec>历史记账凭证主表信息</A>表字段
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LPCSpecSchema other = (LPCSpecSchema)otherObject;
		return
