...
import com.sinosoft.lis.db.LPContPlanDetailRelaSubDB;

/*
 * <p>ClassName: LPContPlanDetailRelaSubSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: Physical Data Model 1
 */
public class LPContPlanDetailRelaSubSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LPContPlanDetailRelaSubSchema.class);
	// @Field
	/** 保全批单号 */
	...
	/** 主被保险人保额占比 */
	private String MainAmntRate;
	/** 附属被保险人保额占比 */
	private String RelaAmntRate;
	/** P1 */
	private String P1;
	/** P2 */
	private String P2;
	...
	// @Constructor
	public LPContPlanDetailRelaSubSchema()
	{
		mErrors = new CErrors();
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LPContPlanDetailRelaSubSchema cloned = (LPContPlanDetailRelaSubSchema)super.clone();
	...
	*/
	...
	public void setRelaToMain(String aRelaToMain)
	{
		if(aRelaToMain!=null && aRelaToMain.length()>4)
			throw new IllegalArgumentException("与主被保险人关系RelaToMain值"+aRelaToMain+"的长度"+aRelaToMain.length()+"大于最大值4");
		RelaToMain = aRelaToMain;
	}
	public String getMainAmntRate()
	{
		return MainAmntRate;
	}
	public void setMainAmntRate(String aMainAmntRate)
	{
		if(aMainAmntRate!=null && aMainAmntRate.length()>20)
			throw new IllegalArgumentException("主被保险人保额占比MainAmntRate值"+aMainAmntRate+"的长度"+aMainAmntRate.length()+"大于最大值20");
		MainAmntRate = aMainAmntRate;
	}
	public String getRelaAmntRate()
	{
		return RelaAmntRate;
	}
	public void setRelaAmntRate(String aRelaAmntRate)
	{
		if(aRelaAmntRate!=null && aRelaAmntRate.length()>20)
			throw new IllegalArgumentException("附属被保险人保额占比RelaAmntRate值"+aRelaAmntRate+"的长度"+aRelaAmntRate.length()+"大于最大值20");
		RelaAmntRate = aRelaAmntRate;
	}
	public String getP1()
	{
		return P1;
	...
	/**
	* 使用另外一个 LPContPlanDetailRelaSubSchema 对象给 Schema 赋值
	* @param: aLPContPlanDetailRelaSubSchema LPContPlanDetailRelaSubSchema
	**/
	public void setSchema(LPContPlanDetailRelaSubSchema aLPContPlanDetailRelaSubSchema)
	{
		this.EdorNo = aLPContPlanDetailRelaSubSchema.getEdorNo();
		this.EdorType = aLPContPlanDetailRelaSubSchema.getEdorType();
		this.PolicyNo = aLPContPlanDetailRelaSubSchema.getPolicyNo();
		this.PropNo = aLPContPlanDetailRelaSubSchema.getPropNo();
		this.SysPlanCode = aLPContPlanDetailRelaSubSchema.getSysPlanCode();
		this.PlanCode = aLPContPlanDetailRelaSubSchema.getPlanCode();
		this.RiskCode = aLPContPlanDetailRelaSubSchema.getRiskCode();
		this.DutyCode = aLPContPlanDetailRelaSubSchema.getDutyCode();
		this.RelaToMain = aLPContPlanDetailRelaSubSchema.getRelaToMain();
		this.MainAmntRate = aLPContPlanDetailRelaSubSchema.getMainAmntRate();
		this.RelaAmntRate = aLPContPlanDetailRelaSubSchema.getRelaAmntRate();
		this.P1 = aLPContPlanDetailRelaSubSchema.getP1();
		this.P2 = aLPContPlanDetailRelaSubSchema.getP2();
		this.P3 = aLPContPlanDetailRelaSubSchema.getP3();
		this.P4 = aLPContPlanDetailRelaSubSchema.getP4();
		this.P5 = aLPContPlanDetailRelaSubSchema.getP5();
		this.P6 = aLPContPlanDetailRelaSubSchema.getP6();
		this.P7 = aLPContPlanDetailRelaSubSchema.getP7();
		this.P8 = aLPContPlanDetailRelaSubSchema.getP8();
		this.P9 = aLPContPlanDetailRelaSubSchema.getP9();
		this.P10 = aLPContPlanDetailRelaSubSchema.getP10();
		this.P11 = aLPContPlanDetailRelaSubSchema.getP11();
		this.P12 = aLPContPlanDetailRelaSubSchema.getP12();
		this.P13 = aLPContPlanDetailRelaSubSchema.getP13();
		this.P14 = aLPContPlanDetailRelaSubSchema.getP14();
		this.P15 = aLPContPlanDetailRelaSubSchema.getP15();
		this.P16 = aLPContPlanDetailRelaSubSchema.getP16();
		this.P17 = aLPContPlanDetailRelaSubSchema.getP17();
		this.P18 = aLPContPlanDetailRelaSubSchema.getP18();
		this.P19 = aLPContPlanDetailRelaSubSchema.getP19();
		this.P20 = aLPContPlanDetailRelaSubSchema.getP20();
		this.P21 = aLPContPlanDetailRelaSubSchema.getP21();
		this.P22 = aLPContPlanDetailRelaSubSchema.getP22();
		this.P23 = aLPContPlanDetailRelaSubSchema.getP23();
		this.P24 = aLPContPlanDetailRelaSubSchema.getP24();
		this.P25 = aLPContPlanDetailRelaSubSchema.getP25();
		this.P26 = aLPContPlanDetailRelaSubSchema.getP26();
		this.P27 = aLPContPlanDetailRelaSubSchema.getP27();
		this.P28 = aLPContPlanDetailRelaSubSchema.getP28();
		this.P29 = aLPContPlanDetailRelaSubSchema.getP29();
		this.P30 = aLPContPlanDetailRelaSubSchema.getP30();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		try
		{
			...
			if( rs.getString("RelaToMain") == null )
				this.RelaToMain = null;
			else
				this.RelaToMain = rs.getString("RelaToMain").trim();

			if( rs.getString("MainAmntRate") == null )
				this.MainAmntRate = null;
			else
				this.MainAmntRate = rs.getString("MainAmntRate").trim();

			if( rs.getString("RelaAmntRate") == null )
				this.RelaAmntRate = null;
			else
				this.RelaAmntRate = rs.getString("RelaAmntRate").trim();
		...
		{
			logger.debug("数据库中的LPContPlanDetailRelaSub表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LPContPlanDetailRelaSubSchema";
	...
	public LPContPlanDetailRelaSubSchema getSchema()
	{
		LPContPlanDetailRelaSubSchema aLPContPlanDetailRelaSubSchema = new LPContPlanDetailRelaSubSchema();
		aLPContPlanDetailRelaSubSchema.setSchema(this);
		return aLPContPlanDetailRelaSubSchema;
	}

	public LPContPlanDetailRelaSubDB getDB()
	{
		LPContPlanDetailRelaSubDB aDBOper = new LPContPlanDetailRelaSubDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLPContPlanDetailRelaSub描述/A>表字段
	...
	**/
	public String encode()
	{
		...
		strReturn.append(StrTool.cTrim(RelaToMain)); strReturn.append(SysConst.PACKAGESPILTER);
		strReturn.append(StrTool.cTrim(MainAmntRate)); strReturn.append(SysConst.PACKAGESPILTER);
		strReturn.append(StrTool.cTrim(RelaAmntRate)); strReturn.append(SysConst.PACKAGESPILTER);
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLPContPlanDetailRelaSub>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			RelaToMain = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 9, SysConst.PACKAGESPILTER );
			MainAmntRate = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 10, SysConst.PACKAGESPILTER );
			RelaAmntRate = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 11, SysConst.PACKAGESPILTER );
			P1 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 12, SysConst.PACKAGESPILTER );
			P2 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 13, SysConst.PACKAGESPILTER );
			P3 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 14, SysConst.PACKAGESPILTER );
			P4 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 15, SysConst.PACKAGESPILTER );
			P5 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 16, SysConst.PACKAGESPILTER );
			P6 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 17, SysConst.PACKAGESPILTER );
			P7 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 18, SysConst.PACKAGESPILTER );
			P8 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 19, SysConst.PACKAGESPILTER );
			P9 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 20, SysConst.PACKAGESPILTER );
			P10 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 21, SysConst.PACKAGESPILTER );
			P11 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 22, SysConst.PACKAGESPILTER );
			P12 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 23, SysConst.PACKAGESPILTER );
			P13 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 24, SysConst.PACKAGESPILTER );
			P14 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 25, SysConst.PACKAGESPILTER );
			P15 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 26, SysConst.PACKAGESPILTER );
			P16 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 27, SysConst.PACKAGESPILTER );
			P17 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 28, SysConst.PACKAGESPILTER );
			P18 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 29, SysConst.PACKAGESPILTER );
			P19 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 30, SysConst.PACKAGESPILTER );
			P20 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 31, SysConst.PACKAGESPILTER );
			P21 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 32, SysConst.PACKAGESPILTER );
			P22 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 33, SysConst.PACKAGESPILTER );
			P23 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 34, SysConst.PACKAGESPILTER );
			P24 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 35, SysConst.PACKAGESPILTER );
			P25 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 36, SysConst.PACKAGESPILTER );
			P26 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 37, SysConst.PACKAGESPILTER );
			P27 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 38, SysConst.PACKAGESPILTER );
			P28 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 39, SysConst.PACKAGESPILTER );
			P29 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 40, SysConst.PACKAGESPILTER );
			P30 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 41, SysConst.PACKAGESPILTER );
		}
	...
	**/
	public String getV(String FCode)
	{
		...
		if (FCode.equalsIgnoreCase("RelaToMain"))
		{
			strReturn = StrTool.GBKToUnicode(String.valueOf(RelaToMain));
		}
		if (FCode.equalsIgnoreCase("MainAmntRate"))
		{
			strReturn = StrTool.GBKToUnicode(String.valueOf(MainAmntRate));
		}
		if (FCode.equalsIgnoreCase("RelaAmntRate"))
		{
			strReturn = StrTool.GBKToUnicode(String.valueOf(RelaAmntRate));
		}
	...
	public String getV(int nFieldIndex)
	{
		...
		switch(nFieldIndex) {
			...
			case 7:
				...
				break;
			case 8:
				strFieldValue = StrTool.GBKToUnicode(RelaToMain);
				break;
			case 9:
				strFieldValue = StrTool.GBKToUnicode(MainAmntRate);
				break;
			case 10:
				strFieldValue = StrTool.GBKToUnicode(RelaAmntRate);
				break;
			case 11:
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LPContPlanDetailRelaSubSchema other = (LPContPlanDetailRelaSubSchema)otherObject;
		return
			...
			&& RelaToMain.equals(other.getRelaToMain())
			&& MainAmntRate.equals(other.getMainAmntRate())
			&& RelaAmntRate.equals(other.getRelaAmntRate())
	...
	**/
	public int getFieldIndex(String strFieldName)
	{
		...
		if( strFieldName.equals("RelaToMain") ) {
			return 8;
		}
		if( strFieldName.equals("MainAmntRate") ) {
			return 9;
		}
		if( strFieldName.equals("RelaAmntRate") ) {
			return 10;
		}
	...
	public String getFieldName(int nFieldIndex)
	{
		...
		switch(nFieldIndex) {
			...
			case 7:
				...
				break;
			case 8:
				strFieldName = "RelaToMain";
				break;
			case 9:
				strFieldName = "MainAmntRate";
				break;
			case 10:
				strFieldName = "RelaAmntRate";
				break;
			case 11:
				strFieldName = "P1";
				break;
