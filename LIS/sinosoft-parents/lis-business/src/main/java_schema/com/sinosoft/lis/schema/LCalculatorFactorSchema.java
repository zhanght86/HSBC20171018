...
/*
 * <p>ClassName: LCalculatorFactorSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 累加器
 */
public class LCalculatorFactorSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LCalculatorFactorSchema.class);
	// @Field
	/** 累加器编号 */
	...
	// @Constructor
	public LCalculatorFactorSchema()
	{
		mErrors = new CErrors();
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LCalculatorFactorSchema cloned = (LCalculatorFactorSchema)super.clone();
	...
	public void setRiskCode(String aRiskCode)
	{
		if(aRiskCode!=null && aRiskCode.length()>10)
			throw new IllegalArgumentException("产品代码RiskCode值"+aRiskCode+"的长度"+aRiskCode.length()+"大于最大值10");
		RiskCode = aRiskCode;
	}
	...
	/**
	* 使用另外一个 LCalculatorFactorSchema 对象给 Schema 赋值
	* @param: aLCalculatorFactorSchema LCalculatorFactorSchema
	**/
	public void setSchema(LCalculatorFactorSchema aLCalculatorFactorSchema)
	{
		this.CalculatorCode = aLCalculatorFactorSchema.getCalculatorCode();
		this.SerialNo = aLCalculatorFactorSchema.getSerialNo();
		this.RiskCode = aLCalculatorFactorSchema.getRiskCode();
		this.DutyCode = aLCalculatorFactorSchema.getDutyCode();
		this.GetDutyCode = aLCalculatorFactorSchema.getGetDutyCode();
		this.GetDutyKind = aLCalculatorFactorSchema.getGetDutyKind();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LCalculatorFactor表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LCalculatorFactorSchema";
	...
	public LCalculatorFactorSchema getSchema()
	{
		LCalculatorFactorSchema aLCalculatorFactorSchema = new LCalculatorFactorSchema();
		aLCalculatorFactorSchema.setSchema(this);
		return aLCalculatorFactorSchema;
	}

	public LCalculatorFactorDB getDB()
	{
		LCalculatorFactorDB aDBOper = new LCalculatorFactorDB();
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLCalculatorFactor>历史记账凭证主表信息</A>表字段
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LCalculatorFactorSchema other = (LCalculatorFactorSchema)otherObject;
		return
