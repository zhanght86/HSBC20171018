...
/*
 * <p>ClassName: LPCUWSubSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 保全流程
 */
public class LPCUWSubSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LPCUWSubSchema.class);
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LPCUWSubSchema cloned = (LPCUWSubSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LPCUWSubSchema 对象给 Schema 赋值
	* @param: aLPCUWSubSchema LPCUWSubSchema
	**/
	public void setSchema(LPCUWSubSchema aLPCUWSubSchema)
	{
		this.EdorNo = aLPCUWSubSchema.getEdorNo();
		this.EdorType = aLPCUWSubSchema.getEdorType();
		this.GrpContNo = aLPCUWSubSchema.getGrpContNo();
		this.ContNo = aLPCUWSubSchema.getContNo();
		this.ProposalContNo = aLPCUWSubSchema.getProposalContNo();
		this.UWNo = aLPCUWSubSchema.getUWNo();
		this.InsuredNo = aLPCUWSubSchema.getInsuredNo();
		this.InsuredName = aLPCUWSubSchema.getInsuredName();
		this.AppntNo = aLPCUWSubSchema.getAppntNo();
		this.AppntName = aLPCUWSubSchema.getAppntName();
		this.AgentCode = aLPCUWSubSchema.getAgentCode();
		this.AgentGroup = aLPCUWSubSchema.getAgentGroup();
		this.PassFlag = aLPCUWSubSchema.getPassFlag();
		this.UWGrade = aLPCUWSubSchema.getUWGrade();
		this.AppGrade = aLPCUWSubSchema.getAppGrade();
		this.PostponeDay = aLPCUWSubSchema.getPostponeDay();
		this.PostponeDate = fDate.getDate( aLPCUWSubSchema.getPostponeDate());
		this.AutoUWFlag = aLPCUWSubSchema.getAutoUWFlag();
		this.State = aLPCUWSubSchema.getState();
		this.ManageCom = aLPCUWSubSchema.getManageCom();
		this.UWIdea = aLPCUWSubSchema.getUWIdea();
		this.UpReportContent = aLPCUWSubSchema.getUpReportContent();
		this.Operator = aLPCUWSubSchema.getOperator();
		this.HealthFlag = aLPCUWSubSchema.getHealthFlag();
		this.QuesFlag = aLPCUWSubSchema.getQuesFlag();
		this.SpecFlag = aLPCUWSubSchema.getSpecFlag();
		this.AddPremFlag = aLPCUWSubSchema.getAddPremFlag();
		this.AddPremReason = aLPCUWSubSchema.getAddPremReason();
		this.ReportFlag = aLPCUWSubSchema.getReportFlag();
		this.PrintFlag = aLPCUWSubSchema.getPrintFlag();
		this.PrintFlag2 = aLPCUWSubSchema.getPrintFlag2();
		this.ChangePolFlag = aLPCUWSubSchema.getChangePolFlag();
		this.ChangePolReason = aLPCUWSubSchema.getChangePolReason();
		this.SpecReason = aLPCUWSubSchema.getSpecReason();
		this.MakeDate = fDate.getDate( aLPCUWSubSchema.getMakeDate());
		this.MakeTime = aLPCUWSubSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLPCUWSubSchema.getModifyDate());
		this.ModifyTime = aLPCUWSubSchema.getModifyTime();
		this.SugPassFlag = aLPCUWSubSchema.getSugPassFlag();
		this.SugUWIdea = aLPCUWSubSchema.getSugUWIdea();
		this.CommonReason = aLPCUWSubSchema.getCommonReason();
		this.CommonReasonCode = aLPCUWSubSchema.getCommonReasonCode();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LPCUWSub表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LPCUWSubSchema";
	...
	public LPCUWSubSchema getSchema()
	{
		LPCUWSubSchema aLPCUWSubSchema = new LPCUWSubSchema();
		aLPCUWSubSchema.setSchema(this);
		return aLPCUWSubSchema;
	}

	public LPCUWSubDB getDB()
	{
		LPCUWSubDB aDBOper = new LPCUWSubDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLPCUWSub描述/A>表字段
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLPCUWSub>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			CommonReason = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 41, SysConst.PACKAGESPILTER );
			CommonReasonCode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 42, SysConst.PACKAGESPILTER );
		}
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LPCUWSubSchema other = (LPCUWSubSchema)otherObject;
		return
