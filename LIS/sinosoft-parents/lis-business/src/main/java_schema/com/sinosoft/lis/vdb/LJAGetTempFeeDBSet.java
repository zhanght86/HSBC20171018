...
/*
 * <p>ClassName: LJAGetTempFeeDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 寿险业务付费
 */
public class LJAGetTempFeeDBSet extends LJAGetTempFeeSet
{
	// @Field
	...
	**/
	...
	// @Constructor
	public LJAGetTempFeeDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LJAGetTempFeeDBSet";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getFeeOperationType() == null || this.get(i).getFeeOperationType().equals("null")) {
				...
				pstmt.setString(5, this.get(i).getFeeOperationType());
			}
			...
			if(this.get(i).getPayMode() == null || this.get(i).getPayMode().equals("null")) {
				...
				pstmt.setString(7, this.get(i).getPayMode());
			}
			pstmt.setDouble(8, this.get(i).getGetMoney());
			if(this.get(i).getGetDate() == null || this.get(i).getGetDate().equals("null")) {
				pstmt.setDate(9,null);
			} else {
				pstmt.setDate(9, Date.valueOf(this.get(i).getGetDate()));
			}
			...
			if(this.get(i).getAPPntName() == null || this.get(i).getAPPntName().equals("null")) {
				...
				pstmt.setString(15, this.get(i).getAPPntName());
			}
			...
			if(this.get(i).getGetReasonCode() == null || this.get(i).getGetReasonCode().equals("null")) {
				...
				pstmt.setString(22, this.get(i).getGetReasonCode());
			}
			...
			if(this.get(i).getGetNoticeNo() == null || this.get(i).getGetNoticeNo().equals("null")) {
				...
				pstmt.setString(24, this.get(i).getGetNoticeNo());
			}
			...
			if(this.get(i).getOperState() == null || this.get(i).getOperState().equals("null")) {
				...
				pstmt.setString(27, this.get(i).getOperState());
			}
			if(this.get(i).getCurrency() == null || this.get(i).getCurrency().equals("null")) {
			...
			pstmt.setDouble(29, this.get(i).getNetAmount());
			pstmt.setDouble(30, this.get(i).getTaxAmount());
			pstmt.setDouble(31, this.get(i).getTax());
			// set where condition
			if(this.get(i).getActuGetNo() == null || this.get(i).getActuGetNo().equals("null")) {
				pstmt.setString(32,null);
			} else {
				pstmt.setString(32, this.get(i).getActuGetNo());
			}
			if(this.get(i).getTempFeeNo() == null || this.get(i).getTempFeeNo().equals("null")) {
				pstmt.setString(33,null);
			} else {
				pstmt.setString(33, this.get(i).getTempFeeNo());
			}
			if(this.get(i).getRiskCode() == null || this.get(i).getRiskCode().equals("null")) {
