...
import com.sinosoft.lis.db.LPGUWSubMainDB;

/*
 * <p>ClassName: LPGUWSubMainSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 保全流程
 */
public class LPGUWSubMainSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LPGUWSubMainSchema.class);
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LPGUWSubMainSchema cloned = (LPGUWSubMainSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LPGUWSubMainSchema 对象给 Schema 赋值
	* @param: aLPGUWSubMainSchema LPGUWSubMainSchema
	**/
	public void setSchema(LPGUWSubMainSchema aLPGUWSubMainSchema)
	{
		this.EdorNo = aLPGUWSubMainSchema.getEdorNo();
		this.GrpContNo = aLPGUWSubMainSchema.getGrpContNo();
		this.ProposalGrpContNo = aLPGUWSubMainSchema.getProposalGrpContNo();
		this.UWNo = aLPGUWSubMainSchema.getUWNo();
		this.InsuredNo = aLPGUWSubMainSchema.getInsuredNo();
		this.InsuredName = aLPGUWSubMainSchema.getInsuredName();
		this.AppntNo = aLPGUWSubMainSchema.getAppntNo();
		this.AppntName = aLPGUWSubMainSchema.getAppntName();
		this.AgentCode = aLPGUWSubMainSchema.getAgentCode();
		this.AgentGroup = aLPGUWSubMainSchema.getAgentGroup();
		this.PassFlag = aLPGUWSubMainSchema.getPassFlag();
		this.UWGrade = aLPGUWSubMainSchema.getUWGrade();
		this.AppGrade = aLPGUWSubMainSchema.getAppGrade();
		this.PostponeDay = aLPGUWSubMainSchema.getPostponeDay();
		this.PostponeDate = fDate.getDate( aLPGUWSubMainSchema.getPostponeDate());
		this.AutoUWFlag = aLPGUWSubMainSchema.getAutoUWFlag();
		this.State = aLPGUWSubMainSchema.getState();
		this.ManageCom = aLPGUWSubMainSchema.getManageCom();
		this.UWIdea = aLPGUWSubMainSchema.getUWIdea();
		this.UpReportContent = aLPGUWSubMainSchema.getUpReportContent();
		this.Operator = aLPGUWSubMainSchema.getOperator();
		this.HealthFlag = aLPGUWSubMainSchema.getHealthFlag();
		this.QuesFlag = aLPGUWSubMainSchema.getQuesFlag();
		this.SpecFlag = aLPGUWSubMainSchema.getSpecFlag();
		this.AddPremFlag = aLPGUWSubMainSchema.getAddPremFlag();
		this.AddPremReason = aLPGUWSubMainSchema.getAddPremReason();
		this.ReportFlag = aLPGUWSubMainSchema.getReportFlag();
		this.PrintFlag = aLPGUWSubMainSchema.getPrintFlag();
		this.PrintFlag2 = aLPGUWSubMainSchema.getPrintFlag2();
		this.ChangePolFlag = aLPGUWSubMainSchema.getChangePolFlag();
		this.ChangePolReason = aLPGUWSubMainSchema.getChangePolReason();
		this.SpecReason = aLPGUWSubMainSchema.getSpecReason();
		this.MakeDate = fDate.getDate( aLPGUWSubMainSchema.getMakeDate());
		this.MakeTime = aLPGUWSubMainSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLPGUWSubMainSchema.getModifyDate());
		this.ModifyTime = aLPGUWSubMainSchema.getModifyTime();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LPGUWSubMain表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LPGUWSubMainSchema";
	...
	public LPGUWSubMainSchema getSchema()
	{
		LPGUWSubMainSchema aLPGUWSubMainSchema = new LPGUWSubMainSchema();
		aLPGUWSubMainSchema.setSchema(this);
		return aLPGUWSubMainSchema;
	}

	public LPGUWSubMainDB getDB()
	{
		LPGUWSubMainDB aDBOper = new LPGUWSubMainDB();
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLPGUWSubMain>历史记账凭证主表信息</A>表字段
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LPGUWSubMainSchema other = (LPGUWSubMainSchema)otherObject;
		return
