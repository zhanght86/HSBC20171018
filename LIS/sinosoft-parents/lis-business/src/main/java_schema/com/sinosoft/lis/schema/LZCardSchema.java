...
/*
 * <p>ClassName: LZCardSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 单证管理
 */
public class LZCardSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LZCardSchema.class);
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LZCardSchema cloned = (LZCardSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LZCardSchema 对象给 Schema 赋值
	* @param: aLZCardSchema LZCardSchema
	**/
	public void setSchema(LZCardSchema aLZCardSchema)
	{
		this.CertifyCode = aLZCardSchema.getCertifyCode();
		this.SubCode = aLZCardSchema.getSubCode();
		this.RiskCode = aLZCardSchema.getRiskCode();
		this.RiskVersion = aLZCardSchema.getRiskVersion();
		this.StartNo = aLZCardSchema.getStartNo();
		this.EndNo = aLZCardSchema.getEndNo();
		this.SendOutCom = aLZCardSchema.getSendOutCom();
		this.ReceiveCom = aLZCardSchema.getReceiveCom();
		this.SumCount = aLZCardSchema.getSumCount();
		this.Prem = aLZCardSchema.getPrem();
		this.Amnt = aLZCardSchema.getAmnt();
		this.Handler = aLZCardSchema.getHandler();
		this.HandleDate = fDate.getDate( aLZCardSchema.getHandleDate());
		this.InvaliDate = fDate.getDate( aLZCardSchema.getInvaliDate());
		this.TakeBackNo = aLZCardSchema.getTakeBackNo();
		this.SaleChnl = aLZCardSchema.getSaleChnl();
		this.StateFlag = aLZCardSchema.getStateFlag();
		this.OperateFlag = aLZCardSchema.getOperateFlag();
		this.PayFlag = aLZCardSchema.getPayFlag();
		this.EnterAccFlag = aLZCardSchema.getEnterAccFlag();
		this.Reason = aLZCardSchema.getReason();
		this.State = aLZCardSchema.getState();
		this.Operator = aLZCardSchema.getOperator();
		this.MakeDate = fDate.getDate( aLZCardSchema.getMakeDate());
		this.MakeTime = aLZCardSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLZCardSchema.getModifyDate());
		this.ModifyTime = aLZCardSchema.getModifyTime();
		this.ApplyNo = aLZCardSchema.getApplyNo();
		this.AgentCom = aLZCardSchema.getAgentCom();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LZCard表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LZCardSchema";
	...
	public LZCardSchema getSchema()
	{
		LZCardSchema aLZCardSchema = new LZCardSchema();
		aLZCardSchema.setSchema(this);
		return aLZCardSchema;
	}

	public LZCardDB getDB()
	{
		LZCardDB aDBOper = new LZCardDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLZCard描述/A>表字段
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLZCard>历史记账凭证主表信息</A>表字段
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LZCardSchema other = (LZCardSchema)otherObject;
		return
