...
/*
 * <p>ClassName: LQRelaInfoSchema </p>
 ...
 */
public class LQRelaInfoSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LQRelaInfoSchema.class);
	...
	public LQRelaInfoSchema()
	{
		...
		PK = pk;
            ...
            public Object clone()
                    throws CloneNotSupportedException
            {
                LQRelaInfoSchema cloned = (LQRelaInfoSchema)super.clone();
	...
	/**
	* 使用另外一个 LQRelaInfoSchema 对象给 Schema 赋值
	* @param: aLQRelaInfoSchema LQRelaInfoSchema
	**/
	public void setSchema(LQRelaInfoSchema aLQRelaInfoSchema)
	{
		this.PrtNo = aLQRelaInfoSchema.getPrtNo();
		this.AskPriceNo = aLQRelaInfoSchema.getAskPriceNo();
		this.AskNo = aLQRelaInfoSchema.getAskNo();
		this.Remark = aLQRelaInfoSchema.getRemark();
		this.MakeDate = fDate.getDate( aLQRelaInfoSchema.getMakeDate());
		this.MakeTime = aLQRelaInfoSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLQRelaInfoSchema.getModifyDate());
		this.ModifyTime = aLQRelaInfoSchema.getModifyTime();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LQRelaInfo表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LQRelaInfoSchema";
	...
	public LQRelaInfoSchema getSchema()
	{
		LQRelaInfoSchema aLQRelaInfoSchema = new LQRelaInfoSchema();
		aLQRelaInfoSchema.setSchema(this);
		return aLQRelaInfoSchema;
	}

	public LQRelaInfoDB getDB()
	{
		LQRelaInfoDB aDBOper = new LQRelaInfoDB();
...
strReturn.append(StrTool.cTrim(ModifyTime));
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLQRelaInfo>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			AskPriceNo = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 2, SysConst.PACKAGESPILTER );
			AskNo = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 3, SysConst.PACKAGESPILTER );
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LQRelaInfoSchema other = (LQRelaInfoSchema)otherObject;
		return
