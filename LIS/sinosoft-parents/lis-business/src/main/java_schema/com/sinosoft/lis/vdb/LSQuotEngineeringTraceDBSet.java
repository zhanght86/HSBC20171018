...
/*
 * <p>ClassName: LSQuotEngineeringTraceDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: Physical Data Model 1
 */
public class LSQuotEngineeringTraceDBSet extends LSQuotEngineeringTraceSet
{
	// @Field
	...
	**/
	...
	// @Constructor
	public LSQuotEngineeringTraceDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public LSQuotEngineeringTraceDBSet()
	{
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LSQuotEngineeringTraceDBSet";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getEnginDays() == null || this.get(i).getEnginDays().equals("null")) {
				...
				pstmt.setString(26, this.get(i).getEnginDays());
			}
			pstmt.setDouble(27, this.get(i).getMinEnginArea());
			pstmt.setDouble(28, this.get(i).getMinEnginCost());
			// set where condition
			if(this.get(i).getSerialNo() == null || this.get(i).getSerialNo().equals("null")) {
			...
			if(this.get(i).getQuotNo() == null || this.get(i).getQuotNo().equals("null")) {
				...
				pstmt.setString(30, this.get(i).getQuotNo());
			}
			pstmt.setInt(31, this.get(i).getQuotBatNo());
			if(this.get(i).getSysPlanCode() == null || this.get(i).getSysPlanCode().equals("null")) {
