...
/*
 * <p>ClassName: LCContPlanInvestDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 新单管理
 */
public class LCContPlanInvestDBSet extends LCContPlanInvestSet
{
	// @Field
	...
	**/
	...
	// @Constructor
	public LCContPlanInvestDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LCContPlanInvestDBSet";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getSegment4() == null || this.get(i).getSegment4().equals("null")) {
				...
				pstmt.setString(11, this.get(i).getSegment4());
			}
