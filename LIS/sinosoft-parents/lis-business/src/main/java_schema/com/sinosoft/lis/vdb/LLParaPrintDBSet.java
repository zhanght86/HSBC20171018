...
/*
 * <p>ClassName: LLParaPrintDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 理赔管理
 */
public class LLParaPrintDBSet extends LLParaPrintSet
{
private static Logger logger = Logger.getLogger(LLParaPrintDBSet.class);
	...
	**/
	...
	// @Constructor
	public LLParaPrintDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LLParaPrintDBSet";
	...
	public boolean delete()
	{
		...
		try
		{
			...
			if(this.get(i).getPrtCode() == null || this.get(i).getPrtCode().equals("null")) {
				...
				pstmt.setString(1, this.get(i).getPrtCode());
			}
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getPrtType() == null || this.get(i).getPrtType().equals("null")) {
				...
				pstmt.setString(1, this.get(i).getPrtType());
			}
			if(this.get(i).getPrtSubType() == null || this.get(i).getPrtSubType().equals("null")) {
				pstmt.setString(2,null);
			} else {
				pstmt.setString(2, this.get(i).getPrtSubType());
			}
			if(this.get(i).getPrtCode() == null || this.get(i).getPrtCode().equals("null")) {
			...
			if(this.get(i).getPrtCode() == null || this.get(i).getPrtCode().equals("null")) {
				...
				pstmt.setString(12, this.get(i).getPrtCode());
			}
