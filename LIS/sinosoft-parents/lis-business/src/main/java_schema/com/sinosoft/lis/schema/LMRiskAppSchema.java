...
public class LMRiskAppSchema implements Schema, Cloneable
{
	...
	*/
	...
	/**
	* G--团体险、I--个人险、A--两者都是<p>
	* 表LMRiskApp中RiskProp字段(险种性质)的值为：<p>
	* G--团体险、<p>
	* I--个人险、<p>
	* Y--银代险<p>
	* B--G+Y<p>
	...
	* <p>
	* <p>
	* (1) 险种编码的代码选择事件中如果填写RiskCode<p>
	* 则显示表LMRiskApp中RiskProp字段值为I,G和A的所有险种编码。<p>
	* (2) 险种编码的代码选择事件中如果填写RiskInd<p>
	* 则显示表LMRiskApp中RiskProp字段值为I和A的所有险种编码。<p>
	* (3) 险种编码的代码选择事件中如果填写RiskGrp<p>
	* 则显示表LMRiskApp中RiskProp字段值为G和A的所有险种编码。
	*/
	...
	* 0-没有利差返还<p>
	* 1-有利差返还<p>
	* 注：利差返还类型的可选项在LMRiskParamsDef中定义
	*/
	...
	**/
	public void setSchema(LMRiskAppSchema aLMRiskAppSchema)
	{
		...
		this.LoanFlag = aLMRiskAppSchema.getLoanFlag();
		...
		this.SpecFlag = aLMRiskAppSchema.getSpecFlag();
		this.InterestDifFlag = aLMRiskAppSchema.getInterestDifFlag();
		this.RiskTypeAcc = aLMRiskAppSchema.getRiskTypeAcc();
		this.RiskPeriodAcc = aLMRiskAppSchema.getRiskPeriodAcc();
		this.RiskType7 = aLMRiskAppSchema.getRiskType7();
		this.RiskType6 = aLMRiskAppSchema.getRiskType6();
		this.HealthType = aLMRiskAppSchema.getHealthType();
		this.CancleForeGetSpecFlag = aLMRiskAppSchema.getCancleForeGetSpecFlag();
		this.RiskType8 = aLMRiskAppSchema.getRiskType8();
		this.SignDateCalMode2 = aLMRiskAppSchema.getSignDateCalMode2();
		this.SignDateCalMode3 = aLMRiskAppSchema.getSignDateCalMode3();
		this.RiskType9 = aLMRiskAppSchema.getRiskType9();
		this.AutoPayType = aLMRiskAppSchema.getAutoPayType();
		this.AutoETIFlag = aLMRiskAppSchema.getAutoETIFlag();
		this.AutoETIType = aLMRiskAppSchema.getAutoETIType();
		this.AutoCTFlag = aLMRiskAppSchema.getAutoCTFlag();
		this.NonParFlag = aLMRiskAppSchema.getNonParFlag();
		this.BackDateFlag = aLMRiskAppSchema.getBackDateFlag();
		this.HoneymoonFlag = aLMRiskAppSchema.getHoneymoonFlag();
		this.NLGFlag = aLMRiskAppSchema.getNLGFlag();
	}
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			RiskTypeAcc = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 64, SysConst.PACKAGESPILTER );
			RiskPeriodAcc = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 65, SysConst.PACKAGESPILTER );
			RiskType7 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 66, SysConst.PACKAGESPILTER );
			RiskType6 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 67, SysConst.PACKAGESPILTER );
			HealthType = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 68, SysConst.PACKAGESPILTER );
			CancleForeGetSpecFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 69, SysConst.PACKAGESPILTER );
			RiskType8 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 70, SysConst.PACKAGESPILTER );
			SignDateCalMode2= new Integer(ChgData.chgNumericStr(StrTool.getStr(strMessage,71,SysConst.PACKAGESPILTER))).intValue();
			SignDateCalMode3= new Integer(ChgData.chgNumericStr(StrTool.getStr(strMessage,72,SysConst.PACKAGESPILTER))).intValue();
			RiskType9 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 73, SysConst.PACKAGESPILTER );
			AutoPayType = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 74, SysConst.PACKAGESPILTER );
			AutoETIFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 75, SysConst.PACKAGESPILTER );
			AutoETIType = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 76, SysConst.PACKAGESPILTER );
			AutoCTFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 77, SysConst.PACKAGESPILTER );
			NonParFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 78, SysConst.PACKAGESPILTER );
			BackDateFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 79, SysConst.PACKAGESPILTER );
			HoneymoonFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 80, SysConst.PACKAGESPILTER );
			NLGFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 81, SysConst.PACKAGESPILTER );
		}
