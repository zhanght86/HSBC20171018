...
import com.sinosoft.lis.db.LCGetBakDB;

/*
 * <p>ClassName: LCGetBakSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: PhysicalDataModel_1
 */
public class LCGetBakSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LCGetBakSchema.class);
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LCGetBakSchema cloned = (LCGetBakSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LCGetBakSchema 对象给 Schema 赋值
	* @param: aLCGetBakSchema LCGetBakSchema
	**/
	public void setSchema(LCGetBakSchema aLCGetBakSchema)
	{
		this.GrpContNo = aLCGetBakSchema.getGrpContNo();
		this.ContNo = aLCGetBakSchema.getContNo();
		this.PolNo = aLCGetBakSchema.getPolNo();
		this.DutyCode = aLCGetBakSchema.getDutyCode();
		this.GetDutyCode = aLCGetBakSchema.getGetDutyCode();
		this.GetDutyKind = aLCGetBakSchema.getGetDutyKind();
		this.InsuredNo = aLCGetBakSchema.getInsuredNo();
		this.GetMode = aLCGetBakSchema.getGetMode();
		this.GetLimit = aLCGetBakSchema.getGetLimit();
		this.GetRate = aLCGetBakSchema.getGetRate();
		this.UrgeGetFlag = aLCGetBakSchema.getUrgeGetFlag();
		this.LiveGetType = aLCGetBakSchema.getLiveGetType();
		this.AddRate = aLCGetBakSchema.getAddRate();
		this.CanGet = aLCGetBakSchema.getCanGet();
		this.NeedAcc = aLCGetBakSchema.getNeedAcc();
		this.NeedCancelAcc = aLCGetBakSchema.getNeedCancelAcc();
		this.StandMoney = aLCGetBakSchema.getStandMoney();
		this.ActuGet = aLCGetBakSchema.getActuGet();
		this.SumMoney = aLCGetBakSchema.getSumMoney();
		this.GetIntv = aLCGetBakSchema.getGetIntv();
		this.GettoDate = fDate.getDate( aLCGetBakSchema.getGettoDate());
		this.GetStartDate = fDate.getDate( aLCGetBakSchema.getGetStartDate());
		this.GetEndDate = fDate.getDate( aLCGetBakSchema.getGetEndDate());
		this.BalaDate = fDate.getDate( aLCGetBakSchema.getBalaDate());
		this.State = aLCGetBakSchema.getState();
		this.ManageCom = aLCGetBakSchema.getManageCom();
		this.Operator = aLCGetBakSchema.getOperator();
		this.MakeDate = fDate.getDate( aLCGetBakSchema.getMakeDate());
		this.MakeTime = aLCGetBakSchema.getMakeTime();
		this.ModifyTime = aLCGetBakSchema.getModifyTime();
		this.ModifyDate = fDate.getDate( aLCGetBakSchema.getModifyDate());
		this.GetEndState = aLCGetBakSchema.getGetEndState();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LCGetBak表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LCGetBakSchema";
	...
	public LCGetBakSchema getSchema()
	{
		LCGetBakSchema aLCGetBakSchema = new LCGetBakSchema();
		aLCGetBakSchema.setSchema(this);
		return aLCGetBakSchema;
	}

	public LCGetBakDB getDB()
	{
		LCGetBakDB aDBOper = new LCGetBakDB();
	...
	**/
	public String encode()
	{
		...
		strReturn.append(StrTool.cTrim(GetEndState));
		return strReturn.toString();
	}

	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLCGetBak>历史记账凭证主表信息</A>表字段
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LCGetBakSchema other = (LCGetBakSchema)otherObject;
		return
