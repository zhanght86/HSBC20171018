...
/*
 * <p>ClassName: LPGetCalModeDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: Physical Data Model 1
 */
public class LPGetCalModeDBSet extends LPGetCalModeSet
{
	// @Field
	...
	**/
	...
	// @Constructor
	public LPGetCalModeDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LPGetCalModeDBSet";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getGetType() == null || this.get(i).getGetType().equals("null")) {
				...
				pstmt.setString(9, this.get(i).getGetType());
			}
			if(this.get(i).getFeeValue() == null || this.get(i).getFeeValue().equals("null")) {
				pstmt.setString(10,null);
			} else {
				pstmt.setString(10, this.get(i).getFeeValue());
			}
			...
			if(this.get(i).getEdorNo() == null || this.get(i).getEdorNo().equals("null")) {
				...
				pstmt.setString(28, this.get(i).getEdorNo());
			}
			if(this.get(i).getEdorType() == null || this.get(i).getEdorType().equals("null")) {
				pstmt.setString(29,null);
			} else {
				pstmt.setString(29, this.get(i).getEdorType());
			}
			if(this.get(i).getSerialNo() == null || this.get(i).getSerialNo().equals("null")) {
				pstmt.setString(30,null);
			} else {
				pstmt.setString(30, this.get(i).getSerialNo());
			}
