...
/*
 * <p>ClassName: LPEdorPopedomSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 保全核心
 */
public class LPEdorPopedomSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LPEdorPopedomSchema.class);
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LPEdorPopedomSchema cloned = (LPEdorPopedomSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LPEdorPopedomSchema 对象给 Schema 赋值
	* @param: aLPEdorPopedomSchema LPEdorPopedomSchema
	**/
	public void setSchema(LPEdorPopedomSchema aLPEdorPopedomSchema)
	{
		this.ManageCom = aLPEdorPopedomSchema.getManageCom();
		this.EdorPopedom = aLPEdorPopedomSchema.getEdorPopedom();
		this.EdorCode = aLPEdorPopedomSchema.getEdorCode();
		this.RiskProp = aLPEdorPopedomSchema.getRiskProp();
		this.RiskPeriod = aLPEdorPopedomSchema.getRiskPeriod();
		this.ApplyFlag = aLPEdorPopedomSchema.getApplyFlag();
		this.ApproveFlag = aLPEdorPopedomSchema.getApproveFlag();
		this.AppDateModifyFlag = aLPEdorPopedomSchema.getAppDateModifyFlag();
		this.LimitPayMoney = aLPEdorPopedomSchema.getLimitPayMoney();
		this.LimitGetMoney = aLPEdorPopedomSchema.getLimitGetMoney();
		this.StartDate = fDate.getDate( aLPEdorPopedomSchema.getStartDate());
		this.EndDate = fDate.getDate( aLPEdorPopedomSchema.getEndDate());
		this.Operator = aLPEdorPopedomSchema.getOperator();
		this.MakeDate = fDate.getDate( aLPEdorPopedomSchema.getMakeDate());
		this.MakeTime = aLPEdorPopedomSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLPEdorPopedomSchema.getModifyDate());
		this.ModifyTime = aLPEdorPopedomSchema.getModifyTime();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LPEdorPopedom表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LPEdorPopedomSchema";
	...
	public LPEdorPopedomSchema getSchema()
	{
		LPEdorPopedomSchema aLPEdorPopedomSchema = new LPEdorPopedomSchema();
		aLPEdorPopedomSchema.setSchema(this);
		return aLPEdorPopedomSchema;
	}

	public LPEdorPopedomDB getDB()
	{
		LPEdorPopedomDB aDBOper = new LPEdorPopedomDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLPEdorPopedom描述/A>表字段
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLPEdorPopedom>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			EdorPopedom = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 2, SysConst.PACKAGESPILTER );
			EdorCode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 3, SysConst.PACKAGESPILTER );
			RiskProp = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 4, SysConst.PACKAGESPILTER );
			RiskPeriod = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 5, SysConst.PACKAGESPILTER );
			ApplyFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 6, SysConst.PACKAGESPILTER );
			ApproveFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 7, SysConst.PACKAGESPILTER );
			AppDateModifyFlag= new Integer(ChgData.chgNumericStr(StrTool.getStr(strMessage,8,SysConst.PACKAGESPILTER))).intValue();
			LimitPayMoney = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,9,SysConst.PACKAGESPILTER))).doubleValue();
			LimitGetMoney = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,10,SysConst.PACKAGESPILTER))).doubleValue();
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LPEdorPopedomSchema other = (LPEdorPopedomSchema)otherObject;
		return
