...
/*
 * <p>ClassName: LLUWSubDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 理赔管理
 */
public class LLUWSubDBSet extends LLUWSubSet
{
private static Logger logger = Logger.getLogger(LLUWSubDBSet.class);
	...
	**/
	...
	// @Constructor
	public LLUWSubDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LLUWSubDBSet";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getBatNo() == null || this.get(i).getBatNo().equals("null")) {
				...
				pstmt.setString(44, this.get(i).getBatNo());
			}
			if(this.get(i).getPolNo() == null || this.get(i).getPolNo().equals("null")) {
