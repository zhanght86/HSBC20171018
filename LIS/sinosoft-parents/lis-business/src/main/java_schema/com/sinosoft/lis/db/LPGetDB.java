...
/*
 * <p>ClassName: LPGetDB </p>
 * <p>Description: DB层数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 保全核心
 */
public class LPGetDB extends LPGetSchema
{
	// @Field
	...
	**/
	...
	// @Constructor
	public LPGetDB( Connection tConnection )
	{
		con = tConnection;
	...
	{
		LPGetSchema tSchema = this.getSchema();
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.getGetMode() == null || this.getGetMode().equals("null")) {
				...
				pstmt.setString(10, this.getGetMode());
			}
			pstmt.setDouble(11, this.getGetLimit());
			pstmt.setDouble(12, this.getGetRate());
			if(this.getUrgeGetFlag() == null || this.getUrgeGetFlag().equals("null")) {
				pstmt.setNull(13, 1);
			} else {
				pstmt.setString(13, this.getUrgeGetFlag());
			}
			if(this.getLiveGetType() == null || this.getLiveGetType().equals("null")) {
				pstmt.setNull(14, 1);
			} else {
				pstmt.setString(14, this.getLiveGetType());
			}
			pstmt.setDouble(15, this.getAddRate());
			if(this.getCanGet() == null || this.getCanGet().equals("null")) {
				pstmt.setNull(16, 1);
			} else {
				pstmt.setString(16, this.getCanGet());
			}
			if(this.getNeedAcc() == null || this.getNeedAcc().equals("null")) {
				pstmt.setNull(17, 1);
			} else {
				pstmt.setString(17, this.getNeedAcc());
			}
			if(this.getNeedCancelAcc() == null || this.getNeedCancelAcc().equals("null")) {
				pstmt.setNull(18, 1);
			} else {
				pstmt.setString(18, this.getNeedCancelAcc());
			}
			pstmt.setDouble(19, this.getStandMoney());
			pstmt.setDouble(20, this.getActuGet());
			pstmt.setDouble(21, this.getSumMoney());
			pstmt.setInt(22, this.getGetIntv());
			if(this.getGettoDate() == null || this.getGettoDate().equals("null")) {
				pstmt.setNull(23, 91);
			} else {
				pstmt.setDate(23, Date.valueOf(this.getGettoDate()));
			}
			if(this.getGetStartDate() == null || this.getGetStartDate().equals("null")) {
				pstmt.setNull(24, 91);
			} else {
				pstmt.setDate(24, Date.valueOf(this.getGetStartDate()));
			}
			if(this.getGetEndDate() == null || this.getGetEndDate().equals("null")) {
				pstmt.setNull(25, 91);
			} else {
				pstmt.setDate(25, Date.valueOf(this.getGetEndDate()));
			}
			if(this.getBalaDate() == null || this.getBalaDate().equals("null")) {
				pstmt.setNull(26, 91);
			} else {
				pstmt.setDate(26, Date.valueOf(this.getBalaDate()));
			}
			...
			if(this.getGetEndState() == null || this.getGetEndState().equals("null")) {
				...
				pstmt.setString(34, this.getGetEndState());
			}
			...
			if(this.getGetDutyCode() == null || this.getGetDutyCode().equals("null")) {
				...
				pstmt.setString(42, this.getGetDutyCode());
			}
			pstmt.executeUpdate();
			pstmt.close();
		} catch (Exception ex) {
	...
	public boolean getInfo()
	{
		...
		try
		{
			pstmt = con.prepareStatement("SELECT * FROM LPGet WHERE  EdorNo = ? AND EdorType = ? AND PolNo = ? AND DutyCode = ? AND GetDutyCode = ?", 
	...
	public LPGetSet query()
	{
	  ...
	  if( !mflag ) {
		...
		{
			SQLString sqlObj = new SQLString("LPGet");
			LPGetSchema aSchema = this.getSchema();
			...
			{
				i++;
				LPGetSchema s1 = new LPGetSchema();
				s1.setSchema(rs,i);
				aLPGetSet.add(s1);
			}
			try{ rs.close(); } catch( Exception ex ) {}
	...
	public LPGetSet executeQuery(String sql)
	{
		Statement stmt = null;
		ResultSet rs = null;
		LPGetSet aLPGetSet = new LPGetSet();
	...
	public LPGetSet query(int nStart, int nCount)
	{
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		LPGetSet aLPGetSet = new LPGetSet();
	...
	public LPGetSet executeQuery(String sql, int nStart, int nCount)
	{
		Statement stmt = null;
		ResultSet rs = null;
		LPGetSet aLPGetSet = new LPGetSet();
	...
	public boolean update(String strWherePart)
	{
	  ...
	  if( !mflag ) {
		...
		try
		{
			...
			String sql = "update LPGet " + sqlObj.getUpdPart() + " where " + strWherePart;
...
public LPGetSet getData()
{
    ...
    try
    {
        ...
        tLPGetSchema.setSchema(mResultSet, 1);
...
public boolean closeData()
{
	...
	public LPGetSet executeQuery(SQLwithBindVariables sqlbv) {
	...
	public LPGetSet executeQuery(SQLwithBindVariables sqlbv, int nStart, int nCount) {
