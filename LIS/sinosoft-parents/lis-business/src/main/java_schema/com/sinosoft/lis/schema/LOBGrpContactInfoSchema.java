...
import com.sinosoft.lis.db.LOBGrpContactInfoDB;

/*
 * 与数据库结构不一致，暂不处理
 * <p>ClassName: LOBGrpContactInfoSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: Physical Data Model 1
 */
public class LOBGrpContactInfoSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LOBGrpContactInfoSchema.class);
	// @Field
	/** 业务类型 */
	...
	// @Constructor
	public LOBGrpContactInfoSchema()
	{
		mErrors = new CErrors();
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LOBGrpContactInfoSchema cloned = (LOBGrpContactInfoSchema)super.clone();
	...
	/**
	* 使用另外一个 LOBGrpContactInfoSchema 对象给 Schema 赋值
	* @param: aLOBGrpContactInfoSchema LOBGrpContactInfoSchema
	**/
	public void setSchema(LOBGrpContactInfoSchema aLOBGrpContactInfoSchema)
	{
		this.BussType = aLOBGrpContactInfoSchema.getBussType();
		this.BussNo = aLOBGrpContactInfoSchema.getBussNo();
		this.GrpContNo = aLOBGrpContactInfoSchema.getGrpContNo();
		this.GrpPropNo = aLOBGrpContactInfoSchema.getGrpPropNo();
		this.CustomerNo = aLOBGrpContactInfoSchema.getCustomerNo();
		this.Province = aLOBGrpContactInfoSchema.getProvince();
		this.City = aLOBGrpContactInfoSchema.getCity();
		this.County = aLOBGrpContactInfoSchema.getCounty();
		this.Address = aLOBGrpContactInfoSchema.getAddress();
		this.ZipCode = aLOBGrpContactInfoSchema.getZipCode();
		this.LinkMan1 = aLOBGrpContactInfoSchema.getLinkMan1();
		this.Department1 = aLOBGrpContactInfoSchema.getDepartment1();
		this.HeadShip1 = aLOBGrpContactInfoSchema.getHeadShip1();
		this.MobilePhone1 = aLOBGrpContactInfoSchema.getMobilePhone1();
		this.Phone1 = aLOBGrpContactInfoSchema.getPhone1();
		this.Fax1 = aLOBGrpContactInfoSchema.getFax1();
		this.EMail1 = aLOBGrpContactInfoSchema.getEMail1();
		this.MakeOperator = aLOBGrpContactInfoSchema.getMakeOperator();
		this.MakeDate = fDate.getDate( aLOBGrpContactInfoSchema.getMakeDate());
		this.MakeTime = aLOBGrpContactInfoSchema.getMakeTime();
		this.ModifyOperator = aLOBGrpContactInfoSchema.getModifyOperator();
		this.ModifyDate = fDate.getDate( aLOBGrpContactInfoSchema.getModifyDate());
		this.ModifyTime = aLOBGrpContactInfoSchema.getModifyTime();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LOBGrpContactInfo表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LOBGrpContactInfoSchema";
	...
	public LOBGrpContactInfoSchema getSchema()
	{
		LOBGrpContactInfoSchema aLOBGrpContactInfoSchema = new LOBGrpContactInfoSchema();
		aLOBGrpContactInfoSchema.setSchema(this);
		return aLOBGrpContactInfoSchema;
	}

	public LOBGrpContactInfoDB getDB()
	{
		LOBGrpContactInfoDB aDBOper = new LOBGrpContactInfoDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLOBGrpContactInfo描述/A>表字段
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLOBGrpContactInfo>历史记账凭证主表信息</A>表字段
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LOBGrpContactInfoSchema other = (LOBGrpContactInfoSchema)otherObject;
		return
