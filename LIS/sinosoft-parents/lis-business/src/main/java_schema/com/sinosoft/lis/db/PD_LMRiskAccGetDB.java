...
/*
 * <p>ClassName: PD_LMRiskAccGetDB </p>
 * <p>Description: DB层数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 产品定义平台_PDM
 */
public class PD_LMRiskAccGetDB extends PD_LMRiskAccGetSchema
{
	// @Field
	...
	**/
	...
	// @Constructor
	public PD_LMRiskAccGetDB( Connection tConnection )
	{
		con = tConnection;
	...
	{
		PD_LMRiskAccGetSchema tSchema = this.getSchema();
		...
		else
		{
			...
			tError.moduleName = "PD_LMRiskAccGetDB";
	...
	public boolean update()
	{
		...
		try
		{
			...
			pstmt.setInt(19, this.getStandbyflag3());
			pstmt.setInt(20, this.getStandbyflag4());
			pstmt.setDouble(21, this.getStandbyflag5());
			pstmt.setDouble(22, this.getStandbyflag6());
			// set where condition
			if(this.getGetDutyCode() == null || this.getGetDutyCode().equals("null")) {
				pstmt.setNull(23, 12);
			} else {
			...
			if(this.getInsuAccNo() == null || this.getInsuAccNo().equals("null")) {
				...
				pstmt.setString(24, this.getInsuAccNo());
			}
			if(this.getRiskCode() == null || this.getRiskCode().equals("null")) {
				pstmt.setNull(25, 12);
			} else {
	...
	public boolean getInfo()
	{
		...
		try
		{
			pstmt = con.prepareStatement("SELECT * FROM PD_LMRiskAccGet WHERE  GetDutyCode = ? AND InsuAccNo = ? AND RiskCode = ?", 
	...
	public PD_LMRiskAccGetSet query()
	{
		Statement stmt = null;
		ResultSet rs = null;
		PD_LMRiskAccGetSet aPD_LMRiskAccGetSet = new PD_LMRiskAccGetSet();
	  ...
	  if( !mflag ) {
		...
		try
		{
			...
			SQLString sqlObj = new SQLString("PD_LMRiskAccGet");
			PD_LMRiskAccGetSchema aSchema = this.getSchema();
			...
			{
				i++;
				PD_LMRiskAccGetSchema s1 = new PD_LMRiskAccGetSchema();
				s1.setSchema(rs,i);
				aPD_LMRiskAccGetSet.add(s1);
			}
			try{ rs.close(); } catch( Exception ex ) {}
		...
		return aPD_LMRiskAccGetSet;
	}

	public PD_LMRiskAccGetSet executeQuery(String sql)
	{
		Statement stmt = null;
		ResultSet rs = null;
		PD_LMRiskAccGetSet aPD_LMRiskAccGetSet = new PD_LMRiskAccGetSet();
	...
	public PD_LMRiskAccGetSet query(int nStart, int nCount)
	{
		Statement stmt = null;
		ResultSet rs = null;
		PD_LMRiskAccGetSet aPD_LMRiskAccGetSet = new PD_LMRiskAccGetSet();
	...
	public PD_LMRiskAccGetSet executeQuery(String sql, int nStart, int nCount)
	{
		Statement stmt = null;
		ResultSet rs = null;
		PD_LMRiskAccGetSet aPD_LMRiskAccGetSet = new PD_LMRiskAccGetSet();
	...
	public boolean update(String strWherePart)
	{
	  ...
	  if( !mflag ) {
		...
		try
		{
			...
			String sql = "update PD_LMRiskAccGet " + sqlObj.getUpdPart() + " where " + strWherePart;
 ...
 */
public PD_LMRiskAccGetSet getData()
{
    int tCount = 0;
    PD_LMRiskAccGetSet tPD_LMRiskAccGetSet = new PD_LMRiskAccGetSet();
    PD_LMRiskAccGetSchema tPD_LMRiskAccGetSchema = null;
    if (null == mResultSet)
    {
        CError tError = new CError();
        tError.moduleName = "PD_LMRiskAccGetDB";
    ...
    {
        tCount = 1;
        tPD_LMRiskAccGetSchema = new PD_LMRiskAccGetSchema();
        tPD_LMRiskAccGetSchema.setSchema(mResultSet, 1);
        tPD_LMRiskAccGetSet.add(tPD_LMRiskAccGetSchema);
