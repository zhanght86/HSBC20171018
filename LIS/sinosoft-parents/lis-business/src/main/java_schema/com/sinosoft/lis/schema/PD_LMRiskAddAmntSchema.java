...
import com.sinosoft.lis.db.PD_LMRiskAddAmntDB;

/**
 * <p>ClassName: PD_LMRiskAddAmntSchema </p>
 ...
 */
public class PD_LMRiskAddAmntSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(PD_LMRiskAddAmntSchema.class);
    ...
    {
        PD_LMRiskAddAmntSchema cloned = (PD_LMRiskAddAmntSchema)super.clone();
    ...
    public void setAddRange(String aAddRange)
    {
        AddRange = aAddRange;
    }
    ...
    public void setAddCalCode(String aAddCalCode)
    {
        AddCalCode = aAddCalCode;
    }
    ...
    /**
     * 使用另外一个 PD_LMRiskAddAmntSchema 对象给 Schema 赋值
     * @param: aPD_LMRiskAddAmntSchema PD_LMRiskAddAmntSchema
     **/
    public void setSchema(PD_LMRiskAddAmntSchema aPD_LMRiskAddAmntSchema)
    {
        this.RiskCode = aPD_LMRiskAddAmntSchema.getRiskCode();
        this.DutyCode = aPD_LMRiskAddAmntSchema.getDutyCode();
        this.AddRange = aPD_LMRiskAddAmntSchema.getAddRange();
        this.AddCalCode = aPD_LMRiskAddAmntSchema.getAddCalCode();
        this.Operator = aPD_LMRiskAddAmntSchema.getOperator();
        this.MakeDate = fDate.getDate(aPD_LMRiskAddAmntSchema.getMakeDate());
        this.MakeTime = aPD_LMRiskAddAmntSchema.getMakeTime();
        this.ModifyDate = fDate.getDate(aPD_LMRiskAddAmntSchema.getModifyDate());
        this.ModifyTime = aPD_LMRiskAddAmntSchema.getModifyTime();
        this.Standbyflag1 = aPD_LMRiskAddAmntSchema.getStandbyflag1();
        this.Standbyflag2 = aPD_LMRiskAddAmntSchema.getStandbyflag2();
        this.Standbyflag3 = aPD_LMRiskAddAmntSchema.getStandbyflag3();
        this.Standbyflag4 = aPD_LMRiskAddAmntSchema.getStandbyflag4();
        this.Standbyflag5 = aPD_LMRiskAddAmntSchema.getStandbyflag5();
        this.Standbyflag6 = aPD_LMRiskAddAmntSchema.getStandbyflag6();
    }
    ...
    public boolean setSchema(ResultSet rs, int i)
    {
        try
        {
            ...
            if (rs.getString(2) == null)
                ...
                this.DutyCode = rs.getString(2).trim();
            if (rs.getString(3) == null)
                this.AddRange = null;
            else
                this.AddRange = rs.getString(3).trim();
            if (rs.getString(4) == null)
                this.AddCalCode = null;
            else
                this.AddCalCode = rs.getString(4).trim();
            if (rs.getString(5) == null)
                this.Operator = null;
            else
                this.Operator = rs.getString(5).trim();
            ...
            if (rs.getString(10) == null)
                ...
                this.Standbyflag1 = rs.getString(10).trim();
            if (rs.getString(11) == null)
                this.Standbyflag2 = null;
            else
                this.Standbyflag2 = rs.getString(11).trim();
            this.Standbyflag3 = rs.getInt(12);
            this.Standbyflag4 = rs.getInt(13);
            this.Standbyflag5 = rs.getDouble(14);
            this.Standbyflag6 = rs.getDouble(15);
        }
        catch (SQLException sqle)
        {
            logger.debug("数据库中表PD_LMRiskAddAmnt字段个数和Schema中的字段个数不一致，或执行db.executeQuery查询时未使用select * from tables");
            // @@错误处理
            CError tError = new CError();
            tError.moduleName = "PD_LMRiskAddAmntSchema";
    ...
    public PD_LMRiskAddAmntSchema getSchema()
    {
        PD_LMRiskAddAmntSchema aPD_LMRiskAddAmntSchema = new PD_LMRiskAddAmntSchema();
        aPD_LMRiskAddAmntSchema.setSchema(this);
        return aPD_LMRiskAddAmntSchema;
    }

    public PD_LMRiskAddAmntDB getDB()
    {
        PD_LMRiskAddAmntDB aDBOper = new PD_LMRiskAddAmntDB();
    ...
    public String encode()
    {
        ...
        strReturn.append(SysConst.PACKAGESPILTER);
        strReturn.append(StrTool.cTrim(AddRange));
        strReturn.append(SysConst.PACKAGESPILTER);
        strReturn.append(StrTool.cTrim(AddCalCode));
        strReturn.append(SysConst.PACKAGESPILTER);
    ...
    /**
     * 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpPD_LMRiskAddAmnt>历史记账凭证主表信息</A>表字段
    ...
    public boolean decode(String strMessage)
    {
        try
        {
            ...
            AddRange = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 3, SysConst.PACKAGESPILTER);
            AddCalCode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 4, SysConst.PACKAGESPILTER);
    ...
    public String getV(String FCode)
    {
        ...
        if (FCode.equalsIgnoreCase("AddRange"))
        {
            strReturn = StrTool.GBKToUnicode(String.valueOf(AddRange));
        }
        if (FCode.equalsIgnoreCase("AddCalCode"))
        {
            strReturn = StrTool.GBKToUnicode(String.valueOf(AddCalCode));
        }
    ...
    public String getV(int nFieldIndex)
    {
        ...
        switch (nFieldIndex)
        {
            ...
            case 1:
                ...
                break;
            case 2:
                strFieldValue = StrTool.GBKToUnicode(AddRange);
                break;
            case 3:
                strFieldValue = StrTool.GBKToUnicode(AddCalCode);
                break;
            case 4:
    ...
    public boolean equals(Object otherObject)
    {
        ...
        if (getClass() != otherObject.getClass())
            return false;
        PD_LMRiskAddAmntSchema other = (PD_LMRiskAddAmntSchema) otherObject;
        return
                ...
                && (AddRange == null ? other.getAddRange() == null : AddRange.equals(other.getAddRange()))
                && (AddCalCode == null ? other.getAddCalCode() == null : AddCalCode.equals(other.getAddCalCode()))
    ...
    public int getFieldIndex(String strFieldName)
    {
        ...
        if (strFieldName.equals("AddRange"))
        {
            return 2;
        }
        if (strFieldName.equals("AddCalCode"))
        {
            return 3;
        }
    ...
    public String getFieldName(int nFieldIndex)
    {
        ...
        switch (nFieldIndex)
        {
            ...
            case 1:
                ...
                break;
            case 2:
                strFieldName = "AddRange";
                break;
            case 3:
                strFieldName = "AddCalCode";
                break;
            case 4:
