...
/*
 * <p>ClassName: LCCUWSubBakDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: PhysicalDataModel_1
 */
public class LCCUWSubBakDBSet extends LCCUWSubBakSet
{
private static Logger logger = Logger.getLogger(LCCUWSubBakDBSet.class);
	...
	**/
	...
	// @Constructor
	public LCCUWSubBakDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LCCUWSubBakDBSet";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getCommonReasonCode() == null || this.get(i).getCommonReasonCode().equals("null")) {
				...
				pstmt.setString(41, this.get(i).getCommonReasonCode());
			}
			// set where condition
			if(this.get(i).getContNo() == null || this.get(i).getContNo().equals("null")) {
			...
			pstmt.setInt(43, this.get(i).getUWNo());
