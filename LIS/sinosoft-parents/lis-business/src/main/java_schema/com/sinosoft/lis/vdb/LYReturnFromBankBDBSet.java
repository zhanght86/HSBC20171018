...
/*
 * <p>ClassName: LYReturnFromBankBDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 银行业务
 */
public class LYReturnFromBankBDBSet extends LYReturnFromBankBSet
{
private static Logger logger = Logger.getLogger(LYReturnFromBankBDBSet.class);
	...
	**/
	...
	// @Constructor
	public LYReturnFromBankBDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LYReturnFromBankBDBSet";
