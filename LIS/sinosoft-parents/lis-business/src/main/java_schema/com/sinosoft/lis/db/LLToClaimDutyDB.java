...
/*
 * <p>ClassName: LLToClaimDutyDB </p>
 * <p>Description: DB层数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 理赔管理
 */
public class LLToClaimDutyDB extends LLToClaimDutySchema
{
	// @Field
	...
	**/
	...
	// @Constructor
	public LLToClaimDutyDB( Connection tConnection )
	{
		con = tConnection;
	...
	{
		LLToClaimDutySchema tSchema = this.getSchema();
		...
		else
		{
			...
			tError.moduleName = "LLToClaimDutyDB";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.getPolSort() == null || this.getPolSort().equals("null")) {
				...
				pstmt.setString(3, this.getPolSort());
			}
			if(this.getPolType() == null || this.getPolType().equals("null")) {
				pstmt.setNull(4, 12);
			} else {
				pstmt.setString(4, this.getPolType());
			}
			if(this.getDutyCode() == null || this.getDutyCode().equals("null")) {
				pstmt.setNull(5, 12);
			} else {
			...
			if(this.getSubRptNo() == null || this.getSubRptNo().equals("null")) {
				...
				pstmt.setString(10, this.getSubRptNo());
			}
			...
			pstmt.setInt(18, this.getClaimCount());
			pstmt.setDouble(19, this.getEstClaimMoney());
			if(this.getGiveType() == null || this.getGiveType().equals("null")) {
				pstmt.setNull(20, 12);
			} else {
				pstmt.setString(20, this.getGiveType());
			}
			if(this.getGiveTypeDesc() == null || this.getGiveTypeDesc().equals("null")) {
				pstmt.setNull(21, 12);
			} else {
				pstmt.setString(21, this.getGiveTypeDesc());
			}
			if(this.getGiveReason() == null || this.getGiveReason().equals("null")) {
				pstmt.setNull(22, 12);
			} else {
				pstmt.setString(22, this.getGiveReason());
			}
			if(this.getGiveReasonDesc() == null || this.getGiveReasonDesc().equals("null")) {
				pstmt.setNull(23, 12);
			} else {
				pstmt.setString(23, this.getGiveReasonDesc());
			}
			pstmt.setDouble(24, this.getAmnt());
			pstmt.setDouble(25, this.getYearBonus());
			pstmt.setDouble(26, this.getEndBonus());
			pstmt.setInt(27, this.getGracePeriod());
			if(this.getCasePolType() == null || this.getCasePolType().equals("null")) {
				pstmt.setNull(28, 12);
			} else {
				pstmt.setString(28, this.getCasePolType());
			}
			if(this.getCustomerNo() == null || this.getCustomerNo().equals("null")) {
				pstmt.setNull(29, 12);
			} else {
			...
			if(this.getPrepayFlag() == null || this.getPrepayFlag().equals("null")) {
				...
				pstmt.setString(30, this.getPrepayFlag());
			}
			pstmt.setDouble(31, this.getPrepaySum());
			if(this.getPosFlag() == null || this.getPosFlag().equals("null")) {
				pstmt.setNull(32, 12);
			} else {
				pstmt.setString(32, this.getPosFlag());
			}
			if(this.getPosEdorNo() == null || this.getPosEdorNo().equals("null")) {
				pstmt.setNull(33, 12);
			} else {
				pstmt.setString(33, this.getPosEdorNo());
			}
			if(this.getEffectOnMainRisk() == null || this.getEffectOnMainRisk().equals("null")) {
				pstmt.setNull(34, 12);
			} else {
				pstmt.setString(34, this.getEffectOnMainRisk());
			}
			if(this.getRiskCalCode() == null || this.getRiskCalCode().equals("null")) {
				pstmt.setNull(35, 12);
			} else {
				pstmt.setString(35, this.getRiskCalCode());
			}
			pstmt.setDouble(36, this.getAddAmnt());
			if(this.getNBPolNo() == null || this.getNBPolNo().equals("null")) {
				pstmt.setNull(37, 12);
			} else {
				pstmt.setString(37, this.getNBPolNo());
			}
			if(this.getPosEdorType() == null || this.getPosEdorType().equals("null")) {
				pstmt.setNull(38, 12);
			} else {
				pstmt.setString(38, this.getPosEdorType());
			}
			if(this.getRiskType() == null || this.getRiskType().equals("null")) {
				pstmt.setNull(39, 12);
			} else {
				pstmt.setString(39, this.getRiskType());
			}
			pstmt.setDouble(40, this.getPopedomPay());
			pstmt.setDouble(41, this.getInsFeePay());
			...
			if(this.getBussType() == null || this.getBussType().equals("null")) {
				...
				pstmt.setString(44, this.getBussType());
			}
			if(this.getBussNo() == null || this.getBussNo().equals("null")) {
				pstmt.setNull(45, 12);
			} else {
				pstmt.setString(45, this.getBussNo());
			}
			if(this.getExpandFlag() == null || this.getExpandFlag().equals("null")) {
				pstmt.setNull(46, 12);
			} else {
				pstmt.setString(46, this.getExpandFlag());
			}
			if(this.getExpandDutyCode() == null || this.getExpandDutyCode().equals("null")) {
				pstmt.setNull(47, 12);
			} else {
				pstmt.setString(47, this.getExpandDutyCode());
			}
			if(this.getManageCom() == null || this.getManageCom().equals("null")) {
				pstmt.setNull(48, 12);
			} else {
				pstmt.setString(48, this.getManageCom());
			}
			if(this.getComCode() == null || this.getComCode().equals("null")) {
				pstmt.setNull(49, 12);
			} else {
				pstmt.setString(49, this.getComCode());
			}
			if(this.getMakeOperator() == null || this.getMakeOperator().equals("null")) {
				pstmt.setNull(50, 12);
			} else {
				pstmt.setString(50, this.getMakeOperator());
			}
			...
			if(this.getCaseNo() == null || this.getCaseNo().equals("null")) {
				...
				pstmt.setString(56, this.getCaseNo());
			}
			if(this.getPolNo() == null || this.getPolNo().equals("null")) {
				pstmt.setNull(57, 12);
			} else {
			...
			if(this.getDutyCode() == null || this.getDutyCode().equals("null")) {
				...
				pstmt.setString(58, this.getDutyCode());
			}
			if(this.getGetDutyCode() == null || this.getGetDutyCode().equals("null")) {
				pstmt.setNull(59, 12);
			} else {
				pstmt.setString(59, this.getGetDutyCode());
			}
			if(this.getGetDutyKind() == null || this.getGetDutyKind().equals("null")) {
				pstmt.setNull(60, 12);
			} else {
				pstmt.setString(60, this.getGetDutyKind());
			}
			if(this.getCaseRelaNo() == null || this.getCaseRelaNo().equals("null")) {
				pstmt.setNull(61, 12);
			} else {
				pstmt.setString(61, this.getCaseRelaNo());
			}
			if(this.getCustomerNo() == null || this.getCustomerNo().equals("null")) {
				pstmt.setNull(62, 12);
			} else {
	...
	public boolean getInfo()
	{
		...
		try
		{
			pstmt = con.prepareStatement("SELECT * FROM LLToClaimDuty WHERE  CaseNo = ? AND PolNo = ? AND DutyCode = ? AND GetDutyCode = ? AND GetDutyKind = ? AND CaseRelaNo = ? AND CustomerNo = ?", 
	...
	public LLToClaimDutySet query()
	{
	  ...
	  if( !mflag ) {
		...
		{
			SQLString sqlObj = new SQLString("LLToClaimDuty");
			LLToClaimDutySchema aSchema = this.getSchema();
			...
			{
				i++;
				LLToClaimDutySchema s1 = new LLToClaimDutySchema();
				s1.setSchema(rs,i);
				aLLToClaimDutySet.add(s1);
			}
			try{ rs.close(); } catch( Exception ex ) {}
			try{ pstmt.close(); } catch( Exception ex1 ) {}
		}
		...
		return aLLToClaimDutySet;
	}

	public LLToClaimDutySet executeQuery(String sql)
	{
		Statement stmt = null;
		ResultSet rs = null;
		LLToClaimDutySet aLLToClaimDutySet = new LLToClaimDutySet();
	...
	public LLToClaimDutySet query(int nStart, int nCount)
	{
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		LLToClaimDutySet aLLToClaimDutySet = new LLToClaimDutySet();
	...
	public LLToClaimDutySet executeQuery(String sql, int nStart, int nCount)
	{
		Statement stmt = null;
		ResultSet rs = null;
		LLToClaimDutySet aLLToClaimDutySet = new LLToClaimDutySet();
	...
	public boolean update(String strWherePart)
	{
	  ...
	  if( !mflag ) {
		...
		try
		{
			...
			String sql = "update LLToClaimDuty " + sqlObj.getUpdPart() + " where " + strWherePart;
 ...
 */
public LLToClaimDutySet getData()
{
    int tCount = 0;
    LLToClaimDutySet tLLToClaimDutySet = new LLToClaimDutySet();
    LLToClaimDutySchema tLLToClaimDutySchema = null;
    if (null == mResultSet)
    {
        CError tError = new CError();
        tError.moduleName = "LLToClaimDutyDB";
    ...
    {
        tCount = 1;
        tLLToClaimDutySchema = new LLToClaimDutySchema();
        tLLToClaimDutySchema.setSchema(mResultSet, 1);
...
public boolean closeData()
{
	...
	public LLToClaimDutySet executeQuery(SQLwithBindVariables sqlbv) {
	...
	public LLToClaimDutySet executeQuery(SQLwithBindVariables sqlbv, int nStart, int nCount) {
