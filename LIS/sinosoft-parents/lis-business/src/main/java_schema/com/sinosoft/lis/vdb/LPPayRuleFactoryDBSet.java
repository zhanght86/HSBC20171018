...
/*
 * <p>ClassName: LPPayRuleFactoryDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 保全核心
 */
public class LPPayRuleFactoryDBSet extends LPPayRuleFactorySet
{
private static Logger logger = Logger.getLogger(LPPayRuleFactoryDBSet.class);
	...
	**/
	...
	// @Constructor
	public LPPayRuleFactoryDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LPPayRuleFactoryDBSet";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getParams() == null || this.get(i).getParams().equals("null")) {
				...
				pstmt.setString(15, this.get(i).getParams());
			}
			if(this.get(i).getCalRemark() == null || this.get(i).getCalRemark().equals("null")) {
				pstmt.setString(16,null);
			} else {
				pstmt.setString(16, this.get(i).getCalRemark());
			}
			...
			if(this.get(i).getPayRuleCode() == null || this.get(i).getPayRuleCode().equals("null")) {
				...
				pstmt.setString(25, this.get(i).getPayRuleCode());
			}
			if(this.get(i).getFactoryType() == null || this.get(i).getFactoryType().equals("null")) {
