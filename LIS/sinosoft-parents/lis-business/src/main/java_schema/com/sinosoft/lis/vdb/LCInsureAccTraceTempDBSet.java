...
/*
 * <p>ClassName: LCInsureAccTraceTempDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 泰康未整理PDM
 */
public class LCInsureAccTraceTempDBSet extends LCInsureAccTraceTempSet
{
	// @Field
	...
	**/
	...
	// @Constructor
	public LCInsureAccTraceTempDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public LCInsureAccTraceTempDBSet()
	{
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LCInsureAccTraceTempDBSet";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getFlag() == null || this.get(i).getFlag().equals("null")) {
				...
				pstmt.setString(27, this.get(i).getFlag());
			}
			if(this.get(i).getPolTypeFlag() == null || this.get(i).getPolTypeFlag().equals("null")) {
				pstmt.setString(28,null);
			} else {
				pstmt.setString(28, this.get(i).getPolTypeFlag());
			}
			// set where condition
			if(this.get(i).getSerialNo() == null || this.get(i).getSerialNo().equals("null")) {
