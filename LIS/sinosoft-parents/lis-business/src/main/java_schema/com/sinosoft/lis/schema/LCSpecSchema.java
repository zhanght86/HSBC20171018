...
/*
 * <p>ClassName: LCSpecSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 承保流程
 */
public class LCSpecSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LCSpecSchema.class);
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LCSpecSchema cloned = (LCSpecSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LCSpecSchema 对象给 Schema 赋值
	* @param: aLCSpecSchema LCSpecSchema
	**/
	public void setSchema(LCSpecSchema aLCSpecSchema)
	{
		this.GrpContNo = aLCSpecSchema.getGrpContNo();
		this.ContNo = aLCSpecSchema.getContNo();
		this.PolNo = aLCSpecSchema.getPolNo();
		this.ProposalNo = aLCSpecSchema.getProposalNo();
		this.PrtSeq = aLCSpecSchema.getPrtSeq();
		this.SerialNo = aLCSpecSchema.getSerialNo();
		this.EndorsementNo = aLCSpecSchema.getEndorsementNo();
		this.SpecType = aLCSpecSchema.getSpecType();
		this.SpecCode = aLCSpecSchema.getSpecCode();
		this.SpecContent = aLCSpecSchema.getSpecContent();
		this.PrtFlag = aLCSpecSchema.getPrtFlag();
		this.BackupType = aLCSpecSchema.getBackupType();
		this.Operator = aLCSpecSchema.getOperator();
		this.MakeDate = fDate.getDate( aLCSpecSchema.getMakeDate());
		this.MakeTime = aLCSpecSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLCSpecSchema.getModifyDate());
		this.ModifyTime = aLCSpecSchema.getModifyTime();
		this.SpecReason = aLCSpecSchema.getSpecReason();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LCSpec表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LCSpecSchema";
	...
	public LCSpecSchema getSchema()
	{
		LCSpecSchema aLCSpecSchema = new LCSpecSchema();
		aLCSpecSchema.setSchema(this);
		return aLCSpecSchema;
	}

	public LCSpecDB getDB()
	{
		LCSpecDB aDBOper = new LCSpecDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLCSpec描述/A>表字段
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLCSpec>历史记账凭证主表信息</A>表字段
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LCSpecSchema other = (LCSpecSchema)otherObject;
		return
