...
/*
 * <p>ClassName: LLInqFeeDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 理赔管理
 */
public class LLInqFeeDBSet extends LLInqFeeSet
{
	// @Field
	...
	**/
	...
	// @Constructor
	public LLInqFeeDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LLInqFeeDBSet";
	...
	public boolean delete()
	{
		...
		try
		{
			...
			if(this.get(i).getInqDept() == null || this.get(i).getInqDept().equals("null")) {
				...
				pstmt.setString(3, this.get(i).getInqDept());
			}
			if(this.get(i).getFeeType() == null || this.get(i).getFeeType().equals("null")) {
				pstmt.setString(4,null);
			} else {
				pstmt.setString(4, this.get(i).getFeeType());
			}
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getFeeDate() == null || this.get(i).getFeeDate().equals("null")) {
				...
				pstmt.setDate(5, Date.valueOf(this.get(i).getFeeDate()));
			}
			pstmt.setDouble(6, this.get(i).getFeeSum());
			if(this.get(i).getPayee() == null || this.get(i).getPayee().equals("null")) {
				pstmt.setString(7,null);
			} else {
				pstmt.setString(7, this.get(i).getPayee());
			}
			if(this.get(i).getPayeeType() == null || this.get(i).getPayeeType().equals("null")) {
				pstmt.setString(8,null);
			} else {
				pstmt.setString(8, this.get(i).getPayeeType());
			}
			...
			if(this.get(i).getInqNo() == null || this.get(i).getInqNo().equals("null")) {
				...
				pstmt.setString(25, this.get(i).getInqNo());
			}
			if(this.get(i).getInqDept() == null || this.get(i).getInqDept().equals("null")) {
				pstmt.setString(26,null);
			} else {
				pstmt.setString(26, this.get(i).getInqDept());
			}
			if(this.get(i).getFeeType() == null || this.get(i).getFeeType().equals("null")) {
