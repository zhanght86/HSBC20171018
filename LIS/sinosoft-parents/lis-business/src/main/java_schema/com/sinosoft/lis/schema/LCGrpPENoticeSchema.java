...
/*
 * <p>ClassName: LCGrpPENoticeSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 承保流程
 */
public class LCGrpPENoticeSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LCGrpPENoticeSchema.class);
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LCGrpPENoticeSchema cloned = (LCGrpPENoticeSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LCGrpPENoticeSchema 对象给 Schema 赋值
	* @param: aLCGrpPENoticeSchema LCGrpPENoticeSchema
	**/
	public void setSchema(LCGrpPENoticeSchema aLCGrpPENoticeSchema)
	{
		this.GrpContNo = aLCGrpPENoticeSchema.getGrpContNo();
		this.PrtSeq = aLCGrpPENoticeSchema.getPrtSeq();
		this.PEDate = fDate.getDate( aLCGrpPENoticeSchema.getPEDate());
		this.PEAddress = aLCGrpPENoticeSchema.getPEAddress();
		this.PEBeforeCond = aLCGrpPENoticeSchema.getPEBeforeCond();
		this.PrintFlag = aLCGrpPENoticeSchema.getPrintFlag();
		this.ManageCom = aLCGrpPENoticeSchema.getManageCom();
		this.AgentName = aLCGrpPENoticeSchema.getAgentName();
		this.AgentCode = aLCGrpPENoticeSchema.getAgentCode();
		this.Operator = aLCGrpPENoticeSchema.getOperator();
		this.MakeDate = fDate.getDate( aLCGrpPENoticeSchema.getMakeDate());
		this.MakeTime = aLCGrpPENoticeSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLCGrpPENoticeSchema.getModifyDate());
		this.ModifyTime = aLCGrpPENoticeSchema.getModifyTime();
		this.Remark = aLCGrpPENoticeSchema.getRemark();
		this.PEResult = aLCGrpPENoticeSchema.getPEResult();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LCGrpPENotice表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LCGrpPENoticeSchema";
	...
	public LCGrpPENoticeSchema getSchema()
	{
		LCGrpPENoticeSchema aLCGrpPENoticeSchema = new LCGrpPENoticeSchema();
		aLCGrpPENoticeSchema.setSchema(this);
		return aLCGrpPENoticeSchema;
	}

	public LCGrpPENoticeDB getDB()
	{
		LCGrpPENoticeDB aDBOper = new LCGrpPENoticeDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLCGrpPENotice描述/A>表字段
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLCGrpPENotice>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			PrtSeq = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 2, SysConst.PACKAGESPILTER );
			PEDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 3,SysConst.PACKAGESPILTER));
			PEAddress = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 4, SysConst.PACKAGESPILTER );
			PEBeforeCond = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 5, SysConst.PACKAGESPILTER );
			PrintFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 6, SysConst.PACKAGESPILTER );
			...
			PEResult = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 16, SysConst.PACKAGESPILTER );
		}
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LCGrpPENoticeSchema other = (LCGrpPENoticeSchema)otherObject;
		return
