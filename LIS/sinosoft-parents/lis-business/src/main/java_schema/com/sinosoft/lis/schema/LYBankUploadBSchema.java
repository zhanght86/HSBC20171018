...
import com.sinosoft.lis.db.LYBankUploadBDB;

/*
 * <p>ClassName: LYBankUploadBSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 银行业务
 */
public class LYBankUploadBSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LYBankUploadBSchema.class);
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LYBankUploadBSchema cloned = (LYBankUploadBSchema)super.clone();
	...
	/**
	* 使用另外一个 LYBankUploadBSchema 对象给 Schema 赋值
	* @param: aLYBankUploadBSchema LYBankUploadBSchema
	**/
	public void setSchema(LYBankUploadBSchema aLYBankUploadBSchema)
	{
		this.SerialNo = aLYBankUploadBSchema.getSerialNo();
		this.BankCode = aLYBankUploadBSchema.getBankCode();
		this.UploadDate = fDate.getDate( aLYBankUploadBSchema.getUploadDate());
		this.Col1 = aLYBankUploadBSchema.getCol1();
		this.Col2 = aLYBankUploadBSchema.getCol2();
		this.Col3 = aLYBankUploadBSchema.getCol3();
		this.Col4 = aLYBankUploadBSchema.getCol4();
		this.Col5 = aLYBankUploadBSchema.getCol5();
		this.Col6 = aLYBankUploadBSchema.getCol6();
		this.Col7 = aLYBankUploadBSchema.getCol7();
		this.Col8 = aLYBankUploadBSchema.getCol8();
		this.Col9 = aLYBankUploadBSchema.getCol9();
		this.Col10 = aLYBankUploadBSchema.getCol10();
		this.Col11 = aLYBankUploadBSchema.getCol11();
		this.Col12 = aLYBankUploadBSchema.getCol12();
		this.Col13 = aLYBankUploadBSchema.getCol13();
		this.Col14 = aLYBankUploadBSchema.getCol14();
		this.Col15 = aLYBankUploadBSchema.getCol15();
		this.LongCol1 = aLYBankUploadBSchema.getLongCol1();
		this.LongCol2 = aLYBankUploadBSchema.getLongCol2();
		this.LongCol3 = aLYBankUploadBSchema.getLongCol3();
		this.Operator = aLYBankUploadBSchema.getOperator();
		this.MakeTime = aLYBankUploadBSchema.getMakeTime();
		this.MakeDate = fDate.getDate( aLYBankUploadBSchema.getMakeDate());
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LYBankUploadB表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LYBankUploadBSchema";
	...
	public LYBankUploadBSchema getSchema()
	{
		LYBankUploadBSchema aLYBankUploadBSchema = new LYBankUploadBSchema();
		aLYBankUploadBSchema.setSchema(this);
		return aLYBankUploadBSchema;
	}

	public LYBankUploadBDB getDB()
	{
		LYBankUploadBDB aDBOper = new LYBankUploadBDB();
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLYBankUploadB>历史记账凭证主表信息</A>表字段
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LYBankUploadBSchema other = (LYBankUploadBSchema)otherObject;
		return
