...
/*
 * <p>ClassName: LCGCUWMasterDB </p>
 * <p>Description: DB层数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 承保流程
 */
public class LCGCUWMasterDB extends LCGCUWMasterSchema
{
private static Logger logger = Logger.getLogger(LCGCUWMasterDB.class);
	...
	**/
	...
	// @Constructor
	public LCGCUWMasterDB( Connection tConnection )
	{
		con = tConnection;
	...
	{
		LCGCUWMasterSchema tSchema = this.getSchema();
		...
		else
		{
			...
			tError.moduleName = "LCGCUWMasterDB";
	...
	public boolean getInfo()
	{
		...
		try
		{
			pstmt = con.prepareStatement("SELECT * FROM LCGCUWMaster WHERE  ProposalGrpContNo = ?", 
	...
	public LCGCUWMasterSet query()
	{
		PreparedStatement pstmt = null;
 		ResultSet rs = null;
		LCGCUWMasterSet aLCGCUWMasterSet = new LCGCUWMasterSet();
	  ...
	  if( !mflag ) {
		...
		{
			SQLString sqlObj = new SQLString("LCGCUWMaster");
			LCGCUWMasterSchema aSchema = this.getSchema();
			...
			{
				i++;
				LCGCUWMasterSchema s1 = new LCGCUWMasterSchema();
				s1.setSchema(rs,i);
				aLCGCUWMasterSet.add(s1);
			}
			try{ rs.close(); } catch( Exception ex ) {}
			try{ pstmt.close(); } catch( Exception ex1 ) {}
		}
		...
		return aLCGCUWMasterSet;

	}

	public LCGCUWMasterSet executeQuery(String sql)
	{
		Statement stmt = null;
		ResultSet rs = null;
		LCGCUWMasterSet aLCGCUWMasterSet = new LCGCUWMasterSet();
	...
	public LCGCUWMasterSet query(int nStart, int nCount)
	{
		PreparedStatement pstmt = null;
 		ResultSet rs = null;
		LCGCUWMasterSet aLCGCUWMasterSet = new LCGCUWMasterSet();
	...
	public LCGCUWMasterSet executeQuery(String sql, int nStart, int nCount)
	{
		Statement stmt = null;
		ResultSet rs = null;
		LCGCUWMasterSet aLCGCUWMasterSet = new LCGCUWMasterSet();
	...
	public boolean update(String strWherePart)
	{
	  ...
	  if( !mflag ) {
		...
		try
		{
			...
			String sql = "update LCGCUWMaster " + sqlObj.getUpdPart() + " where " + strWherePart;
...
/**
 * 获取定量数据
 * @return LCGCUWMasterSet
 */
public LCGCUWMasterSet getData()
{
    int tCount = 0;
    LCGCUWMasterSet tLCGCUWMasterSet = new LCGCUWMasterSet();
    LCGCUWMasterSchema tLCGCUWMasterSchema = null;
    if (null == mResultSet)
    {
        CError tError = new CError();
        tError.moduleName = "LCGCUWMasterDB";
    ...
    {
        tCount = 1;
        tLCGCUWMasterSchema = new LCGCUWMasterSchema();
        tLCGCUWMasterSchema.setSchema(mResultSet, 1);
...
public boolean closeData()
{
	...
	public LCGCUWMasterSet executeQuery(SQLwithBindVariables sqlbv) {
	...
	public LCGCUWMasterSet executeQuery(SQLwithBindVariables sqlbv, int nStart, int nCount) {
