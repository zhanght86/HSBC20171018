...
/*
 * <p>ClassName: LCGUWMasterDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 承保流程
 */
public class LCGUWMasterDBSet extends LCGUWMasterSet
{
	// @Field
	...
	**/
	...
	// @Constructor
	public LCGUWMasterDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LCGUWMasterDBSet";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getGrpProposalNo() == null || this.get(i).getGrpProposalNo().equals("null")) {
				...
				pstmt.setString(44, this.get(i).getGrpProposalNo());
			}
