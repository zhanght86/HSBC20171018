...
import com.sinosoft.lis.db.LCGrpContactInfoDB;

/*
 * <p>ClassName: LCGrpContactInfoSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: Physical Data Model 1
 */
public class LCGrpContactInfoSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LCGrpContactInfoSchema.class);
	// @Field
	/** 团体保单号 */
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LCGrpContactInfoSchema cloned = (LCGrpContactInfoSchema)super.clone();
	...
	/**
	* 使用另外一个 LCGrpContactInfoSchema 对象给 Schema 赋值
	* @param: aLCGrpContactInfoSchema LCGrpContactInfoSchema
	**/
	public void setSchema(LCGrpContactInfoSchema aLCGrpContactInfoSchema)
	{
		this.GrpContNo = aLCGrpContactInfoSchema.getGrpContNo();
		this.GrpPropNo = aLCGrpContactInfoSchema.getGrpPropNo();
		this.CustomerNo = aLCGrpContactInfoSchema.getCustomerNo();
		this.Province = aLCGrpContactInfoSchema.getProvince();
		this.City = aLCGrpContactInfoSchema.getCity();
		this.County = aLCGrpContactInfoSchema.getCounty();
		this.Address = aLCGrpContactInfoSchema.getAddress();
		this.ZipCode = aLCGrpContactInfoSchema.getZipCode();
		this.LinkMan1 = aLCGrpContactInfoSchema.getLinkMan1();
		this.Department1 = aLCGrpContactInfoSchema.getDepartment1();
		this.HeadShip1 = aLCGrpContactInfoSchema.getHeadShip1();
		this.MobilePhone1 = aLCGrpContactInfoSchema.getMobilePhone1();
		this.Phone1 = aLCGrpContactInfoSchema.getPhone1();
		this.Fax1 = aLCGrpContactInfoSchema.getFax1();
		this.EMail1 = aLCGrpContactInfoSchema.getEMail1();
		this.MakeOperator = aLCGrpContactInfoSchema.getMakeOperator();
		this.MakeDate = fDate.getDate( aLCGrpContactInfoSchema.getMakeDate());
		this.MakeTime = aLCGrpContactInfoSchema.getMakeTime();
		this.ModifyOperator = aLCGrpContactInfoSchema.getModifyOperator();
		this.ModifyDate = fDate.getDate( aLCGrpContactInfoSchema.getModifyDate());
		this.ModifyTime = aLCGrpContactInfoSchema.getModifyTime();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LCGrpContactInfo表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LCGrpContactInfoSchema";
	...
	public LCGrpContactInfoSchema getSchema()
	{
		LCGrpContactInfoSchema aLCGrpContactInfoSchema = new LCGrpContactInfoSchema();
		aLCGrpContactInfoSchema.setSchema(this);
		return aLCGrpContactInfoSchema;
	}

	public LCGrpContactInfoDB getDB()
	{
		LCGrpContactInfoDB aDBOper = new LCGrpContactInfoDB();
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLCGrpContactInfo>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			LinkMan1 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 9, SysConst.PACKAGESPILTER );
			Department1 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 10, SysConst.PACKAGESPILTER );
			HeadShip1 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 11, SysConst.PACKAGESPILTER );
			MobilePhone1 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 12, SysConst.PACKAGESPILTER );
			Phone1 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 13, SysConst.PACKAGESPILTER );
			Fax1 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 14, SysConst.PACKAGESPILTER );
			EMail1 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 15, SysConst.PACKAGESPILTER );
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LCGrpContactInfoSchema other = (LCGrpContactInfoSchema)otherObject;
		return
