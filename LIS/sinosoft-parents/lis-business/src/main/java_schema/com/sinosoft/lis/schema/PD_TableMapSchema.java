...
import com.sinosoft.lis.db.PD_TableMapDB;

/*
 * <p>ClassName: PD_TableMapSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: PhysicalDataModel_16
 */
public class PD_TableMapSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(PD_TableMapSchema.class);
	// @Field
	/** 表名代码 */
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		PD_TableMapSchema cloned = (PD_TableMapSchema)super.clone();
	...
	public void setTableCode(String aTableCode)
	{
		if(aTableCode!=null && aTableCode.length()>50)
			throw new IllegalArgumentException("表名代码TableCode值"+aTableCode+"的长度"+aTableCode.length()+"大于最大值50");
	...
	public void setCoreTableCode(String aCoreTableCode)
	{
		if(aCoreTableCode!=null && aCoreTableCode.length()>30)
			throw new IllegalArgumentException("核心业务系统表代码CoreTableCode值"+aCoreTableCode+"的长度"+aCoreTableCode.length()+"大于最大值30");
	...
	*/
	...
	public void setIsSame(String aIsSame)
	{
		if(aIsSame!=null && aIsSame.length()>1)
			throw new IllegalArgumentException("是否一致IsSame值"+aIsSame+"的长度"+aIsSame.length()+"大于最大值1");
		IsSame = aIsSame;
	}
	...
	*/
	...
	{
		if(aStandbyflag1!=null && aStandbyflag1.length()>500)
			throw new IllegalArgumentException("Standbyflag1Standbyflag1值"+aStandbyflag1+"的长度"+aStandbyflag1.length()+"大于最大值500");
		Standbyflag1 = aStandbyflag1;
	}
	/**
	* 含义同pd_basetable的Standbyflag2
	*/
	...
	/**
	* 使用另外一个 PD_TableMapSchema 对象给 Schema 赋值
	* @param: aPD_TableMapSchema PD_TableMapSchema
	**/
	public void setSchema(PD_TableMapSchema aPD_TableMapSchema)
	{
		this.TableCode = aPD_TableMapSchema.getTableCode();
		this.CoreTableCode = aPD_TableMapSchema.getCoreTableCode();
		this.IsSame = aPD_TableMapSchema.getIsSame();
		this.Operator = aPD_TableMapSchema.getOperator();
		this.MakeDate = fDate.getDate( aPD_TableMapSchema.getMakeDate());
		this.MakeTime = aPD_TableMapSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aPD_TableMapSchema.getModifyDate());
		this.ModifyTime = aPD_TableMapSchema.getModifyTime();
		this.Standbyflag1 = aPD_TableMapSchema.getStandbyflag1();
		this.Standbyflag2 = aPD_TableMapSchema.getStandbyflag2();
		this.Standbyflag3 = aPD_TableMapSchema.getStandbyflag3();
		this.Standbyflag4 = aPD_TableMapSchema.getStandbyflag4();
		this.Standbyflag5 = aPD_TableMapSchema.getStandbyflag5();
		this.Standbyflag6 = aPD_TableMapSchema.getStandbyflag6();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		try
		{
			...
			if( rs.getString("IsSame") == null )
				this.IsSame = null;
			else
				this.IsSame = rs.getString("IsSame").trim();
		...
		{
			logger.debug("数据库中的PD_TableMap表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "PD_TableMapSchema";
	...
	public PD_TableMapSchema getSchema()
	{
		PD_TableMapSchema aPD_TableMapSchema = new PD_TableMapSchema();
		aPD_TableMapSchema.setSchema(this);
		return aPD_TableMapSchema;
	}

	public PD_TableMapDB getDB()
	{
		PD_TableMapDB aDBOper = new PD_TableMapDB();
	...
	**/
	public String encode()
	{
		...
		strReturn.append(StrTool.cTrim(IsSame)); strReturn.append(SysConst.PACKAGESPILTER);
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpPD_TableMap>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			IsSame = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 3, SysConst.PACKAGESPILTER );
	...
	**/
	public String getV(String FCode)
	{
		...
		if (FCode.equalsIgnoreCase("IsSame"))
		{
			strReturn = StrTool.GBKToUnicode(String.valueOf(IsSame));
		}
	...
	public String getV(int nFieldIndex)
	{
		...
		switch(nFieldIndex) {
			...
			case 1:
				...
				break;
			case 2:
				strFieldValue = StrTool.GBKToUnicode(IsSame);
				break;
			case 3:
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		PD_TableMapSchema other = (PD_TableMapSchema)otherObject;
		return
			TableCode.equals(other.getTableCode())
			&& CoreTableCode.equals(other.getCoreTableCode())
			&& IsSame.equals(other.getIsSame())
