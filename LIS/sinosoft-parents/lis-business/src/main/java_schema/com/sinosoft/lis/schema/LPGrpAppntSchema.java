...
{
private static Logger logger = Logger.getLogger(LPGrpAppntSchema.class);
	// @Field
	/** 批单号 */
	...
	**/
	public void setSchema(LPGrpAppntSchema aLPGrpAppntSchema)
	{
		...
		this.GrpNamePY = aLPGrpAppntSchema.getGrpNamePY();
		this.SearchKeyWord = aLPGrpAppntSchema.getSearchKeyWord();
		this.BusinessCategory = aLPGrpAppntSchema.getBusinessCategory();
		this.BusiCategory = aLPGrpAppntSchema.getBusiCategory();
		this.GrpNature = aLPGrpAppntSchema.getGrpNature();
		this.SumNumPeople = aLPGrpAppntSchema.getSumNumPeople();
		this.MainBusiness = aLPGrpAppntSchema.getMainBusiness();
		this.Corporation = aLPGrpAppntSchema.getCorporation();
		this.CorIDType = aLPGrpAppntSchema.getCorIDType();
		this.CorID = aLPGrpAppntSchema.getCorID();
		this.CorIDExpiryDate = fDate.getDate( aLPGrpAppntSchema.getCorIDExpiryDate());
		this.OnJobNumber = aLPGrpAppntSchema.getOnJobNumber();
		this.RetireNumber = aLPGrpAppntSchema.getRetireNumber();
		this.OtherNumber = aLPGrpAppntSchema.getOtherNumber();
		this.RgtCapital = aLPGrpAppntSchema.getRgtCapital();
		this.TotalAssets = aLPGrpAppntSchema.getTotalAssets();
		this.NetProfitRate = aLPGrpAppntSchema.getNetProfitRate();
		this.Satrap = aLPGrpAppntSchema.getSatrap();
		this.ActuCtrl = aLPGrpAppntSchema.getActuCtrl();
		this.License = aLPGrpAppntSchema.getLicense();
		this.SocialInsuCode = aLPGrpAppntSchema.getSocialInsuCode();
		this.OrganizationCode = aLPGrpAppntSchema.getOrganizationCode();
		this.TaxCode = aLPGrpAppntSchema.getTaxCode();
		this.Fax = aLPGrpAppntSchema.getFax();
		this.EMail = aLPGrpAppntSchema.getEMail();
		this.FoundDate = fDate.getDate( aLPGrpAppntSchema.getFoundDate());
		this.BlacklistFlag = aLPGrpAppntSchema.getBlacklistFlag();
		this.VIPValue = aLPGrpAppntSchema.getVIPValue();
		this.LevelCode = aLPGrpAppntSchema.getLevelCode();
		this.UpCustoemrNo = aLPGrpAppntSchema.getUpCustoemrNo();
		this.Remark = aLPGrpAppntSchema.getRemark();
		this.Segment1 = aLPGrpAppntSchema.getSegment1();
		this.Segment2 = aLPGrpAppntSchema.getSegment2();
		this.Segment3 = aLPGrpAppntSchema.getSegment3();
		this.ManageCom = aLPGrpAppntSchema.getManageCom();
		this.ComCode = aLPGrpAppntSchema.getComCode();
		this.ModifyOperator = aLPGrpAppntSchema.getModifyOperator();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LPGrpAppnt表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			GrpNamePY = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 21, SysConst.PACKAGESPILTER );
			SearchKeyWord = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 22, SysConst.PACKAGESPILTER );
			BusinessCategory = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 23, SysConst.PACKAGESPILTER );
			BusiCategory = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 24, SysConst.PACKAGESPILTER );
			GrpNature = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 25, SysConst.PACKAGESPILTER );
			SumNumPeople= new Integer(ChgData.chgNumericStr(StrTool.getStr(strMessage,26,SysConst.PACKAGESPILTER))).intValue();
			MainBusiness = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 27, SysConst.PACKAGESPILTER );
			Corporation = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 28, SysConst.PACKAGESPILTER );
			CorIDType = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 29, SysConst.PACKAGESPILTER );
			CorID = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 30, SysConst.PACKAGESPILTER );
			CorIDExpiryDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 31,SysConst.PACKAGESPILTER));
			OnJobNumber= new Integer(ChgData.chgNumericStr(StrTool.getStr(strMessage,32,SysConst.PACKAGESPILTER))).intValue();
			RetireNumber= new Integer(ChgData.chgNumericStr(StrTool.getStr(strMessage,33,SysConst.PACKAGESPILTER))).intValue();
			OtherNumber= new Integer(ChgData.chgNumericStr(StrTool.getStr(strMessage,34,SysConst.PACKAGESPILTER))).intValue();
			RgtCapital = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,35,SysConst.PACKAGESPILTER))).doubleValue();
			TotalAssets = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,36,SysConst.PACKAGESPILTER))).doubleValue();
			NetProfitRate = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,37,SysConst.PACKAGESPILTER))).doubleValue();
			Satrap = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 38, SysConst.PACKAGESPILTER );
			ActuCtrl = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 39, SysConst.PACKAGESPILTER );
			License = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 40, SysConst.PACKAGESPILTER );
			SocialInsuCode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 41, SysConst.PACKAGESPILTER );
			OrganizationCode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 42, SysConst.PACKAGESPILTER );
			TaxCode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 43, SysConst.PACKAGESPILTER );
			Fax = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 44, SysConst.PACKAGESPILTER );
			...
			BlacklistFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 47, SysConst.PACKAGESPILTER );
			VIPValue = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 48, SysConst.PACKAGESPILTER );
			LevelCode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 49, SysConst.PACKAGESPILTER );
			UpCustoemrNo = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 50, SysConst.PACKAGESPILTER );
			Remark = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 51, SysConst.PACKAGESPILTER );
			Segment1 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 52, SysConst.PACKAGESPILTER );
			Segment2 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 53, SysConst.PACKAGESPILTER );
			Segment3 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 54, SysConst.PACKAGESPILTER );
			ManageCom = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 55, SysConst.PACKAGESPILTER );
			ComCode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 56, SysConst.PACKAGESPILTER );
			ModifyOperator = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 57, SysConst.PACKAGESPILTER );
		}
