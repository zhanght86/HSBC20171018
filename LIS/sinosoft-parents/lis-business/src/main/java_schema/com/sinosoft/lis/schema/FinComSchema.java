...
import com.sinosoft.lis.db.FinComDB;

/*
 * <p>ClassName: FinComSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: Physical Data Model 1
 */
public class FinComSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(FinComSchema.class);
	// @Field
	/** 财务机构编码 */
	private String FinComCode;
	/** 财务机构名称 */
	private String FinComName;
	/** 备用字段1 */
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		FinComSchema cloned = (FinComSchema)super.clone();
	...
	public String getFinComName()
	{
		return FinComName;
	}
	public void setFinComName(String aFinComName)
	{
		if(aFinComName!=null && aFinComName.length()>300)
			throw new IllegalArgumentException("财务机构名称FinComName值"+aFinComName+"的长度"+aFinComName.length()+"大于最大值300");
		FinComName = aFinComName;
	}
	...
	/**
	* 使用另外一个 FinComSchema 对象给 Schema 赋值
	* @param: aFinComSchema FinComSchema
	**/
	public void setSchema(FinComSchema aFinComSchema)
	{
		this.FinComCode = aFinComSchema.getFinComCode();
		this.FinComName = aFinComSchema.getFinComName();
		this.Segment1 = aFinComSchema.getSegment1();
		this.Segment2 = aFinComSchema.getSegment2();
		this.Segment3 = aFinComSchema.getSegment3();
		this.MakeOperator = aFinComSchema.getMakeOperator();
		this.MakeDate = fDate.getDate( aFinComSchema.getMakeDate());
		this.MakeTime = aFinComSchema.getMakeTime();
		this.ModifyOperator = aFinComSchema.getModifyOperator();
		this.ModifyDate = fDate.getDate( aFinComSchema.getModifyDate());
		this.ModifyTime = aFinComSchema.getModifyTime();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		try
		{
			...
			if( rs.getString("FinComName") == null )
				this.FinComName = null;
			else
				this.FinComName = rs.getString("FinComName").trim();
		...
		{
			logger.debug("数据库中的FinCom表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "FinComSchema";
	...
	public FinComSchema getSchema()
	{
		FinComSchema aFinComSchema = new FinComSchema();
		aFinComSchema.setSchema(this);
		return aFinComSchema;
	}

	public FinComDB getDB()
	{
		FinComDB aDBOper = new FinComDB();
	...
	**/
	public String encode()
	{
		...
		strReturn.append(StrTool.cTrim(FinComName)); strReturn.append(SysConst.PACKAGESPILTER);
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpFinCom>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			FinComCode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 1, SysConst.PACKAGESPILTER );
			FinComName = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 2, SysConst.PACKAGESPILTER );
			Segment1 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 3, SysConst.PACKAGESPILTER );
			Segment2 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 4, SysConst.PACKAGESPILTER );
			Segment3 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 5, SysConst.PACKAGESPILTER );
	...
	**/
	public String getV(String FCode)
	{
		...
		if (FCode.equalsIgnoreCase("FinComName"))
		{
			strReturn = StrTool.GBKToUnicode(String.valueOf(FinComName));
		}
	...
	public String getV(int nFieldIndex)
	{
		...
		switch(nFieldIndex) {
			case 0:
				...
				break;
			case 1:
				strFieldValue = StrTool.GBKToUnicode(FinComName);
				break;
			case 2:
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		FinComSchema other = (FinComSchema)otherObject;
		return
			FinComCode.equals(other.getFinComCode())
			&& FinComName.equals(other.getFinComName())
	...
	**/
	public int getFieldIndex(String strFieldName)
	{
		...
		if( strFieldName.equals("FinComName") ) {
			return 1;
		}
