...
/*
 * <p>ClassName: LBCustomerImpartDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 寿险业务系统未整理模型
 */
public class LBCustomerImpartDBSet extends LBCustomerImpartSet
{
private static Logger logger = Logger.getLogger(LBCustomerImpartDBSet.class);
	...
	**/
	...
	// @Constructor
	public LBCustomerImpartDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LBCustomerImpartDBSet";
	...
	public boolean delete()
	{
		...
		try
		{
			...
			if(this.get(i).getCustomerNoType() == null || this.get(i).getCustomerNoType().equals("null")) {
				...
				pstmt.setString(6, StrTool.space1(this.get(i).getCustomerNoType(), 1));
			}
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getImpartContent() == null || this.get(i).getImpartContent().equals("null")) {
				...
				pstmt.setString(8, this.get(i).getImpartContent());
			}
			if(this.get(i).getImpartParamModle() == null || this.get(i).getImpartParamModle().equals("null")) {
				pstmt.setString(9,null);
			} else {
				pstmt.setString(9, this.get(i).getImpartParamModle());
			}
			if(this.get(i).getCustomerNo() == null || this.get(i).getCustomerNo().equals("null")) {
			...
			if(this.get(i).getCustomerNoType() == null || this.get(i).getCustomerNoType().equals("null")) {
				...
				pstmt.setString(11, this.get(i).getCustomerNoType());
			}
			if(this.get(i).getUWClaimFlg() == null || this.get(i).getUWClaimFlg().equals("null")) {
				pstmt.setString(12,null);
			} else {
				pstmt.setString(12, this.get(i).getUWClaimFlg());
			}
