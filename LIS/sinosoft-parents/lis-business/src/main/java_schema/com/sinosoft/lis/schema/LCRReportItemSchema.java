...
/*
 * <p>ClassName: LCRReportItemSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 承保流程
 */
public class LCRReportItemSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LCRReportItemSchema.class);
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LCRReportItemSchema cloned = (LCRReportItemSchema)super.clone();
	...
	/**
	* 使用另外一个 LCRReportItemSchema 对象给 Schema 赋值
	* @param: aLCRReportItemSchema LCRReportItemSchema
	**/
	public void setSchema(LCRReportItemSchema aLCRReportItemSchema)
	{
		this.GrpContNo = aLCRReportItemSchema.getGrpContNo();
		this.ContNo = aLCRReportItemSchema.getContNo();
		this.ProposalContNo = aLCRReportItemSchema.getProposalContNo();
		this.PrtSeq = aLCRReportItemSchema.getPrtSeq();
		this.RReportItemCode = aLCRReportItemSchema.getRReportItemCode();
		this.RReportItemName = aLCRReportItemSchema.getRReportItemName();
		this.ModifyDate = fDate.getDate( aLCRReportItemSchema.getModifyDate());
		this.ModifyTime = aLCRReportItemSchema.getModifyTime();
		this.Remark = aLCRReportItemSchema.getRemark();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LCRReportItem表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LCRReportItemSchema";
	...
	public LCRReportItemSchema getSchema()
	{
		LCRReportItemSchema aLCRReportItemSchema = new LCRReportItemSchema();
		aLCRReportItemSchema.setSchema(this);
		return aLCRReportItemSchema;
	}

	public LCRReportItemDB getDB()
	{
		LCRReportItemDB aDBOper = new LCRReportItemDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLCRReportItem描述/A>表字段
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLCRReportItem>历史记账凭证主表信息</A>表字段
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LCRReportItemSchema other = (LCRReportItemSchema)otherObject;
		return
