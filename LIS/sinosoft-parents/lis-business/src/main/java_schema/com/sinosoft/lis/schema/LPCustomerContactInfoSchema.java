...
import com.sinosoft.lis.db.LPCustomerContactInfoDB;

/*
 * <p>ClassName: LPCustomerContactInfoSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: Physical Data Model 1
 */
public class LPCustomerContactInfoSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LPCustomerContactInfoSchema.class);
	// @Field
	/** 保全批单号 */
	...
	// @Constructor
	public LPCustomerContactInfoSchema()
	{
		mErrors = new CErrors();
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LPCustomerContactInfoSchema cloned = (LPCustomerContactInfoSchema)super.clone();
	...
	/**
	* 使用另外一个 LPCustomerContactInfoSchema 对象给 Schema 赋值
	* @param: aLPCustomerContactInfoSchema LPCustomerContactInfoSchema
	**/
	public void setSchema(LPCustomerContactInfoSchema aLPCustomerContactInfoSchema)
	{
		this.EdorNo = aLPCustomerContactInfoSchema.getEdorNo();
		this.EdorType = aLPCustomerContactInfoSchema.getEdorType();
		this.PolicyNo = aLPCustomerContactInfoSchema.getPolicyNo();
		this.PropNo = aLPCustomerContactInfoSchema.getPropNo();
		this.ContNo = aLPCustomerContactInfoSchema.getContNo();
		this.CustomerNo = aLPCustomerContactInfoSchema.getCustomerNo();
		this.Province = aLPCustomerContactInfoSchema.getProvince();
		this.City = aLPCustomerContactInfoSchema.getCity();
		this.County = aLPCustomerContactInfoSchema.getCounty();
		this.PostalAddress = aLPCustomerContactInfoSchema.getPostalAddress();
		this.ZipCode = aLPCustomerContactInfoSchema.getZipCode();
		this.Phone = aLPCustomerContactInfoSchema.getPhone();
		this.Fax = aLPCustomerContactInfoSchema.getFax();
		this.HomeAddress = aLPCustomerContactInfoSchema.getHomeAddress();
		this.HomeZipCode = aLPCustomerContactInfoSchema.getHomeZipCode();
		this.HomePhone = aLPCustomerContactInfoSchema.getHomePhone();
		this.HomeFax = aLPCustomerContactInfoSchema.getHomeFax();
		this.CompanyName = aLPCustomerContactInfoSchema.getCompanyName();
		this.CompanyAddress = aLPCustomerContactInfoSchema.getCompanyAddress();
		this.CompanyZipCode = aLPCustomerContactInfoSchema.getCompanyZipCode();
		this.CompanyPhone = aLPCustomerContactInfoSchema.getCompanyPhone();
		this.CompanyFax = aLPCustomerContactInfoSchema.getCompanyFax();
		this.Mobile1 = aLPCustomerContactInfoSchema.getMobile1();
		this.EMail1 = aLPCustomerContactInfoSchema.getEMail1();
		this.QQ1 = aLPCustomerContactInfoSchema.getQQ1();
		this.MSN1 = aLPCustomerContactInfoSchema.getMSN1();
		this.Wechat1 = aLPCustomerContactInfoSchema.getWechat1();
		this.Mobile2 = aLPCustomerContactInfoSchema.getMobile2();
		this.EMail2 = aLPCustomerContactInfoSchema.getEMail2();
		this.QQ2 = aLPCustomerContactInfoSchema.getQQ2();
		this.MSN2 = aLPCustomerContactInfoSchema.getMSN2();
		this.Wechat2 = aLPCustomerContactInfoSchema.getWechat2();
		this.MakeOperator = aLPCustomerContactInfoSchema.getMakeOperator();
		this.MakeDate = fDate.getDate( aLPCustomerContactInfoSchema.getMakeDate());
		this.MakeTime = aLPCustomerContactInfoSchema.getMakeTime();
		this.ModifyOperator = aLPCustomerContactInfoSchema.getModifyOperator();
		this.ModifyDate = fDate.getDate( aLPCustomerContactInfoSchema.getModifyDate());
		this.ModifyTime = aLPCustomerContactInfoSchema.getModifyTime();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LPCustomerContactInfo表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LPCustomerContactInfoSchema";
	...
	public LPCustomerContactInfoSchema getSchema()
	{
		LPCustomerContactInfoSchema aLPCustomerContactInfoSchema = new LPCustomerContactInfoSchema();
		aLPCustomerContactInfoSchema.setSchema(this);
		return aLPCustomerContactInfoSchema;
	}

	public LPCustomerContactInfoDB getDB()
	{
		LPCustomerContactInfoDB aDBOper = new LPCustomerContactInfoDB();
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLPCustomerContactInfo>历史记账凭证主表信息</A>表字段
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LPCustomerContactInfoSchema other = (LPCustomerContactInfoSchema)otherObject;
		return
