...
/*
 * <p>ClassName: LBPOInsuredDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 内部外包流程
 */
public class LBPOInsuredDBSet extends LBPOInsuredSet
{
private static Logger logger = Logger.getLogger(LBPOInsuredDBSet.class);
	...
	**/
	...
	// @Constructor
	public LBPOInsuredDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LBPOInsuredDBSet";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getMarriageDate() == null || this.get(i).getMarriageDate().equals("null")) {
				...
				pstmt.setString(24, this.get(i).getMarriageDate());
			}
			...
			if(this.get(i).getStature() == null || this.get(i).getStature().equals("null")) {
				...
				pstmt.setString(26, this.get(i).getStature());
			}
			if(this.get(i).getAvoirdupois() == null || this.get(i).getAvoirdupois().equals("null")) {
				pstmt.setString(27,null);
			} else {
				pstmt.setString(27, this.get(i).getAvoirdupois());
			}
			...
			if(this.get(i).getSalary() == null || this.get(i).getSalary().equals("null")) {
				...
				pstmt.setString(35, this.get(i).getSalary());
			}
			...
			if(this.get(i).getStartWorkDate() == null || this.get(i).getStartWorkDate().equals("null")) {
				...
				pstmt.setString(37, this.get(i).getStartWorkDate());
			}
			...
			if(this.get(i).getUWDate() == null || this.get(i).getUWDate().equals("null")) {
				...
				pstmt.setString(51, this.get(i).getUWDate());
			}
			...
			if(this.get(i).getBMI() == null || this.get(i).getBMI().equals("null")) {
				...
				pstmt.setString(53, this.get(i).getBMI());
			}
			if(this.get(i).getInsuredPeoples() == null || this.get(i).getInsuredPeoples().equals("null")) {
				pstmt.setString(54,null);
			} else {
				pstmt.setString(54, this.get(i).getInsuredPeoples());
			}
			...
			if(this.get(i).getCustomerSeqNo() == null || this.get(i).getCustomerSeqNo().equals("null")) {
				...
				pstmt.setString(57, this.get(i).getCustomerSeqNo());
			}
			...
			if(this.get(i).getSignName() == null || this.get(i).getSignName().equals("null")) {
				...
				pstmt.setString(59, this.get(i).getSignName());
			}
