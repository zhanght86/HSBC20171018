...
/*
 * <p>ClassName: LDPlanRiskDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 基础信息
 */
public class LDPlanRiskDBSet extends LDPlanRiskSet
{
private static Logger logger = Logger.getLogger(LDPlanRiskDBSet.class);
	...
	**/
	...
	// @Constructor
	public LDPlanRiskDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LDPlanRiskDBSet";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getPlanType() == null || this.get(i).getPlanType().equals("null")) {
				...
				pstmt.setString(13, this.get(i).getPlanType());
			}
			if(this.get(i).getPortfolioFlag() == null || this.get(i).getPortfolioFlag().equals("null")) {
				pstmt.setString(14,null);
			} else {
				pstmt.setString(14, this.get(i).getPortfolioFlag());
			}
			// set where condition
			if(this.get(i).getMainRiskCode() == null || this.get(i).getMainRiskCode().equals("null")) {
				pstmt.setString(15,null);
			} else {
				pstmt.setString(15, this.get(i).getMainRiskCode());
			}
			if(this.get(i).getRiskCode() == null || this.get(i).getRiskCode().equals("null")) {
			...
			if(this.get(i).getContPlanCode() == null || this.get(i).getContPlanCode().equals("null")) {
				...
				pstmt.setString(17, this.get(i).getContPlanCode());
			}
			if(this.get(i).getPlanType() == null || this.get(i).getPlanType().equals("null")) {
				pstmt.setString(18,null);
			} else {
				pstmt.setString(18, StrTool.space1(this.get(i).getPlanType(), 1));
			}
