...
/*
 * <p>ClassName: LSQuotOfferPlanDetailDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: Physical Data Model 1
 */
public class LSQuotOfferPlanDetailDBSet extends LSQuotOfferPlanDetailSet
{
	// @Field
	...
	**/
	...
	// @Constructor
	public LSQuotOfferPlanDetailDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public LSQuotOfferPlanDetailDBSet()
	{
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LSQuotOfferPlanDetailDBSet";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getOfferListNo() == null || this.get(i).getOfferListNo().equals("null")) {
				...
				pstmt.setString(26, this.get(i).getOfferListNo());
			}
			if(this.get(i).getSysPlanCode() == null || this.get(i).getSysPlanCode().equals("null")) {
