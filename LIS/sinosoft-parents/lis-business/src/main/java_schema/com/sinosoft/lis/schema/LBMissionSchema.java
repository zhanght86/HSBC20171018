...
/*
 * <p>ClassName: LBMissionSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 工作流模型
 */
public class LBMissionSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LBMissionSchema.class);
	// @Field
	/** 流水号 */
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LBMissionSchema cloned = (LBMissionSchema)super.clone();
	...
	public void setSerialNo(String aSerialNo)
	{
		if(aSerialNo!=null && aSerialNo.length()>10)
			throw new IllegalArgumentException("流水号SerialNo值"+aSerialNo+"的长度"+aSerialNo.length()+"大于最大值10");
		SerialNo = aSerialNo;
	}
	...
	*/
	...
	/**
	* 使用另外一个 LBMissionSchema 对象给 Schema 赋值
	* @param: aLBMissionSchema LBMissionSchema
	**/
	public void setSchema(LBMissionSchema aLBMissionSchema)
	{
		this.SerialNo = aLBMissionSchema.getSerialNo();
		this.MissionID = aLBMissionSchema.getMissionID();
		this.SubMissionID = aLBMissionSchema.getSubMissionID();
		this.ProcessID = aLBMissionSchema.getProcessID();
		this.ActivityID = aLBMissionSchema.getActivityID();
		this.ActivityStatus = aLBMissionSchema.getActivityStatus();
		this.MissionProp1 = aLBMissionSchema.getMissionProp1();
		this.MissionProp2 = aLBMissionSchema.getMissionProp2();
		this.MissionProp3 = aLBMissionSchema.getMissionProp3();
		this.MissionProp4 = aLBMissionSchema.getMissionProp4();
		this.MissionProp5 = aLBMissionSchema.getMissionProp5();
		this.MissionProp6 = aLBMissionSchema.getMissionProp6();
		this.MissionProp7 = aLBMissionSchema.getMissionProp7();
		this.MissionProp8 = aLBMissionSchema.getMissionProp8();
		this.MissionProp9 = aLBMissionSchema.getMissionProp9();
		this.MissionProp10 = aLBMissionSchema.getMissionProp10();
		this.MissionProp11 = aLBMissionSchema.getMissionProp11();
		this.MissionProp12 = aLBMissionSchema.getMissionProp12();
		this.MissionProp13 = aLBMissionSchema.getMissionProp13();
		this.MissionProp14 = aLBMissionSchema.getMissionProp14();
		this.MissionProp15 = aLBMissionSchema.getMissionProp15();
		this.MissionProp16 = aLBMissionSchema.getMissionProp16();
		this.MissionProp17 = aLBMissionSchema.getMissionProp17();
		this.MissionProp18 = aLBMissionSchema.getMissionProp18();
		this.MissionProp19 = aLBMissionSchema.getMissionProp19();
		this.MissionProp20 = aLBMissionSchema.getMissionProp20();
		this.DefaultOperator = aLBMissionSchema.getDefaultOperator();
		this.LastOperator = aLBMissionSchema.getLastOperator();
		this.CreateOperator = aLBMissionSchema.getCreateOperator();
		this.MakeDate = fDate.getDate( aLBMissionSchema.getMakeDate());
		this.MakeTime = aLBMissionSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLBMissionSchema.getModifyDate());
		this.ModifyTime = aLBMissionSchema.getModifyTime();
		this.InDate = fDate.getDate( aLBMissionSchema.getInDate());
		this.InTime = aLBMissionSchema.getInTime();
		this.OutDate = fDate.getDate( aLBMissionSchema.getOutDate());
		this.OutTime = aLBMissionSchema.getOutTime();
		this.MissionProp21 = aLBMissionSchema.getMissionProp21();
		this.MissionProp22 = aLBMissionSchema.getMissionProp22();
		this.MissionProp23 = aLBMissionSchema.getMissionProp23();
		this.MissionProp24 = aLBMissionSchema.getMissionProp24();
		this.MissionProp25 = aLBMissionSchema.getMissionProp25();
		this.TimeID = aLBMissionSchema.getTimeID();
		this.StandEndDate = fDate.getDate( aLBMissionSchema.getStandEndDate());
		this.StandEndTime = aLBMissionSchema.getStandEndTime();
		this.OperateCom = aLBMissionSchema.getOperateCom();
		this.MainMissionID = aLBMissionSchema.getMainMissionID();
		this.SQLPriorityID = aLBMissionSchema.getSQLPriorityID();
		this.PriorityID = aLBMissionSchema.getPriorityID();
		this.VERSION = aLBMissionSchema.getVERSION();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LBMission表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LBMissionSchema";
	...
	public LBMissionSchema getSchema()
	{
		LBMissionSchema aLBMissionSchema = new LBMissionSchema();
		aLBMissionSchema.setSchema(this);
		return aLBMissionSchema;
	}

	public LBMissionDB getDB()
	{
		LBMissionDB aDBOper = new LBMissionDB();
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLBMission>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			MissionID = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 2, SysConst.PACKAGESPILTER );
			SubMissionID = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 3, SysConst.PACKAGESPILTER );
			...
			ActivityStatus = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 6, SysConst.PACKAGESPILTER );
			MissionProp1 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 7, SysConst.PACKAGESPILTER );
			MissionProp2 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 8, SysConst.PACKAGESPILTER );
			MissionProp3 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 9, SysConst.PACKAGESPILTER );
			MissionProp4 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 10, SysConst.PACKAGESPILTER );
			MissionProp5 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 11, SysConst.PACKAGESPILTER );
			MissionProp6 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 12, SysConst.PACKAGESPILTER );
			MissionProp7 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 13, SysConst.PACKAGESPILTER );
			MissionProp8 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 14, SysConst.PACKAGESPILTER );
			MissionProp9 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 15, SysConst.PACKAGESPILTER );
			MissionProp10 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 16, SysConst.PACKAGESPILTER );
			MissionProp11 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 17, SysConst.PACKAGESPILTER );
			MissionProp12 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 18, SysConst.PACKAGESPILTER );
			MissionProp13 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 19, SysConst.PACKAGESPILTER );
			MissionProp14 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 20, SysConst.PACKAGESPILTER );
			MissionProp15 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 21, SysConst.PACKAGESPILTER );
			MissionProp16 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 22, SysConst.PACKAGESPILTER );
			MissionProp17 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 23, SysConst.PACKAGESPILTER );
			MissionProp18 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 24, SysConst.PACKAGESPILTER );
			MissionProp19 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 25, SysConst.PACKAGESPILTER );
			MissionProp20 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 26, SysConst.PACKAGESPILTER );
			DefaultOperator = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 27, SysConst.PACKAGESPILTER );
			LastOperator = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 28, SysConst.PACKAGESPILTER );
			CreateOperator = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 29, SysConst.PACKAGESPILTER );
			...
			InDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 34,SysConst.PACKAGESPILTER));
			InTime = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 35, SysConst.PACKAGESPILTER );
			OutDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 36,SysConst.PACKAGESPILTER));
			OutTime = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 37, SysConst.PACKAGESPILTER );
			MissionProp21 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 38, SysConst.PACKAGESPILTER );
			MissionProp22 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 39, SysConst.PACKAGESPILTER );
			MissionProp23 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 40, SysConst.PACKAGESPILTER );
			MissionProp24 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 41, SysConst.PACKAGESPILTER );
			MissionProp25 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 42, SysConst.PACKAGESPILTER );
			TimeID = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 43, SysConst.PACKAGESPILTER );
			StandEndDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 44,SysConst.PACKAGESPILTER));
			StandEndTime = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 45, SysConst.PACKAGESPILTER );
			OperateCom = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 46, SysConst.PACKAGESPILTER );
			MainMissionID = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 47, SysConst.PACKAGESPILTER );
			SQLPriorityID = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 48, SysConst.PACKAGESPILTER );
			PriorityID = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 49, SysConst.PACKAGESPILTER );
			VERSION = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 50, SysConst.PACKAGESPILTER );
		}
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LBMissionSchema other = (LBMissionSchema)otherObject;
		return
