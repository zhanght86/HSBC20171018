...
/*
 * <p>ClassName: LBPOInsuredSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 内部外包流程
 */
public class LBPOInsuredSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LBPOInsuredSchema.class);
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LBPOInsuredSchema cloned = (LBPOInsuredSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LBPOInsuredSchema 对象给 Schema 赋值
	* @param: aLBPOInsuredSchema LBPOInsuredSchema
	**/
	public void setSchema(LBPOInsuredSchema aLBPOInsuredSchema)
	{
		this.GrpContNo = aLBPOInsuredSchema.getGrpContNo();
		this.ContNo = aLBPOInsuredSchema.getContNo();
		this.InputNo = aLBPOInsuredSchema.getInputNo();
		this.FillNo = aLBPOInsuredSchema.getFillNo();
		this.InsuredNo = aLBPOInsuredSchema.getInsuredNo();
		this.PrtNo = aLBPOInsuredSchema.getPrtNo();
		this.AppntNo = aLBPOInsuredSchema.getAppntNo();
		this.ManageCom = aLBPOInsuredSchema.getManageCom();
		this.ExecuteCom = aLBPOInsuredSchema.getExecuteCom();
		this.FamilyID = aLBPOInsuredSchema.getFamilyID();
		this.RelationToMainInsured = aLBPOInsuredSchema.getRelationToMainInsured();
		this.RelationToAppnt = aLBPOInsuredSchema.getRelationToAppnt();
		this.AddressNo = aLBPOInsuredSchema.getAddressNo();
		this.SequenceNo = aLBPOInsuredSchema.getSequenceNo();
		this.Name = aLBPOInsuredSchema.getName();
		this.Sex = aLBPOInsuredSchema.getSex();
		this.Birthday = aLBPOInsuredSchema.getBirthday();
		this.IDType = aLBPOInsuredSchema.getIDType();
		this.IDNo = aLBPOInsuredSchema.getIDNo();
		this.NativePlace = aLBPOInsuredSchema.getNativePlace();
		this.Nationality = aLBPOInsuredSchema.getNationality();
		this.RgtAddress = aLBPOInsuredSchema.getRgtAddress();
		this.Marriage = aLBPOInsuredSchema.getMarriage();
		this.MarriageDate = aLBPOInsuredSchema.getMarriageDate();
		this.Health = aLBPOInsuredSchema.getHealth();
		this.Stature = aLBPOInsuredSchema.getStature();
		this.Avoirdupois = aLBPOInsuredSchema.getAvoirdupois();
		this.Degree = aLBPOInsuredSchema.getDegree();
		this.CreditGrade = aLBPOInsuredSchema.getCreditGrade();
		this.BankCode = aLBPOInsuredSchema.getBankCode();
		this.BankAccNo = aLBPOInsuredSchema.getBankAccNo();
		this.AccName = aLBPOInsuredSchema.getAccName();
		this.JoinCompanyDate = aLBPOInsuredSchema.getJoinCompanyDate();
		this.Position = aLBPOInsuredSchema.getPosition();
		this.Salary = aLBPOInsuredSchema.getSalary();
		this.OccupationType = aLBPOInsuredSchema.getOccupationType();
		this.StartWorkDate = aLBPOInsuredSchema.getStartWorkDate();
		this.OccupationCode = aLBPOInsuredSchema.getOccupationCode();
		this.WorkType = aLBPOInsuredSchema.getWorkType();
		this.PluralityType = aLBPOInsuredSchema.getPluralityType();
		this.SmokeFlag = aLBPOInsuredSchema.getSmokeFlag();
		this.ContPlanCode = aLBPOInsuredSchema.getContPlanCode();
		this.Operator = aLBPOInsuredSchema.getOperator();
		this.InsuredStat = aLBPOInsuredSchema.getInsuredStat();
		this.MakeDate = aLBPOInsuredSchema.getMakeDate();
		this.MakeTime = aLBPOInsuredSchema.getMakeTime();
		this.ModifyDate = aLBPOInsuredSchema.getModifyDate();
		this.ModifyTime = aLBPOInsuredSchema.getModifyTime();
		this.UWFlag = aLBPOInsuredSchema.getUWFlag();
		this.UWCode = aLBPOInsuredSchema.getUWCode();
		this.UWDate = aLBPOInsuredSchema.getUWDate();
		this.UWTime = aLBPOInsuredSchema.getUWTime();
		this.BMI = aLBPOInsuredSchema.getBMI();
		this.InsuredPeoples = aLBPOInsuredSchema.getInsuredPeoples();
		this.License = aLBPOInsuredSchema.getLicense();
		this.LicenseType = aLBPOInsuredSchema.getLicenseType();
		this.CustomerSeqNo = aLBPOInsuredSchema.getCustomerSeqNo();
		this.SocialInsuNo = aLBPOInsuredSchema.getSocialInsuNo();
		this.SignName = aLBPOInsuredSchema.getSignName();
		this.EMail = aLBPOInsuredSchema.getEMail();
		this.Mobile = aLBPOInsuredSchema.getMobile();
		this.CompanyFax = aLBPOInsuredSchema.getCompanyFax();
		this.CompanyPhone = aLBPOInsuredSchema.getCompanyPhone();
		this.CompanyZipCode = aLBPOInsuredSchema.getCompanyZipCode();
		this.CompanyAddress = aLBPOInsuredSchema.getCompanyAddress();
		this.HomeFax = aLBPOInsuredSchema.getHomeFax();
		this.HomePhone = aLBPOInsuredSchema.getHomePhone();
		this.HomeZipCode = aLBPOInsuredSchema.getHomeZipCode();
		this.HomeAddress = aLBPOInsuredSchema.getHomeAddress();
		this.Fax = aLBPOInsuredSchema.getFax();
		this.Phone = aLBPOInsuredSchema.getPhone();
		this.ZipCode = aLBPOInsuredSchema.getZipCode();
		this.PostalAddress = aLBPOInsuredSchema.getPostalAddress();
		this.SocialInsuFlag = aLBPOInsuredSchema.getSocialInsuFlag();
		this.IDExpDate = aLBPOInsuredSchema.getIDExpDate();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LBPOInsured表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LBPOInsuredSchema";
	...
	public LBPOInsuredSchema getSchema()
	{
		LBPOInsuredSchema aLBPOInsuredSchema = new LBPOInsuredSchema();
		aLBPOInsuredSchema.setSchema(this);
		return aLBPOInsuredSchema;
	}

	public LBPOInsuredDB getDB()
	{
		LBPOInsuredDB aDBOper = new LBPOInsuredDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLBPOInsured描述/A>表字段
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLBPOInsured>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			MarriageDate = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 24, SysConst.PACKAGESPILTER );
			Health = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 25, SysConst.PACKAGESPILTER );
			Stature = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 26, SysConst.PACKAGESPILTER );
			Avoirdupois = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 27, SysConst.PACKAGESPILTER );
			...
			Salary = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 35, SysConst.PACKAGESPILTER );
			OccupationType = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 36, SysConst.PACKAGESPILTER );
			StartWorkDate = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 37, SysConst.PACKAGESPILTER );
			...
			MakeDate = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 45, SysConst.PACKAGESPILTER );
			MakeTime = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 46, SysConst.PACKAGESPILTER );
			ModifyDate = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 47, SysConst.PACKAGESPILTER );
			...
			UWDate = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 51, SysConst.PACKAGESPILTER );
			UWTime = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 52, SysConst.PACKAGESPILTER );
			BMI = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 53, SysConst.PACKAGESPILTER );
			InsuredPeoples = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 54, SysConst.PACKAGESPILTER );
			...
			CustomerSeqNo = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 57, SysConst.PACKAGESPILTER );
			SocialInsuNo = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 58, SysConst.PACKAGESPILTER );
			SignName = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 59, SysConst.PACKAGESPILTER );
			...
			CompanyFax = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 62, SysConst.PACKAGESPILTER );
			CompanyPhone = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 63, SysConst.PACKAGESPILTER );
			CompanyZipCode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 64, SysConst.PACKAGESPILTER );
			CompanyAddress = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 65, SysConst.PACKAGESPILTER );
			HomeFax = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 66, SysConst.PACKAGESPILTER );
			HomePhone = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 67, SysConst.PACKAGESPILTER );
			HomeZipCode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 68, SysConst.PACKAGESPILTER );
			HomeAddress = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 69, SysConst.PACKAGESPILTER );
			Fax = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 70, SysConst.PACKAGESPILTER );
			Phone = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 71, SysConst.PACKAGESPILTER );
			ZipCode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 72, SysConst.PACKAGESPILTER );
			PostalAddress = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 73, SysConst.PACKAGESPILTER );
			SocialInsuFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 74, SysConst.PACKAGESPILTER );
			IDExpDate = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 75, SysConst.PACKAGESPILTER );
		}
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LBPOInsuredSchema other = (LBPOInsuredSchema)otherObject;
		return
