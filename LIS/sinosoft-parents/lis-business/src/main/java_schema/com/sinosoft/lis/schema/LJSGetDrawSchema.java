...
/*
 * <p>ClassName: LJSGetDrawSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 寿险业务付费
 */
public class LJSGetDrawSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LJSGetDrawSchema.class);
	// @Field
	/** 给付通知书号码 */
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LJSGetDrawSchema cloned = (LJSGetDrawSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LJSGetDrawSchema 对象给 Schema 赋值
	* @param: aLJSGetDrawSchema LJSGetDrawSchema
	**/
	public void setSchema(LJSGetDrawSchema aLJSGetDrawSchema)
	{
		this.GetNoticeNo = aLJSGetDrawSchema.getGetNoticeNo();
		this.PolNo = aLJSGetDrawSchema.getPolNo();
		this.DutyCode = aLJSGetDrawSchema.getDutyCode();
		this.GetDutyKind = aLJSGetDrawSchema.getGetDutyKind();
		this.GetDutyCode = aLJSGetDrawSchema.getGetDutyCode();
		this.GrpPolNo = aLJSGetDrawSchema.getGrpPolNo();
		this.GrpContNo = aLJSGetDrawSchema.getGrpContNo();
		this.ContNo = aLJSGetDrawSchema.getContNo();
		this.AppntNo = aLJSGetDrawSchema.getAppntNo();
		this.InsuredNo = aLJSGetDrawSchema.getInsuredNo();
		this.GetDate = fDate.getDate( aLJSGetDrawSchema.getGetDate());
		this.GetMoney = aLJSGetDrawSchema.getGetMoney();
		this.EnterAccDate = fDate.getDate( aLJSGetDrawSchema.getEnterAccDate());
		this.ConfDate = fDate.getDate( aLJSGetDrawSchema.getConfDate());
		this.FeeOperationType = aLJSGetDrawSchema.getFeeOperationType();
		this.FeeFinaType = aLJSGetDrawSchema.getFeeFinaType();
		this.KindCode = aLJSGetDrawSchema.getKindCode();
		this.RiskCode = aLJSGetDrawSchema.getRiskCode();
		this.RiskVersion = aLJSGetDrawSchema.getRiskVersion();
		this.ManageCom = aLJSGetDrawSchema.getManageCom();
		this.AgentCom = aLJSGetDrawSchema.getAgentCom();
		this.AgentType = aLJSGetDrawSchema.getAgentType();
		this.AgentCode = aLJSGetDrawSchema.getAgentCode();
		this.AgentGroup = aLJSGetDrawSchema.getAgentGroup();
		this.GrpName = aLJSGetDrawSchema.getGrpName();
		this.Handler = aLJSGetDrawSchema.getHandler();
		this.LastGettoDate = fDate.getDate( aLJSGetDrawSchema.getLastGettoDate());
		this.CurGetToDate = fDate.getDate( aLJSGetDrawSchema.getCurGetToDate());
		this.GetFirstFlag = aLJSGetDrawSchema.getGetFirstFlag();
		this.GetChannelFlag = aLJSGetDrawSchema.getGetChannelFlag();
		this.DestrayFlag = aLJSGetDrawSchema.getDestrayFlag();
		this.PolType = aLJSGetDrawSchema.getPolType();
		this.ApproveCode = aLJSGetDrawSchema.getApproveCode();
		this.ApproveDate = fDate.getDate( aLJSGetDrawSchema.getApproveDate());
		this.ApproveTime = aLJSGetDrawSchema.getApproveTime();
		this.SerialNo = aLJSGetDrawSchema.getSerialNo();
		this.Operator = aLJSGetDrawSchema.getOperator();
		this.MakeDate = fDate.getDate( aLJSGetDrawSchema.getMakeDate());
		this.MakeTime = aLJSGetDrawSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLJSGetDrawSchema.getModifyDate());
		this.ModifyTime = aLJSGetDrawSchema.getModifyTime();
		this.RReportFlag = aLJSGetDrawSchema.getRReportFlag();
		this.ComeFlag = aLJSGetDrawSchema.getComeFlag();
		this.Currency = aLJSGetDrawSchema.getCurrency();
		this.NetAmount = aLJSGetDrawSchema.getNetAmount();
		this.TaxAmount = aLJSGetDrawSchema.getTaxAmount();
		this.Tax = aLJSGetDrawSchema.getTax();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LJSGetDraw表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LJSGetDrawSchema";
	...
	public LJSGetDrawSchema getSchema()
	{
		LJSGetDrawSchema aLJSGetDrawSchema = new LJSGetDrawSchema();
		aLJSGetDrawSchema.setSchema(this);
		return aLJSGetDrawSchema;
	}

	public LJSGetDrawDB getDB()
	{
		LJSGetDrawDB aDBOper = new LJSGetDrawDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLJSGetDraw描述/A>表字段
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLJSGetDraw>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			GetDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 11,SysConst.PACKAGESPILTER));
			GetMoney = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,12,SysConst.PACKAGESPILTER))).doubleValue();
			EnterAccDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 13,SysConst.PACKAGESPILTER));
			...
			LastGettoDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 27,SysConst.PACKAGESPILTER));
			CurGetToDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 28,SysConst.PACKAGESPILTER));
			GetFirstFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 29, SysConst.PACKAGESPILTER );
			GetChannelFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 30, SysConst.PACKAGESPILTER );
			DestrayFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 31, SysConst.PACKAGESPILTER );
			...
			RReportFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 42, SysConst.PACKAGESPILTER );
			ComeFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 43, SysConst.PACKAGESPILTER );
			Currency = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 44, SysConst.PACKAGESPILTER );
			NetAmount = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,45,SysConst.PACKAGESPILTER))).doubleValue();
			TaxAmount = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,46,SysConst.PACKAGESPILTER))).doubleValue();
			Tax = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,47,SysConst.PACKAGESPILTER))).doubleValue();
		}
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LJSGetDrawSchema other = (LJSGetDrawSchema)otherObject;
		return
