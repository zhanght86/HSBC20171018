...
{
private static Logger logger = Logger.getLogger(LDMenuShortDB.class);
	...
	**/
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.getNodeCode() == null || this.getNodeCode().equals("null")) {
				...
				pstmt.setString(12, this.getNodeCode());
			}
			if(this.getOperator() == null || this.getOperator().equals("null")) {
				pstmt.setNull(13, 12);
			} else {
	...
	public boolean getInfo()
	{
		...
		try
		{
			pstmt = con.prepareStatement("SELECT * FROM LDMenuShort WHERE  NodeCode = ? AND Operator = ?", 
...
public boolean closeData()
{
	...
	public LDMenuShortSet executeQuery(SQLwithBindVariables sqlbv) {
	...
	public LDMenuShortSet executeQuery(SQLwithBindVariables sqlbv, int nStart, int nCount) {
