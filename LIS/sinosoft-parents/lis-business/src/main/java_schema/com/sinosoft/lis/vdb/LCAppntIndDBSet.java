...
/*
 * <p>ClassName: LCAppntIndDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 寿险业务系统lis5模型
 */
public class LCAppntIndDBSet extends LCAppntIndSet
{
private static Logger logger = Logger.getLogger(LCAppntIndDBSet.class);
	...
	**/
	...
	// @Constructor
	public LCAppntIndDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LCAppntIndDBSet";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getSequenceNo() == null || this.get(i).getSequenceNo().equals("null")) {
				...
				pstmt.setString(3, this.get(i).getSequenceNo());
			}
			if(this.get(i).getAppntGrade() == null || this.get(i).getAppntGrade().equals("null")) {
				pstmt.setString(4,null);
			} else {
				pstmt.setString(4, this.get(i).getAppntGrade());
			}
			...
			if(this.get(i).getMarriageDate() == null || this.get(i).getMarriageDate().equals("null")) {
				...
				pstmt.setDate(13, Date.valueOf(this.get(i).getMarriageDate()));
			}
			if(this.get(i).getOccupationType() == null || this.get(i).getOccupationType().equals("null")) {
				pstmt.setString(14,null);
			} else {
				pstmt.setString(14, this.get(i).getOccupationType());
			}
			if(this.get(i).getStartWorkDate() == null || this.get(i).getStartWorkDate().equals("null")) {
				pstmt.setDate(15,null);
			} else {
				pstmt.setDate(15, Date.valueOf(this.get(i).getStartWorkDate()));
			}
			pstmt.setDouble(16, this.get(i).getSalary());
			if(this.get(i).getHealth() == null || this.get(i).getHealth().equals("null")) {
				pstmt.setString(17,null);
			} else {
				pstmt.setString(17, this.get(i).getHealth());
			}
			pstmt.setDouble(18, this.get(i).getStature());
			pstmt.setDouble(19, this.get(i).getAvoirdupois());
			if(this.get(i).getCreditGrade() == null || this.get(i).getCreditGrade().equals("null")) {
				pstmt.setString(20,null);
			} else {
				pstmt.setString(20, this.get(i).getCreditGrade());
			}
			...
			if(this.get(i).getProterty() == null || this.get(i).getProterty().equals("null")) {
				...
				pstmt.setString(22, this.get(i).getProterty());
			}
			...
			if(this.get(i).getCustomerNo() == null || this.get(i).getCustomerNo().equals("null")) {
				...
				pstmt.setString(57, this.get(i).getCustomerNo());
			}
