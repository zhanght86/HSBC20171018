...
/*
 * <p>ClassName: LPGrpPolDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 保全核心
 */
public class LPGrpPolDBSet extends LPGrpPolSet
{
	// @Field
	...
	**/
	...
	// @Constructor
	public LPGrpPolDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LPGrpPolDBSet";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getRiskVersion() == null || this.get(i).getRiskVersion().equals("null")) {
				...
				pstmt.setString(9, this.get(i).getRiskVersion());
			}
			...
			if(this.get(i).getAgentType() == null || this.get(i).getAgentType().equals("null")) {
				...
				pstmt.setString(13, this.get(i).getAgentType());
			}
			...
			if(this.get(i).getAgentGroup() == null || this.get(i).getAgentGroup().equals("null")) {
				...
				pstmt.setString(15, this.get(i).getAgentGroup());
			}
			...
			if(this.get(i).getAddressNo() == null || this.get(i).getAddressNo().equals("null")) {
				...
				pstmt.setString(18, this.get(i).getAddressNo());
			}
			if(this.get(i).getGrpName() == null || this.get(i).getGrpName().equals("null")) {
				pstmt.setString(19,null);
			} else {
				pstmt.setString(19, this.get(i).getGrpName());
			}
			if(this.get(i).getFirstPayDate() == null || this.get(i).getFirstPayDate().equals("null")) {
				pstmt.setDate(20,null);
			} else {
				pstmt.setDate(20, Date.valueOf(this.get(i).getFirstPayDate()));
			}
			if(this.get(i).getPayEndDate() == null || this.get(i).getPayEndDate().equals("null")) {
				pstmt.setDate(21,null);
			} else {
				pstmt.setDate(21, Date.valueOf(this.get(i).getPayEndDate()));
			}
			if(this.get(i).getPaytoDate() == null || this.get(i).getPaytoDate().equals("null")) {
				pstmt.setDate(22,null);
			} else {
				pstmt.setDate(22, Date.valueOf(this.get(i).getPaytoDate()));
			}
			if(this.get(i).getRegetDate() == null || this.get(i).getRegetDate().equals("null")) {
				pstmt.setDate(23,null);
			} else {
				pstmt.setDate(23, Date.valueOf(this.get(i).getRegetDate()));
			}
			if(this.get(i).getLastEdorDate() == null || this.get(i).getLastEdorDate().equals("null")) {
				pstmt.setDate(24,null);
			} else {
				pstmt.setDate(24, Date.valueOf(this.get(i).getLastEdorDate()));
			}
			if(this.get(i).getSSFlag() == null || this.get(i).getSSFlag().equals("null")) {
				pstmt.setString(25,null);
			} else {
				pstmt.setString(25, this.get(i).getSSFlag());
			}
			pstmt.setDouble(26, this.get(i).getPeakLine());
			pstmt.setDouble(27, this.get(i).getGetLimit());
			pstmt.setDouble(28, this.get(i).getGetRate());
			pstmt.setDouble(29, this.get(i).getBonusRate());
			pstmt.setDouble(30, this.get(i).getMaxMedFee());
			if(this.get(i).getOutPayFlag() == null || this.get(i).getOutPayFlag().equals("null")) {
				pstmt.setString(31,null);
			} else {
				pstmt.setString(31, this.get(i).getOutPayFlag());
			}
			pstmt.setDouble(32, this.get(i).getEmployeeRate());
			pstmt.setDouble(33, this.get(i).getFamilyRate());
			if(this.get(i).getSpecFlag() == null || this.get(i).getSpecFlag().equals("null")) {
				pstmt.setString(34,null);
			} else {
				pstmt.setString(34, this.get(i).getSpecFlag());
			}
			pstmt.setInt(35, this.get(i).getExpPeoples());
			pstmt.setDouble(36, this.get(i).getExpPremium());
			pstmt.setDouble(37, this.get(i).getExpAmnt());
			if(this.get(i).getPayMode() == null || this.get(i).getPayMode().equals("null")) {
				pstmt.setString(38,null);
			} else {
				pstmt.setString(38, this.get(i).getPayMode());
			}
			pstmt.setDouble(39, this.get(i).getManageFeeRate());
			pstmt.setInt(40, this.get(i).getPayIntv());
			if(this.get(i).getCValiDate() == null || this.get(i).getCValiDate().equals("null")) {
				pstmt.setDate(41,null);
			} else {
				pstmt.setDate(41, Date.valueOf(this.get(i).getCValiDate()));
			}
			pstmt.setInt(42, this.get(i).getPeoples2());
			pstmt.setDouble(43, this.get(i).getMult());
			pstmt.setDouble(44, this.get(i).getPrem());
			pstmt.setDouble(45, this.get(i).getAmnt());
			pstmt.setDouble(46, this.get(i).getSumPrem());
			pstmt.setDouble(47, this.get(i).getSumPay());
			pstmt.setDouble(48, this.get(i).getDif());
			if(this.get(i).getState() == null || this.get(i).getState().equals("null")) {
				pstmt.setString(49,null);
			} else {
				pstmt.setString(49, this.get(i).getState());
			}
			if(this.get(i).getApproveFlag() == null || this.get(i).getApproveFlag().equals("null")) {
				pstmt.setString(50,null);
			} else {
				pstmt.setString(50, this.get(i).getApproveFlag());
			}
			if(this.get(i).getApproveCode() == null || this.get(i).getApproveCode().equals("null")) {
				pstmt.setString(51,null);
			} else {
				pstmt.setString(51, this.get(i).getApproveCode());
			}
			if(this.get(i).getApproveDate() == null || this.get(i).getApproveDate().equals("null")) {
				pstmt.setDate(52,null);
			} else {
				pstmt.setDate(52, Date.valueOf(this.get(i).getApproveDate()));
			}
			if(this.get(i).getApproveTime() == null || this.get(i).getApproveTime().equals("null")) {
				pstmt.setString(53,null);
			} else {
				pstmt.setString(53, this.get(i).getApproveTime());
			}
			if(this.get(i).getUWFlag() == null || this.get(i).getUWFlag().equals("null")) {
				pstmt.setString(54,null);
			} else {
				pstmt.setString(54, this.get(i).getUWFlag());
			}
			if(this.get(i).getUWOperator() == null || this.get(i).getUWOperator().equals("null")) {
				pstmt.setString(55,null);
			} else {
				pstmt.setString(55, this.get(i).getUWOperator());
			}
			if(this.get(i).getUWDate() == null || this.get(i).getUWDate().equals("null")) {
				pstmt.setDate(56,null);
			} else {
				pstmt.setDate(56, Date.valueOf(this.get(i).getUWDate()));
			}
			if(this.get(i).getUWTime() == null || this.get(i).getUWTime().equals("null")) {
				pstmt.setString(57,null);
			} else {
				pstmt.setString(57, this.get(i).getUWTime());
			}
			if(this.get(i).getAppFlag() == null || this.get(i).getAppFlag().equals("null")) {
				pstmt.setString(58,null);
			} else {
				pstmt.setString(58, this.get(i).getAppFlag());
			}
			if(this.get(i).getRemark() == null || this.get(i).getRemark().equals("null")) {
				pstmt.setString(59,null);
			} else {
				pstmt.setString(59, this.get(i).getRemark());
			}
			if(this.get(i).getStandbyFlag1() == null || this.get(i).getStandbyFlag1().equals("null")) {
				pstmt.setString(60,null);
			} else {
				pstmt.setString(60, this.get(i).getStandbyFlag1());
			}
			if(this.get(i).getStandbyFlag2() == null || this.get(i).getStandbyFlag2().equals("null")) {
				pstmt.setString(61,null);
			} else {
				pstmt.setString(61, this.get(i).getStandbyFlag2());
			}
			if(this.get(i).getStandbyFlag3() == null || this.get(i).getStandbyFlag3().equals("null")) {
				pstmt.setString(62,null);
			} else {
				pstmt.setString(62, this.get(i).getStandbyFlag3());
			}
			if(this.get(i).getOperator() == null || this.get(i).getOperator().equals("null")) {
				pstmt.setString(63,null);
			} else {
				pstmt.setString(63, this.get(i).getOperator());
			}
			...
			pstmt.setInt(68, this.get(i).getOnWorkPeoples());
			pstmt.setInt(69, this.get(i).getOffWorkPeoples());
			pstmt.setInt(70, this.get(i).getOtherPeoples());
			pstmt.setInt(71, this.get(i).getRelaPeoples());
			pstmt.setInt(72, this.get(i).getRelaMatePeoples());
			pstmt.setInt(73, this.get(i).getRelaYoungPeoples());
			pstmt.setInt(74, this.get(i).getRelaOtherPeoples());
			pstmt.setInt(75, this.get(i).getWaitPeriod());
			if(this.get(i).getBONUSFLAG() == null || this.get(i).getBONUSFLAG().equals("null")) {
				pstmt.setString(76,null);
			} else {
				pstmt.setString(76, this.get(i).getBONUSFLAG());
			}
			if(this.get(i).getHealthInsurType() == null || this.get(i).getHealthInsurType().equals("null")) {
				pstmt.setString(77,null);
			} else {
				pstmt.setString(77, this.get(i).getHealthInsurType());
			}
			if(this.get(i).getAscriptionFlag() == null || this.get(i).getAscriptionFlag().equals("null")) {
				pstmt.setString(78,null);
			} else {
				pstmt.setString(78, this.get(i).getAscriptionFlag());
			}
			pstmt.setDouble(79, this.get(i).getInitRate());
			if(this.get(i).getHealthProType() == null || this.get(i).getHealthProType().equals("null")) {
				pstmt.setString(80,null);
			} else {
				pstmt.setString(80, this.get(i).getHealthProType());
			}
			if(this.get(i).getDistriFlag() == null || this.get(i).getDistriFlag().equals("null")) {
				pstmt.setString(81,null);
			} else {
				pstmt.setString(81, this.get(i).getDistriFlag());
			}
			pstmt.setInt(82, this.get(i).getPeoples3());
			pstmt.setDouble(83, this.get(i).getFeeRate());
			if(this.get(i).getRenewFlag() == null || this.get(i).getRenewFlag().equals("null")) {
				pstmt.setString(84,null);
			} else {
				pstmt.setString(84, this.get(i).getRenewFlag());
			}
			pstmt.setDouble(85, this.get(i).getDistriRate());
			pstmt.setDouble(86, this.get(i).getFixprofitRate());
			pstmt.setDouble(87, this.get(i).getChargeFeeRate());
			pstmt.setDouble(88, this.get(i).getCommRate());
			if(this.get(i).getStandbyFlag4() == null || this.get(i).getStandbyFlag4().equals("null")) {
				pstmt.setString(89,null);
			} else {
				pstmt.setString(89, this.get(i).getStandbyFlag4());
			}
			if(this.get(i).getCurrency() == null || this.get(i).getCurrency().equals("null")) {
				pstmt.setString(90,null);
			} else {
				pstmt.setString(90, this.get(i).getCurrency());
			}
			if(this.get(i).getUintLinkValiFlag() == null || this.get(i).getUintLinkValiFlag().equals("null")) {
				pstmt.setString(91,null);
			} else {
				pstmt.setString(91, this.get(i).getUintLinkValiFlag());
			}
			pstmt.setInt(92, this.get(i).getRenewCount());
			if(this.get(i).getRenewContNo() == null || this.get(i).getRenewContNo().equals("null")) {
				pstmt.setString(93,null);
			} else {
				pstmt.setString(93, this.get(i).getRenewContNo());
			}
			pstmt.setInt(94, this.get(i).getInitNumPeople());
			pstmt.setDouble(95, this.get(i).getInitMult());
			pstmt.setDouble(96, this.get(i).getInitAmnt());
			pstmt.setDouble(97, this.get(i).getInitRiskAmnt());
			pstmt.setDouble(98, this.get(i).getInitPrem());
			pstmt.setDouble(99, this.get(i).getInitStandPrem());
			pstmt.setDouble(100, this.get(i).getRiskAmnt());
			pstmt.setDouble(101, this.get(i).getStandPrem());
			pstmt.setInt(102, this.get(i).getSumNumPeople());
			if(this.get(i).getValDateType() == null || this.get(i).getValDateType().equals("null")) {
				pstmt.setString(103,null);
			} else {
				pstmt.setString(103, this.get(i).getValDateType());
			}
			if(this.get(i).getEndDate() == null || this.get(i).getEndDate().equals("null")) {
				pstmt.setDate(104,null);
			} else {
				pstmt.setDate(104, Date.valueOf(this.get(i).getEndDate()));
			}
			if(this.get(i).getAutoPayFlag() == null || this.get(i).getAutoPayFlag().equals("null")) {
				pstmt.setString(105,null);
			} else {
				pstmt.setString(105, this.get(i).getAutoPayFlag());
			}
			if(this.get(i).getSubFlag() == null || this.get(i).getSubFlag().equals("null")) {
				pstmt.setString(106,null);
			} else {
				pstmt.setString(106, this.get(i).getSubFlag());
			}
			if(this.get(i).getStopFlag() == null || this.get(i).getStopFlag().equals("null")) {
				pstmt.setString(107,null);
			} else {
				pstmt.setString(107, this.get(i).getStopFlag());
			}
			if(this.get(i).getKeepValueOpt() == null || this.get(i).getKeepValueOpt().equals("null")) {
				pstmt.setString(108,null);
			} else {
				pstmt.setString(108, this.get(i).getKeepValueOpt());
			}
			if(this.get(i).getLang() == null || this.get(i).getLang().equals("null")) {
				pstmt.setString(109,null);
			} else {
				pstmt.setString(109, this.get(i).getLang());
			}
			pstmt.setDouble(110, this.get(i).getGradeFeeRate());
			pstmt.setDouble(111, this.get(i).getOtherFeeRate());
			if(this.get(i).getPricingMode() == null || this.get(i).getPricingMode().equals("null")) {
				pstmt.setString(112,null);
			} else {
				pstmt.setString(112, this.get(i).getPricingMode());
			}
			if(this.get(i).getComCode() == null || this.get(i).getComCode().equals("null")) {
				pstmt.setString(113,null);
			} else {
				pstmt.setString(113, this.get(i).getComCode());
			}
			if(this.get(i).getModifyOperator() == null || this.get(i).getModifyOperator().equals("null")) {
				pstmt.setString(114,null);
			} else {
				pstmt.setString(114, this.get(i).getModifyOperator());
			}
			// set where condition
			if(this.get(i).getEdorNo() == null || this.get(i).getEdorNo().equals("null")) {
				pstmt.setString(115,null);
			} else {
				pstmt.setString(115, this.get(i).getEdorNo());
			}
			if(this.get(i).getEdorType() == null || this.get(i).getEdorType().equals("null")) {
				pstmt.setString(116,null);
			} else {
				pstmt.setString(116, this.get(i).getEdorType());
			}
			if(this.get(i).getGrpPolNo() == null || this.get(i).getGrpPolNo().equals("null")) {
				pstmt.setString(117,null);
			} else {
				pstmt.setString(117, this.get(i).getGrpPolNo());
			}
