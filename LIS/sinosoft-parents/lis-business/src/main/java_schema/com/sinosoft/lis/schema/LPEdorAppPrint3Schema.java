...
import com.sinosoft.lis.db.LPEdorAppPrint3DB;

/*
 * <p>ClassName: LPEdorAppPrint3Schema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 寿险业务系统缺失模型
 */
public class LPEdorAppPrint3Schema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LPEdorAppPrint3Schema.class);
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LPEdorAppPrint3Schema cloned = (LPEdorAppPrint3Schema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LPEdorAppPrint3Schema 对象给 Schema 赋值
	* @param: aLPEdorAppPrint3Schema LPEdorAppPrint3Schema
	**/
	public void setSchema(LPEdorAppPrint3Schema aLPEdorAppPrint3Schema)
	{
		this.EdorAcceptNo = aLPEdorAppPrint3Schema.getEdorAcceptNo();
		this.PrtFlag = aLPEdorAppPrint3Schema.getPrtFlag();
		this.PrtTimes = aLPEdorAppPrint3Schema.getPrtTimes();
		this.ManageCom = aLPEdorAppPrint3Schema.getManageCom();
		this.Operator = aLPEdorAppPrint3Schema.getOperator();
		this.MakeDate = fDate.getDate( aLPEdorAppPrint3Schema.getMakeDate());
		this.MakeTime = aLPEdorAppPrint3Schema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLPEdorAppPrint3Schema.getModifyDate());
		this.ModifyTime = aLPEdorAppPrint3Schema.getModifyTime();
		this.EdorInfo = aLPEdorAppPrint3Schema.getEdorInfo();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LPEdorAppPrint3表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LPEdorAppPrint3Schema";
	...
	public LPEdorAppPrint3Schema getSchema()
	{
		LPEdorAppPrint3Schema aLPEdorAppPrint3Schema = new LPEdorAppPrint3Schema();
		aLPEdorAppPrint3Schema.setSchema(this);
		return aLPEdorAppPrint3Schema;
	}

	public LPEdorAppPrint3DB getDB()
	{
		LPEdorAppPrint3DB aDBOper = new LPEdorAppPrint3DB();
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLPEdorAppPrint3>历史记账凭证主表信息</A>表字段
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LPEdorAppPrint3Schema other = (LPEdorAppPrint3Schema)otherObject;
		return
