...
/*
 * <p>ClassName: LDPersonContactInfoDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 客户管理
 */
public class LDPersonContactInfoDBSet extends LDPersonContactInfoSet
{
	// @Field
	...
	**/
	...
	// @Constructor
	public LDPersonContactInfoDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public LDPersonContactInfoDBSet()
	{
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LDPersonContactInfoDBSet";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getCompanyName() == null || this.get(i).getCompanyName().equals("null")) {
				...
				pstmt.setString(13, this.get(i).getCompanyName());
			}
			if(this.get(i).getCompanyAddress() == null || this.get(i).getCompanyAddress().equals("null")) {
				pstmt.setString(14,null);
			} else {
				pstmt.setString(14, this.get(i).getCompanyAddress());
			}
			if(this.get(i).getCompanyZipCode() == null || this.get(i).getCompanyZipCode().equals("null")) {
				pstmt.setString(15,null);
			} else {
				pstmt.setString(15, this.get(i).getCompanyZipCode());
			}
			if(this.get(i).getCompanyPhone() == null || this.get(i).getCompanyPhone().equals("null")) {
				pstmt.setString(16,null);
			} else {
				pstmt.setString(16, this.get(i).getCompanyPhone());
			}
			if(this.get(i).getCompanyFax() == null || this.get(i).getCompanyFax().equals("null")) {
				pstmt.setString(17,null);
			} else {
				pstmt.setString(17, this.get(i).getCompanyFax());
			}
			if(this.get(i).getUrgentLinkMan() == null || this.get(i).getUrgentLinkMan().equals("null")) {
				pstmt.setString(18,null);
			} else {
				pstmt.setString(18, this.get(i).getUrgentLinkMan());
			}
			if(this.get(i).getRelationToUrgent() == null || this.get(i).getRelationToUrgent().equals("null")) {
				pstmt.setString(19,null);
			} else {
				pstmt.setString(19, this.get(i).getRelationToUrgent());
			}
			if(this.get(i).getUrgentMobile() == null || this.get(i).getUrgentMobile().equals("null")) {
				pstmt.setString(20,null);
			} else {
				pstmt.setString(20, this.get(i).getUrgentMobile());
			}
			if(this.get(i).getMobile1() == null || this.get(i).getMobile1().equals("null")) {
				pstmt.setString(21,null);
			} else {
				pstmt.setString(21, this.get(i).getMobile1());
			}
			if(this.get(i).getEMail1() == null || this.get(i).getEMail1().equals("null")) {
				pstmt.setString(22,null);
			} else {
				pstmt.setString(22, this.get(i).getEMail1());
			}
			if(this.get(i).getQQ1() == null || this.get(i).getQQ1().equals("null")) {
				pstmt.setString(23,null);
			} else {
				pstmt.setString(23, this.get(i).getQQ1());
			}
			if(this.get(i).getMSN1() == null || this.get(i).getMSN1().equals("null")) {
				pstmt.setString(24,null);
			} else {
				pstmt.setString(24, this.get(i).getMSN1());
			}
			if(this.get(i).getWechat1() == null || this.get(i).getWechat1().equals("null")) {
				pstmt.setString(25,null);
			} else {
				pstmt.setString(25, this.get(i).getWechat1());
			}
			if(this.get(i).getMobile2() == null || this.get(i).getMobile2().equals("null")) {
				pstmt.setString(26,null);
			} else {
				pstmt.setString(26, this.get(i).getMobile2());
			}
			if(this.get(i).getEMail2() == null || this.get(i).getEMail2().equals("null")) {
				pstmt.setString(27,null);
			} else {
				pstmt.setString(27, this.get(i).getEMail2());
			}
			if(this.get(i).getQQ2() == null || this.get(i).getQQ2().equals("null")) {
				pstmt.setString(28,null);
			} else {
				pstmt.setString(28, this.get(i).getQQ2());
			}
			if(this.get(i).getMSN2() == null || this.get(i).getMSN2().equals("null")) {
				pstmt.setString(29,null);
			} else {
				pstmt.setString(29, this.get(i).getMSN2());
			}
			if(this.get(i).getWechat2() == null || this.get(i).getWechat2().equals("null")) {
				pstmt.setString(30,null);
			} else {
				pstmt.setString(30, this.get(i).getWechat2());
			}
