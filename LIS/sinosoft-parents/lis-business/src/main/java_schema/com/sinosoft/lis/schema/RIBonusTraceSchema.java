...
import com.sinosoft.lis.db.RIBonusTraceDB;

/*
 * <p>ClassName: RIBonusTraceSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 再保系统模型
 */
public class RIBonusTraceSchema implements Schema, Cloneable
{
	// @Field
	/** 流水号 */
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		RIBonusTraceSchema cloned = (RIBonusTraceSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 RIBonusTraceSchema 对象给 Schema 赋值
	* @param: aRIBonusTraceSchema RIBonusTraceSchema
	**/
	public void setSchema(RIBonusTraceSchema aRIBonusTraceSchema)
	{
		this.SerialNo = aRIBonusTraceSchema.getSerialNo();
		this.PolNo = aRIBonusTraceSchema.getPolNo();
		this.InsuAccNo = aRIBonusTraceSchema.getInsuAccNo();
		this.ContNo = aRIBonusTraceSchema.getContNo();
		this.GrpContNo = aRIBonusTraceSchema.getGrpContNo();
		this.GrpPolNo = aRIBonusTraceSchema.getGrpPolNo();
		this.PrtNo = aRIBonusTraceSchema.getPrtNo();
		this.RiskCode = aRIBonusTraceSchema.getRiskCode();
		this.AccType = aRIBonusTraceSchema.getAccType();
		this.BonusType = aRIBonusTraceSchema.getBonusType();
		this.InsuredNo = aRIBonusTraceSchema.getInsuredNo();
		this.AppntNo = aRIBonusTraceSchema.getAppntNo();
		this.BalaDate = fDate.getDate( aRIBonusTraceSchema.getBalaDate());
		this.Bonus = aRIBonusTraceSchema.getBonus();
		this.ManageCom = aRIBonusTraceSchema.getManageCom();
		this.Operator = aRIBonusTraceSchema.getOperator();
		this.MakeDate = fDate.getDate( aRIBonusTraceSchema.getMakeDate());
		this.MakeTime = aRIBonusTraceSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aRIBonusTraceSchema.getModifyDate());
		this.ModifyTime = aRIBonusTraceSchema.getModifyTime();
		this.Currency = aRIBonusTraceSchema.getCurrency();
		this.PayDate = fDate.getDate( aRIBonusTraceSchema.getPayDate());
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			System.out.println("数据库中的RIBonusTrace表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "RIBonusTraceSchema";
	...
	public RIBonusTraceSchema getSchema()
	{
		RIBonusTraceSchema aRIBonusTraceSchema = new RIBonusTraceSchema();
		aRIBonusTraceSchema.setSchema(this);
		return aRIBonusTraceSchema;
	}

	public RIBonusTraceDB getDB()
	{
		RIBonusTraceDB aDBOper = new RIBonusTraceDB();
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpRIBonusTrace>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			BalaDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 13,SysConst.PACKAGESPILTER));
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		RIBonusTraceSchema other = (RIBonusTraceSchema)otherObject;
		return
