...
/*
 * <p>ClassName: LCPayRuleFactorySchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 承保核心
 */
public class LCPayRuleFactorySchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LCPayRuleFactorySchema.class);
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LCPayRuleFactorySchema cloned = (LCPayRuleFactorySchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LCPayRuleFactorySchema 对象给 Schema 赋值
	* @param: aLCPayRuleFactorySchema LCPayRuleFactorySchema
	**/
	public void setSchema(LCPayRuleFactorySchema aLCPayRuleFactorySchema)
	{
		this.GrpPolNo = aLCPayRuleFactorySchema.getGrpPolNo();
		this.GrpContNo = aLCPayRuleFactorySchema.getGrpContNo();
		this.RiskCode = aLCPayRuleFactorySchema.getRiskCode();
		this.PayRuleCode = aLCPayRuleFactorySchema.getPayRuleCode();
		this.PayRuleName = aLCPayRuleFactorySchema.getPayRuleName();
		this.FactoryType = aLCPayRuleFactorySchema.getFactoryType();
		this.OtherNo = aLCPayRuleFactorySchema.getOtherNo();
		this.FactoryCode = aLCPayRuleFactorySchema.getFactoryCode();
		this.FactorySubCode = aLCPayRuleFactorySchema.getFactorySubCode();
		this.FactoryName = aLCPayRuleFactorySchema.getFactoryName();
		this.InerSerialNo = aLCPayRuleFactorySchema.getInerSerialNo();
		this.CalSql = aLCPayRuleFactorySchema.getCalSql();
		this.Params = aLCPayRuleFactorySchema.getParams();
		this.CalRemark = aLCPayRuleFactorySchema.getCalRemark();
		this.Operator = aLCPayRuleFactorySchema.getOperator();
		this.MakeDate = fDate.getDate( aLCPayRuleFactorySchema.getMakeDate());
		this.MakeTime = aLCPayRuleFactorySchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLCPayRuleFactorySchema.getModifyDate());
		this.ModifyTime = aLCPayRuleFactorySchema.getModifyTime();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LCPayRuleFactory表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LCPayRuleFactorySchema";
	...
	public LCPayRuleFactorySchema getSchema()
	{
		LCPayRuleFactorySchema aLCPayRuleFactorySchema = new LCPayRuleFactorySchema();
		aLCPayRuleFactorySchema.setSchema(this);
		return aLCPayRuleFactorySchema;
	}

	public LCPayRuleFactoryDB getDB()
	{
		LCPayRuleFactoryDB aDBOper = new LCPayRuleFactoryDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLCPayRuleFactory描述/A>表字段
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLCPayRuleFactory>历史记账凭证主表信息</A>表字段
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LCPayRuleFactorySchema other = (LCPayRuleFactorySchema)otherObject;
		return
