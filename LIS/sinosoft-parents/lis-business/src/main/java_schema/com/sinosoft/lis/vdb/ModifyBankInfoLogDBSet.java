...
/*
 * <p>ClassName: ModifyBankInfoLogDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 寿险业务收费
 */
public class ModifyBankInfoLogDBSet extends ModifyBankInfoLogSet
{
	// @Field
	...
	**/
	...
	// @Constructor
	public ModifyBankInfoLogDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "ModifyBankInfoLogDBSet";
	...
	public boolean delete()
	{
		...
		try
		{
			...
			if(this.get(i).getChangeSerialNo() == null || this.get(i).getChangeSerialNo().equals("null")) {
				...
				pstmt.setString(1, this.get(i).getChangeSerialNo());
			}
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getChangeType() == null || this.get(i).getChangeType().equals("null")) {
				...
				pstmt.setString(3, this.get(i).getChangeType());
			}
			...
			if(this.get(i).getEdorAcceptNo() == null || this.get(i).getEdorAcceptNo().equals("null")) {
				...
				pstmt.setString(9, this.get(i).getEdorAcceptNo());
			}
			...
			if(this.get(i).getChangeSerialNo() == null || this.get(i).getChangeSerialNo().equals("null")) {
				...
				pstmt.setString(16, this.get(i).getChangeSerialNo());
			}
