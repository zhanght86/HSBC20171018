 ...
 */
public class LOBGrpContSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LOBGrpContSchema.class);
	// @Field
	/** 集体合同号码 */
	...
	*/
	...
	public void setGrpName(String aGrpName)
	{
		if(aGrpName!=null && aGrpName.length()>60)
			throw new IllegalArgumentException("���位名��GrpName值"+aGrpName+"的长度"+aGrpName.length()+"大于最大值60");
		GrpName = aGrpName;
	}
	/**
	* 冗余，标准在团体客户表
	...
	*/
	...
	public void setAccName(String aAccName)
	{
		if(aAccName!=null && aAccName.length()>60)
			throw new IllegalArgumentException("银行帐户���AccName值"+aAccName+"的长度"+aAccName.length()+"大于最大值60");
		AccName = aAccName;
	}
	...
	*/
	...
	public void setApproveFlag(String aApproveFlag)
	{
		if(aApproveFlag!=null && aApproveFlag.length()>1)
			throw new IllegalArgumentException("复核���态ApproveFlag值"+aApproveFlag+"的长度"+aApproveFlag.length()+"大于最大值1");
	...
	*/
	...
	public void setFirstTrialTime(String aFirstTrialTime)
	{
		if(aFirstTrialTime!=null && aFirstTrialTime.length()>8)
			throw new IllegalArgumentException("初���时间FirstTrialTime值"+aFirstTrialTime+"的长度"+aFirstTrialTime.length()+"大于最大值8");
	...
	*/
	...
	/**
	* 如客户购买的保单与其需求明显不符,是否已向客户解释清��,用该字段记录是��已向客户解释，是－Y，不是－N
	*/
	...
	*/
	...
	public void setAgentCodeOper(String aAgentCodeOper)
	{
		if(aAgentCodeOper!=null && aAgentCodeOper.length()>10)
			throw new IllegalArgumentException("Column_129AgentCodeOper值"+aAgentCodeOper+"的长度"+aAgentCodeOper.length()+"大于最大值10");
	...
	public void setAgentCodeAssi(String aAgentCodeAssi)
	{
		if(aAgentCodeAssi!=null && aAgentCodeAssi.length()>10)
			throw new IllegalArgumentException("Column_130AgentCodeAssi值"+aAgentCodeAssi+"的长度"+aAgentCodeAssi.length()+"大于最大值10");
	...
	public void setContPlanFlag(String aContPlanFlag)
	{
		if(aContPlanFlag!=null && aContPlanFlag.length()>1)
			throw new IllegalArgumentException("Column_131ContPlanFlag值"+aContPlanFlag+"的长度"+aContPlanFlag.length()+"大于最大值1");
	...
	public void setDelayReasonCode(String aDelayReasonCode)
	{
		if(aDelayReasonCode!=null && aDelayReasonCode.length()>1)
			throw new IllegalArgumentException("Column_133DelayReasonCode值"+aDelayReasonCode+"的长度"+aDelayReasonCode.length()+"大于最大值1");
	...
	public void setDelayReasonDesc(String aDelayReasonDesc)
	{
		if(aDelayReasonDesc!=null && aDelayReasonDesc.length()>500)
			throw new IllegalArgumentException("Column_134DelayReasonDesc值"+aDelayReasonDesc+"的长度"+aDelayReasonDesc.length()+"大于最大值500");
	...
	public void setConTFlag(String aConTFlag)
	{
		if(aConTFlag!=null && aConTFlag.length()>1)
			throw new IllegalArgumentException("Column_135ConTFlag值"+aConTFlag+"的长度"+aConTFlag.length()+"大于最大值1");
		ConTFlag = aConTFlag;
	}
	...
	public void setSaleDepart(String aSaleDepart)
	{
		if(aSaleDepart!=null && aSaleDepart.length()>2)
			throw new IllegalArgumentException("Column_136SaleDepart值"+aSaleDepart+"的长度"+aSaleDepart.length()+"大于最大值2");
	...
	public void setChnlType(String aChnlType)
	{
		if(aChnlType!=null && aChnlType.length()>10)
			throw new IllegalArgumentException("Column_137ChnlType值"+aChnlType+"的长度"+aChnlType.length()+"大于最大值10");
		ChnlType = aChnlType;
	}
	...
	public void setAgentBranchesCode(String aAgentBranchesCode)
	{
		if(aAgentBranchesCode!=null && aAgentBranchesCode.length()>20)
			throw new IllegalArgumentException("Column_138AgentBranchesCode值"+aAgentBranchesCode+"的长度"+aAgentBranchesCode.length()+"大于最大值20");
	...
	public void setProjectType(String aProjectType)
	{
		if(aProjectType!=null && aProjectType.length()>30)
			throw new IllegalArgumentException("Column_139ProjectType值"+aProjectType+"的长度"+aProjectType.length()+"大于最大值30");
	...
	public void setRenewFlag(String aRenewFlag)
	{
		if(aRenewFlag!=null && aRenewFlag.length()>10)
			throw new IllegalArgumentException("Column_140RenewFlag值"+aRenewFlag+"的长度"+aRenewFlag.length()+"大于最大值10");
	...
	public void setRenewContNo(String aRenewContNo)
	{
		if(aRenewContNo!=null && aRenewContNo.length()>20)
			throw new IllegalArgumentException("Column_142RenewContNo值"+aRenewContNo+"的长度"+aRenewContNo.length()+"大于最大值20");
	...
	public void setInsuYearFlag(String aInsuYearFlag)
	{
		if(aInsuYearFlag!=null && aInsuYearFlag.length()>1)
			throw new IllegalArgumentException("Column_153InsuYearFlag值"+aInsuYearFlag+"的长度"+aInsuYearFlag.length()+"大于最大值1");
	...
	public void setPayEndYearFlag(String aPayEndYearFlag)
	{
		if(aPayEndYearFlag!=null && aPayEndYearFlag.length()>1)
			throw new IllegalArgumentException("Column_156PayEndYearFlag值"+aPayEndYearFlag+"的长度"+aPayEndYearFlag.length()+"大于最大值1");
	...
	public void setValDateType(String aValDateType)
	{
		if(aValDateType!=null && aValDateType.length()>2)
			throw new IllegalArgumentException("Column_158ValDateType值"+aValDateType+"的长度"+aValDateType.length()+"大于最大值2");
	...
	public void setAutoPayFlag(String aAutoPayFlag)
	{
		if(aAutoPayFlag!=null && aAutoPayFlag.length()>1)
			throw new IllegalArgumentException("Column_163AutoPayFlag值"+aAutoPayFlag+"的长度"+aAutoPayFlag.length()+"大于最大值1");
	...
	public void setSignOperator(String aSignOperator)
	{
		if(aSignOperator!=null && aSignOperator.length()>30)
			throw new IllegalArgumentException("Column_164SignOperator值"+aSignOperator+"的长度"+aSignOperator.length()+"大于最大值30");
	...
	public void setCoInsurance(String aCoInsurance)
	{
		if(aCoInsurance!=null && aCoInsurance.length()>2)
			throw new IllegalArgumentException("Column_165CoInsurance值"+aCoInsurance+"的长度"+aCoInsurance.length()+"大于最大值2");
	...
	public void setScanCom(String aScanCom)
	{
		if(aScanCom!=null && aScanCom.length()>20)
			throw new IllegalArgumentException("Column_168ScanCom值"+aScanCom+"的长度"+aScanCom.length()+"大于最大值20");
		ScanCom = aScanCom;
	}
	...
	public void setComCode(String aComCode)
	{
		if(aComCode!=null && aComCode.length()>20)
			throw new IllegalArgumentException("Column_169ComCode值"+aComCode+"的长度"+aComCode.length()+"大于最大值20");
		ComCode = aComCode;
	}
	...
	public void setModifyOperator(String aModifyOperator)
	{
		if(aModifyOperator!=null && aModifyOperator.length()>30)
			throw new IllegalArgumentException("Column_170ModifyOperator值"+aModifyOperator+"的长度"+aModifyOperator.length()+"大于最大值30");
		ModifyOperator = aModifyOperator;
	}

	/**
	* 使用另外一个 LOBGrpContSchema 对象给 Schema 赋值
	* @param: aLOBGrpContSchema LOBGrpContSchema
	**/
	public void setSchema(LOBGrpContSchema aLOBGrpContSchema)
	{
		this.GrpContNo = aLOBGrpContSchema.getGrpContNo();
		this.ProposalGrpContNo = aLOBGrpContSchema.getProposalGrpContNo();
		this.PrtNo = aLOBGrpContSchema.getPrtNo();
		this.SaleChnl = aLOBGrpContSchema.getSaleChnl();
		this.ManageCom = aLOBGrpContSchema.getManageCom();
		this.AgentCom = aLOBGrpContSchema.getAgentCom();
		this.AgentType = aLOBGrpContSchema.getAgentType();
		this.AgentCode = aLOBGrpContSchema.getAgentCode();
		this.AgentGroup = aLOBGrpContSchema.getAgentGroup();
		this.AgentCode1 = aLOBGrpContSchema.getAgentCode1();
		this.Password = aLOBGrpContSchema.getPassword();
		this.Password2 = aLOBGrpContSchema.getPassword2();
		this.AppntNo = aLOBGrpContSchema.getAppntNo();
		this.AddressNo = aLOBGrpContSchema.getAddressNo();
		this.Peoples2 = aLOBGrpContSchema.getPeoples2();
		this.GrpName = aLOBGrpContSchema.getGrpName();
		this.BusinessType = aLOBGrpContSchema.getBusinessType();
		this.GrpNature = aLOBGrpContSchema.getGrpNature();
		this.RgtMoney = aLOBGrpContSchema.getRgtMoney();
		this.Asset = aLOBGrpContSchema.getAsset();
		this.NetProfitRate = aLOBGrpContSchema.getNetProfitRate();
		this.MainBussiness = aLOBGrpContSchema.getMainBussiness();
		this.Corporation = aLOBGrpContSchema.getCorporation();
		this.ComAera = aLOBGrpContSchema.getComAera();
		this.Fax = aLOBGrpContSchema.getFax();
		this.Phone = aLOBGrpContSchema.getPhone();
		this.GetFlag = aLOBGrpContSchema.getGetFlag();
		this.Satrap = aLOBGrpContSchema.getSatrap();
		this.EMail = aLOBGrpContSchema.getEMail();
		this.FoundDate = fDate.getDate( aLOBGrpContSchema.getFoundDate());
		this.GrpGroupNo = aLOBGrpContSchema.getGrpGroupNo();
		this.BankCode = aLOBGrpContSchema.getBankCode();
		this.BankAccNo = aLOBGrpContSchema.getBankAccNo();
		this.AccName = aLOBGrpContSchema.getAccName();
		this.DisputedFlag = aLOBGrpContSchema.getDisputedFlag();
		this.OutPayFlag = aLOBGrpContSchema.getOutPayFlag();
		this.GetPolMode = aLOBGrpContSchema.getGetPolMode();
		this.Lang = aLOBGrpContSchema.getLang();
		this.Currency = aLOBGrpContSchema.getCurrency();
		this.LostTimes = aLOBGrpContSchema.getLostTimes();
		this.PrintCount = aLOBGrpContSchema.getPrintCount();
		this.RegetDate = fDate.getDate( aLOBGrpContSchema.getRegetDate());
		this.LastEdorDate = fDate.getDate( aLOBGrpContSchema.getLastEdorDate());
		this.LastGetDate = fDate.getDate( aLOBGrpContSchema.getLastGetDate());
		this.LastLoanDate = fDate.getDate( aLOBGrpContSchema.getLastLoanDate());
		this.SpecFlag = aLOBGrpContSchema.getSpecFlag();
		this.GrpSpec = aLOBGrpContSchema.getGrpSpec();
		this.PayMode = aLOBGrpContSchema.getPayMode();
		this.SignCom = aLOBGrpContSchema.getSignCom();
		this.SignDate = fDate.getDate( aLOBGrpContSchema.getSignDate());
		this.SignTime = aLOBGrpContSchema.getSignTime();
		this.CValiDate = fDate.getDate( aLOBGrpContSchema.getCValiDate());
		this.PayIntv = aLOBGrpContSchema.getPayIntv();
		this.ManageFeeRate = aLOBGrpContSchema.getManageFeeRate();
		this.ExpPeoples = aLOBGrpContSchema.getExpPeoples();
		this.ExpPremium = aLOBGrpContSchema.getExpPremium();
		this.ExpAmnt = aLOBGrpContSchema.getExpAmnt();
		this.Peoples = aLOBGrpContSchema.getPeoples();
		this.Mult = aLOBGrpContSchema.getMult();
		this.Prem = aLOBGrpContSchema.getPrem();
		this.Amnt = aLOBGrpContSchema.getAmnt();
		this.SumPrem = aLOBGrpContSchema.getSumPrem();
		this.SumPay = aLOBGrpContSchema.getSumPay();
		this.Dif = aLOBGrpContSchema.getDif();
		this.Remark = aLOBGrpContSchema.getRemark();
		this.StandbyFlag1 = aLOBGrpContSchema.getStandbyFlag1();
		this.StandbyFlag2 = aLOBGrpContSchema.getStandbyFlag2();
		this.StandbyFlag3 = aLOBGrpContSchema.getStandbyFlag3();
		this.InputOperator = aLOBGrpContSchema.getInputOperator();
		this.InputDate = fDate.getDate( aLOBGrpContSchema.getInputDate());
		this.InputTime = aLOBGrpContSchema.getInputTime();
		this.ApproveFlag = aLOBGrpContSchema.getApproveFlag();
		this.ApproveCode = aLOBGrpContSchema.getApproveCode();
		this.ApproveDate = fDate.getDate( aLOBGrpContSchema.getApproveDate());
		this.ApproveTime = aLOBGrpContSchema.getApproveTime();
		this.UWOperator = aLOBGrpContSchema.getUWOperator();
		this.UWFlag = aLOBGrpContSchema.getUWFlag();
		this.UWDate = fDate.getDate( aLOBGrpContSchema.getUWDate());
		this.UWTime = aLOBGrpContSchema.getUWTime();
		this.AppFlag = aLOBGrpContSchema.getAppFlag();
		this.PolApplyDate = fDate.getDate( aLOBGrpContSchema.getPolApplyDate());
		this.CustomGetPolDate = fDate.getDate( aLOBGrpContSchema.getCustomGetPolDate());
		this.GetPolDate = fDate.getDate( aLOBGrpContSchema.getGetPolDate());
		this.GetPolTime = aLOBGrpContSchema.getGetPolTime();
		this.State = aLOBGrpContSchema.getState();
		this.Operator = aLOBGrpContSchema.getOperator();
		this.MakeDate = fDate.getDate( aLOBGrpContSchema.getMakeDate());
		this.MakeTime = aLOBGrpContSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLOBGrpContSchema.getModifyDate());
		this.ModifyTime = aLOBGrpContSchema.getModifyTime();
		this.EnterKind = aLOBGrpContSchema.getEnterKind();
		this.AmntGrade = aLOBGrpContSchema.getAmntGrade();
		this.Peoples3 = aLOBGrpContSchema.getPeoples3();
		this.OnWorkPeoples = aLOBGrpContSchema.getOnWorkPeoples();
		this.OffWorkPeoples = aLOBGrpContSchema.getOffWorkPeoples();
		this.OtherPeoples = aLOBGrpContSchema.getOtherPeoples();
		this.RelaPeoples = aLOBGrpContSchema.getRelaPeoples();
		this.RelaMatePeoples = aLOBGrpContSchema.getRelaMatePeoples();
		this.RelaYoungPeoples = aLOBGrpContSchema.getRelaYoungPeoples();
		this.RelaOtherPeoples = aLOBGrpContSchema.getRelaOtherPeoples();
		this.FirstTrialOperator = aLOBGrpContSchema.getFirstTrialOperator();
		this.FirstTrialDate = fDate.getDate( aLOBGrpContSchema.getFirstTrialDate());
		this.FirstTrialTime = aLOBGrpContSchema.getFirstTrialTime();
		this.ReceiveOperator = aLOBGrpContSchema.getReceiveOperator();
		this.ReceiveDate = fDate.getDate( aLOBGrpContSchema.getReceiveDate());
		this.ReceiveTime = aLOBGrpContSchema.getReceiveTime();
		this.TempFeeNo = aLOBGrpContSchema.getTempFeeNo();
		this.HandlerName = aLOBGrpContSchema.getHandlerName();
		this.HandlerDate = fDate.getDate( aLOBGrpContSchema.getHandlerDate());
		this.HandlerPrint = aLOBGrpContSchema.getHandlerPrint();
		this.AgentDate = fDate.getDate( aLOBGrpContSchema.getAgentDate());
		this.BusinessBigType = aLOBGrpContSchema.getBusinessBigType();
		this.MarketType = aLOBGrpContSchema.getMarketType();
		this.ReportNo = aLOBGrpContSchema.getReportNo();
		this.ConferNo = aLOBGrpContSchema.getConferNo();
		this.SignReportNo = aLOBGrpContSchema.getSignReportNo();
		this.AgentConferNo = aLOBGrpContSchema.getAgentConferNo();
		this.ContType = aLOBGrpContSchema.getContType();
		this.EdorCalType = aLOBGrpContSchema.getEdorCalType();
		this.ClientCare = aLOBGrpContSchema.getClientCare();
		this.FundReason = aLOBGrpContSchema.getFundReason();
		this.BackDateRemark = aLOBGrpContSchema.getBackDateRemark();
		this.ClientNeedJudge = aLOBGrpContSchema.getClientNeedJudge();
		this.DonateContflag = aLOBGrpContSchema.getDonateContflag();
		this.FundJudge = aLOBGrpContSchema.getFundJudge();
		this.ExamAndAppNo = aLOBGrpContSchema.getExamAndAppNo();
		this.EdorTransPercent = aLOBGrpContSchema.getEdorTransPercent();
		this.CardFlag = aLOBGrpContSchema.getCardFlag();
		this.AgentCodeOper = aLOBGrpContSchema.getAgentCodeOper();
		this.AgentCodeAssi = aLOBGrpContSchema.getAgentCodeAssi();
		this.ContPlanFlag = aLOBGrpContSchema.getContPlanFlag();
		this.FYCRate = aLOBGrpContSchema.getFYCRate();
		this.DelayReasonCode = aLOBGrpContSchema.getDelayReasonCode();
		this.DelayReasonDesc = aLOBGrpContSchema.getDelayReasonDesc();
		this.ConTFlag = aLOBGrpContSchema.getConTFlag();
		this.SaleDepart = aLOBGrpContSchema.getSaleDepart();
		this.ChnlType = aLOBGrpContSchema.getChnlType();
		this.AgentBranchesCode = aLOBGrpContSchema.getAgentBranchesCode();
		this.ProjectType = aLOBGrpContSchema.getProjectType();
		this.RenewFlag = aLOBGrpContSchema.getRenewFlag();
		this.RenewCount = aLOBGrpContSchema.getRenewCount();
		this.RenewContNo = aLOBGrpContSchema.getRenewContNo();
		this.InitNumPeople = aLOBGrpContSchema.getInitNumPeople();
		this.InitMult = aLOBGrpContSchema.getInitMult();
		this.InitAmnt = aLOBGrpContSchema.getInitAmnt();
		this.InitRiskAmnt = aLOBGrpContSchema.getInitRiskAmnt();
		this.InitPrem = aLOBGrpContSchema.getInitPrem();
		this.InitStandPrem = aLOBGrpContSchema.getInitStandPrem();
		this.RiskAmnt = aLOBGrpContSchema.getRiskAmnt();
		this.StandPrem = aLOBGrpContSchema.getStandPrem();
		this.SumNumPeople = aLOBGrpContSchema.getSumNumPeople();
		this.InsuYear = aLOBGrpContSchema.getInsuYear();
		this.InsuYearFlag = aLOBGrpContSchema.getInsuYearFlag();
		this.Years = aLOBGrpContSchema.getYears();
		this.PayEndYear = aLOBGrpContSchema.getPayEndYear();
		this.PayEndYearFlag = aLOBGrpContSchema.getPayEndYearFlag();
		this.PayYears = aLOBGrpContSchema.getPayYears();
		this.ValDateType = aLOBGrpContSchema.getValDateType();
		this.EndDate = fDate.getDate( aLOBGrpContSchema.getEndDate());
		this.FirstPayDate = fDate.getDate( aLOBGrpContSchema.getFirstPayDate());
		this.PayEndDate = fDate.getDate( aLOBGrpContSchema.getPayEndDate());
		this.PayToDate = fDate.getDate( aLOBGrpContSchema.getPayToDate());
		this.AutoPayFlag = aLOBGrpContSchema.getAutoPayFlag();
		this.SignOperator = aLOBGrpContSchema.getSignOperator();
		this.CoInsurance = aLOBGrpContSchema.getCoInsurance();
		this.AmntShareRate = aLOBGrpContSchema.getAmntShareRate();
		this.PremShareRate = aLOBGrpContSchema.getPremShareRate();
		this.ScanCom = aLOBGrpContSchema.getScanCom();
		this.ComCode = aLOBGrpContSchema.getComCode();
		this.ModifyOperator = aLOBGrpContSchema.getModifyOperator();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LOBGrpCont表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LOBGrpContSchema";
	...
	public LOBGrpContDB getDB()
	{
		LOBGrpContDB aDBOper = new LOBGrpContDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLOBGrpCont描述/A>表字段
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLOBGrpCont>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			ReportNo = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 114, SysConst.PACKAGESPILTER );
			ConferNo = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 115, SysConst.PACKAGESPILTER );
			SignReportNo = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 116, SysConst.PACKAGESPILTER );
			AgentConferNo = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 117, SysConst.PACKAGESPILTER );
			ContType = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 118, SysConst.PACKAGESPILTER );
			EdorCalType = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 119, SysConst.PACKAGESPILTER );
			ClientCare = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 120, SysConst.PACKAGESPILTER );
			FundReason = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 121, SysConst.PACKAGESPILTER );
			BackDateRemark = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 122, SysConst.PACKAGESPILTER );
			ClientNeedJudge = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 123, SysConst.PACKAGESPILTER );
			DonateContflag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 124, SysConst.PACKAGESPILTER );
			FundJudge = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 125, SysConst.PACKAGESPILTER );
			ExamAndAppNo = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 126, SysConst.PACKAGESPILTER );
			EdorTransPercent = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,127,SysConst.PACKAGESPILTER))).doubleValue();
			...
			ContPlanFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 131, SysConst.PACKAGESPILTER );
			FYCRate = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,132,SysConst.PACKAGESPILTER))).doubleValue();
			...
			ConTFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 135, SysConst.PACKAGESPILTER );
			SaleDepart = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 136, SysConst.PACKAGESPILTER );
			ChnlType = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 137, SysConst.PACKAGESPILTER );
			AgentBranchesCode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 138, SysConst.PACKAGESPILTER );
			ProjectType = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 139, SysConst.PACKAGESPILTER );
			RenewFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 140, SysConst.PACKAGESPILTER );
			RenewCount= new Integer(ChgData.chgNumericStr(StrTool.getStr(strMessage,141,SysConst.PACKAGESPILTER))).intValue();
			RenewContNo = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 142, SysConst.PACKAGESPILTER );
			InitNumPeople= new Integer(ChgData.chgNumericStr(StrTool.getStr(strMessage,143,SysConst.PACKAGESPILTER))).intValue();
			InitMult= new Integer(ChgData.chgNumericStr(StrTool.getStr(strMessage,144,SysConst.PACKAGESPILTER))).intValue();
			InitAmnt = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,145,SysConst.PACKAGESPILTER))).doubleValue();
			InitRiskAmnt = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,146,SysConst.PACKAGESPILTER))).doubleValue();
			InitPrem = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,147,SysConst.PACKAGESPILTER))).doubleValue();
			InitStandPrem = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,148,SysConst.PACKAGESPILTER))).doubleValue();
			RiskAmnt = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,149,SysConst.PACKAGESPILTER))).doubleValue();
			StandPrem = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,150,SysConst.PACKAGESPILTER))).doubleValue();
			SumNumPeople= new Integer(ChgData.chgNumericStr(StrTool.getStr(strMessage,151,SysConst.PACKAGESPILTER))).intValue();
			InsuYear= new Integer(ChgData.chgNumericStr(StrTool.getStr(strMessage,152,SysConst.PACKAGESPILTER))).intValue();
			InsuYearFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 153, SysConst.PACKAGESPILTER );
			Years= new Integer(ChgData.chgNumericStr(StrTool.getStr(strMessage,154,SysConst.PACKAGESPILTER))).intValue();
			PayEndYear= new Integer(ChgData.chgNumericStr(StrTool.getStr(strMessage,155,SysConst.PACKAGESPILTER))).intValue();
			PayEndYearFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 156, SysConst.PACKAGESPILTER );
			PayYears= new Integer(ChgData.chgNumericStr(StrTool.getStr(strMessage,157,SysConst.PACKAGESPILTER))).intValue();
			ValDateType = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 158, SysConst.PACKAGESPILTER );
			EndDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 159,SysConst.PACKAGESPILTER));
			FirstPayDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 160,SysConst.PACKAGESPILTER));
			PayEndDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 161,SysConst.PACKAGESPILTER));
			PayToDate = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 162,SysConst.PACKAGESPILTER));
			AutoPayFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 163, SysConst.PACKAGESPILTER );
			SignOperator = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 164, SysConst.PACKAGESPILTER );
			CoInsurance = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 165, SysConst.PACKAGESPILTER );
			AmntShareRate = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,166,SysConst.PACKAGESPILTER))).doubleValue();
			PremShareRate = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,167,SysConst.PACKAGESPILTER))).doubleValue();
			ScanCom = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 168, SysConst.PACKAGESPILTER );
			ComCode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 169, SysConst.PACKAGESPILTER );
			ModifyOperator = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 170, SysConst.PACKAGESPILTER );
		}
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LOBGrpContSchema other = (LOBGrpContSchema)otherObject;
		return
