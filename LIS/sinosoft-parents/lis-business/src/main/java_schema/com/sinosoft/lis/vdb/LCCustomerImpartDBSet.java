...
/*
 * <p>ClassName: LCCustomerImpartDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 承保核心
 */
public class LCCustomerImpartDBSet extends LCCustomerImpartSet
{
private static Logger logger = Logger.getLogger(LCCustomerImpartDBSet.class);
	...
	**/
	...
	// @Constructor
	public LCCustomerImpartDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LCCustomerImpartDBSet";
	...
	public boolean delete()
	{
		...
		try
		{
			...
			pstmt.setInt(8, this.get(i).getPatchNo());
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getImpartContent() == null || this.get(i).getImpartContent().equals("null")) {
				...
				pstmt.setString(7, this.get(i).getImpartContent());
			}
			if(this.get(i).getImpartParamModle() == null || this.get(i).getImpartParamModle().equals("null")) {
				pstmt.setString(8,null);
			} else {
				pstmt.setString(8, this.get(i).getImpartParamModle());
			}
			if(this.get(i).getCustomerNo() == null || this.get(i).getCustomerNo().equals("null")) {
			...
			if(this.get(i).getUWClaimFlg() == null || this.get(i).getUWClaimFlg().equals("null")) {
				...
				pstmt.setString(11, this.get(i).getUWClaimFlg());
			}
			...
			pstmt.setInt(18, this.get(i).getPatchNo());
			// set where condition
			if(this.get(i).getGrpContNo() == null || this.get(i).getGrpContNo().equals("null")) {
			...
			if(this.get(i).getProposalContNo() == null || this.get(i).getProposalContNo().equals("null")) {
				...
				pstmt.setString(21, this.get(i).getProposalContNo());
			}
			if(this.get(i).getImpartCode() == null || this.get(i).getImpartCode().equals("null")) {
				pstmt.setString(22,null);
			} else {
				pstmt.setString(22, this.get(i).getImpartCode());
			}
			if(this.get(i).getImpartVer() == null || this.get(i).getImpartVer().equals("null")) {
				pstmt.setString(23,null);
			} else {
				pstmt.setString(23, this.get(i).getImpartVer());
			}
			if(this.get(i).getCustomerNo() == null || this.get(i).getCustomerNo().equals("null")) {
				pstmt.setString(24,null);
			} else {
				pstmt.setString(24, this.get(i).getCustomerNo());
			}
			if(this.get(i).getCustomerNoType() == null || this.get(i).getCustomerNoType().equals("null")) {
				pstmt.setString(25,null);
			} else {
				pstmt.setString(25, StrTool.space1(this.get(i).getCustomerNoType(), 1));
			}
			pstmt.setInt(26, this.get(i).getPatchNo());
