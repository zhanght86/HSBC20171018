...
import com.sinosoft.lis.db.PD_LMEdorZTDutyDB;

/*
 * <p>ClassName: PD_LMEdorZTDutySchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 产品定义平台_PDM
 */
public class PD_LMEdorZTDutySchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(PD_LMEdorZTDutySchema.class);
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		PD_LMEdorZTDutySchema cloned = (PD_LMEdorZTDutySchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 PD_LMEdorZTDutySchema 对象给 Schema 赋值
	* @param: aPD_LMEdorZTDutySchema PD_LMEdorZTDutySchema
	**/
	public void setSchema(PD_LMEdorZTDutySchema aPD_LMEdorZTDutySchema)
	{
		this.RiskCode = aPD_LMEdorZTDutySchema.getRiskCode();
		this.DutyCode = aPD_LMEdorZTDutySchema.getDutyCode();
		this.PayByAcc = aPD_LMEdorZTDutySchema.getPayByAcc();
		this.PayCalType = aPD_LMEdorZTDutySchema.getPayCalType();
		this.Operator = aPD_LMEdorZTDutySchema.getOperator();
		this.MakeDate = fDate.getDate( aPD_LMEdorZTDutySchema.getMakeDate());
		this.MakeTime = aPD_LMEdorZTDutySchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aPD_LMEdorZTDutySchema.getModifyDate());
		this.ModifyTime = aPD_LMEdorZTDutySchema.getModifyTime();
		this.Standbyflag1 = aPD_LMEdorZTDutySchema.getStandbyflag1();
		this.Standbyflag2 = aPD_LMEdorZTDutySchema.getStandbyflag2();
		this.Standbyflag3 = aPD_LMEdorZTDutySchema.getStandbyflag3();
		this.Standbyflag4 = aPD_LMEdorZTDutySchema.getStandbyflag4();
		this.Standbyflag5 = aPD_LMEdorZTDutySchema.getStandbyflag5();
		this.Standbyflag6 = aPD_LMEdorZTDutySchema.getStandbyflag6();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的PD_LMEdorZTDuty表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "PD_LMEdorZTDutySchema";
	...
	public PD_LMEdorZTDutySchema getSchema()
	{
		PD_LMEdorZTDutySchema aPD_LMEdorZTDutySchema = new PD_LMEdorZTDutySchema();
		aPD_LMEdorZTDutySchema.setSchema(this);
		return aPD_LMEdorZTDutySchema;
	}

	public PD_LMEdorZTDutyDB getDB()
	{
		PD_LMEdorZTDutyDB aDBOper = new PD_LMEdorZTDutyDB();
	...
	**/
	public String encode()
	{
		...
		strReturn.append(StrTool.cTrim(PayCalType)); strReturn.append(SysConst.PACKAGESPILTER);
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpPD_LMEdorZTDuty>历史记账凭证主表信息</A>表字段
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		PD_LMEdorZTDutySchema other = (PD_LMEdorZTDutySchema)otherObject;
		return
