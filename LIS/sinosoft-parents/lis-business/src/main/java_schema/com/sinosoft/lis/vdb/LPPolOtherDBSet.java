...
/*
 * <p>ClassName: LPPolOtherDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 保全核心
 */
public class LPPolOtherDBSet extends LPPolOtherSet
{
private static Logger logger = Logger.getLogger(LPPolOtherDBSet.class);
	...
	**/
	...
	// @Constructor
	public LPPolOtherDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LPPolOtherDBSet";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getGrpPolNo() == null || this.get(i).getGrpPolNo().equals("null")) {
				...
				pstmt.setString(36, this.get(i).getGrpPolNo());
			}
			if(this.get(i).getContNo() == null || this.get(i).getContNo().equals("null")) {
