...
import com.sinosoft.lis.db.LQDutyClmCtrlRelaDB;

/*
 * <p>ClassName: LQDutyClmCtrlRelaSchema </p>
 ...
 */
public class LQDutyClmCtrlRelaSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LQDutyClmCtrlRelaSchema.class);
	...
	// @Constructor
	public LQDutyClmCtrlRelaSchema()
	{
		mErrors = new CErrors();
		...
		PK = pk;
            ...
            public Object clone()
                    throws CloneNotSupportedException
            {
                LQDutyClmCtrlRelaSchema cloned = (LQDutyClmCtrlRelaSchema)super.clone();
	...
	/**
	* 使用另外一个 LQDutyClmCtrlRelaSchema 对象给 Schema 赋值
	* @param: aLQDutyClmCtrlRelaSchema LQDutyClmCtrlRelaSchema
	**/
	public void setSchema(LQDutyClmCtrlRelaSchema aLQDutyClmCtrlRelaSchema)
	{
		this.AskPriceNo = aLQDutyClmCtrlRelaSchema.getAskPriceNo();
		this.AskNo = aLQDutyClmCtrlRelaSchema.getAskNo();
		this.ClaimCtrlCode = aLQDutyClmCtrlRelaSchema.getClaimCtrlCode();
		this.RiskCode = aLQDutyClmCtrlRelaSchema.getRiskCode();
		this.DutyCode = aLQDutyClmCtrlRelaSchema.getDutyCode();
		this.GetDutyCode = aLQDutyClmCtrlRelaSchema.getGetDutyCode();
		this.GetDutyKind = aLQDutyClmCtrlRelaSchema.getGetDutyKind();
		this.DutyCalFactator = aLQDutyClmCtrlRelaSchema.getDutyCalFactator();
		this.DutyCalFactatorName = aLQDutyClmCtrlRelaSchema.getDutyCalFactatorName();
		this.ContPlanCode = aLQDutyClmCtrlRelaSchema.getContPlanCode();
		this.MakeDate = fDate.getDate( aLQDutyClmCtrlRelaSchema.getMakeDate());
		this.MakeTime = aLQDutyClmCtrlRelaSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLQDutyClmCtrlRelaSchema.getModifyDate());
		this.ModifyTime = aLQDutyClmCtrlRelaSchema.getModifyTime();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LQDutyClmCtrlRela表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LQDutyClmCtrlRelaSchema";
	...
	public LQDutyClmCtrlRelaSchema getSchema()
	{
		LQDutyClmCtrlRelaSchema aLQDutyClmCtrlRelaSchema = new LQDutyClmCtrlRelaSchema();
		aLQDutyClmCtrlRelaSchema.setSchema(this);
		return aLQDutyClmCtrlRelaSchema;
	}

	public LQDutyClmCtrlRelaDB getDB()
	{
		LQDutyClmCtrlRelaDB aDBOper = new LQDutyClmCtrlRelaDB();
...
strReturn.append(StrTool.cTrim(ModifyTime));
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLQDutyClmCtrlRela>历史记账凭证主表信息</A>表字段
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LQDutyClmCtrlRelaSchema other = (LQDutyClmCtrlRelaSchema)otherObject;
		return
