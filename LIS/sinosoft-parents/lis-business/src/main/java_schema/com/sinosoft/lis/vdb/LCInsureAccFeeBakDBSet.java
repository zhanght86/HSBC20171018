...
/*
 * <p>ClassName: LCInsureAccFeeBakDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: PhysicalDataModel_1
 */
public class LCInsureAccFeeBakDBSet extends LCInsureAccFeeBakSet
{
private static Logger logger = Logger.getLogger(LCInsureAccFeeBakDBSet.class);
	...
	**/
	...
	// @Constructor
	public LCInsureAccFeeBakDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LCInsureAccFeeBakDBSet";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getInsuAccNo() == null || this.get(i).getInsuAccNo().equals("null")) {
				...
				pstmt.setString(29, this.get(i).getInsuAccNo());
			}
