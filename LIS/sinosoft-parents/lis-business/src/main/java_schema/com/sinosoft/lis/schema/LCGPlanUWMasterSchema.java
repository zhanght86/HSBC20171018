...
/*
 * <p>ClassName: LCGPlanUWMasterSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 寿险业务系统未整理模型
 */
public class LCGPlanUWMasterSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LCGPlanUWMasterSchema.class);
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LCGPlanUWMasterSchema cloned = (LCGPlanUWMasterSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LCGPlanUWMasterSchema 对象给 Schema 赋值
	* @param: aLCGPlanUWMasterSchema LCGPlanUWMasterSchema
	**/
	public void setSchema(LCGPlanUWMasterSchema aLCGPlanUWMasterSchema)
	{
		this.GrpContNo = aLCGPlanUWMasterSchema.getGrpContNo();
		this.ProposalGrpContNo = aLCGPlanUWMasterSchema.getProposalGrpContNo();
		this.ContPlanCode = aLCGPlanUWMasterSchema.getContPlanCode();
		this.PlanType = aLCGPlanUWMasterSchema.getPlanType();
		this.UWNo = aLCGPlanUWMasterSchema.getUWNo();
		this.InsuredNo = aLCGPlanUWMasterSchema.getInsuredNo();
		this.InsuredName = aLCGPlanUWMasterSchema.getInsuredName();
		this.AppntNo = aLCGPlanUWMasterSchema.getAppntNo();
		this.AppntName = aLCGPlanUWMasterSchema.getAppntName();
		this.AgentCode = aLCGPlanUWMasterSchema.getAgentCode();
		this.AgentGroup = aLCGPlanUWMasterSchema.getAgentGroup();
		this.PassFlag = aLCGPlanUWMasterSchema.getPassFlag();
		this.UWGrade = aLCGPlanUWMasterSchema.getUWGrade();
		this.AppGrade = aLCGPlanUWMasterSchema.getAppGrade();
		this.PostponeDay = aLCGPlanUWMasterSchema.getPostponeDay();
		this.PostponeDate = fDate.getDate( aLCGPlanUWMasterSchema.getPostponeDate());
		this.AutoUWFlag = aLCGPlanUWMasterSchema.getAutoUWFlag();
		this.State = aLCGPlanUWMasterSchema.getState();
		this.ManageCom = aLCGPlanUWMasterSchema.getManageCom();
		this.UWIdea = aLCGPlanUWMasterSchema.getUWIdea();
		this.UpReportContent = aLCGPlanUWMasterSchema.getUpReportContent();
		this.HealthFlag = aLCGPlanUWMasterSchema.getHealthFlag();
		this.QuesFlag = aLCGPlanUWMasterSchema.getQuesFlag();
		this.SpecFlag = aLCGPlanUWMasterSchema.getSpecFlag();
		this.AddPremFlag = aLCGPlanUWMasterSchema.getAddPremFlag();
		this.AddPremReason = aLCGPlanUWMasterSchema.getAddPremReason();
		this.ReportFlag = aLCGPlanUWMasterSchema.getReportFlag();
		this.PrintFlag = aLCGPlanUWMasterSchema.getPrintFlag();
		this.PrintFlag2 = aLCGPlanUWMasterSchema.getPrintFlag2();
		this.ChangePolFlag = aLCGPlanUWMasterSchema.getChangePolFlag();
		this.ChangePolReason = aLCGPlanUWMasterSchema.getChangePolReason();
		this.SpecReason = aLCGPlanUWMasterSchema.getSpecReason();
		this.UpReport = aLCGPlanUWMasterSchema.getUpReport();
		this.Operator = aLCGPlanUWMasterSchema.getOperator();
		this.MakeDate = fDate.getDate( aLCGPlanUWMasterSchema.getMakeDate());
		this.MakeTime = aLCGPlanUWMasterSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLCGPlanUWMasterSchema.getModifyDate());
		this.ModifyTime = aLCGPlanUWMasterSchema.getModifyTime();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LCGPlanUWMaster表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LCGPlanUWMasterSchema";
	...
	public LCGPlanUWMasterSchema getSchema()
	{
		LCGPlanUWMasterSchema aLCGPlanUWMasterSchema = new LCGPlanUWMasterSchema();
		aLCGPlanUWMasterSchema.setSchema(this);
		return aLCGPlanUWMasterSchema;
	}

	public LCGPlanUWMasterDB getDB()
	{
		LCGPlanUWMasterDB aDBOper = new LCGPlanUWMasterDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLCGPlanUWMaster描述/A>表字段
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLCGPlanUWMaster>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			PlanType = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 4, SysConst.PACKAGESPILTER );
			...
			UpReport = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 33, SysConst.PACKAGESPILTER );
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LCGPlanUWMasterSchema other = (LCGPlanUWMasterSchema)otherObject;
		return
