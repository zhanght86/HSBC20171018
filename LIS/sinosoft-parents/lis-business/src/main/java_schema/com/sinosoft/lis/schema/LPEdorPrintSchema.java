...
/*
 * <p>ClassName: LPEdorPrintSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 保全核心
 */
public class LPEdorPrintSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LPEdorPrintSchema.class);
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LPEdorPrintSchema cloned = (LPEdorPrintSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LPEdorPrintSchema 对象给 Schema 赋值
	* @param: aLPEdorPrintSchema LPEdorPrintSchema
	**/
	public void setSchema(LPEdorPrintSchema aLPEdorPrintSchema)
	{
		this.EdorNo = aLPEdorPrintSchema.getEdorNo();
		this.PrtFlag = aLPEdorPrintSchema.getPrtFlag();
		this.PrtTimes = aLPEdorPrintSchema.getPrtTimes();
		this.ManageCom = aLPEdorPrintSchema.getManageCom();
		this.Operator = aLPEdorPrintSchema.getOperator();
		this.MakeDate = fDate.getDate( aLPEdorPrintSchema.getMakeDate());
		this.MakeTime = aLPEdorPrintSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLPEdorPrintSchema.getModifyDate());
		this.ModifyTime = aLPEdorPrintSchema.getModifyTime();
		this.EdorInfo = aLPEdorPrintSchema.getEdorInfo();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LPEdorPrint表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LPEdorPrintSchema";
	...
	public LPEdorPrintSchema getSchema()
	{
		LPEdorPrintSchema aLPEdorPrintSchema = new LPEdorPrintSchema();
		aLPEdorPrintSchema.setSchema(this);
		return aLPEdorPrintSchema;
	}

	public LPEdorPrintDB getDB()
	{
		LPEdorPrintDB aDBOper = new LPEdorPrintDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLPEdorPrint描述/A>表字段
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLPEdorPrint>历史记账凭证主表信息</A>表字段
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LPEdorPrintSchema other = (LPEdorPrintSchema)otherObject;
		return
