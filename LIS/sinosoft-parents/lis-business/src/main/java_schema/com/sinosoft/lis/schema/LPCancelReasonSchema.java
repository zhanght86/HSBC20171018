...
import com.sinosoft.lis.db.LPCancelReasonDB;

/*
 * <p>ClassName: LPCancelReasonSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 保全核心
 */
public class LPCancelReasonSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LPCancelReasonSchema.class);
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LPCancelReasonSchema cloned = (LPCancelReasonSchema)super.clone();
	...
	/**
	* 使用另外一个 LPCancelReasonSchema 对象给 Schema 赋值
	* @param: aLPCancelReasonSchema LPCancelReasonSchema
	**/
	public void setSchema(LPCancelReasonSchema aLPCancelReasonSchema)
	{
		this.EdorAcceptNo = aLPCancelReasonSchema.getEdorAcceptNo();
		this.ReasonCode = aLPCancelReasonSchema.getReasonCode();
		this.Operator = aLPCancelReasonSchema.getOperator();
		this.MakeDate = fDate.getDate( aLPCancelReasonSchema.getMakeDate());
		this.MakeTime = aLPCancelReasonSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLPCancelReasonSchema.getModifyDate());
		this.ModifyTime = aLPCancelReasonSchema.getModifyTime();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LPCancelReason表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LPCancelReasonSchema";
	...
	public LPCancelReasonSchema getSchema()
	{
		LPCancelReasonSchema aLPCancelReasonSchema = new LPCancelReasonSchema();
		aLPCancelReasonSchema.setSchema(this);
		return aLPCancelReasonSchema;
	}

	public LPCancelReasonDB getDB()
	{
		LPCancelReasonDB aDBOper = new LPCancelReasonDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLPCancelReason描述/A>表字段
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLPCancelReason>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			ReasonCode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 2, SysConst.PACKAGESPILTER );
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LPCancelReasonSchema other = (LPCancelReasonSchema)otherObject;
		return
