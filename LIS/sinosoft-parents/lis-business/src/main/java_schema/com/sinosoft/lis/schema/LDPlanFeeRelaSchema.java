...
import com.sinosoft.lis.db.LDPlanFeeRelaDB;

/*
 * <p>ClassName: LDPlanFeeRelaSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: PhysicalDataModel_1
 */
public class LDPlanFeeRelaSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LDPlanFeeRelaSchema.class);
	// @Field
	/** 保障计划代码 */
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LDPlanFeeRelaSchema cloned = (LDPlanFeeRelaSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LDPlanFeeRelaSchema 对象给 Schema 赋值
	* @param: aLDPlanFeeRelaSchema LDPlanFeeRelaSchema
	**/
	public void setSchema(LDPlanFeeRelaSchema aLDPlanFeeRelaSchema)
	{
		this.PlanCode = aLDPlanFeeRelaSchema.getPlanCode();
		this.RiskCode = aLDPlanFeeRelaSchema.getRiskCode();
		this.DutyCode = aLDPlanFeeRelaSchema.getDutyCode();
		this.GetDutyCode = aLDPlanFeeRelaSchema.getGetDutyCode();
		this.FeeCode = aLDPlanFeeRelaSchema.getFeeCode();
		this.StandFlag2 = aLDPlanFeeRelaSchema.getStandFlag2();
		this.FeeType = aLDPlanFeeRelaSchema.getFeeType();
		this.PreAuthFlag = aLDPlanFeeRelaSchema.getPreAuthFlag();
		this.MoneyLimitAnnual = aLDPlanFeeRelaSchema.getMoneyLimitAnnual();
		this.CountLimitAnnual = aLDPlanFeeRelaSchema.getCountLimitAnnual();
		this.DaysLimitAnnual = aLDPlanFeeRelaSchema.getDaysLimitAnnual();
		this.MoneyLimitEveryTime = aLDPlanFeeRelaSchema.getMoneyLimitEveryTime();
		this.DaysLimitEveryTime = aLDPlanFeeRelaSchema.getDaysLimitEveryTime();
		this.MoneyLimitEveryDay = aLDPlanFeeRelaSchema.getMoneyLimitEveryDay();
		this.PayMoneyEveryDay = aLDPlanFeeRelaSchema.getPayMoneyEveryDay();
		this.ObsPeriod = aLDPlanFeeRelaSchema.getObsPeriod();
		this.ObsPeriodUn = aLDPlanFeeRelaSchema.getObsPeriodUn();
		this.Operator = aLDPlanFeeRelaSchema.getOperator();
		this.MakeDate = fDate.getDate( aLDPlanFeeRelaSchema.getMakeDate());
		this.MakeTime = aLDPlanFeeRelaSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLDPlanFeeRelaSchema.getModifyDate());
		this.ModifyTime = aLDPlanFeeRelaSchema.getModifyTime();
		this.StandFlag1 = aLDPlanFeeRelaSchema.getStandFlag1();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LDPlanFeeRela表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LDPlanFeeRelaSchema";
	...
	public LDPlanFeeRelaSchema getSchema()
	{
		LDPlanFeeRelaSchema aLDPlanFeeRelaSchema = new LDPlanFeeRelaSchema();
		aLDPlanFeeRelaSchema.setSchema(this);
		return aLDPlanFeeRelaSchema;
	}

	public LDPlanFeeRelaDB getDB()
	{
		LDPlanFeeRelaDB aDBOper = new LDPlanFeeRelaDB();
	...
	**/
	public String encode()
	{
		...
		strReturn.append(StrTool.cTrim(StandFlag1));
		return strReturn.toString();
	}

	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLDPlanFeeRela>历史记账凭证主表信息</A>表字段
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LDPlanFeeRelaSchema other = (LDPlanFeeRelaSchema)otherObject;
		return
