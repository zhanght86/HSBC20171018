...
/*
 * <p>ClassName: LLUWRReportPrtDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 泰康未整理PDM
 */
public class LLUWRReportPrtDBSet extends LLUWRReportPrtSet
{
	// @Field
	...
	**/
	...
	// @Constructor
	public LLUWRReportPrtDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LLUWRReportPrtDBSet";
	...
	public boolean delete()
	{
		...
		try
		{
			...
			if(this.get(i).getAskCode() == null || this.get(i).getAskCode().equals("null")) {
				...
				pstmt.setString(3, this.get(i).getAskCode());
			}
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getAskCode() == null || this.get(i).getAskCode().equals("null")) {
				...
				pstmt.setString(5, this.get(i).getAskCode());
			}
			...
			if(this.get(i).getAskCode() == null || this.get(i).getAskCode().equals("null")) {
				...
				pstmt.setString(15, this.get(i).getAskCode());
			}
