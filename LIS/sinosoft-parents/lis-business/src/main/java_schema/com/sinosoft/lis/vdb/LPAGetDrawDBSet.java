...
/*
 * <p>ClassName: LPAGetDrawDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 多币种改造业务表
 */
public class LPAGetDrawDBSet extends LPAGetDrawSet
{
private static Logger logger = Logger.getLogger(LPAGetDrawDBSet.class);
	...
	**/
	...
	// @Constructor
	public LPAGetDrawDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LPAGetDrawDBSet";
	...
	public boolean delete()
	{
		...
		try
		{
			...
			if(this.get(i).getActuGetNo() == null || this.get(i).getActuGetNo().equals("null")) {
				...
				pstmt.setString(3, this.get(i).getActuGetNo());
			}
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getGetDate() == null || this.get(i).getGetDate().equals("null")) {
				...
				pstmt.setDate(13, Date.valueOf(this.get(i).getGetDate()));
			}
			pstmt.setDouble(14, this.get(i).getGetMoney());
			...
			if(this.get(i).getGetNoticeNo() == null || this.get(i).getGetNoticeNo().equals("null")) {
				...
				pstmt.setString(42, this.get(i).getGetNoticeNo());
			}
			...
			if(this.get(i).getRReportFlag() == null || this.get(i).getRReportFlag().equals("null")) {
				...
				pstmt.setString(45, this.get(i).getRReportFlag());
			}
			if(this.get(i).getComeFlag() == null || this.get(i).getComeFlag().equals("null")) {
				pstmt.setString(46,null);
			} else {
				pstmt.setString(46, this.get(i).getComeFlag());
			}
			...
			if(this.get(i).getDutyCode() == null || this.get(i).getDutyCode().equals("null")) {
				...
				pstmt.setString(52, this.get(i).getDutyCode());
			}
			if(this.get(i).getGetDutyKind() == null || this.get(i).getGetDutyKind().equals("null")) {
				pstmt.setString(53,null);
			} else {
				pstmt.setString(53, this.get(i).getGetDutyKind());
			}
			if(this.get(i).getGetDutyCode() == null || this.get(i).getGetDutyCode().equals("null")) {
				pstmt.setString(54,null);
			} else {
				pstmt.setString(54, this.get(i).getGetDutyCode());
			}
