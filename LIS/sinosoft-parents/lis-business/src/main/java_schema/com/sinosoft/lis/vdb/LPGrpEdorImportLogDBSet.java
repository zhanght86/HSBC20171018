...
/*
 * <p>ClassName: LPGrpEdorImportLogDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 泰康未整理PDM
 */
public class LPGrpEdorImportLogDBSet extends LPGrpEdorImportLogSet
{
	// @Field
	...
	**/
	...
	// @Constructor
	public LPGrpEdorImportLogDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public LPGrpEdorImportLogDBSet()
	{
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LPGrpEdorImportLogDBSet";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getPayNo() == null || this.get(i).getPayNo().equals("null")) {
				...
				pstmt.setString(9, this.get(i).getPayNo());
			}
			if(this.get(i).getReturnMSG() == null || this.get(i).getReturnMSG().equals("null")) {
				pstmt.setString(10,null);
			} else {
				pstmt.setString(10, this.get(i).getReturnMSG());
			}
