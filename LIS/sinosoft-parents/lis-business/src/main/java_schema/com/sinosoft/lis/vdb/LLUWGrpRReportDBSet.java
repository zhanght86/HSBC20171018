...
/*
 * <p>ClassName: LLUWGrpRReportDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 泰康未整理PDM
 */
public class LLUWGrpRReportDBSet extends LLUWGrpRReportSet
{
	// @Field
	...
	**/
	...
	// @Constructor
	public LLUWGrpRReportDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LLUWGrpRReportDBSet";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getPrintFlag() == null || this.get(i).getPrintFlag().equals("null")) {
				...
				pstmt.setString(4, this.get(i).getPrintFlag());
			}
			...
			if(this.get(i).getRReportReason() == null || this.get(i).getRReportReason().equals("null")) {
				...
				pstmt.setString(14, this.get(i).getRReportReason());
			}
			// set where condition
			if(this.get(i).getClmNo() == null || this.get(i).getClmNo().equals("null")) {
