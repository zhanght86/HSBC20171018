	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getOperState() == null || this.get(i).getOperState().equals("null")) {
				...
				pstmt.setString(37, this.get(i).getOperState());
			}
			if(this.get(i).getBILLPAYREASON() == null || this.get(i).getBILLPAYREASON().equals("null")) {
				pstmt.setString(38,null);
			} else {
				pstmt.setString(38, this.get(i).getBILLPAYREASON());
			}
			if(this.get(i).getInsuredNo() == null || this.get(i).getInsuredNo().equals("null")) {
				pstmt.setString(39,null);
			} else {
				pstmt.setString(39, this.get(i).getInsuredNo());
			}
			if(this.get(i).getDrawerType() == null || this.get(i).getDrawerType().equals("null")) {
				pstmt.setString(40,null);
			} else {
				pstmt.setString(40, this.get(i).getDrawerType());
			}
			if(this.get(i).getCurrency() == null || this.get(i).getCurrency().equals("null")) {
