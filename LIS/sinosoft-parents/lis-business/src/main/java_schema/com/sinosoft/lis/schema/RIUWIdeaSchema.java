...
import com.sinosoft.lis.db.RIUWIdeaDB;

/*
 * <p>ClassName: RIUWIdeaSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 再保系统模型
 */
public class RIUWIdeaSchema implements Schema, Cloneable
{
	// @Field
	/** 序列号 */
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		RIUWIdeaSchema cloned = (RIUWIdeaSchema)super.clone();
	...
	*/
	...
	/**
	* 01－个人新单 02－个人续期 03－个人保全 04－理赔 05－团体新单 06－团体保全
	*/
	...
	*/
	...
	/**
	* 使用另外一个 RIUWIdeaSchema 对象给 Schema 赋值
	* @param: aRIUWIdeaSchema RIUWIdeaSchema
	**/
	public void setSchema(RIUWIdeaSchema aRIUWIdeaSchema)
	{
		this.SerialNo = aRIUWIdeaSchema.getSerialNo();
		this.ProposalGrpContNo = aRIUWIdeaSchema.getProposalGrpContNo();
		this.ProposalContNo = aRIUWIdeaSchema.getProposalContNo();
		this.AuditType = aRIUWIdeaSchema.getAuditType();
		this.AuditCode = aRIUWIdeaSchema.getAuditCode();
		this.AuditAffixCode = aRIUWIdeaSchema.getAuditAffixCode();
		this.UWNo = aRIUWIdeaSchema.getUWNo();
		this.AdjunctPath = aRIUWIdeaSchema.getAdjunctPath();
		this.UWOperator = aRIUWIdeaSchema.getUWOperator();
		this.UWIdea = aRIUWIdeaSchema.getUWIdea();
		this.UWConclusion = aRIUWIdeaSchema.getUWConclusion();
		this.ManageCom = aRIUWIdeaSchema.getManageCom();
		this.Operator = aRIUWIdeaSchema.getOperator();
		this.MakeDate = fDate.getDate( aRIUWIdeaSchema.getMakeDate());
		this.MakeTime = aRIUWIdeaSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aRIUWIdeaSchema.getModifyDate());
		this.ModifyTime = aRIUWIdeaSchema.getModifyTime();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			System.out.println("数据库中的RIUWIdea表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "RIUWIdeaSchema";
	...
	public RIUWIdeaSchema getSchema()
	{
		RIUWIdeaSchema aRIUWIdeaSchema = new RIUWIdeaSchema();
		aRIUWIdeaSchema.setSchema(this);
		return aRIUWIdeaSchema;
	}

	public RIUWIdeaDB getDB()
	{
		RIUWIdeaDB aDBOper = new RIUWIdeaDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpRIUWIdea描述/A>表字段
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpRIUWIdea>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			UWOperator = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 9, SysConst.PACKAGESPILTER );
			UWIdea = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 10, SysConst.PACKAGESPILTER );
			UWConclusion = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 11, SysConst.PACKAGESPILTER );
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		RIUWIdeaSchema other = (RIUWIdeaSchema)otherObject;
		return
