...
/*
 * <p>ClassName: LCGrpEngineeringDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: Physical Data Model 1
 */
public class LCGrpEngineeringDBSet extends LCGrpEngineeringSet
{
	// @Field
	...
	**/
	...
	// @Constructor
	public LCGrpEngineeringDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LCGrpEngineeringDBSet";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getEnginName() == null || this.get(i).getEnginName().equals("null")) {
				...
				pstmt.setString(3, this.get(i).getEnginName());
			}
			if(this.get(i).getEnginType() == null || this.get(i).getEnginType().equals("null")) {
				pstmt.setString(4,null);
			} else {
				pstmt.setString(4, this.get(i).getEnginType());
			}
			...
			if(this.get(i).getPremCalMode() == null || this.get(i).getPremCalMode().equals("null")) {
				...
				pstmt.setString(19, this.get(i).getPremCalMode());
			}
			pstmt.setDouble(20, this.get(i).getPremFeeRate());
			pstmt.setDouble(21, this.get(i).getFirstPrem());
			pstmt.setInt(22, this.get(i).getContractorPeoples());
			if(this.get(i).getSafeProve() == null || this.get(i).getSafeProve().equals("null")) {
				pstmt.setString(23,null);
			} else {
				pstmt.setString(23, this.get(i).getSafeProve());
			}
			...
			if(this.get(i).getEnginDays() == null || this.get(i).getEnginDays().equals("null")) {
				...
				pstmt.setString(33, this.get(i).getEnginDays());
			}
			// set where condition
			if(this.get(i).getGrpContNo() == null || this.get(i).getGrpContNo().equals("null")) {
