...
/*
 * <p>ClassName: LPUWMasterMainDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 保全流程
 */
public class LPUWMasterMainDBSet extends LPUWMasterMainSet
{
private static Logger logger = Logger.getLogger(LPUWMasterMainDBSet.class);
	...
	**/
	...
	// @Constructor
	public LPUWMasterMainDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LPUWMasterMainDBSet";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getPassFlag() == null || this.get(i).getPassFlag().equals("null")) {
				...
				pstmt.setString(12, this.get(i).getPassFlag());
			}
			...
			if(this.get(i).getUWIdea() == null || this.get(i).getUWIdea().equals("null")) {
				...
				pstmt.setString(20, this.get(i).getUWIdea());
			}
			if(this.get(i).getUpReportContent() == null || this.get(i).getUpReportContent().equals("null")) {
				pstmt.setString(21,null);
			} else {
				pstmt.setString(21, this.get(i).getUpReportContent());
			}
