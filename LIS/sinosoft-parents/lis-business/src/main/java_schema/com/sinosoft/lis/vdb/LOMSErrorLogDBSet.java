...
/*
 * <p>ClassName: LOMSErrorLogDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 承保流程
 */
public class LOMSErrorLogDBSet extends LOMSErrorLogSet
{
	// @Field
	...
	**/
	...
	// @Constructor
	public LOMSErrorLogDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LOMSErrorLogDBSet";
...
ex.printStackTrace();
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getErrorLog() == null || this.get(i).getErrorLog().equals("null")) {
				pstmt.setString(15,null);
			} else {
				pstmt.setString(15, this.get(i).getErrorLog());
			}
			...
			if(this.get(i).getMSSeq() == null || this.get(i).getMSSeq().equals("null")) {
				...
				pstmt.setString(23, this.get(i).getMSSeq());
			}
