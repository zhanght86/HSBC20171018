...
/*
 * <p>ClassName: LPCUWSubDB </p>
 * <p>Description: DB层数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 保全流程
 */
public class LPCUWSubDB extends LPCUWSubSchema
{
private static Logger logger = Logger.getLogger(LPCUWSubDB.class);
	...
	**/
	...
	// @Constructor
	public LPCUWSubDB( Connection tConnection )
	{
		con = tConnection;
	...
	{
		LPCUWSubSchema tSchema = this.getSchema();
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.getCommonReason() == null || this.getCommonReason().equals("null")) {
				...
				pstmt.setString(41, this.getCommonReason());
			}
	...
	public boolean getInfo()
	{
		...
		try
		{
			pstmt = con.prepareStatement("SELECT * FROM LPCUWSub WHERE  EdorNo = ? AND EdorType = ? AND ContNo = ? AND UWNo = ?", 
	...
	public LPCUWSubSet query()
	{
		PreparedStatement pstmt = null;
 		ResultSet rs = null;
		LPCUWSubSet aLPCUWSubSet = new LPCUWSubSet();
	  ...
	  if( !mflag ) {
		...
		{
			SQLString sqlObj = new SQLString("LPCUWSub");
			LPCUWSubSchema aSchema = this.getSchema();
			...
			{
				i++;
				LPCUWSubSchema s1 = new LPCUWSubSchema();
				s1.setSchema(rs,i);
				aLPCUWSubSet.add(s1);
			}
			try{ rs.close(); } catch( Exception ex ) {}
	...
	public LPCUWSubSet executeQuery(String sql)
	{
		Statement stmt = null;
		ResultSet rs = null;
		LPCUWSubSet aLPCUWSubSet = new LPCUWSubSet();
	...
	public LPCUWSubSet query(int nStart, int nCount)
	{
		PreparedStatement pstmt = null;
 		ResultSet rs = null;
		LPCUWSubSet aLPCUWSubSet = new LPCUWSubSet();
	...
	public LPCUWSubSet executeQuery(String sql, int nStart, int nCount)
	{
		Statement stmt = null;
		ResultSet rs = null;
		LPCUWSubSet aLPCUWSubSet = new LPCUWSubSet();
	...
	public boolean update(String strWherePart)
	{
	  ...
	  if( !mflag ) {
		...
		try
		{
			...
			String sql = "update LPCUWSub " + sqlObj.getUpdPart() + " where " + strWherePart;
 ...
 * @return LPCUWSubSet
 */
public LPCUWSubSet getData()
{
    int tCount = 0;
    LPCUWSubSet tLPCUWSubSet = new LPCUWSubSet();
    LPCUWSubSchema tLPCUWSubSchema = null;
    if (null == mResultSet)
    {
        CError tError = new CError();
        tError.moduleName = "LPCUWSubDB";
    ...
    try
    {
        ...
        tLPCUWSubSchema.setSchema(mResultSet, 1);
        tLPCUWSubSet.add(tLPCUWSubSchema);
...
public boolean closeData()
{
	...
	public LPCUWSubSet executeQuery(SQLwithBindVariables sqlbv) {
	...
	public LPCUWSubSet executeQuery(SQLwithBindVariables sqlbv, int nStart, int nCount) {
