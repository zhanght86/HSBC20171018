...
import com.sinosoft.lis.db.RIBsnsBillModifyDB;

/*
 * <p>ClassName: RIBsnsBillModifySchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 再保系统模型
 */
public class RIBsnsBillModifySchema implements Schema, Cloneable
{
	// @Field
	/** 备份序号 */
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		RIBsnsBillModifySchema cloned = (RIBsnsBillModifySchema)super.clone();
	...
	/**
	* 使用另外一个 RIBsnsBillModifySchema 对象给 Schema 赋值
	* @param: aRIBsnsBillModifySchema RIBsnsBillModifySchema
	**/
	public void setSchema(RIBsnsBillModifySchema aRIBsnsBillModifySchema)
	{
		this.BackupNo = aRIBsnsBillModifySchema.getBackupNo();
		this.BatchNo = aRIBsnsBillModifySchema.getBatchNo();
		this.BillNo = aRIBsnsBillModifySchema.getBillNo();
		this.Currency = aRIBsnsBillModifySchema.getCurrency();
		this.Operator = aRIBsnsBillModifySchema.getOperator();
		this.ManageCom = aRIBsnsBillModifySchema.getManageCom();
		this.MakeDate = fDate.getDate( aRIBsnsBillModifySchema.getMakeDate());
		this.MakeTime = aRIBsnsBillModifySchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aRIBsnsBillModifySchema.getModifyDate());
		this.ModifyTime = aRIBsnsBillModifySchema.getModifyTime();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			System.out.println("数据库中的RIBsnsBillModify表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			sqle.printStackTrace();
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "RIBsnsBillModifySchema";
	...
	public RIBsnsBillModifySchema getSchema()
	{
		RIBsnsBillModifySchema aRIBsnsBillModifySchema = new RIBsnsBillModifySchema();
		aRIBsnsBillModifySchema.setSchema(this);
		return aRIBsnsBillModifySchema;
	}

	public RIBsnsBillModifyDB getDB()
	{
		RIBsnsBillModifyDB aDBOper = new RIBsnsBillModifyDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpRIBsnsBillModify描述/A>表字段
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpRIBsnsBillModify>历史记账凭证主表信息</A>表字段
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		RIBsnsBillModifySchema other = (RIBsnsBillModifySchema)otherObject;
		return
