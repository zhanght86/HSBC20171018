...
/*
 * <p>ClassName: LJAPayContDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 寿险业务收费
 */
public class LJAPayContDBSet extends LJAPayContSet
{
	// @Field
	...
	**/
	...
	// @Constructor
	public LJAPayContDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LJAPayContDBSet";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getPayNo() == null || this.get(i).getPayNo().equals("null")) {
				...
				pstmt.setString(4, this.get(i).getPayNo());
			}
			...
			if(this.get(i).getGetNoticeNo() == null || this.get(i).getGetNoticeNo().equals("null")) {
				...
				pstmt.setString(20, this.get(i).getGetNoticeNo());
			}
			...
			if(this.get(i).getPayNo() == null || this.get(i).getPayNo().equals("null")) {
				...
				pstmt.setString(48, this.get(i).getPayNo());
			}
