...
/*
 * <p>ClassName: LCPENoticeItemDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 承保流程
 */
public class LCPENoticeItemDBSet extends LCPENoticeItemSet
{
private static Logger logger = Logger.getLogger(LCPENoticeItemDBSet.class);
	...
	**/
	...
	// @Constructor
	public LCPENoticeItemDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LCPENoticeItemDBSet";
