...
/*
 * <p>ClassName: LBInsureAccClassFeeDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 多币种改造业务表
 */
public class LBInsureAccClassFeeDBSet extends LBInsureAccClassFeeSet
{
private static Logger logger = Logger.getLogger(LBInsureAccClassFeeDBSet.class);
	...
	**/
	...
	// @Constructor
	public LBInsureAccClassFeeDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public LBInsureAccClassFeeDBSet()
	{
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LBInsureAccClassFeeDBSet";
	...
	public boolean delete()
	{
		...
		try
		{
			...
			if(this.get(i).getAccAscription() == null || this.get(i).getAccAscription().equals("null")) {
				...
				pstmt.setString(6, StrTool.space1(this.get(i).getAccAscription(), 1));
			}
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getOtherType() == null || this.get(i).getOtherType().equals("null")) {
				...
				pstmt.setString(6, this.get(i).getOtherType());
			}
			if(this.get(i).getAccAscription() == null || this.get(i).getAccAscription().equals("null")) {
				pstmt.setString(7,null);
			} else {
				pstmt.setString(7, this.get(i).getAccAscription());
			}
			...
			if(this.get(i).getAccType() == null || this.get(i).getAccType().equals("null")) {
				...
				pstmt.setString(15, this.get(i).getAccType());
			}
			...
			if(this.get(i).getBalaTime() == null || this.get(i).getBalaTime().equals("null")) {
				...
				pstmt.setString(20, this.get(i).getBalaTime());
			}
			pstmt.setDouble(21, this.get(i).getFeeRate());
			pstmt.setDouble(22, this.get(i).getFee());
			pstmt.setDouble(23, this.get(i).getFeeUnit());
			...
			if(this.get(i).getFeeCode() == null || this.get(i).getFeeCode().equals("null")) {
				...
				pstmt.setString(29, this.get(i).getFeeCode());
			}
			if(this.get(i).getIsInitFee() == null || this.get(i).getIsInitFee().equals("null")) {
				pstmt.setString(30,null);
			} else {
				pstmt.setString(30, this.get(i).getIsInitFee());
			}
			...
			if(this.get(i).getPolNo() == null || this.get(i).getPolNo().equals("null")) {
				...
				pstmt.setString(33, this.get(i).getPolNo());
			}
			if(this.get(i).getInsuAccNo() == null || this.get(i).getInsuAccNo().equals("null")) {
				pstmt.setString(34,null);
			} else {
				pstmt.setString(34, this.get(i).getInsuAccNo());
			}
			if(this.get(i).getPayPlanCode() == null || this.get(i).getPayPlanCode().equals("null")) {
				pstmt.setString(35,null);
			} else {
				pstmt.setString(35, this.get(i).getPayPlanCode());
			}
			if(this.get(i).getOtherNo() == null || this.get(i).getOtherNo().equals("null")) {
			...
			if(this.get(i).getAccAscription() == null || this.get(i).getAccAscription().equals("null")) {
				...
				pstmt.setString(37, StrTool.space1(this.get(i).getAccAscription(), 1));
			}
