...
import com.sinosoft.lis.db.LLBBnfDB;

/*
 * <p>ClassName: LLBBnfSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 多币种改造业务表
 */
public class LLBBnfSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LLBBnfSchema.class);
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LLBBnfSchema cloned = (LLBBnfSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LLBBnfSchema 对象给 Schema 赋值
	* @param: aLLBBnfSchema LLBBnfSchema
	**/
	public void setSchema(LLBBnfSchema aLLBBnfSchema)
	{
		this.BackNo = aLLBBnfSchema.getBackNo();
		this.ClmNo = aLLBBnfSchema.getClmNo();
		this.CaseNo = aLLBBnfSchema.getCaseNo();
		this.BatNo = aLLBBnfSchema.getBatNo();
		this.OtherNo = aLLBBnfSchema.getOtherNo();
		this.OtherNoType = aLLBBnfSchema.getOtherNoType();
		this.GrpContNo = aLLBBnfSchema.getGrpContNo();
		this.GrpPolNo = aLLBBnfSchema.getGrpPolNo();
		this.ContNo = aLLBBnfSchema.getContNo();
		this.BnfKind = aLLBBnfSchema.getBnfKind();
		this.PolNo = aLLBBnfSchema.getPolNo();
		this.InsuredNo = aLLBBnfSchema.getInsuredNo();
		this.BnfNo = aLLBBnfSchema.getBnfNo();
		this.BnfType = aLLBBnfSchema.getBnfType();
		this.BnfGrade = aLLBBnfSchema.getBnfGrade();
		this.RelationToInsured = aLLBBnfSchema.getRelationToInsured();
		this.CustomerNo = aLLBBnfSchema.getCustomerNo();
		this.Name = aLLBBnfSchema.getName();
		this.Sex = aLLBBnfSchema.getSex();
		this.Birthday = fDate.getDate( aLLBBnfSchema.getBirthday());
		this.IDType = aLLBBnfSchema.getIDType();
		this.IDNo = aLLBBnfSchema.getIDNo();
		this.RelationToPayee = aLLBBnfSchema.getRelationToPayee();
		this.PayeeNo = aLLBBnfSchema.getPayeeNo();
		this.PayeeName = aLLBBnfSchema.getPayeeName();
		this.PayeeSex = aLLBBnfSchema.getPayeeSex();
		this.PayeeBirthday = fDate.getDate( aLLBBnfSchema.getPayeeBirthday());
		this.PayeeIDType = aLLBBnfSchema.getPayeeIDType();
		this.PayeeIDNo = aLLBBnfSchema.getPayeeIDNo();
		this.BnfLot = aLLBBnfSchema.getBnfLot();
		this.GetMoney = aLLBBnfSchema.getGetMoney();
		this.CaseGetMode = aLLBBnfSchema.getCaseGetMode();
		this.CasePayMode = aLLBBnfSchema.getCasePayMode();
		this.CasePayFlag = aLLBBnfSchema.getCasePayFlag();
		this.BankCode = aLLBBnfSchema.getBankCode();
		this.BankAccNo = aLLBBnfSchema.getBankAccNo();
		this.AccName = aLLBBnfSchema.getAccName();
		this.ModiReasonCode = aLLBBnfSchema.getModiReasonCode();
		this.ModiReasonDesc = aLLBBnfSchema.getModiReasonDesc();
		this.OBankCode = aLLBBnfSchema.getOBankCode();
		this.OBankAccNo = aLLBBnfSchema.getOBankAccNo();
		this.OAccName = aLLBBnfSchema.getOAccName();
		this.Operator = aLLBBnfSchema.getOperator();
		this.MakeDate = fDate.getDate( aLLBBnfSchema.getMakeDate());
		this.MakeTime = aLLBBnfSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLLBBnfSchema.getModifyDate());
		this.ModifyTime = aLLBBnfSchema.getModifyTime();
		this.NBPolNo = aLLBBnfSchema.getNBPolNo();
		this.FeeOperationType = aLLBBnfSchema.getFeeOperationType();
		this.Currency = aLLBBnfSchema.getCurrency();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LLBBnf表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LLBBnfSchema";
	...
	public LLBBnfSchema getSchema()
	{
		LLBBnfSchema aLLBBnfSchema = new LLBBnfSchema();
		aLLBBnfSchema.setSchema(this);
		return aLLBBnfSchema;
	}

	public LLBBnfDB getDB()
	{
		LLBBnfDB aDBOper = new LLBBnfDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLLBBnf描述/A>表字段
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLLBBnf>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			BnfKind = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 10, SysConst.PACKAGESPILTER );
			...
			BnfNo = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 13, SysConst.PACKAGESPILTER );
			BnfType = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 14, SysConst.PACKAGESPILTER );
			BnfGrade = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 15, SysConst.PACKAGESPILTER );
			RelationToInsured = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 16, SysConst.PACKAGESPILTER );
			CustomerNo = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 17, SysConst.PACKAGESPILTER );
			Name = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 18, SysConst.PACKAGESPILTER );
			Sex = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 19, SysConst.PACKAGESPILTER );
			Birthday = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 20,SysConst.PACKAGESPILTER));
			...
			RelationToPayee = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 23, SysConst.PACKAGESPILTER );
			PayeeNo = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 24, SysConst.PACKAGESPILTER );
			PayeeName = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 25, SysConst.PACKAGESPILTER );
			PayeeSex = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 26, SysConst.PACKAGESPILTER );
			PayeeBirthday = fDate.getDate(StrTool.getStr(StrTool.GBKToUnicode(strMessage), 27,SysConst.PACKAGESPILTER));
			PayeeIDType = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 28, SysConst.PACKAGESPILTER );
			PayeeIDNo = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 29, SysConst.PACKAGESPILTER );
			BnfLot = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,30,SysConst.PACKAGESPILTER))).doubleValue();
			GetMoney = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,31,SysConst.PACKAGESPILTER))).doubleValue();
			CaseGetMode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 32, SysConst.PACKAGESPILTER );
			CasePayMode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 33, SysConst.PACKAGESPILTER );
			CasePayFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 34, SysConst.PACKAGESPILTER );
			BankCode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 35, SysConst.PACKAGESPILTER );
			BankAccNo = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 36, SysConst.PACKAGESPILTER );
			AccName = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 37, SysConst.PACKAGESPILTER );
			ModiReasonCode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 38, SysConst.PACKAGESPILTER );
			ModiReasonDesc = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 39, SysConst.PACKAGESPILTER );
			OBankCode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 40, SysConst.PACKAGESPILTER );
			OBankAccNo = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 41, SysConst.PACKAGESPILTER );
			OAccName = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 42, SysConst.PACKAGESPILTER );
			...
			NBPolNo = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 48, SysConst.PACKAGESPILTER );
			FeeOperationType = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 49, SysConst.PACKAGESPILTER );
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LLBBnfSchema other = (LLBBnfSchema)otherObject;
		return
