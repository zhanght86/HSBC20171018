...
/*
 * <p>ClassName: LMCalFactorSortDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 新险种定义
 */
public class LMCalFactorSortDBSet extends LMCalFactorSortSet
{
private static Logger logger = Logger.getLogger(LMCalFactorSortDBSet.class);
	...
	**/
	...
	// @Constructor
	public LMCalFactorSortDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LMCalFactorSortDBSet";
