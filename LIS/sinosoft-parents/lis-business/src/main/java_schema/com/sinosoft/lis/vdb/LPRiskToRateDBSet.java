...
/*
 * <p>ClassName: LPRiskToRateDBSet </p>
 * <p>Description: DB层多记录数据库操作类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: 费率表维护
 */
public class LPRiskToRateDBSet extends LPRiskToRateSet
{
	// @Field
	...
	**/
	...
	// @Constructor
	public LPRiskToRateDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean deleteSQL()
	{
		...
		else
		{
			...
			tError.moduleName = "LPRiskToRateDBSet";
	...
	public boolean update()
	{
		...
		try
		{
			...
			if(this.get(i).getRateType() == null || this.get(i).getRateType().equals("null")) {
				...
				pstmt.setString(15, this.get(i).getRateType());
			}
			if(this.get(i).getRateTable() == null || this.get(i).getRateTable().equals("null")) {
				pstmt.setString(16,null);
			} else {
				pstmt.setString(16, this.get(i).getRateTable());
			}
