...
import com.sinosoft.lis.db.LSQuotPlanDetailTraceDB;

/*
 * <p>ClassName: LSQuotPlanDetailTraceSchema </p>
 * <p>Description: DB层 Schema 类文件 </p>
 * <p>Copyright: Copyright (c) 2007</p>
 * <p>Company: sinosoft </p>
 * @Database: Physical Data Model 1
 */
public class LSQuotPlanDetailTraceSchema implements Schema, Cloneable
{
private static Logger logger = Logger.getLogger(LSQuotPlanDetailTraceSchema.class);
	// @Field
	/** 流水号 */
	...
	// @Constructor
	public LSQuotPlanDetailTraceSchema()
	{
		mErrors = new CErrors();
	...
	*/
	public Object clone()
		throws CloneNotSupportedException
	{
		LSQuotPlanDetailTraceSchema cloned = (LSQuotPlanDetailTraceSchema)super.clone();
	...
	*/
	...
	/**
	* 使用另外一个 LSQuotPlanDetailTraceSchema 对象给 Schema 赋值
	* @param: aLSQuotPlanDetailTraceSchema LSQuotPlanDetailTraceSchema
	**/
	public void setSchema(LSQuotPlanDetailTraceSchema aLSQuotPlanDetailTraceSchema)
	{
		this.SerialNo = aLSQuotPlanDetailTraceSchema.getSerialNo();
		this.QuotNo = aLSQuotPlanDetailTraceSchema.getQuotNo();
		this.QuotBatNo = aLSQuotPlanDetailTraceSchema.getQuotBatNo();
		this.SysPlanCode = aLSQuotPlanDetailTraceSchema.getSysPlanCode();
		this.PlanCode = aLSQuotPlanDetailTraceSchema.getPlanCode();
		this.RiskCode = aLSQuotPlanDetailTraceSchema.getRiskCode();
		this.DutyCode = aLSQuotPlanDetailTraceSchema.getDutyCode();
		this.AmntType = aLSQuotPlanDetailTraceSchema.getAmntType();
		this.FixedAmnt = aLSQuotPlanDetailTraceSchema.getFixedAmnt();
		this.SalaryMult = aLSQuotPlanDetailTraceSchema.getSalaryMult();
		this.MaxAmnt = aLSQuotPlanDetailTraceSchema.getMaxAmnt();
		this.MinAmnt = aLSQuotPlanDetailTraceSchema.getMinAmnt();
		this.ExceptPremType = aLSQuotPlanDetailTraceSchema.getExceptPremType();
		this.ExceptPrem = aLSQuotPlanDetailTraceSchema.getExceptPrem();
		this.StandValue = aLSQuotPlanDetailTraceSchema.getStandValue();
		this.InitPrem = aLSQuotPlanDetailTraceSchema.getInitPrem();
		this.ExceptYield = aLSQuotPlanDetailTraceSchema.getExceptYield();
		this.SubUWValue = aLSQuotPlanDetailTraceSchema.getSubUWValue();
		this.BranchUWValue = aLSQuotPlanDetailTraceSchema.getBranchUWValue();
		this.UWValue = aLSQuotPlanDetailTraceSchema.getUWValue();
		this.FinalValue = aLSQuotPlanDetailTraceSchema.getFinalValue();
		this.FinalPrem = aLSQuotPlanDetailTraceSchema.getFinalPrem();
		this.FinalAmnt = aLSQuotPlanDetailTraceSchema.getFinalAmnt();
		this.RelaShareFlag = aLSQuotPlanDetailTraceSchema.getRelaShareFlag();
		this.Remark = aLSQuotPlanDetailTraceSchema.getRemark();
		this.MakeOperator = aLSQuotPlanDetailTraceSchema.getMakeOperator();
		this.MakeDate = fDate.getDate( aLSQuotPlanDetailTraceSchema.getMakeDate());
		this.MakeTime = aLSQuotPlanDetailTraceSchema.getMakeTime();
		this.ModifyOperator = aLSQuotPlanDetailTraceSchema.getModifyOperator();
		this.ModifyDate = fDate.getDate( aLSQuotPlanDetailTraceSchema.getModifyDate());
		this.ModifyTime = aLSQuotPlanDetailTraceSchema.getModifyTime();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		{
			logger.debug("数据库中的LSQuotPlanDetailTrace表字段个数和Schema中的字段个数不一致，或者执行db.executeQuery查询时没有使用select * from tables");
			// @@错误处理
			CError tError = new CError();
			tError.moduleName = "LSQuotPlanDetailTraceSchema";
	...
	public LSQuotPlanDetailTraceSchema getSchema()
	{
		LSQuotPlanDetailTraceSchema aLSQuotPlanDetailTraceSchema = new LSQuotPlanDetailTraceSchema();
		aLSQuotPlanDetailTraceSchema.setSchema(this);
		return aLSQuotPlanDetailTraceSchema;
	}

	public LSQuotPlanDetailTraceDB getDB()
	{
		LSQuotPlanDetailTraceDB aDBOper = new LSQuotPlanDetailTraceDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLSQuotPlanDetailTrace描述/A>表字段
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLSQuotPlanDetailTrace>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			AmntType = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 8, SysConst.PACKAGESPILTER );
			FixedAmnt = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 9, SysConst.PACKAGESPILTER );
			SalaryMult = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 10, SysConst.PACKAGESPILTER );
			MaxAmnt = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 11, SysConst.PACKAGESPILTER );
			MinAmnt = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 12, SysConst.PACKAGESPILTER );
			ExceptPremType = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 13, SysConst.PACKAGESPILTER );
			ExceptPrem = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 14, SysConst.PACKAGESPILTER );
			StandValue = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 15, SysConst.PACKAGESPILTER );
			InitPrem = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 16, SysConst.PACKAGESPILTER );
			ExceptYield = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 17, SysConst.PACKAGESPILTER );
			SubUWValue = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 18, SysConst.PACKAGESPILTER );
			BranchUWValue = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 19, SysConst.PACKAGESPILTER );
			UWValue = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 20, SysConst.PACKAGESPILTER );
			FinalValue = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 21, SysConst.PACKAGESPILTER );
			FinalPrem = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 22, SysConst.PACKAGESPILTER );
			FinalAmnt = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 23, SysConst.PACKAGESPILTER );
			RelaShareFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 24, SysConst.PACKAGESPILTER );
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LSQuotPlanDetailTraceSchema other = (LSQuotPlanDetailTraceSchema)otherObject;
		return
