<%
/***************************************************************
 * <p>ProName：BalanceQueryInput.jsp</p>
 * <p>Title：结算单查询</p>
...
<head >
	...
	<script src="./BalanceQueryInput.js"></script>
	<%@include file="./BalanceQueryInit.jsp"%>
</head>
...
<form name=fm id=fm method=post action="" target=fraSubmit>
	...
	<div id="divQuery" class=maxbox1 style="display: ''">
		...
		<!--<input class=cssButton name=QueryButton type=button value="结算单导出" onclick="exportData('xlsx');">-->
	</div>
	...
	<div id="divContInfoGrid" style="display: ''">
		...
		<!--<input class=cssButton type=button value="结算单明细导出" onclick="balanceExport();">	-->
	</div>
