<%
/***************************************************************
 * <p>ProName：BalanceCancleInput.jsp</p>
 * <p>Title：结算单撤销</p>
...
<head >
	...
	<script src="./BalanceCancleInput.js"></script>
	<%@include file="./BalanceCancleInit.jsp"%>
</head>
...
<form name=fm  id=fm method=post action="" target=fraSubmit>
	...
	<div id="divQuery" class=maxbox1 style="display: ''">
		<table class=common>
			<tr class=common>
				...
				<td class=input><input class=codeno name=Managecom readonly style="background:url(../common/images/select--bg_03.png) no-repeat right center"
			...
			<tr class=common>
				...
				<td class=input><input class=codeno name=BalanceType readonly style="background:url(../common/images/select--bg_03.png) no-repeat right center"
					ondblclick="return showCodeList('balancetype',[this,BalanceTypeName],[0, 1],null,null,null,'1',180);" 
					onkeyup="return showCodeListKey('balancetype',[this,BalanceTypeName],[0, 1],null,null,null,'1',180);"><input class=codename name=BalanceTypeName readonly></td>
				<td class=title></td>
				<td class=input></td>
				<td class=title></td>
				<td class=input></td>
	...
	<div id="divContInfoGrid" style="display: ''">
		...
		<input class=cssButton type=button value="结算单撤销" onclick="">	
	</div>
