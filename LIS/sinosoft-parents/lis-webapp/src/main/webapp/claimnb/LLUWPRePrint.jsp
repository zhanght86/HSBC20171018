...
<Input class= "codeno" type=hidden name = CodeS value="LP90" ondblclick="return showCodeList('lluwnoticeprint',[this,NoticeTypeName],[0,1]);" onkeyup="return showCodeListKey('lluwnoticeprint',[this,NoticeTypeName],[0,1]);"><!-- <Input class = codename name= NoticeTypeName readonly = true > -->
