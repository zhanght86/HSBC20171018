...
function initInpBox()
{
	...
	{
		alert("在BodyCheckPrintInit.jsp-->InitInpBox函数中发生异常:初始化界面错误!"+ex.name +":"+ex.message);
	}
}
...
function initForm()
{
	...
	{
		alert("BodyCheckPrintInit.jsp-->InitForm函数中发生异常:初始化界面错误!"+re.name +":"+re.message);
	}
}
	...
	var config ={
			...
			public : {
				query : {
					...
					arrayInfo : {
						col : {
							result0 : {title : "  印刷号   ",style : 1,colNo : 2},
							result1 : {title : "  合同号   ",style : 1,colNo : 1},
							result2 : {title : " 流水号 ",style : 3},
							result3 : {
								title : "代理人编码",
								style : 2,
								colNo : 4,
							...
							result9 : {title : "旧体检通知书流水号",style : 3}
				...
				result : {
					...
					arrayInfo : {
						col : {
							...
							col6 : "0",
							col7 : "0",
							result0 : {title : "  印刷号   ",style : 1,colNo : 7},
							result1 : {title : "  合同号   ",style : 1,colNo : 2},
							result2 : {title : "  流水号  ",style : 1,colNo : 1},
							result3 : {title : " 代理人编码",style : 1,colNo : 3},
							result4 : {title : " 代理人组别",style : 1,colNo : 4},
							result5 : {title : "  展业机构  ",style : 1,colNo : 5},
							result6 : {title : " 管理机构",style : 1,colNo : 6},
							result7 : {title : "赔案号",style : 3},
							result8 : {title : "批次号",style : 3},
							result9 : {title : "旧体检通知书流水号",style : 3}
						}
