...
<%
  ...
  loggerDebug("LLUWPSendAllInit","ContNo:"+tContNo);
  loggerDebug("LLUWPSendAllInit","Flag:"+tFlag);
...
function initForm(tContNo,tMissionID,tSubMissionID,tEdorNo,tEdorType,tClmNo)
{
  try
  {
	...
	initHide(tContNo,tMissionID,tSubMissionID,tEdorNo,tEdorType,tClmNo);
	initLWMission();
	initLoprtManager();
...
function initQuestionTypeGrid()
{
    var iArray = new Array();
      ...
      //QuestionTypeGrid.hiddenPlus        = 1;
      //QuestionTypeGrid.hiddenSubtraction = 1;
...
function initHide(tContNo,tMissionID,tSubMissionID,tEdorNo,tEdorType,tClmNo)
{
