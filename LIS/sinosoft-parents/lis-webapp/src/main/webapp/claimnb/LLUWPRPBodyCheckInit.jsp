...
//modify by lzf
function initUWPRPBodyPool(){
	var config = {
			//activityId : "0000005532",
			functionId : "10030022",
			//operator : operator,
			public : {
				query : {
					...
					arrayInfo : {
						col : {
							...
							result9 : {title : "回收批次",style : 3},
							result10 : {title : "原体检通知书流水号",style : 1,colNo : 2}
						}
					}
				},
				resultTitle : "补打通知书信息",
				result : {
					condition : {
						...
						"1" : false,
						"2" : false,
						"5" : " and code ='LP03' and managecom like '"+strManageCom+"%' "
					},
					mulLineCount : 10,
					arrayInfo : {
						col : {
							...
							col7 : "0",
							result0 : {title : "  印刷号   ",style : 3},
							result1 : {title : "  合同号   ",style : 1,colNo : 3},
	...
	jQuery("#UWPRPBodyPool").workpool(config);
}
//end 
