...
<body  onload="initForm();" >
    ...
    <Div  id= "divInsuBonusRate" style= "display: ''" class="maxbox1">
      <table  class= common>
        <TR  class= common>
          ...
          <TD  class= input5>
          	<Input class="wid" class= common  readonly  name=FiscalYear id=FiscalYear  verify="会计年度 |notnull">
          </TD>                   
        </TR>              
   </table>       
    </Div>   
  ...
  <Div id= "divOperate" style= "display: ''">
			<!--<INPUT class=cssButton name="addbutton" VALUE="上线确认"  TYPE=button onclick="return updateClick();">-->
            <a href="javascript:void(0);" name="addbutton" class="button" onClick="return updateClick();">上线确认</a>
