...
<form method=post name=fm id=fm target="fraSubmit" >
    ...
    <table  class= common align=center>
      <TR  class= common>
        ...
        <TD  class= input5><Input class="common wid" name=GrpPolNo id=GrpPolNo></TD>
		<TD  class= title5>分红状态</TD>
	    <TD  class= input5><Input class="common wid" name=Type id=Type ></TD>                    
      </TR>
      <TR  class= common>
        <TD  class= title5>会计年度</TD>
        <TD  class= input5><Input class="common wid" name=FiscalYear id=FiscalYear></TD>  
