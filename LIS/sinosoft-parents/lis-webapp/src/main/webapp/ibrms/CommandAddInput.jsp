...
<script src="CommandAddInput.js"></script>
...
<table class=common >
	<TR class=common>
		...
		<TD class=input5><Input class="wid" class=common name=Name id=Name
		...
		<TD class=input5><Input style="background:url(../common/images/select--bg_03.png) no-repeat right center" name=Valid id=Valid class=codeno
			...
			onkeyup="return showCodeListKey('IbrmsValid',[this,ValidName],[0,1]);" readonly><input class=codename name="ValidName" id="ValidName" elementtype=nacessary verify="有效性|NOTNULL" readonly></TD>
	</TR>
...
<table class=common>--><tr class=common><TD class=title5>函数参数明细(参数间用','分隔)</TD>
	<TD class=input5><Input class="wid" class=common name=CommDetail id=CommDetail ></TD>
	<TD class=title5></TD>
	<TD class=title5></TD></tr>
	</table>
</div>
</div>
