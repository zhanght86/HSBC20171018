...
//		tTransferData.setNameAndValue("StartDate",request.getParameter("StartDate"));
		...
		String tPrtNo [] = request.getParameterValues("CodeGrid2");  //得到第2列的所有值
		String tContNo [] = request.getParameterValues("CodeGrid3");  //得到第3列的所有值
		String tAppntName [] = request.getParameterValues("CodeGrid4");  //得到第4列的所有值
		String tRiskCode [] = request.getParameterValues("CodeGrid5");  //得到第5列的所有值
		String tPaytoDate [] = request.getParameterValues("CodeGrid6");  //得到第6列的所有值
		String tBankAccNo [] = request.getParameterValues("CodeGrid7");  //得到第7列的所有值
		String tGetNoticeNo [] = request.getParameterValues("CodeGrid8");  //得到第8列的所有值
		String tManageCom [] = request.getParameterValues("CodeGrid9");  //得到第9列的所有值
		String tAgentCom [] = request.getParameterValues("CodeGrid10");  		//得到第10列的所有值
		...
		loggerDebug("RenewBankConfirmSave","共" + tLYRenewBankInfoSet.size() + "条数据");
