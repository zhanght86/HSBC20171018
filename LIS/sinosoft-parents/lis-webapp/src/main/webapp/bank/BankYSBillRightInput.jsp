  	...
  	<form action="./PrintBill.jsp" method=post name=fm target="fraSubmit">
    	...
    	<table class=common>
          ...
          <TD class="common">
            ...
            <TD class= titleImg > 银行转账代收成功清单 </TD>
          </tr>
        </table>
...
<font color='red'>*</font> </TD>
            ...
            <TD  class=input5> <Input class="common wid" name=SXFlag   id=SXFlag CodeData="0|^S|首期^X|续期^B|保全^L|理赔"
...
<a href="javascript:void(0);" class="button"onClick="PrintBill()">打印批单</a>
			...
			<!--
					 <TR  class= common>
            <TD> <input class=cssButton type=button value="列出打印批号" onClick="showSerialNo()"> </TD>
            <TD class=input > <input class=cssButton type=button value="打印批单" onClick="PrintBill()"> </TD>-->
          <table>
    	<tr>  
          <TD  class= input>
