...
src="../common/laydate/skins/default/icon.png" /></a></span>
		...
		<input class= cssButton type=Button value="转帐确认" name="confirm" onClick="submitForm()">-->
        <a href="javascript:void(0);" class="button"onClick="easyQueryClick()">查   询</a>
        <a href="javascript:void(0);" class="button"name="confirm" onClick="submitForm()">转帐确认</a>
  <br><br>
