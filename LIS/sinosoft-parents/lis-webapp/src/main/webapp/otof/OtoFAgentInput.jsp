  ...
  <form method=post name=fm id=fm action= "./OtoFLASave.jsp" target="fraSubmit">
    ...
    <table  class= common>
			...
			<TR class= common>
				...
				<TD  class= input5><Input class="wid" class= readonly name=VouchNo id=VouchNo value="10"></TD>
    ...
    <!--<INPUT  class=cssButton VALUE="提取凭证" name="distill" TYPE=button onclick="SubmitFormAgent();">-->
    <a href="javascript:void(0);" name="distill" class="button" onClick="SubmitFormAgent();">提取凭证</a>
  </form>
