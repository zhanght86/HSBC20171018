  ...
  <form method=post name=fm id=fm action= "./OtoFLASave.jsp" target="fraSubmit">
    ...
    <table  class= common>
			...
			<TR class= common>
				...
				<TD  class= input5><Input class="wid" class= readonly name=VouchNo id=VouchNo value="22"></TD>
    ...
    <a href="javascript:void(0);" name="distill" class="button" onClick="SubmitFormXiAgent();">提取凭证</a>
  </form>
