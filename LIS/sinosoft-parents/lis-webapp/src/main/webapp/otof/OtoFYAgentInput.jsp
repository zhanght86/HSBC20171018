...
<body>
  <form method=post name=fm id=fm action= "./OtoFLASave.jsp" target="fraSubmit">
    ...
    <!--<INPUT  class=cssButton VALUE="提取凭证" name="distill" TYPE=button onclick="SubmitFormYAgent();">-->
    <a href="javascript:void(0);" name="distill" class="button" onClick="SubmitFormYAgent();">提取凭证</a>
  </form>
