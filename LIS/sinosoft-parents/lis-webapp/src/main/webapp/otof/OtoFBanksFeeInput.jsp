...
<meta http-equiv="Content-Type" content="text/html; charset=GBK">
	...
	<title>银代手续费财务接口</title>
</head>
<body>
  <form method=post name=fm id=fm action= "./OtoFLASave.jsp" target="fraSubmit">
    <!-- 保单信息部分 -->
    ...
    <table  class= common>
			<TR  class= common>
				...
				<TD  class= input5><Input  style="background:url(../common/images/guanliyuan-bg.png) no-repeat right center" class="code" name=StatMon id=StatMon verify="统计月|not null" ondblClick="return showCodeList('month',[this]);" onclick="统计月|not null" ondblClick="return showCodeList('month',[this]);"  onkeyup="return showCodeListKey('month',[this]);"></TD>
			</TR>
			
			<TR class= common>
				<TD  class= title5>凭证序号</TD>
				<TD  class= input5><Input class="wid" class= readonly name=VouchNo id=VouchNo value="162"></TD>
				<input type=hidden name="Opt">
				<TD CLASS=title5>管理机构 </TD>
				<TD CLASS=input5><Input style="background:url(../common/images/select--bg_03.png) no-repeat right center" class=codeno NAME=ManageCom id=ManageCom VALUE="" MAXLENGTH=10  ondblclick="return showCodeList('comcode',[this,ManageComName],[0,1],null,codeSql,'1',null,250);" onclick="return showCodeList('comcode',[this,ManageComName],[0,1],null,codeSql,'1',null,250);" onkeyup="return showCodeListKey('comcode',[this,ManageComName],[0,1],null,codeSql,'1',null,250);" verify="管理机构|code:comcode&notnull"  readonly ><input class=codename name=ManageComName id=ManageComName readonly=true></TD>
			</TR>
    </table>
    </Div>
    <!--<INPUT  class=cssButton VALUE="提取凭证" name="distill" TYPE=button onclick="SubmitFormBanksFee();">-->
    <a href="javascript:void(0);" name="distill" class="button" onClick="SubmitFormBanksFee();">提取凭证</a>
  </form>
