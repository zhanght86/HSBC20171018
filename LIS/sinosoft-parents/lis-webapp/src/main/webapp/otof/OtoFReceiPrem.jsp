...
<body>
  <form method=post name=fm id=fm action= "./OtoFPRSave.jsp" target="fraSubmit">
    ...
    <table  class= common>
      ...
      <TR class= common>
	    ...
	    <TR class= common>
	      ...
	      <TD class=title5>提取类型
	      </TD>
	      <TD  class= input5>
	      	 <Input style="background:url(../common/images/guanliyuan-bg.png) no-repeat right center" class="code" name=RType id=RType verify="提取类型|NOTNULL" CodeData="0|^1|全部提取应收保费凭证^2|部分提取应收保费凭证" 
    ...
    <!--<INPUT  class=cssButton VALUE="提取凭证"  name="distill" TYPE=button onclick="SubmitFormRP();">-->
    <a href="javascript:void(0);" name="distill" class="button" onClick="SubmitFormRP();">提取凭证</a>
  </form>
