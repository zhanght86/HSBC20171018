  ...
  <form method=post name=fm id=fm action= "./OtoFLASave.jsp" target="fraSubmit">
    ...
    <table  class= common>
			...
			<TR class= common>
				...
				<TD  class= input5><Input class="wid" class= readonly name=VouchNo id=VouchNo value="81"></TD>
    ...
    <!--<INPUT  class=cssButton VALUE="提取凭证" name="distill" TYPE=button onclick="SubmitFormReB();">-->
    <a href="javascript:void(0);" name="distill" class="button" onClick="SubmitFormReB();">提取凭证</a>
  </form>
