...
function easyQueryClick()
{
	...
	// 书写SQL语句
//	strSQL = "SELECT LOPRTManager.PrtSeq, LOPRTManager.OtherNo,LOPRTManager.AgentCode, LAAgent.AgentGroup,LABranchGroup.BranchAttr,LOPRTManager.ManageCom FROM LOPRTManager,LAAgent,LABranchGroup WHERE LOPRTManager.Code = '47' "  //LOPRTManager.Code='03' 单证类型为核保
...
//	var strSql = "select AgentCode,Name from LAAgent where AgentCode='" + cAgentCode +"'";// and ManageCom = '"+document.all('ManageCom').value+"'";
	...
	var sqlid2="PRnewApplyPrintSql2";
 	...
 	mySql2.addSubPara(cAgentCode);//指定传入参数
