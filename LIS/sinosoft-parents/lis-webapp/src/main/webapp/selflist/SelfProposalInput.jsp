...
<html> 
<%
//程序名称：SelfProposalInput.jsp
//程序功能：自助卡单-客户投保信息录入激活页面
//创建日期：2008-03-05 
//创建人  ：zz
...
<%
	...
	try
	{
		...
		loggerDebug("SelfProposalInput","客户信息录入界面获得卡号="+tCertifyNo);
	}
	catch( Exception e )
	{
		tCertifyNo = "";
...
<body  onload="initForm(); ">
    ...
    <Div  id= "divALL0"  class=maxbox1>
	 <table  class= common>
        <TR  class= common>
		  ...
		  <TD></TD>
          <TD  class= input>
             指定生效日期<input type="checkbox" value="01" name="CValiDateType" id=CValiDateType onclick="callCValiDate(value);">
			 </input>       
          </TD>
 ...
 readonly CodeData="0|^00|本人|^03|父亲|^04|母亲|" ondblclick="return showCodeListEx('RelationToLCInsured',[this]);" onkeyup="return showCodeListKeyEx('RelationToLCInsured',[this]);">
          </TD> 
 ...
 verify="被保人性别|notnull&code:Sex" ondblclick="return showCodeList('Sex',[this]);" onkeyup="return showCodeListKey('Sex',[this]);">
          </TD>
          <TD  class= title>
            出生日期
          </TD>
 ...
 verify="被保人证件类型|code:IDType" ondblclick="return showCodeList('IDType',[this]);" onkeyup="return showCodeListKey('IDType',[this]);">
          </TD>
          <TD  class= title>
            证件号码
          </TD>
        ...
        <TR  class= common>
          ...
          <TD  class= input colspan=3 >
            <Input class= "common3 wid" name="LCInsuredPostalAddress" id=LCInsuredPostalAddress verify="被保人联系地址|len<=80" >
          </TD>
          <TD  class= title>
            邮政编码
          </TD>
       ...
       <TR  class= common>
        ...
        <table  class= common>
       	<tr>
         <td class= titleImg>
             <IMG  src= "../common/images/butExpand.gif" style= "cursor:hand;" OnClick= "showPage(this, divLCInsuredOccupation1)"> 被保人职业信息(下一行的后两项是模糊查询条件)
    	 </td>  
    	</tr> 
    	</table>
  ...
  <!--确认按钮-->
    ...
    <IMG  src= "../common/images/butExpand.gif" style= "cursor:hand;" OnClick= "showPage(this,divAllNotice);">
     	...
     	<TR  class= common>          
          <TD  class= input>
           <Input type=button class=cssButton name="confirmActivate" value="激活确认" onclick="submitForm();">
           <Input type=button class=cssButton name="confirmActivate" value="险种信息查询" onclick="RiskSubmitForm();">
          </TD>                                           
       </TR>
    </table>
	</div>
