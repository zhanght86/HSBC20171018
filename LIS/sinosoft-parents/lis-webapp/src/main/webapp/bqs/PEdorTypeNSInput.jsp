...
loggerDebug("PEdorTypeNSInput","主险保单号tContNo"+tContNo);
...
//	主险保单号生效日
	...
	loggerDebug("PEdorTypeNSInput","当前生效日："+CureCvaliDate);
	loggerDebug("PEdorTypeNSInput","上年生效日："+PreCvaliDate);
	loggerDebug("PEdorTypeNSInput","下年生效日："+NextCvaliDate);
}
...
<body  onload="initForm();" >
  ...
  <Div id= "divEdorquery" class=maxbox1 style="display: ''">
      ...
      <tr class=common>
        ...
        <Input class="cssButton" type=Button name="DetailButton" value="进入险种信息" onclick="gotoRisk()">
        &nbsp;
