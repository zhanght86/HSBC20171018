        ...
        <TR  class= common>  
	       <td CLASS="title">被保人号码
            ...
            <TD  class= input>
                ...
                &nbsp;&nbsp;<input class="codeno" name="SequenceNoCode" id="SequenceNoCode" style="background: url(../common/images/guanliyuan-bg.png) no-repeat center;"  elementtype=nacessary  CodeData="0|^1|第一被保险人 ^2|第二被保险人 ^3|第三被保险人" onclick="return showCodeListEx('SequenceNo', [this,SequenceNoName],[0,1]);" ondblclick="return showCodeListEx('SequenceNo', [this,SequenceNoName],[0,1]);" onkeyup="return showCodeListKeyEx('SequenceNo', [this,SequenceNoName],[0,1]);"><Input class="codename" id="SequenceNoName" name="SequenceNoName" readonly="true">
            </TD>              
	        <TD  class= title>
                与第一被保险人关系</TD>             
            <TD  class= input>
...
<table>
  <tr>
    <td nowrap>
   	<INPUT VALUE="  被保人健康告知查询  " class=cssButton TYPE=button id="indButton1" name="indButton1" onclick="queryInsuredHealthImpart()">   
   	<INPUT VALUE="  被保人既往投保资料查询  " class=cssButton TYPE=button id="indButton2" name="indButton2" onclick="showApp(2);"> 
   	<INPUT VALUE="  儿童特约录入  " class=cssButton TYPE=button id="Button2" name="Button2" onclick="showSpec(1);"> 
   	<INPUT VALUE="  承保结论变更录入  " class=cssButton TYPE=button id="Button3" name="Button3" onclick="NewChangeRiskPlan();"> 
    </td>
  </tr>
</table>
