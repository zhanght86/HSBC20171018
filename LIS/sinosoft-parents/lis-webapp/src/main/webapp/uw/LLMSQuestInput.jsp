...
-->    </div>
  ...
  <table >
	...
	<tr class="common">
          ...
          <TD class="input5">
          <Input class= "codeno wid" id="BackObj" name=BackObj  style="background: url(../common/images/select--bg_03.png) no-repeat center right; "  CodeData="0|^1|核保通知书(打印类)^2|核保通知书(非打印类)^3|业务员通知书^4|返回机构^5|问题件修改岗" onClick="return showCodeListEx('BackObj',[this,BackObjName],[0,1]);" onDblClick="return showCodeListEx('BackObj',[this,BackObjName],[0,1]);" onKeyUp="return showCodeListKeyEx('backobj',[this,BackObjName],[0,1]);"><Input class = codename id="BackObjName" name=BackObjName  readonly = true>    <!-- wyc --> 
          </TD> 
          ...
          <TD  class= title5>
        	...
        	<TD class="input5">
            <Input class="codeno" name=NeedPrintFlag id="NeedPrintFlag" style="background: url(../common/images/select--bg_03.png) no-repeat center right; " CodeData = "0|^Y|下发^N|不下发" onClick="showCodeListEx('IFNeedFlag',[this,IFNeedFlagName],[0,1]);" ondblclick= "showCodeListEx('IFNeedFlag',[this,IFNeedFlagName],[0,1]);" onKeyUp="showCodeListKeyEx('IFNeedFlag',[this,IFNeedFlagName],[0,1]);" ><Input class="codename wid"  name=IFNeedFlagName id="IFNeedFlagName" readonly = true>
        	</TD>
        	<!-- <TD  class= title>
    	  		差错类型
    			</TD> -->
