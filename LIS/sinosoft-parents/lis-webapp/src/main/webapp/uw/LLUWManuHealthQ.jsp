...
<meta http-equiv="Content-Type" content="text/html; charset=GBK">
  ...
  <SCRIPT src="./LLUWManuHealthQ.js"></SCRIPT>
  <LINK href="../common/css/Project.css" rel=stylesheet type='text/css'>
  <LINK href="../common/css/Project3.css" rel=stylesheet type='text/css'>
  <LINK href="../common/css/mulLine.css" rel=stylesheet type='text/css'>
  <SCRIPT src="../common/javascript/MultiCom.js"></SCRIPT>
  <%@include file="LLUWManuHealthQInit.jsp"%>
  <title> 理赔二核体检资料录入 </title>
...
function initPage()
{
       ...
       initForm('<%=tContNo%>','<%=tMissionID%>','<%=tSubMissionID%>','<%=tPrtNo%>','<%=tPrtSeq%>','<%=tCustomerNo%>','<%=tCaseNo%>','<%=tBatNo%>');
...
<body  onload="initPage();" >
  <form method=post name=fm id="fm" target="fraSubmit" action= "./UWManuHealthChk.jsp">
    ...
    <table class=common>
        <TR  class= title>
         ...
         <!--  <Input type= "hidden" class= Common name= 'PrtNo' value= "">-->
          ...
          <INPUT  type= "hidden" class= Common id="RptNo" name= 'RptNo' value= "">          
        ...
        <TR  class= title>
          ...
          <TD  class= input5> <Input class="codeno" name=PEHospital id="PEHospital" style="background: url(../common/images/select--bg_03.png) no-repeat center right; " onClick="return showCodeList('pehospital',[this,PEAddress],[0,1]);" onDblClick="return showCodeList('pehospital',[this,PEAddress],[0,1]);" onKeyUp="return showCodeListKey('pehospital',[this,PEAddress],[0,1]);"><input class=codename name=PEAddress id="PEAddress" readonly=true elementtype=nacessary></TD>
         <!--   <TD  class= title>  体检医师  </TD>
          <TD  class= input5> <Input class="common" name='PEDoctor' > </TD>-->        
          <TD  class= title5>  体检时间  </TD>
          <!--<TD  class= input5> <Input class="common" name='PEDate' > </TD> -->
          <TD  class= input5>
            <Input class="common wid"  dateFormat="short" id="PEDate" name='PEDate' verify="体检时间|date"  onClick="laydate({elem:'#PEDate'});"><span class="icon"><a onClick="laydate({elem: '#PEDate'});"><img src="../common/laydate/skins/default/icon.png" /></a></span>
          </TD>          
          <!--<TD  class= title5>  复查时间  </TD>
          <TD  class= input5> <Input class="common" name='REPEDate' > </TD>
          <TD  class= input5>
            <Input class="multiDatePicker"  dateFormat="short" name='REPEDate' verify="复查时间|date" >
          </TD>
          <TD  class= title5>  阳性标记 </TD>
          <TD nowrap class= input5>
    ...
    <table class=common>
       <tr>
    	<TD  class= title colspan=4>
             <textarea name="OtherPEItem" cols="120" rows="3" class="common" readonly></textarea>
         </TD>
         </tr>
    	<tr class= title>
        	<td class= title5> 其他体检项目结论</td>  
        	<TD  class= input5> <Input class="codeno" name=OtherPEItemResCode id="OtherPEItemResCode" style="background: url(../common/images/select--bg_03.png) no-repeat center right; " onClick="return showCodeList('npo',[this,OtherPEItemRes],[0,1]);"  ondblclick="return showCodeList('npo',[this,OtherPEItemRes],[0,1]);" onKeyUp="return showCodeListKey('npo',[this,OtherPEItemRes],[0,1]);"><input class=codename name=OtherPEItemRes id="OtherPEItemRes" readonly=true elementtype=nacessary> 
           </TD>
   ...
   <Div  id= "divDisDesb" style= "display: none">
    ...
    <Div  id= "divUWDis" class="maxbox1" style= "display: ''">
      	<table  class= common>
       		<tr  class= common>
      	  		<td text-align: left colSpan=1 >
    	...
    	<table class=common>
         ...
         <TR  class= common >
           <TD  class= title colspan=4>
             <textarea name="Note" id=Note cols="120" rows="3" class="common" class="readonly"></textarea>
           </TD>
         </TR>
         <TR  class= common>
         ...
         <TR  class= common>
           <TD  class= title colspan=4>
             <textarea name="PEResultDes" id=PEResultDes cols="120" rows="3" class="common" ></textarea>
           </TD>
         </TR>
      </table>
