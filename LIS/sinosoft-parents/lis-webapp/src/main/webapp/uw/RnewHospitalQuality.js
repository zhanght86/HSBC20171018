...
//             + getWherePart('MakeDate', 'MakeDate');
	   ...
	   var  sqlid1="RnewHospitalQualitySql0";
	   var  mySql1=new SqlClass();
	   mySql1.setResourceName("uw.RnewHospitalQualitySql"); //指定使用的properties文件名
...
// 	          + " from ldhospital a ,RnewPENotice b"
// 	          + " where a.hospitcode = b.hospitcode and b.ContNo='"+ContNo+"'"
// 	          + " order by b.modifydate desc,b.modifytime desc";
 	   var  sqlid2="RnewHospitalQualitySql1";
	   var  mySql2=new SqlClass();
	   mySql2.setResourceName("uw.RnewHospitalQualitySql"); //指定使用的properties文件名
...
//	             + " where hospitcode='"+document.all('HospitalCode').value+"' and contno='"+ContNo+"' ";
	  	   var  sqlid3="RnewHospitalQualitySql2";
		   var  mySql3=new SqlClass();
		   mySql3.setResourceName("uw.RnewHospitalQualitySql"); //指定使用的properties文件名
		   mySql3.setSqlId(sqlid3);//指定使用的Sql的id
		   mySql3.addSubPara(document.all('HospitalCode').value);//指定传入的参数
...
// 	          + " where hospitcode = '"+Field.value+"'";
 	   var  sqlid4="RnewHospitalQualitySql3";
	   var  mySql4=new SqlClass();
	   mySql4.setResourceName("uw.RnewHospitalQualitySql"); //指定使用的properties文件名
...
//             + " where hospitcode='"+document.all('HospitalCode').value+"' and contno='"+PrtNo+"' ";
  	   var  sqlid5="RnewHospitalQualitySql4";
	   var  mySql5=new SqlClass();
	   mySql5.setResourceName("uw.RnewHospitalQualitySql"); //指定使用的properties文件名
	   mySql5.setSqlId(sqlid5);//指定使用的Sql的id
	   mySql5.addSubPara(document.all('HospitalCode').value);//指定传入的参数
...
//        			 + " from RnewPENotice a where contno='"+tPrtNo+"' ";
       var  sqlid6="RnewHospitalQualitySql5";
	   var  mySql6=new SqlClass();
	   mySql6.setResourceName("uw.RnewHospitalQualitySql"); //指定使用的properties文件名
