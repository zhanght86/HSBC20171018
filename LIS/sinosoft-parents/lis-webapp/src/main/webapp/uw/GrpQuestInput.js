...
function QuestQuery(tProposalNo, tFlag)
{
	// 初始化表格
	var i,j,m,n;
	//initQuestGrid();
...
mySql4.setResourceName("uw.QuestInputSql4"); //指定使用的properties文件名
...
mySql5.setResourceName("uw.QuestInputSql5"); //指定使用的properties文件名
mySql5.setSqlId(sqlid5);//指定使用的Sql的id
mySql5.addSubPara(k);//指定传入的参数
mySql5.addSubPara(k);//指定传入的参数
mySql5.addSubPara(tProposalNo);//指定传入的参数
