...
mySql6.setResourceName("uw.QuestInputSql"); //指定使用的properties文件名
...
mySql7.setResourceName("uw.QuestInputSql"); //指定使用的properties文件名
mySql7.setSqlId(sqlid7);//指定使用的Sql的id
mySql7.addSubPara("1");//指定传入的参数
...
function afterCodeSelect( cCodeName, Field )
{
	...
	mySql8.setResourceName("uw.QuestInputSql"); //指定使用的properties文件名
	mySql8.setSqlId(sqlid8);//指定使用的Sql的id
	mySql8.addSubPara(tObjFlag);//指定传入的参数
...
mySql9.setResourceName("uw.QuestInputSql"); //指定使用的properties文件名
...
mySql10.setResourceName("uw.QuestInputSql"); //指定使用的properties文件名
mySql10.setSqlId(sqlid10);//指定使用的Sql的id
mySql10.addSubPara(tContNo);//指定传入的参数
mySql10.addSubPara(document.all('QuestionObj').value);//指定传入的参数
...
mySql11.setResourceName("uw.QuestInputSql"); //指定使用的properties文件名
...
mySql12.setResourceName("uw.QuestInputSql"); //指定使用的properties文件名
mySql12.setSqlId(sqlid12);//指定使用的Sql的id
mySql12.addSubPara(QuestGrid.getRowColData(QuestGrid.getSelNo() - 1, 11));//指定传入的参数
...
mySql13.setResourceName("uw.QuestInputSql"); //指定使用的properties文件名
mySql13.setSqlId(sqlid13);//指定使用的Sql的id
mySql13.addSubPara(QuestGrid.getRowColData(QuestGrid.getSelNo() - 1, 13));//指定传入的参数
...
mySql14.setResourceName("uw.QuestInputSql"); //指定使用的properties文件名
mySql14.setSqlId(sqlid14);//指定使用的Sql的id
mySql14.addSubPara(fm.hiddenProposalContNo.value);//指定传入的参数
