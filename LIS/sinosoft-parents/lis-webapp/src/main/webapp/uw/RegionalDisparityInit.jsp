...
function initInpBox() { 
  ...
  try {                                   
    ...
    alert("在RegionalDisparityInput.jsp-->InitInpBox函数中发生异常:初始化界面错误!");
  }      
}
...
function initSelBox() {  
  try {
    ...
    alert("在RegionalDisparityInput.jsp-->InitSelBox函数中发生异常:初始化界面错误!");
  }
}                                        
...
function initForm() {
	try {
    	...
    	alert("RegionalDisparityInput.jsp-->InitForm函数中发生异常:初始化界面错误!");
  	}
}
