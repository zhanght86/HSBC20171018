...
<%
  ...
  String tInsuredSumHealthAmnt = request.getParameter("InsuredSumHealthAmnt"); 
   loggerDebug("LLUWChangeRiskPlanInput","tInsuredNo:"+tInsuredNo);
%>
...
<meta http-equiv="Content-Type" content="text/html; charset=GBK">
  ...
  <SCRIPT src="LLUWChangeRiskPlan.js"></SCRIPT>
  <LINK href="../common/css/Project.css" rel=stylesheet type=text/css>
  <LINK href="../common/css/Project3.css" rel=stylesheet type=text/css>
  <LINK href="../common/css/mulLine.css" rel=stylesheet type=text/css>
  <title> 客户承保结论变更录入 </title>
  <%@include file="LLUWChangeRiskPlanInit.jsp"%>
</head>
<body  onload="initForm('<%=tContNo%>','<%=tMissionID%>','<%=tSubMissionID%>','<%=tPrtNo%>','<%=tInsuredNo%>','<%=tClmNo %>',<%=tBatNo %>);" >

  <form method=post name=fm id="fm" target="fraSubmit" action= "./LLUWChangeRiskPlanChk.jsp">
    <!-- 以往核保记录部分（列表） -->
    <!--待增加被保人信息-->
    <Div   style= "display: ''">
    	<table>
    ...
    <table  class= common>
            ...
            <TD  class= input>
                ...
                与第一被保险人关系</TD>             
            <TD  class= input>
                <Input class="codeno" name="RelationToMainInsured" id="RelationToMainInsured" style="background:url(../common/images/guanliyuan-bg.png) no-repeat right center" readonly ><Input class="codename" name="RelationToMainInsuredName" id="RelationToMainInsuredName" readonly  >
            </TD>  
            <td class="title">&nbsp;</td>
            <td class="input">&nbsp;</td>                     
	      	</tr>
    ...
    <Div  id= "divSpecAll" style= "display: ''">
		    ...
		    <div id="divLCPolSpec" style= "display: ''">
		    	...
		    	<Div  id= "divTemp" class="maxbox1" style= "display: ''">
		      	...
		      	<td class=input5>
		            <Input class="codeno" name=HealthSpecTemp id="HealthSpecTemp" style="background: url(../common/images/select--bg_03.png) no-repeat center right; " onClick="return showCodeList('healthspcetemp',[this,HealthSpecTempName],[0,1]);" onDblClick="return showCodeList('healthspcetemp',[this,HealthSpecTempName],[0,1]);" 
		    ...
		    <table style= "display: none">
		      ...
		      <TD  class= title>&nbsp;&nbsp; <textarea name="SpecReason" cols="100%" rows="5" witdh=100% class="common"></textarea></TD>
		        </TR>
		    </table>
	  ...
	  <!--分页-->
		<hr class="line">
	  <!--保险计划变更-->
	  <jsp:include page="LLManuUWChangePlanShow.jsp"/>
    ...
    <div class="maxbox1">
     ...
     <INPUT type= "hidden" id="button6" name= "cancleGiven" value="取消提前给付特约" class= cssButton  onclick="cancleGiven1()"> 
