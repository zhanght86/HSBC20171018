...
//		        + " replydate,(case replyflag when '0' then '未回复' when '' then '未回复' else '已回复' end),prtseq,(select codename from ldcode where codetype ='rreportreason' and code=l.RReportReason) from RnewRReport l where 1=1 "
//		        + " and contno = '"+tContNo+"'" ;
