...
<SCRIPT src="UWNoticeBatchInput.js"></SCRIPT>
<LINK href="../common/css/Project.css" rel=stylesheet type=text/css>
<LINK href="../common/css/Project3.css" rel=stylesheet type=text/css>
<LINK href="../common/css/mulLine.css" rel=stylesheet type=text/css>
<%@include file="UWNoticeBatchInit.jsp"%>
...
(this,divInvAssBuildInfo);">
    ...
    <table  class= common align=center>
          ...
          style="background:url(../common/images/select--bg_03.png) no-repeat right center" 
           ...
           onDblClick="return showCodeList('noticetype',[this,NoticeTypeName],[0,1],null,StrSql,'1');"
            onKeyUp="return showCodeListKey('NoticeType',[this,NoticeTypeName],[0,1],null,StrSql,'1');"><Input class = codename id="NoticeTypeName" name= NoticeTypeName readonly = true>
          ...
          <Input  type = "hidden" class= "common wid" id="PrtNo" name=PrtNo >
          </TR>
          <TR  class= common>
  ...
  <form action="./UWF1BatchPSave.jsp" method=post name=fmSave target="fraSubmit">
    <table>
    	<tr>
        	<td class=common>
     ...
     <!-- <INPUT VALUE="首  页" class= cssButton TYPE=button onClick="getFirstPage();">
  	...
  	<p>
      <INPUT VALUE="打  印" class= cssButton TYPE=button onClick="printPol();" id="printButton" disabled>
  	</p>
