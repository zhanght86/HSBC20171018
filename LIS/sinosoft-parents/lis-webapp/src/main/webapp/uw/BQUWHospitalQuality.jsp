...
<body  onload="initForm(EdorNo,ContNo);" >
  ...
  <TR  class= common>
    ...
    <TD  class= input>
       <Input class= 'codeno' name=ManageCom id="ManageCom" verify="所属管理机构|notnull&len<=8"  readonly ><input class=codename readonly=true name=ManageComName id="ManageComName" >
    </TD>
	</TR>
    </table>
 <div id="HealthType">
