...
<body  onload="initForm();" >
  <form method=post id="fm" name=fm target="fraTitle">
    <!-- 保单信息部分 -->
      ...
      <INPUT CLASS=common90 VALUE="首  页" TYPE=button onclick="turnPage.firstPage();"> 
      <INPUT CLASS=common91 VALUE="上一页" TYPE=button onclick="turnPage.previousPage();"> 					
      <INPUT CLASS=common92 VALUE="下一页" TYPE=button onclick="turnPage.nextPage();"> 
      <INPUT CLASS=common93 VALUE="尾  页" TYPE=button onclick="turnPage.lastPage();">
      </Div>
      <table>
    	<tr>
    		<td class= titleImg>
