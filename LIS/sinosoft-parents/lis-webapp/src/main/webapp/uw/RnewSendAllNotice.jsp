...
<meta http-equiv="Content-Type" content="text/html; charset=GBK">
  ...
  <SCRIPT src="RnewSendAllNotice.js"></SCRIPT>
  <LINK href="../common/css/Project.css" rel=stylesheet type=text/css>
  <LINK href="../common/css/Project3.css" rel=stylesheet type=text/css>
  <LINK href="../common/css/mulLine.css" rel=stylesheet type=text/css>
  <title>核保问题件录入</title>
  <%@include file="RnewSendAllNoticeInit.jsp"%>
</head>
<body  onload="initForm('<%=tContNo%>','<%=tMissionID%>','<%=tSubMissionID%>','<%=tEdorNo%>','<%=tEdorType%>');" >
  <form method=post name=fm id="fm" target="fraSubmit" action= "./RnewSendAllNoticeChk.jsp">
  	
  		<table>
		<tr>
			<td><input class="cssButton" value="核保通知书信息"  name="InsuredSequencename" id="InsuredSequencename" readonly ></td>
		</tr>
	</table>
	<!--
     ...
     <table>
      ...
      <Div  id= "divAll2" style= "display: ''">      
	    ...
	    <table>
	    	<tr>
	        	<td class=common>
				    <IMG  src= "../common/images/butCollapse.gif" style= "cursor:hand;" OnClick= "showPage(this,divUWPlan);">
	    		</td>
	    		<td class= titleImg>
	    			待发送承保计划变更信息
	    		</td>
