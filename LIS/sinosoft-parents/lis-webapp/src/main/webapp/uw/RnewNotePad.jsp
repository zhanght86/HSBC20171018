...
<body  onload="initForm();" >
  <form method=post name=fm id="fm" target="fraSubmit" action="./RnewNotePadSave.jsp">
    ...
    <table class= common>
      ...
      <tr class="common">
      	<td class="title5"> <input type= "button" name= "Query" value="查  询" class=cssButton onClick= "queryClick()"></td>
      </tr>
    </table>
  ...
  <table width="80%" height="20%" class= common>
    ...
    <TR  class= common>
      <TD height="85%"  class= title><textarea name="Content" id=Content verify="记事本内容|len<800" verifyorder="1" cols="135" rows="5" class="common" ></textarea></TD>
    </TR>
  </table>
  </div>
