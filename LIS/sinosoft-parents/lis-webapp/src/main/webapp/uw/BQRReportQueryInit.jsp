...
function initForm(tContNo,tEdorNo,tPrtSeq,tMissionID,tSubMissionID)
{
  try
  {	
	initQuestGrid();		
	...
	initHide(tContNo,tEdorNo,tPrtSeq,tMissionID,tSubMissionID);
...
function initHide(tContNo,tEdorNo,tPrtSeq,tMissionID,tSubMissionID)
{
