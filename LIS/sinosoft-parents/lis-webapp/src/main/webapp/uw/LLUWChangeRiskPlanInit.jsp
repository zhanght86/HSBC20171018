...
function initForm(tContNo,tMissionID,tSubMission,tPrtNo,tInsuredNo,tClmNo,tBatNo)
{
  var str = "";
  try
  {
    ...
    initPolAddGrid();
    //alert('1');
    initHide(tContNo,tMissionID,tSubMission,tPrtNo,tInsuredNo,tClmNo,tBatNo);
    queryInsuredInfo(tContNo,tBatNo,tClmNo,tInsuredNo);    
    initCancleGiven(tContNo,tInsuredNo); //初始化取消提前给付特约按钮
    //alert('2');
    if(tQueryFlag=="1"){
...
function initHide(tContNo,tMissionID,tSubMission,tPrtNo,tInsuredNo,tClmNo,tBatNo)
{
...
*/      
      ...
      iArray[11][1]="0px";            		//列宽
      iArray[11][2]=60;            			//列最大值
      iArray[11][3]=3;              			//是否允许输入,1表示允许，0表示不允许 2表示代码选择
      ...
      iArray[13][1]="0px";            		//列宽
      iArray[13][2]=60;            			//列最大值
      iArray[13][3]=3;              			//是否允许输入,1表示允许，0表示不允许 2表示代码选择

      iArray[14]=new Array();
      iArray[14][0]="缴费计划编码";         		//列名
      iArray[14][1]="0px";            		//列宽
      iArray[14][2]=60;            			//列最大值
      iArray[14][3]=3;              			//是否允许输入,1表示允许，0表示不允许 2表示代码选择
      ...
      //iArray[15][7]="AutoCalAddFee";
      iArray[15][10] = "addFormMethod";
      iArray[15][11] = "0|^0|追溯|^2|下期加费|";	//去掉^1|当期加费
...
function initOldRislPlanGrid(str)
  ...
  var iArray = new Array();
      ...
      iArray[10][4]="claimuwstate";              	        //是否引用代码:null||""为不引用
      //iArray[10][5]="1";
      //iArray[10][6]="0|";
      iArray[10][15]="1";
      iArray[10][16]="#1# and code in (#9#,#4#,#1#,#c#,#d#,#6#)";
      iArray[10][19]="1";
