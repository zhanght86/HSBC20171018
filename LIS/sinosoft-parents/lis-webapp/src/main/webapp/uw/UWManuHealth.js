...
function submitForm()
{
	...
	mySql1.setResourceName("uw.UWManuHealthSql"); //指定使用的properties文件名
  ...
  if(arrResult == null)
  {
		...
		mySql2.setResourceName("uw.UWManuHealthSql"); //指定使用的properties文件名
...
//				 + " and insuredno = '"+ tInsuredNo + "'";
	 ...
	 var sqlid3="UWManuHealthSql3";
		...
		mySql3.setResourceName("uw.UWManuHealthSql"); //指定使用的properties文件名
		mySql3.setSqlId(sqlid3);//指定使用的Sql的id
		mySql3.addSubPara(tProposalContno);//指定传入的参数
...
//				 + " and customerno = '"+ tInsuredNo + "'";
	 ...
	 var sqlid4="UWManuHealthSql4";
		...
		mySql4.setResourceName("uw.UWManuHealthSql"); //指定使用的properties文件名
		mySql4.setSqlId(sqlid4);//指定使用的Sql的id
		mySql4.addSubPara(tProposalContno);//指定传入的参数
...
//             + " and (c.uwno = (select max(d.uwno) from LCCUWError d where d.ContNo = '" + tContNo + "'))"
            ...
            var sqlid5="UWManuHealthSql5";
     		...
     		mySql5.setResourceName("uw.UWManuHealthSql"); //指定使用的properties文件名
...
//	       + "where   Prtno = '" +tPrtNo +"' ";
	 ...
	 var sqlid6="UWManuHealthSql6";
		...
		mySql6.setResourceName("uw.UWManuHealthSql"); //指定使用的properties文件名
		mySql6.setSqlId(sqlid6);//指定使用的Sql的id
		mySql6.addSubPara(tPrtNo);//指定传入的参数
...
//           + " union select appntno as a,'投保人' as b ,appntname as c,'A' d,'5' e from lccont where prtno = '" +tPrtNo + "'"
...
//               +  " order by e";
		...
		mySql7.setSqlId("UWManuHealthSql7");// 指定使用的Sql的id
		mySql7.setResourceName("uw.UWManuHealthSql"); //指定使用的properties文件名
		mySql7.addSubPara(tPrtNo);//指定传入的参数
		mySql7.addSubPara(tPrtNo);//指定传入的参数
		mySql7.addSubPara(tPrtNo);//指定传入的参数
		mySql7.addSubPara(tPrtNo);//指定传入的参数
		mySql7.addSubPara(sEdorNo);//指定传入的参数
		mySql7.addSubPara(ContNoid5);//指定传入的参数
		mySql7.addSubPara(sEdorNo);//指定传入的参数
		mySql7.addSubPara(ContNoid6);//指定传入的参数
...
//           + "and mngcom like concat(concat('' , substr((select managecom from lccont where ContNo = '"+tContNo+"'),1,6)) , '%%') ";
	...
	mySql8.setSqlId("UWManuHealthSql8");// 指定使用的Sql的id
	mySql8.setResourceName("uw.UWManuHealthSql"); //指定使用的properties文件名
...
//	         + " order by customerno,makedate,maketime ";
	...
	mySql9.setSqlId("UWManuHealthSql9");// 指定使用的Sql的id
	mySql9.setResourceName("uw.UWManuHealthSql"); //指定使用的properties文件名
...
//	
	...
	mySql10.setSqlId("UWManuHealthSql10");// 指定使用的Sql的id
	mySql10.setResourceName("uw.UWManuHealthSql"); //指定使用的properties文件名
	mySql10.addSubPara(document.all('ContNo').value);//指定传入的参数
	mySql10.addSubPara(turnPage.arrDataCacheSet[i][4]);//指定传入的参数
...
//		            ;
		...
		mySql11.setSqlId("UWManuHealthSql11");// 指定使用的Sql的id
		mySql11.setResourceName("uw.UWManuHealthSql"); //指定使用的properties文件名
		mySql11.addSubPara(document.all('ContNo').value);//指定传入的参数
		mySql11.addSubPara(tPrtSeq);//指定传入的参数
		mySql11.addSubPara(tCustomerNo);//指定传入的参数
		mySql11.addSubPara(tCustomerType);//指定传入的参数
...
//                 + " and prtseq = '"+tPrtSeq+"' ";
	...
	mySql12.setSqlId("UWManuHealthSql12");// 指定使用的Sql的id
	mySql12.setResourceName("uw.UWManuHealthSql"); //指定使用的properties文件名
	mySql12.addSubPara(document.all('ContNo').value);//指定传入的参数
	mySql12.addSubPara(tPrtSeq);//指定传入的参数
