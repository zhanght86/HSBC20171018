...
<body  onload="initForm('<%=tContNo%>');" >
  <form method=post id="fm" name=fm target="fraSubmit" action= "./UWManuReportChk.jsp">
    ...
    <Div  id= "divButton" style= "display: ''">
      <INPUT type= "button" class="cssButton" name= "sure" value="确认" onclick="inputReport()">
      <INPUT type= "button" class="cssButton" name= "sure" value="查询下级核保员分析报告" onclick="window.open('./UWQuerySubReportMain.jsp?ContNo='+fm.ContNo.value);">
    </Div>
