...
function initForm(tActivityID,tContNo,tEdorNo,tMissionID,tSubMission,tPrtNo,tPrtSeq,tCustomerNo)
{
  try
  {
	initHide(tActivityID,tContNo,tEdorNo,tMissionID,tSubMission,tPrtNo,tPrtSeq,tCustomerNo);
	initHealthGrid();
	initHealthOtherGrid();
 // initOtherHealthGrid();
...
function initMainUWHealthGrid()
  {                              
    var iArray = new Array();
      ...
      MainHealthGrid = new MulLineEnter( "document" , "MainHealthGrid" ); 
      //这些属性必须在loadMulLine前                            
      MainHealthGrid.mulLineCount = 5;
...
function initHealthGrid1()
  {                              
    var iArray = new Array();
      ...
      HealthGrid = new MulLineEnter( "document" , "HealthGrid" ); 
      //这些属性必须在loadMulLine前  
...
//      iArray[4][17]="1";
      ...
      HealthOtherGrid = new MulLineEnter( "document" , "HealthOtherGrid" ); 
...
function initOtherHealthGrid()
  {                              
    var iArray = new Array();
      ...
      OtherHealthGrid = new MulLineEnter( "document" , "OtherHealthGrid" ); 
      //这些属性必须在loadMulLine前        
     
      //这些属性必须在loadMulLine前
      OtherHealthGrid.mulLineCount =5;   
...
function initDisDesbGrid()
  {                              
    var iArray = new Array();
      ...
      DisDesbGrid = new MulLineEnter( "document" , "DisDesbGrid" ); 
      //这些属性必须在loadMulLine前                            
      DisDesbGrid.mulLineCount = 5;
...
function initHide(tActivityID,tContNo,tEdorNo,tMissionID,tSubMission,tPrtNo,tPrtSeq,tCustomerNo)
{
