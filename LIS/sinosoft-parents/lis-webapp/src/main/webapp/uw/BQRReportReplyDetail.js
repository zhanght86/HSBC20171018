...
mySql917113605.setResourceName("uw.BQRReportReplyDetailSql");//指定使用的properties文件名
mySql917113605.setSqlId(sqlid917113605);//指定使用的Sql的id
mySql917113605.addSubPara(PolNo);//指定传入的参数
...
//           + " lprreport.replyoperator,lprreport.replydate,decode(lprreport.replyflag,'0','未回复','已回复'),lprreport.prtseq "
...
mySql917113708.setResourceName("uw.BQRReportReplyDetailSql");//指定使用的properties文件名
mySql917113708.setSqlId(sqlid917113708);//指定使用的Sql的id
mySql917113708.addSubPara(PolNo);//指定传入的参数
...
mySql917113841.setResourceName("uw.BQRReportReplyDetailSql");//指定使用的properties文件名
mySql917113841.setSqlId(sqlid917113841);//指定使用的Sql的id
mySql917113841.addSubPara(PolNo);//指定传入的参数
mySql917113841.addSubPara(SerialNo);//指定传入的参数
mySql917113841.addSubPara(SerialNo);//指定传入的参数
