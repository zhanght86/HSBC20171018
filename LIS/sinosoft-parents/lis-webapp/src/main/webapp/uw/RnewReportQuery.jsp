...
<meta http-equiv="Content-Type" content="text/html; charset=GBK">
  ...
  <SCRIPT src="RnewReportQuery.js"></SCRIPT>
  <LINK href="../common/css/Project.css" rel=stylesheet type=text/css>
  <LINK href="../common/css/Project3.css" rel=stylesheet type=text/css>
  <LINK href="../common/css/mulLine.css" rel=stylesheet type=text/css>
  <%@include file="RnewReportQueryInit.jsp"%>
...
<body  onload="initForm('<%=tContNo%>','<%=tPrtSeq%>','<%=tMissionID%>','<%=tSubMissionID%>');" >
  <form method=post name=fm id="fm" target="fraSubmit">
    ...
    <table class=common>
       <tr  class= common>
          <td class=title5>生存调查人</td><td class=input5><Input  class= "common wid" name= 'Operator' id="Operator"  readonly></td>
          <td class=title5>发送时间</td><td class=input5><Input  class= "common wid" name= 'MakeDate' id="MakeDate" readonly></td>
       </tr>
       <tr  class= common>
          <td class=title5>回复时间</td><td class=input5><Input  class= "common wid" name= 'ReplyDate' id="ReplyDate" readonly></td>
  ...
  <table width="121%" height="37%">
    ...
    <Div  id= "divUWSpec1" class="maxbox1" style= "display: ;margin-top:5px;">
    	<table class = common>
    		<tr class = common>
    			<td class=title5>生调费用</td><td class=input5><Input  class= "Common wid" id="RReportFee" name= 'RReportFee' ></td>
                <td class=title5></td><td class=input5></td>
    		</tr>
      </table>
   </Div>
