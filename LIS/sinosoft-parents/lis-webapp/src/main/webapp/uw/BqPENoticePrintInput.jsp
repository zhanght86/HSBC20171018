...
<SCRIPT src="BqPENoticePrintInput.js"></SCRIPT>
<LINK href="../common/css/Project.css" rel=stylesheet type=text/css>
<LINK href="../common/css/Project3.css" rel=stylesheet type=text/css>
<LINK href="../common/css/mulLine.css" rel=stylesheet type=text/css>
<%@include file="BqPENoticePrintInit.jsp"%>
...
<body onLoad="initForm();">
		...
		<table  class=common align=center>
           ...
           onclick="return showCodeList('AgentGroup',[this]);" 
				...
				<TD class="input5" nowrap="true">
					<Input class="common wid" id="BranchGroup" name="BranchGroup">
					<input id="btnQueryBranch" name="btnQueryBranch" class="cssButton" type="button" value="查询" onClick="queryBranch()" style="width:60">
				</TD>
			</TR>
		</table>
        </div></div>
	...
	<form action="./BqPENoticePrintSave.jsp" method=post name=fmSave id=fmSave target="fraSubmit">
		<table>
			<tr>
				<td class=common>
		...
		<input type=hidden id="FunctionID" name="FunctionID" value="10020302">
