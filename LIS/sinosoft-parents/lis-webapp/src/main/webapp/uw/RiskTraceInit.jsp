...
function initForm()
{
  try  
  {
    ...
    alert("RiskTraceInit.jsp-->InitForm函数中发生异常:初始化界面错误!"); 
  }
}
...
function initRiskTraceGrid(){
    var iArray = new Array();
      ...
      {   
          ...
          RiskTraceGrid = new MulLineEnter( "document" , "RiskTraceGrid" ); 

          //这些属性必须在loadMulLine前
          
          RiskTraceGrid.mulLineCount = 5;     
