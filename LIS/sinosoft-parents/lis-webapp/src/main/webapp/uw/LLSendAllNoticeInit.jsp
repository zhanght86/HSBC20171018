...
<%
	...
	loggerDebug("LLSendAllNoticeInit","Flag:"+tFlag);
	loggerDebug("LLSendAllNoticeInit","tNoticeType:"+tNoticeType);
...
function initForm(tContNo,tMissionID,tSubMissionID,tClmNo,tBatNo)
{
  try
  {
	initInpBox();
	//initLWMission();
	initHide(tContNo,tMissionID,tSubMissionID,tClmNo,tBatNo);
	//initLoprtManager();
	initQuestGrid();	
	initQuestionTypeGrid();
	initUWSpecGrid();
	initAddFeeGrid();	
	querySpec(tClmNo,tBatNo);
	queryAddFee(tClmNo,tBatNo);
	queryAllNeedQuestion(tClmNo,tBatNo);
	...
	//initUWExistGrid();
	//initUWPlanGrid();
	queryQuestD(tClmNo,tBatNo);
	queryUWSpecD(tClmNo,tBatNo);
	queryUWHealthD(tClmNo,tBatNo);
	//queryUWExistD(tClmNo,tBatNo);
	queryUWHealth(tClmNo,tBatNo);
	//queryUWExist(tClmNo,tBatNo);
...
function initQuestionTypeGrid()
{
    var iArray = new Array();
      ...
      QuestionTypeGrid = new MulLineEnter( "document" , "QuestionTypeGrid" ); 
      //这些属性必须在loadMulLine前                            
      QuestionTypeGrid.mulLineCount = 5;
...
function initHide(tContNo,tMissionID,tSubMissionID,tClmNo,tBatNo)
{
	document.all('ContNo').value=tContNo;
  	document.all('MissionID').value = tMissionID;
  	document.all('SubMissionID').value = tSubMissionID;	//alert("SubMissionID=="+tSubMissionID);
...
function initQuestDGrid()
  {                               
    var iArray = new Array();
      ...
      QuestDGrid = new MulLineEnter( "document" , "QuestDGrid" ); 
      //这些属性必须在loadMulLine前  
...
function initUWSpecDGrid()
  {                               
    var iArray = new Array();
      ...
      UWSpecDGrid = new MulLineEnter( "document" , "UWSpecDGrid" ); 
      //这些属性必须在loadMulLine前
...
function initUWHealthDGrid()
  {                               
    var iArray = new Array();
      ...
      UWHealthDGrid = new MulLineEnter( "document" , "UWHealthDGrid" ); 
      //这些属性必须在loadMulLine前 
...
function initUWExistDGrid()
  {                               
    var iArray = new Array();
      ...
      UWExistDGrid = new MulLineEnter( "document" , "UWExistDGrid" ); 
      //这些属性必须在loadMulLine前 
...
function initUWHealthGrid()
  {                               
    var iArray = new Array();
      ...
      UWHealthGrid = new MulLineEnter( "document" , "UWHealthGrid" ); 
      //这些属性必须在loadMulLine前  
...
function initUWExistGrid()
  {                               
    var iArray = new Array();
      ...
      UWExistGrid = new MulLineEnter( "document" , "UWExistGrid" ); 
      //这些属性必须在loadMulLine前 
...
function initAddFeeGrid()
  {                               
    var iArray = new Array();
      ...
      UWAddFeeGrid = new MulLineEnter( "document" , "UWAddFeeGrid" ); 
      //这些属性必须在loadMulLine前  
...
function initUWPlanGrid()
  {                               
    var iArray = new Array();
      ...
      UWPlanGrid = new MulLineEnter( "document" , "UWPlanGrid" ); 
      //这些属性必须在loadMulLine前  
