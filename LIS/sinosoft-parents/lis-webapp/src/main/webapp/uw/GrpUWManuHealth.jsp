    ...
    <div class="maxbox">
     <table class= common border=0 width=100%>
        ...
        <table  class= common align=center>
          ...
          <td class=title>体检原因</td><!--CodeData="0|^1|新契约^2|延期/拒保史^3|复检^4|高保额^5|复效^6|加保/增加附加险^7|补充告知" ondblclick="return showCodeListEx('Reason', [this],null,null,null,null,1)"onkeyup="return showCodeListKeyEx('Reason', [this],null,null,null,null,1)"-->
          ...
          <TD  class= input> 
           <!-- <Input class="coolDatePicker wid" dateFormat="short" id="EDate" name=EDate verify="体检日期|date" > -->
           <Input class="coolDatePicker wid" dateFormat="short" id="EDate" name=EDate  onClick="laydate({elem: '#EDate'});" verify="体检日期|date"  ><span class="icon"><a onClick="laydate({elem: '#EDate'});"><img src="../common/laydate/skins/default/icon.png" /></a></span>
             </TD>
...
<div class="maxbox">
      <table class= common border=0 width=100%>
        ...
        <tr class= common>
        <td class= common><input type=radio id="bodyCheck" name="bodyCheck" value='type1'  OnClick= "showBodyCheck(bodyCheckType1);">临床物理检查、心电图、尿常规 </td>
        </tr>
        <tr class= common>
        <td class= common><input type=radio id="bodyCheck" name="bodyCheck" value='type2' OnClick= "showBodyCheck(bodyCheckType2);">临床物理检查、心电图、尿常规、空腹血糖、血常规、肝功能、乙肝表面抗原、血脂、肾功能 </td>
        </tr>
        <tr class= common>
        <td class= common><input type=radio id="bodyCheck" name="bodyCheck" value='type3' OnClick= "showBodyCheck(bodyCheckType3);">临床物理检查、心电图、尿常规、空腹血糖、血常规、肝功能、乙肝表面抗原、血脂、肾功能、眼底、B超、胸部透视 </td>
        </tr>
        <tr class= common>
        <td class= common><input type=radio id="bodyCheck" name="bodyCheck" value='type4' OnClick= "showBodyCheck(bodyCheckType4);">临床物理检查、心电图、尿常规、空腹血糖、血常规、肝功能、乙肝表面抗原、血脂、肾功能、眼底、B超、胸部透视、妇科检查 </td>
        </tr>
      </table>
</div>
       ...
       <div id = "bodyCheckType1" style= "display: none">
          <table  class= common>
              ...
              <tr class=common>
                <td class= common> <input type=checkbox id="type1" name='type1' value='070心电图' checked="checked">心电图 </td>
              </tr>
              <tr class=common>
                <td class= common> <input type=checkbox id="type1" name='type1' value='020尿常规' checked="checked">尿常规 </td>
              </tr>
              <tr class=common>
                <td class= common><input type=checkbox id="type1" name='type1' value='140衰弱测试'>衰弱测试 </td>
              </tr>
          </table>
       </div>
       ...
       <div id = "bodyCheckType2" style= "display: none">
          <table  class= common>
              ...
              <tr class=common>
                <td class= common> <input type=checkbox id="type2" name='type2' value='070心电图' checked="checked">心电图 </td>
              </tr>
              <tr class=common>
                <td class= common> <input type=checkbox id="type2" name='type2' value='020尿常规' checked="checked">尿常规 </td>
              </tr>
               <tr class=common>
               ...
               <tr class=common>
                <td class= common> <input type=checkbox id="type2" name='type2' value='040血常规' checked="checked">血常规 </td>
              </tr>
               <tr class=common>
                <td class= common> <input type=checkbox id="type2" name='type2' value='050肝功能' checked="checked">肝功能 </td>
              </tr>
               <tr class=common>
                <td class= common> <input type=checkbox id="type2" name='type2' value='060乙肝表面抗原' checked="checked">乙肝表面抗原 </td>
              </tr>
               <tr class=common>
                <td class= common> <input type=checkbox id="type2"　name='type2' value='080血脂' checked="checked">血脂 </td>
              </tr>
               <tr class=common>
                <td class= common> <input type=checkbox id="type2" name='type2' value='090肾功能' checked="checked">肾功能 </td>
              </tr>
              <tr class=common>
                <td class= common><input type=checkbox id="type2" name='type2' value='140衰弱测试'>衰弱测试 </td>
              </tr>
          </table>
       </div>
       ...
       <div id = "bodyCheckType3" style= "display: none">
          <table  class= common>
              ...
              <tr class=common>
                <td class= common> <input type=checkbox id="type3" name='type3' value='070心电图' checked="checked">心电图 </td>
              </tr>
              <tr class=common>
                <td class= common> <input type=checkbox id="type3" name='type3' value='020尿常规' checked="checked">尿常规 </td>
              </tr>
               <tr class=common>
               ...
               <tr class=common>
                <td class= common> <input type=checkbox id="type3" name='type3' value='040血常规' checked="checked">血常规 </td>
              </tr>
               <tr class=common>
                <td class= common> <input type=checkbox id="type3" name='type3' value='050肝功能' checked="checked">肝功能 </td>
              </tr>
               <tr class=common>
                <td class= common> <input type=checkbox id="type3" name='type3' value='060乙肝表面抗原' checked="checked">乙肝表面抗原 </td>
              </tr>
               <tr class=common>
                <td class= common> <input type=checkbox id="type3" name='type3' value='080血脂' checked="checked">血脂 </td>
              </tr>
               <tr class=common>
                <td class= common> <input type=checkbox id="type3" name='type3' value='090肾功能' checked="checked">肾功能 </td>
              </tr>
              </tr>
               <tr class=common>
                <td class= common> <input type=checkbox id="type3" name='type3' value='100眼底' checked="checked">眼底 </td>
              </tr>
              </tr>
               <tr class=common>
                <td class= common> <input type=checkbox id="type3" name='type3' value='110B超' checked="checked">B超 </td>
              </tr>
              </tr>
               <tr class=common>
                <td class= common> <input type=checkbox id="type3" name='type3' value='120胸部透视' checked="checked">胸部透视 </td>
              </tr>
              <tr class=common>
                <td class= common><input type=checkbox id="type3" name='type3' value='140衰弱测试'>衰弱测试 </td>
              </tr>
          </table>
       </div>
       ...
       <div id = "bodyCheckType4" style= "display: none">
          <table  class= common>
              ...
              <tr class=common>
                <td class= common> <input type=checkbox id="type4" name='type4' value='070心电图' checked="checked">心电图 </td>
              </tr>
              <tr class=common>
                <td class= common> <input type=checkbox id="type4" name='type4' value='020尿常规' checked="checked">尿常规 </td>
              </tr>
               <tr class=common>
               ...
               <tr class=common>
                <td class= common> <input type=checkbox id="type4" name='type4' value='040血常规' checked="checked">血常规 </td>
              </tr>
               <tr class=common>
                <td class= common> <input type=checkbox id="type4" name='type4' value='050肝功能' checked="checked">肝功能 </td>
              </tr>
               <tr class=common>
                <td class= common> <input type=checkbox id="type4" name='type4' value='060乙肝表面抗原' checked="checked">乙肝表面抗原 </td>
              </tr>
               <tr class=common>
                <td class= common> <input type=checkbox id="type4" name='type4' value='080血脂' checked="checked">血脂 </td>
              </tr>
               <tr class=common>
                <td class= common> <input type=checkbox id="type4" name='type4' value='090肾功能' checked="checked">肾功能 </td>
              </tr>
              </tr>
               <tr class=common>
                <td class= common> <input type=checkbox id="type4" name='type4' value='100眼底' checked="checked">眼底 </td>
              </tr>
              </tr>
               <tr class=common>
                <td class= common> <input type=checkbox id="type4" name='type4' value='110B超' checked="checked">B超 </td>
              </tr>
              </tr>
               <tr class=common>
                <td class= common> <input type=checkbox id="type4" name='type4' value='120胸部透视' checked="checked">胸部透视 </td>
              </tr>
              </tr>
               <tr class=common>
                <td class= common> <input type=checkbox id="type4" name='type4' value='130妇科检查' checked="checked">妇科检查 </td>
              </tr>
              <tr class=common>
                <td class= common><input type=checkbox id="type4" name='type4' value='140衰弱测试'>衰弱测试 </td>
              </tr>
          </table>
