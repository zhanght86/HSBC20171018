...
mySql917105540.setResourceName("uw.RnewManuHealthQSql");//指定使用的properties文件名
mySql917105540.setSqlId(sqlid917105540);//指定使用的Sql的id
mySql917105540.addSubPara(tContNo);//指定传入的参数
mySql917105540.addSubPara(tInsuredNo);//指定传入的参数
...
mySql917105838.setResourceName("uw.RnewManuHealthQSql");//指定使用的properties文件名
mySql917105838.setSqlId(sqlid917105838);//指定使用的Sql的id
mySql917105838.addSubPara(tContNo);//指定传入的参数
mySql917105838.addSubPara(tContNo);//指定传入的参数
mySql917105838.addSubPara(tContNo);//指定传入的参数
mySql917105838.addSubPara(tContNo);//指定传入的参数
mySql917105838.addSubPara(tContNo);//指定传入的参数
mySql917105838.addSubPara(tContNo);//指定传入的参数
mySql917105838.addSubPara(tPrtSeq);//指定传入的参数
...
mySql917110327.setResourceName("uw.RnewManuHealthQSql");//指定使用的properties文件名
mySql917110327.setSqlId(sqlid917110327);//指定使用的Sql的id
mySql917110327.addSubPara(tContNo);//指定传入的参数
mySql917110327.addSubPara(arrReturn[0][4]);//指定传入的参数
mySql917110327.addSubPara(arrReturn[0][5]);//指定传入的参数
mySql917110327.addSubPara(tPrtSeq);//指定传入的参数
mySql917110327.addSubPara(tday);//指定传入的参数
mySql917110327.addSubPara(tday);//指定传入的参数
mySql917110327.addSubPara(time);//指定传入的参数
...
mySql917110528.setResourceName("uw.RnewManuHealthQSql");//指定使用的properties文件名
mySql917110528.setSqlId(sqlid917110528);//指定使用的Sql的id
mySql917110528.addSubPara(tContNo);//指定传入的参数
mySql917110528.addSubPara(tPrtSeq);//指定传入的参数
...
mySql917110609.setResourceName("uw.RnewManuHealthQSql");//指定使用的properties文件名
mySql917110609.setSqlId(sqlid917110609);//指定使用的Sql的id
mySql917110609.addSubPara(tContNo);//指定传入的参数
mySql917110609.addSubPara(tPrtSeq);//指定传入的参数
...
mySql917110658.setResourceName("uw.RnewManuHealthQSql");//指定使用的properties文件名
mySql917110658.setSqlId(sqlid917110658);//指定使用的Sql的id
mySql917110658.addSubPara(tContNo);//指定传入的参数
mySql917110658.addSubPara(tPrtSeq);//指定传入的参数
...
mySql917110738.setResourceName("uw.RnewManuHealthQSql");//指定使用的properties文件名
mySql917110738.setSqlId(sqlid917110738);//指定使用的Sql的id
mySql917110738.addSubPara(tContNo);//指定传入的参数
mySql917110738.addSubPara(tPrtSeq);//指定传入的参数
...
mySql917110843.setResourceName("uw.RnewManuHealthQSql");//指定使用的properties文件名
mySql917110843.setSqlId(sqlid917110843);//指定使用的Sql的id
mySql917110843.addSubPara(tContNo);//指定传入的参数
...
mySql917111237.setResourceName("uw.RnewManuHealthQSql");//指定使用的properties文件名
mySql917111237.setSqlId(sqlid917111237);//指定使用的Sql的id
mySql917111237.addSubPara(tCustomerNo);//指定传入的参数
...
mySql917111352.setResourceName("uw.RnewManuHealthQSql");//指定使用的properties文件名
mySql917111352.setSqlId(sqlid917111352);//指定使用的Sql的id
mySql917111352.addSubPara(tContNo);//指定传入的参数
...
mySql917111505.setResourceName("uw.RnewManuHealthQSql");//指定使用的properties文件名
mySql917111505.setSqlId(sqlid917111505);//指定使用的Sql的id
mySql917111505.addSubPara(prtSeq);//指定传入的参数
...
mySql917111904.setResourceName("uw.RnewManuHealthQSql");//指定使用的properties文件名
mySql917111904.setSqlId(sqlid917111904);//指定使用的Sql的id
mySql917111904.addSubPara(tContNo);//指定传入的参数
mySql917111904.addSubPara(tContNo);//指定传入的参数
mySql917111904.addSubPara(tContNo);//指定传入的参数
mySql917111904.addSubPara(tContNo);//指定传入的参数
mySql917111904.addSubPara(tContNo);//指定传入的参数
mySql917111904.addSubPara(tContNo);//指定传入的参数
mySql917111904.addSubPara(tPrtSeq);//指定传入的参数
...
mySql917112220.setResourceName("uw.RnewManuHealthQSql");//指定使用的properties文件名
mySql917112220.setSqlId(sqlid917112220);//指定使用的Sql的id
mySql917112220.addSubPara(tContNo);//指定传入的参数
mySql917112220.addSubPara(arrReturn[0][4]);//指定传入的参数
mySql917112220.addSubPara(arrReturn[0][5]);//指定传入的参数
mySql917112220.addSubPara(tPrtSeq);//指定传入的参数
...
mySql917112317.setResourceName("uw.RnewManuHealthQSql");//指定使用的properties文件名
mySql917112317.setSqlId(sqlid917112317);//指定使用的Sql的id
mySql917112317.addSubPara(tPrtSeq);//指定传入的参数
...
mySql917112405.setResourceName("uw.RnewManuHealthQSql");//指定使用的properties文件名
mySql917112405.setSqlId(sqlid917112405);//指定使用的Sql的id
mySql917112405.addSubPara(tPrtSeq);//指定传入的参数
...
mySql917112455.setResourceName("uw.RnewManuHealthQSql");//指定使用的properties文件名
mySql917112455.setSqlId(sqlid917112455);//指定使用的Sql的id
mySql917112455.addSubPara(tPrtSeq);//指定传入的参数
...
mySql917112553.setResourceName("uw.RnewManuHealthQSql");//指定使用的properties文件名
mySql917112553.setSqlId(sqlid917112553);//指定使用的Sql的id
mySql917112553.addSubPara(tContNo);//指定传入的参数
mySql917112553.addSubPara(tPrtSeq);//指定传入的参数
...
mySql917112640.setResourceName("uw.RnewManuHealthQSql");//指定使用的properties文件名
mySql917112640.setSqlId(sqlid917112640);//指定使用的Sql的id
mySql917112640.addSubPara(tPrtSeq);//指定传入的参数
...
mySql917112720.setResourceName("uw.RnewManuHealthQSql");//指定使用的properties文件名
mySql917112720.setSqlId(sqlid917112720);//指定使用的Sql的id
mySql917112720.addSubPara(tPrtSeq);//指定传入的参数
...
mySql917112759.setResourceName("uw.RnewManuHealthQSql");//指定使用的properties文件名
mySql917112759.setSqlId(sqlid917112759);//指定使用的Sql的id
mySql917112759.addSubPara(tContNo);//指定传入的参数
mySql917112759.addSubPara(tPrtSeq);//指定传入的参数
