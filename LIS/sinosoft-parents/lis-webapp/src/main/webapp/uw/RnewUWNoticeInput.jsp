...
<SCRIPT src="RnewUWNoticeInput.js"></SCRIPT>
<LINK href="../common/css/Project.css" rel=stylesheet type=text/css>
<LINK href="../common/css/Project3.css" rel=stylesheet type=text/css>
<LINK href="../common/css/mulLine.css" rel=stylesheet type=text/css>
<%@include file="RnewUWNoticeInit.jsp"%>
  <title>打印承保核保通知书 </title>
</head>
<body  onload="initForm();" >
  <form action="./RnewUWNoticeQuery.jsp" method=post name=fm id="fm" target="fraSubmit">
    <!-- 投保单信息部分 -->
    ...
    <table  class= common align=center>
          ...
          CodeData="0|^45|续保核保通知书"
          style="background:url(../common/images/select--bg_03.png) no-repeat right center" 
          onclick="return showCodeListEx('NoticeType', [this,NoticeTypeName],[0,1],null,null,null,1)"
          ondblclick="return showCodeListEx('NoticeType', [this,NoticeTypeName],[0,1],null,null,null,1)"
          onkeyup="return showCodeListKeyEx('NoticeType', [this,NoticeTypeName],[0,1],null,null,null,1)"        
       ...
       <!--   <Input  type = "hidden" class= common name=PrtNo >-->
         ...
         <TD  class= input5>  <Input class="code" name=AgentCode   id=AgentCode 
  ...
  <form action="./RnewUWF1PSave.jsp" method=post name=fmSave target="fraSubmit">
    <table>
    	<tr>
        	<td class=common>
