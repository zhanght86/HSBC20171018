...
{                  
  ...
  try {
	  ...
	  iArray[2][2]=100;            			//列最大值
	  iArray[2][3]=2; 
      iArray[2][4]="renoticetype";       //是否引用代码:null||""为不引用
      ...
      iArray[5][4]="AgentCode";              	        //是否引用代码:null||""为不引用
      iArray[5][5]="4";              	                //引用代码对应第几列，'|'为分割符
      iArray[5][9]="代理人编码|code:AgentCode&NOTNULL";
      iArray[5][18]=250;
      iArray[5][19]= 0 ;
      
      iArray[6]=new Array();
	  iArray[6][0]="投保单印刷号";        //列名
	  iArray[6][1]="0px";            	//列宽
	  iArray[6][2]=200;            			//列最大值
	  iArray[6][3]=0; 									//是否允许输入,1表示允许，0表示不允许
	  
      iArray[7]=new Array();
	  iArray[7][0]="工作流任务编码";        //列名
	  iArray[7][1]="0px";            	//列宽
	  iArray[7][2]=200;            			//列最大值
	  iArray[7][3]=0; 									//是否允许输入,1表示允许，0表示不允许
	  
	  iArray[8]=new Array();
	  iArray[8][0]="工作流子任务编码";        //列名
	  iArray[8][1]="0px";            	//列宽
	  iArray[8][2]=200;            			//列最大值
	  iArray[8][3]=0; 									//是否允许输入,1表示允许，0表示不允许
	  
	  iArray[9]=new Array();
	  iArray[9][0]="工作流子节点号";        //列名
	  iArray[9][1]="0px";            	//列宽
	  iArray[9][2]=200;            			//列最大值
	  iArray[9][3]=0; 	
