...
try
{
	parent.document.all.iframe4.height = screen.availHeight;	//add by liuyuxiao 2011-05-26
}
catch(e)
{}
  ...
  function queryScanType() {
		...
		mySql48.setResourceName("uw.QuestInputSql48"); //指定使用的properties文件名
...
<!--标题与状态区域-->
	...
	<frameset name="fraSet" cols="*" frameborder="yes" border="1" framespacing="0" rows="0,50%,*,0">	
		...
		<!--交互区域-->
		<frame id="fraPic" name="fraPic" scrolling="auto" noresize src="../common/EasyScanQuery/EasyScanQuery.jsp?prtNo=<%=request.getParameter("ContNo")%>&QueryType=3"> 
		<frame id="fraInterface" name="fraInterface" scrolling="auto" src="./ImageQuery.jsp?ContNo=<%=request.getParameter("ContNo")%>">
    	<!--下一步页面区域-->     
    	<frame id="fraNext1" name="fraNext1" scrolling="auto" src="about:blank">
	</frameset> 
</frameset>
<noframes>
	<body bgcolor="#ffffff">
