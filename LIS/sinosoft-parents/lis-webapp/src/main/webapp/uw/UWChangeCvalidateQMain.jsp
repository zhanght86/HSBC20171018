...
<script language="javascript">
  ...
  function queryScanType() {
    ...
    var sqlid1="UWChangeCvalidateQMainSql1";
	var mySql1=new SqlClass();
	mySql1.setResourceName("uw.UWChangeCvalidateQMainSql"); // 指定使用的properties文件名
...
<!--标题与状态区域-->
	...
	<frameset name="fraSet" cols="*" frameborder="yes" border="1" framespacing="0" rows="0,50%,*,0">
		...
		<frame id="fraInterface" name="fraInterface" scrolling="auto" src="./UWChangeCvalidateInput.jsp?ContNo=<%=request.getParameter("ContNo")%>&PrtNo=<%=request.getParameter("prtNo")%>&QueryFlag=<%=request.getParameter("QueryFlag")%>">
    	<!--下一步页面区域-->
