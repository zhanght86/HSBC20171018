...
%>  
		...
		<!--交互区域-->
		<frame id="fraInterface" name="fraInterface" noresize scrolling="auto" src="./BQChangeRiskPlanInput.jsp?ContNo=<%=request.getParameter("ContNo")%>&MissionID=<%=request.getParameter("MissionID")%>&SubMissionID=<%=request.getParameter("SubMissionID")%>&PrtNo=<%=request.getParameter("PrtNo")%>&QueryFlag=<%=request.getParameter("QueryFlag")%>&InsuredNo=<%=request.getParameter("InsuredNo")%>&InsuredSumLifeAmnt=<%=request.getParameter("InsuredSumLifeAmnt")%>&InsuredSumHealthAmnt=<%=request.getParameter("InsuredSumHealthAmnt")%>&EdorNo=<%=request.getParameter("EdorNo") %>&EdorAcceptNo=<%=request.getParameter("EdorAcceptNo") %>&EdorType=<%=request.getParameter("EdorType") %>">
  	<!--险种界面区域-->
