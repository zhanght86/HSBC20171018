...
var sqlid1="EdorQueryCusSql1";
	    ...
	    var aSQL=mySql1.getString();	
//var aSQL= "select a.edorno,d.appntname,a.edorappdate,a.edorvalidate,(select b.codename from ldcode b where b.codetype='edorcontuwstate' and trim(a.uwstate)=trim(b.code)) " + " from LPEdorMain a,lccont d  where  d.contno=a.contno  and d.appntno='"+customerNo+"'";
