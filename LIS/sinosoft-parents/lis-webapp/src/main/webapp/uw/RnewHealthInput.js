...
mySql915152743.setResourceName("uw.RnewHealthInputSql");//指定使用的properties文件名
mySql915152743.setSqlId(sqlid915152743);//指定使用的Sql的id
mySql915152743.addSubPara(fm.QContNo.value);//指定传入的参数
...
mySql915152743.addSubPara(comcode+"%%");//指定传入的参数
...
mySql915153030.setResourceName("uw.RnewHealthInputSql");//指定使用的properties文件名
mySql915153030.setSqlId(sqlid915153030);//指定使用的Sql的id
mySql915153030.addSubPara(ContNo);//指定传入的参数
mySql915153030.addSubPara(PrtSeq);//指定传入的参数
...
mySql915153202.setResourceName("uw.RnewHealthInputSql");//指定使用的properties文件名
mySql915153202.setSqlId(sqlid915153202);//指定使用的Sql的id
mySql915153202.addSubPara(fm.PrtNo.value);//指定传入的参数
...
mySql915153245.setResourceName("uw.RnewHealthInputSql");//指定使用的properties文件名
mySql915153245.setSqlId(sqlid915153245);//指定使用的Sql的id
mySql915153245.addSubPara(fm.PrtNo.value);//指定传入的参数
...
mySql915153400.setResourceName("uw.RnewHealthInputSql");//指定使用的properties文件名
mySql915153400.setSqlId(sqlid915153400);//指定使用的Sql的id
mySql915153400.addSubPara(fm.PrtNo.value);//指定传入的参数
mySql915153400.addSubPara(fm.PrtNo.value);//指定传入的参数
...
mySql915153538.setResourceName("uw.RnewHealthInputSql");//指定使用的properties文件名
mySql915153538.setSqlId(sqlid915153538);//指定使用的Sql的id
mySql915153538.addSubPara(fm.PrtNo.value);//指定传入的参数
...
mySql915153652.setResourceName("uw.RnewHealthInputSql");//指定使用的properties文件名
mySql915153652.setSqlId(sqlid915153652);//指定使用的Sql的id
mySql915153652.addSubPara(fm.PrtNo.value);//指定传入的参数
mySql915153652.addSubPara(fm.PrtNo.value);//指定传入的参数
...
mySql915153849.setResourceName("uw.RnewHealthInputSql");//指定使用的properties文件名
mySql915153849.setSqlId(sqlid915153849);//指定使用的Sql的id
mySql915153849.addSubPara(fm.PrtNo.value);//指定传入的参数
...
mySql915154004.setResourceName("uw.RnewHealthInputSql");//指定使用的properties文件名
mySql915154004.setSqlId(sqlid915154004);//指定使用的Sql的id
mySql915154004.addSubPara(fm.PrtNo.value);//指定传入的参数
mySql915154004.addSubPara(fm.PrtNo.value);//指定传入的参数
