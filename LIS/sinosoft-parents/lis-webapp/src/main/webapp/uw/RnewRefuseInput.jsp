...
<SCRIPT src="RnewRefuseInput.js"></SCRIPT>
<LINK href="../common/css/Project.css" rel=stylesheet type=text/css>
<LINK href="../common/css/Project3.css" rel=stylesheet type=text/css>
<LINK href="../common/css/mulLine.css" rel=stylesheet type=text/css>
<%@include file="RnewRefuseInit.jsp"%>
  <title>打印续保拒保通知书 </title>
</head>
<body  onload="initForm();" >
  <form action="./RnewRefuseQuery.jsp" method=post name=fm  id="fm" target="fraSubmit">
    <!-- 投保单信息部分 -->
    ...
    <table  class= common align=center>
          ...
          <TD class= input5 ><Input class="codeno" id="ManageCom" name = ManageCom  id = ManageCom 
  ...
  <form action="./RnewRefuseSave.jsp" method=post name=fmSave target="fraSubmit">
    <table>
    	<tr>
        	<td class=common>
