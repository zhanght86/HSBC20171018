...
<SCRIPT src="BQMeet.js"></SCRIPT>
<LINK href="../common/css/Project.css" rel=stylesheet type=text/css>
<LINK href="../common/css/Project3.css" rel=stylesheet type=text/css>
<LINK href="../common/css/mulLine.css" rel=stylesheet type=text/css>
<%@include file="BQMeetInit.jsp"%>
...
<body  onload="initForm();" >
  ...
  <form action="./BQMeetF1PSave.jsp" method=post name=fmSave id=fmSave target="f1print">
    <table>
    	<tr>
        	<td class=common>
    ...
    <br><br><br><br>
  	...
  	<input type=hidden id="FunctionID" name="FunctionID" value='10020312'>
