...
//险种编码,险种名称,加费类型,加费类别,加费方式,评点,加费金额,加费原因,起期,止期,下发状态,保单号,主险保单号
      ...
      iArray[2][11] = str;
      iArray[2][12] = "2|1|3|9|10|12|13";
      iArray[2][13] = "1|0|2|3|4|5|6";
      iArray[2][19] = 1;
...
*/      
      ...
      iArray[15][4]="Currency";              	        //是否引用代码:null||""为不引用
      iArray[15][9]="币种|code:Currency";
...
function initOldRislPlanGrid(str)
  ...
  var iArray = new Array();
      ...
      iArray[9][3]=2;              			//是否允许输入,1表示允许，0表示不允许 
	  	iArray[9][4]="uwstate";              	        //是否引用代码:null||""为不引用
      ...
      iArray[12][4]="Currency";              	        //是否引用代码:null||""为不引用
