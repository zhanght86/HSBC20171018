...
function initForm(tContNo,tMissionID,tSubMission,tPrtNo,tPrtSeq,tCustomerNo,tUWFlag)
{
  try
  {
	initHide(tContNo,tMissionID,tSubMission,tPrtNo,tPrtSeq,tCustomerNo,tUWFlag);
...
function initHealthOtherGrid()
  {                              
    var iArray = new Array();
      ...
      iArray[1][5]="1|2";     //引用代码对应第几列，'|'为分割符
      iArray[1][6]="0|1";    //上面的列中放置引用代码中第几位值
     // iArray[1][15]="#1#";    //上面的列中放置引用代码中第几位值
     // iArray[1][16]=" #1# and not exists (select 1 from LCPENoticeReply where 1=1 and ContNo = #"+tContNo+"# and PrtSeq = #"+tPrtSeq+"# and peitemcode = codetype )";    
      iArray[1][18] = 500;
...
function initHide(tContNo,tMissionID,tSubMission,tPrtNo,tPrtSeq,tCustomerNo,tUWFlag)
{
  ...
  document.all('MissionID').value = tMissionID;
	...
	document.all('UWFlag').value = tUWFlag;
