...
//
//  //把dataStream存储到磁盘文件
//  //loggerDebug("EdorAskSave","存储文件到"+strVFPathName);
...
loggerDebug("EdorAskSave","标准路径==="+tPath);
...
loggerDebug("EdorAskSave","合同号==="+tContNo);
...
loggerDebug("EdorAskSave","问卷的行数==="+testSSRS.MaxRow);
