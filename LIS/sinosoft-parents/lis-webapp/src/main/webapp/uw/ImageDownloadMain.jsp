...
<!--标题与状态区域-->
	...
	<frameset name="fraSet" cols="*" frameborder="yes" border="1" framespacing="0" rows="0,0,100%,0">
		<!--菜单区域-->
		<frame name="fraMenu" scrolling="yes" noresize src="about:blank">
		<!--交互区域-->
		<frame id="fraPic" name="fraPic" scrolling="auto" noresize src="">
		<frame id="fraInterface" name="fraInterface" scrolling="auto" src="./ImageDownloadInput.jsp?PrtNo=<%=request.getParameter("PrtNo")%>">
    	<!--下一步页面区域-->
