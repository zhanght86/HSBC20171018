...
function queryClick()
{
	...
	// 书写SQL语句
  var strSql = "select PrtNo, ProposalContNo, NotePadCont, Operator, MakeDate, MakeTime from RnewNotePad where PrtNo='" + PrtNo 
    ...
    var  sqlid1="RnewNotePadSql0";
	var  mySql1=new SqlClass();
	mySql1.setResourceName("uw.RnewNotePadSql"); //指定使用的properties文件名
