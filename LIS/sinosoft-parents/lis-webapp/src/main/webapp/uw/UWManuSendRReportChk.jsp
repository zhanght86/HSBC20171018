...
try
{
  	if (flag == true)
  	{
		...
		String busiName="cbcheckGrpUWRReportUI";
		...
		if (tBusinessDelegate.submitData(tVData,"INSERT",busiName) == false)
		{
			...
			for (int i = 0; i < n; i++)
			Content = " 发集体生调通知书失败，原因是: " + tBusinessDelegate.getCErrors().getError(0).errorMessage;
			FlagStr = "Fail";
		}
		...
		if (FlagStr == "Fail")
		{
		    ...
		    {
		    	Content = " 发集体生调通知书失败，原因是:" + tError.getFirstError();
		    	FlagStr = "Fail";
		    }
		}
	} 
