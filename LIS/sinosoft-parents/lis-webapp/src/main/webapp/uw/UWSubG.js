...
function easyQueryClick()
{
	...
	/*if (PolNo != null || PolNo != "")
	{
		strSQL = "select a.contno,a.polno,a.uwno,a.passflag,a.uwidea,a.operator,a.modifydate from LCUWSub a where 1=1 "
			 + " and a.polno ='" + PolNo + "'"
			 + " union"
			 + " select c.contno,'合同单',c.uwno,c.passflag,c.uwidea,c.operator,c.modifydate from LCCUWSub c where 1=1 "
			 + " and c.contno ='" + ContNo + "'"
	}
	else
	{*/
//		strSQL = " select c.contno,'合同单',c.uwno,c.passflag,c.uwidea,c.operator,c.modifydate from LCCUWSub c where 1=1 "
//			 + " and c.contno ='" + ContNo + "'"
	//}
			 var sqlid1="UWSubGSql1";
				var mySql1=new SqlClass();
				mySql1.setResourceName("uw.UWSubGSql"); //指定使用的properties文件名
