...
<%
  ...
  loggerDebug("MSSendAllNoticeInit","ContNo:"+tContNo);
  loggerDebug("MSSendAllNoticeInit","Flag:"+tFlag);
  loggerDebug("MSSendAllNoticeInit","tNoticeType:"+tNoticeType);
