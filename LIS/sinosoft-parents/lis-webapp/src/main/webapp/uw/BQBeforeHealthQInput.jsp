...
<%
  ...
  GlobalInput tGI = new GlobalInput();
	...
	loggerDebug("BQBeforeHealthQInput","operator:"+tGI.Operator);
%>
<script>
	var operator = "<%=tGI.Operator%>";   //记录操作员
	var manageCom = "<%=tGI.ManageCom%>"; //记录登陆机构
  var tCustomerNo = "<%=tCustomerNo%>"; //客户号
  var tContNo = "<%=tContNo%>";
...
<head>
  ...
  <script src="BQBeforeHealthQ.js"></SCRIPT>  
  
  <%@include file="BQBeforeHealthQInit.jsp"%>  
</head>
