...
<%
  ...
  String tInsuredSumHealthAmnt = request.getParameter("InsuredSumHealthAmnt"); 
   loggerDebug("UWChangeRiskPlanInput","tInsuredNo:"+tInsuredNo);
%>
...
<meta http-equiv="Content-Type" content="text/html; charset=GBK">
  ...
  <SCRIPT src="UWChangeRiskPlan.js"></SCRIPT>
  <script src="../common/javascript/MultiCom.js"></script>
  <LINK href="../common/css/Project.css" rel=stylesheet type=text/css>
  <LINK href="../common/css/Project3.css" rel=stylesheet type=text/css>
  <LINK href="../common/css/mulLine.css" rel=stylesheet type=text/css>
  <title> 客户承保结论变更录入 </title>
  <%@include file="UWChangeRiskPlanInit.jsp"%>
  
</head>
<body  onload="initForm('<%=tContNo%>','<%=tMissionID%>','<%=tSubMissionID%>','<%=tPrtNo%>','<%=tInsuredNo%>');" >

  <form method=post name=fm id="fm" target="fraSubmit" action= "./UWChangeRiskPlanChk.jsp">
    <!-- 以往核保记录部分（列表） -->
    <!--待增加被保人信息-->
    <Div   style= "display: ''">
    	<table>
    ...
    <Div  id= "divSpecAll" style= "display: ''">
		    ...
		    <table style= "display: none">
		     ...
		     <table>
		      ...
		      <INPUT type= "button" id="button1" name= "sure" value="保  存" class= cssButton  onclick="submitForm(1)">			
		      ...
		      <INPUT type= hidden id="button5" name= "sure" value="修改下发标记" class= cssButton  onclick="submitForm(4)">			
    ...
    <hr class="line">
      ...
      <TD  class= title> <textarea name="UWIdea" id=UWIdea cols="100%" rows="5" witdh=100% class= common ></textarea></TD>
      </TR>
     </table>
