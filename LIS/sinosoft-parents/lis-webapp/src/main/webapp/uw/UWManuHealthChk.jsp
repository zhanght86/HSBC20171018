...
<%
  ...
  loggerDebug("UWManuHealthChk","step1..................................");
    ...
    loggerDebug("UWManuHealthChk","step2..................................tHealthItem:"+tHealthItem+":tHealthCode:"+tHealthCode);
    ...
    //loggerDebug("UWManuHealthChk","count:"+ChkCount);
      ...
      //  tLCPENoticeSchema.setProposalContNo(tContNo);
        ...
        tLCPENoticeSchema.setCustomerType(tCustomerType);
  ...
  if (flag == true)
  {
       ...
       // UWAutoHealthBL tUWAutoHealthBL = new UWAutoHealthBL();
        String busiName="cbcheckUWAutoHealthBL";
        BusinessDelegate tBusinessDelegate=BusinessDelegate.getBusinessDelegate();
        
        if(tBusinessDelegate.submitData(tVData,tAction,busiName)==false)
        {
