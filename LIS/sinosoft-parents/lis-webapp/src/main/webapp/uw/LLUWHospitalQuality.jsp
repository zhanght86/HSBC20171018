...
<%
  ...
  GlobalInput tGI = new GlobalInput();
	...
	if(tBusinessDelegate.submitData(new VData(),"INIT",busiName))
		loggerDebug("LLUWHospitalQuality","初始化成功...");
...
<script>
	...
	var ClmNo = "<%=request.getParameter("ClmNo")%>";
...
<meta http-equiv="Content-Type" content="text/html; charset=GBK">
  ...
  <SCRIPT src="LLUWHospitalQuality.js"></SCRIPT>
  <%@include file="LLUWHospitalQualityInit.jsp"%>
...
<body  onload="initForm(ContNo);" >
  <form method=post name=fm id="fm" target="fraSubmit" action="./UWHospitalQualitySave.jsp">
    ...
    <table class= common>
    	<TR  class= common>
          ...
          <TD  class= input> <Input class=code readonly name=HospitalCode id="HospitalCode" style="background: url(../common/images/guanliyuan-bg.png) no-repeat center;" onClick="showCodeListEx('HospitalCode',[this],[0,1],null,null,null,1);" ondblClick="showCodeListEx('HospitalCode',[this],[0,1],null,null,null,1);" 
 ...
 <div class="maxbox">
 	<table class= common align=center>
    	<%
    	//直接写到界面上
    	 for(int i=1;i<=tSSRS_Score.getMaxRow();i++)
                {
                	String tSubCode = tSSRS_Score.GetText(i,1);
                	String tSubName = tSSRS_Score.GetText(i,2);
                	String tother = tSSRS_Score.GetText(i,3);
                	if(i==1)
                	{
...
<table class=common border=0 width=100%>
	<tr>
      <td class=common>
       <IMG  src= "../common/images/butExpand.gif" style= "cursor:hand;" OnClick= "showPage(this,HealthType);">
      </td>
      <td class=titleImg align=center>体检医院管理岗</td>
	</tr>
</table>
...
<table class=common border=0 width=100%>
    ...
    <td class=titleImg align=center>陪检内勤</td>
	</tr>
</table>
<div id="HealthType">
  ...
  <INPUT CLASS=cssButton VALUE="确  定" id="sure" name=sure TYPE=button onClick="UpdateClick()">
