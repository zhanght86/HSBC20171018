...
//		+ " and polno = '"+tProposalNo+"'";
	...
	mySql1.setResourceName("uw.UWGSpecSql"); //指定使用的properties文件名
	mySql1.setSqlId(sqlid1);//指定使用的Sql的id
	mySql1.addSubPara(k);//指定传入的参数
	mySql1.addSubPara(k);//指定传入的参数
	mySql1.addSubPara(tProposalNo);//指定传入的参数
...
//			 + " and payplancode like '000000%%'";			
	...
	mySql2.setResourceName("uw.UWGSpecSql"); //指定使用的properties文件名
	mySql2.setSqlId(sqlid2);//指定使用的Sql的id
	mySql2.addSubPara(tProposalNo);//指定传入的参数
...
//			 + " and grppolno = '"+tProposalNo+"'";
	...
	mySql3.setResourceName("uw.UWGSpecSql"); //指定使用的properties文件名
	mySql3.setSqlId(sqlid3);//指定使用的Sql的id
	mySql3.addSubPara(tProposalNo);//指定传入的参数
...
//			 + " and specno = (select max(specno) from lcspec where polno = '"+tProposalNo+"')";
	...
	mySql4.setResourceName("uw.UWGSpecSql"); //指定使用的properties文件名
	mySql4.setSqlId(sqlid4);//指定使用的Sql的id
	mySql4.addSubPara(tProposalNo);//指定传入的参数
