...
<meta http-equiv="Content-Type" content="text/html; charset=GBK">
  ...
  <SCRIPT src="BQSendAllNotice.js"></SCRIPT>
  <LINK href="../common/css/Project.css" rel=stylesheet type=text/css>
  <LINK href="../common/css/Project3.css" rel=stylesheet type=text/css>
  <LINK href="../common/css/mulLine.css" rel=stylesheet type=text/css>
  <title>核保问题件录入</title>
  <%@include file="BQSendAllNoticeInit.jsp"%>
</head>
<body  onload="initForm('<%=tContNo%>','<%=tMissionID%>','<%=tSubMissionID%>','<%=tEdorNo%>','<%=tEdorType%>');" >
  <form method=post name=fm id="fm" target="fraSubmit" action= "./BQSendAllNoticeChk.jsp">
  	
  		<table>
		<tr>
			<td><input class="cssButton" value="核保通知书信息" id="InsuredSequencename"  name="InsuredSequencename" readonly ></td>
		</tr>
	</table>
	<!--
  ...
  <table class= common align=center width="121%" height="37%">
   ...
   <Div  id= "divDone" style= "display: ''">
     <table>
    	<tr>
        	<td class=common>
			    <IMG  src= "../common/images/butExpand.gif" style= "cursor:hand;" OnClick= "showPage(this,divAll);">
    		</td>
    		<td class= titleImg>
    			已发送信息
    		</td>
	  ...
	  <Div  id= "divAll" style= "display: ''">
	      <table>
	    	<tr>
	        	<td class=common>
				    <IMG  src= "../common/images/butCollapse.gif" style= "cursor:hand;" OnClick= "showPage(this,divQuestD);">
	    		</td>
	    		<td class= titleImg>
	    			已发送问题件信息
	    		</td>
	     ...
	     <table>
	    	<tr>
	        	<td class=common>
				    <IMG  src= "../common/images/butCollapse.gif" style= "cursor:hand;" OnClick= "showPage(this,divUWSpecD);">
	    		</td>
	    		<td class= titleImg>
	    			已发送特约信息
	    		</td>
	      ...
	      <table>
	    	<tr>
	        	<td class=common>
				    <IMG  src= "../common/images/butCollapse.gif" style= "cursor:hand;" OnClick= "showPage(this,divUWHealthD);">
	    		</td>
	    		<td class= titleImg>
	    			已发送体检信息
	    		</td>
	      ...
	      <table>
	    	<tr>
	        	<td class=common>
				    <IMG  src= "../common/images/butCollapse.gif" style= "cursor:hand;" OnClick= "showPage(this,divUWExistD);">
	    		</td>
	    		<td class= titleImg>
	    			已发送生调信息
	    		</td>
	      ...
	      <table>
	    	<tr>
	        	<td class=common>
				    <IMG  src= "../common/images/butCollapse.gif" style= "cursor:hand;" OnClick= "showPage(this,divUWAddFeeD);">
	    		</td>
	    		<td class= titleImg>
	    			已发送加费信息
	    		</td>
	      ...
	      <Div  id= "divUWAddFeeD" style= "display: ''">	
	      	<table  class= common>
	       		<tr  class= common>
	      	  		<td text-align: left colSpan=1 >
	  					<span id="spanUWAddFeeDGrid" >
	  					</span> 
	  			  	</td>
	  			</tr>
	    	</table>
     ...
     <table>
      ...
      <Div  id= "divAll2" style= "display: ''">      
	      <table>
	    	<tr>
	        	<td class=common>
				    <IMG  src= "../common/images/butCollapse.gif" style= "cursor:hand;" OnClick= "showPage(this,divQuest);">
	    		</td>
	    		<td class= titleImg>
	    			待发送问题件信息
	    		</td>
	    	...
	    	<tr>
	        	<td class=common>
				    <IMG  src= "../common/images/butCollapse.gif" style= "cursor:hand;" OnClick= "showPage(this,divUWSpec);">
	    		</td>
	    		<td class= titleImg>
	    			待发送特约信息
	    		</td>
	      ...
	      <table>
	    	<tr>
	        	<td class=common>
				    <IMG  src= "../common/images/butCollapse.gif" style= "cursor:hand;" OnClick= "showPage(this,divUWHealth);">
	    		</td>
	    		<td class= titleImg>
	    			待发送体检信息
	    		</td>
	      ...
	      <table>
	    	<tr>
	        	<td class=common>
				    <IMG  src= "../common/images/butCollapse.gif" style= "cursor:hand;" OnClick= "showPage(this,divUWExist);">
	    		</td>
	    		<td class= titleImg>
	    			待发送生调信息
	    		</td>
	      ...
	      <table>
	    	<tr>
	        	<td class=common>
				    <IMG  src= "../common/images/butCollapse.gif" style= "cursor:hand;" OnClick= "showPage(this,divUWAddFee);">
	    		</td>
	    		<td class= titleImg>
	    			待发送加费信息
	    		</td>
...
<!-- 	    <table>
  ...
  <p>
    ...
    <input type= "button" id="sure" name= "sure" class= cssButton style="display: none;" value="发送通知书" onClick="submitForm()">
  </P>
