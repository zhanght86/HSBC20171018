...
<body onLoad="initForm();">
	...
	<form action="./BodyCheckBatchPrintSave.jsp" method=post id="fmSave" name=fmSave target="fraSubmit">
		...
		<p>
			<INPUT VALUE="打  印" class=cssButton id="printButton" TYPE=button onClick="printPol();" disabled>
			<INPUT VALUE="VTS 打  印" class=cssButton id="printButton2" TYPE=button onClick="printPol2();">
			<INPUT VALUE="PDF 打  印" class=cssButton id="printButton3" TYPE=button onClick="printPol3();">
			<INPUT VALUE="XSL 打  印" class=cssButton id="printButton3" TYPE=button onClick="printPol4();">
		</p>
