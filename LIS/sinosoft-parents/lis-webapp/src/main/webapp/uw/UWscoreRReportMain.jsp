...
<!--标题与状态区域-->
	...
	<frameset name="fraSet" cols="0%,*,0%" frameborder="no" border="1" framespacing="0" rows="*">
		...
		<!--交互区域-->
		<frame id="fraInterface" name="fraInterface" scrolling="auto" src="./UWscoreRReport.jsp?ContNo=<%=request.getParameter("ContNo")%>&PrtSeq=<%=request.getParameter("PrtSeq")%>&Type=<%=tType%>">
    	<!--下一步页面区域-->
