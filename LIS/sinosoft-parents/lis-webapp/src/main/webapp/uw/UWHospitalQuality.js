...
//             + getWherePart('MakeDate', 'MakeDate');
	...
	mySql1.setResourceName("uw.UWHospitalQualitySql"); //指定使用的properties文件名
...
// 	          + " order by b.modifydate desc,b.modifytime desc";
 	...
 	mySql2.setResourceName("uw.UWHospitalQualitySql"); //指定使用的properties文件名
...
//	  	
	 	...
	 	mySql3.setResourceName("uw.UWHospitalQualitySql"); //指定使用的properties文件名
...
// 	          + " where hospitcode = '"+Field.value+"'";
 	...
 	mySql4.setResourceName("uw.UWHospitalQualitySql"); //指定使用的properties文件名
...
//             + " where hospitcode='"+document.all('HospitalCode').value+"' and contno='"+PrtNo+"' ";
 	...
 	mySql5.setResourceName("uw.UWHospitalQualitySql"); //指定使用的properties文件名
...
//        			 + " from lcpenotice a where contno='"+tPrtNo+"' ";
    ...
    var sqlid6="UWHospitalQualitySql6";
 	...
 	mySql6.setResourceName("uw.UWHospitalQualitySql"); //指定使用的properties文件名
