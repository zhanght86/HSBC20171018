    ...
    <table class=common>
        ...
        <TR  class= title>
         ...
         <!--   <TD  class= title>  体检医师  </TD>
          ...
          <TD  class= input5>
            <Input class="coolDatePicker"  dateFormat="short" id="PEDate" name='PEDate' verify="体检时间|date" id="PEDate" onClick="laydate({elem:'#PEDate'});"><span class="icon"><a onClick="laydate({elem: '#PEDate'});"><img src="../common/laydate/skins/default/icon.png" /></a></span>
          </TD>          
