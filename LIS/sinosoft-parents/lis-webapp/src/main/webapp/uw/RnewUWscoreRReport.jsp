...
<meta http-equiv="Content-Type" content="text/html; charset=GBK">
  ...
  <SCRIPT src="RnewUWscoreRReport.js"></SCRIPT>
  <LINK href="../common/css/Project.css" rel=stylesheet type=text/css>
  <link href="../common/css/Project3.css" rel="stylesheet" type="text/css">
  <LINK href="../common/css/mulLine.css" rel=stylesheet type=text/css>
  <title>核保生调评分</title>
  <%@include file="RnewUWscoreRReportInit.jsp"%>
...
<body  onload="initForm();" >
  ...
  <table  class=common border=0 align=center>
      <tr>
       ...
       <TD  class=input5>
         <Input class= "readonly wid" id="PrtNo" readonly name=PrtNo >            
       </TD> 	    
       <TD class = title5> 所属机构 </TD>
       <TD  class=input5><Input class="readonly wid" id="ManageCom" readonly name=ManageCom ></TD>      
     </tr>    
	      <tr>
  ...
  <Div  id= "divSubtract" class="maxbox" style= "display: ''" >
     <table  class=common border=0 align=center>
	      ...
	      <TD  class=input>
	         <Input class= common id="SScore" name=SScore style="background:url(../common/images/guanliyuan-bg.png) no-repeat right center" ondblclick="calcuSScore();">            
	      </TD>	  
  ...
  <Div  id= "divAdd" class="maxbox" style= "display: ''" >
     <table  class=common border=0 align=center>
	      ...
	      <TD  class=input>
	         <Input class= common id="AScore"  name=AScore style="background:url(../common/images/guanliyuan-bg.png) no-repeat right center" ondblclick="calcuAScore();">            
	      </TD>	  
	      <TD  class= title TYPE=hidden></TD>
			<TD  class=input TYPE=hidden><Input class="common" TYPE=hidden></TD>     
		</tr>
  ...
  <table  class=common border=0 align=center>
      <tr>
       ...
       <TD  class=input5>
         <Input class= "common wid" id="Score" name=Score style="background:url(../common/images/guanliyuan-bg.png) no-repeat right center" ondblclick="calcuScore();">            
       </TD> 	    
       ...
       <TD  class= input5><Input class="code wid" id="Conclusion" name=Conclusion readonly ><!--  ondblclick="showCodeList('RReportScoreCon', [this],[1]);" onkeyup="return showCodeListKey('RReportScoreCon', [this],[1]);"--></TD>      
	      ...
	      <td class=title5>评估人</td>
	       ...
	       <TD  class=input5><Input class= "readonly wid" readonly id="AssessDay" name=AssessDay ></TD>     
	     </tr>    
	  </table> 
  <p> 
    <!--读取信息  校验分数是否改变-->
