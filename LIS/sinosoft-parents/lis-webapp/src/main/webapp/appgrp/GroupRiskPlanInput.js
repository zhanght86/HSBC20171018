...
{
	var newWindow = window.open("../appgrp/NewProposal.jsp?RiskCode=111302","",sFeatures);
}
function InputPolicyNoList()
{
	var newWindow = window.open("../appgrp/NewProposal.jsp?NoListFlag=1&RiskCode=111302","",sFeatures);
}
function grpInsuInfo()
{
	var newWindow = window.open("../appgrp/ContInsu.jsp","",sFeatures);
}
