...
{
  //下面增加相应的代码
  //window.showModelessDialog("./ProposalQueryMain.jsp",window,"dialogWidth=15cm;dialogHeight=12cm");
  window.open("./ProposalQueryMain.jsp","",sFeatures);
...
function chooseDuty()
{
  ...
  //showModalDialog("./ProposalDuty.jsp?RiskCode="+cRiskCode+" & RiskVersion="+cRiskVersion,window,"status:no;help:0;close:0;dialogWidth=18cm;dialogHeight=14cm");
    var url1="./ProposalDuty.jsp?RiskCode="+cRiskCode+" & RiskVersion="+cRiskVersion;
	var name='提示';   //网页名称，可为空; 
...
function showDuty()
{
  ...
  var url1="./ProposalDuty.jsp?PolNo="+cPolNo;
	var name='提示';   //网页名称，可为空; 
	var iWidth=18+"cm";      //弹出窗口的宽度; 
	var iHeight=14+"cm";     //弹出窗口的高度; 
	var iTop = (window.screen.availHeight - iHeight) / 2; //获得窗口的垂直位置 
...
function showFee()
{
  ...
  window.open("./ProposalFee.jsp?PolNo="+cPolNo,"",sFeatures);
