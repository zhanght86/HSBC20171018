...
function initRiskFeeGrid(){
	...
	try{
		...
		iArray[8][9]="计算方式|code:FeeCalMode"; //检验格式：按区站代码格式检验
		...
		iArray[9][2]=200;
		iArray[9][3]=2;
		iArray[9][10]="GetYearFlag"
        iArray[9][11]="0|^00|个人帐户^01|法人帐户"
        //iArray[9][9]="缴费帐户|code:getyearflag"; //检验格式：按区站代码格式检验
...
function initRiskFeeParamGrid() {                     
    ...
    try {
      ...
      //这些属性必须在loadMulLine前
      RiskFeeParamGrid.mulLineCount = 0;
