...
<body  onload="initForm('<%=tGrpContNo%>','<%=tFlag%>');" >
  <form method=post name=fm id="fm" target="fraSubmit" action="./GrpQuestQueryChk.jsp">
    ...
    <table class=common >
      ...
      <a href="javascript:void(0)" class=button name= "Query" onclick="query();">查  询</a>
  ...
  <table  class= common>
    <TR  class= common> 
      <TD class= title style="width:9.8%;"> 问题件内容 </TD>
  ...
  <table  class= common>
    <TR  class= common> 
      <TD class= title style="width:9.8%;"> 问题件回复 </TD>
      <TD ><textarea name="ReplyResult" cols="122" rows="4" class="common" readonly></textarea></TD>
    </TR>
  </table>
  </div>
  <a href="javascript:void(0)" class=button name= "Back" onclick="returnParent();">返  回</a>
  <p> 
    <!--读取信息-->
...
<div id = "divButton">
  <a href="javascript:void(0)" class=button name= "sure" onclick="reply();">回复问题</a>
	<!-- <input class= cssButton type= "button" name= "sure" value="回复问题" class= Common onClick="reply()"> -->
</div>
<div id = "divModiButton">
  <a href="javascript:void(0)" class=button name= "sure" onclick="IfPrint();">修改问题件打印标记</a>
