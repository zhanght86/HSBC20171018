...
{
	var newWindow = window.open("../appgrp/NewProposal.jsp?NoListFlag=1&RiskCode=111302");
}
function grpInsuInfo()
{
	showInfo1 = window.open("../appgrp/ContInsu.jsp");
}
  ...
  function grpFeeInput()
{
    ...
    parent.fraInterface.window.location = "../appgrp/GrpFeeInput.jsp";     
}