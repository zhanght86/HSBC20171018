...
<body onload="initForm();" >
    ...
    <table class= common border=0 width=100%>
        ...
        <td class=common>
            <IMG  src= "../common/images/butExpand.gif" style= "cursor:hand;" OnClick= "showPage(this,divSearch1);">
			  ...
			  <td class= titleImg align= center>请输入查询集体主险投保单条件：</td>
		  </tr>
	</table>
  <div class="maxbox1">
    ...
    <table  class= common >
          ...
          <TD  class= input5>
            <Input style="background:url(../common/images/select--bg_03.png)    no-repeat right center" class="codeno" name=ManageCom onclick="return showCodeList('station',[this,ManageComName],[0,1]);" ondblclick="return showCodeList('station',[this,ManageComName],[0,1]);" onkeyup="return showCodeListKey('station',[this,ManageComName],[0,1]);"><input class="codename" name=ManageComName readonly=true>
          </TD>
        </TR>
    </table>
  ...
  <br>
    ...
    <table  class= common >
          ...
          <TD  class= input5>
            <Input style="background:url(../common/images/select--bg_03.png)    no-repeat right center" class="codeno" name=ManageComSelf onclick="return showCodeList('station',[this,ManageComSelfName],[0,1]);" ondblclick="return showCodeList('station',[this,ManageComSelfName],[0,1]);" onkeyup="return showCodeListKey('station',[this,ManageComName],[0,1]);"><input class="codename" name=ManageComSelfName readonly=true>
          </TD>
        </TR>  
    </table>
    </DIV>
