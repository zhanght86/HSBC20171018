...
var sqlresourcename = "appgrp.ContInputSql";
...
function afterSubmit( FlagStr, content,contract )
{
	...
	else
	{
		...
		mySql1.addSubPara(contract);
		
    var uwflag = easyExecSql(mySql1.getString());
    if(uwflag!="9")
    {
    	mark="fail";
    }
    ...
    var sqlid2="ContInputSql2";
		...
		mySql2.addSubPara(contract);
    
    
    var uwflag2 = easyExecSql(mySql2.getString());
    var i;
...
var sqlid6="ContInputSql6";
    ...
    arrResult = easyExecSql(sqlid6.getString(),1,0);
...
var sqlid8="ContInputSql8";
		...
		mySql8.addSubPara(arrResult[0][19]);
...
var sqlid9="ContInputSql9";
		...
		mySql9.addSubPara(arrResult[0][19]);
		
		arrResult=easyExecSql(mySql9.getString(),1,0);
...
*********************/
   ...
   // var strSQL1="select ImpartParam from LCCustomerImpartparams where CustomerNoType='0' and CustomerNo='"+tCustomerNo+"' and ContNo='"+tContNo+"' and impartver='01' and impartcode='001' and ImpartParamNo = '2'";
    ...
    arrResult = easyExecSql(mySql10.getString(),1,0);
    ...
    arrResult1 = easyExecSql(mySql11.getString(),1,0);
 ...
 var sqlid12="ContInputSql12";
		...
		mySql12.addSubPara(tCustomerNo);
...
*/
 ...
 var sqlid13="ContInputSql13";
   ...
   arrResult=easyExecSql(mySql13.getString(),1,0);
...
//查询业务员告知
   ...
   turnPage.queryModal(mySql14.getString(), AgentImpartGrid);
...
{   if(fm.AgentCode.value!=""){
	  ...
	  /*
   	var strSQL = "select a.AgentCode,a.AgentGroup,a.ManageCom,a.Name,c.BranchManager,b.IntroAgency,b.AgentSeries,b.AgentGrade,c.BranchAttr,b.AscriptSeries,c.name from LAAgent a,LATree b,LABranchGroup c where 1=1 "
	         + "and a.AgentCode = b.AgentCode and a.branchtype='1' and a.agentstate!='03' and a.agentstate!='04' and a.AgentGroup = c.AgentGroup and a.AgentCode='"+cAgentCode+"'";
   //alert(strSQL);
   */
  ...
  else
  {
   // arrResult = easyExecSql("select a.*,(select GrpName from LDGrp where CustomerNo=(select GrpNo from LDPerson where CustomerNo=a.CustomerNo) ) from LDPerson a where 1=1  and a.CustomerNo = '" + document.all("AppntNo").value + "'", 1, 0);
    ...
    var sqlid16="ContInputSql16";
		...
		mySql16.addSubPara(document.all("AppntNo").value);
     arrResult = easyExecSql(mySql16.getString(), 1, 0);
...
function queryAgent()
{
  ...
  if(document.all('AgentCode').value == "")	{
	  ...
	  //团险查询业务员branchtype='2' Modify by liuqh 2008-12-02
...
//	         + "and a.AgentCode = b.AgentCode and a.branchtype in ('1','4') and a.agentstate!='03' and a.agentstate!='04' and a.AgentGroup = c.AgentGroup and a.AgentCode='"+cAgentCode+"'";
   ...
   var sqlid17="ContInputSql17";
		...
		mySql17.addSubPara(cAgentCode);
   
   //alert(strSQL);
    var arrResult = easyExecSql(mySql17.getString());
    //alert(arrResult);
    if (arrResult != null) 
    {
    	fm.AgentCode.value = arrResult[0][0];
...
function queryAgent2()
{
    ...
    var sqlid18="ContInputSql18";
		...
		mySql18.addSubPara(document.all('ManageCom').value);
    
    var arrResult = easyExecSql(mySql18.getString());
       //alert(arrResult);
    if (arrResult != null) {
...
//var strSql = "select BankCode,AccName from LCAccount where BankAccNo='" + fm.AppntBankAccNo.value+"' and customerno='"+fm.AppntNo.value+"'";
 ...
 var sqlid19="ContInputSql19";
		...
		mySql19.addSubPara(fm.AppntBankAccNo.value);
		mySql19.addSubPara(fm.AppntNo.value);

var arrResult = easyExecSql(mySql19.getString());
if (arrResult != null) {
...
function getdetailwork()
{
 ...
 // var strSql = "select OccupationType from LDOccupation where OccupationCode='" + fm.AppntOccupationCode.value+"'";
   ...
   var sqlid20="ContInputSql20";
		...
		mySql20.addSubPara(fm.AppntOccupationCode.value);
...
function getdetailaddress(){
     ...
     var sqlid21="ContInputSql21";
		...
		mySql21.addSubPara(fm.AppntAddressNo.value);
...
function afterCodeSelect( cCodeName, Field )
{
 ...
 if(cCodeName=="GetAddressNo"){
 	//var strSQL="select b.* from LCAddress b where b.AddressNo='"+fm.AppntAddressNo.value+"' and b.CustomerNo='"+fm.AppntNo.value+"'";
		...
		mySql23.addSubPara(fm.AppntAddressNo.value);
		mySql23.addSubPara(fm.AppntNo.value);
        
        arrResult=easyExecSql(mySql23.getString());
   try{document.all('AppntNo').value= arrResult[0][0];}catch(ex){};
   try{document.all('AppntAddressNo').value= arrResult[0][1];}catch(ex){};
   try{document.all('AppntPostalAddress').value= arrResult[0][2];}catch(ex){};
   try{document.all('AppntZipCode').value= arrResult[0][3];}catch(ex){};
...
function AppntChk()
{
  ...
  var sqlstr="select * from ldperson where Name='"+fm.AppntName.value
     ...
     */  
		...
		mySql24.addSubPara(fm.AppntName.value);
		mySql24.addSubPara(Sex);
		mySql24.addSubPara(fm.AppntBirthday.value);
		mySql24.addSubPara(fm.AppntNo.value);
		mySql24.addSubPara(fm.AppntIDType.value);
		mySql24.addSubPara(fm.AppntIDNo.value);
		mySql24.addSubPara(fm.AppntNo.value);
...
var sqlid25="ContInputSql25";
		...
		mySql25.addSubPara(fm.AppntName.value);
		mySql25.addSubPara(Sex);
		mySql25.addSubPara(fm.AppntBirthday.value);
		mySql25.addSubPara(fm.AppntNo.value);
		mySql25.addSubPara(fm.AppntIDType.value);
		mySql25.addSubPara(fm.AppntIDNo.value);
		mySql25.addSubPara(fm.AppntNo.value);
...
function getCompanyCode()
{
   ...
   // strsql = "select CustomerNo,GrpName from LDgrp ";
    ...
    var sqlid26="ContInputSql26";
		...
		mySql26.addSubPara("1");
		
    
    document.all("AppntGrpNo").CodeData=tCodeData+easyQueryVer3(mySql26.getString(), 1, 0, 1);
}
...
function intoRiskInfo()
{
  ...
  putCont();   //注意该函数在ContInput.js中
	...
	//alert(fm.ProposalContNo.value);
	//var sqlstr="select sequenceno From lcinsured where prtno='"+fm.ProposalContNo.value+"' and insuredno='"+tInsuredNo+"'" ;
  //alert(sqlstr);
    ...
    var sqlid28="ContInputSql28";
		...
		mySql28.addSubPara(fm.ProposalContNo.value);
		mySql28.addSubPara(tInsuredNo);
  
  var sequence = easyExecSql(mySql28.getString(),1,0);
  if(sequence!="1" && InsuredGrid.mulLineCount>1)
  {
  	alert("请正确选择第一被保人!");
  	return;
  }
...
var sqlid32="ContInputSql32";
		...
		mySql32.addSubPara(tPrtNo);

    arrResult=easyExecSql(mySql32.getString(),1,0);
 ...
 function deleteRecord()
{
  ...
  var sqlid33="ContInputSql33";
		...
		mySql33.addSubPara(fm.ContNo.value);
  
    arrResult=easyExecSql(mySql33.getString(),1,0);
   ...
   // alert("ContType"+ContType);
    ...
    //alert("document.all('fmAction').value"+document.all('fmAction').value);
    fm.action="ContInsuredSave.jsp";
...
function getProposalInsuredInfo()
{
   ...
   var sqlid35="ContInputSql35";
    ...
    arrResult=easyExecSql(mySql35.getString(),1,0);
    ...
    else
    {
      ...
      var sqlid36="ContInputSql36";
		...
		mySql36.addSubPara(tCustomerNo);
...
function getInsuredDetail(parm1,parm2)
{
 ...
 var sqlid37="ContInputSql37";
    ...
    arrResult=easyExecSql(mySql37.getString());
...
var sqlid38="ContInputSql38";
    ...
    arrResult=easyExecSql(mySql38.getString());
...
var sqlid39="ContInputSql39";
		...
		mySql39.addSubPara(InsuredNo);
		mySql39.addSubPara(ContNo);
		
		
	    arrResult = easyExecSql(mySql39.getString(),1,0);
	    ...
	    arrResult1 = easyExecSql(mySql40.getString(),1,0);
...
function checkrelation()
{
    ...
    else
    {
       ...
       //     var strSQL="select * from LCInsured where contno='"+document.all('ContNo').value +"'";
		...
		mySql44.addSubPara(document.all('ContNo').value);
        ...
        ***/
		...
		mySql45.addSubPara(document.all('ContNo').value);
...
function queryInsuredNo()
{
   ...
   //     arrResult = easyExecSql("select a.*,(select GrpName from LDGrp where CustomerNo=(select GrpNo from LDPerson where CustomerNo=a.CustomerNo) ) from LDPerson a where 1=1  and a.CustomerNo = '" + document.all("InsuredNo").value + "'", 1, 0);
		...
		mySql46.addSubPara(document.all("InsuredNo").value);
...
function afterQuery21( arrQueryResult )
{
  //alert("1111here:" + arrQueryResult + "\n" + mOperate);
    ...
    if( arrQueryResult != null )
    {
		...
		mySql47.addSubPara(arrQueryResult[0][0]);
  ...
  arrResult = easyExecSql(mySql47.getString(), 1, 0);
      ...
      arrResult = easyExecSql(mySql48.getString(), 1, 0);
...
function getdetailwork2()
{
  //  var strSql = "select OccupationType from LDOccupation where OccupationCode='" + fm.OccupationCode.value+"'";
     ...
     var sqlid49="ContInputSql49";
		...
		mySql49.addSubPara(fm.OccupationCode.value);
   
    var arrResult = easyExecSql(mySql49.getString());
    if (arrResult != null)
    {
...
function inputConfirm2(wFlag)
{
    ...
    if (wFlag ==1 ) //录入完毕确认
    {
      //  var tStr= "	select * from lwmission where 1=1 and lwmission.activityid in ('0000001001','0000001002','0000001220','0000001230') and lwmission.missionprop1 = '"+fm.ContNo.value+"'";
		...
		mySql50.addSubPara(fm.ContNo.value);
...
function getdetailaddress2()
{
  ...
  //  var strSQL="select b.AddressNo,b.PostalAddress,b.ZipCode,b.Phone,b.Mobile,b.EMail,b.CompanyPhone,b.CompanyAddress,b.CompanyZipCode,b.fax,b.HomePhone,b.grpName,b.province,b.city,b.County from LCAddress b where b.AddressNo='"+fm.InsuredAddressNo.value+"' and b.CustomerNo='"+fm.InsuredNo.value+"'";
     ...
     var sqlid51="ContInputSql51";
		...
		mySql51.addSubPara(fm.InsuredAddressNo.value);
        mySql51.addSubPara(fm.InsuredNo.value);
        
    
    arrResult=easyExecSql(mySql51.getString());
...
function getContPlanCode(tProposalGrpContNo)
{
   ...
   // strsql = "select ContPlanCode,ContPlanName from LCContPlan where ContPlanCode!='00' and ProposalGrpContNo='"+tProposalGrpContNo+"'";
      ...
      var sqlid52="ContInputSql52";
		...
		mySql52.addSubPara(tProposalGrpContNo);
    
    //alert("strsql :" + strsql);
    turnPage.strQueryResult  = easyQueryVer3(mySql52.getString(), 1, 0, 1);
    if (turnPage.strQueryResult != "")
    {
    	turnPage.arrDataCacheSet = decodeEasyQueryResult(turnPage.strQueryResult);
    	m = turnPage.arrDataCacheSet.length;
...
function getExecuteCom(tProposalGrpContNo)
{
	...
	//alert("strsql :" + strsql);
	turnPage.strQueryResult  = easyQueryVer3(mySql53.getString(), 1, 0, 1);
	if (turnPage.strQueryResult != "")
	{
		turnPage.arrDataCacheSet = decodeEasyQueryResult(turnPage.strQueryResult);
		m = turnPage.arrDataCacheSet.length;
...
function GrpInputConfirm(wFlag)
{
	...
	{/*
	    ...
	    */
	    var sqlid54="ContInputSql54";
		var mySql54=new SqlClass();
		mySql54.setResourceName(sqlresourcename);
		mySql54.setSqlId(sqlid54);
		mySql54.addSubPara(fm.ProposalGrpContNo.value);
	    
	    turnPage.strQueryResult = easyQueryVer3(mySql54.getString(), 1, 0, 1);
	    if (turnPage.strQueryResult)
	    {
	        alert("该团单合同已经做过保存！");
	        return;
...
function getaddresscodedata2()
{
   ...
   // strsql = "select AddressNo,PostalAddress from LCAddress where CustomerNo ='"+fm.InsuredNo.value+"'";
     ...
     var sqlid55="ContInputSql55";
		var mySql55=new SqlClass();
		mySql55.setResourceName(sqlresourcename);
		mySql55.setSqlId(sqlid55);
		mySql55.addSubPara(fm.InsuredNo.value);
    
    //alert("strsql :" + strsql);
    turnPage.strQueryResult  = easyQueryVer3(mySql55.getString(), 1, 0, 1);
    if (turnPage.strQueryResult != "")
    {
    	turnPage.arrDataCacheSet = decodeEasyQueryResult(turnPage.strQueryResult);
    	m = turnPage.arrDataCacheSet.length;
...
function getallinfo()
{
 	...
 	{/*
		...
		*/
		...
		mySql56.addSubPara(fm.Name.value);
		mySql56.addSubPara(fm.IDType.value);
		mySql56.addSubPara(fm.IDNo.value);
  ...
  var sqlstr="select * from ldperson where Name='"+tInsuredName
       ...
       */
       var sqlid57="ContInputSql57";
		...
		mySql57.addSubPara(tInsuredName);
		mySql57.addSubPara(tInsuredSex);
		mySql57.addSubPara(tBirthday);
		mySql57.addSubPara(tInsuredNo);
    ...
    if(InsuredGrid.mulLineCount>=1)
    {
     ...
     //  var strhomea="select HomeAddress,HomeZipCode,HomePhone from lcaddress where customerno='"+insuredno+"' and addressno=(select addressno from lcinsured where contno='"+fm.ContNo.value+"' and insuredno='"+insuredno+"')";
      ...
      var sqlid58="ContInputSql58";
		...
		mySql58.addSubPara(insuredno);
		mySql58.addSubPara(fm.ContNo.value);
		mySql58.addSubPara(insuredno);
...
//var strSql = "select BankCode,AccName from LCAccount where BankAccNo='" + fm.BankAccNo.value+"'";
 ...
 var sqlid59="ContInputSql59";
		...
		mySql59.addSubPara(fm.BankAccNo.value);


arrResult = easyExecSql(mySql59.getString());
if (arrResult != null) {
 ...
 */
  var sqlid60="ContInputSql60";
		...
		mySql60.addSubPara(tInsuredName);
		mySql60.addSubPara(tInsuredSex);
		mySql60.addSubPara(tBirthday);
		mySql60.addSubPara(tInsuredNo);
		mySql60.addSubPara(fm.IDType.value);
		mySql60.addSubPara(fm.IDNo.value);
		mySql60.addSubPara(tInsuredNo);
...
{
//alert(1)
	CodeQueryApplet.addCodeToQuery('comcode','ManageCom','ManageComName');  //代码汉化
	//alert(2)
	CodeQueryApplet.addCodeToQuery('comcode','AgentManageCom','AgentManageComName');
//	alert(3)
	CodeQueryApplet.addCodeToQuery('sellType','SellType','sellTypeName');
//	alert(4)
...
{
	CodeQueryApplet.addCodeToQuery('vipvalue','AppntVIPValue','AppntVIPFlagname');
	CodeQueryApplet.addCodeToQuery('IDType','AppntIDType','AppntIDTypeName');
	CodeQueryApplet.addCodeToQuery('Sex','AppntSex','AppntSexName');
	CodeQueryApplet.addCodeToQuery('Marriage','AppntMarriage','AppntMarriageName');
	CodeQueryApplet.addCodeToQuery('NativePlace','AppntNativePlace','AppntNativePlaceName');
	CodeQueryApplet.addCodeToQuery('OccupationCode','AppntOccupationCode','AppntOccupationCodeName');
	CodeQueryApplet.addCodeToQuery('LicenseType','AppntLicenseType','AppntLicenseTypeName');
	CodeQueryApplet.addCodeToQuery('GetAddressNo','AppntAddressNo','AddressNoName');
	CodeQueryApplet.addCodeToQuery('province','AppntProvince','AppntProvinceName');
	CodeQueryApplet.addCodeToQuery('city','AppntCity','AppntCityName');
	CodeQueryApplet.addCodeToQuery('district','AppntDistrict','AppntDistrictName');
	CodeQueryApplet.addCodeToQuery('paymode','PayMode','FirstPayModeName');
	CodeQueryApplet.addCodeToQuery('continuepaymode','SecPayMode','PayModeName');
	CodeQueryApplet.addCodeToQuery('bank','AppntBankCode','FirstBankCodeName');
	CodeQueryApplet.addCodeToQuery('bank','SecAppntBankCode','AppntBankCodeName');
	CodeQueryApplet.addCodeToQuery('incomeway','IncomeWay0','IncomeWayName0');
...
{
	CodeQueryApplet.addCodeToQuery('SequenceNo','SequenceNo','SequenceNoName');
	CodeQueryApplet.addCodeToQuery('vipvalue','VIPValue1','AppntVIPFlagname1');
	CodeQueryApplet.addCodeToQuery('Relation','RelationToMainInsured','RelationToMainInsuredName');
	CodeQueryApplet.addCodeToQuery('Relation','RelationToAppnt','RelationToAppntName');
	CodeQueryApplet.addCodeToQuery('IDType','IDType','IDTypeName');
	CodeQueryApplet.addCodeToQuery('Sex','Sex','SexName');
	CodeQueryApplet.addCodeToQuery('Marriage','Marriage','MarriageName');
	CodeQueryApplet.addCodeToQuery('OccupationCode','OccupationCode','OccupationCodeName');
	CodeQueryApplet.addCodeToQuery('NativePlace','NativePlace','NativePlaceName');
	CodeQueryApplet.addCodeToQuery('LicenseType','LicenseType','LicenseTypeName');
	CodeQueryApplet.addCodeToQuery('GetAddressNo','InsuredAddressNo','InsuredAddressNoName');
	CodeQueryApplet.addCodeToQuery('Province','InsuredProvince','InsuredProvinceName');
	CodeQueryApplet.addCodeToQuery('City','InsuredCity','InsuredCityName');
	CodeQueryApplet.addCodeToQuery('District','InsuredDistrict','InsuredDistrictName');
	CodeQueryApplet.addCodeToQuery('incomeway','IncomeWay','IncomeWayName');
...
function getImpartInitInfo()
{
 ...
 var sqlid63="ContInputSql63";
		...
		mySql63.addSubPara("1");
	turnPage.queryModal(mySql63.getString(), AgentImpartGrid);
      /*
 ...
 var sqlid64="ContInputSql64";
	var mySql64=new SqlClass();
		mySql64.setResourceName(sqlresourcename);
		mySql64.setSqlId(sqlid64);
		mySql64.addSubPara(tContNo);


	turnPage.queryModal(mySql64.getString(),AgentImpartGrid);
	return true;
}
