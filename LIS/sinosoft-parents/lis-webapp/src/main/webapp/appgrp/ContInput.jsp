...
<hr>
   ...
   <div id=DivIncome0 style="display:''">
     <table  class="common">  
       ...
       <tr>
         <td>
           <input class="cssButton" type="button" value="投保人财务告知" onclick="goToPic(1);">

         </td>
         <td>
                    <input class="cssButton" type="button" value="投保人健康告知" onclick="goToPic(2);">
         </td>
       </tr>
    </table> 
   </div>  
...
<hr>
    ...
    <tr  class= common>
      <td  class= common>
        <textarea name="Remark" verify="其他声明|len<800" verifyorder="1" cols="110" rows="2" class="common" >
        </textarea>
      </td>
    </tr>
  </table>
...
<hr>
   ...
   <div id=DivIncome style="display:''">
     <table  class="common">  
       ...
       <tr>
         <td>
           <input class="cssButton" type="button" value="被保人财务告知" onclick="goToPic(1);">

         </td>
         <td>
                    <input class="cssButton" type="button" value="被保人健康告知" onclick="goToPic(2);">
         </td>
       </tr>
...
-->
    ...
    <div id = "divApproveModifyContButton" style = "display:none;float:right">
        ...
        <input id="demo3" name="AppntChkButton2" style = "display:''" class=cssButton VALUE=投保人校验 TYPE=button onclick='AppntChk();'>
        <input id="demo4" name="InsuredChkButton2" style = "display:''" class=cssButton VALUE=被保人校验 TYPE=button onclick='InsuredChk();' disabled="disabled">
...
-->
    ...
    <div id = "divProblemModifyContButton" style = "display:none;float:right">
        ...
        <input class=cssButton VALUE=问题件影像查询 TYPE=button onclick="QuestPicQuery();">
        <input id="demo3" name="AppntChkButton2" style = "display:''" class=cssButton VALUE=投保人校验 TYPE=button onclick='AppntChk();'>
        <input id="demo4" name="InsuredChkButton2" style = "display:''" class=cssButton VALUE=被保人校验 TYPE=button onclick='InsuredChk();'>
    	  <input class=cssButton id="Donextbutton7" VALUE="问题件修改完毕" TYPE=button onclick="inputConfirm(3);">
        <input class="cssButton" id="exitButton2" value="返回" type="button" onclick="exitAuditing2();">
