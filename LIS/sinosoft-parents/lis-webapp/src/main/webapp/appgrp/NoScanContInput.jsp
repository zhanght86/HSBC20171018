	...
	<form action="./NoScanContInputSave.jsp" method=post name=fm id="fm" target="fraSubmit">
		...
		<table class=common>
			...
			<TR class=common  style="display:none">
				<TD class=title>询价编码</TD>
				<TD class=input>
					<Input class="common wid"  name=AskpriceNo id="AskpriceNo" verify="询价编码|num" >
				</TD>
				<TD class=title>询价版本号</TD>
				<TD class=input>
					<Input class="common wid"  name=AskNo id="AskNo" verify="询价版本号|num" >
				</TD>
				<TD class=title></TD>
				<TD class=input></TD>			
			</tr>
