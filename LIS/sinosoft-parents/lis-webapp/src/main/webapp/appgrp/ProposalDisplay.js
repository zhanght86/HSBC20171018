...
function showDuty()
{
  ...
  var urlS1="./ProposalDuty.jsp?PolNo="+cPolNo;
  var name='提示';   //网页名称，可为空; 
   var iWidth=18+"cm";      //弹出窗口的宽度; 
	var iHeight=14+"cm";     //弹出窗口的高度; 
	var iTop = (window.screen.availHeight - iHeight) / 2; //获得窗口的垂直位置 
	var iLeft = (window.screen.availWidth - iWidth) / 2;  //获得窗口的水平位置 
	showInfo = window.open (urlS1,name, "status=no,toolbar=no,menubar=no,location=no,resizable=no,scrollbars=0,titlebar=no,height="+ iHeight+",width="+iWidth+",innerHeight="+iHeight+",innerWidth=" +iWidth+",left="+iLeft+",top="+iTop,false);
