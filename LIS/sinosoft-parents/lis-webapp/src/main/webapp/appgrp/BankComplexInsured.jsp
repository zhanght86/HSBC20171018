  ...
  <table  class="common">  
    ...
    <tr  class="common" style="display:none">   
      ...
      <td class="input">
        ...
        <input class="codeno" name="SequenceNo" value="1" verify="客户内部号码|NOTNULL&NUM"  CodeData="0|^1|被保险人 ^2|第二被保险人 ^3|第三被保险人" ondblclick="return showCodeListEx('SequenceNo', [this,SequenceNoName],[0,1]);" onkeyup="return showCodeListKeyEx('SequenceNo', [this,SequenceNoName],[0,1]);"><Input class="codename" name="SequenceNoName" elementtype=nacessary readonly="true">
      </td>              
      <td  class="title">
        与第一被保险人关系</TD>              
      <td  class="input">
        <input class="codeno" name="RelationToMainInsured" value="00" verify="主被保险人关系|NOTNULL&CODE:Relation"  ondblclick="return showCodeList('Relation', [this,RelationToMainInsuredName], [0,1]);" onkeyup="return showCodeListKey('Relation', [this,RelationToMainInsuredName], [0,1]);"><Input class="codename" name="RelationToMainInsuredName"  elementtype=nacessary readonly="readonly"  >
      </td>  
      </tr> 
  </table> 
</div>  
<div id=DivLCInsured style="display:''">
  <table  class= common>
    <TR  class= common>        
      ...
      <TD  class= input>
        <Input class="codeno" name="IDType" value="0" verify="被保险人证件类型|CODE:IDType" verifyorder='2' ondblclick="return showCodeList('IDType',[this,IDTypeName],[0,1]);" onkeyup="return showCodeListKey('IDType',[this,IDTypeName],[0,1]);" onblur="getallinfo();" ><input class=codename name=IDTypeName readonly=true elementtype=nacessary>
      </TD>
      <TD  class= title>
        证件号码
      </TD>
      <TD  class= input>
        <Input class= common name="IDNo" onblur="checkidtype2();getBirthdaySexByIDNo2(this.value);getAge2();if(LoadFlag=='1')confirmSecondInput(this,'onblur');" elementtype=nacessary  verify="被保险人证件号码|LEN<=20" verifyorder='2'>
      </TD>                                                                                                                                                                                                        
    </TR>
...
<!--      <TD  class= title>
      ...
      <TD  class= input>
     <input class= common name="HomePhone1"  verify="被保险人家庭电话|LEN<=18" verifyorder='2' >
     </TD> 
--> 
    </TR>
<!--    
      ...
      <table  class= common>   	
        ...
        <TR  class= common>
          ...
          <TR  class= common style="display:none">
              ...
              <TD  class= input>
                  <Input class= common name="Mobile" verify="被保险人移动电话|LEN<=15&PHONE"  >
              </TD>
            <TD  class= title>
              办公电话 
            </TD>
            <TD  class= input>
              <Input class= common name="GrpPhone" verify="被保险人办公电话|LEN<=15&PHONE" >
            </TD>          
            <TD  class= title>
              传真电话
            </TD>
            <TD  class= input colspan=3 >
              <Input class= common name="Fax" verify="被保险人传真电话|LEN<=15&PHONE"  >
            </TD>
          </TR>         
        <TR  class= common style="display:">  
  			...
  			<TD class=input>
  			  <Input name="HomePhone" class=common verify="被保险人住宅电话|LEN<=15&PHONE" >
  			</TD>		
  			   </TR>  	
