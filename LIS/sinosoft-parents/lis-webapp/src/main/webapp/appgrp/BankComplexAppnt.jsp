...
<DIV id=DivLCAppntInd STYLE="display:''">
 <table  class= common>
        ...
        <TR  class= common  style="display:none">
          ...
          <TD  class= input>
            <Input class=common name="AppntGrpName" verify="投保人工作单位|NOTNUlL&LEN<=60"  elementtype=nacessary >
          </TD>
          <TD  class= title>
            电子邮箱
          </TD>
          <TD  class= input>
            <Input class= common name="AppntEMail" verify="投保人电子邮箱|EMAIL&LEN<=40"   >
          </TD>  
        </TR>        
        <!--TR  class= common>
          <TD  class= title>
      ...
      <div id="divLCAccount1" style="display:''">
        <table class="common">    
          <tr class="common" style="display:none">
            ...
            <td>
            <input class="codeno" name="PayMode" verify="首期交费方式|NOTNUlL&CODE:paymode"  ondblclick="return showCodeList('paymode',[this,FirstPayModeName],[0,1]);" onkeyup="return showCodeListKey('paymode',[this,FirstPayModeName],[0,1]);"><input class="codename" name="FirstPayModeName" readonly="readonly" elementtype=nacessary>
            </td>
          </tr>
          <tr class='common'>
	          <TD class='title'>
	          ...
	          <TD class='input'>
	            <input  NAME=AppntBankCode VALUE="" CLASS="codeno" MAXLENGTH=20 verify="开户行|CODE:bank"  verifyorder="1" ondblclick="return showCodeList('bank',[this,FirstBankCodeName],[0,1]);" onkeyup="return showCodeListKey('bank',[this,FirstBankCodeName],[0,1]);" ><input class=codename name=FirstBankCodeName readonly=true>
	          </TD>
	          <TD CLASS=title >
	            帐户姓名 
	          </TD>
          ...
          <tr class="common" style="display:none">
            ...
            <td>
            <input class="codeno" name="SecPayMode" verify="续期交费方式|NOTNUlL&CODE:continuepaymode"   ondblclick="return showCodeList('continuepaymode',[this,PayModeName],[0,1]);" onkeyup="return showCodeListKey('continuepaymode',[this,PayModeName],[0,1]);"><input class="codename" name="PayModeName" readonly="readonly" elementtype=nacessary>
            </td>
            <td class="title" >
              首、续期账号一致
            </td>
          ...
          <TR CLASS=common style="display:none">
	          ...
	          <TD CLASS=input COLSPAN=1  >
	            <Input NAME=SecAppntBankCode VALUE="" CLASS="codeno" MAXLENGTH=20 verify="开户行|CODE:bank"   ondblclick="return showCodeList('bank',[this,AppntBankCodeName],[0,1]);" onkeyup="return showCodeListKey('bank',[this,AppntBankCodeName],[0,1]);" ><input class=codename name=AppntBankCodeName readonly=true>
	          </TD>
	          <TD CLASS=title >
	            续期帐户姓名 
	          </TD>
	          <TD CLASS=input COLSPAN=1  >
	            <Input NAME=SecAppntAccName VALUE="" CLASS=common MAXLENGTH=20 verify="户名|LEN<=20"   >
	          </TD>
            <TD CLASS=title width="109" >
	            续期账号
	          </td>
