...
<%
  ...
  tProposalNo = request.getParameter("GrpContNo");
  tFlag = request.getParameter("Flag");

  loggerDebug("GrpQuestInputInit","GrpContNo:"+tGrpContNo);
...
{
	document.all('ProposalNoHide').value=tGrpContNo;
	document.all('GrpContNoHide').value=tGrpContNo;
...
function initCodeDate(tFlag)
{
	...
	else if (tFlag == "5" || tFlag == "4")
	{
		document.all('BackObj').CodeData = "0|^1|操作员^2|业务员^3|保户^4|机构";
		//document.all('BackObj').value = "1";
	}
	else if (tFlag == "1" || tFlag == "2" || tFlag == "3" || tFlag == "13")
	{
		document.all('BackObj').CodeData = "0|^2|业务员^3|保户^4|机构";
	}
	else
