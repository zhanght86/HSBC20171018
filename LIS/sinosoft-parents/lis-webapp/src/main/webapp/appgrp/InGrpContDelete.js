...
var showInfo;
var sqlresourcename = "appgrp.InGrpContDeleteSql";
...
function querygCont()
{
	...
	var strSQL = "select a.ContNo,a.InsuredNo,a.InsuredName,decode(a.insuredsex,0,'男',1,'女',2,'不详',''),a.InsuredBirthday,a.InsuredIDType,a.InsuredIDNo from LCCont a where "
  		...
  		*/
  		var sqlid1="InGrpContDeleteSql1";
		var mySql1=new SqlClass();
		mySql1.setResourceName(sqlresourcename);
		mySql1.setSqlId(sqlid1);
		mySql1.addSubPara(GrpContNo);
...
{ 
	unlockScreen('lkscreen');  
  	...
  	if (FlagStr == "Fail" )
  	{   
  		MsgPageURL = MsgPageURL + "F&content=" + content;
  	...
  	{ 
  		MsgPageURL = MsgPageURL + "S&content=" + content;
  		//showInfo = showModalDialog(MsgPageURL, window, "status=0; help=0; close=0; dialogWidth=550px; dialogHeight=250px");
		var name='提示';   //网页名称，可为空; 
		var iWidth=550;      //弹出窗口的宽度; 
		var iHeight=250;     //弹出窗口的高度; 
