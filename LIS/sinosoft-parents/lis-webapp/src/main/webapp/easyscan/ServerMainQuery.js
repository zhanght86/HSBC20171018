...
//					+ " "+ getWherePart( 'ManageCom' );	
	...
	var sqlid0="ServerMainQuerySql0";
	var mySql0=new SqlClass();
	mySql0.setResourceName("easyscan.ServerMainQuerySql"); //指定使用的properties文件名
...
//					+ " "+ getWherePart( 'ManageCom' );	
	...
	var sqlid1="ServerMainQuerySql1";
	var mySql1=new SqlClass();
	mySql1.setResourceName("easyscan.ServerMainQuerySql"); //指定使用的properties文件名
