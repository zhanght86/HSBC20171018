...
{ 
  ...
  {
    alert("在EsDocManageInit.jsp-->InitInpBox函数中发生异常:初始化界面错误!");
  }      
}
...
function initForm()
{
  ...
  {
    alert("EsDocManageInit.jsp-->InitForm函数中发生异常:初始化界面错误!");
  }
}
...
{                               
    var iArray = new Array();
      ...
      try
      {
        ...
        iArray[12][4]="subtypedetail";  
	      iArray[12][15]="1";
	      iArray[12][16]= "#1#  and busstype like #<%=bussType%>%#";
...
{ 
  ...
  {
    alert("在EsDocManageNewInit.jsp-->InitInpBox1函数中发生异常:初始化界面错误!");
  }      
}
