 ...
 * @version  : 1.00, 1.01
 * @date     : 2005-11-03, 2006-11-14
 * @direction: 综合查询代收代付查询总界面
 ******************************************************************************/
%>
...
<frameset name="fraMain" framespacing="0" frameborder="no" rows="0,0,0,0,*" cols="*" border="1">
    ...
    <frameset name="fraSet" framespacing="0" frameborder="no" rows="*" cols="0%,*,0%" border="1">
        ...
        <!-- 实现交互的区域 -->
        <frame id="fraInterface" name="fraInterface" scrolling="auto" src="ProxyIncomePayQuery.jsp?OtherNo=<%=request.getParameter("OtherNo")%>">
        <!-- 下一步操作区域 -->
