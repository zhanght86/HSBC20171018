...
<!--标题与状态区域-->
	...
	<frameset name="fraSet" cols="0%,*,0%" frameborder="no" border="1" framespacing="0" rows="*">
		...
		<%
			...
			szSrc += "?ClmUWNo=" + request.getParameter("ClmUWNo");
			...
			szSrc += "&Conclusion="+StrTool.unicodeToGBK(request.getParameter("Conclusion"));
			szSrc += "&ClmUWer="+StrTool.unicodeToGBK(request.getParameter("ClmUWer"));
