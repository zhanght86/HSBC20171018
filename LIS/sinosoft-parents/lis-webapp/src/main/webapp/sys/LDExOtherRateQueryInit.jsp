<%
//程序名称：LDExOtherRateQueryInit.jsp
//程序功能：
...
{ 
  ...
  {
    alert("在LDExOtherRateQueryInit.jsp-->InitInpBox函数中发生异常:初始化界面错误!");
  }      
}                        
...
function initForm()
{
  ...
  {
    alert("LDExOtherRateQueryInit.jsp-->InitForm函数中发生异常:初始化界面错误!");
  }
}
/************************************************************
 *               
