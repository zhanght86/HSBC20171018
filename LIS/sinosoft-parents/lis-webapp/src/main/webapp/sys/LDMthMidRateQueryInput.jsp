<%
//程序名称：LDMthMidRateQueryInput.jsp
//程序功能：
...
<meta http-equiv="Content-Type" content="text/html; charset=GBK">
  ...
  <SCRIPT src="./LDMthMidRateQuery.js"></SCRIPT>
  <LINK href="../common/css/Project.css" rel=stylesheet type=text/css>
  <LINK href="../common/css/Project3.css" rel=stylesheet type=text/css>
  <LINK href="../common/css/mulLine.css" rel=stylesheet type=text/css>
  <%@include file="./LDMthMidRateQueryInit.jsp"%>
  <title> </title>
</head>
<body  onload="initForm();" >
  ...
  <TR  class= common>
    ...
    <TD  class= input5>
      <Input class="wid" class= common name=Per id=Per >
    </TD>
  </TR>
  <TR  class= common>
    <TD  class= title5>
    ...
    <TD  class= input5>
      <Input class="wid" class= common name=Average id=Average >
    </TD>
  </TR>
  <TR  class= common>
    <TD  class= title5>
    ...
    <TD  class= input5>
      <Input class="wid" class= common name=ValidYear id=ValidYear >
    </TD>
    <TD  class= title5>
      作用月份
    </TD>
    <TD  class= input5>
      <Input class="wid" class= common name=ValidMonth id=ValidMonth >
    </TD>
  </TR>
</table></div>
