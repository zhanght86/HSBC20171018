  ...
  <table  class= common>
        <TR  class= common>
          ...
          <TD  class= input5>
            ...
            onkeyup="return showCodeListKey('currcode',[this,CurrCodeName],[0,1]);"  verify="外币币种代码|currcode"><input name=CurrCodeName id=CurrCodeName  class=codename readonly=true>
          </TD>
          <TD  class= title5>
            本币币种
          </TD>
          ...
          <Input style="background:url(../common/images/select--bg_03.png) no-repeat right center" class='codeno' name=DestCode id=DestCode ondblclick="return showCodeList('currcode',[this,DestCodeName],[0,1]);"  onclick="return showCodeList('currcode',[this,DestCodeName],[0,1]);" 
            onkeyup="return showCodeListKey('currcode',[this,DestCodeName],[0,1]);"  verify="本币币种代码|currcode"><input name=DestCodeName id=DestCodeName  class=codename  readonly=true>
          </TD>
        </TR>
    ...
    <table>
  	...
  	</div><INPUT VALUE="返  回" TYPE=button class=cssButton onclick="returnParent();"> 
  </form>
