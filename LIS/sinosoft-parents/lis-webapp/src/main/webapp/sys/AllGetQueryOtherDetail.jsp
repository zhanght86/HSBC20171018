...
function easyQueryClick()
{
	...
	mySql40.setResourceName("sys.ProposalQuerySql"); //指定使用的properties文件名
	mySql40.setSqlId(sqlid40); //指定使用的Sql的id
	mySql40.addSubPara(comCode.substring(0,6) ); //指定传入的参数
	strSQL=mySql40.getString();
	
	//strSQL = "select ActuGetNo,OtherNo,OtherNoType, (select codename from ldcode where codetype='paymode' and code=PayMode),GetMoney,GetDate,State,'溢交退费','溢交退费' from LJAGetOther where ActuGetNo='" + tActuGetNo + "'";			 	 
