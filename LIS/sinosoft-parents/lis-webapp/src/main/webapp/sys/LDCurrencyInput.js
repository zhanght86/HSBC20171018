...
function resetForm()
{
  ...
  {
  	alert("在LDCurrencyInput.js-->resetForm函数中发生异常:初始化界面错误!");
  }
} 
...
{
  //下面增加相应的代码
  showInfo=window.open("./LDCurrencyQuery.html");
}           
...
{	
	...
	if( arrQueryResult != null )
	{
		...
		document.all('CurrName').value = arrResult[1];                                              
		document.all('Validation').value = arrResult[2];                                              
