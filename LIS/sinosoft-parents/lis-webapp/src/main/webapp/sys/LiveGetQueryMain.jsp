...
<frameset name="fraMain" framespacing="0" frameborder="no" rows="0,0,0,0,*" cols="*" border="1">
    ...
    <frameset name="fraSet" framespacing="0" frameborder="no" rows="*" cols="0%,*,0%" border="1">
        ...
        <!-- 实现交互的区域 -->
        <frame name="fraInterface" src="LiveGetQueryInput.jsp?ContNo=<%=request.getParameter("ContNo")%>&PolNo=<%=request.getParameter("PolNo")%>&RiskCode=<%=request.getParameter("RiskCode")%>" scrolling="auto">
        <!-- 下一步操作区域 -->
