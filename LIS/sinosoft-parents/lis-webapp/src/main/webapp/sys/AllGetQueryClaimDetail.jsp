...
function easyQueryClick()
{
	...
	//strSQL = "select ActuGetNo,OtherNo,OtherNoType,GetDutyCode,GetDutyKind,contno,SaleChnl,decode(FeeOperationType,'A','赔付','B','预付','赔款'),(select codename from ldcode where codetype='feefinatype' and code=FeeFinaType and rownum=1),RiskCode,Pay,GetDate from LJAGetClaim where ActuGetNo='" + tActuGetNo + "'";			 	 
	mySql = new SqlClass();
