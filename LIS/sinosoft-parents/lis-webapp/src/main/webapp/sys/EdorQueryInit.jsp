...
{ 
  ...
  {
    alert("在EdorQueryInit.jsp-->InitInpBox函数中发生异常:初始化界面错误!");
  }      
}
...
//    setOption("pad_flag","0=正常&1=垫交");   
  ...
  {
    alert("在EdorQueryInit.jsp-->InitSelBox函数中发生异常:初始化界面错误!");
  }
}                                        
...
function initPolGrid()
  {                               
    var iArray = new Array();
      ...
      iArray[5]=new Array();
      iArray[5][0]="补/退费日期";         		//列名
      iArray[5][1]="100px";            		//列宽
      iArray[5][2]=100;            			//列最大值
      iArray[5][3]=0;              			//是否允许输入,1表示允许，0表示不允许
      
      iArray[6]=new Array();
      iArray[6][0]="补/退费金额";         		//列名
      iArray[6][1]="100px";            		//列宽
      iArray[6][2]=100;            			//列最大值
