...
function easyQueryClick()
{
	...
	mySql38.setResourceName("sys.ProposalQuerySql"); //指定使用的properties文件名
	mySql38.setSqlId(sqlid38); //指定使用的Sql的id
	mySql38.addSubPara(tActuGetNo); //指定传入的参数
	strSQL=mySql38.getString();

	//strSQL = "select ActuGetNo,contno,GetDutyCode,GetDutyKind,grpcontno,GetMoney,GetDate,decode(FeeOperationType,'EF','满期给付','YF','年金给付','其他'),decode(FeeFinaType,'EF','满期给付','YF','年金给付','其他'),RiskCode,GrpName,CurGetToDate from LJAGetDraw where ActuGetNo='" + tActuGetNo + "'";			 	 
