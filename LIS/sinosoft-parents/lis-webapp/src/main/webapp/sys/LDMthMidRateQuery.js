...
function easyQueryClick()
{
	...
	mySql1.addSubPara(fm.ValidYear.value);
	mySql1.addSubPara(fm.ValidMonth.value);		
	mySql1.addSubPara(fm.Per.value);
	mySql1.addSubPara(fm.Average.value);		
...
function resetForm()
{
  ...
  {
  	alert("在LDMthMidRateQuery.js-->resetForm函数中发生异常:初始化界面错误!");
  }
} 
