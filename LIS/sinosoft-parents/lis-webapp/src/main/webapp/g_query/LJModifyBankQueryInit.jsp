<%
/***************************************************************
 * <p>ProName：LJSendBatchQueryInit.jsp</p>
 * <p>Title：发盘数据查询</p>
 * <p>Description：发盘数据查询</p>
...
function initQueryInfoGrid() {
	...
	try {
		...
		iArray[i] = new Array();
		iArray[i][0] = "客户新开户银行所在省";
		iArray[i][1] = "90px";
		iArray[i][2] = 300;
		iArray[i++][3] = 0;
		
		iArray[i] = new Array();
		iArray[i][0] = "客户新开户银行所在市";
		iArray[i][1] = "90px";
		iArray[i][2] = 300;
		iArray[i++][3] = 0;
		...
		QueryInfoGrid.selBoxEventFuncName = "showInfo";
...
function initQueryInfo1Grid() {
	...
	try {
		...
		QueryInfo1Grid = new MulLineEnter("fm", "QueryInfo1Grid");
		QueryInfo1Grid.mulLineCount = 0;//初始化行数，以后修改为0
		QueryInfo1Grid.displayTitle = 1;
		QueryInfo1Grid.locked = 0;
		QueryInfo1Grid.canSel = 0;
		QueryInfo1Grid.canChk = 0;
		QueryInfo1Grid.hiddenSubtraction = 1;
		QueryInfo1Grid.hiddenPlus = 1;
		QueryInfo1Grid.loadMulLine(iArray);
	} catch (ex) {
		alert("初始化界面错误!");
	}
}
