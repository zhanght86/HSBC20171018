...
function initChoosedDataGrid() {
	...
	try {
		...
		ChoosedDataGrid = new MulLineEnter("fm", "ChoosedDataGrid");
		ChoosedDataGrid.mulLineCount = 0;
		ChoosedDataGrid.displayTitle = 1;
		ChoosedDataGrid.locked = 0;
		ChoosedDataGrid.canSel = 0;
		ChoosedDataGrid.canChk = 0;
		ChoosedDataGrid.hiddenSubtraction = 1;
...
function initUploadFileGrid() {
	...
	try {
		...
		UploadFileGrid = new MulLineEnter("fm", "UploadFileGrid");
