//ProposalAutoMove.js
var RiskType = "";
var sqlresourcename = "cardgrp.ProposalAutoMove2Sql";
var strSql = "select code1, codename, codealias from ldcode1 where codetype='scaninput'"; 

var sqlid1="ProposalAutoMove2Sql1";
...
function goToArea21() {
  ...
  try { if (objName == "CValiDate") { goToPic(0); top.fraPic.scrollTo(65, 817); showPosition(77+hx, 919+hy, 971, 84); } } catch(e) {} 
