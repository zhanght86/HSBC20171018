...
function returnParent()
{
	...
	var cSubMissionID = "";
 	...
 	//		 tsubtype="TB1002";
 	//	}
 	var strSql2="select missionprop5 from lbmission where activityid='0000011099' and missionprop1='"+cGrpProposalNo+"'";
	...
	//showModalDialog("./QuestInputMain.jsp?ProposalNo1="+cProposalNo+"&Flag="+cFlag,window,"status:no;help:0;close:0;dialogWidth=20cm;dialogHeight=10cm");
	 window.open("../cardgrp/GroupPolApproveInfo.jsp?LoadFlag=13&SubType="+SubType+"&prtNo="+cGrpProposalNo+"&polNo="+cGrpProposalNo+"&MissionID="+cMissionID+"&SubMissionID="+cSubMissionID+"&ActivityID="+ActivityID+"&NoType=2" ,"window1",sFeatures);
...
function easyQueryClickSelf()
{
	...
	var strSQL = "";
	  ...
	  strSQL = "select lwmission.missionprop1,lwmission.missionprop2,lwmission.missionprop3,lwmission.missionprop7,lwmission.missionprop8,lwmission.missionid,lwmission.submissionid,lwmission.activityid from lwmission where 1=1 "
				 ...
				 + " and LWMission.MissionProp4 like '" +fm.ManageComSelf.value+ "%%'";  //集中权限管理体现					 
				 + " order by lwmission.missionprop2"
				 ;
...
function ModifyMakeSure(){
	...
	//showModalDialog("./QuestInputMain.jsp?ProposalNo1="+cProposalNo+"&Flag="+cFlag,window,"status:no;help:0;close:0;dialogWidth=20cm;dialogHeight=10cm");
	 window.open("./GrpApproveModifyMakeSure.jsp?GrpProposalNo="+trim(cGrpProposalNo)+"&GrpPrtNo="+trim(cGrpPrtNo),"window1",sFeatures);
