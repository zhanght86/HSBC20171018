...
<!--
			...
			<td class="input" colspan="1">
			  <input name="AgentComCode" class="codeno" ondblclick="showCodeList('AgentCom',[this,AgentComName],[0,1],null,'1 and #1# = #1# and ManageCom like #' + fm.all('ManageCom').value.substring(0,4) + '%# and #' + fm.all('ManageCom').value + '# is not null  ','1');" onkeyup="return showCodeListKey('AgentCom',[this,AgentComName],[0,1],null,'1 and #1# = #1# and ManageCom like #' + fm.all('ManageCom').value.substring(0,4) + '%# and #' + fm.all('ManageCom').value + '# is not null  ','1');" verify="代理机构|code:AgentCom"><input name="AgentComName" class="codename" readonly="readonly">	
    	</td>
			<td class="title">银行营业网点
      </td>
			<td class="input" colspan="1">
			  <input name="AgentType" class="common">
      </td>
-->
