...
<div id="DivLCCont" STYLE="display:''">
	<table class="common" id="table2">
		<tr CLASS="common">
			...
			<Input class= common name=PrtNo elementtype=nacessary readonly MAXLENGTH="11" verify="印刷号码|notnull&len=11">
    		</td>
			<td CLASS="title">管理机构 
    		</td>
			<td CLASS="input" COLSPAN="1">
			<input NAME="ManageCom" VALUE MAXLENGTH="10" elementtype=nacessary CLASS="code" ondblclick="return showCodeList('comcode',[this],null,null,'1 and #1# = #1# and Length(trim(comcode))=8','1',1);" onkeyup="return showCodeListKey('comcode',[this],null,null,'1 and #1# = #1# and Length(trim(comcode))=8','1',1);" verify="管理机构|code:station&amp;notnull">
    		</td>
		</tr>
		<tr CLASS="common">
			<td CLASS="title">销售渠道 
			...
			<td CLASS="input" COLSPAN="1">
			<input NAME="AgentGroup" VALUE CLASS="common" readonly elementtype=nacessary TABINDEX="-1" MAXLENGTH="12" verify="代理人组别|notnull">
    		</td>
		</tr>
...
<DIV id=DivLCAppntInd STYLE="display:''">
 <table  class= common>
        <TR  class= common>        
          ...
          <TD  class= input>
            <Input class= common name="AppntIDNo" verify="投保人证件号码|len<=20" onblur="checkidtype();getBirthdaySexByIDNo(this.value);" >
          </TD> 
        </TR>
        <TR  class= common>
       <TD  class= title>
...
<DIV id=DivLCInsuredInd STYLE="display:''">
 <table  class= common>
        <TR  class= common>        
          ...
          <TD  class= input>
            <Input class="code" name="InsuredIDType" verify="投保人证件类型|code:IDType" ondblclick="return showCodeList('IDType',[this]);" onkeyup="return showCodeListKey('IDType',[this]);">
          </TD>
          <TD  class= title>
            证件号码
          </TD>
          <TD  class= input>
            <Input class= common name="InsuredIDNo" verify="投保人证件号码|len<=20" onblur="checkidtype1();getBirthdaySexByIDNo1(this.value);">
          </TD>  
        ...
        <TR  class= common>
         <TD  class= title>
          ...
          <TD  class= input>
          <input class="coolDatePicker" dateFormat="short" elementtype=nacessary name="InsuredBirthday" verify="投保人出生日期|notnull&date" >
          </TD>   
          <TD  class= title>
            性别
          </TD>
          <TD  class= input>
            <Input class="code" name=InsuredSex elementtype=nacessary verify="投保人性别|notnull&code:Sex" ondblclick="return showCodeList('Sex',[this]);" onkeyup="return showCodeListKey('Sex',[this]);">
          </TD>
