...
<body  onload="initForm();" >
  <form action="./ScanContInputSave.jsp" method=post name=fm target="fraSubmit">
    ...
    <table  class= common >   
          ...
          <INPUT VALUE="查  询" class = cssButton TYPE=button onclick="easyQueryClick();"> <!--INPUT VALUE="扫描件预览" class = cssButton TYPE=button onclick="easyQueryClick();"> <INPUT VALUE="扫描件作废" class = cssButton TYPE=button onclick="easyQueryClick();"--> 
    <table>
    	<tr>
        	<td class=common>
