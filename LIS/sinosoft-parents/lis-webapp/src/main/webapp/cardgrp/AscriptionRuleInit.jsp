...
function initAscriptionRuleNewGrid(tImpGrpContNo) {
    ...
    try {
      ...
      iArray[2][4] = "scription";
      //iArray[2][10]="scription"
      //iArray[2][11]="0|^1|离职|^2|全残|^3|身故"
      ...
      iArray[3][4] = "RiskAscriptionRuleFactoryType";
      iArray[3][5] = "3|9";
      iArray[3][6] = "0|2";
      ...
      iArray[4] = new Array();
      iArray[4][0] = "要素目标编码";         		//列名
      iArray[4][1] = "80px";            		//列宽
      iArray[4][2] = 60;            			//列最大值
      iArray[4][3] = 2;              			//是否允许输入,1表示允许，0表示不允许
      iArray[4][4] = "RiskAscriptionRuleFactoryNo";
      iArray[4][9] = "要素目标编码|len<=6";
      iArray[4][15] = "RiskCode";
      iArray[4][17] = "9";

      iArray[5] = new Array();
      iArray[5][0] = "要素计算编码";         		//列名
      iArray[5][1] = "80px";            		//列宽
      iArray[5][2] = 60;            			//列最大值
      iArray[5][3] = 2;              			//是否允许输入,1表示允许，0表示不允许
      iArray[5][4] = "RiskAscriptionRuleFactory";
      iArray[5][5] = "5|6|7|8";
      iArray[5][6] = "0|1|2|3";
