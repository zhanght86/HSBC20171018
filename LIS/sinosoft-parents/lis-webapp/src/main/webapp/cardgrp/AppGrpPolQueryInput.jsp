...
<body  onload="initForm();" >
  ...
  <Div  id= "divFCDay" style= "display: ''">
    <table  class= common align=center>
          ...
          <TD  class= input5>
            <Input class= "common wid" name=GrpProposalNo if="GrpProposalNo">
          </TD>
        ...
        <TR  class= common>
          ...
          <td class=input5>
            <INPUT style="background:url(../common/images/select--bg_03.png)     no-repeat right center" onclick="getcodedata2();return showCodeListEx('RiskGrpWithOutEC',[this,RiskCodeName],[0,1],null,null,null,true,'400');" ondblclick="getcodedata2();return showCodeListEx('RiskGrpWithOutEC',[this,RiskCodeName],[0,1],null,null,null,true,'400');" onkeyup="getcodedata2();return showCodeListEx('RiskGrpWithOutEC',[this,RiskCodeName],[0,1],null,null,null,1,'400');" class=codeno name=RiskCode id="RiskCode"><input class=codename name=RiskCodeName id="RiskCodeName" readonly=true elementtype=nacessary>                                              
          </td>
        </TR>
        <TR  class= common>
          <TD  class= title5>客户经理编码</TD>
          <TD  class= input5>
