...
{ 
  ...
  {
    alert("在NALAAgentQueryInit.jsp-->InitInpBox函数中发生异常:初始化界面错误!");
  }      
}
...
//    setOption("pad_flag","0=正常&1=垫交");   
  ...
  {
    alert("在NALAAgentQueryInit.jsp-->InitSelBox函数中发生异常:初始化界面错误!");
  }
}                                        
...
function initForm()
{
  ...
  {
    alert("NALAAgentQueryInit.jsp-->InitForm函数中发生异常:初始化界面错误!");
  }
}
/************************************************************
 *               
