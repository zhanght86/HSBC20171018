...
<head >
	...
	<%@include file="ReClaimQueryPDetailInit.jsp"%>
...
function easyQueryClick()
{
	...
	strSQL = "select polno,GetDutyKind,RgtNo,RealPay,ReturnPay from LRClaimPolicy where PolNo='" + tPolNo + "' and ReinsurItem='"+tReinsurItem+"' and InsuredYear='"+tInsuredYear+"' ";		
