...
起始日期
          ...
          <TD  class= input5>
            <Input class="coolDatePicker" onClick="laydate({elem: '#StartDate'});" dateFormat="short" name=StartDate value = '<%=CurrentDate%>'  id="StartDate">		<span class="icon"><a onClick="laydate({elem: '#StartDate'});">		<img src="../common/laydate/skins/default/icon.png" /></a></span></TD>
          <TD  class= title5>
终止日期
          </TD>
          <TD  class= input5>
...
处理类型
	       	...
	       	<TD class= input5 >
	       		<input class=codeno readonly="readonly" name="ProcessType" CodeData="0|^00|批次申请|^01|业务数据提取|^02|数据校验|^03|<%=""%>|" 
          	...
          	class=codename name=ProcessTypeName readonly="readonly" >
          </TD>
        </TR>
	  	</table>
	  	<br>
	  	<INPUT  class=cssButton VALUE="数据处理" TYPE=Button onclick="SubmitForm();">
			&nbsp;&nbsp;
			<Div id="divList" style= "display: ''">
	  		<table>
	  	  	<tr>
	  	    	<td class=common><IMG src= "../common/images/butExpand.gif" style= "cursor:hand;" 
	  	    	OnClick= "showPage(this,divTaskList);"></td>
	  				<td class= titleImg>任务列表</td></tr>
	  		</table>
