...
<!--标题与状态区域-->
	...
	<frameset name="fraSet" cols="0%,*,0%" frameborder="no" border="0" framespacing="0" rows="*">
      ...
      szSrc += "&RIPreceptNo=" + request.getParameter("RIPreceptNo");
      szSrc += "&IncomeCompanyNo=" + request.getParameter("IncomeCompanyNo");
      szSrc += "&AreaId=" + request.getParameter("AreaId");
      szSrc += "&UpperLimit=" + request.getParameter("UpperLimit");
      szSrc += "&LowerLimit=" + request.getParameter("LowerLimit");
		%>
