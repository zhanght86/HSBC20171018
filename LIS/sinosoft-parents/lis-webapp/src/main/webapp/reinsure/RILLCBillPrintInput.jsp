...
<body onload="initElementtype();initForm();">
	<form action="" method=post name=fm target="fraSubmit">
		...
		<table class= common border=0 width=100%>
			<TR  class= common>
		        <td class=title5>账单名称</td>
				<td class=input5><Input class="codeno" name="billprintType"
					ondblClick="showCodeList('ribill',[this,billprintName,Currency,'',RIContNo,RIContName,RIComCode,RIComName],[0,1,2,3,4,5,6,7],null,null,null,1,260);"
					onkeyup="showCodeListKey('ribill',[this,billprintName,Currency,'',RIContNo,RIContName,RIComCode,RIComName],[0,1,2,3,4,5,6,7],null,null,null,1,260);" 
					verify="账单名称|NOTNULL&code:ribill"  ><Input
					class=codename name='billprintName' elementtype=nacessary>
				</td>
			...
			<TR id = "xx" style="display:none;" > 			

                <TD  class=title >分保合同</TD>
		        <TD  class=input > 
		        	<Input class="codeno" name="RIContNo" 
				      ...
				      class= codename name="RIContName" readonly="readonly">
		        </TD> 					
		      	<TD  class= title5 >再保公司</TD>
		        <TD  class= input5 > 
		        	<Input class="codeno" name="RIComCode" 
				      ondblClick="showCodeList('',[this,null],[0,1],null,null,null,1,250);"
				      onkeyup="showCodeListKey('',[this,null],[0,1],null,null,null,1,250);" readonly="readonly"><Input 
				      class= codename name= 'RIComName' readonly="readonly">  
		        </TD>			
			</TR>
	    </table>
	    <hr>
