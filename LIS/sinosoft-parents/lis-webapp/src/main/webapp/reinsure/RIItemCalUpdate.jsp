...
<%
  ...
  //RIItemCalupdate tRIItemCalupdate = new RIItemCalupdate();
  ...
  try
  {
    ...
    //tRIItemCalupdate.submitData(tVData,tOperate);
    tBusinessDelegate.submitData(tVData,tOperate,"RIItemCalupdate");
