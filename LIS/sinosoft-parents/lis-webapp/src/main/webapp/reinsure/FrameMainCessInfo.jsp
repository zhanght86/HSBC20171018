...
<!--标题与状态区域-->
	...
	<frameset name="fraSet" cols="0%,*,0%" frameborder="no" border="0" framespacing="0" rows="*">
      ...
      szSrc += "?ReContCode=" + request.getParameter("ReContCode");
      szSrc += "&AccumulateDefNO=" + request.getParameter("AccumulateDefNO");
      szSrc += "&CessionMode=" + request.getParameter("CessionMode");
      szSrc += "&RiskSort=" + request.getParameter("DiskKind");
      szSrc += "&OperateNo=" + request.getParameter("OperateNo");
      szSrc += "&CodeType=" + request.getParameter("CodeType");
      szSrc += "&SerialNo=" + request.getParameter("SerialNo");
      szSrc += "&reCountType=" + request.getParameter("reCountType");
      szSrc += "&RIPolno=" + request.getParameter("RIPolno");
      System.out.println("CodeType: "+request.getParameter("CodeType"));
		%>
