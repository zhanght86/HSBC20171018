...
<%
  ...
  //RIItemCalDelete tRIItemCalDelete = new RIItemCalDelete();
  ...
  try
  {
    ...
    //tRIItemCalDelete.submitData(tVData,tOperate);
    tBusinessDelegate.submitData(tVData,tOperate,"RIItemCalDelete");
