...
function submitForm()
{
	...
	*/
	var mySql100=new SqlClass();
	 	mySql100.setResourceName("reinsure.ReContChioceInputSql"); //指定使用的properties文件名
	  	mySql100.setSqlId("ReContChioceInputSql100");//指定使用的Sql的id
	...
	var mySql101=new SqlClass();
	 	mySql101.setResourceName("reinsure.ReContChioceInputSql"); //指定使用的properties文件名
	  	mySql101.setSqlId("ReContChioceInputSql101");//指定使用的Sql的id
	...
	var mySql102=new SqlClass();
	 	mySql102.setResourceName("reinsure.ReContChioceInputSql"); //指定使用的properties文件名
	  	mySql102.setSqlId("ReContChioceInputSql102");//指定使用的Sql的id
