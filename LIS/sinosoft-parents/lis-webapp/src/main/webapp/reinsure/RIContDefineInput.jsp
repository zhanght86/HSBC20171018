...
<br>
	<Div id= "divTable1" style= "display: ''" >
		<Table class= common>
			<TR class= common>
				<TD class= title5>合同编号</TD>
				<TD class= input5>
					<Input class= common name="RIContNo" id="ReContCodeId" elementtype=nacessary verify="合同编号|NOTNULL&len<20"> 
				</TD>
				<TD class= title5>合同名称</TD>
				<TD class= input5>
					<Input class= common  name="RIContName" id="ReContNameId" elementtype=nacessary verify="合同名称|NOTNULL&len<60"> 
				</TD>   			
			</TR> 
			<TR class= common>
				<TD class= title5>合同状态</TD>
 	    		<TD class= input5>
		 	    	...
		 	    	onkeyup="showCodeListKey('ristate',[this,ContStateName],[0,1],null,null,null,1);"  verify="合同状态|NOTNULL"><input class=codename name=ContStateName readonly="readonly"  elementtype=nacessary>
				</TD>
...
<span class="icon"><a onClick="laydate({elem:'#RSignDate'});"><img src="../common/laydate/skins/default/icon.png"/></a></span></TD>
			...
			<TR class= common> 
	    	    ...
	    	    <TD class= input5>
		    	      ...
		    	      onkeyup="showCodeListKey('riconttype',[this,ReCountTypeName],[0,1],null,null,null,1); "verify="合同类型|NOTNULL"><Input 
		    	...
		    	<TD class= title5>适用方式</TD>
	   			<TD class= input5>
			          ...
			          onkeyup="return showCodeListKey('riusetype', [this,UseTypeName],[0,1],null,null,null,1);" verify="适用方式|NOTNULL"><input 
  	...
  	<Div id= "divTable3" style= "display: ''" >
    	<Table class= common>
    	  <TR class= common>
    	  	<TD class= title5>
    	      <Div id= "divTitle1" style= "display:none;" >合同类型</Div>
    	    </TD>
   				<TD class="input5">
