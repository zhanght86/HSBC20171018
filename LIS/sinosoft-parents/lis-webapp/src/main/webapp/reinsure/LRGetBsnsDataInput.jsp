...
<body onload="initElementtype();initForm();">    
  <form action="" method=post name=fm target="fraSubmit" >
    ...
    <Div  id= "divCessGetData" style= "display: ''" style="float: right">
	    ...
	    <br>
	    <INPUT class=cssButton  VALUE="业务数据查询" TYPE=button onClick="queryClick();">	
	    <INPUT class=cssButton  VALUE="业务数据下载" TYPE=button onClick="exportExcel();">	
	    <br><br>
	    <div>
		    <table class="common">		
					<tr class="common">
		...
		<INPUT class=cssButton style= display:none VALUE="保全数据导出" TYPE=button onClick="exportEdorData();">	
		<INPUT class=cssButton style= display:none VALUE="理赔数据导出" TYPE=button onClick="exportClaimData();">	
		</Div>
