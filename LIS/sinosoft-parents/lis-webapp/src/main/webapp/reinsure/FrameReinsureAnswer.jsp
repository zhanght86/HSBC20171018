...
<!--标题与状态区域-->
	...
	<frameset name="fraSet" cols="0ing="yes" noresize src="about:blank">
		...
		src='./LRReinsureAnswerInput.jsp?ProposalNo=<%=request.getParameter("ProposalNo")%>&DutyCode=<%=request.getParameter("DutyCode")%>&OpeFlag=<%=request.getParameter("OpeFlag")%>'>
    	<!--下一步页面区域-->
