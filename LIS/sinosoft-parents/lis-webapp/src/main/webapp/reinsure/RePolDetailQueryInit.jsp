...
{ 
  ...
  {
    myAlert("在PolQueryInit.jsp-->"+"初始化界面错误!");
  }      
}
...
//    setOption("pad_flag","0=正常&1=垫交");   
  ...
  {
    myAlert("在PolQueryInit.jsp-->"+"InitSelBox函数中发生异常:初始化界面错误!");
  }
}                                        
...
function initForm()
{
  ...
  {
    myAlert("PolQueryInit.jsp-->"+"初始化界面错误!");
  }
}
...
function initPolGrid()
  {                               
    var iArray = new Array();
      ...
      iArray[4][18]=250;
      iArray[4][19]= 0 ;          			//是否允许输入,1表示允许，0表示不允许
