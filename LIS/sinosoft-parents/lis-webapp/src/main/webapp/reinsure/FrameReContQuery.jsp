...
<!--标题与状态区域-->
	...
	<frameset name="fraSet" cols="0ing="yes" noresize src="about:blank">
		...
		<!--菜单区域-->		
		<frame id="fraInterface" name="fraInterface" scrolling="auto" src='./ReContQuery.jsp?RIContNo=<%=request.getParameter("RIContNo")%>&PageFlag=<%=request.getParameter("PageFlag")%>'>
