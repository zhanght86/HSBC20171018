...
{                           						
	...
	iArray[2]=new Array();          	
	iArray[2][0]="批次号";  				//列名（第2列）
	iArray[2][1]="155px";  						//列宽
	iArray[2][2]=10;        					//列最大值
	iArray[2][3]=0;       						//是否允许输入,1表示允许，0表示不允许

	iArray[3]=new Array();
	iArray[3][0]="发盘时间";    			//列名（序号列，第1列）
	iArray[3][1]="80px";  						//列宽
	iArray[3][2]=30;      						//列最大值
	...
	iArray[4]=new Array();
	iArray[4][0]="回盘时间";    			//列名（序号列，第1列）
	iArray[4][1]="80px";  						//列宽
	iArray[4][2]=30;      						//列最大值
	iArray[4][3]=0;   								//1表示允许该列输入，0表示只读且不响应Tab键
	
	iArray[5]=new Array();
	iArray[5][0]="成功失败标记";    			//列名（序号列，第1列）
	iArray[5][1]="100px";  						//列宽
	iArray[5][2]=30;      						//列最大值
	iArray[5][3]=0;   								//1表示允许该列输入，0表示只读且不响应Tab键	    	    
	
	iArray[6]=new Array();          	
	iArray[6][0]="账号";  				//列名（第2列）
	iArray[6][1]="145px";  						//列宽
	iArray[6][2]=10;        					//列最大值
	iArray[6][3]=0;       						//是否允许输入,1表示允许，0表示不允许

	iArray[7]=new Array();
	iArray[7][0]="户名";    			//列名（序号列，第1列）
	iArray[7][1]="80px";  						//列宽
	iArray[7][2]=30;      						//列最大值
