...
<form name=fm id=fm method=post action="" target=fraSubmit>
	<table>
		<tr>
			...
			<td class=titleImgtop>财务收费与保单溢缴金额</td>
		</tr>
	</table>
...
<form name=fm1 id=fm1 method=post action="./PremMatchingSave.jsp" target=fraSubmit>
	...
	<input class="cssButton" type=button id=PremMatchButton name=PremMatchButton value="保费匹配" onclick="premMatchClick()">
</form>

<form name=fm3 id=fm3 method=post action="" target=fraSubmit>
	<table class=common>
		<tr class=common>
			<td class=title>匹配结论</td>
	...
	<input class=cssButton type=button value="匹配提交" onclick="matchConfirmClick();">
</form>
...
<form name=fm2 id=fm2 method=post action="" target=fraSubmit>
	<table>
		<tr>
			...
			<td class=titleImgtop>待保费申请确认数据</td>
		</tr>
	</table>
	<div id=divMatchingConfirmGrid style="display:''">
		...
		<input class=cssButton type=button id=ReturnMenu name=ReturnMenu value="返  回" onclick="returnMenu();">
	</div>
</form>
