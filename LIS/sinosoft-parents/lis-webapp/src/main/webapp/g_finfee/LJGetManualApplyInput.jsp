<%
/***************************************************************
 * <p>ProName：LJGetManualApplyInput.jsp</p>
 * <p>Title: 手动付费申请</p>
...
<head>
	...
	<script src="./LJGetManualApplyInput.js"></script>
	<%@include file="./LJGetManualApplyInit.jsp"%>
</head>
	...
	<div id="divInfo1" class=maxbox1 style="display: ''">
		<table class=common>
			<tr class=common>
				...
				<td class=input><input class="wid common" name=QueryBatchNo id=QueryBatchNo></td>
		...
		<input class=cssButton type=button value="批次申请" onclick="applyClick();">
	</div>
		...
		<table class=common>
			<tr class=common>
				<td text-align: left colSpan=1>
					<span id="spanApplyBatchInfoGrid" ></span>
				</td>
			</tr>
		</table>
		<center>		
