...
function initForm() {
	...
	try {
		...
		//add by songsz 20150306 增加付费处理凡是
		fm.GetDealType.value = "00";
		fm.GetDealTypeName.value = "正常支付";
...
function initGetInfoGrid() {
	...
	try {
		...
		GetInfoGrid = new MulLineEnter("fm", "GetInfoGrid");
		GetInfoGrid.mulLineCount = 0;//初始化行数，以后修改为0
		GetInfoGrid.displayTitle = 1;
		GetInfoGrid.locked = 0;
		GetInfoGrid.canSel = 0;
		GetInfoGrid.canChk = 1;
		GetInfoGrid.hiddenSubtraction = 1;
		GetInfoGrid.hiddenPlus = 1;
		//GetInfoGrid.selBoxEventFuncName = "enterClick";
		GetInfoGrid.loadMulLine(iArray);
	} catch (ex) {
		alert("初始化界面错误!");
	}
}
...
function initApplyGetInfoGrid() {
	...
	try {
		...
		//add by songsz 20150305 增加付费处理方式
		iArray[i] = new Array();
		iArray[i][0] = "处理方式编码";
		iArray[i][1] = "0px";
		iArray[i][2] = 300;
		...
		ApplyGetInfoGrid.mulLineCount = 0;//初始化行数，以后修改为0
		ApplyGetInfoGrid.displayTitle = 1;
		ApplyGetInfoGrid.locked = 0;
		ApplyGetInfoGrid.canSel = 0;
		ApplyGetInfoGrid.canChk = 1;
		ApplyGetInfoGrid.hiddenSubtraction = 1;
		ApplyGetInfoGrid.hiddenPlus = 1;
		//ApplyGetInfoGrid.selBoxEventFuncName = "enterClick";
