...
<!-- 投保人信息部分 -->
	<Table>
		<TR>
			...
			<TD class= titleImg>
				投保人信息（客户号：<Input class= common  name=AppntNo readOnly>）
...
<DIV id=DivLCAppntInd STYLE="display:''">
	<Table  class= common>
	    ...
	    <TR  class= common>        
            ...
            <TD>
                 <Input verifyorder="1" class="code" name="AppntSex" id=AppntSex CodeData="0|^0|男^1|女"
	    ...
	    <tr class=common>
			...
			<TD  class= input>
				<Input verifyorder="1" class="code" name="AppntIDType" id=AppntIDType CodeData="0|^0|身份证^1|护照^2|军官证^3|驾照^4|户口本^5|学生证^6|工作证^7|出生证^8|其他^9|无证件"
            	style="background:url(../common/images/guanliyuan-bg.png) no-repeat right center"
		...
		<TR  class= common>
			...
			<TD class=title name="AppntNativePlace1"id=AppntNativePlace1>国籍</TD>
			<TD>
			...
			<td>
			<Input verifyorder="1" class="code" name="AppntMarriage" id=AppntMarriage CodeData="0|^0|未婚^1|已婚^2|离异^3|丧偶"
            style="background:url(../common/images/guanliyuan-bg.png) no-repeat right center"
    ...
    <TR  class= common style="display:none">   
		...
		<TR  class= common style="display:none">
			<TD  class= title>省</TD>
			<TD  class= input>
				<Input class="codeno" verify="投保人省份|num&LEN=6" name="AppntProvince"  id=AppntProvince
				style="background:url(../common/images/guanliyuan-bg.png) no-repeat right center"
			...
			<TD  class= title>市</TD>
			<TD  class= input>
				<Input class="codeno" verify="投保人城市|num&LEN=6"   name="AppntCity" id=AppntCity
				style="background:url(../common/images/guanliyuan-bg.png) no-repeat right center"
			...
			<TD  class= input>
				<Input class="codeno" verify="投保人区/县|num&LEN=6"  name="AppntDistrict" id=AppntDistrict
				style="background:url(../common/images/guanliyuan-bg.png) no-repeat right center"
		...
		<div id="divLCAccount1" style="display:''">
        	<Table class="common">    
				...
				<TR CLASS=common>
					...
					<TD CLASS=input COLSPAN=1  >
						<Input NAME=SecAppntBankCode id=SecAppntBankCode VALUE="" CLASS="codeno" MAXLENGTH=20 verify="开户行|CODE:bank"   
						style="background:url(../common/images/guanliyuan-bg.png) no-repeat right center"
