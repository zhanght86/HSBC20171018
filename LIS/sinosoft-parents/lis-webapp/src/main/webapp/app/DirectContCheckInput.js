...
function initQueryCont()
{
	...
	if(document.all('ContNo').value==null ||document.all('ContNo').value=="" || document.all('ContNo').value=="null")
	{
		...
		var sqlid1="DirectContCheckInputSql1";
		var mySql1=new SqlClass();
		mySql1.setResourceName("app.DirectContCheckInputSql"); //指定使用的properties文件名
...
//			+" from lccont where prtno='"+fm.PrtNo.value+"' ";
	...
	else
	{
		...
		var sqlid2="DirectContCheckInputSql2";
		var mySql2=new SqlClass();
		mySql2.setResourceName("app.DirectContCheckInputSql"); //指定使用的properties文件名
...
function initqueryAgent()
{
	...
	//查询外务员信息 laagent.branchtype = '5' and laagent.branchtype2 = '02'--外务员
		...
		var sqlid3="DirectContCheckInputSql3";
		var mySql3=new SqlClass();
		mySql3.setResourceName("app.DirectContCheckInputSql"); //指定使用的properties文件名
...
//		+" (select agentcode from lacommisiondetail where grpcontno='"+fm.ContNo.value+"')";
	...
	//查询外务员信息 laagent.branchtype = '5' and laagent.branchtype2 = '01'--话务员
		...
		var sqlid4="DirectContCheckInputSql4";
		var mySql4=new SqlClass();
		mySql4.setResourceName("app.DirectContCheckInputSql"); //指定使用的properties文件名
...
function initqueryAppnt()
{
	...
	//根据"合同号"查询出投保人信息，并填入相应输入栏
		...
		var sqlid5="DirectContCheckInputSql5";
		var mySql5=new SqlClass();
		mySql5.setResourceName("app.DirectContCheckInputSql"); //指定使用的properties文件名
...
//			+" from lcappnt where contno='"+fm.ContNo.value+"'";
	...
	if(arrApp!=null)
	{
		...
		var sqlid6="DirectContCheckInputSql6";
		var mySql6=new SqlClass();
		mySql6.setResourceName("app.DirectContCheckInputSql"); //指定使用的properties文件名
		mySql6.setSqlId(sqlid6);//指定使用的Sql的id
		mySql6.addSubPara(fm.AppntNo.value);//指定传入的参数
		mySql6.addSubPara(fm.AppntAddressNo.value);//指定传入的参数
...
function initqueryAccount()
{
	...
	clearPayFeeInfoData();//清除缴费信息输入框
		...
		var sqlid7="DirectContCheckInputSql7";
		var mySql7=new SqlClass();
		mySql7.setResourceName("app.DirectContCheckInputSql"); //指定使用的properties文件名
...
function initqueryInsured()
{
	...
	if(fm.ContNo.value==""){return true;}
		...
		var sqlid8="DirectContCheckInputSql8";
		var mySql8=new SqlClass();
		mySql8.setResourceName("app.DirectContCheckInputSql"); //指定使用的properties文件名
...
//			+" from lcinsured where contno='"+fm.ContNo.value+"'";
	...
	//根据"合同号"查询出被保人信息，并填入相应输入栏
			...
			var sqlid9="DirectContCheckInputSql9";
		var mySql9=new SqlClass();
		mySql9.setResourceName("app.DirectContCheckInputSql"); //指定使用的properties文件名
...
//				+ " and addressno='"+document.all("InsuredAddressNo").value+"'";
		...
		var sqlid45="DirectContCheckInputSql45";
		var mySql45=new SqlClass();
		mySql45.setResourceName("app.DirectContCheckInputSql"); //指定使用的properties文件名
		mySql45.setSqlId(sqlid45);//指定使用的Sql的id
		mySql45.addSubPara(document.all("InsuredNo").value);//指定传入的参数
		mySql45.addSubPara(document.all("InsuredAddressNo").value);//指定传入的参数
		var sInsuredAddSQL=mySql45.getString();
...
function initqueryImpartInsuredGrid() 
{
    ...
    if(ContNo=="" || InsuredNo=="") {return true;}
		...
		var sqlid10="DirectContCheckInputSql10";
		var mySql10=new SqlClass();
		mySql10.setResourceName("app.DirectContCheckInputSql"); //指定使用的properties文件名
		mySql10.setSqlId(sqlid10);//指定使用的Sql的id
		mySql10.addSubPara(InsuredNo);//指定传入的参数
...
function initqueryPolGrid()
{
    ...
    if(tContNo=="" || tInsuredNo=="") {return true;}
	
		var sqlid11="DirectContCheckInputSql11";
		var mySql11=new SqlClass();
		mySql11.setResourceName("app.DirectContCheckInputSql"); //指定使用的properties文件名
...
//    	+" where insuredno='"+tInsuredNo+"' and ContNo='"+tContNo+"'";      
	...
	turnPolPage.queryModal(strSQL,PolGrid);
		...
		var sqlid12="DirectContCheckInputSql12";
		var mySql12=new SqlClass();
		mySql12.setResourceName("app.DirectContCheckInputSql"); //指定使用的properties文件名
		mySql12.setSqlId(sqlid12);//指定使用的Sql的id
		mySql12.addSubPara(tContNo);//指定传入的参数
	    var lcbnfSQL=mySql12.getString();	
...
//		+" from lcbnf where contno='"+tContNo+"'";
	var turnLcBnfPage = new turnPageClass();
	turnLcBnfPage.queryModal(lcbnfSQL,LCBnfGrid);
}
//初始化记事本按钮
function checkNotePad(prtNo,LoadFlag)
{
	
		var sqlid13="DirectContCheckInputSql13";
		var mySql13=new SqlClass();
		mySql13.setResourceName("app.DirectContCheckInputSql"); //指定使用的properties文件名
...
//	arrButtonAndSQL[0][2] = "select 'x' from lcissuepol where 2 = 2 and operatepos in ('0', '1', '5', 'a', 'i') and contno = '"+tContNo+"'";

	var sqlid146="DirectContCheckInputSql46";
	var mySql146=new SqlClass();
	mySql146.setResourceName("app.DirectContCheckInputSql"); //指定使用的properties文件名
	mySql146.setSqlId(sqlid146);//指定使用的Sql的id
	mySql146.addSubPara(tContNo);//指定传入的参数
    var SQL=mySql146.getString();
    arrButtonAndSQL[0][2] = SQL;
	
	//判断系统中是否存在姓名、性别、出生日期相同或证件类型证件号码相同的投保人信息。
	
		var sqlid14="DirectContCheckInputSql14";
		var mySql14=new SqlClass();
		mySql14.setResourceName("app.DirectContCheckInputSql"); //指定使用的properties文件名
		mySql14.setSqlId(sqlid14);//指定使用的Sql的id
		mySql14.addSubPara(fm.AppntName.value);//指定传入的参数
		mySql14.addSubPara(fm.AppntSex.value);//指定传入的参数
		mySql14.addSubPara(fm.AppntBirthday.value);//指定传入的参数
		mySql14.addSubPara(fm.AppntNo.value);//指定传入的参数
		mySql14.addSubPara(fm.AppntIDNo.value);//指定传入的参数
		mySql14.addSubPara(fm.AppntNo.value);//指定传入的参数
		
	    var AppChkSQL=mySql14.getString();	
	
//	var AppChkSQL="select customerno from ldperson where 1=1 and name='"+fm.AppntName.value+"'"
//		+ " and sex='"+fm.AppntSex.value+"' and birthday='"+fm.AppntBirthday.value+"'"
...
//		+ " and idno is not null and customerno<>'"+fm.AppntNo.value+"'" ;
	...
	arrButtonAndSQL[1][0] = "AppntChkButton";
	arrButtonAndSQL[1][1] = "投保人效验";
	arrButtonAndSQL[1][2] = AppChkSQL;
	
    //判断系统中是否存在姓名、性别、出生日期相同或证件类型证件号码相同的被保人信息。
	
		var sqlid15="DirectContCheckInputSql15";
		var mySql15=new SqlClass();
		mySql15.setResourceName("app.DirectContCheckInputSql"); //指定使用的properties文件名
		mySql15.setSqlId(sqlid15);//指定使用的Sql的id
		mySql15.addSubPara(fm.InsuredName.value);//指定传入的参数
		mySql15.addSubPara(fm.InsuredSex.value);//指定传入的参数
		mySql15.addSubPara(fm.InsuredBirthday.value);//指定传入的参数
		mySql15.addSubPara(fm.InsuredNo.value);//指定传入的参数
		mySql15.addSubPara(fm.InsuredIDNo.value);//指定传入的参数
		mySql15.addSubPara(fm.InsuredNo.value);//指定传入的参数
		
	    var InsuChkSQL=mySql15.getString();	
	
//	var InsuChkSQL="select customerno from ldperson where 1=1 and name='"+fm.InsuredName.value+"'"
//		+" and sex='"+fm.InsuredSex.value+"' and birthday='"+fm.InsuredBirthday.value+"'"
//		+" and customerno<>'"+fm.InsuredNo.value+"'"
//		+" union "
//		+" select customerno from ldperson where 1=1 "
//		+" and idno = '"+fm.InsuredIDNo.value+"'"
//		+" and idno is not null and customerno<>'"+fm.InsuredNo.value+"'" ;
	arrButtonAndSQL[2] = new Array;
	arrButtonAndSQL[2][0] = "InsuredChkButton";
	arrButtonAndSQL[2][1] = "投保人效验";
	arrButtonAndSQL[2][2] = InsuChkSQL;
...
function getAppOpName()
{
	...
	showOneCodeName('occupationcode','AppntOccupationCode','AppntOccupationCodeName');
		...
		var sqlid16="DirectContCheckInputSql16";
		var mySql16=new SqlClass();
		mySql16.setResourceName("app.DirectContCheckInputSql"); //指定使用的properties文件名
		mySql16.setSqlId(sqlid16);//指定使用的Sql的id
		mySql16.addSubPara(fm.AppntOccupationCode.value);//指定传入的参数
...
function getAppntAddressNoData()
{
	var tCodeData = "0|";
		...
		var sqlid17="DirectContCheckInputSql17";
		var mySql17=new SqlClass();
		mySql17.setResourceName("app.DirectContCheckInputSql"); //指定使用的properties文件名
...
function getInsuredOpName()
{
	...
	showOneCodeName('occupationcode','InsuredOccupationCode','InsuredOccupationCodeName');
		...
		var sqlid18="DirectContCheckInputSql18";
		var mySql18=new SqlClass();
		mySql18.setResourceName("app.DirectContCheckInputSql"); //指定使用的properties文件名
		mySql18.setSqlId(sqlid18);//指定使用的Sql的id
		mySql18.addSubPara(fm.InsuredOccupationCode.value);//指定传入的参数
...
function getInsuredAddressNoData()
{
	var tCodeData = "0|";
		...
		var sqlid19="DirectContCheckInputSql19";
		var mySql19=new SqlClass();
		mySql19.setResourceName("app.DirectContCheckInputSql"); //指定使用的properties文件名
		mySql19.setSqlId(sqlid19);//指定使用的Sql的id
		mySql19.addSubPara(fm.InsuredNo.value);//指定传入的参数
...
function queryAgent()
{
	...
	else
	{
		...
		var sqlid20="DirectContCheckInputSql20";
		var mySql20=new SqlClass();
		mySql20.setResourceName("app.DirectContCheckInputSql"); //指定使用的properties文件名
...
function queryTelephonist()
{
	...
	else
	{
		...
		var sqlid21="DirectContCheckInputSql21";
		var mySql21=new SqlClass();
		mySql21.setResourceName("app.DirectContCheckInputSql"); //指定使用的properties文件名
		mySql21.setSqlId(sqlid21);//指定使用的Sql的id
		mySql21.addSubPara(cAgentCode);//指定传入的参数
...
function queryAppntNo(AppntNo)
{
	var tAppntNo=trim(AppntNo);
		...
		var sqlid22="DirectContCheckInputSql22";
		var mySql22=new SqlClass();
		mySql22.setResourceName("app.DirectContCheckInputSql"); //指定使用的properties文件名
		mySql22.setSqlId(sqlid22);//指定使用的Sql的id
		mySql22.addSubPara(tAppntNo);//指定传入的参数
	   var sSQL=mySql22.getString();	
...
function queryInsuredNo(InsuredNo)
{
	var tInsuredNo=trim(InsuredNo);
		...
		var sqlid23="DirectContCheckInputSql23";
		var mySql23=new SqlClass();
		mySql23.setResourceName("app.DirectContCheckInputSql"); //指定使用的properties文件名
		mySql23.setSqlId(sqlid23);//指定使用的Sql的id
		mySql23.addSubPara(tInsuredNo);//指定传入的参数
	   var sSQL=mySql23.getString();	
...
function afterCodeSelect(CodeName, Field)
{
	...
	if(CodeName=="GetAppntAddressNo")
	{
		...
		var sqlid24="DirectContCheckInputSql24";
		var mySql24=new SqlClass();
		mySql24.setResourceName("app.DirectContCheckInputSql"); //指定使用的properties文件名
		mySql24.setSqlId(sqlid24);//指定使用的Sql的id
		mySql24.addSubPara(fm.AppntAddressNo.value);//指定传入的参数
...
//			+" from lcaddress where addressno='"+fm.AppntAddressNo.value+"' and customerno='"+fm.AppntNo.value+"'";
	...
	if(CodeName=="GetInsuredAddressNo")
	{
		...
		var sqlid25="DirectContCheckInputSql25";
		var mySql25=new SqlClass();
		mySql25.setResourceName("app.DirectContCheckInputSql"); //指定使用的properties文件名
		mySql25.setSqlId(sqlid25);//指定使用的Sql的id
		mySql25.addSubPara(fm.InsuredAddressNo.value);//指定传入的参数
		mySql25.addSubPara(fm.InsuredNo.value);//指定传入的参数
...
//	var sqlstr="select forceuwflag from lccont where contno='"+ContNo+"'" ;
	...
	var sqlid47="DirectContCheckInputSql47";
	var mySql47=new SqlClass();
	mySql47.setResourceName("app.DirectContCheckInputSql"); //指定使用的properties文件名
	mySql47.setSqlId(sqlid47);//指定使用的Sql的id
	mySql47.addSubPara(ContNo);//指定传入的参数
	var sqlstr=mySql47.getString();
...
//	var sqlstr="select forceuwflag from lccont where contno='"+ContNo+"'" ;
	...
	var sqlid48="DirectContCheckInputSql48";
	var mySql48=new SqlClass();
	mySql48.setResourceName("app.DirectContCheckInputSql"); //指定使用的properties文件名
	mySql48.setSqlId(sqlid48);//指定使用的Sql的id
	mySql48.addSubPara(ContNo);//指定传入的参数
...
function deleteClick()
{
	...
	var ContNo=document.all("ContNo").value;
		...
		var sqlid26="DirectContCheckInputSql26";
		var mySql26=new SqlClass();
		mySql26.setResourceName("app.DirectContCheckInputSql"); //指定使用的properties文件名
...
function addRecord()
{
	...
	var ContNo=document.all("ContNo").value;
		...
		var sqlid27="DirectContCheckInputSql27";
		var mySql27=new SqlClass();
		mySql27.setResourceName("app.DirectContCheckInputSql"); //指定使用的properties文件名
		mySql27.setSqlId(sqlid27);//指定使用的Sql的id
		mySql27.addSubPara(ContNo);//指定传入的参数
...
function modifyRecord()
{
	...
	var ContNo=document.all("ContNo").value;
		...
		var sqlid28="DirectContCheckInputSql28";
		var mySql28=new SqlClass();
		mySql28.setResourceName("app.DirectContCheckInputSql"); //指定使用的properties文件名
...
//	var sqlstr="select forceuwflag from lccont where contno='"+ContNo+"'" ;
	...
	//判断是否更改了被保人的关键信息
		...
		var sqlid29="DirectContCheckInputSql29";
		var mySql29=new SqlClass();
		mySql29.setResourceName("app.DirectContCheckInputSql"); //指定使用的properties文件名
...
//		+" from lcinsured where contno='"+fm.ContNo.value+"' and insuredno='"+tOldInsuredNo+"'";
	  ...
	  || fm.InsuredSex.value!=tOldArr[0][2] || fm.InsuredBirthday.value!=tOldArr[0][3] || fm.InsuredOccupationCode.value!=tOldArr[0][6])
	{
		...
		var sqlid30="DirectContCheckInputSql30";
		var mySql30=new SqlClass();
		mySql30.setResourceName("app.DirectContCheckInputSql"); //指定使用的properties文件名
...
function deleteRecord()
{
	//判断该被保人是否已经保存
		...
		var sqlid31="DirectContCheckInputSql31";
		var mySql31=new SqlClass();
		mySql31.setResourceName("app.DirectContCheckInputSql"); //指定使用的properties文件名
...
function AppntChk()
{
	var Sex=fm.AppntSex.value;
	    ...
	    var sqlid32="DirectContCheckInputSql32";
		var mySql32=new SqlClass();
		mySql32.setResourceName("app.DirectContCheckInputSql"); //指定使用的properties文件名
...
function InsuredChk()
{
	...
	var tBirthday=InsuredGrid.getRowColData(tRow,4);
	     ...
	     var sqlid33="DirectContCheckInputSql33";
		var mySql33=new SqlClass();
		mySql33.setResourceName("app.DirectContCheckInputSql"); //指定使用的properties文件名
...
function intoRiskInfo()
{
	//校验合同信息、投保人信息及被保人信息是否已经保存（）
		...
		var sqlid34="DirectContCheckInputSql34";
		var mySql34=new SqlClass();
		mySql34.setResourceName("app.DirectContCheckInputSql"); //指定使用的properties文件名
...
function inputConfirm(wFlag)
{
	//校验合同信息、投保人信息及被保人信息是否已经保存（）
		...
		var sqlid35="DirectContCheckInputSql35";
		var mySql35=new SqlClass();
		mySql35.setResourceName("app.DirectContCheckInputSql"); //指定使用的properties文件名
...
//  		+" and exists (select 'X' from lcpol where contno='"+fm.ContNo.value+"')" ;
	...
	if (wFlag ==1 ) //录入完毕确认
	{
		...
		var sqlid36="DirectContCheckInputSql36";
		var mySql36=new SqlClass();
		mySql36.setResourceName("app.DirectContCheckInputSql"); //指定使用的properties文件名
		mySql36.setSqlId(sqlid36);//指定使用的Sql的id
		
		mySql36.addSubPara(fm.ContNo.value);//指定传入的参数
		
	   var tStr=mySql36.getString();
...
//		var tStr= "	select * from lwmission where 1=1 and lwmission.activityid in ('0000001001','0000001002','0000001220','0000001230') and lwmission.missionprop1 = '"+fm.ContNo.value+"'";
	...
	else if (wFlag ==2)//复核完毕确认
	{
		...
		{ 
				...
				var sqlid37="DirectContCheckInputSql37";
				var mySql37=new SqlClass();
				mySql37.setResourceName("app.DirectContCheckInputSql"); //指定使用的properties文件名
				mySql37.setSqlId(sqlid37);//指定使用的Sql的id
				
				mySql37.addSubPara(fm.ContNo.value);//指定传入的参数
				mySql37.addSubPara(fm.AppntNo.value);//指定传入的参数
...
//			var strSql = "select * from LCIssuePol where contno = '"+fm.ContNo.value+"' and issuetype = '99' and questionobj = '"+document.all('AppntNo').value+"'";
		...
		if(fm.InsuredChkButton.disabled==false)
		{
				...
				var sqlid38="DirectContCheckInputSql38";
				var mySql38=new SqlClass();
				mySql38.setResourceName("app.DirectContCheckInputSql"); //指定使用的properties文件名
...
//	strObjName.value="";
	if(strObjCode.value !="")
	{
		PlaceCode=strObjCode.value;
				...
				var sqlid39="DirectContCheckInputSql39";
				var mySql39=new SqlClass();
				mySql39.setResourceName("app.DirectContCheckInputSql"); //指定使用的properties文件名
				mySql39.setSqlId(sqlid39);//指定使用的Sql的id
				
				mySql39.addSubPara(PlaceCode);//指定传入的参数
				mySql39.addSubPara(PlaceType);//指定传入的参数
...
function checkpayfee(ContNo)
{
	...
	//查询收银录入的保费
					...
					var sqlid40="DirectContCheckInputSql40";
				var mySql40=new SqlClass();
				mySql40.setResourceName("app.DirectContCheckInputSql"); //指定使用的properties文件名
				mySql40.setSqlId(sqlid40);//指定使用的Sql的id
				
				mySql40.addSubPara(tContNo);//指定传入的参数
				
			   var tempfeeSQL=mySql40.getString();
...
//		+" and otherno=(select contno from lccont where prtno= '"+tContNo+"')";
	...
	//查询系统生成的保费
			    ...
			    var sqlid41="DirectContCheckInputSql41";
				var mySql41=new SqlClass();
				mySql41.setResourceName("app.DirectContCheckInputSql"); //指定使用的properties文件名
				mySql41.setSqlId(sqlid41);//指定使用的Sql的id
				
				mySql41.addSubPara(tContNo);//指定传入的参数
				
			   var premfeeSQL=mySql41.getString();
...
function checkPolDate(ContNo,PolAppntDate)
{
    ...
    //查询录单日期与投保日期的标准间隔天数
			    ...
			    var sqlid42="DirectContCheckInputSql42";
				var mySql42=new SqlClass();
				mySql42.setResourceName("app.DirectContCheckInputSql"); //指定使用的properties文件名
				mySql42.setSqlId(sqlid42);//指定使用的Sql的id
				
//				mySql42.addSubPara(tContNo);//指定传入的参数
				
			   var premfeeSQL42=mySql42.getString();
	
	 var DayIntvArr = easyExecSql(premfeeSQL42);
   // var DayIntvArr = easyExecSql("select sysvarvalue from ldsysvar where sysvar='input_poldate_intv'");
    ...
    if(tContNo!=null && tContNo!="")
    {
				...
				var sqlid43="DirectContCheckInputSql43";
				var mySql43=new SqlClass();
				mySql43.setResourceName("app.DirectContCheckInputSql"); //指定使用的properties文件名
				mySql43.setSqlId(sqlid43);//指定使用的Sql的id
				
				mySql43.addSubPara(tContNo);//指定传入的参数
				
			   var makedatesql=mySql43.getString();
...
//				mySql43.addSubPara(tContNo);//指定传入的参数
			   ...
			   var sysdatesql43=mySql43.getString();
	
	     var sysdatearr = easyExecSql(sysdatesql43);
