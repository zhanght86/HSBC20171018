...
<%
	...
	tAction = request.getParameter("fmAction");
	loggerDebug("DSEasyProposalSave","动作是:" + tAction);
	...
	try {
		...
		tOldAction = tAction;
		loggerDebug("DSEasyProposalSave","用户选择的操作为tAction:" + tAction);
		...
		//break;
			...
			loggerDebug("DSEasyProposalSave","被保险人序号是："+tInsuredType[i]);
		...
		loggerDebug("DSEasyProposalSave","end set schema 受益人信息...");
		...
		loggerDebug("DSEasyProposalSave","险种个数："+POLCount);
		...
		loggerDebug("DSEasyProposalSave","是否为家庭单"+request.getParameter("FamilyType"));
