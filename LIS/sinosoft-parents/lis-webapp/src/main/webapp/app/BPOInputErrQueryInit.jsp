<%
//程序名称：BPOInputErrQueryInit.jsp
//程序功能：外包录入差错统计
//创建日期：2007-09-14 11:19
//创建人  ：Fuqx
...
function initForm()
{
  ...
  {
    alert("BPOInputErrQueryInit.jsp-->InitForm函数中发生异常:初始化界面错误!");
  }
}
...
{                           						
	...
	try
	{
	    ...
	    iArray[2]=new Array();          	
	    iArray[2][0]="差错内容";  				//列名（第2列）
	    iArray[2][1]="145px";  						//列宽
	    iArray[2][2]=10;        					//列最大值
	    iArray[2][3]=0;       						//是否允许输入,1表示允许，0表示不允许

	    iArray[3]=new Array();
	    iArray[3][0]="数据包回传时间";    			//列名（序号列，第1列）
	    iArray[3][1]="100px";  						//列宽
	    iArray[3][2]=30;      						//列最大值
...
{ 
  ...
  {
    alert("BPOInputErrQueryInit.jsp-->InitInpBox函数中发生异常:初始化界面错误!");
  }      
}    
