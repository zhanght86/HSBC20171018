...
<Div id="DivLCInsured" style="display:''">
	...
	<Table  class= common>
		<TR  class= common>	
			...
			<TD class= input>
				<Input verifyorder="1" class="common wid" name="IDNo" id="IDNo">
			</TD>
			<td class=title>有效期至</td>
			<TD class=input>
				<input class="common wid" name="IDExpDate" id="IDExpDate">
			</TD>
		</TR>
		<tr class= common>
		...
		<tr class= common>
		    ...
		    <TD  class= input colspan=3>
		        <Input verifyorder="1" class='common3' name="WorkType" id="WorkType" value="" >
		    </TD>
	...
	<Table  class= common>
		...
		<TR class= common>
			...
			<td class=input>
			<Input style="background:url(../common/images/guanliyuan-bg.png)     no-repeat right center" verifyorder="1" class="code" name="Marriage" id="Marriage" CodeData="0|^0|未婚^1|已婚^2|离异^3|丧偶"
            								    onClick="showCodeListEx('ForMarriage',[this],[0,1]);"
		...
		<TR class= common>
			...
			<TD  class= input>
				<Input style="background:url(../common/images/select--bg_03.png) 		no-repeat right center" verifyorder="1" class="codeno" name="InsuredAddressNo" id="InsuredAddressNo"><input class=codename name=InsuredAddressNoName id="InsuredAddressNoName" readonly=true>
			</TD>
		</TR>
		<TR class=common style="display:'none'">
  	...
  	<Div id="DivAddress" STYLE="display:none">   
      	<Table  class= common>   	
			...
			<TR class= common>
				...
				<TD  class= input>
					<!--
					<Input class="codeno" verify="被保人省份|NOTNULL&NUM&LEN=6"  verifyorder="2" name="InsuredProvince"  onclick="return showCodeList('province',[this,InsuredProvinceName],[0,1]);" ondblclick="return showCodeList('province',[this,InsuredProvinceName],[0,1]);" onkeyup="return showCodeListKey('province',[this,InsuredProvinceName],[0,1]);"><input class=codename name=InsuredProvinceName readonly=true elementtype=nacessary>
				    --> 
				...
				<TD  class= input>
					<!--
					<Input class="codeno" verify="被保人城市|NOTNULL&NUM&LEN=6"  verifyorder="2" name="InsuredCity"  onclick="showCodeList('city',[this,InsuredCityName],[0,1],null,fm.InsuredProvince.value,['upplacename']);" ondblclick="showCodeList('city',[this,InsuredCityName],[0,1],null,fm.InsuredProvince.value,['upplacename']);" onkeyup="return showCodeListKey('city',[this,InsuredCityName],[0,1],null,fm.InsuredProvince.value,['upplacename']);"><input class=codename name=InsuredCityName readonly=true elementtype=nacessary>
				    --> 
				...
				<TD  class= input>
					<!--
					<Input class="codeno" verify="被保人区/县|NOTNULL&NUM&LEN=6"  verifyorder="2" name="InsuredDistrict"  onclick="showCodeList('district',[this,InsuredDistrictName],[0,1],null,fm.InsuredCity.value,['upplacename'],null,'240');" ondblclick="showCodeList('district',[this,InsuredDistrictName],[0,1],null,fm.InsuredCity.value,['upplacename'],null,'240');" onkeyup="return showCodeListKey('district',[this,InsuredDistrictName],[0,1],null,fm.InsuredCity.value,['upplacename'],null,'240');"><input class=codename name=InsuredDistrictName readonly=true elementtype=nacessary>
				    --> 
