...
<head>
  ...
  <SCRIPT src="./YBTDZQuery.js"></SCRIPT>   
  <%@include file="./YBTDZQueryInit.jsp"%>   
  <LINK href="../common/css/Project.css" rel=stylesheet type=text/css>
  <LINK href="../common/css/Project3.css" rel=stylesheet type=text/css>
  <LINK href="../common/css/mulLine.css" rel=stylesheet type=text/css>
  <title>邮保通对帐信息查询</title>
</head>      
  ...
  <div id="divInvAssBuildInfo">
   ...
   <table class= common>
     ...
     <TR class= common> 
          ...
          <TD  class= input5> <Input class="multiDatePicker laydate-icon"   onClick="laydate({elem: '#StartDate'});"dateFormat="short" name=StartDate id=StartDate><span class="icon"><a onClick="laydate({elem: '#StartDate'});"><img 
