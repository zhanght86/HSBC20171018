...
<%
  ...
  if(tGI==null)
  {
    loggerDebug("GrpFillInsuredSave","页面失效,请重新登陆");   
    FlagStr = "Fail";        
    Content = "页面失效,请重新登陆";  
  }
  else //页面有效
  {
    ...
    loggerDebug("GrpFillInsuredSave","fmAction=="+fmAction);
    loggerDebug("GrpFillInsuredSave","Begin->告知");
	...
	//loggerDebug("GrpFillInsuredSave","Begin->告知2");
...
//	tLCContSchema.setSumPrem(tP);
    ...
    loggerDebug("GrpFillInsuredSave","end set schema 告知信息..."+ImpartCount);
    ...
    loggerDebug("GrpFillInsuredSave","end set schema 告知明细信息..."+ImpartDetailCount); 
