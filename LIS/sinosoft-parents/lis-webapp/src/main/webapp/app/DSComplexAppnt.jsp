	...
	<Table  class= common>
		...
		<TR>
			...
			<TD class=input colspan=3>
				<Input verifyorder="1" class="common3"   name="AppntIDNo" id="AppntIDNo" >
			</TD>
			<td class=title>有效期至</td>
			<TD class=input>
				<input verifyorder="1" class="common wid"  name="AppntIDExpDate" id="AppntIDExpDate">
			</TD>
		</TR>
	</Table>
	<Table  class= common>
		<TR  class= common>
			...
			<TD>
				<input style="background:url(../common/images/guanliyuan-bg.png)     no-repeat right center" verifyorder="1" class="code" name="AppntNativePlace" id="AppntNativePlace" onclick="return showCodeList('NativePlace',[this,null],[0,1]);" ondblclick="return showCodeList('NativePlace',[this,null],[0,1]);" onkeyup="return showCodeListKey('NativePlace',[this,null],[0,1]);">
			</TD>
			<TD>户口所在地</TD>
			<TD>
    	...
    	<TR  class= common>
			...
			<td class= title>您是否拥有公费医疗、社会医疗保险</td>
			<TD class=input>
				<Input style="background:url(../common/images/guanliyuan-bg.png)     no-repeat right center" verifyorder="1" class="code" name="AppntSocialInsuFlag" id="AppntSocialInsuFlag" CodeData="0|^0|否^1|是" onClick="showCodeListEx('SocialInsuFlag',[this],[0,1]);" ondblClick="showCodeListEx('SocialInsuFlag',[this],[0,1]);" onkeyup="showCodeListKeyEx('SocialInsuFlag',[this],[0,1]);">
			</TD>
		</TR>
		<TR  class= common>
			<TD  class= title>
		...
		<div id="divLCAccount1" style="display:''">
        	...
        	<Table class="common">    
				<TR class='common'>
					...
					<TD CLASS=input COLSPAN=1  >
						<Input  NAME=AppntBankAccNo id="AppntBankAccNo" CLASS="common wid" VALUE=""  ><input type="hidden" class=codename name=AppntBankAccNoName id="AppntBankAccNoName" readonly=true>
					</TD>
				</TR>
				<TR class="common">
				...
				<TR CLASS=common>
					...
					<TD CLASS=input COLSPAN=1  >
						<Input  NAME=SecAppntBankAccNo id="SecAppntBankAccNo" class="common wid" VALUE="" ><input type="hidden" class=codename name=aa id="aa" readonly=true>
					</TD>
				</TR>
				<TR CLASS=common>
