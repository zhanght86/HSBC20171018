...
//  			+ "customerno='"+tInsuredNo+"'"; 
	...
	mySql1.setResourceName("app.AppntChkSql"); //指定使用的properties文件名
...
//            +" and CustomerNo<>'"+arrResult[0][0]+"'" ;
	...
	mySql1.setResourceName("app.AppntChkSql"); //指定使用的properties文件名
	mySql1.setSqlId(sqlid1);//指定使用的Sql的id
	mySql1.addSubPara(arrResult[0][1]);//指定传入的参数
	mySql1.addSubPara(arrResult[0][6]);//指定传入的参数
	mySql1.addSubPara(arrResult[0][7]);//指定传入的参数
	mySql1.addSubPara(arrResult[0][0]);//指定传入的参数
	mySql1.addSubPara(arrResult[0][2]);//指定传入的参数
	mySql1.addSubPara(arrResult[0][3]);//指定传入的参数
	mySql1.addSubPara(arrResult[0][0]);//指定传入的参数
