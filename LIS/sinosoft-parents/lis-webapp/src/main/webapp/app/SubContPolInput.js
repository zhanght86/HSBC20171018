...
function queryGrpCustomerInfo(cExecuteCom)
{
	var cGrpContNo = document.all("GrpContNo").value;
		...
		mySql34.setResourceName("app.ContQuerySQL"); //指定使用的properties文件名
		mySql34.setSqlId(sqlid34);//指定使用的Sql的id
		mySql34.addSubPara(cGrpContNo);//指定传入的参数
		mySql34.addSubPara(cExecuteCom);//指定传入的参数
...
function queryGeneralInfo()
{
	var cGrpContNo = document.all("GrpContNo").value;
		...
		mySql35.setResourceName("app.ContQuerySQL"); //指定使用的properties文件名
		mySql35.setSqlId(sqlid35);//指定使用的Sql的id
		mySql35.addSubPara(cGrpContNo);//指定传入的参数
...
function showAppnt()
{
 ...
 else
 {
	var cCustomerNo = document.all("CustomerNo").value;
		...
		mySql36.setResourceName("app.ContQuerySQL"); //指定使用的properties文件名
		mySql36.setSqlId(sqlid36);//指定使用的Sql的id
		mySql36.addSubPara(cGrpContNo);//指定传入的参数
...
function checkuseronly(comname)
{
		...
		mySql37.setResourceName("app.ContQuerySQL"); //指定使用的properties文件名
		mySql37.setSqlId(sqlid37);//指定使用的Sql的id
		mySql37.addSubPara(comname);//指定传入的参数
...
//arrResult = easyExecSql("select * from LDGrp  where GrpName='" + comname + "'", 1, 0);			
	 if (arrResult == null) {
		...
		mySql38.setResourceName("app.ContQuerySQL"); //指定使用的properties文件名
		mySql38.setSqlId(sqlid38);//指定使用的Sql的id
		mySql38.addSubPara(comname);//指定传入的参数
