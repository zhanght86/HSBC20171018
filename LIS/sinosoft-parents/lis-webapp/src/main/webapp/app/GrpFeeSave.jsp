...
String tContPlanCode = "00";	//保障级别
String tContPlanName = "默认值";	//保障说明
String tPlanSql = "";	//分类说明
String tPlanType = "3";	//计划类型
String tPeoples3 = "0";	//可保人数
...
loggerDebug("GrpFeeSave","arrCount=" + arrCount.length);
if (arrCount != null){
...
//		loggerDebug("GrpFeeSave","记录"+i+"放入Set！tGrpPolNo[i] is "+tGrpPolNo[i]);
	}
}
