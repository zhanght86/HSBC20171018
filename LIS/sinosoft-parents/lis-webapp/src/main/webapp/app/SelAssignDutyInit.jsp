...
function initForm()
{
  ...
  {
    alert(initForm.re);
    alert("SelAssignInit.jsp-->InitForm函数中发生异常:初始化界面错误!");
  }
}
...
{                               
    ...
    try
    {
      ...
      iArray[1][4]="AppAlluser";              	        //是否引用代码:null||""为不引用
      ...
      iArray[4][11]="0|^0|启动^1|终止"; 

      iArray[5]=new Array();
      iArray[5][0]="问题件修改工作量";      	   		//列名
      iArray[5][1]="60px";            		//列宽
      iArray[5][2]=20;            			//列最大值
      iArray[5][3]=1; 
      ...
      iArray[6][11]="0|^0|启动^1|终止"; 
      

      iArray[7]=new Array();
      iArray[7][0]="人工合并工作量";      	   		//列名
      iArray[7][1]="60px";            		//列宽
      iArray[7][2]=20;            			//列最大值
