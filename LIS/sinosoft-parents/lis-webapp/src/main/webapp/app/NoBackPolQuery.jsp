...
<head>
  ...
  <SCRIPT src="./NoBackPolQuery.js"></SCRIPT>   
  <%@include file="./NoBackPolQueryInit.jsp"%>   
...
<form method=post name=fm target="fraSubmit" action="./NoBackPolQueryLisSave.jsp">
	<table class= common border=0 width=100%>
  <tr>
  <td class="common"><IMG  src= "../common/images/butExpand.gif" style= "cursor:hand;" OnClick= "showPage(this,grand);"></td>
	<td class= titleImg>请输入查询条件：</td>
	</tr>
	</table>
  <form method=post name=fm id=fm>
  <Div  id= "grand" style= "display: ''" class="maxbox1">
   <table class= common>
     <TR class= common> 
          <TD  class= title5>
            外包公司
