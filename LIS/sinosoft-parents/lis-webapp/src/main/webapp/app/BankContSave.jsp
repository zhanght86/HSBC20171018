...
//      VData rVData = LockTableUI1.getResult();
    ...
    loggerDebug("BankContSave","tLCContSchema:"+tLCContSchema.getAgentCom());
    ...
    loggerDebug("BankContSave","AppntName::::" + request.getParameter("AppntName"));
    loggerDebug("BankContSave","==================RelationToInsured======" + request.getParameter("RelationToInsured"));
  ...
  if(BQFlag==null) SavePolType="0";                                                 
	...
	if(tAction.equals( "UPDATE" )){
		tOldAppntNo = tLCContSchema.getAppntNo();
		tTransferData.setNameAndValue("OldAppntNo",tOldAppntNo); //旧投保人客户号
	}                                    
  ...
  tTransferData.setNameAndValue("LoadFlag",request.getParameter("LoadFlag")); //传入loadflag以判断在何处进行操作。---yeshu,20071224 
