  ...
  <div class="maxbox">
    <Div  id= "divFCDay" style= "display: ''"> 
     ...
     <TR  class= common>
       		...
       		<TD  class= input5 >
            <Input class="coolDatePicker" onClick="laydate({elem: '#StartDate'});" verify="录单开始日期|NOTNULL" dateFormat="short" name=StartDate id="StartDate"><span class="icon"><a onClick="laydate({elem: '#StartDate'});"><img src="../common/laydate/skins/default/icon.png" /></a></span>
       		</TD>
       		<TD  class= title5 >
       		  录单结束日期
       		</TD>
       		<TD  class= input5>
            <Input class="coolDatePicker" onClick="laydate({elem: '#EndDate'});" verify="录单结束日期|NOTNULL" dateFormat="short" name=EndDate id="EndDate"><span class="icon"><a onClick="laydate({elem: '#EndDate'});"><img src="../common/laydate/skins/default/icon.png" /></a></span>
       		</TD>  
     </TR>
   	 <tr class=common>
       		<TD  class= title5 >
   	 ...
   	 <tr class=common>
       		...
       		<TD  class= input5 >
            <Input class="coolDatePicker" onClick="laydate({elem: '#SignStartDate'});" verify="最近一次签单开始时间|NOTNULL" dateFormat="short" name=SignStartDate id="SignStartDate"><span class="icon"><a onClick="laydate({elem: '#SignStartDate'});"><img src="../common/laydate/skins/default/icon.png" /></a></span>
       		</TD>
       		<TD  class= title5 >
       		  最近一次签单结束时间
       		</TD>
       		<TD  class= input5 >
            <Input class="coolDatePicker" onClick="laydate({elem: '#SignEndDate'});" verify="最近一次签单结束时间|NOTNULL" dateFormat="short" name=SignEndDate id="SignEndDate"><span class="icon"><a onClick="laydate({elem: '#SignEndDate'});"><img src="../common/laydate/skins/default/icon.png" /></a></span>
       		</TD>  
   	 </tr>
   	</table>
   </div>
