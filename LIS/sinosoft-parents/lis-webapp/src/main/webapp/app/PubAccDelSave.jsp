...
if(tG==null)
{
    loggerDebug("PubAccDelSave","页面失效,请重新登陆");   
    FlagStr = "Fail";        
    Content = "页面失效,请重新登陆";  
}
else //页面有效
{
    ...
    if (arrCount != null)
    {
    	...
    	String tContNo[] = request.getParameterValues("PubAccGrid9");      //合同号
    ...
    try
    {
		...
		{       
			loggerDebug("PubAccDelSave","删除失败！");
   				FlagStr = "Fail";
			...
			{
				loggerDebug("PubAccDelSave","删除成功!");
				Content = "个单删除成功! ";
				FlagStr = "Succ";
			}
  	}
