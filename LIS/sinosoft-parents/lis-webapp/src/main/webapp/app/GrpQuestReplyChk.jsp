...
*/	{
			...
			loggerDebug("GrpQuestReplyChk","flag:"+flag);
  			if (flag == true)
  			{
				...
				String busiName="cbcheckGrpQuestReplyChkUI";
				...
				%>
    			    <script language="javascript">
            			try {
            				var tIndex = parent.fraInterface.QuestGrid.getSelNo();
            				if (tIndex >= 1)
            				    parent.fraInterface.QuestGrid.setRowColData(tIndex - 1,4,"<%=treply%>");
            		  } catch(e) {}
                    </script>         
                <% 
				}
