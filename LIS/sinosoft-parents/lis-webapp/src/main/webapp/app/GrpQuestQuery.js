...
mySql15.setResourceName("uw.QuestInputSql15"); //指定使用的properties文件名
mySql15.setSqlId(sqlid15);//指定使用的Sql的id
mySql15.addSubPara(cGrpContNo);//指定传入的参数
...
mySql16.setResourceName("uw.QuestInputSql16"); //指定使用的properties文件名
mySql16.setSqlId(sqlid16);//指定使用的Sql的id
mySql16.addSubPara(fm.GrpContNo.value);//指定传入的参数
mySql16.addSubPara(fm.BackObj.value);//指定传入的参数
mySql16.addSubPara(fm.ManageCom.value);//指定传入的参数

mySql16.addSubPara(fm.OManageCom.value);//指定传入的参数
mySql16.addSubPara(fm.OperatePos.value);//指定传入的参数
mySql16.addSubPara(fm.Quest.value);//指定传入的参数
...
mySql17.setResourceName("uw.QuestInputSql17"); //指定使用的properties文件名
mySql17.setSqlId(sqlid17);//指定使用的Sql的id
mySql17.addSubPara(k);//指定传入的参数
mySql17.addSubPara(k);//指定传入的参数

mySql17.addSubPara(fm.GrpContNo.value);//指定传入的参数
mySql17.addSubPara(fm.issuetype.value);//指定传入的参数
mySql17.addSubPara(fm.OperatePos.value);//指定传入的参数

mySql17.addSubPara(fm.SerialNo.value);//指定传入的参数
...
mySql18.setResourceName("uw.QuestInputSql18"); //指定使用的properties文件名
mySql18.setSqlId(sqlid18);//指定使用的Sql的id
mySql18.addSubPara(k);//指定传入的参数
mySql18.addSubPara(k);//指定传入的参数
