...
function initBnfGrid() {
  ...
  try {
    ...
    //iArray[2][10]="SquesNo";			
    //iArray[2][11]="0|^0|满期/生存保险金受益人 ^1|身故保险金受益人";  
    //iArray[2][19]=1;
...
function initPolGrid()
{
    ...
    try 
    {
      ...
      iArray[8]=new Array();
      iArray[8][0]="交费年期(年)";         		//列名
      iArray[8][1]="40px";            		        //列宽
      iArray[8][2]=60;            			//列最大值
      iArray[8][3]=1;              			//是否允许输入,1表示允许，0表示不允许 
      
      iArray[9]=new Array();
      iArray[9][0]="标准保费(年)";         		//列名
      iArray[9][1]="40px";            		        //列宽
      iArray[9][2]=60;            			//列最大值
      iArray[9][3]=1;              			//是否允许输入,1表示允许，0表示不允许
      
      iArray[10]=new Array();
      iArray[10][0]="职业加费(年)";         		//列名
      iArray[10][1]="40px";            		        //列宽
      iArray[10][2]=60;            			//列最大值
