...
<script language="javascript">
	...
	//alert("ContNo:"+ContNo);
	var specScanFlag = "";    //记录通过特殊保单有扫描件录入，如果是，则其值为specScanFlag = "bposcan";
...
<hr class="line">
    ...
    <tr  class= common>
      <td  class= input>
        <textarea name="Remark1" id="Remark1" verify="其他声明|len<800" verifyorder="1" cols="110" rows="4" class="common" >
        </textarea>
      </td>
    </tr>
  </table>
    ...
    <!-- 告知信息部分（列表） -->
      <table>
        <tr>
          ...
          <TD><Input type="button" class="cssButton" name="insuhealthmpart" id="insuhealthmpart" value="被保人健康告知信息"></TD>
          <TD><Input type="button" class="cssButton" name="insuworkimpart" id="insuworkimpart" value="被保人职业告知信息"></TD>
        </tr>
      </table>
        ...
        <tr>
          <td>
            ...
            <input class=cssButton id="demo4" name="InsuredChkButton2" VALUE=被保人校验 TYPE=hidden onclick='InsuredChk();'>
      	    <input class=cssButton name="NotePadButton3" VALUE="记事本查看" TYPE=button onclick="showNotePad();">
          </td>
        </tr>
        <tr>
          <td>
...
-->
    <div  id= "HiddenValue" style="display:none;float: right">
      ...
      <!--input type='hidden' name="LoadFlag"><!--增加-->  -->
    </div>           
<!--
    VVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVV
    VVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVV
