...
<Div id=DivLCInsuredButton STYLE="display:''">
	...
	<Table>
		<tr>
			...
			<TD class="titleImg">
				<input class="mulinetitle" value="被保险人资料"  name="InsuredSequencename" readonly >（客户号：<input class="common" name="InsuredNo" id=InsuredNo value="" readOnly>
...
<Div id=DivLCInsured style="display:''">
	<Table  class= common>
		<TR class= common>        
            ...
            <TD class=input>
            	<Input verifyorder="1" class="code" name="Sex" id=Sex CodeData="0|^0|男^1|女"
	...
	<Table  class= common> -->
		<TR  class= common>	
			...
			<TD  class= input>
				<Input verifyorder="1" class="code" name="IDType" id=IDType CodeData="0|^0|身份证^1|护照^2|军官证^3|驾照^4|户口本^5|学生证^6|工作证^7|出生证^8|其他^9|无证件"
            	style="background:url(../common/images/guanliyuan-bg.png) no-repeat right center"
	...
	<Table  class= common>
		...
		<TR class= common>
			...
			<TD>婚姻状况</TD>
			<td>
			<Input verifyorder="1" class="code" name="Marriage" id=Marriage CodeData="0|^0|未婚^1|已婚^2|离异^3|丧偶"
			style="background:url(../common/images/guanliyuan-bg.png) no-repeat right center"
  ...
  <Div id=DivClaim STYLE="display:none"> 
      ...
      <TR class= common>  
              ...
              <TD  class= input>
                  <Input class="code" name="AccountNo" id=AccountNo  CodeData="0|^1|缴费帐户^2|其它" >
              </TD>
      </TR> 
      <TR CLASS=common>
  	    <TD CLASS=title  >
  	    ...
  	    <TD CLASS=input COLSPAN=1  >
  	      <Input NAME=InsuredBankCode id=InsuredBankCode VALUE="" CLASS="code" MAXLENGTH=20 verify="开户行|CODE:bank" >
  	    </TD>
  	  </TR>   
      </Table>          
  </Div>
      ...
      <Table  class= common>        
          <TR class= common>
            ...
            <TD CLASS=input COLSPAN=1>
              ...
              <TD CLASS=input COLSPAN=1>
                  <Input NAME=InsuredPeoples id=InsuredPeoples VALUE="" readonly=true CLASS=common verify="被保人人数|NUM" >
              </TD>
  	    </TR>  
