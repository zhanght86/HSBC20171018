...
*/ 
  ...
  tmLCInsuredSchema.setPosition(request.getParameter("Occupation")); 
  tmLCInsuredSchema.setInsuredStat(request.getParameter("ListState"));
  tmLCInsuredSchema.setSocialInsuNo(request.getParameter("SocialInsuNo"));
  ...
  tLDPersonSchema.setOthIDNo(request.getParameter("WorkNo"));
  ...
  tLDPersonSchema.setPosition(request.getParameter("Occupation"));
  ...
  tLDPersonSchema.setSocialInsuNo(request.getParameter("SocialInsuNo"));
  ...
  tTransferData.setNameAndValue("Mult",request.getParameter("Mult")); //内部客户号
  tTransferData.setNameAndValue("EdorType",request.getParameter("EdorType")); //保全项目
  tTransferData.setNameAndValue("EdorValiDate",request.getParameter("EdorValiDate")); //保全生效日
  tTransferData.setNameAndValue("BQFlag",request.getParameter("BQFlag")); //保全标志
          
  loggerDebug("GrpContInsuredSave","EdorType==="+EdorType);
  loggerDebug("GrpContInsuredSave","SavePolType="+SavePolType);
  loggerDebug("GrpContInsuredSave","ContNo="+request.getParameter("ContNo"));
  loggerDebug("GrpContInsuredSave","FamilyType="+request.getParameter("FamilyType"));
  loggerDebug("GrpContInsuredSave","ContType="+request.getParameter("ContType"));
  loggerDebug("GrpContInsuredSave","PolTypeFlag="+request.getParameter("PolTypeFlag"));
  loggerDebug("GrpContInsuredSave","InsuredPeoples="+request.getParameter("InsuredPeoples"));
  loggerDebug("GrpContInsuredSave","InsuredAppAge=="+request.getParameter("InsuredAppAge"));
  loggerDebug("GrpContInsuredSave","SequenceNo=="+request.getParameter("SequenceNo"));
  loggerDebug("GrpContInsuredSave","EdorValiDate=="+request.getParameter("EdorValiDate"));
  loggerDebug("GrpContInsuredSave","BQFlag=="+request.getParameter("BQFlag"));
  ...
  loggerDebug("GrpContInsuredSave","tOLDLCInsuredDB="+tOLDLCInsuredDB.encode());
...
/************************************		
  ...
  loggerDebug("GrpContInsuredSave","end set schema 告知明细信息..."+ImpartDetailCount);             
************************************/
  try
  {
    // 准备传输数据 VData
    loggerDebug("GrpContInsuredSave","tLDPersonSchema2"+tLDPersonSchema);
    loggerDebug("GrpContInsuredSave","tLCContSchema="+tLCContSchema.encode());
    loggerDebug("GrpContInsuredSave","tLDPersonSchema="+tLDPersonSchema.encode());
    loggerDebug("GrpContInsuredSave","tLCCustomerImpartSet="+tLCCustomerImpartSet.encode());
    loggerDebug("GrpContInsuredSave","tmLCInsuredSchema="+tmLCInsuredSchema.encode());
    loggerDebug("GrpContInsuredSave","tLCAddressSchema="+tLCAddressSchema.encode());
    loggerDebug("GrpContInsuredSave","tOLDLCInsuredDB="+tOLDLCInsuredDB.encode());
...
//    tVData.add(tLCCustomerImpartDetailSet);             
    ...
    loggerDebug("GrpContInsuredSave","sadf12312"+tOLDLCInsuredDB.getInsuredNo());
...
<%
      loggerDebug("GrpContInsuredSave",request.getParameter("LoadFlag"));
      if(request.getParameter("LoadFlag").equals("2"))
%>
   <SCRIPT language="javascript">
  parent.fraInterface.InsuredGrid.setRowColData(parent.fraInterface.InsuredGrid.mulLineCount-1,1,"<%=StrTool.unicodeToGBK(mLCInsuredSchema.getInsuredNo())%>");     	 
  parent.fraInterface.InsuredGrid.setRowColData(parent.fraInterface.InsuredGrid.mulLineCount-1,2,"<%=StrTool.unicodeToGBK(mLCInsuredSchema.getName())%>");
