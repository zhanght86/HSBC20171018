...
<Div  id= "divCustomerUnion" style= "display:   "> 
	...
	<div id= "divCustomerUnionIssueInfo" style= "display:  " >	
		<table width="121%" height="37%" class= common>
		    ...
		    <TR  class= common>
		      <TD height="87%"  class= title><textarea name="CUIContent" id=CUIContent cols="100" rows="10" class="common" >本次投保申请中*******，但您在我公司投保的其他保单中********，请您提供您的身份证复印件，以便我公司进行核对</textarea></td>
		    </TR>
		</table>      	
	</div>
	</div>
