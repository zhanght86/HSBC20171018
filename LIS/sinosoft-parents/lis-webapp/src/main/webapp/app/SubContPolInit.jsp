...
//	document.all( 'PrtNo' ).value = "200411240001";
//	document.all( 'GrpContNo' ).value = "86110020040990000041";
//	document.all( 'ProposalGrpContNo' ).value = "86110020040990000041";
...
//    try { document.all( 'ProposalGrpContNo' ).value = mSwitch.getVar( "ProposalGrpContNo" ); } catch(ex) { };
    try { document.all( 'GrpContNo' ).value = tGrpContNo; } catch(ex) { };
    try { document.all( 'PrtNo' ).value = tPrtNo; } catch(ex) { };
