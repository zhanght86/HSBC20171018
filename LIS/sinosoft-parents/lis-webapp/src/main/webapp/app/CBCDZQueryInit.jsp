<%
//程序名称：CBCDZQueryInit.jsp
//程序功能：建行对帐数据查询
//创建日期：2008-08-02 15:10
//创建人  ：
...
{                           						
	...
	try
	{
	    ...
	    iArray[2]=new Array();          	
	    iArray[2][0]="业务日期";  				//列名（第2列）
	    iArray[2][1]="145px";  						//列宽
	    iArray[2][2]=10;        					//列最大值
	    iArray[2][3]=0;       						//是否允许输入,1表示允许，0表示不允许

	    iArray[3]=new Array();
	    iArray[3][0]="金额";    			//列名（序号列，第1列）
	    iArray[3][1]="100px";  						//列宽
	    iArray[3][2]=30;      						//列最大值
	    ...
	    iArray[4]=new Array();
	    iArray[4][0]="对帐日期";    			//列名（序号列，第1列）
	    iArray[4][1]="100px";  						//列宽
	    iArray[4][2]=30;      						//列最大值
	    iArray[4][3]=0;   								//1表示允许该列输入，0表示只读且不响应Tab键
	    
	    iArray[5]=new Array();
	    iArray[5][0]="网点";    			//列名（序号列，第1列）
	    iArray[5][1]="100px";  						//列宽
	    iArray[5][2]=30;      						//列最大值
