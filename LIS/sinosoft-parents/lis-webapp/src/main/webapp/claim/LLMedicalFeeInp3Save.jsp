...
else
{
    ...
    tLLCaseInfoSchema.setDefoType(request.getParameter("DefoType")); //伤残类型
    tLLCaseInfoSchema.setDefoGrade(request.getParameter("DefoGrade")); //伤残级别代码
    tLLCaseInfoSchema.setDefoName(request.getParameter("DefoGradeName")); //伤残级别名称
    tLLCaseInfoSchema.setDefoCode(request.getParameter("DefoCode")); //伤残代码
    tLLCaseInfoSchema.setDefoCodeName(request.getParameter("DefoCodeName")); //伤残代码
