...
<head>
    ...
    <SCRIPT src="LLClaimUser.js"></SCRIPT>
    <%@include file="LLClaimUserInit.jsp"%>
</head>
	...
	<Div  id= "ClaimUser" style= "display:''" class="maxbox">
	    <Table  class= common>
          <TR class= common>  
			...
			<TD  class= input5> <Input style="background:url(../common/images/select--bg_03.png) no-repeat right center" class="codeno" name=JobCategoryQ id=JobCategoryQ readonly ondblclick="return showCodeList('jobcategory',[this,JobCategoryNameQ],[0,1]);" onclick="return showCodeList('jobcategory',[this,JobCategoryNameQ],[0,1]);" onkeyup="return showCodeListKey('jobcategory',[this,JobCategoryNameQ],[0,1]);"><input class="codename" name="JobCategoryNameQ" id="JobCategoryNameQ" readonly></TD>      
	       </TR>   
	       <TR class= common> 
			          				
	        <TD  class= title5>在岗状态</TD>            
...
<a href="javascript:void(0);" class="button" onClick="ClearQuerydataClick();">重    填</a>-->
	<Table>
	     <TR><TD class=common><IMG  src= "../common/images/butExpand.gif" style= "cursor:hand;" OnClick= "showPage(this,DivClaimUserGrid);"></TD>
	          <TD class= titleImg>理赔用户列表</TD>
	     </TR>
	</Table>  
    <Div id= "DivClaimUserGrid" style= "display:''">    
		<Table  class= common>
		    <TR>
    ...
    <Div id= "DivLLClaimUserInfo" style= "display:''" class="maxbox">       
        ...
        <Table  class= common>
            <TR class= common>   
				<TD  class= title5>用户编码</TD>
				<TD  class= input5> <input class="readonly wid" readonly name=UserCode id=UserCode></TD>
                <TD  class= title5>用户姓名</TD>      
                <TD  class= input5> <input class="readonly wid" readonly name=UserName id=UserName></TD> </TR>
              <TR class= common>      
                <TD  class= title5>管理机构</TD>            
                ...
                <TD  class= title5>上级用户编码</TD>
                <TD  class= input5> <input class="wid" class="common" name="UpUserCode" id="UpUserCode" maxlength="6"></TD>
		     </TR>
            <TR class= common> 
				...
				<TD  class= title5>上级用户名称</TD>
                <TD  class= input5> <input class="wid" class=common name=UpUserName id=UpUserName ></TD>
                <TD  class= title5>权限级别</TD>
				<TD  class= input5> <Input style="background:url(../common/images/select--bg_03.png) no-repeat right center" class="codeno" name=JobCategory id=JobCategory readonly ondblclick="return showCodeList('jobcategory',[this,JobCategoryName],[0,1]);" onclick="return showCodeList('jobcategory',[this,JobCategoryName],[0,1]);" onkeyup="return showCodeListKey('jobcategory',[this,JobCategoryName],[0,1]);"><input class="codename" name="JobCategoryName" id="JobCategoryName" readonly></TD>             				
            </TR>
            <TR class= common>    
                <TD  class= title5>报案权限</TD>
				...
				<TD  class= title5>立案权限</TD>
                <TD  class= input5> <input style="background:url(../common/images/select--bg_03.png) no-repeat right center" class=codeno readonly name=RegisterFlag id=RegisterFlag CodeData="0|3^0|无立案权限^1|有立案权限" ondblclick="return showCodeListEx('RegisterFlag', [this,RegisterFlagName],[0,1],'','','','',150)" onclick="return showCodeListEx('RegisterFlag', [this,RegisterFlagName],[0,1],'','','','',150);" onkeyup="return showCodeListKeyEx('RegisterFlag', [this,RegisterFlagName],[0,1],'','','','',150);"><input class=codename name=RegisterFlagName  id=RegisterFlagName readonly=true></TD> </TR>
                 <TR class= common>               
				<TD  class= title5>呈报权限</TD>
			...
			<TR class= common>    
				...
				<TD  class= title5>任务分配权限</TD>
				<TD  class= input5> <input style="background:url(../common/images/select--bg_03.png) no-repeat right center" class=codeno  readonly name=TaskAssign id=TaskAssign CodeData="0|3^0|无任务分配权限^1|有任务分配权限" ondblclick="return showCodeListEx('TaskAssign',[this,TaskAssignName],[0,1],'','','','',150);" onclick="return showCodeListEx('TaskAssign',[this,TaskAssignName],[0,1],'','','','',150);" onkeyup="return showCodeListKeyEx('TaskAssign',[this,TaskAssignName],[0,1],'','','','',150);"><input class=codename name=TaskAssignName id=TaskAssignName readonly=true></TD> </TR>
                <TR class= common>   
				<TD  class= title5>审核权限</TD>
            ...
            <TR class= common>   
 				<TD  class= title5>工作电话</TD>
                <TD  class= input5> <input class="wid" class=common name=RelPhone id=RelPhone ></TD> 	
				<TD  class= title5></TD>
                <TD  class= input5></TD> 	
                ...
                <input class=cssButton name="saveUserButton"   value="增   加" disabled type=button onclick="UserAddClick();">
               ...
               <a href="javascript:void(0);" name="resetUserButton" class="button" onClick="UserResetClick();">重    置</a> 
               <a href="javascript:void(0);" name="queryUserButton" class="button" onClick="userQueryClick();">用户查询</a>-->
    <!--隐藏表单区域-->	
