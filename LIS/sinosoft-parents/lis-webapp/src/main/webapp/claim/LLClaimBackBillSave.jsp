...
<%
	...
	if (tG == null) {
		loggerDebug("LLClaimBackBillSave","未获取到登录信息!");
		return;
	}
	...
	if (tLLClaimBillUI.submitData(tVData, "BackBill") == false) {
		...
		if (txmlExport == null) {
			...
			loggerDebug("LLClaimBackBillSave","没有得到要显示的数据文件");
		}
	}
	...
	if (FlagStr.equals("Succ")) {
		...
		//把dataStream存储到磁盘文件
		loggerDebug("LLClaimBackBillSave","存储文件到" + strVFPathName);
