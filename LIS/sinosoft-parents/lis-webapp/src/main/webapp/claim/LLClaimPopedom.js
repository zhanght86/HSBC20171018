...
function submitPopedomForm()
{
    ...
    fm.action = "./LLClaimPopedomSave.jsp";
...
//	var strSQL="select JobCategory,CaseCategory,(select codename from ldcode where codetype='casecategory' and code=casecategory),(select codename from ldcode where codetype='jobcategory' and code=JobCategory),"
//		         +" ClaimType,ClaimCheckUwFlag,BaseMin,BaseMax,StartDate,EndDate,MngCom,Operator,MakeDate,MakeTime,ModifyDate,ModifyTime from LLClaimPopedom where 1=1 "
...
//				 + " order by JobCategory ";
	 ...
	 var  CaseCategoryQ1 = window.document.getElementsByName(trim("CaseCategoryQ"))[0].value;
	 var sqlid1="LLClaimPopedomSql1";
	 var mySql1=new SqlClass();
	 mySql1.setResourceName("claim.LLClaimPopedomSql");
	 mySql1.setSqlId(sqlid1);//指定使用SQL的id
	 mySql1.addSubPara(JobCategoryQ1);//指定传入参数
	 mySql1.addSubPara(CaseCategoryQ1);//指定传入参数
