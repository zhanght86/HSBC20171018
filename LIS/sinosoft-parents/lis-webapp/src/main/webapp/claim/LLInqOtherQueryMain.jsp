...
<!--标题与状态区域-->
    ...
    <frameset name="fraSet" cols="0%,*,0%" frameborder="no" border="1" framespacing="0" rows="*">
        ...
        <!--交互区域-->
        <%
			  String szSrc = "LLInqOtherQueryInput.jsp";	
			  ...
			  szSrc += "&InqDept=" + request.getParameter("InqDept");	//调查机构
			  szSrc += "&Type=" + request.getParameter("Type");	//标志 0--，2--
			  loggerDebug("LLInqOtherQueryMain",szSrc);
		    %>        
