...
function initForm()
{
  ...
  {
    alert("在LLClaimQueryInit.jsp-->InitForm函数中发生异常:初始化界面错误!");
  }
}
...
function initInpBox()
{
  ...
  {
    alert("在LLClaimQueryInit.jsp-->InitInpBox函数中发生异常:初始化界面错误!");
  }
}
