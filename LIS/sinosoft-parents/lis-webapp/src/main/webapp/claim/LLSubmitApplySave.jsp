...
if(tGI == null)
{
    FlagStr = "Fail";
    Content = "页面失效,请重新登陆";
    loggerDebug("LLSubmitApplySave","页面失效,请重新登陆");    
}
else //页面有效
{
    ...
    //	wFlag = "8999999999";
        try
        {
            ...
            if(!tWorkFlowUI.submitData(tVData, "create")){
            	Content = " 提交tLLSubmitApplyUI失败，原因是: " + tWorkFlowUI.mErrors.getError(0).errorMessage;
                FlagStr = "Fail";
            }
...
//            }
        ...
        {
        	Content = "数据提交tLLSubmitApplyUI失败，原因是:" + ex.toString();
        	FlagStr = "Fail";
        }	
    }  
    catch(Exception ex)
