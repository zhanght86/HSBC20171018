<%
//程序名称：LLClaimEndCaseMissInit.jsp
//程序功能：
//创建日期：2005-6-6 11:30
//创建人  ：zl
//更新记录：
...
{ 
  ...
  {
    alert("在LLClaimEndCaseMissInit.jsp-->InitInpBox函数中发生异常:初始化界面错误!");
  }      
}
...
//    setOption("sex","0=男&1=女&2=不详");        
  ...
  {
    alert("在LLClaimEndCaseMissInit.jsp-->InitSelBox函数中发生异常:初始化界面错误!");
  }
}                                        
...
//	easyQueryClickSelf();
  ...
  {
    alert("LLClaimEndCaseMissInit.jsp-->InitForm函数中发生异常:初始化界面错误!");
  }
}
...
//    LLClaimEndCaseGrid.canChk = 1;
    LLClaimEndCaseGrid.canSel =1; // 1 显示 ；0 隐藏（缺省值）
    LLClaimEndCaseGrid.selBoxEventFuncName ="LLClaimEndCaseGridClick"; //响应的函数名，不加扩号
//        LLClaimEndCaseGrid.selBoxEventFuncParm =""; //传入的参数,可以省略该项     
...
//    SelfLLClaimEndCaseGrid.canChk = 1;
    SelfLLClaimEndCaseGrid.canSel =1; // 1 显示 ；0 隐藏（缺省值）
    SelfLLClaimEndCaseGrid.selBoxEventFuncName ="SelfLLClaimEndCaseGridClick"; //响应的函数名，不加扩号
//        SelfLLClaimEndCaseGrid.selBoxEventFuncParm =""; //传入的参数,可以省略该项    
