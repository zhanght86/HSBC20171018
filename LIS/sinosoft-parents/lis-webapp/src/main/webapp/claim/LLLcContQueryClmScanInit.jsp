...
/*        iArray[11]=new Array();                //此项不显示，作为保存数据用
        ...
        LLLcContSuspendGrid = new MulLineEnter( "fm" , "LLLcContSuspendGrid" );
        //这些属性必须在loadMulLine前
        LLLcContSuspendGrid.mulLineCount = 0;
...
function initLcContStateGrid()
{
    ...
    try
    {
        ...
        LcContStateGrid = new MulLineEnter( "fm" , "LcContStateGrid" );
        //这些属性必须在loadMulLine前
        LcContStateGrid.mulLineCount = 0;
