...
<head >
    ...
    <SCRIPT src="LLClaimPopedom.js"></SCRIPT>
	...
	<Div  id= "QueryPopedom" style= "display:''" class="maxbox1">
	    <Table  class= common>
            <TR class= common>  
	                ...
	                <TD  class= input5> <Input style="background:url(../common/images/select--bg_03.png) no-repeat right center" class="codeno" name=CaseCategoryQ id=CaseCategoryQ readonly ondblclick="return showCodeList('casecategory',[this,CaseCategoryNameQ],[0,1]);" onclick="return showCodeList('casecategory',[this,CaseCategoryNameQ],[0,1]);" onkeyup="return showCodeListKey('casecategory',[this,CaseCategoryNameQ],[0,1]);"><input class="codename" name="CaseCategoryNameQ" id="CaseCategoryNameQ" readonly></TD>             				
...
<!--<a href="javascript:void(0);" class="button" onClick="InitQueryClick();">查    询</a>-->
	...
	<Div  id= "ClaimPopedom" style= "display:''" class="maxbox">
        ...
        <table  class= common>
            <tr class= common>
				<TD  class= title5>权限级别</TD>
				<TD  class= input5> <Input style="background:url(../common/images/select--bg_03.png) no-repeat right center" class="codeno" name=JobCategory id=JobCategory readonly ondblclick="return showCodeList('jobcategory',[this,JobCategoryName],[0,1]);" onclick="return showCodeList('jobcategory',[this,JobCategoryName],[0,1]);" onkeyup="return showCodeListKey('jobcategory',[this,JobCategoryName],[0,1]);"><input class="codename" name="JobCategoryName" id="JobCategoryName" readonly><font size=1 color='#ff0000'><b>*</b></font></TD>     
				<TD  class= title5>案件类型</TD>      
	            <TD  class= input5> <Input style="background:url(../common/images/select--bg_03.png) no-repeat right center" class="codeno" name=CaseCategory id=CaseCategory  readonly ondblclick="return showCodeList('casecategory',[this,CaseCategoryName],[0,1]);" onclick="return showCodeList('casecategory',[this,CaseCategoryName],[0,1]);" onkeyup="return showCodeListKey('casecategory',[this,CaseCategoryName],[0,1]);"><input class="codename" name="CaseCategoryName" id="CaseCategoryName" readonly><font size=1 color='#ff0000'><b>*</b></font></TD>             	</tr>
                <tr class= common>			       				
            ...
            <tr class= common>    
                ...
                <TD  class= input5> <!--<input class="coolDatePicker" verify="启用日期|date&NOTNULL" dateFormat="short" name="StartDate" onblur="CheckDate(fm.StartDate);">-->
                <Input class="coolDatePicker" onClick="laydate({elem: '#StartDate'});" verify="启用日期|date&NOTNULL" dateFormat="short" onblur="CheckDate(fm.StartDate);" name=StartDate id="StartDate"><span class="icon"><a onClick="laydate({elem: '#StartDate'});"><img src="../common/laydate/skins/default/icon.png" /></a></span>
                <font size=1 color='#ff0000'><b>*</b></font></TD>                       
            </tr>
            
            <tr class= common>
                <TD  class= title5>结束日期</TD>
                <TD  class= input5><!-- <input class="coolDatePicker" verify="结束日期|date&NOTNULL" dateFormat="short" name="EndDate" onblur="CheckDate(fm.EndDate);">-->
                 <Input class="coolDatePicker" onClick="laydate({elem: '#EndDate'});" verify="启用日期|date&NOTNULL" dateFormat="short" onblur="CheckDate(fm.EndDate);" name=EndDate id="EndDate"><span class="icon"><a onClick="laydate({elem: '#EndDate'});"><img src="../common/laydate/skins/default/icon.png" /></a></span>
                </TD>                      
                <TD  class= title5>操作员</TD>
                <TD  class= input5> <Input class="readonly wid" readonly name=Operator id=Operator ></TD> </tr>
                 <tr class= common>          
