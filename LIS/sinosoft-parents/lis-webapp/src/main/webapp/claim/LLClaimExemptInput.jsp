...
-->        
    ...
    <br>
    <a href="javascript:void(0);" name="exemptquery" id="exemptquery" class="button" onClick="LLExemptQueryClick();">获取豁免信息</a>
	...
	<Div id= "divLLClaimExemptFreeInfo" style= "display: 'none'">
		<Table class=common>
			<tr class=common>
                ...
                <Input class="coolDatePicker" onClick="laydate({elem: '#FreeStartDate'});" verify="有效开始日期|DATE" dateFormat="short" name=FreeStartDate id="FreeStartDate"><span class="icon"><a onClick="laydate({elem: '#FreeStartDate'});"><img src="../common/laydate/skins/default/icon.png" /></a></span>
                </TD>
	            <TD class= title>免交止期</TD>
	            <TD class= input><!--<input class="coolDatePicker" dateFormat="short" name="FreeEndDate"  >-->
                <Input class="coolDatePicker" onClick="laydate({elem: '#FreeEndDate'});" verify="有效开始日期|DATE" dateFormat="short" name=FreeEndDate id="FreeEndDate"><span class="icon"><a onClick="laydate({elem: '#FreeEndDate'});"><img src="../common/laydate/skins/default/icon.png" /></a></span>
                </TD>
	        </tr>
            <tr class=common>
    ...
    <br>
    <a href="javascript:void(0);" class="button" onClick="LLExemptSaveClick();">保    存</a>
