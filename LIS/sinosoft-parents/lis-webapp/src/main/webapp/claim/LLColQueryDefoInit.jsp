...
function initForm()
{
    ...
    {
        alter("LLColQueryDefoInit.jsp-->InitForm函数中发生异常:初始化界面错误!");
    }
}
...
function initInpBox()
{
  ...
  {
    alter("LLColQueryDefoInit.jsp-->InitInpBox函数中发生异常:初始化界面错误!");
  }
}
...
//        iArray[8][3]=0;
        ...
        LLColQueryDefoGrid.canSel =1;              //单选按钮，1显示，0隐藏
        LLColQueryDefoGrid.hiddenPlus=1;           //＋号，1隐藏，0显示
        LLColQueryDefoGrid.hiddenSubtraction=1;    //－号：1隐藏，0显示
//        LLColQueryDefoGrid.selBoxEventFuncName = "LLColQueryDefoGridClick"; //函数名称
