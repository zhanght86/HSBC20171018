...
else
{
    ...
    tLLOperationSchema.setCaseNo(tLLOperationSchema.getClmNo());
    tLLOperationSchema.setSerialNo(request.getParameter("SerialNo4").trim());
    ...
    tLLOperationSchema.setCurrency(request.getParameter("OpCurrency"));
    tLLOperationSchema.setOpFee(request.getParameter("OpFee")); //费用金额
    tLLOperationSchema.setAdjSum(tLLOperationSchema.getOpFee());   //调整金额设为初始金额
    tLLOperationSchema.setSelfAmnt(request.getParameter("selfOpFeeSum")); //自费/自付金额
...
//            }
//        }
		String busiName="LLMedicalFeeInp4UI";
