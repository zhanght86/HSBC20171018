...
<%
	//程序名称：LLClaimCancelBillInput.jsp
	//程序功能：个险理赔撤件案件清单
	//创建日期：2009-04-16
	//创建人  ：mw
	//更新记录：
...
<script src="./LLClaimCancelBill.js"></script>
<SCRIPT src="LLClaimPubFun.js"></SCRIPT>
<%@include file="LLClaimCancelBillInit.jsp"%>
</head>
<body onLoad="initForm();">
<form action="./LLClaimCancelBillSave.jsp" name=fm id=fm target=fraSubmit method=post>
<table>
	<TR>
...
src="../common/laydate/skins/default/icon.png" /></a></span><font color='#ff0000'><b>*</b></font></TD>
	...
	<Input class=cssButton VALUE="理赔预付案件清单" TYPE=button onclick="showLLClaimInqBill()">
