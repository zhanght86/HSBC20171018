...
try
  ...
  {
    alert("在LLDealUWsecondSendAllNoticeInit.jsp-->InitInpBox函数中发生异常:初始化界面错误!");
  }   
}
...
{  
  ...
  {
    alert("在LLDealUWsecondSendAllNoticeInit.jsp-->InitSelBox函数中发生异常:初始化界面错误!");
  }
}                                        
...
function initForm()
{
  ...
  {
    alert("LLDealUWsecondSendAllNoticeInit.jsp-->InitForm函数中发生异常:初始化界面错误!");
  }
}
