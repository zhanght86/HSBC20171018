...
if(tGI == null)
{
    FlagStr = "Fail";
    Content = "页面失效,请重新登陆";
    loggerDebug("LLPRTInteInqPaySave","页面失效,请重新登陆");    
}
//else
//{
    ...
    mTransferData.setNameAndValue("Payee",request.getParameter("Payee")); //查勘人
//   	mTransferData.setNameAndValue("Path",tPath);
    ...
    {
        Content = " 数据提交失败，原因是: " + tLLPRTInteInqPayUI.mErrors.getError(0).errorMessage;
        FlagStr = "Fail";
    }
    else
    {
	    ...
	    if(txmlExport==null)
	    {
            ...
            loggerDebug("LLPRTInteInqPaySave","没有得到要显示的数据文件");
	    }
    }
	if (FlagStr.equals("Succ"))
	{
		...
		//把dataStream存储到磁盘文件
		loggerDebug("LLPRTInteInqPaySave","存储文件到"+strVFPathName);
