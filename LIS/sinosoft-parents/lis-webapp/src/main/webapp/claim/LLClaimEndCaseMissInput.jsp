...
<body  onload="initForm();" >
    ...
    <Div  id= "divSearch" style= "display: ''" class="maxbox1">
        <table class= common>
            ...
            <TR class= common>
                ...
                <Input class="coolDatePicker" onClick="laydate({elem: '#RgtDate'});" verify="有效开始日期|DATE" dateFormat="short" onblur=" CheckDate(fm.RgtDate); " name=RgtDate id="RgtDate"><span class="icon"><a onClick="laydate({elem: '#RgtDate'});"><img src="../common/laydate/skins/default/icon.png" /></a></span>
                </TD>
            </TR>
            <TR class= common>
 				<TD class= title5> 签批同意日期 </TD>
                <TD class= input5><!-- <input class="coolDatePicker" dateFormat="short" name="EndCaseDate" onblur=" CheckDate(fm.EndCaseDate); " >-->
                 <Input class="coolDatePicker" onClick="laydate({elem: '#EndCaseDate'});" verify="有效开始日期|DATE" dateFormat="short" onblur=" CheckDate(fm.EndCaseDate); " name=EndCaseDate id="EndCaseDate"><span class="icon"><a onClick="laydate({elem: '#EndCaseDate'});"><img src="../common/laydate/skins/default/icon.png" /></a></span>
                </TD>
                <TD class= title5>  </TD>
                <TD class= input5> </TD>
    ...
    <Div id= "divSelfLLClaimEndCaseGrid" style= "display: ''">
        ...
        <table align="center">
            <tr>
                <td><INPUT VALUE="首  页" class=cssButton90 TYPE=button onclick="turnPage2.firstPage();HighlightSelfByRow()"></td>
                <td><INPUT VALUE="上一页" class=cssButton91 TYPE=button onclick="turnPage2.previousPage();HighlightSelfByRow()"></td>
                <td><INPUT VALUE="下一页" class=cssButton92 TYPE=button onclick="turnPage2.nextPage();HighlightSelfByRow()"></td>
                <td><INPUT VALUE="尾  页" class=cssButton93 TYPE=button onclick="turnPage2.lastPage();HighlightSelfByRow()"></td>
            </tr>
        </table>        
    </div>
