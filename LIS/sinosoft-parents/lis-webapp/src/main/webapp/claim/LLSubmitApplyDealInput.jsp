...
<body  onload="initForm();">
	<Form action="./LLSubmitApplyDealSave.jsp"  method=post name=fm id=fm target="fraSubmit">
	    <table>
	        <TR>
        ...
        <Div  id= "DivLLSubmit" style= "display: ''" class="maxbox">
     		<Table class= common>     				
		        ...
		        <TR  class= common>   	
                    ...
                    <TD  class= input> <Input style="background:url(../common/images/select--bg_03.png) no-repeat right center" class=codeno type=hidden disabled name="InitPhase" id="InitPhase" ondblclick="return showCodeList('llinitphase',[this,InitPhaseName],[0,1]);" onclick="return showCodeList('llinitphase',[this,InitPhaseName],[0,1]);" onkeyup="return showCodeListKey('llinitphase',[this,InitPhaseName],[0,1]);"><input class= "wid" name="InitPhaseName" id="InitPhaseName" readonly=true></TD>
			        <TD  class= title> 呈报类型</TD>
                    <TD  class= input> <Input style="background:url(../common/images/select--bg_03.png) no-repeat right center" class=codeno type=hidden  disabled name="SubType" id="SubType" ondblclick="return showCodeList('llsubtype',[this,SubTypeName],[0,1]);" onclick="return showCodeList('llsubtype',[this,SubTypeName],[0,1]);" onkeyup="return showCodeListKey('llinitphase',[this,SubTypeName],[0,1]);"><input class= "wid" name="SubTypeName" id="SubTypeName" readonly=true></TD>
		        ...
		        <TR  class= common>   	
                    ...
                    <TD  class= input> <Input style="background:url(../common/images/select--bg_03.png) no-repeat right center" class=codeno disabled type=hidden name="SubDept" id="SubDept" ondblclick="return showCodeList('station',[this,SubDeptName],[0,1]);" onclick="return showCodeList('station',[this,SubDeptName],[0,1]);" onkeyup="return showCodeListKey('station',[this,SubDeptName],[0,1]);"><input class= "wid"  name="SubDeptName" id="SubDeptName" readonly=true></TD>
		        ...
		        <TR  class= common>   	
                    ...
                    <TD  class= input> <Input style="background:url(../common/images/select--bg_03.png) no-repeat right center" class=codeno type=hidden  disabled name="SubState" id="SubState" ondblclick="return showCodeList('llsubstate',[this,SubStateName],[0,1]);" onclick="return showCodeList('llsubstate',[this,SubStateName],[0,1]);" onkeyup="return showCodeListKey('llsubstate',[this,SubStateName],[0,1]);"><input class= "wid" name="SubStateName" id="SubStateName" readonly=true></TD>		        
			        ...
			        <TD  class= input><Input class= "readonly wid" readonly id="DispDept"  name="DispDept"></TD>
		        </TR>
		 	</Table>
		 	<Table class= common>
		        <TR >
	    ...
	    <Div  id= "DivHeadIdea" style= "display: ''">  
	    	...
	    	<TABLE class= common> 
	            ...
	            <TR class= common>  
	            	<TD style="padding-left:16px" class= input> <textarea name="HeadIdea" id=HeadIdea readonly cols="199" rows="4" witdh=25% class="common"></textarea></TD>
	            </TR>
  	    	</TABLE> 
	    </Div> 
	    <hr class="line">
	    <Div> 
	    	<TABLE class= common>   
	        	<TR >
                    ...
                    <TD  class= input> <Input style="background:url(../common/images/select--bg_03.png) no-repeat right center" class=codeno readonly name="DispType" id="DispType" ondblclick="return showCodeList('lldisptype',[this,DispTypeName],[0,1]);" onclick="return showCodeList('lldisptype',[this,DispTypeName],[0,1]);" onkeyup="return showCodeListKey('lldisptype',[this,DispTypeName],[0,1]);"><input class=codename name="DispTypeName" id="DispTypeName" readonly=true></TD>
                    <TD class= title></TD>
                    <TD  class= input></TD>
                    <TD class= title></TD>
                    <TD  class= input></TD>
		...
		<Div  id= "DivReportheadSubDesc" style= "display: 'none'">  
	    	<Table class= common>
	            ...
	            <TR >  
	            	<TD style="padding-left:16px" class= input> <textarea name="ReportheadSubDesc" id=ReportheadSubDesc  cols="199" rows="4" witdh=25% class="common"></textarea></TD>
	            </TR>
      		</Table>
	    </Div>	
	    <!--<Div>          
	    ...
	    </Div>--> <br><a  name="Replyconfirm" href="javascript:void(0);" class="button" onClick="Replyport();">呈报确认</a>
