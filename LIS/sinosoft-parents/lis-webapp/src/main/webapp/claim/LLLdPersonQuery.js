...
function easyQueryClick()
{
    ...
    initPersonGrid();
    /*var strSQL = "";
    strSQL = "select CustomerNo,Name,Sex,Birthday,IDType,IDNo,(case when trim(nvl(SocialInsuFlag, 0)) = '1' then '有' else '无' end) as 是否有社保标志 ,deathdate from LDPerson where 1=1 "
	...
	mySql.addSubPara(fm.IDNo.value ); 
    	   //2008-11-20 客户要求个险只能查询到个险的客户,不能查询到团险的客户,所以封住录入团体保单号的录入框,并限制必须查询是个险客户
           if (fm.ContNo.value != "")
           {
