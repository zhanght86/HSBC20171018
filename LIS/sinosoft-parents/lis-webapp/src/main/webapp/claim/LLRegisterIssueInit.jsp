...
{ 
  ...
  {
    alert("在LLIssueMissInit.jsp-->InitInpBox函数中发生异常:初始化界面错误!");
  }      
}
...
//    setOption("sex","0=男&1=女&2=不详");        
  ...
  {
    alert("在LLIssueMissInit.jsp-->InitSelBox函数中发生异常:初始化界面错误!");
  }
}                                        
...
//	easyQueryClickSelf();
  ...
  {
    alert("LLIssueMissInit.jsp-->InitForm函数中发生异常:初始化界面错误!");
  }
}
