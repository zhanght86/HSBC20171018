...
else //页面有效
{
	...
	mTransferData.setNameAndValue("MngCom", request.getParameter("tInitDept"));  //机构 ------调查任务机构   
	//为lwmission中defaultoperator做数据准备：产生下一节点时的默认操作人为任务分配时的被指定人 Add by zhaorx 2006-03-11 
    ...
    mTransferData.setNameAndValue("CreateOrExecuteFlag","1");  //用于工作流createaction的是否执行创建服务类
    try
    {
        //准备传输数据 VData
