...
<%
	//程序名称：LLClaimDelayInterestBillInput.jsp
	//程序功能：延滞利息清单
	//创建日期：2009-04-16
	//创建人  ：mw
	//更新记录：
...
<script src="./LLClaimDelayInterestBillInput.js"></script>
<SCRIPT src="LLClaimPubFun.js"></SCRIPT>
<%@include file="LLClaimDelayInterestBillInit.jsp"%>
</head>
<body onLoad="initForm();">
<form action="./LLClaimDelayInterestBillSave.jsp" name=fm  id=fm target=fraSubmit method=post>
<table  >
	<TR >
...
<Table class=common>
	<TR class=common>
		...
		<TD class=input5><Input class=codeno name="MngCom" id="MngCom"
			verify="统计机构|NOTNULL"
	...
	<TR class=common>
		...
		<TD class=input5>
            <input class="coolDatePicker" dateFormat="short"  name="EndDate"   id="EndDate" onClick="laydate({elem:'#EndDate'});" verify="结束日期|NOTNULL"> <span class="icon"><a onClick="laydate({elem: '#EndDate'});"><img src="../common/laydate/skins/default/icon.png" /></a></span>
            <font color='#ff0000'><b>*</b></font></TD>
	</TR>
</table>
</Div>
</Div>
 <a href="javascript:void(0);" class="button"onclick="showLLClaimDelayInterestBill()">延滞利息清单</a>

<!--<table>
	<TR>
		<TD><Input class=cssButton VALUE="延滞利息清单" TYPE=button
			onclick="showLLClaimDelayInterestBill()"></TD>
	</TR>
</table>-->
