...
<script src="./LLClaimEndCaseBill.js"></script>
<SCRIPT src="LLClaimPubFun.js"></SCRIPT>
<%@include file="LLClaimEndCaseBillInit.jsp"%>
</head>
<body onLoad="initForm();">
<form action="./LLClaimEndCaseBillSave.jsp" name=fm id=fm target=fraSubmit method=post>
<table>
	<TR>
...
<Table class=common>
	...
	<TR class=common>
		...
		<TD class=input5>
            <input class="coolDatePicker" dateFormat="short" name="EndDate"  name="EndDate" onClick="laydate({elem:'#EndDate'});" verify="结束日期|NOTNULL"> <span class="icon"><a onClick="laydate({elem: '#EndDate'});"><img src="../common/laydate/skins/default/icon.png" /></a></span>
            <font color='#ff0000'><b>*</b></font></TD>
	</TR>
</table>
</Div>
</Div>
<a href="javascript:void(0);" class="button"onclick="showLLClaimEndCaseBill()">已结案件清单</a>

<!--<table>
	<TR>
		<TD><Input class=cssButton VALUE="已结案件清单" TYPE=button
