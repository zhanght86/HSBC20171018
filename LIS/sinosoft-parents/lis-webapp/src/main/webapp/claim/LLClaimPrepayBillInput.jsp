...
<%
	//程序名称：LLClaimPrepayBillInput.jsp
	//程序功能：个险理赔预付案件清单
	//创建日期：2009-04-15
	//创建人  ：mw
	//更新记录：
...
<script src="./LLClaimPrepayBill.js"></script>
<SCRIPT src="LLClaimPubFun.js"></SCRIPT>
<%@include file="LLClaimPrepayBillInit.jsp"%>
</head>
<body onLoad="initForm();">
<form action="./LLClaimPrepayBillSave.jsp" name=fm id=fm target=fraSubmit method=post>
<table>
	<TR>
...
({elem:'#StartDate'});" verify="起始日期|NOTNULL"> <span class="icon"><a onClick="laydate({elem: '#StartDate'});"><img 
...
<a href="javascript:void(0);" class="button"onclick="showLLClaimPrepayBill()">理赔预付案件清单</a>

<!--<table>
	<TR>
		<TD><Input class=cssButton VALUE="理赔预付案件清单" TYPE=button
