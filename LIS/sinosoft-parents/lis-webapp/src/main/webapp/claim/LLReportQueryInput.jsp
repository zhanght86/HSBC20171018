...
<form name=fm id=fm target=fraSubmit method=post>
    ...
    <span id= "spanLLReport" class=maxbox style= "display: ''">
        <table class= common>
            <TR class= common>    
                ...
                <TD class= input> <Input class= "common wid" name=RptorPhone id=RptorPhone ></TD>
            </TR>
            <TR class= common>                  
                ...
                <TD class= input> <Input class=codeno name="RptMode" id=RptMode style="background:url(../common/images/guanliyuan-bg.png) no-repeat right center" ondblclick="return showCodeList('llrptcasetype',[this,RptModeName],[0,1]);" onkeyup="return showCodeListKey('llrptcasetype',[this,RptModeName],[0,1]);"><input class=codename name="RptModeName" id=RptModeName readonly=true></TD>            
            </TR>
<!--
            <TR class= common>            
...
-->            
    ...
    <Div  id= "divLLReport" style= "display: ''">
        <Table  class= common>
            <TR  class= common>
                <TD style="text-align: left" colSpan=1><span id="spanLLReportGrid" ></span> </TD>
            </TR>
        </Table>
        </Table>
        <table> 
