...
<script src="./LLClaimInqBill.js"></script>
<SCRIPT src="LLClaimPubFun.js"></SCRIPT>
<%@include file="LLClaimInqBillInit.jsp"%>
</head>
<body onLoad="initForm();">
<form action="./LLClaimInqBillSave.jsp" name=fm id=fm target=fraSubmit method=post>
<table>
	<TR>
...
<a href="javascript:void(0);" class="button"onclick="showLLClaimInqBill()">理赔预付案件清单</a>

<!--<table>
	<TR>
		<TD><Input class=cssButton VALUE="理赔预付案件清单" TYPE=button
			onclick="showLLClaimInqBill()"></TD>
	</TR>
</table>-->
