...
function initLCInsureAccClassGrid()
{
    ...
    try
    {
        ...
        LCInsureAccClassGrid = new MulLineEnter("document","LCInsureAccClassGrid");
        LCInsureAccClassGrid.mulLineCount = 5;
...
function initLCInsureAccTraceGrid()
{
    ...
    try
    {
      ...
      iArray[5][3]=0;              			//是否允许输入,1表示允许，0表示不允许
        ...
        LCInsureAccTraceGrid = new MulLineEnter("document","LCInsureAccTraceGrid");
        LCInsureAccTraceGrid.mulLineCount = 5;       // 显示行数
