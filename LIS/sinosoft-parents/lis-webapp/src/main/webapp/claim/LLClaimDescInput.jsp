...
<form name=fm id=fm target=fraSubmit method=post>
    ...
    <table>
        <TR>
            <TD class="common"><IMG  src= "../common/images/butExpand.gif" style= "cursor:hand;" OnClick= "showPage(this,divLLSubReportDesc1);"></TD>
    ...
    <Div id= "divLLSubReportDesc2" style= "display: ''" class="maxbox1">
        ...
        <Table class= common>
            ...
            <tr class= common>
                <td colspan="6" style="padding-left:16px"> <textarea name="Describe" id=Describe cols="224" rows="4" witdh=25% class="common"></textarea></td>
            </tr>
        </TABLE></Div>
