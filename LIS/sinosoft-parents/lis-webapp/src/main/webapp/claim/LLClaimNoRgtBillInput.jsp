...
<%
	//程序名称：LLClaimNoRgtBillInput.jsp
	//程序功能：个险理赔不予立案清单
	//创建日期：2009-04-14
	//创建人  ：mw
	//更新记录：
...
<script src="./LLClaimNoRgtBill.js"></script>
<SCRIPT src="LLClaimPubFun.js"></SCRIPT>
<%@include file="LLClaimNoRgtBillInit.jsp"%>
</head>
<body onLoad="initForm();">
<form action="./LLClaimNoRgtBillSave.jsp" name=fm id=fm target=fraSubmit method=post>
<table>
	<TR>
...
<a href="javascript:void(0);" class="button"onclick="showLLClaimNoRgtBill()">理赔不予立案清单</a>

<!--<table>
	<TR>
		<TD><Input class=cssButton VALUE="理赔不予立案清单" TYPE=button
			onclick="showLLClaimNoRgtBill()"></TD>
	</TR>
</table>-->
