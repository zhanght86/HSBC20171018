...
else
{
    ...
    mTransferData.setNameAndValue("AccDate", request.getParameter("AccidentDate")); //事故
    ...
    mTransferData.setNameAndValue("Auditer", Operator);  //审核操作人,为审批不通过时返回个人工作队列用
    ...
    mTransferData.setNameAndValue("ActivityID",request.getParameter("ActivityID"));//lzf 2013-05-17
...
//    }
	...
	String busiName = "WorkFlowUI";//lzf
	 BusinessDelegate tBusinessDelegate=BusinessDelegate.getBusinessDelegate();
	   ...
	   {    
	        ...
	        { 
					   Content = "数据提交工作流失败，原因是:" + tBusinessDelegate.getCErrors().getFirstError();
					   FlagStr = "Fail";
			}
			else
			{
