...
function initParam()
{
    ...
    document.all('insurednobak').value = nullToEmpty("<%= tInsuredNo %>"); //保存传过来的客户信息
...
function initLLBalanceGrid()
{
    ...
    try
    {
        ...
        iArray[7]=new Array();
        iArray[7][0]="GrpContNo";        //列名
        iArray[7][1]="100px";                //列宽
        iArray[7][2]=100;                  //列最大值
        iArray[7][3]=3;                    //是否允许输入,1表示允许，0表示不允许

        iArray[8]=new Array();
        iArray[8][0]="GrpPolNo";             //列名
        iArray[8][1]="100px";                //列宽
        iArray[8][2]=200;                  //列最大值
        iArray[8][3]=3;

        iArray[9]=new Array();
        iArray[9][0]="ContNo";          //列名
        iArray[9][1]="100px";                //列宽
        iArray[9][2]=200;                  //列最大值
...
function initLLBnfGrid()
{
    ...
    try
    {
      ...
      iArray[21][3]=0;              			//是否允许输入,1表示允许，0表示不允许
        ...
        iArray[27]=new Array();
        iArray[27][0]="银行帐户名";          //列名
        iArray[27][1]="100px";                //列宽
        iArray[27][2]=200;                  //列最大值
        iArray[27][3]=3;                    //是否允许输入,1表示允许，0表示不允许

        iArray[28]=new Array();
        iArray[28][0]="分配项目编码";             //列名
        iArray[28][1]="60px";                //列宽
        iArray[28][2]=60;                  //列最大值
        iArray[28][3]=3;                    //是否允许输入,1表示允许，0表示不允许

        iArray[29]=new Array();
        iArray[29][0]="支付方式";          //列名
        iArray[29][1]="100px";                //列宽
        iArray[29][2]=100;                  //列最大值
        iArray[29][3]=0;                    //是否允许输入,1表示允许，0表示不允许

        iArray[30]=new Array();
        iArray[30][0]="原受益人序号";          //列名
        iArray[30][1]="10px";                //列宽
        iArray[30][2]=10;                  //列最大值
        iArray[30][3]=3;                    //是否允许输入,1表示允许，0表示不允许

        iArray[31]=new Array();
        iArray[31][0]="备份未合并金额前的本项目的受益金额";          //列名
        iArray[31][1]="10px";                //列宽
        iArray[31][2]=10;                  //列最大值
        iArray[31][3]=3;                    //是否允许输入,1表示允许，0表示不允许
