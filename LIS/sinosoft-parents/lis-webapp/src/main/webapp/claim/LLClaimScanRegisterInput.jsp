...
<form action="./LLClaimRegisterSave.jsp" method=post name=fm id=fm target="fraSubmit">
    ...
    <Div id= "divLLSubReport" style= "display: ''" class="maxbox">
     ...
     <table>
        ...
        <!--<a href="javascript:void(0);" name=QueryPerson class="button" onClick="showInsPerQuery();">客户查询</a>
        <a href="javascript:void(0);" name=QueryReportClm class="button" onClick="queryLLReport();">报案查询与关联</a>
        <a href="javascript:void(0);" name=QueryIssue class="button" onClick="queryLLIssue();">问题件查询</a>
        <a href="javascript:void(0);" name=QueryReport class="button" onClick="queryLLAccident();">事件查询</a>
        <a href="javascript:void(0);" name=addbutton class="button" onClick="saveClick();">保    存</a>
    ...
    <table>
        <tr>
            ...
            <td><INPUT class=cssButton name="BatchCreateNote" VALUE="单证批量打印控制"  TYPE=button onclick="showPrtControl()"></td>
