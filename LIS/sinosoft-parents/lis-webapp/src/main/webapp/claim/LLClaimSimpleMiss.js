...
//    var strSQL = "";/*
//	strSQL = "select missionprop1,(case missionprop2 when '20' then '立案' when '30' then '审核' when '40' then '审批' end),missionprop3,missionprop4,(case missionprop5 when '0' then '男' when '1' then '女' when '2' then '未知' end),"
