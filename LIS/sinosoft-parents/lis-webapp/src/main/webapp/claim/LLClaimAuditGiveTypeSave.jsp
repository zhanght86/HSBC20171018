...
else //页面有效
{
    ...
    else
    {
        ...
        String tGrid13 [] = request.getParameterValues("PolDutyCodeGrid14"); //赔付结论
        String tGrid15 [] = request.getParameterValues("PolDutyCodeGrid16"); //拒付原因代码
        String tGrid17 [] = request.getParameterValues("PolDutyCodeGrid18"); //拒付依据
        String tGrid18 [] = request.getParameterValues("PolDutyCodeGrid19"); //特殊备注
        String tGrid21 [] = request.getParameterValues("PolDutyCodeGrid22"); //调整金额
        String tGrid22 [] = request.getParameterValues("PolDutyCodeGrid23"); //调整原因代码
        String tGrid23 [] = request.getParameterValues("PolDutyCodeGrid24"); //调整原因名称
        String tGrid24 [] = request.getParameterValues("PolDutyCodeGrid25"); //调整备注
        String tGrid28 [] = request.getParameterValues("PolDutyCodeGrid29"); //dutycode
        String tGrid29 [] = request.getParameterValues("PolDutyCodeGrid30"); //客户号码
...
//            FlagStr = "Fail";
//        }
	 String busiName="LLClaimAuditGiveTypeUI";
	 BusinessDelegate tBusinessDelegate=BusinessDelegate.getBusinessDelegate();
	   ...
	   {    
	        ...
	        { 
					   Content = "LLClaimAuditGiveTypeUI处理数据失败，原因是:" + tBusinessDelegate.getCErrors().getFirstError();
					   FlagStr = "Fail";
			}
			else
			{
