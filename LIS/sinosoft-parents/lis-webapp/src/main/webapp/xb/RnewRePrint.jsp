  ...
  <form action="./RnewRePrintSave1.jsp" method=post name=fm  id="fm" target="fraSubmit">
    ...
    <tr  class= common>
         <TD  class= title5>   起始日期   </TD>
          <TD  class= input5>  <input class="coolDatePicker" dateFormat="short" id="StartDay"  name="StartDay" onClick="laydate({elem:'#StartDay'});" verify="提数日期|Date"> <span class="icon"><a onClick="laydate({elem: '#StartDay'});"><img 
src="../common/laydate/skins/default/icon.png" /></a></span> </TD>
          <TD  class= title5>  结束日期 </TD>
          <TD  class= input5> <input class="coolDatePicker" dateFormat="short" id="EndDay"  name="EndDay" onClick="laydate({elem:'#EndDay'});" verify="提数日期|Date"> <span class="icon"><a onClick="laydate({elem: '#EndDay'});"><img src="../common/laydate/skins/default/icon.png" /></a></span> </TD>        	  
     </tr>
    </table>
    </div></div>
  ...
  <!--	<p>
    ...
    <a href="javascript:void(0);" class="button"onClick="printPol();">提交补打通知书数据</a>
    <br><br><br><br>
