...
try
    {
    initBnfGrid();
//    BnfGrid.setRowColData(0,1,"1"); //锁定身故受益人
    }catch(ex){
       alert("在CardContInit.jsp-->初始化界面错误!"); 
    }
}
...
if(CardRisk!=null&&(CardRisk=="111603"||CardRisk=="141812"||CardRisk=="311603")){
        ...
        //iArray[1][4] = "bnftype";
        //iArray[1][9] = "姓名|code:bnftype"; //校验
        iArray[1][10]="bnforder"
        iArray[1][11]="0|^1|身故受益人"
}else{
        iArray[1] = new Array();
        iArray[1][0] = "受益人类别"; //列名
        iArray[1][1] = "80px"; //列宽
...
if(CardRisk!=null&&(CardRisk=="141812")){
        ...
        iArray[6][11]="0|^31|父母|^32|子女|^33|配偶|^30|其他"
        ...
        // iArray[6][11]="0|^01|丈夫^02|妻子|^03|父亲|^04|母亲|^05|儿子|^06|女儿|^30|其他"
        ...
        iArray[6][9] = "与被保人关系|code:Relation";
        iArray[6][10]="cardrelation2"
        iArray[6][11]="0|^31|父母|^33|配偶|^30|其他"
        //iArray[6][9] = "与被保人关系|code:Relation";
}else{
        iArray[6] = new Array();
        iArray[6][0] = "与被保人关系"; //列名
...
function queryinfo()
{
	...
	mySql34.setResourceName("card.CardContInputSql"); //指定使用的properties文件名
