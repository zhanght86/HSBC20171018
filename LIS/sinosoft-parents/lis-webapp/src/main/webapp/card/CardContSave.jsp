...
<%
    ...
    //tContType = tExeSQL.getOneValue("select decode(count(*),0,1,2) from lmriskapp"
    ...
    if (flag.equals("DELETE")) {
        ...
        tLCContSchema.setContNo(request.getParameter("PrtNo"));
        tLCContSchema.setProposalContNo(request.getParameter("PrtNo"));
        ...
        if (request.getParameter("PolApplyDate") == null || request.getParameter("PolApplyDate").equals("")) {
        	tLCContSchema.setPolApplyDate(request.getParameter("CValiDate"));
        } else {
        	tLCContSchema.setPolApplyDate(request.getParameter("PolApplyDate"));
        }
        ...
        if(tLCContSchema.getForceUWReason()==null||"".equals(tLCContSchema.getForceUWReason())){
	        tLCContSchema.setForceUWReason(request.getParameter("PrtNo"));
        }

        //投保人信息
        tLCAppntSchema.setAppntNo(request.getParameter("AppntCustomerNo"));
        tLCAppntSchema.setContNo(request.getParameter("ProposalContNo"));
        tLCAppntSchema.setAppntName(request.getParameter("AppntName"));
        tLCAppntSchema.setGrpContNo("00000000000000000000");
        if(request.getParameter("AppntSex")==null)
	        tLCAppntSchema.setAppntSex("2");
        else
        	tLCAppntSchema.setAppntSex(request.getParameter("AppntSex"));
        if(request.getParameter("AppntBirthday")==null)
	        tLCAppntSchema.setAppntBirthday("1900-01-01");
        else
        ...
        tLCAppntSchema.setRelationToInsured(request.getParameter("RelationToInsured"));
        ...
        if(request.getParameter("Sex")==null)
        	tmLCInsuredSchema.setSex("2");
        else
	        tmLCInsuredSchema.setSex(request.getParameter("Sex"));
        if(request.getParameter("Birthday")==null)
        	tmLCInsuredSchema.setBirthday("1900-01-01");
        else
        ...
        if(request.getParameter("Sex")==null)
	        tLDPersonSchema.setSex("2");
        else
	        tLDPersonSchema.setSex(request.getParameter("Sex"));
        if(request.getParameter("Birthday")==null)
	        tLDPersonSchema.setBirthday("1900-01-01");
        else        	
        ...
        for (int i = 0; i < BnfCount; i++) {
            ...
            if (zSSRS.MaxRow > 0) {
                ...
                if(tBnfGrade[i]==null||"".equals(tBnfGrade[i]))
                	 tBnfGrade[i]="1";
        ...
        LACommisionDetailSchema tLACommisionDetailSchema = new LACommisionDetailSchema();
        tLACommisionDetailSchema.setGrpContNo(request.getParameter("PrtNo"));
        tLACommisionDetailSchema.setAgentCode(request.getParameter("AgentCode"));
        ...
        //}
        //tLCPolSchema.setCValiDate(request.getParameter("PolAppntDate")); (request.getParameter("PolAppntDate"));             //保单生效日期
        ...
        if(request.getParameter("CValiDate")!=null)
    ...
    tTransferData.setNameAndValue("CardRelationToInsured", request.getParameter("RelationToInsured"));
