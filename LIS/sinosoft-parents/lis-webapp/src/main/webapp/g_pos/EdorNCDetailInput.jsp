	...
	<div id="divInfo2" style="display: ''">
		...
		<table class=common>
			...
			<tr class=common id=idPrem name=idPrem style="display: none">
				...
				<td class=input colspan=3><input class=common name=ExceptPrem id=ExceptPrem verify="期望保费/期望费率/费率折扣|num&value>=0" elementtype=nacessary> <input class=cssButton type=button id=tryCalButton name=tryCalButton style="display: none" value="试  算" onclick="tryCal();"></td>
			</tr>
			<tr class=common id=idFeeRate name=idFeeRate style="display: none">
				<td class=title>初始保费</td>
				<td class=input><input class="wid common" name=InitPrem verify="初始保费|num&value>=0" elementtype=nacessary></td>
				<td class=title>期望收益率</td>
				<td class=input><input class="wid common" name=ExceptYield verify="期望收益率|num&value>=0"></td>
				<td class=title></td>
				<td class=input></td>
			</tr>
