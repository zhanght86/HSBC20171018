	...
	<div id="divEdorAudit" class=maxbox1 style="display: ''">
		<table class=common>
			...
			<tr class=common>
				...
				<td class=input colspan=5><textarea cols=76 rows=3 name=AuditOpinion id=AuditOpinion verify="审核意见|len<=1500" elementtype=nacessary></textarea></td>
			</tr>
		</table>
		
		<input class=cssButton type=button value="审核完毕" onclick="auditConfirm();">
