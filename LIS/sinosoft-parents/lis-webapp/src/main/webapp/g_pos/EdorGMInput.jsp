...
<div id="divQueryOld" style="display: none">
	...
	<table class=common>
		<tr class=common>
			<td class=title>变更后领取方式</td>
			<td class=input><input class=codeno name=AnnuityGetMode id=AnnuityGetMode verify="变更后领取方式|NOTNULL" readonly style="background:url(../common/images/select--bg_03.png) no-repeat right center"
	...
	<div id="divModifyButton" style="display: none">
		<input class=cssButton type=button value="领取方式变更" onclick="modifyClick();">
	</div>
</div>
