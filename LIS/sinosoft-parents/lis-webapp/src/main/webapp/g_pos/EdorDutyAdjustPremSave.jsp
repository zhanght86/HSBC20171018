<%
/***************************************************************
* <p>ProName：EdorDutyAdjustPremSave.jsp</p>
	...
	if (tGI==null) {
		...
		try {
			...
			for (int i = 0; i < tUWAdjustNum.length; i++){
				...
				tLCDutyUWAdjustSchema.setBussType("PG");
				tLCDutyUWAdjustSchema.setBussNo(tEdorNo);
		...
		if (!tBusinessDelegate.submitData(tVData, tOperate, "EdorDutyUWAdjustUI")) {
