...
<%
	...
	if (tGI==null) {
		...
		try {
			...
			String tPosition = request.getParameter("Position");
			String tPositionName = request.getParameter("PositionName");
			...
			if ("UPDATE".equals(tOperate)) {
				...
				for (int index=0;index<tChk.length;index++) {
					...
					if(tChk[index].equals("1")){
						...
						mLBPOEdorInsuredListSchema.setPosition(tPosition);
						mLBPOEdorInsuredListSchema.setPositionName(tPositionName);
			...
			if (!tBusinessDelegate.submitData(tVData, tOperate, "EdorVRUI")) {
