<%
/***************************************************************
 * <p>ProName：EdorInputQueryInput.jsp</p>
 * <p>Title：保全录入</p>
...
<head >
	...
	<script src="./EdorInputQueryInput.js"></script>
	<%@include file="./EdorInputQueryInit.jsp"%>
</head>
...
<form name=fm id=fm method=post action="" target=fraSubmit>
	...
	<div id="divQuery" class=maxbox1 style="display: ''">
		<table class=common>
			...
			<tr class=common>
				...
				<td class=input><input class=codeno name=AcceptOperator readonly style="background:url(../common/images/select--bg_03.png) no-repeat right center"
	...
	<div id="divPersonalGrid" style="display: ''">
		...
		<input class=cssButton type=button value="保全录入" onclick="GotoDetail();">
