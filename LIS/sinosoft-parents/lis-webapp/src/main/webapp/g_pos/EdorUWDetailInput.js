...
function gotoReins(){
	...
	window.open("../reinsure/RIFaculDealMain.jsp?EdorNo="+tEdorNo+"&GrpPropNo="+tGrpContNo+"&Flag=PG","再保处理",'width=1600,height=620,top=0,left=0,toolbar=0,location=0,directories=0,menubar=0,scrollbars=1,resizable=1,status=0');
}
...
function insuredQuery(){
	...
	var tGrpContNo = fm.HidGrpContNo.value;
	window.open("./EdorUWInsuredQueryMain.jsp?GrpPropNo="+tGrpContNo+"&EdorNo="+tEdorNo+"&EdorAppNo="+tEdorAppNo,"人员清单查询",'width=1600,height=620,top=0,left=0,toolbar=0,location=0,directories=0,menubar=0,scrollbars=1,resizable=1,status=0');
}
 ...
 */
 function insuredStatistic(){
 	...
 	window.open("./EdorUWPersonQueryMain.jsp?GrpPropNo="+tGrpPropNo+"&EdorNo="+tEdorNo+"&EdorAppNo="+tEdorAppNo,"查询分部清单",'width=950,height=520,top=0,left=0,toolbar=0,location=0,directories=0,menubar=0,scrollbars=1,resizable=1,status=0');
 }
...
function showPlanQuery(){
	...
	window.open("../g_app/LCContPlanQueryMain.jsp?PolicyNo="+fm.HidGrpContNo.value ,"方案查询",'width=1366,height=768,top=0,left=0,toolbar=0,location=0,directories=0,menubar=0,scrollbars=1,resizable=1,status=0');
}
 ...
 */
 function goToGErr(){
 	...
 	var tGrpPropNo = fm.HidGrpContNo.value;
 	window.open("./EdorUWGErrMain.jsp?GrpPropNo="+tGrpPropNo+"&EdorAppNo="+tEdorAppNo+"&EdorNo="+tEdorNo,"保全核保处理",'width=1600,height=620,top=0,left=0,toolbar=0,location=0,directories=0,menubar=0,scrollbars=1,resizable=1,status=0');
 }
