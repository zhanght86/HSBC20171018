/***************************************************************
 * <p>ProName：EdorInputDetailInput.js</p>
 * <p>Title：保全录入</p>
...
function queryEdorAppInfo() {
	...
	tSQLInfo.setResourceName("g_pos.EdorInputSql");
	tSQLInfo.setSqlId("EdorInputSql1");
...
function queryEdorTypeInfo() {
	...
	tSQLInfo = new SqlClass();
	tSQLInfo.setResourceName("g_pos.EdorInputSql");
	tSQLInfo.setSqlId("EdorInputSql2");
	tSQLInfo.addSubPara(tEdorAppNo);
...
function confirmClick() {
	...
	fm.action = "./EdorInputDetailSave.jsp?Operate="+ mOperate+"&EdorNo="+tEdorNo+"&EdorAppNo="+tEdorAppNo+"&GrpContNo="+tGrpContNo+"&MissionID="+tMissionID+"&SubMissionID="+tSubMissionID+"&ActivityID="+tActivityID;
	submitForm(fm);
}
