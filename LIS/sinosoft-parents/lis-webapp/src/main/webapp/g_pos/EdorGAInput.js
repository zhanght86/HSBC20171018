...
function queryOldClick(){
	...
	tSQLInfo.setResourceName("g_pos.EdorGASql");
	tSQLInfo.setSqlId("EdorGASql1");
...
function transClick(){
	...
	if (fm.AnnuityGetMode.value=="") {
		alert("领取方式不能为空！");
		return false;
	}
	
	mOperate="UPDATE";
	fm.action = "./EdorGASave.jsp?Operate="+ mOperate+"&EdorType="+tEdorType+"&EdorAppNo="+tEdorAppNo+"&GrpContNo="+tGrpContNo+"&MissionID="+tMissionID+"&SubMissionID="+tSubMissionID+"&ActivityID="+tActivityID;
	submitFunc();
}
