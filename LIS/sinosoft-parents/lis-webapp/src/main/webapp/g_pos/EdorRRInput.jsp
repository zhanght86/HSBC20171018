...
<form name=fm method=post action="EdorRRSave.jsp" target=fraSubmit>
	...
	<table>
		<tr>
			...
			<td class=titleImg>实名化被保险人信息</td>
		</tr>
	</table>
			...
			<table class=common>
				...
				<tr class=common>
					...
					<td class=input colspan=5>
						...
						<input class=codeno name=CityName style="width:80px" readonly style="background:url(../common/images/select--bg_03.png) no-repeat right center" ondblclick="return returnShowCodeList('city',[this, CityCode],[1,0]);" onkeyup="return returnShowCodeLisKey('city',[this, CityCode],[1,0]);"><input type=hidden name=CityCode readonly>市
						...
						<input class="wid common" name=DetailAddress verify="单位详细地址|len<100" maxlength=100 style="width:300px">
					</td>
				</tr>
			</table>
		...
		<div id="divQuerySPE" class=maxbox1 style="display: ''">
			<table class=common>
				...
				<tr class=common>
					...
					<td class=input><input class="wid common" id=Seniority name=Seniority verify="工龄|int"  ></td>
				</tr>
				<tr class=common>	
					<td class=title>月薪（元）</td>
					<td class=input><input class="wid common" id=Salary name=Salary  verify="月薪|VALUE>=0&LEN<10"></td>
					<td class=title></td>
					<td class=input></td>
					<td class=title></td>
					<td class=input></td>
