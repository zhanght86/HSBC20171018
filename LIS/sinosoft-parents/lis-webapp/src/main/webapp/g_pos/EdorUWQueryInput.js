/***************************************************************
 * <p>ProName：EdorUWQueryInput.js</p>
 * <p>Title：保全核保</p>
...
function queryClick(QueryFlag) {
	...
	tSQLInfo.setSqlId("EdorProcessSql7");
...
function PersonalQuery() {
	...
	tSQLInfo = new SqlClass();
	tSQLInfo.setResourceName("g_pos.EdorProcessSql");
	tSQLInfo.setSqlId("EdorProcessSql8");
...
function GotoDetail() {
	...
	location.href = "./EdorUWDetailInput.jsp?MissionID="+ tMissionID +"&SubMissionID="+ tSubMissionID +"&ActivityID="+ tActivityID +"&EdorAppNo="+ tEdorAppNo +"&EdorNo="+ tEdorNo;
}
