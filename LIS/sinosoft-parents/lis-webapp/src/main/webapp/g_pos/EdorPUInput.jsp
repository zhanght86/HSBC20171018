...
<head>
	...
	<script src="./EdorPUInput.js"></script>
	<%@include file="./EdorPUInit.jsp"%>
</head>
...
<div id="divQueryOld" style="display: none">
	...
	<div id="divModifyButton" style="display: none">
		<input class=cssButton type=button value="减额交清" onclick="modifyClick();">
	</div>
</div>
