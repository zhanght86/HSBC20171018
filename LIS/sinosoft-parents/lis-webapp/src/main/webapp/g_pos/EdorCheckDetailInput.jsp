<%
/***************************************************************
 * <p>ProName：EdorCheckDetailInput.jsp</p>
 * <p>Title：保全复核</p>
...
<head >
	...
	<script src="./EdorCheckDetailInput.js"></script>
	<script src="./EdorCommonInput.js"></script>
	<%@include file="./EdorCheckDetailInit.jsp"%>
</head>
...
<form name=fm id=fm method=post action="" target=fraSubmit>
	...
	<div id="divEdorTypeGrid" style="display: ''">
		...
		<input class=cssButton type=button id=QueryButton name=QueryButton style= "display: 'none'" value="保单既往保全查询" onclick="showOldEdor(); ">
		<input class=cssButton type=button id=returnButton name=returnButton style= "display: 'none'" value="关  闭" onclick="returnC();">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<br>
	<div id= "divButton" style= "display: ''">	
		<input class=cssButton type=button value="复核完毕" onclick="confirmClick();">
