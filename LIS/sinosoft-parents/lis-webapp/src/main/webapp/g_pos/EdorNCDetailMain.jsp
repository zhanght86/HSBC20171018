<%
/***************************************************************
 * <p>ProName：EdorNCDetailMain.jsp</p>
 * <p>Title：方案明细维护</p>
 * <p>Description：方案明细维护</p>
...
<%
	...
	String tSrc = "";
	tSrc = "./EdorNCDetailInput.jsp";
	tSrc += "?PolicyNo="+ tPolicyNo+ "&EdorNo="+ tEdorNo + "&EdorType="+ tEdorType + "&ContPlanType="+ tContPlanType + "&MissionID="+tMissionID+"&ActivityID="+tActivityID+"&SubMissionID="+tSubMissionID +"&QueryFlag="+tQueryFlag;
%>
</head>
