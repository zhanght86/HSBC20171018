<%
/***************************************************************
 * <p>ProName：EdorUWQueryInput.jsp</p>
 * <p>Title：保全核保</p>
...
<head >
	...
	<script src="./EdorUWQueryInput.js"></script>
...
<form name=fm id=fm method=post action="" target=fraSubmit>
		...
		<table class=common>
			...
			<tr class=common>
				...
				<td class=input><input class=codeno name=CheckOperator id=CheckOperator readonly  style="background:url(../common/images/select--bg_03.png) no-repeat right center"
					...
					onkeyup="return showCodeListKey('usercode',[this, CheckOperatorName],[0, 1],null,null,null,'1',180);"><input class=codename name=CheckOperatorName readonly></td>
				<td class=title>复核起期</td>
	...
	<div id="divPersonalGrid" style="display: ''">
		...
		<input class=cssButton type=button value="保全核保" onclick="GotoDetail();">
