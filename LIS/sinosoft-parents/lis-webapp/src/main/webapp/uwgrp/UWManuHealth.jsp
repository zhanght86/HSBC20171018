...
<body  onload="initForm('<%=tContNo%>','<%=tMissionID%>','<%=tSubMissionID%>','<%=tPrtNo%>','<%=tFlag%>');" >
  <form method=post name=fm target="fraSubmit" action= "./UWManuHealthChk.jsp">
    ...
    <table  class= common align=center>
        ...
        <TR  class= common>
          ...
          <TD  class= input>
              <Input class="codeno" name=PEReason ondblclick="showCodeList('pereason',[this,PEReasonName],[0,1]);" onkeyup="showCodeListKeyEx('pereason',[this,PEReasonName],[0,1]);"><input class="codename" name="PEReasonName" readonly="readonly">
          </TD>
        </TR>
