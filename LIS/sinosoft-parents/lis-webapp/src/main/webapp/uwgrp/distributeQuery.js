...
function easyQueryClick(cGrpContNo){
	...
	strSQL = "select grppolno,grpcontno,riskcode,0,0,'',0 from lcgrppol  where grpcontno='"+cGrpContNo+"' and DistriRate=0 and FeeRate=0 union select grppolno,grpcontno,riskcode,distrirate,feerate,managecom,fee from DistriControl where grpcontno='"+cGrpContNo+"'";
	//alert(strSQL);
	turnPage.strQueryResult  = easyQueryVer3(strSQL, 1, 0, 1);  
