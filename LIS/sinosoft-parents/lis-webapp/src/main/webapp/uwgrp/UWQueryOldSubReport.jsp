...
<body  onload="initForm();" >
  <form method=post name=fm target="fraSubmit" action="./UWQuerySubReportSave.jsp">  
    <table>
    	<tr>
        	<td class=common>
  ...
  <table width="80%" height="20%" class= common>
    <TR  class= common> 
      <TD width="100%" height="15%"  class= title> 核保员分析报告内容 </TD>
    </TR>
    <TR  class= common>
