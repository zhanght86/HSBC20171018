...
try
{
  	if (flag == true)
  	{
		...
		if (tUWSendPrintUI.submitData(tVData,"INSERT") == false)
		{
			int n = tUWSendPrintUI.mErrors.getErrorCount();
			for (int i = 0; i < n; i++)
			Content = " 操作失败,原因是: " + tUWSendPrintUI.mErrors.getError(0).errorMessage;
			FlagStr = "Fail";
		}
		//如果在Catch中发现异常，则不从错误类中提取错误信息
		if (FlagStr == "Fail")
		{
		    tError = tUWSendPrintUI.mErrors;		    
