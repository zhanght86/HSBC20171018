...
try
{
  	if (flag == true)
  	{
		...
		if (tGrpUWAutoHealthUI.submitData(tVData,"INSERT") == false)
		{
			int n = tGrpUWAutoHealthUI.mErrors.getErrorCount();
			for (int i = 0; i < n; i++)
			Content = " 发集体体检通知书失败，原因是: " + tGrpUWAutoHealthUI.mErrors.getError(0).errorMessage;
			FlagStr = "Fail";
		}
		//如果在Catch中发现异常，则不从错误类中提取错误信息
		if (FlagStr == "Fail")
		{
		    tError = tGrpUWAutoHealthUI.mErrors;
