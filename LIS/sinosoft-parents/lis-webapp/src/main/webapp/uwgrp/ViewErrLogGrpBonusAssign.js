...
mySql831100643.setResourceName("uwgrp.ViewErrLogGrpBonusAssignSql");//指定使用的properties文件名
mySql831100643.setSqlId(sqlid831100643);//指定使用的Sql的id
mySql831100643.addSubPara(fm.GrpPolNo.value);//指定传入的参数
mySql831100643.addSubPara(fm.Type.value);//指定传入的参数
mySql831100643.addSubPara(fm.FiscalYear.value);//指定传入的参数
mySql831100643.addSubPara(fm.MakeDate.value);//指定传入的参数
