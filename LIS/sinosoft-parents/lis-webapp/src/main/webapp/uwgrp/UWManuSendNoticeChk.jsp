...
try
{
   ...
   BusinessDelegate tBusinessDelegate=BusinessDelegate.getBusinessDelegate();
		...
		if (!tBusinessDelegate.submitData(tVData,"0000001105",busiName)) //执行保全核保生调工作流节点0000000004
		{
			int n = tBusinessDelegate.getCErrors().getErrorCount();
			Content = " 新契约人工核发送核保通知书失败，原因是: " + tBusinessDelegate.getCErrors().getError(0).errorMessage;
			FlagStr = "Fail";
		}
