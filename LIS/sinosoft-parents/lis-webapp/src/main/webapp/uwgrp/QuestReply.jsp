...
<body  onload="initForm('<%=tContNo%>','<%=tFlag%>','<%=tQuest%>');" >
  <form method=post name=fm target="fraSubmit" action= "./QuestReplyChk.jsp">
    <table>
    	<TR  class= common>
          <TD  class= title>
            保单号码
  ...
  <table width="121%" height="37%">
    ...
    <TR  class= common>
      <TD height="87%"  class= title><textarea name="ReplyResult" cols="135" rows="10" class="common"></textarea></TD>
    </TR>
  </table>
  <p> 
    <!--读取信息-->
