...
<%
  ...
  loggerDebug("UWAppFamilyInit","ContNo:"+tContNo);
%>                            
...
function initFamilyGrid()
  {                               
    var iArray = new Array();
      ...
      FamilyGrid = new MulLineEnter( "fm" , "FamilyGrid" ); 
      //这些属性必须在loadMulLine前
      FamilyGrid.mulLineCount = 10;   
      FamilyGrid.displayTitle = 1;
      FamilyGrid.locked = 1;
      FamilyGrid.canSel = 1;
      FamilyGrid.loadMulLine(iArray);
      
      FamilyGrid. selBoxEventFuncName = "easyQueryClick";
      
      //这些操作必须在loadMulLine后面
      //FamilyGrid.setRowColData(1,1,"asdf");
      }
      catch(ex)
      {
        alert(ex);
