...
<%
//程序名称：PDTestPointClewQuerySave.jsp
//程序功能：测试要点提示查询界面
//创建日期：2009-3-18
//创建人  ：
...
<%
 ...
 PDTestPointClewQueryBL pDTestPointClewQueryBL = new PDTestPointClewQueryBL();
...
transferData.setNameAndValue("tableName",request.getParameter("tableName"));
 try
 {
  ...
  pDTestPointClewQueryBL.submitData(tVData,operator);
 }
 catch(Exception ex)
 {
 ...
 if (FlagStr=="")
 {
  tError = pDTestPointClewQueryBL.mErrors;
