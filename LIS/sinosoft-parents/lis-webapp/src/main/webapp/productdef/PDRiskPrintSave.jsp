...
<%
 ...
 PDRiskPrintBL pDRiskPrintBL = new PDRiskPrintBL();
...
try
 {
  ...
  pDRiskPrintBL.submitData(tVData,operator);
  
  new RiskState().setState(request.getParameter("RiskCode"), ""+"契约业务控制"+"->"+"条款打印定义"+"", "1");
 }
 catch(Exception ex)
 {
