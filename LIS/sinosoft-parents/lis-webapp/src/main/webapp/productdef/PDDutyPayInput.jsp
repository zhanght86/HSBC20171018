...
<TABLE  class="common" >
<tr class="common">
<td class="title">产品险种编码</td><td class="input"><input class="readonly" name="RiskCode" readonly="readonly" ></td>
<td class="title">缴费责任代码</td><td class="input"><input class="readonly" name="PayPlanCode" readonly="readonly"  ></td>  
</tr>
</TABLE>
<table>
  <tr>
    <td class="titleImg" >责任缴费属性定义: </td>
  </tr>
   <tr  class= common>
...
<input value="算法定义" type=button  onclick="button122( )" class="cssButton" type="button" >
<br><br>
