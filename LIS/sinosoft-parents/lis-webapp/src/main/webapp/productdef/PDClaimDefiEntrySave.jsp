...
<%
 ...
 PDClaimDefiEntryBL pDClaimDefiEntryBL = new PDClaimDefiEntryBL();
...
transferData.setNameAndValue("tableName",request.getParameter("tableName"));
 try
 {
  ...
  pDClaimDefiEntryBL.submitData(tVData,operator);
 }
 catch(Exception ex)
 {
 ...
 if (FlagStr=="")
 {
  tError = pDClaimDefiEntryBL.mErrors;
