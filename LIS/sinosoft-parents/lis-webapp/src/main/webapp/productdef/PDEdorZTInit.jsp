...
function initForm()
{
	try{
		...
		myAlert("PDEdorZTInit.jsp-->"+"InitForm函数中发生异常:初始化界面错误!");
	}
}
...
function initMulline10Grid()
{
	...
	try{
		...
		iArray[3]=new Array();
		iArray[3][0]="期交是否允许通融退保";
		iArray[3][1]="150px";
		iArray[3][2]=100;
		iArray[3][3]=0;

		iArray[4]=new Array();
		iArray[4][0]="期交退保控制范围类型";
		iArray[4][1]="150px";
		iArray[4][2]=100;
		iArray[4][3]=0;

		iArray[5]=new Array();
		iArray[5][0]="趸交是否允许通融退保";
		iArray[5][1]="150px";
		iArray[5][2]=100;
		iArray[5][3]=0;

		iArray[6]=new Array();
		iArray[6][0]="趸交退保控制范围类型";
		iArray[6][1]="150px";
		iArray[6][2]=100;
		iArray[6][3]=0;
