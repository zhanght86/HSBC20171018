...
<head>
 ...
 <SCRIPT src="PDClaimCtrlFee.js"></SCRIPT>
 <%@include file="PDClaimCtrlFeeInit.jsp"%>
<LINK href="../common/css/Project3.css" rel=stylesheet type=text/css><SCRIPT src="../common/laydate/laydate.js"></SCRIPT></head>
<body  onload="initForm();initElementtype();">
<form action="./PDClaimCtrlFeeSave.jsp" method=post name=fm target="fraSubmit">

险种编码
<input class="readonly" name="RiskCode" readonly="readonly" ><BR>
<table>
  <tr>
    <td class="titleImg" >已有赔付控制费用</td>
  </tr>
</table>
<table  class= common>
   <tr  class= common>
...
<input type=hidden name="tableName" value="PD_LMClaimCtrlFee">
