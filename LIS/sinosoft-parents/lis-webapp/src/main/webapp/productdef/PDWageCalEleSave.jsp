...
<%
 ...
 PDWageCalEleBL pDWageCalEleBL = new PDWageCalEleBL();
...
transferData.setNameAndValue("tableName",request.getParameter("tableName"));
 try
 {
  ...
  Content = " "+"保存成功!"+" ";
  FlagStr = "Success";
  //pDWageCalEleBL.submitData(tVData,operator);
 }
 catch(Exception ex)
 {
