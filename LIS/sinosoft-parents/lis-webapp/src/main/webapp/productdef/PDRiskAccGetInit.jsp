...
function initForm()
{
	try{
		...
		myAlert("PDRiskAccGetInit.jsp-->"+"InitForm函数中发生异常:初始化界面错误!");
	}
}
function updateDisplayState()
{
 ...
 for(var i = 0; i < rowCount; i++)
 {
     ...
     if(rowcode[i][1]!=null&&(rowcode[i][1]=='pd_getdutycode'||rowcode[i][1]=='pd_riskinsuacc'))
     {
