...
代理机构
						...
						<TD class=input5 STYLE="display:none;">
							<Input class="codeno" name=AgentCom verify="银行机构|code:bankcom"
...
代理机构
					...
					<table>
						<INPUT VALUE="重  置" TYPE="button" class=cssButton 
							onclick="addClick();">
						<INPUT VALUE="新  增" TYPE="button" class=cssButton id=savabutton1
							onclick="saveClick();">
						<INPUT id=savabutton2 VALUE="修  改" TYPE="button" class=cssButton id=savabutton2
							onclick="updateClick();">
						<INPUT id=savabutton3 VALUE="删  除" TYPE="button" class=cssButton id=savabutton3
							onclick="deleteClick();">
					</table>
				</div>
			</div>
