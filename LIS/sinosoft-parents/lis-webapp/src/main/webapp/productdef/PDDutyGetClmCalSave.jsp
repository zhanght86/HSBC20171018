...
<%
 ...
 PDDutyGetClmCalBL pDDutyGetClmCalBL = new PDDutyGetClmCalBL();
...
transferData.setNameAndValue("tableName",request.getParameter("tableName"));
 try
 {
  ...
  pDDutyGetClmCalBL.submitData(tVData,operator);
 }
 catch(Exception ex)
 {
 ...
 if (FlagStr=="")
 {
  tError = pDDutyGetClmCalBL.mErrors;
