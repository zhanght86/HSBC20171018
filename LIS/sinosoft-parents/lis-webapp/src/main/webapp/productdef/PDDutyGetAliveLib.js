...
var showInfo;	
//定义sql配置文件
var tResourceName = "productdef.PDDutyGetAliveLibInputSql";
function returnParent()
{ 
if(Mulline9Grid.getRowColData(fm.all("GetDutyCode2RowOfMulLine").value,4) == "")
{
	myAlert(""+"请选中某个责任给付生存库代码，再点击返回"+"");
	return;
}
...
function query()
{
    ...
    var mySql=new SqlClass();
	  var sqlid = "PDDutyGetAliveLibInputSql1";
    ...
    var sql = mySql.getString();
	  ...
	  var sqlid2 = "PDDutyGetAliveLibInputSql2";
...
function queryRela()
{
	...
	var mySql=new SqlClass();
	var sqlid = "PDDutyGetAliveLibInputSql3";
	mySql.setResourceName(tResourceName); //指定使用的properties文件名
	mySql.setSqlId(sqlid);//指定使用的Sql的id
...
function queryMulline9Grid()
{
   var strSQL = "";
   var mySql=new SqlClass();
	 var sqlid = "PDDutyGetAliveLibInputSql4";
	 mySql.setResourceName(tResourceName); //指定使用的properties文件名
	 mySql.setSqlId(sqlid);//指定使用的Sql的id
