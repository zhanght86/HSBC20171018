...
数据导入
		           ...
		           <INPUT VALUE="全量导入" name="ImportExcel1"  class= cssbutton TYPE=button onclick="fullInputClick();">
		           <INPUT VALUE="增量导入" name="ImportExcel2" class= cssbutton TYPE=button onclick="incrementalClick();">
		    	</TD>
			</TR>
 </Table>
</form>
