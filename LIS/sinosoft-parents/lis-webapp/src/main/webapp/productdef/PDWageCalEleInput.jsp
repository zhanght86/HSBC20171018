...
<head>
 ...
 <SCRIPT src="PDWageCalEle.js"></SCRIPT>
 <%@include file="PDWageCalEleInit.jsp"%>
<LINK href="../common/css/Project3.css" rel=stylesheet type=text/css><SCRIPT src="../common/laydate/laydate.js"></SCRIPT></head>
<body  onload="initForm();initElementtype();">
<form action="./PDWageCalEleSave.jsp" method=post name=fm target="fraSubmit">

险种编码
<input class="readonly" name="RiskCode" readonly="readonly" ><BR>
<table>
  <tr>
    <td class="titleImg" >已有佣金计算描述</td>
  </tr>
</table>
<table  class= common>
   <tr  class= common>
...
<table>
  <tr>
    <td class="titleImg" >佣金计算描述属性定义:</td>
  </tr>
</table>
<table  class= common>
   <tr  class= common>
...
<input type=hidden name="tableName" value="PD_LAWAGECALELEMENT">
</form>
