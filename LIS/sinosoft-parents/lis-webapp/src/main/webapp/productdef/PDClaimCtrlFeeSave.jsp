...
<%
 ...
 PDClaimCtrlFeeBL pDClaimCtrlFeeBL = new PDClaimCtrlFeeBL();
...
transferData.setNameAndValue("tableName",request.getParameter("tableName"));
 try
 {
  ...
  pDClaimCtrlFeeBL.submitData(tVData,operator);
 }
 catch(Exception ex)
 {
 ...
 if (FlagStr=="")
 {
  tError = pDClaimCtrlFeeBL.mErrors;
