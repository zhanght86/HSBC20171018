...
<head>
 ...
 <SCRIPT src="PDRiskPay.js"></SCRIPT>
 <%@include file="PDRiskPayInit.jsp"%>
<LINK href="../common/css/Project3.css" rel=stylesheet type=text/css><SCRIPT src="../common/laydate/laydate.js"></SCRIPT></head>
<body  onload="initForm();initElementtype();">
<form action="./PDRiskPaySave.jsp" method=post name=fm target="fraSubmit">
<table class=common>
	<tr class=common>
...
<!--table>
  <tr>
    <td class="titleImg" >已录入险种缴费属性</td>
  </tr>
</table>
<table  class= common>
   <tr  class= common>
...
<input type=hidden name="tableName" value="PD_LMRiskPay">
