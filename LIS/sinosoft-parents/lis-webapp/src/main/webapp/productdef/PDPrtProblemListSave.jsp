...
<%
  ...
  tTransferData.setNameAndValue("TestType", request.getParameter("TestType"));
  ...
  if(!tPDRiskDefReportListPrtBL.submitData(tVData,"ProblemList"))
  {          
     operFlag = false;
  ...
  {             
	...
	if (operFlag==true)
	{
	  ...
	  outname=""+"产品测试问题件统计"+""+tG.Operator+date+time+".xls";
