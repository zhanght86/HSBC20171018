...
function initForm()
{
	try{	
		...
		myAlert("PDDutyPayLibInit.jsp-->"+"初始化界面错误!");
	}
}
...
function updateDisplayState()
{
 ...
 for(var i = 0; i < rowCount; i++)
 {
    Mulline9Grid.setRowColDataCustomize(i,4,null,null,rowcode[i][1]);
 	...
 	if(Mulline9Grid.getRowColData(i,2) == "PAYPLANCODE2")
	{
	    fm.all("PayPlanCode2RowOfMulLine").value = i;
...
function updateDisplayState2(obj,objTarget)
{
 ...
 if(dic == null || dic("PAYPLANCODE2") != obj.getRowColData(selNo - 1, 1))
 {
 	var arr = new Array();
 	arr[0] = new Array();
