...
function initForm()
{
	try{
		...
		myAlert("PDLMDutyInit.jsp-->"+"初始化界面错误!");
	}
}
	function updateDisplayState()
{
 ...
 for(var i = 0; i < rowCount; i++)
 {
   if(Mulline9Grid.getRowColData(i,2) == "DUTYCODE")
	 ...
	 {
	 	 var tDefaultValueSQL = "select "+Mulline9Grid.getRowColData(i,2)+" from "+fm.all("tableName").value+" where dutycode = '"+fm.DutyCode.value +"'"
	 	 						+ " and " + Mulline9Grid.getRowColData(i,2) + " is not null ";
