...
<%
 ...
 PDCalFactorQueryBL pDCalFactorQueryBL = new PDCalFactorQueryBL();
...
transferData.setNameAndValue("tableName",request.getParameter("tableName"));
 try
 {
  ...
  pDCalFactorQueryBL.submitData(tVData,operator);
 }
 catch(Exception ex)
 {
 ...
 if (FlagStr=="")
 {
  tError = pDCalFactorQueryBL.mErrors;
