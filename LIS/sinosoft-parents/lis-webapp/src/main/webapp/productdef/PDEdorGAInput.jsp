...
<head>
 ...
 <SCRIPT src="PDEdorGA.js"></SCRIPT>
 <%@include file="PDEdorGAInit.jsp"%>
<LINK href="../common/css/Project3.css" rel=stylesheet type=text/css><SCRIPT src="../common/laydate/laydate.js"></SCRIPT></head>
<body  onload="initForm();initElementtype();">
<form action="./PDEdorGASave.jsp" method=post name=fm target="fraSubmit">
...
<input value="算法定义" type=button  onclick="button302( )" class="cssButton" type="button" >
<br><br>
<input value="返回" type=button  onClick="retBack()" class="cssButton" >
<br><br>

<input type=hidden name="operator">
<input type=hidden name="tableName" value="PD_LMEdorGA">
