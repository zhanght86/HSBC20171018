...
function initForm()
{
	try{
		...
		myAlert("PDDutyGetClmLibInit.jsp-->"+"初始化界面错误!");
	}
}
...
function initButtonDisplay()
{
	...
	else 
	{
		try
		{
			if(top.opener.location.href != null && top.opener.location.href.indexOf("PDDutyGetClmInput") > -1)
			{
