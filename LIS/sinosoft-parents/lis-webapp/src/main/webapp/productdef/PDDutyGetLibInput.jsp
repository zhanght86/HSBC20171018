...
<table>
  <tr>
    <td class="titleImg" >给付责任库查询条件：</td>
  </tr>
</table>
<table class=common>
	<tr class=common>
		<td class=title5>给付库责任代码</td>
		<td class=input5>
			<input name="GetDutyCode2" class=common>
		</td>
		<td class=title5>给付库责任名称</td>
		<td class=input5>
			<input name="GetDutyName" class=common>
		</td>	
		<td class=title5>给付类型</td>
		<td class=input5>
...
<table>
  <tr>
    <td class="titleImg" >给付责任库查询结果：</td>
  </tr>
</table>
<table  class= common>
   <tr  class= common>
...
<table>
  <tr>
    <td class="titleImg" >责任给付属性定义:</TD><td width=500></td><TD><input value="保存" type=button name=btnSave onclick="save()" class="cssButton" type="button" ><input value="修改" type=button name=btnEdit onclick="update()" class="cssButton" type="button" ><input value="删除" type=button name=btnDele onclick="del()" class="cssButton" type="button" ></td>
  </tr>
</table>
<table  class= common>
   <tr  class= common>
