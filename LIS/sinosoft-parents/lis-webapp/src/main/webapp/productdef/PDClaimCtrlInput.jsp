...
<head>
 ...
 <SCRIPT src="PDClaimCtrl.js"></SCRIPT>
 <%@include file="PDClaimCtrlInit.jsp"%>
<LINK href="../common/css/Project3.css" rel=stylesheet type=text/css><SCRIPT src="../common/laydate/laydate.js"></SCRIPT></head>
<body  onload="initForm();initElementtype();">
<form action="./PDClaimCtrlSave.jsp" method=post name=fm target="fraSubmit">
...
<input type=hidden name="tableName" value="PD_LMClaimCtrl">
