...
function initForm()
{
	try{
		...
		myAlert("PDLoanInit.jsp-->"+"InitForm函数中发生异常:初始化界面错误!");
	}
}
...
function initPara(){
 ...
 fm.all("RiskName").value = result[0][0]; 
   sql = "select edorname from lmedoritem where edorcode='"+fm.all("EdorType").value+"' and appobj='I' ";
