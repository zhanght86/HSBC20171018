...
<%
 ...
 PDBaseFieldQueryBL pDBaseFieldQueryBL = new PDBaseFieldQueryBL();
...
transferData.setNameAndValue("tableName",request.getParameter("tableName"));
 try
 {
  ...
  pDBaseFieldQueryBL.submitData(tVData,operator);
 }
 catch(Exception ex)
 {
 ...
 if (FlagStr=="")
 {
  tError = pDBaseFieldQueryBL.mErrors;
