...
<html>
	...
	<head>
		...
		<SCRIPT src="PDSugTabHeadType.js"></SCRIPT>
		<script src="../common/javascript/jquery.js"></script>
		<script src="../common/javascript/jquery.easyui.min.js"></script>
		<%@include file="PDSugTabHeadTypeInit.jsp"%>

	<LINK href="../common/css/Project3.css" rel=stylesheet type=text/css><SCRIPT src="../common/laydate/laydate.js"></SCRIPT></head>
	<body onload="initForm();initElementtype();">
		<form action="./PDSugTabHeadTypeSave.jsp" method=post name=fm target="fraSubmit">
			<table>
				<tr>
					<td class="titleImg">
表头类型管理:
...
类型：
					...
					<td class=input5>
						<input class="common" name=TITTLE verify="类型|NOTNUlL&LEN<=40" elementtype="nacessary">
					</td>
					<td class=title5>
备注信息：
					</td>
