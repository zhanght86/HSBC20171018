...
<head>
 ...
 <SCRIPT src="PD_LMDutyGetClmCal.js"></SCRIPT>
 <%@include file="PD_LMDutyGetClmCalInit.jsp"%>
...
<input value="修改" type=button  onclick="update()" class="cssButton" type="button" ></div>
<br>
<table>
  <tr>
    <td class="titleImg" >扩充计算公式定义：</td>
  </tr>
</table>
<table  class= common>
   <tr  class= common>
...
<input value="进入算法定义" type=button  onclick="button268( )" class="cssButton" type="button" >
<br><br>
