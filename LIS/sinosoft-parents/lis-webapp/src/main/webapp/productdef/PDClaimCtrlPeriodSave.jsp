...
<%
//程序名称：PDClaimCtrlPeriodSave.jsp
//程序功能：赔付控制时期
//创建日期：2009-3-16
//创建人  ：
...
<%
 ...
 PDClaimCtrlPeriodBL pDClaimCtrlPeriodBL = new PDClaimCtrlPeriodBL();
...
transferData.setNameAndValue("tableName",request.getParameter("tableName"));
 try
 {
  ...
  pDClaimCtrlPeriodBL.submitData(tVData,operator);
 }
 catch(Exception ex)
 {
 ...
 if (FlagStr=="")
 {
  tError = pDClaimCtrlPeriodBL.mErrors;
