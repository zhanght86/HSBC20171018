...
<%
 ...
 //PDRiskParamsDefBL pDRiskParamsDefBL = new PDRiskParamsDefBL();
...
transferData.setNameAndValue("RiskCode",request.getParameter("RiskCode"));
 ...
 try
 {
  ...
  //pDRiskParamsDefBL.submitData(tVData,operator);
String busiName="PDRiskParamsDefBL";
 ...
 if (FlagStr=="")
 {
  tError = pDRiskParamsDefBL.mErrors;
  if (!tError.needDealError())
  {                          
   Content = " 保存成功! ";
   FlagStr = "Success";
   RiskState.setState(request.getParameter("RiskCode"),"契约业务控制->缴费字段控制","1");
