...
<%
//程序名称：PDAlgoTempLibQuerySave.jsp
//程序功能：算法模板库查询界面
//创建日期：2009-3-18
//创建人  ：
...
<%
 ...
 PDAlgoTempLibQueryBL pDAlgoTempLibQueryBL = new PDAlgoTempLibQueryBL();
...
transferData.setNameAndValue("tableName",request.getParameter("tableName"));
 try
 {
  ...
  pDAlgoTempLibQueryBL.submitData(tVData,operator);
 }
 catch(Exception ex)
 {
 ...
 if (FlagStr=="")
 {
  tError = pDAlgoTempLibQueryBL.mErrors;
