...
<SCRIPT src="GrpSumInfoQuery.js"></SCRIPT>
<%@include file="GrpSumInfoQueryInit.jsp"%>
</head>
<body onload="initForm()">
<form action="" method=post name=fm id=fm target="fraTitle">
<table class=common border=0 width=100%>
	<tr>
    <td class="common"><IMG  src= "../common/images/butExpand.gif" style= "cursor:hand;" OnClick= "showPage(this,english);"></td>
		<td class=titleImg align=center>&nbsp;请输入查询条件：</td>
	</tr>
</table>
<Div  id= "english" style= "display: ''" class="maxbox1">
<table class=common>
	<tr class=common>
...
<!--<INPUT VALUE="查询出单统计表" class="cssButton" TYPE="button" name="query"
	onclick="easyQuery();">-->
    <a href="javascript:void(0);" class="button" name="query" onClick="easyQuery();">查询出单统计表</a>
<table>
	<tr>
		<td class=common><IMG src="../common/images/butExpand.gif"
			style="cursor: hand;" OnClick="showPage(this,divInvoice);"></td>
		<td class=titleImg>出单统计表</td>
	</tr>
</table>
<Div id="divInvoice" style="display: ''" align=center>
<table class=common>
	<tr class=common>
		<td style="text-align:left" colSpan=1><span id="spanSumInfoGrid"></span>
		</td>
	</tr>
</table>
