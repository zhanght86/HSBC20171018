...
<%
	//程序名称：GrpPlanInfoQueryInput.jsp
	//程序功能：套餐业务统计表
	//创建日期：20090318
	//创建人  ：袁亦方
...
<table class=common>
    ...
    <TD class=title5>截止日期<font color=red> *</font></TD>
		...
		<td class="input5"><Input style="background:url(../common/images/select--bg_03.png) no-repeat right center" class=codeno name=ContPlanCode id=ContPlanCode
			verify="套餐计划编码|notnull&code:ContPlanCode"
...
<!--<INPUT VALUE="查询套餐业务统计表" class="cssButton" TYPE="button" name="query"
	onclick="easyQuery();">-->
    <a href="javascript:void(0);" class="button" name="query" onClick="easyQuery();">查询套餐业务统计表</a>
<table>
	<tr>
		<td class=common><IMG src="../common/images/butExpand.gif"
			style="cursor: hand;" OnClick="showPage(this,divInvoice);"></td>
		<td class=titleImg>套餐业务统计表</td>
	</tr>
</table>
