...
<html>
<%
//程序名称：VersionRuleQueryForOther.jsp
//程序功能：版本信息查询页面
//创建日期：2008-08-11
//创建人  ：ZhongYan
...
<body onload="initForm();initElementtype();">
  ...
  <table  class= common>
		...
		<tr class= common>
				 ...
				 <TD class=input5>
				 	 <Input style="background:url(../common/images/select--bg_03.png) no-repeat right center" class="codeno" name= VersionState id= VersionState verify="版本状态|notnull" CodeData="0|^01|正常^02|维护^03|删除" onMouseDown="return showCodeListEx('VersionState',[this,VersionStateName],[0,1],null,null,null,[1]);"  ondblclick="return showCodeListEx('VersionState',[this,VersionStateName],[0,1],null,null,null,[1]);" onkeyup="return showCodeListKeyEx('VersionState',[this,VersionStateName],[0,1],null,null,null,[1]);"  ><input class=codename name=VersionStateName id=VersionStateName readonly=true></TD>  
				</TD>
		</tr>
