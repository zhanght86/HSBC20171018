...
function initInpBox()
{
  ...
  {
    alert("FIRuleDealLogQueryForDownLoadinit.jsp-->InitInpBox函数中发生异常:初始化界面错误!");
  }      
}
...
function initSelBox()
{
  ...
  {
    alert("FIRuleDealLogQueryForDownLoadinit.jsp-->InitSelBox函数中发生异常:初始化界面错误!");
  }
}
...
function initForm()
{
  ...
  {
    alert("FIRuleDealLogQueryForDownLoadinit.jsp-->InitForm函数中发生异常:初始化界面错误!");
  }
}
...
{                                  
	...
	try
	{
      ...
      FIRuleDealLogQueryForDownLoadGrid.detailInfo="单击显示详细信息";
