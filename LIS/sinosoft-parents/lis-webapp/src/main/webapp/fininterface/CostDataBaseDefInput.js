		...
		strSQL = strSQL + " VersionNo ='"+VersionNo+"' and AcquisitionID ='"+AcquisitionID+"' order by DataBaseOrder ASC ";
  		*/
  		var mySql1=new SqlClass();
			mySql1.setResourceName("fininterface.CostDataBaseDefInputSql"); //指定使用的properties文件名
			mySql1.setSqlId("CostDataBaseDefInputSql1");//指定使用的Sql的id
...
function getQueryResult()
{
	 ...
	 */
	 	var mySql2=new SqlClass();
			mySql2.setResourceName("fininterface.CostDataBaseDefInputSql"); //指定使用的properties文件名
			mySql2.setSqlId("CostDataBaseDefInputSql2");//指定使用的Sql的id
			mySql2.addSubPara(CostDataBaseDefInputGrid.getRowColData(tRow-1,1));//指定传入的参数
			mySql2.addSubPara(CostDataBaseDefInputGrid.getRowColData(tRow-1,2));//指定传入的参数
			mySql2.addSubPara(CostDataBaseDefInputGrid.getRowColData(tRow-1,3));//指定传入的参数
  	...
  	*/
  	//alert(strSQL);
  		var mySql3=new SqlClass();
			mySql3.setResourceName("fininterface.CostDataBaseDefInputSql"); //指定使用的properties文件名
			mySql3.setSqlId("CostDataBaseDefInputSql3");//指定使用的Sql的id
