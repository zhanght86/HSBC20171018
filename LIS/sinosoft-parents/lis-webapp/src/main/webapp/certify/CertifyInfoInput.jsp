...
<table class="common">
	<tr class="common">
		...
		<td class=input5><Input style="background:url(../common/images/select--bg_03.png) no-repeat right center" class="codeno" name=StateFlag id=StateFlag
			CodeData="0|^1|待入库^2|已入库^3|已发放未核销^4|自动缴销^5|手工缴销^6|使用作废^7|停用作废^8|逾期^9|挂失^10|遗失^11|销毁^12|已缴销^13|已作废^14|已核销"
...
<input value="单证状态查询" type="button" onclick="certifyQuery()" class="cssButton">
<input value=" 打    印 " type="button" onclick="certifyPrint()" class="cssButton">-->
