...
<%
	//程序名称：CardNotTakeBackInfoInput.jsp
	//程序功能：有价单证未核销清单
	//创建日期： 2009-02-18
	//创建人  ： mw
...
<script src="./CardNotTakeBackInfoInput.js"></script>
<%@include file="CardNotTakeBackInfoInit.jsp"%>
</head>
...
<table class="common">
	...
	<tr class="common">
		...
		<TD class=input5><Input style="background:url(../common/images/select--bg_03.png) no-repeat right center" class=codeno name=StateFlagN id=StateFlagN
			CodeData="0|^3|已发放未核销 ^8|逾期 ^9|挂失"
			ondblClick="showCodeListEx('StateFlagN',[this,StateFlagNName],[0,1],null,null,null,1);"
            onclick="showCodeListEx('StateFlagN',[this,StateFlagNName],[0,1],null,null,null,1);"
			onkeyup="showCodeListKeyEx('StateFlagN',[this,StateFlagNName],[0,1],null,null,null,1);"><Input
			class=codename name=StateFlagNName id=StateFlagNName readonly=true></TD>
	...
	<tr class="common">
		...
		<td class="input5"><input class="common wid" name=ReceiveCom id=ReceiveCom onblur="getAgentCom()"></td>
	</tr>
	...
	<tr class="common">
		...
		<TD class=input5><Input style="background:url(../common/images/select--bg_03.png) no-repeat right center" class=codeno name=agentCom id=agentCom CodeData=""
			ondblClick="showCodeListEx('agentCom',[this,agentComName],[0,1],null,null,null,1);"
            onclick="showCodeListEx('agentCom',[this,agentComName],[0,1],null,null,null,1);"
			onkeyup="showCodeListKeyEx('agentCom',[this,agentComName],[0,1],null,null,null,1);"><Input
	...
	<tr class="common">
		...
		<td class="input5">
            <Input class="coolDatePicker" onClick="laydate({elem: '#MakeDateB'});" verify="起始日期|NOTNULL" dateFormat="short" name=MakeDateB id="MakeDateB"><span class="icon"><a onClick="laydate({elem: '#MakeDateB'});"><img src="../common/laydate/skins/default/icon.png" /></a></span>
            <font
			color=red>*</font></td>
		<td class="title5">终止日期</td>
		<td class="input5">
            <Input class="coolDatePicker" onClick="laydate({elem: '#MakeDateE'});" verify="终止日期（结束）|NOTNULL" dateFormat="short" name=MakeDateE id="MakeDateE"><span class="icon"><a onClick="laydate({elem: '#MakeDateE'});"><img src="../common/laydate/skins/default/icon.png" /></a></span>
            <font
			color=red>*</font></td>
	</tr>
