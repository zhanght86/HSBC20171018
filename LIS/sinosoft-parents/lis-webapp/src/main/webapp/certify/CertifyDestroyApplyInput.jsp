...
<html>
<%
	//程序名称：CertifyDestroyApplyInput.jsp
	//程序功能：销毁提交
	//创建日期：2009-1-5
	//创建人  ：mw
...
<table class="common">
	<tr class="common">
		...
		<td class="input5"><input class="common wid" name="Handler" id="Handler"
			verify="销毁提交人|NOTNULL"><font color=red>*</font></td>
		<td class="title5">提交日期</td>
		<td class="input5"><Input class="coolDatePicker" onClick="laydate({elem: '#HandleDate'});" verify="提交日期|NOTNULL" dateFormat="short" name=HandleDate id="HandleDate"><span class="icon"><a onClick="laydate({elem: '#HandleDate'});"><img src="../common/laydate/skins/default/icon.png" /></a></span><font
			color=red>*</font></td>
	</tr>
...
<Table class=common>
	<TR>
		<TD class=title5>销毁备注<font color=red>*</font></TD>
		<TD colspan="3"><textarea name="Reason" cols="151%" rows="4"
			witdh=25% class="common" verify="销毁备注|NOTNULL"></textarea></TD>
	</TR>
</table>


<input style="display:none" name="btnOp" class="cssButton" type="button" value="销毁提交"
	onclick="submitForm()">
    <a href="javascript:void(0);" name="btnOp" class="button" onClick="submitForm();">销毁提交</a>
    </form>
