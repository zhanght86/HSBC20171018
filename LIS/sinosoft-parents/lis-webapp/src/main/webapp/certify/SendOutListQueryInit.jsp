...
function initForm()
{
  ...
  {
    alert("SendOutListQueryInit.jsp-->InitForm函数中发生异常:初始化界面错误!");
  }
}
...
{                           						
	...
	try
	{
		...
		iArray[10]=new Array();          	
	    iArray[10][0]="最后一次客户问题件回复时间";				  //列名（第2列）
	    iArray[10][1]="60px";  						//列宽
	    iArray[10][2]=10;        					//列最大值
...
{ 
  ...
  {
    alert("SendOutListQueryInit.jsp-->InitInpBox函数中发生异常:初始化界面错误!");
  }      
}    
