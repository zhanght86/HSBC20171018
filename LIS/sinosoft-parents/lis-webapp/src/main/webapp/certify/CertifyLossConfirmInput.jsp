...
<html>
<%
	//程序名称：CertifyLossConfirmInput.jsp
	//程序功能：遗失确认
	//创建日期：2009-1-5
	//创建人  ：mw
...
<table>
	<tr>
		...
		<td class=titleImg>遗失情况说明</td>
	</tr>
</table>
<div id="divLossInfo" class="maxbox1">
<table class="common">
	<tr class="common">
		<td class="title5">登报日期</td>
		<td class="input5">
            <Input class="coolDatePicker" onClick="laydate({elem: '#PublishDate'});" verify="有效开始日期|DATE" dateFormat="short" name=PublishDate id="PublishDate"><span class="icon"><a onClick="laydate({elem: '#PublishDate'});"><img src="../common/laydate/skins/default/icon.png" /></a></span>
            <font color=red>*</font></td>
		<td class="title5">报纸名称</td>
...
<input class="cssButton" type="button" value="遗失确认" onclick="submitForm()">
