...
<%
	//程序名称：CardBlankOutInfoInput.jsp
	//程序功能：作废清单
	//创建日期： 2009-02-18
	//创建人  ： mw
...
<script src="./CardBlankOutInfoInput.js"></script>
<%@include file="CardBlankOutInfoInit.jsp"%>
</head>
...
<table class="common">
	...
	<tr class="common">
		...
		<TD class=title5>作废状态</TD>
		<TD class=input5><Input style="background:url(../common/images/select--bg_03.png) no-repeat right center" class=codeno name=StateFlagBlankOut id=StateFlagBlankOut
			CodeData="0|^6|使用作废 ^7|停用作废"
			ondblClick="showCodeListEx('StateFlagBlankOut',[this,StateFlagBlankOutName],[0,1],null,null,null,1);"
            onclick="showCodeListEx('StateFlagBlankOut',[this,StateFlagBlankOutName],[0,1],null,null,null,1);"
			onkeyup="showCodeListKeyEx('StateFlagBlankOut',[this,StateFlagBlankOutNName],[0,1],null,null,null,1);"><Input
			class=codename name=StateFlagBlankOutName id=StateFlagBlankOutName readonly=true></TD>
