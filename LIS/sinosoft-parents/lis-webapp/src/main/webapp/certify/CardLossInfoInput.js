...
var tResourceName="certify.CardLossInfoInputSql";
//单证状态查询
function certifyQuery()
{
  ...
  /*strSQL="select a.certifycode, "
		...
		+" a.startno, a.endno, a.sumcount, a.makedate, (select substr(note,1,10) from lzcardapp where applyno=a.applyno),"
		+" (select substr(note,12,length(note)) from lzcardapp where applyno=a.applyno), a.SendOutCom,"
		...
		+" from lzcardB a where 1 = 1 and a.stateflag = '10'"
