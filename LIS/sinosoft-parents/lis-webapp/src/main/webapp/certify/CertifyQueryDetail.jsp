...
<%
  ...
  CertifyQueryUI tCertifyQueryUI   = new CertifyQueryUI();
	if (!tCertifyQueryUI.submitData(tVData,"QUERY||DETAIL"))
	{
...
loggerDebug("CertifyQueryDetail","------end------");
loggerDebug("CertifyQueryDetail",FlagStr);
loggerDebug("CertifyQueryDetail",Content);
