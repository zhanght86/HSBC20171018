...
<%
	...
	try {
		...
		// 数据传输
		/*CertDestroyApplyUI tCertDestroyApplyUI = new CertDestroyApplyUI();
		if (!tCertDestroyApplyUI.submitData(vData, "APPLY")) { //APPLY:挂失
			Content = " 保存失败，原因是: "
			+ tCertDestroyApplyUI.mErrors.getFirstError();
			FlagStr = "Fail";
		} else {
			Content = " 保存成功. ";
			FlagStr = "Succ";
		}*/
		String busiName="CertDestroyApplyUI";
		  String mDescType="保存";
