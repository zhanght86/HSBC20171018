...
<%
	//程序名称：CardSendOutEXInfoInput.jsp
	//程序功能：增领单证清单
	//创建日期： 2009-02-18
	//创建人  ： mw
...
<script src="./CardSendOutEXInfoInput.js"></script>
<%@include file="CardSendOutEXInfoInit.jsp"%>
</head>
...
<table class="common">
	...
	<tr class="common">
		...
		<td class="input5"><Input class="coolDatePicker" onClick="laydate({elem: '#MakeDateB'});" verify="发放日期（开始）|NOTNULL" dateFormat="short" name=MakeDateB id="MakeDateB"><span class="icon"><a onClick="laydate({elem: '#MakeDateB'});"><img src="../common/laydate/skins/default/icon.png" /></a></span><font
			color=red>*</font></td>
		<td class="title5">发放日期（结束）</td>
		<td class="input5"><Input class="coolDatePicker" onClick="laydate({elem: '#MakeDateE'});" verify="发放日期（结束）|NOTNULL" dateFormat="short" name=MakeDateE id="MakeDateE"><span class="icon"><a onClick="laydate({elem: '#MakeDateE'});"><img src="../common/laydate/skins/default/icon.png" /></a></span><font
			color=red>*</font></td>
	</tr>
</table>
</div>
...
<table>
	<tr>
		...
		<td class=titleImg>增领单证信息</td>
	</tr>
</table>
<div id="divCardSendOutInfo" style="display: ''">
<table class="common">
	<tr class="common">
		<td text-align: left colSpan=1><span id="spanCardSendOutInfoGrid"></span></td>
	</tr>
</table>
