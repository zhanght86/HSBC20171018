...
<script src="./CardStockInfo.js"></script>
<%@include file="CardStockInfoInit.jsp"%>
</head>
...
<table class="common">
	<tr class="common">
		...
		<td class=input5><Input style="background:url(../common/images/select--bg_03.png) no-repeat right center" class="codeno" name=Grade id=Grade readonly
            ...
            onclick="return showCodeListEx('Grade',[this,GradeName],[0,1],null,null,null,1);"
	...
	<tr class="common">
		...
		<td class="input5"><Input class="coolDatePicker" onClick="laydate({elem: '#MakeDateB'});" verify="开始日期|NOTNULL" dateFormat="short" name=MakeDateB id="MakeDateB"><span class="icon"><a onClick="laydate({elem: '#MakeDateB'});"><img src="../common/laydate/skins/default/icon.png" /></a></span></td>
		<td class="title5">终止日期</td>
		<td class="input5"><Input class="coolDatePicker" onClick="laydate({elem: '#MakeDateE'});" verify="终止日期|NOTNULL" dateFormat="short" name=MakeDateE id="MakeDateE"><span class="icon"><a onClick="laydate({elem: '#MakeDateE'});"><img src="../common/laydate/skins/default/icon.png" /></a></span></td>
	</tr>
</table>
</div>
...
<input type="hidden" name="hidManageCom"> <input type="hidden"
	name="hidGrade"></form>
