...
<script src="./CardSendOutReceive.js"></script>
<%@include file="CardSendOutReceiveInit.jsp"%>
</head>
...
<table class="common">
	...
	<tr class="common">
		...
		<td class="input5"><input class="wid" class="common" name="ReceiveCom" id="ReceiveCom" onblur="getAgentCom()"></td>
	</tr>
...
<table>
	<tr>
		<td class=common><IMG src="../common/images/butExpand.gif"
			style="cursor:hand;" OnClick="showPage(this, popoiu);"></td>
		<td class=titleImg>发放信息</td>
	</tr>
</table>
<div id="popoiu" style="display: ''">
<table class="common">
	<tr class="common">
		<td style="text-align: left" colSpan=1><span id="spanCardSendOutReceiveGrid"></span></td>
	</tr>
</table>
