...
<table class="common">
	<tr>
		<td><a href="./CertifyTakeBack20090824.xls">点击此处下载</a><br>
		</TD>
	</tr>
</table>
</Div>
...
<!--<INPUT class=cssButton VALUE="导入缴销" TYPE=button
			name="PrintIn" onclick="getin()">-->
            <a href="javascript:void(0);" class="button" name="PrintIn" onClick="getin();">导入缴销</a>
            </TD>
...
<!--<input value="清单下载" type="button" onclick="certifyPrint()"
			class="cssButton">-->
