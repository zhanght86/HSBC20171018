...
<%
	//程序名称：CertifyDestroyApplySave.jsp
	//程序功能：
	//创建日期：2002-09-23
	//创建人  ：周平
...
<%
	...
	try {
		...
		// 数据传输
		/*CertReveTakeBackApplyUI tCertReveTakeBackApplyUI = new CertReveTakeBackApplyUI();
		if (!tCertReveTakeBackApplyUI.submitData(vData, "APPLY")) { //APPLY:挂失
			Content = " 保存失败，原因是: "
			+ tCertReveTakeBackApplyUI.mErrors.getFirstError();
			FlagStr = "Fail";
		} else {
			Content = " 保存成功. ";
			FlagStr = "Succ";
		}*/
		String busiName="CertReveTakeBackApplyUI";
		  String mDescType="保存";
