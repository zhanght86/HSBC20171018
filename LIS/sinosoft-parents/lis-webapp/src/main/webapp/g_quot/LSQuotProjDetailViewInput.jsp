<%
/***************************************************************
 * <p>ProName：LSQuotProjDetailViewInput.jsp</p>
 * <p>Title：明细查看(项目询价)</p>
...
<head>
	...
	<script src="./LSQuotProjDetailViewInput.js"></script>
	<%@include file="./LSQuotProjDetailViewInit.jsp"%>
</head>
<body onload="initForm(); initElementtype();">
<form name=fm id=fm idmethod=post action="" target=fraSubmit>
	<div id="tab1">
		<ul>
		   <li id=id1 name=name1></li>
		   <li id=id2 name=name2></li>
		   <li id=id3 name=name3></li>
			<li onmouseover="setTabOver(1,3)" onmouseout="setTabOut(1,3)" onclick="showGrpSpec();" class="libutton">特别约定</li>
			<li onmouseover="setTabOver(1,4)" onmouseout="setTabOut(1,4)" onclick="showAttachment();" class="libutton">附件管理</li>
			<li onmouseover="setTabOver(1,5)" onmouseout="setTabOut(1,5)" onclick="showQuesnaire();" class="libutton">问卷调查</li>
			<li onmouseover="setTabOver(1,6)" onmouseout="setTabOut(1,6)" onclick="showPast();" class="libutton">既往信息</li>
			<li onmouseover="setTabOver(1,7)" onmouseout="setTabOut(1,7)" onclick="showFeeInfo();" class="libutton">费用信息</li>
			<li onmouseover="setTabOver(1,8)" onmouseout="setTabOut(1,8)" onclick="onlyShowRequest();" class="libutton">业务需求</li>
		</ul>
	</div>
</form>
<div class="tablist block">
	<form name=fm2 id=fm2 method=post action="" target=fraSubmit>
		...
		<div id=divInfo1 name=divInfo1 class=maxbox style="display: ''">
			<table class=common>
				...
				<tr class=common>
					...
					<td class=input><input class="wid common" name=BlanketFlag style="display: none"><input class="wid readonly" name=BlanketFlagName  id=BlanketFlagName readonly></td>
		...
		<div id="divUnderwriting" style="display: ''">
			<table>
				<tr>
					<td class=common>
			...
			<table class=common>
				<tr class=common>
					...
					<td class=input colspan=11><textarea class="wid readonly" cols=70 rows=2 name=FinalOpinion id=FinalOpinion readonly></textarea></td>
				</tr>
				<tr class=common>
