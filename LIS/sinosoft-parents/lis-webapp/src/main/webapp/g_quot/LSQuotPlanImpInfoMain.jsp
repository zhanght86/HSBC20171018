<%
/***************************************************************
 * <p>ProName：LSQuotPlanImpInfoMain.jsp</p>
 * <p>Title：询价方案导入信息</p>
...
<!--标题与状态区域-->
	...
	<frameset name="fraSet" cols="0%,*,0%" frameborder="no" border="1" framespacing="0" rows="*">
		...
		<%
			...
			tSrc = "./LSQuotPlanImpInfoInput.jsp";
			tSrc += "?QuotNo="+ tQuotNo +"&QuotBatNo="+ tQuotBatNo +"&QuotType="+ tQuotType+"&TranProdType="+ tTranProdType;
		%>
