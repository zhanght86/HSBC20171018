...
<form name=fm id=fm method=post action="./LSQuotPlanCombiSave.jsp" target=fraSubmit>
	...
	<div id="divPlanQuery" class=maxbox1 style="display: ''">
		...
		<input class=cssButton type=button value="查  询" name="QueryImpInfo" id=QueryImpInfo onclick="queryPlanImpList();">
		...
		<input class=cssButton type=button value="导入批次错误信息下载" name="DownloadButton" onclick="downloadClick();">
	</div>
