<%
/***************************************************************
 * <p>ProName：LSQuotBranchUWQueryInput.jsp</p>
 * <p>Title：分公司核保</p>
 * <p>Description：分公司核保</p>
...
<%
	...
	//判断当前操作人员是否核保主管，如果既不是核保师也不是核保主管，则将标记置为99，不允许查询到信息
	String tSupervisorFlag = LSQuotPubFun.getSupervisorFlag(tGI.Operator);
	
	if ("".equals(tSupervisorFlag) || "null".equals(tSupervisorFlag)) {
		tSupervisorFlag = "99";
	}
%>
<script>
	...
	var tSupervisorFlag = "<%=tSupervisorFlag%>";
</script>
<html>
<head >
	<title>分公司核保</title>
	...
	<%@include file="./LSQuotBranchUWQueryInit.jsp"%>
</head>
