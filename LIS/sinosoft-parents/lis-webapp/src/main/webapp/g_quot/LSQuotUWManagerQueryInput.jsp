<%
/***************************************************************
 * <p>ProName：LSQuotUWManagerQueryInput.jsp</p>
 * <p>Title：核保经理审核</p>
 * <p>Description：核保经理审核</p>
...
<head >
	...
	<script src="./LSQuotUWManagerQueryInput.js"></script>
	<%@include file="./LSQuotUWManagerQueryInit.jsp"%>
</head>
