        ...
        <Span id="spanAudit" style="display: ''">
            ...
            <Div id= "divLLAudit" style= "display: ''" class="maxbox1">
                 <table class= common>
                    <TR class= common>
                        ...
                        <TD  class= title>拒付原因</TD>
                            <TD  class= input><Input style="background:url(../common/images/select--bg_03.png) no-repeat right center"  type=hidden name=ProtestReason ondblclick="return showCodeList('llprotestreason',[this,ProtestReasonName],[0,1]);" onkeyup="return showCodeListKey('llprotestreason',[this,ProtestReasonName],[0,1]);"><input class="wid" class=readonly readonly name=ProtestReasonName id=ProtestReasonName readonly=true></TD>
                    </tr>
                </table>
                ...
                <table class= common>
                    ...
                    <TR class= common>
                        <TD colspan="6" style="padding-left:16px"> <textarea name="AuditIdea" cols="228" rows="4" witdh=25% class="common" readonly ></textarea></TD>
                    </tr>
                 </table>
            </Div>
        </span>
        ...
        <Span id= "spanConfirm" style="display: '';">
            ...
            <Div  id= "divShowQueryDetail" style="display: '';" class="maxbox1">
                ...
                <table class= common>
                    ...
                    <TR class= common>
                        <TD  colspan="6" style="padding-left:16px"> <textarea name="RemarkSP" cols="228%" rows="4" witdh=25% class="common" readonly ></textarea></TD>
                    </tr>
                </table>
            </div>
        </span>
