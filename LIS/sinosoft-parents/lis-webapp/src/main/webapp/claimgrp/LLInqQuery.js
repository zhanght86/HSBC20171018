...
function queryLLInqPayclusionGrid()
{
	/*var strSQL = "select clmno,conno,batno,initdept,inqdept,inqconclusion, "
        ...
        + " order by clmno";*/
    mySql = new SqlClass();
	mySql.setResourceName("claimgrp.LLInqQueryInputSql");
...
//    fm.fmtransact.value="SinglePrt||Print";
    fm.action="../claim/LLPRTInteInqTaskSave.jsp";
    fm.target = "../f1print";
...
{
//    fm.fmtransact.value="SinglePrt||Print";
    fm.action="../claim/LLPRTInteInqReportSave.jsp";
    fm.target = "../f1print";
	document.getElementById("fm").submit();
}
...
//	                     + " and batno = '"+LLInqConclusionGrid.getRowColData(i,3)+"' and FiniFlag = '0' "; 
//    var tResult = easyExecSql(tPAConclusionSQL);
//    if(tResult != "0")
//    {
