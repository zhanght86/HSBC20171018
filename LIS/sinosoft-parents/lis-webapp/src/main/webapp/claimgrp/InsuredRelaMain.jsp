...
<!--标题与状态区域-->
	...
	<frameset name="fraSet" cols="*" frameborder="yes" border="1" framespacing="0" rows="0,0,*,0">
		...
		<frame id="fraInterface" name="fraInterface" scrolling="auto" noresize src="./InsuredRelaAdd.jsp?PrtNo=<%=request.getParameter("PrtNo")%>&LoadFlag=18&GrpContNo=<%=request.getParameter("GrpContNo")%>">
    <!--下一步页面区域-->
