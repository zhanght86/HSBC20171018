...
else
{
    ...
    mTransferData.setNameAndValue("Auditer", request.getParameter("tOperator")); //审核人
    ...
    loggerDebug("LLClaimAuditSave","案件类型:"+request.getParameter("mRgtState"));
    ...
    mTransferData.setNameAndValue("RgtState",request.getParameter("mRgtState")); //案件类型
