...
<meta http-equiv="Content-Type" content="text/html; charset=gb2312">
  ...
  <SCRIPT src="LLGrpFillList.js"></SCRIPT>
  <%@include file="LLGrpFillListInit.jsp"%>
...
<form method=post name=fm target="fraSubmit">
    ...
    <!--<INPUT VALUE="连带被保人关系补录" class= cssButton TYPE=button onclick="addNameClick();">-->
    <a href="javascript:void(0);" class="button" onClick="addNameClick();">连带被保人关系补录</a>
