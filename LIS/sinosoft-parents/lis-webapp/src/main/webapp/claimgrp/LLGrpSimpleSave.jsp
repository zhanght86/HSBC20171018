...
if(tGI == null)
{
    FlagStr = "Fail";
    Content = "页面失效,请重新登陆";
    loggerDebug("LLGrpSimpleSave","页面失效,请重新登陆");
}
else
{
    //获取操作符
    ...
    tLLClaimUWMainSchema.setAuditConclusion(request.getParameter("SimpleConclusion2")); //审核结论
...
{    
	...
	else
	{
        ...
        else
        {
            ...
            loggerDebug("LLGrpSimpleSave","========加入再保险处理     sujd   2007-12-17=====");
            ...
            {     
                 ...
                 loggerDebug("LLGrpSimpleSave","==================再保批处理结束=================");
            }            
