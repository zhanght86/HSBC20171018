...
function initParam()
{
    ...
    fm.all('BnfKind').value = nullToEmpty("<%= tBnfKind %>");
}
...
function initLLBalanceGrid()
{
    ...
    try
    {
        ...
        iArray[4]=new Array();
        iArray[4][0]="GrpContNo";        //列名
        iArray[4][1]="100px";                //列宽
        iArray[4][2]=100;                  //列最大值
        iArray[4][3]=3;                    //是否允许输入,1表示允许，0表示不允许

        iArray[5]=new Array();
        iArray[5][0]="GrpPolNo";             //列名
        iArray[5][1]="100px";                //列宽
        iArray[5][2]=200;                  //列最大值
        iArray[5][3]=3;

        iArray[6]=new Array();
        iArray[6][0]="ContNo";          //列名
        iArray[6][1]="100px";                //列宽
        iArray[6][2]=200;                  //列最大值
...
function initLLBnfGrid()
{
    ...
    try
    {
        ...
        iArray[11]=new Array();
        iArray[11][0]="relationtoinsured";         //列名
        iArray[11][1]="80px";                //列宽
        ...
        iArray[13]=new Array();
        iArray[13][0]="birthday";         //列名
        iArray[13][1]="80px";                //列宽
        iArray[13][2]=200;                  //列最大值
        iArray[13][3]=3;                    //是否允许输入,1表示允许，0表示不允许
        
        iArray[14]=new Array();
        iArray[14][0]="idtype";         //列名
        iArray[14][1]="80px";                //列宽
