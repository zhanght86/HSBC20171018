...
<body  onload="initForm();" >
    ...
    <Div  id= "divSearch" style= "display: none" class="maxbox1">
        <table class= common>
            <TR class= common>
                ...
                <TD class= input5> <Input style="background:url(../common/images/select--bg_03.png) no-repeat right center" class=codeno name=ClmState id=ClmState CodeData="0|3^10|已报案^20|已立案^30|审核" ondblclick="return showCodeListEx('ClmState', [this,ClmStateName],[0,1])"  onclick="return showCodeListEx('ClmState', [this,ClmStateName],[0,1])" onkeyup="return showCodeListKeyEx('ClmState', [this,ClmStateName],[0,1])" ><Input class=codename name=ClmStateName id=ClmStateName readonly=true></TD></TR>
                <TR class= common>
    ...
    <Div  id= "divLLClaimAudit" style= "display: none">
        <Table  class= common>
            <TR  class= common>
    ...
    <Div id= "divSelfLLClaimAuditGrid" style= "display: ''">
        <table  class= common >
            <tr  class=common>
