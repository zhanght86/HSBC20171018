    ...
    <Div  id= "divSearch" style= "display: ''">
        <table class= common>
            <TR class= common>
                ...
                <TD class= input> <Input class=codeno name=ClmState CodeData="0|3^10|已报案^20|已立案" ondblclick="return showCodeListEx('ClmState', [this,ClmStateName],[0,1])"onkeyup="return showCodeListKeyEx('ClmState', [this,ClmStateName],[0,1])" ><Input class=codename name=ClmStateName readonly=true></TD>
