<%
//文件名称：LLPRTInteInqReportSave.jsp
//文件功能：打印理赔调查报告
//创建人：yuejw
//创建日期:
%>
...
if(tGI == null)
{
    FlagStr = "Fail";
    Content = "页面失效,请重新登陆";
    loggerDebug("LLPRTInteInqReportSave","页面失效,请重新登陆");    
}
//else
//{
...
//   	mTransferData.setNameAndValue("Path",tPath);
    ...
    {
        Content = " 数据提交失败，原因是: " + tLLPRTInteInqReportUI.mErrors.getError(0).errorMessage;
        FlagStr = "Fail";
    }
    else
    {
	    ...
	    if(txmlExport==null)
	    {
            ...
            loggerDebug("LLPRTInteInqReportSave","没有得到要显示的数据文件");
	    }
    }
	if (FlagStr.equals("Succ"))
	{
		...
		//把dataStream存储到磁盘文件
		loggerDebug("LLPRTInteInqReportSave","存储文件到"+strVFPathName);
