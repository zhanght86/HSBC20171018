...
<form name=fm target=fraSubmit method=post>
    ...
    <span id= "spanLLClaimRegister" style= "display: ''">
        <table class= common>
            <TR class= common>    
            ...
            <TR class= common>                  
                ...
                <TD class= input> <Input class=codeno name="RgtConclusion" ondblclick="return showCodeList('RptMode',[this,RptModeName],[0,1]);" onkeyup="return showCodeListKey('RptMode',[this,RptModeName],[0,1]);"><input class=codename name="RptModeName" readonly=true></TD>            
            </TR>
<!--
            <TR class= common>            
