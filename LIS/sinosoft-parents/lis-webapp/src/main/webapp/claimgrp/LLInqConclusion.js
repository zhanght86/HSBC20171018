...
function initializeQuery()
{
    ...
    else
    {
     ...
     //查询调查申请信息,组成mulline
    var strSQL = "select clmno,inqno,batno,customerno,customername,vipflag,(case initphase when '01' then '报案阶段' when '02' then '审核阶段' when '03' then '呈报阶段' end) ,inqrcode,inqitem,inqconclusion ,inqstartdate,inqenddate from llinqapply where "
