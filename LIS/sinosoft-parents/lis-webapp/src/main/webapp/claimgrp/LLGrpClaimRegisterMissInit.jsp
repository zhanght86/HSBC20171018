<%
//程序名称：LLGrpClaimRegisterMissInit.jsp
//程序功能：
//创建日期：2005-10-20
//创建人  ：pd
//更新记录：
...
function initLLClaimRegisterGrid()
{
    ...
    iArray[10]=new Array();
    iArray[10][0]="报案日期";             //列名AccidentReason
    iArray[10][1]="70px";                //列宽
    iArray[10][2]=200;                  //列最大值
    iArray[10][3]=0;                    //是否允许输入,1表示允许，0表示不允许
    
    iArray[11]=new Array();
    iArray[11][0]="报案受理人";             //列名AccidentReason
    iArray[11][1]="40px";                //列宽
    iArray[11][2]=40;                  //列最大值
    iArray[11][3]=0;                    //是否允许输入,1表示允许，0表示不允许
    
    iArray[12]=new Array();
    iArray[12][0]="管理机构";             //列名AccidentReason
    iArray[12][1]="60px";                //列宽
    iArray[12][2]=60;                  //列最大值
    iArray[12][3]=0;                    //是否允许输入,1表示允许，0表示不允许
    
    iArray[13]=new Array();
    iArray[13][0]="扫描件";             //列名AccidentReason
    iArray[13][1]="60px";                //列宽
    iArray[13][2]=60;                  //列最大值
    iArray[13][3]=0;                    //是否允许输入,1表示允许，0表示不允许    
    
    iArray[14]=new Array();
    iArray[14][0]="调查状态";             //列名AccidentReason
    iArray[14][1]="80px";                //列宽
    iArray[14][2]=80;                  //列最大值
    iArray[14][3]=0;                    //是否允许输入,1表示允许，0表示不允许       
    
    LLClaimRegisterGrid = new MulLineEnter( "document" , "LLClaimRegisterGrid" ); 
    //这些属性必须在loadMulLine前
    LLClaimRegisterGrid.mulLineCount = 5;   
...
{                               
    ...
    iArray[12]=new Array();
    iArray[12][0]="扫描件";             //列名AccidentReason
    iArray[12][1]="60px";                //列宽
    iArray[12][2]=60;                  //列最大值
    iArray[12][3]=0;                    //是否允许输入,1表示允许，0表示不允许  
    
    iArray[13]=new Array();                                                    
    iArray[13][0]="调查状态";             //列名AccidentReason                   
    iArray[13][1]="60px";                //列宽                                
    iArray[13][2]=60;                  //列最大值                              
    iArray[13][3]=0;                    //是否允许输入,1表示允许，0表示不允许  

    iArray[14]=new Array();                                                    
    iArray[14][0]="受理日期";             //列名AccidentReason                   
    iArray[14][1]="60px";                //列宽                                
    iArray[14][2]=60;                  //列最大值                              
    ...
    SelfLLClaimRegisterGrid = new MulLineEnter( "document" , "SelfLLClaimRegisterGrid" ); 
    //这些属性必须在loadMulLine前
    SelfLLClaimRegisterGrid.mulLineCount = 5;   
