...
<form name=fm target=fraSubmit method=post>
    ...
    <Div id= "button" style= "display: 'none'" align = center>
    <input TYPE=button class=cssButton name="exemptquery" value="获取豁免信息" onclick="LLExemptQueryClick();">
    <Input class=codeno readonly name=ExemptReason ondblclick="return showCodeList('llexemptreason',[this,ExemptReasonname],[0,1]);" onkeyup="return showCodeListKey('llexemptreason',[this,ExemptReasonname],[0,1]);">
    </div>
	...
	<Div id= "divLLClaimExemptFreeInfo" style= "display: 'none'">
		<Table class=common>
			<tr class=common>
				...
				<td class=input><Input class="readonly" name=ExemptReasonname readonly ></td>
		        <TD class= title>免交起期</TD>
	            <TD class= input><input class="coolDatePicker" readonly name="FreeStartDate"  ></TD>
	            <TD class= title>免交止期</TD>
	            <TD class= input><input class="coolDatePicker" readonly name="FreeEndDate"  ></TD>
	        </tr>
            <tr class=common>
