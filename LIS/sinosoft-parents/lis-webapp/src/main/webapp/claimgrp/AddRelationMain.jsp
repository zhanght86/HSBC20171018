...
<frame id="fraPic" name="fraPic" scrolling="auto" noresize src="about:blank">
		<frame id="fraInterface" name="fraInterface" scrolling="auto" noresize src="./AddRelation.jsp?ContNo=<%=request.getParameter("ContNo")%>&PrtNo=<%=request.getParameter("PrtNo")%>&GrpContNo=<%=request.getParameter("GrpContNo")%>">
    <!--下一步页面区域-->
