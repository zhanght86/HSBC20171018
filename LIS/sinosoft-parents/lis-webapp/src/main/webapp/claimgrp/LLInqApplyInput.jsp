...
<br>
  ...
  <table>
  <TR>
  <TD><IMG  src= "../common/images/butExpand.gif" style= "cursor:hand;" OnClick= "showPage(this,divLLInqApply1);"></TD>
  <TD class= titleImg>发起调查</TD>
  </TR>
  </table>
  <Div id= "divLLInqApply1" style= "display: ''">
  <table>
  <tr>
  ...
  <tr class=common>
    ...
    <td class= input><Input class=codeno  name="InqReason" ondblclick="return showCodeList('llinqreason',[this,InqReasonName],[0,1],null,null,null,null,'400');" onkeyup="return showCodeListKey('llinqreason',[this,InqReasonName],[0,1],null,null,null,null,'400');"><input class=codename name="InqReasonName" readonly=true></TD>       
    <td class=title> 调查机构 </td>
    <td class= input><Input class=codeno readonly disabled name="InqOrg" ondblclick="return showCodeList('stati',[this,InqOrgName],[0,1]);" onkeyup="return showCodeListKey('stati',[this,InqOrgName],[0,1]);"><input class=codename name="InqOrgName" readonly=true></TD>   
     <td ><input type="checkbox" value="1" name="MoreInq" onclick="MoreInqClick()">异地调查</input></td>   
  </tr> 
  </tr>
  <!--
  <TR  class= common>
  ...
  <tr class= common>   
    <td class= input> <textarea name="InqItem" cols="100%" rows="2" witdh=25% class="common"></textarea></td>
  </tr>
  ...
  <tr class= common>   
    <td class= input> <textarea name="InqDesc" cols="100%" rows="3" witdh=25% class="common"></textarea></td>
  </tr>
  </TABLE>
  </Div>
  <br>
