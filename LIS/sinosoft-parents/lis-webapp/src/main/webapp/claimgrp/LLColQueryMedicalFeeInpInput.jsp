    	...
    	<Div  id= "MedFeeClinicInp" style= "display:''">
            ...
            <table  class= common>
                ...
                <tr class= common>
                    ...
                    <TD  class= input> <input class="coolDatePicker" verify="开始日期|date&NOTNULL" dateFormat="short" name="ClinicStartDate" ><font size=1 color='#ff0000'><b>*</b></font></TD>
        ...
        <Div  id= "MedFeeInHosInp" style= "display:''">
            ...
            <table  class= common>
                <tr class= common>
                    ...
                    <TD  class= title> 费用类型</TD>
                    <TD  class= input> <Input class=codeno name=InHosMedFeeType  verify="费用类型|code:LLMedFeeType" ondblclick="return showCodeList('LLMedFeeType',[this,InHosMedFeeTypeName],[0,1],null,null,null,null,'150');" onkeyup="return showCodeListKey('LLMedFeeType',[this,InHosMedFeeTypeName],[0,1],null,null,null,null,'150');"><input class=codename name=InHosMedFeeTypeName readonly=true><font size=1 color='#ff0000'><b>*</b></font></TD>
                </tr>
                <tr class= common>
                    <TD  class= title> 费用金额</TD>
                    <TD  class= input> <Input class=common  name=InHosMedFeeSum verify="费用金额|num" onchange=verifyElementWrap(this.verify,this.value,this.form.name+"."+this.name)></TD>
                    <TD  class= title> 开始日期</TD>
