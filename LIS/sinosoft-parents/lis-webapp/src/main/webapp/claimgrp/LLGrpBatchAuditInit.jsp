<%
//Name: LLClaimBatchAuditInit.jsp
//function：
//author:
//Date:
%>
...
function initParam()
{
    ...
    document.all('RptNo').value = nullToEmpty("<%= RptNo %>");
    document.all('Flag').value = nullToEmpty("<%= Flag %>");
...
function initSubMeansGrid()
{
    ...
    try
    {
      ...
      SubMeansGrid = new MulLineEnter("document","SubMeansGrid");
      SubMeansGrid.mulLineCount = 5;        // 显示行数
