...
function initForm()
{
    ...
    {
        alter("LLGrpClaimUserInit.jsp-->InitForm函数中发生异常:初始化界面错误!");
    }
}
...
//      LLGrpClaimUserGrid.canChk =1;              //多选按钮，1显示，0隐藏
        LLGrpClaimUserGrid.canSel =1;              //单选按钮，1显示，0隐藏
        LLGrpClaimUserGrid.hiddenPlus=1;           //＋号，1隐藏，0显示
        LLGrpClaimUserGrid.hiddenSubtraction=1;    //－号：1隐藏，0显示
        LLGrpClaimUserGrid.selBoxEventFuncName = "LLGrpClaimUserGridClick"; //函数名称
