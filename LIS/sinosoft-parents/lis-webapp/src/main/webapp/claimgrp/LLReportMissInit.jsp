...
//    iArray[10][3]=3;                    //是否允许输入,1表示允许，0表示不允许         
    ...
    SelfLLReportGrid = new MulLineEnter( "fm" , "SelfLLReportGrid" ); 
    //这些属性必须在loadMulLine前
    SelfLLReportGrid.mulLineCount = 0;   
