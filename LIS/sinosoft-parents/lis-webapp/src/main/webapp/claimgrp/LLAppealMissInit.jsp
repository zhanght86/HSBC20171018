<%
//程序名称：LLAppealMissInit.jsp
//程序功能：
//创建日期：2005-7-25 15:50
//创建人  ：zl
//更新记录：
%>
<!--用户校验类-->
...
//    iArray[10][3]=3;                    //是否允许输入,1表示允许，0表示不允许
    ...
    LLAppealGrid = new MulLineEnter( "fm" , "LLAppealGrid" ); 
    //这些属性必须在loadMulLine前
    LLAppealGrid.mulLineCount = 0;   
...
//    iArray[10][3]=3;                    //是否允许输入,1表示允许，0表示不允许         
    ...
    SelfLLAppealGrid = new MulLineEnter( "fm" , "SelfLLAppealGrid" ); 
    //这些属性必须在loadMulLine前
    SelfLLAppealGrid.mulLineCount = 0;   
