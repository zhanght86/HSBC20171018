...
<%
//程序名称：EdorAppMUHealthInput.jsp
//程序功能：保全人工核保体检资料录入
//创建日期：2005-06-13 12:59:36
//创建人  ：liurongxiao
    ...
    <table  class= common align=center>
    	<TR  class= common >
          ...
          <TD  class= input> <Input class="readonly" name=ContNo > </TD>
           <INPUT  type= "hidden" class= "Common wid" name= MissionID id=MissionID value= ""><!-- 工作流任务编码 -->
        ...
        <TR  class= common>
          ...
          <TD  class= input>  <Input class="multiDatePicker" dateFormat="short" name=EDate id=EDate verify="体检日期|date" >  </TD>
      ...
      <table class= common border=0 width=100%>
        ...
        <tr class= common>
          <td class= common><input type=radio name="bodyCheck" id=bodyCheck value='type1'  OnClick= "showBodyCheck(bodyCheckType1);">临床物理检查、心电图、尿常规 </td>
        </tr>
        <tr class= common>
          <td class= common><input type=radio name="bodyCheck" id=bodyCheck value='type2' OnClick= "showBodyCheck(bodyCheckType2);">临床物理检查、心电图、尿常规、空腹血糖、血常规、肝功能、乙肝表面抗原、血脂、肾功能 </td>
        </tr>
        <tr class= common>
          <td class= common><input type=radio name="bodyCheck" id=bodyCheck value='type3' OnClick= "showBodyCheck(bodyCheckType3);">临床物理检查、心电图、尿常规、空腹血糖、血常规、肝功能、乙肝表面抗原、血脂、肾功能、眼底、B超、胸部透视 </td>
        </tr>
        <tr class= common>
          <td class= common><input type=radio name="bodyCheck" id=bodyCheck value='type4' OnClick= "showBodyCheck(bodyCheckType4);">临床物理检查、心电图、尿常规、空腹血糖、血常规、肝功能、乙肝表面抗原、血脂、肾功能、眼底、B超、胸部透视、妇科检查 </td>
        </tr>
      </table>
       ...
       <table class= common border=0 width=100%>
         <tr>
          ...
          <table  class= common>
              ...
              <tr class=common>
                <td class= common> <input type=checkbox name='type1' id=type1 value='070心电图' checked="checked">心电图 </td>
              </tr>
              <tr class=common>
                <td class= common> <input type=checkbox name='type1' id=type1 value='020尿常规' checked="checked">尿常规 </td>
              </tr>
              <tr class=common>
                <td class= common><input type=checkbox name='type1' id=type1 value='140衰弱测试'>衰弱测试 </td>
              </tr>
          </table>
       </div>
       ...
       <table class= common border=0 width=100%>
		...
		<td class= titleImg align= center>体检项目选择</td>
          ...
          <table  class= common>
              ...
              <tr class=common>
                <td class= common> <input type=checkbox name='type2' id=type2 value='070心电图' checked="checked">心电图 </td>
              </tr>
              <tr class=common>
                <td class= common> <input type=checkbox name='type2' id=type2 value='020尿常规' checked="checked">尿常规 </td>
              </tr>
               <tr class=common>
               ...
               <tr class=common>
                <td class= common> <input type=checkbox name='type2' id=type2 value='040血常规' checked="checked">血常规 </td>
              </tr>
               <tr class=common>
                <td class= common> <input type=checkbox name='type2' id=type2 value='050肝功能' checked="checked">肝功能 </td>
              </tr>
               <tr class=common>
                <td class= common> <input type=checkbox name='type2' id=type2 value='060乙肝表面抗原' checked="checked">乙肝表面抗原 </td>
              </tr>
               <tr class=common>
                <td class= common> <input type=checkbox name='type2' id=type2 value='080血脂' checked="checked">血脂 </td>
              </tr>
               <tr class=common>
                <td class= common> <input type=checkbox name='type2' vid=type2 alue='090肾功能' checked="checked">肾功能 </td>
              </tr>
              <tr class=common>
                <td class= common><input type=checkbox name='type2' id=type2 value='140衰弱测试'>衰弱测试 </td>
              </tr>
          </table>
       </div>
       ...
       <table class= common border=0 width=100%>
		...
		<td class= titleImg align= center>体检项目选择</td>
          ...
          <table  class= common>
              ...
              <tr class=common>
                <td class= common> <input type=checkbox name='type3' id=type3 value='070心电图' checked="checked">心电图 </td>
              </tr>
              <tr class=common>
                <td class= common> <input type=checkbox name='type3' id=type3 value='020尿常规' checked="checked">尿常规 </td>
              </tr>
               <tr class=common>
               ...
               <tr class=common>
                <td class= common> <input type=checkbox name='type3' id=type3 value='040血常规' checked="checked">血常规 </td>
              </tr>
               <tr class=common>
                <td class= common> <input type=checkbox name='type3' id=type3 value='050肝功能' checked="checked">肝功能 </td>
              </tr>
               <tr class=common>
                <td class= common> <input type=checkbox name='type3' id=type3 value='060乙肝表面抗原' checked="checked">乙肝表面抗原 </td>
              </tr>
               <tr class=common>
                <td class= common> <input type=checkbox name='type3' id=type3 value='080血脂' checked="checked">血脂 </td>
              </tr>
               <tr class=common>
                <td class= common> <input type=checkbox name='type3' id=type3 value='090肾功能' checked="checked">肾功能 </td>
              </tr>
              </tr>
               <tr class=common>
                <td class= common> <input type=checkbox name='type3' id=type3 value='100眼底' checked="checked">眼底 </td>
              </tr>
              </tr>
               <tr class=common>
                <td class= common> <input type=checkbox name='type3' id=type3 value='110B超' checked="checked">B超 </td>
              </tr>
              </tr>
               <tr class=common>
                <td class= common> <input type=checkbox name='type3' id=type3 value='120胸部透视' checked="checked">胸部透视 </td>
              </tr>
              <tr class=common>
                <td class= common><input type=checkbox name='type3' id=type3 value='140衰弱测试'>衰弱测试 </td>
              </tr>
          </table>
       </div>
		...
		<td class= titleImg align= center>体检项目选择</td>
          ...
          <table  class= common>
              ...
              <tr class=common>
               ...
               <tr class=common>
                <td class= common> <input type=checkbox name='type4' id=type4 value='040血常规' checked="checked">血常规 </td>
              </tr>
               <tr class=common>
                <td class= common> <input type=checkbox name='type4' id=type4 value='050肝功能' checked="checked">肝功能 </td>
              </tr>
               <tr class=common>
                <td class= common> <input type=checkbox name='type4' id=type4 value='060乙肝表面抗原' checked="checked">乙肝表面抗原 </td>
              </tr>
               <tr class=common>
                <td class= common> <input type=checkbox name='type4' id=type4 value='080血脂' checked="checked">血脂 </td>
              </tr>
               <tr class=common>
                <td class= common> <input type=checkbox name='type4' id=type4 value='090肾功能' checked="checked">肾功能 </td>
              </tr>
              </tr>
               <tr class=common>
                <td class= common> <input type=checkbox name='type4' id=type4 value='100眼底' checked="checked">眼底 </td>
              </tr>
              </tr>
               <tr class=common>
                <td class= common> <input type=checkbox name='type4' id=type4 value='110B超' checked="checked">B超 </td>
              </tr>
              </tr>
               <tr class=common>
                <td class= common> <input type=checkbox name='type4' id=type4 value='120胸部透视' checked="checked">胸部透视 </td>
              </tr>
              </tr>
               <tr class=common>
                <td class= common> <input type=checkbox name='type4' id=type4 value='130妇科检查' checked="checked">妇科检查 </td>
              </tr>
              <tr class=common>
                <td class= common><input type=checkbox name='type4' id=type4 value='140衰弱测试'>衰弱测试 </td>
              </tr>
          </table>
       </div>
