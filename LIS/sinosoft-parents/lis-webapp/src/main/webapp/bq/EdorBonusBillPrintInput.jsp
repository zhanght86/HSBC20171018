...
<html>
<%
//程序名称：EdorBonusBillPrintInput.jsp
//程序功能：保全清单在线打印控制台
...
<SCRIPT src="./EdorBonusBillPrint.js"></SCRIPT>
<LINK href="../common/css/Project.css" rel=stylesheet type=text/css>
<LINK href="../common/css/Project3.css" rel=stylesheet type=text/css>
<LINK href="../common/css/mulLine.css" rel=stylesheet type=text/css>
<%@include file="EdorBonusBillPrintInit.jsp"%>
<title>红利清单 </title>
</head>
<body  onload="initForm();" >
  <form  action="./EdorBonusBillPrintSave.jsp" method=post name=fm id=fm  target="fraSubmit">
    <!-- 查询部分 -->
<table >
  <tr>
    <td class="common">
    ...
    <table  class= common align=center>
       <TR  class= common>
          <td class="title5">渠道</td>
           <TD  class= input5><Input class="codeno" name=SaleChnl id=SaleChnl  CodeData="0|^02|个人营销^03|银行代理^05|专业代理^07|联办代理^10|收展业务" 
           ...
           <td class="title5">分红年度</td>
           <TD  class= input5> <Input name=FinaYear class="common wid"></td>
       </TR>
    </table>
...
src="../common/laydate/skins/default/icon.png" /></a></span> </TD>
 ...
 <table  class= common align=center>
       <TR>
          ...
          <TD  class= input5>
          	<Input class="common wid" name=ManageCom
