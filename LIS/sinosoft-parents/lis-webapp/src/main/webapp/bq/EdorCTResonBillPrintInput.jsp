...
<html>
<%
//程序名称：EdorCTResonBillPrintInput.jsp
//程序功能：保全清单在线打印控制台
...
<SCRIPT src="./EdorCTResonBillPrint.js"></SCRIPT>
<LINK href="../common/css/Project.css" rel=stylesheet type=text/css>
<LINK href="../common/css/Project3.css" rel=stylesheet type=text/css>
<LINK href="../common/css/mulLine.css" rel=stylesheet type=text/css>
<%@include file="EdorCTResonBillPrintInit.jsp"%>
<title>退保原因清单 </title>
</head>
<body  onload="initForm();" >
  <form  action="./EdorCTResonBillPrintSave.jsp" method=post name=fm id=fm target="fraSubmit">
    <!-- 查询部分 -->
<table >
  <tr>
    <td class="common">
...
<script>
	...
	var SQL = "1  and edorcode in (select code from ldcode where codetype=#edortype# and othersign=#1#) and edorcode in (#CT#,#WT#,#XT#)";
</script>
