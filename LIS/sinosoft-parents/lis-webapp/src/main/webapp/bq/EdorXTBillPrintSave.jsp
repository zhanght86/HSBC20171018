...
<%
  		//loggerDebug("EdorXTBillPrintSave","保全清单打印开始..........");
  		String Content = "";
  		CErrors tError = null;
  		String FlagStr = "Fail";
  		String strOperation = "";
        ...
        loggerDebug("EdorXTBillPrintSave","startdate:"+StartDate);
        loggerDebug("EdorXTBillPrintSave","EndDate:"+EndDate);
        ...
        tTransferData.setNameAndValue("Type", "006");
        tVData.add(tG);
        ...
        {
          loggerDebug("EdorXTBillPrintSave","保全清单打印失败！");
          FlagStr = "Fail";
        ...
        else
        {
          ...
          if(txmlExport==null)
          {
        	loggerDebug("EdorXTBillPrintSave","打印失败,原因是＝＝"+tError.getFirstError());
        	FlagStr = "Fail";
      	  ...
      	  {
        	loggerDebug("EdorXTBillPrintSave","保全清单即将合并模板");
    		//合并VTS文件
    		...
    		//把dataStream存储到磁盘文件
    		//loggerDebug("EdorXTBillPrintSave","存储文件到"+strVFPathName);
    		AccessVtsFile.saveToFile(dataStream,strVFPathName);
    		//loggerDebug("EdorXTBillPrintSave","==> Write VTS file to disk ");

    		//loggerDebug("EdorXTBillPrintSave","===strVFFileName : "+strVFFileName);
