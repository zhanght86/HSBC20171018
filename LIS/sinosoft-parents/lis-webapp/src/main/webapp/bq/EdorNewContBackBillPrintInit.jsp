<%
//程序名称：EdorNewContBackBillPrintInit.jsp
//程序功能：
...
{ 
  ...
  {
    alert("在EdorNewContBackBillPrintInit.jsp-->InitInpBox函数中发生异常:初始化界面错误!");
  }      
}
...
function initForm()
{
  ...
  {
    alert("EdorNewContBackBillPrintInit.jsp-->InitForm函数中发生异常:初始化界面错误!");
  }
}
</script>
