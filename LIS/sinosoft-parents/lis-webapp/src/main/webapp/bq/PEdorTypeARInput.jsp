...
<body  onload="initForm();" >
  <form action="" method=post name=fm id=fm target="fraSubmit">    
	...
	<br>  
	  <Input type=Button value="个人账户领取" class = cssButton onclick="EdorDetail()">
	  <Input type=Button value="返  回" class = cssButton onclick="returnParent()">
        ...
        <INPUT CLASS=cssButton90 VALUE="首  页" TYPE=button onclick="divPage3.firstPage();"> 
        <INPUT CLASS=cssButton91 VALUE="上一页" TYPE=button onclick="divPage3.previousPage();"> 					
        <INPUT CLASS=cssButton92 VALUE="下一页" TYPE=button onclick="divPage3.nextPage();"> 
        <INPUT CLASS=cssButton93 VALUE="尾  页" TYPE=button onclick="divPage3.lastPage();">					
  	</div>
