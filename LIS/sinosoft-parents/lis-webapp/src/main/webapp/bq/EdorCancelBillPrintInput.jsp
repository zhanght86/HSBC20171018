...
<html>
<%
//程序名称：EdorCancelBillPrintInput.jsp
//程序功能：保全清单在线打印控制台
...
<SCRIPT src="./EdorCancelBillPrint.js"></SCRIPT>
<LINK href="../common/css/Project.css" rel=stylesheet type=text/css>
<LINK href="../common/css/Project3.css" rel=stylesheet type=text/css>
<LINK href="../common/css/mulLine.css" rel=stylesheet type=text/css>
<%@include file="EdorCancelBillPrintInit.jsp"%>
<title>保全撤销清单 </title>
</head>
<body  onload="initForm();" >
  <form  action="./EdorCancelBillPrintSave.jsp" method=post name=fm id=fm target="fraSubmit">
    <!-- 查询部分 -->
<table >
  <tr>
    <td class="common">
...
src="../common/laydate/skins/default/icon.png" /></a></span>   </TD>
 ...
 <table  class= common align=center>
       <TR>
          ...
          <TD  class= input5>
          	<Input class= code name=ManageCom onDblClick="showCodeList('Station',[this],[0],null,codeSql,'1')" onKeyUp="showCodeListKey('Station',[this],[0],null,codeSql,'1')"></TD>
...
<script>
	...
	var SQL = "1 and edorcode  in (select code from ldcode where codetype in (#edortype#)) ";
</script>
