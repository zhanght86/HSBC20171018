...
<%
 //接收信息，并作校验处理。
  ...
  if(fmAction.equals("INSERT||PMAIN"))
  {
	  ...
	  String[] tCanMoveUnit=request.getParameterValues("LCGrpInsuAccGrid6");//可赎回单位
	  ...
	  if((tAccOutUnit[tSelNo]!=null&&!tAccOutUnit[tSelNo].equals(""))&&(tAccOutBala[tSelNo]!=null&&!tAccOutBala[tSelNo].equals("")))
	  {
	  	FlagStr="Fail";
	  	Content = "请输入转出单位!";
	  }
  ...
  }else
  {
	  try
	  {
	  	 //PEdorARDetailUI tPEdorARDetailUI   = new PEdorARDetailUI();
	    ...
	    BusinessDelegate tBusinessDelegate=BusinessDelegate.getBusinessDelegate();
		 ...
		 tVData.addElement(tLPInsuAccOutSchema);
	        // tPEdorARDetailUI.submitData(tVData,fmAction);
