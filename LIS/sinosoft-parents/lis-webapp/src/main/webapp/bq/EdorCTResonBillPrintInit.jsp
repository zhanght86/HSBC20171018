<%
//程序名称：EdorCTResonBillPrintInit.jsp
//程序功能：清单打印
...
function initInpBox()
{
  ...
  {
    alert("在EdorCTResonBillPrintInit.jsp-->InitInpBox函数中发生异常:初始化界面错误!");
  }
}
...
function initSelBox()
{
  ...
  {
    alert("在EdorCTResonBillPrintInit.jsp-->InitSelBox函数中发生异常:初始化界面错误!");
  }
}
...
function initForm()
{
  ...
  {
    alert("EdorCTResonBillPrintInit.jsp-->InitForm函数中发生异常:初始化界面错误!");
  }
}
