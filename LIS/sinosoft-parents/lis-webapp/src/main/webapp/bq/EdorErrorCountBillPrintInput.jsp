...
<html>
<%
//程序名称：EdorErrorCountBillPrintInput.jsp
//程序功能：保全清单在线打印控制台
...
<SCRIPT src="./EdorErrorCountBillPrint.js"></SCRIPT>
<LINK href="../common/css/Project.css" rel=stylesheet type=text/css>
<LINK href="../common/css/Project3.css" rel=stylesheet type=text/css>
<LINK href="../common/css/mulLine.css" rel=stylesheet type=text/css>
<%@include file="EdorErrorCountBillPrintInit.jsp"%>
<title>保全差错率统计 </title>
</head>
<body  onload="initForm();" >
  <form  action="./EdorErrorCountBillPrintSave.jsp" method=post name=fm  id=fm target="fraSubmit">
    <!-- 查询部分 -->
