...
<%
//name : EdorDayInfoBillPrintSave.jsp
//Creator  ：liurx
//Date ：2005-08-08
%>
<!--用户校验类-->
...
<%
  		//loggerDebug("EdorDayInfoBillPrintSave","保全清单打印开始..........");
  		String Content = "";
  		CErrors tError = null;
  		String FlagStr = "Fail";
  		String strOperation = "";
        ...
        String sMakeDate = request.getParameter("MakeDate");
        ...
        tTransferData.setNameAndValue("MakeDate", sMakeDate);
        tTransferData.setNameAndValue("EdorType", sEdorType);
        tTransferData.setNameAndValue("Type", "013");
        tVData.add(tG);
        ...
        {
          loggerDebug("EdorDayInfoBillPrintSave","保全清单打印失败！");
          FlagStr = "Fail";
        ...
        else
        {
          ...
          if(txmlExport==null)
          {
        	loggerDebug("EdorDayInfoBillPrintSave","打印失败,原因是＝＝"+tError.getFirstError());
        	FlagStr = "Fail";
      	  ...
      	  {
        	loggerDebug("EdorDayInfoBillPrintSave","保全清单即将合并模板");
    		//合并VTS文件
    		...
    		//把dataStream存储到磁盘文件
    		//loggerDebug("EdorDayInfoBillPrintSave","存储文件到"+strVFPathName);
    		AccessVtsFile.saveToFile(dataStream,strVFPathName);
    		//loggerDebug("EdorDayInfoBillPrintSave","==> Write VTS file to disk ");

    		//loggerDebug("EdorDayInfoBillPrintSave","===strVFFileName : "+strVFFileName);
