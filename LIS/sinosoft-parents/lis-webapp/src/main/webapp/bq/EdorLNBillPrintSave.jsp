...
<%
  		//loggerDebug("EdorLNBillPrintSave","保全清单打印开始..........");
  		String Content = "";
  		CErrors tError = null;
  		String FlagStr = "Fail";
  		String strOperation = "";
        ...
        String sCountDate = request.getParameter("CountDate");

        loggerDebug("EdorLNBillPrintSave","startdate:"+StartDate);
        loggerDebug("EdorLNBillPrintSave","EndDate:"+EndDate);
        ...
        tTransferData.setNameAndValue("CountDate", sCountDate);
        tTransferData.setNameAndValue("Type", "011");
        tVData.add(tG);
        ...
        {
          loggerDebug("EdorLNBillPrintSave","保全清单打印失败！");
          FlagStr = "Fail";
        ...
        else
        {
          ...
          if(txmlExport==null)
          {
        	loggerDebug("EdorLNBillPrintSave","打印失败,原因是＝＝"+tError.getFirstError());
        	FlagStr = "Fail";
      	  ...
      	  {
        	loggerDebug("EdorLNBillPrintSave","保全清单即将合并模板");
    		//合并VTS文件
    		...
    		//把dataStream存储到磁盘文件
    		//loggerDebug("EdorLNBillPrintSave","存储文件到"+strVFPathName);
    		AccessVtsFile.saveToFile(dataStream,strVFPathName);
    		//loggerDebug("EdorLNBillPrintSave","==> Write VTS file to disk ");

    		//loggerDebug("EdorLNBillPrintSave","===strVFFileName : "+strVFFileName);
