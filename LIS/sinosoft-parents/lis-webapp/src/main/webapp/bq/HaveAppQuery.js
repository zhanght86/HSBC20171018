...
function getQueryResult()
{
	...
	mySql1.setResourceName("bq.HaveAppQueryInputSql");//指定使用的properties文件名
...
function easyQueryClick()
{
	...
	mySql2.setResourceName("bq.HaveAppQueryInputSql");//指定使用的properties文件名
	mySql2.setSqlId(sqlid2);//指定使用的Sql的id
	mySql2.addSubPara(fm.SubPer.value);//指定传入的参数
	mySql2.addSubPara(fm.EdorType.value);//指定传入的参数
	mySql2.addSubPara(fm.SubManageCom.value);//指定传入的参数
	mySql2.addSubPara(fm.DispPer.value);//指定传入的参数
	mySql2.addSubPara(fm.GrpContNo.value);//指定传入的参数
	mySql2.addSubPara(fm.SubState.value);//指定传入的参数
...
function getEdorInfo()
{
	...
	mySql3.setResourceName("bq.HaveAppQueryInputSql");//指定使用的properties文件名
