...
<%
//name : EdorPremBillPrintSave.jsp
//Creator  ：liurx
//Date ：2005-08-08
%>
<!--用户校验类-->
...
<%
  		//loggerDebug("EdorPremBillPrintSave","保全清单打印开始..........");
  		String Content = "";
  		CErrors tError = null;
  		String FlagStr = "Fail";
  		String strOperation = "";
        ...
        loggerDebug("EdorPremBillPrintSave","startdate:"+StartDate);
        loggerDebug("EdorPremBillPrintSave","EndDate:"+EndDate);
        ...
        tTransferData.setNameAndValue("Type", "001");
        tVData.add(tG);
        ...
        {
          loggerDebug("EdorPremBillPrintSave","保全清单打印失败！");
          FlagStr = "Fail";
        ...
        else
        {
          ...
          if(txmlExport==null)
          {
        	loggerDebug("EdorPremBillPrintSave","打印失败,原因是＝＝"+tError.getFirstError());
        	FlagStr = "Fail";
      	  ...
      	  {
        	loggerDebug("EdorPremBillPrintSave","保全清单即将合并模板");
    		//合并VTS文件
    		...
    		//把dataStream存储到磁盘文件
    		//loggerDebug("EdorPremBillPrintSave","存储文件到"+strVFPathName);
    		AccessVtsFile.saveToFile(dataStream,strVFPathName);
    		//loggerDebug("EdorPremBillPrintSave","==> Write VTS file to disk ");

    		//loggerDebug("EdorPremBillPrintSave","===strVFFileName : "+strVFFileName);
