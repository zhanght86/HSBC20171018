...
function initInpBox()
{
  ...
  {
    alert("在EdorPMBillPrintInit.jsp-->InitInpBox函数中发生异常:初始化界面错误!");
  }
}
...
function initSelBox()
{
  ...
  {
    alert("在EdorPMBillPrintInit.jsp-->InitSelBox函数中发生异常:初始化界面错误!");
  }
}
...
function initForm()
{
  ...
  {
    alert("EdorPMBillPrintInit.jsp-->InitForm函数中发生异常:初始化界面错误!");
  }
}
