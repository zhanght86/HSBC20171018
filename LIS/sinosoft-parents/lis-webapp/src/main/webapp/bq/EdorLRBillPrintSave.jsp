...
<%
  		//loggerDebug("EdorLRBillPrintSave","保全清单打印开始..........");
  		String Content = "";
  		CErrors tError = null;
  		String FlagStr = "Fail";
  		String strOperation = "";
        ...
        loggerDebug("EdorLRBillPrintSave","startdate:"+StartDate);
        loggerDebug("EdorLRBillPrintSave","EndDate:"+EndDate);
        ...
        tTransferData.setNameAndValue("Type", "017");
        tVData.add(tG);
        ...
        {
          loggerDebug("EdorLRBillPrintSave","保全清单打印失败！");
          FlagStr = "Fail";
        ...
        else
        {
          ...
          if(txmlExport==null)
          {
        	loggerDebug("EdorLRBillPrintSave","打印失败,原因是＝＝"+tError.getFirstError());
        	FlagStr = "Fail";
      	  ...
      	  {
        	loggerDebug("EdorLRBillPrintSave","保全清单即将合并模板");
    		//合并VTS文件
    		...
    		//把dataStream存储到磁盘文件
    		//loggerDebug("EdorLRBillPrintSave","存储文件到"+strVFPathName);
    		AccessVtsFile.saveToFile(dataStream,strVFPathName);
    		//loggerDebug("EdorLRBillPrintSave","==> Write VTS file to disk ");

    		//loggerDebug("EdorLRBillPrintSave","===strVFFileName : "+strVFFileName);
