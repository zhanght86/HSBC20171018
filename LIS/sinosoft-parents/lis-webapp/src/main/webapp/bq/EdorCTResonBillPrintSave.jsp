...
<%
//name : EdorCTResonBillPrintSave.jsp
//Creator  ：liurx
//Date ：2005-08-08
%>
<!--用户校验类-->
...
<%
  		//loggerDebug("EdorCTResonBillPrintSave","保全清单打印开始..........");
  		String Content = "";
  		CErrors tError = null;
  		String FlagStr = "Fail";
  		String strOperation = "";
        ...
        loggerDebug("EdorCTResonBillPrintSave","startdate:"+StartDate);
        loggerDebug("EdorCTResonBillPrintSave","EndDate:"+EndDate);
        ...
        tTransferData.setNameAndValue("EdorType", sEdorType);
         tTransferData.setNameAndValue("Type", "008");
        tVData.add(tG);
        ...
        {
          loggerDebug("EdorCTResonBillPrintSave","保全清单打印失败！");
          FlagStr = "Fail";
        ...
        else
        {
          ...
          if(txmlExport==null)
          {
        	loggerDebug("EdorCTResonBillPrintSave","打印失败,原因是＝＝"+tError.getFirstError());
        	FlagStr = "Fail";
      	  ...
      	  {
        	loggerDebug("EdorCTResonBillPrintSave","保全清单即将合并模板");
    		//合并VTS文件
    		...
    		//把dataStream存储到磁盘文件
    		//loggerDebug("EdorCTResonBillPrintSave","存储文件到"+strVFPathName);
    		AccessVtsFile.saveToFile(dataStream,strVFPathName);
    		//loggerDebug("EdorCTResonBillPrintSave","==> Write VTS file to disk ");

    		//loggerDebug("EdorCTResonBillPrintSave","===strVFFileName : "+strVFFileName);
