...
function initInpBox()
{
  ...
  {
    alert("在EdorAllBillPrintInit.jsp-->InitInpBox函数中发生异常:初始化界面错误!");
  }
}
...
function initSelBox()
{
  ...
  {
    alert("在EdorAllBillPrintInit.jsp-->InitSelBox函数中发生异常:初始化界面错误!");
  }
}
...
function initForm()
{
  ...
  {
    alert("EdorAllBillPrintInit.jsp-->InitForm函数中发生异常:初始化界面错误!");
  }
}
