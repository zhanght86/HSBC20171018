...
<html> 
<% 
//程序名称：EdorNoticeRePrintInput.jsp
//程序功能：保全通知书在线打印控制台
...
<SCRIPT src="./EdorNoticeRePrint.js"></SCRIPT>
<LINK href="../common/css/Project.css" rel=stylesheet type=text/css>
<LINK href="../common/css/Project3.css" rel=stylesheet type=text/css>
<LINK href="../common/css/mulLine.css" rel=stylesheet type=text/css>
<%@include file="EdorNoticeRePrintInit.jsp"%>
<title>保全通知书打印 </title>   
</head>
<body  onload="initForm();" >
  <form  action="./EdorNoticeRePrintSave.jsp" method=post name=fm id=fm target="fraSubmit">
    <!-- 查询部分 -->
...
<div id = divBonus style= "display: ''">
  ...
  <br><br>
   <table>
  	...
  	<!--<p>
      <INPUT VALUE="补打通知书" class= cssButton TYPE=button onClick="printNotice();"> 
  	</p>  	-->
     <a href="javascript:void(0);" class="button"onClick="printNotice();">补打通知书</a>
     <br><br><br><br>
