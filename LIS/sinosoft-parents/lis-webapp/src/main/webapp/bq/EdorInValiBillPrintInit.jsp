<%
//程序名称：EdorInValiBillPrintInit.jsp
//程序功能：清单打印
...
function initInpBox()
{
  ...
  {
    alert("在EdorInValiBillPrintInit.jsp-->InitInpBox函数中发生异常:初始化界面错误!");
  }
}
...
function initSelBox()
{
  ...
  {
    alert("在EdorInValiBillPrintInit.jsp-->InitSelBox函数中发生异常:初始化界面错误!");
  }
}
...
function initForm()
{
  ...
  {
    alert("EdorInValiBillPrintInit.jsp-->InitForm函数中发生异常:初始化界面错误!");
  }
}
