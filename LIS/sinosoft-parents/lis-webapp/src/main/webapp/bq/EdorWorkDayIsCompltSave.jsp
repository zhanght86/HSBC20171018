...
<%
  		//loggerDebug("EdorWorkDayIsCompltSave","保全清单打印开始..........");
  		String Content = "";
  		CErrors tError = null;
  		String FlagStr = "Fail";
  		String strOperation = "";
        ...
        loggerDebug("EdorWorkDayIsCompltSave","startdate:"+StartDate);
        loggerDebug("EdorWorkDayIsCompltSave","EndDate:"+EndDate);
        ...
        tTransferData.setNameAndValue("NewRePortFlag","5");
        tTransferData.setNameAndValue("Type", "034");
        tVData.add(tG);
        ...
        {
          loggerDebug("EdorWorkDayIsCompltSave","保全清单打印失败！");
          FlagStr = "Fail";
        ...
        else
        {
          ...
          if(txmlExport==null)
          {
        	loggerDebug("EdorWorkDayIsCompltSave","打印失败,原因是＝＝"+tError.getFirstError());
        	FlagStr = "Fail";
      	  ...
      	  {
        	loggerDebug("EdorWorkDayIsCompltSave","保全清单即将合并模板");
    		//合并VTS文件
    		...
    		//把dataStream存储到磁盘文件
    		//loggerDebug("EdorWorkDayIsCompltSave","存储文件到"+strVFPathName);
    		AccessVtsFile.saveToFile(dataStream,strVFPathName);
    		//loggerDebug("EdorWorkDayIsCompltSave","==> Write VTS file to disk ");

    		//loggerDebug("EdorWorkDayIsCompltSave","===strVFFileName : "+strVFFileName);
