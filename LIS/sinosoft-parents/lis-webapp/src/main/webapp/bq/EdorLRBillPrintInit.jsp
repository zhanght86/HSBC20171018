...
function initInpBox()
{
  ...
  {
    alert("在EdorLRBillPrintInit.jsp-->InitInpBox函数中发生异常:初始化界面错误!");
  }
}
...
function initSelBox()
{
  ...
  {
    alert("在EdorLRBillPrintInit.jsp-->InitSelBox函数中发生异常:初始化界面错误!");
  }
}
...
function initForm()
{
  ...
  {
    alert("EdorLRBillPrintInit.jsp-->InitForm函数中发生异常:初始化界面错误!");
  }
}
