...
<%
//name : EdorInValiBillPrintSave.jsp
//Creator  ：liurx
//Date ：2005-08-08
%>
<!--用户校验类-->
...
<%
  		//loggerDebug("EdorTerminateBillPrintSave","保全清单打印开始..........");
  		String Content = "";
  		CErrors tError = null;
  		String FlagStr = "Fail";
  		String strOperation = "";
        ...
        loggerDebug("EdorTerminateBillPrintSave","startdate:"+StartDate);
        loggerDebug("EdorTerminateBillPrintSave","EndDate:"+EndDate);
        ...
        tTransferData.setNameAndValue("Type", "029");
        tVData.add(tG);
        ...
        {
          loggerDebug("EdorTerminateBillPrintSave","保全清单打印失败！");
          FlagStr = "Fail";
        ...
        else
        {
          ...
          if(txmlExport==null)
          {
        	loggerDebug("EdorTerminateBillPrintSave","打印失败,原因是＝＝"+tError.getFirstError());
        	FlagStr = "Fail";
      	  ...
      	  {
        	loggerDebug("EdorTerminateBillPrintSave","保全清单即将合并模板");
    		//合并VTS文件
    		...
    		//把dataStream存储到磁盘文件
    		//loggerDebug("EdorTerminateBillPrintSave","存储文件到"+strVFPathName);
    		AccessVtsFile.saveToFile(dataStream,strVFPathName);
    		//loggerDebug("EdorTerminateBillPrintSave","==> Write VTS file to disk ");

    		//loggerDebug("EdorTerminateBillPrintSave","===strVFFileName : "+strVFFileName);
