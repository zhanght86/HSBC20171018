...
{
	    //alert(sCodeListType);
    if (sCodeListType == "NewWRePortFlag")
    {
        //
        if (oCodeListField.value == 3)
        {
            document.all("divItem").style.display = "";
        }else
        	{
        		document.all("divItem").style.display = "none";
        		}
    }
     //CodeListType == ComGrade
    //alert(oCodeListField.value);
}