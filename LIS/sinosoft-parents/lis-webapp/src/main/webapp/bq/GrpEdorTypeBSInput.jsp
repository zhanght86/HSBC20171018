...
<script>
	...
	<SCRIPT src="GrpEdorTypeBS.js"></SCRIPT>
	<%@include file="GrpEdorTypeBSInit.jsp"%>
...
<body  onload="initForm(); " >
  ...
  <table class=common>
    <TR  class= common> 
      ...
      <TD class = input >
      	<Input class=codeno  readonly name=EdorType><input class=codename name=EdorTypeName readonly=true>
      </TD>
  ...
  <table>
   ...
   <Div  id= "divLCGrpState" style= "display: ''">
     ...
     <tr class=common>
       <TD  class= title> 中断日期 </TD>
       <TD  class= input><input class="multiDatePicker" dateFormat="short" name="EndDate" ><font size=1 color='#ff0000'><b>*</b></font></TD>                    
