<html> 
<% 
//程序名称：WFEdorTestInput.jsp
//程序功能：保全工作流-保全无扫描申请
//创建日期：2005-11-10 15:13:22
//创建人  ：zhangtao
...
<head >
  ...
  <SCRIPT src="WFEdorTest.js"></SCRIPT>
  <LINK href="../common/css/Project.css" rel=stylesheet type=text/css>
  <LINK href="../common/css/Project3.css" rel=stylesheet type=text/css>
  <LINK href="../common/css/mulLine.css" rel=stylesheet type=text/css>  
  <%@include file="WFEdorTestInit.jsp"%>
...
<body  onload="initForm();" >
  <form action="./WFEdorTestSave.jsp" method=post name=fm id=fm target="fraSubmit">
...
<Div  id= "divSearchAll" style= "display: 'none'">  
    ...
    <div class="maxbox">
		...
		<!--<INPUT class=cssButton id="riskbutton" VALUE="申请试算" TYPE=button onClick="applyMission();">-->
        <a href="javascript:void(0);" id="riskbutton" class="button" onClick="applyMission();">申请试算</a>
	<br>
	</Div>
    <table>
    	<tr>
	...
	<!--<INPUT class= cssButton TYPE=button VALUE="保全试算" onclick="GoToBusiDeal();"> 
	<INPUT class= cssButton TYPE=button VALUE="试算完毕" onclick="EdorTestFinish();">-->
    <a href="javascript:void(0);" class="button" onClick="GoToBusiDeal();">保全试算</a>
    <a href="javascript:void(0);" class="button" onClick="EdorTestFinish();">试算完毕</a>
