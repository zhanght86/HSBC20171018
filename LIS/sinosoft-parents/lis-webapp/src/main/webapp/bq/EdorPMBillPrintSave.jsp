...
<%
  		//loggerDebug("EdorPMBillPrintSave","保全清单打印开始..........");
  		String Content = "";
  		CErrors tError = null;
  		String FlagStr = "Fail";
  		String strOperation = "";
        ...
        loggerDebug("EdorPMBillPrintSave","startdate:"+StartDate);
        loggerDebug("EdorPMBillPrintSave","EndDate:"+EndDate);
        ...
        tTransferData.setNameAndValue("Type", "005");
        tVData.add(tG);
        ...
        {
          loggerDebug("EdorPMBillPrintSave","保全清单打印失败！");
          FlagStr = "Fail";
        ...
        else
        {
          ...
          if(txmlExport==null)
          {
        	loggerDebug("EdorPMBillPrintSave","打印失败,原因是＝＝"+tError.getFirstError());
        	FlagStr = "Fail";
      	  ...
      	  {
        	loggerDebug("EdorPMBillPrintSave","保全清单即将合并模板");
    		//合并VTS文件
    		...
    		//把dataStream存储到磁盘文件
    		//loggerDebug("EdorPMBillPrintSave","存储文件到"+strVFPathName);
    		AccessVtsFile.saveToFile(dataStream,strVFPathName);
    		//loggerDebug("EdorPMBillPrintSave","==> Write VTS file to disk ");

    		//loggerDebug("EdorPMBillPrintSave","===strVFFileName : "+strVFFileName);
