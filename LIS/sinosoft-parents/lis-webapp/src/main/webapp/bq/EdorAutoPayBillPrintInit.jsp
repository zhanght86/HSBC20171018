<%
//程序名称：EdorAutoPayBillPrintInit.jsp
//程序功能：清单打印
...
function initInpBox()
{
  ...
  {
    alert("在EdorAutoPayBillPrintInit.jsp-->InitInpBox函数中发生异常:初始化界面错误!");
  }
}
...
function initSelBox()
{
  ...
  {
    alert("在EdorAutoPayBillPrintInit.jsp-->InitSelBox函数中发生异常:初始化界面错误!");
  }
}
...
function initForm()
{
  ...
  {
    alert("EdorAutoPayBillPrintInit.jsp-->InitForm函数中发生异常:初始化界面错误!");
  }
}
