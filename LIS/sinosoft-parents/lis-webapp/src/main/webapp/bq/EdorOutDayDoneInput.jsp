...
<SCRIPT src="./EdorOutDayDone.js"></SCRIPT>
<LINK href="../common/css/Project.css" rel=stylesheet type=text/css>
<LINK href="../common/css/Project3.css" rel=stylesheet type=text/css>

<LINK href="../common/css/mulLine.css" rel=stylesheet type=text/css>
<%@include file="EdorOutDayDoneInit.jsp"%>
<title>保全系统处理超期提醒清单 </title>
</head>
<body  onload="initForm();" >
  <form  action="./EdorOutDayDoneSave.jsp" method=post name=fm  id=fm target="fraSubmit">
...
保全系统处理超期提醒清单
    ...
    <table  class= common align=center>
       <TR  class= common>
          ...
          <TD  class= input5>
          	<Input class= code name=ManageCom verify="管理机构|notnull" 
...
<div id = "divDate" style= "display: ''">
 <table  class= common align=center>
        <TR  class= common>   
          		...
          		<TD  class= input5 width="25%"><input class="coolDatePicker" dateFormat="short" id="StartDate"  name="StartDate" onClick="laydate
...
src="../common/laydate/skins/default/icon.png" /></a></span>
          		...
          		<TD  class= input5 width="25%"> <input class="coolDatePicker" dateFormat="short" id="EndDate"  name="EndDate" onClick="laydate({elem:'#EndDate'});"  verify="统计止期|notnull&Date"> <span class="icon"><a onClick="laydate({elem: '#EndDate'});"><img src="../common/laydate/skins/default/icon.png" /></a></span>
                </TD>  
      	 </TR>
 </table>
</div>
