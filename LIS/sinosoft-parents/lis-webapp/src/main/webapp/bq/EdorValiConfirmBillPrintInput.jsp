...
<html>
<%
//程序名称：EdorValiConfirmBillPrintInput.jsp
//程序功能：保全清单在线打印控制台
...
<SCRIPT src="./EdorValiConfirmBillPrint.js"></SCRIPT>
<LINK href="../common/css/Project.css" rel=stylesheet type=text/css>
<LINK href="../common/css/Project3.css" rel=stylesheet type=text/css>
<LINK href="../common/css/mulLine.css" rel=stylesheet type=text/css>
<%@include file="EdorValiConfirmBillPrintInit.jsp"%>
<title>保全操作时效清单 </title>
</head>
<body  onload="initForm();" >
  <form  action="./EdorValiConfirmBillPrintSave.jsp" method=post name=fm id=fm target="fraSubmit">
    <!-- 查询部分 -->
<table >
  <tr>
    <td class="common">
