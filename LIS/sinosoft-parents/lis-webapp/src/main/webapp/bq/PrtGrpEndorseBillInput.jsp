...
<meta http-equiv="Content-Type" content="text/html; charset=GBK">
  ...
  <SCRIPT src="./PrtGrpEndorseBill.js"></SCRIPT>
  <SCRIPT src="PEdor.js"></SCRIPT>
  <LINK href="../common/css/Project.css" rel=stylesheet type=text/css>
   <LINK href="../common/css/Project3.css" rel=stylesheet type=text/css>
  <LINK href="../common/css/mulLine.css" rel=stylesheet type=text/css>
  <%@include file="../common/jsp/UsrCheck.jsp"%>
  <%@include file="PrtGrpEndorseBillInit.jsp"%>

  <title>团体批单附属清单打印</title>
</head>
...
<form action="./PEdorQueryOut.jsp" method=post name=fm id=fm target="fraSubmit" >
  ...
  <!-- <INPUT VALUE="查  询" class= cssButton TYPE=button onClick="queryEndorse();"> -->
   ...
   <!--<INPUT VALUE="打印批单附属清单" class= cssButton TYPE=button onClick="print();">-->
    <a href="javascript:void(0);" class="button"onClick="print();">打印批单附属清单</a>
<br><br><br><br>
  <!-- 隐藏域 -->
