...
<%
//name : EdorValiConfirmBillPrintSave.jsp
//Creator  ：liurx
//Date ：2005-08-08
%>
<!--用户校验类-->
...
<%
  		//loggerDebug("EdorValiConfirmBillPrintSave","保全清单打印开始..........");
  		String Content = "";
  		CErrors tError = null;
  		String FlagStr = "Fail";
  		String strOperation = "";
        ...
        loggerDebug("EdorValiConfirmBillPrintSave","startdate:"+StartDate);
        loggerDebug("EdorValiConfirmBillPrintSave","EndDate:"+EndDate);
        ...
        tTransferData.setNameAndValue("Type", "016");
        tVData.add(tG);
        ...
        {
          loggerDebug("EdorValiConfirmBillPrintSave","保全清单打印失败！");
          FlagStr = "Fail";
        ...
        else
        {
          ...
          if(txmlExport==null)
          {
        	loggerDebug("EdorValiConfirmBillPrintSave","打印失败,原因是＝＝"+tError.getFirstError());
        	FlagStr = "Fail";
      	  ...
      	  {
        	loggerDebug("EdorValiConfirmBillPrintSave","保全清单即将合并模板");
    		//合并VTS文件
    		...
    		//把dataStream存储到磁盘文件
    		//loggerDebug("EdorValiConfirmBillPrintSave","存储文件到"+strVFPathName);
    		AccessVtsFile.saveToFile(dataStream,strVFPathName);
    		//loggerDebug("EdorValiConfirmBillPrintSave","==> Write VTS file to disk ");

    		//loggerDebug("EdorValiConfirmBillPrintSave","===strVFFileName : "+strVFFileName);
