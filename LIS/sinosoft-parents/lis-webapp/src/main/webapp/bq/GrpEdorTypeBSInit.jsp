...
function initGrpEdor()
{
  ...
  var strSQL = "select max(startdate) from lcgrpcontstate where grpcontno = '"+document.all('GrpContNo').value+"' and enddate is null and statetype='Available' and state = '0'";
