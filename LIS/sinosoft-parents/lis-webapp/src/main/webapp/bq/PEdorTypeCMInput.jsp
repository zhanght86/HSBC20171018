   ...
   <tr class = common>
     ...
     <Div  id= "divCustomerNewInfo" class=maxbox1 style= "display: ">
      <table  class= common>
          ...
          <TD  class= input>
            <Input class="wid common" name=LastNameBak id=LastNameBak verify="姓|notnull&len<=120">
          </TD>
          <TD  class= title>
            名
          </TD>
          <TD  class= input>
            <Input class="wid common" name=FirstNameBak id=FirstNameBak verify="名|notnull&len<=120">
          </TD>
           <TD  class= title>
            客户姓名
          </TD>
        ...
        <TR  class= common>
          ...
          <TD  class= input>
            <Input class= "coolDatePicker" dateFormat="short" name=BirthdayBak verify="日期|DATE" onClick="laydate({elem: '#BirthdayBak'});" id="BirthdayBak"><span class="icon"><a onClick="laydate({elem: '#BirthdayBak'});"><img src="../common/laydate/skins/default/icon.png" /></a></span>
          </TD>
                      <TD  class= title > </TD>
            <TD  class= title > </TD>
        </TR>
    ...
    <Div id= "divEdorquery" style="display: ''">
         ...
         <input class="cssButton" type="button" value=" 重 置 " onclick="edorTypeReturn()">
