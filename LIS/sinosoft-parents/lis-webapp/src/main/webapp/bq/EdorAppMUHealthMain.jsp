...
<%
//程序名称：EdorAppMUHealthMain.jsp
//程序功能：保全人工核保体检资料录入
//创建日期：2005-06-13 12:56:36
//创建人  ：Liurongxiao
...
<!--标题与状态区域-->
	...
	<frameset name="fraSet" cols="0%,*,0%" frameborder="no" border="1" framespacing="0" rows="*">
		...
		String varSrc = "./EdorAppMUHealthInput.jsp?"+"EdorAcceptNo="+pEdorAcceptNo+"&EdorNo="
		                      +pEdorNo+"&ContNo="+pContNo+"&MissionID="+pMissionID+"&SubMissionID="
		                      +pSubMissionID+"&PrtNo="+pPrtNo;
		%>
