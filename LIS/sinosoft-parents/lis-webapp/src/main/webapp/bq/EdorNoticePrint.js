...
function queryNotice()
{
    ...
    else
    {
        ...
        {
     	   alert("没有要打印的保全"+tNoticeTypeName+"！ ");
        }
        initNoticeGrid(tNoticeType);
     	return ;
    }
...
//	                             + " and a.otherno = b.contno and b.polno=b.mainpolno "//otherno存的是contno
//	                             + " and a.ManageCom LIKE '" + comcode.substring(0,6) + "%%'" //登陆机构权限控制
//	                             + " and a.StateFlag = '0' ";
	                             //modify by jiaqiangli 2009-05-13 直接判断loprtmanager 年金生存金都在一块，不需要区分
							...
							strSql = mySql7.getString();
   	                       ...
   	                       break;
   	  //满期领取通知书，其它号码：polno，发送对象：被保人
   	  //给付分类1	GetType1	CHAR(1)	"0--满期金 1--年金" LMDutyGet
...
//							     + " and exists(select 1 from lcget where polno = b.polno and  getdutycode in (select getdutycode from LMDutyGet f where GetType1 = '0' and getdutycode = f.getdutycode))";
							...
							mySql8.addSubPara(window.document.getElementsByName(trim("ManageCom"))[0].value);//指定传入参数
...
//	                             + " and a.StateFlag = '0' ";
							...
							mySql9.addSubPara(window.document.getElementsByName(trim("ManageCom"))[0].value);//指定传入参数
...
//	                             + " and a.ManageCom LIKE '" + comcode.substring(0,6) + "%%'" //登陆机构权限控制
//	                             + " and a.StateFlag = '0' and a.makedate>='2009-6-15'"; //只能获取新系统上线后产生的
...
//	                             + " and a.StateFlag = '0' ";
      ...
      //<!-- XinYQ added on 2006-03-06 : 付费通知书(续期领取形式变更) : BGN -->
...
//	                             +    "and a.StateFlag = '0'";
							...
							mySql13.addSubPara(window.document.getElementsByName(trim("NoticeNo"))[0].value);//指定传入参数
							...
							strSql = mySql13.getString();
   	                        ...
   	                        break;
      //<!-- XinYQ added on 2006-03-06 : 付费通知书(续期领取形式变更) : END -->

      //<!-- XinYQ added on 2006-06-28 : 收付费方式变更通知书 : BGN -->
...
//   	  
							...
							mySql14.addSubPara(window.document.getElementsByName(trim("NoticeNo"))[0].value);//指定传入参数
							...
							strSql = mySql14.getString();
   	                        ...
   	                        break;
      //<!-- XinYQ added on 2006-06-28 : 收付费方式变更通知书 : END -->
...
//	                             + " and a.StateFlag = '0' ";	
							...
							mySql18.addSubPara(window.document.getElementsByName(trim("ManageCom"))[0].value);//指定传入参数
...
//	                             + " and a.StateFlag = '0' ";	 
							...
							mySql19.addSubPara(window.document.getElementsByName(trim("ManageCom"))[0].value);//指定传入参数
...
//	                             + " and a.StateFlag = '0' ";
							...
							mySql20.addSubPara(window.document.getElementsByName(trim("ManageCom"))[0].value);//指定传入参数
