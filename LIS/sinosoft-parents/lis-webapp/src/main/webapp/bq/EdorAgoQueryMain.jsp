 ...
 * @version  : 1.00, 1.01
 * @date     : 2005-12-15, 2006-03-21
 * @direction: 保全人工核保投(被)保人既往保全查询总界面
 ******************************************************************************/
%>
...
<frameset name="fraMain" framespacing="0" frameborder="no" rows="0,0,0,0,*" cols="*" border="1">
    ...
    <frameset name="fraSet" framespacing="0" frameborder="no" rows="*" cols="0%,*,0%" border="1">
        ...
        <!-- 实现交互的区域 -->
        <frame id="fraInterface" name="fraInterface" src="EdorAgoQueryInput.jsp?CustomerNo=<%=request.getParameter("CustomerNo")%>&EdorAcceptNo=<%=request.getParameter("EdorAcceptNo")%>" scrolling="auto">
        <!-- 下一步操作区域 -->
