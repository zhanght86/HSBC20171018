...
<%
//name : EdorBankBillPrintSave.jsp
//Creator  ：liurx
//Date ：2005-08-08
%>
<!--用户校验类-->
...
<%
  		//loggerDebug("EdorBankBillPrintSave","保全清单打印开始..........");
  		String Content = "";
  		CErrors tError = null;
  		String FlagStr = "Fail";
  		String strOperation = "";
        ...
        loggerDebug("EdorBankBillPrintSave","startdate:"+StartDate);
        loggerDebug("EdorBankBillPrintSave","EndDate:"+EndDate);
        ...
        tTransferData.setNameAndValue("Type", "002");
        tVData.add(tG);
        ...
        {
          loggerDebug("EdorBankBillPrintSave","保全清单打印失败！");
          FlagStr = "Fail";
        ...
        else
        {
          ...
          if(txmlExport==null)
          {
        	loggerDebug("EdorBankBillPrintSave","打印失败,原因是＝＝"+tError.getFirstError());
        	FlagStr = "Fail";
      	  ...
      	  {
        	loggerDebug("EdorBankBillPrintSave","保全清单即将合并模板");
    		//合并VTS文件
    		...
    		//把dataStream存储到磁盘文件
    		//loggerDebug("EdorBankBillPrintSave","存储文件到"+strVFPathName);
    		AccessVtsFile.saveToFile(dataStream,strVFPathName);
    		//loggerDebug("EdorBankBillPrintSave","==> Write VTS file to disk ");

    		//loggerDebug("EdorBankBillPrintSave","===strVFFileName : "+strVFFileName);
