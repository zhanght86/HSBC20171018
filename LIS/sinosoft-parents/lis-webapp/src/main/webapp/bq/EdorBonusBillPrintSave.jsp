...
<%
//name : EdorBonusBillPrintSave.jsp
//Creator  ：liurx
//Date ：2005-08-08
%>
<!--用户校验类-->
...
<%
  		//loggerDebug("EdorBonusBillPrintSave","保全清单打印开始..........");
  		String Content = "";
  		CErrors tError = null;
  		String FlagStr = "Fail";
  		String strOperation = "";
        ...
        String FinaYear = request.getParameter("FinaYear");
        strOperation = request.getParameter("fmtransact");

        loggerDebug("EdorBonusBillPrintSave","startdate:"+StartDate);
        loggerDebug("EdorBonusBillPrintSave","EndDate:"+EndDate);
        ...
        tTransferData.setNameAndValue("Type", "014");
        tTransferData.setNameAndValue("FinaYear",FinaYear); 
        tVData.add(tG);
        ...
        {
          loggerDebug("EdorBonusBillPrintSave","保全清单打印失败！");
          FlagStr = "Fail";
        ...
        else
        {
          ...
          if(txmlExport==null)
          {
        	loggerDebug("EdorBonusBillPrintSave","打印失败,原因是＝＝"+tError.getFirstError());
        	FlagStr = "Fail";
      	  ...
      	  {
        	loggerDebug("EdorBonusBillPrintSave","保全清单即将合并模板");
    		//合并VTS文件
    		...
    		//把dataStream存储到磁盘文件
    		//loggerDebug("EdorBonusBillPrintSave","存储文件到"+strVFPathName);
    		AccessVtsFile.saveToFile(dataStream,strVFPathName);
    		//loggerDebug("EdorBonusBillPrintSave","==> Write VTS file to disk ");

    		//loggerDebug("EdorBonusBillPrintSave","===strVFFileName : "+strVFFileName);
