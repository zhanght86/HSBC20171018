...
<html>
<%
//程序名称：EdorPremBillPrintInput.jsp
//程序功能：保全清单在线打印控制台
...
<SCRIPT src="./EdorPremBillPrint.js"></SCRIPT>
<LINK href="../common/css/Project.css" rel=stylesheet type=text/css>
<LINK href="../common/css/Project3.css" rel=stylesheet type=text/css>
<LINK href="../common/css/mulLine.css" rel=stylesheet type=text/css>
<%@include file="EdorPremBillPrintInit.jsp"%>
<title>保全保费清单打印 </title>
</head>
<body  onload="initForm();" >
  <form  action="./EdorPremBillPrintSave.jsp" method=post name=fm id=fm target="fraSubmit">
    <!-- 查询部分 -->
<table >
  <tr>
    <td class="common">
...
(this,divInvAssBuildInfo);">
    ...
    <table  class= common align=center>
       <TR  class= common>
          ...
          style="background:url(../common/images/select--bg_03.png) no-repeat right center" 
             onclick="showCodeList('PEdorType',[this,EdorTypeName],[0,1],null,SQL,1)" 
           ondblclick="showCodeList('PEdorType',[this,EdorTypeName],[0,1],null,SQL,1)" 
           onKeyUp="showCodeListKey('PEdorType',[this,EdorTypeName],[0,1])"><input type="text" class="codename" name="EdorTypeName" id=EdorTypeName readonly></td>
