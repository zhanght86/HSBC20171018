...
<%
//name : InsuAccYearBillPrintSave.jsp
//Creator  ：liurx
//Date ：2005-08-08
%>
<!--用户校验类-->
...
<%
  		//loggerDebug("InsuAccYearBillPrintSave","保全清单打印开始..........");
  		String Content = "";
  		CErrors tError = null;
  		String FlagStr = "Fail";
  		String strOperation = "";
  ...
  {
  	loggerDebug("InsuAccYearBillPrintSave","获取模板路径失败");
  }
      templatepath = tLDSysVarDB2.getSysVarValue();
       String strTemplatePath = application.getRealPath(templatepath)+"/";
        ...
        loggerDebug("InsuAccYearBillPrintSave","startdate:"+StartDate);
        loggerDebug("InsuAccYearBillPrintSave","EndDate:"+EndDate);
        ...
        tTransferData.setNameAndValue("Type", "028");
        tTransferData.setNameAndValue("ExCelFile", "InsuAccYearList-028");
        ...
        {
          loggerDebug("InsuAccYearBillPrintSave","保全清单打印失败！");
          FlagStr = "Fail";
      ...
      //    if(txmlExport==null)
      //    {
      //  	loggerDebug("InsuAccYearBillPrintSave","打印失败,原因是＝＝"+tError.getFirstError());
      //  	FlagStr = "Fail";
      ...
      //	  else
      //	  {
      //  	loggerDebug("InsuAccYearBillPrintSave","保全清单即将合并模板");
    	//	//合并VTS文件
      ...
      //
    	//	//把dataStream存储到磁盘文件
    	//	//loggerDebug("InsuAccYearBillPrintSave","存储文件到"+strVFPathName);
    	//	AccessVtsFile.saveToFile(dataStream,strVFPathName);
    	//	//loggerDebug("InsuAccYearBillPrintSave","==> Write VTS file to disk ");
      //
    	//	//loggerDebug("InsuAccYearBillPrintSave","===strVFFileName : "+strVFFileName);
