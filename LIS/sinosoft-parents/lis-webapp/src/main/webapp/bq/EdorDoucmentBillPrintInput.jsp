...
<html>
<%
//程序名称：EdorDoucmentBillPrintInput.jsp
//程序功能：保全清单在线打印控制台
...
<SCRIPT src="./EdorDoucmentBillPrint.js"></SCRIPT>
<LINK href="../common/css/Project.css" rel=stylesheet type=text/css>
<LINK href="../common/css/Project3.css" rel=stylesheet type=text/css>
<LINK href="../common/css/mulLine.css" rel=stylesheet type=text/css>
<%@include file="EdorDoucmentBillPrintInit.jsp"%>
<title>保全档案清单 </title>
</head>
<body  onload="initForm();" >
  <form  action="./EdorDoucmentBillPrintSave.jsp" method=post name=fm id=fm target="fraSubmit">
    <!-- 查询部分 -->
<table >
  <tr>
    <td class="common">
    ...
    <table  class= common align=center>
       <TR  class= common>
        <td class="title5">档案类型</td>
          <td class="input5">
          	<input type="text" class="codeno" name="EdorType" id="EdorType"  CodeData="0|^0|永久档案^1|长期档案^2|短期档案" 
