...
<meta http-equiv="Content-Type" content="text/html; charset=GBK">
  ...
  <SCRIPT src="./PEdorTypeEN.js"></SCRIPT>
  <LINK href="../common/css/Project.css" rel=stylesheet type=text/css>
  <LINK href="../common/css/Project3.css" rel=stylesheet type=text/css>
  <LINK href="../common/css/mulLine.css" rel=stylesheet type=text/css>
  <%@include file="../common/jsp/UsrCheck.jsp"%>
  <%@include file="PEdorTypeENInit.jsp"%>

  <title>续保方式变更申请 </title>
</head>
<body  onload="initForm();" >
  <form action="./PEdorTypeENSubmit.jsp" method=post name=fm id=fm target="fraSubmit">
  <div class=maxbox1>
 <TABLE class=common>
    <TR  class= common>
  ...
  <Div id= "divEdorquery" style="display: ''">
    <TABLE>
        <TR>
	       <TD>
            <Input class= cssButton type=Button value="保  存" onclick="edorTypeENSave()">
