...
<%
//name : EdorCancelBillPrintSave.jsp
//Creator  ：liurx
//Date ：2005-08-08
%>
<!--用户校验类-->
...
<%
  		//loggerDebug("EdorCancelBillPrintSave","保全清单打印开始..........");
  		String Content = "";
  		CErrors tError = null;
  		String FlagStr = "Fail";
  		String strOperation = "";
        ...
        loggerDebug("EdorCancelBillPrintSave","startdate:"+StartDate);
        loggerDebug("EdorCancelBillPrintSave","EndDate:"+EndDate);
        ...
        tTransferData.setNameAndValue("Type", "003");
        tVData.add(tG);
        ...
        {
          loggerDebug("EdorCancelBillPrintSave","保全清单打印失败！");
          FlagStr = "Fail";
        ...
        else
        {
          ...
          if(txmlExport==null)
          {
        	loggerDebug("EdorCancelBillPrintSave","打印失败,原因是＝＝"+tError.getFirstError());
        	FlagStr = "Fail";
      	  ...
      	  {
        	loggerDebug("EdorCancelBillPrintSave","保全清单即将合并模板");
    		//合并VTS文件
    		...
    		//把dataStream存储到磁盘文件
    		//loggerDebug("EdorCancelBillPrintSave","存储文件到"+strVFPathName);
    		AccessVtsFile.saveToFile(dataStream,strVFPathName);
    		//loggerDebug("EdorCancelBillPrintSave","==> Write VTS file to disk ");

    		//loggerDebug("EdorCancelBillPrintSave","===strVFFileName : "+strVFFileName);
