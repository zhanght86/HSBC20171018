...
function initInpBox()
{
  ...
  {
    alert("在EdorXTBillPrintInit.jsp-->InitInpBox函数中发生异常:初始化界面错误!");
  }
}
...
function initSelBox()
{
  ...
  {
    alert("在EdorXTBillPrintInit.jsp-->InitSelBox函数中发生异常:初始化界面错误!");
  }
}
...
function initForm()
{
  ...
  {
    alert("EdorXTBillPrintInit.jsp-->InitForm函数中发生异常:初始化界面错误!");
  }
}
