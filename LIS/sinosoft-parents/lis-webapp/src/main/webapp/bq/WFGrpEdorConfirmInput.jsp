...
<head >
  ...
  <SCRIPT src="WFGrpEdorConfirm.js"></SCRIPT>
  <LINK href="../common/css/Project.css" rel=stylesheet type=text/css>
  <LINK href="../common/css/Project3.css" rel=stylesheet type=text/css>
  <LINK href="../common/css/mulLine.css" rel=stylesheet type=text/css>  
  <%@include file="WFGrpEdorConfirmInit.jsp"%>
...
<body  onload="initForm();" >
  <form action="./WFGrpEdorConfirmSave.jsp" method=post name=fm id=fm target="fraSubmit">
	    ...
	    <table  class= common >   
	      	<TR  class= common>
		        ...
		        <td class= input><Input class="wid" class="common" name=EdorAcceptNoSearch id=EdorAcceptNoSearch></td>
	          	...
	          	<td class= input><Input style="background:url(../common/images/select--bg_03.png) no-repeat right center" class="codeno" name=OtherNoType id=OtherNoType ondblclick="showCodeList('gedornotype',[this, OtherNoName], [0, 1]);"onkeyup="showCodeListKey('edornotype', [this, OtherNoName], [0, 1]);" onMouseDown="showCodeListKey('edornotype', [this, OtherNoName], [0, 1]);" onkeydown="QueryOnKeyDown();" ><input class=codename name=OtherNoName id=OtherNoName readonly=true ></td>            	                          
