...
<%
//name : EdorNewContBackBillPrintSave.jsp
//Creator  ：liurx
//Date ：2005-08-08
%>
<!--用户校验类-->
...
<%
  		//loggerDebug("EdorNewContBackBillPrintSave","保全清单打印开始..........");
  		String Content = "";
  		CErrors tError = null;
  		String FlagStr = "Fail";
  		String strOperation = "";
        ...
        loggerDebug("EdorNewContBackBillPrintSave","startdate:"+StartDate);
        loggerDebug("EdorNewContBackBillPrintSave","EndDate:"+EndDate);
        ...
        tTransferData.setNameAndValue("Type", "025");
        tVData.add(tG);
        ...
        {
          loggerDebug("EdorNewContBackBillPrintSave","保全清单打印失败！");
          FlagStr = "Fail";
        ...
        else
        {
          ...
          if(txmlExport==null)
          {
        	loggerDebug("EdorNewContBackBillPrintSave","打印失败,原因是＝＝"+tError.getFirstError());
        	FlagStr = "Fail";
      	  ...
      	  {
        	loggerDebug("EdorNewContBackBillPrintSave","保全清单即将合并模板");
    		//合并VTS文件
    		...
    		//把dataStream存储到磁盘文件
    		//loggerDebug("EdorNewContBackBillPrintSave","存储文件到"+strVFPathName);
    		AccessVtsFile.saveToFile(dataStream,strVFPathName);
    		//loggerDebug("EdorNewContBackBillPrintSave","==> Write VTS file to disk ");

    		//loggerDebug("EdorNewContBackBillPrintSave","===strVFFileName : "+strVFFileName);
