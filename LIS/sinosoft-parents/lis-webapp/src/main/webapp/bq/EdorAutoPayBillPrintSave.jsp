...
<%
//name : EdorAutoPayBillPrintSave.jsp
//Creator  ：liurx
//Date ：2005-08-08
%>
<!--用户校验类-->
...
<%
  		//loggerDebug("EdorAutoPayBillPrintSave","保全清单打印开始..........");
  		String Content = "";
  		CErrors tError = null;
  		String FlagStr = "Fail";
  		String strOperation = "";
        ...
        loggerDebug("EdorAutoPayBillPrintSave","startdate:"+StartDate);
        loggerDebug("EdorAutoPayBillPrintSave","EndDate:"+EndDate);
        ...
        tTransferData.setNameAndValue("Type", "004");
        tVData.add(tG);
        ...
        {
          loggerDebug("EdorAutoPayBillPrintSave","保全清单打印失败！");
          FlagStr = "Fail";
        ...
        else
        {
          ...
          if(txmlExport==null)
          {
        	loggerDebug("EdorAutoPayBillPrintSave","打印失败,原因是＝＝"+tError.getFirstError());
        	FlagStr = "Fail";
      	  ...
      	  {
        	loggerDebug("EdorAutoPayBillPrintSave","保全清单即将合并模板");
    		//合并VTS文件
    		...
    		//把dataStream存储到磁盘文件
    		//loggerDebug("EdorAutoPayBillPrintSave","存储文件到"+strVFPathName);
    		AccessVtsFile.saveToFile(dataStream,strVFPathName);
    		//loggerDebug("EdorAutoPayBillPrintSave","==> Write VTS file to disk ");

    		//loggerDebug("EdorAutoPayBillPrintSave","===strVFFileName : "+strVFFileName);
