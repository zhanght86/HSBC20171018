...
<%
  		//loggerDebug("EdorWorkDayFinishSave","保全清单打印开始..........");
  		String Content = "";
  		CErrors tError = null;
  		String FlagStr = "Fail";
  		String strOperation = "";
        ...
        loggerDebug("EdorWorkDayFinishSave","startdate:"+StartDate);
        loggerDebug("EdorWorkDayFinishSave","EndDate:"+EndDate);
        ...
        tTransferData.setNameAndValue("NewRePortFlag","3");
        tTransferData.setNameAndValue("Type", "032");
        tVData.add(tG);
        ...
        {
          loggerDebug("EdorWorkDayFinishSave","保全清单打印失败！");
          FlagStr = "Fail";
        ...
        else
        {
          ...
          if(txmlExport==null)
          {
        	loggerDebug("EdorWorkDayFinishSave","打印失败,原因是＝＝"+tError.getFirstError());
        	FlagStr = "Fail";
      	  ...
      	  {
        	loggerDebug("EdorWorkDayFinishSave","保全清单即将合并模板");
    		//合并VTS文件
    		...
    		//把dataStream存储到磁盘文件
    		//loggerDebug("EdorWorkDayFinishSave","存储文件到"+strVFPathName);
    		AccessVtsFile.saveToFile(dataStream,strVFPathName);
    		//loggerDebug("EdorWorkDayFinishSave","==> Write VTS file to disk ");

    		//loggerDebug("EdorWorkDayFinishSave","===strVFFileName : "+strVFFileName);
