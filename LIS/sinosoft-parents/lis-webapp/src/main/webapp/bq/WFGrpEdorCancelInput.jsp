...
<body  onload="initForm()" >
  <form action="./WFEdorCancelSave.jsp" method=post name=fm id=fm target="fraSubmit">
    ...
    <!--<INPUT VALUE=" 查 询 " class = cssButton TYPE=button onclick="queryAllGrid()">-->
    ...
    <br>
        <!--<INPUT class=cssButton VALUE=" 申 请 " TYPE=button onClick="applyMission()">-->
        <a href="javascript:void(0);" class="button" onClick="applyMission();">申    请</a>
    <br><br>
    ...
    <div id="divSelfGrid" style="display:''">
        ...
        <div id="divTurnPageSelfGrid" align="center" style="display:'none'">
            <!--<input type="button" class="cssButton" value="首  页" onclick="turnPageSelfGrid.firstPage()">
            <input type="button" class="cssButton" value="上一页" onclick="turnPageSelfGrid.previousPage()">
            <input type="button" class="cssButton" value="下一页" onclick="turnPageSelfGrid.nextPage()">
            <input type="button" class="cssButton" value="尾  页" onclick="turnPageSelfGrid.lastPage()">-->
        </div>
    </div>

    <br>
    <!--<INPUT class= cssButton TYPE=button VALUE=" 保全撤销 " onclick="GoToBusiDeal()">
    <INPUT class= cssButton TYPE=button VALUE="记事本查看" onclick="showNotePad()">-->
      <a href="javascript:void(0);" class="button" onClick="GoToBusiDeal();">保全撤销</a>
...
<!-- ========zhangtao======2005-05-04==========BGN=============================================
    ...
    <input type=button class= cssButton value="批单撤销" onClick="CancelEdorMain();" >
