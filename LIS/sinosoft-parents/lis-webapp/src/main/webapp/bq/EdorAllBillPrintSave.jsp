...
<%
  		//loggerDebug("EdorAllBillPrintSave","保全清单打印开始..........");
  		String Content = "";
  		CErrors tError = null;
  		String FlagStr = "Fail";
  		String strOperation = "";
        ...
        loggerDebug("EdorAllBillPrintSave","startdate:"+StartDate);
        loggerDebug("EdorAllBillPrintSave","EndDate:"+EndDate);
        ...
        tTransferData.setNameAndValue("PayFlag" ,PayFlag);
        tTransferData.setNameAndValue("ScanFlag",ScanFlag);
        tTransferData.setNameAndValue("RePortFlag",RePortFlag);
        
        tTransferData.setNameAndValue("Type", "023");
        tVData.add(tG);
        ...
        {
          loggerDebug("EdorAllBillPrintSave","保全清单打印失败！");
          FlagStr = "Fail";
        ...
        else
        {
          ...
          if(txmlExport==null)
          {
        	loggerDebug("EdorAllBillPrintSave","打印失败,原因是＝＝"+tError.getFirstError());
        	FlagStr = "Fail";
      	  ...
      	  {
        	loggerDebug("EdorAllBillPrintSave","保全清单即将合并模板");
    		//合并VTS文件
    		...
    		//把dataStream存储到磁盘文件
    		//loggerDebug("EdorAllBillPrintSave","存储文件到"+strVFPathName);
    		AccessVtsFile.saveToFile(dataStream,strVFPathName);
    		//loggerDebug("EdorAllBillPrintSave","==> Write VTS file to disk ");

    		//loggerDebug("EdorAllBillPrintSave","===strVFFileName : "+strVFFileName);
