...
<SCRIPT src="./EdorInValiBillPrint.js"></SCRIPT>
<LINK href="../common/css/Project.css" rel=stylesheet type=text/css>
<LINK href="../common/css/Project3.css" rel=stylesheet type=text/css>
<LINK href="../common/css/mulLine.css" rel=stylesheet type=text/css>
<%@include file="EdorInValiBillPrintInit.jsp"%>
<title>保单停效清单 </title>
</head>
<body  onload="initForm();" >
  <form  action="./EdorInValiBillPrintSave.jsp" method=post name=fm id=fm target="fraSubmit">
    <!-- 查询部分 -->
<table >
  <tr>
    <td class="common">
