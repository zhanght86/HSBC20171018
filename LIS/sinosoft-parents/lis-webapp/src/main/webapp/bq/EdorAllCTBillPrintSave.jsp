...
<%
//name : EdorAllCTBillPrintSave.jsp
//Creator  ：liurx
//Date ：2005-08-08
%>
<!--用户校验类-->
...
<%
  		//loggerDebug("EdorAllCTBillPrintSave","保全清单打印开始..........");
  		String Content = "";
  		CErrors tError = null;
  		String FlagStr = "Fail";
  		String strOperation = "";
        ...
        String sNewRePortFlag=request.getParameter("NewRePortFlag");
        strOperation = request.getParameter("fmtransact");

        loggerDebug("EdorAllCTBillPrintSave","startdate:"+StartDate);
        loggerDebug("EdorAllCTBillPrintSave","EndDate:"+EndDate);
        ...
        tTransferData.setNameAndValue("NewRePortFlag", sNewRePortFlag);
        tTransferData.setNameAndValue("Type", "021");
        tVData.add(tG);
        ...
        {
          loggerDebug("EdorAllCTBillPrintSave","保全清单打印失败！");
          FlagStr = "Fail";
        ...
        else
        {
          ...
          if(txmlExport==null)
          {
        	loggerDebug("EdorAllCTBillPrintSave","打印失败,原因是＝＝"+tError.getFirstError());
        	FlagStr = "Fail";
      	  ...
      	  {
        	loggerDebug("EdorAllCTBillPrintSave","保全清单即将合并模板");
    		//合并VTS文件
    		...
    		//把dataStream存储到磁盘文件
    		//loggerDebug("EdorAllCTBillPrintSave","存储文件到"+strVFPathName);
    		AccessVtsFile.saveToFile(dataStream,strVFPathName);
    		//loggerDebug("EdorAllCTBillPrintSave","==> Write VTS file to disk ");

    		//loggerDebug("EdorAllCTBillPrintSave","===strVFFileName : "+strVFFileName);
