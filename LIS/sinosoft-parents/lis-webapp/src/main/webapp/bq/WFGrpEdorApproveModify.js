...
function easyQueryClickAll()
{
	...
	mySql1.setResourceName("bq.WFGrpEdorApproveModifyInputSql");//指定使用的properties文件名
...
//			+ " and activityid = '0000008010' "  //工作流保全-复核修改
...
function easyQueryClickSelf()
{
	...
	mySql3.setResourceName("bq.WFGrpEdorApproveModifyInputSql");//指定使用的properties文件名
...
//			+ " createoperator, makedate, missionid, submissionid, activityid "
//			+ " from lwmission where 1=1  "
//			+ " and activityid = '0000008010' "  //工作流保全-保全确认
//			+ " and processid = '0000000000' "
...
function GoToBusiDeal()
{
	...
	var newWindow = OpenWindowNew("../bq/GEdorApproveModifyFrame.jsp?Interface= ../bq/GEdorAppInput.jsp" + varSrc,"保全审批修改","left");	
