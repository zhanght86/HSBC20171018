...
<body  onload="initForm();" >
  ...
  <Div  id= "divPolGrid1" style= "display: ''">
    ...
    <Div  id= "divLPInsured" style= "display: ''" class=maxbox>
      <table  class= common>
        <TR class = common>
            ...
            <TD  class= input ><input class="coolDatePicker" readonly name=CustomGetPolDate onClick="laydate({elem: '#CustomGetPolDate'});" id="CustomGetPolDate"><span class="icon"><a onClick="laydate({elem: '#CustomGetPolDate'});"><img src="../common/laydate/skins/default/icon.png" /></a></span>
        ...
        <TR class = common>
            ...
            <td class=input><Input class=codeno name=SurrReason id=SurrReason style="background:url(../common/images/guanliyuan-bg.png) no-repeat right center"
 verify="退保原因|code:surrordereason&notnull" ondblclick="return showCodeList('SurrORDeReason',[this,SurrReasonName],[0,1],null,null,null,0,208);" onkeyup="return showCodeListKey('SurrORDeReason',[this,SurrReasonName],[0,1],null,null,null,0,208)" onFocus="showInfo();"><input class=codename name=SurrReasonName id=SurrReasonName readonly=true elementtype=nacessary></td>
            <td  class = title> 投保人与业务员关系 </td>
            <td class= input ><Input class="codeno" name=RelationToAppnt id=RelationToAppnt style="background:url(../common/images/guanliyuan-bg.png) no-repeat right center"
 ondblclick="showCodeList('relationtoappnt',[this,RelationToAppntName],[0,1],null,null,null,0,208);"onkeyup="showCodeListKey('relationtoappnt',[this,RelationToAppntName],[0,1],null,null,null,0,208);"><input class=codename name=RelationToAppntName id=RelationToAppntName readonly=true></td>            
            <TD  class= title > 扣除工本费 </TD>
            <TD  class= input ><input type="checkbox" name="FeeGetFlag" id=FeeGetFlag ></TD>
       </TR>
	   <TR class = common>
            <TD  class= title >  体检费用 </TD>
            <TD  class= input ><input class="readonly wid" readonly name=TJFee id=TJFee value="0" ></TD>
			<TD  class= title >   </TD>
			<TD  class= title >   </TD>
			<TD  class= title >   </TD>
			<TD  class= title >   </TD>
