...
<%
  		//loggerDebug("EdorInValiBillPrintSave","保全清单打印开始..........");
  		String Content = "";
  		CErrors tError = null;
  		String FlagStr = "Fail";
  		String strOperation = "";
        ...
        loggerDebug("EdorInValiBillPrintSave","startdate:"+StartDate);
        loggerDebug("EdorInValiBillPrintSave","EndDate:"+EndDate);
        ...
        tTransferData.setNameAndValue("Type", "007");
        tVData.add(tG);
        ...
        {
          loggerDebug("EdorInValiBillPrintSave","保全清单打印失败！");
          FlagStr = "Fail";
        ...
        else
        {
          ...
          if(txmlExport==null)
          {
        	loggerDebug("EdorInValiBillPrintSave","打印失败,原因是＝＝"+tError.getFirstError());
        	FlagStr = "Fail";
      	  ...
      	  {
        	loggerDebug("EdorInValiBillPrintSave","保全清单即将合并模板");
    		//合并VTS文件
    		...
    		//把dataStream存储到磁盘文件
    		//loggerDebug("EdorInValiBillPrintSave","存储文件到"+strVFPathName);
    		AccessVtsFile.saveToFile(dataStream,strVFPathName);
    		//loggerDebug("EdorInValiBillPrintSave","==> Write VTS file to disk ");

    		//loggerDebug("EdorInValiBillPrintSave","===strVFFileName : "+strVFFileName);
