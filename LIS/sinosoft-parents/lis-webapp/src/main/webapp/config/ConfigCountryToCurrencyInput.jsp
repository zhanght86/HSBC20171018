...
<head >
  ...
  <%@include file="ConfigCountryToCurrencyInit.jsp"%>
  <SCRIPT src="ConfigCountryToCurrencyInput.js"></SCRIPT>
</head>
<body  onload="initForm();" >
 
  <form action="./ConfigCountryToCurrencySave.jsp" method=post name=fm id=fm target="fraSubmit">
    <table>
    	<tr>
    		<td class=common>
