...
<head >
  ...
  <%@include file="ConfigCurrencyInit.jsp"%>
  <SCRIPT src="ConfigCurrencyInput.js"></SCRIPT>
</head>
<body  onload="initForm();" >
 
  <form action="./ConfigCurrencySave.jsp" method=post name=fm id=fm target="fraSubmit">	 
    <table>
    	<tr>
    		<td class=common>
