...
function queryMulCurrencyGrid()
{
	var sqlid1="ConfigCountryToCurrencyInputSql1";
	var mySql1=new SqlClass();
	
	mySql1.setResourceName("config.ConfigCountryToCurrencyInputSql"); //指定使用的properties文件名
  mySql1.setSqlId(sqlid1);//指定使用的Sql的id
  mySql1.addSubPara('1');//指定传入的参数
	var aSQL=mySql1.getString();
	
  turnPage.queryModal(aSQL, MulCurrencyGrid);
}               
