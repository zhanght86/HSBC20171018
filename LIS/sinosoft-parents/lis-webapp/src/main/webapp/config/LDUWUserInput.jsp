...
<body  onload="initForm();initElementtype();" >
  <form action="./LDUWUserSave.jsp" method=post name=fm id=fm target="fraSubmit">
  ...
  <TR  class= common>
    ...
    <TD  class= input>
      <!--Input class= 'code' name=UWPopedom elementtype=nacessary verify="核保权限|notnull&len<=2" ondblclick=" showCodeList('UWPopedom',[this]);"  onkeyup="return showCodeListKey('UWPopedom',[this]);"-->   
       <Input style="background:url(../common/images/select--bg_03.png) no-repeat right center" class= 'codeno' name=UWPopedom id=UWPopedom  ondblclick="return showCodeList('uwgrppopedom',[this,UWPopedomName],[0,1]);" onclick="return showCodeList('uwgrppopedom',[this,UWPopedomName],[0,1]);" onkeyup="return showCodeListKey('uwgrppopedom', [this,UWPopedomName],[0,1]);"><input class=codename readonly=true name=UWPopedomName id=UWPopedomName elementtype=nacessary>
  ...
  <TR  class= common>-->
    ...
    <TD  class= input>
      <!--Input class= 'code' name=UpUwPopedom verify="上级核保级别|notnull&len<=2" ondblClick="showCodeListEx('upuwpopedom',[this,''],[0,1]);" onkeyup="showCodeListKeyEx('upuwpopedom',[this,''],[0,1]);"-->
       <Input style="background:url(../common/images/select--bg_03.png) no-repeat right center" class= 'codeno' name=UpUwPopedom id=UpUwPopedom verify="上级核保师|notnull&len<=10"  ondblclick="return showCodeList('uwgrppopedom',[this,UpUserCodeName],[0,1]);" onclick="return showCodeList('uwgrppopedom',[this,UpUserCodeName],[0,1]);" onkeyup="return showCodeListKey('uwgrppopedom', [this,UpUserCodeName],[0,1]);"><input class=codename readonly=true name=UpUserCodeName id=UpUserCodeName elementtype=nacessary>
    </TD>
...
<table  class= common align='center' >--><table  class= common style="display:none" >
<TR  class= common>
	 <TD  class= title>
      理赔权限
    </TD>
...
<!-- <TR  class= common
    ...
    <input type=hidden id="MaxGrade" name="MaxGrade"> <br>
