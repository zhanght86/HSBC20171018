<%
/***************************************************************
 * <p>ProName：LCGrpQueryMComManagerMain.jsp</p>
 * <p>Title：归属地客户经理查询中转页</p>
 * <p>Description：归属地客户经理查询中转页</p>
...
<%
	...
	tSrc = "./LCGrpQueryMComManagerInput.jsp";
	tSrc += "?SelNo="+ tSelNo+"&ManageCom="+tManageCom;
%>
		</head>
