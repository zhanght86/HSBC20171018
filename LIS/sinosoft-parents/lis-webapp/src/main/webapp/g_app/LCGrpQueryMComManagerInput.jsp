<%
/***************************************************************
 * <p>ProName：LCGrpQueryMComManagerInput.jsp</p>
 * <p>Title：归属地查询客户经理</p>
 * <p>Description：归属地查询客户经理</p>
...
<head>
	...
	<script src="./LCGrpQueryMComManagerInput.js"></script>
	<%@include file="./LCGrpQueryMComManagerInit.jsp"%>
</head>
...
<form name=fm method=post action="" target=fraSubmit>
	<table>
		<tr>
			...
			<td class=titleImg>归属地客户经理查询条件</td>
		</tr>
	</table>
	...
	<table>
		<tr>
			...
			<td class=titleImg>归属地客户经理信息列表</td>
		</tr>
	</table>
