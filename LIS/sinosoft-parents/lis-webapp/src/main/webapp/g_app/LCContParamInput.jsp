<%
/***************************************************************
 * <p>ProName：LCContParamInput.jsp</p>
...
<head>
	...
	<script src="./LCContParamInput.js"></script>
	<script src="./LCContCommonInput.js"></script>
	<%@include file="./LCContParamInit.jsp"%>
</head>
		...
		<div id="divManageFee" style="display: ''">
			...
			<table class=common>
				<tr class=common>
					...
					<td class=input><input class=codeno name=RiskCode id=RiskCode readonly verify="险种|NOTNULL" style="background:url(../common/images/select--bg_03.png) no-repeat right center" ondblclick="return showCodeList('contplanrisk',[this,RiskName],[0,1],null,'1 and a.policyno = #<%=tBussNo%>#','1','1',null);" onkeyup="return showCodeListKey('contplanrisk',[this,RiskName],[0,1],null,'1 and a.policyno = #<%=tBussNo%>#','1','1',null);">
					<input class=codename name=RiskName id=RiskName elementtype=nacessary readonly></td>
					<td class=title>账户类型</td>
					<td class=input><input class=codeno name=AccType id=AccType readonly verify="账户类型|NOTNULL" style="background:url(../common/images/select--bg_03.png) no-repeat right center" ondblclick="selectAccType(this,AccTypeName,RiskCode);" onkeyup="return showCodeListKey('risktoacc',[this,AccTypeName],[0,1],null,null,null,'1',null);" >
					<input class=codename name=AccTypeName id=AccTypeName elementtype=nacessary readonly></td>
					<td class=title>管理费类型</td>
					<td class=input><input class=codeno name=FeeType id=FeeType readonly verify="管理费类型|NOTNULL" style="background:url(../common/images/select--bg_03.png) no-repeat right center" ondblclick="return showCodeList('mafeetype',[this, FeeTypeName], [0,1],null,null,null,1);" onkeyup="return showCodeListKey('mafeetype',[this, FeeTypeName], [0,1],null,null,null,1);">
					<input class=codename name=FeeTypeName id=FeeTypeName elementtype=nacessary readonly></td>
				</tr>
				<tr id=allTR1 class=common style="display: none">
					<td class=title>初始管理费扣除方式</td>
					<td class=input><input class=codeno name=DeductType id=DeductType readonly style="background:url(../common/images/select--bg_03.png) no-repeat right center" ondblclick="returnShowCodeList('deducttype',[this,DeductTypeName],[0,1]);" onkeyup="returnShowCodeListKey('deducttype',[this,DeductTypeName],[0,1]);">
					<input class=codename name=DeductTypeName id=DeductTypeName elementtype=nacessary readonly></td>
				...
				<tr id=allTR2 class=common style="display: none">
					...
					<td class=input><input class=codeno name=MonthFeeType id=MonthFeeType readonly style="background:url(../common/images/select--bg_03.png) no-repeat right center" ondblclick="returnShowCodeList('deducttype',[this,MonthFeeTypeName],[0,1]);" onkeyup="returnShowCodeListKey('deducttype',[this,MonthFeeTypeName],[0,1]);">
					<input class=codename name=MonthFeeTypeName id=MonthFeeTypeName elementtype=nacessary readonly></td>
				...
				<tr id=allTR3 class=common style="display: none">
					...
					<td class=input><input class=codeno name=YearFeeType id=YearFeeType readonly style="background:url(../common/images/select--bg_03.png) no-repeat right center" ondblclick="returnShowCodeList('deducttype',[this,YearFeeTypeName],[0,1]);" onkeyup="returnShowCodeListKey('deducttype',[this,YearFeeTypeName],[0,1]);">
					<input class=codename name=YearFeeTypeName id=YearFeeTypeName elementtype=nacessary readonly></td>
