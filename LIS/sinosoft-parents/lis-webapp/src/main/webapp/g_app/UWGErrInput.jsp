...
<head >
	...
	<script src="./UWGErrInput.js"></script>
			...
			<div id="tablistdiv1" class="tablist" style="display: none">
				...
				<div id="divCUWMaster" class=maxbox1 style="display:''">
					<table class=common>
						...
						<input class=cssButton value="查  询" type=button onclick="queryCGUWMaster(1)">
