...
<head>
	...
	<script src="./LCGrpUWListInput.js"></script>
	<%@include file="./LCGrpUWListInit.jsp"%>
</head>
<body onload="initForm(); initElementtype();">
<!-- 查询条件 -->
<form name=fm id=fm method=post action="LCGrpUWListSave.jsp" target=fraSubmit>
	<table>
		<tr>
			<td class=common>
	...
	<input class=cssButton type=button value="人工核保" onclick="scanMyInfo();">
