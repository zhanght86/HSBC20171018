...
<script>
	...
	var tAgentCom = "<%=tAgentCom%>";//中介机构编码
...
<form name=fm id=fm method=post action="" target=fraSubmit>
	...
	<div id="divInfo1" class=maxbox1 style="display: ''">
		...
		<input class=cssButton type=button value="查  询" onclick="querySaler();">
		<input class=cssButton type=button value="选  择" onclick="returnSaler();">
	</div>
