/***************************************************************
 * <p>ProName：RenewalBackInput.js</p>
 * <p>Title：抽档回退</p>
...
function queryClick(o) {
	...
	tSQLInfo.setResourceName("g_renewal.RenewalBackSql");
	tSQLInfo.setSqlId("RenewalBackSql1");
...
function showRiskInfo() {
	...
	tSQLInfo = new SqlClass();
	tSQLInfo.setResourceName("g_renewal.RenewalBackSql");
	tSQLInfo.setSqlId("RenewalBackSql2");
...
function reback(){
	...
	var tRenewalNo = ContInfoGrid.getRowColData(tSelNo, 1);

	mOperate="REBACK";
	fm.action = "./RenewalBackSave.jsp?Operate="+ mOperate +"&RenewalType=Manu&RenewalNo="+tRenewalNo;
	submitForm();
}
