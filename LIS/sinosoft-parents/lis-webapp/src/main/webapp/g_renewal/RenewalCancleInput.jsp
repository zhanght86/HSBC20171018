<%
/***************************************************************
 * <p>ProName：RenewalCancleInput.jsp</p>
 * <p>Title：续期核销</p>
 * <p>Description：续期核销</p>
...
<head >
	...
	<script src="./RenewalCancleInput.js"></script>
	<%@include file="./RenewalCancleInit.jsp"%>
</head>
...
<form name=fm id=fm method=post action="" target=fraSubmit>
	...
	<div id="divContInfoGrid" style="display: ''">
		...
		<input class=cssButton type=button value="续期核销" onclick="renewalCancle();">	
	</div>
