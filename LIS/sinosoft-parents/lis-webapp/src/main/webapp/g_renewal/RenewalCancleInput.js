/***************************************************************
 * <p>ProName：RenewalCancleInput.js</p>
 * <p>Title：续期核销</p>
...
function queryClick(o) {
	...
	tSQLInfo.setSqlId("RenewalCancleSql1");
...
function renewalCancle(){
	...
	mOperate="CANCLE";
	fm.action = "./RenewalCancleSave.jsp?Operate="+ mOperate +"&RenewalType=Manu&RenewalNo="+tRenewalNo;
	submitForm();
}
