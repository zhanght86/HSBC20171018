<%
/***************************************************************
 * <p>ProName：RenewalQueryInput.jsp</p>
 * <p>Title：续期查询</p>
...
<head >
	...
	<script src="./RenewalQueryInput.js"></script>
	<%@include file="./RenewalQueryInit.jsp"%>
</head>
		...
		<table class=common>
			<tr class=common>
				...
				<td class=input><input class=codeno name=ManageCom id=ManageCom readonly style="background:url(../common/images/select--bg_03.png) no-repeat right center"
					ondblclick="return showCodeList('managecom',[this, ManageComName],[0, 1],null,null,'1','1',180);" 
					onkeyup="return showCodeListKey('managecom',[this, ManageComName],[0, 1],null,null,'1','1',180);"><input class=codename name=ManageComName readonly></td>
			...
			<tr class=common>
				...
				<td class=title>续期状态</td>
				<td class=input><input class=codeno  name=RenewalState style="background:url(../common/images/select--bg_03.png) no-repeat right center"
					ondblclick="return showCodeList('renewalstate',[this, RenewalStateName],[0, 1],null,null,null,'1',180);" 
					onkeyup="return showCodeListKey('renewalstate',[this, RenewalStateName],[0, 1],null,null,null,'1',180);"><input class=codename name=RenewalStateName readonly></td>
			</tr>
			<tr class=common>
				<td class=title>财务到账起期</td>
