...
<body onload="initForm(); initElementtype();">
	<form name=fm id=fm method=post action="./LLClaimSpotCheckSave.jsp" target=fraSubmit>
		...
		<div id=divQueryInfo class=maxbox1 style="display:''">
			...
			<input value="查  询" class=cssButton type=button name=querybutton onclick="queryClaimRuleInfo();">
		</div>
		<table>
			<tr>
				<td class=common>
		...
		<table class=common>
			...
			<tr class=common>
        <td class=title>抽检比例</td>
				<td class=input><input class="wid common" name=CheckRate verify="抽检比例|notnull&num&value>0&value<=1" elementtype=nacessary></td>
				<td class=title>赔付金额(>=)</td>
				<td class=input><input class="wid common" name=CheckMoney verify="赔付金额|num"></td>
				<td class=title>给付方式</td>      
     	...
     	<tr class=common>
				<td class=title>被保险人与受益人是否一致</td>
