<%
/***************************************************************
 * <p>ProName：LLClaimAssReportMain.jsp</p>
 * <p>Title：报案关联</p>
...
<!--标题与状态区域-->
	...
	<frameset name="fraSet" cols="*" frameborder="yes" border="1" framespacing="0" rows="0,100%,*,0">	
		...
		%>
		<frame id="fraInterface" name="fraInterface" scrolling="auto" src="./LLClaimAssReportInput.jsp?RgtNo=<%=tRgtNo%>&CustomerNo=<%=tCustomerNo%>&Mode=<%=tMode%>">
