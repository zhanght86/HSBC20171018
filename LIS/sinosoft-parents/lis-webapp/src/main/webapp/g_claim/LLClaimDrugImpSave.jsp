<%
/***************************************************************
 * <p>ProName：LLClaimDrugImpSave.jsp</p>
 * <p>Title：药品信息导入</p>
 * <p>Description：药品信息导入</p>
...
<%
	...
	if (tGI==null) {
		...
		try {
			...
			String tFileName = "";
			String tExtenName = "";
			System.out.println("22222222222"+tOperate);
			...
			if ("Succ".equals(tFlagStr)) {
				...
				if (!tBusinessDelegate.submitData(tVData, tOperate, "LLClaimDrugImpUI")) {
