<%
/***************************************************************
 * <p>ProName：LLClaimSpecialCaseMain.jsp</p>
 * <p>Title：特殊立案</p>
 * <p>Description：特殊立案</p>
...
<!--标题与状态区域-->
	...
	<frameset name="fraSet" cols="*" frameborder="yes" border="1" framespacing="0" rows="0,100%,*,0">	
		...
		%>
		<frame id="fraInterface" name="fraInterface" scrolling="auto" src="./LLClaimCaseInput.jsp?GrpRgtNo=<%=tGrpRgtNo%>&Mode=<%=tMode%>">
