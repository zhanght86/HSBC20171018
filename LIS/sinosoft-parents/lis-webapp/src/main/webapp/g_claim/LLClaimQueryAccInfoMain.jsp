<%
/***************************************************************
 * <p>ProName：LLClaimQuerySocialInfoMain.jsp</p>
 * <p>Title：账户信息查询</p>
...
<!--标题与状态区域-->
	...
	<frameset name="fraSet" cols="*" frameborder="yes" border="1" framespacing="0" rows="0,100%,*,0">	
		...
		%>
		<frame id="fraInterface" name="fraInterface" scrolling="auto" src="./LLClaimQueryAccInfoInput.jsp?GrpRgtNo=<%=tGrpRgtNo%>&RgtNo=<%=tRgtNo%>&Mode=<%=tMode%>">
