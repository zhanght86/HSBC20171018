<%
/***************************************************************
 * <p>ProName：LLClaimCustImportMain.jsp</p>
...
<!--标题与状态区域-->
	...
	<frameset name="fraSet" cols="*" frameborder="yes" border="1" framespacing="0" rows="0,100%,*,0">	
		...
		%>
		<frame id="fraInterface" name="fraInterface" scrolling="auto" src="./LLClaimControlImpInput.jsp?Mode=<%=tMode%>&GrpContNo=<%=tGrpContNo%>">
