<%
/***************************************************************
 * <p>ProName：LLClaimCaseCheckdAppInput.jsp</p>
 * <p>Title：案件复核申请页面</p>
 * <p>Description：案件复核申请页面</p>
...
<head>
	...
	<script src="./LLClaimCaseCheckAppInput.js"></script>
	<%@include file="./LLClaimCaseCheckAppInit.jsp"%>
</head>
<body onload="initForm(); initElementtype();">
<form name=fm id=fm method=post action="./LLClaimCaseCheckAppSave.jsp" target=fraSubmit>
	<table>
		<tr>
			<td class=common>
	...
	<input class=cssButton value="申  请" type=button onclick="applayClick();">
	...
	<input class=cssButton value="进入案件" type=button onclick="enterCase();">
	<input class=cssButton value="释放案件" type=button onclick="releaseCase();">
