<%
/***************************************************************
 * <p>ProName：LLClaimCaseReviewInit.jsp</p>
 * <p>Title：赔案审核录入初始化</p>
 * <p>Description：赔案审核录入初始化</p>
	...
	try {
		...
		if (mGrpRegisterNo!=null && mGrpRegisterNo!="" && mGrpRegisterNo!="null") {
			...
			if (fm.CaseType.value!="02") {
				...
				conditionCode = "1 and codealias in (#1#,#2#)";
			} else {
				conditionCode = "1 and codealias=#1#";
			} 
		}
...
function initAcceptInfo() {
		...
		fm.ReviewMoney.value = "";
		fm.CaseType.value = "";
		fm.CaseTypeName.value = "";
		fm.PayType.value = "01";//00-团单给付；01-个人给付
...
function initButton() {
	...
	try {
		...
		if (mMode==1) {
			...
			fm.AllCal.style.display = "none";
			fm.PerCal.style.display = "none";
			//fm.BatchPay.style.display = "none";
			
			fm.stopLLClaimValue.style.display = "none";
			
			fm.AccidentAdd.style.display = "none";
			fm.AccidentModify.style.display = "none";
			fm.AccidentDelete.style.display = "none";
			fm.AccidentClose.style.display = "none";
			fm.AccidentOpen.style.display = "none";
		//	fm.CloseCase.style.display = "none";
			
			fm.AssociateOff.style.display = "none";
			fm.AssociateOn.style.display = "none";
			
			fm.PayInfoSave.style.display = "none";
			fm.ConfirmCase.style.display = "none";
