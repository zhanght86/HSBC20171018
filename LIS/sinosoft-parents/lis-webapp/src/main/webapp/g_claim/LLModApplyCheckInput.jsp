<%
/***************************************************************
 * <p>ProName：LLModApplyCheckInput.jsp</p>
...
<head>
	...
	<script src="LLModApplyCheckInput.js"></script>
	<%@include file="LLModApplyCheckInit.jsp"%>

</head>
<body onload="initForm(); initElementtype();">
<form name=fm id=fm method=post action="./LLModApplyCheckSave.jsp" target=fraSubmit>
	<table>
		<tr>
			<td class=common>
	...
	<div id="divQuery" class=maxbox1 style="display: ''">
		<table class=common>
			<tr class=common>
				...
				<td class=input><input class=codeno name=ManageCom readonly verify="管理机构|code:managecom" style="background:url(../common/images/select--bg_03.png) no-repeat right center" ondblclick="showCodeList('conditioncomcode',[this,ManageComName],[0,1],null,'1 and comgrade=#02# and comcode like #'+tManageCom+'%#',1,'1',180);" onkeyup="return showCodeListKey('managecom',[this,ManageComName],[0,1],null,'1 and comgrade=#02# and comcode like #'+tManageCom+'%#',1,'1',180);"><input class=codename name=ManageComName></td>
 	...
 	<table>
		...
		<table class=common>
			<tr class=common>
				...
				<td class=input><input class=codeno name=CheckConclusion style="background:url(../common/images/select--bg_03.png) no-repeat right center" ondblclick="return showCodeList('modchkconclusion',[this,CheckConclusionName],[0,1],null,null,null,1);" onkeyup="return showCodeListKey('modchkconclusion',[this,CheckConclusionName],[0,1],null,null,null,1);"><input class=codename name=CheckConclusionName elementtype=nacessary></td>
				<td class=title></td>	   		
	   			<td class=input></td>
	   			<td class=title></td>
	   			<td class=input></td>
			...
			<tr class=common>
				...
				<td class=input colspan="5"><textarea name=CheckIdea id=CheckIdea cols="60" rows="3" class=common maxlength=2000 elementtype=nacessary></textarea></td>
			</tr>
			<tr class=common>
			    <td>
			        <input class=cssButton type=button value="提交复核" onclick="submitClick();">
			    </td>
			</tr>
		</table>
	</div>	
