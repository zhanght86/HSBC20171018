<%
/***************************************************************
 * <p>ProName：LLClaimCaseApproveAppInput.js</p>
 * <p>Title：案件审批申请</p>
 * <p>Description：案件审批申请</p>
...
function initParam() {
	...
	try {
		...
		var tAcceptCountSpan = "";
		
		tSQLInfo = new SqlClass();
		tSQLInfo.setResourceName("claim.LLClaimCaseAppSql");
		tSQLInfo.setSqlId("LLClaimCaseAppSql2");
		tSQLInfo.addSubPara(mManageCom);
		
		var tArr = easyExecSql(tSQLInfo.getString(), 1, 0, 1);
		if (tArr!=null && tArr.length==1) {
			
			tAcceptCountSpan = "时效统计："
			+ "受理天数为5个工作日以下 ["+ tArr[0][0] +"] 件，5-10个工作日 ["+ tArr[0][1] +"] 件，"
			+ "10个工作日以上 ["+ tArr[0][2] +"] 件，25个工作日以上 ["+ tArr[0][3] +"] 件，"
			+ "统计时间:"+ tArr[0][4] +" "+ tArr[0][5] +"";
		}
		
		AcceptCountSpan.innerHTML = tAcceptCountSpan; 	
