<%
/***************************************************************
 * <p>ProName：LLClaimSpecialCasePrintInput.jsp</p>
 * <p>Title：特殊立案打印</p>
 * <p>Description：特殊立案打印</p>
...
<head>
	...
	<script src="./LLClaimSpecialCasePrintInput.js"></script>
	<%@include file="./LLClaimSpecialCasePrintInit.jsp"%>
</head>
<body onload="initForm(); initElementtype();">
<form name=fm id=fm method=post action="./LLClaimSpecialCasePrintSave.jsp" target=fraSubmit>
	<table>
		<tr>
			<td class=common>
	...
	<div id="divMissFind" class=maxbox1 style="display: ''">
		<table class=common>
			<tr class=common>
				<td class=title>投保人名称</td>
				<td class=input><input class="wid common" name=SingleGrpName id=SingleGrpName></td>
				<td class=title>被保险人姓名</td>
				<td class=input><input class="wid common" name=SingleCustomerName id=SingleCustomerName></td>
				<td class=title>证件号码</td>
				<td class=input><input class="wid common" name=SingleIdNo id=SingleIdNo></td>				
			</tr>
		</table>		
