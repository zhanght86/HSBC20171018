<%
/***************************************************************
 * <p>ProName：LLClaimCaseApproveInput.jsp</p>
 * <p>Title：案件审批录入</p>
 * <p>Description：案件审批录入</p>
...
<head>
	...
	<script src="./LLClaimCaseApproveInput.js"></script>
	<%@include file="./LLClaimCaseApproveInit.jsp"%>
</head>
<body onload="initForm(); initElementtype();">
<form name=fm id=fm method=post action="./LLClaimCaseApproveSave.jsp" target=fraSubmit>
	<table>
		<tr>
			<td class=common>
	...
	<div id="divAccidentInfo" class=maxbox1 style="display:''">
		...
		<table class=common>
			<tr class=common>
				...
				<td class=input><input class="coolDatePicker" dateFormat="short" name=AccDate elementtype=nacessary readonly onClick="laydate({elem: '#AccDate'});" id="AccDate"><span class="icon"><a onClick="laydate({elem: '#AccDate'});"><img src="../common/laydate/skins/default/icon.png" /></a></span></td> 
			...
			<tr class=common>
				...
				<td class=input colspan=3>
					...
					<input class="wid common" name=AccidentPlace style="width:280px">
				</td>
				<td class=title></td>
				<td class=input></td>
			</tr>
		...
		<div id="divBaseUnit1" class=maxbox1 style="display:''">
			<table class=common>
				<tr class=common>
					...
					<td class=input><input class=codeno name=GiveType style="background:url(../common/images/select--bg_03.png) no-repeat right center" ondblclick="showCodeList('givetype',[this,GiveTypeName],[0,1],null,null,null,1);" onkeyup="showCodeListKeyEx('givetype',[this,GiveTypeName],[0,1],null,null,null,1);"><input class=codename name=GiveTypeName elementtype=nacessary></td>					
					<td class=title></td>
					<td class=input></td>
					<td class=title></td>
					<td class=input></td>	      			
				...
				<tr class=common id=AdjustInfo style="display:''">
					...
					<td class=input><input class=codeno name=AdjReason style="background:url(../common/images/select--bg_03.png) no-repeat right center" ondblclick="return showCodeList('adjreason',[this,AdjReasonName],[0,1],null,null,null,1);" onkeyup="return showCodeListKey('adjreason',[this,AdjReasonName],[0,1],null,null,null,1);"><input class=codename name=AdjReasonName readonly></td>
	...
	<div id=divAuditConclusion class=maxbox1 style="display:''">
		<table class=common>
			<tr class=common>
				...
				<td class=input><input class=codeno name=Conclusion readonly><input class=codename name=ConclusionName readonly></td>
				<td class=title></td>
	   		<td class=input></td>
	   		<td class=title></td>
	   		<td class=input></td>
			...
			<td class=input colspan="5"><textarea name=ReviewAdvice id=ReviewAdvice cols="60" rows="3" class=common maxlength=1000 readonly></textarea></td>
			</tr>
			<tr class=common id=AgainReviewAdvice style="display:none">
			<td class=title>再审意见</td>
			<td class=input colspan="5"><textarea name=AgainReviewAdvice id=AgainReviewAdvice cols="60" rows="3" class=common maxlength=1000 readonly></textarea>
			</tr>
		</table>
	</div>
	<div id=CheckInfo style="display:''">
		<table>
			<tr>
		...
		<div id=divCehckConclusion class=maxbox1 style="display:''">
			<table class=common>
				<tr class=common>
					...
					<td class=input><input class=codeno name=ChkConclusion readonly ><input class=codename name=ChkConclusionName readonly></td>
					<td class=title></td>	   		
			   		<td class=input><input type=hidden class=codeno name=ChkAdvice readonly ><input type=hidden class=codename name=ChkAdviceName readonly></td>
			   		<td class=title></td>
			   		<td class=input></td>
				</tr>
				<tr class=common>
					<td class=title>复核意见<font color="#FF0000">*</font></td>
					<td class=input colspan="5"><textarea name=CheckAdvice id=CheckAdvice cols="60" rows="3" class=common maxlength=2000 readonly></textarea></td>
				</tr>
			</table>
		</div>
	</div>
	
	<div id=ApproveInfo style="display:''">
	<table>
		<tr>
			<td class=common><img src="../common/images/butExpand.gif" style="cursor:hand;" OnClick="showPage(this,divApproveConclusion);"></ td>
			<td class=titleImg>审批结论</td>
		</tr>
	</table>
			
	<div id=divApproveConclusion class=maxbox1 style="display:''">
		<table class=common>
			<tr class=common>
				<td class=title>审批结论</td>
				<td class=input><input class=codeno name=AppConclusion style="background:url(../common/images/select--bg_03.png) no-repeat right center" ondblclick="return showCodeList('chkconclusion',[this,AppConclusionName],[0,1],null,conditionCode,'1',1);" onkeyup="return showCodeListKey('chkconclusion',[this,AppConclusionName],[0,1],null,conditionCode,'1',1);"><input class=codename name=AppConclusionName readonly=true elementtype=nacessary></td>
				<td class=title></td>
		   		<td class=input><input type=hidden class=codeno name=AppAdvice readonly style="background:url(../common/images/select--bg_03.png) no-repeat right center" ondblclick="return showCodeList('chkadvice',[this,AppAdviceName],[0,1],null,null,null,1);" onkeyup="return showCodeListKey('chkadvice',[this,AppAdviceName],[0,1],null,null,null,1);"><input type=hidden class=codename name=AppAdviceName readonly></td>
		   		<td class=title></td>
		   		<td class=input></td>
			</tr>
			<tr class=common>
				<td class=title>审批意见<font color="#FF0000">*</font></td>
				<td class=input colspan="5"><textarea name=ApproveAdvice id=ApproveAdvice cols="60" rows="3" class=common></textarea></td>
			</tr>
		</table>
	</div>
	</div>
	...
	<input class=cssButton name=showTrace value="核赔履历查看" type=button onclick="showCaseTrace();">
	<input class=cssButton name=CaseConfirm value="审批确认" type=button onclick="approveConfirm();">
	<input class=cssButton name=BatchCaseConfirm value="批量审批确认" type=button onclick="batchApproveConfirm();">
	<font color="red" size="2">***提示：只能对下【0-给付或部分给付】、【5-案件回退】结论的案件进行批量审批确认！</font>  
