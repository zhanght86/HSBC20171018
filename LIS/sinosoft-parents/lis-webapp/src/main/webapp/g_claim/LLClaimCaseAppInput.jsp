...
<form name=fm id=fm method=post action="./LLClaimCaseAppSave.jsp" target=fraSubmit>
	...
	<div id="divMissFind" class=maxbox1 style="display: ''">
		...
		<input class=cssButton value="查  询" type=button onclick="queryCommonClick(1);">	
	</div>
	<br>
	...
	<input class=cssButton name='Report' value="申  请" type=button onclick="applyClick();">
