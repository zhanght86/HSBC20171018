...
/////获得参数-险种编码
  ...
  loggerDebug("Risk111801","页面是否需要调用赋值函数=====" + needSetValue);
			    ...
			    sqlVData.add(sqlTransferData);
			  	BusinessDelegate tsqlBusinessDelegate=BusinessDelegate.getBusinessDelegate();
			  	  ...
			  	  {    
			  	       ...
			  	       { 
			  				loggerDebug("Risk111801","查询失败，原因是:" + tsqlBusinessDelegate.getCErrors().getFirstError());
			  		   }
			  		   else
			  		   {
			  			 	loggerDebug("Risk111801","查询失败");				
			  		   }
			  	  }
	riskFlagSSRS=(SSRS)tsqlBusinessDelegate.getResult().get(0);
    loggerDebug("Risk111801","主副险标记====="+riskFlagSSRS.GetText(1,1));
