...
/////获得参数-险种编码
  ...
  String queryCode3="!PayEndYearFlag-"+riskcode+"*0&0";
  ...
  ExeSQL rexeSql = new ExeSQL();
    ...
    loggerDebug("RiskUVA14","祝福险标记====="+riskFlagSSRS.GetText(1,1));
...
<TABLE class=common>
 <TR CLASS=common>
   ...
   <TR CLASS=common>
    ...
    <TD CLASS=input COLSPAN=1>
      <Input class=codeno name=PayEndYearFlag id=PayEndYearFlag verify="交费期间单位 |code:!PayEndYearFlag&notnull" style="background:url(../common/images/select--bg_03.png) no-repeat right center"  ondblclick="return showCodeList('<%=queryCode3%>',[this,PayEndYearFlagName],[0,1]);" onkeyup="return showCodeListKey('<%=queryCode3%>',[this,PayEndYearFlagName],[0,1]);"><input class=codename name=PayEndYearFlagName id=PayEndYearFlagName readonly=true elementtype=nacessary>
    </TD>  
	<TD CLASS=title>
      交费方式
    </TD>
...
<input type=hidden id="inpNeedDutyGrid" name="inpNeedDutyGrid" value="1">
...
window.top.opener.returnFromRiskInput('UVA14');
}
