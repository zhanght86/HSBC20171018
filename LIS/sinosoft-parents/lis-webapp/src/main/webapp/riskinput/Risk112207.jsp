...
/////获得参数-险种编码
  ...
  ExeSQL rexeSql = new ExeSQL();
    ...
    loggerDebug("Risk112207","祝福险标记====="+riskFlagSSRS.GetText(1,1));
...
<TABLE class=common>
 <TR CLASS=common>
   ...
   <TR CLASS=common>
    ...
    <TD CLASS=input COLSPAN=1>
      <Input NAME=PayEndYearFlag id=PayEndYearFlag value="" class="wid readonly" TABINDEX=-1 verify="交费期间单位|notnull">
    </TD>  
	<TD CLASS=title>
      交费方式
    </TD>
    ...
    <TD CLASS=input COLSPAN=1>
      <Input NAME=GetDutyKind   id=GetDutyKind CLASS="wid readonly" readonly TABINDEX=-1>
    </TD>
 </TR>
...
window.top.opener.returnFromRiskInput('112207');
}
