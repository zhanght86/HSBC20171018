...
/////获得参数-险种编码
  ...
  ExeSQL rexeSql = new ExeSQL();
    ...
    loggerDebug("Risk121303","****************RiskCode:"+riskcode);
    riskFlagSSRS = rexeSql.execSQL("select subriskflag from lmriskapp where riskcode='"+riskcode+"'");
    loggerDebug("Risk121303","主副险标记====="+riskFlagSSRS.GetText(1,1));
...
<TABLE class=common>
  ...
  <TR CLASS=common>
    ...
    <TD CLASS=input COLSPAN=1>
      <Input class=wid NAME=MainPolNo>
    </TD>
	<TD CLASS=title></TD>
    <TD CLASS=input></TD>
	<TD CLASS=title></TD>
...
<td class= titleImg>
投保人信息（客户号：<Input class="wid common"  name=AppntCustomerNo id=AppntCustomerNo >
...
<TABLE class=common>
 ...
 <TR CLASS=common>
    ...
    <TD CLASS=input COLSPAN=1>
      <Input NAME=InsuYearFlag id=InsuYearFlag VALUE="Y" CLASS="wid readonly" readonly TABINDEX=-1 verify="保险期间单位|notnull">
    </TD>    
	<TD CLASS=title>
      交费期间
    </TD>
...
<TR CLASS=common> 
    ...
    <TD CLASS=input COLSPAN=1>
       <Input NAME=PayEndYearFlag id=PayEndYearFlag  VALUE="Y" CLASS="wid readonly" readonly TABINDEX=-1 verify="交费期间单位|notnull">
    </TD>
   	<TD CLASS=title>
      保费
    </TD>
...
<TABLE class=common>
 <TR CLASS=common>
    ...
    <TD CLASS=input COLSPAN=1>
      <Input NAME=BonusGetMode id=BonusGetMode VALUE="" CLASS="wid readonly" readonly TABINDEX=-1>
    </TD>
    ...
    <TD CLASS=input COLSPAN=1>
     <Input class=codeno name=GetDutyKind id=GetDutyKind verify="给付方法|code:!GetDutyKind&notnull" style="background:url(../common/images/select--bg_03.png) no-repeat right center"  ondblclick="return showCodeList('<%=queryCode4%>',[this,GetDutyKindName],[0,1]);" onkeyup="return showCodeListKey('<%=queryCode4%>',[this,GetDutyKindName],[0,1]);"><input class=codename name=GetDutyKindName id=GetDutyKindName readonly=true elementtype=nacessary>
    </TD> 
    <TD CLASS=title>
          起领期间
    </TD>
 ...
 <TR CLASS=common>   
    ...
    <TD CLASS=input COLSPAN=1>
      <Input NAME=GetYearFlag id=GetYearFlag  VALUE="" CLASS="wid readonly" readonly TABINDEX=-1 verify="起领期间单位|notnull">
   </TD>
    ...
    <TD CLASS=input COLSPAN=1>
      <Input NAME=AutoPayFlag id=AutoPayFlag VALUE="" CLASS=code CodeData="0|^0|不自动垫交^1|自动垫交" style="background:url(../common/images/guanliyuan-bg.png) no-repeat right center" ondblClick="showCodeListEx('AutoPayFlag',[this],[0]);" onkeyup="showCodeListKeyEx('AutoPayFlag',[this],[0]);" verify="自动垫交标志|notnull" >
    </TD> 
    <TD CLASS=title>
      保单生效日期
    </TD>
 ...
 <TD CLASS=title>
    ...
    <TD CLASS=input COLSPAN=1>
      <Input NAME=LiveGetMode id=LiveGetMode VALUE="" CLASS="wid readonly" readonly TABINDEX=-1>
    </TD>
    <TD CLASS=title>
      领取方式
    </TD>
    <TD CLASS=input COLSPAN=1>
      <Input class=wid NAME=getIntv id=getIntv>
    </TD>
  ...
  <TR CLASS=common>
    ...
    <TD CLASS=input COLSPAN=1>
      <Input class=wid NAME=LiveGetMode id=LiveGetMode>
    </TD>
     </TR>
...
window.top.opener.returnFromRiskInput('121303','<%=needSetValue%>');
haveMenu = 1;
}
