...
/////获得参数-险种编码
  ...
  loggerDebug("Risk121301","页面是否需要调用赋值函数=====" + needSetValue);
  ...
  ExeSQL rexeSql = new ExeSQL();
    ...
    loggerDebug("Risk121301","祝福险标记====="+riskFlagSSRS.GetText(1,1));
...
<TABLE class=common>
	...
	<TR CLASS=common>
		...
		<TD CLASS=input COLSPAN=1><Input class=codeno name=RiskCode id=RiskCode style="background:url(../common/images/select--bg_03.png) no-repeat right center"
...
<TABLE class=common>
	...
	<TR CLASS=common>
		...
		<TD CLASS=input COLSPAN=1><Input class=wid id= NAME=Handler></TD>
		<TD CLASS=title>联合代理人编码</TD>
		<TD CLASS=input COLSPAN=1><Input class=wid id= NAME=AgentCode1></TD>
	</TR>
...
<TABLE class=common>
	...
	<TR CLASS=common>
		...
		<TD CLASS=input COLSPAN=1><Input NAME=AgentCom id=AgentCom VALUE=""
			...
			ondblclick="showCodeList('AgentCom',[this],null,null,'#1# and ManageCom like #' + document.all('ManageCom').value.substring(0,4) + '%# and #' + document.all('ManageCom').value + '# is not null  ','1');"
			onkeyup="return showCodeListKey('AgentCom',[this],null,null,'#1# and ManageCom like #' + document.all('ManageCom').value.substring(0,4) + '%# and #' + document.all('ManageCom').value + '# is not null  ','1');"
...
<TABLE class=common>
	...
	<TR CLASS=common>
		...
		<TD CLASS=input COLSPAN=1><Input NAME=AppntNativePlace id=AppntNativePlace VALUE=""
			CLASS=code ondblclick="return showCodeList('NativePlace', [this]);" style="background:url(../common/images/guanliyuan-bg.png) no-repeat right center"
...
<TABLE class=common>
	...
	<TR CLASS=common>
		...
		<TD CLASS=input COLSPAN=1><Input class=wid id=AppGrpNo NAME=AppGrpNo></TD>
		<TD CLASS=title>单位名称</TD>
		<TD CLASS=input COLSPAN=1><Input class=wid id=AppGrpName NAME=AppGrpName></TD>
		<TD CLASS=title>单位地址</TD>
		<TD CLASS=input COLSPAN=1><Input class=wid id=AppGrpAddress NAME=AppGrpAddress></TD>
	</TR>
...
<TABLE class=common>
	...
	<TR CLASS=common>
		...
		<TD CLASS=title>性别</TD>
		<TD CLASS=input COLSPAN=1><Input NAME=Sex id=Sex VALUE="" MAXLENGTH=1 style="background:url(../common/images/guanliyuan-bg.png) no-repeat right center"
	...
	<TR CLASS=common>
		...
		<TD CLASS=input COLSPAN=1><Input NAME=IDType id=IDType VALUE="" MAXLENGTH=1
			CLASS=code ondblclick="return showCodeList('IDType', [this]);" style="background:url(../common/images/guanliyuan-bg.png) no-repeat right center"
			onkeyup="return showCodeListKey('IDType', [this]);"
		...
		<TD CLASS=input COLSPAN=1><Input NAME=IDNo id=IDNo VALUE="" CLASS="wid common"
			MAXLENGTH=20></TD>
		<TD CLASS=title>国籍</TD>
		<TD CLASS=input COLSPAN=1><Input NAME=NativePlace id=NativePlace VALUE="" style="background:url(../common/images/guanliyuan-bg.png) no-repeat right center"
...
<TABLE class=common>
	...
	<TR CLASS=common STYLE="display: none">
		<TD CLASS=title5>保险期间</TD>
		<TD CLASS=input5 COLSPAN=1><Input class=codeno name=InsuYear id=InsuYear VALUE=""
			verify="保险期间|code:!InsuYear&notnull" style="background:url(../common/images/select--bg_03.png) no-repeat right center"
		...
		<TD CLASS=title5>保险期间单位</TD>
		<TD CLASS=input5 COLSPAN=1><Input NAME=InsuYearFlag id=InsuYearFlag VALUE=""
			class="wid readonly" readonly TABINDEX=-1 verify="保险期间单位|notnull">
		</TD>
	</TR>

	<TR CLASS=common STYLE="display: none">
		<TD CLASS=title5>起领期间</TD>
		<TD CLASS=input5 COLSPAN=1><Input class=codeno name=GetYear id=GetYear
			verify="起领期间|code:!GetYear&notnull" style="background:url(../common/images/select--bg_03.png) no-repeat right center"
		...
		<TD CLASS=title5>起领期间单位</TD>
		<TD CLASS=input5 COLSPAN=1><Input NAME=GetYearFlag id=GetYearFlag VALUE="A"
			class="wid readonly" readonly TABINDEX=-1 verify="起领期间单位|notnull">
		</TD>
	</TR>
	...
	<TR CLASS=common>
		...
		<TD CLASS=input5 COLSPAN=1><Input class=codeno name=PayIntv id=PayIntv
			verify="缴费方式|code:!PayIntv&notnull" style="background:url(../common/images/select--bg_03.png) no-repeat right center"
		...
		<TD CLASS=title5 STYLE="display: none">给付方法</TD>
		<TD CLASS=input5 COLSPAN=1 STYLE="display: none"><Input
			class=codeno name=GetDutyKind id=GetDutyKind verify="给付方法|code:!GetDutyKind&notnull" style="background:url(../common/images/select--bg_03.png) no-repeat right center"
	...
	<TR CLASS=common>
		...
		<TD CLASS=title5>交费期间</TD>
		<TD CLASS=input5 COLSPAN=1><Input class="wid common" id=PayEndYear name=PayEndYear
			verify="交费期间|code:!PayEndYear&notnull">
		</TD>

		<TD CLASS=title5>交费期间单位</TD>
		<TD CLASS=input5 COLSPAN=1><Input NAME=PayEndYearFlag id=PayEndYearFlag VALUE="Y"
			class="wid readonly" readonly TABINDEX=-1 verify="交费期间单位|notnull">
		</TD>

	</TR>
	<TR CLASS=common>
		<TD CLASS=title5>保额</TD>
		<TD CLASS=input5 COLSPAN=1><Input NAME=Amnt id=Amnt VALUE="" MAXLENGTH=12
			CLASS="wid common"></TD>
	
		<TD CLASS=title5>保费</TD>
		<TD CLASS=input5 COLSPAN=1><Input NAME=Prem id=Prem VALUE="" MAXLENGTH=12
			class="wid readonly" readonly ></TD>
	</TR>

	<TR CLASS=common STYLE="display: none">

		<TD CLASS=title5>红利领取方式</TD>
		<TD CLASS=input5 COLSPAN=1><Input NAME=BonusGetMode id=BonusGetMode VALUE=""
			CLASS=codeno   style="background:url(../common/images/select--bg_03.png) no-repeat right center"
...
<TABLE class=common>
	<TR CLASS=common>
		...
		<TD CLASS=input COLSPAN=1><Input NAME=AutoPayFlag id=AutoPayFlag VALUE=""
			CLASS=code CodeData="0|^0|不自动垫交^1|自动垫交" style="background:url(../common/images/select--bg_03.png) no-repeat right center"
		...
		<TD CLASS=input COLSPAN=1><Input NAME=LiveGetMode id=LiveGetMode VALUE=""
			class="wid readonly" readonly TABINDEX=-1></TD>
	</tr>
	<TR CLASS=common>
...
<DIV id=DivPageEnd STYLE="display: ''">
	...
	<input type='hidden' name="AppntNo" id=AppntNo value=""> <!--end-->
...
if(isDia==0) { //如果是打开一个新的窗口，则执行下面的代码
	...
	window.top.opener.returnFromRiskInput('121301','<%=needSetValue%>');
	haveMenu = 1;
}
