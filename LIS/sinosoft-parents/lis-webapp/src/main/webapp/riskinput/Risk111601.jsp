...
//    riskFlagSSRS = rexeSql.execSQL("select subriskflag from lmriskapp where riskcode='"+riskcode+"'");
    ...
    loggerDebug("Risk111601","祝福险标记====="+riskFlagSSRS.GetText(1,1));
...
<INPUT VALUE="关联暂交费信息" TYPE=button class=cssButton onclick="showFee();">
...
<TABLE class=common>
  ...
  <TR CLASS=common>
    ...
    <TD CLASS=input COLSPAN=1>
      <Input id=PrtNo NAME=PrtNo VALUE="" class="readonly wid" readonly TABINDEX=-1 MAXLENGTH=11 verify="印刷号码|notnull&len=11" >
    </TD>
    <TD CLASS=title>
      管理机构
    </TD>
...
<TABLE class=common>
    ...
    <TR CLASS=common>
		...
		<TD CLASS=input COLSPAN=1><Input class=codeno NAME=CurrencyCode id=CurrencyCode verify="币种|code:notnull"
