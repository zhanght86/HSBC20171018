...
String needSetValue = request.getParameter("needSetValue");
  ...
  String queryCode4="!InsuYearFlag-"+riskcode+"*0&0";
  String queryCode5="!PayEndYearFlag-"+riskcode+"*0&0";
   //////////////////////////////////
  String queryCodeApp="";
  ExeSQL rexeSql = new ExeSQL();
    ...
    loggerDebug("RiskTCIR2","祝福险标记====="+riskFlagSSRS.GetText(1,1));
...
<TABLE class=common>
  ...
  <TR CLASS=common>
    ...
    <TD CLASS=input COLSPAN=1>
      <Input NAME=PrtNo id=PrtNo VALUE="" CLASS="wid readonly" readonly TABINDEX=-1 MAXLENGTH=11 verify="印刷号码|notnull&len=11" >
    </TD>
    <TD CLASS=title>
      管理机构
    </TD>
  ...
  <TR CLASS=common>
    ...
    <TD CLASS=input COLSPAN=1>
      <Input NAME=AgentGroup id=AgentGroup VALUE="" CLASS="wid readonly" readonly TABINDEX=-1 MAXLENGTH=12 verify="代理人组别|notnull" >
    </TD>
  </TR>
...
<td class= titleImg>
投保人信息（客户号：<Input class= "common"  name=AppntCustomerNo id=AppntCustomerNo >
...
<TABLE class=common>
  ...
  <TR CLASS=common>
    ...
    <TD CLASS=input COLSPAN=1>
      <Input NAME=AppntRelationToInsured id=AppntRelationToInsured style="background:url(../common/images/guanliyuan-bg.png) no-repeat right center" VALUE="" MAXLENGTH=2 CLASS=code ondblclick="return showCodeList('Relation', [this]);" onkeyup="return showCodeListKey('Relation', [this]);" verify="投保人与被保险人关系|code:Relation&notnull" >
    </TD>
    <TD CLASS=title>
      证件类型
    </TD>
    <TD CLASS=input COLSPAN=1>
      <Input NAME=AppntIDType id=AppntIDType style="background:url(../common/images/guanliyuan-bg.png) no-repeat right center" VALUE="" MAXLENGTH=1 CLASS=code ondblclick="return showCodeList('IDType', [this]);" onkeyup="return showCodeListKey('IDType', [this]);" verify="投保人证件类型|code:IDType" >
    </TD>
    <TD CLASS=title>
      证件号码
    </TD>
  ...
  <TR CLASS=common>
    ...
    <TD CLASS=input COLSPAN=1>
      <Input NAME=AppntOccupationType id=AppntOccupationType VALUE="" CLASS="wid readonly" readonly TABINDEX=-1 verify="被保人职业类别|code:OccupationType" >
    </TD>
  </TR>
...
<td class= titleImg>
被保人信息（客户号：<Input class= "common" name=CustomerNo id=CustomerNo >
...
<TABLE class=common>
  ...
  <TR CLASS=common>
    ...
    <TD CLASS=input COLSPAN=1>
      <Input NAME=OccupationType id=OccupationType VALUE="" CLASS="wid readonly" readonly TABINDEX=-1 verify="被保人职业类别|code:OccupationType" >
    </TD>
  </TR>
...
<TABLE class=common>
 <TR CLASS=common>
    ...
    <TD CLASS=input COLSPAN=1>
      <!--<Input NAME=InsuYearFlag id=InsuYearFlag VALUE="A" CLASS="wid readonly" readonly TABINDEX=-1 verify="保险期间单位|notnull">-->
	  <Input class=codeno name=InsuYearFlag  id=InsuYearFlag verify="保险期间单位|code:!InsuYearFlag&notnull" style="background:url(../common/images/select--bg_03.png) no-repeat right center"  ondblclick="return showCodeList('<%=queryCode4%>',[this,InsuYearFlagName],[0,1]);" onkeyup="return showCodeListKey('<%=queryCode4%>',[this,InsuYearFlagName],[0,1]);"><input class=codename name=InsuYearFlagName id=InsuYearFlagName  readonly=true elementtype=nacessary>
    </TD>
...
<TD CLASS=title>
    ...
    <TD CLASS=input COLSPAN=1>
      <!--<Input NAME=PayEndYearFlag id=PayEndYearFlag value="Y" class="wid readonly" TABINDEX=-1 verify="交费期间单位|notnull">-->
	  
	  <Input class=codeno name=PayEndYearFlag id=PayEndYearFlag verify="交费期间单位|code:!PayEndYearFlag&notnull" style="background:url(../common/images/select--bg_03.png) no-repeat right center"  ondblclick="return showCodeList('<%=queryCode5%>',[this,PayEndYearFlagName],[0,1]);" onkeyup="return showCodeListKey('<%=queryCode5%>',[this,PayEndYearFlagName],[0,1]);"><input class=codename name=PayEndYearFlagName id=PayEndYearFlagName readonly=true elementtype=nacessary>
    </TD> 
	</TR>
	<tr class=common>
<TD CLASS=title>
...
<TABLE class=common>
  ...
  <!--  <TR CLASS=common>
    ...
    <TD CLASS=input COLSPAN=1>
      <Input NAME=GetYear id=GetYear> 
    </TD>
    <TD CLASS=title>
      起领期间单位
    </TD>
    <TD CLASS=input COLSPAN=1>
      <Input NAME=GetYearFlag id=GetYearFlag>
    </TD>-->
    <TD CLASS=title>
      起领日期计算类型
    </TD>
    <TD CLASS=input COLSPAN=1>
      <Input NAME=GetStartType id=GetStartType>
    </TD>
  ...
  <TR CLASS=common>
    ...
    <TD CLASS=input COLSPAN=1>
      <Input NAME=InterestDifFlag id=InterestDifFlag>
    </TD>
    <TD CLASS=title>
      减额交清标志
    </TD>
    <TD CLASS=input COLSPAN=1>
      <Input NAME=SubFlag id=SubFlag>
    </TD>
    <TD CLASS=title>
      是否自动续保
    </TD>
    <TD CLASS=input COLSPAN=1>
      <Input NAME=RnewFlag id=RnewFlag>
    </TD>
  </TR>
...
<Input NAME=GetDutyKind  type="hidden"  id=GetDutyKind CLASS="wid readonly" value = '3' readonly TABINDEX=-1>
<!--需要在险种界面增加-->
...
window.top.opener.returnFromRiskInput('TCIR2','<%=needSetValue%>');
}
