...
/////获得参数-险种编码
  ...
  ExeSQL rexeSql = new ExeSQL();
    ...
    loggerDebug("Risk112401","祝福险标记====="+riskFlagSSRS.GetText(1,1));
...
<TABLE class=common>
  ...
  <TR CLASS=common>
    ...
    <TD CLASS=input COLSPAN=1>
      <Input NAME=AppntZipCode id=AppntZipCode VALUE="" CLASS=common MAXLENGTH=6 verify="投保人邮政编码|zipcode" >
    </TD>
  </TR>
...
<TABLE class=common>
 ...
 <TR CLASS=common>
  ...
  <TR CLASS=common>
    ...
    <TD CLASS=input COLSPAN=1>
      <Input NAME=GetYearFlag id=GetYearFlag  VALUE="A" CLASS="wid readonly" readonly TABINDEX=-1 verify="起领期间单位|notnull">
   </TD>
  </TR>
...
<TR CLASS=common>   
 ...
 <TR CLASS=common>
    ...
    <TD CLASS=input COLSPAN=1>
      <Input NAME=BonusGetMode id=BonusGetMode VALUE="5" CLASS="wid readonly" readonly TABINDEX=-1>
    </TD>
     <TD CLASS=title>
                生存金领取方式
      </TD>
...
window.top.opener.returnFromRiskInput('112401');
}
