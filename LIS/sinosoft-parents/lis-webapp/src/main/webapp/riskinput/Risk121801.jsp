...
/////获得参数-险种编码
  ...
  ExeSQL rexeSql = new ExeSQL();
    ...
    loggerDebug("Risk121801","主附险标记====="+riskFlagSSRS.GetText(1,1));
...
<TABLE class=common>
 ...
 <TR CLASS=common>
    ...
    <TD CLASS=input COLSPAN=1>
      <Input NAME=Amnt VALUE="" MAXLENGTH=12 CLASS=common>
    </TD>
    ...
    <TD CLASS=input COLSPAN=1>
      <Input NAME=Prem VALUE="" MAXLENGTH=12 CLASS=common >
    </TD>
...
<TABLE class=common>
 <TR CLASS=common>
    ...
    <TD CLASS=input COLSPAN=1>
      <Input NAME=InsuYear VALUE="" CLASS=common >
    </TD>
    ...
    <TD CLASS=input COLSPAN=1>
      <Input NAME=PayEndYear VALUE="" CLASS=common >
    </TD>
  ...
  <TR CLASS=common>
    ...
    <TD CLASS=input COLSPAN=1>
      <Input NAME=CValiDate VALUE="<%= ValidDate %>" CLASS=common verify="保单生效日期|notnull&date" >
    </TD>
    ...
    <TD CLASS=input COLSPAN=1>
      <Input NAME=InsuYearFlag value="" class="common">
    </TD>
   ...
   <TR CLASS=common>
    ...
    <TD CLASS=input COLSPAN=1>
      <Input NAME=PayEndYearFlag value="" class="common">
    </TD>
  </TR>
...
window.top.opener.returnFromRiskInput('121801','<%=needSetValue%>');
haveMenu = 1;
}
