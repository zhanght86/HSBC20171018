...
/////获得参数-险种编码
  ...
  loggerDebug("Risk121601","页面是否需要调用赋值函数=====" + needSetValue);
  ...
  ExeSQL rexeSql = new ExeSQL();
    ...
    loggerDebug("Risk121601","主附险标记====="+riskFlagSSRS.GetText(1,1));
...
<TABLE class=common>
  ...
  <TR CLASS=common>
    ...
    <TD CLASS=input COLSPAN=1>
     <Input class=codeno name=RiskCode id=RiskCode style="background:url(../common/images/select--bg_03.png) no-repeat right center" ondblclick="showCodeList('<%=queryCodeApp%>',[this,RiskCodeName],[0,1],null,null,null,null,'400');" onkeyup="return showCodeListKey('<%=queryCodeApp%>',[this,RiskCodeName],[0,1],null,null,null,null,'400');">
...
<TABLE class=common>
  ...
  <TR CLASS=common>
    ...
    <TD CLASS=input COLSPAN=1>
      <Input NAME=AgentCode id=AgentCode style="background:url(../common/images/guanliyuan-bg.png) no-repeat right center" VALUE="" MAXLENGTH=10 CLASS=code ondblclick="return queryAgent();"onkeyup="return queryAgent2();" >
    </TD>
    <TD CLASS=title>
      代理人组别
    </TD>
...
<TABLE class=common>
  ...
  <TR CLASS=common>
    ...
    <TD CLASS=input COLSPAN=1>
      <Input NAME=AppntSex id=AppntSex style="background:url(../common/images/guanliyuan-bg.png) no-repeat right center" VALUE="" MAXLENGTH=1 CLASS=code ondblclick="return showCodeList('Sex', [this]);" onkeyup="return showCodeListKey('Sex', [this]);" verify="投保人性别|notnull&code:Sex" >
    </TD>
    <TD CLASS=title>
      出生日期
    </TD>
...
<td class= titleImg>
被保人信息（客户号：<Input class=common id=CustomerNo name=CustomerNo >
...
<TABLE class=common>
 ...
 <TR CLASS=common>
    ...
    <TD CLASS=input COLSPAN=1>
      <Input NAME=Mult VALUE="" CLASS=common>
    </TD-->
...
if(isDia==0) { //如果是打开一个新的窗口，则执行下面的代码
	...
	window.top.opener.returnFromRiskInput('121601','<%=needSetValue%>');
	haveMenu = 1;
}
