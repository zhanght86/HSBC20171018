...
{ 
  ...
  {
    alert("在WorkAchieveStatInit.jsp-->InitInpBox函数中发生异常:初始化界面错误!");
  }      
}
...
{  
  ...
  {
    alert("在WorkAchieveStatInit.jsp-->InitSelBox函数中发生异常:初始化界面错误!");
  }
}                                        
...
function initForm()
{
  try
  {
    ...
    initEdorType(); //初始化保全项目下拉框
  }
  catch(re)
  {
    alert("WorkAchieveStatInit.jsp-->InitForm函数中发生异常:初始化界面错误!");
  }
}
