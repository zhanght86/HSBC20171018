 ...
 <input class="coolDatePicker" dateFormat="short" id=EndDay  name=EndDay  onClick="laydate({elem:'#EndDay '});" verify="结束日期|NOTNULL"> <span class="icon"><a onClick="laydate({elem: '#EndDay'});"><img src="../common/laydate/skins/default/icon.png" /></a></span>
        ...
        <TR  class= common>
          ...
          <TD  class= input5>  <Input type="text" class="codeno" name=ManageGrade   id=ManageGrade
           CodeData="0|^4|二级机构|^6|三级机构^8|四级机构" 
           style="background:url(../common/images/select--bg_03.png) no-repeat right center" 
...
<br>
  	<input class="cssButton" type=button value="普通保单交接清单" onClick="fnBillPrint()">
    <input class= cssButton type=Button name="BillPrintBank" value="银行打印保单交接清单" onclick="fnBillPrintBank()">
  	<!--<input class="cssButton" type=button  name="BillPrintVIP" value="VIP保单交接清单" onClick="fnBillPrintVIP()">-->
    <input class="cssButton" type=button  name="BillRePrint" value="补打保单交接清单" onClick="fnBillPrintLR()">
  	<input class="cssButton" type=button  name="BillLRPrint" value="重打保单交接清单" onClick="fnBillPrintRe()">
