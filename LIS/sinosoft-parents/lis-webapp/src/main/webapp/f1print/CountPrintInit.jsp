<%
//程序名称：CountPrintInit.jsp
//程序功能：
//创建日期：2003-10-24 04:10:36
//创建人  ：
...
{ 
  ...
  {
  	//fm.reset();
  	document.all('ManageCom').value= "<%=globalInput.ManageCom%>";
  }
  catch(ex)
  {
    alert("在CountPrintInit.jsp-->InitInpBox函数中发生异常:初始化界面错误!");
  }      
}
...
function initForm()
{
  ...
  {
    alert("CountPrintInit.jsp-->InitForm函数中发生异常:初始化界面错误!");
  }
}
