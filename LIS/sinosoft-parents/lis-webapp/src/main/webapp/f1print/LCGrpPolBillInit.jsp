...
{ 
  ...
  {
    alert("在LCGrpPolBillInit.jsp-->InitInpBox函数中发生异常:初始化界面错误!");
  }      
}
...
//    setOption("pad_flag","0=正常&1=垫交");   
  ...
  {
    alert("在LCGrpPolBillInit.jsp-->InitSelBox函数中发生异常:初始化界面错误!");
  }
}                                        
...
function initForm()
{
  ...
  {
    alert("LCGrpPolBillInit.jsp-->InitForm函数中发生异常:初始化界面错误!");
  }
}
</script>
