...
{ 
  ...
  {
    alert("在TempFeeInvoiceInit.jsp-->InitInpBox函数中发生异常:初始化界面错误!");
  }      
}
...
{  
  ...
  {
    alert("在TempFeeInvoiceInit.jsp-->InitSelBox函数中发生异常:初始化界面错误!");
  }
}                                        
...
function initForm()
{
  ...
  {
    alert("TempFeeInvoiceInit.jsp-->InitForm函数中发生异常:初始化界面错误!");
  }
}
