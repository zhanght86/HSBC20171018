...
<SCRIPT src="PolAppNoScanStatInput.js"></SCRIPT>
<LINK href="../common/css/Project.css" rel=stylesheet type=text/css>
<LINK href="../common/css/Project3.css" rel=stylesheet type=text/css>
<LINK href="../common/css/mulLine.css" rel=stylesheet type=text/css>
<%@include file="PolAppNoScanStatInit.jsp"%>
</head>

<body onload="initForm();" >
<form action="PolAppNoScanStatSave.jsp" method=post name=fm id=fm target="fraSubmit">
...
<table  class=common>
   <TR  class= common>
      ...
      <TD class= input5>    
         ...
         <Input class="coolDatePicker" onClick="laydate({elem: '#StartTime'});" verify="扫描日期|len=8" value="00:00:00" dateFormat="short" name=StartTime id="StartTime"><span class="icon"><a onClick="laydate({elem: '#StartTime'});"><img src="../common/laydate/skins/default/icon.png" /></a></span>
         (例:22:00:00)
      </TD>
    </TR>
    <TR class= common>
      ...
      <TD class= input5>    
         ...
         <Input class="coolDatePicker" onClick="laydate({elem: '#EndTime'});" verify="扫描日期|len=8" value="00:00:00" dateFormat="short" name=EndTime id="EndTime"><span class="icon"><a onClick="laydate({elem: '#EndTime'});"><img src="../common/laydate/skins/default/icon.png" /></a></span>
         (例:22:00:00)
      </TD>
    </TR>
    <TR class= common>  
	...
	报表类型
      ...
      <TD  class= input5>
      <Input style="background:url(../common/images/guanliyuan-bg.png) no-repeat right center" class=code name=AppReportType id=AppReportType  ondblClick="showCodeList('NoScanReportType',[this,ReportName],[0,1]);" onclick="showCodeList('NoScanReportType',[this,ReportName],[0,1]);" onkeyup="showCodeListKey('NoScanReportType',[this,ReportName],[0,1]);">
      </TD>
      <TD class= title5>
	统计区域
      </TD>
  ...
  <Div  id= "divRisk" style= "display: 'none'">
  <table  class=common>  
    <TR  class= common>
