...
<%
  ...
  try
  {
    ...
    PolAppHospiStatUI tPolAppHospiStatUI = new PolAppHospiStatUI();
    ...
    if(!tPolAppHospiStatUI.submitData(tVData,mOperate))
    {
      FlagStr="Fail";
      Content = " 处理失败，原因是:" +tPolAppHospiStatUI.mErrors.getFirstError();
    }  
    else
    { 
    mResult = tPolAppHospiStatUI.getResult();
    XmlExport txmlExport = new XmlExport();
    txmlExport=(XmlExport)mResult.getObjectByObjectName("XmlExport",0);
    if (txmlExport==null)
    {
      System.out.println("null");
      tError = tPolAppHospiStatUI.mErrors;
