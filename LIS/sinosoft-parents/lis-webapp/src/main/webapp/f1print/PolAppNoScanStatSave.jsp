...
<%
  ...
  try
  {
    ...
    PolAppNoScanStatUI tPolAppNoScanStatUI = new PolAppNoScanStatUI();
    ...
    System.out.println("Start PolAppNoScanStatUI...");      
    if(!tPolAppNoScanStatUI.submitData(tVData,mOperate))
    {
      FlagStr="Fail";
      Content = " 处理失败，原因是:" +tPolAppNoScanStatUI.mErrors.getFirstError();
    }  
    else
    { 
    mResult = tPolAppNoScanStatUI.getResult();
    XmlExport txmlExport = new XmlExport();
    txmlExport=(XmlExport)mResult.getObjectByObjectName("XmlExport",0);
    if (txmlExport==null)
    {
      System.out.println("null");
      tError = tPolAppNoScanStatUI.mErrors;
